...
- No declarative way to manage individual Cloudflare DNS records via Project Planton
...
Created a complete deployment component following the Project Planton 80/20 principle—exposing only the essential fields most users need while maintaining feature parity between Pulumi and Terraform implementations.
...
```
apis/org/project_planton/provider/cloudflare/cloudflarednsrecord/v1/
...
- **Consistent API**: Same manifest format as all other Project Planton components
