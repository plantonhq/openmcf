...
description: "A regional NAT gateway: one AWS-managed gateway that spans every availability zone of a VPC, replacing the classic per-AZ gateway fleet. AWS places capacity in each zone, allocates and rotates the..."
type: "preset"
rank: "03"
presetSlug: "03-regional-nat-gateway"
