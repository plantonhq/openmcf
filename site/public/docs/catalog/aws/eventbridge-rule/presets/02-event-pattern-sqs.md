...
description: "This preset creates an event-pattern-based EventBridge rule that routes matching AWS events to an SQS queue with a dead letter queue for failed deliveries. It demonstrates the core event-driven..."
type: "preset"
rank: "02"
presetSlug: "02-event-pattern-sqs"
