...
description: "This preset creates an App Runner service from a public ECR image with all default settings. It is the simplest possible App Runner deployment -- no IAM roles, no VPC, no encryption configuration...."
type: "preset"
rank: "01"
presetSlug: "01-basic-public-image"
