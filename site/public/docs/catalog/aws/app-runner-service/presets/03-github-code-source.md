...
description: "This preset creates an App Runner service that deploys directly from a GitHub repository using the Node.js 22 managed runtime. App Runner clones the repository, runs the build command, and starts the..."
type: "preset"
rank: "03"
presetSlug: "03-github-code-source"
