...
description: "This preset creates an App Runner service with NO public endpoint: incoming traffic is disabled on the internet side, and the service is published into a VPC through an interface VPC endpoint (AWS..."
type: "preset"
rank: "04"
presetSlug: "04-private-vpc-ingress"
