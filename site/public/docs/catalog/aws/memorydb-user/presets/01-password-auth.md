...
description: "This preset creates one MemoryDB ACL identity that authenticates with a password in the AUTH command. Each application gets its own user with an access string scoping exactly which keys and commands..."
type: "preset"
rank: "01"
presetSlug: "01-password-auth"
