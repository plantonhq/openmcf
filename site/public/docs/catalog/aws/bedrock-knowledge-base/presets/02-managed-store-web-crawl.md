...
description: "This preset creates a MANAGED-type knowledge base — AWS provisions and runs the vector store, so there is nothing to size or operate — crawling a documentation site (host-only scope, 1000 pages, 60..."
type: "preset"
rank: "02"
presetSlug: "02-managed-store-web-crawl"
