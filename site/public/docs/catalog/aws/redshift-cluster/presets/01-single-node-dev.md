...
description: "This preset creates a single-node Redshift cluster on the ra3.large node type for development and testing. The single-node topology combines the leader and compute roles on one node, keeping costs..."
type: "preset"
rank: "01"
