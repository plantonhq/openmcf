...
description: "Redshift Cluster deployment documentation"
icon: "package"
order: 100
componentName: "awsredshiftcluster"
---
...
- [AwsKmsKey](/docs/catalog/aws/kms-key) — provides KMS keys for cluster encryption and Secrets Manager
- [AwsIamRole](/docs/catalog/aws/iam-role) — provides IAM roles for S3 access, Spectrum, and other AWS service integrations
- [AwsS3Bucket](/docs/catalog/aws/s3-bucket) — stores data for COPY/UNLOAD operations and audit logs (when using S3 log destination)
