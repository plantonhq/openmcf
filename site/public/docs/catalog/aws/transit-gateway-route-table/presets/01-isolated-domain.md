...
description: "The canonical segmentation building block: a routing domain whose members see shared services but not the rest of the network, with a blackhole guaranteeing the isolation."
type: "preset"
rank: "01"
presetSlug: "01-isolated-domain"
