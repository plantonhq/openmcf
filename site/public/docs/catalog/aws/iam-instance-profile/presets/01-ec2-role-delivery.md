...
description: "This preset wraps an `AwsIamRole` in an instance profile so EC2 instances can receive the role's temporary credentials through the instance metadata service. Reference this profile's..."
type: "preset"
rank: "01"
presetSlug: "01-ec2-role-delivery"
