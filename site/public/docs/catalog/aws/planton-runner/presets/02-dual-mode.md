...
description: "This preset runs the runner in `dual` mode: everything the private VPC worker does, plus the real-time CloudOps channel -- live browsing of the resources behind the runner (pods, services, cluster..."
type: "preset"
rank: "02"
presetSlug: "02-dual-mode"
