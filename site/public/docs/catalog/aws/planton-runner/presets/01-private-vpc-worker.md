...
description: "This preset deploys the standard runner appliance: a pull-based worker on two private subnets that receives deploy operations through its queue and executes them from inside the VPC. The 30-second..."
type: "preset"
rank: "01"
presetSlug: "01-private-vpc-worker"
