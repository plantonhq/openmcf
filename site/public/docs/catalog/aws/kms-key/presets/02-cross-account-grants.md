...
description: "This preset creates a rotating symmetric key whose access is delegated through KMS grants instead of key-policy edits: one grant wires a workload role (referenced from an `AwsIamRole` in the same..."
type: "preset"
rank: "02"
presetSlug: "02-cross-account-grants"
