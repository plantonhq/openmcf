...
description: "This preset vaults the two credential shapes agent tools most commonly need — an API key and a GitHub OAuth client — as managed-secret references resolved just-in-time at deploy. Gateway targets and..."
type: "preset"
rank: "01"
presetSlug: "01-vaulted-credentials"
