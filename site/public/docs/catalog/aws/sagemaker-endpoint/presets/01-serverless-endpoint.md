...
description: "This preset serves one model on serverless compute — SageMaker scales capacity with traffic and bills per inference, so an idle endpoint costs $0. The start-cheap shape for new and spiky workloads."
type: "preset"
rank: "01"
presetSlug: "01-serverless-endpoint"
