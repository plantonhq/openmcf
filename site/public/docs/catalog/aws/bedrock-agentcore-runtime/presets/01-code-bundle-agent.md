...
description: "This preset hosts a Python agent from an S3 code bundle on the managed runtime — no container image to build or maintain — with public egress and one floating `live` endpoint."
type: "preset"
rank: "01"
presetSlug: "01-code-bundle-agent"
