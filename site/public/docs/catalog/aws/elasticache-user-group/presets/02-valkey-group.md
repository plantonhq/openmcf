...
description: "This preset creates a Valkey RBAC user group — the same membership and attachment model as the Redis preset, with `engine: valkey` so AWS accepts only Valkey-engine users and attaches the group only..."
type: "preset"
rank: "02"
presetSlug: "02-valkey-group"
