...
description: "ElastiCache User Group deployment documentation"
icon: "package"
order: 100
componentName: "awselasticacheusergroup"
---
...
- [AwsElasticacheUser](/docs/catalog/aws/elasticache-user) — RBAC identities referenced in `userIds`
- [AwsRedisElasticache](/docs/catalog/aws/redis-elasticache) — replication groups that attach user groups
