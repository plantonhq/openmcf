...
description: "Use this preset when one hostname must route requests to DIFFERENT REST APIs by path or header — a service split (`/orders` to the orders API), tenant pinning (beta tenants to a canary API), or a..."
type: "preset"
rank: "03"
presetSlug: "03-rule-routed-domain"
