...
description: "Use this preset to give one HTTP API a branded production URL: `https://api.example.com/` serving the API's `$default` stage at the domain root."
type: "preset"
rank: "01"
presetSlug: "01-single-api-domain"
