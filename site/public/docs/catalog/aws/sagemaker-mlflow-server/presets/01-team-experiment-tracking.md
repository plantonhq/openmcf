...
description: "This preset stands up a `Small` tracking server for a single ML team — experiments, runs, and model tracking with artifacts in your S3 bucket, and automatic model registration left off (the safe..."
type: "preset"
rank: "01"
presetSlug: "01-team-experiment-tracking"
