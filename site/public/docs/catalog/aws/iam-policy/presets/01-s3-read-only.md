...
description: "This preset creates a managed policy granting read-only access to a single S3 bucket -- the most common shared permission set in a typical AWS estate. Attach it to any role or user through their..."
type: "preset"
rank: "01"
presetSlug: "01-s3-read-only"
