...
- [AWS SES Configuration Set](/docs/catalog/aws/ses-configuration-set) — the sending rules and event publishing this identity opts into.
- [AWS Route53 DNS Record](/docs/catalog/aws/route53-dns-record) — publishes the DKIM CNAMEs and MAIL FROM MX/SPF records.
- [AWS Route53 Zone](/docs/catalog/aws/route53-zone) — the hosted zone those records live in.
