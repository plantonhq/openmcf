---
title: "Anthropic Model with Use-Case Form"
description: "This preset enables an Anthropic model, supplying the account use-case form Anthropic agreements require. The form is ACCOUNT-GLOBAL and write-once — keep it in exactly one instance (this one); every..."
type: "preset"
rank: "02"
presetSlug: "02-anthropic-with-use-case"
