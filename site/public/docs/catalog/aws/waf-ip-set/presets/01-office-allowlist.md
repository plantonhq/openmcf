...
description: "A REGIONAL IPv4 set carrying a /24 office range and a /32 single-host entry — the two CIDR shapes AWS accepts. Pair with a web ACL whose default action is block and an early-priority allow rule..."
type: "preset"
rank: "01"
presetSlug: "01-office-allowlist"
...
Reference from [AwsWafWebAcl](../../awswafwebacl/v1/README.md):
