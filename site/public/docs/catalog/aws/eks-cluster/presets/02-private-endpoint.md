...
description: "This preset creates a hardened, fully private EKS control plane: the API server is reachable only from inside the VPC, Kubernetes secrets are envelope-encrypted with a customer-managed KMS key, and..."
type: "preset"
rank: "02"
presetSlug: "02-private-endpoint"
