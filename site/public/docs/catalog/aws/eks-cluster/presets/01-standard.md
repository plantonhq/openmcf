...
description: "This preset creates a two-AZ EKS control plane with the modern access-entries authentication model, audit-grade control-plane logging, and standard upgrade support. The API endpoint stays publicly..."
type: "preset"
rank: "01"
