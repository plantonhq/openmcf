...
description: "The canonical Batch cost pattern: jobs try the Spot environment first (order 1) and spill to On-Demand (order 2) only when Spot capacity runs out. Most work rides ~90%-discounted compute; nothing..."
type: "preset"
rank: "02"
presetSlug: "02-spot-overflow"
