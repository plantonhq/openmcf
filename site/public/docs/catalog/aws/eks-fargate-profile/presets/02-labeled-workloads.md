...
description: "This preset runs only opted-in pods on Fargate -- pods that carry the selector's labels -- while the rest of the namespace keeps running on node groups. The mixed-compute pattern for shared..."
type: "preset"
rank: "02"
presetSlug: "02-labeled-workloads"
