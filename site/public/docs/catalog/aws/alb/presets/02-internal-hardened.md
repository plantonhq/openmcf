...
description: "This preset creates a VPC-internal Application Load Balancer with the HTTP hardening turned all the way up: invalid request headers are dropped, desync mitigation runs in `strictest` mode, and every..."
type: "preset"
rank: "02"
presetSlug: "02-internal-hardened"
componentSlug: "alb"
componentTitle: "ALB"
provider: "aws"
icon: "package"
