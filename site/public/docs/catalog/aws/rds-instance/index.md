...
- [AwsSubnet](/docs/catalog/aws/subnet) — the private subnets behind the subnet group
...
- [AwsIamRole](/docs/catalog/aws/iam-role) — the Enhanced Monitoring role
- [AwsRdsCluster](/docs/catalog/aws/rds-cluster) — Aurora and Multi-AZ cluster shapes
