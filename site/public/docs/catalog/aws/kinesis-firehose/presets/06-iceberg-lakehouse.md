...
description: "Streams records directly into a Glue-cataloged Apache Iceberg table with upsert semantics — Firehose writes Iceberg snapshots itself, so there is no Spark job, no custom writer, and no staged-file..."
type: "preset"
rank: "06"
presetSlug: "06-iceberg-lakehouse"
