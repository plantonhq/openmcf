...
description: "This preset runs an interruptible batch/burst pool on Spot capacity at a steep discount, with the two Spot survival practices built in: several similar instance types for pool diversity, and a taint..."
type: "preset"
rank: "02"
