...
description: "This preset composes the node group onto a first-class `AwsLaunchTemplate`: the template owns the launch mechanics (instance type, IMDSv2 enforcement, encrypted volumes, instance tags), and promoting..."
type: "preset"
rank: "03"
presetSlug: "03-launch-template"
