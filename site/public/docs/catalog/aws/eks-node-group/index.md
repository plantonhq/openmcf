...
- [AwsEksCluster](/docs/catalog/aws/eks-cluster) — the control plane this pool registers with
- [AwsLaunchTemplate](/docs/catalog/aws/launch-template) — hardened launch mechanics for the pool
- [AwsIamRole](/docs/catalog/aws/iam-role) — the node role (carries its own worker policies)
- [AwsSubnet](/docs/catalog/aws/subnet) — where the nodes launch
- [AwsSecurityGroup](/docs/catalog/aws/security-group) — SSH source scoping for remote access
