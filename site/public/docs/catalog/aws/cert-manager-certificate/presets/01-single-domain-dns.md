...
description: "This preset provisions an ACM certificate for a single domain using automated DNS validation via Route53. DNS validation is the recommended method because it requires no manual intervention -- ACM..."
type: "preset"
rank: "01"
