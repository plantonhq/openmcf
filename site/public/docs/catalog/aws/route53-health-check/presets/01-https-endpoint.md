...
description: "This preset creates the standard internet-facing HTTPS probe: Route 53's global checker fleet requests your application's health endpoint and the check stays healthy while the endpoint answers..."
type: "preset"
rank: "01"
presetSlug: "01-https-endpoint"
