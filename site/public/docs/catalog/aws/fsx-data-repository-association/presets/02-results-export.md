...
description: "Write-side association: everything jobs write under `/output` on the Lustre file system flows back to an S3 results prefix automatically."
type: "preset"
rank: "02"
presetSlug: "02-results-export"
