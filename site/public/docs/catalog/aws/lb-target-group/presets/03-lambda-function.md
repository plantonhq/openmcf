...
description: "This preset creates a Lambda target group: the ALB invokes the function directly for each request, so there is no port, protocol, or VPC to configure. The function is the group's single target,..."
type: "preset"
rank: "03"
presetSlug: "03-lambda-function"
