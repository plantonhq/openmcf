...
description: "This preset creates a `TCP_QUIC` target group for a Network Load Balancer serving HTTP/3 traffic: QUIC connections pass through natively while the same group serves clients that fall back to TCP on..."
type: "preset"
rank: "04"
presetSlug: "04-quic-passthrough"
