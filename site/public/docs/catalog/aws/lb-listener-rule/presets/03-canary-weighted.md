...
description: "This preset splits one route's traffic between two target groups -- 95% to the stable version, 5% to the canary -- with group stickiness so a client stays on whichever version served its first..."
type: "preset"
rank: "03"
presetSlug: "03-canary-weighted"
