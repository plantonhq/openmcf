...
description: "This preset routes one URL prefix to one service: requests whose path matches `/api/*` forward to the service's target group, while everything else falls through to lower-priority rules and the..."
type: "preset"
rank: "01"
presetSlug: "01-path-based-routing"
