...
- [AwsIamRole](/docs/catalog/aws/iam-role) — bulk loader and ML integration roles
- [AwsDocumentDb](/docs/catalog/aws/documentdb) — the document-database sibling with the same cluster anatomy
