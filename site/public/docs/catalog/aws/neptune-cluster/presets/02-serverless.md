...
description: "This preset creates a Neptune Serverless cluster: a single `db.serverless` instance that scales between 1 and 32 NCUs as traversal load moves, IAM database authentication, encrypted storage, and..."
type: "preset"
rank: "02"
