...
description: "This preset consumes an Amazon MSK topic with a pinned poller fleet that is SHARED across mappings: every mapping naming the same `pollerGroupName` draws from (and is jointly capped by) one..."
type: "preset"
rank: "03"
presetSlug: "03-msk-shared-pollers"
