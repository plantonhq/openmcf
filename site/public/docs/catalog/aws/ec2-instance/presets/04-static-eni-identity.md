...
description: "This preset attaches a pre-provisioned network interface (ENI) as the instance's primary interface instead of creating one. The ENI -- not the instance -- owns the network identity: the subnet, the..."
type: "preset"
rank: "04"
presetSlug: "04-static-eni-identity"
