...
- [AwsIamRole](/docs/catalog/aws/iam-role) — execution roles for the user plane, space plane, RStudio, Canvas capabilities, and EMR access
- [AwsSecurityGroup](/docs/catalog/aws/security-group) — controls network access for domain and user-level resources
- [AwsKmsKey](/docs/catalog/aws/kms-key) — customer-managed encryption for the EFS volume, shared outputs, and Canvas artifacts
- [AwsElasticFileSystem](/docs/catalog/aws/elastic-file-system) — additional shared file systems mounted into apps
- [AwsS3Bucket](/docs/catalog/aws/s3-bucket) — stores notebook outputs and Canvas artifacts
