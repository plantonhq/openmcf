...
description: "This preset creates a minimal Global Accelerator that accepts TCP traffic on port 443 and routes it to a single ALB endpoint. It uses all default settings: AWS-allocated static anycast IPs, no flow..."
type: "preset"
rank: "01"
presetSlug: "01-basic-tcp-accelerator"
