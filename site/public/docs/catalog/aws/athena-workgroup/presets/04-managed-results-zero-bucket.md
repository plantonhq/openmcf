...
description: "An Athena workgroup that stores query results in AWS-managed storage — no S3 bucket to create, secure, or lifecycle. Results are retained for 24 hours and retrieved through Athena APIs..."
type: "preset"
rank: "04"
presetSlug: "04-managed-results-zero-bucket"
