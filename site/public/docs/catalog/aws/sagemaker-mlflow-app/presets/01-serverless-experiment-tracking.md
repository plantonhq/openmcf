...
description: "This preset is MLflow with no meter running: a serverless MLflow 3.x app storing artifacts in your S3 bucket, billed per use and $0 when idle — the successor to the hourly-billed tracking server."
type: "preset"
rank: "01"
presetSlug: "01-serverless-experiment-tracking"
