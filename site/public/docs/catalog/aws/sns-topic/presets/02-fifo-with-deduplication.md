...
description: "This preset creates a FIFO SNS topic with content-based deduplication and high-throughput mode (per message group). Designed for workflows that require exactly-once, ordered message delivery."
type: "preset"
rank: "02"
presetSlug: "02-fifo-with-deduplication"
