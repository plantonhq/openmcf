...
- [AwsSnsSubscription](/docs/catalog/aws/sns-subscription) — the delivery edge attaching consumers to this topic
- [AwsSqsQueue](/docs/catalog/aws/sqs-queue) — the most common fan-out target
- [AwsKmsKey](/docs/catalog/aws/kms-key) — customer-managed encryption at rest
- [AwsIamRole](/docs/catalog/aws/iam-role) — delivery-status logging roles
- [AwsCloudwatchAlarm](/docs/catalog/aws/cloudwatch-alarm) — publishes alarm notifications to topics
