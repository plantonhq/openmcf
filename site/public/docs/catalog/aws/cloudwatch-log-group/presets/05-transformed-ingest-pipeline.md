...
description: "**Use case:** Normalize messy service logs at ingestion so queries, filters, and alarms all see one clean shape."
type: "preset"
rank: "05"
presetSlug: "05-transformed-ingest-pipeline"
