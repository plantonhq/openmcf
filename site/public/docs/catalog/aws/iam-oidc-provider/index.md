...
- [AwsIamRole](/docs/catalog/aws/iam-role) — the role whose trust policy references `provider_arn` to grant web-identity access
- [AwsEksCluster](/docs/catalog/aws/eks-cluster) — exports the `oidc_issuer_url` this provider consumes for IRSA
- [AwsIamUser](/docs/catalog/aws/iam-user) — the long-lived-credential alternative this component is designed to make unnecessary
