...
description: "This preset serves a trained scikit-learn artifact on AWS's own prebuilt framework image — the fastest path from a `model.tar.gz` in S3 to a deployable model, with no container of your own to build."
type: "preset"
rank: "01"
presetSlug: "01-prebuilt-framework-model"
