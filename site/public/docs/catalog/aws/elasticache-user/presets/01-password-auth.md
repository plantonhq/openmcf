...
description: "This preset creates one Redis/Valkey RBAC identity that authenticates with a password in the AUTH command. Each application gets its own user with an access string scoping exactly which keys and..."
type: "preset"
rank: "01"
