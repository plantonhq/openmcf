...
- [AwsElasticacheUserGroup](/docs/catalog/aws/elasticache-user-group) — collects users and attaches to caches
- [AwsRedisElasticache](/docs/catalog/aws/redis-elasticache) — replication groups that reference user groups
