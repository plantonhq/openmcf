---
title: "Presets"
description: "Ready-to-deploy configuration presets for FSx ONTAP Storage Virtual Machine"
type: "preset-list"
componentSlug: "fsx-ontap-storage-virtual-machine"
componentTitle: "FSx ONTAP Storage Virtual Machine"
provider: "aws"
icon: "package"
order: 200
presets:
...
# FSx ONTAP Storage Virtual Machine Presets

Ready-to-deploy configuration presets for FSx ONTAP Storage Virtual Machine. Each preset is a complete manifest you can copy, customize, and deploy.
