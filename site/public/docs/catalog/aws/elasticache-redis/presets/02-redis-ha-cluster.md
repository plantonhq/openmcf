...
description: "This preset creates a 3-node Redis 7.1 cluster (1 primary + 2 read replicas) with automatic failover, multi-AZ deployment, encryption, daily snapshots, and a tuned eviction policy. Production-ready..."
type: "preset"
rank: "02"
presetSlug: "02-redis-ha-cluster"
