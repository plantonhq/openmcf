...
description: "This preset creates a three-stage V2 pipeline that treats the production deploy as a guarded, self-healing operation: the deploy stage only opens during business hours (a DeploymentWindow entry..."
type: "preset"
rank: "04"
presetSlug: "04-gated-deploy-with-rollback"
