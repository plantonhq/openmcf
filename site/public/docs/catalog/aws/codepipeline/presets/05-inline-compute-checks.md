...
description: "This preset creates a three-stage V2 pipeline whose quality gate runs as a Compute action — shell commands executed directly in CodePipeline-managed compute, with no CodeBuild project to create or..."
type: "preset"
rank: "05"
presetSlug: "05-inline-compute-checks"
