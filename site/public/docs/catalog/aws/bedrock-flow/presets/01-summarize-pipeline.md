...
description: "This preset creates the canonical minimal flow — Input → inline Prompt → Output — summarizing whatever document the caller sends, at temperature 0 on Amazon Nova Micro."
type: "preset"
rank: "01"
presetSlug: "01-summarize-pipeline"
