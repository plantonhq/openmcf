...
description: "Launch Template deployment documentation"
icon: "package"
order: 100
componentName: "awslaunchtemplate"
---
...
- [AwsAutoScalingGroup](/docs/catalog/aws/auto-scaling-group) — launches and manages fleets from this template
- [AwsBatchComputeEnvironment](/docs/catalog/aws/batch-compute-environment) — launches Batch compute from this template
- [AwsIamInstanceProfile](/docs/catalog/aws/iam-instance-profile) — the instance identity the template attaches
- [AwsSecurityGroup](/docs/catalog/aws/security-group) — network access control for launched instances
- [AwsKmsKey](/docs/catalog/aws/kms-key) — customer-managed EBS encryption keys
- [AwsSubnet](/docs/catalog/aws/subnet) — subnet placement for explicit network interfaces
