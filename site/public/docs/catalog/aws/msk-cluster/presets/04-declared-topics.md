...
description: "An MSK cluster whose topics deploy WITH it: three contract topics (an event stream, its dead-letter queue, and a compacted snapshot topic) declared in the spec and managed through the MSK topic API —..."
type: "preset"
rank: "04"
presetSlug: "04-declared-topics"
