...
description: "This preset defines a Fargate web application task: one container with a named HTTP port (ready for load-balancer and Service Connect wiring), secrets injected by reference at task start, an..."
type: "preset"
rank: "01"
presetSlug: "01-web-app"
