...
description: "This preset declares a task whose volume is configured at launch time: the task definition names the volume slot, and the ECS service that runs it attaches a fresh, service-owned EBS volume per task..."
type: "preset"
rank: "04"
presetSlug: "04-launch-time-ebs-volume"
