...
description: "FSx for Windows File Server deployment documentation"
icon: "package"
order: 100
componentName: "awsfsxwindowsfilesystem"
---
...
- [AwsSecurityGroup](/docs/catalog/aws/security-group) — controls SMB and AD traffic to the file system
- [AwsKmsKey](/docs/catalog/aws/kms-key) — provides customer-managed encryption keys
- [AwsCloudwatchLogGroup](/docs/catalog/aws/cloudwatch-log-group) — receives audit log events
- [AwsFsxOpenzfsFileSystem](/docs/catalog/aws/fsx-for-openzfs) — NFS alternative for Linux workloads
