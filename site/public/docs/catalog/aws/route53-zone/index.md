...
- [AwsRoute53DnsRecord](/docs/catalog/aws/route53-dns-record) — the records that live in this zone
- [AwsRoute53HealthCheck](/docs/catalog/aws/route53-health-check) — gates records' DNS answers on endpoint health
- [AwsCertManagerCert](/docs/catalog/aws/certificate) — DNS-validates certificates against this zone
- [AwsVpc](/docs/catalog/aws/vpc) — the VPCs a private zone resolves in
- [AwsKmsKey](/docs/catalog/aws/kms-key) — backs the DNSSEC key-signing key
