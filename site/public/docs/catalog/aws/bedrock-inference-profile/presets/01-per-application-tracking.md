...
description: "This preset creates one application inference profile routing straight to a foundation model — the per-consumer attribution unit: give each service its own copy of this preset (named after the..."
type: "preset"
rank: "01"
