...
- [AwsIamRole](/docs/catalog/aws/iam-role) — engine integration roles and the Enhanced Monitoring role
- [AwsRdsInstance](/docs/catalog/aws/rds-instance) — the single-node alternative
