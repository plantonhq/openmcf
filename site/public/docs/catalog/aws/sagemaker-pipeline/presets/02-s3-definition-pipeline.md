...
description: "This preset reads the pipeline definition from an S3 object — for definitions too large to inline, or published to S3 by the pipeline's own build tooling — with a parallelism cap on executions."
type: "preset"
rank: "02"
presetSlug: "02-s3-definition-pipeline"
