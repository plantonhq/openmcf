...
description: "This preset creates a Client VPN endpoint with SAML 2.0 single sign-on and group-scoped authorization — users authenticate with their existing identity provider (Okta, Entra ID, ...), download their..."
type: "preset"
rank: "03"
presetSlug: "03-saml-sso"
