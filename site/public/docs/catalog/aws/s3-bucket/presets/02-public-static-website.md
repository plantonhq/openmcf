...
description: "This preset creates a bucket that serves a static website directly over S3's website endpoint. Public access is granted deliberately and precisely: the policy grants read on objects, and only the two..."
type: "preset"
rank: "02"
