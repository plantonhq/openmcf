...
description: "Use this preset to front an internal Application Load Balancer (or NLB / Cloud Map service) with HTTP APIs. One link per VPC is typically enough -- every API that needs private backends in that VPC..."
type: "preset"
rank: "01"
presetSlug: "01-private-alb-link"
