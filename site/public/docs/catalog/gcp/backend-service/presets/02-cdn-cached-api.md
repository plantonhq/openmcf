...
description: "A read-heavy API served through Cloud CDN with the origin in control: `USE_ORIGIN_HEADERS` caches exactly what the application marks cacheable, tracking parameters are stripped from the cache key,..."
type: "preset"
rank: "02"
presetSlug: "02-cdn-cached-api"
