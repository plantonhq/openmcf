...
- **An existing BigQuery dataset** — referenced via `datasetId` (a [GcpBigQueryDataset](/docs/catalog/gcp/bigquery-dataset) resource or a literal dataset ID)
...
- [GcpBigQueryDataset](/docs/catalog/gcp/bigquery-dataset) — parent dataset
- [GcpKmsKey](/docs/catalog/gcp/kms-key) — CMEK key reference
