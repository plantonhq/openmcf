...
description: "A production-scale connector for serverless fleets that push serious traffic into the VPC. `e2-standard-4` instances carry roughly a 1 Gbps class of throughput each (versus ~200 Mbps for `e2-micro`),..."
type: "preset"
rank: "02"
presetSlug: "02-high-throughput"
