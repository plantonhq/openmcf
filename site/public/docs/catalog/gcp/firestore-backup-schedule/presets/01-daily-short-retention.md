...
description: "A daily backup schedule with a one-week retention window — the common companion to PITR for recent restore points without long-term storage cost."
type: "preset"
rank: "01"
presetSlug: "01-daily-short-retention"
