...
description: "The workhorse event route: a message published to a Pub/Sub topic invokes a Cloud Run service — with your own topic as transport so the topic remains shared infrastructure."
type: "preset"
rank: "01"
presetSlug: "01-pubsub-to-cloud-run"
