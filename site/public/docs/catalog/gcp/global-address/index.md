...
description: "Global Address deployment documentation"
icon: "package"
order: 100
componentName: "gcpglobaladdress"
---
...
- [GcpVpc](/docs/catalog/gcp/vpc) — provides the VPC network for internal address reservations and can enable Private Services Access
- [GcpCloudCdn](/docs/catalog/gcp/cloud-cdn) — uses an external global address as the frontend IP for CDN-enabled load balancers
