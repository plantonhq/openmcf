...
description: "This preset reserves a `/20` internal IP range for VPC peering with Google managed services. Cloud SQL, Memorystore (Redis), AlloyDB, and Filestore all use this mechanism to assign private IPs from..."
type: "preset"
rank: "02"
presetSlug: "02-internal-vpc-peering-range"
