...
description: "Backs the database up every 12 hours using incremental chains — each backup stores only the changes since the previous one, at a fraction of full-backup storage cost with the same restore semantics."
type: "preset"
rank: "02"
presetSlug: "02-incremental-enterprise"
