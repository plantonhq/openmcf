...
description: "A bulk-built index seeded from a Cloud Storage directory of embedding files — the economical shape for corpora refreshed on a schedule."
type: "preset"
rank: "02"
presetSlug: "02-batch-from-gcs"
