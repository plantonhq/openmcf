...
description: "A fixed-size, three-zone fleet with application-level auto-healing and hardened boot — the availability-first posture for serving tiers whose size is planned rather than demand-driven."
type: "preset"
rank: "02"
presetSlug: "02-regional-ha-group"
