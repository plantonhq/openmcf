...
description: "This preset creates a KMS key ring in the `global` location, making encryption keys accessible from any GCP region without latency penalties associated with cross-region access."
type: "preset"
rank: "02"
presetSlug: "02-global-key-ring"
