...
description: "One pull URL for everything: a virtual repository that serves first-party images from the team's standard repository and falls through to the Docker Hub cache for everything else — consumers never..."
type: "preset"
rank: "03"
presetSlug: "03-virtual-aggregation"
