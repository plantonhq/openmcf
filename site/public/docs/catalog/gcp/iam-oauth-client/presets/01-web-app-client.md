...
description: "The standard server-side shape: a confidential client with one managed credential whose secret GCP generates — the app authenticates users through the code flow and keeps sessions alive with refresh..."
type: "preset"
rank: "01"
presetSlug: "01-web-app-client"
