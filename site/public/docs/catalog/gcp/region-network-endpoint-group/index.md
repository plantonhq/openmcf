---
title: "Region Network Endpoint Group"
description: "Region Network Endpoint Group deployment documentation"
icon: "package"
order: 100
...
- [GcpBackendService](/docs/catalog/gcp/backend-service) — references this NEG in `backends[].group`
- [GcpCloudRun](/docs/catalog/gcp/cloud-run) — the serverless workload a SERVERLESS NEG fronts
- [GcpVpcNetwork](/docs/catalog/gcp/vpc) — the network for PSC/INTERNET NEGs
