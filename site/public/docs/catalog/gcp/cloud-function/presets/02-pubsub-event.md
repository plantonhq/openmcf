...
description: "An event-driven worker consuming a Pub/Sub topic ([GcpPubSubTopic](/docs/catalog/gcp/gcppubsubtopic)) through Eventarc. Ingress is locked to internal traffic — nothing about an event consumer needs a..."
type: "preset"
rank: "02"
