...
description: "A backend bucket with edge caching off: the load balancer proxies every request to the bucket. The simplest way to put GCS content behind the same global VIP, hostname, and URL map as the rest of an..."
type: "preset"
rank: "02"
presetSlug: "02-plain-origin"
