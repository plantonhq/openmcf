---
title: "Cloud Composer User Workloads ConfigMap"
description: "Cloud Composer User Workloads ConfigMap deployment documentation"
icon: "package"
order: 100
componentName: "gcpcloudcomposeruserworkloadsconfigmap"
---
...
- [GcpCloudComposerEnvironment](/docs/catalog/gcp/cloud-composer-environment) — the environment the ConfigMap is delivered into
- [GcpCloudComposerUserWorkloadsSecret](/docs/catalog/gcp/cloud-composer-user-workloads-secret) — the secret-bearing sibling for credentials
