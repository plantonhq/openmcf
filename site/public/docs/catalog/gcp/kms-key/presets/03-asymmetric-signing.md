...
description: "The code- and artifact-signing primitive: an `ASYMMETRIC_SIGN` key whose private material never leaves Cloud KMS, with public keys fetched by verifiers per version."
type: "preset"
rank: "03"
