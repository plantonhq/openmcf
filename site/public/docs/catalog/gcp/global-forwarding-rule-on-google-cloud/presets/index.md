---
title: "Presets"
description: "Ready-to-deploy configuration presets for Global Forwarding Rule on Google Cloud"
type: "preset-list"
componentSlug: "global-forwarding-rule-on-google-cloud"
componentTitle: "Global Forwarding Rule on Google Cloud"
provider: "gcp"
icon: "package"
order: 200
presets:
...
# Global Forwarding Rule on Google Cloud Presets

Ready-to-deploy configuration presets for Global Forwarding Rule on Google Cloud. Each preset is a complete manifest you can copy, customize, and deploy.
