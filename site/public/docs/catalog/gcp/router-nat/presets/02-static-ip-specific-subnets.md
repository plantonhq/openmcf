...
description: "This preset creates a Cloud Router with NAT restricted to specific subnets using manually assigned static external IPs. Use this when you need predictable egress IP addresses -- for example, when..."
type: "preset"
rank: "02"
presetSlug: "02-static-ip-specific-subnets"
