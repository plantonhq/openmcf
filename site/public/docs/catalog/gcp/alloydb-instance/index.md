...
description: "AlloyDB Instance deployment documentation"
icon: "package"
order: 100
componentName: "gcpalloydbinstance"
---
...
- **An existing [GcpAlloydbCluster](/docs/catalog/gcp/alloydb-cluster)** (or literal cluster resource path)
...
- [GcpAlloydbUser](/docs/catalog/gcp/alloydb-user)
