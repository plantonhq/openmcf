---
title: "Presets"
description: "Ready-to-deploy configuration presets for Backend Bucket on Google Cloud"
type: "preset-list"
...
# Backend Bucket on Google Cloud Presets

Ready-to-deploy configuration presets for Backend Bucket on Google Cloud. Each preset is a complete manifest you can copy, customize, and deploy.
