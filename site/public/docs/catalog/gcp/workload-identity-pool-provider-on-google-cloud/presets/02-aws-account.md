...
description: "This preset trusts workloads running in one AWS account: EC2 instances, Lambda functions, and ECS tasks federate into Google Cloud using their native AWS credentials — no tokens to mint, no keys to..."
type: "preset"
rank: "02"
presetSlug: "02-aws-account"
