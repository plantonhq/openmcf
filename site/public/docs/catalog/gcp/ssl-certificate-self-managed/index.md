---
title: "SSL Certificate (Self-Managed)"
description: "SSL Certificate (Self-Managed) deployment documentation"
icon: "package"
order: 100
componentName: "gcpsslcertificate"
---
...
- [GcpTargetHttpsProxy](/docs/catalog/gcp/target-https-proxy) — presents this certificate to clients
- [GcpManagedSslCertificate](/docs/catalog/gcp/managed-ssl-certificate) — the Google-managed alternative
- [GcpSslPolicy](/docs/catalog/gcp/ssl-policy) — hardens TLS versions and ciphers on the same proxy
