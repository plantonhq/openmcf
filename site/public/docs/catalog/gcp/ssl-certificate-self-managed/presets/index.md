---
title: "Presets"
description: "Ready-to-deploy configuration presets for SSL Certificate (Self-Managed)"
type: "preset-list"
...
# SSL Certificate (Self-Managed) Presets

Ready-to-deploy configuration presets for SSL Certificate (Self-Managed). Each preset is a complete manifest you can copy, customize, and deploy.
