...
description: "Hand-pick the exact cipher suites the load balancer may negotiate — for security reviews that specify an allowlist rather than a named profile."
type: "preset"
rank: "03"
presetSlug: "03-custom-cipher-list"
