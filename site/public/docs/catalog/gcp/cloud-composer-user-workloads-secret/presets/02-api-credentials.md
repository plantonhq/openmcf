...
description: "Two token entries — an API key and a webhook signing secret — delivered as one Kubernetes Secret. DAG tasks that call the external service mount both from a single named Secret."
type: "preset"
rank: "02"
presetSlug: "02-api-credentials"
