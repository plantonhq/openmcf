---
title: "KMS Key IAM Member"
description: "KMS Key IAM Member deployment documentation"
icon: "package"
order: 100
...
- [GcpKmsKey](/docs/catalog/gcp/kms-key) — the key being granted on
- [GcpKmsKeyRing](/docs/catalog/gcp/kms-key-ring) — the key's parent ring
- [GcpServiceAccount](/docs/catalog/gcp/service-account) — a grantable identity
