...
description: "The zero-downtime cutover shape: create the mapping with NO managed certificate, publish the DNS records while the old host still serves, then flip to `AUTOMATIC` once traffic has moved."
type: "preset"
rank: "02"
presetSlug: "02-migration-no-cert"
