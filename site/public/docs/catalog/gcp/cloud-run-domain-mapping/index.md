...
description: "Cloud Run Domain Mapping deployment documentation"
icon: "package"
order: 100
componentName: "gcpcloudrundomainmapping"
---
...
- [GcpCloudRun](/docs/catalog/gcp/cloud-run) — the service being mapped
- [GcpDnsRecord](/docs/catalog/gcp/dns-record-on-google-cloud) — publishes the emitted records in a Cloud DNS zone
- [GcpDnsZone](/docs/catalog/gcp/dns-zone-on-google-cloud) — the managed zone those records live in
- [GcpProject](/docs/catalog/gcp/project-on-google-cloud) — provides the project and API enablement
