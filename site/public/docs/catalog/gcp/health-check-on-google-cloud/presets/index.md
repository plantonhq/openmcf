---
title: "Presets"
description: "Ready-to-deploy configuration presets for Health Check on Google Cloud"
type: "preset-list"
...
# Health Check on Google Cloud Presets

Ready-to-deploy configuration presets for Health Check on Google Cloud. Each preset is a complete manifest you can copy, customize, and deploy.
