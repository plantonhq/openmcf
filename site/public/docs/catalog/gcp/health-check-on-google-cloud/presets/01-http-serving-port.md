...
description: "The workhorse health check for global external HTTP(S) load balancers: an HTTP GET against a dedicated health endpoint, probing whatever port each backend actually serves on (`USE_SERVING_PORT`) so..."
type: "preset"
rank: "01"
presetSlug: "01-http-serving-port"
