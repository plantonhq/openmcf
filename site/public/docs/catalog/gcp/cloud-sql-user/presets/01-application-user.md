...
description: "This preset creates a classic username/password user for one application, with a lockout policy after repeated failed logins. One user per application — never share the instance's admin user across..."
type: "preset"
rank: "01"
