...
description: "Workload Identity Pool deployment documentation"
icon: "package"
order: 100
...
- [GcpWorkloadIdentityPoolProvider](/docs/catalog/gcp/workload-identity-pool-provider) — attaches an external issuer to this pool
- [GcpServiceAccount](/docs/catalog/gcp/service-account) — the identity federated principals typically impersonate
- [GcpProjectIamMember](/docs/catalog/gcp/project-iam-member) — grants roles to principals built from this pool
- [GcpProject](/docs/catalog/gcp/project) — provides the project that owns the pool
