...
description: "Provisions a compliance-grade Spanner database: customer-managed encryption (CMEK) by reference to a `GcpKmsKey`, GCP API-side drop protection, point-in-time recovery, and an explicit UTC time zone."
type: "preset"
rank: "03"
presetSlug: "03-cmek-encrypted"
