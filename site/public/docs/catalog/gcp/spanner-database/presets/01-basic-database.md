...
description: "Provisions a Spanner database on an existing instance with Google's SQL dialect and a 24-hour point-in-time recovery window. The database is named after `metadata.name`; schema management belongs to..."
type: "preset"
rank: "01"
