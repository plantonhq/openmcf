...
description: "This preset creates a firewall rule that allows SSH (port 22) access exclusively from Google's Identity-Aware Proxy (IAP) IP range (`35.235.240.0/20`). IAP provides authenticated, audited SSH access..."
type: "preset"
rank: "02"
presetSlug: "02-ingress-allow-ssh-iap"
