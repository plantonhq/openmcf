...
- [GcpKmsKey](/docs/catalog/gcp/kms-key) — CMEK and Kerberos file encryption keys
- [GcpGkeCluster](/docs/catalog/gcp/gke-cluster) — the virtual arm's compute substrate
- [GcpGkeNodePool](/docs/catalog/gcp/gke-node-pool) — node pools Dataproc roles schedule onto
