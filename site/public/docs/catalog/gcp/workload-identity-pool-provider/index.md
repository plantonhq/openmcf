...
description: "Workload Identity Pool Provider deployment documentation"
icon: "package"
order: 100
componentName: "gcpworkloadidentitypoolprovider"
---
...
- [GcpWorkloadIdentityPool](/docs/catalog/gcp/workload-identity-pool) — the pool this provider attaches to
- [GcpServiceAccount](/docs/catalog/gcp/service-account) — grant `roles/iam.workloadIdentityUser` to this provider's principals for impersonation
- [GcpProjectIamMember](/docs/catalog/gcp/project-iam-member) — grants roles directly to principals mapped by this provider
