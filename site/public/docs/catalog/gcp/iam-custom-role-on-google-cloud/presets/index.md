---
title: "Presets"
description: "Ready-to-deploy configuration presets for IAM Custom Role on Google Cloud"
type: "preset-list"
...
# IAM Custom Role on Google Cloud Presets

Ready-to-deploy configuration presets for IAM Custom Role on Google Cloud. Each preset is a complete manifest you can copy, customize, and deploy.
