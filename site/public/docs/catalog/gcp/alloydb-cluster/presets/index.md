...
presets:
  - slug: "01-dev-basic"
    rank: "01"
    title: "Dev Basic"
    excerpt: "Minimal development cluster for local development, CI/CD pipelines, and prototyping. Uses 2 CPUs, ZONAL availability, no CMEK for easy teardown."
  - slug: "02-ha-production"
    rank: "02"
    title: "HA Production"
    excerpt: "Production-ready AlloyDB cluster with high availability, automated backups with 7-day retention, initial user, and ENCRYPTED_ONLY SSL. Uses 4 CPUs and REGIONAL deployment for automatic failover."
