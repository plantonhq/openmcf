---
title: "Managed SSL Certificate"
description: "Managed SSL Certificate deployment documentation"
icon: "package"
order: 100
...
- [GcpUrlMap](/docs/catalog/gcp/url-map) — routes traffic behind the HTTPS proxy
- [GcpBackendService](/docs/catalog/gcp/backend-service) — backends the load balancer targets
- [GcpGlobalAddress](/docs/catalog/gcp/global-address) — static IP for DNS A records
