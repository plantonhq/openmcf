---
title: "Presets"
description: "Ready-to-deploy configuration presets for Target HTTP Proxy on Google Cloud"
type: "preset-list"
...
# Target HTTP Proxy on Google Cloud Presets

Ready-to-deploy configuration presets for Target HTTP Proxy on Google Cloud. Each preset is a complete manifest you can copy, customize, and deploy.
