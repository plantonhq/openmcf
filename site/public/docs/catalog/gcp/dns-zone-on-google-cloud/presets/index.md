---
title: "Presets"
description: "Ready-to-deploy configuration presets for DNS Zone on Google Cloud"
type: "preset-list"
...
# DNS Zone on Google Cloud Presets

Ready-to-deploy configuration presets for DNS Zone on Google Cloud. Each preset is a complete manifest you can copy, customize, and deploy.
