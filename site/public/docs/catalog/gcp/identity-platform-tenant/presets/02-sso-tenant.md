---
title: "SSO Tenant"
description: "A tenant whose customer brings their own corporate IdP: users authenticate against the customer's SAML directory (Okta, Azure AD, Ping, ...), and no passwords live in the tenant at all."
type: "preset"
rank: "02"
presetSlug: "02-sso-tenant"
