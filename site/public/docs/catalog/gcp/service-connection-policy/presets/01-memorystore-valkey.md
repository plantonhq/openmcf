...
description: "The policy that unlocks Memorystore for Valkey on a network: authorizes the `gcp-memorystore` service class in one region and gives the connectivity automation a subnet to place PSC endpoints in."
type: "preset"
rank: "01"
presetSlug: "01-memorystore-valkey"
