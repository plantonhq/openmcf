...
description: "The canonical availability monitor: probe a public URL over TLS from all regions every five minutes, with certificate validation so an expired certificate fails the probe instead of passing silently."
type: "preset"
rank: "01"
presetSlug: "01-public-https-check"
