...
description: "Probes a health endpoint that sits behind HTTP basic auth, asserting both transport health (2xx over valid TLS) and body truth (the health JSON actually says ok)."
type: "preset"
rank: "03"
presetSlug: "03-authenticated-api-check"
