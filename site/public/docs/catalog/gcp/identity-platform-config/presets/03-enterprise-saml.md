...
description: "Inbound SAML SSO from a corporate identity provider (Okta, Azure AD, Ping, ...) with MFA enabled and the app's domain authorized — the enterprise sign-in posture."
type: "preset"
rank: "03"
presetSlug: "03-enterprise-saml"
