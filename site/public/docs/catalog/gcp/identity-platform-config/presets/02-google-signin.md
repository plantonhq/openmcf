...
description: "Email/password plus \"Sign in with Google\" — the standard consumer-app pair. Google handles the second flow's credentials; your app never sees a password for those users."
type: "preset"
rank: "02"
presetSlug: "02-google-signin"
