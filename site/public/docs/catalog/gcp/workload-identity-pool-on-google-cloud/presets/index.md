---
title: "Presets"
description: "Ready-to-deploy configuration presets for Workload Identity Pool on Google Cloud"
type: "preset-list"
...
# Workload Identity Pool on Google Cloud Presets

Ready-to-deploy configuration presets for Workload Identity Pool on Google Cloud. Each preset is a complete manifest you can copy, customize, and deploy.
