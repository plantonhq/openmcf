...
description: "Global Forwarding Rule deployment documentation"
icon: "package"
order: 100
...
- [GcpTargetHttpsProxy](/docs/catalog/gcp/target-https-proxy) — the default target
- [GcpTargetHttpProxy](/docs/catalog/gcp/target-http-proxy) — the port-80 redirect target
- [GcpGlobalAddress](/docs/catalog/gcp/global-address) — the reserved static VIP
- [GcpVpcNetwork](/docs/catalog/gcp/vpc) — the network for internal/PSC frontends
