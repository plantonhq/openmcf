...
description: "This preset teaches the distinction that trips up most custom-role authors: control-plane `actions` manage Azure resources, data-plane `dataActions` access the data inside them. A role with every..."
type: "preset"
rank: "02"
presetSlug: "02-blob-data-reader-role"
