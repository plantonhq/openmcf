...
description: "This preset creates a public (internet-facing) Azure Load Balancer: one public frontend, a `web` backend pool, an HTTP health probe, and TCP rules for ports 80 and 443 with TCP reset enabled. This is..."
type: "preset"
rank: "01"
