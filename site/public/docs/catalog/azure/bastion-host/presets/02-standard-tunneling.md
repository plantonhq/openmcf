...
description: "This preset deploys a Standard host shaped for engineering teams: native-client sessions from a local terminal (`az network bastion ssh/rdp/tunnel`), file transfer, IP-based connections across..."
type: "preset"
rank: "02"
presetSlug: "02-standard-tunneling"
