...
description: "This preset routes everything a resource emits -- every log category (via the `allLogs` group) and all metrics -- to a Log Analytics Workspace in the modern resource-specific table layout. It is the..."
type: "preset"
rank: "01"
presetSlug: "01-logs-to-workspace"
