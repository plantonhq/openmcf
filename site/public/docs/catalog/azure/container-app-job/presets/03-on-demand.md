...
description: "This preset creates a manually triggered job -- the database-migration model. The job definition lives in the environment ready to run; executions start on demand from the CLI (`az containerapp job..."
type: "preset"
rank: "03"
presetSlug: "03-on-demand"
