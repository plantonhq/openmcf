...
description: "This preset creates a Standard profile with access-log scrubbing turned all the way up -- client IP addresses, request URIs, and query-string arguments are masked before Front Door writes its logs."
type: "preset"
rank: "03"
presetSlug: "03-compliance-log-scrubbing"
