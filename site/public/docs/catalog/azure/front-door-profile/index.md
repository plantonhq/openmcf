...
description: "Front Door Profile deployment documentation"
icon: "package"
order: 100
componentName: "azurefrontdoorprofile"
---
...
- [AzureResourceGroup](/docs/catalog/azure/resource-group) -- provides the resource group for profile placement
- [AzureDnsRecord](/docs/catalog/azure/dns-record) -- creates CNAME records pointing to endpoint hostnames
- [AzureLinuxWebApp](/docs/catalog/azure/linux-web-app) -- common origin backend for web applications
- [AzureFunctionApp](/docs/catalog/azure/function-app) -- common origin backend for serverless APIs
- [AzureStorageAccount](/docs/catalog/azure/storage-account) -- common origin backend for static content
