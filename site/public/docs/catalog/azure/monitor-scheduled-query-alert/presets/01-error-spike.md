...
description: "This preset creates the bread-and-butter log alert: count the error rows a KQL query returns and fire when the count crosses a line -- here, more than 10 application exceptions in 10 minutes."
type: "preset"
rank: "01"
presetSlug: "01-error-spike"
