...
description: "This preset locks the account down on every axis the service offers: deny-by-default network ACLs with explicit IP and subnet allowances, Entra-ID-only authentication (keys disabled), and restricted..."
type: "preset"
rank: "03"
presetSlug: "03-private-hardened-account"
