...
description: "This preset creates a share whose external access rides stored access policies (signed identifiers). SAS tokens issued against a policy inherit its window and permissions -- and revoking the policy..."
type: "preset"
rank: "03"
