...
description: "This preset creates the policy almost every gateway should start with: the OWASP 3.2 core rule set in Prevention mode (Azure's default), no custom rules, no overrides. It blocks SQL injection,..."
type: "preset"
rank: "01"
presetSlug: "01-owasp-baseline"
