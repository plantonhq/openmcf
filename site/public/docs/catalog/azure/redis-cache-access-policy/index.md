...
- [Azure Redis Cache](/docs/catalog/azure/cache-for-redis) -- the parent cache
- [Azure Redis Cache Access Policy Assignment](/docs/catalog/azure/redis-cache-access-policy-assignment) -- grants this policy to an identity
