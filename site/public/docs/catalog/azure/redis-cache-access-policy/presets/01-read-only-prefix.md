...
description: "This preset defines the most common custom policy: read-only access scoped to one application's key prefix -- finer than the built-in \"Data Reader\", which reads every key on the cache."
type: "preset"
rank: "01"
presetSlug: "01-read-only-prefix"
