---
title: "Event Hub Namespace Customer Managed Key"
description: "Event Hub Namespace Customer Managed Key deployment documentation"
icon: "package"
order: 100
componentName: "azureeventhubnamespacecustomermanagedkey"
---
...
- [Azure Event Hub Namespace](/docs/catalog/azure/event-hub-namespace) -- the namespace to encrypt (dedicated cluster or PREMIUM)
- [Azure Event Hub Cluster](/docs/catalog/azure/event-hub-cluster) -- dedicated placement that unlocks CMK eligibility
- [Azure Key Vault Key](/docs/catalog/azure/key-vault-key) -- the encryption keys (versionless for auto-rotation)
- [Azure Role Assignment](/docs/catalog/azure/role-assignment) -- the wrap/unwrap grant on the vault
- [Azure User Assigned Identity](/docs/catalog/azure/user-assigned-identity) -- an optional dedicated unwrapping identity
