...
description: "This preset creates the protected microservice front door: a WAF_v2 gateway enforcing a referenced Web Application Firewall policy, with path-based routing that sends `/api/*` to a dedicated backend..."
type: "preset"
rank: "02"
presetSlug: "02-waf-path-routing"
