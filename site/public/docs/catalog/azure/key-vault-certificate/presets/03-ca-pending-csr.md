...
description: "This preset runs the out-of-band CA flow: the vault generates the private key (which never leaves it -- `exportable: false`), mints a CSR, and holds the operation pending until your CA's signed..."
type: "preset"
rank: "03"
presetSlug: "03-ca-pending-csr"
