...
description: "This preset creates a STANDARD namespace in the production security posture: SAS authentication disabled (Entra-only data plane) and a DENY firewall admitting only named sources."
type: "preset"
rank: "02"
presetSlug: "02-locked-down-keyless"
