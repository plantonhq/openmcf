...
description: "The production posture: a `standard` service with three replicas (the 99.9% read-write SLA floor), Entra RBAC enabled alongside API keys, and a system identity for keyless indexer connections."
type: "preset"
rank: "01"
presetSlug: "01-production-search"
