...
description: "This preset creates a general-purpose Azure Subnet with a /24 CIDR block (254 usable IPs) and common service endpoints for Storage, Key Vault, and SQL. This is the standard subnet configuration for..."
type: "preset"
rank: "01"
