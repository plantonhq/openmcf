...
description: "This preset attaches a Front Door WAF policy to an endpoint's default `*.azurefd.net` hostname -- the association that actually turns the WAF on. Without a security policy, a WAF policy sits idle."
type: "preset"
rank: "01"
presetSlug: "01-endpoint-association"
