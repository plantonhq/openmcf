...
description: "This preset creates an Azure Private Endpoint that connects an Azure SQL Database server to a VNet subnet via Private Link. It includes a DNS zone group registration so that the SQL server's FQDN..."
type: "preset"
rank: "01"
presetSlug: "01-sql-server"
