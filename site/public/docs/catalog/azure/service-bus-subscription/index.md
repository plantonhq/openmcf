...
description: "Service Bus Subscription deployment documentation"
icon: "package"
order: 100
componentName: "azureservicebussubscription"
---
...
- [Azure Service Bus Topic](/docs/catalog/azure/service-bus-topic) -- the parent topic
- [Azure Service Bus Queue](/docs/catalog/azure/service-bus-queue) -- pair with `forwardTo` for fan-out-then-collect routing
