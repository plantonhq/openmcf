...
description: "This preset creates an unfiltered subscription: the consumer receives every message published to the topic (Azure's auto-created `$Default` catch-all rule stays in place). The right starting point..."
type: "preset"
rank: "01"
presetSlug: "01-catch-all-consumer"
