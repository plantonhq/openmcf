...
description: "This preset adds a low-weight origin beside the main backend: same priority, ~5% of traffic. Ramping the canary is a weight change -- an in-place update -- and rolling back is deleting one resource."
type: "preset"
rank: "02"
