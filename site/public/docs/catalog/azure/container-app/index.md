...
- [AzureContainerAppEnvironment](/docs/catalog/azure/container-app-environment) -- provides the hosting environment for the Container App
- [AzureResourceGroup](/docs/catalog/azure/resource-group) -- provides the resource group
- [AzureUserAssignedIdentity](/docs/catalog/azure/user-assigned-identity) -- provides managed identity for Key Vault and ACR access
- [AzureKeyVault](/docs/catalog/azure/key-vault) -- stores secrets referenced by the Container App
- [AzureContainerRegistry](/docs/catalog/azure/container-registry) -- hosts container images for the app
