...
description: "This preset peers **named subnets only** instead of the networks' complete address spaces. Set `peer_complete_virtual_networks_enabled` to false and list the local and remote subnet names included in..."
type: "preset"
rank: "03"
presetSlug: "03-subnet-scoped-peering"
