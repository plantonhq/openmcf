---
title: "Hub to Spoke"
description: "This preset is the **hub-side half** of a hub-and-spoke peering pair. It is written on the hub network and points at one spoke. Connectivity only works once the reciprocal `spoke-to-hub` preset (or..."
type: "preset"
rank: "01"
presetSlug: "01-hub-to-spoke"
