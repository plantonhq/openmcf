...
description: "This preset creates an encryption scope with a Microsoft-managed key -- a distinct encryption boundary inside a shared account with ZERO key management: Azure creates and rotates the key."
type: "preset"
rank: "01"
presetSlug: "01-platform-managed-scope"
