...
description: "This preset creates a route-based VpnGw1 VPN gateway with BGP -- the standard Azure-side anchor for datacenter-to-Azure connectivity. Pair it with an `AzureLocalNetworkGateway` per site and an..."
type: "preset"
rank: "01"
