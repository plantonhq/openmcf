...
description: "This preset deploys a private AKS cluster with no public API server endpoint. The Kubernetes API is accessible only from within the VNet or via peered networks (VPN, ExpressRoute). All other..."
type: "preset"
rank: "02"
