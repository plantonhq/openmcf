...
description: "This preset runs the vault in the legacy access-policy authorization mode: `rbacAuthorizationEnabled: false` with explicit per-principal permission lists carried on the vault itself. ARM stores but..."
type: "preset"
rank: "03"
presetSlug: "03-legacy-access-policy"
