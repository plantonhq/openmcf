...
description: "This preset serves a registered model version from the workspace on one managed instance -- the everyday deployment an MLflow model needs, since the service infers scoring code and environment for..."
type: "preset"
rank: "01"
presetSlug: "01-registered-model-deployment"
