...
description: "This preset registers a Dapr pub/sub component backed by Azure Service Bus topics. Publisher and subscriber apps use Dapr's pub/sub API with the component name (`pubsub`); Dapr manages the topics,..."
type: "preset"
rank: "02"
