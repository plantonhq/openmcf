...
description: "This preset creates a container with a two-level MultiHash partition key (/tenantId, /userId) and a composite index for time-ordered queries -- the shape for tenant data that outgrows a single..."
type: "preset"
rank: "02"
presetSlug: "02-hierarchical-key"
