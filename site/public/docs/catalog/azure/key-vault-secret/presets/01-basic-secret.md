---
title: "Basic Secret"
description: "This preset stores one secret in a Key Vault with the value wired by reference -- the manifest records that the secret exists and where it lives, never what it is. The example wires a storage..."
type: "preset"
rank: "01"
presetSlug: "01-basic-secret"
