...
description: "This preset stores a third-party API key with explicit activation and expiry attributes, making the credential's validity window -- and the rotation it implies -- auditable infrastructure."
type: "preset"
rank: "02"
presetSlug: "02-expiring-api-key"
