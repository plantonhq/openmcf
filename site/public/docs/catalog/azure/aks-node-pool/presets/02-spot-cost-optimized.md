...
description: "This preset creates a cost-optimized AKS user node pool using Azure Spot VMs, which provide 30-90% savings over on-demand pricing. The pool scales to zero when idle and up to 20 nodes under load...."
type: "preset"
rank: "02"
