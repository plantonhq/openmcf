...
description: "This preset creates a database with an autoscale throughput budget that every container inside it SHARES (unless a container brings its own). Azure scales the budget between 10% and 100% of the..."
type: "preset"
rank: "02"
