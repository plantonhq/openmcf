---
title: "Managed Disk"
description: "Managed Disk deployment documentation"
icon: "package"
order: 100
componentName: "azuremanageddisk"
---
...
- [AzureResourceGroup](/docs/catalog/azure/resource-group) -- provides the resource group for disk placement
- [AzureVirtualMachine](/docs/catalog/azure/virtual-machine) -- attaches the disk via `dataDiskAttachments`, owning the LUN and caching mode for each mount
