...
description: "This preset creates a LOCAL-tier circuit: connectivity to the Azure regions in the circuit's own metro only, with NO egress fees. When your facility sits near the Azure region you use, this is the..."
type: "preset"
rank: "02"
presetSlug: "02-local-metro-circuit"
