...
Records are separate resources: declare them with [Azure DNS Record](/docs/catalog/azure/dns-record), one per record set, referencing this zone.
...
- [Azure DNS Record](/docs/catalog/azure/dns-record) -- the record sets declared in the zone
- [Azure Private DNS Zone](/docs/catalog/azure/private-dns-zone) -- name resolution inside virtual networks
- [Azure Front Door Custom Domain](/docs/catalog/azure/front-door-custom-domain) -- watches the zone for its validation records
