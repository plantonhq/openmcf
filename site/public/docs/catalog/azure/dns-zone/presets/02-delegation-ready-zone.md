...
description: "A public zone tuned for active operations: the SOA contact points at your DNS team and the negative-caching TTL is lowered so newly created records (certificate validation records especially) become..."
type: "preset"
rank: "02"
presetSlug: "02-delegation-ready-zone"
