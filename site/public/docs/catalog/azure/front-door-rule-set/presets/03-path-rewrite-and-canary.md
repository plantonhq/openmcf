...
description: "This preset creates a delivery policy that decouples the public URL surface from the backend's real path layout (a rewrite the client never sees) and routes cookie-flagged requests to a canary origin..."
type: "preset"
rank: "03"
presetSlug: "03-path-rewrite-and-canary"
