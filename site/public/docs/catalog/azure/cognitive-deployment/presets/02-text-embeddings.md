...
description: "This preset deploys `text-embedding-3-large` with a pinned upgrade policy -- the shape retrieval and RAG pipelines want: vectors stored today must stay comparable with vectors computed next month, so..."
type: "preset"
rank: "02"
presetSlug: "02-text-embeddings"
