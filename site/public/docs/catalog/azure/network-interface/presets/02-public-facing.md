...
description: "This preset creates a network interface whose primary configuration is fronted by a referenced `AzurePublicIp` and filtered by a NIC-level `AzureNetworkSecurityGroup`. It is the shape for a single..."
type: "preset"
rank: "02"
presetSlug: "02-public-facing"
