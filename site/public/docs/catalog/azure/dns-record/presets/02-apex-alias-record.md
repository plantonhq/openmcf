...
description: "Point the zone apex (your-domain.com itself) at an Azure Public IP with an alias record. Azure keeps the answer in sync with the resource -- when the IP's address changes, the record follows..."
type: "preset"
rank: "02"
presetSlug: "02-apex-alias-record"
