...
description: "This preset describes a resilient branch: two ISPs, each a separate link with its own BGP speaker, and no static prefix list -- the branch advertises its routes. A connection then builds one tunnel..."
type: "preset"
rank: "02"
presetSlug: "02-dual-link-bgp-branch"
