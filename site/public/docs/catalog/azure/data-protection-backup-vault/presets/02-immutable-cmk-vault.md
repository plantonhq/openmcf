...
description: "This preset creates the compliance-grade vault: trial-run immutability, a 30-day soft-delete window, and backup data encrypted with your own Key Vault key. For organizations whose backup posture must..."
type: "preset"
rank: "02"
