...
description: "This preset creates the everyday batch endpoint: the minimal routing object batch deployments attach to, with Microsoft Entra authentication applied by default (the only mode the batch service..."
type: "preset"
rank: "01"
presetSlug: "01-batch-scoring-endpoint"
