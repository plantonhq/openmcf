...
description: "This preset creates a two-region SQL (NoSQL) API account with automatic failover and continuous backup -- the production baseline for document workloads. Databases and containers are deployed as..."
type: "preset"
rank: "01"
...
| --- | --- | --- |
| `myorg-orders-cosmos` | 3-50 lowercase letters/digits/hyphens, unique across all of Azure | Your naming convention |
