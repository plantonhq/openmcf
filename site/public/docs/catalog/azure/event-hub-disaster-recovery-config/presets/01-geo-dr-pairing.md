...
description: "This preset pairs two Event Hubs namespaces across regions under a failover-stable alias: hub/consumer-group/rule metadata continuously replicates to the partner, and clients connected through the..."
type: "preset"
rank: "01"
presetSlug: "01-geo-dr-pairing"
componentSlug: "event-hub-disaster-recovery-config"
componentTitle: "Event Hub Disaster Recovery Config"
provider: "azure"
icon: "package"
order: 1
---
