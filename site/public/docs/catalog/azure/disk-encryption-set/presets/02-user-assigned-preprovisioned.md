...
description: "This preset creates a disk encryption set backed by a user-assigned managed identity. Because the identity exists independently of the set, you grant it Key Vault crypto access BEFORE creating the..."
type: "preset"
rank: "02"
presetSlug: "02-user-assigned-preprovisioned"
