...
description: "This preset mints a full-rights (listen+send+manage) SAS credential over a whole namespace -- for operational tooling that creates and inspects hubs and consumer groups, distinct from the built-in..."
type: "preset"
rank: "02"
