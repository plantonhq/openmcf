...
description: "This preset creates the everyday production vault: geo-redundant backup storage with cross-region restore, Microsoft-managed encryption, all alert switches at their all-on defaults. The right..."
type: "preset"
rank: "01"
