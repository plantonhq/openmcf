...
description: "This preset carries two namespaces on one rule book: the live corporate domain, plus an acquired company's domain PARKED with `enabled: false` until its connectivity is ready -- flipping one field..."
type: "preset"
rank: "02"
presetSlug: "02-staged-multi-domain"
