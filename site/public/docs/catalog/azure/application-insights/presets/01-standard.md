...
description: "This preset creates a workspace-based Application Insights resource for a web application at full telemetry fidelity -- the default APM shape. Its `connection_string` output is what Function Apps,..."
type: "preset"
rank: "01"
