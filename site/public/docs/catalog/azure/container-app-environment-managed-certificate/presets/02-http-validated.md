...
description: "A managed certificate for an apex domain (example.com itself): DNS forbids CNAME at the apex, so the domain routes by A record and Azure proves ownership by serving an HTTP token through it."
type: "preset"
rank: "02"
presetSlug: "02-http-validated"
