...
description: "This preset creates a web test that not only checks for a 200 but also asserts the response body contains an expected healthy payload (for example `\"status\":\"ok\"`). A endpoint can return 200 while..."
type: "preset"
rank: "02"
presetSlug: "02-content-check"
