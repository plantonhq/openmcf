---
title: "Team Foundry Project"
description: "The standard team workspace inside a shared AI Foundry hub: one project per team, with its own system-assigned identity so grants can be scoped per team while everything else (vault, storage,..."
type: "preset"
rank: "01"
presetSlug: "01-team-project"
componentSlug: "ai-foundry-project"
componentTitle: "AI Foundry Project"
provider: "azure"
icon: "package"
order: 1
---
