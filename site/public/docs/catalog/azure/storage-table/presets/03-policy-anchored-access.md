...
description: "This preset creates a table whose external access rides a read-only stored access policy. SAS tokens issued against the policy inherit its window and query-only permissions -- and revoking the policy..."
type: "preset"
rank: "03"
presetSlug: "03-policy-anchored-access"
