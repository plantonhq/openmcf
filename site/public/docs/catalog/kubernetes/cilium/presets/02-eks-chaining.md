...
description: "This preset runs Cilium ON TOP of the AWS VPC CNI on an EKS cluster — CNI chaining, the no-rip-and-replace path. The AWS VPC CNI keeps doing what EKS depends on (IPAM from the VPC, ENI wiring,..."
type: "preset"
rank: "02"
presetSlug: "02-eks-chaining"
