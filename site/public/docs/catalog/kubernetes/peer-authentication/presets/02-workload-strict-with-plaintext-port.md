...
description: "Require mTLS for a single selected workload, while exempting one port that must stay plaintext -- for example a health-check, metrics-scrape, or legacy port that a non-mesh client probes directly."
type: "preset"
rank: "02"
presetSlug: "02-workload-strict-with-plaintext-port"
