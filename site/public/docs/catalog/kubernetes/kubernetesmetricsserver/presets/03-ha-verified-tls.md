...
description: "This preset hardens both availability and trust: two replicas guarded by a PodDisruptionBudget keep the metrics API serving through node drains, and cert-manager issues (and renews) the serving..."
type: "preset"
rank: "03"
presetSlug: "03-ha-verified-tls"
