...
description: "The complete install, which is deliberately tiny: the operator is a lifecycle manager, not the product. It brings the Tekton CRDs and the controller that turns a `TektonConfig` declaration into..."
type: "preset"
rank: "01"
