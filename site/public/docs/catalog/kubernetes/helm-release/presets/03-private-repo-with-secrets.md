...
description: "This preset is the production shape for a chart from a private repository: repository credentials for the pull, `set_sensitive` for a secret chart value, and the two lifecycle knobs (`atomic`,..."
type: "preset"
rank: "03"
presetSlug: "03-private-repo-with-secrets"
