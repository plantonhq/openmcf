...
description: "The fastest declarable RabbitMQ: one node on ephemeral storage (emptyDir — no PVC, no StorageClass involved), 1Gi of memory with requests equal to limits, and a 60-second termination grace period in..."
type: "preset"
rank: "01"
