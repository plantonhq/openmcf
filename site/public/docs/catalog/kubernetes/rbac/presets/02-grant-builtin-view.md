...
description: "This preset binds the Kubernetes built-in `view` ClusterRole to a group, confined to one namespace. No role is created — only a RoleBinding — giving everyone in the group read-only access to most..."
type: "preset"
rank: "02"
presetSlug: "02-grant-builtin-view"
componentSlug: "rbac"
componentTitle: "RBAC"
provider: "kubernetes"
icon: "package"
