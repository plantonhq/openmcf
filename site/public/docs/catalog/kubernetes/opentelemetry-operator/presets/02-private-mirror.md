...
description: "The air-gapped posture: both image seams mirrored, because they are DIFFERENT seams. `imageRegistry` replaces only the registry part of the operator's own manager image (the path stays the upstream..."
type: "preset"
rank: "02"
presetSlug: "02-private-mirror"
