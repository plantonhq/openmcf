...
description: "The standard operator install: the pinned chart (0.120.0 = operator v0.156.0) into its own `otel-operator` namespace, watching every namespace on the cluster. Nothing else is set — the chart creates..."
type: "preset"
rank: "01"
