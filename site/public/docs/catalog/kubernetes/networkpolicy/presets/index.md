---
title: "Presets"
description: "Ready-to-deploy configuration presets for NetworkPolicy"
type: "preset-list"
...
Ready-to-deploy configuration presets for NetworkPolicy. Each preset is a complete manifest you can copy, customize, and deploy.
