...
description: "This preset allows all pods in the namespace to resolve DNS: egress on UDP and TCP port 53 to the cluster DNS pods in `kube-system`. It is the mandatory companion to any deny-all-egress posture — a..."
type: "preset"
rank: "04"
presetSlug: "04-allow-dns-egress"
