...
description: "An organization-wide fleet that can build containers: dind mode runs a privileged Docker daemon beside every runner, so `docker build`, `docker run` and container-based actions work exactly as they..."
type: "preset"
rank: "02"
presetSlug: "02-org-docker-builds"
