...
description: "This preset declares a machine template for organizations that build their own node AMIs: the image is resolved from an SSM parameter your pipeline maintains, so AMI rollout is controlled by the..."
type: "preset"
rank: "03"
presetSlug: "03-custom-ami-pipeline"
