...
description: "One Loki serving several teams with isolation: every push and query carries an `X-Scope-OrgID` tenant header, and the gateway enforces HTTP basic auth per tenant. Passwords are supplied as bcrypt..."
type: "preset"
rank: "03"
presetSlug: "03-multitenant"
componentSlug: "loki"
componentTitle: "Loki"
provider: "kubernetes"
icon: "package"
