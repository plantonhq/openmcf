...
description: "The smallest useful Argo Workflows: the engine, the UI, and a runner identity — submit a Workflow CR (or use the UI over a port-forward; the command lands in the stack outputs) and it runs. The..."
type: "preset"
rank: "01"
presetSlug: "01-dev-pipelines"
