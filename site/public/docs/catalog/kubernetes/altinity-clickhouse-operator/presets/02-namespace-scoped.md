...
description: "The tenancy posture: an operator that watches exactly one namespace and holds only namespace-scoped Roles instead of cluster-wide RBAC. On a shared cluster this is what lets a team run their own..."
type: "preset"
rank: "02"
presetSlug: "02-namespace-scoped"
