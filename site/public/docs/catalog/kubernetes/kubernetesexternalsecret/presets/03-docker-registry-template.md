...
description: "This preset syncs registry credentials from the backend and TEMPLATES them into a `kubernetes.io/dockerconfigjson` Secret — the shape `imagePullSecrets` expects. The synced `username`/`password` keys..."
type: "preset"
rank: "03"
presetSlug: "03-docker-registry-template"
