...
description: "OpenBao with zero ceremony: dev mode auto-initializes and auto-unseals at startup, the root token is literally `root`, and all data lives in memory. Port-forward the `openbao-dev` Service and start..."
type: "preset"
rank: "01"
