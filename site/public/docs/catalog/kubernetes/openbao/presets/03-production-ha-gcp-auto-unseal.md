...
description: "The production-ha shape with the restart toil removed: the master key is wrapped by a Cloud KMS crypto key, so every server unseals ITSELF at startup — pod restarts, node replacements and scale..."
type: "preset"
rank: "03"
presetSlug: "03-production-ha-gcp-auto-unseal"
