...
description: "Attach a team-owned HTTPS listener to a centrally managed Gateway without editing the Gateway itself. The platform team owns the Gateway (address, load balancer, GatewayClass); each application team..."
type: "preset"
rank: "01"
presetSlug: "01-team-https-listeners"
