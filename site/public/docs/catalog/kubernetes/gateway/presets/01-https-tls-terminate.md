...
description: "A single HTTPS listener that terminates TLS at the Gateway using a certificate stored in a Kubernetes Secret (typically created by a cert-manager `KubernetesCertificate`). This is the most common..."
type: "preset"
rank: "01"
presetSlug: "01-https-tls-terminate"
