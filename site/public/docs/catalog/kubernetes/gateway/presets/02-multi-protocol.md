...
description: "A single Gateway exposing three listeners on distinct ports: cleartext HTTP (often used to redirect to HTTPS), HTTPS with TLS termination, and a raw TCP listener for a non-HTTP workload such as a..."
type: "preset"
rank: "02"
presetSlug: "02-multi-protocol"
