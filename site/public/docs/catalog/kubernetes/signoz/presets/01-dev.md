...
description: "The smallest honest SigNoz: the component's defaults against a composed `KubernetesClickHouse` named `telemetry` in the same namespace — the whole platform (UI, API, alerting, the ingestion..."
type: "preset"
rank: "01"
presetSlug: "01-dev"
