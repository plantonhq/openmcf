...
description: "A production-shaped single-cluster observability platform: replicated ClickHouse (one shard, two replicas over a 3-node ZooKeeper quorum), autoscaled ingestion, alert emails over authenticated SMTP,..."
type: "preset"
rank: "02"
presetSlug: "02-production-bundled"
