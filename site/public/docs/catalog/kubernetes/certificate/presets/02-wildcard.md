...
description: "This preset creates a wildcard certificate (`*.example.com`) via a ClusterIssuer. Wildcard certificates cover all subdomains under a domain, reducing the number of certificates needed for..."
type: "preset"
rank: "02"
presetSlug: "02-wildcard"
