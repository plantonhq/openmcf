...
description: "A production single server: credentials referenced from a pre-existing Secret (never declared in the manifest), an explicit heap/page-cache memory split sized to the container, a 100Gi data volume on..."
type: "preset"
rank: "02"
