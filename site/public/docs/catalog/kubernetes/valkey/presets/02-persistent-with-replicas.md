...
description: "This preset deploys a primary plus two replicas (Redis-compatible) with per-pod append-only persistence, write safety, a dedicated read Service, a PodDisruptionBudget, and ACL authentication. Read..."
type: "preset"
rank: "02"
