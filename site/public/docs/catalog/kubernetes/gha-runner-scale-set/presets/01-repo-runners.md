...
description: "Self-hosted runners for one repository, scaled to zero when idle: a queued job creates an ephemeral runner pod, the pod runs exactly that job and is replaced. Workflows target the fleet by NAME —..."
type: "preset"
rank: "01"
presetSlug: "01-repo-runners"
