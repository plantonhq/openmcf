...
description: "This preset creates the namespace-wide security baseline: it denies ALL inbound and outbound traffic for every pod in the namespace. NetworkPolicies are additive allows with no deny rule, so \"deny..."
type: "preset"
rank: "01"
presetSlug: "01-default-deny-all"
