...
description: "A quorum-safe application cluster with exactly one credential story: a single SCRAM-SHA-512-over-TLS listener plus simple ACL authorization. Every client — including the admin — is a..."
type: "preset"
rank: "04"
presetSlug: "04-scram-app-cluster"
componentSlug: "kafka"
