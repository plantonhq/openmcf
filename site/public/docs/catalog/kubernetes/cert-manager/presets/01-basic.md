...
description: "This preset installs cert-manager with default settings. No workload identity is configured -- suitable for clusters where ClusterIssuers will use Cloudflare (API token secrets) or where workload..."
type: "preset"
rank: "01"
presetSlug: "01-basic"
