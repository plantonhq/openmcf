...
description: "An operator fenced to a single namespace with namespace-scoped RBAC: `watch_namespace` limits what it reconciles, `use_role_bindings` swaps ClusterRoleBindings for RoleBindings in the watched..."
type: "preset"
rank: "02"
