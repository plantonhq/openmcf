...
description: "The smallest honest Harbor: the chart's in-cluster PostgreSQL and Redis (single-node, evaluation-grade by upstream's own position), artifact blobs on a 20Gi PersistentVolumeClaim, Trivy scanning on..."
type: "preset"
rank: "01"
