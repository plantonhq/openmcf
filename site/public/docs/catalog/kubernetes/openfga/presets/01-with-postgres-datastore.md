...
description: "The production OpenFGA shape: three stateless server replicas sharing a PostgreSQL datastore, schema migrations running as an init container in every pod (idempotent — `openfga migrate` gates each..."
type: "preset"
rank: "01"
