...
description: "Zalando Postgres Operator deployment documentation"
icon: "package"
order: 100
...
- [KubernetesPostgres](/docs/catalog/kubernetes/postgres) — deploys PostgreSQL instances that can be managed by the Zalando Operator installed by this component
