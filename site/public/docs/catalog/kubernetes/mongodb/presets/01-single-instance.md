...
description: "This preset declares the smallest useful MongoDB cluster: one replica set (`rs0`) with a single member, small storage, no backups. It is a single point of failure by construction — the development..."
type: "preset"
rank: "01"
