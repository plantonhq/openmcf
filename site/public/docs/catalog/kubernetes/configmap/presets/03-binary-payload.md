...
description: "This preset creates a ConfigMap that carries a binary entry (`binaryData`, base64-encoded) alongside a regular text entry (`data`). Binary entries are for payloads that are not valid UTF-8 — icons,..."
type: "preset"
rank: "03"
presetSlug: "03-binary-payload"
