...
description: "This preset installs the KEDA engine cluster-wide with the upstream defaults: the operator, the external-metrics API server, and the admission webhooks in a dedicated `keda` namespace, watching..."
type: "preset"
rank: "01"
