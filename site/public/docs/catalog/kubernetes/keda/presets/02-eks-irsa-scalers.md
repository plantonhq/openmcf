...
description: "This preset installs KEDA on an EKS cluster with IAM Roles for Service Accounts (IRSA) wired for the scalers: KEDA's own service account is annotated with an IAM role, so scalers that read AWS metric..."
type: "preset"
rank: "02"
