---
title: "HA Production"
description: "This preset hardens KEDA for clusters where autoscaling is load-bearing: two replicas of every component (warm standbys — KEDA leader-elects, so extra replicas buy failover speed, not throughput),..."
type: "preset"
rank: "03"
