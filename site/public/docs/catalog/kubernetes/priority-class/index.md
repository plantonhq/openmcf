...
description: "Priority Class deployment documentation"
icon: "package"
order: 100
componentName: "kubernetespriorityclass"
---
...
- [KubernetesDeployment](/docs/catalog/kubernetes/deployment) — workload whose pod spec references the class via `priority_class_name`
- [KubernetesResourceQuota](/docs/catalog/kubernetes/resource-quota) — budgets pods of specific priority classes with its `priority_class` scope selector
- [KubernetesNamespace](/docs/catalog/kubernetes/namespace) — namespace-level governance that composes with cluster-level priority tiers
