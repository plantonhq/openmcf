...
description: "This preset declares no host or path rules at all — just a `default_backend`. Every request the controller routes to this Ingress, regardless of hostname or path, goes to one Service. It is the..."
type: "preset"
rank: "04"
presetSlug: "04-default-backend"
