...
description: "The air-gapped posture for the operator: `imageRegistry` replaces only the registry part of the operator's own image (the path stays the upstream `kuberay/operator`; the default registry is quay.io)..."
type: "preset"
rank: "02"
