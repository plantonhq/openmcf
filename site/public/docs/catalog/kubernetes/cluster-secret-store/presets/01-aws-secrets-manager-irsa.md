...
description: "This preset creates a cluster-wide store connected to AWS Secrets Manager, authenticating through a referenced ServiceAccount whose IRSA (IAM Roles for Service Accounts) binding authorizes the reads...."
type: "preset"
rank: "01"
presetSlug: "01-aws-secrets-manager-irsa"
componentSlug: "cluster-secret-store"
componentTitle: "Cluster Secret Store"
provider: "kubernetes"
icon: "package"
order: 1
---
