...
description: "The most common TCPRoute: forward all connections arriving on a Gateway's TCP listener to a backend Service. A TCP route has no matching -- the listener's port selects the traffic, and the route..."
type: "preset"
rank: "01"
presetSlug: "01-tcp-port-forward"
