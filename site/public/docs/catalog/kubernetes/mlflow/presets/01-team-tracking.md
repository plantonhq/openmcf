...
description: "The one-manifest MLflow: experiments, runs, metrics and the model registry on a sqlite volume, artifacts on a second volume served through the tracking server itself — nothing else to operate, and..."
type: "preset"
rank: "01"
presetSlug: "01-team-tracking"
