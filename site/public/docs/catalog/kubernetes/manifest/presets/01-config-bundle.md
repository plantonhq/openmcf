---
title: "Config Bundle"
description: "This preset applies a multi-document manifest — a ConfigMap and a Secret — anchored in a single namespace. Neither document declares its own `metadata.namespace`, so both land in the anchor namespace..."
type: "preset"
rank: "01"
presetSlug: "01-config-bundle"
