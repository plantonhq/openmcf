...
description: "The standard operator install: the pinned version (1.15.0, the signed Apache per-version chart channel) into its own `flink-system` namespace, watching every namespace, the admission webhook ON."
type: "preset"
rank: "01"
