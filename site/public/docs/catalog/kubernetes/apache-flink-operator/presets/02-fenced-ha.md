...
description: "The multi-tenant, standby-backed posture: the operator watches ONLY the listed namespaces — the chart scopes its RBAC AND the admission webhook's namespaceSelector to exactly this list, so Flink..."
type: "preset"
rank: "02"
presetSlug: "02-fenced-ha"
