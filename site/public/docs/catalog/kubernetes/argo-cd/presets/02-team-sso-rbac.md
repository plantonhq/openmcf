...
description: "Argo CD the way a team should meet it: logins through the organization's identity provider, authorization through Argo CD's own RBAC (read-only by default, admin for the platform group), and the..."
type: "preset"
rank: "02"
presetSlug: "02-team-sso-rbac"
