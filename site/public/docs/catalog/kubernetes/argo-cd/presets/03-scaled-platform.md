...
description: "Argo CD sized for a real platform team: the API server and repo server on autoscalers (the repo server is what saturates first — every sync renders manifests there), the application controller given..."
type: "preset"
rank: "03"
presetSlug: "03-scaled-platform"
