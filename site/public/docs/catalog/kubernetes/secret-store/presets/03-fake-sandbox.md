...
description: "This preset creates a namespaced store backed by ESO's built-in fake backend: the store serves the literal key/value entries declared in the spec — no external account, no network, fully..."
type: "preset"
rank: "03"
presetSlug: "03-fake-sandbox"
