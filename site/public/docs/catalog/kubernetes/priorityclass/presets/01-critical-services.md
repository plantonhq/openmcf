...
description: "This preset creates the top rung of the user-definable importance ladder: value 1,000,000 with preemption enabled. Pods that reference this class (via the workload pod spec's `priority_class_name`)..."
type: "preset"
rank: "01"
presetSlug: "01-critical-services"
