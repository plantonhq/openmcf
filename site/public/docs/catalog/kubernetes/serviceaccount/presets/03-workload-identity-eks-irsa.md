...
description: "This preset creates a ServiceAccount bound to an AWS IAM role via IRSA. Pods running as this identity call AWS APIs keylessly — the AWS SDK inside the pod exchanges the projected ServiceAccount token..."
type: "preset"
rank: "03"
presetSlug: "03-workload-identity-eks-irsa"
