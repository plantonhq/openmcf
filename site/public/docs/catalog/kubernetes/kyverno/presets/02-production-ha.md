...
description: "Kyverno sized for a cluster where admission availability matters. The admission controller runs three replicas — it sits on the cluster's WRITE PATH, and with the default fail-closed policy posture..."
type: "preset"
rank: "02"
