...
description: "The smallest declarable Kyverno: the chart defaults end to end. All four controllers run single-replica, the engine generates and rotates its own webhook certificates (no prerequisites), the policy..."
type: "preset"
rank: "01"
presetSlug: "01-dev-cluster"
