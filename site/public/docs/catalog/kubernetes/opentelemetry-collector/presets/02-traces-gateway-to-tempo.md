...
description: "The gateway shape for traces: a two-replica deployment applications push OTLP spans to (gRPC on 4317, HTTP on 4318 — the exported `otlp_grpc_endpoint`/`otlp_http_endpoint` outputs are what they point..."
type: "preset"
rank: "02"
presetSlug: "02-traces-gateway-to-tempo"
