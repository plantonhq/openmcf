...
description: "Registers a whole wildcard domain (`*.example-saas.com`) in the mesh's service registry with `DYNAMIC_DNS` resolution: the proxy resolves the ACTUAL hostname each request asks for, at request time —..."
type: "preset"
rank: "03"
presetSlug: "03-dynamic-dns-wildcard-egress"
