...
description: "The production posture: two Grafana replicas behind one Service with ALL state — dashboards, users, sessions, preferences — in an external Postgres. Any pod can die, be drained or be upgraded and..."
type: "preset"
rank: "03"
presetSlug: "03-ha-external-db"
