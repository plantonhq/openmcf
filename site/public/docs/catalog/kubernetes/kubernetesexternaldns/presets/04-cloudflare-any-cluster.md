...
description: "This preset installs ExternalDNS publishing to Cloudflare — the canonical cross-cloud arm. Cloudflare has no workload-identity federation with Kubernetes clusters, so authentication is always an API..."
type: "preset"
rank: "04"
presetSlug: "04-cloudflare-any-cluster"
