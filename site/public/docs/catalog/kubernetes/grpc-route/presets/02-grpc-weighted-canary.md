...
description: "Split gRPC traffic for a service across two backends by weight -- the standard progressive-delivery pattern. Here 90% of calls go to the stable backend and 10% to the canary; adjust the weights to..."
type: "preset"
rank: "02"
presetSlug: "02-grpc-weighted-canary"
