...
description: "The recommended production grain: one APPLICATION cluster per pipeline — the cluster exists to run this one job and follows its lifecycle, with a custom image that BAKES the job jar (`local:///`..."
type: "preset"
rank: "01"
presetSlug: "01-application-stateless"
