...
description: "A production-shaped change-data-capture source: the Debezium Postgres connector streams row-level changes from a Postgres database into Kafka topics (`orders.public.orders`, ...), using Postgres's..."
type: "preset"
rank: "02"
presetSlug: "02-debezium-postgres-cdc"
