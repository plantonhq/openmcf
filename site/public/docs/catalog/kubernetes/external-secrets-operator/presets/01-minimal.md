...
description: "This preset installs the External Secrets Operator with chart defaults: one controller replica, CRDs installed with the release and kept on uninstall, webhook and cert-controller enabled. No ambient..."
type: "preset"
rank: "01"
