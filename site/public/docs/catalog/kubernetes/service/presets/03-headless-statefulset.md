...
description: "This preset creates a headless service (`clusterIP: None`): no virtual IP is allocated and DNS returns the pod IPs directly, with each pod also getting its own stable name..."
type: "preset"
rank: "03"
presetSlug: "03-headless-statefulset"
