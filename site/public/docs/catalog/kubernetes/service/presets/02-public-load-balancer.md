...
description: "This preset asks the cloud provider to provision an external load balancer in front of the selected pods. Once deployed, the provider's address lands in the stack outputs — `load_balancer_ip` on..."
type: "preset"
rank: "02"
presetSlug: "02-public-load-balancer"
