...
description: "The smallest useful Airflow 3: API server (UI + REST API), scheduler, DAG processor and triggerer against a composed KubernetesPostgres named `airflow-db` in the same Kubernetes namespace, running..."
type: "preset"
rank: "01"
presetSlug: "01-dev-kubernetes-executor"
