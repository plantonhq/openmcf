...
description: "The production shape: a Celery worker fleet that KEDA scales on real queue depth (polling the metadata database for queued tasks — and back to ZERO between runs), DAGs synced from your Git repository..."
type: "preset"
rank: "02"
presetSlug: "02-production-celery"
