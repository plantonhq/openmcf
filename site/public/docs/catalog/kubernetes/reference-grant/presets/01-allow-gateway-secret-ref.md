...
description: "The most common ReferenceGrant: a Gateway terminates TLS using a certificate Secret that lives in a different namespace (typically the cert-manager namespace). By default that cross-namespace..."
type: "preset"
rank: "01"
presetSlug: "01-allow-gateway-secret-ref"
