...
description: "This preset signs certificates through a HashiCorp Vault (or OpenBao) PKI secrets engine using the Kubernetes auth method — the keyless path: Vault validates a ServiceAccount token instead of holding..."
type: "preset"
rank: "04"
presetSlug: "04-vault"
