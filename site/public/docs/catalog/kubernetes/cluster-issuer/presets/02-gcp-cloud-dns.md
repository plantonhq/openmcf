...
description: "This preset creates a ClusterIssuer that uses Google Cloud DNS for ACME DNS-01 certificate challenges. Authentication uses GKE Workload Identity, so no service account keys are stored in the cluster...."
type: "preset"
rank: "02"
