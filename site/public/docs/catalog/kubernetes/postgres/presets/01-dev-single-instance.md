...
description: "This preset declares the smallest useful PostgreSQL cluster: one instance, small storage, a fresh `app` database with an operator-generated password, no backups. It is a single point of failure by..."
type: "preset"
rank: "01"
