...
description: "A production Qdrant: 3 nodes (the quorum posture — Raft survives one member loss), generated read-write and read-only API keys living in the chart-owned Secret (never in a manifest), 8Gi of memory..."
type: "preset"
rank: "02"
