...
description: "A single-node Qdrant sized for a typical RAG corpus: 8Gi of memory (the real capacity bound — Qdrant serves from RAM-resident segments and HNSW indexes; 8Gi holds an embedding set in the..."
type: "preset"
rank: "03"
presetSlug: "03-rag-workload"
