...
description: "This preset installs Velero against an S3-COMPATIBLE object store — an in-cluster MinIO by default — with no cloud account involved anywhere: the store is reached by endpoint URL with path-style..."
type: "preset"
rank: "03"
presetSlug: "03-minio-self-contained"
