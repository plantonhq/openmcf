---
title: "Presets"
description: "Ready-to-deploy configuration presets for GitHub Actions Runner Scale Set Controller"
type: "preset-list"
...
# GitHub Actions Runner Scale Set Controller Presets

Ready-to-deploy configuration presets for GitHub Actions Runner Scale Set Controller. Each preset is a complete manifest you can copy, customize, and deploy.
