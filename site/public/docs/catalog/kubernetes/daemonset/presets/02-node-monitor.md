---
title: "Node Monitor"
description: "This preset deploys a node-metrics agent (the node-exporter shape) that observes the node itself: it joins the node's network and PID namespaces, reads `/proc` and `/sys` through read-only HostPath..."
type: "preset"
rank: "02"
presetSlug: "02-node-monitor"
