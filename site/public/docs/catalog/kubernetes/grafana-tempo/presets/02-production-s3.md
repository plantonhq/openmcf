...
description: "Trace blocks in an S3-compatible object store (an in-cluster KubernetesSeaweedFs here; AWS S3, GCS or Azure by swapping the storage block), with the metrics generator deriving service-graph and span..."
type: "preset"
rank: "02"
presetSlug: "02-production-s3"
