...
description: "Temporal sized for real workloads on the composed-PostgreSQL story: replicated frontend/matching/worker, three history replicas (shard ownership redistributes across them — history is where workflow..."
type: "preset"
rank: "02"
