...
description: "Validate JWTs for a single selected workload, extract the token from a custom header, restrict it to a specific audience, and forward a verified claim to the backend as an HTTP header the application..."
type: "preset"
rank: "02"
presetSlug: "02-workload-jwt-with-claim-headers"
