...
description: "For Enterprise accounts that upload their own certificate and key for the custom hostname instead of using a Cloudflare-issued DV certificate, and route it to a specific origin."
type: "preset"
rank: "02"
presetSlug: "02-byo-certificate"
