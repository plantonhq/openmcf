...
description: "A self-hosted web app behind Cloudflare Access, protecting `dashboard.example.com` with a referenced Access policy and a 24-hour session."
type: "preset"
rank: "01"
presetSlug: "01-self-hosted-web-app"
