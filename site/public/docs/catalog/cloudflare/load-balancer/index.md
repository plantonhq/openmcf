...
- [CloudflareLoadBalancerPool](/docs/catalog/cloudflare/load-balancer-pool) — the pools this load balancer references
- [CloudflareLoadBalancerMonitor](/docs/catalog/cloudflare/load-balancer-monitor) — health checks the pools use
- [CloudflareDnsZone](/docs/catalog/cloudflare/dns-zone) — provides `zoneId`
