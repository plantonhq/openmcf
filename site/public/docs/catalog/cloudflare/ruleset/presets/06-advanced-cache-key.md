...
description: "Take full control of the cache key with the `http_request_cache_settings` phase: include only the query parameters, cookies, headers, and user attributes that should vary the cached object, and..."
type: "preset"
rank: "06"
