...
description: "Enable Cloudflare's managed WAF rulesets to protect against common web attacks including XSS, SQL injection, and OWASP Top 10 vulnerabilities."
type: "preset"
rank: "02"
