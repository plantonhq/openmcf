---
title: "Queue"
description: "Queue deployment documentation"
icon: "package"
order: 100
componentName: "ociqueue"
---
...
- [OciKmsKey](/docs/catalog/oci/kms-key) — provides the encryption key referenced by `customEncryptionKeyId` via `valueFrom`
- [OciAlarm](/docs/catalog/oci/alarm) — monitors queue metrics (queue depth, message age) via MQL
- [OciLogGroup](/docs/catalog/oci/log-group) — collects queue service logs
