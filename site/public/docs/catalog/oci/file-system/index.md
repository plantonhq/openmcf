...
- [OciSubnet](/docs/catalog/oci/subnet) — provides the subnet for the mount target via `valueFrom`
- [OciSecurityGroup](/docs/catalog/oci/network-security-group) — controls NFS traffic to the mount target via `nsgIds`
