---
title: "VCN"
description: "VCN deployment documentation"
icon: "package"
order: 100
componentName: "ocivcn"
---
...
- [OciSubnet](/docs/catalog/oci/subnet) — creates subnets within this VCN, with route table attachments for gateway routing
- [OciSecurityGroup](/docs/catalog/oci/network-security-group) — manages network security rules for resources attached to this VCN
