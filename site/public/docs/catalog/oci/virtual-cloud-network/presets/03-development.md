...
description: "This preset creates a minimal-cost VCN with only an Internet Gateway. NAT Gateway and Service Gateway are omitted to avoid their hourly charges. This is the simplest VCN configuration, suitable for..."
type: "preset"
rank: "03"
