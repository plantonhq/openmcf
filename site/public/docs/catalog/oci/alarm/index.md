---
title: "Alarm"
description: "Alarm deployment documentation"
icon: "package"
order: 100
componentName: "ocialarm"
---
...
- [OciCompartment](/docs/catalog/oci/compartment) — provides compartments referenced by `compartmentId` and `metricCompartmentId` via `valueFrom`
- [OciQueue](/docs/catalog/oci/queue) — queue metrics (depth, message age) are common alarm targets
- [OciAutonomousDatabase](/docs/catalog/oci/autonomous-database) — database metrics are common alarm targets
- [OciComputeInstance](/docs/catalog/oci/compute-instance) — compute metrics (CPU, memory, disk) are common alarm targets
