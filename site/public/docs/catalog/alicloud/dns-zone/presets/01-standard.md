...
description: "This preset registers a domain in Alibaba Cloud DNS (Alidns) with only the required fields. After deployment, point your domain registrar's NS records to the DNS servers returned in the stack outputs."
type: "preset"
rank: "01"
