...
description: "This preset creates a minimal ACK Managed Kubernetes cluster for development and testing. It uses the free ack.standard tier with Flannel overlay networking, two availability zones, and only the..."
type: "preset"
rank: "02"
presetSlug: "02-development-flannel"
