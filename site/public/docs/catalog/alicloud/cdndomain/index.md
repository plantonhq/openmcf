---
title: "CdnDomain"
description: "CdnDomain deployment documentation"
icon: "package"
order: 100
componentName: "alicloudcdndomain"
---
...
- [AliCloudDnsRecord](/docs/catalog/alicloud/dns-record) -- create the CNAME record pointing to the `cname` output
- [AliCloudStorageBucket](/docs/catalog/alicloud/oss-bucket) -- OSS bucket to use as an origin source
