...
description: "KubernetesCluster deployment documentation"
icon: "package"
order: 100
componentName: "alicloudkubernetescluster"
---
...
- [AliCloudVpc](/docs/catalog/alicloud/vpc) — provides the VPC for cluster networking
- [AliCloudVswitch](/docs/catalog/alicloud/vswitch) — provides VSwitches for node and pod placement
- [AliCloudSecurityGroup](/docs/catalog/alicloud/security-group) — controls inbound and outbound traffic for cluster nodes
- [AliCloudNatGateway](/docs/catalog/alicloud/nat-gateway) — provides outbound internet access for nodes in private VSwitches
- [AliCloudKmsKey](/docs/catalog/alicloud/kms-key) — provides the encryption key for Kubernetes Secrets at rest
- [AliCloudLogProject](/docs/catalog/alicloud/log-project) — provides the SLS project for control plane and audit logs
- [AliCloudKubernetesNodePool](/docs/catalog/alicloud/kubernetesnodepool) — manages worker node pools within this cluster
