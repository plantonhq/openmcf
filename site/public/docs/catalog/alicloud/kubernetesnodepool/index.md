...
description: "KubernetesNodePool deployment documentation"
icon: "package"
order: 100
...
- [AliCloudKubernetesCluster](/docs/catalog/alicloud/kubernetescluster) — the parent cluster that this node pool belongs to
- [AliCloudVswitch](/docs/catalog/alicloud/vswitch) — provides VSwitches for worker node placement
- [AliCloudSecurityGroup](/docs/catalog/alicloud/security-group) — controls network access for worker nodes
