---
title: "OSS Bucket"
description: "OSS Bucket deployment documentation"
icon: "package"
order: 100
...
- [AliCloudKmsKey](/docs/catalog/alicloud/kms-key) -- for customer-managed encryption keys when using KMS server-side encryption
- [AliCloudFcFunction](/docs/catalog/alicloud/alicloudfcfunction) -- uses OSS for function code storage
- [AliCloudCdnDomain](/docs/catalog/alicloud/cdndomain) -- uses OSS as an origin for CDN acceleration
