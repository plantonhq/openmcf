---
title: "Presets"
description: "Ready-to-deploy configuration presets for Droplet/VM"
type: "preset-list"
...
Ready-to-deploy configuration presets for Droplet/VM. Each preset is a complete manifest you can copy, customize, and deploy.
