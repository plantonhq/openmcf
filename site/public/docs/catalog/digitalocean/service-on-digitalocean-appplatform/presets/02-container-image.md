...
description: "This preset deploys a web service on DigitalOcean App Platform from a pre-built container image stored in DigitalOcean Container Registry (DOCR). It uses a professional-tier instance with..."
type: "preset"
rank: "02"
presetSlug: "02-container-image"
