...
This extends to all 360+ components across 17 providers in the [Component Catalog](../catalog). Whether you are deploying a Kubernetes PostgreSQL database, an AWS VPC, a GCP Cloud SQL instance, or a Cloudflare DNS zone, the workflow is the same: write a manifest, plan, apply.
...
- [Components](../concepts/components) — how components are structured with protobuf APIs and dual IaC modules
