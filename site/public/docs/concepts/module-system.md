...
```
{workspace}/catalog/{provider}/{kind}/iac/{engine}/
```
...
~/.planton/pulumi/staging-workspaces/my-org-my-project-prod/
  catalog/kubernetes/kubernetespostgres/iac/pulumi/
```
...
cd ~/my-planton-fork/catalog/kubernetes/kubernetespostgres/iac/pulumi/
