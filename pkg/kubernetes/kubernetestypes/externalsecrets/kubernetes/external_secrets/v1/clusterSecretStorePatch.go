...
func NewClusterSecretStorePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1:ClusterSecretStorePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterSecretStorePatch(ctx *pulumi.Context,
	...
	var resource ClusterSecretStorePatch
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1:ClusterSecretStorePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
