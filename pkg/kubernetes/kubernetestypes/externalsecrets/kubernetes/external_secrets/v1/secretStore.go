...
func NewSecretStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1:SecretStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretStore(ctx *pulumi.Context,
	...
	var resource SecretStore
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1:SecretStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
