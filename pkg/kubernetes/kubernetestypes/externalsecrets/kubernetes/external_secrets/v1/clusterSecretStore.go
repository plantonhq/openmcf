...
func NewClusterSecretStore(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1:ClusterSecretStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterSecretStore(ctx *pulumi.Context,
	...
	var resource ClusterSecretStore
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1:ClusterSecretStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
