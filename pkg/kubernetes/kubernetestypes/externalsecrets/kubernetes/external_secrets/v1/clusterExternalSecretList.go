...
func NewClusterExternalSecretList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1:ClusterExternalSecretList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterExternalSecretList(ctx *pulumi.Context,
	...
	var resource ClusterExternalSecretList
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1:ClusterExternalSecretList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
