...
func NewSecretStorePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1:SecretStorePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretStorePatch(ctx *pulumi.Context,
	...
	var resource SecretStorePatch
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1:SecretStorePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
