...
func NewExternalSecret(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1:ExternalSecret", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExternalSecret(ctx *pulumi.Context,
	...
	var resource ExternalSecret
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1:ExternalSecret", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
