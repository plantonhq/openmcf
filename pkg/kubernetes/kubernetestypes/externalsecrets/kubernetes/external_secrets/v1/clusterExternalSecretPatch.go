...
func NewClusterExternalSecretPatch(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("external-secrets.io/v1")
	args.Kind = pulumi.StringPtr("ClusterExternalSecret")
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:external-secrets.io/v1beta1:ClusterExternalSecretPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ClusterExternalSecretPatch
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1:ClusterExternalSecretPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterExternalSecretPatch(ctx *pulumi.Context,
	...
	var resource ClusterExternalSecretPatch
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1:ClusterExternalSecretPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
