...
type TelemetrySpecTracing struct {
	...
	DisableContextPropagation *bool `pulumi:"disableContextPropagation"`
...
type TelemetrySpecTracingArgs struct {
	...
	// Controls whether trace context headers (e.g., `traceparent`/`tracestate` for W3C, `X-B3-*` for Zipkin) are propagated in forwarded requests.
	DisableContextPropagation pulumi.BoolPtrInput `pulumi:"disableContextPropagation"`
	// Controls span reporting.
...
// Controls whether trace context headers (e.g., `traceparent`/`tracestate` for W3C, `X-B3-*` for Zipkin) are propagated in forwarded requests.
func (o TelemetrySpecTracingOutput) DisableContextPropagation() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v TelemetrySpecTracing) *bool { return v.DisableContextPropagation }).(pulumi.BoolPtrOutput)
}
...
// Controls whether trace context headers (e.g., `traceparent`/`tracestate` for W3C, `X-B3-*` for Zipkin) are propagated in forwarded requests.
func (o TelemetrySpecTracingPatchOutput) DisableContextPropagation() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v TelemetrySpecTracingPatch) *bool { return v.DisableContextPropagation }).(pulumi.BoolPtrOutput)
}
