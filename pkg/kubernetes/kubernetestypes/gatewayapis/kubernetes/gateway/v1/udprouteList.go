...
func NewUDPRouteList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:UDPRouteList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUDPRouteList(ctx *pulumi.Context,
	...
	var resource UDPRouteList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:UDPRouteList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
