...
func NewBackendTLSPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha3:BackendTLSPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BackendTLSPolicy
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:BackendTLSPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendTLSPolicy(ctx *pulumi.Context,
	...
	var resource BackendTLSPolicy
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:BackendTLSPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
