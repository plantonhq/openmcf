...
func NewBackendTLSPolicyPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha3:BackendTLSPolicyPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BackendTLSPolicyPatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:BackendTLSPolicyPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendTLSPolicyPatch(ctx *pulumi.Context,
	...
	var resource BackendTLSPolicyPatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:BackendTLSPolicyPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
