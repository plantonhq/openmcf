...
func NewBackendTLSPolicyList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:BackendTLSPolicyList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackendTLSPolicyList(ctx *pulumi.Context,
	...
	var resource BackendTLSPolicyList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:BackendTLSPolicyList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
