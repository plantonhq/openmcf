...
func NewTCPRoutePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha2:TCPRoutePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TCPRoutePatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:TCPRoutePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTCPRoutePatch(ctx *pulumi.Context,
	...
	var resource TCPRoutePatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:TCPRoutePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
