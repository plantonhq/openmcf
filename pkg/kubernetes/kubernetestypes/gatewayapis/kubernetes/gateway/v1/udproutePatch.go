...
func NewUDPRoutePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha2:UDPRoutePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource UDPRoutePatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:UDPRoutePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUDPRoutePatch(ctx *pulumi.Context,
	...
	var resource UDPRoutePatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:UDPRoutePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
