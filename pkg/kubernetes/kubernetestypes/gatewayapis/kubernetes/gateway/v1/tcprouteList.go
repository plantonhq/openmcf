...
func NewTCPRouteList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:TCPRouteList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTCPRouteList(ctx *pulumi.Context,
	...
	var resource TCPRouteList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:TCPRouteList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
