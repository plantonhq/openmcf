...
func NewUDPRoute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha2:UDPRoute"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource UDPRoute
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:UDPRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUDPRoute(ctx *pulumi.Context,
	...
	var resource UDPRoute
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:UDPRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
