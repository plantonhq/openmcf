...
func NewTCPRoute(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1alpha2:TCPRoute"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TCPRoute
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:TCPRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTCPRoute(ctx *pulumi.Context,
	...
	var resource TCPRoute
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:TCPRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
