...
| `service.*` | Service delivery: registration doors, delivery verbs, runs, serving domains, previews, local env vars, kustomize authoring, the offline/GitHub-Actions lane, the delete cascade |
