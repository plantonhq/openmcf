#!/usr/bin/env python3
"""
Deterministic tool: Write the component-root e2e/manifest.yaml for a provider/kind.

Usage (stdin):
  cat manifest.yaml | python3 _rules/deployment-component/_scripts/e2e_manifest_write.py --provider aws --kindfolder awscloudfront --stdin

Usage (file):
  python3 _rules/deployment-component/_scripts/e2e_manifest_write.py --provider aws --kindfolder awscloudfront --content-file /tmp/manifest.yaml
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Write the component's e2e/manifest.yaml deterministically")
