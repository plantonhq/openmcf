#!/usr/bin/env python3
"""
Deterministic tool: Read existing outputs.proto content for a given provider and kind folder.

Usage:
  python3 _rules/deployment-component/_scripts/outputs_reader.py --provider aws --kindfolder awscloudfront
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Read existing outputs.proto for provider/kind")
