...
**Audit** is the diagnostic rule that evaluates components against the ideal state defined in `architecture/component.md`. It generates comprehensive, actionable reports showing exactly what's complete, what's missing, and how to achieve 100% completion.
...
- **Audit Rule:** `_rules/component/audit/audit-planton-component.mdc`
