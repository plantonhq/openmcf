...
The Rename system provides automated, comprehensive renaming of components across the entire Planton codebase. It handles all aspects of a rename: file operations, find-replace patterns, registry updates, documentation changes, and build verification.
...
├── README.md                                 # This file
└── _scripts/
    └── rename_component.py       # Python script (execution)
```
...
Confirmation Summary
      ↓
rename_component.py (Python Script)
      ↓
   [Validate]
      ↓
   [Copy Directory]
...
- **Python Script**: `_scripts/rename_component.py`
