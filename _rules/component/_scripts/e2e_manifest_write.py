...
Usage (stdin):
  cat manifest.yaml | python3 _rules/component/_scripts/e2e_manifest_write.py --provider aws --kindfolder awscloudfront --stdin

Usage (file):
  python3 _rules/component/_scripts/e2e_manifest_write.py --provider aws --kindfolder awscloudfront --content-file /tmp/manifest.yaml
