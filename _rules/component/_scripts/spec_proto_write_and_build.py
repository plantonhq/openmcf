...
Usage examples:
  ...
  cat my_spec.proto | python3 _rules/component/_scripts/spec_proto_write_and_build.py --provider aws --kindfolder awslambda --stdin

  # Or provide a file path
  python3 _rules/component/_scripts/spec_proto_write_and_build.py --provider aws --kindfolder awslambda --content-file /tmp/spec.proto
