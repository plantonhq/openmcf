...
Usage examples:
  # From stdin
  cat spec_test.go | python3 _rules/component/_scripts/spec_tests_write_and_run.py --provider aws --kindfolder awscloudfront --stdin

  # From file
  python3 _rules/component/_scripts/spec_tests_write_and_run.py --provider aws --kindfolder awscloudfront --content-file /tmp/spec_test.go
