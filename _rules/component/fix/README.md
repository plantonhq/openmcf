...
**Fix** is the operation for making targeted improvements to components with automatic propagation to all related artifacts. It ensures that when you fix the source code (proto, IaC), all documentation, examples, and tests are automatically updated to match.
...
- **Ideal State:** `architecture/component.md`
- **Fix Rule:** `_rules/component/fix/fix-planton-component.mdc`
- **Master README:** `_rules/component/README.md`
