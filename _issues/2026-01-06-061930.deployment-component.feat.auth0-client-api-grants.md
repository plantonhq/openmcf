...
Currently, after deploying an Auth0Client via OpenMCF, operators must **manually log into the Auth0 Dashboard** to:
...
In `apis/org/openmcf/provider/auth0/auth0client/v1/iac/pulumi/module/client.go`, add:
...
In `apis/org/openmcf/provider/auth0/auth0client/v1/iac/tf/main.tf`, add:
...
Users must:
- Deploy Auth0Client via OpenMCF
