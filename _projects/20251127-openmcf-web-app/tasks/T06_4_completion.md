...
- `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/iac/pulumi/module/variables.go`
- `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/iac/pulumi/module/helm_chart.go`

### Terraform Implementation
- `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/iac/tf/locals.tf`
- `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/iac/tf/helm_chart.tf`
...
✅ **Production services restored** - Critical infrastructure operational
...
✅ **Easy version updates** - Change once in variables/locals

## Technical Metrics

- **6 files changed** (Pulumi: 2, Terraform: 2, Build: 2)
- **Image upgrade**: Redis 7.0.11 → 8.2.1
- **Repository migration**: `bitnami/redis` → `bitnamilegacy/redis`
- **Debian upgrade**: debian-11 → debian-12
...
### Immediate Benefits
- ✅ All Redis deployments now succeed
- ✅ Production services restored
- ✅ Latest Redis version deployed
- ✅ Consistent image across IaC tools
...
**Location:** `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/iac/`
