...
// 	protoc        (unknown)
// source: dev/planton/provider/civo/civokubernetescluster/v1/spec.proto
...
func (x *CivoKubernetesClusterSpec) Reset() {
	*x = CivoKubernetesClusterSpec{}
	mi := &file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes[0]
...
func (*CivoKubernetesClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoKubernetesClusterDefaultNodePool) Reset() {
	*x = CivoKubernetesClusterDefaultNodePool{}
	mi := &file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoKubernetesClusterDefaultNodePool) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/civo/civokubernetescluster/v1/spec.proto\x122dev.planton.provider.civo.civokubernetescluster.v1\x1a\x1bbuf/validate/validate.proto\x1a&dev/planton/provider/civo/region.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xec\x04\n" +
	...
	"\x11default_node_pool\x18\t \x01(\v2X.dev.planton.provider.civo.civokubernetescluster.v1.CivoKubernetesClusterDefaultNodePoolB\x06\xbaH\x03\xc8\x01\x01R\x0fdefaultNodePool\"m\n" +
	...
	"6com.dev.planton.provider.civo.civokubernetescluster.v1B\tSpecProtoP\x01Zlgithub.com/plantonhq/planton/apis/dev/planton/provider/civo/civokubernetescluster/v1;civokubernetesclusterv1\xa2\x02\x05DPPCC\xaa\x022Dev.Planton.Provider.Civo.Civokubernetescluster.V1\xca\x022Dev\\Planton\\Provider\\Civo\\Civokubernetescluster\\V1\xe2\x02>Dev\\Planton\\Provider\\Civo\\Civokubernetescluster\\V1\\GPBMetadata\xea\x027Dev::Planton::Provider::Civo::Civokubernetescluster::V1b\x06proto3"

var (
	file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_goTypes = []any{
	(*CivoKubernetesClusterSpec)(nil),            // 0: dev.planton.provider.civo.civokubernetescluster.v1.CivoKubernetesClusterSpec
	(*CivoKubernetesClusterDefaultNodePool)(nil), // 1: dev.planton.provider.civo.civokubernetescluster.v1.CivoKubernetesClusterDefaultNodePool
...
var file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.civo.civokubernetescluster.v1.CivoKubernetesClusterSpec.region:type_name -> dev.planton.provider.civo.CivoRegion
	3, // 1: dev.planton.provider.civo.civokubernetescluster.v1.CivoKubernetesClusterSpec.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.civo.civokubernetescluster.v1.CivoKubernetesClusterSpec.default_node_pool:type_name -> dev.planton.provider.civo.civokubernetescluster.v1.CivoKubernetesClusterDefaultNodePool
...
func init() { file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_init() }
func file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_init() {
	if File_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto = out.File
	file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_civo_civokubernetescluster_v1_spec_proto_depIdxs = nil
}
