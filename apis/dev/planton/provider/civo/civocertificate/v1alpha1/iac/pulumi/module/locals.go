...
import (
	civocertificatev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/civo/civocertificate/v1alpha1"
...
type Locals struct {
	...
	CivoCertificate *civocertificatev1alpha1.CivoCertificate
...
func initializeLocals(ctx *pulumi.Context, stackInput *civocertificatev1alpha1.CivoCertificateStackInput) *Locals {
	locals := &Locals{
