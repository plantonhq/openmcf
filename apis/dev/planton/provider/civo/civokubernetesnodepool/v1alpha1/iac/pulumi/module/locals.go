...
import (
	...
	civokubernetesnodepoolv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/civo/civokubernetesnodepool/v1alpha1"
...
type Locals struct {
	...
	CivoKubernetesNodePool *civokubernetesnodepoolv1alpha1.CivoKubernetesNodePool
...
// along easily.
func initializeLocals(_ *pulumi.Context, stackInput *civokubernetesnodepoolv1alpha1.CivoKubernetesNodePoolStackInput) *Locals {
	locals := &Locals{}
