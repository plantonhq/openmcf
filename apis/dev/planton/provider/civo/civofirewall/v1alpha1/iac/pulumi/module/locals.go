...
import (
	...
	civofirewallv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/civo/civofirewall/v1alpha1"
...
type Locals struct {
	...
	CivoFirewall       *civofirewallv1alpha1.CivoFirewall
	CivoLabels         map[string]string
}

// initializeLocals gives us quick access to spec + metadata.
func initializeLocals(_ *pulumi.Context, stackInput *civofirewallv1alpha1.CivoFirewallStackInput) *Locals {
	locals := &Locals{}
