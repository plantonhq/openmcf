...
import (
	...
	civodnsrecordv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/civo/civodnsrecord/v1alpha1"
...
type Locals struct {
	...
	CivoDnsRecord      *civodnsrecordv1alpha1.CivoDnsRecord
	CivoLabels         map[string]string
	ZoneId             string
}

// initializeLocals mirrors the pattern used by other Planton modules.
func initializeLocals(_ *pulumi.Context, stackInput *civodnsrecordv1alpha1.CivoDnsRecordStackInput) *Locals {
	locals := &Locals{}
