...
import (
	...
	civovolumev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/civo/civovolume/v1alpha1"
...
type Locals struct {
	...
	CivoVolume         *civovolumev1alpha1.CivoVolume
...
func initializeLocals(_ *pulumi.Context, stackInput *civovolumev1alpha1.CivoVolumeStackInput) *Locals {
	locals := &Locals{}
