...
type Locals struct {
	...
	CivoIpAddress      *civoipaddressv1alpha1.CivoIpAddress
}

// initializeLocals prepares the struct in the simplest possible way.
func initializeLocals(_ *pulumi.Context, stackInput *civoipaddressv1alpha1.CivoIpAddressStackInput) *Locals {
	locals := &Locals{}
