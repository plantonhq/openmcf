...
import (
	...
	civobucketv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/civo/civobucket/v1alpha1"
...
type Locals struct {
	...
	CivoBucket         *civobucketv1alpha1.CivoBucket
	CivoLabels         map[string]string
}

// initializeLocals copies stack‑input fields into Locals and builds a label map.
func initializeLocals(_ *pulumi.Context, stackInput *civobucketv1alpha1.CivoBucketStackInput) *Locals {
	var locals Locals
