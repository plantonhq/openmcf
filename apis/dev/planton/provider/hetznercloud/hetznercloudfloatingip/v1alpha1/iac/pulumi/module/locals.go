...
import (
	...
	hetznercloudfloatingipv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudfloatingip/v1alpha1"
...
type Locals struct {
	...
	HetznerCloudFloatingIp     *hetznercloudfloatingipv1alpha1.HetznerCloudFloatingIp
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudfloatingipv1alpha1.HetznerCloudFloatingIpStackInput) *Locals {
	locals := &Locals{}
