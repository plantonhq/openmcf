...
import (
	...
	hetznercloudsnapshotv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudsnapshot/v1alpha1"
...
type Locals struct {
	...
	HetznerCloudSnapshot       *hetznercloudsnapshotv1alpha1.HetznerCloudSnapshot
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudsnapshotv1alpha1.HetznerCloudSnapshotStackInput) *Locals {
	locals := &Locals{}
