...
import (
	...
	hetznercloudcertificatev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudcertificate/v1alpha1"
...
func certificate(
	...
	case *hetznercloudcertificatev1alpha1.HetznerCloudCertificateSpec_Uploaded:
		return uploadedCertificate(ctx, name, cert.Uploaded, locals, hcloudProvider)
	case *hetznercloudcertificatev1alpha1.HetznerCloudCertificateSpec_Managed:
...
func uploadedCertificate(
	ctx *pulumi.Context,
	name string,
	config *hetznercloudcertificatev1alpha1.UploadedCertificateConfig,
	locals *Locals,
	hcloudProvider *hcloud.Provider,
) error {
...
func managedCertificate(
	ctx *pulumi.Context,
	name string,
	config *hetznercloudcertificatev1alpha1.ManagedCertificateConfig,
	locals *Locals,
	hcloudProvider *hcloud.Provider,
) error {
