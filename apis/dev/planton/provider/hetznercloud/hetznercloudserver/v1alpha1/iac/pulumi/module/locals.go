...
type Locals struct {
	...
	HetznerCloudServer         *hetznercloudserverv1alpha1.HetznerCloudServer
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudserverv1alpha1.HetznerCloudServerStackInput) *Locals {
	locals := &Locals{}
