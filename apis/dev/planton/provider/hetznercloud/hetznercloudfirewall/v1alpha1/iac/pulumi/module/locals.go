...
type Locals struct {
	...
	HetznerCloudFirewall       *hetznercloudfirewallv1alpha1.HetznerCloudFirewall
	Labels                     map[string]string
}

// initializeLocals copies stack-input fields into the Locals struct and builds
// a reusable label map.
func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudfirewallv1alpha1.HetznerCloudFirewallStackInput) *Locals {
	locals := &Locals{}
