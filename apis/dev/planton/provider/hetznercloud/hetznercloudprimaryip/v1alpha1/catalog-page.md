...
- [HetznerCloudServer](/docs/catalog/hetznercloud/hetznercloudserver) — Assigns the Primary IP to a server's primary public IP slot via `primaryIpId`
- [HetznerCloudFloatingIp](/docs/catalog/hetznercloud/hetznercloudfloatingip) — Alternative IP type that can be reassigned between servers in any location (not location-bound like Primary IPs)
...
- [HetznerCloudNetwork](/docs/catalog/hetznercloud/hetznercloudnetwork) — Private networking commonly deployed alongside public IPs for server connectivity
