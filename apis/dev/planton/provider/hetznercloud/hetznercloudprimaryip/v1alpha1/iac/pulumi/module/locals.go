...
import (
	...
	hetznercloudprimaryipv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudprimaryip/v1alpha1"
...
type Locals struct {
	...
	HetznerCloudPrimaryIp      *hetznercloudprimaryipv1alpha1.HetznerCloudPrimaryIp
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudprimaryipv1alpha1.HetznerCloudPrimaryIpStackInput) *Locals {
	locals := &Locals{}
