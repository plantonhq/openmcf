...
import (
	...
	hetznercloudnetworkv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudnetwork/v1alpha1"
...
type Locals struct {
	...
	HetznerCloudNetwork        *hetznercloudnetworkv1alpha1.HetznerCloudNetwork
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudnetworkv1alpha1.HetznerCloudNetworkStackInput) *Locals {
	locals := &Locals{}
