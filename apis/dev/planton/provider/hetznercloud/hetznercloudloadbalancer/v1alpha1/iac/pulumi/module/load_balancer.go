...
import (
	...
	hetznercloudloadbalancerv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudloadbalancer/v1alpha1"
...
func loadBalancer(
	...
	if spec.Algorithm != hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_algorithm_unspecified {
...
func createServices(
	ctx *pulumi.Context,
	services []*hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_Service,
	...
	for _, svc := range services {
		...
		if svc.Http != nil && svc.Protocol != hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_tcp {
...
func createTargets(
	ctx *pulumi.Context,
	spec *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec,
...
func createNetworkAttachment(
	ctx *pulumi.Context,
	netCfg *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_NetworkAttachment,
	lbIdInt pulumi.IntOutput,
	hcloudProvider *hcloud.Provider,
...
func buildHttpConfig(
	httpCfg *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_HttpConfig,
...
func buildHealthCheck(
	hc *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_HealthCheck,
	svcProtocol hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_ServiceProtocol,
	destPort int32,
...
func effectiveListenPort(svc *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_Service) int32 {
	if svc.ListenPort != nil {
		return *svc.ListenPort
	}
	switch svc.Protocol {
	case hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_http:
		return 80
	case hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_https:
		return 443
	default:
		return 0
	}
...
func effectiveDestinationPort(svc *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_Service, listenPort int32) int32 {
...
func defaultHealthCheckProtocol(
	hcProtocol hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_ServiceProtocol,
	svcProtocol hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_ServiceProtocol,
) string {
	if hcProtocol != hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_service_protocol_unspecified {
		return hcProtocol.String()
	}
	if svcProtocol == hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerSpec_https {
		return "http"
	}
