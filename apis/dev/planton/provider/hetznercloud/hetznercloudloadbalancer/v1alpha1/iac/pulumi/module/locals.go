...
type Locals struct {
	...
	HetznerCloudLoadBalancer   *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancer
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudloadbalancerv1alpha1.HetznerCloudLoadBalancerStackInput) *Locals {
	locals := &Locals{}
