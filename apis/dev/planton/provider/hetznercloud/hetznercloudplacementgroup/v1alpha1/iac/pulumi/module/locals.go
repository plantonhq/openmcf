...
import (
	...
	hetznercloudplacementgroupv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudplacementgroup/v1alpha1"
...
type Locals struct {
	...
	HetznerCloudPlacementGroup *hetznercloudplacementgroupv1alpha1.HetznerCloudPlacementGroup
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudplacementgroupv1alpha1.HetznerCloudPlacementGroupStackInput) *Locals {
	locals := &Locals{}
