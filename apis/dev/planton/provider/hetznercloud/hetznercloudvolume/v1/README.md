...
No other Planton components currently reference `HetznerCloudVolume` outputs. The `volume_id` output is available for external use (scripts, monitoring, manual operations) and for future components that may reference volumes.
