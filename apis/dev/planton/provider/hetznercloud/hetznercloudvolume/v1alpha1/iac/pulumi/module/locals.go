...
type Locals struct {
	...
	HetznerCloudVolume         *hetznercloudvolumev1alpha1.HetznerCloudVolume
	Labels                     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudvolumev1alpha1.HetznerCloudVolumeStackInput) *Locals {
	locals := &Locals{}
