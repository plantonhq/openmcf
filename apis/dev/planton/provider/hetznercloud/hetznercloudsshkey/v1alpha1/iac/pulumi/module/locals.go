...
import (
	...
	hetznercloudsshkeyv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/hetznercloud/hetznercloudsshkey/v1alpha1"
...
type Locals struct {
	...
	HetznerCloudSshKey         *hetznercloudsshkeyv1alpha1.HetznerCloudSshKey
...
func initializeLocals(_ *pulumi.Context, stackInput *hetznercloudsshkeyv1alpha1.HetznerCloudSshKeyStackInput) *Locals {
	locals := &Locals{}
