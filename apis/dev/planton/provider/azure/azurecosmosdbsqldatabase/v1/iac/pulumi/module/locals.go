...
type Locals struct {
	AzureCosmosdbSqlDatabase *azurecosmosdbsqldatabasev1.AzureCosmosdbSqlDatabase
	CosmosdbAccountId        string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurecosmosdbsqldatabasev1.AzureCosmosdbSqlDatabaseStackInput) *Locals {
	locals := &Locals{}
