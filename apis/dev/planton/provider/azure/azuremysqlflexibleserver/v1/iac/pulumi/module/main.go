...
func Resources(ctx *pulumi.Context, stackInput *azuremysqlflexibleserverv1.AzureMysqlFlexibleServerStackInput) error {
	...
	isDefaultMode := true
	if spec.CreateMode != azuremysqlflexibleserverv1.AzureMysqlFlexibleServerCreateMode_azure_mysql_flexible_server_create_mode_unspecified {
		serverArgs.CreateMode = pulumi.String(createModeStrings[spec.CreateMode])
		isDefaultMode = spec.CreateMode == azuremysqlflexibleserverv1.AzureMysqlFlexibleServerCreateMode_DEFAULT
	}
	...
	if spec.ReplicationRole == azuremysqlflexibleserverv1.AzureMysqlFlexibleServerReplicationRole_NONE {
	...
	if spec.PublicNetworkAccess != azuremysqlflexibleserverv1.AzureMysqlFlexibleServerPublicNetworkAccess_azure_mysql_flexible_server_public_network_access_unspecified {
