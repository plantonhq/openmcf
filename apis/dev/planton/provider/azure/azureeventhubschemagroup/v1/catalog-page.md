...
- [Azure Event Hub Namespace](/docs/catalog/azure/azureeventhubnamespace) -- the namespace whose registry holds the group (STANDARD+)
- [Azure Event Hub](/docs/catalog/azure/azureeventhub) -- the streams whose events reference the registered schemas
