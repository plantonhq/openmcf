...
func Resources(ctx *pulumi.Context, stackInput *azuremonitordiagnosticsettingv1.AzureMonitorDiagnosticSettingStackInput) error {
	...
	if spec.LogAnalyticsDestinationType != azuremonitordiagnosticsettingv1.AzureMonitorDiagnosticSettingLogAnalyticsDestinationType_azure_monitor_diagnostic_setting_log_analytics_destination_type_unspecified {
