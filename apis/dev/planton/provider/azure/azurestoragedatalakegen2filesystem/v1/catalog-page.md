...
- [Azure Storage Account](/docs/catalog/azure/azurestorageaccount) -- the parent (HNS-enabled) account
- [Azure Storage Encryption Scope](/docs/catalog/azure/azurestorageencryptionscope) -- sub-account key isolation the filesystem can pin
- [Azure Role Assignment](/docs/catalog/azure/azureroleassignment) -- grants data-plane roles at the `filesystem_id` scope
