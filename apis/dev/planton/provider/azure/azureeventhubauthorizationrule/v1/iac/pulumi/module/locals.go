...
type Locals struct {
	AzureEventHubAuthorizationRule *azureeventhubauthorizationrulev1.AzureEventHubAuthorizationRule
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureeventhubauthorizationrulev1.AzureEventHubAuthorizationRuleStackInput) (*Locals, error) {
	locals := &Locals{}
