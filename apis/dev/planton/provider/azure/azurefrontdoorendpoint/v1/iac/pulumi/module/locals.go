...
type Locals struct {
	AzureFrontDoorEndpoint *azurefrontdoorendpointv1.AzureFrontDoorEndpoint
	ProfileId              string
	AzureTags              map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurefrontdoorendpointv1.AzureFrontDoorEndpointStackInput) *Locals {
	locals := &Locals{}
