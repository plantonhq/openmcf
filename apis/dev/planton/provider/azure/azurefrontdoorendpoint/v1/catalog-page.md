...
- [Azure Front Door Route](/docs/catalog/azure/azurefrontdoorroute) -- attaches traffic rules to this endpoint
- [Azure DNS Record](/docs/catalog/azure/azurednsrecord) -- CNAMEs custom domains onto the endpoint hostname
