...
type Locals struct {
	AzureServiceBusDisasterRecoveryConfig *azureservicebusdisasterrecoveryconfigv1.AzureServiceBusDisasterRecoveryConfig
	PrimaryNamespaceId                    string
	PartnerNamespaceId                    string
	AliasAuthorizationRuleId              string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azureservicebusdisasterrecoveryconfigv1.AzureServiceBusDisasterRecoveryConfigStackInput) *Locals {
	locals := &Locals{}
