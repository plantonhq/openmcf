...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurefrontdoorprofile/v1alpha1/spec.proto
...
func (AzureFrontDoorProfileSku) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureFrontDoorProfileSku) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureFrontDoorProfileSku) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureFrontDoorProfileIdentityType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureFrontDoorProfileIdentityType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureFrontDoorProfileIdentityType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureFrontDoorProfileLogScrubbingVariable) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureFrontDoorProfileLogScrubbingVariable) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureFrontDoorProfileLogScrubbingVariable) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
type AzureFrontDoorProfileSpec struct {
	...
	Sku AzureFrontDoorProfileSku `protobuf:"varint,3,opt,name=sku,proto3,enum=dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSku" json:"sku,omitempty"`
	...
	LogScrubbingVariables []AzureFrontDoorProfileLogScrubbingVariable `protobuf:"varint,6,rep,packed,name=log_scrubbing_variables,json=logScrubbingVariables,proto3,enum=dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariable" json:"log_scrubbing_variables,omitempty"`
...
func (x *AzureFrontDoorProfileSpec) Reset() {
	*x = AzureFrontDoorProfileSpec{}
	mi := &file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes[0]
...
type AzureFrontDoorProfileIdentity struct {
	...
	Type AzureFrontDoorProfileIdentityType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityType" json:"type,omitempty"`
...
func (x *AzureFrontDoorProfileIdentity) Reset() {
	*x = AzureFrontDoorProfileIdentity{}
	mi := &file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/azure/azurefrontdoorprofile/v1alpha1/spec.proto\x129dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xf0\b\n" +
	...
	"\x1efront_door_profile_name_format\x12yprofile_name must be 2-90 characters, start and end with a letter or digit, and contain only letters, digits, and hyphens\x1a:this.matches('^[a-zA-Z0-9][a-zA-Z0-9-]{0,88}[a-zA-Z0-9]$')\xc8\x01\x01r\x04\x10\x02\x18ZR\vprofileName\x12o\n" +
	"\x03sku\x18\x03 \x01(\x0e2S.dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSkuB\b\xbaH\x05\x82\x01\x02\x10\x01R\x03sku\x12P\n" +
	"\x18response_timeout_seconds\x18\x04 \x01(\x05B\x11\xbaH\a\x1a\x05\x18\xf0\x01(\x10\x8a\xa6\x1d\x03120H\x00R\x16responseTimeoutSeconds\x88\x01\x01\x12t\n" +
	"\bidentity\x18\x05 \x01(\v2X.dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityR\bidentity\x12\xb1\x01\n" +
	"\x17log_scrubbing_variables\x18\x06 \x03(\x0e2d.dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariableB\x13\xbaH\x10\x92\x01\r\x10\x03\x18\x01\"\a\x82\x01\x04\x10\x01 \x00R\x15logScrubbingVariables\x12r\n" +
	"\x04tags\x18\a \x03(\v2^.dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x1b\n" +
	"\x19_response_timeout_seconds\"\xf2\x04\n" +
	"\x1dAzureFrontDoorProfileIdentity\x12|\n" +
	"\x04type\x18\x01 \x01(\x0e2\\.dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityTypeB\n" +
	...
	"\vREQUEST_URI\x10\x03B\xd0\x03\n" +
	"=com.dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1B\tSpecProtoP\x01Zygithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azurefrontdoorprofile/v1alpha1;azurefrontdoorprofilev1alpha1\xa2\x02\x05DPPAA\xaa\x029Dev.Planton.Provider.Azure.Azurefrontdoorprofile.V1alpha1\xca\x029Dev\\Planton\\Provider\\Azure\\Azurefrontdoorprofile\\V1alpha1\xe2\x02EDev\\Planton\\Provider\\Azure\\Azurefrontdoorprofile\\V1alpha1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Azure::Azurefrontdoorprofile::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_goTypes = []any{
	(AzureFrontDoorProfileSku)(0),                  // 0: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSku
	(AzureFrontDoorProfileIdentityType)(0),         // 1: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityType
	(AzureFrontDoorProfileLogScrubbingVariable)(0), // 2: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariable
	(*AzureFrontDoorProfileSpec)(nil),              // 3: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec
	(*AzureFrontDoorProfileIdentity)(nil),          // 4: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity
	nil,                                            // 5: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),                    // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 1: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.sku:type_name -> dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSku
	4, // 2: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.identity:type_name -> dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity
	2, // 3: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.log_scrubbing_variables:type_name -> dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariable
	5, // 4: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.tags:type_name -> dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.TagsEntry
	1, // 5: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity.type:type_name -> dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityType
	6, // 6: dev.planton.provider.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity.user_assigned_identity_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurefrontdoorprofile_v1alpha1_spec_proto_depIdxs = nil
}
