...
func Resources(ctx *pulumi.Context, stackInput *azureeventhubnamespacecustomermanagedkeyv1alpha1.AzureEventHubNamespaceCustomerManagedKeyStackInput) error {
