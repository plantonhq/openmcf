...
type Locals struct {
	AzureVirtualNetworkPeering *azurevirtualnetworkpeeringv1.AzureVirtualNetworkPeering
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurevirtualnetworkpeeringv1.AzureVirtualNetworkPeeringStackInput) *Locals {
	locals := &Locals{}
