...
type Locals struct {
	AzureManagedRedisGeoReplication *azuremanagedredisgeoreplicationv1.AzureManagedRedisGeoReplication
	ManagedRedisId                  string
	LinkedManagedRedisIds           []string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azuremanagedredisgeoreplicationv1.AzureManagedRedisGeoReplicationStackInput) *Locals {
	locals := &Locals{}
