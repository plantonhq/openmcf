...
type Locals struct {
	AzureRoleAssignment *azureroleassignmentv1.AzureRoleAssignment
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureroleassignmentv1.AzureRoleAssignmentStackInput) *Locals {
	locals := &Locals{}
...
func principalTypeToArm(t azureroleassignmentv1.AzureRoleAssignmentPrincipalType) string {
	switch t {
	case azureroleassignmentv1.AzureRoleAssignmentPrincipalType_SERVICE_PRINCIPAL:
		return "ServicePrincipal"
	case azureroleassignmentv1.AzureRoleAssignmentPrincipalType_USER:
		return "User"
	case azureroleassignmentv1.AzureRoleAssignmentPrincipalType_GROUP:
		return "Group"
	default:
		return ""
	}
