...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azureroleassignment/v1alpha1/spec.proto
...
func (AzureRoleAssignmentPrincipalType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureRoleAssignmentPrincipalType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureRoleAssignmentPrincipalType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type AzureRoleAssignmentSpec struct {
	...
	PrincipalType AzureRoleAssignmentPrincipalType `protobuf:"varint,5,opt,name=principal_type,json=principalType,proto3,enum=dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentPrincipalType" json:"principal_type,omitempty"`
...
func (x *AzureRoleAssignmentSpec) Reset() {
	*x = AzureRoleAssignmentSpec{}
	mi := &file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_msgTypes[0]
...
var File_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/provider/azure/azureroleassignment/v1alpha1/spec.proto\x127dev.planton.provider.azure.azureroleassignment.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xcd\v\n" +
	...
	"\fprincipal_id\x18\x04 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB*\xbaH\x03\xc8\x01\x01\x88\xd4a\x8c\x10\x92\xd4a\x1bstatus.outputs.principal_idR\vprincipalId\x12\x80\x01\n" +
	"\x0eprincipal_type\x18\x05 \x01(\x0e2Y.dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentPrincipalTypeR\rprincipalType\x12 \n" +
	...
	"\x04USER\x10\x02\x12\t\n" +
	"\x05GROUP\x10\x03B\xc2\x03\n" +
	";com.dev.planton.provider.azure.azureroleassignment.v1alpha1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azureroleassignment/v1alpha1;azureroleassignmentv1alpha1\xa2\x02\x05DPPAA\xaa\x027Dev.Planton.Provider.Azure.Azureroleassignment.V1alpha1\xca\x027Dev\\Planton\\Provider\\Azure\\Azureroleassignment\\V1alpha1\xe2\x02CDev\\Planton\\Provider\\Azure\\Azureroleassignment\\V1alpha1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Azure::Azureroleassignment::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_goTypes = []any{
	(AzureRoleAssignmentPrincipalType)(0), // 0: dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentPrincipalType
	(*AzureRoleAssignmentSpec)(nil),       // 1: dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentSpec
	(*v1.StringValueOrRef)(nil),           // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentSpec.scope:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentSpec.role_definition_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentSpec.principal_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 3: dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentSpec.principal_type:type_name -> dev.planton.provider.azure.azureroleassignment.v1alpha1.AzureRoleAssignmentPrincipalType
...
func init() { file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azureroleassignment_v1alpha1_spec_proto_depIdxs = nil
}
