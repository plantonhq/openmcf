...
type Locals struct {
	AzureServiceBusAuthorizationRule *azureservicebusauthorizationrulev1.AzureServiceBusAuthorizationRule
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureservicebusauthorizationrulev1.AzureServiceBusAuthorizationRuleStackInput) *Locals {
	locals := &Locals{}
