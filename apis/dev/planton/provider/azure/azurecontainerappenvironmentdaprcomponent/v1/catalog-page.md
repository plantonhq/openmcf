...
- [Azure Container App Environment](/docs/catalog/azure/azurecontainerappenvironment) -- the environment the component is registered on
- [Azure Container App](/docs/catalog/azure/azurecontainerapp) -- the Dapr-enabled workloads that consume it
