...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurenatgateway/v1alpha1/spec.proto
...
func (AzureNatGatewaySkuName) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureNatGatewaySkuName) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureNatGatewaySkuName) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type AzureNatGatewaySpec struct {
	...
	// creation.
	SkuName AzureNatGatewaySkuName `protobuf:"varint,4,opt,name=sku_name,json=skuName,proto3,enum=dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySkuName" json:"sku_name,omitempty"`
...
func (x *AzureNatGatewaySpec) Reset() {
	*x = AzureNatGatewaySpec{}
	mi := &file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_msgTypes[0]
...
var File_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/azure/azurenatgateway/v1alpha1/spec.proto\x123dev.planton.provider.azure.azurenatgateway.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xd0\n" +
	"\n" +
	...
	"\x17nat_gateway_name_format\x12\x9b\x01NAT gateway names start with a letter or number, end with a letter, number, or underscore, and may contain alphanumerics, underscores, periods, and hyphens\x1aIthis == '' || this.matches('^[a-zA-Z0-9]([a-zA-Z0-9._-]*[a-zA-Z0-9_])?$')\xc8\x01\x01r\x04\x10\x01\x18PR\x04name\x12f\n" +
	"\bsku_name\x18\x04 \x01(\x0e2K.dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySkuNameR\askuName\x12J\n" +
	...
	"\x14public_ip_prefix_ids\x18\b \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB+\x88\xd4a\xe5\x0f\x92\xd4a\"status.outputs.public_ip_prefix_idR\x11publicIpPrefixIds\x12f\n" +
	"\x04tags\x18\t \x03(\v2R.dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var (
	file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_goTypes = []any{
	(AzureNatGatewaySkuName)(0), // 0: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySkuName
	(*AzureNatGatewaySpec)(nil), // 1: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec
	nil,                         // 2: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 1: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.sku_name:type_name -> dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySkuName
	3, // 2: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.public_ip_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 3: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.public_ip_prefix_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 4: dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.tags:type_name -> dev.planton.provider.azure.azurenatgateway.v1alpha1.AzureNatGatewaySpec.TagsEntry
...
func init() { file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurenatgateway_v1alpha1_spec_proto_depIdxs = nil
}
