...
type Locals struct {
	AzureNetworkInterface *azurenetworkinterfacev1.AzureNetworkInterface
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurenetworkinterfacev1.AzureNetworkInterfaceStackInput) *Locals {
	locals := &Locals{}
	...
	case azurenetworkinterfacev1.AzureNetworkInterfaceAuxiliaryMode_ACCELERATED_CONNECTIONS:
		locals.AuxiliaryMode = "AcceleratedConnections"
	case azurenetworkinterfacev1.AzureNetworkInterfaceAuxiliaryMode_FLOATING:
		locals.AuxiliaryMode = "Floating"
	case azurenetworkinterfacev1.AzureNetworkInterfaceAuxiliaryMode_MAX_CONNECTIONS:
		locals.AuxiliaryMode = "MaxConnections"
	}

	switch target.Spec.AuxiliarySku {
	case azurenetworkinterfacev1.AzureNetworkInterfaceAuxiliarySku_A1:
		locals.AuxiliarySku = "A1"
	case azurenetworkinterfacev1.AzureNetworkInterfaceAuxiliarySku_A2:
		locals.AuxiliarySku = "A2"
	case azurenetworkinterfacev1.AzureNetworkInterfaceAuxiliarySku_A4:
		locals.AuxiliarySku = "A4"
	case azurenetworkinterfacev1.AzureNetworkInterfaceAuxiliarySku_A8:
