...
import (
	...
	azurenetworkinterfacev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/azure/azurenetworkinterface/v1alpha1"
	"github.com/plantonhq/planton/pkg/iac/pulumi/pulumimodule/provider/azure/pulumiazureprovider"
	"github.com/pulumi/pulumi-azure/sdk/v6/go/azure/network"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

func Resources(ctx *pulumi.Context, stackInput *azurenetworkinterfacev1alpha1.AzureNetworkInterfaceStackInput) error {
	...
	for _, config := range spec.IpConfigurations {
		...
		// on both engines.
		allocation := "Dynamic"
		if config.PrivateIpAllocation == azurenetworkinterfacev1alpha1.AzureNetworkInterfacePrivateIpAllocation_STATIC {
			allocation = "Static"
		}
		version := "IPv4"
		if config.PrivateIpVersion == azurenetworkinterfacev1alpha1.AzureNetworkInterfacePrivateIpVersion_IPV6 {
			version = "IPv6"
		}
