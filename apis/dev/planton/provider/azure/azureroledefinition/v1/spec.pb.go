...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azureroledefinition/v1/spec.proto
...
func (x *AzureRoleDefinitionSpec) Reset() {
	*x = AzureRoleDefinitionSpec{}
	mi := &file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_msgTypes[0]
...
func (*AzureRoleDefinitionSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureRoleDefinitionPermission) Reset() {
	*x = AzureRoleDefinitionPermission{}
	mi := &file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureRoleDefinitionPermission) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_azure_azureroledefinition_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<dev/planton/provider/azure/azureroledefinition/v1/spec.proto\x121dev.planton.provider.azure.azureroledefinition.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\x92\x04\n" +
	...
	"\x10not_data_actions\x18\x04 \x03(\tR\x0enotDataActionsB\x98\x03\n" +
...
var (
	file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_goTypes = []any{
	(*AzureRoleDefinitionSpec)(nil),       // 0: dev.planton.provider.azure.azureroledefinition.v1.AzureRoleDefinitionSpec
	(*AzureRoleDefinitionPermission)(nil), // 1: dev.planton.provider.azure.azureroledefinition.v1.AzureRoleDefinitionPermission
	(*v1.StringValueOrRef)(nil),           // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.azure.azureroledefinition.v1.AzureRoleDefinitionSpec.scope:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.azure.azureroledefinition.v1.AzureRoleDefinitionSpec.permissions:type_name -> dev.planton.provider.azure.azureroledefinition.v1.AzureRoleDefinitionPermission
	2, // 2: dev.planton.provider.azure.azureroledefinition.v1.AzureRoleDefinitionSpec.assignable_scopes:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_init() }
func file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_init() {
	if File_dev_planton_provider_azure_azureroledefinition_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azureroledefinition_v1_spec_proto = out.File
	file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azureroledefinition_v1_spec_proto_depIdxs = nil
}
