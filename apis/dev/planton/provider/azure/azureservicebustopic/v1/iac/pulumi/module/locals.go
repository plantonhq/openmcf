...
type Locals struct {
	AzureServiceBusTopic *azureservicebustopicv1.AzureServiceBusTopic
	NamespaceId          string
...
var statusStrings = map[azureservicebustopicv1.AzureServiceBusTopicStatusValue]string{
	azureservicebustopicv1.AzureServiceBusTopicStatusValue_azure_service_bus_topic_status_unspecified: "Active",
	azureservicebustopicv1.AzureServiceBusTopicStatusValue_ACTIVE:                                     "Active",
	azureservicebustopicv1.AzureServiceBusTopicStatusValue_DISABLED:                                   "Disabled",
}
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureservicebustopicv1.AzureServiceBusTopicStackInput) *Locals {
	locals := &Locals{}
