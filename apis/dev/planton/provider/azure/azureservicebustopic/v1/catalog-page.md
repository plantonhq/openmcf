...
- [Azure Service Bus Subscription](/docs/catalog/azure/azureservicebussubscription) -- the consuming views
- [Azure Service Bus Authorization Rule](/docs/catalog/azure/azureservicebusauthorizationrule) -- topic-scoped SAS credentials
