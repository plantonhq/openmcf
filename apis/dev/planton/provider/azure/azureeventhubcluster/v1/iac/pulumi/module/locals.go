...
type Locals struct {
	AzureEventHubCluster *azureeventhubclusterv1.AzureEventHubCluster
	ResourceGroupName    string
	AzureTags            map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azureeventhubclusterv1.AzureEventHubClusterStackInput) *Locals {
	locals := &Locals{}
