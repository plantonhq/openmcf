...
import (
	...
	azurefrontdoorcustomdomainv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/azure/azurefrontdoorcustomdomain/v1alpha1"
	"github.com/plantonhq/planton/pkg/iac/pulumi/pulumimodule/provider/azure/pulumiazureprovider"
	"github.com/pulumi/pulumi-azure/sdk/v6/go/azure/cdn"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

func Resources(ctx *pulumi.Context, stackInput *azurefrontdoorcustomdomainv1alpha1.AzureFrontDoorCustomDomainStackInput) error {
	...
	if spec.Tls.CertificateType != azurefrontdoorcustomdomainv1alpha1.AzureFrontDoorCustomDomainCertificateType_azure_front_door_custom_domain_certificate_type_unspecified {
