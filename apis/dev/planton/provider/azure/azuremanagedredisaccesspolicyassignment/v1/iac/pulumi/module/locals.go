...
type Locals struct {
	AzureManagedRedisAccessPolicyAssignment *azuremanagedredisaccesspolicyassignmentv1.AzureManagedRedisAccessPolicyAssignment
	ManagedRedisId                          string
	ObjectId                                string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azuremanagedredisaccesspolicyassignmentv1.AzureManagedRedisAccessPolicyAssignmentStackInput) *Locals {
	locals := &Locals{}
