...
- [AzureResourceGroup](/docs/catalog/azure/azureresourcegroup) -- provides the resource group for plan placement
- [AzureFunctionApp](/docs/catalog/azure/azurefunctionapp) -- serverless Function Apps hosted on this plan
- [AzureLinuxWebApp](/docs/catalog/azure/azurelinuxwebapp) -- Linux web applications hosted on this plan
