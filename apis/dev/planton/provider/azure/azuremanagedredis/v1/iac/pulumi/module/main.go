...
func Resources(ctx *pulumi.Context, stackInput *azuremanagedredisv1.AzureManagedRedisStackInput) error {
	...
	if database.ClientProtocol != azuremanagedredisv1.AzureManagedRedisClientProtocol_azure_managed_redis_client_protocol_unspecified {
	...
	if database.ClusteringPolicy != azuremanagedredisv1.AzureManagedRedisClusteringPolicy_azure_managed_redis_clustering_policy_unspecified {
	...
	if database.EvictionPolicy != azuremanagedredisv1.AzureManagedRedisEvictionPolicy_azure_managed_redis_eviction_policy_unspecified {
