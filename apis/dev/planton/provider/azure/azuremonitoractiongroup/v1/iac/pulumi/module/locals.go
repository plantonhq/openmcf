...
type Locals struct {
	AzureMonitorActionGroup *azuremonitoractiongroupv1.AzureMonitorActionGroup
	ResourceGroupName       string
	AzureTags               map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azuremonitoractiongroupv1.AzureMonitorActionGroupStackInput) *Locals {
	locals := &Locals{}
