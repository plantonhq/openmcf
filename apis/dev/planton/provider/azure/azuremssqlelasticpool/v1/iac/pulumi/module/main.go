...
func Resources(ctx *pulumi.Context, stackInput *azuremssqlelasticpoolv1.AzureMssqlElasticPoolStackInput) error {
	...
	// accordingly.
	if spec.EnclaveType != azuremssqlelasticpoolv1.AzureMssqlElasticPoolEnclaveType_azure_mssql_elastic_pool_enclave_type_unspecified {
		poolArgs.EnclaveType = pulumi.String(enclaveTypeStrings[spec.EnclaveType])
	}

	if spec.LicenseType != azuremssqlelasticpoolv1.AzureMssqlElasticPoolLicenseType_azure_mssql_elastic_pool_license_type_unspecified {
