...
type Locals struct {
	AzureMssqlElasticPool *azuremssqlelasticpoolv1.AzureMssqlElasticPool
...
// values.
var enclaveTypeStrings = map[azuremssqlelasticpoolv1.AzureMssqlElasticPoolEnclaveType]string{
	azuremssqlelasticpoolv1.AzureMssqlElasticPoolEnclaveType_VBS:             "VBS",
	azuremssqlelasticpoolv1.AzureMssqlElasticPoolEnclaveType_DEFAULT_ENCLAVE: "Default",
}

// licenseTypeStrings maps the Azure Hybrid Benefit enum to ARM's values.
var licenseTypeStrings = map[azuremssqlelasticpoolv1.AzureMssqlElasticPoolLicenseType]string{
	azuremssqlelasticpoolv1.AzureMssqlElasticPoolLicenseType_BASE_PRICE:       "BasePrice",
	azuremssqlelasticpoolv1.AzureMssqlElasticPoolLicenseType_LICENSE_INCLUDED: "LicenseIncluded",
}

func initializeLocals(ctx *pulumi.Context, stackInput *azuremssqlelasticpoolv1.AzureMssqlElasticPoolStackInput) *Locals {
	locals := &Locals{}
