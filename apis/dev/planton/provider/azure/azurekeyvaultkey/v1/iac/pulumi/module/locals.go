...
type Locals struct {
	AzureKeyVaultKey *azurekeyvaultkeyv1.AzureKeyVaultKey
...
var keyTypeStrings = map[azurekeyvaultkeyv1.AzureKeyVaultKeyType]string{
	azurekeyvaultkeyv1.AzureKeyVaultKeyType_RSA:     "RSA",
	azurekeyvaultkeyv1.AzureKeyVaultKeyType_RSA_HSM: "RSA-HSM",
	azurekeyvaultkeyv1.AzureKeyVaultKeyType_EC:      "EC",
	azurekeyvaultkeyv1.AzureKeyVaultKeyType_EC_HSM:  "EC-HSM",
}

var curveStrings = map[azurekeyvaultkeyv1.AzureKeyVaultKeyCurve]string{
	azurekeyvaultkeyv1.AzureKeyVaultKeyCurve_P_256:  "P-256",
	azurekeyvaultkeyv1.AzureKeyVaultKeyCurve_P_256K: "P-256K",
	azurekeyvaultkeyv1.AzureKeyVaultKeyCurve_P_384:  "P-384",
	azurekeyvaultkeyv1.AzureKeyVaultKeyCurve_P_521:  "P-521",
}

var keyOperationStrings = map[azurekeyvaultkeyv1.AzureKeyVaultKeyOperation]string{
	azurekeyvaultkeyv1.AzureKeyVaultKeyOperation_DECRYPT:    "decrypt",
	azurekeyvaultkeyv1.AzureKeyVaultKeyOperation_ENCRYPT:    "encrypt",
	azurekeyvaultkeyv1.AzureKeyVaultKeyOperation_SIGN:       "sign",
	azurekeyvaultkeyv1.AzureKeyVaultKeyOperation_UNWRAP_KEY: "unwrapKey",
	azurekeyvaultkeyv1.AzureKeyVaultKeyOperation_VERIFY:     "verify",
	azurekeyvaultkeyv1.AzureKeyVaultKeyOperation_WRAP_KEY:   "wrapKey",
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurekeyvaultkeyv1.AzureKeyVaultKeyStackInput) *Locals {
	locals := &Locals{}
