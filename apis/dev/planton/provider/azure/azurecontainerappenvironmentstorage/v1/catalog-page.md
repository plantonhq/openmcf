...
- [Azure Container App Environment](/docs/catalog/azure/azurecontainerappenvironment) -- the environment the registration lives on
- [Azure Container App](/docs/catalog/azure/azurecontainerapp) / [Azure Container App Job](/docs/catalog/azure/azurecontainerappjob) -- the workloads that mount it
- [Azure Storage Share](/docs/catalog/azure/azurestorageshare) -- the Azure Files share being registered
