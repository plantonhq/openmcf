...
- [Azure Storage Account](/docs/catalog/azure/azurestorageaccount) -- both ends of the pair (versioning/change-feed prerequisites)
- [Azure Storage Container](/docs/catalog/azure/azurestoragecontainer) -- what the rules map between
