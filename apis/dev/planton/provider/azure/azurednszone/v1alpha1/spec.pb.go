...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurednszone/v1alpha1/spec.proto
...
func (x *AzureDnsZoneSpec) Reset() {
	*x = AzureDnsZoneSpec{}
	mi := &file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_msgTypes[0]
...
func (*AzureDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureDnsZoneSoaRecord) Reset() {
	*x = AzureDnsZoneSoaRecord{}
	mi := &file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsZoneSoaRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";dev/planton/provider/azure/azurednszone/v1alpha1/spec.proto\x120dev.planton.provider.azure.azurednszone.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x8a\b\n" +
	...
	"\x0eresource_group\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB1\xbaH\x03\xc8\x01\x01\x88\xd4a\xd0\x0f\x92\xd4a\"status.outputs.resource_group_nameR\rresourceGroup\x12f\n" +
	"\n" +
	"soa_record\x18\x03 \x01(\v2G.dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSoaRecordR\tsoaRecord\x12`\n" +
	"\x04tags\x18\x04 \x03(\v2L.dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x9a\x02\xbaH\x96\x02\x1a\x93\x02\n" +
	")azure_dns_zone_name_plus_soa_email_length\x12\x8f\x01The zone name and the SOA email together cannot exceed 253 characters (Azure combines them into the SOA record) -- shorten the soa_record.email\x1aT!has(this.soa_record) || (size(this.zone_name) + size(this.soa_record.email)) <= 253\"\x9a\b\n" +
	...
	"\"\b\x18\xff\xff\xff\xff\a(\x00\x8a\xa6\x1d\x043600H\x05R\x03ttl\x88\x01\x01\x12e\n" +
	"\x04tags\x18\b \x03(\v2Q.dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSoaRecord.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x04_ttlB\x91\x03\n" +
	"4com.dev.planton.provider.azure.azurednszone.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azurednszone/v1alpha1;azurednszonev1alpha1\xa2\x02\x05DPPAA\xaa\x020Dev.Planton.Provider.Azure.Azurednszone.V1alpha1\xca\x020Dev\\Planton\\Provider\\Azure\\Azurednszone\\V1alpha1\xe2\x02<Dev\\Planton\\Provider\\Azure\\Azurednszone\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Provider::Azure::Azurednszone::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_goTypes = []any{
	(*AzureDnsZoneSpec)(nil),      // 0: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSpec
	(*AzureDnsZoneSoaRecord)(nil), // 1: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSoaRecord
	nil,                           // 2: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSpec.TagsEntry
	nil,                           // 3: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSoaRecord.TagsEntry
	(*v1.StringValueOrRef)(nil),   // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSpec.soa_record:type_name -> dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSoaRecord
	2, // 2: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSpec.tags:type_name -> dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSpec.TagsEntry
	3, // 3: dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSoaRecord.tags:type_name -> dev.planton.provider.azure.azurednszone.v1alpha1.AzureDnsZoneSoaRecord.TagsEntry
...
func init() { file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurednszone_v1alpha1_spec_proto_depIdxs = nil
}
