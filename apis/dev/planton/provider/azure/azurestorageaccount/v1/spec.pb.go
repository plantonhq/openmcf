...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurestorageaccount/v1/spec.proto
...
func (AzureStorageAccountKind) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureStorageAccountKind) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[0]
}
...
func (AzureStorageAccountTier) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureStorageAccountTier) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[1]
}
...
func (x *AzureStorageAccountSpec) Reset() {
	*x = AzureStorageAccountSpec{}
	mi := &file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[0]
...
const file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc = "" +
	...
	"\x19user_assigned_identity_id\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB)\xbaH\x03\xc8\x01\x01\x88\xd4a\x8c\x10\x92\xd4a\x1astatus.outputs.identity_idR\x16userAssignedIdentityId\"\xf2\x04\n" +
	...
	"\x1avirtual_network_subnet_ids\x18\x04 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB%\x88\xd4a\xdb\x0f\x92\xd4a\x18status.outputs.subnet_id\x98\xd4a\x01R\x17virtualNetworkSubnetIds\x12\x87\x01\n" +
...
var (
	file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto = out.File
	file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurestorageaccount_v1_spec_proto_depIdxs = nil
}
