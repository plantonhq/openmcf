...
func Resources(ctx *pulumi.Context, stackInput *azurestorageaccountv1.AzureStorageAccountStackInput) error {
	...
	if spec.AccountKind != azurestorageaccountv1.AzureStorageAccountKind_azure_storage_account_kind_unspecified {
		accountKind = accountKindStrings[spec.AccountKind]
	}
	accountArgs.AccountKind = pulumi.String(accountKind)

	accountTier := "Standard"
	if spec.AccountTier != azurestorageaccountv1.AzureStorageAccountTier_azure_storage_account_tier_unspecified {
		accountTier = accountTierStrings[spec.AccountTier]
	}
	accountArgs.AccountTier = pulumi.String(accountTier)

	replicationType := "LRS"
	if spec.ReplicationType != azurestorageaccountv1.AzureStorageAccountReplicationType_azure_storage_account_replication_type_unspecified {
	...
	if spec.AccessTier != azurestorageaccountv1.AzureStorageAccountAccessTier_azure_storage_account_access_tier_unspecified {
	...
	if spec.MinTlsVersion != azurestorageaccountv1.AzureStorageAccountMinTlsVersion_azure_storage_account_min_tls_version_unspecified {
	...
	if spec.AllowedCopyScope != azurestorageaccountv1.AzureStorageAccountAllowedCopyScope_azure_storage_account_allowed_copy_scope_unspecified {
	...
	if spec.SasPolicy != nil {
		...
		if spec.SasPolicy.ExpirationAction != azurestorageaccountv1.AzureStorageAccountSasExpirationAction_azure_storage_account_sas_expiration_action_unspecified {
	...
	if spec.DnsEndpointType != azurestorageaccountv1.AzureStorageAccountDnsEndpointType_azure_storage_account_dns_endpoint_type_unspecified {
	...
	if spec.QueueEncryptionKeyType != azurestorageaccountv1.AzureStorageAccountEncryptionKeyType_azure_storage_account_encryption_key_type_unspecified {
		accountArgs.QueueEncryptionKeyType = pulumi.String(encryptionKeyTypeStrings[spec.QueueEncryptionKeyType])
	}
	if spec.TableEncryptionKeyType != azurestorageaccountv1.AzureStorageAccountEncryptionKeyType_azure_storage_account_encryption_key_type_unspecified {
	...
	if spec.Routing != nil {
		...
		if spec.Routing.Choice != azurestorageaccountv1.AzureStorageAccountRoutingChoice_azure_storage_account_routing_choice_unspecified {
	...
	if spec.AzureFilesAuthentication != nil {
		...
		if spec.AzureFilesAuthentication.DefaultShareLevelPermission != azurestorageaccountv1.AzureStorageAccountDefaultSharePermission_azure_storage_account_default_share_permission_unspecified {
