...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azureloganalyticsworkspace/v1alpha1/stack_outputs.proto
...
func (x *AzureLogAnalyticsWorkspaceStackOutputs) Reset() {
	*x = AzureLogAnalyticsWorkspaceStackOutputs{}
	mi := &file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*AzureLogAnalyticsWorkspaceStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Rdev/planton/provider/azure/azureloganalyticsworkspace/v1alpha1/stack_outputs.proto\x12>dev.planton.provider.azure.azureloganalyticsworkspace.v1alpha1\"\xea\x02\n" +
	...
	"\x15identity_principal_id\x18\a \x01(\tR\x13identityPrincipalIdB\xfc\x03\n" +
	"Bcom.dev.planton.provider.azure.azureloganalyticsworkspace.v1alpha1B\x11StackOutputsProtoP\x01Z\x83\x01github.com/plantonhq/planton/apis/dev/planton/provider/azure/azureloganalyticsworkspace/v1alpha1;azureloganalyticsworkspacev1alpha1\xa2\x02\x05DPPAA\xaa\x02>Dev.Planton.Provider.Azure.Azureloganalyticsworkspace.V1alpha1\xca\x02>Dev\\Planton\\Provider\\Azure\\Azureloganalyticsworkspace\\V1alpha1\xe2\x02JDev\\Planton\\Provider\\Azure\\Azureloganalyticsworkspace\\V1alpha1\\GPBMetadata\xea\x02CDev::Planton::Provider::Azure::Azureloganalyticsworkspace::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*AzureLogAnalyticsWorkspaceStackOutputs)(nil), // 0: dev.planton.provider.azure.azureloganalyticsworkspace.v1alpha1.AzureLogAnalyticsWorkspaceStackOutputs
}
var file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_init() {
	if File_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto = out.File
	file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_azure_azureloganalyticsworkspace_v1alpha1_stack_outputs_proto_depIdxs = nil
}
