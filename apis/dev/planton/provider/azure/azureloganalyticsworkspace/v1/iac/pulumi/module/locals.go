...
var skuStrings = map[azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceSku]string{
	azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceSku_azure_log_analytics_workspace_sku_unspecified: "PerGB2018",
	azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceSku_PER_GB_2018:                                   "PerGB2018",
	azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceSku_CAPACITY_RESERVATION:                          "CapacityReservation",
	azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceSku_PER_NODE:                                      "PerNode",
	azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceSku_STANDALONE:                                    "Standalone",
}
...
var identityTypeStrings = map[azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceIdentityType]string{
	azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceIdentityType_SYSTEM_ASSIGNED: "SystemAssigned",
	azureloganalyticsworkspacev1.AzureLogAnalyticsWorkspaceIdentityType_USER_ASSIGNED:   "UserAssigned",
}
