...
type Locals struct {
	AzureDiskEncryptionSet *azurediskencryptionsetv1.AzureDiskEncryptionSet
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurediskencryptionsetv1.AzureDiskEncryptionSetStackInput) *Locals {
	locals := &Locals{}
	...
	case azurediskencryptionsetv1.AzureDiskEncryptionSetEncryptionType_ENCRYPTION_AT_REST_WITH_CUSTOMER_KEY:
		locals.EncryptionType = "EncryptionAtRestWithCustomerKey"
	case azurediskencryptionsetv1.AzureDiskEncryptionSetEncryptionType_ENCRYPTION_AT_REST_WITH_PLATFORM_AND_CUSTOMER_KEYS:
		locals.EncryptionType = "EncryptionAtRestWithPlatformAndCustomerKeys"
	case azurediskencryptionsetv1.AzureDiskEncryptionSetEncryptionType_CONFIDENTIAL_VM_ENCRYPTED_WITH_CUSTOMER_KEY:
		locals.EncryptionType = "ConfidentialVmEncryptedWithCustomerKey"
	}

	if spec.Identity != nil {
		switch spec.Identity.Type {
		case azurediskencryptionsetv1.AzureDiskEncryptionSetIdentityType_SYSTEM_ASSIGNED:
			locals.IdentityType = "SystemAssigned"
		case azurediskencryptionsetv1.AzureDiskEncryptionSetIdentityType_USER_ASSIGNED:
			locals.IdentityType = "UserAssigned"
		case azurediskencryptionsetv1.AzureDiskEncryptionSetIdentityType_SYSTEM_AND_USER_ASSIGNED:
