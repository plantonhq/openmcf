...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azuresubnet/v1alpha1/spec.proto
...
func (AzureSubnetPrivateEndpointNetworkPolicies) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureSubnetPrivateEndpointNetworkPolicies) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureSubnetPrivateEndpointNetworkPolicies) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureSubnetSharingScope) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureSubnetSharingScope) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureSubnetSharingScope) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
type AzureSubnetSpec struct {
	...
	SharingScope AzureSubnetSharingScope `protobuf:"varint,11,opt,name=sharing_scope,json=sharingScope,proto3,enum=dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSharingScope" json:"sharing_scope,omitempty"`
...
func (x *AzureSubnetSpec) Reset() {
	*x = AzureSubnetSpec{}
	mi := &file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_msgTypes[0]
...
func (x *AzureSubnetIpAddressPool) Reset() {
	*x = AzureSubnetIpAddressPool{}
	mi := &file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureSubnetDelegation) Reset() {
	*x = AzureSubnetDelegation{}
	mi := &file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureSubnetDelegation) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":dev/planton/provider/azure/azuresubnet/v1alpha1/spec.proto\x12/dev.planton.provider.azure.azuresubnet.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc2\x12\n" +
	...
	"\x10address_prefixes\x18\x03 \x03(\tR\x0faddressPrefixes\x12q\n" +
	"\x0fip_address_pool\x18\x04 \x01(\v2I.dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetIpAddressPoolR\ripAddressPool\x12+\n" +
	"\x11service_endpoints\x18\x05 \x03(\tR\x10serviceEndpoints\x12=\n" +
	"\x1bservice_endpoint_policy_ids\x18\x06 \x03(\tR\x18serviceEndpointPolicyIds\x12h\n" +
	"\vdelegations\x18\a \x03(\v2F.dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetDelegationR\vdelegations\x12\xa5\x01\n" +
	"!private_endpoint_network_policies\x18\b \x01(\x0e2Z.dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetPrivateEndpointNetworkPoliciesR\x1eprivateEndpointNetworkPolicies\x12n\n" +
	...
	" \x01(\bB\b\x8a\xa6\x1d\x04trueH\x01R\x1cdefaultOutboundAccessEnabled\x88\x01\x01\x12m\n" +
	"\rsharing_scope\x18\v \x01(\x0e2H.dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSharingScopeR\fsharingScope\x12\x80\x01\n" +
	...
	"\n" +
	"\x06TENANT\x10\x01B\x8a\x03\n" +
	"3com.dev.planton.provider.azure.azuresubnet.v1alpha1B\tSpecProtoP\x01Zegithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azuresubnet/v1alpha1;azuresubnetv1alpha1\xa2\x02\x05DPPAA\xaa\x02/Dev.Planton.Provider.Azure.Azuresubnet.V1alpha1\xca\x02/Dev\\Planton\\Provider\\Azure\\Azuresubnet\\V1alpha1\xe2\x02;Dev\\Planton\\Provider\\Azure\\Azuresubnet\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Provider::Azure::Azuresubnet::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_goTypes = []any{
	(AzureSubnetPrivateEndpointNetworkPolicies)(0), // 0: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetPrivateEndpointNetworkPolicies
	(AzureSubnetSharingScope)(0),                   // 1: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSharingScope
	(*AzureSubnetSpec)(nil),                        // 2: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec
	(*AzureSubnetIpAddressPool)(nil),               // 3: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetIpAddressPool
	(*AzureSubnetDelegation)(nil),                  // 4: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetDelegation
	(*v1.StringValueOrRef)(nil),                    // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.virtual_network_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.ip_address_pool:type_name -> dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetIpAddressPool
	4, // 2: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.delegations:type_name -> dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetDelegation
	0, // 3: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.private_endpoint_network_policies:type_name -> dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetPrivateEndpointNetworkPolicies
	1, // 4: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.sharing_scope:type_name -> dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSharingScope
	5, // 5: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.route_table_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 6: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.network_security_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 7: dev.planton.provider.azure.azuresubnet.v1alpha1.AzureSubnetSpec.nat_gateway_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azuresubnet_v1alpha1_spec_proto_depIdxs = nil
}
