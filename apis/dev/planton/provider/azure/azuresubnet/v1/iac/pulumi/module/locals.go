...
func initializeLocals(ctx *pulumi.Context, stackInput *azuresubnetv1.AzureSubnetStackInput) *Locals {
	...
	case azuresubnetv1.AzureSubnetPrivateEndpointNetworkPolicies_ENABLED:
		locals.PrivateEndpointNetworkPolicies = "Enabled"
	case azuresubnetv1.AzureSubnetPrivateEndpointNetworkPolicies_NETWORK_SECURITY_GROUP_ENABLED:
		locals.PrivateEndpointNetworkPolicies = "NetworkSecurityGroupEnabled"
	case azuresubnetv1.AzureSubnetPrivateEndpointNetworkPolicies_ROUTE_TABLE_ENABLED:
		locals.PrivateEndpointNetworkPolicies = "RouteTableEnabled"
	}

	if target.Spec.SharingScope == azuresubnetv1.AzureSubnetSharingScope_TENANT {
