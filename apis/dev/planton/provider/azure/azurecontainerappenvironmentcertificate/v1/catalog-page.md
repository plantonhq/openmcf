...
- [Azure Container App Custom Domain](/docs/catalog/azure/azurecontainerappcustomdomain) -- binds the certificate to an app hostname
- [Azure Container App Environment Managed Certificate](/docs/catalog/azure/azurecontainerappenvironmentmanagedcertificate) -- the free, Azure-renewed alternative
- [Azure Key Vault Certificate](/docs/catalog/azure/azurekeyvaultcertificate) -- the Key Vault source this kind can track
