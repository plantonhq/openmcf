...
type Locals struct {
	AzureContainerAppEnvironmentCertificate *azurecontainerappenvironmentcertificatev1.AzureContainerAppEnvironmentCertificate
	EnvironmentId                           string
	AzureTags                               map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurecontainerappenvironmentcertificatev1.AzureContainerAppEnvironmentCertificateStackInput) *Locals {
	locals := &Locals{}
