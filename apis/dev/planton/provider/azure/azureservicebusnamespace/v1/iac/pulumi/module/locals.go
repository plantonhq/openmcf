...
var skuStrings = map[azureservicebusnamespacev1.AzureServiceBusNamespaceSku]string{
	azureservicebusnamespacev1.AzureServiceBusNamespaceSku_azure_service_bus_namespace_sku_unspecified: "Standard",
	azureservicebusnamespacev1.AzureServiceBusNamespaceSku_BASIC:                                       "Basic",
	azureservicebusnamespacev1.AzureServiceBusNamespaceSku_STANDARD:                                    "Standard",
	azureservicebusnamespacev1.AzureServiceBusNamespaceSku_PREMIUM:                                     "Premium",
}
...
var identityTypeStrings = map[azureservicebusnamespacev1.AzureServiceBusNamespaceIdentityType]string{
	azureservicebusnamespacev1.AzureServiceBusNamespaceIdentityType_SYSTEM_ASSIGNED:          "SystemAssigned",
	azureservicebusnamespacev1.AzureServiceBusNamespaceIdentityType_USER_ASSIGNED:            "UserAssigned",
	azureservicebusnamespacev1.AzureServiceBusNamespaceIdentityType_SYSTEM_AND_USER_ASSIGNED: "SystemAssigned, UserAssigned",
}
...
// dials.
var networkDefaultActionStrings = map[azureservicebusnamespacev1.AzureServiceBusNetworkDefaultAction]string{
	azureservicebusnamespacev1.AzureServiceBusNetworkDefaultAction_azure_service_bus_network_default_action_unspecified: "Allow",
	azureservicebusnamespacev1.AzureServiceBusNetworkDefaultAction_ALLOW:                                                "Allow",
	azureservicebusnamespacev1.AzureServiceBusNetworkDefaultAction_DENY:                                                 "Deny",
}
