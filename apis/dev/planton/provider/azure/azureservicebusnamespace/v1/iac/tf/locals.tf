locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_service_bus_namespace"
  ...
  # Identity type wire values -- Service Bus namespaces support all
  # three managed-identity models.
  identity_type_map = {
  ...
  # Firewall default-action wire values. Unset keeps Azure's open
  # default -- the block may be declared just for trusted-services or
  # public-access dials.
