...
- [Azure Service Bus Queue](/docs/catalog/azure/azureservicebusqueue) -- point-to-point messaging
- [Azure Service Bus Topic](/docs/catalog/azure/azureservicebustopic) -- publish-subscribe
- [Azure Service Bus Authorization Rule](/docs/catalog/azure/azureservicebusauthorizationrule) -- least-privilege SAS credentials
- [Azure Service Bus Disaster Recovery Config](/docs/catalog/azure/azureservicebusdisasterrecoveryconfig) -- geo-DR pairing
