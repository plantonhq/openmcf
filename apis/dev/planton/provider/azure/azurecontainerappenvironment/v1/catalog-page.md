...
- [Azure Container App](/docs/catalog/azure/azurecontainerapp) -- continuously running services in this environment
- [Azure Container App Job](/docs/catalog/azure/azurecontainerappjob) -- run-to-completion workloads
- [Azure Container App Environment Storage](/docs/catalog/azure/azurecontainerappenvironmentstorage) -- mountable Azure Files shares
- [Azure Container App Environment Dapr Component](/docs/catalog/azure/azurecontainerappenvironmentdaprcomponent) -- Dapr building-block backends
- [Azure Subnet](/docs/catalog/azure/azuresubnet) -- the VNet-injection seam
- [Azure Log Analytics Workspace](/docs/catalog/azure/azureloganalyticsworkspace) -- the logging seam
