...
- [Azure Front Door Origin](/docs/catalog/azure/azurefrontdoororigin) -- the backends in this group
- [Azure Front Door Route](/docs/catalog/azure/azurefrontdoorroute) -- sends traffic to this group
