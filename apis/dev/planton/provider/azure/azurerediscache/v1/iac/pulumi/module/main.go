...
func Resources(ctx *pulumi.Context, stackInput *azurerediscachev1.AzureRedisCacheStackInput) error {
	...
	if spec.RedisConfiguration != nil {
		...
		if configuration.DataPersistenceAuthenticationMethod != azurerediscachev1.AzureRedisCachePersistenceAuthMethod_azure_redis_cache_persistence_auth_method_unspecified {
