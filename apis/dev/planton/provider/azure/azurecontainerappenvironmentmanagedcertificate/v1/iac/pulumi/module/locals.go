...
type Locals struct {
	AzureContainerAppEnvironmentManagedCertificate *azurecontainerappenvironmentmanagedcertificatev1.AzureContainerAppEnvironmentManagedCertificate
	EnvironmentId                                  string
	AzureTags                                      map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurecontainerappenvironmentmanagedcertificatev1.AzureContainerAppEnvironmentManagedCertificateStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureContainerAppEnvironmentManagedCertificate.String()),
	}
