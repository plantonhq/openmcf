...
The deployment polls until Azure's domain validation succeeds -- publish the DNS records first or the operation fails around the 30-minute mark. With the domain's zone on Azure DNS, declare both records as [Azure DNS Record](/docs/catalog/azure/azurednsrecord) resources in the same composition.
...
- [Azure Container App Custom Domain](/docs/catalog/azure/azurecontainerappcustomdomain) -- the binding Azure attaches this certificate to
- [Azure DNS Record](/docs/catalog/azure/azurednsrecord) -- the validation and routing records
- [Azure Container App Environment Certificate](/docs/catalog/azure/azurecontainerappenvironmentcertificate) -- bring your own certificate (EV/OV, wildcards, org CAs)
