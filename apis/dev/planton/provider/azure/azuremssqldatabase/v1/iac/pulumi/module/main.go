...
func Resources(ctx *pulumi.Context, stackInput *azuremssqldatabasev1.AzureMssqlDatabaseStackInput) error {
	...
	if spec.LicenseType != azuremssqldatabasev1.AzureMssqlDatabaseLicenseType_azure_mssql_database_license_type_unspecified {
	...
	if spec.EnclaveType != azuremssqldatabasev1.AzureMssqlDatabaseEnclaveType_azure_mssql_database_enclave_type_unspecified {
	...
	if spec.CreateMode != azuremssqldatabasev1.AzureMssqlDatabaseCreateMode_azure_mssql_database_create_mode_unspecified {
	...
	if spec.SecondaryType != azuremssqldatabasev1.AzureMssqlDatabaseSecondaryType_azure_mssql_database_secondary_type_unspecified {
	...
	if spec.StorageAccountType != azuremssqldatabasev1.AzureMssqlDatabaseBackupStorageAccountType_azure_mssql_database_backup_storage_account_type_unspecified {
