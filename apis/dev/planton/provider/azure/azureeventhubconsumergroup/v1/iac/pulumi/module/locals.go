...
type Locals struct {
	AzureEventHubConsumerGroup *azureeventhubconsumergroupv1.AzureEventHubConsumerGroup
	EventHubId                 string
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureeventhubconsumergroupv1.AzureEventHubConsumerGroupStackInput) *Locals {
	locals := &Locals{}
