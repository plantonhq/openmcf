...
type Locals struct {
	AzureEventHubDisasterRecoveryConfig *azureeventhubdisasterrecoveryconfigv1.AzureEventHubDisasterRecoveryConfig
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureeventhubdisasterrecoveryconfigv1.AzureEventHubDisasterRecoveryConfigStackInput) (*Locals, error) {
	locals := &Locals{}
