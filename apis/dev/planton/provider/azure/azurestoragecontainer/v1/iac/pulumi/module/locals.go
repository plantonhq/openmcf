...
type Locals struct {
	AzureStorageContainer *azurestoragecontainerv1.AzureStorageContainer
...
var containerAccessTypeStrings = map[azurestoragecontainerv1.AzureStorageContainerAccessType]string{
	azurestoragecontainerv1.AzureStorageContainerAccessType_PRIVATE:   "private",
	azurestoragecontainerv1.AzureStorageContainerAccessType_BLOB:      "blob",
	azurestoragecontainerv1.AzureStorageContainerAccessType_CONTAINER: "container",
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurestoragecontainerv1.AzureStorageContainerStackInput) *Locals {
	locals := &Locals{}
