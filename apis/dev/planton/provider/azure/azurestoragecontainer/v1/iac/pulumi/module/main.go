...
func Resources(ctx *pulumi.Context, stackInput *azurestoragecontainerv1.AzureStorageContainerStackInput) error {
	...
	if spec.ContainerAccessType != azurestoragecontainerv1.AzureStorageContainerAccessType_azure_storage_container_access_type_unspecified {
