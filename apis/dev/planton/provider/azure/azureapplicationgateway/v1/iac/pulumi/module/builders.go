...
func buildFrontendIpConfigurations(frontends []*azureapplicationgatewayv1.AzureApplicationGatewayFrontendIpConfiguration) network.ApplicationGatewayFrontendIpConfigurationArray {
	...
	for _, frontend := range frontends {
		...
		if frontend.PrivateIpAddressAllocation != azureapplicationgatewayv1.AzureApplicationGatewayIpAllocation_azure_application_gateway_ip_allocation_unspecified {
...
func buildFrontendPorts(ports []*azureapplicationgatewayv1.AzureApplicationGatewayFrontendPort) network.ApplicationGatewayFrontendPortArray {
...
func buildBackendAddressPools(pools []*azureapplicationgatewayv1.AzureApplicationGatewayBackendAddressPool) network.ApplicationGatewayBackendAddressPoolArray {
...
func buildBackendHttpSettings(settings []*azureapplicationgatewayv1.AzureApplicationGatewayBackendHttpSettings) network.ApplicationGatewayBackendHttpSettingArray {
...
func buildHttpListeners(listeners []*azureapplicationgatewayv1.AzureApplicationGatewayHttpListener) network.ApplicationGatewayHttpListenerArray {
...
func buildRequestRoutingRules(rules []*azureapplicationgatewayv1.AzureApplicationGatewayRequestRoutingRule) network.ApplicationGatewayRequestRoutingRuleArray {
...
func buildUrlPathMaps(pathMaps []*azureapplicationgatewayv1.AzureApplicationGatewayUrlPathMap) network.ApplicationGatewayUrlPathMapArray {
...
func buildProbes(probes []*azureapplicationgatewayv1.AzureApplicationGatewayProbe) network.ApplicationGatewayProbeArray {
...
func buildSslCertificates(certificates []*azureapplicationgatewayv1.AzureApplicationGatewaySslCertificate) network.ApplicationGatewaySslCertificateArray {
...
func buildTrustedRootCertificates(certificates []*azureapplicationgatewayv1.AzureApplicationGatewayTrustedRootCertificate) network.ApplicationGatewayTrustedRootCertificateArray {
...
func buildTrustedClientCertificates(certificates []*azureapplicationgatewayv1.AzureApplicationGatewayTrustedClientCertificate) network.ApplicationGatewayTrustedClientCertificateArray {
...
func buildSslProfiles(profiles []*azureapplicationgatewayv1.AzureApplicationGatewaySslProfile) network.ApplicationGatewaySslProfileArray {
	...
	for _, profile := range profiles {
		...
		if profile.VerifyClientCertificateRevocation == azureapplicationgatewayv1.AzureApplicationGatewayClientRevocationCheck_OCSP {
		...
		if profile.SslPolicy != nil {
			...
			if profile.SslPolicy.PolicyType != azureapplicationgatewayv1.AzureApplicationGatewaySslPolicyType_azure_application_gateway_ssl_policy_type_unspecified {
			...
			if profile.SslPolicy.MinProtocolVersion != azureapplicationgatewayv1.AzureApplicationGatewayTlsProtocol_azure_application_gateway_tls_protocol_unspecified {
...
func buildGlobalSslPolicy(policy *azureapplicationgatewayv1.AzureApplicationGatewaySslPolicy) *network.ApplicationGatewaySslPolicyArgs {
	args := &network.ApplicationGatewaySslPolicyArgs{}
	if policy.PolicyType != azureapplicationgatewayv1.AzureApplicationGatewaySslPolicyType_azure_application_gateway_ssl_policy_type_unspecified {
		args.PolicyType = pulumi.String(sslPolicyTypeStrings[policy.PolicyType])
	}
	if policy.PolicyName != "" {
		args.PolicyName = pulumi.String(policy.PolicyName)
	}
	if policy.MinProtocolVersion != azureapplicationgatewayv1.AzureApplicationGatewayTlsProtocol_azure_application_gateway_tls_protocol_unspecified {
...
func buildRedirectConfigurations(redirects []*azureapplicationgatewayv1.AzureApplicationGatewayRedirectConfiguration) network.ApplicationGatewayRedirectConfigurationArray {
...
func buildRewriteRuleSets(ruleSets []*azureapplicationgatewayv1.AzureApplicationGatewayRewriteRuleSet) network.ApplicationGatewayRewriteRuleSetArray {
	...
	for _, ruleSet := range ruleSets {
		...
		for _, rule := range ruleSet.RewriteRules {
			...
			if rule.Url != nil {
				...
				if rule.Url.Components != azureapplicationgatewayv1.AzureApplicationGatewayRewriteRuleUrlComponent_azure_application_gateway_rewrite_rule_url_component_unspecified {
...
func buildLayer4Listeners(listeners []*azureapplicationgatewayv1.AzureApplicationGatewayLayer4Listener) network.ApplicationGatewayListenerArray {
...
func buildLayer4Backends(backends []*azureapplicationgatewayv1.AzureApplicationGatewayLayer4BackendSettings) network.ApplicationGatewayBackendArray {
...
func buildLayer4RoutingRules(rules []*azureapplicationgatewayv1.AzureApplicationGatewayLayer4RoutingRule) network.ApplicationGatewayRoutingRuleArray {
...
func buildCustomErrorConfigurations(configs []*azureapplicationgatewayv1.AzureApplicationGatewayCustomErrorConfiguration) network.ApplicationGatewayCustomErrorConfigurationArray {
...
func buildPrivateLinkConfigurations(configs []*azureapplicationgatewayv1.AzureApplicationGatewayPrivateLinkConfiguration) network.ApplicationGatewayPrivateLinkConfigurationArray {
