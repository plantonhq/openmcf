...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurecontainerapp/v1alpha1/spec.proto
...
func (AzureContainerAppRevisionMode) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureContainerAppRevisionMode) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureContainerAppRevisionMode) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureContainerAppProbeTransport) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureContainerAppProbeTransport) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureContainerAppProbeTransport) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureContainerAppVolumeStorageType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureContainerAppVolumeStorageType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureContainerAppVolumeStorageType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (AzureContainerAppIngressTransport) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[3].Descriptor()
}

func (AzureContainerAppIngressTransport) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[3]
}
...
func (AzureContainerAppIngressTransport) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (AzureContainerAppIngressClientCertificateMode) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[4].Descriptor()
}

func (AzureContainerAppIngressClientCertificateMode) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[4]
}
...
func (AzureContainerAppIngressClientCertificateMode) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (AzureContainerAppIpRestrictionAction) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[5].Descriptor()
}

func (AzureContainerAppIpRestrictionAction) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[5]
}
...
func (AzureContainerAppIpRestrictionAction) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (AzureContainerAppDaprProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[6].Descriptor()
}

func (AzureContainerAppDaprProtocol) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[6]
}
...
func (AzureContainerAppDaprProtocol) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (AzureContainerAppIdentityType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[7].Descriptor()
}

func (AzureContainerAppIdentityType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes[7]
}
...
func (AzureContainerAppIdentityType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
type AzureContainerAppSpec struct {
	...
	RevisionMode AzureContainerAppRevisionMode `protobuf:"varint,4,opt,name=revision_mode,json=revisionMode,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppRevisionMode" json:"revision_mode,omitempty"`
...
func (x *AzureContainerAppSpec) Reset() {
	*x = AzureContainerAppSpec{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[0]
...
func (x *AzureContainerAppContainer) Reset() {
	*x = AzureContainerAppContainer{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureContainerAppInitContainer) Reset() {
	*x = AzureContainerAppInitContainer{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureContainerAppEnvVar) Reset() {
	*x = AzureContainerAppEnvVar{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureContainerAppProbe struct {
	...
	Transport AzureContainerAppProbeTransport `protobuf:"varint,1,opt,name=transport,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeTransport" json:"transport,omitempty"`
...
func (x *AzureContainerAppProbe) Reset() {
	*x = AzureContainerAppProbe{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureContainerAppProbeHeader) Reset() {
	*x = AzureContainerAppProbeHeader{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureContainerAppVolumeMount) Reset() {
	*x = AzureContainerAppVolumeMount{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureContainerAppVolume struct {
	...
	StorageType AzureContainerAppVolumeStorageType `protobuf:"varint,2,opt,name=storage_type,json=storageType,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeStorageType" json:"storage_type,omitempty"`
...
func (x *AzureContainerAppVolume) Reset() {
	*x = AzureContainerAppVolume{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureContainerAppSecret) Reset() {
	*x = AzureContainerAppSecret{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppSecret) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AzureContainerAppRegistry) Reset() {
	*x = AzureContainerAppRegistry{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppRegistry) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
type AzureContainerAppIngress struct {
	...
	// raw TCP protocols.
	Transport AzureContainerAppIngressTransport `protobuf:"varint,4,opt,name=transport,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressTransport" json:"transport,omitempty"`
	...
	ClientCertificateMode AzureContainerAppIngressClientCertificateMode `protobuf:"varint,6,opt,name=client_certificate_mode,json=clientCertificateMode,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressClientCertificateMode" json:"client_certificate_mode,omitempty"`
...
func (x *AzureContainerAppIngress) Reset() {
	*x = AzureContainerAppIngress{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppIngress) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *AzureContainerAppTrafficWeight) Reset() {
	*x = AzureContainerAppTrafficWeight{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppTrafficWeight) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
type AzureContainerAppIpSecurityRestriction struct {
	...
	Action AzureContainerAppIpRestrictionAction `protobuf:"varint,2,opt,name=action,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpRestrictionAction" json:"action,omitempty"`
...
func (x *AzureContainerAppIpSecurityRestriction) Reset() {
	*x = AzureContainerAppIpSecurityRestriction{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppIpSecurityRestriction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *AzureContainerAppCors) Reset() {
	*x = AzureContainerAppCors{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppCors) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *AzureContainerAppHttpScaleRule) Reset() {
	*x = AzureContainerAppHttpScaleRule{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppHttpScaleRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *AzureContainerAppTcpScaleRule) Reset() {
	*x = AzureContainerAppTcpScaleRule{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppTcpScaleRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *AzureContainerAppAzureQueueScaleRule) Reset() {
	*x = AzureContainerAppAzureQueueScaleRule{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppAzureQueueScaleRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{16}
}
...
func (x *AzureContainerAppCustomScaleRule) Reset() {
	*x = AzureContainerAppCustomScaleRule{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppCustomScaleRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{17}
}
...
func (x *AzureContainerAppScaleRuleAuth) Reset() {
	*x = AzureContainerAppScaleRuleAuth{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppScaleRuleAuth) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{18}
}
...
type AzureContainerAppDapr struct {
	...
	// DAPR_HTTP.
	AppProtocol   AzureContainerAppDaprProtocol `protobuf:"varint,3,opt,name=app_protocol,json=appProtocol,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDaprProtocol" json:"app_protocol,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AzureContainerAppDapr) Reset() {
	*x = AzureContainerAppDapr{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppDapr) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{19}
}
...
type AzureContainerAppIdentity struct {
	...
	Type AzureContainerAppIdentityType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentityType" json:"type,omitempty"`
...
func (x *AzureContainerAppIdentity) Reset() {
	*x = AzureContainerAppIdentity{}
	mi := &file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureContainerAppIdentity) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP(), []int{20}
}
...
var File_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/azure/azurecontainerapp/v1alpha1/spec.proto\x125dev.planton.provider.azure.azurecontainerapp.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xb4\x18\n" +
	...
	"\x1ccontainer_app_environment_id\x18\x03 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB,\xbaH\x03\xc8\x01\x01\x88\xd4a\xf8\x0f\x92\xd4a\x1dstatus.outputs.environment_idR\x19containerAppEnvironmentId\x12\x83\x01\n" +
	"\rrevision_mode\x18\x04 \x01(\x0e2T.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppRevisionModeB\b\xbaH\x05\x82\x01\x02\x10\x01R\frevisionMode\x122\n" +
	"\x15workload_profile_name\x18\x05 \x01(\tR\x13workloadProfileName\x12D\n" +
	"\x16max_inactive_revisions\x18\x06 \x01(\x05B\t\xbaH\x06\x1a\x04\x18d(\x00H\x00R\x14maxInactiveRevisions\x88\x01\x01\x12{\n" +
	"\n" +
	"containers\x18\a \x03(\v2Q.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainerB\b\xbaH\x05\x92\x01\x02\b\x01R\n" +
	"containers\x12~\n" +
	"\x0finit_containers\x18\b \x03(\v2U.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppInitContainerR\x0einitContainers\x12h\n" +
	"\avolumes\x18\t \x03(\v2N.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeR\avolumes\x127\n" +
	"\fmin_replicas\x18\n" +
	...
	" termination_grace_period_seconds\x18\x0f \x01(\x05B\x0f\xbaH\a\x1a\x05\x18\xd8\x04(\x00\x8a\xa6\x1d\x010H\x05R\x1dterminationGracePeriodSeconds\x88\x01\x01\x12\x7f\n" +
	"\x10http_scale_rules\x18\x10 \x03(\v2U.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppHttpScaleRuleR\x0ehttpScaleRules\x12|\n" +
	"\x0ftcp_scale_rules\x18\x11 \x03(\v2T.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppTcpScaleRuleR\rtcpScaleRules\x12\x92\x01\n" +
	"\x17azure_queue_scale_rules\x18\x12 \x03(\v2[.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppAzureQueueScaleRuleR\x14azureQueueScaleRules\x12\x85\x01\n" +
	"\x12custom_scale_rules\x18\x13 \x03(\v2W.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRuleR\x10customScaleRules\x12h\n" +
	"\asecrets\x18\x14 \x03(\v2N.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSecretR\asecrets\x12p\n" +
	"\n" +
	"registries\x18\x15 \x03(\v2P.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppRegistryR\n" +
	"registries\x12i\n" +
	"\aingress\x18\x16 \x01(\v2O.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressR\aingress\x12`\n" +
	"\x04dapr\x18\x17 \x01(\v2L.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDaprR\x04dapr\x12l\n" +
	"\bidentity\x18\x18 \x01(\v2P.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentityR\bidentity\x12j\n" +
	"\x04tags\x18\x19 \x03(\v2V.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"!_termination_grace_period_seconds\"\xdf\r\n" +
	...
	"\x03env\x18\x05 \x03(\v2N.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppEnvVarR\x03env\x12\x18\n" +
	"\acommand\x18\x06 \x03(\tR\acommand\x12\x12\n" +
	"\x04args\x18\a \x03(\tR\x04args\x12t\n" +
	"\x0eliveness_probe\x18\b \x01(\v2M.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeR\rlivenessProbe\x12v\n" +
	"\x0freadiness_probe\x18\t \x01(\v2M.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeR\x0ereadinessProbe\x12r\n" +
	"\rstartup_probe\x18\n" +
	" \x01(\v2M.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeR\fstartupProbe\x12x\n" +
	"\rvolume_mounts\x18\v \x03(\v2S.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeMountR\fvolumeMounts:\xea\x05\xbaH\xe6\x05\x1a\xcd\x02\n" +
	...
	"\x1dcontainer_startup_probe_shape\x125startup probes do not support success_count_threshold\x1aL!has(this.startup_probe) || !has(this.startup_probe.success_count_threshold)\"\x9f\x05\n" +
	...
	"\x03env\x18\x05 \x03(\v2N.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppEnvVarR\x03env\x12\x18\n" +
	"\acommand\x18\x06 \x03(\tR\acommand\x12\x12\n" +
	"\x04args\x18\a \x03(\tR\x04args\x12x\n" +
	"\rvolume_mounts\x18\b \x03(\v2S.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeMountR\fvolumeMountsB\x06\n" +
	"\x04_cpuB\t\n" +
	"\a_memory\"\xd5\x02\n" +
	...
	"\x18env_var_value_xor_secret\x12\x8f\x01an environment variable takes either a literal value or a secret_name, not both -- move the literal into the app's secrets list to reference it\x1a-!(this.value != '' && this.secret_name != '')\"\xb6\x06\n" +
	"\x16AzureContainerAppProbe\x12\x80\x01\n" +
	"\ttransport\x18\x01 \x01(\x0e2V.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeTransportB\n" +
	...
	"\aheaders\x18\x05 \x03(\v2S.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeHeaderR\aheaders\x12G\n" +
	...
	"\bsub_path\x18\x03 \x01(\tR\asubPath\"\xed\x04\n" +
	"\x17AzureContainerAppVolume\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12\x86\x01\n" +
	"\fstorage_type\x18\x02 \x01(\x0e2Y.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeStorageTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\vstorageType\x12{\n" +
	...
	"\x12registry_auth_mode\x12\xb3\x01a registry authenticates with either a managed identity or a username + password_secret_name pair -- exactly one mode, and username and password_secret_name always travel together\x1a\xa2\x01(this.identity != '' && this.username == '' && this.password_secret_name == '') || (this.identity == '' && this.username != '' && this.password_secret_name != '')\"\xb3\t\n" +
	...
	"targetPort\x123\n" +
	"\fexposed_port\x18\x03 \x01(\x05B\v\xbaH\b\x1a\x06\x18\xff\xff\x03(\x01H\x01R\vexposedPort\x88\x01\x01\x12\x80\x01\n" +
	"\ttransport\x18\x04 \x01(\x0e2X.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressTransportB\b\xbaH\x05\x82\x01\x02\x10\x01R\ttransport\x12L\n" +
	"\x1aallow_insecure_connections\x18\x05 \x01(\bB\t\x8a\xa6\x1d\x05falseH\x02R\x18allowInsecureConnections\x88\x01\x01\x12\xa6\x01\n" +
	"\x17client_certificate_mode\x18\x06 \x01(\x0e2d.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressClientCertificateModeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x15clientCertificateMode\x12\x86\x01\n" +
	"\x0etraffic_weight\x18\a \x03(\v2U.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppTrafficWeightB\b\xbaH\x05\x92\x01\x02\b\x01R\rtrafficWeight\x12\x97\x01\n" +
	"\x18ip_security_restrictions\x18\b \x03(\v2].dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpSecurityRestrictionR\x16ipSecurityRestrictions\x12`\n" +
	"\x04cors\x18\t \x01(\v2L.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCorsR\x04cors:\xb4\x01\xbaH\xb0\x01\x1a\xad\x01\n" +
	...
	"\x10_latest_revision\"\xa1\x02\n" +
	"&AzureContainerAppIpSecurityRestriction\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12\x7f\n" +
	"\x06action\x18\x02 \x01(\x0e2[.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpRestrictionActionB\n" +
	...
	"\x1a_allow_credentials_enabled\"\x96\x03\n" +
	...
	"&http_rule_concurrent_requests_positive\x12Nconcurrent_requests must be a positive integer written as a string, e.g. \"100\"\x1a\x1dthis.matches('^[1-9][0-9]*$')\xc8\x01\x01R\x12concurrentRequests\x12}\n" +
	"\x0eauthentication\x18\x03 \x03(\v2U.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuthR\x0eauthentication\"\x94\x03\n" +
	...
	"%tcp_rule_concurrent_requests_positive\x12Nconcurrent_requests must be a positive integer written as a string, e.g. \"100\"\x1a\x1dthis.matches('^[1-9][0-9]*$')\xc8\x01\x01R\x12concurrentRequests\x12}\n" +
	"\x0eauthentication\x18\x03 \x03(\v2U.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuthR\x0eauthentication\"\xa5\x04\n" +
	...
	"\fqueue_length\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\vqueueLength\x12\x87\x01\n" +
	"\x0eauthentication\x18\x04 \x03(\v2U.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuthB\b\xbaH\x05\x92\x01\x02\b\x01R\x0eauthentication:\xfb\x01\xbaH\xf7\x01\x1a\xf4\x01\n" +
	"!queue_rule_auth_trigger_parameter\x12\x97\x01Azure Queue scale rule authentication entries must set trigger_parameter (typically \"connection\") so KEDA knows which scaler parameter the secret feeds\x1a5this.authentication.all(a, a.trigger_parameter != '')\"\x8f\x10\n" +
	...
	"secretName\x12+\n" +
	"\x11trigger_parameter\x18\x02 \x01(\tR\x10triggerParameter\"\xeb\x01\n" +
	"\x15AzureContainerAppDapr\x12!\n" +
	"\x06app_id\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x05appId\x12\x1e\n" +
	"\bapp_port\x18\x02 \x01(\x05H\x00R\aappPort\x88\x01\x01\x12\x81\x01\n" +
	"\fapp_protocol\x18\x03 \x01(\x0e2T.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDaprProtocolB\b\xbaH\x05\x82\x01\x02\x10\x01R\vappProtocolB\v\n" +
	"\t_app_port\"\xe1\x04\n" +
	"\x19AzureContainerAppIdentity\x12t\n" +
	"\x04type\x18\x01 \x01(\x0e2T.dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentityTypeB\n" +
	...
	"9com.dev.planton.provider.azure.azurecontainerapp.v1alpha1B\tSpecProtoP\x01Zqgithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azurecontainerapp/v1alpha1;azurecontainerappv1alpha1\xa2\x02\x05DPPAA\xaa\x025Dev.Planton.Provider.Azure.Azurecontainerapp.V1alpha1\xca\x025Dev\\Planton\\Provider\\Azure\\Azurecontainerapp\\V1alpha1\xe2\x02ADev\\Planton\\Provider\\Azure\\Azurecontainerapp\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Azure::Azurecontainerapp::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_goTypes = []any{
	(AzureContainerAppRevisionMode)(0),                 // 0: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppRevisionMode
	(AzureContainerAppProbeTransport)(0),               // 1: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeTransport
	(AzureContainerAppVolumeStorageType)(0),            // 2: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeStorageType
	(AzureContainerAppIngressTransport)(0),             // 3: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressTransport
	(AzureContainerAppIngressClientCertificateMode)(0), // 4: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressClientCertificateMode
	(AzureContainerAppIpRestrictionAction)(0),          // 5: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpRestrictionAction
	(AzureContainerAppDaprProtocol)(0),                 // 6: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDaprProtocol
	(AzureContainerAppIdentityType)(0),                 // 7: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentityType
	(*AzureContainerAppSpec)(nil),                      // 8: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec
	(*AzureContainerAppContainer)(nil),                 // 9: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainer
	(*AzureContainerAppInitContainer)(nil),             // 10: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppInitContainer
	(*AzureContainerAppEnvVar)(nil),                    // 11: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppEnvVar
	(*AzureContainerAppProbe)(nil),                     // 12: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbe
	(*AzureContainerAppProbeHeader)(nil),               // 13: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeHeader
	(*AzureContainerAppVolumeMount)(nil),               // 14: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeMount
	(*AzureContainerAppVolume)(nil),                    // 15: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolume
	(*AzureContainerAppSecret)(nil),                    // 16: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSecret
	(*AzureContainerAppRegistry)(nil),                  // 17: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppRegistry
	(*AzureContainerAppIngress)(nil),                   // 18: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngress
	(*AzureContainerAppTrafficWeight)(nil),             // 19: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppTrafficWeight
	(*AzureContainerAppIpSecurityRestriction)(nil),     // 20: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpSecurityRestriction
	(*AzureContainerAppCors)(nil),                      // 21: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCors
	(*AzureContainerAppHttpScaleRule)(nil),             // 22: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppHttpScaleRule
	(*AzureContainerAppTcpScaleRule)(nil),              // 23: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppTcpScaleRule
	(*AzureContainerAppAzureQueueScaleRule)(nil),       // 24: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppAzureQueueScaleRule
	(*AzureContainerAppCustomScaleRule)(nil),           // 25: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRule
	(*AzureContainerAppScaleRuleAuth)(nil),             // 26: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuth
	(*AzureContainerAppDapr)(nil),                      // 27: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDapr
	(*AzureContainerAppIdentity)(nil),                  // 28: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentity
	nil,                                                // 29: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.TagsEntry
	nil,                                                // 30: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRule.MetadataEntry
	(*v1.StringValueOrRef)(nil),                        // 31: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_depIdxs = []int32{
	31, // 0: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	31, // 1: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.container_app_environment_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 2: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.revision_mode:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppRevisionMode
	9,  // 3: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.containers:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainer
	10, // 4: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.init_containers:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppInitContainer
	15, // 5: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.volumes:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolume
	22, // 6: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.http_scale_rules:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppHttpScaleRule
	23, // 7: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.tcp_scale_rules:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppTcpScaleRule
	24, // 8: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.azure_queue_scale_rules:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppAzureQueueScaleRule
	25, // 9: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.custom_scale_rules:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRule
	16, // 10: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.secrets:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSecret
	17, // 11: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.registries:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppRegistry
	18, // 12: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.ingress:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngress
	27, // 13: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.dapr:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDapr
	28, // 14: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.identity:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentity
	29, // 15: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.tags:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppSpec.TagsEntry
	11, // 16: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainer.env:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppEnvVar
	12, // 17: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainer.liveness_probe:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbe
	12, // 18: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainer.readiness_probe:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbe
	12, // 19: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainer.startup_probe:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbe
	14, // 20: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppContainer.volume_mounts:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeMount
	11, // 21: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppInitContainer.env:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppEnvVar
	14, // 22: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppInitContainer.volume_mounts:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeMount
	1,  // 23: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbe.transport:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeTransport
	13, // 24: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbe.headers:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppProbeHeader
	2,  // 25: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolume.storage_type:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolumeStorageType
	31, // 26: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppVolume.storage_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 27: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngress.transport:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressTransport
	4,  // 28: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngress.client_certificate_mode:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngressClientCertificateMode
	19, // 29: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngress.traffic_weight:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppTrafficWeight
	20, // 30: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngress.ip_security_restrictions:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpSecurityRestriction
	21, // 31: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIngress.cors:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCors
	5,  // 32: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpSecurityRestriction.action:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIpRestrictionAction
	26, // 33: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppHttpScaleRule.authentication:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuth
	26, // 34: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppTcpScaleRule.authentication:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuth
	26, // 35: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppAzureQueueScaleRule.authentication:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuth
	30, // 36: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRule.metadata:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRule.MetadataEntry
	26, // 37: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRule.authentication:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppScaleRuleAuth
	31, // 38: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppCustomScaleRule.identity_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 39: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDapr.app_protocol:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppDaprProtocol
	7,  // 40: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentity.type:type_name -> dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentityType
	31, // 41: dev.planton.provider.azure.azurecontainerapp.v1alpha1.AzureContainerAppIdentity.user_assigned_identity_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[10].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[11].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[13].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes[19].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   23,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurecontainerapp_v1alpha1_spec_proto_depIdxs = nil
}
