...
func Resources(ctx *pulumi.Context, stackInput *azurefirewallpolicyrulecollectiongroupv1.AzureFirewallPolicyRuleCollectionGroupStackInput) error {
...
func protocolWireValues(protocols []azurefirewallpolicyrulecollectiongroupv1.AzureFirewallPolicyRuleProtocol) []string {
