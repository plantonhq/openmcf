...
func Resources(ctx *pulumi.Context, stackInput *azurelinuxwebappv1.AzureLinuxWebAppStackInput) error {
	...
	if spec.ClientCertificateMode != azurelinuxwebappv1.AzureLinuxWebAppClientCertificateMode_azure_linux_web_app_client_certificate_mode_unspecified {
...
func buildSiteConfig(spec *azurelinuxwebappv1.AzureLinuxWebAppSpec) *appservice.LinuxWebAppSiteConfigArgs {
	...
	minTls := "1.2"
	if sc.MinimumTlsVersion != azurelinuxwebappv1.AzureLinuxWebAppTlsVersion_azure_linux_web_app_tls_version_unspecified {
		minTls = tlsVersionStrings[sc.MinimumTlsVersion]
	}
	siteConfig.MinimumTlsVersion = pulumi.StringPtr(minTls)

	scmMinTls := "1.2"
	if sc.ScmMinimumTlsVersion != azurelinuxwebappv1.AzureLinuxWebAppTlsVersion_azure_linux_web_app_tls_version_unspecified {
	...
	ftpsState := "Disabled"
	if sc.FtpsState != azurelinuxwebappv1.AzureLinuxWebAppFtpsState_azure_linux_web_app_ftps_state_unspecified {
		ftpsState = ftpsStateStrings[sc.FtpsState]
	}
	siteConfig.FtpsState = pulumi.StringPtr(ftpsState)

	loadBalancing := "LeastRequests"
	if sc.LoadBalancingMode != azurelinuxwebappv1.AzureLinuxWebAppLoadBalancingMode_azure_linux_web_app_load_balancing_mode_unspecified {
	...
	if sc.ManagedPipelineMode != azurelinuxwebappv1.AzureLinuxWebAppManagedPipelineMode_azure_linux_web_app_managed_pipeline_mode_unspecified {
	...
	if sc.IpRestrictionDefaultAction != azurelinuxwebappv1.AzureLinuxWebAppIpRestrictionAction_azure_linux_web_app_ip_restriction_action_unspecified {
	...
	if sc.ScmIpRestrictionDefaultAction != azurelinuxwebappv1.AzureLinuxWebAppIpRestrictionAction_azure_linux_web_app_ip_restriction_action_unspecified {
...
func buildAutoHealSetting(spec *azurelinuxwebappv1.AzureLinuxWebAppAutoHealSetting) *appservice.LinuxWebAppSiteConfigAutoHealSettingArgs {
...
func buildApplicationStack(stack *azurelinuxwebappv1.AzureLinuxWebAppApplicationStack) *appservice.LinuxWebAppSiteConfigApplicationStackArgs {
	...
	if stack.JavaServer != azurelinuxwebappv1.AzureLinuxWebAppJavaServer_azure_linux_web_app_java_server_unspecified {
...
func buildIpRestrictions(specs []*azurelinuxwebappv1.AzureLinuxWebAppIpRestriction) appservice.LinuxWebAppSiteConfigIpRestrictionArray {
	...
	for _, r := range specs {
		...
		action := "Allow"
		if r.Action != azurelinuxwebappv1.AzureLinuxWebAppIpRestrictionAction_azure_linux_web_app_ip_restriction_action_unspecified {
...
func buildLogs(spec *azurelinuxwebappv1.AzureLinuxWebAppLogs) *appservice.LinuxWebAppLogsArgs {
	...
	if spec.ApplicationLogs != nil {
		...
		if spec.ApplicationLogs.FileSystemLevel != azurelinuxwebappv1.AzureLinuxWebAppLogLevel_azure_linux_web_app_log_level_unspecified {
...
func buildBackup(spec *azurelinuxwebappv1.AzureLinuxWebAppBackup) *appservice.LinuxWebAppBackupArgs {
...
func buildAuthSettingsV2(spec *azurelinuxwebappv1.AzureLinuxWebAppAuthSettingsV2) *appservice.LinuxWebAppAuthSettingsV2Args {
	...
	if spec.UnauthenticatedAction != azurelinuxwebappv1.AzureLinuxWebAppUnauthenticatedAction_azure_linux_web_app_unauthenticated_action_unspecified {
	...
	if spec.ForwardProxyConvention != azurelinuxwebappv1.AzureLinuxWebAppForwardProxyConvention_azure_linux_web_app_forward_proxy_convention_unspecified {
...
func buildAuthV2Login(spec *azurelinuxwebappv1.AzureLinuxWebAppAuthV2Login) *appservice.LinuxWebAppAuthSettingsV2LoginArgs {
	...
	if spec.CookieExpirationConvention != azurelinuxwebappv1.AzureLinuxWebAppCookieExpirationConvention_azure_linux_web_app_cookie_expiration_convention_unspecified {
