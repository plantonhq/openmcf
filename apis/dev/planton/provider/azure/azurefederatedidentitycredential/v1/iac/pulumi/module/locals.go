...
type Locals struct {
	AzureFederatedIdentityCredential *azurefederatedidentitycredentialv1.AzureFederatedIdentityCredential
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurefederatedidentitycredentialv1.AzureFederatedIdentityCredentialStackInput) *Locals {
	locals := &Locals{}
