...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurefederatedidentitycredential/v1/spec.proto
...
func (x *AzureFederatedIdentityCredentialSpec) Reset() {
	*x = AzureFederatedIdentityCredentialSpec{}
	mi := &file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_msgTypes[0]
...
func (*AzureFederatedIdentityCredentialSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDesc = "" +
	...
	"\t_audienceB\xf4\x03\n" +
	"Bcom.dev.planton.provider.azure.azurefederatedidentitycredential.v1B\tSpecProtoP\x01Z\x83\x01github.com/plantonhq/planton/apis/dev/planton/provider/azure/azurefederatedidentitycredential/v1;azurefederatedidentitycredentialv1\xa2\x02\x05DPPAA\xaa\x02>Dev.Planton.Provider.Azure.Azurefederatedidentitycredential.V1\xca\x02>Dev\\Planton\\Provider\\Azure\\Azurefederatedidentitycredential\\V1\xe2\x02JDev\\Planton\\Provider\\Azure\\Azurefederatedidentitycredential\\V1\\GPBMetadata\xea\x02CDev::Planton::Provider::Azure::Azurefederatedidentitycredential::V1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_goTypes = []any{
	(*AzureFederatedIdentityCredentialSpec)(nil), // 0: dev.planton.provider.azure.azurefederatedidentitycredential.v1.AzureFederatedIdentityCredentialSpec
...
func file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto = out.File
	file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurefederatedidentitycredential_v1_spec_proto_depIdxs = nil
}
