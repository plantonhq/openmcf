...
- [AzureResourceGroup](/docs/catalog/azure/azureresourcegroup) -- the resource group for load balancer placement
- [AzurePublicIp](/docs/catalog/azure/azurepublicip) -- Standard SKU public IPs for public frontends
- [AzurePublicIpPrefix](/docs/catalog/azure/azurepublicipprefix) -- reserved contiguous ranges for SNAT-scaling frontends
- [AzureSubnet](/docs/catalog/azure/azuresubnet) -- subnets for internal frontends
- [AzureNetworkInterface](/docs/catalog/azure/azurenetworkinterface) -- joins backend pools and completes NAT rules from the member side
- [AzureDnsRecord](/docs/catalog/azure/azurednsrecord) -- DNS records pointing at frontend addresses
