...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurenetworksecuritygroup/v1alpha1/spec.proto
...
func (AzureNetworkSecurityGroupRuleDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureNetworkSecurityGroupRuleDirection) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureNetworkSecurityGroupRuleDirection) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureNetworkSecurityGroupRuleAccess) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureNetworkSecurityGroupRuleAccess) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureNetworkSecurityGroupRuleAccess) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureNetworkSecurityGroupRuleProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureNetworkSecurityGroupRuleProtocol) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureNetworkSecurityGroupRuleProtocol) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AzureNetworkSecurityGroupSpec) Reset() {
	*x = AzureNetworkSecurityGroupSpec{}
	mi := &file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes[0]
...
type AzureNetworkSecurityGroupRule struct {
	...
	Direction AzureNetworkSecurityGroupRuleDirection `protobuf:"varint,4,opt,name=direction,proto3,enum=dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirection" json:"direction,omitempty"`
	// Whether matching traffic is permitted (ALLOW) or blocked (DENY).
	Access AzureNetworkSecurityGroupRuleAccess `protobuf:"varint,5,opt,name=access,proto3,enum=dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccess" json:"access,omitempty"`
	// The network protocol the rule matches. ANY matches everything; AH and
	// ESP match IPsec traffic (site-to-site VPN scenarios).
	Protocol AzureNetworkSecurityGroupRuleProtocol `protobuf:"varint,6,opt,name=protocol,proto3,enum=dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocol" json:"protocol,omitempty"`
...
func (x *AzureNetworkSecurityGroupRule) Reset() {
	*x = AzureNetworkSecurityGroupRule{}
	mi := &file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Hdev/planton/provider/azure/azurenetworksecuritygroup/v1alpha1/spec.proto\x12=dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xa8\x06\n" +
	...
	"\x0fnsg_name_format\x12\x93\x01NSG names start with a letter or number, end with a letter, number, or underscore, and may contain alphanumerics, underscores, periods, and hyphens\x1aIthis == '' || this.matches('^[a-zA-Z0-9]([a-zA-Z0-9._-]*[a-zA-Z0-9_])?$')\xc8\x01\x01r\x04\x10\x01\x18PR\x04name\x12\x83\x01\n" +
	"\x0esecurity_rules\x18\x04 \x03(\v2\\.dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleR\rsecurityRules\x12z\n" +
	"\x04tags\x18\x05 \x03(\v2f.dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x90\x15\n" +
	...
	"\xc8\x01\x01\x1a\x05\x18\x80 (dR\bpriority\x12\x90\x01\n" +
	"\tdirection\x18\x04 \x01(\x0e2e.dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirectionB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\tdirection\x12\x87\x01\n" +
	"\x06access\x18\x05 \x01(\x0e2b.dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccessB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x06access\x12\x8d\x01\n" +
	"\bprotocol\x18\x06 \x01(\x0e2d.dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocolB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\bprotocol\x12/\n" +
	...
	"\x02AH\x10\x05\x12\a\n" +
	"\x03ESP\x10\x06B\xed\x03\n" +
	"Acom.dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1B\tSpecProtoP\x01Z\x81\x01github.com/plantonhq/planton/apis/dev/planton/provider/azure/azurenetworksecuritygroup/v1alpha1;azurenetworksecuritygroupv1alpha1\xa2\x02\x05DPPAA\xaa\x02=Dev.Planton.Provider.Azure.Azurenetworksecuritygroup.V1alpha1\xca\x02=Dev\\Planton\\Provider\\Azure\\Azurenetworksecuritygroup\\V1alpha1\xe2\x02IDev\\Planton\\Provider\\Azure\\Azurenetworksecuritygroup\\V1alpha1\\GPBMetadata\xea\x02BDev::Planton::Provider::Azure::Azurenetworksecuritygroup::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_goTypes = []any{
	(AzureNetworkSecurityGroupRuleDirection)(0), // 0: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirection
	(AzureNetworkSecurityGroupRuleAccess)(0),    // 1: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccess
	(AzureNetworkSecurityGroupRuleProtocol)(0),  // 2: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocol
	(*AzureNetworkSecurityGroupSpec)(nil),       // 3: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec
	(*AzureNetworkSecurityGroupRule)(nil),       // 4: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule
	nil,                                         // 5: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),                 // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.security_rules:type_name -> dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule
	5, // 2: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.tags:type_name -> dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.TagsEntry
	0, // 3: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.direction:type_name -> dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirection
	1, // 4: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.access:type_name -> dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccess
	2, // 5: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.protocol:type_name -> dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocol
	6, // 6: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.source_application_security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 7: dev.planton.provider.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.destination_application_security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_depIdxs = nil
}
