...
type Locals struct {
	AzureCosmosdbSqlRoleDefinition *azurecosmosdbsqlroledefinitionv1.AzureCosmosdbSqlRoleDefinition
	CosmosdbAccountId              string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurecosmosdbsqlroledefinitionv1.AzureCosmosdbSqlRoleDefinitionStackInput) *Locals {
	locals := &Locals{}
