...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurefrontdoorroute/v1/spec.proto
...
func (AzureFrontDoorRouteProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureFrontDoorRouteProtocol) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes[0]
}
...
func (AzureFrontDoorRouteProtocol) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureFrontDoorRouteForwardingProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureFrontDoorRouteForwardingProtocol) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes[1]
}
...
func (AzureFrontDoorRouteForwardingProtocol) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureFrontDoorRouteQueryStringCachingBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureFrontDoorRouteQueryStringCachingBehavior) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes[2]
}
...
func (AzureFrontDoorRouteQueryStringCachingBehavior) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AzureFrontDoorRouteSpec) Reset() {
	*x = AzureFrontDoorRouteSpec{}
	mi := &file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_msgTypes[0]
...
func (x *AzureFrontDoorRouteCache) Reset() {
	*x = AzureFrontDoorRouteCache{}
	mi := &file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDesc = "" +
	...
	"\b_enabledB\x0e\n" +
	"\f_origin_path\"\xa7\f\n" +
	"\x18AzureFrontDoorRouteCache\x12\xad\x01\n" +
	"\x1dquery_string_caching_behavior\x18\x01 \x01(\x0e2`.dev.planton.provider.azure.azurefrontdoorroute.v1.AzureFrontDoorRouteQueryStringCachingBehaviorB\b\xbaH\x05\x82\x01\x02\x10\x01R\x1aqueryStringCachingBehavior\x12\x9f\x01\n" +
	...
	"\x1fINCLUDE_SPECIFIED_QUERY_STRINGS\x10\x04B\x98\x03\n" +
	"5com.dev.planton.provider.azure.azurefrontdoorroute.v1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azurefrontdoorroute/v1;azurefrontdoorroutev1\xa2\x02\x05DPPAA\xaa\x021Dev.Planton.Provider.Azure.Azurefrontdoorroute.V1\xca\x021Dev\\Planton\\Provider\\Azure\\Azurefrontdoorroute\\V1\xe2\x02=Dev\\Planton\\Provider\\Azure\\Azurefrontdoorroute\\V1\\GPBMetadata\xea\x026Dev::Planton::Provider::Azure::Azurefrontdoorroute::V1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_goTypes = []any{
	(AzureFrontDoorRouteProtocol)(0),                   // 0: dev.planton.provider.azure.azurefrontdoorroute.v1.AzureFrontDoorRouteProtocol
	(AzureFrontDoorRouteForwardingProtocol)(0),         // 1: dev.planton.provider.azure.azurefrontdoorroute.v1.AzureFrontDoorRouteForwardingProtocol
	(AzureFrontDoorRouteQueryStringCachingBehavior)(0), // 2: dev.planton.provider.azure.azurefrontdoorroute.v1.AzureFrontDoorRouteQueryStringCachingBehavior
	(*AzureFrontDoorRouteSpec)(nil),                    // 3: dev.planton.provider.azure.azurefrontdoorroute.v1.AzureFrontDoorRouteSpec
	(*AzureFrontDoorRouteCache)(nil),                   // 4: dev.planton.provider.azure.azurefrontdoorroute.v1.AzureFrontDoorRouteCache
	(*v1.StringValueOrRef)(nil),                        // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_depIdxs = []int32{
...
func file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto = out.File
	file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurefrontdoorroute_v1_spec_proto_depIdxs = nil
}
