...
- [AzureServicePlan](/docs/catalog/azure/azureserviceplan) -- provides the compute tier for the Function App
- [AzureStorageAccount](/docs/catalog/azure/azurestorageaccount) -- provides runtime storage for triggers and logs
