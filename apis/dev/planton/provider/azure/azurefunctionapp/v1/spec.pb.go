...
const file_dev_planton_provider_azure_azurefunctionapp_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9dev/planton/provider/azure/azurefunctionapp/v1/spec.proto\x12.dev.planton.provider.azure.azurefunctionapp.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x920\n" +
	...
	"&function_app_sticky_settings_not_empty\x12Xsticky_settings requires at least one app_setting_names or connection_string_names entry\x1aLthis.app_setting_names.size() > 0 || this.connection_string_names.size() > 0\"\xce\x04\n" +
	...
	"\x16_retention_period_days\"\xb8\x03\n" +
