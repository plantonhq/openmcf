...
type Locals struct {
	AzureContainerAppCustomDomain *azurecontainerappcustomdomainv1.AzureContainerAppCustomDomain
	ContainerAppId                string
	CertificateId                 string
}

func initializeLocals(ctx *pulumi.Context, stackInput *azurecontainerappcustomdomainv1.AzureContainerAppCustomDomainStackInput) *Locals {
	locals := &Locals{}
