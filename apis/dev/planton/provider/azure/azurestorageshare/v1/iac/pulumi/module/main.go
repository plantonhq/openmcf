...
func Resources(ctx *pulumi.Context, stackInput *azurestoragesharev1.AzureStorageShareStackInput) error {
	...
	enabledProtocol := "SMB"
	if spec.EnabledProtocol != azurestoragesharev1.AzureStorageShareProtocol_azure_storage_share_protocol_unspecified {
	...
	if spec.AccessTier != azurestoragesharev1.AzureStorageShareAccessTier_azure_storage_share_access_tier_unspecified {
