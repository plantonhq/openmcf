...
func Resources(ctx *pulumi.Context, stackInput *azurefrontdoororiginv1.AzureFrontDoorOriginStackInput) error {
	...
	if spec.PrivateLink != nil {
		...
		if spec.PrivateLink.TargetType != azurefrontdoororiginv1.AzureFrontDoorOriginPrivateLinkTargetType_azure_front_door_origin_private_link_target_type_unspecified {
