...
- [Azure Front Door Origin Group](/docs/catalog/azure/azurefrontdoororigingroup) -- the parent pool
- [Azure Front Door Route](/docs/catalog/azure/azurefrontdoorroute) -- forwards traffic to the pool
- [Azure Front Door Profile](/docs/catalog/azure/azurefrontdoorprofile) -- the grandparent container (PREMIUM required for Private Link)
