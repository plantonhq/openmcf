...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurefrontdoororigin/v1/spec.proto
...
func (AzureFrontDoorOriginPrivateLinkTargetType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureFrontDoorOriginPrivateLinkTargetType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_enumTypes[0]
}
...
func (AzureFrontDoorOriginPrivateLinkTargetType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureFrontDoorOriginSpec) Reset() {
	*x = AzureFrontDoorOriginSpec{}
	mi := &file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_msgTypes[0]
...
type AzureFrontDoorOriginPrivateLink struct {
	...
	TargetType AzureFrontDoorOriginPrivateLinkTargetType `protobuf:"varint,3,opt,name=target_type,json=targetType,proto3,enum=dev.planton.provider.azure.azurefrontdoororigin.v1.AzureFrontDoorOriginPrivateLinkTargetType" json:"target_type,omitempty"`
...
func (x *AzureFrontDoorOriginPrivateLink) Reset() {
	*x = AzureFrontDoorOriginPrivateLink{}
	mi := &file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFrontDoorOriginPrivateLink) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDesc = "" +
	...
	",front_door_origin_private_link_target_arm_id\x12Qprivate_link_target_id must be an ARM resource ID (starting with /subscriptions/)\x1a\"this.startsWith('/subscriptions/')\xc8\x01\x01R\x13privateLinkTargetId\x12\x88\x01\n" +
	"\vtarget_type\x18\x03 \x01(\x0e2].dev.planton.provider.azure.azurefrontdoororigin.v1.AzureFrontDoorOriginPrivateLinkTargetTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\n" +
	"targetType\x12n\n" +
	...
	"\aGATEWAY\x10\aB\x9f\x03\n" +
	"6com.dev.planton.provider.azure.azurefrontdoororigin.v1B\tSpecProtoP\x01Zkgithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azurefrontdoororigin/v1;azurefrontdoororiginv1\xa2\x02\x05DPPAA\xaa\x022Dev.Planton.Provider.Azure.Azurefrontdoororigin.V1\xca\x022Dev\\Planton\\Provider\\Azure\\Azurefrontdoororigin\\V1\xe2\x02>Dev\\Planton\\Provider\\Azure\\Azurefrontdoororigin\\V1\\GPBMetadata\xea\x027Dev::Planton::Provider::Azure::Azurefrontdoororigin::V1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_goTypes = []any{
	(AzureFrontDoorOriginPrivateLinkTargetType)(0), // 0: dev.planton.provider.azure.azurefrontdoororigin.v1.AzureFrontDoorOriginPrivateLinkTargetType
	(*AzureFrontDoorOriginSpec)(nil),               // 1: dev.planton.provider.azure.azurefrontdoororigin.v1.AzureFrontDoorOriginSpec
	(*AzureFrontDoorOriginPrivateLink)(nil),        // 2: dev.planton.provider.azure.azurefrontdoororigin.v1.AzureFrontDoorOriginPrivateLink
...
func file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto = out.File
	file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurefrontdoororigin_v1_spec_proto_depIdxs = nil
}
