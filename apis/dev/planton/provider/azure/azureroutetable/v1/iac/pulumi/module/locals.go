...
var nextHopTypeToArm = map[azureroutetablev1.AzureRouteTableNextHopType]string{
	azureroutetablev1.AzureRouteTableNextHopType_VIRTUAL_NETWORK_GATEWAY: "VirtualNetworkGateway",
	azureroutetablev1.AzureRouteTableNextHopType_VNET_LOCAL:              "VnetLocal",
	azureroutetablev1.AzureRouteTableNextHopType_INTERNET:                "Internet",
	azureroutetablev1.AzureRouteTableNextHopType_VIRTUAL_APPLIANCE:       "VirtualAppliance",
	azureroutetablev1.AzureRouteTableNextHopType_NONE:                    "None",
}

type Locals struct {
	AzureRouteTable *azureroutetablev1.AzureRouteTable
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureroutetablev1.AzureRouteTableStackInput) *Locals {
	locals := &Locals{}
