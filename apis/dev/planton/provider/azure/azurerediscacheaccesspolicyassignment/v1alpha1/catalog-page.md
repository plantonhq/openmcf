...
- [Azure Redis Cache](/docs/catalog/azure/azurerediscache) -- the cache being granted on
- [Azure Redis Cache Access Policy](/docs/catalog/azure/azurerediscacheaccesspolicy) -- custom policies beyond the built-ins
- [Azure User Assigned Identity](/docs/catalog/azure/azureuserassignedidentity) -- the workload principal
