...
```bash
planton tofu plan --manifest fleet.yaml --module-dir apis/dev/planton/provider/azure/azurevirtualmachinescaleset/v1alpha1/iac/tf
planton tofu apply --manifest fleet.yaml --module-dir apis/dev/planton/provider/azure/azurevirtualmachinescaleset/v1alpha1/iac/tf
```
