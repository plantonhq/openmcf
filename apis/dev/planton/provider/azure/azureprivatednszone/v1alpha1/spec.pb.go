...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azureprivatednszone/v1alpha1/spec.proto
...
func (x *AzurePrivateDnsZoneSpec) Reset() {
	*x = AzurePrivateDnsZoneSpec{}
	mi := &file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_msgTypes[0]
...
func (*AzurePrivateDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzurePrivateDnsZoneSoaRecord) Reset() {
	*x = AzurePrivateDnsZoneSoaRecord{}
	mi := &file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzurePrivateDnsZoneSoaRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/provider/azure/azureprivatednszone/v1alpha1/spec.proto\x127dev.planton.provider.azure.azureprivatednszone.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc0\x05\n" +
	...
	"\tzone_name\x12eZone name must be a valid DNS domain (e.g., privatelink.postgres.database.azure.com or corp.internal)\x1abthis.matches('^(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?[.])*[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?$')\xc8\x01\x01R\x04name\x12t\n" +
	"\n" +
	"soa_record\x18\x03 \x01(\v2U.dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSoaRecordR\tsoaRecord\x12n\n" +
	"\x04tags\x18\x04 \x03(\v2Z.dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\"\b\x18\xff\xff\xff\xff\a(\x00\x8a\xa6\x1d\x043600H\x04R\x03ttl\x88\x01\x01\x12s\n" +
	"\x04tags\x18\a \x03(\v2_.dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSoaRecord.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\v_retry_timeB\x06\n" +
	"\x04_ttlB\xc2\x03\n" +
	";com.dev.planton.provider.azure.azureprivatednszone.v1alpha1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azureprivatednszone/v1alpha1;azureprivatednszonev1alpha1\xa2\x02\x05DPPAA\xaa\x027Dev.Planton.Provider.Azure.Azureprivatednszone.V1alpha1\xca\x027Dev\\Planton\\Provider\\Azure\\Azureprivatednszone\\V1alpha1\xe2\x02CDev\\Planton\\Provider\\Azure\\Azureprivatednszone\\V1alpha1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Azure::Azureprivatednszone::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_goTypes = []any{
	(*AzurePrivateDnsZoneSpec)(nil),      // 0: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSpec
	(*AzurePrivateDnsZoneSoaRecord)(nil), // 1: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSoaRecord
	nil,                                  // 2: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSpec.TagsEntry
	nil,                                  // 3: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSoaRecord.TagsEntry
	(*v1.StringValueOrRef)(nil),          // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSpec.soa_record:type_name -> dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSoaRecord
	2, // 2: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSpec.tags:type_name -> dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSpec.TagsEntry
	3, // 3: dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSoaRecord.tags:type_name -> dev.planton.provider.azure.azureprivatednszone.v1alpha1.AzurePrivateDnsZoneSoaRecord.TagsEntry
...
func init() { file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azureprivatednszone_v1alpha1_spec_proto_depIdxs = nil
}
