...
type Locals struct {
	AzureServiceBusSubscription *azureservicebussubscriptionv1.AzureServiceBusSubscription
	TopicId                     string
	TopicName                   string
...
var statusStrings = map[azureservicebussubscriptionv1.AzureServiceBusSubscriptionStatusValue]string{
	azureservicebussubscriptionv1.AzureServiceBusSubscriptionStatusValue_azure_service_bus_subscription_status_unspecified: "Active",
	azureservicebussubscriptionv1.AzureServiceBusSubscriptionStatusValue_ACTIVE:                                            "Active",
	azureservicebussubscriptionv1.AzureServiceBusSubscriptionStatusValue_DISABLED:                                          "Disabled",
	azureservicebussubscriptionv1.AzureServiceBusSubscriptionStatusValue_RECEIVE_DISABLED:                                  "ReceiveDisabled",
}

// filterTypeStrings maps the rule's filter-type enum to the provider's
// case-sensitive wire values.
var filterTypeStrings = map[azureservicebussubscriptionv1.AzureServiceBusFilterType]string{
	azureservicebussubscriptionv1.AzureServiceBusFilterType_SQL_FILTER:         "SqlFilter",
	azureservicebussubscriptionv1.AzureServiceBusFilterType_CORRELATION_FILTER: "CorrelationFilter",
}
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureservicebussubscriptionv1.AzureServiceBusSubscriptionStackInput) *Locals {
	locals := &Locals{}
