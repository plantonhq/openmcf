...
func Resources(ctx *pulumi.Context, stackInput *azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyStackInput) error {
	...
	if len(spec.CustomRules) > 0 {
		...
		for _, rule := range spec.CustomRules {
			...
			if rule.RateLimitDuration != azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyRateLimitDuration_azure_web_application_firewall_policy_rate_limit_duration_unspecified {
			...
			if rule.GroupRateLimitBy != azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyGroupRateLimitBy_azure_web_application_firewall_policy_group_rate_limit_by_unspecified {
	...
	if spec.PolicySettings != nil {
		...
		if settings.Mode != azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyMode_azure_web_application_firewall_policy_mode_unspecified {
		...
		if settings.LogScrubbing != nil {
			...
			for _, rule := range settings.LogScrubbing.Rules {
				...
				if rule.SelectorMatchOperator != azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicySelectorMatchOperator_azure_web_application_firewall_policy_selector_match_operator_unspecified {
...
func buildManagedRules(managedRules *azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyManagedRules) *waf.PolicyManagedRulesArgs {
		...
		if len(ruleSet.RuleGroupOverrides) > 0 {
			...
			for _, override := range ruleSet.RuleGroupOverrides {
				...
				for _, rule := range override.Rules {
					...
					if rule.Action != azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyRuleOverrideAction_azure_web_application_firewall_policy_rule_override_action_unspecified {
...
func buildMatchConditions(conditions []*azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyMatchCondition) waf.PolicyCustomRuleMatchConditionArray {
...
func managedRuleSetTypeString(t azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyManagedRuleSetType) string {
	if t == azurewebapplicationfirewallpolicyv1.AzureWebApplicationFirewallPolicyManagedRuleSetType_azure_web_application_firewall_policy_managed_rule_set_type_unspecified {
		return "OWASP"
	}
