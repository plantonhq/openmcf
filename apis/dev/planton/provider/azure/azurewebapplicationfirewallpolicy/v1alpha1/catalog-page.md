...
- [AzureApplicationGateway](/docs/catalog/azure/azureapplicationgateway) — the L7 load balancer that enforces the policy
- [AzureResourceGroup](/docs/catalog/azure/azureresourcegroup) — provides the resource group for policy placement
