...
- [Azure Service Bus Namespace](/docs/catalog/azure/azureservicebusnamespace) -- the parent namespace
- [Azure Service Bus Authorization Rule](/docs/catalog/azure/azureservicebusauthorizationrule) -- queue-scoped SAS credentials
- [Azure Role Assignment](/docs/catalog/azure/azureroleassignment) -- keyless data-plane grants on `queue_id`
