...
type Locals struct {
	AzureServiceBusQueue *azureservicebusqueuev1.AzureServiceBusQueue
	NamespaceId          string
...
var statusStrings = map[azureservicebusqueuev1.AzureServiceBusEntityStatus]string{
	azureservicebusqueuev1.AzureServiceBusEntityStatus_azure_service_bus_entity_status_unspecified: "Active",
	azureservicebusqueuev1.AzureServiceBusEntityStatus_ACTIVE:                                      "Active",
	azureservicebusqueuev1.AzureServiceBusEntityStatus_DISABLED:                                    "Disabled",
	azureservicebusqueuev1.AzureServiceBusEntityStatus_SEND_DISABLED:                               "SendDisabled",
	azureservicebusqueuev1.AzureServiceBusEntityStatus_RECEIVE_DISABLED:                            "ReceiveDisabled",
}
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureservicebusqueuev1.AzureServiceBusQueueStackInput) *Locals {
	locals := &Locals{}
