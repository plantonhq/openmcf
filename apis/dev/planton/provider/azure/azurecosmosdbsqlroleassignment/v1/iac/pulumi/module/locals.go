...
type Locals struct {
	AzureCosmosdbSqlRoleAssignment *azurecosmosdbsqlroleassignmentv1.AzureCosmosdbSqlRoleAssignment
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurecosmosdbsqlroleassignmentv1.AzureCosmosdbSqlRoleAssignmentStackInput) *Locals {
	locals := &Locals{}
