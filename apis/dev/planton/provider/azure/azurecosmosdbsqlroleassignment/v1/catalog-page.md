...
- [Azure Cosmos DB SQL Role Definition](/docs/catalog/azure/azurecosmosdbsqlroledefinition) -- custom roles this grant can bind
- [Azure User Assigned Identity](/docs/catalog/azure/azureuserassignedidentity) -- the workload identity most grants target
