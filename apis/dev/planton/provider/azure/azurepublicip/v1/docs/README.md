...
cannot use Basic. This is why this Planton component only supports Standard SKU.
...
| Tags | Automatic via Planton metadata |
...
Public IP addresses are consumed by three Azure resources in the Planton plan:
...
- Already exists in Planton; currently creates its own inline Public IP
