...
- [Azure Front Door Route](/docs/catalog/azure/azurefrontdoorroute) -- attaches this policy to traffic
- [Azure Front Door Origin Group](/docs/catalog/azure/azurefrontdoororigingroup) -- the target of a rule's origin override
