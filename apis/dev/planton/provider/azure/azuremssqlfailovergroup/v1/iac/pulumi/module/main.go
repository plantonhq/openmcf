...
func Resources(ctx *pulumi.Context, stackInput *azuremssqlfailovergroupv1.AzureMssqlFailoverGroupStackInput) error {
	...
	if spec.ReadWriteEndpointFailoverPolicy.Mode == azuremssqlfailovergroupv1.AzureMssqlFailoverGroupFailoverMode_AUTOMATIC {
