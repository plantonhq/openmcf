...
type Locals struct {
	AzureFirewall *azurefirewallv1.AzureFirewall
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurefirewallv1.AzureFirewallStackInput) *Locals {
	locals := &Locals{}
...
func skuNameWireValue(skuName azurefirewallv1.AzureFirewallSkuName) string {
	if skuName == azurefirewallv1.AzureFirewallSkuName_AZFW_HUB {
		return "AZFW_Hub"
	}
	return "AZFW_VNet"
}
...
func skuTierWireValue(skuTier azurefirewallv1.AzureFirewallSkuTier) string {
	switch skuTier {
	case azurefirewallv1.AzureFirewallSkuTier_BASIC:
		return "Basic"
	case azurefirewallv1.AzureFirewallSkuTier_PREMIUM:
		return "Premium"
	default:
		return "Standard"
	}
...
func threatIntelModeWireValue(mode azurefirewallv1.AzureFirewallThreatIntelMode) string {
	switch mode {
	case azurefirewallv1.AzureFirewallThreatIntelMode_ALERT:
		return "Alert"
	case azurefirewallv1.AzureFirewallThreatIntelMode_DENY:
		return "Deny"
	case azurefirewallv1.AzureFirewallThreatIntelMode_OFF:
		return "Off"
	default:
		return ""
	}
