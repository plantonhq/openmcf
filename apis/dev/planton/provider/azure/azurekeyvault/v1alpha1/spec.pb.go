...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurekeyvault/v1alpha1/spec.proto
...
func (AzureKeyVaultSku) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureKeyVaultSku) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureKeyVaultSku) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureKeyVaultNetworkAclsDefaultAction) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureKeyVaultNetworkAclsDefaultAction) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureKeyVaultNetworkAclsDefaultAction) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureKeyVaultNetworkAclsBypass) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureKeyVaultNetworkAclsBypass) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureKeyVaultNetworkAclsBypass) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (AzureKeyVaultKeyPermission) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[3].Descriptor()
}

func (AzureKeyVaultKeyPermission) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[3]
}
...
func (AzureKeyVaultKeyPermission) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (AzureKeyVaultSecretPermission) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[4].Descriptor()
}

func (AzureKeyVaultSecretPermission) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[4]
}
...
func (AzureKeyVaultSecretPermission) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (AzureKeyVaultCertificatePermission) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[5].Descriptor()
}

func (AzureKeyVaultCertificatePermission) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[5]
}
...
func (AzureKeyVaultCertificatePermission) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (AzureKeyVaultStoragePermission) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[6].Descriptor()
}

func (AzureKeyVaultStoragePermission) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes[6]
}
...
func (AzureKeyVaultStoragePermission) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
type AzureKeyVaultSpec struct {
	...
	// be changed in place.
	Sku AzureKeyVaultSku `protobuf:"varint,4,opt,name=sku,proto3,enum=dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSku" json:"sku,omitempty"`
...
func (x *AzureKeyVaultSpec) Reset() {
	*x = AzureKeyVaultSpec{}
	mi := &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_msgTypes[0]
...
type AzureKeyVaultAccessPolicy struct {
	...
	// operators.
	KeyPermissions []AzureKeyVaultKeyPermission `protobuf:"varint,4,rep,packed,name=key_permissions,json=keyPermissions,proto3,enum=dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultKeyPermission" json:"key_permissions,omitempty"`
	...
	SecretPermissions []AzureKeyVaultSecretPermission `protobuf:"varint,5,rep,packed,name=secret_permissions,json=secretPermissions,proto3,enum=dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSecretPermission" json:"secret_permissions,omitempty"`
	...
	CertificatePermissions []AzureKeyVaultCertificatePermission `protobuf:"varint,6,rep,packed,name=certificate_permissions,json=certificatePermissions,proto3,enum=dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultCertificatePermission" json:"certificate_permissions,omitempty"`
	...
	StoragePermissions []AzureKeyVaultStoragePermission `protobuf:"varint,7,rep,packed,name=storage_permissions,json=storagePermissions,proto3,enum=dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultStoragePermission" json:"storage_permissions,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *AzureKeyVaultAccessPolicy) Reset() {
	*x = AzureKeyVaultAccessPolicy{}
	mi := &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureKeyVaultNetworkAcls struct {
	...
	// configured.
	DefaultAction AzureKeyVaultNetworkAclsDefaultAction `protobuf:"varint,1,opt,name=default_action,json=defaultAction,proto3,enum=dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsDefaultAction" json:"default_action,omitempty"`
	...
	Bypass AzureKeyVaultNetworkAclsBypass `protobuf:"varint,2,opt,name=bypass,proto3,enum=dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsBypass" json:"bypass,omitempty"`
...
func (x *AzureKeyVaultNetworkAcls) Reset() {
	*x = AzureKeyVaultNetworkAcls{}
	mi := &file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"<dev/planton/provider/azure/azurekeyvault/v1alpha1/spec.proto\x121dev.planton.provider.azure.azurekeyvault.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc0\v\n" +
	...
	"%key_vault_name_no_consecutive_hyphens\x124vault_name cannot contain consecutive hyphens (\"--\")\x1a\x14!this.contains('--')\xc8\x01\x01r)2'^[a-zA-Z][a-zA-Z0-9-]{1,22}[a-zA-Z0-9]$R\tvaultName\x12U\n" +
	"\x03sku\x18\x04 \x01(\x0e2C.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSkuR\x03sku\x12K\n" +
	"\x1arbac_authorization_enabled\x18\x05 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x00R\x18rbacAuthorizationEnabled\x88\x01\x01\x12\x80\x01\n" +
	"\x0faccess_policies\x18\x06 \x03(\v2L.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicyB\t\xbaH\x06\x92\x01\x03\x10\x80\bR\x0eaccessPolicies\x124\n" +
	...
	"\x1asoft_delete_retention_days\x18\f \x01(\x05B\x0f\xbaH\x06\x1a\x04\x18Z(\a\x8a\xa6\x1d\x0290H\x02R\x17softDeleteRetentionDays\x88\x01\x01\x12n\n" +
	"\fnetwork_acls\x18\r \x01(\v2K.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsR\vnetworkAcls\x12b\n" +
	"\x04tags\x18\x0e \x03(\v2N.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x1b_soft_delete_retention_days\"\xf0\x06\n" +
	...
	"\x0eapplication_id\x18\x03 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01H\x01R\rapplicationId\x88\x01\x01\x12\x87\x01\n" +
	"\x0fkey_permissions\x18\x04 \x03(\x0e2M.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultKeyPermissionB\x0f\xbaH\f\x92\x01\t\"\a\x82\x01\x04\x10\x01 \x00R\x0ekeyPermissions\x12\x90\x01\n" +
	"\x12secret_permissions\x18\x05 \x03(\x0e2P.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSecretPermissionB\x0f\xbaH\f\x92\x01\t\"\a\x82\x01\x04\x10\x01 \x00R\x11secretPermissions\x12\x9f\x01\n" +
	"\x17certificate_permissions\x18\x06 \x03(\x0e2U.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultCertificatePermissionB\x0f\xbaH\f\x92\x01\t\"\a\x82\x01\x04\x10\x01 \x00R\x16certificatePermissions\x12\x93\x01\n" +
	"\x13storage_permissions\x18\a \x03(\x0e2Q.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultStoragePermissionB\x0f\xbaH\f\x92\x01\t\"\a\x82\x01\x04\x10\x01 \x00R\x12storagePermissionsB\f\n" +
	"\n" +
	"_tenant_idB\x11\n" +
	"\x0f_application_id\"\xd6\x03\n" +
	"\x18AzureKeyVaultNetworkAcls\x12\x87\x01\n" +
	"\x0edefault_action\x18\x01 \x01(\x0e2X.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsDefaultActionB\x06\xbaH\x03\xc8\x01\x01R\rdefaultAction\x12i\n" +
	"\x06bypass\x18\x02 \x01(\x0e2Q.dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsBypassR\x06bypass\x12$\n" +
	...
	"\x12STORAGE_DELETE_SAS\x10\x0eB\x98\x03\n" +
	"5com.dev.planton.provider.azure.azurekeyvault.v1alpha1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azurekeyvault/v1alpha1;azurekeyvaultv1alpha1\xa2\x02\x05DPPAA\xaa\x021Dev.Planton.Provider.Azure.Azurekeyvault.V1alpha1\xca\x021Dev\\Planton\\Provider\\Azure\\Azurekeyvault\\V1alpha1\xe2\x02=Dev\\Planton\\Provider\\Azure\\Azurekeyvault\\V1alpha1\\GPBMetadata\xea\x026Dev::Planton::Provider::Azure::Azurekeyvault::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_goTypes = []any{
	(AzureKeyVaultSku)(0),                      // 0: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSku
	(AzureKeyVaultNetworkAclsDefaultAction)(0), // 1: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsDefaultAction
	(AzureKeyVaultNetworkAclsBypass)(0),        // 2: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsBypass
	(AzureKeyVaultKeyPermission)(0),            // 3: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultKeyPermission
	(AzureKeyVaultSecretPermission)(0),         // 4: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSecretPermission
	(AzureKeyVaultCertificatePermission)(0),    // 5: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultCertificatePermission
	(AzureKeyVaultStoragePermission)(0),        // 6: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultStoragePermission
	(*AzureKeyVaultSpec)(nil),                  // 7: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec
	(*AzureKeyVaultAccessPolicy)(nil),          // 8: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicy
	(*AzureKeyVaultNetworkAcls)(nil),           // 9: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAcls
	nil,                                        // 10: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),                // 11: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_depIdxs = []int32{
	11, // 0: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 1: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.sku:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSku
	8,  // 2: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.access_policies:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicy
	9,  // 3: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.network_acls:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAcls
	10, // 4: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.tags:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSpec.TagsEntry
	11, // 5: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicy.object_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 6: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicy.key_permissions:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultKeyPermission
	4,  // 7: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicy.secret_permissions:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultSecretPermission
	5,  // 8: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicy.certificate_permissions:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultCertificatePermission
	6,  // 9: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultAccessPolicy.storage_permissions:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultStoragePermission
	1,  // 10: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAcls.default_action:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsDefaultAction
	2,  // 11: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAcls.bypass:type_name -> dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAclsBypass
	11, // 12: dev.planton.provider.azure.azurekeyvault.v1alpha1.AzureKeyVaultNetworkAcls.virtual_network_subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurekeyvault_v1alpha1_spec_proto_depIdxs = nil
}
