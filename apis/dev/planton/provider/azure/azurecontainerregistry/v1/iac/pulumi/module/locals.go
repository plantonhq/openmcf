...
type Locals struct {
	AzureContainerRegistry *azurecontainerregistryv1.AzureContainerRegistry
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurecontainerregistryv1.AzureContainerRegistryStackInput) *Locals {
	locals := &Locals{}
	...
	case azurecontainerregistryv1.AzureContainerRegistryNetworkRuleBypassOption_AZURE_SERVICES:
		locals.NetworkRuleBypassOption = "AzureServices"
	case azurecontainerregistryv1.AzureContainerRegistryNetworkRuleBypassOption_NONE:
		locals.NetworkRuleBypassOption = "None"
	}

	if target.Spec.Identity != nil {
		switch target.Spec.Identity.Type {
		case azurecontainerregistryv1.AzureContainerRegistryIdentityType_SYSTEM_ASSIGNED:
			locals.IdentityType = "SystemAssigned"
		case azurecontainerregistryv1.AzureContainerRegistryIdentityType_USER_ASSIGNED:
			locals.IdentityType = "UserAssigned"
		case azurecontainerregistryv1.AzureContainerRegistryIdentityType_SYSTEM_AND_USER_ASSIGNED:
