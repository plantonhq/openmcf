...
- [Azure DNS Zone](/docs/catalog/azure/azurednszone) -- the zone the record lives in
- [Azure Public IP](/docs/catalog/azure/azurepublicip) -- a common alias-record target
- [Azure Container App Custom Domain](/docs/catalog/azure/azurecontainerappcustomdomain) -- consumes the `asuid.` TXT + CNAME records this kind declares
