...
// 	protoc        (unknown)
// source: dev/planton/provider/azure/azurednsrecord/v1alpha1/spec.proto
...
func (AzureDnsCaaTag) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureDnsCaaTag) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureDnsCaaTag) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureDnsRecordSpec) Reset() {
	*x = AzureDnsRecordSpec{}
	mi := &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[0]
...
func (x *AzureDnsARecord) Reset() {
	*x = AzureDnsARecord{}
	mi := &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsARecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AzureDnsAaaaRecord) Reset() {
	*x = AzureDnsAaaaRecord{}
	mi := &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsAaaaRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AzureDnsCnameRecord) Reset() {
	*x = AzureDnsCnameRecord{}
	mi := &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsCnameRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AzureDnsMxEntry) Reset() {
	*x = AzureDnsMxEntry{}
	mi := &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsMxEntry) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AzureDnsSrvEntry) Reset() {
	*x = AzureDnsSrvEntry{}
	mi := &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsSrvEntry) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
type AzureDnsCaaEntry struct {
	...
	Tag AzureDnsCaaTag `protobuf:"varint,2,opt,name=tag,proto3,enum=dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaTag" json:"tag,omitempty"`
...
func (x *AzureDnsCaaEntry) Reset() {
	*x = AzureDnsCaaEntry{}
	mi := &file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsCaaEntry) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/azure/azurednsrecord/v1alpha1/spec.proto\x122dev.planton.provider.azure.azurednsrecord.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xfd\x0f\n" +
	...
	"ttlSeconds\x88\x01\x01\x12d\n" +
	"\x04tags\x18\x05 \x03(\v2P.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.TagsEntryR\x04tags\x12Q\n" +
	"\x01a\x18\x06 \x01(\v2C.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsARecordR\x01a\x12Z\n" +
	"\x04aaaa\x18\a \x01(\v2F.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsAaaaRecordR\x04aaaa\x12]\n" +
	"\x05cname\x18\b \x01(\v2G.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCnameRecordR\x05cname\x12S\n" +
	"\x02mx\x18\t \x03(\v2C.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsMxEntryR\x02mx\x12V\n" +
	"\x03srv\x18\n" +
	" \x03(\v2D.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsSrvEntryR\x03srv\x12V\n" +
	"\x03caa\x18\v \x03(\v2D.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaEntryR\x03caa\x12D\n" +
	...
	"\xc8\x01\x01\x1a\x05\x18\xff\x01(\x00H\x00R\x05flags\x88\x01\x01\x12a\n" +
	"\x03tag\x18\x02 \x01(\x0e2B.dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaTagB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x03tag\x12\x1c\n" +
	...
	"\fCONTACTEMAIL\x10\x04B\x9f\x03\n" +
	"6com.dev.planton.provider.azure.azurednsrecord.v1alpha1B\tSpecProtoP\x01Zkgithub.com/plantonhq/planton/apis/dev/planton/provider/azure/azurednsrecord/v1alpha1;azurednsrecordv1alpha1\xa2\x02\x05DPPAA\xaa\x022Dev.Planton.Provider.Azure.Azurednsrecord.V1alpha1\xca\x022Dev\\Planton\\Provider\\Azure\\Azurednsrecord\\V1alpha1\xe2\x02>Dev\\Planton\\Provider\\Azure\\Azurednsrecord\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Provider::Azure::Azurednsrecord::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_goTypes = []any{
	(AzureDnsCaaTag)(0),         // 0: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaTag
	(*AzureDnsRecordSpec)(nil),  // 1: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec
	(*AzureDnsARecord)(nil),     // 2: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsARecord
	(*AzureDnsAaaaRecord)(nil),  // 3: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsAaaaRecord
	(*AzureDnsCnameRecord)(nil), // 4: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCnameRecord
	(*AzureDnsMxEntry)(nil),     // 5: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsMxEntry
	(*AzureDnsSrvEntry)(nil),    // 6: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsSrvEntry
	(*AzureDnsCaaEntry)(nil),    // 7: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaEntry
	nil,                         // 8: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 9: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_depIdxs = []int32{
	9,  // 0: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 1: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.zone_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 2: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.tags:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.TagsEntry
	2,  // 3: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.a:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsARecord
	3,  // 4: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.aaaa:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsAaaaRecord
	4,  // 5: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.cname:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCnameRecord
	5,  // 6: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.mx:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsMxEntry
	6,  // 7: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.srv:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsSrvEntry
	7,  // 8: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.caa:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaEntry
	9,  // 9: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsRecordSpec.txt:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 10: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsARecord.target_resource_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 11: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsAaaaRecord.target_resource_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 12: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCnameRecord.value:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 13: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCnameRecord.target_resource_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 14: dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaEntry.tag:type_name -> dev.planton.provider.azure.azurednsrecord.v1alpha1.AzureDnsCaaTag
...
func init() { file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_azure_azurednsrecord_v1alpha1_spec_proto_depIdxs = nil
}
