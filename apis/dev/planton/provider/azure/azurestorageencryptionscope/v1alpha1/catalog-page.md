...
- [Azure Storage Container](/docs/catalog/azure/azurestoragecontainer) -- pins a scope as its default
- [Azure Key Vault Key](/docs/catalog/azure/azurekeyvaultkey) -- the customer-managed key source
