...
import (
	auth0clientv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/auth0/auth0client/v1alpha1"
...
type Locals struct {
	...
	// JWT configuration
	JwtConfiguration *auth0clientv1alpha1.Auth0JwtConfiguration

	// Refresh token configuration
	RefreshToken *auth0clientv1alpha1.Auth0RefreshTokenConfiguration

	// Native social login
	NativeSocialLogin *auth0clientv1alpha1.Auth0NativeSocialLogin

	// Mobile configuration
	Mobile *auth0clientv1alpha1.Auth0MobileConfiguration
	...
	OidcBackchannelLogout          *auth0clientv1alpha1.Auth0OidcBackchannelLogout
