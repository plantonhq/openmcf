...
// 	protoc        (unknown)
// source: dev/planton/provider/auth0/auth0resourceserver/v1alpha1/spec.proto
...
func (x *Auth0ResourceServerSpec) Reset() {
	*x = Auth0ResourceServerSpec{}
	mi := &file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_msgTypes[0]
...
func (*Auth0ResourceServerSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *Auth0ResourceServerScope) Reset() {
	*x = Auth0ResourceServerScope{}
	mi := &file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Auth0ResourceServerScope) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/provider/auth0/auth0resourceserver/v1alpha1/spec.proto\x127dev.planton.provider.auth0.auth0resourceserver.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xfe\x05\n" +
	...
	"\rtoken_dialect\x18\t \x01(\tB\x9d\x01\xbaHNrLR\x00R\faccess_tokenR\x12access_token_authzR\x0frfc9068_profileR\x15rfc9068_profile_authz\xaa\xa6\x1dHAccess-token format selector (e.g. rfc9068_profile), not a secret value.R\ftokenDialect\x12i\n" +
	"\x06scopes\x18\n" +
	" \x03(\v2Q.dev.planton.provider.auth0.auth0resourceserver.v1alpha1.Auth0ResourceServerScopeR\x06scopes\"X\n" +
	"\x18Auth0ResourceServerScope\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescriptionB\xc2\x03\n" +
	";com.dev.planton.provider.auth0.auth0resourceserver.v1alpha1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/apis/dev/planton/provider/auth0/auth0resourceserver/v1alpha1;auth0resourceserverv1alpha1\xa2\x02\x05DPPAA\xaa\x027Dev.Planton.Provider.Auth0.Auth0resourceserver.V1alpha1\xca\x027Dev\\Planton\\Provider\\Auth0\\Auth0resourceserver\\V1alpha1\xe2\x02CDev\\Planton\\Provider\\Auth0\\Auth0resourceserver\\V1alpha1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Auth0::Auth0resourceserver::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_goTypes = []any{
	(*Auth0ResourceServerSpec)(nil),  // 0: dev.planton.provider.auth0.auth0resourceserver.v1alpha1.Auth0ResourceServerSpec
	(*Auth0ResourceServerScope)(nil), // 1: dev.planton.provider.auth0.auth0resourceserver.v1alpha1.Auth0ResourceServerScope
}
var file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.auth0.auth0resourceserver.v1alpha1.Auth0ResourceServerSpec.scopes:type_name -> dev.planton.provider.auth0.auth0resourceserver.v1alpha1.Auth0ResourceServerScope
...
func init() { file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_auth0_auth0resourceserver_v1alpha1_spec_proto_depIdxs = nil
}
