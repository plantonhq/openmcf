...
import (
	auth0connectionv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/auth0/auth0connection/v1alpha1"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

// Locals contains computed values for the Auth0 Connection deployment
type Locals struct {
	Auth0Connection *auth0connectionv1alpha1.Auth0Connection
	...
	DatabaseOptions *auth0connectionv1alpha1.Auth0DatabaseOptions

	// Social options (for social strategies)
	SocialOptions *auth0connectionv1alpha1.Auth0SocialOptions

	// SAML options (when strategy is samlp)
	SamlOptions *auth0connectionv1alpha1.Auth0SamlOptions

	// OIDC options (when strategy is oidc)
	OidcOptions *auth0connectionv1alpha1.Auth0OidcOptions
