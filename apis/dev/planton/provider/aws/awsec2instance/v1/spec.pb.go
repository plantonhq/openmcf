...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsec2instance/v1/spec.proto
...
func (x *AwsEc2InstanceSpec) Reset() {
	*x = AwsEc2InstanceSpec{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[0]
...
func (*AwsEc2InstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEc2InstanceLaunchTemplate) Reset() {
	*x = AwsEc2InstanceLaunchTemplate{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceLaunchTemplate) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEc2InstancePrivateDnsNameOptions) Reset() {
	*x = AwsEc2InstancePrivateDnsNameOptions{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstancePrivateDnsNameOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsEc2InstanceSecondaryNetworkInterface) Reset() {
	*x = AwsEc2InstanceSecondaryNetworkInterface{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceSecondaryNetworkInterface) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsEc2InstanceRootBlockDevice) Reset() {
	*x = AwsEc2InstanceRootBlockDevice{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceRootBlockDevice) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsEc2InstanceEbsBlockDevice) Reset() {
	*x = AwsEc2InstanceEbsBlockDevice{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceEbsBlockDevice) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsEc2InstanceEphemeralBlockDevice) Reset() {
	*x = AwsEc2InstanceEphemeralBlockDevice{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceEphemeralBlockDevice) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsEc2InstanceMetadataOptions) Reset() {
	*x = AwsEc2InstanceMetadataOptions{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceMetadataOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsEc2InstanceCpuOptions) Reset() {
	*x = AwsEc2InstanceCpuOptions{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceCpuOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsEc2InstanceSpotOptions) Reset() {
	*x = AwsEc2InstanceSpotOptions{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceSpotOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *AwsEc2InstanceCapacityReservation) Reset() {
	*x = AwsEc2InstanceCapacityReservation{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstanceCapacityReservation) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *AwsEc2InstancePlacement) Reset() {
	*x = AwsEc2InstancePlacement{}
	mi := &file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEc2InstancePlacement) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{11}
}
...
var File_dev_planton_provider_aws_awsec2instance_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDesc = "" +
	"\n" +
	"5dev/planton/provider/aws/awsec2instance/v1/spec.proto\x12*dev.planton.provider.aws.awsec2instance.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xce&\n" +
	...
	"\x13enable_primary_ipv6\x18\x10 \x01(\bH\x02R\x11enablePrimaryIpv6\x88\x01\x01\x12\x88\x01\n" +
	"\x18private_dns_name_options\x18\x11 \x01(\v2O.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstancePrivateDnsNameOptionsR\x15privateDnsNameOptions\x12\x95\x01\n" +
	"\x1csecondary_network_interfaces\x18\x12 \x03(\v2S.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSecondaryNetworkInterfaceR\x1asecondaryNetworkInterfaces\x12u\n" +
	"\x11root_block_device\x18\x13 \x01(\v2I.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceRootBlockDeviceR\x0frootBlockDevice\x12t\n" +
	"\x11ebs_block_devices\x18\x14 \x03(\v2H.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceEbsBlockDeviceR\x0febsBlockDevices\x12\x86\x01\n" +
	"\x17ephemeral_block_devices\x18\x15 \x03(\v2N.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceEphemeralBlockDeviceR\x15ephemeralBlockDevices\x12#\n" +
	"\rebs_optimized\x18\x16 \x01(\bR\febsOptimized\x12t\n" +
	"\x10metadata_options\x18\x17 \x01(\v2I.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceMetadataOptionsR\x0fmetadataOptions\x12/\n" +
	"\x13detailed_monitoring\x18\x18 \x01(\bR\x12detailedMonitoring\x12e\n" +
	"\vcpu_options\x18\x19 \x01(\v2D.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceCpuOptionsR\n" +
	"cpuOptions\x12\x1f\n" +
	"\vcpu_credits\x18\x1a \x01(\tR\n" +
	"cpuCredits\x12h\n" +
	"\fspot_options\x18\x1b \x01(\v2E.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpotOptionsR\vspotOptions\x12\x80\x01\n" +
	"\x14capacity_reservation\x18\x1c \x01(\v2M.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceCapacityReservationR\x13capacityReservation\x12a\n" +
	"\tplacement\x18\x1d \x01(\v2C.dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstancePlacementR\tplacement\x12'\n" +
	...
	"\x18partition_requires_group\x12Dpartition_number requires a placement group (group_name or group_id)\x1aJthis.partition_number == 0 || this.group_name != '' || this.group_id != ''B\xe9\x02\n" +
	".com.dev.planton.provider.aws.awsec2instance.v1B\tSpecProtoP\x01Z]github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsec2instance/v1;awsec2instancev1\xa2\x02\x05DPPAA\xaa\x02*Dev.Planton.Provider.Aws.Awsec2instance.V1\xca\x02*Dev\\Planton\\Provider\\Aws\\Awsec2instance\\V1\xe2\x026Dev\\Planton\\Provider\\Aws\\Awsec2instance\\V1\\GPBMetadata\xea\x02/Dev::Planton::Provider::Aws::Awsec2instance::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_goTypes = []any{
	(*AwsEc2InstanceSpec)(nil),                      // 0: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec
	(*AwsEc2InstanceLaunchTemplate)(nil),            // 1: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceLaunchTemplate
	(*AwsEc2InstancePrivateDnsNameOptions)(nil),     // 2: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstancePrivateDnsNameOptions
	(*AwsEc2InstanceSecondaryNetworkInterface)(nil), // 3: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSecondaryNetworkInterface
	(*AwsEc2InstanceRootBlockDevice)(nil),           // 4: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceRootBlockDevice
	(*AwsEc2InstanceEbsBlockDevice)(nil),            // 5: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceEbsBlockDevice
	(*AwsEc2InstanceEphemeralBlockDevice)(nil),      // 6: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceEphemeralBlockDevice
	(*AwsEc2InstanceMetadataOptions)(nil),           // 7: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceMetadataOptions
	(*AwsEc2InstanceCpuOptions)(nil),                // 8: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceCpuOptions
	(*AwsEc2InstanceSpotOptions)(nil),               // 9: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpotOptions
	(*AwsEc2InstanceCapacityReservation)(nil),       // 10: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceCapacityReservation
	(*AwsEc2InstancePlacement)(nil),                 // 11: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstancePlacement
	(*v1.StringValueOrRef)(nil),                     // 12: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.launch_template:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceLaunchTemplate
	12, // 1: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.instance_profile:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 2: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 3: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 4: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.private_dns_name_options:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstancePrivateDnsNameOptions
	3,  // 5: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.secondary_network_interfaces:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSecondaryNetworkInterface
	4,  // 6: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.root_block_device:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceRootBlockDevice
	5,  // 7: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.ebs_block_devices:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceEbsBlockDevice
	6,  // 8: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.ephemeral_block_devices:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceEphemeralBlockDevice
	7,  // 9: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.metadata_options:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceMetadataOptions
	8,  // 10: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.cpu_options:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceCpuOptions
	9,  // 11: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.spot_options:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpotOptions
	10, // 12: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.capacity_reservation:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceCapacityReservation
	11, // 13: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.placement:type_name -> dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstancePlacement
	12, // 14: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceLaunchTemplate.id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 15: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceSecondaryNetworkInterface.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 16: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceRootBlockDevice.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 17: dev.planton.provider.aws.awsec2instance.v1.AwsEc2InstanceEbsBlockDevice.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsec2instance_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsec2instance_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsec2instance_v1_spec_proto_depIdxs = nil
}
