...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsapprunnerservice/v1alpha1/stack_outputs.proto
...
func (x *AwsAppRunnerServiceStackOutputs) Reset() {
	*x = AwsAppRunnerServiceStackOutputs{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*AwsAppRunnerServiceStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsAppRunnerServiceCustomDomainOutput) Reset() {
	*x = AwsAppRunnerServiceCustomDomainOutput{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceCustomDomainOutput) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsAppRunnerServiceCertificateValidationRecord) Reset() {
	*x = AwsAppRunnerServiceCertificateValidationRecord{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceCertificateValidationRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Idev/planton/provider/aws/awsapprunnerservice/v1alpha1/stack_outputs.proto\x125dev.planton.provider.aws.awsapprunnerservice.v1alpha1\"\xd2\x02\n" +
	...
	"\x0eservice_status\x18\x05 \x01(\tR\rserviceStatus\x12\x83\x01\n" +
	"\x0ecustom_domains\x18\x06 \x03(\v2\\.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCustomDomainOutputR\rcustomDomains\"\xad\x02\n" +
	"%AwsAppRunnerServiceCustomDomainOutput\x12\x1f\n" +
	"\vdomain_name\x18\x01 \x01(\tR\n" +
	"domainName\x12\x1d\n" +
	"\n" +
	"dns_target\x18\x02 \x01(\tR\tdnsTarget\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12\xab\x01\n" +
	"\x1ecertificate_validation_records\x18\x04 \x03(\v2e.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCertificateValidationRecordR\x1ccertificateValidationRecords\"\x95\x01\n" +
	".AwsAppRunnerServiceCertificateValidationRecord\x12\x1f\n" +
	"\vrecord_name\x18\x01 \x01(\tR\n" +
	"recordName\x12\x1f\n" +
	"\vrecord_type\x18\x02 \x01(\tR\n" +
	"recordType\x12!\n" +
	"\frecord_value\x18\x03 \x01(\tR\vrecordValueB\xbe\x03\n" +
	"9com.dev.planton.provider.aws.awsapprunnerservice.v1alpha1B\x11StackOutputsProtoP\x01Zsgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsapprunnerservice/v1alpha1;awsapprunnerservicev1alpha1\xa2\x02\x05DPPAA\xaa\x025Dev.Planton.Provider.Aws.Awsapprunnerservice.V1alpha1\xca\x025Dev\\Planton\\Provider\\Aws\\Awsapprunnerservice\\V1alpha1\xe2\x02ADev\\Planton\\Provider\\Aws\\Awsapprunnerservice\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Aws::Awsapprunnerservice::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*AwsAppRunnerServiceStackOutputs)(nil),                // 0: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceStackOutputs
	(*AwsAppRunnerServiceCustomDomainOutput)(nil),          // 1: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCustomDomainOutput
	(*AwsAppRunnerServiceCertificateValidationRecord)(nil), // 2: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCertificateValidationRecord
}
var file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceStackOutputs.custom_domains:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCustomDomainOutput
	2, // 1: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCustomDomainOutput.certificate_validation_records:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCertificateValidationRecord
...
func init() { file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_init() }
func file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_init() {
	if File_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto = out.File
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_depIdxs = nil
}
