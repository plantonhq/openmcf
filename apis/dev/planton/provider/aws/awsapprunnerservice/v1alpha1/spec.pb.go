...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsapprunnerservice/v1alpha1/spec.proto
...
func (x *AwsAppRunnerServiceSpec) Reset() {
	*x = AwsAppRunnerServiceSpec{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsAppRunnerServiceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsAppRunnerServiceImageSource) Reset() {
	*x = AwsAppRunnerServiceImageSource{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceImageSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsAppRunnerServiceCodeSource) Reset() {
	*x = AwsAppRunnerServiceCodeSource{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceCodeSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsAppRunnerServiceHealthCheck) Reset() {
	*x = AwsAppRunnerServiceHealthCheck{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceHealthCheck) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsAppRunnerServiceCustomDomain) Reset() {
	*x = AwsAppRunnerServiceCustomDomain{}
	mi := &file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceCustomDomain) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/aws/awsapprunnerservice/v1alpha1/spec.proto\x125dev.planton.provider.aws.awsapprunnerservice.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x82\x1d\n" +
	"\x17AwsAppRunnerServiceSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12x\n" +
	"\fimage_source\x18\x02 \x01(\v2U.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceImageSourceR\vimageSource\x12u\n" +
	"\vcode_source\x18\x03 \x01(\v2T.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCodeSourceR\n" +
	"codeSource\x12!\n" +
	"\x04port\x18\x04 \x01(\tB\b\x8a\xa6\x1d\x048080H\x00R\x04port\x88\x01\x01\x12#\n" +
	"\rstart_command\x18\x05 \x01(\tR\fstartCommand\x12\x9d\x01\n" +
	"\x15environment_variables\x18\x06 \x03(\v2h.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.EnvironmentVariablesEntryR\x14environmentVariables\x12\x8c\x02\n" +
	"\x13environment_secrets\x18\a \x03(\v2f.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.EnvironmentSecretsEntryBs\xaa\xa6\x1dovalues are Secrets Manager / SSM Parameter Store ARNs (references to secrets), never the secret material itselfR\x12environmentSecrets\x12\x1f\n" +
	...
	" \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xf0\a\x92\xd4a\x17status.outputs.role_arnR\x0finstanceRoleArn\x12x\n" +
	"\fhealth_check\x18\v \x01(\v2U.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceHealthCheckR\vhealthCheck\x12\xa2\x01\n" +
	...
	"\x18auto_deployments_enabled\x18\x12 \x01(\bR\x16autoDeploymentsEnabled\x12}\n" +
	"\x0ecustom_domains\x18\x13 \x03(\v2V.dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCustomDomainR\rcustomDomains\x12w\n" +
	...
	"\x15_enable_www_subdomainB\xb6\x03\n" +
	"9com.dev.planton.provider.aws.awsapprunnerservice.v1alpha1B\tSpecProtoP\x01Zsgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsapprunnerservice/v1alpha1;awsapprunnerservicev1alpha1\xa2\x02\x05DPPAA\xaa\x025Dev.Planton.Provider.Aws.Awsapprunnerservice.V1alpha1\xca\x025Dev\\Planton\\Provider\\Aws\\Awsapprunnerservice\\V1alpha1\xe2\x02ADev\\Planton\\Provider\\Aws\\Awsapprunnerservice\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Aws::Awsapprunnerservice::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_goTypes = []any{
	(*AwsAppRunnerServiceSpec)(nil),         // 0: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec
	(*AwsAppRunnerServiceImageSource)(nil),  // 1: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceImageSource
	(*AwsAppRunnerServiceCodeSource)(nil),   // 2: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCodeSource
	(*AwsAppRunnerServiceHealthCheck)(nil),  // 3: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceHealthCheck
	(*AwsAppRunnerServiceCustomDomain)(nil), // 4: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCustomDomain
	nil,                                     // 5: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.EnvironmentVariablesEntry
	nil,                                     // 6: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.EnvironmentSecretsEntry
	(*v1.StringValueOrRef)(nil),             // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.image_source:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceImageSource
	2,  // 1: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.code_source:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCodeSource
	5,  // 2: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.environment_variables:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.EnvironmentVariablesEntry
	6,  // 3: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.environment_secrets:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.EnvironmentSecretsEntry
	7,  // 4: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.instance_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 5: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.health_check:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceHealthCheck
	7,  // 6: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.auto_scaling_configuration_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 7: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.vpc_connector_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 8: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.observability_configuration_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 9: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 10: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.custom_domains:type_name -> dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCustomDomain
	7,  // 11: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceSpec.web_acl_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 12: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceImageSource.access_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 13: dev.planton.provider.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCodeSource.connection_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsapprunnerservice_v1alpha1_spec_proto_depIdxs = nil
}
