...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsfsxontapstoragevirtualmachine/v1alpha1/spec.proto
...
func (x *AwsFsxOntapStorageVirtualMachineSpec) Reset() {
	*x = AwsFsxOntapStorageVirtualMachineSpec{}
	mi := &file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsFsxOntapStorageVirtualMachineSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration) Reset() {
	*x = AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Mdev/planton/provider/aws/awsfsxontapstoragevirtualmachine/v1alpha1/spec.proto\x12Bdev.planton.provider.aws.awsfsxontapstoragevirtualmachine.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x95\t\n" +
	"$AwsFsxOntapStorageVirtualMachineSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12\x86\x01\n" +
	"\x0efile_system_id\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB,\xbaH\x03\xc8\x01\x01\x88\xd4a\xc6\b\x92\xd4a\x1dstatus.outputs.file_system_idR\ffileSystemId\x12\x1d\n" +
	...
	"\x12svm_admin_password\x18\x05 \x01(\tB\x04\xa0\xa6\x1d\x01R\x10svmAdminPassword\x12\xc7\x01\n" +
	"\x1eactive_directory_configuration\x18\x06 \x01(\v2\x80\x01.dev.planton.provider.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineActiveDirectoryConfigurationR\x1cactiveDirectoryConfiguration:\xba\x04\xbaH\xb6\x04\x1a\xbc\x01\n" +
	...
	"!_file_system_administrators_groupB\x92\x04\n" +
...
var (
	file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_goTypes = []any{
	(*AwsFsxOntapStorageVirtualMachineSpec)(nil),                         // 0: dev.planton.provider.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineSpec
	(*AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration)(nil), // 1: dev.planton.provider.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration
	(*v1.StringValueOrRef)(nil),                                          // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineSpec.file_system_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineSpec.active_directory_configuration:type_name -> dev.planton.provider.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration
...
func file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_depIdxs = nil
}
