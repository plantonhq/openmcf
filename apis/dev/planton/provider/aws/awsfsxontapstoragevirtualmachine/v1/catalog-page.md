...
- [AwsFsxOntapFileSystem](/docs/catalog/aws/awsfsxontapfilesystem) — parent file system that provides the storage infrastructure for this SVM
- [AwsFsxOntapVolume](/docs/catalog/aws/awsfsxontapvolume) — data volumes created within this SVM
- [AwsVpc](/docs/catalog/aws/awsvpc) — provides the network subnets for the parent file system
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls network access to the parent file system's endpoints
