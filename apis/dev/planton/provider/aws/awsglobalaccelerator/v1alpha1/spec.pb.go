...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsglobalaccelerator/v1alpha1/spec.proto
...
func (x *AwsGlobalAcceleratorSpec) Reset() {
	*x = AwsGlobalAcceleratorSpec{}
	mi := &file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsGlobalAcceleratorSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsGlobalAcceleratorFlowLogs) Reset() {
	*x = AwsGlobalAcceleratorFlowLogs{}
	mi := &file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlobalAcceleratorFlowLogs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsGlobalAcceleratorListener) Reset() {
	*x = AwsGlobalAcceleratorListener{}
	mi := &file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlobalAcceleratorListener) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsGlobalAcceleratorPortRange) Reset() {
	*x = AwsGlobalAcceleratorPortRange{}
	mi := &file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlobalAcceleratorPortRange) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsGlobalAcceleratorEndpointGroup) Reset() {
	*x = AwsGlobalAcceleratorEndpointGroup{}
	mi := &file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlobalAcceleratorEndpointGroup) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsGlobalAcceleratorEndpoint) Reset() {
	*x = AwsGlobalAcceleratorEndpoint{}
	mi := &file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlobalAcceleratorEndpoint) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsGlobalAcceleratorPortOverride) Reset() {
	*x = AwsGlobalAcceleratorPortOverride{}
	mi := &file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlobalAcceleratorPortOverride) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Adev/planton/provider/aws/awsglobalaccelerator/v1alpha1/spec.proto\x126dev.planton.provider.aws.awsglobalaccelerator.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xfb\x04\n" +
	...
	"\fip_addresses\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\x10\x02R\vipAddresses\x12q\n" +
	"\tflow_logs\x18\x05 \x01(\v2T.dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorFlowLogsR\bflowLogs\x12\x7f\n" +
	"\tlisteners\x18\x06 \x03(\v2T.dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorListenerB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\tlisteners:\x9c\x01\xbaH\x98\x01\x1a\x95\x01\n" +
	...
	"\x1cflow_logs_s3_bucket_required\x120s3_bucket is required when flow logs are enabled\x1a$!this.enabled || has(this.s3_bucket)\"\xf4\x06\n" +
	...
	"\x0fclient_affinity\x18\x03 \x01(\tB\b\x8a\xa6\x1d\x04NONEH\x00R\x0eclientAffinity\x88\x01\x01\x12\x85\x01\n" +
	"\vport_ranges\x18\x04 \x03(\v2U.dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorPortRangeB\r\xbaH\n" +
	"\xc8\x01\x01\x92\x01\x04\b\x01\x10\n" +
	"R\n" +
	"portRanges\x12\x8f\x01\n" +
	"\x0fendpoint_groups\x18\x05 \x03(\v2Y.dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpointGroupB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\x0eendpointGroups:\xf7\x01\xbaH\xf3\x01\x1a[\n" +
	...
	"\x10port_range_order\x122to_port must be greater than or equal to from_port\x1a\x1ethis.to_port >= this.from_port\"\x88\f\n" +
	...
	"\x17traffic_dial_percentage\x18\b \x01(\x01B \xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00Y@)\x00\x00\x00\x00\x00\x00\x00\x00\x92\xa6\x1d\x05100.0H\x04R\x15trafficDialPercentage\x88\x01\x01\x12r\n" +
	"\tendpoints\x18\t \x03(\v2T.dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpointR\tendpoints\x12\x89\x01\n" +
	"\x0eport_overrides\x18\n" +
	" \x03(\v2X.dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorPortOverrideB\b\xbaH\x05\x92\x01\x02\x10\n" +
	...
	"\rendpoint_port\x18\x02 \x01(\x05B\x0e\xbaH\v\xc8\x01\x01\x1a\x06\x18\xff\xff\x03(\x01R\fendpointPortB\xbd\x03\n" +
	":com.dev.planton.provider.aws.awsglobalaccelerator.v1alpha1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsglobalaccelerator/v1alpha1;awsglobalacceleratorv1alpha1\xa2\x02\x05DPPAA\xaa\x026Dev.Planton.Provider.Aws.Awsglobalaccelerator.V1alpha1\xca\x026Dev\\Planton\\Provider\\Aws\\Awsglobalaccelerator\\V1alpha1\xe2\x02BDev\\Planton\\Provider\\Aws\\Awsglobalaccelerator\\V1alpha1\\GPBMetadata\xea\x02;Dev::Planton::Provider::Aws::Awsglobalaccelerator::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_goTypes = []any{
	(*AwsGlobalAcceleratorSpec)(nil),          // 0: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorSpec
	(*AwsGlobalAcceleratorFlowLogs)(nil),      // 1: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorFlowLogs
	(*AwsGlobalAcceleratorListener)(nil),      // 2: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorListener
	(*AwsGlobalAcceleratorPortRange)(nil),     // 3: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorPortRange
	(*AwsGlobalAcceleratorEndpointGroup)(nil), // 4: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpointGroup
	(*AwsGlobalAcceleratorEndpoint)(nil),      // 5: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpoint
	(*AwsGlobalAcceleratorPortOverride)(nil),  // 6: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorPortOverride
	(*v1.StringValueOrRef)(nil),               // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorSpec.flow_logs:type_name -> dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorFlowLogs
	2, // 1: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorSpec.listeners:type_name -> dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorListener
	7, // 2: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorFlowLogs.s3_bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 3: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorListener.port_ranges:type_name -> dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorPortRange
	4, // 4: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorListener.endpoint_groups:type_name -> dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpointGroup
	5, // 5: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpointGroup.endpoints:type_name -> dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpoint
	6, // 6: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpointGroup.port_overrides:type_name -> dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorPortOverride
	7, // 7: dev.planton.provider.aws.awsglobalaccelerator.v1alpha1.AwsGlobalAcceleratorEndpoint.endpoint_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsglobalaccelerator_v1alpha1_spec_proto_depIdxs = nil
}
