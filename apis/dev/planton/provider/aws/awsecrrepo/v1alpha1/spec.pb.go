...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsecrrepo/v1alpha1/spec.proto
...
func (x *AwsEcrRepoSpec) Reset() {
	*x = AwsEcrRepoSpec{}
	mi := &file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsEcrRepoSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEcrRepoLifecycleRule) Reset() {
	*x = AwsEcrRepoLifecycleRule{}
	mi := &file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcrRepoLifecycleRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7dev/planton/provider/aws/awsecrrepo/v1alpha1/spec.proto\x12,dev.planton.provider.aws.awsecrrepo.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x89\x14\n" +
	...
	"\fforce_delete\x18\b \x01(\bR\vforceDelete\x12n\n" +
	"\x0flifecycle_rules\x18\t \x03(\v2E.dev.planton.provider.aws.awsecrrepo.v1alpha1.AwsEcrRepoLifecycleRuleR\x0elifecycleRules\x12D\n" +
	...
	"\x1ctagged_requires_one_selector\x12ktag_status 'tagged' requires exactly one of tag_prefixes or tag_patterns; 'untagged' and 'any' take neither\x1a\xa3\x01this.tag_status == 'tagged' ? ((this.tag_prefixes.size() > 0) != (this.tag_patterns.size() > 0)) : (this.tag_prefixes.size() == 0 && this.tag_patterns.size() == 0)B\xf7\x02\n" +
	"0com.dev.planton.provider.aws.awsecrrepo.v1alpha1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsecrrepo/v1alpha1;awsecrrepov1alpha1\xa2\x02\x05DPPAA\xaa\x02,Dev.Planton.Provider.Aws.Awsecrrepo.V1alpha1\xca\x02,Dev\\Planton\\Provider\\Aws\\Awsecrrepo\\V1alpha1\xe2\x028Dev\\Planton\\Provider\\Aws\\Awsecrrepo\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Provider::Aws::Awsecrrepo::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_goTypes = []any{
	(*AwsEcrRepoSpec)(nil),          // 0: dev.planton.provider.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec
	(*AwsEcrRepoLifecycleRule)(nil), // 1: dev.planton.provider.aws.awsecrrepo.v1alpha1.AwsEcrRepoLifecycleRule
	(*v1.StringValueOrRef)(nil),     // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),         // 3: google.protobuf.Struct
}
var file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec.lifecycle_rules:type_name -> dev.planton.provider.aws.awsecrrepo.v1alpha1.AwsEcrRepoLifecycleRule
	3, // 2: dev.planton.provider.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec.repository_policy:type_name -> google.protobuf.Struct
...
func init() { file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsecrrepo_v1alpha1_spec_proto_depIdxs = nil
}
