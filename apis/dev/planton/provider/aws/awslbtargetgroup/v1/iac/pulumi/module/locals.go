...
type Locals struct {
	AwsLbTargetGroup *awslbtargetgroupv1.AwsLbTargetGroup
	AwsTags          map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *awslbtargetgroupv1.AwsLbTargetGroupStackInput) *Locals {
	locals := &Locals{}
