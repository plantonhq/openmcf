...
func healthCheckArgs(hc *awslbtargetgroupv1.AwsLbTargetGroupHealthCheck) *lb.TargetGroupHealthCheckArgs {
...
func stickinessArgs(s *awslbtargetgroupv1.AwsLbTargetGroupStickiness) *lb.TargetGroupStickinessArgs {
	enabled := true
	if s.Enabled != nil {
...
func targetGroupHealthArgs(h *awslbtargetgroupv1.AwsLbTargetGroupHealthPolicy) *lb.TargetGroupTargetGroupHealthArgs {
...
func specTargetTypeOrDefault(spec *awslbtargetgroupv1.AwsLbTargetGroupSpec) string {
	if spec.TargetType == "" {
		return "instance"
	}
