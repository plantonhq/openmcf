...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awskinesisstream/v1alpha1/spec.proto
...
func (x *AwsKinesisStreamSpec) Reset() {
	*x = AwsKinesisStreamSpec{}
	mi := &file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsKinesisStreamSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/aws/awskinesisstream/v1alpha1/spec.proto\x122dev.planton.provider.aws.awskinesisstream.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x9a\x11\n" +
	...
	"*warm_throughput_conflicts_with_shard_count\x12rwarm_throughput_mib_ps cannot be set together with shard_count (warm throughput applies to ON_DEMAND streams only)\x1a9this.warm_throughput_mib_ps == 0 || this.shard_count == 0B\xa1\x03\n" +
	"6com.dev.planton.provider.aws.awskinesisstream.v1alpha1B\tSpecProtoP\x01Zmgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awskinesisstream/v1alpha1;awskinesisstreamv1alpha1\xa2\x02\x05DPPAA\xaa\x022Dev.Planton.Provider.Aws.Awskinesisstream.V1alpha1\xca\x022Dev\\Planton\\Provider\\Aws\\Awskinesisstream\\V1alpha1\xe2\x02>Dev\\Planton\\Provider\\Aws\\Awskinesisstream\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Provider::Aws::Awskinesisstream::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_goTypes = []any{
	(*AwsKinesisStreamSpec)(nil), // 0: dev.planton.provider.aws.awskinesisstream.v1alpha1.AwsKinesisStreamSpec
	(*v1.StringValueOrRef)(nil),  // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),      // 2: google.protobuf.Struct
}
var file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awskinesisstream.v1alpha1.AwsKinesisStreamSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.aws.awskinesisstream.v1alpha1.AwsKinesisStreamSpec.resource_policy:type_name -> google.protobuf.Struct
...
func init() { file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awskinesisstream_v1alpha1_spec_proto_depIdxs = nil
}
