...
import (
	...
	"github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsecsservice/v1alpha1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &awsecsservicev1alpha1.AwsEcsServiceStackInput{}
