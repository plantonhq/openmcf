...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsroute53healthcheck/v1alpha1/spec.proto
...
func (x *AwsRoute53HealthCheckSpec) Reset() {
	*x = AwsRoute53HealthCheckSpec{}
	mi := &file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRoute53HealthCheckSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/provider/aws/awsroute53healthcheck/v1alpha1/spec.proto\x127dev.planton.provider.aws.awsroute53healthcheck.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x9a\x1f\n" +
	...
	"\v_enable_sniB\xc4\x03\n" +
	";com.dev.planton.provider.aws.awsroute53healthcheck.v1alpha1B\tSpecProtoP\x01Zwgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsroute53healthcheck/v1alpha1;awsroute53healthcheckv1alpha1\xa2\x02\x05DPPAA\xaa\x027Dev.Planton.Provider.Aws.Awsroute53healthcheck.V1alpha1\xca\x027Dev\\Planton\\Provider\\Aws\\Awsroute53healthcheck\\V1alpha1\xe2\x02CDev\\Planton\\Provider\\Aws\\Awsroute53healthcheck\\V1alpha1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Aws::Awsroute53healthcheck::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_goTypes = []any{
	(*AwsRoute53HealthCheckSpec)(nil), // 0: dev.planton.provider.aws.awsroute53healthcheck.v1alpha1.AwsRoute53HealthCheckSpec
	(*v1.StringValueOrRef)(nil),       // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awsroute53healthcheck.v1alpha1.AwsRoute53HealthCheckSpec.child_health_checks:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsroute53healthcheck_v1alpha1_spec_proto_depIdxs = nil
}
