...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsbatchcomputeenvironment/v1/spec.proto
...
func (x *AwsBatchComputeEnvironmentSpec) Reset() {
	*x = AwsBatchComputeEnvironmentSpec{}
	mi := &file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[0]
...
func (*AwsBatchComputeEnvironmentSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsBatchComputeResources) Reset() {
	*x = AwsBatchComputeResources{}
	mi := &file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsBatchComputeResources) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsBatchLaunchTemplate) Reset() {
	*x = AwsBatchLaunchTemplate{}
	mi := &file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AwsBatchEc2Configuration) Reset() {
	*x = AwsBatchEc2Configuration{}
	mi := &file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsBatchEc2Configuration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsBatchEksConfiguration) Reset() {
	*x = AwsBatchEksConfiguration{}
	mi := &file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsBatchEksConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsBatchUpdatePolicy) Reset() {
	*x = AwsBatchUpdatePolicy{}
	mi := &file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsBatchUpdatePolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
var File_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Adev/planton/provider/aws/awsbatchcomputeenvironment/v1/spec.proto\x126dev.planton.provider.aws.awsbatchcomputeenvironment.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xfe\x04\n" +
	...
	"\rresource_tags\x18\x10 \x03(\v2b.dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.ResourceTagsEntryR\fresourceTags\x1a?\n" +
	...
	"\x1e_job_execution_timeout_minutesB\xbd\x03\n" +
	":com.dev.planton.provider.aws.awsbatchcomputeenvironment.v1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsbatchcomputeenvironment/v1;awsbatchcomputeenvironmentv1\xa2\x02\x05DPPAA\xaa\x026Dev.Planton.Provider.Aws.Awsbatchcomputeenvironment.V1\xca\x026Dev\\Planton\\Provider\\Aws\\Awsbatchcomputeenvironment\\V1\xe2\x02BDev\\Planton\\Provider\\Aws\\Awsbatchcomputeenvironment\\V1\\GPBMetadata\xea\x02;Dev::Planton::Provider::Aws::Awsbatchcomputeenvironment::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_goTypes = []any{
	(*AwsBatchComputeEnvironmentSpec)(nil), // 0: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeEnvironmentSpec
	(*AwsBatchComputeResources)(nil),       // 1: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources
	(*AwsBatchLaunchTemplate)(nil),         // 2: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchLaunchTemplate
	(*AwsBatchEc2Configuration)(nil),       // 3: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchEc2Configuration
	(*AwsBatchEksConfiguration)(nil),       // 4: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchEksConfiguration
	(*AwsBatchUpdatePolicy)(nil),           // 5: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchUpdatePolicy
	nil,                                    // 6: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.ResourceTagsEntry
	(*v1.StringValueOrRef)(nil),            // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_depIdxs = []int32{
	7,  // 0: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeEnvironmentSpec.service_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeEnvironmentSpec.compute_resources:type_name -> dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources
	4,  // 2: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeEnvironmentSpec.eks_configuration:type_name -> dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchEksConfiguration
	5,  // 3: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeEnvironmentSpec.update_policy:type_name -> dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchUpdatePolicy
	7,  // 4: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 5: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 6: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.instance_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 7: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.spot_iam_fleet_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 8: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.launch_template:type_name -> dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchLaunchTemplate
	3,  // 9: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.ec2_configurations:type_name -> dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchEc2Configuration
	6,  // 10: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.resource_tags:type_name -> dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchComputeResources.ResourceTagsEntry
	7,  // 11: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchLaunchTemplate.launch_template_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 12: dev.planton.provider.aws.awsbatchcomputeenvironment.v1.AwsBatchEksConfiguration.eks_cluster_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsbatchcomputeenvironment_v1_spec_proto_depIdxs = nil
}
