...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsiamuser/v1alpha1/spec.proto
...
func (x *AwsIamUserSpec) Reset() {
	*x = AwsIamUserSpec{}
	mi := &file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsIamUserSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7dev/planton/provider/aws/awsiamuser/v1alpha1/spec.proto\x12,dev.planton.provider.aws.awsiamuser.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xf3\a\n" +
	...
	"\x13managed_policy_arns\x18\x04 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\"\x88\xd4a\x86\b\x92\xd4a\x19status.outputs.policy_arnR\x11managedPolicyArns\x12\x88\x01\n" +
	"\x0finline_policies\x18\x05 \x03(\v2P.dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec.InlinePoliciesEntryB\r\xbaH\n" +
	...
	"\vpath_length\x12#path must be at most 512 characters\x1a\x16size(this.path) <= 512B\xf7\x02\n" +
	"0com.dev.planton.provider.aws.awsiamuser.v1alpha1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsiamuser/v1alpha1;awsiamuserv1alpha1\xa2\x02\x05DPPAA\xaa\x02,Dev.Planton.Provider.Aws.Awsiamuser.V1alpha1\xca\x02,Dev\\Planton\\Provider\\Aws\\Awsiamuser\\V1alpha1\xe2\x028Dev\\Planton\\Provider\\Aws\\Awsiamuser\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Provider::Aws::Awsiamuser::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_goTypes = []any{
	(*AwsIamUserSpec)(nil),      // 0: dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec
	nil,                         // 1: dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec.InlinePoliciesEntry
	(*v1.StringValueOrRef)(nil), // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),     // 3: google.protobuf.Struct
}
var file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec.managed_policy_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec.inline_policies:type_name -> dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec.InlinePoliciesEntry
	2, // 2: dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec.permissions_boundary:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 3: dev.planton.provider.aws.awsiamuser.v1alpha1.AwsIamUserSpec.InlinePoliciesEntry.value:type_name -> google.protobuf.Struct
...
func init() { file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsiamuser_v1alpha1_spec_proto_depIdxs = nil
}
