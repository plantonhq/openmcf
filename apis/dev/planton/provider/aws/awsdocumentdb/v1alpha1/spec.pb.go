...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsdocumentdb/v1alpha1/spec.proto
...
func (x *AwsDocumentDbSpec) Reset() {
	*x = AwsDocumentDbSpec{}
	mi := &file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsDocumentDbSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsDocumentDbInstance) Reset() {
	*x = AwsDocumentDbInstance{}
	mi := &file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbInstance) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsDocumentDbServerlessV2Scaling) Reset() {
	*x = AwsDocumentDbServerlessV2Scaling{}
	mi := &file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbServerlessV2Scaling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsDocumentDbRestoreToPointInTime) Reset() {
	*x = AwsDocumentDbRestoreToPointInTime{}
	mi := &file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbRestoreToPointInTime) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsDocumentDbParameter) Reset() {
	*x = AwsDocumentDbParameter{}
	mi := &file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbParameter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":dev/planton/provider/aws/awsdocumentdb/v1alpha1/spec.proto\x12/dev.planton.provider.aws.awsdocumentdb.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x8a+\n" +
	...
	"\fstorage_type\x18\t \x01(\tB\x19\xbaH\x16\xd8\x01\x01r\x11R\bstandardR\x05iopt1R\vstorageType\x12d\n" +
	"\tinstances\x18\n" +
	" \x03(\v2F.dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbInstanceR\tinstances\x12\x85\x01\n" +
	"\x15serverless_v2_scaling\x18\v \x01(\v2Q.dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbServerlessV2ScalingR\x13serverlessV2Scaling\x12'\n" +
	...
	"\x13snapshot_identifier\x18\x18 \x01(\tR\x12snapshotIdentifier\x12\x8a\x01\n" +
	"\x18restore_to_point_in_time\x18\x19 \x01(\v2R.dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbRestoreToPointInTimeR\x14restoreToPointInTime\x12:\n" +
	"\x19global_cluster_identifier\x18\x1a \x01(\tR\x17globalClusterIdentifier\x12D\n" +
	"\x1fdb_cluster_parameter_group_name\x18\x1b \x01(\tR\x1bdbClusterParameterGroupName\x12g\n" +
	"\n" +
	"parameters\x18\x1c \x03(\v2G.dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbParameterR\n" +
	"parameters\x12+\n" +
	...
	"3com.dev.planton.provider.aws.awsdocumentdb.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsdocumentdb/v1alpha1;awsdocumentdbv1alpha1\xa2\x02\x05DPPAA\xaa\x02/Dev.Planton.Provider.Aws.Awsdocumentdb.V1alpha1\xca\x02/Dev\\Planton\\Provider\\Aws\\Awsdocumentdb\\V1alpha1\xe2\x02;Dev\\Planton\\Provider\\Aws\\Awsdocumentdb\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Provider::Aws::Awsdocumentdb::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_goTypes = []any{
	(*AwsDocumentDbSpec)(nil),                 // 0: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec
	(*AwsDocumentDbInstance)(nil),             // 1: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbInstance
	(*AwsDocumentDbServerlessV2Scaling)(nil),  // 2: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbServerlessV2Scaling
	(*AwsDocumentDbRestoreToPointInTime)(nil), // 3: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbRestoreToPointInTime
	(*AwsDocumentDbParameter)(nil),            // 4: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbParameter
	(*v1.StringValueOrRef)(nil),               // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 1: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.db_subnet_group_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 2: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 3: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.instances:type_name -> dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbInstance
	2, // 4: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.serverless_v2_scaling:type_name -> dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbServerlessV2Scaling
	5, // 5: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 6: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.restore_to_point_in_time:type_name -> dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbRestoreToPointInTime
	4, // 7: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec.parameters:type_name -> dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbParameter
	5, // 8: dev.planton.provider.aws.awsdocumentdb.v1alpha1.AwsDocumentDbInstance.performance_insights_kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsdocumentdb_v1alpha1_spec_proto_depIdxs = nil
}
