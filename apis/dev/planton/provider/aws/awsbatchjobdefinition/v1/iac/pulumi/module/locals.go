...
type Locals struct {
	AwsBatchJobDefinition *awsbatchjobdefinitionv1.AwsBatchJobDefinition
	AwsTags               map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *awsbatchjobdefinitionv1.AwsBatchJobDefinitionStackInput) *Locals {
	locals := &Locals{}
