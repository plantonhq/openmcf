...
func Resources(ctx *pulumi.Context, stackInput *awsecstaskdefinitionv1.AwsEcsTaskDefinitionStackInput) error {
...
func buildContainerDefinitions(spec *awsecstaskdefinitionv1.AwsEcsTaskDefinitionSpec, logGroupName string) (string, error) {
