...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awseventbridgebus/v1alpha1/spec.proto
...
func (x *AwsEventBridgeBusSpec) Reset() {
	*x = AwsEventBridgeBusSpec{}
	mi := &file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsEventBridgeBusSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEventBridgeBusDeadLetterConfig) Reset() {
	*x = AwsEventBridgeBusDeadLetterConfig{}
	mi := &file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEventBridgeBusDeadLetterConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEventBridgeBusLogConfig) Reset() {
	*x = AwsEventBridgeBusLogConfig{}
	mi := &file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEventBridgeBusLogConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/aws/awseventbridgebus/v1alpha1/spec.proto\x123dev.planton.provider.aws.awseventbridgebus.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xd7\x06\n" +
	...
	"\x11event_source_name\x18\x04 \x01(\tR\x0feventSourceName\x12\x84\x01\n" +
	"\x12dead_letter_config\x18\x05 \x01(\v2V.dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusDeadLetterConfigR\x10deadLetterConfig\x12n\n" +
	"\n" +
	"log_config\x18\x06 \x01(\v2O.dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusLogConfigR\tlogConfig\x12@\n" +
	...
	"\x15include_detail_values\x12)include_detail must be one of: NONE, FULL\x1aDthis.include_detail == '' || this.include_detail in ['NONE', 'FULL']B\xa8\x03\n" +
	"7com.dev.planton.provider.aws.awseventbridgebus.v1alpha1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awseventbridgebus/v1alpha1;awseventbridgebusv1alpha1\xa2\x02\x05DPPAA\xaa\x023Dev.Planton.Provider.Aws.Awseventbridgebus.V1alpha1\xca\x023Dev\\Planton\\Provider\\Aws\\Awseventbridgebus\\V1alpha1\xe2\x02?Dev\\Planton\\Provider\\Aws\\Awseventbridgebus\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Provider::Aws::Awseventbridgebus::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_goTypes = []any{
	(*AwsEventBridgeBusSpec)(nil),             // 0: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusSpec
	(*AwsEventBridgeBusDeadLetterConfig)(nil), // 1: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusDeadLetterConfig
	(*AwsEventBridgeBusLogConfig)(nil),        // 2: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusLogConfig
	(*v1.StringValueOrRef)(nil),               // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),                   // 4: google.protobuf.Struct
}
var file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusSpec.kms_key_identifier:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusSpec.dead_letter_config:type_name -> dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusDeadLetterConfig
	2, // 2: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusSpec.log_config:type_name -> dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusLogConfig
	4, // 3: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusSpec.resource_policy:type_name -> google.protobuf.Struct
	3, // 4: dev.planton.provider.aws.awseventbridgebus.v1alpha1.AwsEventBridgeBusDeadLetterConfig.arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awseventbridgebus_v1alpha1_spec_proto_depIdxs = nil
}
