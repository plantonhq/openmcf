...
type Locals struct {
	AwsLambdaEventSourceMapping *awslambdaeventsourcemappingv1.AwsLambdaEventSourceMapping
...
func initializeLocals(_ *pulumi.Context, stackInput *awslambdaeventsourcemappingv1.AwsLambdaEventSourceMappingStackInput) *Locals {
	locals := &Locals{}
