...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsredshiftcluster/v1alpha1/spec.proto
...
func (x *AwsRedshiftClusterSpec) Reset() {
	*x = AwsRedshiftClusterSpec{}
	mi := &file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRedshiftClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRedshiftClusterLogging) Reset() {
	*x = AwsRedshiftClusterLogging{}
	mi := &file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedshiftClusterLogging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRedshiftClusterSnapshotCopy) Reset() {
	*x = AwsRedshiftClusterSnapshotCopy{}
	mi := &file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedshiftClusterSnapshotCopy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsRedshiftClusterParameter) Reset() {
	*x = AwsRedshiftClusterParameter{}
	mi := &file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedshiftClusterParameter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"?dev/planton/provider/aws/awsredshiftcluster/v1alpha1/spec.proto\x124dev.planton.provider.aws.awsredshiftcluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xcd0\n" +
	...
	"\rowner_account\x18# \x01(\tR\fownerAccount\x12i\n" +
	"\alogging\x18$ \x01(\v2O.dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterLoggingR\alogging\x12y\n" +
	"\rsnapshot_copy\x18% \x01(\v2T.dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSnapshotCopyR\fsnapshotCopy\x12?\n" +
	"\x1ccluster_parameter_group_name\x18& \x01(\tR\x19clusterParameterGroupName\x12q\n" +
	"\n" +
	"parameters\x18' \x03(\v2Q.dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterParameterR\n" +
	"parameters\x124\n" +
	...
	"8com.dev.planton.provider.aws.awsredshiftcluster.v1alpha1B\tSpecProtoP\x01Zqgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsredshiftcluster/v1alpha1;awsredshiftclusterv1alpha1\xa2\x02\x05DPPAA\xaa\x024Dev.Planton.Provider.Aws.Awsredshiftcluster.V1alpha1\xca\x024Dev\\Planton\\Provider\\Aws\\Awsredshiftcluster\\V1alpha1\xe2\x02@Dev\\Planton\\Provider\\Aws\\Awsredshiftcluster\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Provider::Aws::Awsredshiftcluster::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_goTypes = []any{
	(*AwsRedshiftClusterSpec)(nil),         // 0: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec
	(*AwsRedshiftClusterLogging)(nil),      // 1: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterLogging
	(*AwsRedshiftClusterSnapshotCopy)(nil), // 2: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSnapshotCopy
	(*AwsRedshiftClusterParameter)(nil),    // 3: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterParameter
	(*v1.StringValueOrRef)(nil),            // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_depIdxs = []int32{
	4,  // 0: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 1: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.cluster_subnet_group_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 2: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 3: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.elastic_ip:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 4: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.master_password_secret_kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 5: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 6: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.iam_roles:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 7: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.default_iam_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 8: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.logging:type_name -> dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterLogging
	2,  // 9: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.snapshot_copy:type_name -> dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSnapshotCopy
	3,  // 10: dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterSpec.parameters:type_name -> dev.planton.provider.aws.awsredshiftcluster.v1alpha1.AwsRedshiftClusterParameter
...
func init() { file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsredshiftcluster_v1alpha1_spec_proto_depIdxs = nil
}
