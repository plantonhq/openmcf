...
type Locals struct {
	AwsSesConfigurationSet *awssesconfigurationsetv1.AwsSesConfigurationSet
	...
	EventDestinations map[string]*awssesconfigurationsetv1.AwsSesConfigurationSetEventDestination
}

func initializeLocals(_ *pulumi.Context, stackInput *awssesconfigurationsetv1.AwsSesConfigurationSetStackInput) *Locals {
	locals := &Locals{}
	...
	locals.EventDestinations = make(map[string]*awssesconfigurationsetv1.AwsSesConfigurationSetEventDestination)
