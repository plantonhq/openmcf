...
- [AWS SES Email Identity](/docs/catalog/aws/awssesemailidentity) — references a configuration set as its default sending rules.
- [AWS SNS Topic](/docs/catalog/aws/awssnstopic) — the classic bounce/complaint feedback-loop destination.
- [AWS Kinesis Firehose](/docs/catalog/aws/awskinesisfirehose) — durable event analytics into S3/Redshift/OpenSearch.
- [AWS EventBridge Bus](/docs/catalog/aws/awseventbridgebus) — rule-based routing of email events.
