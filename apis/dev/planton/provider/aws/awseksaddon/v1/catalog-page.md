...
- [AwsEksCluster](/docs/catalog/aws/awsekscluster) — the control plane the add-on installs on
- [AwsIamRole](/docs/catalog/aws/awsiamrole) — the add-on's IAM identity (IRSA or Pod Identity)
- [AwsIamOidcProvider](/docs/catalog/aws/awsiamoidcprovider) — required for IRSA wiring
- [AwsEksNodeGroup](/docs/catalog/aws/awseksnodegroup) — the compute the add-on's pods run on
