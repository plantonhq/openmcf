...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awslambda/v1alpha1/spec.proto
...
func (x *AwsLambdaSpec) Reset() {
	*x = AwsLambdaSpec{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsLambdaSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsLambdaS3Code) Reset() {
	*x = AwsLambdaS3Code{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaS3Code) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsLambdaImageConfig) Reset() {
	*x = AwsLambdaImageConfig{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaImageConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsLambdaFileSystemConfig) Reset() {
	*x = AwsLambdaFileSystemConfig{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaFileSystemConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsLambdaLoggingConfig) Reset() {
	*x = AwsLambdaLoggingConfig{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaLoggingConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsLambdaAlias) Reset() {
	*x = AwsLambdaAlias{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaAlias) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsLambdaFunctionUrl) Reset() {
	*x = AwsLambdaFunctionUrl{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaFunctionUrl) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsLambdaFunctionUrlCors) Reset() {
	*x = AwsLambdaFunctionUrlCors{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaFunctionUrlCors) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsLambdaInvokePermission) Reset() {
	*x = AwsLambdaInvokePermission{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaInvokePermission) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsLambdaAsyncInvokeConfig) Reset() {
	*x = AwsLambdaAsyncInvokeConfig{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaAsyncInvokeConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *AwsLambdaRuntimeManagement) Reset() {
	*x = AwsLambdaRuntimeManagement{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLambdaRuntimeManagement) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
var File_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"6dev/planton/provider/aws/awslambda/v1alpha1/spec.proto\x12+dev.planton.provider.aws.awslambda.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xf6(\n" +
	"\rAwsLambdaSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x02R\vdescription\x12u\n" +
	"\brole_arn\x18\x03 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB&\xbaH\x03\xc8\x01\x01\x88\xd4a\xf0\a\x92\xd4a\x17status.outputs.role_arnR\aroleArn\x12L\n" +
	"\x02s3\x18\x04 \x01(\v2<.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaS3CodeR\x02s3\x12\x1b\n" +
	...
	"\x14ephemeral_storage_mb\x18\r \x01(\x05B\x0e\xbaH\v\xd8\x01\x01\x1a\x06\x18\x80P(\x80\x04R\x12ephemeralStorageMb\x12m\n" +
	"\venvironment\x18\x0e \x03(\v2K.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.EnvironmentEntryR\venvironment\x12s\n" +
	...
	"\ftracing_mode\x18\x14 \x01(\tB\x1d\xbaH\x1a\xd8\x01\x01r\x15R\x06ActiveR\vPassThroughR\vtracingMode\x12t\n" +
	"\x12file_system_config\x18\x15 \x01(\v2F.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFileSystemConfigR\x10fileSystemConfig\x12d\n" +
	"\fimage_config\x18\x16 \x01(\v2A.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaImageConfigR\vimageConfig\x12[\n" +
	"\n" +
	...
	"\x0elogging_config\x18\x1b \x01(\v2C.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaLoggingConfigR\rloggingConfig\x125\n" +
	"\x17code_signing_config_arn\x18\x1c \x01(\tR\x14codeSigningConfigArn\x12U\n" +
	"\aaliases\x18\x1d \x03(\v2;.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAliasR\aaliases\x12d\n" +
	"\ffunction_url\x18\x1e \x01(\v2A.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFunctionUrlR\vfunctionUrl\x12u\n" +
	"\x12invoke_permissions\x18\x1f \x03(\v2F.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaInvokePermissionR\x11invokePermissions\x12w\n" +
	"\x13async_invoke_config\x18  \x01(\v2G.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAsyncInvokeConfigR\x11asyncInvokeConfig\x12A\n" +
	"\x0erecursive_loop\x18! \x01(\tB\x1a\xbaH\x17\xd8\x01\x01r\x12R\x05AllowR\tTerminateR\rrecursiveLoop\x12v\n" +
	"\x12runtime_management\x18\" \x01(\v2G.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaRuntimeManagementR\x11runtimeManagement\x1a>\n" +
	...
	"\x1dlevel_filtering_requires_json\x12wapplication_log_level and system_log_level require log_format JSON -- plain-text logs carry no level field to filter on\x1a^(this.application_log_level == '' && this.system_log_level == '') || this.log_format == 'JSON'\"\xe1\v\n" +
	...
	"\x10function_version\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0ffunctionVersion\x12\xad\x01\n" +
	"\"routing_additional_version_weights\x18\x04 \x03(\v2`.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAlias.RoutingAdditionalVersionWeightsEntryR\x1froutingAdditionalVersionWeights\x12X\n" +
	...
	"\"_provisioned_concurrent_executions\"\xff\x01\n" +
	...
	"invokeMode\x12Y\n" +
	"\x04cors\x18\x03 \x01(\v2E.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFunctionUrlCorsR\x04cors\"\x95\x02\n" +
	...
	"\x1fmanual_pin_requires_version_arn\x12wupdate_runtime_on Manual requires runtime_version_arn (the exact runtime build to pin); other modes must leave it empty\x1aH(this.update_runtime_on == 'Manual') == (this.runtime_version_arn != '')B\xf0\x02\n" +
	"/com.dev.planton.provider.aws.awslambda.v1alpha1B\tSpecProtoP\x01Z_github.com/plantonhq/planton/apis/dev/planton/provider/aws/awslambda/v1alpha1;awslambdav1alpha1\xa2\x02\x05DPPAA\xaa\x02+Dev.Planton.Provider.Aws.Awslambda.V1alpha1\xca\x02+Dev\\Planton\\Provider\\Aws\\Awslambda\\V1alpha1\xe2\x027Dev\\Planton\\Provider\\Aws\\Awslambda\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Provider::Aws::Awslambda::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_goTypes = []any{
	(*AwsLambdaSpec)(nil),              // 0: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec
	(*AwsLambdaS3Code)(nil),            // 1: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaS3Code
	(*AwsLambdaImageConfig)(nil),       // 2: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaImageConfig
	(*AwsLambdaFileSystemConfig)(nil),  // 3: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFileSystemConfig
	(*AwsLambdaLoggingConfig)(nil),     // 4: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaLoggingConfig
	(*AwsLambdaAlias)(nil),             // 5: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAlias
	(*AwsLambdaFunctionUrl)(nil),       // 6: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFunctionUrl
	(*AwsLambdaFunctionUrlCors)(nil),   // 7: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFunctionUrlCors
	(*AwsLambdaInvokePermission)(nil),  // 8: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaInvokePermission
	(*AwsLambdaAsyncInvokeConfig)(nil), // 9: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAsyncInvokeConfig
	(*AwsLambdaRuntimeManagement)(nil), // 10: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaRuntimeManagement
	nil,                                // 11: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.EnvironmentEntry
	nil,                                // 12: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAlias.RoutingAdditionalVersionWeightsEntry
	(*v1.StringValueOrRef)(nil),        // 13: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_depIdxs = []int32{
	13, // 0: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.s3:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaS3Code
	13, // 2: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.source_kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 3: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.environment:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.EnvironmentEntry
	13, // 4: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	13, // 5: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	13, // 6: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	13, // 7: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.dead_letter_target_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 8: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.file_system_config:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFileSystemConfig
	2,  // 9: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.image_config:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaImageConfig
	13, // 10: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.layer_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 11: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.logging_config:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaLoggingConfig
	5,  // 12: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.aliases:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAlias
	6,  // 13: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.function_url:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFunctionUrl
	8,  // 14: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.invoke_permissions:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaInvokePermission
	9,  // 15: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.async_invoke_config:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAsyncInvokeConfig
	10, // 16: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaSpec.runtime_management:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaRuntimeManagement
	13, // 17: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaS3Code.bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	13, // 18: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFileSystemConfig.access_point_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	13, // 19: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaLoggingConfig.log_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 20: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAlias.routing_additional_version_weights:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAlias.RoutingAdditionalVersionWeightsEntry
	7,  // 21: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFunctionUrl.cors:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaFunctionUrlCors
	13, // 22: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAsyncInvokeConfig.on_success_destination_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	13, // 23: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaAsyncInvokeConfig.on_failure_destination_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awslambda_v1alpha1_spec_proto_depIdxs = nil
}
