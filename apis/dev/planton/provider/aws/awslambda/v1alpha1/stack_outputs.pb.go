...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awslambda/v1alpha1/stack_outputs.proto
...
func (x *AwsLambdaStackOutputs) Reset() {
	*x = AwsLambdaStackOutputs{}
	mi := &file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*AwsLambdaStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"?dev/planton/provider/aws/awslambda/v1alpha1/stack_outputs.proto\x12+dev.planton.provider.aws.awslambda.v1alpha1\"\xb6\x03\n" +
	...
	"\ffunction_url\x18\x06 \x01(\tR\vfunctionUrl\x12p\n" +
	"\n" +
	"alias_arns\x18\a \x03(\v2Q.dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaStackOutputs.AliasArnsEntryR\taliasArns\x12$\n" +
	...
	"/com.dev.planton.provider.aws.awslambda.v1alpha1B\x11StackOutputsProtoP\x01Z_github.com/plantonhq/planton/apis/dev/planton/provider/aws/awslambda/v1alpha1;awslambdav1alpha1\xa2\x02\x05DPPAA\xaa\x02+Dev.Planton.Provider.Aws.Awslambda.V1alpha1\xca\x02+Dev\\Planton\\Provider\\Aws\\Awslambda\\V1alpha1\xe2\x027Dev\\Planton\\Provider\\Aws\\Awslambda\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Provider::Aws::Awslambda::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*AwsLambdaStackOutputs)(nil), // 0: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaStackOutputs
	nil,                           // 1: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaStackOutputs.AliasArnsEntry
}
var file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaStackOutputs.alias_arns:type_name -> dev.planton.provider.aws.awslambda.v1alpha1.AwsLambdaStackOutputs.AliasArnsEntry
...
func init() { file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_init() }
func file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_init() {
	if File_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto = out.File
	file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_aws_awslambda_v1alpha1_stack_outputs_proto_depIdxs = nil
}
