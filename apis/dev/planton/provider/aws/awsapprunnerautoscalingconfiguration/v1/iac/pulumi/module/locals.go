...
type Locals struct {
	AwsAppRunnerAutoScalingConfiguration *awsapprunnerautoscalingconfigurationv1.AwsAppRunnerAutoScalingConfiguration
	AwsTags                              map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *awsapprunnerautoscalingconfigurationv1.AwsAppRunnerAutoScalingConfigurationStackInput) *Locals {
	locals := &Locals{}
