locals {
  ...
  # same basis the Pulumi module uses. AWS registers every value change as a
  # new revision under this name.
  ...
  aws_tags = {
    ...
    "planton.ai/resource-kind" = "AwsAppRunnerAutoScalingConfiguration"
