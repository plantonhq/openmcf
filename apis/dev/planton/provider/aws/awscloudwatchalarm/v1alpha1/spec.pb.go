...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awscloudwatchalarm/v1alpha1/spec.proto
...
func (x *AwsCloudwatchAlarmSpec) Reset() {
	*x = AwsCloudwatchAlarmSpec{}
	mi := &file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsCloudwatchAlarmSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsCloudwatchAlarmMetricQuery) Reset() {
	*x = AwsCloudwatchAlarmMetricQuery{}
	mi := &file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmMetricQuery) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCloudwatchAlarmMetricQueryMetric) Reset() {
	*x = AwsCloudwatchAlarmMetricQueryMetric{}
	mi := &file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmMetricQueryMetric) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsCloudwatchAlarmEvaluationCriteria) Reset() {
	*x = AwsCloudwatchAlarmEvaluationCriteria{}
	mi := &file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmEvaluationCriteria) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsCloudwatchAlarmPromqlCriteria) Reset() {
	*x = AwsCloudwatchAlarmPromqlCriteria{}
	mi := &file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmPromqlCriteria) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"?dev/planton/provider/aws/awscloudwatchalarm/v1alpha1/spec.proto\x124dev.planton.provider.aws.awscloudwatchalarm.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\x908\n" +
	...
	"\x12extended_statistic\x18\r \x01(\tR\x11extendedStatistic\x12|\n" +
	"\n" +
	"dimensions\x18\x0e \x03(\v2\\.dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.DimensionsEntryR\n" +
	"dimensions\x12\x12\n" +
	"\x04unit\x18\x0f \x01(\tR\x04unit\x12z\n" +
	"\x0emetric_queries\x18\x10 \x03(\v2S.dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryR\rmetricQueries\x12z\n" +
	...
	"%evaluate_low_sample_count_percentiles\x18\x15 \x01(\tR!evaluateLowSampleCountPercentiles\x12\x8b\x01\n" +
	"\x13evaluation_criteria\x18\x16 \x01(\v2Z.dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteriaR\x12evaluationCriteria\x12/\n" +
	...
	"expression\x12q\n" +
	"\x06metric\x18\x03 \x01(\v2Y.dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetricR\x06metric\x12\x14\n" +
	...
	"\x19query_period_valid_values\x12=period must be 1, 5, 10, 20, 30, or a multiple of 60 when set\x1aethis.period == 0 || this.period in [1, 5, 10, 20, 30] || (this.period >= 60 && this.period % 60 == 0)\"\xc6\x04\n" +
	...
	"\x04stat\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04stat\x12\x89\x01\n" +
	"\n" +
	"dimensions\x18\x05 \x03(\v2i.dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntryR\n" +
	"dimensions\x12\x12\n" +
	"\x04unit\x18\x06 \x01(\tR\x04unit\x1a=\n" +
	"\x0fDimensionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xac\x01\xbaH\xa8\x01\x1a\xa5\x01\n" +
	"\x1ametric_period_valid_values\x124period must be 1, 5, 10, 20, 30, or a multiple of 60\x1aQthis.period in [1, 5, 10, 20, 30] || (this.period >= 60 && this.period % 60 == 0)\"\xb0\x01\n" +
	"$AwsCloudwatchAlarmEvaluationCriteria\x12\x87\x01\n" +
	"\x0fpromql_criteria\x18\x01 \x01(\v2V.dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmPromqlCriteriaB\x06\xbaH\x03\xc8\x01\x01R\x0epromqlCriteria\"\xb4\x04\n" +
	...
	"\x10_recovery_periodB\xaf\x03\n" +
	"8com.dev.planton.provider.aws.awscloudwatchalarm.v1alpha1B\tSpecProtoP\x01Zqgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awscloudwatchalarm/v1alpha1;awscloudwatchalarmv1alpha1\xa2\x02\x05DPPAA\xaa\x024Dev.Planton.Provider.Aws.Awscloudwatchalarm.V1alpha1\xca\x024Dev\\Planton\\Provider\\Aws\\Awscloudwatchalarm\\V1alpha1\xe2\x02@Dev\\Planton\\Provider\\Aws\\Awscloudwatchalarm\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Provider::Aws::Awscloudwatchalarm::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_goTypes = []any{
	(*AwsCloudwatchAlarmSpec)(nil),               // 0: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec
	(*AwsCloudwatchAlarmMetricQuery)(nil),        // 1: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQuery
	(*AwsCloudwatchAlarmMetricQueryMetric)(nil),  // 2: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric
	(*AwsCloudwatchAlarmEvaluationCriteria)(nil), // 3: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteria
	(*AwsCloudwatchAlarmPromqlCriteria)(nil),     // 4: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmPromqlCriteria
	nil,                                          // 5: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.DimensionsEntry
	nil,                                          // 6: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntry
	(*v1.StringValueOrRef)(nil),                  // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.dimensions:type_name -> dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.DimensionsEntry
	1, // 1: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.metric_queries:type_name -> dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQuery
	7, // 2: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.alarm_actions:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7, // 3: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.ok_actions:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7, // 4: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.insufficient_data_actions:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 5: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.evaluation_criteria:type_name -> dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteria
	2, // 6: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQuery.metric:type_name -> dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric
	6, // 7: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.dimensions:type_name -> dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntry
	4, // 8: dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteria.promql_criteria:type_name -> dev.planton.provider.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmPromqlCriteria
...
func init() { file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awscloudwatchalarm_v1alpha1_spec_proto_depIdxs = nil
}
