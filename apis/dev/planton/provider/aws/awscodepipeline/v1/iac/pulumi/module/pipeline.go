...
func buildBeforeEntryCondition(c *awscodepipelinev1.AwsCodePipelineStageCondition) *codepipeline.PipelineStageBeforeEntryConditionArgs {
...
func buildOnSuccessCondition(c *awscodepipelinev1.AwsCodePipelineStageCondition) *codepipeline.PipelineStageOnSuccessConditionArgs {
...
func buildOnFailureCondition(c *awscodepipelinev1.AwsCodePipelineStageCondition) *codepipeline.PipelineStageOnFailureConditionArgs {
...
func applyCommonRuleFields(
	r *awscodepipelinev1.AwsCodePipelineRule,
...
func buildBeforeEntryRuleTypeId(id *awscodepipelinev1.AwsCodePipelineRuleTypeId) *codepipeline.PipelineStageBeforeEntryConditionRuleRuleTypeIdArgs {
...
func buildOnSuccessRuleTypeId(id *awscodepipelinev1.AwsCodePipelineRuleTypeId) *codepipeline.PipelineStageOnSuccessConditionRuleRuleTypeIdArgs {
...
func buildOnFailureRuleTypeId(id *awscodepipelinev1.AwsCodePipelineRuleTypeId) *codepipeline.PipelineStageOnFailureConditionRuleRuleTypeIdArgs {
...
func ruleCategory(id *awscodepipelinev1.AwsCodePipelineRuleTypeId) string {
	if id.GetCategory() != "" {
...
func ruleOwner(id *awscodepipelinev1.AwsCodePipelineRuleTypeId) string {
	if id.GetOwner() != "" {
		return id.GetOwner()
	}
	return "AWS"
