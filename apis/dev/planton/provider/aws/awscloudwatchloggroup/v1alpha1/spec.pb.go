...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awscloudwatchloggroup/v1alpha1/spec.proto
...
func (x *AwsCloudwatchLogGroupSpec) Reset() {
	*x = AwsCloudwatchLogGroupSpec{}
	mi := &file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsCloudwatchLogGroupSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsCloudwatchLogGroupMetricFilter) Reset() {
	*x = AwsCloudwatchLogGroupMetricFilter{}
	mi := &file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchLogGroupMetricFilter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCloudwatchLogGroupMetricTransformation) Reset() {
	*x = AwsCloudwatchLogGroupMetricTransformation{}
	mi := &file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchLogGroupMetricTransformation) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsCloudwatchLogGroupSubscriptionFilter) Reset() {
	*x = AwsCloudwatchLogGroupSubscriptionFilter{}
	mi := &file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchLogGroupSubscriptionFilter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/provider/aws/awscloudwatchloggroup/v1alpha1/spec.proto\x127dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xfc\x11\n" +
	...
	"\x1bdeletion_protection_enabled\x18\x05 \x01(\bR\x19deletionProtectionEnabled\x12\x81\x01\n" +
	"\x0emetric_filters\x18\x06 \x03(\v2Z.dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricFilterR\rmetricFilters\x12\x93\x01\n" +
	"\x14subscription_filters\x18\a \x03(\v2`.dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSubscriptionFilterR\x13subscriptionFilters\x12M\n" +
	...
	"\x1cinfrequent_access_no_filters\x12\x93\x01metric_filters and subscription_filters are not supported on INFREQUENT_ACCESS log groups — use a STANDARD class log group for filtering features\x1awthis.log_group_class != 'INFREQUENT_ACCESS' || (size(this.metric_filters) == 0 && size(this.subscription_filters) == 0)\"\xb8\x02\n" +
	...
	"\x19apply_on_transformed_logs\x18\x03 \x01(\bR\x16applyOnTransformedLogs\x12\x92\x01\n" +
	"\x0etransformation\x18\x04 \x01(\v2b.dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricTransformationB\x06\xbaH\x03\xc8\x01\x01R\x0etransformation\"\xf1\n" +
	"\n" +
	...
	"\rdefault_value\x18\x04 \x01(\x01H\x00R\fdefaultValue\x88\x01\x01\x12\x92\x01\n" +
	"\n" +
	"dimensions\x18\x05 \x03(\v2r.dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricTransformation.DimensionsEntryR\n" +
	"dimensions\x12\x12\n" +
	...
	"\x1femit_system_fields_valid_values\x12Bemit_system_fields entries must be '@aws.account' or '@aws.region'\x1aDthis.emit_system_fields.all(f, f in ['@aws.account', '@aws.region'])B\xc4\x03\n" +
	";com.dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1B\tSpecProtoP\x01Zwgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awscloudwatchloggroup/v1alpha1;awscloudwatchloggroupv1alpha1\xa2\x02\x05DPPAA\xaa\x027Dev.Planton.Provider.Aws.Awscloudwatchloggroup.V1alpha1\xca\x027Dev\\Planton\\Provider\\Aws\\Awscloudwatchloggroup\\V1alpha1\xe2\x02CDev\\Planton\\Provider\\Aws\\Awscloudwatchloggroup\\V1alpha1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Aws::Awscloudwatchloggroup::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_goTypes = []any{
	(*AwsCloudwatchLogGroupSpec)(nil),                 // 0: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSpec
	(*AwsCloudwatchLogGroupMetricFilter)(nil),         // 1: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricFilter
	(*AwsCloudwatchLogGroupMetricTransformation)(nil), // 2: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricTransformation
	(*AwsCloudwatchLogGroupSubscriptionFilter)(nil),   // 3: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSubscriptionFilter
	nil,                         // 4: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricTransformation.DimensionsEntry
	(*v1.StringValueOrRef)(nil), // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),     // 6: google.protobuf.Struct
}
var file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSpec.metric_filters:type_name -> dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricFilter
	3, // 2: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSpec.subscription_filters:type_name -> dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSubscriptionFilter
	6, // 3: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSpec.data_protection_policy:type_name -> google.protobuf.Struct
	6, // 4: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSpec.field_index_policy:type_name -> google.protobuf.Struct
	2, // 5: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricFilter.transformation:type_name -> dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricTransformation
	4, // 6: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricTransformation.dimensions:type_name -> dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupMetricTransformation.DimensionsEntry
	5, // 7: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSubscriptionFilter.destination_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 8: dev.planton.provider.aws.awscloudwatchloggroup.v1alpha1.AwsCloudwatchLogGroupSubscriptionFilter.role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awscloudwatchloggroup_v1alpha1_spec_proto_depIdxs = nil
}
