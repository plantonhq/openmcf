...
// roll the fleet.
func launchTemplateArgs(ref *awsautoscalinggroupv1.AwsAutoScalingGroupLaunchTemplateRef) *autoscaling.GroupLaunchTemplateArgs {
...
func launchTemplateSpecificationArgs(ref *awsautoscalinggroupv1.AwsAutoScalingGroupLaunchTemplateRef) *autoscaling.GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationArgs {
...
func mixedInstancesPolicyArgs(policy *awsautoscalinggroupv1.AwsAutoScalingGroupMixedInstancesPolicy) *autoscaling.GroupMixedInstancesPolicyArgs {
...
func overrideVersion(ref *awsautoscalinggroupv1.AwsAutoScalingGroupLaunchTemplateRef) pulumi.StringPtrInput {
	if ref.Version != "" {
...
func overrideInstanceRequirementsArgs(requirements *awsautoscalinggroupv1.AwsAutoScalingGroupInstanceRequirements) *autoscaling.GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsArgs {
...
func instanceRefreshArgs(refresh *awsautoscalinggroupv1.AwsAutoScalingGroupInstanceRefresh) *autoscaling.GroupInstanceRefreshArgs {
...
func warmPoolArgs(pool *awsautoscalinggroupv1.AwsAutoScalingGroupWarmPool) *autoscaling.GroupWarmPoolArgs {
