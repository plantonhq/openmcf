...
func scalingPolicy(ctx *pulumi.Context, provider pulumi.ProviderResource, createdGroup *autoscaling.Group, policy *awsautoscalinggroupv1.AwsAutoScalingGroupScalingPolicy) error {
...
func targetTrackingArgs(tracking *awsautoscalinggroupv1.AwsAutoScalingGroupTargetTrackingConfig) *autoscaling.PolicyTargetTrackingConfigurationArgs {
...
func customizedMetricArgs(metric *awsautoscalinggroupv1.AwsAutoScalingGroupCustomizedMetric) *autoscaling.PolicyTargetTrackingConfigurationCustomizedMetricSpecificationArgs {
...
func metricStatDimensions(dimensions []*awsautoscalinggroupv1.AwsAutoScalingGroupMetricDimension) autoscaling.PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricDimensionArray {
	if len(dimensions) == 0 {
		return nil
	}
...
func predictiveScalingArgs(predictive *awsautoscalinggroupv1.AwsAutoScalingGroupPredictiveScalingConfig) *autoscaling.PolicyPredictiveScalingConfigurationArgs {
