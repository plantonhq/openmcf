...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsrediselasticache/v1alpha1/spec.proto
...
func (x *AwsRedisElasticacheSpec) Reset() {
	*x = AwsRedisElasticacheSpec{}
	mi := &file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRedisElasticacheSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRedisElasticacheNodeGroupConfiguration) Reset() {
	*x = AwsRedisElasticacheNodeGroupConfiguration{}
	mi := &file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedisElasticacheNodeGroupConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRedisElasticacheParameter) Reset() {
	*x = AwsRedisElasticacheParameter{}
	mi := &file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedisElasticacheParameter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsRedisElasticacheLogDeliveryConfig) Reset() {
	*x = AwsRedisElasticacheLogDeliveryConfig{}
	mi := &file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRedisElasticacheLogDeliveryConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/aws/awsrediselasticache/v1alpha1/spec.proto\x125dev.planton.provider.aws.awsrediselasticache.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc7M\n" +
	...
	" \x01(\x05B\t\xbaH\x06\x1a\x04\x18\x05(\x00R\x14replicasPerNodeGroup\x12\x9c\x01\n" +
	"\x19node_group_configurations\x18\v \x03(\v2`.dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheNodeGroupConfigurationR\x17nodeGroupConfigurations\x12<\n" +
	...
	"\x16parameter_group_family\x18# \x01(\tR\x14parameterGroupFamily\x12s\n" +
	"\n" +
	"parameters\x18$ \x03(\v2S.dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheParameterR\n" +
	"parameters\x120\n" +
	"\x14parameter_group_name\x18% \x01(\tR\x12parameterGroupName\x12\x9b\x01\n" +
	"\x1blog_delivery_configurations\x18& \x03(\v2[.dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheLogDeliveryConfigR\x19logDeliveryConfigurations\x12\x8b\x01\n" +
	...
	"\x0elog_type_valid\x12+log_type must be 'slow-log' or 'engine-log'\x1a+this.log_type in ['slow-log', 'engine-log']B\xb6\x03\n" +
	"9com.dev.planton.provider.aws.awsrediselasticache.v1alpha1B\tSpecProtoP\x01Zsgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsrediselasticache/v1alpha1;awsrediselasticachev1alpha1\xa2\x02\x05DPPAA\xaa\x025Dev.Planton.Provider.Aws.Awsrediselasticache.V1alpha1\xca\x025Dev\\Planton\\Provider\\Aws\\Awsrediselasticache\\V1alpha1\xe2\x02ADev\\Planton\\Provider\\Aws\\Awsrediselasticache\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Aws::Awsrediselasticache::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_goTypes = []any{
	(*AwsRedisElasticacheSpec)(nil),                   // 0: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec
	(*AwsRedisElasticacheNodeGroupConfiguration)(nil), // 1: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheNodeGroupConfiguration
	(*AwsRedisElasticacheParameter)(nil),              // 2: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheParameter
	(*AwsRedisElasticacheLogDeliveryConfig)(nil),      // 3: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheLogDeliveryConfig
	(*v1.StringValueOrRef)(nil),                       // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.node_group_configurations:type_name -> dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheNodeGroupConfiguration
	4,  // 1: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 2: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 3: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 4: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.auth_token:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 5: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.user_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 6: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.parameters:type_name -> dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheParameter
	3,  // 7: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.log_delivery_configurations:type_name -> dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheLogDeliveryConfig
	4,  // 8: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheSpec.notification_topic_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 9: dev.planton.provider.aws.awsrediselasticache.v1alpha1.AwsRedisElasticacheLogDeliveryConfig.destination:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsrediselasticache_v1alpha1_spec_proto_depIdxs = nil
}
