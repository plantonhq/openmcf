...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsserverlesselasticache/v1/spec.proto
...
func (x *AwsServerlessElasticacheSpec) Reset() {
	*x = AwsServerlessElasticacheSpec{}
	mi := &file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_msgTypes[0]
...
func (*AwsServerlessElasticacheSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
const file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDesc = "" +
	...
	"8com.dev.planton.provider.aws.awsserverlesselasticache.v1B\tSpecProtoP\x01Zqgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsserverlesselasticache/v1;awsserverlesselasticachev1\xa2\x02\x05DPPAA\xaa\x024Dev.Planton.Provider.Aws.Awsserverlesselasticache.V1\xca\x024Dev\\Planton\\Provider\\Aws\\Awsserverlesselasticache\\V1\xe2\x02@Dev\\Planton\\Provider\\Aws\\Awsserverlesselasticache\\V1\\GPBMetadata\xea\x029Dev::Planton::Provider::Aws::Awsserverlesselasticache::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_goTypes = []any{
	(*AwsServerlessElasticacheSpec)(nil), // 0: dev.planton.provider.aws.awsserverlesselasticache.v1.AwsServerlessElasticacheSpec
	(*v1.StringValueOrRef)(nil),          // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_depIdxs = []int32{
...
func file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsserverlesselasticache_v1_spec_proto_depIdxs = nil
}
