...
type Locals struct {
	AwsPlantonRunner *awsplantonrunnerv1.AwsPlantonRunner
...
func initializeLocals(ctx *pulumi.Context, stackInput *awsplantonrunnerv1.AwsPlantonRunnerStackInput) *Locals {
	locals := &Locals{
