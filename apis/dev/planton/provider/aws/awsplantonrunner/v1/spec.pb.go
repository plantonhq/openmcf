...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsplantonrunner/v1/spec.proto
...
func (x *AwsPlantonRunnerSpec) Reset() {
	*x = AwsPlantonRunnerSpec{}
	mi := &file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_msgTypes[0]
...
func (*AwsPlantonRunnerSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDesc = "" +
	"\n" +
	...
	"\x13_log_retention_daysB\xf7\x02\n" +
	"0com.dev.planton.provider.aws.awsplantonrunner.v1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsplantonrunner/v1;awsplantonrunnerv1\xa2\x02\x05DPPAA\xaa\x02,Dev.Planton.Provider.Aws.Awsplantonrunner.V1\xca\x02,Dev\\Planton\\Provider\\Aws\\Awsplantonrunner\\V1\xe2\x028Dev\\Planton\\Provider\\Aws\\Awsplantonrunner\\V1\\GPBMetadata\xea\x021Dev::Planton::Provider::Aws::Awsplantonrunner::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_goTypes = []any{
	(*AwsPlantonRunnerSpec)(nil), // 0: dev.planton.provider.aws.awsplantonrunner.v1.AwsPlantonRunnerSpec
	(*v1.StringValueOrRef)(nil),  // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awsplantonrunner.v1.AwsPlantonRunnerSpec.subnets:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awsplantonrunner.v1.AwsPlantonRunnerSpec.security_groups:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.aws.awsplantonrunner.v1.AwsPlantonRunnerSpec.task_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsplantonrunner_v1_spec_proto_depIdxs = nil
}
