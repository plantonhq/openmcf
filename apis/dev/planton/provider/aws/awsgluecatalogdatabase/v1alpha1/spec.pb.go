...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsgluecatalogdatabase/v1alpha1/spec.proto
...
func (x *AwsGlueCatalogDatabaseSpec) Reset() {
	*x = AwsGlueCatalogDatabaseSpec{}
	mi := &file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsGlueCatalogDatabaseSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsGlueCatalogDatabasePrincipalPermissions) Reset() {
	*x = AwsGlueCatalogDatabasePrincipalPermissions{}
	mi := &file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlueCatalogDatabasePrincipalPermissions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsGlueCatalogDatabaseTarget) Reset() {
	*x = AwsGlueCatalogDatabaseTarget{}
	mi := &file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlueCatalogDatabaseTarget) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsGlueCatalogDatabaseFederation) Reset() {
	*x = AwsGlueCatalogDatabaseFederation{}
	mi := &file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsGlueCatalogDatabaseFederation) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Cdev/planton/provider/aws/awsgluecatalogdatabase/v1alpha1/spec.proto\x128dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1\x1a\x1bbuf/validate/validate.proto\"\xf8\a\n" +
	...
	"\flocation_uri\x18\x04 \x01(\tR\vlocationUri\x12\x84\x01\n" +
	"\n" +
	"parameters\x18\x05 \x03(\v2d.dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec.ParametersEntryR\n" +
	"parameters\x12\xad\x01\n" +
	" create_table_default_permissions\x18\x06 \x03(\v2d.dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabasePrincipalPermissionsR\x1dcreateTableDefaultPermissions\x12\x7f\n" +
	"\x0ftarget_database\x18\a \x01(\v2V.dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseTargetR\x0etargetDatabase\x12\x89\x01\n" +
	"\x12federated_database\x18\b \x01(\v2Z.dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseFederationR\x11federatedDatabase\x1a=\n" +
	...
	"identifier\x12'\n" +
	"\x0fconnection_name\x18\x02 \x01(\tR\x0econnectionNameB\xcb\x03\n" +
	"<com.dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1B\tSpecProtoP\x01Zygithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsgluecatalogdatabase/v1alpha1;awsgluecatalogdatabasev1alpha1\xa2\x02\x05DPPAA\xaa\x028Dev.Planton.Provider.Aws.Awsgluecatalogdatabase.V1alpha1\xca\x028Dev\\Planton\\Provider\\Aws\\Awsgluecatalogdatabase\\V1alpha1\xe2\x02DDev\\Planton\\Provider\\Aws\\Awsgluecatalogdatabase\\V1alpha1\\GPBMetadata\xea\x02=Dev::Planton::Provider::Aws::Awsgluecatalogdatabase::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_goTypes = []any{
	(*AwsGlueCatalogDatabaseSpec)(nil),                 // 0: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec
	(*AwsGlueCatalogDatabasePrincipalPermissions)(nil), // 1: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabasePrincipalPermissions
	(*AwsGlueCatalogDatabaseTarget)(nil),               // 2: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseTarget
	(*AwsGlueCatalogDatabaseFederation)(nil),           // 3: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseFederation
	nil,                                                // 4: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec.ParametersEntry
}
var file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec.parameters:type_name -> dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec.ParametersEntry
	1, // 1: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec.create_table_default_permissions:type_name -> dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabasePrincipalPermissions
	2, // 2: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec.target_database:type_name -> dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseTarget
	3, // 3: dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseSpec.federated_database:type_name -> dev.planton.provider.aws.awsgluecatalogdatabase.v1alpha1.AwsGlueCatalogDatabaseFederation
...
func init() { file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsgluecatalogdatabase_v1alpha1_spec_proto_depIdxs = nil
}
