...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsroute53dnsrecord/v1alpha1/spec.proto
...
func (x *AwsRoute53DnsRecordSpec) Reset() {
	*x = AwsRoute53DnsRecordSpec{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRoute53DnsRecordSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRoute53AliasTarget) Reset() {
	*x = AwsRoute53AliasTarget{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53AliasTarget) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRoute53RoutingPolicy) Reset() {
	*x = AwsRoute53RoutingPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53RoutingPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsRoute53WeightedPolicy) Reset() {
	*x = AwsRoute53WeightedPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53WeightedPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsRoute53LatencyPolicy) Reset() {
	*x = AwsRoute53LatencyPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53LatencyPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsRoute53FailoverPolicy) Reset() {
	*x = AwsRoute53FailoverPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53FailoverPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsRoute53GeolocationPolicy) Reset() {
	*x = AwsRoute53GeolocationPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53GeolocationPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsRoute53GeoproximityPolicy) Reset() {
	*x = AwsRoute53GeoproximityPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53GeoproximityPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsRoute53Coordinates) Reset() {
	*x = AwsRoute53Coordinates{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53Coordinates) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsRoute53CidrPolicy) Reset() {
	*x = AwsRoute53CidrPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53CidrPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *AwsRoute53MultivalueAnswerPolicy) Reset() {
	*x = AwsRoute53MultivalueAnswerPolicy{}
	mi := &file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53MultivalueAnswerPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}

var File_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/aws/awsroute53dnsrecord/v1alpha1/spec.proto\x125dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\x94\x10\n" +
	...
	"\x06values\x18\x06 \x03(\tR\x06values\x12o\n" +
	"\falias_target\x18\a \x01(\v2L.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53AliasTargetR\valiasTarget\x12u\n" +
	"\x0erouting_policy\x18\b \x01(\v2N.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicyR\rroutingPolicy\x12\x83\x01\n" +
	...
	"\x16evaluate_target_health\x18\x03 \x01(\bR\x14evaluateTargetHealth\"\xcc\x06\n" +
	"\x17AwsRoute53RoutingPolicy\x12m\n" +
	"\bweighted\x18\x01 \x01(\v2O.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53WeightedPolicyH\x00R\bweighted\x12j\n" +
	"\alatency\x18\x02 \x01(\v2N.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53LatencyPolicyH\x00R\alatency\x12m\n" +
	"\bfailover\x18\x03 \x01(\v2O.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53FailoverPolicyH\x00R\bfailover\x12v\n" +
	"\vgeolocation\x18\x04 \x01(\v2R.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53GeolocationPolicyH\x00R\vgeolocation\x12y\n" +
	"\fgeoproximity\x18\x05 \x01(\v2S.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53GeoproximityPolicyH\x00R\fgeoproximity\x12a\n" +
	"\x04cidr\x18\x06 \x01(\v2K.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53CidrPolicyH\x00R\x04cidr\x12\x86\x01\n" +
	"\x11multivalue_answer\x18\a \x01(\v2W.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53MultivalueAnswerPolicyH\x00R\x10multivalueAnswerB\b\n" +
	"\x06policy\">\n" +
	...
	"\x1dgeolocation_location_required\x12?geolocation routing requires continent, country, or subdivision\x1aDthis.continent != '' || this.country != '' || this.subdivision != ''\"\xf1\x03\n" +
	"\x1cAwsRoute53GeoproximityPolicy\x12\x1d\n" +
	"\n" +
	"aws_region\x18\x01 \x01(\tR\tawsRegion\x12n\n" +
	"\vcoordinates\x18\x02 \x01(\v2L.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53CoordinatesR\vcoordinates\x12(\n" +
	...
	" AwsRoute53MultivalueAnswerPolicyB\xb6\x03\n" +
	"9com.dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1B\tSpecProtoP\x01Zsgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsroute53dnsrecord/v1alpha1;awsroute53dnsrecordv1alpha1\xa2\x02\x05DPPAA\xaa\x025Dev.Planton.Provider.Aws.Awsroute53dnsrecord.V1alpha1\xca\x025Dev\\Planton\\Provider\\Aws\\Awsroute53dnsrecord\\V1alpha1\xe2\x02ADev\\Planton\\Provider\\Aws\\Awsroute53dnsrecord\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Aws::Awsroute53dnsrecord::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_goTypes = []any{
	(*AwsRoute53DnsRecordSpec)(nil),          // 0: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53DnsRecordSpec
	(*AwsRoute53AliasTarget)(nil),            // 1: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53AliasTarget
	(*AwsRoute53RoutingPolicy)(nil),          // 2: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy
	(*AwsRoute53WeightedPolicy)(nil),         // 3: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53WeightedPolicy
	(*AwsRoute53LatencyPolicy)(nil),          // 4: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53LatencyPolicy
	(*AwsRoute53FailoverPolicy)(nil),         // 5: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53FailoverPolicy
	(*AwsRoute53GeolocationPolicy)(nil),      // 6: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53GeolocationPolicy
	(*AwsRoute53GeoproximityPolicy)(nil),     // 7: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53GeoproximityPolicy
	(*AwsRoute53Coordinates)(nil),            // 8: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53Coordinates
	(*AwsRoute53CidrPolicy)(nil),             // 9: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53CidrPolicy
	(*AwsRoute53MultivalueAnswerPolicy)(nil), // 10: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53MultivalueAnswerPolicy
	(*v1.StringValueOrRef)(nil),              // 11: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_depIdxs = []int32{
	11, // 0: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53DnsRecordSpec.zone_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53DnsRecordSpec.alias_target:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53AliasTarget
	2,  // 2: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53DnsRecordSpec.routing_policy:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy
	11, // 3: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53DnsRecordSpec.health_check_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 4: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53AliasTarget.dns_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 5: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53AliasTarget.zone_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 6: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy.weighted:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53WeightedPolicy
	4,  // 7: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy.latency:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53LatencyPolicy
	5,  // 8: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy.failover:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53FailoverPolicy
	6,  // 9: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy.geolocation:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53GeolocationPolicy
	7,  // 10: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy.geoproximity:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53GeoproximityPolicy
	9,  // 11: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy.cidr:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53CidrPolicy
	10, // 12: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53RoutingPolicy.multivalue_answer:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53MultivalueAnswerPolicy
	8,  // 13: dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53GeoproximityPolicy.coordinates:type_name -> dev.planton.provider.aws.awsroute53dnsrecord.v1alpha1.AwsRoute53Coordinates
...
func init() { file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsroute53dnsrecord_v1alpha1_spec_proto_depIdxs = nil
}
