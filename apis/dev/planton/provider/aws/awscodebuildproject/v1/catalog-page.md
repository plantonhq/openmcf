...
- [AwsIamRole](/docs/catalog/aws/awsiamrole) — provides the service role for CodeBuild
- [AwsVpc](/docs/catalog/aws/awsvpc) — provides VPC and subnets for builds that access private resources
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls network access for VPC-enabled builds
- [AwsS3Bucket](/docs/catalog/aws/awss3bucket) — stores build artifacts and cache
- [AwsCloudwatchLogGroup](/docs/catalog/aws/awscloudwatchloggroup) — hosts build logs
