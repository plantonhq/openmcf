...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awssqsqueue/v1alpha1/spec.proto
...
func (x *AwsSqsQueueSpec) Reset() {
	*x = AwsSqsQueueSpec{}
	mi := &file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsSqsQueueSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsSqsQueueDeadLetterConfig) Reset() {
	*x = AwsSqsQueueDeadLetterConfig{}
	mi := &file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSqsQueueDeadLetterConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsSqsQueueRedriveAllowPolicy) Reset() {
	*x = AwsSqsQueueRedriveAllowPolicy{}
	mi := &file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSqsQueueRedriveAllowPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"8dev/planton/provider/aws/awssqsqueue/v1alpha1/spec.proto\x12-dev.planton.provider.aws.awssqsqueue.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xaa\x16\n" +
	...
	" \x01(\tR\x13fifoThroughputLimit\x12x\n" +
	"\x12dead_letter_config\x18\v \x01(\v2J.dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueDeadLetterConfigR\x10deadLetterConfig\x12q\n" +
	"\n" +
	...
	"\x06policy\x18\x0f \x01(\v2\x17.google.protobuf.StructR\x06policy\x12~\n" +
	"\x14redrive_allow_policy\x18\x10 \x01(\v2L.dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueRedriveAllowPolicyR\x12redriveAllowPolicy:\xe0\r\xbaH\xdc\r\x1a\xbb\x01\n" +
	...
	"\x1esource_queues_match_permission\x12|source_queue_arns is required (1-10 entries) with redrive_permission 'byQueue' and must be empty for 'allowAll' or 'denyAll'\x1althis.redrive_permission == 'byQueue' ? size(this.source_queue_arns) >= 1 : size(this.source_queue_arns) == 0B\xfe\x02\n" +
	"1com.dev.planton.provider.aws.awssqsqueue.v1alpha1B\tSpecProtoP\x01Zcgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awssqsqueue/v1alpha1;awssqsqueuev1alpha1\xa2\x02\x05DPPAA\xaa\x02-Dev.Planton.Provider.Aws.Awssqsqueue.V1alpha1\xca\x02-Dev\\Planton\\Provider\\Aws\\Awssqsqueue\\V1alpha1\xe2\x029Dev\\Planton\\Provider\\Aws\\Awssqsqueue\\V1alpha1\\GPBMetadata\xea\x022Dev::Planton::Provider::Aws::Awssqsqueue::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_goTypes = []any{
	(*AwsSqsQueueSpec)(nil),               // 0: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec
	(*AwsSqsQueueDeadLetterConfig)(nil),   // 1: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueDeadLetterConfig
	(*AwsSqsQueueRedriveAllowPolicy)(nil), // 2: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueRedriveAllowPolicy
	(*v1.StringValueOrRef)(nil),           // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),               // 4: google.protobuf.Struct
}
var file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.dead_letter_config:type_name -> dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueDeadLetterConfig
	3, // 1: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 2: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.policy:type_name -> google.protobuf.Struct
	2, // 3: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.redrive_allow_policy:type_name -> dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueRedriveAllowPolicy
	3, // 4: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueDeadLetterConfig.target_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 5: dev.planton.provider.aws.awssqsqueue.v1alpha1.AwsSqsQueueRedriveAllowPolicy.source_queue_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awssqsqueue_v1alpha1_spec_proto_depIdxs = nil
}
