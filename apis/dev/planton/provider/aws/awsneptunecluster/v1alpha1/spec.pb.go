...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsneptunecluster/v1alpha1/spec.proto
...
func (x *AwsNeptuneClusterSpec) Reset() {
	*x = AwsNeptuneClusterSpec{}
	mi := &file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsNeptuneClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsNeptuneClusterInstance) Reset() {
	*x = AwsNeptuneClusterInstance{}
	mi := &file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNeptuneClusterInstance) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsNeptuneClusterServerlessV2Scaling) Reset() {
	*x = AwsNeptuneClusterServerlessV2Scaling{}
	mi := &file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNeptuneClusterServerlessV2Scaling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsNeptuneClusterParameter) Reset() {
	*x = AwsNeptuneClusterParameter{}
	mi := &file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsNeptuneClusterParameter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/aws/awsneptunecluster/v1alpha1/spec.proto\x123dev.planton.provider.aws.awsneptunecluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xf9%\n" +
	...
	"\fstorage_type\x18\b \x01(\tB\x19\xbaH\x16\xd8\x01\x01r\x11R\bstandardR\x05iopt1R\vstorageType\x12l\n" +
	"\tinstances\x18\t \x03(\v2N.dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterInstanceR\tinstances\x12\x8d\x01\n" +
	"\x15serverless_v2_scaling\x18\n" +
	" \x01(\v2Y.dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterServerlessV2ScalingR\x13serverlessV2Scaling\x125\n" +
	...
	"$neptune_cluster_parameter_group_name\x18\x1a \x01(\tR neptuneClusterParameterGroupName\x12o\n" +
	"\n" +
	"parameters\x18\x1b \x03(\v2O.dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterParameterR\n" +
	"parameters\x12P\n" +
	...
	"\x12apply_method_valid\x12=apply_method must be 'immediate' or 'pending-reboot' when set\x1aOthis.apply_method == '' || this.apply_method in ['immediate', 'pending-reboot']B\xa8\x03\n" +
	"7com.dev.planton.provider.aws.awsneptunecluster.v1alpha1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsneptunecluster/v1alpha1;awsneptuneclusterv1alpha1\xa2\x02\x05DPPAA\xaa\x023Dev.Planton.Provider.Aws.Awsneptunecluster.V1alpha1\xca\x023Dev\\Planton\\Provider\\Aws\\Awsneptunecluster\\V1alpha1\xe2\x02?Dev\\Planton\\Provider\\Aws\\Awsneptunecluster\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Provider::Aws::Awsneptunecluster::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_goTypes = []any{
	(*AwsNeptuneClusterSpec)(nil),                // 0: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec
	(*AwsNeptuneClusterInstance)(nil),            // 1: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterInstance
	(*AwsNeptuneClusterServerlessV2Scaling)(nil), // 2: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterServerlessV2Scaling
	(*AwsNeptuneClusterParameter)(nil),           // 3: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterParameter
	(*v1.StringValueOrRef)(nil),                  // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.neptune_subnet_group_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 2: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 3: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.instances:type_name -> dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterInstance
	2, // 4: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.serverless_v2_scaling:type_name -> dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterServerlessV2Scaling
	4, // 5: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 6: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.iam_roles:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 7: dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterSpec.parameters:type_name -> dev.planton.provider.aws.awsneptunecluster.v1alpha1.AwsNeptuneClusterParameter
...
func init() { file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsneptunecluster_v1alpha1_spec_proto_depIdxs = nil
}
