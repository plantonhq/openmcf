...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/provider.proto
...
func (x *AwsProviderConfig) Reset() {
	*x = AwsProviderConfig{}
	mi := &file_dev_planton_provider_aws_provider_proto_msgTypes[0]
...
func (*AwsProviderConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_provider_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsWebIdentityProviderConfig) Reset() {
	*x = AwsWebIdentityProviderConfig{}
	mi := &file_dev_planton_provider_aws_provider_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsWebIdentityProviderConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_provider_proto_rawDescGZIP(), []int{1}
}
...
const file_dev_planton_provider_aws_provider_proto_rawDesc = "" +
	"\n" +
	"'dev/planton/provider/aws/provider.proto\x12\x18dev.planton.provider.aws\x1a\x1bbuf/validate/validate.proto\"\xc3\a\n" +
...
var (
	file_dev_planton_provider_aws_provider_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_provider_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_provider_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_provider_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_provider_proto_rawDesc), len(file_dev_planton_provider_aws_provider_proto_rawDesc)))
	})
...
func file_dev_planton_provider_aws_provider_proto_init() {
	if File_dev_planton_provider_aws_provider_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_aws_provider_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_provider_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_provider_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_provider_proto = out.File
	file_dev_planton_provider_aws_provider_proto_goTypes = nil
	file_dev_planton_provider_aws_provider_proto_depIdxs = nil
}
