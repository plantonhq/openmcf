...
func buildDefaultAction(defaultAction *awswafwebaclv1.AwsWafWebAclDefaultAction) *wafv2.WebAclDefaultActionArgs {
...
func buildAssociationConfig(config *awswafwebaclv1.AwsWafWebAclAssociationConfig) *wafv2.WebAclAssociationConfigArgs {
...
func buildDataProtectionConfig(config *awswafwebaclv1.AwsWafWebAclDataProtectionConfig) *wafv2.WebAclDataProtectionConfigArgs {
