...
func buildStatement(statement *awswafwebaclv1.AwsWafWebAclStatement) (map[string]interface{}, error) {
	...
	case *awswafwebaclv1.AwsWafWebAclStatement_ManagedRuleGroup:
		return buildManagedRuleGroupStatement(stmt.ManagedRuleGroup)

	case *awswafwebaclv1.AwsWafWebAclStatement_RateBased:
		return buildRateBasedStatement(stmt.RateBased)

	case *awswafwebaclv1.AwsWafWebAclStatement_RuleGroupReference:
		return buildRuleGroupReferenceStatement(stmt.RuleGroupReference), nil

	case *awswafwebaclv1.AwsWafWebAclStatement_IpSetReference:
		return buildIpSetReferenceStatement(stmt.IpSetReference), nil

	case *awswafwebaclv1.AwsWafWebAclStatement_RegexPatternSetReference:
		return buildRegexPatternSetReferenceStatement(stmt.RegexPatternSetReference)

	case *awswafwebaclv1.AwsWafWebAclStatement_GeoMatch:
		return buildGeoMatchStatement(stmt.GeoMatch), nil

	case *awswafwebaclv1.AwsWafWebAclStatement_ByteMatch:
		return buildByteMatchStatement(stmt.ByteMatch)

	case *awswafwebaclv1.AwsWafWebAclStatement_SqliMatch:
		return buildSqliMatchStatement(stmt.SqliMatch)

	case *awswafwebaclv1.AwsWafWebAclStatement_XssMatch:
		return buildXssMatchStatement(stmt.XssMatch)

	case *awswafwebaclv1.AwsWafWebAclStatement_SizeConstraint:
		return buildSizeConstraintStatement(stmt.SizeConstraint)

	case *awswafwebaclv1.AwsWafWebAclStatement_RegexMatch:
		return buildRegexMatchStatement(stmt.RegexMatch)

	case *awswafwebaclv1.AwsWafWebAclStatement_LabelMatch:
	...
	case *awswafwebaclv1.AwsWafWebAclStatement_AsnMatch:
	...
	case *awswafwebaclv1.AwsWafWebAclStatement_AndStatement:
	...
	case *awswafwebaclv1.AwsWafWebAclStatement_OrStatement:
	...
	case *awswafwebaclv1.AwsWafWebAclStatement_NotStatement:
	...
	case *awswafwebaclv1.AwsWafWebAclStatement_CustomStatement:
...
func buildStatementList(statements []*awswafwebaclv1.AwsWafWebAclStatement) ([]map[string]interface{}, error) {
...
func buildManagedRuleGroupStatement(mg *awswafwebaclv1.AwsWafWebAclManagedRuleGroupStatement) (map[string]interface{}, error) {
...
func buildManagedRuleGroupConfigs(configs *awswafwebaclv1.AwsWafWebAclManagedRuleGroupConfigs) []map[string]interface{} {
...
// responses.
func buildResponseInspection(ri *awswafwebaclv1.AwsWafWebAclResponseInspection) map[string]interface{} {
	inspection := map[string]interface{}{}
...
func buildRuleActionOverrides(overrides []*awswafwebaclv1.AwsWafWebAclRuleActionOverride) []map[string]interface{} {
...
func buildRuleGroupReferenceStatement(rg *awswafwebaclv1.AwsWafWebAclRuleGroupReferenceStatement) map[string]interface{} {
	stmt := map[string]interface{}{
		"ARN": rg.Arn,
	}
...
func buildRateBasedStatement(rb *awswafwebaclv1.AwsWafWebAclRateBasedStatement) (map[string]interface{}, error) {
	stmt := map[string]interface{}{
		"Limit": rb.Limit,
	}
...
func buildRateBasedCustomKeys(keys []*awswafwebaclv1.AwsWafWebAclRateBasedCustomKey) []map[string]interface{} {
	out := make([]map[string]interface{}, 0, len(keys))
	for _, key := range keys {
		switch k := key.Key.(type) {
		case *awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_Header:
		...
		case *awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_Cookie:
		...
		case *awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_QueryArgument:
		...
		case *awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_QueryString:
		...
		case *awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_UriPath:
		...
		case *awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_Ja4Fingerprint:
...
func buildRegexPatternSetReferenceStatement(rp *awswafwebaclv1.AwsWafWebAclRegexPatternSetReferenceStatement) (map[string]interface{}, error) {
...
func buildByteMatchStatement(bm *awswafwebaclv1.AwsWafWebAclByteMatchStatement) (map[string]interface{}, error) {
...
func buildSqliMatchStatement(sm *awswafwebaclv1.AwsWafWebAclSqliMatchStatement) (map[string]interface{}, error) {
...
func buildXssMatchStatement(xm *awswafwebaclv1.AwsWafWebAclXssMatchStatement) (map[string]interface{}, error) {
...
// comparison rule.
func buildSizeConstraintStatement(sc *awswafwebaclv1.AwsWafWebAclSizeConstraintStatement) (map[string]interface{}, error) {
...
func buildRegexMatchStatement(rm *awswafwebaclv1.AwsWafWebAclRegexMatchStatement) (map[string]interface{}, error) {
...
func buildFieldToMatch(ftm *awswafwebaclv1.AwsWafWebAclFieldToMatch) (map[string]interface{}, error) {
	...
	case *awswafwebaclv1.AwsWafWebAclFieldToMatch_Headers:
	...
	case *awswafwebaclv1.AwsWafWebAclFieldToMatch_Cookies:
...
func buildNamePattern(pattern *awswafwebaclv1.AwsWafWebAclNamePattern, includedKey, excludedKey string) map[string]interface{} {
	switch {
...
// matching.
func buildTextTransformations(transformations []*awswafwebaclv1.AwsWafWebAclTextTransformation) []map[string]interface{} {
...
// immunity-time block.
func buildImmunityConfig(config *awswafwebaclv1.AwsWafWebAclImmunityTimeConfig) map[string]interface{} {
	return map[string]interface{}{
