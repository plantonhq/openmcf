...
func TestBuildRulesJSON_MatchesWafApiShape(t *testing.T) {
	spec := &awswafwebaclv1.AwsWafWebAclSpec{
		Region: "us-west-2",
		Scope:  "REGIONAL",
		DefaultAction: &awswafwebaclv1.AwsWafWebAclDefaultAction{
			Type: "allow",
		},
		Rules: []*awswafwebaclv1.AwsWafWebAclRule{
			{
				Name:           "aws-managed-common",
				Priority:       1,
				OverrideAction: "none",
				Statement: &awswafwebaclv1.AwsWafWebAclStatement{
					Statement: &awswafwebaclv1.AwsWafWebAclStatement_ManagedRuleGroup{
						ManagedRuleGroup: &awswafwebaclv1.AwsWafWebAclManagedRuleGroupStatement{
							Name:       "AWSManagedRulesCommonRuleSet",
							VendorName: "AWS",
							ScopeDownStatement: &awswafwebaclv1.AwsWafWebAclStatement{
								Statement: &awswafwebaclv1.AwsWafWebAclStatement_NotStatement{
									NotStatement: &awswafwebaclv1.AwsWafWebAclNotStatement{
										Statement: &awswafwebaclv1.AwsWafWebAclStatement{
											Statement: &awswafwebaclv1.AwsWafWebAclStatement_ByteMatch{
												ByteMatch: &awswafwebaclv1.AwsWafWebAclByteMatchStatement{
													SearchString:         "/health",
													PositionalConstraint: "STARTS_WITH",
													FieldToMatch: &awswafwebaclv1.AwsWafWebAclFieldToMatch{
														Field: &awswafwebaclv1.AwsWafWebAclFieldToMatch_UriPath{UriPath: true},
													},
													TextTransformations: []*awswafwebaclv1.AwsWafWebAclTextTransformation{
			...
			},
			{
				...
				Action:   "block",
				Statement: &awswafwebaclv1.AwsWafWebAclStatement{
					Statement: &awswafwebaclv1.AwsWafWebAclStatement_RateBased{
						RateBased: &awswafwebaclv1.AwsWafWebAclRateBasedStatement{
							Limit:            2000,
							AggregateKeyType: "CUSTOM_KEYS",
							CustomKeys: []*awswafwebaclv1.AwsWafWebAclRateBasedCustomKey{
								{Key: &awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_Header{
									Header: &awswafwebaclv1.AwsWafWebAclKeyWithTransformations{
										Name: "x-api-key",
										TextTransformations: []*awswafwebaclv1.AwsWafWebAclTextTransformation{
											{Priority: 0, Type: "NONE"},
										},
								...
								{Key: &awswafwebaclv1.AwsWafWebAclRateBasedCustomKey_Ip{Ip: true}},
							},
						},
					},
				},
			},
			{
				...
				Statement: &awswafwebaclv1.AwsWafWebAclStatement{
					Statement: &awswafwebaclv1.AwsWafWebAclStatement_OrStatement{
						OrStatement: &awswafwebaclv1.AwsWafWebAclOrStatement{
							Statements: []*awswafwebaclv1.AwsWafWebAclStatement{
								{Statement: &awswafwebaclv1.AwsWafWebAclStatement_ByteMatch{
									ByteMatch: &awswafwebaclv1.AwsWafWebAclByteMatchStatement{
								...
								{Statement: &awswafwebaclv1.AwsWafWebAclStatement_SqliMatch{
									SqliMatch: &awswafwebaclv1.AwsWafWebAclSqliMatchStatement{
										FieldToMatch: &awswafwebaclv1.AwsWafWebAclFieldToMatch{
											Field: &awswafwebaclv1.AwsWafWebAclFieldToMatch_Body{
												Body: &awswafwebaclv1.AwsWafWebAclBodyMatch{OversizeHandling: "MATCH"},
											},
										},
										TextTransformations: []*awswafwebaclv1.AwsWafWebAclTextTransformation{
		...
		Rules: []*awswafwebaclv1.AwsWafWebAclRule{
			{
				...
				Action:   "allow",
				Statement: &awswafwebaclv1.AwsWafWebAclStatement{
					Statement: &awswafwebaclv1.AwsWafWebAclStatement_IpSetReference{
						IpSetReference: &awswafwebaclv1.AwsWafWebAclIpSetReferenceStatement{
