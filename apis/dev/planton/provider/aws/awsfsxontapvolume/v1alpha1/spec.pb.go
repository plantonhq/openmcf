...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsfsxontapvolume/v1alpha1/spec.proto
...
func (x *AwsFsxOntapVolumeSpec) Reset() {
	*x = AwsFsxOntapVolumeSpec{}
	mi := &file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsFsxOntapVolumeSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxOntapVolumeTieringPolicy) Reset() {
	*x = AwsFsxOntapVolumeTieringPolicy{}
	mi := &file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeTieringPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsFsxOntapVolumeSnaplockConfiguration) Reset() {
	*x = AwsFsxOntapVolumeSnaplockConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeSnaplockConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsFsxOntapVolumeAutocommitPeriod) Reset() {
	*x = AwsFsxOntapVolumeAutocommitPeriod{}
	mi := &file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeAutocommitPeriod) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsFsxOntapVolumeRetentionPeriod) Reset() {
	*x = AwsFsxOntapVolumeRetentionPeriod{}
	mi := &file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeRetentionPeriod) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsFsxOntapVolumeRetentionDuration) Reset() {
	*x = AwsFsxOntapVolumeRetentionDuration{}
	mi := &file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeRetentionDuration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsFsxOntapVolumeAggregateConfiguration) Reset() {
	*x = AwsFsxOntapVolumeAggregateConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeAggregateConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/aws/awsfsxontapvolume/v1alpha1/spec.proto\x123dev.planton.provider.aws.awsfsxontapvolume.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x8a\x17\n" +
	...
	"\x11skip_final_backup\x18\r \x01(\bB\t\x8a\xa6\x1d\x05falseH\x06R\x0fskipFinalBackup\x88\x01\x01\x12\x8b\x01\n" +
	"\x11final_backup_tags\x18\x0e \x03(\v2_.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.FinalBackupTagsEntryR\x0ffinalBackupTags\x12_\n" +
	"$bypass_snaplock_enterprise_retention\x18\x0f \x01(\bB\t\x8a\xa6\x1d\x05falseH\aR!bypassSnaplockEnterpriseRetention\x88\x01\x01\x12z\n" +
	"\x0etiering_policy\x18\x10 \x01(\v2S.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeTieringPolicyR\rtieringPolicy\x12\x92\x01\n" +
	"\x16snaplock_configuration\x18\x11 \x01(\v2[.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfigurationR\x15snaplockConfiguration\x12\x95\x01\n" +
	"\x17aggregate_configuration\x18\x12 \x01(\v2\\.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAggregateConfigurationR\x16aggregateConfiguration\x1aB\n" +
	"\x14FinalBackupTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xc6\t\xbaH\xc2\t\x1a\xb2\x01\n" +
	...
	"\x14junction_path_format\x12!junction_path must start with '/'\x1a>this.junction_path == '' || this.junction_path.startsWith('/')\x1a\xc7\x02\n" +
	"\x1caggregate_requires_flexgroup\x12]aggregate_configuration is only valid for FLEXGROUP volumes (set volume_style to 'FLEXGROUP')\x1a\xc7\x01!has(this.aggregate_configuration) || this.aggregate_configuration == dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAggregateConfiguration{} || this.volume_style == 'FLEXGROUP'B\x14\n" +
	...
	"\x14cooling_period_range\x12-cooling_period must be between 2 and 183 days\x1aTthis.cooling_period == 0 || (this.cooling_period >= 2 && this.cooling_period <= 183)\"\xc9\a\n" +
	...
	"\x1avolume_append_mode_enabled\x18\x04 \x01(\bB\t\x8a\xa6\x1d\x05falseH\x02R\x17volumeAppendModeEnabled\x88\x01\x01\x12\x83\x01\n" +
	"\x11autocommit_period\x18\x05 \x01(\v2V.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAutocommitPeriodR\x10autocommitPeriod\x12\x80\x01\n" +
	"\x10retention_period\x18\x06 \x01(\v2U.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriodR\x0fretentionPeriod:\xd6\x02\xbaH\xd2\x02\x1a}\n" +
	...
	"\x16autocommit_value_range\x123autocommit period value must be between 1 and 65535\x1a;this.value == 0 || (this.value >= 1 && this.value <= 65535)\"\xb7\x03\n" +
	" AwsFsxOntapVolumeRetentionPeriod\x12\x84\x01\n" +
	"\x11default_retention\x18\x01 \x01(\v2W.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDurationR\x10defaultRetention\x12\x84\x01\n" +
	"\x11minimum_retention\x18\x02 \x01(\v2W.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDurationR\x10minimumRetention\x12\x84\x01\n" +
	"\x11maximum_retention\x18\x03 \x01(\v2W.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDurationR\x10maximumRetention\"\xea\x02\n" +
	...
	"\x12constituents_range\x124constituents_per_aggregate must be between 1 and 200\x1axthis.constituents_per_aggregate == 0 || (this.constituents_per_aggregate >= 1 && this.constituents_per_aggregate <= 200)B\xa8\x03\n" +
	"7com.dev.planton.provider.aws.awsfsxontapvolume.v1alpha1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsfsxontapvolume/v1alpha1;awsfsxontapvolumev1alpha1\xa2\x02\x05DPPAA\xaa\x023Dev.Planton.Provider.Aws.Awsfsxontapvolume.V1alpha1\xca\x023Dev\\Planton\\Provider\\Aws\\Awsfsxontapvolume\\V1alpha1\xe2\x02?Dev\\Planton\\Provider\\Aws\\Awsfsxontapvolume\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Provider::Aws::Awsfsxontapvolume::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_goTypes = []any{
	(*AwsFsxOntapVolumeSpec)(nil),                   // 0: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec
	(*AwsFsxOntapVolumeTieringPolicy)(nil),          // 1: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeTieringPolicy
	(*AwsFsxOntapVolumeSnaplockConfiguration)(nil),  // 2: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration
	(*AwsFsxOntapVolumeAutocommitPeriod)(nil),       // 3: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAutocommitPeriod
	(*AwsFsxOntapVolumeRetentionPeriod)(nil),        // 4: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod
	(*AwsFsxOntapVolumeRetentionDuration)(nil),      // 5: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
	(*AwsFsxOntapVolumeAggregateConfiguration)(nil), // 6: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAggregateConfiguration
	nil,                         // 7: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.FinalBackupTagsEntry
	(*v1.StringValueOrRef)(nil), // 8: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_depIdxs = []int32{
	8,  // 0: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.storage_virtual_machine_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 1: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.final_backup_tags:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.FinalBackupTagsEntry
	1,  // 2: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.tiering_policy:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeTieringPolicy
	2,  // 3: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.snaplock_configuration:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration
	6,  // 4: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.aggregate_configuration:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAggregateConfiguration
	3,  // 5: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration.autocommit_period:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAutocommitPeriod
	4,  // 6: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration.retention_period:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod
	5,  // 7: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod.default_retention:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
	5,  // 8: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod.minimum_retention:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
	5,  // 9: dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod.maximum_retention:type_name -> dev.planton.provider.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
...
func init() { file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsfsxontapvolume_v1alpha1_spec_proto_depIdxs = nil
}
