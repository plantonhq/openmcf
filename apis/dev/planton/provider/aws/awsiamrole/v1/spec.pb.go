...
func (x *AwsIamRoleOidcTrust) Reset() {
	*x = AwsIamRoleOidcTrust{}
	mi := &file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsIamRoleOidcTrust) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
const file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_rawDesc = "" +
	"\n" +
	"1dev/planton/provider/aws/awsiamrole/v1/spec.proto\x12&dev.planton.provider.aws.awsiamrole.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xfc\n" +
	"\n" +
	...
	"\ftrust_policy\x18\x04 \x01(\v2\x17.google.protobuf.StructH\x00R\vtrustPolicy\x12\\\n" +
	"\n" +
	"oidc_trust\x18\n" +
	...
	"\x1coidc_trust_subjects_required\x12\x8f\x01at least one subject is required -- exact (subjects, e.g. 'system:serviceaccount:<namespace>:<serviceaccount>') or wildcard (wildcard_subjects)\x1a;size(this.subjects) > 0 || size(this.wildcard_subjects) > 0B\xcd\x02\n" +
...
var file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_goTypes = []any{
	...
	(*AwsIamRoleOidcTrust)(nil), // 1: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleOidcTrust
	nil,                         // 2: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.InlinePoliciesEntry
...
var file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.trust_policy:type_name -> google.protobuf.Struct
	1, // 1: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.oidc_trust:type_name -> dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleOidcTrust
	4, // 2: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.managed_policy_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.inline_policies:type_name -> dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.InlinePoliciesEntry
	4, // 4: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.permissions_boundary:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 5: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleOidcTrust.provider_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 6: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleOidcTrust.provider_url:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 7: dev.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.InlinePoliciesEntry.value:type_name -> google.protobuf.Struct
...
func file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_init() {
	...
	file_dev_planton_provider_aws_awsiamrole_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
