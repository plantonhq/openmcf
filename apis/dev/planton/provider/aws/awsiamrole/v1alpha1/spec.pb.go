...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsiamrole/v1alpha1/spec.proto
...
func (x *AwsIamRoleSpec) Reset() {
	*x = AwsIamRoleSpec{}
	mi := &file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsIamRoleSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsIamRoleOidcTrust) Reset() {
	*x = AwsIamRoleOidcTrust{}
	mi := &file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsIamRoleOidcTrust) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7dev/planton/provider/aws/awsiamrole/v1alpha1/spec.proto\x12,dev.planton.provider.aws.awsiamrole.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x88\v\n" +
	...
	"\ftrust_policy\x18\x04 \x01(\v2\x17.google.protobuf.StructH\x00R\vtrustPolicy\x12b\n" +
	"\n" +
	"oidc_trust\x18\n" +
	" \x01(\v2A.dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleOidcTrustH\x00R\toidcTrust\x12\x86\x01\n" +
	"\x13managed_policy_arns\x18\x05 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\"\x88\xd4a\x86\b\x92\xd4a\x19status.outputs.policy_arnR\x11managedPolicyArns\x12\x88\x01\n" +
	"\x0finline_policies\x18\x06 \x03(\v2P.dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.InlinePoliciesEntryB\r\xbaH\n" +
	...
	"\x1coidc_trust_subjects_required\x12\x8f\x01at least one subject is required -- exact (subjects, e.g. 'system:serviceaccount:<namespace>:<serviceaccount>') or wildcard (wildcard_subjects)\x1a;size(this.subjects) > 0 || size(this.wildcard_subjects) > 0B\xf7\x02\n" +
	"0com.dev.planton.provider.aws.awsiamrole.v1alpha1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsiamrole/v1alpha1;awsiamrolev1alpha1\xa2\x02\x05DPPAA\xaa\x02,Dev.Planton.Provider.Aws.Awsiamrole.V1alpha1\xca\x02,Dev\\Planton\\Provider\\Aws\\Awsiamrole\\V1alpha1\xe2\x028Dev\\Planton\\Provider\\Aws\\Awsiamrole\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Provider::Aws::Awsiamrole::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_goTypes = []any{
	(*AwsIamRoleSpec)(nil),      // 0: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec
	(*AwsIamRoleOidcTrust)(nil), // 1: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleOidcTrust
	nil,                         // 2: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.InlinePoliciesEntry
	(*structpb.Struct)(nil),     // 3: google.protobuf.Struct
	(*v1.StringValueOrRef)(nil), // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.trust_policy:type_name -> google.protobuf.Struct
	1, // 1: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.oidc_trust:type_name -> dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleOidcTrust
	4, // 2: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.managed_policy_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.inline_policies:type_name -> dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.InlinePoliciesEntry
	4, // 4: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.permissions_boundary:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 5: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleOidcTrust.provider_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 6: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleOidcTrust.provider_url:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 7: dev.planton.provider.aws.awsiamrole.v1alpha1.AwsIamRoleSpec.InlinePoliciesEntry.value:type_name -> google.protobuf.Struct
...
func init() { file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsiamrole_v1alpha1_spec_proto_depIdxs = nil
}
