...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsstepfunction/v1alpha1/spec.proto
...
func (x *AwsStepFunctionSpec) Reset() {
	*x = AwsStepFunctionSpec{}
	mi := &file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsStepFunctionSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsStepFunctionLoggingConfig) Reset() {
	*x = AwsStepFunctionLoggingConfig{}
	mi := &file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsStepFunctionLoggingConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsStepFunctionEncryptionConfig) Reset() {
	*x = AwsStepFunctionEncryptionConfig{}
	mi := &file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsStepFunctionEncryptionConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"<dev/planton/provider/aws/awsstepfunction/v1alpha1/spec.proto\x121dev.planton.provider.aws.awsstepfunction.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x8f\a\n" +
	...
	"\apublish\x18\x05 \x01(\bR\apublish\x12i\n" +
	"\alogging\x18\x06 \x01(\v2O.dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionLoggingConfigR\alogging\x12'\n" +
	"\x0ftracing_enabled\x18\a \x01(\bR\x0etracingEnabled\x12r\n" +
	"\n" +
	"encryption\x18\b \x01(\v2R.dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionEncryptionConfigR\n" +
	...
	"\x18kms_data_key_reuse_range\x12Ekms_data_key_reuse_period_seconds must be between 60 and 900 when set\x1a\x8e\x01this.kms_data_key_reuse_period_seconds == 0 || (this.kms_data_key_reuse_period_seconds >= 60 && this.kms_data_key_reuse_period_seconds <= 900)B\x9a\x03\n" +
	"5com.dev.planton.provider.aws.awsstepfunction.v1alpha1B\tSpecProtoP\x01Zkgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsstepfunction/v1alpha1;awsstepfunctionv1alpha1\xa2\x02\x05DPPAA\xaa\x021Dev.Planton.Provider.Aws.Awsstepfunction.V1alpha1\xca\x021Dev\\Planton\\Provider\\Aws\\Awsstepfunction\\V1alpha1\xe2\x02=Dev\\Planton\\Provider\\Aws\\Awsstepfunction\\V1alpha1\\GPBMetadata\xea\x026Dev::Planton::Provider::Aws::Awsstepfunction::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_goTypes = []any{
	(*AwsStepFunctionSpec)(nil),             // 0: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionSpec
	(*AwsStepFunctionLoggingConfig)(nil),    // 1: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionLoggingConfig
	(*AwsStepFunctionEncryptionConfig)(nil), // 2: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionEncryptionConfig
	(*structpb.Struct)(nil),                 // 3: google.protobuf.Struct
	(*v1.StringValueOrRef)(nil),             // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionSpec.definition:type_name -> google.protobuf.Struct
	4, // 1: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionSpec.role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionSpec.logging:type_name -> dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionLoggingConfig
	2, // 3: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionSpec.encryption:type_name -> dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionEncryptionConfig
	4, // 4: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionLoggingConfig.log_destination:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 5: dev.planton.provider.aws.awsstepfunction.v1alpha1.AwsStepFunctionEncryptionConfig.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsstepfunction_v1alpha1_spec_proto_depIdxs = nil
}
