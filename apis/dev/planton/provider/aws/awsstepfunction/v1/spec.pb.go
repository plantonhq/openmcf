...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsstepfunction/v1/spec.proto
...
func (x *AwsStepFunctionSpec) Reset() {
	*x = AwsStepFunctionSpec{}
	mi := &file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_msgTypes[0]
...
func (*AwsStepFunctionSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsStepFunctionLoggingConfig) Reset() {
	*x = AwsStepFunctionLoggingConfig{}
	mi := &file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsStepFunctionLoggingConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsStepFunctionEncryptionConfig) Reset() {
	*x = AwsStepFunctionEncryptionConfig{}
	mi := &file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsStepFunctionEncryptionConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsstepfunction_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDesc = "" +
	...
	"\n" +
	"encryption\x18\b \x01(\v2L.dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionEncryptionConfigR\n" +
...
var (
	file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_goTypes = []any{
	(*AwsStepFunctionSpec)(nil),             // 0: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionSpec
	(*AwsStepFunctionLoggingConfig)(nil),    // 1: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionLoggingConfig
	(*AwsStepFunctionEncryptionConfig)(nil), // 2: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionEncryptionConfig
	(*structpb.Struct)(nil),                 // 3: google.protobuf.Struct
	(*v1.StringValueOrRef)(nil),             // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionSpec.definition:type_name -> google.protobuf.Struct
	4, // 1: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionSpec.role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionSpec.logging:type_name -> dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionLoggingConfig
	2, // 3: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionSpec.encryption:type_name -> dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionEncryptionConfig
	4, // 4: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionLoggingConfig.log_destination:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 5: dev.planton.provider.aws.awsstepfunction.v1.AwsStepFunctionEncryptionConfig.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsstepfunction_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsstepfunction_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsstepfunction_v1_spec_proto_depIdxs = nil
}
