...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awskmskey/v1alpha1/spec.proto
...
func (x *AwsKmsKeySpec) Reset() {
	*x = AwsKmsKeySpec{}
	mi := &file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsKmsKeySpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"6dev/planton/provider/aws/awskmskey/v1alpha1/spec.proto\x12+dev.planton.provider.aws.awskmskey.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xf1\x0f\n" +
	...
	"\x17no_reserved_aws_aliases\x12Wthe alias/aws/ prefix is reserved for AWS-managed keys -- choose a different alias name\x1a0this.aliases.all(a, !a.startsWith('alias/aws/'))B\xf0\x02\n" +
	"/com.dev.planton.provider.aws.awskmskey.v1alpha1B\tSpecProtoP\x01Z_github.com/plantonhq/planton/apis/dev/planton/provider/aws/awskmskey/v1alpha1;awskmskeyv1alpha1\xa2\x02\x05DPPAA\xaa\x02+Dev.Planton.Provider.Aws.Awskmskey.V1alpha1\xca\x02+Dev\\Planton\\Provider\\Aws\\Awskmskey\\V1alpha1\xe2\x027Dev\\Planton\\Provider\\Aws\\Awskmskey\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Provider::Aws::Awskmskey::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_goTypes = []any{
	(*AwsKmsKeySpec)(nil), // 0: dev.planton.provider.aws.awskmskey.v1alpha1.AwsKmsKeySpec
}
var file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_depIdxs = []int32{
...
func init() { file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awskmskey_v1alpha1_spec_proto_depIdxs = nil
}
