...
// place.
func ec2CapacityProvider(ctx *pulumi.Context, locals *Locals, provider *aws.Provider, providerSpec *awsecsclusterv1.AwsEcsClusterEc2CapacityProvider) (*ecs.CapacityProvider, error) {
