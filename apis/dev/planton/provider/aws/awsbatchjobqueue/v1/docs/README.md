...
Attaching an [AwsBatchSchedulingPolicy](../../awsbatchschedulingpolicy/v1/docs/README.md) switches the queue from FIFO to fair-share ordering by the share identifiers jobs carry at submission.
