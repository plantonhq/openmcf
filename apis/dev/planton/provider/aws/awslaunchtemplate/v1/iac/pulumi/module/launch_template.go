...
// override safe.
func blockDeviceMappingArgs(mappings []*awslaunchtemplatev1.AwsLaunchTemplateBlockDeviceMapping) ec2.LaunchTemplateBlockDeviceMappingArray {
...
func networkInterfaceArgs(interfaces []*awslaunchtemplatev1.AwsLaunchTemplateNetworkInterface) ec2.LaunchTemplateNetworkInterfaceArray {
...
// keep applying.
func instanceRequirementsArgs(requirements *awslaunchtemplatev1.AwsLaunchTemplateInstanceRequirements) *ec2.LaunchTemplateInstanceRequirementsArgs {
...
func metadataOptionsArgs(options *awslaunchtemplatev1.AwsLaunchTemplateMetadataOptions) *ec2.LaunchTemplateMetadataOptionsArgs {
...
func placementArgs(placement *awslaunchtemplatev1.AwsLaunchTemplatePlacement) *ec2.LaunchTemplatePlacementArgs {
...
func cpuOptionsArgs(options *awslaunchtemplatev1.AwsLaunchTemplateCpuOptions) *ec2.LaunchTemplateCpuOptionsArgs {
...
func spotOptionsArgs(options *awslaunchtemplatev1.AwsLaunchTemplateSpotOptions) *ec2.LaunchTemplateInstanceMarketOptionsSpotOptionsArgs {
...
func privateDnsNameOptionsArgs(options *awslaunchtemplatev1.AwsLaunchTemplatePrivateDnsNameOptions) *ec2.LaunchTemplatePrivateDnsNameOptionsArgs {
