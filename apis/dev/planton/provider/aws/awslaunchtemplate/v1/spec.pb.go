...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awslaunchtemplate/v1/spec.proto
...
func (x *AwsLaunchTemplateSpec) Reset() {
	*x = AwsLaunchTemplateSpec{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[0]
...
func (*AwsLaunchTemplateSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsLaunchTemplateInstanceRequirements) Reset() {
	*x = AwsLaunchTemplateInstanceRequirements{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateInstanceRequirements) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsLaunchTemplateIntRange) Reset() {
	*x = AwsLaunchTemplateIntRange{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateIntRange) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsLaunchTemplateDoubleRange) Reset() {
	*x = AwsLaunchTemplateDoubleRange{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateDoubleRange) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsLaunchTemplateBlockDeviceMapping) Reset() {
	*x = AwsLaunchTemplateBlockDeviceMapping{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateBlockDeviceMapping) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsLaunchTemplateEbs) Reset() {
	*x = AwsLaunchTemplateEbs{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateEbs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsLaunchTemplateNetworkInterface) Reset() {
	*x = AwsLaunchTemplateNetworkInterface{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateNetworkInterface) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsLaunchTemplateMetadataOptions) Reset() {
	*x = AwsLaunchTemplateMetadataOptions{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateMetadataOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsLaunchTemplatePlacement) Reset() {
	*x = AwsLaunchTemplatePlacement{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplatePlacement) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsLaunchTemplateCpuOptions) Reset() {
	*x = AwsLaunchTemplateCpuOptions{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateCpuOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *AwsLaunchTemplateSpotOptions) Reset() {
	*x = AwsLaunchTemplateSpotOptions{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplateSpotOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *AwsLaunchTemplatePrivateDnsNameOptions) Reset() {
	*x = AwsLaunchTemplatePrivateDnsNameOptions{}
	mi := &file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLaunchTemplatePrivateDnsNameOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP(), []int{11}
}
...
var File_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8dev/planton/provider/aws/awslaunchtemplate/v1/spec.proto\x12-dev.planton.provider.aws.awslaunchtemplate.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x88\x19\n" +
	...
	"\rinstance_type\x18\x04 \x01(\tR\finstanceType\x12\x89\x01\n" +
	...
	"\x12network_interfaces\x18\f \x03(\v2P.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateNetworkInterfaceR\x11networkInterfaces\x12z\n" +
	"\x10metadata_options\x18\r \x01(\v2O.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateMetadataOptionsR\x0fmetadataOptions\x12/\n" +
	"\x13detailed_monitoring\x18\x0e \x01(\bR\x12detailedMonitoring\x12g\n" +
	"\tplacement\x18\x0f \x01(\v2I.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplatePlacementR\tplacement\x12k\n" +
	"\vcpu_options\x18\x10 \x01(\v2J.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateCpuOptionsR\n" +
	"cpuOptions\x12\x1f\n" +
	"\vcpu_credits\x18\x11 \x01(\tR\n" +
	"cpuCredits\x12n\n" +
	"\fspot_options\x18\x12 \x01(\v2K.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpotOptionsR\vspotOptions\x12'\n" +
	"\x0fenclave_enabled\x18\x13 \x01(\bR\x0eenclaveEnabled\x12/\n" +
	"\x13hibernation_enabled\x18\x14 \x01(\bR\x12hibernationEnabled\x12#\n" +
	"\rauto_recovery\x18\x15 \x01(\tR\fautoRecovery\x12\x8e\x01\n" +
	"\x18private_dns_name_options\x18\x16 \x01(\v2U.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplatePrivateDnsNameOptionsR\x15privateDnsNameOptions\x12(\n" +
	...
	"(security_groups_conflict_with_interfaces\x12lwhen network_interfaces are declared, attach security groups on each interface instead of security_group_ids\x1aHsize(this.network_interfaces) == 0 || size(this.security_group_ids) == 0\"\xc8\x18\n" +
	"%AwsLaunchTemplateInstanceRequirements\x12o\n" +
	"\n" +
	"memory_mib\x18\x01 \x01(\v2H.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRangeB\x06\xbaH\x03\xc8\x01\x01R\tmemoryMib\x12o\n" +
	"\n" +
	"vcpu_count\x18\x02 \x01(\v2H.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRangeB\x06\xbaH\x03\xc8\x01\x01R\tvcpuCount\x12?\n" +
	...
	"\x13local_storage_types\x18\x0e \x03(\tR\x11localStorageTypes\x12\x80\x01\n" +
	"\x16total_local_storage_gb\x18\x0f \x01(\v2K.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateDoubleRangeR\x13totalLocalStorageGb\x12z\n" +
	"\x13memory_gib_per_vcpu\x18\x10 \x01(\v2K.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateDoubleRangeR\x10memoryGibPerVcpu\x12\x80\x01\n" +
	"\x17network_interface_count\x18\x11 \x01(\v2H.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRangeR\x15networkInterfaceCount\x12\x81\x01\n" +
	"\x16network_bandwidth_gbps\x18\x12 \x01(\v2K.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateDoubleRangeR\x14networkBandwidthGbps\x12\x87\x01\n" +
	"\x1bbaseline_ebs_bandwidth_mbps\x18\x13 \x01(\v2H.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRangeR\x18baselineEbsBandwidthMbps\x12u\n" +
	"\x11accelerator_count\x18\x14 \x01(\v2H.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRangeR\x10acceleratorCount\x12;\n" +
	...
	"\x11accelerator_types\x18\x17 \x03(\tR\x10acceleratorTypes\x12\x89\x01\n" +
	"\x1caccelerator_total_memory_mib\x18\x18 \x01(\v2H.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRangeR\x19acceleratorTotalMemoryMib:\x97\b\xbaH\x93\b\x1a\xba\x01\n" +
	...
	"\x14double_range_ordered\x12:max must be greater than or equal to min when both are set\x1a:this.min == 0.0 || this.max == 0.0 || this.max >= this.min\"\xf3\x03\n" +
	...
	"\tno_device\x18\x03 \x01(\bR\bnoDevice\x12U\n" +
	"\x03ebs\x18\x04 \x01(\v2C.dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateEbsR\x03ebs:\x8b\x02\xbaH\x87\x02\x1a\x88\x01\n" +
	...
	"\x13hostname_type_valid\x12;hostname_type must be 'ip-name' or 'resource-name' when set\x1aNthis.hostname_type == '' || this.hostname_type in ['ip-name', 'resource-name']B\xfe\x02\n" +
	"1com.dev.planton.provider.aws.awslaunchtemplate.v1B\tSpecProtoP\x01Zcgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awslaunchtemplate/v1;awslaunchtemplatev1\xa2\x02\x05DPPAA\xaa\x02-Dev.Planton.Provider.Aws.Awslaunchtemplate.V1\xca\x02-Dev\\Planton\\Provider\\Aws\\Awslaunchtemplate\\V1\xe2\x029Dev\\Planton\\Provider\\Aws\\Awslaunchtemplate\\V1\\GPBMetadata\xea\x022Dev::Planton::Provider::Aws::Awslaunchtemplate::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_goTypes = []any{
	(*AwsLaunchTemplateSpec)(nil),                  // 0: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec
	(*AwsLaunchTemplateInstanceRequirements)(nil),  // 1: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements
	(*AwsLaunchTemplateIntRange)(nil),              // 2: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRange
	(*AwsLaunchTemplateDoubleRange)(nil),           // 3: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateDoubleRange
	(*AwsLaunchTemplateBlockDeviceMapping)(nil),    // 4: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateBlockDeviceMapping
	(*AwsLaunchTemplateEbs)(nil),                   // 5: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateEbs
	(*AwsLaunchTemplateNetworkInterface)(nil),      // 6: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateNetworkInterface
	(*AwsLaunchTemplateMetadataOptions)(nil),       // 7: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateMetadataOptions
	(*AwsLaunchTemplatePlacement)(nil),             // 8: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplatePlacement
	(*AwsLaunchTemplateCpuOptions)(nil),            // 9: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateCpuOptions
	(*AwsLaunchTemplateSpotOptions)(nil),           // 10: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpotOptions
	(*AwsLaunchTemplatePrivateDnsNameOptions)(nil), // 11: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplatePrivateDnsNameOptions
	(*v1.StringValueOrRef)(nil),                    // 12: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.instance_requirements:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements
	12, // 1: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.instance_profile:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 2: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 3: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.block_device_mappings:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateBlockDeviceMapping
	6,  // 4: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.network_interfaces:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateNetworkInterface
	7,  // 5: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.metadata_options:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateMetadataOptions
	8,  // 6: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.placement:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplatePlacement
	9,  // 7: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.cpu_options:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateCpuOptions
	10, // 8: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.spot_options:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpotOptions
	11, // 9: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateSpec.private_dns_name_options:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplatePrivateDnsNameOptions
	2,  // 10: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.memory_mib:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRange
	2,  // 11: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.vcpu_count:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRange
	3,  // 12: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.total_local_storage_gb:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateDoubleRange
	3,  // 13: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.memory_gib_per_vcpu:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateDoubleRange
	2,  // 14: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.network_interface_count:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRange
	3,  // 15: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.network_bandwidth_gbps:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateDoubleRange
	2,  // 16: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.baseline_ebs_bandwidth_mbps:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRange
	2,  // 17: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.accelerator_count:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRange
	2,  // 18: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateInstanceRequirements.accelerator_total_memory_mib:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateIntRange
	5,  // 19: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateBlockDeviceMapping.ebs:type_name -> dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateEbs
	12, // 20: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateEbs.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 21: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateNetworkInterface.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 22: dev.planton.provider.aws.awslaunchtemplate.v1.AwsLaunchTemplateNetworkInterface.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awslaunchtemplate_v1_spec_proto_depIdxs = nil
}
