...
func capacityType(value awseksnodegroupv1.AwsEksNodeGroupCapacityType) string {
	switch value {
	case awseksnodegroupv1.AwsEksNodeGroupCapacityType_spot:
		return "SPOT"
	case awseksnodegroupv1.AwsEksNodeGroupCapacityType_capacity_block:
...
func launchTemplateVersion(launchTemplate *awseksnodegroupv1.AwsEksNodeGroupLaunchTemplate) string {
