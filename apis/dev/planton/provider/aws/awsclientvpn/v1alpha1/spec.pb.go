...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsclientvpn/v1alpha1/spec.proto
...
func (x *AwsClientVpnSpec) Reset() {
	*x = AwsClientVpnSpec{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsClientVpnSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsClientVpnAuthenticationOption) Reset() {
	*x = AwsClientVpnAuthenticationOption{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsClientVpnAuthenticationOption) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsClientVpnAuthorizationRule) Reset() {
	*x = AwsClientVpnAuthorizationRule{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsClientVpnAuthorizationRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsClientVpnRoute) Reset() {
	*x = AwsClientVpnRoute{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsClientVpnRoute) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsClientVpnClientConnectOptions) Reset() {
	*x = AwsClientVpnClientConnectOptions{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsClientVpnClientConnectOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsClientVpnLoginBanner) Reset() {
	*x = AwsClientVpnLoginBanner{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsClientVpnLoginBanner) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsClientVpnConnectionLog) Reset() {
	*x = AwsClientVpnConnectionLog{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsClientVpnConnectionLog) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsClientVpnTransitGatewayConfiguration) Reset() {
	*x = AwsClientVpnTransitGatewayConfiguration{}
	mi := &file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsClientVpnTransitGatewayConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
var File_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"9dev/planton/provider/aws/awsclientvpn/v1alpha1/spec.proto\x12.dev.planton.provider.aws.awsclientvpn.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x87\x1d\n" +
	"\x10AwsClientVpnSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x96\x01\n" +
	"\x16authentication_options\x18\x03 \x03(\v2P.dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnAuthenticationOptionB\r\xbaH\n" +
	...
	"\n" +
	"subnet_ids\x18\r \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\xbc\b\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12\x9b\x01\n" +
	"\x1dtransit_gateway_configuration\x18\x0e \x01(\v2W.dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnTransitGatewayConfigurationR\x1btransitGatewayConfiguration\x12~\n" +
	"\x13authorization_rules\x18\x0f \x03(\v2M.dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnAuthorizationRuleR\x12authorizationRules\x12Y\n" +
	"\x06routes\x18\x10 \x03(\v2A.dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnRouteR\x06routes\x12L\n" +
	...
	"\x1bself_service_portal_enabled\x18\x13 \x01(\bR\x18selfServicePortalEnabled\x12\x86\x01\n" +
	"\x16client_connect_options\x18\x14 \x01(\v2P.dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnClientConnectOptionsR\x14clientConnectOptions\x12w\n" +
	"\x13client_login_banner\x18\x15 \x01(\v2G.dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnLoginBannerR\x11clientLoginBanner\x12G\n" +
	...
	"dnsServers\x12p\n" +
	"\x0econnection_log\x18\x18 \x01(\v2I.dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnConnectionLogR\rconnectionLog:\xee\n" +
	"\xbaH\xea\n" +
	"\x1a\x9a\x02\n" +
	...
	"\vone_az_form\x12navailability_zones (names) and availability_zone_ids (IDs) are mutually exclusive — pick one addressing form\x1aN!(this.availability_zones.size() > 0 && this.availability_zone_ids.size() > 0)B\x85\x03\n" +
	"2com.dev.planton.provider.aws.awsclientvpn.v1alpha1B\tSpecProtoP\x01Zegithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsclientvpn/v1alpha1;awsclientvpnv1alpha1\xa2\x02\x05DPPAA\xaa\x02.Dev.Planton.Provider.Aws.Awsclientvpn.V1alpha1\xca\x02.Dev\\Planton\\Provider\\Aws\\Awsclientvpn\\V1alpha1\xe2\x02:Dev\\Planton\\Provider\\Aws\\Awsclientvpn\\V1alpha1\\GPBMetadata\xea\x023Dev::Planton::Provider::Aws::Awsclientvpn::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_goTypes = []any{
	(*AwsClientVpnSpec)(nil),                        // 0: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec
	(*AwsClientVpnAuthenticationOption)(nil),        // 1: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnAuthenticationOption
	(*AwsClientVpnAuthorizationRule)(nil),           // 2: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnAuthorizationRule
	(*AwsClientVpnRoute)(nil),                       // 3: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnRoute
	(*AwsClientVpnClientConnectOptions)(nil),        // 4: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnClientConnectOptions
	(*AwsClientVpnLoginBanner)(nil),                 // 5: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnLoginBanner
	(*AwsClientVpnConnectionLog)(nil),               // 6: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnConnectionLog
	(*AwsClientVpnTransitGatewayConfiguration)(nil), // 7: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnTransitGatewayConfiguration
	(*v1.StringValueOrRef)(nil),                     // 8: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.authentication_options:type_name -> dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnAuthenticationOption
	8,  // 1: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.server_certificate_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 2: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 3: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 4: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 5: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.transit_gateway_configuration:type_name -> dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnTransitGatewayConfiguration
	2,  // 6: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.authorization_rules:type_name -> dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnAuthorizationRule
	3,  // 7: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.routes:type_name -> dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnRoute
	4,  // 8: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.client_connect_options:type_name -> dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnClientConnectOptions
	5,  // 9: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.client_login_banner:type_name -> dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnLoginBanner
	6,  // 10: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnSpec.connection_log:type_name -> dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnConnectionLog
	8,  // 11: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnAuthenticationOption.root_certificate_chain_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 12: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnRoute.target_subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 13: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnClientConnectOptions.lambda_function_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 14: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnConnectionLog.cloudwatch_log_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 15: dev.planton.provider.aws.awsclientvpn.v1alpha1.AwsClientVpnTransitGatewayConfiguration.transit_gateway_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsclientvpn_v1alpha1_spec_proto_depIdxs = nil
}
