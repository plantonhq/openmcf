...
import (
	...
	"github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsclientvpn/v1alpha1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &awsclientvpnv1alpha1.AwsClientVpnStackInput{}
