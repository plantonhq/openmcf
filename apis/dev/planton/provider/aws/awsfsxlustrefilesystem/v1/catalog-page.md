...
- [AwsElasticFileSystem](/docs/catalog/aws/awselasticfilesystem) — alternative managed file system for general-purpose NFS workloads
- [AwsVpc](/docs/catalog/aws/awsvpc) — provides the subnet for file system placement
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls Lustre protocol traffic (TCP 988, 1018-1023) to the file system
- [AwsKmsKey](/docs/catalog/aws/awskmskey) — provides a customer-managed encryption key for data at rest
- [AwsCloudwatchLogGroup](/docs/catalog/aws/awscloudwatchloggroup) — receives audit log events from the file system
