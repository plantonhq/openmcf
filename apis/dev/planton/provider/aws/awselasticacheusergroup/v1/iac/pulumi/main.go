...
import (
	...
	"github.com/plantonhq/planton/apis/dev/planton/provider/aws/awselasticacheusergroup/v1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &awselasticacheusergroupv1.AwsElasticacheUserGroupStackInput{}
