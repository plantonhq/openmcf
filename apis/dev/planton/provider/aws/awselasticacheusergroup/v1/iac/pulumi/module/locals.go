...
type Locals struct {
	AwsElasticacheUserGroup *awselasticacheusergroupv1.AwsElasticacheUserGroup
...
func initializeLocals(_ *pulumi.Context, stackInput *awselasticacheusergroupv1.AwsElasticacheUserGroupStackInput) *Locals {
	locals := &Locals{}
