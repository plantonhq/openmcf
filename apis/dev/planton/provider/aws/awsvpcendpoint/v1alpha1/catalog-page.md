...
- [AwsVpc](/docs/catalog/aws/awsvpc) — the VPC the endpoint lives in (and the main/default route-table outputs gateway endpoints attach to)
- [AwsSubnet](/docs/catalog/aws/awssubnet) — subnets for interface ENIs; subnet-owned route tables for gateway endpoints
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls client access to an interface endpoint's ENIs
- [AwsRoute53Zone](/docs/catalog/aws/awsroute53zone) — private zones that alias onto the endpoint's DNS name
