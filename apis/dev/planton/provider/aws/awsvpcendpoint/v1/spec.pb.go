...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsvpcendpoint/v1/spec.proto
...
func (x *AwsVpcEndpointSpec) Reset() {
	*x = AwsVpcEndpointSpec{}
	mi := &file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_msgTypes[0]
...
func (*AwsVpcEndpointSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsVpcEndpointDnsOptions) Reset() {
	*x = AwsVpcEndpointDnsOptions{}
	mi := &file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsVpcEndpointDnsOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsVpcEndpointSubnetConfiguration) Reset() {
	*x = AwsVpcEndpointSubnetConfiguration{}
	mi := &file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsVpcEndpointSubnetConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDesc = "" +
	"\n" +
	"5dev/planton/provider/aws/awsvpcendpoint/v1/spec.proto\x12*dev.planton.provider.aws.awsvpcendpoint.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xd3\x19\n" +
	...
	"\x13service_network_arn\x18\x06 \x01(\tR\x11serviceNetworkArn\x12\x82\x01\n" +
	"\x0froute_table_ids\x18\a \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB&\x88\xd4a\x9c\x02\x92\xd4a\x1dstatus.outputs.route_table_idR\rrouteTableIds\x12t\n" +
	"\n" +
	...
	"\x06policy\x18\r \x01(\tR\x06policy\x12\x82\x01\n" +
	"\x15subnet_configurations\x18\x0e \x03(\v2M.dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSubnetConfigurationR\x14subnetConfigurations\x12%\n" +
...
var (
	file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_goTypes = []any{
	(*AwsVpcEndpointSpec)(nil),                // 0: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSpec
	(*AwsVpcEndpointDnsOptions)(nil),          // 1: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointDnsOptions
	(*AwsVpcEndpointSubnetConfiguration)(nil), // 2: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSubnetConfiguration
	(*v1.StringValueOrRef)(nil),               // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSpec.route_table_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 3: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 4: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSpec.dns_options:type_name -> dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointDnsOptions
	2, // 5: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSpec.subnet_configurations:type_name -> dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSubnetConfiguration
	3, // 6: dev.planton.provider.aws.awsvpcendpoint.v1.AwsVpcEndpointSubnetConfiguration.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsvpcendpoint_v1_spec_proto_depIdxs = nil
}
