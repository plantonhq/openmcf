...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsekscluster/v1/spec.proto
...
func (x *AwsEksClusterSpec) Reset() {
	*x = AwsEksClusterSpec{}
	mi := &file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_msgTypes[0]
...
func (*AwsEksClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEksClusterAccessConfig) Reset() {
	*x = AwsEksClusterAccessConfig{}
	mi := &file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEksClusterAccessConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEksClusterAutoMode) Reset() {
	*x = AwsEksClusterAutoMode{}
	mi := &file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEksClusterAutoMode) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsekscluster_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"4dev/planton/provider/aws/awsekscluster/v1/spec.proto\x12)dev.planton.provider.aws.awsekscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xbc\x17\n" +
	"\x11AwsEksClusterSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12\x7f\n" +
	"\n" +
	"subnet_ids\x18\x02 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB,\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x02\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x12\x84\x01\n" +
	"\x10cluster_role_arn\x18\x03 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB&\xbaH\x03\xc8\x01\x01\x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\x0eclusterRoleArn\x12\x18\n" +
	...
	"\x19enabled_cluster_log_types\x18\f \x03(\tB\b\xbaH\x05\x92\x01\x02\x18\x01R\x16enabledClusterLogTypes\x12s\n" +
	"\vkms_key_arn\x18\r \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\tkmsKeyArn\x12i\n" +
	...
	"-com.dev.planton.provider.aws.awsekscluster.v1B\tSpecProtoP\x01Z[github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsekscluster/v1;awseksclusterv1\xa2\x02\x05DPPAA\xaa\x02)Dev.Planton.Provider.Aws.Awsekscluster.V1\xca\x02)Dev\\Planton\\Provider\\Aws\\Awsekscluster\\V1\xe2\x025Dev\\Planton\\Provider\\Aws\\Awsekscluster\\V1\\GPBMetadata\xea\x02.Dev::Planton::Provider::Aws::Awsekscluster::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_goTypes = []any{
	(*AwsEksClusterSpec)(nil),         // 0: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterSpec
	(*AwsEksClusterAccessConfig)(nil), // 1: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterAccessConfig
	(*AwsEksClusterAutoMode)(nil),     // 2: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterAutoMode
	(*v1.StringValueOrRef)(nil),       // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterSpec.cluster_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 3: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 4: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterSpec.access_config:type_name -> dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterAccessConfig
	2, // 5: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterSpec.auto_mode:type_name -> dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterAutoMode
	3, // 6: dev.planton.provider.aws.awsekscluster.v1.AwsEksClusterAutoMode.node_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsekscluster_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsekscluster_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsekscluster_v1_spec_proto_depIdxs = nil
}
