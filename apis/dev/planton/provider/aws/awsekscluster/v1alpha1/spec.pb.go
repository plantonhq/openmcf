...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsekscluster/v1alpha1/spec.proto
...
func (x *AwsEksClusterSpec) Reset() {
	*x = AwsEksClusterSpec{}
	mi := &file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsEksClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEksClusterAccessConfig) Reset() {
	*x = AwsEksClusterAccessConfig{}
	mi := &file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEksClusterAccessConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEksClusterAutoMode) Reset() {
	*x = AwsEksClusterAutoMode{}
	mi := &file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEksClusterAutoMode) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":dev/planton/provider/aws/awsekscluster/v1alpha1/spec.proto\x12/dev.planton.provider.aws.awsekscluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x8d\x18\n" +
	...
	"\vkms_key_arn\x18\r \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB9\xb2\xa6\x1d\x16secrets encrypted with\x88\xd4a\xfb\a\x92\xd4a\x16status.outputs.key_arnR\tkmsKeyArn\x12o\n" +
	"\raccess_config\x18\x0e \x01(\v2J.dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterAccessConfigR\faccessConfig\x12c\n" +
	"\tauto_mode\x18\x0f \x01(\v2F.dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterAutoModeR\bautoMode\x120\n" +
	...
	"\x18node_role_requires_pools\x126node_role_arn is required when node_pools is non-empty\x1a5size(this.node_pools) == 0 || has(this.node_role_arn)B\x8c\x03\n" +
	"3com.dev.planton.provider.aws.awsekscluster.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsekscluster/v1alpha1;awseksclusterv1alpha1\xa2\x02\x05DPPAA\xaa\x02/Dev.Planton.Provider.Aws.Awsekscluster.V1alpha1\xca\x02/Dev\\Planton\\Provider\\Aws\\Awsekscluster\\V1alpha1\xe2\x02;Dev\\Planton\\Provider\\Aws\\Awsekscluster\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Provider::Aws::Awsekscluster::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_goTypes = []any{
	(*AwsEksClusterSpec)(nil),         // 0: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterSpec
	(*AwsEksClusterAccessConfig)(nil), // 1: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterAccessConfig
	(*AwsEksClusterAutoMode)(nil),     // 2: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterAutoMode
	(*v1.StringValueOrRef)(nil),       // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterSpec.cluster_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 3: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 4: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterSpec.access_config:type_name -> dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterAccessConfig
	2, // 5: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterSpec.auto_mode:type_name -> dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterAutoMode
	3, // 6: dev.planton.provider.aws.awsekscluster.v1alpha1.AwsEksClusterAutoMode.node_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsekscluster_v1alpha1_spec_proto_depIdxs = nil
}
