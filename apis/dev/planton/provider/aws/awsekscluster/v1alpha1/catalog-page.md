...
- [AwsEksNodeGroup](/docs/catalog/aws/awseksnodegroup) — managed worker fleets registered to this cluster
- [AwsIamRole](/docs/catalog/aws/awsiamrole) — the cluster role (and Auto Mode node role) this cluster assumes
- [AwsIamOidcProvider](/docs/catalog/aws/awsiamoidcprovider) — IRSA trust anchor fed by `oidc_issuer_url`
- [AwsSubnet](/docs/catalog/aws/awssubnet) — where the control plane attaches its network interfaces
- [AwsKmsKey](/docs/catalog/aws/awskmskey) — customer-managed secrets encryption
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — additional control-plane security groups
