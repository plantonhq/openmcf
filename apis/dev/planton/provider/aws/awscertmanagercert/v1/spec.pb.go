...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awscertmanagercert/v1/spec.proto
...
func (x *AwsCertManagerCertSpec) Reset() {
	*x = AwsCertManagerCertSpec{}
	mi := &file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes[0]
...
func (*AwsCertManagerCertSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsCertManagerCertValidationOption) Reset() {
	*x = AwsCertManagerCertValidationOption{}
	mi := &file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCertManagerCertValidationOption) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCertManagerCertOptions) Reset() {
	*x = AwsCertManagerCertOptions{}
	mi := &file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCertManagerCertOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsCertManagerCertImported) Reset() {
	*x = AwsCertManagerCertImported{}
	mi := &file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCertManagerCertImported) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc = "" +
	...
	"\bimported\x18\n" +
	" \x01(\v2J.dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertImportedR\bimported\x12\x8f\x01\n" +
	...
	"privateKey\x12+\n" +
	"\x11certificate_chain\x18\x03 \x01(\tR\x10certificateChainB\x85\x03\n" +
	"2com.dev.planton.provider.aws.awscertmanagercert.v1B\tSpecProtoP\x01Zegithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awscertmanagercert/v1;awscertmanagercertv1\xa2\x02\x05DPPAA\xaa\x02.Dev.Planton.Provider.Aws.Awscertmanagercert.V1\xca\x02.Dev\\Planton\\Provider\\Aws\\Awscertmanagercert\\V1\xe2\x02:Dev\\Planton\\Provider\\Aws\\Awscertmanagercert\\V1\\GPBMetadata\xea\x023Dev::Planton::Provider::Aws::Awscertmanagercert::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_goTypes = []any{
	(*AwsCertManagerCertSpec)(nil),             // 0: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertSpec
	(*AwsCertManagerCertValidationOption)(nil), // 1: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertValidationOption
	(*AwsCertManagerCertOptions)(nil),          // 2: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertOptions
	(*AwsCertManagerCertImported)(nil),         // 3: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertImported
	(*v1.StringValueOrRef)(nil),                // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertSpec.validation_options:type_name -> dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertValidationOption
	4, // 1: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertSpec.route53_hosted_zone_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertSpec.options:type_name -> dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertOptions
	3, // 3: dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertSpec.imported:type_name -> dev.planton.provider.aws.awscertmanagercert.v1.AwsCertManagerCertImported
...
func init() { file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awscertmanagercert_v1_spec_proto_depIdxs = nil
}
