...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awss3objectset/v1alpha1/spec.proto
...
func (x *AwsS3ObjectSetSpec) Reset() {
	*x = AwsS3ObjectSetSpec{}
	mi := &file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsS3ObjectSetSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsS3Object) Reset() {
	*x = AwsS3Object{}
	mi := &file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsS3Object) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";dev/planton/provider/aws/awss3objectset/v1alpha1/spec.proto\x120dev.planton.provider.aws.awss3objectset.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xaa\x03\n" +
	"\x12AwsS3ObjectSetSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12s\n" +
	"\x06bucket\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB'\xbaH\x03\xc8\x01\x01\x88\xd4a\xf5\a\x92\xd4a\x18status.outputs.bucket_idR\x06bucket\x12a\n" +
	"\aobjects\x18\x03 \x03(\v2=.dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectB\b\xbaH\x05\x92\x01\x02\b\x01R\aobjects\x12b\n" +
	"\x04tags\x18\x04 \x03(\v2N.dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectSetSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x8c\x1c\n" +
	...
	"\bmetadata\x18\t \x03(\v2K.dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.MetadataEntryB\x15\xbaH\x12\x9a\x01\x0f\"\rr\v2\t^[^A-Z]*$R\bmetadata\x12)\n" +
	...
	"\rforce_destroy\x18\x14 \x01(\bR\fforceDestroy\x12[\n" +
	"\x04tags\x18\x15 \x03(\v2G.dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.TagsEntryR\x04tags\x1a;\n" +
	...
	"\x06sourceB\x0f\n" +
	"\r_content_typeB\x15\n" +
	"\x13_bucket_key_enabledB\x93\x03\n" +
	"4com.dev.planton.provider.aws.awss3objectset.v1alpha1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awss3objectset/v1alpha1;awss3objectsetv1alpha1\xa2\x02\x05DPPAA\xaa\x020Dev.Planton.Provider.Aws.Awss3objectset.V1alpha1\xca\x020Dev\\Planton\\Provider\\Aws\\Awss3objectset\\V1alpha1\xe2\x02<Dev\\Planton\\Provider\\Aws\\Awss3objectset\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Provider::Aws::Awss3objectset::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_goTypes = []any{
	(*AwsS3ObjectSetSpec)(nil),  // 0: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectSetSpec
	(*AwsS3Object)(nil),         // 1: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object
	nil,                         // 2: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectSetSpec.TagsEntry
	nil,                         // 3: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.MetadataEntry
	nil,                         // 4: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.TagsEntry
	(*v1.StringValueOrRef)(nil), // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectSetSpec.bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectSetSpec.objects:type_name -> dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object
	2, // 2: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectSetSpec.tags:type_name -> dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3ObjectSetSpec.TagsEntry
	3, // 3: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.metadata:type_name -> dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.MetadataEntry
	5, // 4: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.kms_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 5: dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.tags:type_name -> dev.planton.provider.aws.awss3objectset.v1alpha1.AwsS3Object.TagsEntry
...
func init() { file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awss3objectset_v1alpha1_spec_proto_depIdxs = nil
}
