...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awss3objectset/v1/stack_outputs.proto
...
func (x *AwsS3ObjectSetStackOutputs) Reset() {
	*x = AwsS3ObjectSetStackOutputs{}
	mi := &file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_msgTypes[0]
...
var File_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDesc = "" +
	...
	".com.dev.planton.provider.aws.awss3objectset.v1B\x11StackOutputsProtoP\x01Z]github.com/plantonhq/planton/apis/dev/planton/provider/aws/awss3objectset/v1;awss3objectsetv1\xa2\x02\x05DPPAA\xaa\x02*Dev.Planton.Provider.Aws.Awss3objectset.V1\xca\x02*Dev\\Planton\\Provider\\Aws\\Awss3objectset\\V1\xe2\x026Dev\\Planton\\Provider\\Aws\\Awss3objectset\\V1\\GPBMetadata\xea\x02/Dev::Planton::Provider::Aws::Awss3objectset::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_rawDesc)))
	})
...
func file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_init() {
	if File_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto = out.File
	file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_aws_awss3objectset_v1_stack_outputs_proto_depIdxs = nil
}
