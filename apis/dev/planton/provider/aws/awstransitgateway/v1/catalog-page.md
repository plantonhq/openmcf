...
- [AwsVpc](/docs/catalog/aws/awsvpc) — provides the VPCs and subnets attached to the Transit Gateway
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls traffic in attached VPCs; cross-VPC referencing available when `securityGroupReferencingSupport` is enabled
- [AwsClientVpn](/docs/catalog/aws/awsclientvpn) — VPN connectivity into the Transit Gateway network
