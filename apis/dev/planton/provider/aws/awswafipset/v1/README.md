...
| Need | Use Instead |
|------|-------------|
| **One-off regex on a URI path** | An inline `regex_match` statement on the web ACL, or an [AwsWafRegexPatternSet](../awswafregexpatternset/v1/README.md) when the same patterns back multiple rules. |
