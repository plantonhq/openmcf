...
- [AwsEksCluster](/docs/catalog/aws/awsekscluster) — the control plane the profile attaches to
- [AwsIamRole](/docs/catalog/aws/awsiamrole) — the pod execution role (carries its own policy)
- [AwsSubnet](/docs/catalog/aws/awssubnet) — the private subnets pods launch into
- [AwsNatGateway](/docs/catalog/aws/awsnatgateway) — outbound internet for Fargate pods
- [AwsEksNodeGroup](/docs/catalog/aws/awseksnodegroup) — EC2-backed compute for everything else
