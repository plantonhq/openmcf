...
type Locals struct {
	AwsEksFargateProfile *awseksfargateprofilev1.AwsEksFargateProfile
...
func initializeLocals(_ *pulumi.Context, stackInput *awseksfargateprofilev1.AwsEksFargateProfileStackInput) *Locals {
	locals := &Locals{}
