...
- [AwsVpc](/docs/catalog/aws/awsvpc) — provides VPC subnets for cluster placement
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls network access to MemoryDB endpoints
...
- [AwsRedisElasticache](/docs/catalog/aws/awsrediselasticache) — ephemeral caching alternative when durability is not needed
