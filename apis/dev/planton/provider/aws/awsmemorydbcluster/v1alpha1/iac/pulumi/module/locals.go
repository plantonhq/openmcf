...
import (
	...
	awsmemorydbclusterv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsmemorydbcluster/v1alpha1"
...
type Locals struct {
	Target *awsmemorydbclusterv1alpha1.AwsMemorydbCluster
	Spec   *awsmemorydbclusterv1alpha1.AwsMemorydbClusterSpec
...
func initializeLocals(_ *pulumi.Context, in *awsmemorydbclusterv1alpha1.AwsMemorydbClusterStackInput) *Locals {
	locals := &Locals{}
