...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsfsxwindowsfilesystem/v1alpha1/spec.proto
...
func (x *AwsFsxWindowsFileSystemSpec) Reset() {
	*x = AwsFsxWindowsFileSystemSpec{}
	mi := &file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsFsxWindowsFileSystemSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxWindowsFileSystemSelfManagedActiveDirectory) Reset() {
	*x = AwsFsxWindowsFileSystemSelfManagedActiveDirectory{}
	mi := &file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxWindowsFileSystemSelfManagedActiveDirectory) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsFsxWindowsFileSystemAuditLogConfiguration) Reset() {
	*x = AwsFsxWindowsFileSystemAuditLogConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxWindowsFileSystemAuditLogConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsFsxWindowsFileSystemDiskIopsConfiguration) Reset() {
	*x = AwsFsxWindowsFileSystemDiskIopsConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxWindowsFileSystemDiskIopsConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/aws/awsfsxwindowsfilesystem/v1alpha1/spec.proto\x129dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x91)\n" +
	...
	" \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefR\x11activeDirectoryId\x12\xaf\x01\n" +
	"\x1dself_managed_active_directory\x18\v \x01(\v2l.dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSelfManagedActiveDirectoryR\x1aselfManagedActiveDirectory\x12+\n" +
	"\aaliases\x18\f \x03(\tB\x11\xbaH\x0e\x92\x01\v\x102\"\ar\x05\x10\x04\x18\xfd\x01R\aaliases\x12\x9f\x01\n" +
	"\x17audit_log_configuration\x18\r \x01(\v2g.dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemAuditLogConfigurationR\x15auditLogConfiguration\x12\x9f\x01\n" +
	"\x17disk_iops_configuration\x18\x0e \x01(\v2g.dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemDiskIopsConfigurationR\x15diskIopsConfiguration\x12Q\n" +
	...
	"\x11skip_final_backup\x18\x12 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x04R\x0fskipFinalBackup\x88\x01\x01\x12\x97\x01\n" +
	"\x11final_backup_tags\x18\x15 \x03(\v2k.dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.FinalBackupTagsEntryR\x0ffinalBackupTags\x12\xa4\x02\n" +
	...
	"\x05_modeB\a\n" +
	"\x05_iopsB\xd2\x03\n" +
	"=com.dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1B\tSpecProtoP\x01Z{github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsfsxwindowsfilesystem/v1alpha1;awsfsxwindowsfilesystemv1alpha1\xa2\x02\x05DPPAA\xaa\x029Dev.Planton.Provider.Aws.Awsfsxwindowsfilesystem.V1alpha1\xca\x029Dev\\Planton\\Provider\\Aws\\Awsfsxwindowsfilesystem\\V1alpha1\xe2\x02EDev\\Planton\\Provider\\Aws\\Awsfsxwindowsfilesystem\\V1alpha1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Aws::Awsfsxwindowsfilesystem::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_goTypes = []any{
	(*AwsFsxWindowsFileSystemSpec)(nil),                       // 0: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec
	(*AwsFsxWindowsFileSystemSelfManagedActiveDirectory)(nil), // 1: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSelfManagedActiveDirectory
	(*AwsFsxWindowsFileSystemAuditLogConfiguration)(nil),      // 2: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemAuditLogConfiguration
	(*AwsFsxWindowsFileSystemDiskIopsConfiguration)(nil),      // 3: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemDiskIopsConfiguration
	nil,                         // 4: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.FinalBackupTagsEntry
	(*v1.StringValueOrRef)(nil), // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_depIdxs = []int32{
	5,  // 0: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 1: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.preferred_subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 2: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 3: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 4: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.active_directory_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 5: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.self_managed_active_directory:type_name -> dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSelfManagedActiveDirectory
	2,  // 6: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.audit_log_configuration:type_name -> dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemAuditLogConfiguration
	3,  // 7: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.disk_iops_configuration:type_name -> dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemDiskIopsConfiguration
	4,  // 8: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.final_backup_tags:type_name -> dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSpec.FinalBackupTagsEntry
	5,  // 9: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemSelfManagedActiveDirectory.domain_join_service_account_secret_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 10: dev.planton.provider.aws.awsfsxwindowsfilesystem.v1alpha1.AwsFsxWindowsFileSystemAuditLogConfiguration.audit_log_destination:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsfsxwindowsfilesystem_v1alpha1_spec_proto_depIdxs = nil
}
