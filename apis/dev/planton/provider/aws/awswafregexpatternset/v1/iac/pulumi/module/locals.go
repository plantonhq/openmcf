...
type Locals struct {
	AwsWafRegexPatternSet *awswafregexpatternsetv1.AwsWafRegexPatternSet
	AwsTags               map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *awswafregexpatternsetv1.AwsWafRegexPatternSetStackInput) *Locals {
	locals := &Locals{}
