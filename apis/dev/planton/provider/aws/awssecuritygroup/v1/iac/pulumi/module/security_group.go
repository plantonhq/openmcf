...
func ruleToIngress(r *awssecuritygroupv1.SecurityGroupRule) *ec2.SecurityGroupIngressArgs {
...
func ruleToEgress(r *awssecuritygroupv1.SecurityGroupRule) *ec2.SecurityGroupEgressArgs {
