...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awss3bucket/v1/spec.proto
...
func (x *AwsS3BucketSpec) Reset() {
	*x = AwsS3BucketSpec{}
	mi := &file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_msgTypes[0]
...
func (*AwsS3BucketSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awss3bucket_v1_spec_proto protoreflect.FileDescriptor
...
var (
	file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awss3bucket_v1_spec_proto != nil {
		return
	}
	type x struct{}
	...
	file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awss3bucket_v1_spec_proto_depIdxs = nil
}
