...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsmemcachedelasticache/v1alpha1/spec.proto
...
func (x *AwsMemcachedElasticacheSpec) Reset() {
	*x = AwsMemcachedElasticacheSpec{}
	mi := &file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsMemcachedElasticacheSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsMemcachedElasticacheParameter) Reset() {
	*x = AwsMemcachedElasticacheParameter{}
	mi := &file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMemcachedElasticacheParameter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/aws/awsmemcachedelasticache/v1alpha1/spec.proto\x129dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xb1\x16\n" +
	...
	"\x16parameter_group_family\x18\r \x01(\tR\x14parameterGroupFamily\x12{\n" +
	"\n" +
	"parameters\x18\x0e \x03(\v2[.dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheParameterR\n" +
	"parameters\x120\n" +
	...
	"\x05value\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05valueB\xd2\x03\n" +
	"=com.dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1B\tSpecProtoP\x01Z{github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsmemcachedelasticache/v1alpha1;awsmemcachedelasticachev1alpha1\xa2\x02\x05DPPAA\xaa\x029Dev.Planton.Provider.Aws.Awsmemcachedelasticache.V1alpha1\xca\x029Dev\\Planton\\Provider\\Aws\\Awsmemcachedelasticache\\V1alpha1\xe2\x02EDev\\Planton\\Provider\\Aws\\Awsmemcachedelasticache\\V1alpha1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Aws::Awsmemcachedelasticache::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_goTypes = []any{
	(*AwsMemcachedElasticacheSpec)(nil),      // 0: dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheSpec
	(*AwsMemcachedElasticacheParameter)(nil), // 1: dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheParameter
	(*v1.StringValueOrRef)(nil),              // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheSpec.parameters:type_name -> dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheParameter
	2, // 3: dev.planton.provider.aws.awsmemcachedelasticache.v1alpha1.AwsMemcachedElasticacheSpec.notification_topic_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsmemcachedelasticache_v1alpha1_spec_proto_depIdxs = nil
}
