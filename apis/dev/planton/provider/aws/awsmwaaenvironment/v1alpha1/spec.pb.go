...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsmwaaenvironment/v1alpha1/spec.proto
...
func (x *AwsMwaaEnvironmentSpec) Reset() {
	*x = AwsMwaaEnvironmentSpec{}
	mi := &file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsMwaaEnvironmentSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsMwaaEnvironmentLoggingConfiguration) Reset() {
	*x = AwsMwaaEnvironmentLoggingConfiguration{}
	mi := &file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMwaaEnvironmentLoggingConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsMwaaEnvironmentLoggingModuleConfig) Reset() {
	*x = AwsMwaaEnvironmentLoggingModuleConfig{}
	mi := &file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMwaaEnvironmentLoggingModuleConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"?dev/planton/provider/aws/awsmwaaenvironment/v1alpha1/spec.proto\x124dev.planton.provider.aws.awsmwaaenvironment.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x93\x16\n" +
	"\x16AwsMwaaEnvironmentSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12'\n" +
	"\x0fairflow_version\x18\x02 \x01(\tR\x0eairflowVersion\x12\xb1\x01\n" +
	"\x1dairflow_configuration_options\x18\x03 \x03(\v2m.dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntryR\x1bairflowConfigurationOptions\x12\x88\x01\n" +
	...
	"\x13endpoint_management\x18\x17 \x01(\tB\x1b\xbaH\x18\xd8\x01\x01r\x13R\aSERVICER\bCUSTOMERR\x12endpointManagement\x12\x91\x01\n" +
	"\x15logging_configuration\x18\x18 \x01(\v2\\.dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfigurationR\x14loggingConfiguration\x12E\n" +
	...
	"\x16_webserver_access_mode\"\xb8\x05\n" +
	"&AwsMwaaEnvironmentLoggingConfiguration\x12\x8b\x01\n" +
	"\x13dag_processing_logs\x18\x01 \x01(\v2[.dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\x11dagProcessingLogs\x12\x82\x01\n" +
	"\x0escheduler_logs\x18\x02 \x01(\v2[.dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\rschedulerLogs\x12x\n" +
	"\ttask_logs\x18\x03 \x01(\v2[.dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\btaskLogs\x12\x82\x01\n" +
	"\x0ewebserver_logs\x18\x04 \x01(\v2[.dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\rwebserverLogs\x12|\n" +
	"\vworker_logs\x18\x05 \x01(\v2[.dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\n" +
	"workerLogs\"\x8f\x01\n" +
	"%AwsMwaaEnvironmentLoggingModuleConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12L\n" +
	"\tlog_level\x18\x02 \x01(\tB/\xbaH,\xd8\x01\x01r'R\bCRITICALR\x05ERRORR\aWARNINGR\x04INFOR\x05DEBUGR\blogLevelB\xaf\x03\n" +
...
var (
	file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_goTypes = []any{
	(*AwsMwaaEnvironmentSpec)(nil),                 // 0: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec
	(*AwsMwaaEnvironmentLoggingConfiguration)(nil), // 1: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration
	(*AwsMwaaEnvironmentLoggingModuleConfig)(nil),  // 2: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	nil,                         // 3: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntry
	(*v1.StringValueOrRef)(nil), // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_depIdxs = []int32{
	3,  // 0: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.airflow_configuration_options:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntry
	4,  // 1: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.source_bucket_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 2: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.execution_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 3: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 4: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 5: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 6: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.logging_configuration:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration
	2,  // 7: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.dag_processing_logs:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 8: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.scheduler_logs:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 9: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.task_logs:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 10: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.webserver_logs:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 11: dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.worker_logs:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
...
func init() { file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsmwaaenvironment_v1alpha1_spec_proto_depIdxs = nil
}
