...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsmwaaenvironment/v1/spec.proto
...
func (x *AwsMwaaEnvironmentSpec) Reset() {
	*x = AwsMwaaEnvironmentSpec{}
	mi := &file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_msgTypes[0]
...
func (*AwsMwaaEnvironmentSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsMwaaEnvironmentLoggingConfiguration) Reset() {
	*x = AwsMwaaEnvironmentLoggingConfiguration{}
	mi := &file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMwaaEnvironmentLoggingConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsMwaaEnvironmentLoggingModuleConfig) Reset() {
	*x = AwsMwaaEnvironmentLoggingModuleConfig{}
	mi := &file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMwaaEnvironmentLoggingModuleConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDesc = "" +
	...
	"\x0escheduler_logs\x18\x02 \x01(\v2U.dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentLoggingModuleConfigR\rschedulerLogs\x12r\n" +
	"\ttask_logs\x18\x03 \x01(\v2U.dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentLoggingModuleConfigR\btaskLogs\x12|\n" +
	"\x0ewebserver_logs\x18\x04 \x01(\v2U.dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentLoggingModuleConfigR\rwebserverLogs\x12v\n" +
	"\vworker_logs\x18\x05 \x01(\v2U.dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentLoggingModuleConfigR\n" +
	"workerLogs\"\x8f\x01\n" +
...
var (
	file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_goTypes = []any{
	(*AwsMwaaEnvironmentSpec)(nil),                 // 0: dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentSpec
	(*AwsMwaaEnvironmentLoggingConfiguration)(nil), // 1: dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentLoggingConfiguration
	(*AwsMwaaEnvironmentLoggingModuleConfig)(nil),  // 2: dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentLoggingModuleConfig
	nil,                         // 3: dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntry
	(*v1.StringValueOrRef)(nil), // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_depIdxs = []int32{
	3,  // 0: dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentSpec.airflow_configuration_options:type_name -> dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntry
	4,  // 1: dev.planton.provider.aws.awsmwaaenvironment.v1.AwsMwaaEnvironmentSpec.source_bucket_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsmwaaenvironment_v1_spec_proto_depIdxs = nil
}
