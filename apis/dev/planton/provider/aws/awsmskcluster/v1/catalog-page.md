...
- [AwsSubnet](/docs/catalog/aws/awssubnet) — provides subnets for broker placement
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — attached to the broker network interfaces; carries the Kafka/ZooKeeper ingress rules
