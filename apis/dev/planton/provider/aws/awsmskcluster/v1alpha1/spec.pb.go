...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsmskcluster/v1alpha1/spec.proto
...
func (x *AwsMskClusterSpec) Reset() {
	*x = AwsMskClusterSpec{}
	mi := &file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsMskClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsMskClusterAuthentication) Reset() {
	*x = AwsMskClusterAuthentication{}
	mi := &file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMskClusterAuthentication) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsMskClusterVpcConnectivity) Reset() {
	*x = AwsMskClusterVpcConnectivity{}
	mi := &file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMskClusterVpcConnectivity) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsMskClusterLogging) Reset() {
	*x = AwsMskClusterLogging{}
	mi := &file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMskClusterLogging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsMskClusterCloudwatchLogging) Reset() {
	*x = AwsMskClusterCloudwatchLogging{}
	mi := &file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMskClusterCloudwatchLogging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsMskClusterFirehoseLogging) Reset() {
	*x = AwsMskClusterFirehoseLogging{}
	mi := &file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMskClusterFirehoseLogging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsMskClusterS3Logging) Reset() {
	*x = AwsMskClusterS3Logging{}
	mi := &file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMskClusterS3Logging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":dev/planton/provider/aws/awsmskcluster/v1alpha1/spec.proto\x12/dev.planton.provider.aws.awsmskcluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x82%\n" +
	...
	"\x12public_access_type\x18\a \x01(\tB)\xbaH&\xd8\x01\x01r!R\bDISABLEDR\x15SERVICE_PROVIDED_EIPSR\x10publicAccessType\x12x\n" +
	"\x10vpc_connectivity\x18\b \x01(\v2M.dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterVpcConnectivityR\x0fvpcConnectivity\x127\n" +
	...
	"\x15in_cluster_encryption\x18\x10 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x02R\x13inClusterEncryption\x88\x01\x01\x12t\n" +
	"\x0eauthentication\x18\x11 \x01(\v2L.dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterAuthenticationR\x0eauthentication\x12\xed\x01\n" +
	...
	"\xbaH\a\xd8\x01\x01\x1a\x02(\x01R\x15configurationRevision\x12\x85\x01\n" +
	"\x11server_properties\x18\x16 \x03(\v2X.dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.ServerPropertiesEntryR\x10serverProperties\x12_\n" +
	"\alogging\x18\x17 \x01(\v2E.dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterLoggingR\alogging\x12}\n" +
	...
	"\vtls_enabled\x18\x03 \x01(\bR\n" +
	"tlsEnabled\"\xd4\x02\n" +
	"\x14AwsMskClusterLogging\x12x\n" +
	"\x0fcloudwatch_logs\x18\x01 \x01(\v2O.dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterCloudwatchLoggingR\x0ecloudwatchLogs\x12i\n" +
	"\bfirehose\x18\x02 \x01(\v2M.dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterFirehoseLoggingR\bfirehose\x12W\n" +
	"\x02s3\x18\x03 \x01(\v2G.dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterS3LoggingR\x02s3\"\xc3\x02\n" +
	...
	"\x1cbucket_required_when_enabled\x12-bucket is required when S3 logging is enabled\x1a&this.enabled ? has(this.bucket) : trueB\x8c\x03\n" +
	"3com.dev.planton.provider.aws.awsmskcluster.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsmskcluster/v1alpha1;awsmskclusterv1alpha1\xa2\x02\x05DPPAA\xaa\x02/Dev.Planton.Provider.Aws.Awsmskcluster.V1alpha1\xca\x02/Dev\\Planton\\Provider\\Aws\\Awsmskcluster\\V1alpha1\xe2\x02;Dev\\Planton\\Provider\\Aws\\Awsmskcluster\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Provider::Aws::Awsmskcluster::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_goTypes = []any{
	(*AwsMskClusterSpec)(nil),              // 0: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec
	(*AwsMskClusterAuthentication)(nil),    // 1: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterAuthentication
	(*AwsMskClusterVpcConnectivity)(nil),   // 2: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterVpcConnectivity
	(*AwsMskClusterLogging)(nil),           // 3: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterLogging
	(*AwsMskClusterCloudwatchLogging)(nil), // 4: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterCloudwatchLogging
	(*AwsMskClusterFirehoseLogging)(nil),   // 5: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterFirehoseLogging
	(*AwsMskClusterS3Logging)(nil),         // 6: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterS3Logging
	nil,                                    // 7: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.ServerPropertiesEntry
	(*v1.StringValueOrRef)(nil),            // 8: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_depIdxs = []int32{
	8,  // 0: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 1: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 2: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.vpc_connectivity:type_name -> dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterVpcConnectivity
	8,  // 3: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 4: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.authentication:type_name -> dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterAuthentication
	7,  // 5: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.server_properties:type_name -> dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.ServerPropertiesEntry
	3,  // 6: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterSpec.logging:type_name -> dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterLogging
	8,  // 7: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterAuthentication.tls_certificate_authority_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 8: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterLogging.cloudwatch_logs:type_name -> dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterCloudwatchLogging
	5,  // 9: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterLogging.firehose:type_name -> dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterFirehoseLogging
	6,  // 10: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterLogging.s3:type_name -> dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterS3Logging
	8,  // 11: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterCloudwatchLogging.log_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 12: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterFirehoseLogging.delivery_stream:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 13: dev.planton.provider.aws.awsmskcluster.v1alpha1.AwsMskClusterS3Logging.bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsmskcluster_v1alpha1_spec_proto_depIdxs = nil
}
