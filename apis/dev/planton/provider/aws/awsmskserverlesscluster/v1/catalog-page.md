...
- [AwsMskCluster](/docs/catalog/aws/awsmskcluster) — the provisioned sibling: choose it for SCRAM/mTLS auth, public access, PrivateLink, tiered storage, or sustained high throughput
