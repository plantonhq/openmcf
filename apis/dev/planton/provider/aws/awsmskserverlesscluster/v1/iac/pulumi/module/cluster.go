...
// Kafka version, so the whole declaration is WHERE it lives (subnets +
// security groups). Everything except tags is create-time (ForceNew) --
// changing networking or auth replaces the cluster. This mirrors the
// Terraform module field-for-field.
