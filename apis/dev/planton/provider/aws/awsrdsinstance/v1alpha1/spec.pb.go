...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsrdsinstance/v1alpha1/spec.proto
...
func (x *AwsRdsInstanceSpec) Reset() {
	*x = AwsRdsInstanceSpec{}
	mi := &file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRdsInstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRdsInstanceActiveDirectory) Reset() {
	*x = AwsRdsInstanceActiveDirectory{}
	mi := &file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsInstanceActiveDirectory) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRdsInstanceRestoreToPointInTime) Reset() {
	*x = AwsRdsInstanceRestoreToPointInTime{}
	mi := &file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsInstanceRestoreToPointInTime) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";dev/planton/provider/aws/awsrdsinstance/v1alpha1/spec.proto\x120dev.planton.provider.aws.awsrdsinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x89D\n" +
	...
	"\x13snapshot_identifier\x18\x1c \x01(\tR\x12snapshotIdentifier\x12\x8c\x01\n" +
	"\x18restore_to_point_in_time\x18\x1d \x01(\v2T.dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceRestoreToPointInTimeR\x14restoreToPointInTime\x12A\n" +
	...
	"\x11option_group_name\x18/ \x01(\tR\x0foptionGroupName\x12z\n" +
	"\x10active_directory\x180 \x01(\v2O.dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceActiveDirectoryR\x0factiveDirectory\x12#\n" +
	...
	"\x10exactly_one_time\x12Eexactly one of restore_time or use_latest_restorable_time must be set\x1a<(this.restore_time != '') != this.use_latest_restorable_timeB\x93\x03\n" +
	"4com.dev.planton.provider.aws.awsrdsinstance.v1alpha1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsrdsinstance/v1alpha1;awsrdsinstancev1alpha1\xa2\x02\x05DPPAA\xaa\x020Dev.Planton.Provider.Aws.Awsrdsinstance.V1alpha1\xca\x020Dev\\Planton\\Provider\\Aws\\Awsrdsinstance\\V1alpha1\xe2\x02<Dev\\Planton\\Provider\\Aws\\Awsrdsinstance\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Provider::Aws::Awsrdsinstance::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_goTypes = []any{
	(*AwsRdsInstanceSpec)(nil),                 // 0: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec
	(*AwsRdsInstanceActiveDirectory)(nil),      // 1: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceActiveDirectory
	(*AwsRdsInstanceRestoreToPointInTime)(nil), // 2: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceRestoreToPointInTime
	(*v1.StringValueOrRef)(nil),                // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.db_subnet_group_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 3: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 4: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.master_user_secret_kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 5: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.restore_to_point_in_time:type_name -> dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceRestoreToPointInTime
	3, // 6: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.performance_insights_kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 7: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.monitoring_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 8: dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceSpec.active_directory:type_name -> dev.planton.provider.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceActiveDirectory
...
func init() { file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsrdsinstance_v1alpha1_spec_proto_depIdxs = nil
}
