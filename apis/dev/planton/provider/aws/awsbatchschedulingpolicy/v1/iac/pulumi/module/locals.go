...
type Locals struct {
	AwsBatchSchedulingPolicy *awsbatchschedulingpolicyv1.AwsBatchSchedulingPolicy
	AwsTags                  map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *awsbatchschedulingpolicyv1.AwsBatchSchedulingPolicyStackInput) *Locals {
	locals := &Locals{}
