...
The policy is a standalone, shareable object: many [job queues](../awsbatchjobqueue/v1/README.md) can reference the same policy, so an organization's fairness rules are defined once. Every dial updates in place on a live policy.
