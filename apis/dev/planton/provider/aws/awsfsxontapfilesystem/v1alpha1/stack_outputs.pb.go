...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsfsxontapfilesystem/v1alpha1/stack_outputs.proto
...
func (x *AwsFsxOntapFileSystemStackOutputs) Reset() {
	*x = AwsFsxOntapFileSystemStackOutputs{}
	mi := &file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*AwsFsxOntapFileSystemStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Kdev/planton/provider/aws/awsfsxontapfilesystem/v1alpha1/stack_outputs.proto\x127dev.planton.provider.aws.awsfsxontapfilesystem.v1alpha1\"\xaf\x03\n" +
	...
	"\bowner_id\x18\t \x01(\tR\aownerIdB\xcc\x03\n" +
	";com.dev.planton.provider.aws.awsfsxontapfilesystem.v1alpha1B\x11StackOutputsProtoP\x01Zwgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsfsxontapfilesystem/v1alpha1;awsfsxontapfilesystemv1alpha1\xa2\x02\x05DPPAA\xaa\x027Dev.Planton.Provider.Aws.Awsfsxontapfilesystem.V1alpha1\xca\x027Dev\\Planton\\Provider\\Aws\\Awsfsxontapfilesystem\\V1alpha1\xe2\x02CDev\\Planton\\Provider\\Aws\\Awsfsxontapfilesystem\\V1alpha1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Aws::Awsfsxontapfilesystem::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*AwsFsxOntapFileSystemStackOutputs)(nil), // 0: dev.planton.provider.aws.awsfsxontapfilesystem.v1alpha1.AwsFsxOntapFileSystemStackOutputs
}
var file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_init() }
func file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_init() {
	if File_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto = out.File
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_depIdxs = nil
}
