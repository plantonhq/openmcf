...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsfsxontapfilesystem/v1/spec.proto
...
func (x *AwsFsxOntapFileSystemSpec) Reset() {
	*x = AwsFsxOntapFileSystemSpec{}
	mi := &file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_msgTypes[0]
...
func (*AwsFsxOntapFileSystemSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxOntapFileSystemDiskIopsConfiguration) Reset() {
	*x = AwsFsxOntapFileSystemDiskIopsConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapFileSystemDiskIopsConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDesc = "" +
	...
	"\x05_modeB\x9a\x03\n" +
	"5com.dev.planton.provider.aws.awsfsxontapfilesystem.v1B\tSpecProtoP\x01Zkgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsfsxontapfilesystem/v1;awsfsxontapfilesystemv1\xa2\x02\x05DPPAA\xaa\x021Dev.Planton.Provider.Aws.Awsfsxontapfilesystem.V1\xca\x021Dev\\Planton\\Provider\\Aws\\Awsfsxontapfilesystem\\V1\xe2\x02=Dev\\Planton\\Provider\\Aws\\Awsfsxontapfilesystem\\V1\\GPBMetadata\xea\x026Dev::Planton::Provider::Aws::Awsfsxontapfilesystem::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_goTypes = []any{
	(*AwsFsxOntapFileSystemSpec)(nil),                  // 0: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemSpec
	(*AwsFsxOntapFileSystemDiskIopsConfiguration)(nil), // 1: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemDiskIopsConfiguration
	(*v1.StringValueOrRef)(nil),                        // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemSpec.preferred_subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemSpec.route_table_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 4: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 5: dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemSpec.disk_iops_configuration:type_name -> dev.planton.provider.aws.awsfsxontapfilesystem.v1.AwsFsxOntapFileSystemDiskIopsConfiguration
...
func init() { file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_init() }
func file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsfsxontapfilesystem_v1_spec_proto_depIdxs = nil
}
