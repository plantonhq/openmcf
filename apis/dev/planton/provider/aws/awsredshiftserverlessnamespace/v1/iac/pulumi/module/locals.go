...
type Locals struct {
	AwsRedshiftServerlessNamespace *awsredshiftserverlessnamespacev1.AwsRedshiftServerlessNamespace
...
func initializeLocals(_ *pulumi.Context, stackInput *awsredshiftserverlessnamespacev1.AwsRedshiftServerlessNamespaceStackInput) *Locals {
	locals := &Locals{}
