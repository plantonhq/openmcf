...
func buildRestrictions(geo *awscloudfrontv1.AwsCloudFrontGeoRestriction) *cloudfront.DistributionRestrictionsArgs {
...
func buildViewerCertificate(vc *awscloudfrontv1.AwsCloudFrontViewerCertificate) *cloudfront.DistributionViewerCertificateArgs {
...
func resolveBehaviorParts(b *awscloudfrontv1.AwsCloudFrontCacheBehavior) behaviorParts {
	parts := behaviorParts{}
...
func buildDefaultCacheBehavior(b *awscloudfrontv1.AwsCloudFrontCacheBehavior) *cloudfront.DistributionDefaultCacheBehaviorArgs {
...
func buildOrderedCacheBehavior(ob *awscloudfrontv1.AwsCloudFrontOrderedCacheBehavior) *cloudfront.DistributionOrderedCacheBehaviorArgs {
	b := ob.Behavior
	parts := resolveBehaviorParts(b)
