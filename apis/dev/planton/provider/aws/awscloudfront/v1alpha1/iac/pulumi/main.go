...
import (
	...
	"github.com/plantonhq/planton/apis/dev/planton/provider/aws/awscloudfront/v1alpha1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &awscloudfrontv1alpha1.AwsCloudFrontStackInput{}
