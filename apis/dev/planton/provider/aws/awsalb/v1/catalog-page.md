...
- [AwsLbListener](/docs/catalog/aws/awslblistener) — attaches to this ALB by ARN; owns ports, TLS material, and default actions
- [AwsLbListenerRule](/docs/catalog/aws/awslblistenerrule) — per-service routing attached to a listener
- [AwsLbTargetGroup](/docs/catalog/aws/awslbtargetgroup) — the destination of forward actions
- [AwsSubnet](/docs/catalog/aws/awssubnet) — provides the subnets for ALB placement
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls inbound and outbound traffic to the ALB
- [AwsS3Bucket](/docs/catalog/aws/awss3bucket) — receives access, connection, and health-check logs
