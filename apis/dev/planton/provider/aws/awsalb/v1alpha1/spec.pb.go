...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsalb/v1alpha1/spec.proto
...
func (x *AwsAlbSpec) Reset() {
	*x = AwsAlbSpec{}
	mi := &file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsAlbSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsAlbLogDelivery) Reset() {
	*x = AwsAlbLogDelivery{}
	mi := &file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAlbLogDelivery) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsAlbDns) Reset() {
	*x = AwsAlbDns{}
	mi := &file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAlbDns) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"3dev/planton/provider/aws/awsalb/v1alpha1/spec.proto\x12(dev.planton.provider.aws.awsalb.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xe4\x14\n" +
	"\n" +
	"AwsAlbSpec\x12\x1f\n" +
	...
	",tls_version_and_cipher_suite_headers_enabled\x18\x11 \x01(\bR&tlsVersionAndCipherSuiteHeadersEnabled\x12\\\n" +
	"\vaccess_logs\x18\x12 \x01(\v2;.dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDeliveryR\n" +
	"accessLogs\x12d\n" +
	"\x0fconnection_logs\x18\x13 \x01(\v2;.dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDeliveryR\x0econnectionLogs\x12g\n" +
	"\x11health_check_logs\x18\x14 \x01(\v2;.dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDeliveryR\x0fhealthCheckLogs\x12E\n" +
	"\x03dns\x18\x15 \x01(\v23.dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbDnsR\x03dns:\xb7\b\xbaH\xb3\b\x1a\xdf\x01\n" +
	...
	",com.dev.planton.provider.aws.awsalb.v1alpha1B\tSpecProtoP\x01ZYgithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsalb/v1alpha1;awsalbv1alpha1\xa2\x02\x05DPPAA\xaa\x02(Dev.Planton.Provider.Aws.Awsalb.V1alpha1\xca\x02(Dev\\Planton\\Provider\\Aws\\Awsalb\\V1alpha1\xe2\x024Dev\\Planton\\Provider\\Aws\\Awsalb\\V1alpha1\\GPBMetadata\xea\x02-Dev::Planton::Provider::Aws::Awsalb::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_goTypes = []any{
	(*AwsAlbSpec)(nil),          // 0: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec
	(*AwsAlbLogDelivery)(nil),   // 1: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDelivery
	(*AwsAlbDns)(nil),           // 2: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbDns
	(*v1.StringValueOrRef)(nil), // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec.subnets:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec.security_groups:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec.web_acl_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 3: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec.access_logs:type_name -> dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDelivery
	1, // 4: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec.connection_logs:type_name -> dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDelivery
	1, // 5: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec.health_check_logs:type_name -> dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDelivery
	2, // 6: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbSpec.dns:type_name -> dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbDns
	3, // 7: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbLogDelivery.bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 8: dev.planton.provider.aws.awsalb.v1alpha1.AwsAlbDns.route53_zone_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsalb_v1alpha1_spec_proto_depIdxs = nil
}
