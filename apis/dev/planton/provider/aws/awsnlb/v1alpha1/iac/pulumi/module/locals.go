...
func initializeLocals(ctx *pulumi.Context, stackInput *awsnlbv1alpha1.AwsNlbStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsNlb.String(),
