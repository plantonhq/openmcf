...
- [AwsLbListener](/docs/catalog/aws/awslblistener) — attaches to this NLB by ARN; owns port, protocol, and TLS material (forward-only actions)
- [AwsLbTargetGroup](/docs/catalog/aws/awslbtargetgroup) — the destination of forward actions; `targetType: alb` expresses the NLB-in-front-of-ALB pattern
- [AwsElasticIp](/docs/catalog/aws/awselasticip) — provides `allocationId` values for static public IPs in subnet mappings
- [AwsSubnet](/docs/catalog/aws/awssubnet) — provides the subnets for node placement
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — optional inbound traffic filtering for the NLB
- [AwsS3Bucket](/docs/catalog/aws/awss3bucket) — receives TLS-listener access logs
- [AwsRoute53Zone](/docs/catalog/aws/awsroute53zone) — hosts the DNS zone for alias records
- [AwsAlb](/docs/catalog/aws/awsalb) — the Layer-7 alternative; combine both by registering an ALB as an NLB target
