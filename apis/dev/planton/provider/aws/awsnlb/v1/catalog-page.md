...
metadata:
  ...
  labels:
    ...
    pulumi.planton.dev/stack.name: dev.AwsNlb.my-nlb
spec:
  region: us-west-2
  subnetMappings:
...
metadata:
  ...
  labels:
    ...
    pulumi.planton.dev/organization: my-org
    pulumi.planton.dev/project: my-project
    pulumi.planton.dev/stack.name: dev.AwsNlb.internal-tcp-nlb
spec:
  region: us-west-2
  subnetMappings:
...
metadata:
  ...
  labels:
    planton.dev/provisioner: pulumi
    pulumi.planton.dev/project: my-project
    pulumi.planton.dev/stack.name: prod.AwsNlb.tls-nlb
spec:
  region: us-east-1
  subnetMappings:
...
metadata:
  ...
  labels:
    planton.dev/provisioner: pulumi
    pulumi.planton.dev/project: my-project
    pulumi.planton.dev/stack.name: prod.AwsNlb.static-ip-nlb
spec:
  region: us-west-2
  subnetMappings:
    - subnetId: subnet-public-az1
...
metadata:
  ...
  labels:
    ...
    pulumi.planton.dev/organization: my-org
    pulumi.planton.dev/project: my-project
    pulumi.planton.dev/stack.name: prod.AwsNlb.prod-nlb
spec:
  region: us-west-2
  subnetMappings:
    - subnetId:
