...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsrdscluster/v1alpha1/spec.proto
...
func (x *AwsRdsClusterSpec) Reset() {
	*x = AwsRdsClusterSpec{}
	mi := &file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRdsClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRdsClusterInstance) Reset() {
	*x = AwsRdsClusterInstance{}
	mi := &file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterInstance) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRdsClusterServerlessV2Scaling) Reset() {
	*x = AwsRdsClusterServerlessV2Scaling{}
	mi := &file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterServerlessV2Scaling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsRdsClusterServerlessV1Scaling) Reset() {
	*x = AwsRdsClusterServerlessV1Scaling{}
	mi := &file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterServerlessV1Scaling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsRdsClusterRestoreToPointInTime) Reset() {
	*x = AwsRdsClusterRestoreToPointInTime{}
	mi := &file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterRestoreToPointInTime) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsRdsClusterParameter) Reset() {
	*x = AwsRdsClusterParameter{}
	mi := &file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterParameter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
var File_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":dev/planton/provider/aws/awsrdscluster/v1alpha1/spec.proto\x12/dev.planton.provider.aws.awsrdscluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xecQ\n" +
	...
	" \x01(\tR\n" +
	"engineMode\x128\n" +
	"\x18engine_lifecycle_support\x18\v \x01(\tR\x16engineLifecycleSupport\x12d\n" +
	"\tinstances\x18\f \x03(\v2F.dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterInstanceR\tinstances\x12\x85\x01\n" +
	"\x15serverless_v2_scaling\x18\r \x01(\v2Q.dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterServerlessV2ScalingR\x13serverlessV2Scaling\x12\x85\x01\n" +
	"\x15serverless_v1_scaling\x18\x0e \x01(\v2Q.dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterServerlessV1ScalingR\x13serverlessV1Scaling\x129\n" +
	...
	"\x13snapshot_identifier\x18- \x01(\tR\x12snapshotIdentifier\x12\x8a\x01\n" +
	"\x18restore_to_point_in_time\x18. \x01(\v2R.dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterRestoreToPointInTimeR\x14restoreToPointInTime\x12B\n" +
	...
	"\x1fdb_cluster_parameter_group_name\x184 \x01(\tR\x1bdbClusterParameterGroupName\x12g\n" +
	"\n" +
	"parameters\x185 \x03(\v2G.dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterParameterR\n" +
	"parameters\x12F\n" +
	...
	"\x12apply_method_valid\x12=apply_method must be 'immediate' or 'pending-reboot' when set\x1aOthis.apply_method == '' || this.apply_method in ['immediate', 'pending-reboot']B\x8c\x03\n" +
	"3com.dev.planton.provider.aws.awsrdscluster.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsrdscluster/v1alpha1;awsrdsclusterv1alpha1\xa2\x02\x05DPPAA\xaa\x02/Dev.Planton.Provider.Aws.Awsrdscluster.V1alpha1\xca\x02/Dev\\Planton\\Provider\\Aws\\Awsrdscluster\\V1alpha1\xe2\x02;Dev\\Planton\\Provider\\Aws\\Awsrdscluster\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Provider::Aws::Awsrdscluster::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_goTypes = []any{
	(*AwsRdsClusterSpec)(nil),                 // 0: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec
	(*AwsRdsClusterInstance)(nil),             // 1: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterInstance
	(*AwsRdsClusterServerlessV2Scaling)(nil),  // 2: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterServerlessV2Scaling
	(*AwsRdsClusterServerlessV1Scaling)(nil),  // 3: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterServerlessV1Scaling
	(*AwsRdsClusterRestoreToPointInTime)(nil), // 4: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterRestoreToPointInTime
	(*AwsRdsClusterParameter)(nil),            // 5: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterParameter
	(*v1.StringValueOrRef)(nil),               // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_depIdxs = []int32{
	6,  // 0: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 1: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.db_subnet_group_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 2: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 3: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.instances:type_name -> dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterInstance
	2,  // 4: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.serverless_v2_scaling:type_name -> dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterServerlessV2Scaling
	3,  // 5: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.serverless_v1_scaling:type_name -> dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterServerlessV1Scaling
	6,  // 6: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.master_user_secret_kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 7: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 8: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.iam_roles:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 9: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.performance_insights_kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 10: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.monitoring_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 11: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.restore_to_point_in_time:type_name -> dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterRestoreToPointInTime
	5,  // 12: dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterSpec.parameters:type_name -> dev.planton.provider.aws.awsrdscluster.v1alpha1.AwsRdsClusterParameter
...
func init() { file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsrdscluster_v1alpha1_spec_proto_depIdxs = nil
}
