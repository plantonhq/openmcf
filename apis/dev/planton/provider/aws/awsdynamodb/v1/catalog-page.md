...
- [AwsKmsKey](/docs/catalog/aws/awskmskey) — customer-managed encryption keys for the table and its replicas
- [AwsKinesisStream](/docs/catalog/aws/awskinesisstream) — receives the table's item-level change data
- [AwsS3Bucket](/docs/catalog/aws/awss3bucket) — holds source data for table imports
- [AwsIamRole](/docs/catalog/aws/awsiamrole) — IAM roles with policies for table access
- [AwsLambda](/docs/catalog/aws/awslambda) — triggered by DynamoDB Streams events
