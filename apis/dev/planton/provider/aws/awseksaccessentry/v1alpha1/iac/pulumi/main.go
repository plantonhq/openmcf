...
import (
	...
	"github.com/plantonhq/planton/apis/dev/planton/provider/aws/awseksaccessentry/v1alpha1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &awseksaccessentryv1alpha1.AwsEksAccessEntryStackInput{}
