...
type Locals struct {
	AwsEksAccessEntry *awseksaccessentryv1.AwsEksAccessEntry

	AwsTags map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *awseksaccessentryv1.AwsEksAccessEntryStackInput) *Locals {
	locals := &Locals{}
