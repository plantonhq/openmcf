...
- [AwsEksCluster](/docs/catalog/aws/awsekscluster) — the cluster access is granted on (needs API authentication mode)
- [AwsIamRole](/docs/catalog/aws/awsiamrole) — the principal being granted access
- [AwsEksNodeGroup](/docs/catalog/aws/awseksnodegroup) — managed nodes get their entries auto-created by EKS
