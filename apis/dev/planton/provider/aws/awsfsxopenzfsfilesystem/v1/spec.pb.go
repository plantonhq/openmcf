...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsfsxopenzfsfilesystem/v1/spec.proto
...
func (x *AwsFsxOpenzfsFileSystemSpec) Reset() {
	*x = AwsFsxOpenzfsFileSystemSpec{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_msgTypes[0]
...
func (*AwsFsxOpenzfsFileSystemSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDesc = "" +
	...
	"7com.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awsfsxopenzfsfilesystem/v1;awsfsxopenzfsfilesystemv1\xa2\x02\x05DPPAA\xaa\x023Dev.Planton.Provider.Aws.Awsfsxopenzfsfilesystem.V1\xca\x023Dev\\Planton\\Provider\\Aws\\Awsfsxopenzfsfilesystem\\V1\xe2\x02?Dev\\Planton\\Provider\\Aws\\Awsfsxopenzfsfilesystem\\V1\\GPBMetadata\xea\x028Dev::Planton::Provider::Aws::Awsfsxopenzfsfilesystem::V1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto = out.File
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1_spec_proto_depIdxs = nil
}
