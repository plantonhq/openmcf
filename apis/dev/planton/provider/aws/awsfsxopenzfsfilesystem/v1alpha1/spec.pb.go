...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awsfsxopenzfsfilesystem/v1alpha1/spec.proto
...
func (x *AwsFsxOpenzfsFileSystemSpec) Reset() {
	*x = AwsFsxOpenzfsFileSystemSpec{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsFsxOpenzfsFileSystemSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxOpenzfsFileSystemReadCacheConfiguration) Reset() {
	*x = AwsFsxOpenzfsFileSystemReadCacheConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOpenzfsFileSystemReadCacheConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsFsxOpenzfsFileSystemDiskIopsConfiguration) Reset() {
	*x = AwsFsxOpenzfsFileSystemDiskIopsConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOpenzfsFileSystemDiskIopsConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsFsxOpenzfsFileSystemRootVolumeConfiguration) Reset() {
	*x = AwsFsxOpenzfsFileSystemRootVolumeConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOpenzfsFileSystemRootVolumeConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsFsxOpenzfsFileSystemNfsExports) Reset() {
	*x = AwsFsxOpenzfsFileSystemNfsExports{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOpenzfsFileSystemNfsExports) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsFsxOpenzfsFileSystemNfsClientConfiguration) Reset() {
	*x = AwsFsxOpenzfsFileSystemNfsClientConfiguration{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOpenzfsFileSystemNfsClientConfiguration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsFsxOpenzfsFileSystemUserAndGroupQuota) Reset() {
	*x = AwsFsxOpenzfsFileSystemUserAndGroupQuota{}
	mi := &file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOpenzfsFileSystemUserAndGroupQuota) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/aws/awsfsxopenzfsfilesystem/v1alpha1/spec.proto\x129dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xcd3\n" +
	...
	"\x13throughput_capacity\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x12throughputCapacity\x12\xa2\x01\n" +
	"\x18read_cache_configuration\x18\x06 \x01(\v2h.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemReadCacheConfigurationR\x16readCacheConfiguration\x12|\n" +
	"\n" +
	...
	"\tbackup_id\x18\r \x01(\tR\bbackupId\x12\x9f\x01\n" +
	"\x17disk_iops_configuration\x18\x0e \x01(\v2g.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemDiskIopsConfigurationR\x15diskIopsConfiguration\x12\xa5\x01\n" +
	"\x19root_volume_configuration\x18\x0f \x01(\v2i.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemRootVolumeConfigurationR\x17rootVolumeConfiguration\x12Z\n" +
	...
	"\x11skip_final_backup\x18\x14 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x04R\x0fskipFinalBackup\x88\x01\x01\x12\x97\x01\n" +
	"\x11final_backup_tags\x18\x15 \x03(\v2k.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.FinalBackupTagsEntryR\x0ffinalBackupTags\x12%\n" +
	...
	"\x15data_compression_type\x18\x01 \x01(\tB\b\x8a\xa6\x1d\x04NONEH\x00R\x13dataCompressionType\x88\x01\x01\x12}\n" +
	"\vnfs_exports\x18\x02 \x01(\v2\\.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemNfsExportsR\n" +
	"nfsExports\x12\x1b\n" +
	"\tread_only\x18\x03 \x01(\bR\breadOnly\x124\n" +
	"\x0frecord_size_kib\x18\x04 \x01(\x05B\a\x8a\xa6\x1d\x03128H\x01R\rrecordSizeKib\x88\x01\x01\x12\x96\x01\n" +
	"\x15user_and_group_quotas\x18\x05 \x03(\v2c.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemUserAndGroupQuotaR\x12userAndGroupQuotas\x123\n" +
	...
	"\x10_record_size_kib\"\xcf\x01\n" +
	"!AwsFsxOpenzfsFileSystemNfsExports\x12\xa9\x01\n" +
	"\x15client_configurations\x18\x01 \x03(\v2h.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemNfsClientConfigurationB\n" +
	...
	"\x10quota_type_valid\x12\x1etype must be 'USER' or 'GROUP'\x1a\x1ethis.type in ['USER', 'GROUP']B\xd2\x03\n" +
	"=com.dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1B\tSpecProtoP\x01Z{github.com/plantonhq/planton/apis/dev/planton/provider/aws/awsfsxopenzfsfilesystem/v1alpha1;awsfsxopenzfsfilesystemv1alpha1\xa2\x02\x05DPPAA\xaa\x029Dev.Planton.Provider.Aws.Awsfsxopenzfsfilesystem.V1alpha1\xca\x029Dev\\Planton\\Provider\\Aws\\Awsfsxopenzfsfilesystem\\V1alpha1\xe2\x02EDev\\Planton\\Provider\\Aws\\Awsfsxopenzfsfilesystem\\V1alpha1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Aws::Awsfsxopenzfsfilesystem::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_goTypes = []any{
	(*AwsFsxOpenzfsFileSystemSpec)(nil),                    // 0: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec
	(*AwsFsxOpenzfsFileSystemReadCacheConfiguration)(nil),  // 1: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemReadCacheConfiguration
	(*AwsFsxOpenzfsFileSystemDiskIopsConfiguration)(nil),   // 2: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemDiskIopsConfiguration
	(*AwsFsxOpenzfsFileSystemRootVolumeConfiguration)(nil), // 3: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemRootVolumeConfiguration
	(*AwsFsxOpenzfsFileSystemNfsExports)(nil),              // 4: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemNfsExports
	(*AwsFsxOpenzfsFileSystemNfsClientConfiguration)(nil),  // 5: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemNfsClientConfiguration
	(*AwsFsxOpenzfsFileSystemUserAndGroupQuota)(nil),       // 6: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemUserAndGroupQuota
	nil,                         // 7: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.FinalBackupTagsEntry
	(*v1.StringValueOrRef)(nil), // 8: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.read_cache_configuration:type_name -> dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemReadCacheConfiguration
	8,  // 1: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 2: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 3: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.preferred_subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 4: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.route_table_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 5: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 6: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.disk_iops_configuration:type_name -> dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemDiskIopsConfiguration
	3,  // 7: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.root_volume_configuration:type_name -> dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemRootVolumeConfiguration
	7,  // 8: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.final_backup_tags:type_name -> dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemSpec.FinalBackupTagsEntry
	4,  // 9: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemRootVolumeConfiguration.nfs_exports:type_name -> dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemNfsExports
	6,  // 10: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemRootVolumeConfiguration.user_and_group_quotas:type_name -> dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemUserAndGroupQuota
	5,  // 11: dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemNfsExports.client_configurations:type_name -> dev.planton.provider.aws.awsfsxopenzfsfilesystem.v1alpha1.AwsFsxOpenzfsFileSystemNfsClientConfiguration
...
func init() { file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awsfsxopenzfsfilesystem_v1alpha1_spec_proto_depIdxs = nil
}
