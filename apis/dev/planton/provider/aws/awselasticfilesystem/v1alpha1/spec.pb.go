...
// 	protoc        (unknown)
// source: dev/planton/provider/aws/awselasticfilesystem/v1alpha1/spec.proto
...
func (x *AwsElasticFileSystemSpec) Reset() {
	*x = AwsElasticFileSystemSpec{}
	mi := &file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsElasticFileSystemSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsElasticFileSystemMountTarget) Reset() {
	*x = AwsElasticFileSystemMountTarget{}
	mi := &file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsElasticFileSystemMountTarget) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsElasticFileSystemReplication) Reset() {
	*x = AwsElasticFileSystemReplication{}
	mi := &file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsElasticFileSystemReplication) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Adev/planton/provider/aws/awselasticfilesystem/v1alpha1/spec.proto\x126dev.planton.provider.aws.awselasticfilesystem.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x83 \n" +
	...
	" replication_overwrite_protection\x18\f \x01(\tR\x1ereplicationOverwriteProtection\x12\x89\x01\n" +
	"\rmount_targets\x18\r \x03(\v2W.dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemMountTargetB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\fmountTargets\x12\x8b\x01\n" +
	...
	"\"bypass_policy_lockout_safety_check\x18\x10 \x01(\bR\x1ebypassPolicyLockoutSafetyCheck\x12y\n" +
	"\vreplication\x18\x11 \x01(\v2W.dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemReplicationR\vreplication:\xaa\x16\xbaH\xa6\x16\x1a\xac\x01\n" +
	...
	" replication_destination_required\x12Tat least one of destination_region or destination_availability_zone_name is required\x1aNthis.destination_region != '' || this.destination_availability_zone_name != ''B\xbd\x03\n" +
	":com.dev.planton.provider.aws.awselasticfilesystem.v1alpha1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/apis/dev/planton/provider/aws/awselasticfilesystem/v1alpha1;awselasticfilesystemv1alpha1\xa2\x02\x05DPPAA\xaa\x026Dev.Planton.Provider.Aws.Awselasticfilesystem.V1alpha1\xca\x026Dev\\Planton\\Provider\\Aws\\Awselasticfilesystem\\V1alpha1\xe2\x02BDev\\Planton\\Provider\\Aws\\Awselasticfilesystem\\V1alpha1\\GPBMetadata\xea\x02;Dev::Planton::Provider::Aws::Awselasticfilesystem::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_goTypes = []any{
	(*AwsElasticFileSystemSpec)(nil),        // 0: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemSpec
	(*AwsElasticFileSystemMountTarget)(nil), // 1: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemMountTarget
	(*AwsElasticFileSystemReplication)(nil), // 2: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemReplication
	(*v1.StringValueOrRef)(nil),             // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),                 // 4: google.protobuf.Struct
}
var file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemSpec.mount_targets:type_name -> dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemMountTarget
	3, // 2: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 3: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemSpec.policy:type_name -> google.protobuf.Struct
	2, // 4: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemSpec.replication:type_name -> dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemReplication
	3, // 5: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemMountTarget.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 6: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemReplication.destination_kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 7: dev.planton.provider.aws.awselasticfilesystem.v1alpha1.AwsElasticFileSystemReplication.destination_file_system_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_aws_awselasticfilesystem_v1alpha1_spec_proto_depIdxs = nil
}
