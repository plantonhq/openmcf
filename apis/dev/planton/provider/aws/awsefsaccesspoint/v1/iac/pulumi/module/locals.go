...
type Locals struct {
	AwsEfsAccessPoint *awsefsaccesspointv1.AwsEfsAccessPoint
	AwsTags           map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *awsefsaccesspointv1.AwsEfsAccessPointStackInput) *Locals {
	locals := &Locals{}
