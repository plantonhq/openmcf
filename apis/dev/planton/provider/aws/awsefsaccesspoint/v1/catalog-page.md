...
- **An EFS file system** — an [AwsElasticFileSystem](/docs/catalog/aws/awselasticfilesystem) resource (or a literal `fs-` ID) in the same region
...
- [AwsElasticFileSystem](/docs/catalog/aws/awselasticfilesystem) — the file system this access point enters
- [AwsLambda](/docs/catalog/aws/awslambda) — mounts EFS through the access point ARN
- [AwsEcsTaskDefinition](/docs/catalog/aws/awsecstaskdefinition) — authorizes EFS volumes through the access point ID
