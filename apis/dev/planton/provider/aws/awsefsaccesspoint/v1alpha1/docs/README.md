...
See the [AwsElasticFileSystem architecture reference](../../awselasticfilesystem/v1alpha1/docs/README.md) for the file system side: mount targets, storage classes, throughput modes, encryption, and replication.
