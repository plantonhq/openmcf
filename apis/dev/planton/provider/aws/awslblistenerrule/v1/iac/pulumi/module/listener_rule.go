...
func conditionArgs(conditions []*awslblistenerrulev1.AwsLbListenerRuleCondition) lb.ListenerRuleConditionArray {
...
func actionArgs(actions []*awslblistenerrulev1.AwsLbListenerRuleAction) (lb.ListenerRuleActionArray, error) {
...
func transformArgs(transforms []*awslblistenerrulev1.AwsLbListenerRuleTransform) lb.ListenerRuleTransformArray {
