...
func applyHttpHeaders(args *lb.ListenerArgs, headers *awslblistenerv1.AwsLbListenerHttpHeaders) {
	if headers == nil {
		return
	}
...
func defaultActionArgs(actions []*awslblistenerv1.AwsLbListenerAction) (lb.ListenerDefaultActionArray, error) {
