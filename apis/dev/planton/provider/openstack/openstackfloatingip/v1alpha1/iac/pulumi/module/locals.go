...
type Locals struct {
	...
	OpenStackFloatingIp     *openstackfloatingipv1alpha1.OpenStackFloatingIp
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackfloatingipv1alpha1.OpenStackFloatingIpStackInput) *Locals {
	locals := &Locals{}
