...
import (
	...
	openstackloadbalancerpoolv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackloadbalancerpool/v1alpha1"
...
type Locals struct {
	...
	OpenStackLoadBalancerPool *openstackloadbalancerpoolv1alpha1.OpenStackLoadBalancerPool
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackloadbalancerpoolv1alpha1.OpenStackLoadBalancerPoolStackInput) *Locals {
	locals := &Locals{}
