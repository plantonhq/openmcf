...
Industry standard. Planton wraps this with FK-based references.
...
The Terraform openstack_lb_pool_v2 resource exposes 11 schema fields. Planton exposes 8 fields:
