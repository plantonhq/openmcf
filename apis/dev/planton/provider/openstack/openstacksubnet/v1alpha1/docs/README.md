...
The Terraform `openstack_networking_subnet_v2` resource exposes 22 schema fields. Planton's `OpenStackSubnetSpec` exposes 11 fields -- the ones that cover 95%+ of real-world use cases:
