...
import (
	...
	openstacksubnetv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstacksubnet/v1alpha1"
...
type Locals struct {
	...
	OpenStackSubnet         *openstacksubnetv1alpha1.OpenStackSubnet
...
func initializeLocals(_ *pulumi.Context, stackInput *openstacksubnetv1alpha1.OpenStackSubnetStackInput) *Locals {
	locals := &Locals{}
