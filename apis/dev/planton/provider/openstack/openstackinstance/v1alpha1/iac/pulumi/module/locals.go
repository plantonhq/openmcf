...
import (
	...
	openstackinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackinstance/v1alpha1"
...
type Locals struct {
	...
	OpenStackInstance       *openstackinstancev1alpha1.OpenStackInstance
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackinstancev1alpha1.OpenStackInstanceStackInput) *Locals {
	locals := &Locals{}
