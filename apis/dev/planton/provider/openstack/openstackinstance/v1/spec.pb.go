...
// 	protoc        (unknown)
// source: dev/planton/provider/openstack/openstackinstance/v1/spec.proto
...
func (x *OpenStackInstanceSpec) Reset() {
	*x = OpenStackInstanceSpec{}
	mi := &file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_msgTypes[0]
...
func (*OpenStackInstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *InstanceNetwork) Reset() {
	*x = InstanceNetwork{}
	mi := &file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstanceNetwork) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *BlockDevice) Reset() {
	*x = BlockDevice{}
	mi := &file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlockDevice) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_openstack_openstackinstance_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/openstack/openstackinstance/v1/spec.proto\x123dev.planton.provider.openstack.openstackinstance.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\x8d\n" +
	"\n" +
	...
	"volumeTypeB\xa2\x03\n" +
	"7com.dev.planton.provider.openstack.openstackinstance.v1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackinstance/v1;openstackinstancev1\xa2\x02\x05DPPOO\xaa\x023Dev.Planton.Provider.Openstack.Openstackinstance.V1\xca\x023Dev\\Planton\\Provider\\Openstack\\Openstackinstance\\V1\xe2\x02?Dev\\Planton\\Provider\\Openstack\\Openstackinstance\\V1\\GPBMetadata\xea\x028Dev::Planton::Provider::Openstack::Openstackinstance::V1b\x06proto3"

var (
	file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_goTypes = []any{
	(*OpenStackInstanceSpec)(nil), // 0: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec
	(*InstanceNetwork)(nil),       // 1: dev.planton.provider.openstack.openstackinstance.v1.InstanceNetwork
	(*BlockDevice)(nil),           // 2: dev.planton.provider.openstack.openstackinstance.v1.BlockDevice
	nil,                           // 3: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.MetadataEntry
	(*v1.StringValueOrRef)(nil),   // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.key_pair:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.networks:type_name -> dev.planton.provider.openstack.openstackinstance.v1.InstanceNetwork
	4, // 2: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.security_groups:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.block_device:type_name -> dev.planton.provider.openstack.openstackinstance.v1.BlockDevice
	3, // 4: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.metadata:type_name -> dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.MetadataEntry
	4, // 5: dev.planton.provider.openstack.openstackinstance.v1.OpenStackInstanceSpec.server_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 6: dev.planton.provider.openstack.openstackinstance.v1.InstanceNetwork.uuid:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 7: dev.planton.provider.openstack.openstackinstance.v1.InstanceNetwork.port:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_init() }
func file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_init() {
	if File_dev_planton_provider_openstack_openstackinstance_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_openstack_openstackinstance_v1_spec_proto = out.File
	file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_openstack_openstackinstance_v1_spec_proto_depIdxs = nil
}
