...
import (
	...
	openstackrouterinterfacev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackrouterinterface/v1alpha1"
...
type Locals struct {
	...
	OpenStackRouterInterface *openstackrouterinterfacev1alpha1.OpenStackRouterInterface
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackrouterinterfacev1alpha1.OpenStackRouterInterfaceStackInput) *Locals {
	locals := &Locals{}
