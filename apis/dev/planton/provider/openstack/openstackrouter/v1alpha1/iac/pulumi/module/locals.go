...
import (
	...
	openstackrouterv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackrouter/v1alpha1"
...
type Locals struct {
	...
	OpenStackRouter         *openstackrouterv1alpha1.OpenStackRouter
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackrouterv1alpha1.OpenStackRouterStackInput) *Locals {
	locals := &Locals{}
