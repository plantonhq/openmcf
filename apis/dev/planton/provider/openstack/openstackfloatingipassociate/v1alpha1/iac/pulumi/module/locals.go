...
import (
	...
	openstackfloatingipassociatev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackfloatingipassociate/v1alpha1"
...
type Locals struct {
	...
	OpenStackFloatingIpAssociate *openstackfloatingipassociatev1alpha1.OpenStackFloatingIpAssociate
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackfloatingipassociatev1alpha1.OpenStackFloatingIpAssociateStackInput) *Locals {
	locals := &Locals{}
