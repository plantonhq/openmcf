...
import (
	...
	openstacksecuritygrouprulev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstacksecuritygrouprule/v1alpha1"
...
type Locals struct {
	...
	OpenStackSecurityGroupRule *openstacksecuritygrouprulev1alpha1.OpenStackSecurityGroupRule
...
func initializeLocals(_ *pulumi.Context, stackInput *openstacksecuritygrouprulev1alpha1.OpenStackSecurityGroupRuleStackInput) *Locals {
	locals := &Locals{}
