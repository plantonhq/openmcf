...
import (
	...
	openstacknetworkportv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstacknetworkport/v1alpha1"
...
type Locals struct {
	...
	OpenStackNetworkPort    *openstacknetworkportv1alpha1.OpenStackNetworkPort
...
func initializeLocals(_ *pulumi.Context, stackInput *openstacknetworkportv1alpha1.OpenStackNetworkPortStackInput) *Locals {
	locals := &Locals{}
