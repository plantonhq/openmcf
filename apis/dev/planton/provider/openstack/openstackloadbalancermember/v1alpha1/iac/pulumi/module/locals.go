...
import (
	...
	openstackloadbalancermemberv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackloadbalancermember/v1alpha1"
...
type Locals struct {
	...
	OpenStackLoadBalancerMember *openstackloadbalancermemberv1alpha1.OpenStackLoadBalancerMember
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackloadbalancermemberv1alpha1.OpenStackLoadBalancerMemberStackInput) *Locals {
	locals := &Locals{}
