...
Industry standard. Planton wraps this with FK-based references and validation.
...
The Terraform openstack_lb_monitor_v2 resource exposes 14 schema fields. Planton exposes 11 fields:
