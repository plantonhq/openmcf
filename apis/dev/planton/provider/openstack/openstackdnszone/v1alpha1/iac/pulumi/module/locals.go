...
import (
	...
	openstackdnszonev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackdnszone/v1alpha1"
...
type Locals struct {
	...
	OpenStackDnsZone        *openstackdnszonev1alpha1.OpenStackDnsZone
}

// initializeLocals copies fields from the stack input into Locals.
func initializeLocals(_ *pulumi.Context, stackInput *openstackdnszonev1alpha1.OpenStackDnsZoneStackInput) *Locals {
	locals := &Locals{}
