...
import (
	...
	openstackloadbalancerlistenerv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackloadbalancerlistener/v1alpha1"
...
type Locals struct {
	...
	OpenStackLoadBalancerListener *openstackloadbalancerlistenerv1alpha1.OpenStackLoadBalancerListener
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackloadbalancerlistenerv1alpha1.OpenStackLoadBalancerListenerStackInput) *Locals {
	locals := &Locals{}
