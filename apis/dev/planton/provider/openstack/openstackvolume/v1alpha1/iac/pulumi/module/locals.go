...
import (
	...
	openstackvolumev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackvolume/v1alpha1"
...
type Locals struct {
	...
	OpenStackVolume         *openstackvolumev1alpha1.OpenStackVolume
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackvolumev1alpha1.OpenStackVolumeStackInput) *Locals {
	locals := &Locals{}
