...
import (
	...
	openstackloadbalancerv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openstack/openstackloadbalancer/v1alpha1"
...
type Locals struct {
	...
	OpenStackLoadBalancer   *openstackloadbalancerv1alpha1.OpenStackLoadBalancer
...
func initializeLocals(_ *pulumi.Context, stackInput *openstackloadbalancerv1alpha1.OpenStackLoadBalancerStackInput) *Locals {
	locals := &Locals{}
