...
import (
	openfgaauthorizationmodelv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openfga/openfgaauthorizationmodel/v1alpha1"
...
func Resources(ctx *pulumi.Context, stackInput *openfgaauthorizationmodelv1alpha1.OpenFgaAuthorizationModelStackInput) error {
