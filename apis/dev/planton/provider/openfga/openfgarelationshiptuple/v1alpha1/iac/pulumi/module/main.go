...
import (
	openfgarelationshiptuplev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openfga/openfgarelationshiptuple/v1alpha1"
...
func Resources(ctx *pulumi.Context, stackInput *openfgarelationshiptuplev1alpha1.OpenFgaRelationshipTupleStackInput) error {
