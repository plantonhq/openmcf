...
// 	protoc        (unknown)
// source: dev/planton/provider/openfga/openfgarelationshiptuple/v1/spec.proto
...
func (x *OpenFgaRelationshipTupleSpec) Reset() {
	*x = OpenFgaRelationshipTupleSpec{}
	mi := &file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_msgTypes[0]
...
func (*OpenFgaRelationshipTupleSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *OpenFgaRelationshipTupleUser) Reset() {
	*x = OpenFgaRelationshipTupleUser{}
	mi := &file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaRelationshipTupleUser) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *OpenFgaRelationshipTupleObject) Reset() {
	*x = OpenFgaRelationshipTupleObject{}
	mi := &file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaRelationshipTupleObject) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *OpenFgaRelationshipTupleCondition) Reset() {
	*x = OpenFgaRelationshipTupleCondition{}
	mi := &file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaRelationshipTupleCondition) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDesc = "" +
	"\n" +
	...
	"\tcondition\x18\x06 \x01(\v2[.dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleConditionR\tcondition\"\xa2\x01\n" +
	...
	"<com.dev.planton.provider.openfga.openfgarelationshiptuple.v1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/apis/dev/planton/provider/openfga/openfgarelationshiptuple/v1;openfgarelationshiptuplev1\xa2\x02\x05DPPOO\xaa\x028Dev.Planton.Provider.Openfga.Openfgarelationshiptuple.V1\xca\x028Dev\\Planton\\Provider\\Openfga\\Openfgarelationshiptuple\\V1\xe2\x02DDev\\Planton\\Provider\\Openfga\\Openfgarelationshiptuple\\V1\\GPBMetadata\xea\x02=Dev::Planton::Provider::Openfga::Openfgarelationshiptuple::V1b\x06proto3"

var (
	file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDesc), len(file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_goTypes = []any{
	(*OpenFgaRelationshipTupleSpec)(nil),      // 0: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec
	(*OpenFgaRelationshipTupleUser)(nil),      // 1: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleUser
	(*OpenFgaRelationshipTupleObject)(nil),    // 2: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleObject
	(*OpenFgaRelationshipTupleCondition)(nil), // 3: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleCondition
	(*v1.StringValueOrRef)(nil),               // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec.store_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec.authorization_model_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec.user:type_name -> dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleUser
	2, // 3: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec.object:type_name -> dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleObject
	3, // 4: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec.condition:type_name -> dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleCondition
	4, // 5: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleUser.id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 6: dev.planton.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleObject.id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_init() }
func file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_init() {
	if File_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDesc), len(file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto = out.File
	file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_openfga_openfgarelationshiptuple_v1_spec_proto_depIdxs = nil
}
