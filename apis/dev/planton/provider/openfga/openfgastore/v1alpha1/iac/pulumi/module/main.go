...
import (
	openfgastorev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/openfga/openfgastore/v1alpha1"
...
//
//	planton apply --manifest openfga-store.yaml --provisioner tofu
//
// Reference: https://github.com/openfga/terraform-provider-openfga
func Resources(ctx *pulumi.Context, stackInput *openfgastorev1alpha1.OpenFgaStoreStackInput) error {
	...
	ctx.Log.Info("To deploy: planton apply --manifest <manifest.yaml> --provisioner tofu", nil)
