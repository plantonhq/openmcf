...
- [GcpGkeCluster](/docs/catalog/gcp/gcpgkecluster) — provides the target GKE cluster for virtual cluster deployment
- [GcpGkeNodePool](/docs/catalog/gcp/gcpgkenodepool) — provides node pools assigned to Dataproc roles
- [GcpGcsBucket](/docs/catalog/gcp/gcpgcsbucket) — staging bucket for job dependencies
- [GcpDataprocCluster](/docs/catalog/gcp/gcpdataproccluster) — standard GCE-based alternative for dedicated Spark clusters
