...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpgcsbucket/v1alpha1/spec.proto
...
func (x *GcpGcsBucketSpec) Reset() {
	*x = GcpGcsBucketSpec{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpGcsBucketSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGcsBucketAutoclass) Reset() {
	*x = GcpGcsBucketAutoclass{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketAutoclass) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpGcsBucketLifecycleRule) Reset() {
	*x = GcpGcsBucketLifecycleRule{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketLifecycleRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpGcsBucketLifecycleAction) Reset() {
	*x = GcpGcsBucketLifecycleAction{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketLifecycleAction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpGcsBucketLifecycleCondition) Reset() {
	*x = GcpGcsBucketLifecycleCondition{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketLifecycleCondition) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpGcsBucketRetentionPolicy) Reset() {
	*x = GcpGcsBucketRetentionPolicy{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketRetentionPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpGcsBucketSoftDeletePolicy) Reset() {
	*x = GcpGcsBucketSoftDeletePolicy{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketSoftDeletePolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpGcsBucketWebsite) Reset() {
	*x = GcpGcsBucketWebsite{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketWebsite) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpGcsBucketCorsRule) Reset() {
	*x = GcpGcsBucketCorsRule{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketCorsRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpGcsBucketLogging) Reset() {
	*x = GcpGcsBucketLogging{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketLogging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *GcpGcsBucketCustomPlacementConfig) Reset() {
	*x = GcpGcsBucketCustomPlacementConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketCustomPlacementConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *GcpGcsBucketIpFilter) Reset() {
	*x = GcpGcsBucketIpFilter{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketIpFilter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *GcpGcsBucketIpFilterPublicNetworkSource) Reset() {
	*x = GcpGcsBucketIpFilterPublicNetworkSource{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketIpFilterPublicNetworkSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *GcpGcsBucketIpFilterVpcNetworkSource) Reset() {
	*x = GcpGcsBucketIpFilterVpcNetworkSource{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketIpFilterVpcNetworkSource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *GcpGcsBucketIamMember) Reset() {
	*x = GcpGcsBucketIamMember{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketIamMember) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *GcpGcsBucketIamCondition) Reset() {
	*x = GcpGcsBucketIamCondition{}
	mi := &file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsBucketIamCondition) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP(), []int{15}
}
...
var File_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"9dev/planton/provider/gcp/gcpgcsbucket/v1alpha1/spec.proto\x12.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\x9c\x15\n" +
	...
	"\x12versioning_enabled\x18\b \x01(\bR\x11versioningEnabled\x12c\n" +
	"\tautoclass\x18\t \x01(\v2E.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketAutoclassR\tautoclass\x12|\n" +
	"\x0flifecycle_rules\x18\n" +
	" \x03(\v2I.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleRuleB\b\xbaH\x05\x92\x01\x02\x10dR\x0elifecycleRules\x12v\n" +
	"\x10retention_policy\x18\v \x01(\v2K.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketRetentionPolicyR\x0fretentionPolicy\x12z\n" +
	"\x12soft_delete_policy\x18\f \x01(\v2L.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSoftDeletePolicyR\x10softDeletePolicy\x12t\n" +
	...
	"\x17enable_object_retention\x18\x10 \x01(\bR\x15enableObjectRetention\x12]\n" +
	"\awebsite\x18\x11 \x01(\v2C.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketWebsiteR\awebsite\x12c\n" +
	"\n" +
	"cors_rules\x18\x12 \x03(\v2D.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketCorsRuleR\tcorsRules\x12]\n" +
	"\alogging\x18\x13 \x01(\v2C.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLoggingR\alogging\x12\x89\x01\n" +
	"\x17custom_placement_config\x18\x14 \x01(\v2Q.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketCustomPlacementConfigR\x15customPlacementConfig\x12\x7f\n" +
	...
	"\x1ehierarchical_namespace_enabled\x18\x16 \x01(\bR\x1chierarchicalNamespaceEnabled\x12d\n" +
	"\x06labels\x18\x17 \x03(\v2L.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.LabelsEntryR\x06labels\x12f\n" +
	"\viam_members\x18\x18 \x03(\v2E.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamMemberR\n" +
	"iamMembers\x12a\n" +
	"\tip_filter\x18\x19 \x01(\v2D.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterR\bipFilter\x1a9\n" +
	...
	"\x1cvalid_terminal_storage_class\x128terminal_storage_class must be one of: NEARLINE, ARCHIVE\x1a-this == '' || this in ['NEARLINE', 'ARCHIVE']R\x14terminalStorageClass\"\xfe\x01\n" +
	"\x19GcpGcsBucketLifecycleRule\x12k\n" +
	"\x06action\x18\x01 \x01(\v2K.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleActionB\x06\xbaH\x03\xc8\x01\x01R\x06action\x12t\n" +
	"\tcondition\x18\x02 \x01(\v2N.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleConditionB\x06\xbaH\x03\xc8\x01\x01R\tcondition\"\xd5\x04\n" +
	...
	"\xbaH\a\x92\x01\x04\b\x02\x10\x02R\rdataLocations\"\x8a\x06\n" +
	"\x14GcpGcsBucketIpFilter\x12|\n" +
	"\x04mode\x18\x01 \x01(\tBh\xbaHe\xba\x01_\n" +
	"\x14valid_ip_filter_mode\x12&mode must be one of: Enabled, Disabled\x1a\x1fthis in ['Enabled', 'Disabled']\xc8\x01\x01R\x04mode\x12\x8b\x01\n" +
	"\x15public_network_source\x18\x02 \x01(\v2W.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterPublicNetworkSourceR\x13publicNetworkSource\x12\x84\x01\n" +
	"\x13vpc_network_sources\x18\x03 \x03(\v2T.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterVpcNetworkSourceR\x11vpcNetworkSources\x12/\n" +
	...
	"\x16allowed_ip_cidr_ranges\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x13allowedIpCidrRanges\"\x8d\x02\n" +
	"\x15GcpGcsBucketIamMember\x12\x1a\n" +
	"\x04role\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04role\x12p\n" +
	"\x06member\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB$\xbaH\x03\xc8\x01\x01\x88\xd4a\xc6\x17\x92\xd4a\x15status.outputs.memberR\x06member\x12f\n" +
	"\tcondition\x18\x03 \x01(\v2H.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamConditionR\tcondition\"\x90\x01\n" +
	...
	"expression\x12*\n" +
	"\vdescription\x18\x03 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x02R\vdescriptionB\x85\x03\n" +
	"2com.dev.planton.provider.gcp.gcpgcsbucket.v1alpha1B\tSpecProtoP\x01Zegithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpgcsbucket/v1alpha1;gcpgcsbucketv1alpha1\xa2\x02\x05DPPGG\xaa\x02.Dev.Planton.Provider.Gcp.Gcpgcsbucket.V1alpha1\xca\x02.Dev\\Planton\\Provider\\Gcp\\Gcpgcsbucket\\V1alpha1\xe2\x02:Dev\\Planton\\Provider\\Gcp\\Gcpgcsbucket\\V1alpha1\\GPBMetadata\xea\x023Dev::Planton::Provider::Gcp::Gcpgcsbucket::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_goTypes = []any{
	(*GcpGcsBucketSpec)(nil),                        // 0: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec
	(*GcpGcsBucketAutoclass)(nil),                   // 1: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketAutoclass
	(*GcpGcsBucketLifecycleRule)(nil),               // 2: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleRule
	(*GcpGcsBucketLifecycleAction)(nil),             // 3: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleAction
	(*GcpGcsBucketLifecycleCondition)(nil),          // 4: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleCondition
	(*GcpGcsBucketRetentionPolicy)(nil),             // 5: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketRetentionPolicy
	(*GcpGcsBucketSoftDeletePolicy)(nil),            // 6: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSoftDeletePolicy
	(*GcpGcsBucketWebsite)(nil),                     // 7: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketWebsite
	(*GcpGcsBucketCorsRule)(nil),                    // 8: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketCorsRule
	(*GcpGcsBucketLogging)(nil),                     // 9: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLogging
	(*GcpGcsBucketCustomPlacementConfig)(nil),       // 10: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketCustomPlacementConfig
	(*GcpGcsBucketIpFilter)(nil),                    // 11: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilter
	(*GcpGcsBucketIpFilterPublicNetworkSource)(nil), // 12: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterPublicNetworkSource
	(*GcpGcsBucketIpFilterVpcNetworkSource)(nil),    // 13: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterVpcNetworkSource
	(*GcpGcsBucketIamMember)(nil),                   // 14: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamMember
	(*GcpGcsBucketIamCondition)(nil),                // 15: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamCondition
	nil,                                             // 16: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.LabelsEntry
	(*v1.StringValueOrRef)(nil),                     // 17: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_depIdxs = []int32{
	17, // 0: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.autoclass:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketAutoclass
	2,  // 2: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.lifecycle_rules:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleRule
	5,  // 3: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.retention_policy:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketRetentionPolicy
	6,  // 4: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.soft_delete_policy:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSoftDeletePolicy
	17, // 5: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.kms_key_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 6: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.website:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketWebsite
	8,  // 7: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.cors_rules:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketCorsRule
	9,  // 8: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.logging:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLogging
	10, // 9: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.custom_placement_config:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketCustomPlacementConfig
	16, // 10: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.labels:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.LabelsEntry
	14, // 11: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.iam_members:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamMember
	11, // 12: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketSpec.ip_filter:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilter
	3,  // 13: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleRule.action:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleAction
	4,  // 14: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleRule.condition:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLifecycleCondition
	17, // 15: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketLogging.log_bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 16: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilter.public_network_source:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterPublicNetworkSource
	13, // 17: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilter.vpc_network_sources:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterVpcNetworkSource
	17, // 18: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIpFilterVpcNetworkSource.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	17, // 19: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamMember.member:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	15, // 20: dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamMember.condition:type_name -> dev.planton.provider.gcp.gcpgcsbucket.v1alpha1.GcpGcsBucketIamCondition
...
func init() { file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpgcsbucket_v1alpha1_spec_proto_depIdxs = nil
}
