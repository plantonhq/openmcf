...
type Locals struct {
	GcpManagedSslCertificate *gcpmanagedsslcertificatev1.GcpManagedSslCertificate
...
func initializeLocals(ctx *pulumi.Context, stackInput *gcpmanagedsslcertificatev1.GcpManagedSslCertificateStackInput) *Locals {
