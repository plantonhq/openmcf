...
- [GcpVpc](/docs/catalog/gcp/gcpvpc) — provides the VPC network for PSC endpoint creation
...
- [GcpRedisInstance](/docs/catalog/gcp/gcpredisinstance) — legacy Memorystore for Redis API using VPC peering instead of PSC
