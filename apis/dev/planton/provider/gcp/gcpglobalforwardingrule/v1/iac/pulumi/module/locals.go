...
type Locals struct {
	GcpGlobalForwardingRule *gcpglobalforwardingrulev1.GcpGlobalForwardingRule
...
func initializeLocals(ctx *pulumi.Context, stackInput *gcpglobalforwardingrulev1.GcpGlobalForwardingRuleStackInput) *Locals {
