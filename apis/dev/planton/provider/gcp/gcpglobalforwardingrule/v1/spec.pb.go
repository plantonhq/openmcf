...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpglobalforwardingrule/v1/spec.proto
...
func (x *GcpGlobalForwardingRuleSpec) Reset() {
	*x = GcpGlobalForwardingRuleSpec{}
	mi := &file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_msgTypes[0]
...
func (*GcpGlobalForwardingRuleSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGlobalForwardingRuleMetadataFilter) Reset() {
	*x = GcpGlobalForwardingRuleMetadataFilter{}
	mi := &file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGlobalForwardingRuleMetadataFilter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpGlobalForwardingRuleMetadataFilterLabel) Reset() {
	*x = GcpGlobalForwardingRuleMetadataFilterLabel{}
	mi := &file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGlobalForwardingRuleMetadataFilterLabel) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpGlobalForwardingRuleServiceDirectoryRegistration) Reset() {
	*x = GcpGlobalForwardingRuleServiceDirectoryRegistration{}
	mi := &file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGlobalForwardingRuleServiceDirectoryRegistration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDesc = "" +
	"\n" +
	...
	"\x10metadata_filters\x18\r \x03(\v2Z.dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleMetadataFilterR\x0fmetadataFilters\x12\xae\x01\n" +
	"\x1eservice_directory_registration\x18\x0e \x01(\v2h.dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleServiceDirectoryRegistrationR\x1cserviceDirectoryRegistration\x12/\n" +
	"\x14no_automate_dns_zone\x18\x0f \x01(\bR\x11noAutomateDnsZone\x12t\n" +
	"\x06labels\x18\x10 \x03(\v2\\.dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.LabelsEntryR\x06labels\x12\xd2\x02\n" +
	...
	"\f_ip_protocolB\x18\n" +
	"\x16_load_balancing_scheme\"\xf2\x02\n" +
	"%GcpGlobalForwardingRuleMetadataFilter\x12\xb5\x01\n" +
	"\x15filter_match_criteria\x18\x01 \x01(\tB\x80\x01\xbaH}\xba\x01w\n" +
	"\x1bvalid_filter_match_criteria\x124filter_match_criteria must be MATCH_ALL or MATCH_ANY\x1a\"this in ['MATCH_ALL', 'MATCH_ANY']\xc8\x01\x01R\x13filterMatchCriteria\x12\x90\x01\n" +
	"\rfilter_labels\x18\x02 \x03(\v2_.dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleMetadataFilterLabelB\n" +
	...
	"\x18service_directory_region\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x18?R\x16serviceDirectoryRegionB\xa8\x03\n" +
	"7com.dev.planton.provider.gcp.gcpglobalforwardingrule.v1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpglobalforwardingrule/v1;gcpglobalforwardingrulev1\xa2\x02\x05DPPGG\xaa\x023Dev.Planton.Provider.Gcp.Gcpglobalforwardingrule.V1\xca\x023Dev\\Planton\\Provider\\Gcp\\Gcpglobalforwardingrule\\V1\xe2\x02?Dev\\Planton\\Provider\\Gcp\\Gcpglobalforwardingrule\\V1\\GPBMetadata\xea\x028Dev::Planton::Provider::Gcp::Gcpglobalforwardingrule::V1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_goTypes = []any{
	(*GcpGlobalForwardingRuleSpec)(nil),                         // 0: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec
	(*GcpGlobalForwardingRuleMetadataFilter)(nil),               // 1: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleMetadataFilter
	(*GcpGlobalForwardingRuleMetadataFilterLabel)(nil),          // 2: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleMetadataFilterLabel
	(*GcpGlobalForwardingRuleServiceDirectoryRegistration)(nil), // 3: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleServiceDirectoryRegistration
	nil,                         // 4: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.LabelsEntry
	(*v1.StringValueOrRef)(nil), // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 1: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.target:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 2: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.ip_address:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 3: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 4: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.subnetwork:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 5: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.metadata_filters:type_name -> dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleMetadataFilter
	3, // 6: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.service_directory_registration:type_name -> dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleServiceDirectoryRegistration
	4, // 7: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.labels:type_name -> dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleSpec.LabelsEntry
	2, // 8: dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleMetadataFilter.filter_labels:type_name -> dev.planton.provider.gcp.gcpglobalforwardingrule.v1.GcpGlobalForwardingRuleMetadataFilterLabel
...
func init() { file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpglobalforwardingrule_v1_spec_proto_depIdxs = nil
}
