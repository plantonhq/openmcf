...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpproject/v1/spec.proto
...
func (GcpProjectParentType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpProjectParentType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_enumTypes[0]
}
...
func (x *GcpProjectSpec) Reset() {
	*x = GcpProjectSpec{}
	mi := &file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_msgTypes[0]
...
const file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc = "" +
	...
	"*com.dev.planton.provider.gcp.gcpproject.v1B\tSpecProtoP\x01ZUgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpproject/v1;gcpprojectv1\xa2\x02\x05DPPGG\xaa\x02&Dev.Planton.Provider.Gcp.Gcpproject.V1\xca\x02&Dev\\Planton\\Provider\\Gcp\\Gcpproject\\V1\xe2\x022Dev\\Planton\\Provider\\Gcp\\Gcpproject\\V1\\GPBMetadata\xea\x02+Dev::Planton::Provider::Gcp::Gcpproject::V1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescData
}
...
func file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpproject_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpproject_v1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpproject_v1_spec_proto_depIdxs = nil
}
