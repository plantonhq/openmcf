...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpproject/v1alpha1/spec.proto
...
func (GcpProjectParentType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpProjectParentType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_enumTypes[0]
}
...
func (GcpProjectParentType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type GcpProjectSpec struct {
	...
	ParentType GcpProjectParentType `protobuf:"varint,3,opt,name=parent_type,json=parentType,proto3,enum=dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectParentType" json:"parent_type,omitempty"`
...
func (x *GcpProjectSpec) Reset() {
	*x = GcpProjectSpec{}
	mi := &file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_msgTypes[0]
...
var File_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7dev/planton/provider/gcp/gcpproject/v1alpha1/spec.proto\x12,dev.planton.provider.gcp.gcpproject.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xe6\b\n" +
	...
	"\vparent_type\x18\x03 \x01(\x0e2B.dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectParentTypeR\n" +
	...
	"\x12billing_account_id\x18\x05 \x01(\tB/\xbaH,\xd8\x01\x01r'2%^[A-Z0-9]{6}-[A-Z0-9]{6}-[A-Z0-9]{6}$R\x10billingAccountId\x12`\n" +
	"\x06labels\x18\x06 \x03(\v2H.dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.LabelsEntryR\x06labels\x12Z\n" +
	"\x04tags\x18\a \x03(\v2F.dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.TagsEntryR\x04tags\x12>\n" +
	...
	"\n" +
	"\x06folder\x10\x02B\xf7\x02\n" +
	"0com.dev.planton.provider.gcp.gcpproject.v1alpha1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpproject/v1alpha1;gcpprojectv1alpha1\xa2\x02\x05DPPGG\xaa\x02,Dev.Planton.Provider.Gcp.Gcpproject.V1alpha1\xca\x02,Dev\\Planton\\Provider\\Gcp\\Gcpproject\\V1alpha1\xe2\x028Dev\\Planton\\Provider\\Gcp\\Gcpproject\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Provider::Gcp::Gcpproject::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_goTypes = []any{
	(GcpProjectParentType)(0), // 0: dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectParentType
	(*GcpProjectSpec)(nil),    // 1: dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec
	nil,                       // 2: dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.LabelsEntry
	nil,                       // 3: dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.TagsEntry
}
var file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_depIdxs = []int32{
	0, // 0: dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.parent_type:type_name -> dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectParentType
	2, // 1: dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.labels:type_name -> dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.LabelsEntry
	3, // 2: dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.tags:type_name -> dev.planton.provider.gcp.gcpproject.v1alpha1.GcpProjectSpec.TagsEntry
...
func init() { file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpproject_v1alpha1_spec_proto_depIdxs = nil
}
