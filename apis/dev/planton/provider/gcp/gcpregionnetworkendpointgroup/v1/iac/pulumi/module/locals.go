...
type Locals struct {
	GcpRegionNetworkEndpointGroup *gcpregionnetworkendpointgroupv1.GcpRegionNetworkEndpointGroup
...
func initializeLocals(ctx *pulumi.Context, stackInput *gcpregionnetworkendpointgroupv1.GcpRegionNetworkEndpointGroupStackInput) *Locals {
