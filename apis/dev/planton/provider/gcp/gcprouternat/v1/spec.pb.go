...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcprouternat/v1/spec.proto
...
func (GcpRouterNatLogFilter) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpRouterNatLogFilter) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_enumTypes[0]
}
...
func (GcpRouterNatLogFilter) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpRouterNatSubnetwork) Reset() {
	*x = GcpRouterNatSubnetwork{}
	mi := &file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_msgTypes[0]
...
func (x *GcpRouterNatRuleAction) Reset() {
	*x = GcpRouterNatRuleAction{}
	mi := &file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpRouterNatRuleAction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpRouterNatRule) Reset() {
	*x = GcpRouterNatRule{}
	mi := &file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpRouterNatRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
type GcpRouterNatSpec struct {
	...
	LogFilter     *GcpRouterNatLogFilter `protobuf:"varint,25,opt,name=log_filter,json=logFilter,proto3,enum=dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatLogFilter,oneof" json:"log_filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GcpRouterNatSpec) Reset() {
	*x = GcpRouterNatSpec{}
	mi := &file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpRouterNatSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_gcp_gcprouternat_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDesc = "" +
	"\n" +
	...
	"\x19tcp_time_wait_timeout_sec\x18\x17 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x15tcpTimeWaitTimeoutSec\x12P\n" +
	"\x05rules\x18\x18 \x03(\v2:.dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRuleR\x05rules\x12t\n" +
	"\n" +
	"log_filter\x18\x19 \x01(\x0e2?.dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatLogFilterB\x0f\x8a\xa6\x1d\vERRORS_ONLYH\x00R\tlogFilter\x88\x01\x01:\x95\x16\xbaH\x91\x16\x1a\xd5\x01\n" +
	...
	"\x11TRANSLATIONS_ONLY\x10\x03B\xdb\x02\n" +
	",com.dev.planton.provider.gcp.gcprouternat.v1B\tSpecProtoP\x01ZYgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcprouternat/v1;gcprouternatv1\xa2\x02\x05DPPGG\xaa\x02(Dev.Planton.Provider.Gcp.Gcprouternat.V1\xca\x02(Dev\\Planton\\Provider\\Gcp\\Gcprouternat\\V1\xe2\x024Dev\\Planton\\Provider\\Gcp\\Gcprouternat\\V1\\GPBMetadata\xea\x02-Dev::Planton::Provider::Gcp::Gcprouternat::V1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_goTypes = []any{
	(GcpRouterNatLogFilter)(0),     // 0: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatLogFilter
	(*GcpRouterNatSubnetwork)(nil), // 1: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSubnetwork
	(*GcpRouterNatRuleAction)(nil), // 2: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRuleAction
	(*GcpRouterNatRule)(nil),       // 3: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRule
	(*GcpRouterNatSpec)(nil),       // 4: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec
	(*v1.StringValueOrRef)(nil),    // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_depIdxs = []int32{
	5,  // 0: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSubnetwork.subnetwork:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 1: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRuleAction.source_nat_active_ips:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 2: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRuleAction.source_nat_drain_ips:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 3: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRuleAction.source_nat_active_ranges:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 4: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRuleAction.source_nat_drain_ranges:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 5: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRule.action:type_name -> dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRuleAction
	5,  // 6: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 7: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec.vpc_self_link:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 8: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec.subnetworks:type_name -> dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSubnetwork
	5,  // 9: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec.nat_ips:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 10: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec.drain_nat_ips:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 11: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec.rules:type_name -> dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatRule
	0,  // 12: dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatSpec.log_filter:type_name -> dev.planton.provider.gcp.gcprouternat.v1.GcpRouterNatLogFilter
...
func init() { file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcprouternat_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcprouternat_v1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcprouternat_v1_spec_proto_depIdxs = nil
}
