...
func sourceSubnetworkIpRangesToNat(spec *gcprouternatv1.GcpRouterNatSpec) string {
...
func buildRuleAction(action *gcprouternatv1.GcpRouterNatRuleAction) *compute.RouterNatRuleActionArgs {
