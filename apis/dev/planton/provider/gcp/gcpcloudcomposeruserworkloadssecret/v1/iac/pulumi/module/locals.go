...
type Locals struct {
	...
	GcpCloudComposerUserWorkloadsSecret *gcpcloudcomposeruserworkloadssecretv1.GcpCloudComposerUserWorkloadsSecret
}

func initializeLocals(_ *pulumi.Context, stackInput *gcpcloudcomposeruserworkloadssecretv1.GcpCloudComposerUserWorkloadsSecretStackInput) *Locals {
	locals := &Locals{}
