...
func Resources(ctx *pulumi.Context, stackInput *gcpbigtabletablev1alpha1.GcpBigtableTableStackInput) error {
	...
	if err := bigtableTable(ctx, locals, gcpProvider); err != nil {
