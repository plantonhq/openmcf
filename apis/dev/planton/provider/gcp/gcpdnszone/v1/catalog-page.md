...
Creates a Google Cloud DNS managed zone (`google_dns_managed_zone`) — the zone shell only. Individual DNS records are composed via the separate [GcpDnsRecord](/docs/catalog/gcp/gcpdnsrecord) kind.
...
- **For private zones:** a [GcpVpcNetwork](/docs/catalog/gcp/gcpvpcnetwork) (and/or [GcpGkeCluster](/docs/catalog/gcp/gcpgkecluster)) referenced in `privateVisibilityConfig`
...
- [GcpDnsRecord](/docs/catalog/gcp/gcpdnsrecord) — individual DNS records
- [GcpVpcNetwork](/docs/catalog/gcp/gcpvpcnetwork) — private zone visibility
- [GcpGkeCluster](/docs/catalog/gcp/gcpgkecluster) — cluster-scoped private visibility
- [GcpProject](/docs/catalog/gcp/gcpproject) — owning project
