...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpcloudarmorpolicy/v1alpha1/spec.proto
...
func (x *GcpCloudArmorRateThreshold) Reset() {
	*x = GcpCloudArmorRateThreshold{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpCloudArmorRateThreshold) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpCloudArmorRedirectConfig) Reset() {
	*x = GcpCloudArmorRedirectConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorRedirectConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpCloudArmorRecaptchaOptions) Reset() {
	*x = GcpCloudArmorRecaptchaOptions{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorRecaptchaOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpCloudArmorRuleMatch) Reset() {
	*x = GcpCloudArmorRuleMatch{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorRuleMatch) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpCloudArmorEnforceOnKeyConfig) Reset() {
	*x = GcpCloudArmorEnforceOnKeyConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorEnforceOnKeyConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpCloudArmorRateLimitOptions) Reset() {
	*x = GcpCloudArmorRateLimitOptions{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorRateLimitOptions) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpCloudArmorRequestHeader) Reset() {
	*x = GcpCloudArmorRequestHeader{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorRequestHeader) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpCloudArmorHeaderAction) Reset() {
	*x = GcpCloudArmorHeaderAction{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorHeaderAction) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpCloudArmorWafExclusionFieldParams) Reset() {
	*x = GcpCloudArmorWafExclusionFieldParams{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorWafExclusionFieldParams) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpCloudArmorWafExclusion) Reset() {
	*x = GcpCloudArmorWafExclusion{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorWafExclusion) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *GcpCloudArmorPreconfiguredWafConfig) Reset() {
	*x = GcpCloudArmorPreconfiguredWafConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorPreconfiguredWafConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *GcpCloudArmorRule) Reset() {
	*x = GcpCloudArmorRule{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *GcpCloudArmorTrafficGranularityConfig) Reset() {
	*x = GcpCloudArmorTrafficGranularityConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorTrafficGranularityConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *GcpCloudArmorThresholdConfig) Reset() {
	*x = GcpCloudArmorThresholdConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorThresholdConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *GcpCloudArmorAdaptiveProtectionConfig) Reset() {
	*x = GcpCloudArmorAdaptiveProtectionConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorAdaptiveProtectionConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *GcpCloudArmorJsonCustomConfig) Reset() {
	*x = GcpCloudArmorJsonCustomConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorJsonCustomConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *GcpCloudArmorAdvancedOptionsConfig) Reset() {
	*x = GcpCloudArmorAdvancedOptionsConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorAdvancedOptionsConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{16}
}
...
func (x *GcpCloudArmorRecaptchaOptionsConfig) Reset() {
	*x = GcpCloudArmorRecaptchaOptionsConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorRecaptchaOptionsConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{17}
}
...
func (x *GcpCloudArmorPolicySpec) Reset() {
	*x = GcpCloudArmorPolicySpec{}
	mi := &file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudArmorPolicySpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{18}
}
...
var File_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/gcp/gcpcloudarmorpolicy/v1alpha1/spec.proto\x125dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xfb\x01\n" +
	...
	"\x1brecaptcha_options_not_empty\x12Mat least one of action_token_site_keys or session_token_site_keys must be set\x1aQthis.action_token_site_keys.size() > 0 || this.session_token_site_keys.size() > 0\"\x80\a\n" +
	...
	"expression\x12w\n" +
	"\fexpr_options\x18\x04 \x01(\v2T.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRecaptchaOptionsR\vexprOptions:\x8a\x04\xbaH\x86\x04\x1a\xd2\x01\n" +
	...
	"\x18key_config_name_coherent\x12cenforce_on_key_name is required for HTTP_HEADER/HTTP_COOKIE key types and must not be set otherwise\x1a`(this.enforce_on_key_type in ['HTTP_HEADER', 'HTTP_COOKIE']) == (this.enforce_on_key_name != '')\"\xd3\x10\n" +
	...
	"\x13enforce_on_key_name\x18\x04 \x01(\tR\x10enforceOnKeyName\x12\x8b\x01\n" +
	"\x16enforce_on_key_configs\x18\x05 \x03(\v2V.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorEnforceOnKeyConfigR\x13enforceOnKeyConfigs\x12\x8b\x01\n" +
	"\x14rate_limit_threshold\x18\x06 \x01(\v2Q.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateThresholdB\x06\xbaH\x03\xc8\x01\x01R\x12rateLimitThreshold\x12v\n" +
	"\rban_threshold\x18\a \x01(\v2Q.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateThresholdR\fbanThreshold\x12\xa7\x01\n" +
	"\x10ban_duration_sec\x18\b \x01(\x05B}\xbaHz\xba\x01w\n" +
	"\x12ban_duration_valid\x125ban_duration_sec must be between 60 and 86400 seconds\x1a*this == 0 || (this >= 60 && this <= 86400)R\x0ebanDurationSec\x12\x8a\x01\n" +
	"\x17exceed_redirect_options\x18\t \x01(\v2R.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRedirectConfigR\x15exceedRedirectOptions:\xca\x04\xbaH\xc6\x04\x1a\xa2\x01\n" +
	...
	"headerName\x12!\n" +
	"\fheader_value\x18\x02 \x01(\tR\vheaderValue\"\xb0\x01\n" +
	"\x19GcpCloudArmorHeaderAction\x12\x92\x01\n" +
	"\x17request_headers_to_adds\x18\x01 \x03(\v2Q.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRequestHeaderB\b\xbaH\x05\x92\x01\x02\b\x01R\x14requestHeadersToAdds\"\xc2\x03\n" +
	...
	"\x18exclusion_value_coherent\x12Kvalue is required for all operators except EQUALS_ANY, which takes no value\x1a5(this.operator == 'EQUALS_ANY') == (this.value == '')\"\x91\x05\n" +
	"\x19GcpCloudArmorWafExclusion\x12.\n" +
	"\x0ftarget_rule_set\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\rtargetRuleSet\x12&\n" +
	"\x0ftarget_rule_ids\x18\x02 \x03(\tR\rtargetRuleIds\x12\x84\x01\n" +
	"\x0frequest_headers\x18\x03 \x03(\v2[.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParamsR\x0erequestHeaders\x12\x84\x01\n" +
	"\x0frequest_cookies\x18\x04 \x03(\v2[.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParamsR\x0erequestCookies\x12~\n" +
	"\frequest_uris\x18\x05 \x03(\v2[.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParamsR\vrequestUris\x12\x8d\x01\n" +
	"\x14request_query_params\x18\x06 \x03(\v2[.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParamsR\x12requestQueryParams\"\xa1\x01\n" +
	"#GcpCloudArmorPreconfiguredWafConfig\x12z\n" +
	"\n" +
	"exclusions\x18\x01 \x03(\v2P.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionB\b\xbaH\x05\x92\x01\x02\b\x01R\n" +
	"exclusions\"\x87\v\n" +
	...
	"\xbaH\a\xc8\x01\x01\x1a\x02(\x00R\bpriority\x12k\n" +
	"\x05match\x18\x03 \x01(\v2M.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRuleMatchB\x06\xbaH\x03\xc8\x01\x01R\x05match\x12)\n" +
	"\vdescription\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x18@R\vdescription\x12\x18\n" +
	"\apreview\x18\x05 \x01(\bR\apreview\x12\x82\x01\n" +
	"\x12rate_limit_options\x18\x06 \x01(\v2T.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateLimitOptionsR\x10rateLimitOptions\x12}\n" +
	"\x10redirect_options\x18\a \x01(\v2R.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRedirectConfigR\x0fredirectOptions\x12u\n" +
	"\rheader_action\x18\b \x01(\v2P.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorHeaderActionR\fheaderAction\x12\x94\x01\n" +
	"\x18preconfigured_waf_config\x18\t \x01(\v2Z.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPreconfiguredWafConfigR\x16preconfiguredWafConfig:\x84\x03\xbaH\x80\x03\x1a\xd0\x01\n" +
	...
	"\x1bgranularity_value_exclusive\x12=enable_each_unique_value can only be true when value is empty\x1a4!(this.enable_each_unique_value && this.value != '')\"\x9f\b\n" +
	...
	"\"detection_relative_to_baseline_qps\x18\b \x01(\x01H\x06R\x1edetectionRelativeToBaselineQps\x88\x01\x01\x12\x9c\x01\n" +
	"\x1btraffic_granularity_configs\x18\t \x03(\v2\\.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorTrafficGranularityConfigR\x19trafficGranularityConfigsB#\n" +
	...
	"#_detection_relative_to_baseline_qps\"\xbd\x04\n" +
	...
	"\x15rule_visibility_valid\x12+rule_visibility must be STANDARD or PREMIUM\x1a-this == '' || this in ['STANDARD', 'PREMIUM']R\x0eruleVisibility\x12\x80\x01\n" +
	"\x11threshold_configs\x18\x03 \x03(\v2S.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorThresholdConfigR\x10thresholdConfigs:\xad\x01\xbaH\xa9\x01\x1a\xa6\x01\n" +
	...
	"\rcontent_types\x18\x01 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\fcontentTypes\"\x95\x06\n" +
	...
	"\x17user_ip_request_headers\x18\x03 \x03(\tR\x14userIpRequestHeaders\x12\x82\x01\n" +
	"\x12json_custom_config\x18\x04 \x01(\v2T.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorJsonCustomConfigR\x10jsonCustomConfig:\xda\x01\xbaH\xd6\x01\x1a\xd3\x01\n" +
	...
	"\x11redirect_site_key\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x0fredirectSiteKey\"\xb3\f\n" +
	...
	"\n" +
	"type_valid\x12Ktype must be CLOUD_ARMOR, CLOUD_ARMOR_EDGE, or CLOUD_ARMOR_INTERNAL_SERVICE\x1aYthis == '' || this in ['CLOUD_ARMOR', 'CLOUD_ARMOR_EDGE', 'CLOUD_ARMOR_INTERNAL_SERVICE']R\x04type\x12\x9a\x01\n" +
	"\x1aadaptive_protection_config\x18\x05 \x01(\v2\\.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdaptiveProtectionConfigR\x18adaptiveProtectionConfig\x12\x91\x01\n" +
	"\x17advanced_options_config\x18\x06 \x01(\v2Y.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdvancedOptionsConfigR\x15advancedOptionsConfig\x12\x94\x01\n" +
	"\x18recaptcha_options_config\x18\a \x01(\v2Z.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRecaptchaOptionsConfigR\x16recaptchaOptionsConfig\x12^\n" +
	"\x05rules\x18\b \x03(\v2H.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRuleR\x05rules:\xea\x02\xbaH\xe6\x02\x1a\xb8\x01\n" +
	...
	"\x16rule_priorities_unique\x12%each rule must have a unique priority\x1agthis.rules.size() == 0 || this.rules.all(r, this.rules.filter(x, x.priority == r.priority).size() == 1)B\xb6\x03\n" +
	"9com.dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1B\tSpecProtoP\x01Zsgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpcloudarmorpolicy/v1alpha1;gcpcloudarmorpolicyv1alpha1\xa2\x02\x05DPPGG\xaa\x025Dev.Planton.Provider.Gcp.Gcpcloudarmorpolicy.V1alpha1\xca\x025Dev\\Planton\\Provider\\Gcp\\Gcpcloudarmorpolicy\\V1alpha1\xe2\x02ADev\\Planton\\Provider\\Gcp\\Gcpcloudarmorpolicy\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Gcp::Gcpcloudarmorpolicy::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_goTypes = []any{
	(*GcpCloudArmorRateThreshold)(nil),            // 0: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateThreshold
	(*GcpCloudArmorRedirectConfig)(nil),           // 1: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRedirectConfig
	(*GcpCloudArmorRecaptchaOptions)(nil),         // 2: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRecaptchaOptions
	(*GcpCloudArmorRuleMatch)(nil),                // 3: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRuleMatch
	(*GcpCloudArmorEnforceOnKeyConfig)(nil),       // 4: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorEnforceOnKeyConfig
	(*GcpCloudArmorRateLimitOptions)(nil),         // 5: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateLimitOptions
	(*GcpCloudArmorRequestHeader)(nil),            // 6: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRequestHeader
	(*GcpCloudArmorHeaderAction)(nil),             // 7: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorHeaderAction
	(*GcpCloudArmorWafExclusionFieldParams)(nil),  // 8: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParams
	(*GcpCloudArmorWafExclusion)(nil),             // 9: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusion
	(*GcpCloudArmorPreconfiguredWafConfig)(nil),   // 10: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPreconfiguredWafConfig
	(*GcpCloudArmorRule)(nil),                     // 11: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRule
	(*GcpCloudArmorTrafficGranularityConfig)(nil), // 12: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorTrafficGranularityConfig
	(*GcpCloudArmorThresholdConfig)(nil),          // 13: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorThresholdConfig
	(*GcpCloudArmorAdaptiveProtectionConfig)(nil), // 14: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdaptiveProtectionConfig
	(*GcpCloudArmorJsonCustomConfig)(nil),         // 15: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorJsonCustomConfig
	(*GcpCloudArmorAdvancedOptionsConfig)(nil),    // 16: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdvancedOptionsConfig
	(*GcpCloudArmorRecaptchaOptionsConfig)(nil),   // 17: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRecaptchaOptionsConfig
	(*GcpCloudArmorPolicySpec)(nil),               // 18: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPolicySpec
	(*v1.StringValueOrRef)(nil),                   // 19: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_depIdxs = []int32{
	2,  // 0: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRuleMatch.expr_options:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRecaptchaOptions
	4,  // 1: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateLimitOptions.enforce_on_key_configs:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorEnforceOnKeyConfig
	0,  // 2: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateLimitOptions.rate_limit_threshold:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateThreshold
	0,  // 3: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateLimitOptions.ban_threshold:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateThreshold
	1,  // 4: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateLimitOptions.exceed_redirect_options:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRedirectConfig
	6,  // 5: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorHeaderAction.request_headers_to_adds:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRequestHeader
	8,  // 6: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusion.request_headers:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParams
	8,  // 7: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusion.request_cookies:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParams
	8,  // 8: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusion.request_uris:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParams
	8,  // 9: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusion.request_query_params:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusionFieldParams
	9,  // 10: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPreconfiguredWafConfig.exclusions:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorWafExclusion
	3,  // 11: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRule.match:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRuleMatch
	5,  // 12: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRule.rate_limit_options:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRateLimitOptions
	1,  // 13: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRule.redirect_options:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRedirectConfig
	7,  // 14: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRule.header_action:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorHeaderAction
	10, // 15: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRule.preconfigured_waf_config:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPreconfiguredWafConfig
	12, // 16: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorThresholdConfig.traffic_granularity_configs:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorTrafficGranularityConfig
	13, // 17: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdaptiveProtectionConfig.threshold_configs:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorThresholdConfig
	15, // 18: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdvancedOptionsConfig.json_custom_config:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorJsonCustomConfig
	19, // 19: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPolicySpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	14, // 20: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPolicySpec.adaptive_protection_config:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdaptiveProtectionConfig
	16, // 21: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPolicySpec.advanced_options_config:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorAdvancedOptionsConfig
	17, // 22: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPolicySpec.recaptcha_options_config:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRecaptchaOptionsConfig
	11, // 23: dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorPolicySpec.rules:type_name -> dev.planton.provider.gcp.gcpcloudarmorpolicy.v1alpha1.GcpCloudArmorRule
...
func init() { file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes[13].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpcloudarmorpolicy_v1alpha1_spec_proto_depIdxs = nil
}
