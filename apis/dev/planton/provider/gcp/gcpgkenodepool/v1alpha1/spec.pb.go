...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpgkenodepool/v1alpha1/spec.proto
...
func (x *GcpGkeNodePoolSpec) Reset() {
	*x = GcpGkeNodePoolSpec{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpGkeNodePoolSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGkeNodePoolAutoscaling) Reset() {
	*x = GcpGkeNodePoolAutoscaling{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolAutoscaling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpGkeNodePoolManagement) Reset() {
	*x = GcpGkeNodePoolManagement{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolManagement) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpGkeNodePoolUpgradeSettings) Reset() {
	*x = GcpGkeNodePoolUpgradeSettings{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolUpgradeSettings) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpGkeNodePoolBlueGreenSettings) Reset() {
	*x = GcpGkeNodePoolBlueGreenSettings{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolBlueGreenSettings) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpGkeNodePoolStandardRolloutPolicy) Reset() {
	*x = GcpGkeNodePoolStandardRolloutPolicy{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolStandardRolloutPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpGkeNodePoolPlacementPolicy) Reset() {
	*x = GcpGkeNodePoolPlacementPolicy{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolPlacementPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpGkeNodePoolNetworkConfig) Reset() {
	*x = GcpGkeNodePoolNetworkConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolNetworkConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpGkeNodePoolNodeConfig) Reset() {
	*x = GcpGkeNodePoolNodeConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolNodeConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpGkeNodePoolTaint) Reset() {
	*x = GcpGkeNodePoolTaint{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolTaint) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *GcpGkeNodePoolGuestAccelerator) Reset() {
	*x = GcpGkeNodePoolGuestAccelerator{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolGuestAccelerator) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *GcpGkeNodePoolGpuSharingConfig) Reset() {
	*x = GcpGkeNodePoolGpuSharingConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolGpuSharingConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *GcpGkeNodePoolShieldedInstanceConfig) Reset() {
	*x = GcpGkeNodePoolShieldedInstanceConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolShieldedInstanceConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *GcpGkeNodePoolConfidentialNodes) Reset() {
	*x = GcpGkeNodePoolConfidentialNodes{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolConfidentialNodes) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *GcpGkeNodePoolEphemeralStorageLocalSsd) Reset() {
	*x = GcpGkeNodePoolEphemeralStorageLocalSsd{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolEphemeralStorageLocalSsd) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *GcpGkeNodePoolLocalNvmeSsdBlock) Reset() {
	*x = GcpGkeNodePoolLocalNvmeSsdBlock{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolLocalNvmeSsdBlock) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *GcpGkeNodePoolReservationAffinity) Reset() {
	*x = GcpGkeNodePoolReservationAffinity{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolReservationAffinity) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{16}
}
...
func (x *GcpGkeNodePoolSecondaryBootDisk) Reset() {
	*x = GcpGkeNodePoolSecondaryBootDisk{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolSecondaryBootDisk) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{17}
}
...
func (x *GcpGkeNodePoolKubeletConfig) Reset() {
	*x = GcpGkeNodePoolKubeletConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolKubeletConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{18}
}
...
func (x *GcpGkeNodePoolLinuxNodeConfig) Reset() {
	*x = GcpGkeNodePoolLinuxNodeConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolLinuxNodeConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{19}
}
...
func (x *GcpGkeNodePoolHugepagesConfig) Reset() {
	*x = GcpGkeNodePoolHugepagesConfig{}
	mi := &file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolHugepagesConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP(), []int{20}
}
...
var File_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";dev/planton/provider/gcp/gcpgkenodepool/v1alpha1/spec.proto\x120dev.planton.provider.gcp.gcpgkenodepool.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xdd\r\n" +
	...
	"\n" +
	"node_count\x18\t \x01(\rH\x00R\tnodeCount\x12o\n" +
	"\vautoscaling\x18\n" +
	" \x01(\v2K.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolAutoscalingH\x00R\vautoscaling\x12j\n" +
	"\n" +
	"management\x18\v \x01(\v2J.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolManagementR\n" +
	"management\x12z\n" +
	"\x10upgrade_settings\x18\f \x01(\v2O.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolUpgradeSettingsR\x0fupgradeSettings\x12z\n" +
	"\x10placement_policy\x18\r \x01(\v2O.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolPlacementPolicyR\x0fplacementPolicy\x12>\n" +
	"\x1bqueued_provisioning_enabled\x18\x0e \x01(\bR\x19queuedProvisioningEnabled\x12t\n" +
	"\x0enetwork_config\x18\x0f \x01(\v2M.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNetworkConfigR\rnetworkConfig\x12k\n" +
	"\vnode_config\x18\x10 \x01(\v2J.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfigR\n" +
	...
	"\x0estrategy_valid\x12,strategy must be empty, SURGE, or BLUE_GREEN\x1a-this == '' || this in ['SURGE', 'BLUE_GREEN']R\bstrategy\x12\x81\x01\n" +
	"\x13blue_green_settings\x18\x04 \x01(\v2Q.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolBlueGreenSettingsR\x11blueGreenSettings:\x8b\x03\xbaH\x87\x03\x1a\xa3\x01\n" +
	...
	"\n" +
	"_max_surgeB\x12\n" +
	"\x10_max_unavailable\"\x8f\x03\n" +
	"\x1fGcpGkeNodePoolBlueGreenSettings\x12\x95\x01\n" +
	"\x17standard_rollout_policy\x18\x01 \x01(\v2U.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolStandardRolloutPolicyB\x06\xbaH\x03\xc8\x01\x01R\x15standardRolloutPolicy\x12\xd3\x01\n" +
	...
	"\foauth_scopes\x18\x06 \x03(\tB\x06\xbaH\x03\xd8\x01\x01R\voauthScopes\x12n\n" +
	"\x06labels\x18\a \x03(\v2V.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.LabelsEntryR\x06labels\x12\x87\x01\n" +
	"\x0fresource_labels\x18\b \x03(\v2^.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.ResourceLabelsEntryR\x0eresourceLabels\x12\x1a\n" +
	"\x04tags\x18\t \x03(\tB\x06\xbaH\x03\xd8\x01\x01R\x04tags\x12t\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2X.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.MetadataEntryR\bmetadata\x12]\n" +
	"\x06taints\x18\v \x03(\v2E.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolTaintR\x06taints\x12\x12\n" +
	"\x04spot\x18\f \x01(\bR\x04spot\x12 \n" +
	"\vpreemptible\x18\r \x01(\bR\vpreemptible\x12\x7f\n" +
	"\x12guest_accelerators\x18\x0e \x03(\v2P.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolGuestAcceleratorR\x11guestAccelerators\x12\x90\x01\n" +
	"\x18shielded_instance_config\x18\x0f \x01(\v2V.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolShieldedInstanceConfigR\x16shieldedInstanceConfig\x12\x80\x01\n" +
	"\x12confidential_nodes\x18\x10 \x01(\v2Q.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolConfidentialNodesR\x11confidentialNodes\x12(\n" +
	"\x10min_cpu_platform\x18\x11 \x01(\tR\x0eminCpuPlatform\x12+\n" +
	"\x0flocal_ssd_count\x18\x12 \x01(\rH\x03R\rlocalSsdCount\x88\x01\x01\x12\x97\x01\n" +
	"\x1bephemeral_storage_local_ssd\x18\x13 \x01(\v2X.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolEphemeralStorageLocalSsdR\x18ephemeralStorageLocalSsd\x12\x82\x01\n" +
	"\x14local_nvme_ssd_block\x18\x14 \x01(\v2Q.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLocalNvmeSsdBlockR\x11localNvmeSsdBlock\x12!\n" +
	...
	"\x1cworkload_metadata_mode_valid\x12Cworkload_metadata_mode must be empty, GCE_METADATA, or GKE_METADATA\x1a6this == '' || this in ['GCE_METADATA', 'GKE_METADATA']R\x14workloadMetadataMode\x12\x86\x01\n" +
	"\x14reservation_affinity\x18\x1a \x01(\v2S.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolReservationAffinityR\x13reservationAffinity\x12\x83\x01\n" +
	"\x14secondary_boot_disks\x18\x1b \x03(\v2Q.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSecondaryBootDiskR\x12secondaryBootDisks\x12t\n" +
	"\x0ekubelet_config\x18\x1c \x01(\v2M.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolKubeletConfigR\rkubeletConfig\x12{\n" +
	"\x11linux_node_config\x18\x1d \x01(\v2O.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfigR\x0flinuxNodeConfig\x12\xb9\x01\n" +
	...
	"\x18gpu_driver_version_valid\x12Kgpu_driver_version must be empty, INSTALLATION_DISABLED, DEFAULT, or LATEST\x1aDthis == '' || this in ['INSTALLATION_DISABLED', 'DEFAULT', 'LATEST']R\x10gpuDriverVersion\x12~\n" +
	"\x12gpu_sharing_config\x18\x05 \x01(\v2P.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolGpuSharingConfigR\x10gpuSharingConfig\"\xb8\x01\n" +
	...
	" _image_gc_high_threshold_percent\"\xbd\x04\n" +
	"\x1dGcpGkeNodePoolLinuxNodeConfig\x12v\n" +
	"\asysctls\x18\x01 \x03(\v2\\.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfig.SysctlsEntryR\asysctls\x12\xeb\x01\n" +
	...
	"cgroupMode\x12z\n" +
	"\x10hugepages_config\x18\x03 \x01(\v2O.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolHugepagesConfigR\x0fhugepagesConfig\x1a:\n" +
	...
	"\x11_hugepage_size_1gB\x93\x03\n" +
	"4com.dev.planton.provider.gcp.gcpgkenodepool.v1alpha1B\tSpecProtoP\x01Zigithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpgkenodepool/v1alpha1;gcpgkenodepoolv1alpha1\xa2\x02\x05DPPGG\xaa\x020Dev.Planton.Provider.Gcp.Gcpgkenodepool.V1alpha1\xca\x020Dev\\Planton\\Provider\\Gcp\\Gcpgkenodepool\\V1alpha1\xe2\x02<Dev\\Planton\\Provider\\Gcp\\Gcpgkenodepool\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Provider::Gcp::Gcpgkenodepool::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_goTypes = []any{
	(*GcpGkeNodePoolSpec)(nil),                     // 0: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec
	(*GcpGkeNodePoolAutoscaling)(nil),              // 1: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolAutoscaling
	(*GcpGkeNodePoolManagement)(nil),               // 2: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolManagement
	(*GcpGkeNodePoolUpgradeSettings)(nil),          // 3: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolUpgradeSettings
	(*GcpGkeNodePoolBlueGreenSettings)(nil),        // 4: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolBlueGreenSettings
	(*GcpGkeNodePoolStandardRolloutPolicy)(nil),    // 5: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolStandardRolloutPolicy
	(*GcpGkeNodePoolPlacementPolicy)(nil),          // 6: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolPlacementPolicy
	(*GcpGkeNodePoolNetworkConfig)(nil),            // 7: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNetworkConfig
	(*GcpGkeNodePoolNodeConfig)(nil),               // 8: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig
	(*GcpGkeNodePoolTaint)(nil),                    // 9: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolTaint
	(*GcpGkeNodePoolGuestAccelerator)(nil),         // 10: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolGuestAccelerator
	(*GcpGkeNodePoolGpuSharingConfig)(nil),         // 11: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolGpuSharingConfig
	(*GcpGkeNodePoolShieldedInstanceConfig)(nil),   // 12: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolShieldedInstanceConfig
	(*GcpGkeNodePoolConfidentialNodes)(nil),        // 13: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolConfidentialNodes
	(*GcpGkeNodePoolEphemeralStorageLocalSsd)(nil), // 14: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolEphemeralStorageLocalSsd
	(*GcpGkeNodePoolLocalNvmeSsdBlock)(nil),        // 15: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLocalNvmeSsdBlock
	(*GcpGkeNodePoolReservationAffinity)(nil),      // 16: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolReservationAffinity
	(*GcpGkeNodePoolSecondaryBootDisk)(nil),        // 17: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSecondaryBootDisk
	(*GcpGkeNodePoolKubeletConfig)(nil),            // 18: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolKubeletConfig
	(*GcpGkeNodePoolLinuxNodeConfig)(nil),          // 19: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfig
	(*GcpGkeNodePoolHugepagesConfig)(nil),          // 20: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolHugepagesConfig
	nil,                                            // 21: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.LabelsEntry
	nil,                                            // 22: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.ResourceLabelsEntry
	nil,                                            // 23: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.MetadataEntry
	nil,                                            // 24: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfig.SysctlsEntry
	(*v1.StringValueOrRef)(nil),                    // 25: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_depIdxs = []int32{
	25, // 0: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	25, // 1: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.cluster_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	25, // 2: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.location:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 3: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.autoscaling:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolAutoscaling
	2,  // 4: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.management:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolManagement
	3,  // 5: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.upgrade_settings:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolUpgradeSettings
	6,  // 6: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.placement_policy:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolPlacementPolicy
	7,  // 7: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.network_config:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNetworkConfig
	8,  // 8: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSpec.node_config:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig
	4,  // 9: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolUpgradeSettings.blue_green_settings:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolBlueGreenSettings
	5,  // 10: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolBlueGreenSettings.standard_rollout_policy:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolStandardRolloutPolicy
	25, // 11: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.service_account:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 12: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.labels:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.LabelsEntry
	22, // 13: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.resource_labels:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.ResourceLabelsEntry
	23, // 14: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.metadata:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.MetadataEntry
	9,  // 15: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.taints:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolTaint
	10, // 16: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.guest_accelerators:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolGuestAccelerator
	12, // 17: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.shielded_instance_config:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolShieldedInstanceConfig
	13, // 18: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.confidential_nodes:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolConfidentialNodes
	14, // 19: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.ephemeral_storage_local_ssd:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolEphemeralStorageLocalSsd
	15, // 20: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.local_nvme_ssd_block:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLocalNvmeSsdBlock
	25, // 21: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.boot_disk_kms_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	16, // 22: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.reservation_affinity:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolReservationAffinity
	17, // 23: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.secondary_boot_disks:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolSecondaryBootDisk
	18, // 24: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.kubelet_config:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolKubeletConfig
	19, // 25: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolNodeConfig.linux_node_config:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfig
	11, // 26: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolGuestAccelerator.gpu_sharing_config:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolGpuSharingConfig
	24, // 27: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfig.sysctls:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfig.SysctlsEntry
	20, // 28: dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolLinuxNodeConfig.hugepages_config:type_name -> dev.planton.provider.gcp.gcpgkenodepool.v1alpha1.GcpGkeNodePoolHugepagesConfig
...
func init() { file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{
		(*GcpGkeNodePoolSpec_NodeCount)(nil),
		(*GcpGkeNodePoolSpec_Autoscaling)(nil),
	}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[8].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[12].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[14].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[18].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes[20].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   25,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpgkenodepool_v1alpha1_spec_proto_depIdxs = nil
}
