...
func globalHealthCheck(ctx *pulumi.Context, locals *Locals, gcpProvider *gcp.Provider, computeApiService pulumi.Resource) error {
	...
	case *gcphealthcheckv1.GcpHealthCheckSpec_Http:
	...
	case *gcphealthcheckv1.GcpHealthCheckSpec_Https:
	...
	case *gcphealthcheckv1.GcpHealthCheckSpec_Http2:
	...
	case *gcphealthcheckv1.GcpHealthCheckSpec_Tcp:
	...
	case *gcphealthcheckv1.GcpHealthCheckSpec_Ssl:
	...
	case *gcphealthcheckv1.GcpHealthCheckSpec_Grpc:
	...
	case *gcphealthcheckv1.GcpHealthCheckSpec_GrpcTls:
