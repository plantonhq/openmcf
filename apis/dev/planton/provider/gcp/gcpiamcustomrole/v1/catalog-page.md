...
- [GcpProjectIamMember](/docs/catalog/gcp/gcpprojectiammember) — grants this role to an identity
- [GcpServiceAccount](/docs/catalog/gcp/gcpserviceaccount) — the identity most commonly granted custom roles
- [GcpProject](/docs/catalog/gcp/gcpproject) — provides the project that owns the role
