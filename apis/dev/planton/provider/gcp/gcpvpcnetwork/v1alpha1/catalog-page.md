...
- [GcpGlobalAddress](/docs/catalog/gcp/gcpglobaladdress) — reserves the VPC_PEERING range used for private services access
- [GcpServiceNetworkingConnection](/docs/catalog/gcp/gcpservicenetworkingconnection) — peers this VPC with Google's managed-service producer network
- [GcpAddress](/docs/catalog/gcp/gcpaddress) — reserves regional static IPs inside this VPC's subnets
...
- [GcpCloudSql](/docs/catalog/gcp/gcpcloudsql) — deploys Cloud SQL instances that use the composed private-services-access pair for private IP connectivity
