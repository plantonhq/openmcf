...
This directory contains the Pulumi implementation for deploying GCP VPC networks using Planton's `GcpVpcNetwork` API. The module is written in Go and leverages the Pulumi GCP provider to create production-ready Virtual Private Cloud networks with best-practice defaults.
...
# Update Planton dependencies to latest
make update-deps
```
...
```go
import (
    gcpvpcnetworkv1 "github.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpvpcnetwork/v1alpha1"
    "github.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpvpcnetwork/v1alpha1/iac/pulumi/module"
)
...
- [Planton Architecture Overview](../../docs/README.md)
...
4. Open an issue in the Planton repository
