...
func buildTaskTemplate(
	spec *gcpcloudrunjobv1.GcpCloudRunJobSpec,
	tmpl *gcpcloudrunjobv1.GcpCloudRunJobTemplate,
	...
	if tmpl.ExecutionEnvironment != gcpcloudrunjobv1.GcpCloudRunJobExecutionEnvironment_EXECUTION_ENVIRONMENT_UNSPECIFIED {
	...
	if len(tmpl.Volumes) > 0 {
		...
		for _, volume := range tmpl.Volumes {
			...
			case *gcpcloudrunjobv1.GcpCloudRunJobVolume_CloudSqlInstance:
			...
			case *gcpcloudrunjobv1.GcpCloudRunJobVolume_Secret:
			...
			case *gcpcloudrunjobv1.GcpCloudRunJobVolume_EmptyDir:
			...
			case *gcpcloudrunjobv1.GcpCloudRunJobVolume_Gcs:
			...
			case *gcpcloudrunjobv1.GcpCloudRunJobVolume_Nfs:
...
func buildContainers(tmpl *gcpcloudrunjobv1.GcpCloudRunJobTemplate) cloudrunv2.JobTemplateTemplateContainerArray {
