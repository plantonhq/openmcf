...
type Locals struct {
	...
	GcpVertexAiIndexEndpoint *gcpvertexaiindexendpointv1.GcpVertexAiIndexEndpoint
	GcpLabels                map[string]string
	Network                  string
}

func initializeLocals(_ *pulumi.Context, stackInput *gcpvertexaiindexendpointv1.GcpVertexAiIndexEndpointStackInput) *Locals {
	locals := &Locals{}
