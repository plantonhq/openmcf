...
- [GcpVertexAiIndex](/docs/catalog/gcp/gcpvertexaiindex) — the vector index deployed onto this endpoint
- [GcpVertexAiDeployedIndex](/docs/catalog/gcp/gcpvertexaideployedindex) — places an index onto this endpoint for querying
- [GcpVpcNetwork](/docs/catalog/gcp/gcpvpcnetwork) — provides the VPC network for peered private endpoints
