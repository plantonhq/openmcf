...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpvertexainotebook/v1alpha1/spec.proto
...
func (x *GcpVertexAiNotebookBootDisk) Reset() {
	*x = GcpVertexAiNotebookBootDisk{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpVertexAiNotebookBootDisk) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpVertexAiNotebookDataDisk) Reset() {
	*x = GcpVertexAiNotebookDataDisk{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookDataDisk) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpVertexAiNotebookAcceleratorConfig) Reset() {
	*x = GcpVertexAiNotebookAcceleratorConfig{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookAcceleratorConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpVertexAiNotebookNetworkInterface) Reset() {
	*x = GcpVertexAiNotebookNetworkInterface{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookNetworkInterface) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpVertexAiNotebookConfidentialInstanceConfig) Reset() {
	*x = GcpVertexAiNotebookConfidentialInstanceConfig{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookConfidentialInstanceConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpVertexAiNotebookReservationAffinity) Reset() {
	*x = GcpVertexAiNotebookReservationAffinity{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookReservationAffinity) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpVertexAiNotebookVmImage) Reset() {
	*x = GcpVertexAiNotebookVmImage{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookVmImage) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpVertexAiNotebookContainerImage) Reset() {
	*x = GcpVertexAiNotebookContainerImage{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookContainerImage) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpVertexAiNotebookShieldedInstanceConfig) Reset() {
	*x = GcpVertexAiNotebookShieldedInstanceConfig{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookShieldedInstanceConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpVertexAiNotebookSpec) Reset() {
	*x = GcpVertexAiNotebookSpec{}
	mi := &file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVertexAiNotebookSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
var File_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/gcp/gcpvertexainotebook/v1alpha1/spec.proto\x125dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\x9a\x04\n" +
	...
	"enableVtpm\x12>\n" +
	"\x1benable_integrity_monitoring\x18\x03 \x01(\bR\x19enableIntegrityMonitoring\"\x80\x18\n" +
	...
	"\x14disable_proxy_access\x18\a \x01(\bR\x12disableProxyAccess\x12x\n" +
	"\bmetadata\x18\b \x03(\v2\\.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.MetadataEntryR\bmetadata\x12r\n" +
	"\x06labels\x18\t \x03(\v2Z.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.LabelsEntryR\x06labels\x12o\n" +
	"\tboot_disk\x18\n" +
	" \x01(\v2R.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookBootDiskR\bbootDisk\x12o\n" +
	"\tdata_disk\x18\v \x01(\v2R.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookDataDiskR\bdataDisk\x12\x8a\x01\n" +
	"\x12accelerator_config\x18\f \x01(\v2[.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookAcceleratorConfigR\x11acceleratorConfig\x12\x87\x01\n" +
	"\x11network_interface\x18\r \x01(\v2Z.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookNetworkInterfaceR\x10networkInterface\x12*\n" +
	...
	"\x04tags\x18\x11 \x03(\tR\x04tags\x12l\n" +
	"\bvm_image\x18\x12 \x01(\v2Q.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookVmImageR\avmImage\x12\x81\x01\n" +
	"\x0fcontainer_image\x18\x13 \x01(\v2X.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookContainerImageR\x0econtainerImage\x12\x9a\x01\n" +
	"\x18shielded_instance_config\x18\x14 \x01(\v2`.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookShieldedInstanceConfigR\x16shieldedInstanceConfig\x12\xa6\x01\n" +
	"\x1cconfidential_instance_config\x18\x15 \x01(\v2d.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookConfidentialInstanceConfigR\x1aconfidentialInstanceConfig\x12\x90\x01\n" +
	"\x14reservation_affinity\x18\x16 \x01(\v2].dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookReservationAffinityR\x13reservationAffinity\x12,\n" +
	...
	",external_ip_conflicts_with_disable_public_ip\x12Jnetwork_interface.external_ip cannot be set when disable_public_ip is true\x1ac!this.disable_public_ip || !has(this.network_interface) || !has(this.network_interface.external_ip)B\xb6\x03\n" +
	"9com.dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1B\tSpecProtoP\x01Zsgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpvertexainotebook/v1alpha1;gcpvertexainotebookv1alpha1\xa2\x02\x05DPPGG\xaa\x025Dev.Planton.Provider.Gcp.Gcpvertexainotebook.V1alpha1\xca\x025Dev\\Planton\\Provider\\Gcp\\Gcpvertexainotebook\\V1alpha1\xe2\x02ADev\\Planton\\Provider\\Gcp\\Gcpvertexainotebook\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Gcp::Gcpvertexainotebook::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_goTypes = []any{
	(*GcpVertexAiNotebookBootDisk)(nil),                   // 0: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookBootDisk
	(*GcpVertexAiNotebookDataDisk)(nil),                   // 1: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookDataDisk
	(*GcpVertexAiNotebookAcceleratorConfig)(nil),          // 2: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookAcceleratorConfig
	(*GcpVertexAiNotebookNetworkInterface)(nil),           // 3: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookNetworkInterface
	(*GcpVertexAiNotebookConfidentialInstanceConfig)(nil), // 4: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookConfidentialInstanceConfig
	(*GcpVertexAiNotebookReservationAffinity)(nil),        // 5: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookReservationAffinity
	(*GcpVertexAiNotebookVmImage)(nil),                    // 6: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookVmImage
	(*GcpVertexAiNotebookContainerImage)(nil),             // 7: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookContainerImage
	(*GcpVertexAiNotebookShieldedInstanceConfig)(nil),     // 8: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookShieldedInstanceConfig
	(*GcpVertexAiNotebookSpec)(nil),                       // 9: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec
	nil,                                                   // 10: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.MetadataEntry
	nil,                                                   // 11: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.LabelsEntry
	(*v1.StringValueOrRef)(nil),                           // 12: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_depIdxs = []int32{
	12, // 0: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookBootDisk.kms_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 1: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookDataDisk.kms_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 2: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookNetworkInterface.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 3: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookNetworkInterface.subnet:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 4: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookNetworkInterface.external_ip:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 5: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	10, // 6: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.metadata:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.MetadataEntry
	11, // 7: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.labels:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.LabelsEntry
	0,  // 8: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.boot_disk:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookBootDisk
	1,  // 9: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.data_disk:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookDataDisk
	2,  // 10: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.accelerator_config:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookAcceleratorConfig
	3,  // 11: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.network_interface:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookNetworkInterface
	12, // 12: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.service_account:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 13: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.vm_image:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookVmImage
	7,  // 14: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.container_image:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookContainerImage
	8,  // 15: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.shielded_instance_config:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookShieldedInstanceConfig
	4,  // 16: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.confidential_instance_config:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookConfidentialInstanceConfig
	5,  // 17: dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookSpec.reservation_affinity:type_name -> dev.planton.provider.gcp.gcpvertexainotebook.v1alpha1.GcpVertexAiNotebookReservationAffinity
...
func init() { file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpvertexainotebook_v1alpha1_spec_proto_depIdxs = nil
}
