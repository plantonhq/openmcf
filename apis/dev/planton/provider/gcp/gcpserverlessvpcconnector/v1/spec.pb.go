...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpserverlessvpcconnector/v1/spec.proto
...
func (x *GcpServerlessVpcConnectorSpec) Reset() {
	*x = GcpServerlessVpcConnectorSpec{}
	mi := &file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_msgTypes[0]
...
func (*GcpServerlessVpcConnectorSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpServerlessVpcConnectorSubnet) Reset() {
	*x = GcpServerlessVpcConnectorSubnet{}
	mi := &file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpServerlessVpcConnectorSubnet) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDesc = "" +
	"\n" +
...
var (
	file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_goTypes = []any{
	(*GcpServerlessVpcConnectorSpec)(nil),   // 0: dev.planton.provider.gcp.gcpserverlessvpcconnector.v1.GcpServerlessVpcConnectorSpec
	(*GcpServerlessVpcConnectorSubnet)(nil), // 1: dev.planton.provider.gcp.gcpserverlessvpcconnector.v1.GcpServerlessVpcConnectorSubnet
	(*v1.StringValueOrRef)(nil),             // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.gcp.gcpserverlessvpcconnector.v1.GcpServerlessVpcConnectorSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.gcp.gcpserverlessvpcconnector.v1.GcpServerlessVpcConnectorSpec.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.gcp.gcpserverlessvpcconnector.v1.GcpServerlessVpcConnectorSpec.subnet:type_name -> dev.planton.provider.gcp.gcpserverlessvpcconnector.v1.GcpServerlessVpcConnectorSubnet
	2, // 3: dev.planton.provider.gcp.gcpserverlessvpcconnector.v1.GcpServerlessVpcConnectorSubnet.name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpserverlessvpcconnector_v1_spec_proto_depIdxs = nil
}
