...
type Locals struct {
	...
	GcpServerlessVpcConnector *gcpserverlessvpcconnectorv1.GcpServerlessVpcConnector
...
func initializeLocals(_ *pulumi.Context, stackInput *gcpserverlessvpcconnectorv1.GcpServerlessVpcConnectorStackInput) *Locals {
	locals := &Locals{}
