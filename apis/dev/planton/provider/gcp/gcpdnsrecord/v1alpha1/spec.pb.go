...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpdnsrecord/v1alpha1/spec.proto
...
func (x *GcpDnsRecordSpec) Reset() {
	*x = GcpDnsRecordSpec{}
	mi := &file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpDnsRecordSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpDnsRecordRoutingPolicy) Reset() {
	*x = GcpDnsRecordRoutingPolicy{}
	mi := &file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpDnsRecordRoutingPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpDnsRecordWrrPolicyItem) Reset() {
	*x = GcpDnsRecordWrrPolicyItem{}
	mi := &file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpDnsRecordWrrPolicyItem) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpDnsRecordGeoPolicyItem) Reset() {
	*x = GcpDnsRecordGeoPolicyItem{}
	mi := &file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpDnsRecordGeoPolicyItem) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpDnsRecordPrimaryBackupPolicy) Reset() {
	*x = GcpDnsRecordPrimaryBackupPolicy{}
	mi := &file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpDnsRecordPrimaryBackupPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpDnsRecordHealthCheckedTargets) Reset() {
	*x = GcpDnsRecordHealthCheckedTargets{}
	mi := &file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpDnsRecordHealthCheckedTargets) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpDnsRecordInternalLoadBalancerTarget) Reset() {
	*x = GcpDnsRecordInternalLoadBalancerTarget{}
	mi := &file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpDnsRecordInternalLoadBalancerTarget) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"9dev/planton/provider/gcp/gcpdnsrecord/v1alpha1/spec.proto\x12.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xec\b\n" +
	...
	"ttlSeconds\x88\x01\x01\x12p\n" +
	"\x0erouting_policy\x18\a \x01(\v2I.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordRoutingPolicyR\rroutingPolicy:\xdc\x03\xbaH\xd8\x03\x1a\x8b\x01\n" +
	...
	"\f_ttl_seconds\"\xe9\x06\n" +
	"\x19GcpDnsRecordRoutingPolicy\x12[\n" +
	"\x03wrr\x18\x01 \x03(\v2I.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordWrrPolicyItemR\x03wrr\x12[\n" +
	"\x03geo\x18\x02 \x03(\v2I.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordGeoPolicyItemR\x03geo\x12,\n" +
	"\x12enable_geo_fencing\x18\x03 \x01(\bR\x10enableGeoFencing\x12v\n" +
	"\x0eprimary_backup\x18\x04 \x01(\v2O.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordPrimaryBackupPolicyR\rprimaryBackup\x12x\n" +
	...
	"'routing_policy.geo_fencing_requires_geo\x12Henable_geo_fencing applies only to geolocation routing (set geo entries)\x1a/!this.enable_geo_fencing || this.geo.size() > 0\"\xf7\x01\n" +
	...
	"\x06values\x18\x02 \x03(\tR\x06values\x12\x86\x01\n" +
	"\x16health_checked_targets\x18\x03 \x01(\v2P.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargetsR\x14healthCheckedTargetsB\t\n" +
	"\a_weight\"\xe0\x01\n" +
	"\x19GcpDnsRecordGeoPolicyItem\x12\"\n" +
	"\blocation\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\blocation\x12\x16\n" +
	"\x06values\x18\x02 \x03(\tR\x06values\x12\x86\x01\n" +
	"\x16health_checked_targets\x18\x03 \x01(\v2P.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargetsR\x14healthCheckedTargets\"\xa2\x03\n" +
	"\x1fGcpDnsRecordPrimaryBackupPolicy\x12r\n" +
	"\aprimary\x18\x01 \x01(\v2P.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargetsB\x06\xbaH\x03\xc8\x01\x01R\aprimary\x12r\n" +
	"\n" +
	"backup_geo\x18\x02 \x03(\v2I.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordGeoPolicyItemB\b\xbaH\x05\x92\x01\x02\b\x01R\tbackupGeo\x12A\n" +
	...
	"\x0e_trickle_ratio\"\xab\x03\n" +
	" GcpDnsRecordHealthCheckedTargets\x12\x8e\x01\n" +
	"\x17internal_load_balancers\x18\x01 \x03(\v2V.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordInternalLoadBalancerTargetR\x15internalLoadBalancers\x12-\n" +
	...
	"\x06region\x18\a \x01(\tR\x06regionB\x85\x03\n" +
	"2com.dev.planton.provider.gcp.gcpdnsrecord.v1alpha1B\tSpecProtoP\x01Zegithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpdnsrecord/v1alpha1;gcpdnsrecordv1alpha1\xa2\x02\x05DPPGG\xaa\x02.Dev.Planton.Provider.Gcp.Gcpdnsrecord.V1alpha1\xca\x02.Dev\\Planton\\Provider\\Gcp\\Gcpdnsrecord\\V1alpha1\xe2\x02:Dev\\Planton\\Provider\\Gcp\\Gcpdnsrecord\\V1alpha1\\GPBMetadata\xea\x023Dev::Planton::Provider::Gcp::Gcpdnsrecord::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_goTypes = []any{
	(*GcpDnsRecordSpec)(nil),                       // 0: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordSpec
	(*GcpDnsRecordRoutingPolicy)(nil),              // 1: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordRoutingPolicy
	(*GcpDnsRecordWrrPolicyItem)(nil),              // 2: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordWrrPolicyItem
	(*GcpDnsRecordGeoPolicyItem)(nil),              // 3: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordGeoPolicyItem
	(*GcpDnsRecordPrimaryBackupPolicy)(nil),        // 4: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordPrimaryBackupPolicy
	(*GcpDnsRecordHealthCheckedTargets)(nil),       // 5: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargets
	(*GcpDnsRecordInternalLoadBalancerTarget)(nil), // 6: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordInternalLoadBalancerTarget
	(*v1.StringValueOrRef)(nil),                    // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_depIdxs = []int32{
	7,  // 0: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 1: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordSpec.managed_zone:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 2: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordSpec.name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 3: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordSpec.values:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 4: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordSpec.routing_policy:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordRoutingPolicy
	2,  // 5: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordRoutingPolicy.wrr:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordWrrPolicyItem
	3,  // 6: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordRoutingPolicy.geo:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordGeoPolicyItem
	4,  // 7: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordRoutingPolicy.primary_backup:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordPrimaryBackupPolicy
	7,  // 8: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordRoutingPolicy.health_check:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 9: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordWrrPolicyItem.health_checked_targets:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargets
	5,  // 10: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordGeoPolicyItem.health_checked_targets:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargets
	5,  // 11: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordPrimaryBackupPolicy.primary:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargets
	3,  // 12: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordPrimaryBackupPolicy.backup_geo:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordGeoPolicyItem
	6,  // 13: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordHealthCheckedTargets.internal_load_balancers:type_name -> dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordInternalLoadBalancerTarget
	7,  // 14: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordInternalLoadBalancerTarget.ip_address:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 15: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordInternalLoadBalancerTarget.network_url:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 16: dev.planton.provider.gcp.gcpdnsrecord.v1alpha1.GcpDnsRecordInternalLoadBalancerTarget.project:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpdnsrecord_v1alpha1_spec_proto_depIdxs = nil
}
