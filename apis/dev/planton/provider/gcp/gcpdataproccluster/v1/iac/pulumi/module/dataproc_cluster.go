...
func diskFields(d *gcpdataprocclusterv1.GcpDataprocClusterDiskConfig) (bootDiskSizeGb *int, bootDiskType *string, numLocalSsds *int, localSsdInterface *string) {
...
func buildClusterConfig(cfg *gcpdataprocclusterv1.GcpDataprocClusterConfig) *dataproc.ClusterClusterConfigArgs {
...
func buildVirtualClusterConfig(vcc *gcpdataprocclusterv1.GcpDataprocClusterVirtualClusterConfig) *dataproc.ClusterVirtualClusterConfigArgs {
