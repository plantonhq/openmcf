...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpredisinstance/v1alpha1/spec.proto
...
func (x *GcpRedisInstanceMaintenanceWindow) Reset() {
	*x = GcpRedisInstanceMaintenanceWindow{}
	mi := &file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpRedisInstanceMaintenanceWindow) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpRedisInstancePersistenceConfig) Reset() {
	*x = GcpRedisInstancePersistenceConfig{}
	mi := &file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpRedisInstancePersistenceConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpRedisInstanceSpec) Reset() {
	*x = GcpRedisInstanceSpec{}
	mi := &file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpRedisInstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/gcp/gcpredisinstance/v1alpha1/spec.proto\x122dev.planton.provider.gcp.gcpredisinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xc1\x01\n" +
	...
	")rdb_snapshot_start_time_requires_rdb_mode\x12Grdb_snapshot_start_time is only meaningful when persistence_mode is RDB\x1aDthis.rdb_snapshot_start_time == '' || this.persistence_mode == 'RDB'\"\xc7\x17\n" +
	...
	"#transit_encryption_mode_valid_value\x12Atransit_encryption_mode must be DISABLED or SERVER_AUTHENTICATION\x1a;this == '' || this in ['DISABLED', 'SERVER_AUTHENTICATION']R\x15transitEncryptionMode\x12\x7f\n" +
	"\rredis_configs\x18\x10 \x03(\v2Z.dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.RedisConfigsEntryR\fredisConfigs\x12\x84\x01\n" +
	"\x12maintenance_window\x18\x11 \x01(\v2U.dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceMaintenanceWindowR\x11maintenanceWindow\x12/\n" +
	...
	"\rreplica_count\x18\x14 \x01(\x05R\freplicaCount\x12\x84\x01\n" +
	"\x12persistence_config\x18\x15 \x01(\v2U.dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstancePersistenceConfigR\x11persistenceConfig\x12\x84\x01\n" +
	...
	" alternative_location_must_differ\x12Aalternative_location_id must be a different zone from location_id\x1aVthis.alternative_location_id == '' || this.alternative_location_id != this.location_idB\xa1\x03\n" +
	"6com.dev.planton.provider.gcp.gcpredisinstance.v1alpha1B\tSpecProtoP\x01Zmgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpredisinstance/v1alpha1;gcpredisinstancev1alpha1\xa2\x02\x05DPPGG\xaa\x022Dev.Planton.Provider.Gcp.Gcpredisinstance.V1alpha1\xca\x022Dev\\Planton\\Provider\\Gcp\\Gcpredisinstance\\V1alpha1\xe2\x02>Dev\\Planton\\Provider\\Gcp\\Gcpredisinstance\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Provider::Gcp::Gcpredisinstance::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_goTypes = []any{
	(*GcpRedisInstanceMaintenanceWindow)(nil), // 0: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceMaintenanceWindow
	(*GcpRedisInstancePersistenceConfig)(nil), // 1: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstancePersistenceConfig
	(*GcpRedisInstanceSpec)(nil),              // 2: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec
	nil,                                       // 3: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.RedisConfigsEntry
	(*v1.StringValueOrRef)(nil),               // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.authorized_network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.redis_configs:type_name -> dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.RedisConfigsEntry
	0, // 3: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.maintenance_window:type_name -> dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceMaintenanceWindow
	1, // 4: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.persistence_config:type_name -> dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstancePersistenceConfig
	4, // 5: dev.planton.provider.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.customer_managed_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpredisinstance_v1alpha1_spec_proto_depIdxs = nil
}
