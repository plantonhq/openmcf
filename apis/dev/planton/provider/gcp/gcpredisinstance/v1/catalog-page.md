...
- [GcpKmsKeyRing](/docs/catalog/gcp/gcpkmskeyring) — manages the key ring containing the KMS key
- [GcpFirewallRule](/docs/catalog/gcp/gcpfirewallrule) — controls network access to the VPC where the instance resides
