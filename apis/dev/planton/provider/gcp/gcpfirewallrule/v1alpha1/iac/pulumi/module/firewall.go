...
import (
	...
	gcpfirewallrulev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpfirewallrule/v1alpha1"
...
func mapToAllowRules(rules []*gcpfirewallrulev1alpha1.GcpFirewallProtocolPort) compute.FirewallAllowArray {
...
func mapToDenyRules(rules []*gcpfirewallrulev1alpha1.GcpFirewallProtocolPort) compute.FirewallDenyArray {
