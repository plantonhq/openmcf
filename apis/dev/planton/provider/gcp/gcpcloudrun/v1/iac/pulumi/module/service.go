...
func service(
	...
	if spec.Ingress != gcpcloudrunv1.GcpCloudRunIngress_INGRESS_TRAFFIC_UNSPECIFIED {
...
func buildTemplate(spec *gcpcloudrunv1.GcpCloudRunSpec) *cloudrunv2.ServiceTemplateArgs {
	...
	if spec.ExecutionEnvironment != gcpcloudrunv1.GcpCloudRunExecutionEnvironment_EXECUTION_ENVIRONMENT_UNSPECIFIED {
	...
	if len(spec.Volumes) > 0 {
		...
		for _, volume := range spec.Volumes {
			...
			case *gcpcloudrunv1.GcpCloudRunVolume_CloudSqlInstance:
			...
			case *gcpcloudrunv1.GcpCloudRunVolume_Secret:
			...
			case *gcpcloudrunv1.GcpCloudRunVolume_EmptyDir:
			...
			case *gcpcloudrunv1.GcpCloudRunVolume_Gcs:
			...
			case *gcpcloudrunv1.GcpCloudRunVolume_Nfs:
...
func buildContainers(spec *gcpcloudrunv1.GcpCloudRunSpec) cloudrunv2.ServiceTemplateContainerArray {
	...
	for _, container := range spec.Containers {
		...
		if container.StartupProbe != nil {
			...
			case *gcpcloudrunv1.GcpCloudRunProbe_HttpGet:
			...
			case *gcpcloudrunv1.GcpCloudRunProbe_TcpSocket:
			...
			case *gcpcloudrunv1.GcpCloudRunProbe_Grpc:
