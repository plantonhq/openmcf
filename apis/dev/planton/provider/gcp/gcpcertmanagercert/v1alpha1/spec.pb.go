...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpcertmanagercert/v1alpha1/spec.proto
...
func (x *GcpCertManagerCertSpec) Reset() {
	*x = GcpCertManagerCertSpec{}
	mi := &file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpCertManagerCertSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpCertManagerCertManaged) Reset() {
	*x = GcpCertManagerCertManaged{}
	mi := &file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCertManagerCertManaged) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpCertManagerCertSelfManaged) Reset() {
	*x = GcpCertManagerCertSelfManaged{}
	mi := &file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCertManagerCertSelfManaged) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"?dev/planton/provider/gcp/gcpcertmanagercert/v1alpha1/spec.proto\x124dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xd1\n" +
	"\n" +
	...
	"\vscope.valid\x12>scope must be DEFAULT, EDGE_CACHE, ALL_REGIONS, or CLIENT_AUTH\x1aMthis == '' || this in ['DEFAULT', 'EDGE_CACHE', 'ALL_REGIONS', 'CLIENT_AUTH']R\x05scope\x12i\n" +
	"\amanaged\x18\x06 \x01(\v2O.dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertManagedR\amanaged\x12v\n" +
	"\fself_managed\x18\a \x01(\v2S.dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSelfManagedR\vselfManaged\x12p\n" +
	"\x06labels\x18\b \x03(\v2X.dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec.LabelsEntryR\x06labels\x1a9\n" +
	...
	"\x17pem_private_key.framing\x12_pem_private_key must be a PEM PRIVATE KEY block (did you swap the certificate and private key?)\x1a\x1cthis.contains('PRIVATE KEY')\xc8\x01\x01\xa0\xa6\x1d\x01R\rpemPrivateKeyB\xaf\x03\n" +
	"8com.dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1B\tSpecProtoP\x01Zqgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpcertmanagercert/v1alpha1;gcpcertmanagercertv1alpha1\xa2\x02\x05DPPGG\xaa\x024Dev.Planton.Provider.Gcp.Gcpcertmanagercert.V1alpha1\xca\x024Dev\\Planton\\Provider\\Gcp\\Gcpcertmanagercert\\V1alpha1\xe2\x02@Dev\\Planton\\Provider\\Gcp\\Gcpcertmanagercert\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Provider::Gcp::Gcpcertmanagercert::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_goTypes = []any{
	(*GcpCertManagerCertSpec)(nil),        // 0: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec
	(*GcpCertManagerCertManaged)(nil),     // 1: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertManaged
	(*GcpCertManagerCertSelfManaged)(nil), // 2: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSelfManaged
	nil,                                   // 3: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec.LabelsEntry
	(*v1.StringValueOrRef)(nil),           // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec.managed:type_name -> dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertManaged
	2, // 2: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec.self_managed:type_name -> dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSelfManaged
	3, // 3: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec.labels:type_name -> dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertSpec.LabelsEntry
	4, // 4: dev.planton.provider.gcp.gcpcertmanagercert.v1alpha1.GcpCertManagerCertManaged.dns_authorizations:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpcertmanagercert_v1alpha1_spec_proto_depIdxs = nil
}
