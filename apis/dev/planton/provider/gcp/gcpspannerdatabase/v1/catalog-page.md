...
- [GcpSpannerInstance](/docs/catalog/gcp/gcpspannerinstance) — the instance this database lives on
- [GcpSpannerBackupSchedule](/docs/catalog/gcp/gcpspannerbackupschedule) — cron-driven full/incremental backups for this database
- [GcpKmsKey](/docs/catalog/gcp/gcpkmskey) — customer-managed encryption keys for CMEK
