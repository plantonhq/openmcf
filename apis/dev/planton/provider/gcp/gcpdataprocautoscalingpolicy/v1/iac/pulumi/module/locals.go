...
type Locals struct {
	...
	GcpDataprocAutoscalingPolicy *gcpdataprocautoscalingpolicyv1.GcpDataprocAutoscalingPolicy
}

func initializeLocals(_ *pulumi.Context, stackInput *gcpdataprocautoscalingpolicyv1.GcpDataprocAutoscalingPolicyStackInput) *Locals {
	locals := &Locals{}
