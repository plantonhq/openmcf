...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpcloudtasksqueue/v1alpha1/spec.proto
...
func (x *GcpCloudTasksQueueHttpHeaderOverride) Reset() {
	*x = GcpCloudTasksQueueHttpHeaderOverride{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpCloudTasksQueueHttpHeaderOverride) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpCloudTasksQueueOAuthToken) Reset() {
	*x = GcpCloudTasksQueueOAuthToken{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueOAuthToken) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpCloudTasksQueueOidcToken) Reset() {
	*x = GcpCloudTasksQueueOidcToken{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueOidcToken) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpCloudTasksQueueUriOverride) Reset() {
	*x = GcpCloudTasksQueueUriOverride{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueUriOverride) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpCloudTasksQueueHttpTarget) Reset() {
	*x = GcpCloudTasksQueueHttpTarget{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueHttpTarget) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpCloudTasksQueueAppEngineRoutingOverride) Reset() {
	*x = GcpCloudTasksQueueAppEngineRoutingOverride{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueAppEngineRoutingOverride) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpCloudTasksQueueRateLimits) Reset() {
	*x = GcpCloudTasksQueueRateLimits{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueRateLimits) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpCloudTasksQueueRetryConfig) Reset() {
	*x = GcpCloudTasksQueueRetryConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueRetryConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpCloudTasksQueueLoggingConfig) Reset() {
	*x = GcpCloudTasksQueueLoggingConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueLoggingConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpCloudTasksQueueSpec) Reset() {
	*x = GcpCloudTasksQueueSpec{}
	mi := &file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudTasksQueueSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
var File_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"?dev/planton/provider/gcp/gcpcloudtasksqueue/v1alpha1/spec.proto\x124dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"^\n" +
	...
	"\x12valid_enforce_mode\x12,enforce_mode must be ALWAYS or IF_NOT_EXISTS\x1a1this == '' || this in ['ALWAYS', 'IF_NOT_EXISTS']R\venforceMode\"\xf7\x06\n" +
	...
	"httpMethod\x12\x85\x01\n" +
	"\x10header_overrides\x18\x02 \x03(\v2Z.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpHeaderOverrideR\x0fheaderOverrides\x12s\n" +
	"\voauth_token\x18\x03 \x01(\v2R.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOAuthTokenR\n" +
	"oauthToken\x12p\n" +
	"\n" +
	"oidc_token\x18\x04 \x01(\v2Q.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOidcTokenR\toidcToken\x12v\n" +
	"\furi_override\x18\x05 \x01(\v2S.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueUriOverrideR\vuriOverride:\x91\x01\xbaH\x8d\x01\x1a\x8a\x01\n" +
	...
	"\x14valid_sampling_ratio\x124sampling_ratio must be between 0.0 and 1.0 inclusive\x1a\x1athis >= 0.0 && this <= 1.0R\rsamplingRatio\"\x93\a\n" +
	...
	"\blocation\x18\x03 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\blocation\x12s\n" +
	"\vhttp_target\x18\x04 \x01(\v2R.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpTargetR\n" +
	"httpTarget\x12\x9f\x01\n" +
	"\x1bapp_engine_routing_override\x18\x05 \x01(\v2`.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueAppEngineRoutingOverrideR\x18appEngineRoutingOverride\x12s\n" +
	"\vrate_limits\x18\x06 \x01(\v2R.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueRateLimitsR\n" +
	"rateLimits\x12v\n" +
	"\fretry_config\x18\a \x01(\v2S.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueRetryConfigR\vretryConfig\x12\x93\x01\n" +
	"\x1astackdriver_logging_config\x18\b \x01(\v2U.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueLoggingConfigR\x18stackdriverLoggingConfigB\xaf\x03\n" +
	"8com.dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1B\tSpecProtoP\x01Zqgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpcloudtasksqueue/v1alpha1;gcpcloudtasksqueuev1alpha1\xa2\x02\x05DPPGG\xaa\x024Dev.Planton.Provider.Gcp.Gcpcloudtasksqueue.V1alpha1\xca\x024Dev\\Planton\\Provider\\Gcp\\Gcpcloudtasksqueue\\V1alpha1\xe2\x02@Dev\\Planton\\Provider\\Gcp\\Gcpcloudtasksqueue\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Provider::Gcp::Gcpcloudtasksqueue::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_goTypes = []any{
	(*GcpCloudTasksQueueHttpHeaderOverride)(nil),       // 0: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpHeaderOverride
	(*GcpCloudTasksQueueOAuthToken)(nil),               // 1: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOAuthToken
	(*GcpCloudTasksQueueOidcToken)(nil),                // 2: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOidcToken
	(*GcpCloudTasksQueueUriOverride)(nil),              // 3: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueUriOverride
	(*GcpCloudTasksQueueHttpTarget)(nil),               // 4: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpTarget
	(*GcpCloudTasksQueueAppEngineRoutingOverride)(nil), // 5: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueAppEngineRoutingOverride
	(*GcpCloudTasksQueueRateLimits)(nil),               // 6: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueRateLimits
	(*GcpCloudTasksQueueRetryConfig)(nil),              // 7: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueRetryConfig
	(*GcpCloudTasksQueueLoggingConfig)(nil),            // 8: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueLoggingConfig
	(*GcpCloudTasksQueueSpec)(nil),                     // 9: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueSpec
	(*v1.StringValueOrRef)(nil),                        // 10: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_depIdxs = []int32{
	10, // 0: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOAuthToken.service_account_email:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	10, // 1: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOidcToken.service_account_email:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 2: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpTarget.header_overrides:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpHeaderOverride
	1,  // 3: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpTarget.oauth_token:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOAuthToken
	2,  // 4: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpTarget.oidc_token:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueOidcToken
	3,  // 5: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpTarget.uri_override:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueUriOverride
	10, // 6: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 7: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueSpec.http_target:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueHttpTarget
	5,  // 8: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueSpec.app_engine_routing_override:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueAppEngineRoutingOverride
	6,  // 9: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueSpec.rate_limits:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueRateLimits
	7,  // 10: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueSpec.retry_config:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueRetryConfig
	8,  // 11: dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueSpec.stackdriver_logging_config:type_name -> dev.planton.provider.gcp.gcpcloudtasksqueue.v1alpha1.GcpCloudTasksQueueLoggingConfig
...
func init() { file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpcloudtasksqueue_v1alpha1_spec_proto_depIdxs = nil
}
