...
// HTTP default).
func isEventTrigger(spec *gcpcloudfunctionv1.GcpCloudFunctionSpec) bool {
	return spec.Trigger != nil &&
		spec.Trigger.TriggerType == gcpcloudfunctionv1.GcpCloudFunctionTriggerType_EVENT_TRIGGER &&
...
func needsEffectiveProject(spec *gcpcloudfunctionv1.GcpCloudFunctionSpec) bool {
	if spec.ServiceConfig == nil {
		return false
	}
...
func buildConfig(spec *gcpcloudfunctionv1.GcpCloudFunctionSpec) *cloudfunctionsv2.FunctionBuildConfigArgs {
	bc := spec.BuildConfig
	...
	if bc.UpdatePolicy == gcpcloudfunctionv1.GcpCloudFunctionBuildUpdatePolicy_ON_DEPLOY {
...
func serviceConfig(spec *gcpcloudfunctionv1.GcpCloudFunctionSpec, effectiveProject string) *cloudfunctionsv2.FunctionServiceConfigArgs {
	...
	if sc.VpcConnector.GetValue() != "" {
		...
		if sc.VpcConnectorEgressSettings != gcpcloudfunctionv1.GcpCloudFunctionVpcEgressSetting_PRIVATE_RANGES_ONLY {
			serviceArgs.VpcConnectorEgressSettings = pulumi.String(sc.VpcConnectorEgressSettings.String())
		}
	}
	if sc.IngressSettings != gcpcloudfunctionv1.GcpCloudFunctionIngressSetting_ALLOW_ALL {
...
func eventTrigger(spec *gcpcloudfunctionv1.GcpCloudFunctionSpec) *cloudfunctionsv2.FunctionEventTriggerArgs {
	...
	if et.RetryPolicy != gcpcloudfunctionv1.GcpCloudFunctionRetryPolicy_RETRY_POLICY_DO_NOT_RETRY {
