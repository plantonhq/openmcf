...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpcloudfunction/v1alpha1/spec.proto
...
func (GcpCloudFunctionBuildUpdatePolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpCloudFunctionBuildUpdatePolicy) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[0]
}
...
func (GcpCloudFunctionBuildUpdatePolicy) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (GcpCloudFunctionTriggerType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (GcpCloudFunctionTriggerType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[1]
}
...
func (GcpCloudFunctionTriggerType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (GcpCloudFunctionIngressSetting) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (GcpCloudFunctionIngressSetting) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[2]
}
...
func (GcpCloudFunctionIngressSetting) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (GcpCloudFunctionVpcEgressSetting) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[3].Descriptor()
}

func (GcpCloudFunctionVpcEgressSetting) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[3]
}
...
func (GcpCloudFunctionVpcEgressSetting) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (GcpCloudFunctionRetryPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[4].Descriptor()
}

func (GcpCloudFunctionRetryPolicy) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes[4]
}
...
func (GcpCloudFunctionRetryPolicy) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpCloudFunctionSpec) Reset() {
	*x = GcpCloudFunctionSpec{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[0]
...
type GcpCloudFunctionBuildConfig struct {
	...
	// between deploys.
	UpdatePolicy  GcpCloudFunctionBuildUpdatePolicy `protobuf:"varint,8,opt,name=update_policy,json=updatePolicy,proto3,enum=dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildUpdatePolicy" json:"update_policy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GcpCloudFunctionBuildConfig) Reset() {
	*x = GcpCloudFunctionBuildConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GcpCloudFunctionSource) Reset() {
	*x = GcpCloudFunctionSource{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GcpCloudFunctionStorageSource) Reset() {
	*x = GcpCloudFunctionStorageSource{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GcpCloudFunctionRepoSource) Reset() {
	*x = GcpCloudFunctionRepoSource{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type GcpCloudFunctionServiceConfig struct {
	...
	VpcConnectorEgressSettings GcpCloudFunctionVpcEgressSetting `protobuf:"varint,10,opt,name=vpc_connector_egress_settings,json=vpcConnectorEgressSettings,proto3,enum=dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionVpcEgressSetting" json:"vpc_connector_egress_settings,omitempty"`
	...
	IngressSettings GcpCloudFunctionIngressSetting `protobuf:"varint,11,opt,name=ingress_settings,json=ingressSettings,proto3,enum=dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionIngressSetting" json:"ingress_settings,omitempty"`
...
func (x *GcpCloudFunctionServiceConfig) Reset() {
	*x = GcpCloudFunctionServiceConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionServiceConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpCloudFunctionSecretEnvVar) Reset() {
	*x = GcpCloudFunctionSecretEnvVar{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionSecretEnvVar) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpCloudFunctionSecretVolume) Reset() {
	*x = GcpCloudFunctionSecretVolume{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionSecretVolume) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpCloudFunctionSecretVolumeVersion) Reset() {
	*x = GcpCloudFunctionSecretVolumeVersion{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionSecretVolumeVersion) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpCloudFunctionScalingConfig) Reset() {
	*x = GcpCloudFunctionScalingConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionScalingConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
type GcpCloudFunctionTrigger struct {
	...
	TriggerType GcpCloudFunctionTriggerType `protobuf:"varint,1,opt,name=trigger_type,json=triggerType,proto3,enum=dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTriggerType" json:"trigger_type,omitempty"`
...
func (x *GcpCloudFunctionTrigger) Reset() {
	*x = GcpCloudFunctionTrigger{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionTrigger) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
type GcpCloudFunctionEventTrigger struct {
	...
	RetryPolicy GcpCloudFunctionRetryPolicy `protobuf:"varint,5,opt,name=retry_policy,json=retryPolicy,proto3,enum=dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionRetryPolicy" json:"retry_policy,omitempty"`
...
func (x *GcpCloudFunctionEventTrigger) Reset() {
	*x = GcpCloudFunctionEventTrigger{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionEventTrigger) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *GcpCloudFunctionEventFilter) Reset() {
	*x = GcpCloudFunctionEventFilter{}
	mi := &file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionEventFilter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
var File_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"=dev/planton/provider/gcp/gcpcloudfunction/v1alpha1/spec.proto\x122dev.planton.provider.gcp.gcpcloudfunction.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xb8\a\n" +
	...
	"\x06labels\x18\x05 \x03(\v2T.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.LabelsEntryR\x06labels\x12t\n" +
	...
	"kmsKeyName\x12z\n" +
	"\fbuild_config\x18\a \x01(\v2O.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfigB\x06\xbaH\x03\xc8\x01\x01R\vbuildConfig\x12x\n" +
	"\x0eservice_config\x18\b \x01(\v2Q.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfigR\rserviceConfig\x12e\n" +
	"\atrigger\x18\t \x01(\v2K.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTriggerR\atrigger\x1a9\n" +
	...
	"entryPoint\x12j\n" +
	"\x06source\x18\x03 \x01(\v2J.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSourceB\x06\xbaH\x03\xc8\x01\x01R\x06source\x12\xae\x01\n" +
	"\x1bbuild_environment_variables\x18\x04 \x03(\v2n.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.BuildEnvironmentVariablesEntryR\x19buildEnvironmentVariables\x12y\n" +
	...
	"\x11docker_repository\x18\a \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB'\x88\xd4a\xb8\x17\x92\xd4a\x1estatus.outputs.repository_pathR\x10dockerRepository\x12\x89\x01\n" +
	"\rupdate_policy\x18\b \x01(\x0e2U.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildUpdatePolicyB\r\x92\xa6\x1d\tAUTOMATICR\fupdatePolicy\x1aL\n" +
	"\x1eBuildEnvironmentVariablesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xdf\x03\n" +
	"\x16GcpCloudFunctionSource\x12x\n" +
	"\x0estorage_source\x18\x01 \x01(\v2Q.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionStorageSourceR\rstorageSource\x12o\n" +
	"\vrepo_source\x18\x02 \x01(\v2N.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionRepoSourceR\n" +
	...
	" repo_source.exactly_one_revision\x12Ipin the source to exactly one revision: branchName, tagName, or commitSha\x1ag(this.branch_name != '' ? 1 : 0) + (this.tag_name != '' ? 1 : 0) + (this.commit_sha != '' ? 1 : 0) == 1\"\x81\x0e\n" +
	...
	"\xd8\x01\x01\x1a\x05\x18\xe8\a(\x01\x92\xa6\x1d\x011R\x1dmaxInstanceRequestConcurrency\x12\xa0\x01\n" +
	"\x15environment_variables\x18\x06 \x03(\v2k.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.EnvironmentVariablesEntryR\x14environmentVariables\x12\x92\x01\n" +
	"\x1csecret_environment_variables\x18\a \x03(\v2P.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretEnvVarR\x1asecretEnvironmentVariables\x12w\n" +
	"\x0esecret_volumes\x18\b \x03(\v2P.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretVolumeR\rsecretVolumes\x12z\n" +
	"\rvpc_connector\x18\t \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\xb1\x18\x92\xd4a\x18status.outputs.self_linkR\fvpcConnector\x12\xb0\x01\n" +
	"\x1dvpc_connector_egress_settings\x18\n" +
	" \x01(\x0e2T.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionVpcEgressSettingB\x17\x92\xa6\x1d\x13PRIVATE_RANGES_ONLYR\x1avpcConnectorEgressSettings\x12\x8c\x01\n" +
	"\x10ingress_settings\x18\v \x01(\x0e2R.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionIngressSettingB\r\x92\xa6\x1d\tALLOW_ALLR\x0fingressSettings\x12k\n" +
	"\ascaling\x18\f \x01(\v2Q.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionScalingConfigR\ascaling\x12Q\n" +
	...
	"\n" +
	"project_id\x18\x04 \x01(\tR\tprojectId\"\xe9\x02\n" +
	...
	"\bversions\x18\x04 \x03(\v2W.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretVolumeVersionR\bversions\"k\n" +
	...
	"\x13scaling.min_lte_max\x12/minInstanceCount cannot exceed maxInstanceCount\x1a2this.min_instance_count <= this.max_instance_count\"\xbf\x03\n" +
	"\x17GcpCloudFunctionTrigger\x12|\n" +
	"\ftrigger_type\x18\x01 \x01(\x0e2O.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTriggerTypeB\b\x92\xa6\x1d\x04HTTPR\vtriggerType\x12u\n" +
	"\revent_trigger\x18\x02 \x01(\v2P.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventTriggerR\feventTrigger:\xae\x01\xbaH\xaa\x01\x1a\xa7\x01\n" +
	"\x1etrigger.event_trigger_required\x12Ran EVENT_TRIGGER function needs the eventTrigger block (eventType and its filters)\x1a1this.trigger_type != 1 || has(this.event_trigger)\"\x9f\x05\n" +
	"\x1cGcpCloudFunctionEventTrigger\x12)\n" +
	"\n" +
	"event_type\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\teventType\x12w\n" +
	"\fpubsub_topic\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xf4\x17\x92\xd4a\x17status.outputs.topic_idR\vpubsubTopic\x12t\n" +
	"\revent_filters\x18\x03 \x03(\v2O.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventFilterR\feventFilters\x12I\n" +
	"\x0etrigger_region\x18\x04 \x01(\tB\"\xbaH\x1f\xd8\x01\x01r\x1a2\x18^[a-z]+(-[a-z]+[0-9]+)?$R\rtriggerRegion\x12\x91\x01\n" +
	"\fretry_policy\x18\x05 \x01(\x0e2O.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionRetryPolicyB\x1d\x92\xa6\x1d\x19RETRY_POLICY_DO_NOT_RETRYR\vretryPolicy\x12\x85\x01\n" +
	...
	"\x12RETRY_POLICY_RETRY\x10\x01B\xa1\x03\n" +
	"6com.dev.planton.provider.gcp.gcpcloudfunction.v1alpha1B\tSpecProtoP\x01Zmgithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpcloudfunction/v1alpha1;gcpcloudfunctionv1alpha1\xa2\x02\x05DPPGG\xaa\x022Dev.Planton.Provider.Gcp.Gcpcloudfunction.V1alpha1\xca\x022Dev\\Planton\\Provider\\Gcp\\Gcpcloudfunction\\V1alpha1\xe2\x02>Dev\\Planton\\Provider\\Gcp\\Gcpcloudfunction\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Provider::Gcp::Gcpcloudfunction::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_goTypes = []any{
	(GcpCloudFunctionBuildUpdatePolicy)(0),      // 0: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildUpdatePolicy
	(GcpCloudFunctionTriggerType)(0),            // 1: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTriggerType
	(GcpCloudFunctionIngressSetting)(0),         // 2: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionIngressSetting
	(GcpCloudFunctionVpcEgressSetting)(0),       // 3: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionVpcEgressSetting
	(GcpCloudFunctionRetryPolicy)(0),            // 4: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionRetryPolicy
	(*GcpCloudFunctionSpec)(nil),                // 5: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec
	(*GcpCloudFunctionBuildConfig)(nil),         // 6: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig
	(*GcpCloudFunctionSource)(nil),              // 7: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSource
	(*GcpCloudFunctionStorageSource)(nil),       // 8: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionStorageSource
	(*GcpCloudFunctionRepoSource)(nil),          // 9: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionRepoSource
	(*GcpCloudFunctionServiceConfig)(nil),       // 10: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig
	(*GcpCloudFunctionSecretEnvVar)(nil),        // 11: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretEnvVar
	(*GcpCloudFunctionSecretVolume)(nil),        // 12: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretVolume
	(*GcpCloudFunctionSecretVolumeVersion)(nil), // 13: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretVolumeVersion
	(*GcpCloudFunctionScalingConfig)(nil),       // 14: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionScalingConfig
	(*GcpCloudFunctionTrigger)(nil),             // 15: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTrigger
	(*GcpCloudFunctionEventTrigger)(nil),        // 16: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventTrigger
	(*GcpCloudFunctionEventFilter)(nil),         // 17: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventFilter
	nil,                                         // 18: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.LabelsEntry
	nil,                                         // 19: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.BuildEnvironmentVariablesEntry
	nil,                                         // 20: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.EnvironmentVariablesEntry
	(*v1.StringValueOrRef)(nil),                 // 21: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_depIdxs = []int32{
	21, // 0: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	18, // 1: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.labels:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.LabelsEntry
	21, // 2: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.kms_key_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 3: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.build_config:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig
	10, // 4: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.service_config:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig
	15, // 5: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSpec.trigger:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTrigger
	7,  // 6: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.source:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSource
	19, // 7: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.build_environment_variables:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.BuildEnvironmentVariablesEntry
	21, // 8: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.service_account:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 9: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.docker_repository:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 10: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildConfig.update_policy:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionBuildUpdatePolicy
	8,  // 11: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSource.storage_source:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionStorageSource
	9,  // 12: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSource.repo_source:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionRepoSource
	21, // 13: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionStorageSource.bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 14: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.service_account_email:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	20, // 15: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.environment_variables:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.EnvironmentVariablesEntry
	11, // 16: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.secret_environment_variables:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretEnvVar
	12, // 17: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.secret_volumes:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretVolume
	21, // 18: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.vpc_connector:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 19: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.vpc_connector_egress_settings:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionVpcEgressSetting
	2,  // 20: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.ingress_settings:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionIngressSetting
	14, // 21: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionServiceConfig.scaling:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionScalingConfig
	13, // 22: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretVolume.versions:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionSecretVolumeVersion
	1,  // 23: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTrigger.trigger_type:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTriggerType
	16, // 24: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionTrigger.event_trigger:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventTrigger
	21, // 25: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventTrigger.pubsub_topic:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	17, // 26: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventTrigger.event_filters:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventFilter
	4,  // 27: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventTrigger.retry_policy:type_name -> dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionRetryPolicy
	21, // 28: dev.planton.provider.gcp.gcpcloudfunction.v1alpha1.GcpCloudFunctionEventTrigger.service_account_email:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpcloudfunction_v1alpha1_spec_proto_depIdxs = nil
}
