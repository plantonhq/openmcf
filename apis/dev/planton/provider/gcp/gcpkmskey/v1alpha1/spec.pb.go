...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpkmskey/v1alpha1/spec.proto
...
func (x *GcpKmsKeyVersionTemplate) Reset() {
	*x = GcpKmsKeyVersionTemplate{}
	mi := &file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpKmsKeyVersionTemplate) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpKmsKeySpec) Reset() {
	*x = GcpKmsKeySpec{}
	mi := &file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpKmsKeySpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"6dev/planton/provider/gcp/gcpkmskey/v1alpha1/spec.proto\x12+dev.planton.provider.gcp.gcpkmskey.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\x9e\x02\n" +
	...
	"\x16valid_protection_level\x12Fprotection_level must be one of: SOFTWARE, HSM, EXTERNAL, EXTERNAL_VPC\x1aEthis == '' || this in ['SOFTWARE', 'HSM', 'EXTERNAL', 'EXTERNAL_VPC']R\x0fprotectionLevel\"\xbc\x10\n" +
	"\rGcpKmsKeySpec\x12}\n" +
	...
	"\x1dvalid_destroy_duration_format\x12Wdestroy_scheduled_duration must be a duration in seconds (e.g., '2592000s' for 30 days)\x1a7this == '' || this.matches('^[0-9]+(\\\\.[0-9]{1,9})?s$')R\x18destroyScheduledDuration\x12p\n" +
	"\x10version_template\x18\x06 \x01(\v2E.dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeyVersionTemplateR\x0fversionTemplate\x12A\n" +
	"\x1dskip_initial_version_creation\x18\a \x01(\bR\x1askipInitialVersionCreation\x12\x1f\n" +
	"\vimport_only\x18\b \x01(\bR\n" +
	"importOnly\x12`\n" +
	"\x12crypto_key_backend\x18\t \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefR\x10cryptoKeyBackend\x12^\n" +
	"\x06labels\x18\n" +
	" \x03(\v2F.dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.LabelsEntryR\x06labels\x1a9\n" +
	...
	"(crypto_key_backend_requires_external_vpc\x12\xa3\x01crypto_key_backend applies only to keys with version_template.protection_level EXTERNAL_VPC (EXTERNAL keys link material per version via external key URIs instead)\x1ay!has(this.crypto_key_backend) || (has(this.version_template) && this.version_template.protection_level == 'EXTERNAL_VPC')B\xf0\x02\n" +
	"/com.dev.planton.provider.gcp.gcpkmskey.v1alpha1B\tSpecProtoP\x01Z_github.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpkmskey/v1alpha1;gcpkmskeyv1alpha1\xa2\x02\x05DPPGG\xaa\x02+Dev.Planton.Provider.Gcp.Gcpkmskey.V1alpha1\xca\x02+Dev\\Planton\\Provider\\Gcp\\Gcpkmskey\\V1alpha1\xe2\x027Dev\\Planton\\Provider\\Gcp\\Gcpkmskey\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Provider::Gcp::Gcpkmskey::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_goTypes = []any{
	(*GcpKmsKeyVersionTemplate)(nil), // 0: dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeyVersionTemplate
	(*GcpKmsKeySpec)(nil),            // 1: dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec
	nil,                              // 2: dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.LabelsEntry
	(*v1.StringValueOrRef)(nil),      // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.key_ring_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 1: dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.version_template:type_name -> dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeyVersionTemplate
	3, // 2: dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.crypto_key_backend:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.labels:type_name -> dev.planton.provider.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.LabelsEntry
...
func init() { file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpkmskey_v1alpha1_spec_proto_depIdxs = nil
}
