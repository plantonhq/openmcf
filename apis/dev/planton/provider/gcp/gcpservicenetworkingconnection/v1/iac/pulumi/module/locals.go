...
type Locals struct {
	GcpServiceNetworkingConnection *gcpservicenetworkingconnectionv1.GcpServiceNetworkingConnection
...
func initializeLocals(ctx *pulumi.Context, stackInput *gcpservicenetworkingconnectionv1.GcpServiceNetworkingConnectionStackInput) *Locals {
