...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpglobaladdress/v1/spec.proto
...
func (x *GcpGlobalAddressSpec) Reset() {
	*x = GcpGlobalAddressSpec{}
	mi := &file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_msgTypes[0]
...
func (*GcpGlobalAddressSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDesc = "" +
	...
	"0com.dev.planton.provider.gcp.gcpglobaladdress.v1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpglobaladdress/v1;gcpglobaladdressv1\xa2\x02\x05DPPGG\xaa\x02,Dev.Planton.Provider.Gcp.Gcpglobaladdress.V1\xca\x02,Dev\\Planton\\Provider\\Gcp\\Gcpglobaladdress\\V1\xe2\x028Dev\\Planton\\Provider\\Gcp\\Gcpglobaladdress\\V1\\GPBMetadata\xea\x021Dev::Planton::Provider::Gcp::Gcpglobaladdress::V1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_goTypes = []any{
	(*GcpGlobalAddressSpec)(nil), // 0: dev.planton.provider.gcp.gcpglobaladdress.v1.GcpGlobalAddressSpec
	(*v1.StringValueOrRef)(nil),  // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.gcp.gcpglobaladdress.v1.GcpGlobalAddressSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.gcp.gcpglobaladdress.v1.GcpGlobalAddressSpec.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpglobaladdress_v1_spec_proto_depIdxs = nil
}
