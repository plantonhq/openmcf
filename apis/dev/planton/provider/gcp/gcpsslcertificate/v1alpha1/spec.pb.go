...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpsslcertificate/v1alpha1/spec.proto
...
func (x *GcpSslCertificateSpec) Reset() {
	*x = GcpSslCertificateSpec{}
	mi := &file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpSslCertificateSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/gcp/gcpsslcertificate/v1alpha1/spec.proto\x123dev.planton.provider.gcp.gcpsslcertificate.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xf2\t\n" +
	...
	"privateKeyB\xa8\x03\n" +
	"7com.dev.planton.provider.gcp.gcpsslcertificate.v1alpha1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpsslcertificate/v1alpha1;gcpsslcertificatev1alpha1\xa2\x02\x05DPPGG\xaa\x023Dev.Planton.Provider.Gcp.Gcpsslcertificate.V1alpha1\xca\x023Dev\\Planton\\Provider\\Gcp\\Gcpsslcertificate\\V1alpha1\xe2\x02?Dev\\Planton\\Provider\\Gcp\\Gcpsslcertificate\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Provider::Gcp::Gcpsslcertificate::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_goTypes = []any{
	(*GcpSslCertificateSpec)(nil), // 0: dev.planton.provider.gcp.gcpsslcertificate.v1alpha1.GcpSslCertificateSpec
	(*v1.StringValueOrRef)(nil),   // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.gcp.gcpsslcertificate.v1alpha1.GcpSslCertificateSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpsslcertificate_v1alpha1_spec_proto_depIdxs = nil
}
