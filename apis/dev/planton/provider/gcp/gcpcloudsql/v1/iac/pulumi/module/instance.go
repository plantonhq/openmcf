...
func buildIpConfiguration(network *gcpcloudsqlv1.GcpCloudSqlNetwork) *sql.DatabaseInstanceSettingsIpConfigurationArgs {
	if network == nil {
...
func buildReplicaConfiguration(rc *gcpcloudsqlv1.GcpCloudSqlReplicaConfiguration) *sql.DatabaseInstanceReplicaConfigurationArgs {
	if rc == nil {
		return nil
	}
