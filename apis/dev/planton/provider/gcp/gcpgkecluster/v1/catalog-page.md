...
- [GcpKmsKey](/docs/catalog/gcp/gcpkmskey) — CMEK key for etcd secrets encryption
- [GcpGkeWorkloadIdentityBinding](/docs/catalog/gcp/gcpgkeworkloadidentitybinding) — binds Kubernetes service accounts to IAM service accounts
- [GcpPubSubTopic](/docs/catalog/gcp/gcppubsubtopic) — receives cluster lifecycle notifications
- [GcpBigQueryDataset](/docs/catalog/gcp/gcpbigquerydataset) — receives resource-usage export records
