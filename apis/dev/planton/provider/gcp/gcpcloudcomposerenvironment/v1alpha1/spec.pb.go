...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpcloudcomposerenvironment/v1alpha1/spec.proto
...
func (x *GcpCloudComposerEnvironmentSpec) Reset() {
	*x = GcpCloudComposerEnvironmentSpec{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpCloudComposerEnvironmentSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpCloudComposerNodeConfig) Reset() {
	*x = GcpCloudComposerNodeConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerNodeConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpCloudComposerIpAllocationPolicy) Reset() {
	*x = GcpCloudComposerIpAllocationPolicy{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerIpAllocationPolicy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpCloudComposerSoftwareConfig) Reset() {
	*x = GcpCloudComposerSoftwareConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerSoftwareConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpCloudComposerCloudDataLineageIntegration) Reset() {
	*x = GcpCloudComposerCloudDataLineageIntegration{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerCloudDataLineageIntegration) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpCloudComposerPrivateEnvironmentConfig) Reset() {
	*x = GcpCloudComposerPrivateEnvironmentConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerPrivateEnvironmentConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpCloudComposerWorkloadsConfig) Reset() {
	*x = GcpCloudComposerWorkloadsConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerWorkloadsConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpCloudComposerWorkloadResource) Reset() {
	*x = GcpCloudComposerWorkloadResource{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerWorkloadResource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpCloudComposerWebServerResource) Reset() {
	*x = GcpCloudComposerWebServerResource{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerWebServerResource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpCloudComposerWorkerResource) Reset() {
	*x = GcpCloudComposerWorkerResource{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerWorkerResource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *GcpCloudComposerTriggererResource) Reset() {
	*x = GcpCloudComposerTriggererResource{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerTriggererResource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *GcpCloudComposerMaintenanceWindow) Reset() {
	*x = GcpCloudComposerMaintenanceWindow{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerMaintenanceWindow) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *GcpCloudComposerRecoveryConfig) Reset() {
	*x = GcpCloudComposerRecoveryConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerRecoveryConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *GcpCloudComposerWebServerAccessControl) Reset() {
	*x = GcpCloudComposerWebServerAccessControl{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerWebServerAccessControl) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *GcpCloudComposerAllowedIpRange) Reset() {
	*x = GcpCloudComposerAllowedIpRange{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerAllowedIpRange) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *GcpCloudComposerMasterAuthorizedNetworksConfig) Reset() {
	*x = GcpCloudComposerMasterAuthorizedNetworksConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerMasterAuthorizedNetworksConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *GcpCloudComposerCidrBlock) Reset() {
	*x = GcpCloudComposerCidrBlock{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerCidrBlock) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{16}
}
...
func (x *GcpCloudComposerDataRetentionConfig) Reset() {
	*x = GcpCloudComposerDataRetentionConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudComposerDataRetentionConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{17}
}
...
var File_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Hdev/planton/provider/gcp/gcpcloudcomposerenvironment/v1alpha1/spec.proto\x12=dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xa6\x13\n" +
	...
	"\x10environment_name\x18\x03 \x01(\tB+\xbaH(r&2$^([a-z]([a-z0-9-]{0,62}[a-z0-9])?)?$R\x0fenvironmentName\x12z\n" +
	"\vnode_config\x18\x04 \x01(\v2Y.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerNodeConfigR\n" +
	"nodeConfig\x12\x86\x01\n" +
	"\x0fsoftware_config\x18\x05 \x01(\v2].dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfigR\x0esoftwareConfig\x12\xa5\x01\n" +
	"\x1aprivate_environment_config\x18\x06 \x01(\v2g.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerPrivateEnvironmentConfigR\x18privateEnvironmentConfig\x12\x89\x01\n" +
	"\x10workloads_config\x18\a \x01(\v2^.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfigR\x0fworkloadsConfig\x12\x99\x01\n" +
	...
	"kmsKeyName\x12\x8f\x01\n" +
	"\x12maintenance_window\x18\v \x01(\v2`.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerMaintenanceWindowR\x11maintenanceWindow\x12\x86\x01\n" +
	"\x0frecovery_config\x18\f \x01(\v2].dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerRecoveryConfigR\x0erecoveryConfig\x12\xaf\x01\n" +
	"!web_server_network_access_control\x18\r \x01(\v2e.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWebServerAccessControlR\x1dwebServerNetworkAccessControl\x12\xb8\x01\n" +
	"!master_authorized_networks_config\x18\x0e \x01(\v2m.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerMasterAuthorizedNetworksConfigR\x1emasterAuthorizedNetworksConfig\x12\x96\x01\n" +
	"\x15data_retention_config\x18\x0f \x01(\v2b.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerDataRetentionConfigR\x13dataRetentionConfig\x12|\n" +
	...
	"\x1aenable_private_builds_only\x18\x12 \x01(\bR\x17enablePrivateBuildsOnly\x12\x82\x01\n" +
	"\x06labels\x18\x13 \x03(\v2j.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.LabelsEntryR\x06labels\x1a9\n" +
	...
	"\x14enable_ip_masq_agent\x18\a \x01(\bR\x11enableIpMasqAgent\x12\x93\x01\n" +
	"\x14ip_allocation_policy\x18\b \x01(\v2a.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerIpAllocationPolicyR\x12ipAllocationPolicy\"\xa4\x05\n" +
	...
	"\x1cservices_range_name_xor_cidr\x12Qservices_secondary_range_name and services_ipv4_cidr_block are mutually exclusive\x1aOthis.services_secondary_range_name == '' || this.services_ipv4_cidr_block == ''\"\xfb\a\n" +
	"\x1eGcpCloudComposerSoftwareConfig\x12#\n" +
	"\rimage_version\x18\x01 \x01(\tR\fimageVersion\x12\xb3\x01\n" +
	"\x18airflow_config_overrides\x18\x02 \x03(\v2y.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.AirflowConfigOverridesEntryR\x16airflowConfigOverrides\x12\x94\x01\n" +
	"\rpypi_packages\x18\x03 \x03(\v2o.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.PypiPackagesEntryR\fpypiPackages\x12\x94\x01\n" +
	"\renv_variables\x18\x04 \x03(\v2o.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.EnvVariablesEntryR\fenvVariables\x12Q\n" +
	"\x17web_server_plugins_mode\x18\x05 \x01(\tB\x1a\xbaH\x17r\x15R\x00R\aENABLEDR\bDISABLEDR\x14webServerPluginsMode\x12\xaf\x01\n" +
	"\x1ecloud_data_lineage_integration\x18\x06 \x01(\v2j.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerCloudDataLineageIntegrationR\x1bcloudDataLineageIntegration\x1aI\n" +
	...
	" enable_privately_used_public_ips\x18\a \x01(\bR\x1cenablePrivatelyUsedPublicIps\"\x9f\x05\n" +
	"\x1fGcpCloudComposerWorkloadsConfig\x12}\n" +
	"\tscheduler\x18\x01 \x01(\v2_.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadResourceR\tscheduler\x12\x7f\n" +
	"\n" +
	"web_server\x18\x02 \x01(\v2`.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWebServerResourceR\twebServer\x12u\n" +
	"\x06worker\x18\x03 \x01(\v2].dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkerResourceR\x06worker\x12~\n" +
	"\ttriggerer\x18\x04 \x01(\v2`.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerTriggererResourceR\ttriggerer\x12\x84\x01\n" +
	"\rdag_processor\x18\x05 \x01(\v2_.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadResourceR\fdagProcessor\"\x86\x01\n" +
	...
	"\ttime_zone\x18\x04 \x01(\tR\btimeZone\"\xb4\x01\n" +
	"&GcpCloudComposerWebServerAccessControl\x12\x89\x01\n" +
	"\x11allowed_ip_ranges\x18\x01 \x03(\v2].dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerAllowedIpRangeR\x0fallowedIpRanges\"`\n" +
	...
	"\vcidr_blocks\x18\x02 \x03(\v2X.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerCidrBlockR\n" +
	"cidrBlocks\"e\n" +
	...
	"\x1bretention_days_require_mode\x12Rairflow_metadata_retention_days requires airflow_metadata_retention_mode to be set\x1aWthis.airflow_metadata_retention_days == 0 || this.airflow_metadata_retention_mode != ''B\xef\x03\n" +
	"Acom.dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1B\tSpecProtoP\x01Z\x83\x01github.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpcloudcomposerenvironment/v1alpha1;gcpcloudcomposerenvironmentv1alpha1\xa2\x02\x05DPPGG\xaa\x02=Dev.Planton.Provider.Gcp.Gcpcloudcomposerenvironment.V1alpha1\xca\x02=Dev\\Planton\\Provider\\Gcp\\Gcpcloudcomposerenvironment\\V1alpha1\xe2\x02IDev\\Planton\\Provider\\Gcp\\Gcpcloudcomposerenvironment\\V1alpha1\\GPBMetadata\xea\x02BDev::Planton::Provider::Gcp::Gcpcloudcomposerenvironment::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_goTypes = []any{
	(*GcpCloudComposerEnvironmentSpec)(nil),                // 0: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec
	(*GcpCloudComposerNodeConfig)(nil),                     // 1: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerNodeConfig
	(*GcpCloudComposerIpAllocationPolicy)(nil),             // 2: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerIpAllocationPolicy
	(*GcpCloudComposerSoftwareConfig)(nil),                 // 3: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig
	(*GcpCloudComposerCloudDataLineageIntegration)(nil),    // 4: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerCloudDataLineageIntegration
	(*GcpCloudComposerPrivateEnvironmentConfig)(nil),       // 5: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerPrivateEnvironmentConfig
	(*GcpCloudComposerWorkloadsConfig)(nil),                // 6: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfig
	(*GcpCloudComposerWorkloadResource)(nil),               // 7: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadResource
	(*GcpCloudComposerWebServerResource)(nil),              // 8: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWebServerResource
	(*GcpCloudComposerWorkerResource)(nil),                 // 9: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkerResource
	(*GcpCloudComposerTriggererResource)(nil),              // 10: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerTriggererResource
	(*GcpCloudComposerMaintenanceWindow)(nil),              // 11: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerMaintenanceWindow
	(*GcpCloudComposerRecoveryConfig)(nil),                 // 12: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerRecoveryConfig
	(*GcpCloudComposerWebServerAccessControl)(nil),         // 13: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWebServerAccessControl
	(*GcpCloudComposerAllowedIpRange)(nil),                 // 14: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerAllowedIpRange
	(*GcpCloudComposerMasterAuthorizedNetworksConfig)(nil), // 15: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerMasterAuthorizedNetworksConfig
	(*GcpCloudComposerCidrBlock)(nil),                      // 16: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerCidrBlock
	(*GcpCloudComposerDataRetentionConfig)(nil),            // 17: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerDataRetentionConfig
	nil,                         // 18: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.LabelsEntry
	nil,                         // 19: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.AirflowConfigOverridesEntry
	nil,                         // 20: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.PypiPackagesEntry
	nil,                         // 21: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.EnvVariablesEntry
	(*v1.StringValueOrRef)(nil), // 22: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_depIdxs = []int32{
	22, // 0: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.node_config:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerNodeConfig
	3,  // 2: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.software_config:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig
	5,  // 3: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.private_environment_config:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerPrivateEnvironmentConfig
	6,  // 4: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.workloads_config:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfig
	22, // 5: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.kms_key_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 6: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.maintenance_window:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerMaintenanceWindow
	12, // 7: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.recovery_config:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerRecoveryConfig
	13, // 8: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.web_server_network_access_control:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWebServerAccessControl
	15, // 9: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.master_authorized_networks_config:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerMasterAuthorizedNetworksConfig
	17, // 10: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.data_retention_config:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerDataRetentionConfig
	22, // 11: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.storage_bucket:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	18, // 12: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.labels:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerEnvironmentSpec.LabelsEntry
	22, // 13: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerNodeConfig.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	22, // 14: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerNodeConfig.subnetwork:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	22, // 15: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerNodeConfig.service_account:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 16: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerNodeConfig.ip_allocation_policy:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerIpAllocationPolicy
	19, // 17: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.airflow_config_overrides:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.AirflowConfigOverridesEntry
	20, // 18: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.pypi_packages:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.PypiPackagesEntry
	21, // 19: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.env_variables:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.EnvVariablesEntry
	4,  // 20: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerSoftwareConfig.cloud_data_lineage_integration:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerCloudDataLineageIntegration
	7,  // 21: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfig.scheduler:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadResource
	8,  // 22: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfig.web_server:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWebServerResource
	9,  // 23: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfig.worker:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkerResource
	10, // 24: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfig.triggerer:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerTriggererResource
	7,  // 25: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadsConfig.dag_processor:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWorkloadResource
	14, // 26: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerWebServerAccessControl.allowed_ip_ranges:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerAllowedIpRange
	16, // 27: dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerMasterAuthorizedNetworksConfig.cidr_blocks:type_name -> dev.planton.provider.gcp.gcpcloudcomposerenvironment.v1alpha1.GcpCloudComposerCidrBlock
...
func init() { file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpcloudcomposerenvironment_v1alpha1_spec_proto_depIdxs = nil
}
