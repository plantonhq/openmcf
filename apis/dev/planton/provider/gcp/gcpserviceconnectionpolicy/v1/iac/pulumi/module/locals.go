...
type Locals struct {
	GcpServiceConnectionPolicy *gcpserviceconnectionpolicyv1.GcpServiceConnectionPolicy
...
func initializeLocals(_ *pulumi.Context, stackInput *gcpserviceconnectionpolicyv1.GcpServiceConnectionPolicyStackInput) *Locals {
	locals := &Locals{}
