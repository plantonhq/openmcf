...
- [GcpVertexAiIndex](/docs/catalog/gcp/gcpvertexaiindex) — the vector index being deployed
- [GcpVertexAiIndexEndpoint](/docs/catalog/gcp/gcpvertexaiindexendpoint) — the serving surface being deployed onto
- [GcpGlobalAddress](/docs/catalog/gcp/gcpglobaladdress) — reserved `VPC_PEERING` ranges for `reservedIpRanges`
- [GcpServiceAccount](/docs/catalog/gcp/gcpserviceaccount) — JWT issuers for `authConfig.allowedIssuers`
