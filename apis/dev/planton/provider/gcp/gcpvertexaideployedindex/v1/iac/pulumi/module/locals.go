...
type Locals struct {
	...
	GcpVertexAiDeployedIndex *gcpvertexaideployedindexv1.GcpVertexAiDeployedIndex
}

func initializeLocals(_ *pulumi.Context, stackInput *gcpvertexaideployedindexv1.GcpVertexAiDeployedIndexStackInput) *Locals {
	locals := &Locals{}
