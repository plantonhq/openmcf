...
1. **Create user-facing README.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpsubnetwork/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpsubnetwork/v1/examples.md`
...
3. **Create Pulumi README.md**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpsubnetwork/v1/iac/pulumi/README.md`
...
1. **Terraform main.tf is completely empty (0 bytes)**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpsubnetwork/v1/iac/tf/main.tf`
...
2. **Terraform outputs.tf is empty (0 bytes)**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpsubnetwork/v1/iac/tf/outputs.tf`
...
3. **Missing locals.tf for Terraform**
   ...
   - **File:** `apis/dev/planton/provider/gcp/gcpsubnetwork/v1/iac/tf/locals.tf`
...
- Folder exists at correct path: `apis/dev/planton/provider/gcp/gcpsubnetwork/v1/`
...
```bash
cd apis/dev/planton/provider/gcp/gcpsubnetwork/v1/
go test -v
```
...
3. **Create Terraform locals.tf**
   ...
   - **How:**
     ...
     - Consider referencing similar components like GcpVpcNetwork for patterns
...
**Most Similar Complete Component:** GcpVpcNetwork
...
**Path to reference:** `apis/dev/planton/provider/gcp/gcpvpcnetwork/v1/`

**Recommendation:** Use GcpVpcNetwork as a template for completing GcpSubnetwork's Terraform module and user-facing documentation. The structure is nearly identical (both are GCP networking primitives), so the patterns can be directly applied.
...
5. **Re-run audit** to verify improvements: `@audit-planton-component GcpSubnetwork`
