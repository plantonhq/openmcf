...
// 	protoc        (unknown)
// source: dev/planton/provider/gcp/gcpsubnetwork/v1alpha1/spec.proto
...
func (x *GcpSubnetworkSpec) Reset() {
	*x = GcpSubnetworkSpec{}
	mi := &file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpSubnetworkSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpSubnetworkSecondaryRange) Reset() {
	*x = GcpSubnetworkSecondaryRange{}
	mi := &file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSubnetworkSecondaryRange) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpSubnetworkLogConfig) Reset() {
	*x = GcpSubnetworkLogConfig{}
	mi := &file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSubnetworkLogConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":dev/planton/provider/gcp/gcpsubnetwork/v1alpha1/spec.proto\x12/dev.planton.provider.gcp.gcpsubnetwork.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xa3\x19\n" +
	...
	"\n" +
	"valid_role\x12\x1drole must be ACTIVE or BACKUP\x1a*this == '' || this in ['ACTIVE', 'BACKUP']R\x04role\x12|\n" +
	"\x13secondary_ip_ranges\x18\t \x03(\v2L.dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSecondaryRangeR\x11secondaryIpRanges\x127\n" +
	...
	" send_secondary_ip_range_if_empty\x18\x10 \x01(\bR\x1bsendSecondaryIpRangeIfEmpty\x12f\n" +
	"\n" +
	"log_config\x18\x11 \x01(\v2G.dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkLogConfigR\tlogConfig:\xfb\x06\xbaH\xf7\x06\x1a\xd2\x01\n" +
	...
	"\t_metadataB\x8c\x03\n" +
	"3com.dev.planton.provider.gcp.gcpsubnetwork.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/apis/dev/planton/provider/gcp/gcpsubnetwork/v1alpha1;gcpsubnetworkv1alpha1\xa2\x02\x05DPPGG\xaa\x02/Dev.Planton.Provider.Gcp.Gcpsubnetwork.V1alpha1\xca\x02/Dev\\Planton\\Provider\\Gcp\\Gcpsubnetwork\\V1alpha1\xe2\x02;Dev\\Planton\\Provider\\Gcp\\Gcpsubnetwork\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Provider::Gcp::Gcpsubnetwork::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_goTypes = []any{
	(*GcpSubnetworkSpec)(nil),           // 0: dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSpec
	(*GcpSubnetworkSecondaryRange)(nil), // 1: dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSecondaryRange
	(*GcpSubnetworkLogConfig)(nil),      // 2: dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkLogConfig
	(*v1.StringValueOrRef)(nil),         // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSpec.vpc_self_link:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSpec.secondary_ip_ranges:type_name -> dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSecondaryRange
	2, // 3: dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkSpec.log_config:type_name -> dev.planton.provider.gcp.gcpsubnetwork.v1alpha1.GcpSubnetworkLogConfig
...
func init() { file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_gcp_gcpsubnetwork_v1alpha1_spec_proto_depIdxs = nil
}
