...
func (x *GcpComputeInstanceServiceAccount) Reset() {
	*x = GcpComputeInstanceServiceAccount{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceServiceAccount) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpComputeInstanceScheduling) Reset() {
	*x = GcpComputeInstanceScheduling{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceScheduling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *GcpComputeInstanceNodeAffinity) Reset() {
	*x = GcpComputeInstanceNodeAffinity{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceNodeAffinity) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *GcpComputeInstanceShieldedConfig) Reset() {
	*x = GcpComputeInstanceShieldedConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceShieldedConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *GcpComputeInstanceConfidentialConfig) Reset() {
	*x = GcpComputeInstanceConfidentialConfig{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceConfidentialConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *GcpComputeInstanceAdvancedMachineFeatures) Reset() {
	*x = GcpComputeInstanceAdvancedMachineFeatures{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceAdvancedMachineFeatures) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *GcpComputeInstanceGuestAccelerator) Reset() {
	*x = GcpComputeInstanceGuestAccelerator{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceGuestAccelerator) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *GcpComputeInstanceReservationAffinity) Reset() {
	*x = GcpComputeInstanceReservationAffinity{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceReservationAffinity) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *GcpComputeInstanceSpecificReservation) Reset() {
	*x = GcpComputeInstanceSpecificReservation{}
	mi := &file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpComputeInstanceSpecificReservation) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDescGZIP(), []int{16}
}
...
const file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_rawDesc = "" +
	...
	"\x0fhostname_format\x12Zhostname must be a fully qualified DNS name of RFC-1035 labels, e.g. host.example.internal\x1aZthis == '' || this.matches('^[a-z]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z]([-a-z0-9]*[a-z0-9])?)+$')R\bhostname\x12o\n" +
	"\tboot_disk\x18\a \x01(\v2J.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceBootDiskB\x06\xbaH\x03\xc8\x01\x01R\bbootDisk\x12u\n" +
	"\x0eattached_disks\x18\b \x03(\v2N.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAttachedDiskR\rattachedDisks\x12r\n" +
	"\rscratch_disks\x18\t \x03(\v2M.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceScratchDiskR\fscratchDisks\x12\x8e\x01\n" +
	"\x12network_interfaces\x18\n" +
	" \x03(\v2R.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterfaceB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\x11networkInterfaces\x12y\n" +
	"\x0fservice_account\x18\v \x01(\v2P.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceServiceAccountR\x0eserviceAccount\x12l\n" +
	"\n" +
	"scheduling\x18\f \x01(\v2L.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSchedulingR\n" +
	"scheduling\x12\x8a\x01\n" +
	"\x18shielded_instance_config\x18\r \x01(\v2P.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceShieldedConfigR\x16shieldedInstanceConfig\x12\x96\x01\n" +
	"\x1cconfidential_instance_config\x18\x0e \x01(\v2T.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceConfidentialConfigR\x1aconfidentialInstanceConfig\x12\x95\x01\n" +
	"\x19advanced_machine_features\x18\x0f \x01(\v2Y.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAdvancedMachineFeaturesR\x17advancedMachineFeatures\x12\x81\x01\n" +
	"\x12guest_accelerators\x18\x10 \x03(\v2R.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceGuestAcceleratorR\x11guestAccelerators\x12\x88\x01\n" +
	"\x14reservation_affinity\x18\x11 \x01(\v2U.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceReservationAffinityR\x13reservationAffinity\x12\xc9\x01\n" +
	"\x1btotal_egress_bandwidth_tier\x18\x12 \x01(\tB\x89\x01\xbaH\x85\x01\xba\x01\x81\x01\n" +
	"\x1bvalid_egress_bandwidth_tier\x125total_egress_bandwidth_tier must be DEFAULT or TIER_1\x1a+this == '' || this in ['DEFAULT', 'TIER_1']R\x18totalEgressBandwidthTier\x12p\n" +
	"\bmetadata\x18\x13 \x03(\v2T.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.MetadataEntryR\bmetadata\x12%\n" +
	"\x0estartup_script\x18\x14 \x01(\tR\rstartupScript\x12\x19\n" +
	"\bssh_keys\x18\x15 \x03(\tR\asshKeys\x12j\n" +
	"\x06labels\x18\x16 \x03(\v2R.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.LabelsEntryR\x06labels\x12\x12\n" +
	"\x04tags\x18\x17 \x03(\tR\x04tags\x12\x93\x01\n" +
	"\x15resource_manager_tags\x18\x18 \x03(\v2_.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.ResourceManagerTagsEntryR\x13resourceManagerTags\x125\n" +
	...
	"\x1a_allow_stopping_for_update\"\xdc\v\n" +
	...
	"queueCount\x88\x01\x01\x12v\n" +
	"\x0falias_ip_ranges\x18\n" +
	" \x03(\v2N.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAliasIpRangeR\raliasIpRanges:\xd8\x02\xbaH\xd4\x02\x1a\xd1\x02\n" +
	...
	"\rmin_node_cpus\x18\t \x01(\x05B\a\xbaH\x04\x1a\x02(\x01H\x04R\vminNodeCpus\x88\x01\x01\x12w\n" +
	"\x0fnode_affinities\x18\n" +
	" \x03(\v2N.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNodeAffinityR\x0enodeAffinities\x12\\\n" +
	...
	"\xbaH\a\xc8\x01\x01\x1a\x02(\x01R\x05count\"\xce\x03\n" +
	"%GcpComputeInstanceReservationAffinity\x12S\n" +
	"\x04type\x18\x01 \x01(\tB?\xbaH<\xc8\x01\x01r7R\x0fANY_RESERVATIONR\x14SPECIFIC_RESERVATIONR\x0eNO_RESERVATIONR\x04type\x12\x88\x01\n" +
	"\x14specific_reservation\x18\x02 \x01(\v2U.dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpecificReservationR\x13specificReservation:\xc4\x01\xbaH\xc0\x01\x1a\xbd\x01\n" +
	...
	"\x06values\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x06valuesB\x85\x03\n" +
...
var file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_goTypes = []any{
	...
	(*GcpComputeInstanceAttachedDisk)(nil),            // 2: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAttachedDisk
	(*GcpComputeInstanceScratchDisk)(nil),             // 3: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceScratchDisk
	(*GcpComputeInstanceNetworkInterface)(nil),        // 4: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface
	(*GcpComputeInstanceAccessConfig)(nil),            // 5: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAccessConfig
	(*GcpComputeInstanceIpv6AccessConfig)(nil),        // 6: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceIpv6AccessConfig
	(*GcpComputeInstanceAliasIpRange)(nil),            // 7: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAliasIpRange
	(*GcpComputeInstanceServiceAccount)(nil),          // 8: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceServiceAccount
	(*GcpComputeInstanceScheduling)(nil),              // 9: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceScheduling
	(*GcpComputeInstanceNodeAffinity)(nil),            // 10: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNodeAffinity
	(*GcpComputeInstanceShieldedConfig)(nil),          // 11: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceShieldedConfig
	(*GcpComputeInstanceConfidentialConfig)(nil),      // 12: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceConfidentialConfig
	(*GcpComputeInstanceAdvancedMachineFeatures)(nil), // 13: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAdvancedMachineFeatures
	(*GcpComputeInstanceGuestAccelerator)(nil),        // 14: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceGuestAccelerator
	(*GcpComputeInstanceReservationAffinity)(nil),     // 15: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceReservationAffinity
	(*GcpComputeInstanceSpecificReservation)(nil),     // 16: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpecificReservation
	nil,                         // 17: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.MetadataEntry
	nil,                         // 18: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.LabelsEntry
	nil,                         // 19: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.ResourceManagerTagsEntry
	nil,                         // 20: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceBootDisk.DiskLabelsEntry
...
var file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_depIdxs = []int32{
	21, // 0: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	...
	2,  // 2: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.attached_disks:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAttachedDisk
	3,  // 3: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.scratch_disks:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceScratchDisk
	4,  // 4: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.network_interfaces:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface
	8,  // 5: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.service_account:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceServiceAccount
	9,  // 6: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.scheduling:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceScheduling
	11, // 7: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.shielded_instance_config:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceShieldedConfig
	12, // 8: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.confidential_instance_config:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceConfidentialConfig
	13, // 9: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.advanced_machine_features:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAdvancedMachineFeatures
	14, // 10: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.guest_accelerators:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceGuestAccelerator
	15, // 11: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.reservation_affinity:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceReservationAffinity
	17, // 12: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.metadata:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.MetadataEntry
	18, // 13: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.labels:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.LabelsEntry
	19, // 14: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.resource_manager_tags:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpec.ResourceManagerTagsEntry
	21, // 15: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceBootDisk.source_disk:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 16: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceBootDisk.kms_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	20, // 17: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceBootDisk.disk_labels:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceBootDisk.DiskLabelsEntry
	21, // 18: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAttachedDisk.source:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 19: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAttachedDisk.kms_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 20: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 21: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface.subnetwork:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 22: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface.network_ip:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 23: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface.access_configs:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAccessConfig
	6,  // 24: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface.ipv6_access_configs:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceIpv6AccessConfig
	7,  // 25: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNetworkInterface.alias_ip_ranges:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAliasIpRange
	21, // 26: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceAccessConfig.nat_ip:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 27: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceServiceAccount.email:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	10, // 28: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceScheduling.node_affinities:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceNodeAffinity
	16, // 29: dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceReservationAffinity.specific_reservation:type_name -> dev.planton.provider.gcp.gcpcomputeinstance.v1.GcpComputeInstanceSpecificReservation
...
func file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_init() {
	...
	file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[9].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[11].OneofWrappers = []any{}
	file_dev_planton_provider_gcp_gcpcomputeinstance_v1_spec_proto_msgTypes[13].OneofWrappers = []any{}
	type x struct{}
