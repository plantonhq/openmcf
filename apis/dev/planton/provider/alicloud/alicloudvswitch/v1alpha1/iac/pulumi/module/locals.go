...
type Locals struct {
	AliCloudVswitch *alicloudvswitchv1alpha1.AliCloudVswitch
	VpcId           string
	Tags            map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudvswitchv1alpha1.AliCloudVswitchStackInput) *Locals {
	locals := &Locals{}
