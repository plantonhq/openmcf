...
go build ./apis/dev/planton/provider/alicloud/alicloudredisinstance/v1/iac/pulumi/...

# Go vet
go vet ./apis/dev/planton/provider/alicloud/alicloudredisinstance/v1/iac/pulumi/...

# Spec tests
go test ./apis/dev/planton/provider/alicloud/alicloudredisinstance/v1/...
