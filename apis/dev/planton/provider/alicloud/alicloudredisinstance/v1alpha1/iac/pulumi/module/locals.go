...
import (
	...
	alicloudredisinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudredisinstance/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	AliCloudRedisInstance *alicloudredisinstancev1alpha1.AliCloudRedisInstance
	Tags                  map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudredisinstancev1alpha1.AliCloudRedisInstanceStackInput) *Locals {
	locals := &Locals{}
...
func engineVersion(spec *alicloudredisinstancev1alpha1.AliCloudRedisInstanceSpec) string {
...
func instanceType(spec *alicloudredisinstancev1alpha1.AliCloudRedisInstanceSpec) string {
...
func paymentType(spec *alicloudredisinstancev1alpha1.AliCloudRedisInstanceSpec) string {
...
func vpcAuthMode(spec *alicloudredisinstancev1alpha1.AliCloudRedisInstanceSpec) string {
