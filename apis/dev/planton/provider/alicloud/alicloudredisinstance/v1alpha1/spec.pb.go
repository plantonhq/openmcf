...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudredisinstance/v1alpha1/spec.proto
...
func (x *AliCloudRedisInstanceSpec) Reset() {
	*x = AliCloudRedisInstanceSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudRedisInstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Gdev/planton/provider/alicloud/alicloudredisinstance/v1alpha1/spec.proto\x12<dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x85\x18\n" +
	...
	"\x11resource_group_id\x18\r \x01(\tR\x0fresourceGroupId\x12u\n" +
	"\x04tags\x18\x0e \x03(\v2a.dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.TagsEntryR\x04tags\x12-\n" +
	...
	"\x13vpc_auth_mode_valid\x12)vpc_auth_mode must be one of: Open, Close\x1a'this == '' || this in ['Open', 'Close']\x8a\xa6\x1d\x04OpenH\aR\vvpcAuthMode\x88\x01\x01\x12{\n" +
	"\x06config\x18\x15 \x03(\v2c.dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.ConfigEntryR\x06config\x12C\n" +
	...
	"\a_periodB\xe2\x03\n" +
	"@com.dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1B\tSpecProtoP\x01Z|github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudredisinstance/v1alpha1;alicloudredisinstancev1alpha1\xa2\x02\x05DPPAA\xaa\x02<Dev.Planton.Provider.Alicloud.Alicloudredisinstance.V1alpha1\xca\x02<Dev\\Planton\\Provider\\Alicloud\\Alicloudredisinstance\\V1alpha1\xe2\x02HDev\\Planton\\Provider\\Alicloud\\Alicloudredisinstance\\V1alpha1\\GPBMetadata\xea\x02ADev::Planton::Provider::Alicloud::Alicloudredisinstance::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudRedisInstanceSpec)(nil), // 0: dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec
	nil,                               // 1: dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.TagsEntry
	nil,                               // 2: dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.ConfigEntry
	(*v1.StringValueOrRef)(nil),       // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.TagsEntry
	2, // 2: dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.config:type_name -> dev.planton.provider.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.ConfigEntry
...
func init() { file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudredisinstance_v1alpha1_spec_proto_depIdxs = nil
}
