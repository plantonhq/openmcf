...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudnasfilesystem/v1alpha1/spec.proto
...
func (x *AliCloudNasFileSystemSpec) Reset() {
	*x = AliCloudNasFileSystemSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudNasFileSystemSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudNasEncryption) Reset() {
	*x = AliCloudNasEncryption{}
	mi := &file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudNasEncryption) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudNasAccessRule) Reset() {
	*x = AliCloudNasAccessRule{}
	mi := &file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudNasAccessRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Gdev/planton/provider/alicloud/alicloudnasfilesystem/v1alpha1/spec.proto\x12<dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x85\v\n" +
	...
	"\n" +
	"encryption\x18\x06 \x01(\v2S.dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasEncryptionR\n" +
	"encryption\x12\x1a\n" +
	...
	"\n" +
	"vswitch_id\x18\n" +
	" \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB(\xbaH\x03\xc8\x01\x01\x88\xd4a\xf5]\x92\xd4a\x19status.outputs.vswitch_idR\tvswitchId\x12v\n" +
	"\faccess_rules\x18\v \x03(\v2S.dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasAccessRuleR\vaccessRules\x12*\n" +
	"\x11resource_group_id\x18\f \x01(\tR\x0fresourceGroupId\x12u\n" +
	"\x04tags\x18\r \x03(\v2a.dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\t_priorityB\xe2\x03\n" +
	"@com.dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1B\tSpecProtoP\x01Z|github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudnasfilesystem/v1alpha1;alicloudnasfilesystemv1alpha1\xa2\x02\x05DPPAA\xaa\x02<Dev.Planton.Provider.Alicloud.Alicloudnasfilesystem.V1alpha1\xca\x02<Dev\\Planton\\Provider\\Alicloud\\Alicloudnasfilesystem\\V1alpha1\xe2\x02HDev\\Planton\\Provider\\Alicloud\\Alicloudnasfilesystem\\V1alpha1\\GPBMetadata\xea\x02ADev::Planton::Provider::Alicloud::Alicloudnasfilesystem::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudNasFileSystemSpec)(nil), // 0: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec
	(*AliCloudNasEncryption)(nil),     // 1: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasEncryption
	(*AliCloudNasAccessRule)(nil),     // 2: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasAccessRule
	nil,                               // 3: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),       // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.encryption:type_name -> dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasEncryption
	4, // 1: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 2: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.access_rules:type_name -> dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasAccessRule
	3, // 4: dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudnasfilesystem.v1alpha1.AliCloudNasFileSystemSpec.TagsEntry
...
func init() { file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudnasfilesystem_v1alpha1_spec_proto_depIdxs = nil
}
