...
import (
	...
	alicloudprivatednszonev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudprivatednszone/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	AliCloudPrivateDnsZone *alicloudprivatednszonev1alpha1.AliCloudPrivateDnsZone
	Tags                   map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudprivatednszonev1alpha1.AliCloudPrivateDnsZoneStackInput) *Locals {
	locals := &Locals{}
