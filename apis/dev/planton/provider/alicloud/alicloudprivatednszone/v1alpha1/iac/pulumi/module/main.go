...
func Resources(ctx *pulumi.Context, stackInput *alicloudprivatednszonev1alpha1.AliCloudPrivateDnsZoneStackInput) error {
	locals := initializeLocals(ctx, stackInput)
	spec := locals.AliCloudPrivateDnsZone.Spec
