...
import (
	...
	alicloudrocketmqinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudrocketmqinstance/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	AliCloudRocketmqInstance *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqInstance
	Tags                     map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqInstanceStackInput) *Locals {
	locals := &Locals{}
...
func paymentType(spec *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqInstanceSpec) string {
...
func commodityCode(spec *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqInstanceSpec) string {
...
func internetSpec(spec *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqInstanceSpec) string {
...
func flowOutType(spec *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqInstanceSpec) string {
	if spec.InternetInfo == nil || spec.InternetInfo.Enabled == nil || !*spec.InternetInfo.Enabled {
		return "uninvolved"
	}
...
func messageType(t *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqTopic) string {
...
func retryPolicy(cg *alicloudrocketmqinstancev1alpha1.AliCloudRocketmqConsumerGroup) string {
