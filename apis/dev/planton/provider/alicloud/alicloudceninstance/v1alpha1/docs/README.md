...
Planton's v1 component covers only the first row — the foundation that every CEN deployment needs.
...
### Level 4: Control Planes (Planton)

Planton provides a single `AliCloudCenInstance` resource that bundles the CEN instance and its attachments:
