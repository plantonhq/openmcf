...
func Resources(ctx *pulumi.Context, stackInput *alicloudceninstancev1alpha1.AliCloudCenInstanceStackInput) error {
...
func cenAttachment(
	...
	attachment *alicloudceninstancev1alpha1.AliCloudCenAttachment,
	index int,
) error {
	childType := "VPC"
