...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudnetworkloadbalancer/v1alpha1/spec.proto
...
func (x *AliCloudNetworkLoadBalancerSpec) Reset() {
	*x = AliCloudNetworkLoadBalancerSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudNetworkLoadBalancerSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudNetworkLoadBalancerZoneMapping) Reset() {
	*x = AliCloudNetworkLoadBalancerZoneMapping{}
	mi := &file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudNetworkLoadBalancerZoneMapping) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudNetworkLoadBalancerServerGroup) Reset() {
	*x = AliCloudNetworkLoadBalancerServerGroup{}
	mi := &file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudNetworkLoadBalancerServerGroup) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudNetworkLoadBalancerHealthCheckConfig) Reset() {
	*x = AliCloudNetworkLoadBalancerHealthCheckConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudNetworkLoadBalancerHealthCheckConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudNetworkLoadBalancerListener) Reset() {
	*x = AliCloudNetworkLoadBalancerListener{}
	mi := &file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudNetworkLoadBalancerListener) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Mdev/planton/provider/alicloud/alicloudnetworkloadbalancer/v1alpha1/spec.proto\x12Bdev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xbf\n" +
	"\n" +
	...
	"\x12address_type_valid\x12/address_type must be one of: Internet, Intranet\x1a.this == '' || this in ['Internet', 'Intranet']\x8a\xa6\x1d\bInternetH\x00R\vaddressType\x88\x01\x01\x12\x9c\x01\n" +
	"\rzone_mappings\x18\x05 \x03(\v2j.dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerZoneMappingB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x02R\fzoneMappings\x12*\n" +
	"\x11resource_group_id\x18\x06 \x01(\tR\x0fresourceGroupId\x12;\n" +
	"\x12cross_zone_enabled\x18\a \x01(\bB\b\x8a\xa6\x1d\x04trueH\x01R\x10crossZoneEnabled\x88\x01\x01\x12\x81\x01\n" +
	"\x04tags\x18\b \x03(\v2m.dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.TagsEntryR\x04tags\x12\x8f\x01\n" +
	"\rserver_groups\x18\t \x03(\v2j.dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerServerGroupR\fserverGroups\x12\x85\x01\n" +
	"\tlisteners\x18\n" +
	" \x03(\v2g.dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerListenerR\tlisteners\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\rallocation_id\x18\x03 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1e\x88\xd4a\xf7]\x92\xd4a\x15status.outputs.eip_idR\fallocationId\"\xad\a\n" +
	...
	"\x1apreserve_client_ip_enabled\x18\x06 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x04R\x17preserveClientIpEnabled\x88\x01\x01\x12\x9b\x01\n" +
	"\fhealth_check\x18\a \x01(\v2p.dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerHealthCheckConfigB\x06\xbaH\x03\xc8\x01\x01R\vhealthCheckB\v\n" +
	"\t_protocolB\f\n" +
	"\n" +
	"_schedulerB\x1b\n" +
	...
	"\v_ca_enabledB\x8d\x04\n" +
	"Fcom.dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1B\tSpecProtoP\x01Z\x88\x01github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudnetworkloadbalancer/v1alpha1;alicloudnetworkloadbalancerv1alpha1\xa2\x02\x05DPPAA\xaa\x02BDev.Planton.Provider.Alicloud.Alicloudnetworkloadbalancer.V1alpha1\xca\x02BDev\\Planton\\Provider\\Alicloud\\Alicloudnetworkloadbalancer\\V1alpha1\xe2\x02NDev\\Planton\\Provider\\Alicloud\\Alicloudnetworkloadbalancer\\V1alpha1\\GPBMetadata\xea\x02GDev::Planton::Provider::Alicloud::Alicloudnetworkloadbalancer::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudNetworkLoadBalancerSpec)(nil),              // 0: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec
	(*AliCloudNetworkLoadBalancerZoneMapping)(nil),       // 1: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerZoneMapping
	(*AliCloudNetworkLoadBalancerServerGroup)(nil),       // 2: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerServerGroup
	(*AliCloudNetworkLoadBalancerHealthCheckConfig)(nil), // 3: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerHealthCheckConfig
	(*AliCloudNetworkLoadBalancerListener)(nil),          // 4: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerListener
	nil,                         // 5: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.zone_mappings:type_name -> dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerZoneMapping
	5, // 2: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.TagsEntry
	2, // 3: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.server_groups:type_name -> dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerServerGroup
	4, // 4: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerSpec.listeners:type_name -> dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerListener
	6, // 5: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerZoneMapping.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 6: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerZoneMapping.allocation_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 7: dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerServerGroup.health_check:type_name -> dev.planton.provider.alicloud.alicloudnetworkloadbalancer.v1alpha1.AliCloudNetworkLoadBalancerHealthCheckConfig
...
func init() {
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_init()
}
func file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudnetworkloadbalancer_v1alpha1_spec_proto_depIdxs = nil
}
