...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudkubernetescluster/v1alpha1/spec.proto
...
func (x *AliCloudKubernetesClusterSpec) Reset() {
	*x = AliCloudKubernetesClusterSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudKubernetesClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudKubernetesAddon) Reset() {
	*x = AliCloudKubernetesAddon{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesAddon) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudKubernetesClusterLogging) Reset() {
	*x = AliCloudKubernetesClusterLogging{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesClusterLogging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudKubernetesClusterMaintenanceWindow) Reset() {
	*x = AliCloudKubernetesClusterMaintenanceWindow{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesClusterMaintenanceWindow) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudKubernetesClusterAutoUpgrade) Reset() {
	*x = AliCloudKubernetesClusterAutoUpgrade{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesClusterAutoUpgrade) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Kdev/planton/provider/alicloud/alicloudkubernetescluster/v1alpha1/spec.proto\x12@dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xa4\x14\n" +
	...
	"\n" +
	"custom_san\x18\x19 \x01(\tR\tcustomSan\x12q\n" +
	"\x06addons\x18\x1e \x03(\v2Y.dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesAddonR\x06addons\x12|\n" +
	"\alogging\x18( \x01(\v2b.dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterLoggingR\alogging\x12\x9b\x01\n" +
	"\x12maintenance_window\x182 \x01(\v2l.dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterMaintenanceWindowR\x11maintenanceWindow\x12\x89\x01\n" +
	"\fauto_upgrade\x183 \x01(\v2f.dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterAutoUpgradeR\vautoUpgrade\x12}\n" +
	"\x04tags\x18< \x03(\v2i.dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.TagsEntryR\x04tags\x12*\n" +
	...
	"\n" +
	"\b_channelB\xff\x03\n" +
	"Dcom.dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1B\tSpecProtoP\x01Z\x84\x01github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudkubernetescluster/v1alpha1;alicloudkubernetesclusterv1alpha1\xa2\x02\x05DPPAA\xaa\x02@Dev.Planton.Provider.Alicloud.Alicloudkubernetescluster.V1alpha1\xca\x02@Dev\\Planton\\Provider\\Alicloud\\Alicloudkubernetescluster\\V1alpha1\xe2\x02LDev\\Planton\\Provider\\Alicloud\\Alicloudkubernetescluster\\V1alpha1\\GPBMetadata\xea\x02EDev::Planton::Provider::Alicloud::Alicloudkubernetescluster::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudKubernetesClusterSpec)(nil),              // 0: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec
	(*AliCloudKubernetesAddon)(nil),                    // 1: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesAddon
	(*AliCloudKubernetesClusterLogging)(nil),           // 2: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterLogging
	(*AliCloudKubernetesClusterMaintenanceWindow)(nil), // 3: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterMaintenanceWindow
	(*AliCloudKubernetesClusterAutoUpgrade)(nil),       // 4: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterAutoUpgrade
	nil,                         // 5: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_depIdxs = []int32{
	6,  // 0: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.vswitch_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 1: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.pod_vswitch_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 2: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.security_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 3: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.encryption_provider_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 4: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.addons:type_name -> dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesAddon
	2,  // 5: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.logging:type_name -> dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterLogging
	3,  // 6: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.maintenance_window:type_name -> dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterMaintenanceWindow
	4,  // 7: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.auto_upgrade:type_name -> dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterAutoUpgrade
	5,  // 8: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterSpec.TagsEntry
	6,  // 9: dev.planton.provider.alicloud.alicloudkubernetescluster.v1alpha1.AliCloudKubernetesClusterLogging.control_plane_log_project:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudkubernetescluster_v1alpha1_spec_proto_depIdxs = nil
}
