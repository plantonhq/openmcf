...
func Resources(ctx *pulumi.Context, stackInput *alicloudkubernetesclusterv1alpha1.AliCloudKubernetesClusterStackInput) error {
...
func configureLogging(args *cs.ManagedKubernetesArgs, logging *alicloudkubernetesclusterv1alpha1.AliCloudKubernetesClusterLogging) {
...
func autoUpgradeChannel(au *alicloudkubernetesclusterv1alpha1.AliCloudKubernetesClusterAutoUpgrade) string {
	if au.Channel != nil {
		return *au.Channel
	}
	return "patch"
