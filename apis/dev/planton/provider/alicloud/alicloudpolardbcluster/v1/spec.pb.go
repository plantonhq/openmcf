...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudpolardbcluster/v1/spec.proto
...
func (x *AliCloudPolardbClusterSpec) Reset() {
	*x = AliCloudPolardbClusterSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[0]
...
func (*AliCloudPolardbClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudPolardbParameter) Reset() {
	*x = AliCloudPolardbParameter{}
	mi := &file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbParameter) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudPolardbDatabase) Reset() {
	*x = AliCloudPolardbDatabase{}
	mi := &file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbDatabase) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudPolardbAccount) Reset() {
	*x = AliCloudPolardbAccount{}
	mi := &file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbAccount) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudPolardbAccountPrivilege) Reset() {
	*x = AliCloudPolardbAccountPrivilege{}
	mi := &file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbAccountPrivilege) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Bdev/planton/provider/alicloud/alicloudpolardbcluster/v1/spec.proto\x127dev.planton.provider.alicloud.alicloudpolardbcluster.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xee\x1f\n" +
	...
	"\x04tags\x18\x11 \x03(\v2].dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.TagsEntryR\x04tags\x12\x8e\x02\n" +
	...
	"\n" +
	"parameters\x18\x1b \x03(\v2Q.dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbParameterR\n" +
	"parameters\x12n\n" +
	"\tdatabases\x18\x1c \x03(\v2P.dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbDatabaseR\tdatabases\x12k\n" +
	"\baccounts\x18\x1d \x03(\v2O.dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbAccountR\baccounts\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\n" +
	"privileges\x18\x05 \x03(\v2X.dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbAccountPrivilegeR\n" +
	"privilegesB\x0f\n" +
	...
	";com.dev.planton.provider.alicloud.alicloudpolardbcluster.v1B\tSpecProtoP\x01Zrgithub.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudpolardbcluster/v1;alicloudpolardbclusterv1\xa2\x02\x05DPPAA\xaa\x027Dev.Planton.Provider.Alicloud.Alicloudpolardbcluster.V1\xca\x027Dev\\Planton\\Provider\\Alicloud\\Alicloudpolardbcluster\\V1\xe2\x02CDev\\Planton\\Provider\\Alicloud\\Alicloudpolardbcluster\\V1\\GPBMetadata\xea\x02<Dev::Planton::Provider::Alicloud::Alicloudpolardbcluster::V1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_goTypes = []any{
	(*AliCloudPolardbClusterSpec)(nil),      // 0: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec
	(*AliCloudPolardbParameter)(nil),        // 1: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbParameter
	(*AliCloudPolardbDatabase)(nil),         // 2: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbDatabase
	(*AliCloudPolardbAccount)(nil),          // 3: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbAccount
	(*AliCloudPolardbAccountPrivilege)(nil), // 4: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbAccountPrivilege
	nil,                                     // 5: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),             // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 1: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.TagsEntry
	1, // 2: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.parameters:type_name -> dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbParameter
	2, // 3: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.databases:type_name -> dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbDatabase
	3, // 4: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbClusterSpec.accounts:type_name -> dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbAccount
	4, // 5: dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbAccount.privileges:type_name -> dev.planton.provider.alicloud.alicloudpolardbcluster.v1.AliCloudPolardbAccountPrivilege
...
func init() { file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudpolardbcluster_v1_spec_proto_depIdxs = nil
}
