...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudecsinstance/v1alpha1/spec.proto
...
func (x *AliCloudEcsInstanceSpec) Reset() {
	*x = AliCloudEcsInstanceSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudEcsInstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudEcsSystemDisk) Reset() {
	*x = AliCloudEcsSystemDisk{}
	mi := &file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudEcsSystemDisk) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudEcsDataDisk) Reset() {
	*x = AliCloudEcsDataDisk{}
	mi := &file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudEcsDataDisk) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Edev/planton/provider/alicloud/alicloudecsinstance/v1alpha1/spec.proto\x12:dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x91\x19\n" +
	...
	"\x12description_length\x129description must be between 2 and 256 characters when set\x1a6this == '' || (this.size() >= 2 && this.size() <= 256)R\vdescription\x12r\n" +
	"\vsystem_disk\x18\t \x01(\v2Q.dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsSystemDiskR\n" +
	"systemDisk\x12x\n" +
	"\n" +
	"data_disks\x18\n" +
	" \x03(\v2O.dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsDataDiskB\b\xbaH\x05\x92\x01\x02\x10\x10R\tdataDisks\x12\x19\n" +
	...
	"\x04tags\x18\x19 \x03(\v2].dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\n" +
	"_encryptedB\x17\n" +
	"\x15_delete_with_instanceB\xd4\x03\n" +
	">com.dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1B\tSpecProtoP\x01Zxgithub.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudecsinstance/v1alpha1;alicloudecsinstancev1alpha1\xa2\x02\x05DPPAA\xaa\x02:Dev.Planton.Provider.Alicloud.Alicloudecsinstance.V1alpha1\xca\x02:Dev\\Planton\\Provider\\Alicloud\\Alicloudecsinstance\\V1alpha1\xe2\x02FDev\\Planton\\Provider\\Alicloud\\Alicloudecsinstance\\V1alpha1\\GPBMetadata\xea\x02?Dev::Planton::Provider::Alicloud::Alicloudecsinstance::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudEcsInstanceSpec)(nil), // 0: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec
	(*AliCloudEcsSystemDisk)(nil),   // 1: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsSystemDisk
	(*AliCloudEcsDataDisk)(nil),     // 2: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsDataDisk
	nil,                             // 3: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),     // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.system_disk:type_name -> dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsSystemDisk
	2, // 3: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.data_disks:type_name -> dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsDataDisk
	3, // 4: dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.TagsEntry
...
func init() { file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudecsinstance_v1alpha1_spec_proto_depIdxs = nil
}
