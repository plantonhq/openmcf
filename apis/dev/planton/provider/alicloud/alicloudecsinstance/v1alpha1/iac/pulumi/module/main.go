...
func Resources(ctx *pulumi.Context, stackInput *alicloudecsinstancev1alpha1.AliCloudEcsInstanceStackInput) error {
...
func buildDataDisks(disks []*alicloudecsinstancev1alpha1.AliCloudEcsDataDisk) ecs.InstanceDataDiskArray {
