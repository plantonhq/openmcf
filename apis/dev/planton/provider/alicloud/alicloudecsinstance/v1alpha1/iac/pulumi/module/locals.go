...
import (
	...
	alicloudecsinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudecsinstance/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	AliCloudEcsInstance *alicloudecsinstancev1alpha1.AliCloudEcsInstance
	Tags                map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudecsinstancev1alpha1.AliCloudEcsInstanceStackInput) *Locals {
	locals := &Locals{}
...
func instanceChargeType(spec *alicloudecsinstancev1alpha1.AliCloudEcsInstanceSpec) string {
...
func systemDiskCategory(spec *alicloudecsinstancev1alpha1.AliCloudEcsInstanceSpec) string {
...
func systemDiskSize(spec *alicloudecsinstancev1alpha1.AliCloudEcsInstanceSpec) int {
...
func dataDiskCategory(disk *alicloudecsinstancev1alpha1.AliCloudEcsDataDisk) string {
...
func dataDiskDeleteWithInstance(disk *alicloudecsinstancev1alpha1.AliCloudEcsDataDisk) bool {
