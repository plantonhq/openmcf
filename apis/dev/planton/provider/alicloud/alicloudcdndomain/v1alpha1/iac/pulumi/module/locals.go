...
type Locals struct {
	AliCloudCdnDomain *alicloudcdndomainv1alpha1.AliCloudCdnDomain
	Tags              map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudcdndomainv1alpha1.AliCloudCdnDomainStackInput) *Locals {
	locals := &Locals{}
