...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudsecuritygroup/v1alpha1/spec.proto
...
func (x *AliCloudSecurityGroupSpec) Reset() {
	*x = AliCloudSecurityGroupSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudSecurityGroupSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudSecurityGroupRule) Reset() {
	*x = AliCloudSecurityGroupRule{}
	mi := &file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSecurityGroupRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Gdev/planton/provider/alicloud/alicloudsecuritygroup/v1alpha1/spec.proto\x12<dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xb4\x06\n" +
	...
	"\x11resource_group_id\x18\x06 \x01(\tR\x0fresourceGroupId\x12u\n" +
	"\x04tags\x18\a \x03(\v2a.dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.TagsEntryR\x04tags\x12m\n" +
	"\x05rules\x18\b \x03(\v2W.dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupRuleR\x05rules\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\t_priorityB\t\n" +
	"\a_policyB\xe2\x03\n" +
	"@com.dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1B\tSpecProtoP\x01Z|github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudsecuritygroup/v1alpha1;alicloudsecuritygroupv1alpha1\xa2\x02\x05DPPAA\xaa\x02<Dev.Planton.Provider.Alicloud.Alicloudsecuritygroup.V1alpha1\xca\x02<Dev\\Planton\\Provider\\Alicloud\\Alicloudsecuritygroup\\V1alpha1\xe2\x02HDev\\Planton\\Provider\\Alicloud\\Alicloudsecuritygroup\\V1alpha1\\GPBMetadata\xea\x02ADev::Planton::Provider::Alicloud::Alicloudsecuritygroup::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudSecurityGroupSpec)(nil), // 0: dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec
	(*AliCloudSecurityGroupRule)(nil), // 1: dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupRule
	nil,                               // 2: dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),       // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.TagsEntry
	1, // 2: dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.rules:type_name -> dev.planton.provider.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupRule
...
func init() { file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_depIdxs = nil
}
