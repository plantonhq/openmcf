...
func Resources(ctx *pulumi.Context, stackInput *alicloudramrolev1alpha1.AliCloudRamRoleStackInput) error {
...
func policyAttachment(
	...
	role *ram.Role,
	roleName string,
	pa *alicloudramrolev1alpha1.AliCloudRamRolePolicyAttachment,
) error {
	pt := policyType(pa)
