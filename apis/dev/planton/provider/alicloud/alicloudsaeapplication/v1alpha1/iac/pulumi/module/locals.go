...
type Locals struct {
	AliCloudSaeApplication *alicloudsaeapplicationv1alpha1.AliCloudSaeApplication
	Tags                   map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudsaeapplicationv1alpha1.AliCloudSaeApplicationStackInput) *Locals {
	locals := &Locals{}
