...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudvpngateway/v1/spec.proto
...
func (x *AliCloudVpnGatewaySpec) Reset() {
	*x = AliCloudVpnGatewaySpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[0]
...
func (*AliCloudVpnGatewaySpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudVpnConnection) Reset() {
	*x = AliCloudVpnConnection{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudVpnConnection) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudIkeConfig) Reset() {
	*x = AliCloudIkeConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudIkeConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudIpsecConfig) Reset() {
	*x = AliCloudIpsecConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudIpsecConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudVpnHealthCheckConfig) Reset() {
	*x = AliCloudVpnHealthCheckConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudVpnHealthCheckConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/alicloud/alicloudvpngateway/v1/spec.proto\x123dev.planton.provider.alicloud.alicloudvpngateway.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc8\t\n" +
	...
	"\x04tags\x18\n" +
	" \x03(\v2U.dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec.TagsEntryR\x04tags\x12*\n" +
	"\x11resource_group_id\x18\v \x01(\tR\x0fresourceGroupId\x12l\n" +
	"\vconnections\x18\f \x03(\v2J.dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnConnectionR\vconnections\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\n" +
	"ike_config\x18\t \x01(\v2F.dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudIkeConfigR\tikeConfig\x12k\n" +
	"\fipsec_config\x18\n" +
	" \x01(\v2H.dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudIpsecConfigR\vipsecConfig\x12\x81\x01\n" +
	"\x13health_check_config\x18\v \x01(\v2Q.dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnHealthCheckConfigR\x11healthCheckConfigB\r\n" +
	"\v_enable_dpdB\x17\n" +
	...
	"\t_intervalB\b\n" +
	"\x06_retryB\xa3\x03\n" +
	"7com.dev.planton.provider.alicloud.alicloudvpngateway.v1B\tSpecProtoP\x01Zjgithub.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudvpngateway/v1;alicloudvpngatewayv1\xa2\x02\x05DPPAA\xaa\x023Dev.Planton.Provider.Alicloud.Alicloudvpngateway.V1\xca\x023Dev\\Planton\\Provider\\Alicloud\\Alicloudvpngateway\\V1\xe2\x02?Dev\\Planton\\Provider\\Alicloud\\Alicloudvpngateway\\V1\\GPBMetadata\xea\x028Dev::Planton::Provider::Alicloud::Alicloudvpngateway::V1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_goTypes = []any{
	(*AliCloudVpnGatewaySpec)(nil),       // 0: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec
	(*AliCloudVpnConnection)(nil),        // 1: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnConnection
	(*AliCloudIkeConfig)(nil),            // 2: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudIkeConfig
	(*AliCloudIpsecConfig)(nil),          // 3: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudIpsecConfig
	(*AliCloudVpnHealthCheckConfig)(nil), // 4: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnHealthCheckConfig
	nil,                                  // 5: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec.TagsEntry
	(*v1.StringValueOrRef)(nil),          // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 1: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 2: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec.tags:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec.TagsEntry
	1, // 3: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnGatewaySpec.connections:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnConnection
	2, // 4: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnConnection.ike_config:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudIkeConfig
	3, // 5: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnConnection.ipsec_config:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudIpsecConfig
	4, // 6: dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnConnection.health_check_config:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1.AliCloudVpnHealthCheckConfig
...
func init() { file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1_spec_proto_depIdxs = nil
}
