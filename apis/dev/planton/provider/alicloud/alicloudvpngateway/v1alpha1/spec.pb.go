...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudvpngateway/v1alpha1/spec.proto
...
func (x *AliCloudVpnGatewaySpec) Reset() {
	*x = AliCloudVpnGatewaySpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudVpnGatewaySpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudVpnConnection) Reset() {
	*x = AliCloudVpnConnection{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudVpnConnection) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudIkeConfig) Reset() {
	*x = AliCloudIkeConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudIkeConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudIpsecConfig) Reset() {
	*x = AliCloudIpsecConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudIpsecConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudVpnHealthCheckConfig) Reset() {
	*x = AliCloudVpnHealthCheckConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudVpnHealthCheckConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/alicloud/alicloudvpngateway/v1alpha1/spec.proto\x129dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xd4\t\n" +
	...
	"\x0fssl_connections\x18\t \x01(\x05H\x02R\x0esslConnections\x88\x01\x01\x12o\n" +
	"\x04tags\x18\n" +
	" \x03(\v2[.dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.TagsEntryR\x04tags\x12*\n" +
	"\x11resource_group_id\x18\v \x01(\tR\x0fresourceGroupId\x12r\n" +
	"\vconnections\x18\f \x03(\v2P.dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnectionR\vconnections\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x0f\n" +
	"\r_payment_typeB\r\n" +
	"\v_enable_sslB\x12\n" +
	"\x10_ssl_connections\"\xe2\x06\n" +
	...
	"\x12effect_immediately\x18\b \x01(\bB\b\x8a\xa6\x1d\x04trueH\x02R\x11effectImmediately\x88\x01\x01\x12k\n" +
	"\n" +
	"ike_config\x18\t \x01(\v2L.dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudIkeConfigR\tikeConfig\x12q\n" +
	"\fipsec_config\x18\n" +
	" \x01(\v2N.dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudIpsecConfigR\vipsecConfig\x12\x87\x01\n" +
	"\x13health_check_config\x18\v \x01(\v2W.dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnHealthCheckConfigR\x11healthCheckConfigB\r\n" +
	"\v_enable_dpdB\x17\n" +
	...
	"\t_intervalB\b\n" +
	"\x06_retryB\xcd\x03\n" +
	"=com.dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1B\tSpecProtoP\x01Zvgithub.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudvpngateway/v1alpha1;alicloudvpngatewayv1alpha1\xa2\x02\x05DPPAA\xaa\x029Dev.Planton.Provider.Alicloud.Alicloudvpngateway.V1alpha1\xca\x029Dev\\Planton\\Provider\\Alicloud\\Alicloudvpngateway\\V1alpha1\xe2\x02EDev\\Planton\\Provider\\Alicloud\\Alicloudvpngateway\\V1alpha1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Alicloud::Alicloudvpngateway::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudVpnGatewaySpec)(nil),       // 0: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec
	(*AliCloudVpnConnection)(nil),        // 1: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection
	(*AliCloudIkeConfig)(nil),            // 2: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudIkeConfig
	(*AliCloudIpsecConfig)(nil),          // 3: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudIpsecConfig
	(*AliCloudVpnHealthCheckConfig)(nil), // 4: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnHealthCheckConfig
	nil,                                  // 5: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.TagsEntry
	(*v1.StringValueOrRef)(nil),          // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 1: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 2: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.tags:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.TagsEntry
	1, // 3: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.connections:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection
	2, // 4: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection.ike_config:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudIkeConfig
	3, // 5: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection.ipsec_config:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudIpsecConfig
	4, // 6: dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection.health_check_config:type_name -> dev.planton.provider.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnHealthCheckConfig
...
func init() { file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudvpngateway_v1alpha1_spec_proto_depIdxs = nil
}
