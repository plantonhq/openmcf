...
func vpnConnection(
	...
	gateway *vpn.Gateway,
	conn *alicloudvpngatewayv1alpha1.AliCloudVpnConnection,
...
func buildIkeConfig(cfg *alicloudvpngatewayv1alpha1.AliCloudIkeConfig) vpn.ConnectionIkeConfigPtrInput {
...
func buildIpsecConfig(cfg *alicloudvpngatewayv1alpha1.AliCloudIpsecConfig) vpn.ConnectionIpsecConfigPtrInput {
...
func buildHealthCheckConfig(cfg *alicloudvpngatewayv1alpha1.AliCloudVpnHealthCheckConfig) vpn.ConnectionHealthCheckConfigPtrInput {
