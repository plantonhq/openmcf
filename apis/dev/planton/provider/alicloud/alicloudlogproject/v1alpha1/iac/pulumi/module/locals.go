...
import (
	...
	alicloudlogprojectv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudlogproject/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	AliCloudLogProject *alicloudlogprojectv1alpha1.AliCloudLogProject
	Tags               map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudlogprojectv1alpha1.AliCloudLogProjectStackInput) *Locals {
	locals := &Locals{}
...
func logStoreRetentionDays(ls *alicloudlogprojectv1alpha1.AliCloudLogStore) int {
...
func logStoreShardCount(ls *alicloudlogprojectv1alpha1.AliCloudLogStore) int {
...
func logStoreAutoSplit(ls *alicloudlogprojectv1alpha1.AliCloudLogStore) bool {
	if ls.AutoSplit != nil {
		return *ls.AutoSplit
	}
	return true
...
func logStoreMaxSplitShardCount(ls *alicloudlogprojectv1alpha1.AliCloudLogStore) int {
...
func logStoreEnableIndex(ls *alicloudlogprojectv1alpha1.AliCloudLogStore) bool {
...
func logStoreAppendMeta(ls *alicloudlogprojectv1alpha1.AliCloudLogStore) bool {
