...
func Resources(ctx *pulumi.Context, stackInput *alicloudlogprojectv1alpha1.AliCloudLogProjectStackInput) error {
...
func logStore(
	...
	project *log.Project,
	projectName string,
	ls *alicloudlogprojectv1alpha1.AliCloudLogStore,
) (*log.Store, error) {
