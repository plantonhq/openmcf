...
import (
	...
	alicloudstoragebucketv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudstoragebucket/v1alpha1"
	"github.com/pulumi/pulumi-alicloud/sdk/v3/go/alicloud"
	"github.com/pulumi/pulumi-alicloud/sdk/v3/go/alicloud/oss"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

func Resources(ctx *pulumi.Context, stackInput *alicloudstoragebucketv1alpha1.AliCloudStorageBucketStackInput) error {
...
func buildCorsRules(rules []*alicloudstoragebucketv1alpha1.AliCloudStorageBucketCorsRule) oss.BucketCorsRuleArray {
...
func buildLifecycleRules(rules []*alicloudstoragebucketv1alpha1.AliCloudStorageBucketLifecycleRule) oss.BucketLifecycleRuleArray {
