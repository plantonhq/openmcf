...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudstoragebucket/v1alpha1/spec.proto
...
func (x *AliCloudStorageBucketSpec) Reset() {
	*x = AliCloudStorageBucketSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudStorageBucketSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudStorageBucketEncryption) Reset() {
	*x = AliCloudStorageBucketEncryption{}
	mi := &file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudStorageBucketEncryption) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudStorageBucketLifecycleRule) Reset() {
	*x = AliCloudStorageBucketLifecycleRule{}
	mi := &file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudStorageBucketLifecycleRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudStorageBucketLifecycleTransition) Reset() {
	*x = AliCloudStorageBucketLifecycleTransition{}
	mi := &file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudStorageBucketLifecycleTransition) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudStorageBucketCorsRule) Reset() {
	*x = AliCloudStorageBucketCorsRule{}
	mi := &file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudStorageBucketCorsRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AliCloudStorageBucketLogging) Reset() {
	*x = AliCloudStorageBucketLogging{}
	mi := &file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudStorageBucketLogging) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
var File_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Gdev/planton/provider/alicloud/alicloudstoragebucket/v1alpha1/spec.proto\x12<dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a(dev/planton/shared/options/options.proto\"\xc3\f\n" +
	...
	"\x12versioning_enabled\x18\x06 \x01(\bR\x11versioningEnabled\x12\x93\x01\n" +
	"\x16server_side_encryption\x18\a \x01(\v2].dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketEncryptionR\x14serverSideEncryption\x12\x89\x01\n" +
	"\x0flifecycle_rules\x18\b \x03(\v2`.dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLifecycleRuleR\x0elifecycleRules\x12z\n" +
	"\n" +
	"cors_rules\x18\t \x03(\v2[.dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketCorsRuleR\tcorsRules\x12t\n" +
	"\alogging\x18\n" +
	" \x01(\v2Z.dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLoggingR\alogging\x12#\n" +
	"\rforce_destroy\x18\v \x01(\bR\fforceDestroy\x12*\n" +
	"\x11resource_group_id\x18\f \x01(\tR\x0fresourceGroupId\x12u\n" +
	"\x04tags\x18\r \x03(\v2a.dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x11kms_master_key_id\x18\x02 \x01(\tR\x0ekmsMasterKeyId\"\x96\x03\n" +
	"\"AliCloudStorageBucketLifecycleRule\x12\x16\n" +
	"\x06prefix\x18\x01 \x01(\tR\x06prefix\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\x12'\n" +
	"\x0fexpiration_days\x18\x03 \x01(\x05R\x0eexpirationDays\x12\x88\x01\n" +
	"\vtransitions\x18\x04 \x03(\v2f.dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLifecycleTransitionR\vtransitions\x12=\n" +
	...
	"\rtarget_prefix\x18\x02 \x01(\tR\ftargetPrefixB\xe2\x03\n" +
	"@com.dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1B\tSpecProtoP\x01Z|github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudstoragebucket/v1alpha1;alicloudstoragebucketv1alpha1\xa2\x02\x05DPPAA\xaa\x02<Dev.Planton.Provider.Alicloud.Alicloudstoragebucket.V1alpha1\xca\x02<Dev\\Planton\\Provider\\Alicloud\\Alicloudstoragebucket\\V1alpha1\xe2\x02HDev\\Planton\\Provider\\Alicloud\\Alicloudstoragebucket\\V1alpha1\\GPBMetadata\xea\x02ADev::Planton::Provider::Alicloud::Alicloudstoragebucket::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudStorageBucketSpec)(nil),                // 0: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec
	(*AliCloudStorageBucketEncryption)(nil),          // 1: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketEncryption
	(*AliCloudStorageBucketLifecycleRule)(nil),       // 2: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLifecycleRule
	(*AliCloudStorageBucketLifecycleTransition)(nil), // 3: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLifecycleTransition
	(*AliCloudStorageBucketCorsRule)(nil),            // 4: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketCorsRule
	(*AliCloudStorageBucketLogging)(nil),             // 5: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLogging
	nil,                                              // 6: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.TagsEntry
}
var file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.server_side_encryption:type_name -> dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketEncryption
	2, // 1: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.lifecycle_rules:type_name -> dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLifecycleRule
	4, // 2: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.cors_rules:type_name -> dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketCorsRule
	5, // 3: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.logging:type_name -> dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLogging
	6, // 4: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketSpec.TagsEntry
	3, // 5: dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLifecycleRule.transitions:type_name -> dev.planton.provider.alicloud.alicloudstoragebucket.v1alpha1.AliCloudStorageBucketLifecycleTransition
...
func init() { file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudstoragebucket_v1alpha1_spec_proto_depIdxs = nil
}
