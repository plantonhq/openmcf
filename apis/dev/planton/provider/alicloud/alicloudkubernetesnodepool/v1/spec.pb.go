...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudkubernetesnodepool/v1/spec.proto
...
func (x *AliCloudKubernetesNodePoolSpec) Reset() {
	*x = AliCloudKubernetesNodePoolSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[0]
...
func (*AliCloudKubernetesNodePoolSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudKubernetesNodePoolSystemDisk) Reset() {
	*x = AliCloudKubernetesNodePoolSystemDisk{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesNodePoolSystemDisk) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudKubernetesNodePoolDataDisk) Reset() {
	*x = AliCloudKubernetesNodePoolDataDisk{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesNodePoolDataDisk) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudKubernetesNodePoolTaint) Reset() {
	*x = AliCloudKubernetesNodePoolTaint{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesNodePoolTaint) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudKubernetesNodePoolScalingConfig) Reset() {
	*x = AliCloudKubernetesNodePoolScalingConfig{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesNodePoolScalingConfig) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AliCloudKubernetesNodePoolManagement) Reset() {
	*x = AliCloudKubernetesNodePoolManagement{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesNodePoolManagement) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AliCloudKubernetesNodePoolSpotPriceLimit) Reset() {
	*x = AliCloudKubernetesNodePoolSpotPriceLimit{}
	mi := &file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudKubernetesNodePoolSpotPriceLimit) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Fdev/planton/provider/alicloud/alicloudkubernetesnodepool/v1/spec.proto\x12;dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xb7!\n" +
	...
	"\vsystem_disk\x18\v \x01(\v2a.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSystemDiskR\n" +
	"systemDisk\x12~\n" +
	"\n" +
	...
	"\x06labels\x18\x1e \x03(\v2g.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.LabelsEntryR\x06labels\x12t\n" +
	"\x06taints\x18\x1f \x03(\v2\\.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolTaintR\x06taints\x12\x8f\x01\n" +
	"\n" +
	...
	"\x0escaling_config\x18( \x01(\v2d.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolScalingConfigR\rscalingConfig\x12\xd1\x01\n" +
	...
	"\n" +
	"management\x18- \x01(\v2a.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolManagementR\n" +
	...
	"\x11spot_price_limits\x183 \x03(\v2e.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpotPriceLimitR\x0fspotPriceLimits\x12\xcf\x01\n" +
	...
	"\x04tags\x18< \x03(\v2e.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.TagsEntryR\x04tags\x12*\n" +
	...
	"priceLimitB\xdb\x03\n" +
	"?com.dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1B\tSpecProtoP\x01Zzgithub.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudkubernetesnodepool/v1;alicloudkubernetesnodepoolv1\xa2\x02\x05DPPAA\xaa\x02;Dev.Planton.Provider.Alicloud.Alicloudkubernetesnodepool.V1\xca\x02;Dev\\Planton\\Provider\\Alicloud\\Alicloudkubernetesnodepool\\V1\xe2\x02GDev\\Planton\\Provider\\Alicloud\\Alicloudkubernetesnodepool\\V1\\GPBMetadata\xea\x02@Dev::Planton::Provider::Alicloud::Alicloudkubernetesnodepool::V1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_goTypes = []any{
	(*AliCloudKubernetesNodePoolSpec)(nil),           // 0: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec
	(*AliCloudKubernetesNodePoolSystemDisk)(nil),     // 1: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSystemDisk
	(*AliCloudKubernetesNodePoolDataDisk)(nil),       // 2: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolDataDisk
	(*AliCloudKubernetesNodePoolTaint)(nil),          // 3: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolTaint
	(*AliCloudKubernetesNodePoolScalingConfig)(nil),  // 4: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolScalingConfig
	(*AliCloudKubernetesNodePoolManagement)(nil),     // 5: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolManagement
	(*AliCloudKubernetesNodePoolSpotPriceLimit)(nil), // 6: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpotPriceLimit
	nil,                         // 7: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.LabelsEntry
	nil,                         // 8: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 9: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_depIdxs = []int32{
	9,  // 0: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.cluster_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 1: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.vswitch_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 2: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.system_disk:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSystemDisk
	2,  // 3: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.data_disks:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolDataDisk
	9,  // 4: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 5: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.labels:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.LabelsEntry
	3,  // 6: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.taints:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolTaint
	4,  // 7: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.scaling_config:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolScalingConfig
	5,  // 8: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.management:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolManagement
	6,  // 9: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.spot_price_limits:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpotPriceLimit
	8,  // 10: dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudkubernetesnodepool.v1.AliCloudKubernetesNodePoolSpec.TagsEntry
...
func init() { file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudkubernetesnodepool_v1_spec_proto_depIdxs = nil
}
