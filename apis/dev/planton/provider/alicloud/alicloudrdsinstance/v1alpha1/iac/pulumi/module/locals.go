...
import (
	...
	alicloudrdsinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudrdsinstance/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	AliCloudRdsInstance *alicloudrdsinstancev1alpha1.AliCloudRdsInstance
	Tags                map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudrdsinstancev1alpha1.AliCloudRdsInstanceStackInput) *Locals {
	locals := &Locals{}
...
func instanceChargeType(spec *alicloudrdsinstancev1alpha1.AliCloudRdsInstanceSpec) string {
...
func category(spec *alicloudrdsinstancev1alpha1.AliCloudRdsInstanceSpec) string {
...
func accountType(acct *alicloudrdsinstancev1alpha1.AliCloudRdsAccount) string {
...
func privilege(priv *alicloudrdsinstancev1alpha1.AliCloudRdsAccountPrivilege) string {
