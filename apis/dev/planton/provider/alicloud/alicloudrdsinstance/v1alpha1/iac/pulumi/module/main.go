...
func Resources(ctx *pulumi.Context, stackInput *alicloudrdsinstancev1alpha1.AliCloudRdsInstanceStackInput) error {
...
func sslAction(spec *alicloudrdsinstancev1alpha1.AliCloudRdsInstanceSpec) string {
...
func tdeAction(spec *alicloudrdsinstancev1alpha1.AliCloudRdsInstanceSpec) string {
