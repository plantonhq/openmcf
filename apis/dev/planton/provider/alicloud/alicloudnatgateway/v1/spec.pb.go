...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudnatgateway/v1/spec.proto
...
func (x *AliCloudNatGatewaySpec) Reset() {
	*x = AliCloudNatGatewaySpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_msgTypes[0]
...
func (*AliCloudNatGatewaySpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudSnatEntry) Reset() {
	*x = AliCloudSnatEntry{}
	mi := &file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSnatEntry) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/alicloud/alicloudnatgateway/v1/spec.proto\x123dev.planton.provider.alicloud.alicloudnatgateway.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x9d\r\n" +
...
var (
	file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_goTypes = []any{
	(*AliCloudNatGatewaySpec)(nil), // 0: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec
	(*AliCloudSnatEntry)(nil),      // 1: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudSnatEntry
	nil,                            // 2: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec.TagsEntry
	(*v1.StringValueOrRef)(nil),    // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec.tags:type_name -> dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec.TagsEntry
	3, // 3: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec.eip_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 4: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudNatGatewaySpec.snat_entries:type_name -> dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudSnatEntry
	3, // 5: dev.planton.provider.alicloud.alicloudnatgateway.v1.AliCloudSnatEntry.source_vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudnatgateway_v1_spec_proto_depIdxs = nil
}
