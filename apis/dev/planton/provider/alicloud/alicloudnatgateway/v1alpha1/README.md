...
go build ./apis/dev/planton/provider/alicloud/alicloudnatgateway/v1alpha1/iac/pulumi/...

# Go vet
go vet ./apis/dev/planton/provider/alicloud/alicloudnatgateway/v1alpha1/iac/pulumi/...

# Spec tests
go test ./apis/dev/planton/provider/alicloud/alicloudnatgateway/v1alpha1/...

# Terraform validation
cd apis/dev/planton/provider/alicloud/alicloudnatgateway/v1alpha1/iac/tf
