...
import (
	...
	alicloudmongodbinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudmongodbinstance/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	AliCloudMongodbInstance *alicloudmongodbinstancev1alpha1.AliCloudMongodbInstance
	Tags                    map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudmongodbinstancev1alpha1.AliCloudMongodbInstanceStackInput) *Locals {
	locals := &Locals{}
...
func replicationFactor(spec *alicloudmongodbinstancev1alpha1.AliCloudMongodbInstanceSpec) int {
...
func storageEngine(spec *alicloudmongodbinstancev1alpha1.AliCloudMongodbInstanceSpec) string {
...
func instanceChargeType(spec *alicloudmongodbinstancev1alpha1.AliCloudMongodbInstanceSpec) string {
