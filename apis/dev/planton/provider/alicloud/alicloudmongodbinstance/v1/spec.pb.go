...
// 	protoc        (unknown)
// source: dev/planton/provider/alicloud/alicloudmongodbinstance/v1/spec.proto
...
func (x *AliCloudMongodbInstanceSpec) Reset() {
	*x = AliCloudMongodbInstanceSpec{}
	mi := &file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_msgTypes[0]
...
func (*AliCloudMongodbInstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cdev/planton/provider/alicloud/alicloudmongodbinstance/v1/spec.proto\x128dev.planton.provider.alicloud.alicloudmongodbinstance.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xb1\x1c\n" +
	...
	"\x04tags\x18\x14 \x03(\v2_.dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.TagsEntryR\x04tags\x12\x9f\x01\n" +
	"\n" +
	...
	"\n" +
	"parameters\x18\x1e \x03(\v2e.dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.ParametersEntryR\n" +
	"parameters\x12H\n" +
	...
	"<com.dev.planton.provider.alicloud.alicloudmongodbinstance.v1B\tSpecProtoP\x01Ztgithub.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudmongodbinstance/v1;alicloudmongodbinstancev1\xa2\x02\x05DPPAA\xaa\x028Dev.Planton.Provider.Alicloud.Alicloudmongodbinstance.V1\xca\x028Dev\\Planton\\Provider\\Alicloud\\Alicloudmongodbinstance\\V1\xe2\x02DDev\\Planton\\Provider\\Alicloud\\Alicloudmongodbinstance\\V1\\GPBMetadata\xea\x02=Dev::Planton::Provider::Alicloud::Alicloudmongodbinstance::V1b\x06proto3"

var (
	file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_goTypes = []any{
	(*AliCloudMongodbInstanceSpec)(nil), // 0: dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec
	nil,                                 // 1: dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.TagsEntry
	nil,                                 // 2: dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.ParametersEntry
	(*v1.StringValueOrRef)(nil),         // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.tags:type_name -> dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.TagsEntry
	2, // 2: dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.parameters:type_name -> dev.planton.provider.alicloud.alicloudmongodbinstance.v1.AliCloudMongodbInstanceSpec.ParametersEntry
...
func init() { file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_init() }
func file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_init() {
	if File_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto = out.File
	file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_alicloud_alicloudmongodbinstance_v1_spec_proto_depIdxs = nil
}
