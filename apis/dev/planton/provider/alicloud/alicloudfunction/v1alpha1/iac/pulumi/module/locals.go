...
type Locals struct {
	AliCloudFunction *alicloudfunctionv1alpha1.AliCloudFunction
	Tags             map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *alicloudfunctionv1alpha1.AliCloudFunctionStackInput) *Locals {
	locals := &Locals{}
