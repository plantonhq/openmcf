...
import (
	...
	alicloudfunctionv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/alicloud/alicloudfunction/v1alpha1"
	"github.com/pulumi/pulumi-alicloud/sdk/v3/go/alicloud"
	"github.com/pulumi/pulumi-alicloud/sdk/v3/go/alicloud/fc"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

func Resources(ctx *pulumi.Context, stackInput *alicloudfunctionv1alpha1.AliCloudFunctionStackInput) error {
...
func codeArgs(code *alicloudfunctionv1alpha1.AliCloudFunctionCode) fc.V3FunctionCodePtrInput {
...
func vpcConfigArgs(cfg *alicloudfunctionv1alpha1.AliCloudFunctionVpcConfig) fc.V3FunctionVpcConfigPtrInput {
...
func logConfigArgs(cfg *alicloudfunctionv1alpha1.AliCloudFunctionLogConfig) fc.V3FunctionLogConfigPtrInput {
...
func customContainerConfigArgs(cfg *alicloudfunctionv1alpha1.AliCloudFunctionCustomContainerConfig) fc.V3FunctionCustomContainerConfigPtrInput {
...
func containerHealthCheckArgs(hc *alicloudfunctionv1alpha1.AliCloudFunctionHealthCheckConfig) fc.V3FunctionCustomContainerConfigHealthCheckConfigPtrInput {
...
func customRuntimeConfigArgs(cfg *alicloudfunctionv1alpha1.AliCloudFunctionCustomRuntimeConfig) fc.V3FunctionCustomRuntimeConfigPtrInput {
...
func runtimeHealthCheckArgs(hc *alicloudfunctionv1alpha1.AliCloudFunctionHealthCheckConfig) fc.V3FunctionCustomRuntimeConfigHealthCheckConfigPtrInput {
...
func instanceLifecycleConfigArgs(cfg *alicloudfunctionv1alpha1.AliCloudFunctionInstanceLifecycleConfig) fc.V3FunctionInstanceLifecycleConfigPtrInput {
...
func nasConfigArgs(cfg *alicloudfunctionv1alpha1.AliCloudFunctionNasConfig) fc.V3FunctionNasConfigPtrInput {
...
func gpuConfigArgs(cfg *alicloudfunctionv1alpha1.AliCloudFunctionGpuConfig) fc.V3FunctionGpuConfigPtrInput {
