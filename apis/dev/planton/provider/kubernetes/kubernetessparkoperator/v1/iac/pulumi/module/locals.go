...
type Locals struct {
	Spec *kubernetessparkoperatorv1.KubernetesSparkOperatorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetessparkoperatorv1.KubernetesSparkOperatorStackInput) *Locals {
