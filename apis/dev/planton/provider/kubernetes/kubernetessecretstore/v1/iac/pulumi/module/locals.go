...
type Locals struct {
	Spec *kubernetessecretstorev1.KubernetesSecretStoreSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetessecretstorev1.KubernetesSecretStoreStackInput) *Locals {
