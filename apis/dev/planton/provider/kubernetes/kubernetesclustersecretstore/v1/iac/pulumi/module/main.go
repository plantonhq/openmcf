...
// a wait_for block.
func Resources(ctx *pulumi.Context, stackInput *kubernetesclustersecretstorev1.KubernetesClusterSecretStoreStackInput) error {
...
// lockstep.
func buildConditions(conditions []*kubernetesclustersecretstorev1.KubernetesClusterSecretStoreCondition) []interface{} {
