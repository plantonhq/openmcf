...
func buildDataSource(ds *kubernetespersistentvolumeclaimv1.KubernetesPersistentVolumeClaimDataSource) *kubernetescorev1.TypedLocalObjectReferenceArgs {
	args := &kubernetescorev1.TypedLocalObjectReferenceArgs{
		Name: pulumi.String(ds.GetName()),
	}
	if ds.GetKind() == kubernetespersistentvolumeclaimv1.KubernetesPersistentVolumeClaimDataSource_volume_snapshot {
...
func buildLabelSelector(s *kubernetespersistentvolumeclaimv1.KubernetesPersistentVolumeClaimLabelSelector) *metav1.LabelSelectorArgs {
