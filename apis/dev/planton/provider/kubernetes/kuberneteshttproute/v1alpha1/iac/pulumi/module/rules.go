...
func buildRules(rules []*kuberneteshttproutev1alpha1.KubernetesHttpRouteRule) gatewayv1.HTTPRouteSpecRulesArray {
...
func buildTimeouts(timeouts *kuberneteshttproutev1alpha1.KubernetesHttpRouteTimeouts) gatewayv1.HTTPRouteSpecRulesTimeoutsArgs {
