...
// buildMatches maps the Planton request matchers (path, headers, query params,
// method) onto the typed crd2pulumi matches array.
func buildMatches(matches []*kuberneteshttproutev1alpha1.KubernetesHttpRouteMatch) gatewayv1.HTTPRouteSpecRulesMatchesArray {
...
func buildMatchPath(path *kuberneteshttproutev1alpha1.KubernetesHttpRoutePathMatch) gatewayv1.HTTPRouteSpecRulesMatchesPathArgs {
