...
- [KubernetesHelmRelease](/docs/catalog/kubernetes/kuberneteshelmrelease) — when the vendor ships a Helm chart, use it instead of pasting rendered YAML here
- [KubernetesNamespace](/docs/catalog/kubernetes/kubernetesnamespace) — a governed namespace this component's anchor can reference
- [KubernetesDeployment](/docs/catalog/kubernetes/kubernetesdeployment) — the first-class path for workloads; always prefer it over a raw Deployment document
