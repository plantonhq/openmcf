...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesmanifest/v1/spec.proto
...
func (x *KubernetesManifestSpec) Reset() {
	*x = KubernetesManifestSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_msgTypes[0]
...
const file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/kubernetes/kubernetesmanifest/v1/spec.proto\x125dev.planton.provider.kubernetes.kubernetesmanifest.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xf2\x01\n" +
	"\x16KubernetesManifestSpec\x12j\n" +
	"\tnamespace\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x18\xbaH\x03\xc8\x01\x01\x88\xd4a\xc4\x06\x92\xd4a\tspec.nameR\tnamespace\x12)\n" +
	"\x10create_namespace\x18\x03 \x01(\bR\x0fcreateNamespace\x12+\n" +
	"\rmanifest_yaml\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\fmanifestYamlJ\x04\b\x01\x10\x02R\x0etarget_clusterB\xaf\x03\n" +
...
var (
	file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDescData
}
...
func file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesmanifest_v1_spec_proto_depIdxs = nil
}
