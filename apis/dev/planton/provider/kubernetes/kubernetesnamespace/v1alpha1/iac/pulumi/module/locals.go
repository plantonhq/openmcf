...
import (
	...
	kubernetesnamespacev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesnamespace/v1alpha1"
...
type Locals struct {
	...
	Spec *kubernetesnamespacev1alpha1.KubernetesNamespaceSpec
...
func buildLabels(locals *Locals) map[string]string {
	...
	if locals.Spec.PodSecurityStandard != kubernetesnamespacev1alpha1.KubernetesNamespaceSpec_pod_security_standard_unspecified {
...
func buildAnnotations(locals *Locals) map[string]string {
	...
	if locals.Spec.ServiceMeshConfig != nil && locals.Spec.ServiceMeshConfig.Enabled {
		...
		case kubernetesnamespacev1alpha1.KubernetesNamespaceServiceMeshConfig_istio:
		...
		case kubernetesnamespacev1alpha1.KubernetesNamespaceServiceMeshConfig_linkerd:
			// Linkerd sidecar injection
			annotations["linkerd.io/inject"] = "enabled"
		case kubernetesnamespacev1alpha1.KubernetesNamespaceServiceMeshConfig_consul:
...
func computeResourceQuota(spec *kubernetesnamespacev1alpha1.KubernetesNamespaceSpec) *ResourceQuotaConfig {
	...
	case *kubernetesnamespacev1alpha1.KubernetesNamespaceResourceProfile_Preset:
		// Apply preset profile
		switch profileConfig.Preset {
		case kubernetesnamespacev1alpha1.KubernetesNamespaceResourceProfile_small:
		...
		case kubernetesnamespacev1alpha1.KubernetesNamespaceResourceProfile_medium:
		...
		case kubernetesnamespacev1alpha1.KubernetesNamespaceResourceProfile_large:
		...
		case kubernetesnamespacev1alpha1.KubernetesNamespaceResourceProfile_xlarge:
	...
	case *kubernetesnamespacev1alpha1.KubernetesNamespaceResourceProfile_Custom:
		// Apply custom quotas
...
func computeLimitRange(spec *kubernetesnamespacev1alpha1.KubernetesNamespaceSpec) *LimitRangeConfig {
	...
	if customProfile, ok := spec.ResourceProfile.ProfileConfig.(*kubernetesnamespacev1alpha1.KubernetesNamespaceResourceProfile_Custom); ok {
...
func extractNetworkPolicyConfig(spec *kubernetesnamespacev1alpha1.KubernetesNamespaceSpec) *NetworkPolicyConfig {
...
func extractServiceMeshConfig(spec *kubernetesnamespacev1alpha1.KubernetesNamespaceSpec) *ServiceMeshConfig {
...
func getPodSecurityStandard(spec *kubernetesnamespacev1alpha1.KubernetesNamespaceSpec) string {
	switch spec.PodSecurityStandard {
	case kubernetesnamespacev1alpha1.KubernetesNamespaceSpec_privileged:
		return "privileged"
	case kubernetesnamespacev1alpha1.KubernetesNamespaceSpec_baseline:
		return "baseline"
	case kubernetesnamespacev1alpha1.KubernetesNamespaceSpec_restricted:
		return "restricted"
	default:
		return ""
	}
