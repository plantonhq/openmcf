...
type Locals struct {
	...
	Spec        *kubernetespriorityclassv1.KubernetesPriorityClassSpec
	Name        string
...
func initializeLocals(ctx *pulumi.Context, stackInput *kubernetespriorityclassv1.KubernetesPriorityClassStackInput) *Locals {
	...
	if spec.GetPreemptionPolicy() == kubernetespriorityclassv1.KubernetesPriorityClassSpec_never {
