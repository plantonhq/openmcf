...
func databaseEngineValue(engine kubernetesgrafanav1.KubernetesGrafanaDatabaseEngine) string {
	if engine == kubernetesgrafanav1.KubernetesGrafanaDatabaseEngine_mysql {
		return "mysql"
	}
	return "postgres"
}
