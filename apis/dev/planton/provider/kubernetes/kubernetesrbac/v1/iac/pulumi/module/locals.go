...
type Locals struct {
	...
	StackInput *kubernetesrbacv1.KubernetesRbacStackInput

	// Target RBAC grant resource
	Target *kubernetesrbacv1.KubernetesRbac

	// Spec from the target
	Spec *kubernetesrbacv1.KubernetesRbacSpec
...
func initializeLocals(ctx *pulumi.Context, stackInput *kubernetesrbacv1.KubernetesRbacStackInput) (*Locals, error) {
	locals := &Locals{
		Ctx:        ctx,
