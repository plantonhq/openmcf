...
func buildSubjects(locals *Locals) rbacv1.SubjectArray {
	...
	for _, specSubject := range specSubjects {
		...
		case *kubernetesrbacv1.KubernetesRbacSubject_ServiceAccount:
		...
		case *kubernetesrbacv1.KubernetesRbacSubject_User:
			subjects = append(subjects, rbacv1.SubjectArgs{
		...
		case *kubernetesrbacv1.KubernetesRbacSubject_Group:
			subjects = append(subjects, rbacv1.SubjectArgs{
