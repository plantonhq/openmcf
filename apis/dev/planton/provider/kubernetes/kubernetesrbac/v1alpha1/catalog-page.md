...
- [KubernetesServiceAccount](/docs/catalog/kubernetes/kubernetesserviceaccount) — the identity most grants target; reference it from `subjects[].serviceAccount.name` to create identity and grant in one run
- [KubernetesNamespace](/docs/catalog/kubernetes/kubernetesnamespace) — provides the namespace for namespace-scoped grants
