...
type Locals struct {
	Spec *kuberneteskafkamirrormaker2v1alpha1.KubernetesKafkaMirrorMaker2Spec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskafkamirrormaker2v1alpha1.KubernetesKafkaMirrorMaker2StackInput) *Locals {
