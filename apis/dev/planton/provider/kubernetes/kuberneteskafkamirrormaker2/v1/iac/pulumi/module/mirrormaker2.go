...
func mirrorsBody(mirrors []*kuberneteskafkamirrormaker2v1.KubernetesKafkaMirrorMaker2Mirror) []interface{} {
...
func sourceBody(source *kuberneteskafkamirrormaker2v1.KubernetesKafkaMirrorMaker2Source) map[string]interface{} {
	body := map[string]interface{}{
...
func connectorBody(connector *kuberneteskafkamirrormaker2v1.KubernetesKafkaMirrorMaker2Connector) map[string]interface{} {
	if connector == nil {
		return nil
	}
	body := map[string]interface{}{}
...
func podTemplateBody(spec *kuberneteskafkamirrormaker2v1.KubernetesKafkaMirrorMaker2Spec) map[string]interface{} {
...
func jvmBody(jvm *kuberneteskafkamirrormaker2v1.KubernetesKafkaMirrorMaker2Jvm) map[string]interface{} {
	if jvm == nil {
		return nil
	}
	body := map[string]interface{}{}
