...
type Locals struct {
	Spec *kubernetesopenfgav1.KubernetesOpenFgaSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesopenfgav1.KubernetesOpenFgaStackInput) *Locals {
