...
type Locals struct {
	Spec *kubernetesmetricsserverv1alpha1.KubernetesMetricsServerSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesmetricsserverv1alpha1.KubernetesMetricsServerStackInput) *Locals {
