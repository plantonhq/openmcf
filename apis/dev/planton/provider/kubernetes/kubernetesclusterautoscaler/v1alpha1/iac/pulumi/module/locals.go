...
type Locals struct {
	Spec *kubernetesclusterautoscalerv1alpha1.KubernetesClusterAutoscalerSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesclusterautoscalerv1alpha1.KubernetesClusterAutoscalerStackInput) *Locals {
