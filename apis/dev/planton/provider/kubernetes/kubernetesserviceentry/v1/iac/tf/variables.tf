...
#
# Thin projection of the networking.istio.io/v1 "ServiceEntry" custom resource.
#
...
variable "spec" {
  description = "Spec for the networking.istio.io/v1 \"ServiceEntry\" custom resource, passed through verbatim to kubectl_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
