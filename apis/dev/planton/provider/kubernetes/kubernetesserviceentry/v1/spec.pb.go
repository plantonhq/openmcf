...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesserviceentry/v1/spec.proto
...
func (x *KubernetesServiceEntrySpec) Reset() {
	*x = KubernetesServiceEntrySpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesServiceEntryPort) Reset() {
	*x = KubernetesServiceEntryPort{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesServiceEntryPort) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesServiceEntryEndpoint) Reset() {
	*x = KubernetesServiceEntryEndpoint{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesServiceEntryEndpoint) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/kubernetes/kubernetesserviceentry/v1/spec.proto\x129dev.planton.provider.kubernetes.kubernetesserviceentry.v1\x1a\x1bbuf/validate/validate.proto\x1a/dev/planton/provider/kubernetes/istio_api.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xa0\x10\n" +
	...
	"\t_locationB\r\n" +
	"\v_resolutionJ\x04\b\x01\x10\x02R\x0etarget_cluster\"\x8a\x02\n" +
	...
	"\x05ports\x18\x02 \x03(\v2d.dev.planton.provider.kubernetes.kubernetesserviceentry.v1.KubernetesServiceEntryEndpoint.PortsEntryBC\xbaH@\x9a\x01=\x10\x80\x01\".r,\x18?2(^[a-zA-Z0-9]([-a-zA-Z0-9]*[a-zA-Z0-9])?$*\b*\x06\x18\xff\xff\x03(\x01R\x05ports\x12\x88\x01\n" +
	"\x06labels\x18\x03 \x03(\v2e.dev.planton.provider.kubernetes.kubernetesserviceentry.v1.KubernetesServiceEntryEndpoint.LabelsEntryB\t\xbaH\x06\x9a\x01\x03\x10\x80\x02R\x06labels\x12'\n" +
	...
	"=com.dev.planton.provider.kubernetes.kubernetesserviceentry.v1B\tSpecProtoP\x01Ztgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesserviceentry/v1;kubernetesserviceentryv1\xa2\x02\x05DPPKK\xaa\x029Dev.Planton.Provider.Kubernetes.Kubernetesserviceentry.V1\xca\x029Dev\\Planton\\Provider\\Kubernetes\\Kubernetesserviceentry\\V1\xe2\x02EDev\\Planton\\Provider\\Kubernetes\\Kubernetesserviceentry\\V1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Kubernetes::Kubernetesserviceentry::V1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_goTypes = []any{
	(*KubernetesServiceEntrySpec)(nil),     // 0: dev.planton.provider.kubernetes.kubernetesserviceentry.v1.KubernetesServiceEntrySpec
	(*KubernetesServiceEntryPort)(nil),     // 1: dev.planton.provider.kubernetes.kubernetesserviceentry.v1.KubernetesServiceEntryPort
...
func file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesserviceentry_v1_spec_proto_depIdxs = nil
}
