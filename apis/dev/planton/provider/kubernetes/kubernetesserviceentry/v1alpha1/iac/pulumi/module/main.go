...
import (
	...
	kubernetesserviceentryv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesserviceentry/v1alpha1"
...
// buildPortArgs maps one Planton service port to the typed SDK args. The proto uint32 port
...
func buildPortArgs(port *kubernetesserviceentryv1alpha1.KubernetesServiceEntryPort) istionetworkingv1.ServiceEntrySpecPortsArgs {
...
// buildEndpointArgs maps one Planton endpoint to the typed SDK args. The endpoint port map
...
func buildEndpointArgs(endpoint *kubernetesserviceentryv1alpha1.KubernetesServiceEntryEndpoint) istionetworkingv1.ServiceEntrySpecEndpointsArgs {
