...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesargocd/v1/spec.proto
...
func (x *KubernetesArgocdSpec) Reset() {
	*x = KubernetesArgocdSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_msgTypes[0]
...
const file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDesc = "" +
	...
	"\aingress\x18\x05 \x01(\v2L.dev.planton.provider.kubernetes.kubernetesargocd.v1.KubernetesArgocdIngressR\aingressJ\x04\b\x01\x10\x02R\x0etarget_cluster\"\xce\x01\n" +
...
var (
	file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesargocd_v1_spec_proto_depIdxs = nil
}
