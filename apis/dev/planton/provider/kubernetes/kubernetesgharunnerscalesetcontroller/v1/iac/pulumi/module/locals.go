...
type Locals struct {
	Spec *kubernetesgharunnerscalesetcontrollerv1.KubernetesGhaRunnerScaleSetControllerSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesgharunnerscalesetcontrollerv1.KubernetesGhaRunnerScaleSetControllerStackInput) *Locals {
