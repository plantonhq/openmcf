...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesgharunnerscalesetcontroller/v1alpha1/spec.proto
...
func (x *KubernetesGhaRunnerScaleSetControllerSpec) Reset() {
	*x = KubernetesGhaRunnerScaleSetControllerSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesGhaRunnerScaleSetControllerSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesGhaRunnerScaleSetControllerFlags) Reset() {
	*x = KubernetesGhaRunnerScaleSetControllerFlags{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGhaRunnerScaleSetControllerFlags) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesGhaRunnerScaleSetControllerMetrics) Reset() {
	*x = KubernetesGhaRunnerScaleSetControllerMetrics{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGhaRunnerScaleSetControllerMetrics) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesGhaRunnerScaleSetControllerScheduling) Reset() {
	*x = KubernetesGhaRunnerScaleSetControllerScheduling{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGhaRunnerScaleSetControllerScheduling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ydev/planton/provider/kubernetes/kubernetesgharunnerscalesetcontroller/v1alpha1/spec.proto\x12Ndev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xd3\b\n" +
	...
	"\tresources\x18\x06 \x01(\v23.dev.planton.provider.kubernetes.ContainerResourcesR\tresources\x12\x90\x01\n" +
	"\x05flags\x18\a \x01(\v2z.dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerFlagsR\x05flags\x12\x96\x01\n" +
	"\ametrics\x18\b \x01(\v2|.dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerMetricsR\ametrics\x12\x81\x01\n" +
	"\x12image_pull_secrets\x18\t \x03(\tBS\xaa\xa6\x1dONames of existing Kubernetes imagePullSecrets (references), not secret materialR\x10imagePullSecrets\x12\x9f\x01\n" +
	"\n" +
	"scheduling\x18\n" +
	" \x01(\v2\x7f.dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSchedulingR\n" +
	"scheduling\x12\x1f\n" +
	...
	"\x11listener_endpoint\x18\x03 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x10listenerEndpoint\"\x83\x03\n" +
	"/KubernetesGhaRunnerScaleSetControllerScheduling\x12\xb7\x01\n" +
	"\rnode_selector\x18\x01 \x03(\v2\x91\x01.dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerScheduling.NodeSelectorEntryR\fnodeSelector\x12U\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xdf\x04\n" +
	"Rcom.dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1B\tSpecProtoP\x01Z\x9e\x01github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesgharunnerscalesetcontroller/v1alpha1;kubernetesgharunnerscalesetcontrollerv1alpha1\xa2\x02\x05DPPKK\xaa\x02NDev.Planton.Provider.Kubernetes.Kubernetesgharunnerscalesetcontroller.V1alpha1\xca\x02NDev\\Planton\\Provider\\Kubernetes\\Kubernetesgharunnerscalesetcontroller\\V1alpha1\xe2\x02ZDev\\Planton\\Provider\\Kubernetes\\Kubernetesgharunnerscalesetcontroller\\V1alpha1\\GPBMetadata\xea\x02SDev::Planton::Provider::Kubernetes::Kubernetesgharunnerscalesetcontroller::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesGhaRunnerScaleSetControllerSpec)(nil),       // 0: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSpec
	(*KubernetesGhaRunnerScaleSetControllerFlags)(nil),      // 1: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerFlags
	(*KubernetesGhaRunnerScaleSetControllerMetrics)(nil),    // 2: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerMetrics
	(*KubernetesGhaRunnerScaleSetControllerScheduling)(nil), // 3: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerScheduling
	nil,                                   // 4: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerScheduling.NodeSelectorEntry
...
var file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 1: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSpec.image:type_name -> dev.planton.provider.kubernetes.ContainerImage
	7, // 2: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSpec.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	1, // 3: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSpec.flags:type_name -> dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerFlags
	2, // 4: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSpec.metrics:type_name -> dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerMetrics
	3, // 5: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerSpec.scheduling:type_name -> dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerScheduling
	4, // 6: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerScheduling.node_selector:type_name -> dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerScheduling.NodeSelectorEntry
	8, // 7: dev.planton.provider.kubernetes.kubernetesgharunnerscalesetcontroller.v1alpha1.KubernetesGhaRunnerScaleSetControllerScheduling.tolerations:type_name -> dev.planton.provider.kubernetes.WorkloadToleration
...
func file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesgharunnerscalesetcontroller_v1alpha1_spec_proto_depIdxs = nil
}
