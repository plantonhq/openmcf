...
The **KubernetesZalandoPostgresOperator** is a Planton component that deploys and manages the [Zalando Postgres Operator](https://github.com/zalando/postgres-operator) on Kubernetes clusters. This operator simplifies the deployment, management, and backup of PostgreSQL databases in Kubernetes, providing production-grade database automation.
...
This Planton component abstracts the complexity of deploying and configuring the Zalando Postgres Operator, providing a simplified interface while maintaining flexibility for production deployments.
...
# Deploy the operator
planton pulumi up --manifest postgres-operator.yaml
```

### Using Planton CLI with Terraform
...
planton terraform apply --manifest postgres-operator.yaml
```
...
1. **Namespace Management**: 
   - If `create_namespace: true` - Creates namespace with Planton labels
...
- [Planton Documentation](https://docs.planton.io)

## Support

For issues, questions, or contributions:
- File an issue in the Planton repository
