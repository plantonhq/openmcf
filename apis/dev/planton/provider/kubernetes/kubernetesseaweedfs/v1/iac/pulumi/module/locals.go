...
type Locals struct {
	Spec *kubernetesseaweedfsv1.KubernetesSeaweedFsSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesseaweedfsv1.KubernetesSeaweedFsStackInput) *Locals {
