...
// nil).
func pvcDataMap(volume *kubernetesseaweedfsv1.KubernetesSeaweedFsDataVolume, defaultSize string) map[string]interface{} {
	size := volume.GetSize()
	if size == "" {
		size = defaultSize
	}
...
func bucketsSlice(buckets []*kubernetesseaweedfsv1.KubernetesSeaweedFsS3Bucket) []interface{} {
