...
#
# Applies one Gateway API ListenerSet custom resource. The CR spec arrives from the
...
# connection at plan time — a ListenerSet can be PLANNED before the Gateway API
...
resource "kubectl_manifest" "listener_set" {
