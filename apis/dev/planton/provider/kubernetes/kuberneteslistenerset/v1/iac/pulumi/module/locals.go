...
type Locals struct {
	KubernetesListenerSet *kuberneteslistenersetv1.KubernetesListenerSet
...
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteslistenersetv1.KubernetesListenerSetStackInput) *Locals {
