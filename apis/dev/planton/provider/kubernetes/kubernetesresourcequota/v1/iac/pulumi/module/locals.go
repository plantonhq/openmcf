...
type Locals struct {
	...
	Spec        *kubernetesresourcequotav1.KubernetesResourceQuotaSpec
	Namespace   string
	Name        string
...
func initializeLocals(ctx *pulumi.Context, stackInput *kubernetesresourcequotav1.KubernetesResourceQuotaStackInput) *Locals {
...
func scopeApiString(s kubernetesresourcequotav1.KubernetesResourceQuotaSpec_KubernetesResourceQuotaScope) string {
	switch s {
	case kubernetesresourcequotav1.KubernetesResourceQuotaSpec_terminating:
		return "Terminating"
	case kubernetesresourcequotav1.KubernetesResourceQuotaSpec_not_terminating:
		return "NotTerminating"
	case kubernetesresourcequotav1.KubernetesResourceQuotaSpec_best_effort:
		return "BestEffort"
	case kubernetesresourcequotav1.KubernetesResourceQuotaSpec_not_best_effort:
		return "NotBestEffort"
	case kubernetesresourcequotav1.KubernetesResourceQuotaSpec_priority_class:
		return "PriorityClass"
	case kubernetesresourcequotav1.KubernetesResourceQuotaSpec_cross_namespace_pod_affinity:
		return "CrossNamespacePodAffinity"
	case kubernetesresourcequotav1.KubernetesResourceQuotaSpec_volume_attributes_class:
...
func limitTypeApiString(t kubernetesresourcequotav1.KubernetesResourceQuotaLimitDefaults_KubernetesResourceQuotaLimitType) string {
	switch t {
	case kubernetesresourcequotav1.KubernetesResourceQuotaLimitDefaults_pod:
		return "Pod"
	case kubernetesresourcequotav1.KubernetesResourceQuotaLimitDefaults_persistent_volume_claim:
