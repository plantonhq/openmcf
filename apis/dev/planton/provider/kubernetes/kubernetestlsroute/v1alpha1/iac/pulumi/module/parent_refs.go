...
func buildParentRefs(parentRefs []*kubernetesapis.KubernetesGatewayApiParentReference) gatewayv1.TLSRouteSpecParentRefsArray {
	arr := gatewayv1.TLSRouteSpecParentRefsArray{}
	for _, ref := range parentRefs {
		args := gatewayv1.TLSRouteSpecParentRefsArgs{
