...
1. **The workload's inline block** — KubernetesDeployment's
   ...
   default; the [Deployment guide](../../kubernetesdeployment/v1/GUIDE.md)
...
3. **[KubernetesKeda](../../kuberneteskeda/v1/GUIDE.md)** — event-driven
...
[KubernetesMetricsServer](../../kubernetesmetricsserver/v1/GUIDE.md) on
