...
func buildMetric(m *kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetric) *autoscalingv2.MetricSpecArgs {
	switch m.GetType() {
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricType_container_resource:
	...
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricType_pods:
		p := m.GetPods()
		return &autoscalingv2.MetricSpecArgs{
	...
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricType_object:
		o := m.GetObject()
		return &autoscalingv2.MetricSpecArgs{
	...
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricType_external:
		e := m.GetExternal()
		return &autoscalingv2.MetricSpecArgs{
...
func buildMetricTarget(t *kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricTarget) *autoscalingv2.MetricTargetArgs {
...
func buildMetricIdentifier(id *kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricIdentifier) *autoscalingv2.MetricIdentifierArgs {
...
func buildScalingRules(rules *kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerScalingRules) *autoscalingv2.HPAScalingRulesArgs {
