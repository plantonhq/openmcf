...
type Locals struct {
	...
	Spec        *kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerSpec
	Namespace   string
	Name        string
...
func initializeLocals(ctx *pulumi.Context, stackInput *kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerStackInput) *Locals {
...
func metricTargetTypeApiString(t kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricTargetType) string {
	switch t {
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricTargetType_utilization:
		return "Utilization"
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerMetricTargetType_raw_value:
		return "Value"
	default:
		return "AverageValue"
	}
...
func selectPolicyApiString(rules *kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerScalingRules) string {
	switch rules.GetSelectPolicy() {
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerScalingRules_min_change:
		return "Min"
	case kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerScalingRules_disabled:
		return "Disabled"
	default:
		return "Max"
	}
...
func scalingPolicyTypeApiString(t kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerScalingPolicy_KubernetesHorizontalPodAutoscalerScalingPolicyType) string {
	if t == kuberneteshorizontalpodautoscalerv1.KubernetesHorizontalPodAutoscalerScalingPolicy_percent {
		return "Percent"
	}
	return "Pods"
}
