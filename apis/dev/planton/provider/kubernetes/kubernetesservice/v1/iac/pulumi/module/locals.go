...
func resolveInternalTrafficPolicy(p kubernetesservicev1.KubernetesServiceSpec_KubernetesServiceInternalTrafficPolicy) string {
	switch p {
	case kubernetesservicev1.KubernetesServiceSpec_internal_local:
		return "Local"
	default:
		return "Cluster"
	}
...
func resolveTrafficDistribution(d kubernetesservicev1.KubernetesServiceSpec_KubernetesServiceTrafficDistribution) string {
	switch d {
	case kubernetesservicev1.KubernetesServiceSpec_prefer_same_zone:
		return "PreferSameZone"
	case kubernetesservicev1.KubernetesServiceSpec_prefer_same_node:
...
func resolveIpFamily(f kubernetesservicev1.KubernetesServiceSpec_KubernetesServiceIpFamily) string {
	switch f {
	case kubernetesservicev1.KubernetesServiceSpec_ipv6:
		return "IPv6"
	default:
		return "IPv4"
	}
...
func resolveIpFamilyPolicy(p kubernetesservicev1.KubernetesServiceSpec_KubernetesServiceIpFamilyPolicy) string {
	switch p {
	case kubernetesservicev1.KubernetesServiceSpec_single_stack:
		return "SingleStack"
	case kubernetesservicev1.KubernetesServiceSpec_prefer_dual_stack:
		return "PreferDualStack"
	case kubernetesservicev1.KubernetesServiceSpec_require_dual_stack:
