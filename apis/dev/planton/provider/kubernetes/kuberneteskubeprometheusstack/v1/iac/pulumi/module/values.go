...
func buildPrometheusSpec(locals *Locals) (map[string]interface{}, error) {
	...
	discovery := kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackMonitorDiscovery_all_monitors
	if prom != nil && prom.Discovery != nil {
		discovery = prom.GetDiscovery()
	}
	if discovery == kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackMonitorDiscovery_all_monitors ||
		discovery == kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackMonitorDiscovery_kubernetes_kube_prometheus_stack_monitor_discovery_unspecified {
	...
	if len(prom.GetRemoteWrite()) > 0 {
		...
		for i, rw := range prom.GetRemoteWrite() {
			...
			case *kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackRemoteWrite_BasicAuth:
			...
			case *kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackRemoteWrite_BearerTokenSecret:
			...
			case *kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackRemoteWrite_Sigv4:
				...
				entry["sigv4"] = sigv4
			case *kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackRemoteWrite_AzureAd:
...
func applyScheduling(target map[string]interface{}, sched *kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackScheduling) {
	if sched == nil {
		return
	}
