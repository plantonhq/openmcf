...
type Locals struct {
	Spec *kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskubeprometheusstackv1.KubernetesKubePrometheusStackStackInput) *Locals {
