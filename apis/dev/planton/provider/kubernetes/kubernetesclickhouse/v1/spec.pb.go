...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesclickhouse/v1/spec.proto
...
func (x *KubernetesClickHouseSpec) Reset() {
	*x = KubernetesClickHouseSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[0]
...
func (*KubernetesClickHouseSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type KubernetesClickHouseUser struct {
	...
	// "10.0.0.0/8") or "::/0" for anywhere. Empty = the upstream default
	// ("::/0" — any network; the password is the only gate).
...
var (
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_init() {
	...
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_depIdxs = nil
}
