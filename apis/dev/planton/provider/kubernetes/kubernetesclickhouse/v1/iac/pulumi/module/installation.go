...
func buildZookeeper(locals *Locals) clickhousev1.ClickHouseInstallationSpecConfigurationZookeeperPtrInput {
	...
	if coordinationType != kubernetesclickhousev1.KubernetesClickHouseCoordination_external_keeper &&
		coordinationType != kubernetesclickhousev1.KubernetesClickHouseCoordination_external_zookeeper {
		return nil
	}
...
func buildUsers(users []*kubernetesclickhousev1.KubernetesClickHouseUser,
	createdAuthSecret *kubernetescorev1.Secret,
) pulumi.MapInput {
	if len(users) == 0 {
		return nil
...
func buildNamedSettings(bundles []*kubernetesclickhousev1.KubernetesClickHouseNamedSettings) pulumi.MapInput {
	if len(bundles) == 0 {
		return nil
	}
...
func buildVolumeClaimTemplates(spec *kubernetesclickhousev1.KubernetesClickHouseSpec) clickhousev1.ClickHouseInstallationSpecTemplatesVolumeClaimTemplatesArray {
