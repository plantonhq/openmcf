...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesclickhouse/v1alpha1/spec.proto
...
func (KubernetesClickHouseCoordination_CoordinationType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesClickHouseCoordination_CoordinationType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_enumTypes[0]
}
...
func (KubernetesClickHouseCoordination_CoordinationType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *KubernetesClickHouseSpec) Reset() {
	*x = KubernetesClickHouseSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesClickHouseSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type KubernetesClickHouseCoordination struct {
	...
	Type KubernetesClickHouseCoordination_CoordinationType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination_CoordinationType" json:"type,omitempty"`
	// *
...
func (x *KubernetesClickHouseCoordination) Reset() {
	*x = KubernetesClickHouseCoordination{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseCoordination) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesClickHouseManagedKeeper) Reset() {
	*x = KubernetesClickHouseManagedKeeper{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseManagedKeeper) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesClickHouseExternalCoordination) Reset() {
	*x = KubernetesClickHouseExternalCoordination{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseExternalCoordination) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesClickHouseCoordinationNode) Reset() {
	*x = KubernetesClickHouseCoordinationNode{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseCoordinationNode) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesClickHouseUser) Reset() {
	*x = KubernetesClickHouseUser{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseUser) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesClickHouseNamedSettings) Reset() {
	*x = KubernetesClickHouseNamedSettings{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseNamedSettings) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Hdev/planton/provider/kubernetes/kubernetesclickhouse/v1alpha1/spec.proto\x12=dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xbb\x19\n" +
	...
	"\x18retain_volumes_on_delete\x18\f \x01(\bR\x15retainVolumesOnDelete\x12\x83\x01\n" +
	"\fcoordination\x18\r \x01(\v2_.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordinationR\fcoordination\x12m\n" +
	"\x05users\x18\x0e \x03(\v2W.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUserR\x05users\x12|\n" +
	"\bprofiles\x18\x0f \x03(\v2`.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettingsR\bprofiles\x12x\n" +
	"\x06quotas\x18\x10 \x03(\v2`.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettingsR\x06quotas\x12\x81\x01\n" +
	"\bsettings\x18\x11 \x03(\v2e.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.SettingsEntryR\bsettings\x12x\n" +
	"\x05files\x18\x12 \x03(\v2b.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.FilesEntryR\x05files\x12B\n" +
	...
	"\x13pdb_max_unavailable\x18\x15 \x01(\x05B\f\xbaH\x04\x1a\x02(\x00\x8a\xa6\x1d\x011H\x04R\x11pdbMaxUnavailable\x88\x01\x01\x12\x8e\x01\n" +
	"\rnode_selector\x18\x16 \x03(\v2i.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.NodeSelectorEntryR\fnodeSelector\x12U\n" +
	"\vtolerations\x18\x17 \x03(\v23.dev.planton.provider.kubernetes.WorkloadTolerationR\vtolerations\x12\xa0\x01\n" +
	"\x13service_annotations\x18\x18 \x03(\v2o.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.ServiceAnnotationsEntryR\x12serviceAnnotations\x12\x18\n" +
	...
	"\x14_pdb_max_unavailable\"\x9f\x06\n" +
	" KubernetesClickHouseCoordination\x12\x84\x01\n" +
	"\x04type\x18\x01 \x01(\x0e2p.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination.CoordinationTypeR\x04type\x12x\n" +
	"\x06keeper\x18\x02 \x01(\v2`.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseManagedKeeperR\x06keeper\x12\x83\x01\n" +
	"\bexternal\x18\x03 \x01(\v2g.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseExternalCoordinationR\bexternal\"n\n" +
	...
	"\n" +
	"_disk_size\"\xdb\x01\n" +
	"(KubernetesClickHouseExternalCoordination\x12y\n" +
	"\x05nodes\x18\x01 \x03(\v2c.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordinationNodeR\x05nodes\x12\x12\n" +
	...
	"\x11access_management\x18\a \x01(\bR\x10accessManagement\x12\x81\x01\n" +
	"\bsettings\x18\b \x03(\v2e.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUser.SettingsEntryR\bsettings\x1a;\n" +
	"\rSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xbd\x02\n" +
	"!KubernetesClickHouseNamedSettings\x12N\n" +
	"\x04name\x18\x01 \x01(\tB:\xbaH7\xc8\x01\x01r220^[a-zA-Z0-9_]([a-zA-Z0-9_-]{0,61}[a-zA-Z0-9_])?$R\x04name\x12\x8a\x01\n" +
	"\bsettings\x18\x02 \x03(\v2n.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettings.SettingsEntryR\bsettings\x1a;\n" +
	"\rSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xe7\x03\n" +
	"Acom.dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1B\tSpecProtoP\x01Z|github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesclickhouse/v1alpha1;kubernetesclickhousev1alpha1\xa2\x02\x05DPPKK\xaa\x02=Dev.Planton.Provider.Kubernetes.Kubernetesclickhouse.V1alpha1\xca\x02=Dev\\Planton\\Provider\\Kubernetes\\Kubernetesclickhouse\\V1alpha1\xe2\x02IDev\\Planton\\Provider\\Kubernetes\\Kubernetesclickhouse\\V1alpha1\\GPBMetadata\xea\x02BDev::Planton::Provider::Kubernetes::Kubernetesclickhouse::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_goTypes = []any{
	(KubernetesClickHouseCoordination_CoordinationType)(0), // 0: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination.CoordinationType
	(*KubernetesClickHouseSpec)(nil),                       // 1: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec
	(*KubernetesClickHouseCoordination)(nil),               // 2: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination
	(*KubernetesClickHouseManagedKeeper)(nil),              // 3: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseManagedKeeper
	(*KubernetesClickHouseExternalCoordination)(nil),       // 4: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseExternalCoordination
	(*KubernetesClickHouseCoordinationNode)(nil),           // 5: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordinationNode
	(*KubernetesClickHouseUser)(nil),                       // 6: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUser
	(*KubernetesClickHouseNamedSettings)(nil),              // 7: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettings
	nil,                                   // 8: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.SettingsEntry
	nil,                                   // 9: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.FilesEntry
	nil,                                   // 10: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.NodeSelectorEntry
	nil,                                   // 11: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.ServiceAnnotationsEntry
	nil,                                   // 12: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUser.SettingsEntry
	nil,                                   // 13: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettings.SettingsEntry
...
var file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_depIdxs = []int32{
	14, // 0: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	15, // 1: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.image:type_name -> dev.planton.provider.kubernetes.ContainerImage
	16, // 2: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	14, // 3: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.storage_class:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 4: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.coordination:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination
	6,  // 5: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.users:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUser
	7,  // 6: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.profiles:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettings
	7,  // 7: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.quotas:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettings
	8,  // 8: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.settings:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.SettingsEntry
	9,  // 9: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.files:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.FilesEntry
	10, // 10: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.node_selector:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.NodeSelectorEntry
	17, // 11: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.tolerations:type_name -> dev.planton.provider.kubernetes.WorkloadToleration
	11, // 12: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.service_annotations:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseSpec.ServiceAnnotationsEntry
	0,  // 13: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination.type:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination.CoordinationType
	3,  // 14: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination.keeper:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseManagedKeeper
	4,  // 15: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordination.external:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseExternalCoordination
	16, // 16: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseManagedKeeper.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	14, // 17: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseManagedKeeper.storage_class:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 18: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseExternalCoordination.nodes:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseCoordinationNode
	14, // 19: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUser.password:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 20: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUser.settings:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseUser.SettingsEntry
	13, // 21: dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettings.settings:type_name -> dev.planton.provider.kubernetes.kubernetesclickhouse.v1alpha1.KubernetesClickHouseNamedSettings.SettingsEntry
...
func init() { file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesclickhouse_v1alpha1_spec_proto_depIdxs = nil
}
