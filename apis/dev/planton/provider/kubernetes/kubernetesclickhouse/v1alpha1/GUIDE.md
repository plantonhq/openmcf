...
is the full story, and the [operator guide](../../kubernetesaltinityoperator/v1alpha1/GUIDE.md)
...
`spec.coordination` (the field doc on [reference.md](reference.md) is the
