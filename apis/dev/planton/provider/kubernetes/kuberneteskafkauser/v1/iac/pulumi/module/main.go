...
func Resources(ctx *pulumi.Context, stackInput *kuberneteskafkauserv1.KubernetesKafkaUserStackInput) error {
...
func authorizationBody(authorization *kuberneteskafkauserv1.KubernetesKafkaUserAuthorization) map[string]interface{} {
...
func quotasBody(quotas *kuberneteskafkauserv1.KubernetesKafkaUserQuotas) map[string]interface{} {
	if quotas == nil {
		return nil
	}
