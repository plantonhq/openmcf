...
import (
	...
	kubernetestelemetryv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetestelemetry/v1alpha1"
...
func buildTelemetrySpec(spec *kubernetestelemetryv1alpha1.KubernetesTelemetrySpec) map[string]interface{} {
...
func buildProviderRefs(refs []*kubernetestelemetryv1alpha1.KubernetesTelemetryProviderRef) []interface{} {
	out := make([]interface{}, 0, len(refs))
	for _, ref := range refs {
...
func buildTracingList(list []*kubernetestelemetryv1alpha1.KubernetesTelemetryTracing) []interface{} {
...
func buildMetricsList(list []*kubernetestelemetryv1alpha1.KubernetesTelemetryMetrics) []interface{} {
	out := make([]interface{}, 0, len(list))
...
func buildMetricsOverrides(list []*kubernetestelemetryv1alpha1.KubernetesTelemetryMetricsOverride) []interface{} {
	out := make([]interface{}, 0, len(list))
	for _, o := range list {
		m := map[string]interface{}{}
...
func buildMetricSelector(match *kubernetestelemetryv1alpha1.KubernetesTelemetryMetricSelector) map[string]interface{} {
	m := map[string]interface{}{}
	switch {
...
func buildTagOverrides(tags map[string]*kubernetestelemetryv1alpha1.KubernetesTelemetryTagOverride) map[string]interface{} {
	out := make(map[string]interface{}, len(tags))
...
func buildAccessLoggingList(list []*kubernetestelemetryv1alpha1.KubernetesTelemetryAccessLogging) []interface{} {
	out := make([]interface{}, 0, len(list))
	for _, al := range list {
		m := map[string]interface{}{}
