...
import (
	...
	kuberneteskeycloakv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kuberneteskeycloak/v1alpha1"
...
func dbBody(db *kuberneteskeycloakv1alpha1.KubernetesKeycloakDb) map[string]interface{} {
...
func httpBody(locals *Locals, http *kuberneteskeycloakv1alpha1.KubernetesKeycloakHttp) map[string]interface{} {
	if http == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func hostnameBody(hostname *kuberneteskeycloakv1alpha1.KubernetesKeycloakHostname) map[string]interface{} {
	if hostname == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func featuresBody(features *kuberneteskeycloakv1alpha1.KubernetesKeycloakFeatures) map[string]interface{} {
	if features == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func additionalOptionsBody(options []*kuberneteskeycloakv1alpha1.KubernetesKeycloakAdditionalOption) []interface{} {
	if len(options) == 0 {
		return nil
	}
	out := []interface{}{}
...
func schedulingBody(scheduling *kuberneteskeycloakv1alpha1.KubernetesKeycloakScheduling) map[string]interface{} {
	if scheduling == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func updateBody(update *kuberneteskeycloakv1alpha1.KubernetesKeycloakUpdate) map[string]interface{} {
	if update == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func tracingBody(tracing *kuberneteskeycloakv1alpha1.KubernetesKeycloakTracing) map[string]interface{} {
	if tracing == nil {
		return nil
	}
	out := map[string]interface{}{}
