...
type KubernetesIstioSpec struct {
	...
	//
	// Defaults to "1.26.8" -- the Istio version this Planton release targets and the
...
const file_dev_planton_provider_kubernetes_kubernetesistio_v1_spec_proto_rawDesc = "" +
	...
	"\n" +
	"\b_versionJ\x04\b\x01\x10\x02R\x0etarget_cluster\"\x94\x01\n" +
