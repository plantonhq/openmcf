...
func buildJobSpec(jobTemplate *kubernetescronjobv1alpha1.KubernetesCronJobJobTemplate, locals *Locals,
...
func buildPodFailurePolicy(policy *kubernetescronjobv1alpha1.KubernetesCronJobPodFailurePolicy) *batchv1.PodFailurePolicyArgs {
...
func buildSuccessPolicy(policy *kubernetescronjobv1alpha1.KubernetesCronJobSuccessPolicy) *batchv1.SuccessPolicyArgs {
