...
import (
	...
	kubernetesjobv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesjob/v1alpha1"
...
func buildPodFailurePolicy(policy *kubernetesjobv1alpha1.KubernetesJobPodFailurePolicy) *batchv1.PodFailurePolicyArgs {
...
func buildSuccessPolicy(policy *kubernetesjobv1alpha1.KubernetesJobSuccessPolicy) *batchv1.SuccessPolicyArgs {
