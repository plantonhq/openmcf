# Provider requirements for the KubernetesKafka module.
#
# kubectl (alekc/kubectl) applies the Kafka and KafkaNodePool custom
# resources: unlike the hashicorp kubernetes provider's
