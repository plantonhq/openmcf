...
func storageBody(storage *kuberneteskafkav1.KubernetesKafkaStorage) map[string]interface{} {
...
func jbodVolumeBody(volume *kuberneteskafkav1.KubernetesKafkaStorageVolume) map[string]interface{} {
	body := map[string]interface{}{
		"id":   int(volume.GetId()),
		"type": "persistent-claim",
		"size": volume.GetSize(),
...
func poolTemplateBody(pool *kuberneteskafkav1.KubernetesKafkaNodePool) map[string]interface{} {
