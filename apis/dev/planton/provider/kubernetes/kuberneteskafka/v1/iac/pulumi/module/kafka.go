...
func listenersBody(listeners []*kuberneteskafkav1.KubernetesKafkaListener) []interface{} {
...
func listenerType(listener *kuberneteskafkav1.KubernetesKafkaListener) string {
	if listener.GetType() != "" {
...
func listenerAuthenticationBody(auth *kuberneteskafkav1.KubernetesKafkaListenerAuthentication) map[string]interface{} {
	if auth == nil {
		return nil
	}
	body := map[string]interface{}{
...
func listenerConfigurationBody(configuration *kuberneteskafkav1.KubernetesKafkaListenerConfiguration) map[string]interface{} {
...
func listenerBootstrapBody(bootstrap *kuberneteskafkav1.KubernetesKafkaListenerBootstrap) map[string]interface{} {
	if bootstrap == nil {
		return nil
	}
	body := map[string]interface{}{}
...
func listenerBrokersBody(brokers []*kuberneteskafkav1.KubernetesKafkaListenerBroker) []interface{} {
...
func authorizationBody(authorization *kuberneteskafkav1.KubernetesKafkaAuthorization) map[string]interface{} {
...
func entityOperatorBody(entityOperator *kuberneteskafkav1.KubernetesKafkaEntityOperator) map[string]interface{} {
	topicEnabled := true
	userEnabled := true
...
func cruiseControlBody(cruiseControl *kuberneteskafkav1.KubernetesKafkaCruiseControl) map[string]interface{} {
...
func kafkaExporterBody(exporter *kuberneteskafkav1.KubernetesKafkaExporter) map[string]interface{} {
...
func caBody(ca *kuberneteskafkav1.KubernetesKafkaCa) map[string]interface{} {
	if ca == nil {
		return nil
	}
	body := map[string]interface{}{}
...
func jvmBody(jvm *kuberneteskafkav1.KubernetesKafkaJvm) map[string]interface{} {
	if jvm == nil {
		return nil
	}
	body := map[string]interface{}{}
