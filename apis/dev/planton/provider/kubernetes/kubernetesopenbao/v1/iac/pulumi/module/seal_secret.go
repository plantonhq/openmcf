...
func sealSecretData(spec *kubernetesopenbaov1.KubernetesOpenBaoSpec) map[string]string {
...
func sealPlainEnv(spec *kubernetesopenbaov1.KubernetesOpenBaoSpec) map[string]string {
	seal := spec.GetAutoUnseal()
	if seal == nil {
		return nil
	}
