...
import (
	...
	kubernetesexternalsecretsoperatorv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesexternalsecretsoperator/v1alpha1"
...
type Locals struct {
	Spec *kubernetesexternalsecretsoperatorv1alpha1.KubernetesExternalSecretsOperatorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesexternalsecretsoperatorv1alpha1.KubernetesExternalSecretsOperatorStackInput) *Locals {
