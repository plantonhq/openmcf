...
1. [KubernetesAltinityOperator](../../kubernetesaltinityoperator/v1alpha1/GUIDE.md)
   — watching the ClickHouse's namespace (its guide's own trap).
2. [KubernetesClickHouse](../../kubernetesclickhouse/v1alpha1/GUIDE.md) — with
...
[KubernetesOtelCollector](../../kubernetesotelcollector/v1alpha1/GUIDE.md) in
