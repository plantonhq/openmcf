...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetessignoz/v1alpha1/spec.proto
...
func (x *KubernetesSignozSpec) Reset() {
	*x = KubernetesSignozSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesSignozSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesSignozClickHouse) Reset() {
	*x = KubernetesSignozClickHouse{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozClickHouse) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesSignozClickHousePassword) Reset() {
	*x = KubernetesSignozClickHousePassword{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozClickHousePassword) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesSignozServer) Reset() {
	*x = KubernetesSignozServer{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozServer) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesSignozSmtp) Reset() {
	*x = KubernetesSignozSmtp{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozSmtp) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesSignozSecretKeyRef) Reset() {
	*x = KubernetesSignozSecretKeyRef{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozSecretKeyRef) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesSignozOtelCollector) Reset() {
	*x = KubernetesSignozOtelCollector{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozOtelCollector) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesSignozOtelCollectorAutoscaling) Reset() {
	*x = KubernetesSignozOtelCollectorAutoscaling{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozOtelCollectorAutoscaling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *KubernetesSignozScheduling) Reset() {
	*x = KubernetesSignozScheduling{}
	mi := &file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesSignozScheduling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
var File_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ddev/planton/provider/kubernetes/kubernetessignoz/v1alpha1/spec.proto\x129dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xbd\a\n" +
	"\x14KubernetesSignozSpec\x12j\n" +
	"\tnamespace\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x18\xbaH\x03\xc8\x01\x01\x88\xd4a\xa0\x1f\x92\xd4a\tspec.nameR\tnamespace\x12)\n" +
	"\x10create_namespace\x18\x02 \x01(\bR\x0fcreateNamespace\x125\n" +
	"\rchart_version\x18\x03 \x01(\tB\v\x8a\xa6\x1d\a0.133.0H\x00R\fchartVersion\x88\x01\x01\x12}\n" +
	"\n" +
	"clickhouse\x18\x04 \x01(\v2U.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHouseB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"clickhouse\x12i\n" +
	"\x06server\x18\x05 \x01(\v2Q.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServerR\x06server\x12\x7f\n" +
	"\x0eotel_collector\x18\x06 \x01(\v2X.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollectorR\rotelCollector\x12!\n" +
	"\fcluster_name\x18\a \x01(\tR\vclusterName\x12%\n" +
	"\x0eimage_registry\x18\b \x01(\tR\rimageRegistry\x12x\n" +
	"\x12image_pull_secrets\x18\t \x03(\tBJ\xaa\xa6\x1dFNames of existing image-pull Secrets (references), not secret materialR\x10imagePullSecrets\x12u\n" +
	"\n" +
	"scheduling\x18\n" +
	" \x01(\v2U.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSchedulingR\n" +
	"scheduling\x12\x1f\n" +
	"\vhelm_values\x18\v \x01(\tR\n" +
	"helmValuesB\x10\n" +
	"\x0e_chart_version\"\xb8\x06\n" +
	...
	"\busername\x18\x05 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\busername\x12\x8e\x01\n" +
	"\x0fpassword_secret\x18\x06 \x01(\v2].dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHousePasswordB\x06\xbaH\x03\xc8\x01\x01R\x0epasswordSecret\x12\x16\n" +
	...
	"secretName\x12n\n" +
	"\n" +
	"secret_key\x18\x02 \x01(\tBO\xbaH\x03\xc8\x01\x01\xaa\xa6\x1dEKey NAME within an existing Secret (a reference), not secret materialR\tsecretKey\"\xf9\x04\n" +
	...
	"\fexternal_url\x18\x04 \x01(\tR\vexternalUrl\x12c\n" +
	"\x04smtp\x18\x05 \x01(\v2O.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSmtpR\x04smtp\x12l\n" +
	"\x03env\x18\x06 \x03(\v2Z.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer.EnvEntryR\x03env\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
	...
	"\busername\x18\x03 \x01(\tR\busername\x12\x80\x01\n" +
	"\x0fpassword_secret\x18\x04 \x01(\v2W.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSecretKeyRefR\x0epasswordSecret\x12\x1f\n" +
	...
	"\x03key\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x03key\"\x8c\x05\n" +
	...
	"\tresources\x18\x02 \x01(\v23.dev.planton.provider.kubernetes.ContainerResourcesR\tresources\x12\x85\x01\n" +
	"\vautoscaling\x18\x03 \x01(\v2c.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollectorAutoscalingR\vautoscaling\x12E\n" +
	...
	"\"_target_memory_utilization_percent\"\xf3\x02\n" +
	"\x1aKubernetesSignozScheduling\x12\x8c\x01\n" +
	"\rnode_selector\x18\x01 \x03(\v2g.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozScheduling.NodeSelectorEntryR\fnodeSelector\x12U\n" +
	...
	"=com.dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1B\tSpecProtoP\x01Ztgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetessignoz/v1alpha1;kubernetessignozv1alpha1\xa2\x02\x05DPPKK\xaa\x029Dev.Planton.Provider.Kubernetes.Kubernetessignoz.V1alpha1\xca\x029Dev\\Planton\\Provider\\Kubernetes\\Kubernetessignoz\\V1alpha1\xe2\x02EDev\\Planton\\Provider\\Kubernetes\\Kubernetessignoz\\V1alpha1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Kubernetes::Kubernetessignoz::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesSignozSpec)(nil),                     // 0: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSpec
	(*KubernetesSignozClickHouse)(nil),               // 1: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHouse
	(*KubernetesSignozClickHousePassword)(nil),       // 2: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHousePassword
	(*KubernetesSignozServer)(nil),                   // 3: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer
	(*KubernetesSignozSmtp)(nil),                     // 4: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSmtp
	(*KubernetesSignozSecretKeyRef)(nil),             // 5: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSecretKeyRef
	(*KubernetesSignozOtelCollector)(nil),            // 6: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollector
	(*KubernetesSignozOtelCollectorAutoscaling)(nil), // 7: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollectorAutoscaling
	(*KubernetesSignozScheduling)(nil),               // 8: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozScheduling
	nil,                                              // 9: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer.EnvEntry
	nil,                                              // 10: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozScheduling.NodeSelectorEntry
...
var file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_depIdxs = []int32{
	11, // 0: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSpec.clickhouse:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHouse
	3,  // 2: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSpec.server:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer
	6,  // 3: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSpec.otel_collector:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollector
	8,  // 4: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSpec.scheduling:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozScheduling
	11, // 5: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHouse.host:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 6: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHouse.cluster_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 7: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHouse.password_secret:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHousePassword
	11, // 8: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozClickHousePassword.secret_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 9: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer.storage_class:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 10: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	4,  // 11: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer.smtp:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSmtp
	9,  // 12: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer.env:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozServer.EnvEntry
	5,  // 13: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSmtp.password_secret:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozSecretKeyRef
	12, // 14: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollector.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	7,  // 15: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollector.autoscaling:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozOtelCollectorAutoscaling
	10, // 16: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozScheduling.node_selector:type_name -> dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozScheduling.NodeSelectorEntry
	13, // 17: dev.planton.provider.kubernetes.kubernetessignoz.v1alpha1.KubernetesSignozScheduling.tolerations:type_name -> dev.planton.provider.kubernetes.WorkloadToleration
...
func init() { file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetessignoz_v1alpha1_spec_proto_depIdxs = nil
}
