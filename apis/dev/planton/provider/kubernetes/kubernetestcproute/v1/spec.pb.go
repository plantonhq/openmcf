...
var file_dev_planton_provider_kubernetes_kubernetestcproute_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.kubernetes.kubernetestcproute.v1.KubernetesTcpRouteSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.provider.kubernetes.kubernetestcproute.v1.KubernetesTcpRouteSpec.parent_refs:type_name -> dev.planton.provider.kubernetes.KubernetesGatewayApiParentReference
	1, // 2: dev.planton.provider.kubernetes.kubernetestcproute.v1.KubernetesTcpRouteSpec.rules:type_name -> dev.planton.provider.kubernetes.kubernetestcproute.v1.KubernetesTcpRouteRule
	4, // 3: dev.planton.provider.kubernetes.kubernetestcproute.v1.KubernetesTcpRouteRule.backend_refs:type_name -> dev.planton.provider.kubernetes.KubernetesGatewayApiBackendRef
