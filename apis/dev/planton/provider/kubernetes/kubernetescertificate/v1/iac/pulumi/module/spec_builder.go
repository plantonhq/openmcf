...
func buildCertificateSpec(locals *Locals) (certmanagerv1.CertificateSpecArgs, error) {
	...
	if pk := spec.GetPrivateKey(); pk != nil {
		...
		if pk.Algorithm != nil {
			...
			case kubernetescertificatev1.KubernetesCertificatePrivateKey_rsa:
				privateKey.Algorithm = pulumi.StringPtr("RSA")
			case kubernetescertificatev1.KubernetesCertificatePrivateKey_ecdsa:
				privateKey.Algorithm = pulumi.StringPtr("ECDSA")
			case kubernetescertificatev1.KubernetesCertificatePrivateKey_ed25519:
		...
		if pk.Encoding != nil {
			...
			case kubernetescertificatev1.KubernetesCertificatePrivateKey_pkcs1:
				privateKey.Encoding = pulumi.StringPtr("PKCS1")
			case kubernetescertificatev1.KubernetesCertificatePrivateKey_pkcs8:
				privateKey.Encoding = pulumi.StringPtr("PKCS8")
			}
		}
		if pk.RotationPolicy != nil {
			switch pk.GetRotationPolicy() {
			case kubernetescertificatev1.KubernetesCertificatePrivateKey_always:
				privateKey.RotationPolicy = pulumi.StringPtr("Always")
			case kubernetescertificatev1.KubernetesCertificatePrivateKey_never:
...
func buildIssuerRef(issuerRef *kubernetescertificatev1.KubernetesCertificateIssuerRef) (*certmanagerv1.CertificateSpecIssuerRefArgs, error) {
	switch {
