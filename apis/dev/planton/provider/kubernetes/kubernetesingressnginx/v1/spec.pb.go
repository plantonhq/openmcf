...
const file_dev_planton_provider_kubernetes_kubernetesingressnginx_v1_spec_proto_rawDesc = "" +
	...
	"\x1dadditional_security_group_ids\x18\x01 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x1aadditionalSecurityGroupIds\x12t\n" +
	"\n" +
	"subnet_ids\x18\x02 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x9c\x02\x92\xd4a\x18status.outputs.subnet_idR\tsubnetIds\x123\n" +
