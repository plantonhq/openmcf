...
func buildHelmValues(locals *Locals) (map[string]interface{}, error) {
	...
	case kubernetesingressnginxv1.KubernetesIngressNginxServiceType_node_port:
		service["type"] = "NodePort"
	case kubernetesingressnginxv1.KubernetesIngressNginxServiceType_cluster_ip:
	...
	if spec.GetService().GetExternalTrafficPolicy() == kubernetesingressnginxv1.KubernetesIngressNginxExternalTrafficPolicy_local {
	...
	// ---- workload shape ---------------------------------------------------
	if spec.GetControllerKind() == kubernetesingressnginxv1.KubernetesIngressNginxControllerKind_daemon_set {
	...
	if aw := spec.GetAdmissionWebhooks(); aw != nil {
		...
		if aw.GetFailurePolicy() == kubernetesingressnginxv1.KubernetesIngressNginxWebhookFailurePolicy_ignore {
