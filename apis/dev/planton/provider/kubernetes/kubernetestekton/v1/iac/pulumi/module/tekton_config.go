...
func namespaceMetadataBody(metadata *kubernetestektonv1.KubernetesTektonNamespaceMetadata) map[string]interface{} {
	if metadata == nil {
		return nil
	}
...
func placementBody(placement *kubernetestektonv1.KubernetesTektonPlacement) map[string]interface{} {
	if placement == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func pipelineBody(pipeline *kubernetestektonv1.KubernetesTektonPipeline) map[string]interface{} {
	if pipeline == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func performanceBody(performance *kubernetestektonv1.KubernetesTektonPipelinePerformance) map[string]interface{} {
	if performance == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func triggerBody(trigger *kubernetestektonv1.KubernetesTektonTrigger) map[string]interface{} {
	if trigger == nil {
		return nil
	}
	out := map[string]interface{}{}
...
func dashboardBody(dashboard *kubernetestektonv1.KubernetesTektonDashboard) map[string]interface{} {
	if dashboard == nil {
		return nil
	}
	out := map[string]interface{}{
...
func chainBody(chain *kubernetestektonv1.KubernetesTektonChain) map[string]interface{} {
	if chain == nil {
		return nil
	}
	out := map[string]interface{}{
...
func prunerBody(pruner *kubernetestektonv1.KubernetesTektonPruner) map[string]interface{} {
	if pruner == nil {
		return nil
	}
	out := map[string]interface{}{
...
func paramsBody(params []*kubernetestektonv1.KubernetesTektonParam) []interface{} {
	if len(params) == 0 {
		return nil
	}
	out := []interface{}{}
