...
type Locals struct {
	Spec *kuberneteskarpenterv1.KubernetesKarpenterSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskarpenterv1.KubernetesKarpenterStackInput) *Locals {
