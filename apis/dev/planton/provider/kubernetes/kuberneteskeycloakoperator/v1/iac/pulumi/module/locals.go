...
type Locals struct {
	KubernetesKeycloakOperator *kuberneteskeycloakoperatorv1.KubernetesKeycloakOperator
	Spec                       *kuberneteskeycloakoperatorv1.KubernetesKeycloakOperatorSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskeycloakoperatorv1.KubernetesKeycloakOperatorStackInput) *Locals {
