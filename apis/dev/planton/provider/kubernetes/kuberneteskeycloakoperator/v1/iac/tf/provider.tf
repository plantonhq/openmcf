# Provider requirements for the KubernetesKeycloakOperator module.
#
# kubectl (alekc/kubectl) applies the release manifests per document with
...
# The http provider fetches the release manifests from the pinned tag.
#
