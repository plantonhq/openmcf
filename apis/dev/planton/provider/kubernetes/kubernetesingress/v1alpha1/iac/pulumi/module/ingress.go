...
import (
	...
	kubernetesingressv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesingress/v1alpha1"
...
func buildBackend(b *kubernetesingressv1alpha1.KubernetesIngressBackend) *kubernetesnetworkingv1.IngressBackendArgs {
...
func resolvePathType(t kubernetesingressv1alpha1.KubernetesIngressHttpPath_KubernetesIngressPathType) string {
	switch t {
	case kubernetesingressv1alpha1.KubernetesIngressHttpPath_exact:
		return "Exact"
	case kubernetesingressv1alpha1.KubernetesIngressHttpPath_implementation_specific:
