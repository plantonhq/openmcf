...
import (
	kubernetesgatewayapicrdsv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesgatewayapicrds/v1alpha1"
...
func initializeLocals(ctx *pulumi.Context, stackInput *kubernetesgatewayapicrdsv1alpha1.KubernetesGatewayApiCrdsStackInput) *Locals {
	...
	if spec.InstallChannel != nil {
		if spec.InstallChannel.Channel == kubernetesgatewayapicrdsv1alpha1.KubernetesGatewayApiCrdsSpec_InstallChannel_experimental {
			isExperimental = true
