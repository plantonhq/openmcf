...
- [KubernetesGatewayClass](/docs/catalog/kubernetes/kubernetesgatewayclass) and [KubernetesGateway](/docs/catalog/kubernetes/kubernetesgateway) — the first-class Gateway API kinds that require these CRDs
- [KubernetesHttpRoute](/docs/catalog/kubernetes/kuberneteshttproute) and its route siblings (gRPC, TLS, TCP, UDP) — attach routing to a Gateway
