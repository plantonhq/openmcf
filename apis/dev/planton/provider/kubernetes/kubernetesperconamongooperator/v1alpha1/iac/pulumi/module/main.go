...
import (
	...
	kubernetesperconamongooperatorv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesperconamongooperator/v1alpha1"
	"github.com/plantonhq/planton/pkg/iac/pulumi/pulumimodule/provider/kubernetes/pulumikubernetesprovider"
	helmv3 "github.com/pulumi/pulumi-kubernetes/sdk/v4/go/kubernetes/helm/v3"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

// Resources installs the Percona Operator for MongoDB from the official
...
func Resources(ctx *pulumi.Context, stackInput *kubernetesperconamongooperatorv1alpha1.KubernetesPerconaMongoOperatorStackInput) error {
	...
	_, err = helmv3.NewRelease(ctx, locals.ReleaseName, &helmv3.ReleaseArgs{
		...
		// timeout, not surface later as PerconaServerMongoDB resources
	...
	if err != nil {
		return errors.Wrap(err, "failed to install psmdb-operator helm release")
	}
