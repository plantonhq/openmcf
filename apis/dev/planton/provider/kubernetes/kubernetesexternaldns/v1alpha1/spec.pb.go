...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesexternaldns/v1alpha1/spec.proto
...
func (x *KubernetesExternalDnsSpec) Reset() {
	*x = KubernetesExternalDnsSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesExternalDnsSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesExternalDnsAwsRoute53) Reset() {
	*x = KubernetesExternalDnsAwsRoute53{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsAwsRoute53) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesExternalDnsGoogleCloudDns) Reset() {
	*x = KubernetesExternalDnsGoogleCloudDns{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsGoogleCloudDns) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesExternalDnsAzureDns) Reset() {
	*x = KubernetesExternalDnsAzureDns{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsAzureDns) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesExternalDnsCloudflare) Reset() {
	*x = KubernetesExternalDnsCloudflare{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsCloudflare) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesExternalDnsWebhook) Reset() {
	*x = KubernetesExternalDnsWebhook{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsWebhook) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesExternalDnsInMemory) Reset() {
	*x = KubernetesExternalDnsInMemory{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsInMemory) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesExternalDnsPrometheus) Reset() {
	*x = KubernetesExternalDnsPrometheus{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsPrometheus) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
var File_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Idev/planton/provider/kubernetes/kubernetesexternaldns/v1alpha1/spec.proto\x12>dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a7dev/planton/provider/kubernetes/workload_identity.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x87\x1f\n" +
	...
	"\x8a\xa6\x1d\x061.21.1H\x01R\fchartVersion\x88\x01\x01\x12\x82\x01\n" +
	"\vaws_route53\x18\x04 \x01(\v2_.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53H\x00R\n" +
	"awsRoute53\x12\x8f\x01\n" +
	"\x10google_cloud_dns\x18\x05 \x01(\v2c.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDnsH\x00R\x0egoogleCloudDns\x12|\n" +
	"\tazure_dns\x18\x06 \x01(\v2].dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDnsH\x00R\bazureDns\x12\x81\x01\n" +
	"\n" +
	"cloudflare\x18\a \x01(\v2_.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflareH\x00R\n" +
	"cloudflare\x12x\n" +
	"\awebhook\x18\b \x01(\v2\\.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhookH\x00R\awebhook\x12|\n" +
	"\tin_memory\x18\t \x01(\v2].dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsInMemoryH\x00R\binMemory\x12h\n" +
	...
	"\tresources\x18\x1d \x01(\v23.dev.planton.provider.kubernetes.ContainerResourcesR\tresources\x12\x90\x01\n" +
	"\rnode_selector\x18\x1e \x03(\v2k.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.NodeSelectorEntryR\fnodeSelector\x12U\n" +
	"\vtolerations\x18\x1f \x03(\v23.dev.planton.provider.kubernetes.WorkloadTolerationR\vtolerations\x12.\n" +
	"\x13priority_class_name\x18  \x01(\tR\x11priorityClassName\x12\x7f\n" +
	"\n" +
	"prometheus\x18! \x01(\v2_.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheusR\n" +
	"prometheus\x12)\n" +
	...
	"\x15_dns_records_per_page\"\x86\x03\n" +
	...
	"\x04args\x18\x03 \x03(\tR\x04args\x12w\n" +
	"\x03env\x18\x04 \x03(\v2e.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.EnvEntryR\x03env\x12Q\n" +
	...
	"\x05zones\x18\x01 \x03(\tR\x05zones\"\xff\x02\n" +
	"\x1fKubernetesExternalDnsPrometheus\x12'\n" +
	"\x0fservice_monitor\x18\x01 \x01(\bR\x0eserviceMonitor\x128\n" +
	"\x18service_monitor_interval\x18\x02 \x01(\tR\x16serviceMonitorInterval\x12\xaf\x01\n" +
	"\x16service_monitor_labels\x18\x03 \x03(\v2y.dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.ServiceMonitorLabelsEntryR\x14serviceMonitorLabels\x1aG\n" +
...
var (
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesExternalDnsSpec)(nil),             // 0: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec
	(*KubernetesExternalDnsAwsRoute53)(nil),       // 1: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53
	(*KubernetesExternalDnsGoogleCloudDns)(nil),   // 2: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns
	(*KubernetesExternalDnsAzureDns)(nil),         // 3: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDns
	(*KubernetesExternalDnsCloudflare)(nil),       // 4: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflare
	(*KubernetesExternalDnsWebhook)(nil),          // 5: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook
	(*KubernetesExternalDnsInMemory)(nil),         // 6: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsInMemory
	(*KubernetesExternalDnsPrometheus)(nil),       // 7: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus
	nil,                                           // 8: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.NodeSelectorEntry
	nil,                                           // 9: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.EnvEntry
	nil,                                           // 10: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.ServiceMonitorLabelsEntry
...
var file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_depIdxs = []int32{
	11, // 0: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.aws_route53:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53
	2,  // 2: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.google_cloud_dns:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns
	3,  // 3: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.azure_dns:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDns
	4,  // 4: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.cloudflare:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflare
	5,  // 5: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.webhook:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook
	6,  // 6: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.in_memory:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsInMemory
	12, // 7: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.workload_identity:type_name -> dev.planton.provider.kubernetes.KubernetesWorkloadIdentity
	13, // 8: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	8,  // 9: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.node_selector:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.NodeSelectorEntry
	14, // 10: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.tolerations:type_name -> dev.planton.provider.kubernetes.WorkloadToleration
	7,  // 11: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.prometheus:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus
	11, // 12: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 13: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53.assume_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 14: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns.project:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 15: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 16: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDns.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 17: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflare.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 18: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.env:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.EnvEntry
	13, // 19: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	10, // 20: dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.service_monitor_labels:type_name -> dev.planton.provider.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.ServiceMonitorLabelsEntry
...
func init() { file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_depIdxs = nil
}
