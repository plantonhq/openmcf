...
type Locals struct {
	Spec *kubernetesflinkoperatorv1alpha1.KubernetesFlinkOperatorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesflinkoperatorv1alpha1.KubernetesFlinkOperatorStackInput) *Locals {
