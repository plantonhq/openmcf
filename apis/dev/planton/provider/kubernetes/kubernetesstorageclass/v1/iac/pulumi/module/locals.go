...
type Locals struct {
	...
	Spec        *kubernetesstorageclassv1.KubernetesStorageClassSpec
	Name        string
...
func initializeLocals(ctx *pulumi.Context, stackInput *kubernetesstorageclassv1.KubernetesStorageClassStackInput) *Locals {
...
func resolveReclaimPolicy(spec *kubernetesstorageclassv1.KubernetesStorageClassSpec) string {
	if spec.GetReclaimPolicy() == kubernetesstorageclassv1.KubernetesStorageClassSpec_retain {
		return "Retain"
	}
	return "Delete"
}
...
func resolveVolumeBindingMode(spec *kubernetesstorageclassv1.KubernetesStorageClassSpec) string {
	if spec.GetVolumeBindingMode() == kubernetesstorageclassv1.KubernetesStorageClassSpec_wait_for_first_consumer {
