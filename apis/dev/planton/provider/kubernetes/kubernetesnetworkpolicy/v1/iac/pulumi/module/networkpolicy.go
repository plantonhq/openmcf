...
func buildPeers(peers []*kubernetesnetworkpolicyv1.KubernetesNetworkPolicyPeer) kubernetesnetworkingv1.NetworkPolicyPeerArray {
...
// contiguous range.
func buildPorts(ports []*kubernetesnetworkpolicyv1.KubernetesNetworkPolicyPort) kubernetesnetworkingv1.NetworkPolicyPortArray {
...
func buildLabelSelector(s *kubernetesnetworkpolicyv1.KubernetesNetworkPolicyLabelSelector) *metav1.LabelSelectorArgs {
...
func resolveProtocol(p kubernetesnetworkpolicyv1.KubernetesNetworkPolicyPort_KubernetesNetworkPolicyProtocol) string {
	switch p {
	case kubernetesnetworkpolicyv1.KubernetesNetworkPolicyPort_UDP:
		return "UDP"
	case kubernetesnetworkpolicyv1.KubernetesNetworkPolicyPort_SCTP:
		return "SCTP"
	default:
		return "TCP"
	}
