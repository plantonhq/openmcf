...
allows (the [KubernetesNamespace guide](../../kubernetesnamespace/v1alpha1/GUIDE.md)
...
the additive-allow model on [reference.md](reference.md): selecting a pod
...
[KubernetesCilium](../../kubernetescilium/v1alpha1/GUIDE.md) is the catalog's
