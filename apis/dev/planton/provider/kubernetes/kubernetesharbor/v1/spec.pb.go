...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesharbor/v1/spec.proto
...
func (x *KubernetesHarborSpec) Reset() {
	*x = KubernetesHarborSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[0]
...
const file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc = "" +
	"\n" +
	">dev/planton/provider/kubernetes/kubernetesharbor/v1/spec.proto\x123dev.planton.provider.kubernetes.kubernetesharbor.v1\x1a\x1bbuf/validate/validate.proto\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\x1a google/protobuf/descriptor.proto\"\xde\v\n" +
...
var (
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_init() {
	...
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1_spec_proto_depIdxs = nil
}
