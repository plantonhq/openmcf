...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesharbor/v1alpha1/stack_outputs.proto
...
func (x *KubernetesHarborStackOutputs) Reset() {
	*x = KubernetesHarborStackOutputs{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesHarborStackOutputs) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Mdev/planton/provider/kubernetes/kubernetesharbor/v1alpha1/stack_outputs.proto\x129dev.planton.provider.kubernetes.kubernetesharbor.v1alpha1\x1a0dev/planton/provider/kubernetes/kubernetes.proto\"\x87\x05\n" +
	...
	"\x14port_forward_command\x18\x0e \x01(\tR\x12portForwardCommandB\xd3\x03\n" +
	"=com.dev.planton.provider.kubernetes.kubernetesharbor.v1alpha1B\x11StackOutputsProtoP\x01Ztgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesharbor/v1alpha1;kubernetesharborv1alpha1\xa2\x02\x05DPPKK\xaa\x029Dev.Planton.Provider.Kubernetes.Kubernetesharbor.V1alpha1\xca\x029Dev\\Planton\\Provider\\Kubernetes\\Kubernetesharbor\\V1alpha1\xe2\x02EDev\\Planton\\Provider\\Kubernetes\\Kubernetesharbor\\V1alpha1\\GPBMetadata\xea\x02>Dev::Planton::Provider::Kubernetes::Kubernetesharbor::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*KubernetesHarborStackOutputs)(nil),   // 0: dev.planton.provider.kubernetes.kubernetesharbor.v1alpha1.KubernetesHarborStackOutputs
	(*kubernetes.KubernetesSecretKey)(nil), // 1: dev.planton.provider.kubernetes.KubernetesSecretKey
}
var file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.kubernetes.kubernetesharbor.v1alpha1.KubernetesHarborStackOutputs.admin_password_secret:type_name -> dev.planton.provider.kubernetes.KubernetesSecretKey
...
func file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesharbor_v1alpha1_stack_outputs_proto_depIdxs = nil
}
