...
func hasSecretMaterial(spec *kubernetesvelerov1alpha1.KubernetesVeleroSpec) bool {
	backupStorage := spec.GetBackupStorage()
	switch {
	case backupStorage.GetS3() != nil:
...
func scheduleMap(s *kubernetesvelerov1alpha1.KubernetesVeleroSchedule) map[string]interface{} {
