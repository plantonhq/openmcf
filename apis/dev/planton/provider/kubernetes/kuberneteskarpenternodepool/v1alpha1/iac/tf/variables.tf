...
#
# Thin projection of the karpenter.sh/v1 "NodePool" custom resource.
#
...
variable "spec" {
  description = "Spec for the karpenter.sh/v1 \"NodePool\" custom resource, passed through verbatim to kubectl_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
