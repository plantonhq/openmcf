...
type Locals struct {
	KubernetesKarpenterNodePool *kuberneteskarpenternodepoolv1.KubernetesKarpenterNodePool
	NodePoolName                string
	Labels                      map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskarpenternodepoolv1.KubernetesKarpenterNodePoolStackInput) *Locals {
