...
type Locals struct {
	Spec *kuberneteskafkauiv1.KubernetesKafkaUiSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskafkauiv1.KubernetesKafkaUiStackInput) *Locals {
