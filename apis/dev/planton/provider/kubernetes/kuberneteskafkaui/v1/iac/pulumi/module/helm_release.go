...
func clusterEntries(spec *kuberneteskafkauiv1.KubernetesKafkaUiSpec) []interface{} {
...
// directly.
func clusterProperties(i int, cluster *kuberneteskafkauiv1.KubernetesKafkaUiCluster) map[string]interface{} {
...
func saslJaasConfig(i int, sasl *kuberneteskafkauiv1.KubernetesKafkaUiClusterSasl) string {
...
func secretMapping(passwordSecret *kuberneteskafkauiv1.KubernetesKafkaUiPasswordSecret) map[string]interface{} {
...
func tlsVolumes(spec *kuberneteskafkauiv1.KubernetesKafkaUiSpec) []interface{} {
...
func tlsVolumeMounts(spec *kuberneteskafkauiv1.KubernetesKafkaUiSpec) []interface{} {
