...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesenvoyfilter/v1/spec.proto
...
func (x *KubernetesEnvoyFilterSpec) Reset() {
	*x = KubernetesEnvoyFilterSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesEnvoyFilterConfigPatch) Reset() {
	*x = KubernetesEnvoyFilterConfigPatch{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesEnvoyFilterConfigPatch) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesEnvoyFilterEnvoyConfigObjectMatch) Reset() {
	*x = KubernetesEnvoyFilterEnvoyConfigObjectMatch{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesEnvoyFilterEnvoyConfigObjectMatch) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDesc = "" +
	...
	"\x05vhost\x18\x04 \x01(\v2_.dev.planton.provider.kubernetes.kubernetesenvoyfilter.v1.KubernetesEnvoyFilterVirtualHostMatchR\x05vhost\x12\x17\n" +
	...
	"\x05route\x18\x03 \x01(\v2Y.dev.planton.provider.kubernetes.kubernetesenvoyfilter.v1.KubernetesEnvoyFilterRouteMatchR\x05routeB\a\n" +
	"\x05_nameB\x0e\n" +
	...
	"\ffilter_chain\x18\x02 \x01(\v2_.dev.planton.provider.kubernetes.kubernetesenvoyfilter.v1.KubernetesEnvoyFilterFilterChainMatchR\vfilterChain\x12,\n" +
	...
	"\x06filter\x18\x05 \x01(\v2Z.dev.planton.provider.kubernetes.kubernetesenvoyfilter.v1.KubernetesEnvoyFilterFilterMatchR\x06filter\x12;\n" +
	...
	"\x04name\x18\x01 \x01(\tH\x00R\x04name\x88\x01\x01\x12|\n" +
	"\n" +
	"sub_filter\x18\x02 \x01(\v2].dev.planton.provider.kubernetes.kubernetesenvoyfilter.v1.KubernetesEnvoyFilterSubFilterMatchR\tsubFilterB\a\n" +
	"\x05_name\"G\n" +
	...
	"<com.dev.planton.provider.kubernetes.kubernetesenvoyfilter.v1B\tSpecProtoP\x01Zrgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesenvoyfilter/v1;kubernetesenvoyfilterv1\xa2\x02\x05DPPKK\xaa\x028Dev.Planton.Provider.Kubernetes.Kubernetesenvoyfilter.V1\xca\x028Dev\\Planton\\Provider\\Kubernetes\\Kubernetesenvoyfilter\\V1\xe2\x02DDev\\Planton\\Provider\\Kubernetes\\Kubernetesenvoyfilter\\V1\\GPBMetadata\xea\x02=Dev::Planton::Provider::Kubernetes::Kubernetesenvoyfilter::V1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[8].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes[9].OneofWrappers = []any{}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesenvoyfilter_v1_spec_proto_depIdxs = nil
}
