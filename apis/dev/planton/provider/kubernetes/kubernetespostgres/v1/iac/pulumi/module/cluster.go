...
func buildStorage(storage *kubernetespostgresv1.KubernetesPostgresStorage) postgresqlv1.ClusterSpecStorageArgs {
...
func storageClassOrNil(storage *kubernetespostgresv1.KubernetesPostgresStorage) pulumi.StringPtrInput {
...
func resizeOrNil(storage *kubernetespostgresv1.KubernetesPostgresStorage) pulumi.BoolPtrInput {
...
func buildPostgresql(config *kubernetespostgresv1.KubernetesPostgresServerConfig) postgresqlv1.ClusterSpecPostgresqlPtrInput {
	if config == nil {
		return nil
	}
...
func buildAffinity(scheduling *kubernetespostgresv1.KubernetesPostgresScheduling) postgresqlv1.ClusterSpecAffinityPtrInput {
	if scheduling == nil {
		return nil
	}
