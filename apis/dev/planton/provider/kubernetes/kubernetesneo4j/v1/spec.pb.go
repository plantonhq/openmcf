...
var file_dev_planton_provider_kubernetes_kubernetesneo4j_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesNeo4JContainer)(nil),
		Field:         5008130,
		Name:          "dev.planton.provider.kubernetes.kubernetesneo4j.v1.default_container",
		Tag:           "bytes,5008130,opt,name=default_container",
		Filename:      "dev/planton/provider/kubernetes/kubernetesneo4j/v1/spec.proto",
	},
}

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional dev.planton.provider.kubernetes.kubernetesneo4j.v1.KubernetesNeo4jContainer default_container = 5008130;
	E_DefaultContainer = &file_dev_planton_provider_kubernetes_kubernetesneo4j_v1_spec_proto_extTypes[0]
)
...
const file_dev_planton_provider_kubernetes_kubernetesneo4j_v1_spec_proto_rawDesc = "" +
	...
	"\rmemory_config\x18\x05 \x01(\v2O.dev.planton.provider.kubernetes.kubernetesneo4j.v1.KubernetesNeo4jMemoryConfigR\fmemoryConfig\x12d\n" +
	"\aingress\x18\x06 \x01(\v2J.dev.planton.provider.kubernetes.kubernetesneo4j.v1.KubernetesNeo4jIngressR\aingressJ\x04\b\x01\x10\x02R\x0etarget_cluster\"\xbb\x01\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\x82ֱ\x02 \x01(\v2L.dev.planton.provider.kubernetes.kubernetesneo4j.v1.KubernetesNeo4jContainerR\x10defaultContainerB\x9a\x03\n" +
...
func file_dev_planton_provider_kubernetes_kubernetesneo4j_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		ExtensionInfos:    file_dev_planton_provider_kubernetes_kubernetesneo4j_v1_spec_proto_extTypes,
	}.Build()
