...
import (
	...
	kubernetesotelcollectorv1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesotelcollector/v1"
...
type Locals struct {
	Spec *kubernetesotelcollectorv1.KubernetesOtelCollectorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesotelcollectorv1.KubernetesOtelCollectorStackInput) *Locals {
	...
	if spec.Mode != nil && spec.GetMode() != kubernetesotelcollectorv1.KubernetesOtelCollectorMode_kubernetes_otel_collector_mode_unspecified {
