...
func buildValidation(validation *kubernetesbackendtlspolicyv1.KubernetesBackendTlsPolicyValidation) gatewayv1.BackendTLSPolicySpecValidationArgs {
...
func buildCaCertificateRefs(caCertificateRefs []*kubernetesbackendtlspolicyv1.KubernetesBackendTlsPolicyCaCertificateReference) gatewayv1.BackendTLSPolicySpecValidationCaCertificateRefsArray {
...
func buildSubjectAltNames(subjectAltNames []*kubernetesbackendtlspolicyv1.KubernetesBackendTlsPolicySubjectAltName) gatewayv1.BackendTLSPolicySpecValidationSubjectAltNamesArray {
