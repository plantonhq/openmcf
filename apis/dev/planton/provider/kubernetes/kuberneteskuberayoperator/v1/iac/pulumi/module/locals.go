...
type Locals struct {
	Spec *kuberneteskuberayoperatorv1.KubernetesKubeRayOperatorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskuberayoperatorv1.KubernetesKubeRayOperatorStackInput) *Locals {
