...
// outputs.
type Locals struct {
	KubernetesFlinkDeployment *kubernetesflinkdeploymentv1.KubernetesFlinkDeployment
	Spec                      *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentStackInput) *Locals {
