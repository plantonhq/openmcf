...
func resolveImage(spec *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentSpec) string {
	if spec.GetImage() != "" {
...
func resolveServiceAccount(spec *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentSpec) string {
...
func flinkConfigurationBody(spec *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentSpec) map[string]interface{} {
...
func jobBody(job *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentJob) map[string]interface{} {
	if job == nil {
		return nil
	}
...
// them).
func jobManagerBody(jobManager *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentJobManager) map[string]interface{} {
	out := map[string]interface{}{
...
func taskManagerBody(taskManager *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentTaskManager) map[string]interface{} {
	out := map[string]interface{}{
...
func validateCpuQuantities(spec *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentSpec) error {
...
// main container name").
func podTemplateBody(spec *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentSpec) map[string]interface{} {
...
// plugin set.
func s3EnvBody(s3 *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentS3) []interface{} {
	if s3 == nil {
		return nil
	}
	env := []interface{}{
...
func secretEnvVar(name string, selector *kubernetesflinkdeploymentv1.KubernetesFlinkDeploymentSecretSelector) map[string]interface{} {
	return map[string]interface{}{
		"name": name,
