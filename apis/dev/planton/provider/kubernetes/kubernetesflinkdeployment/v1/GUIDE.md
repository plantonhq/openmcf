...
[reference.md](reference.md)). Choose by workload, and say which in the
...
[KubernetesSeaweedFs](../../kubernetesseaweedfs/v1/reference.md) and point
...
[operator guide](../../kubernetesflinkoperator/v1/GUIDE.md); the
