...
func processorList(processors []kubernetestempov1.KubernetesTempoMetricsGeneratorProcessor) []interface{} {
	if len(processors) == 0 {
	...
	for _, p := range processors {
		switch p {
		case kubernetestempov1.KubernetesTempoMetricsGeneratorProcessor_service_graphs:
			out = append(out, "service-graphs")
		case kubernetestempov1.KubernetesTempoMetricsGeneratorProcessor_span_metrics:
...
func secretEnvVar(name string, ref *kubernetestempov1.KubernetesTempoSecretKeyRef) map[string]interface{} {
