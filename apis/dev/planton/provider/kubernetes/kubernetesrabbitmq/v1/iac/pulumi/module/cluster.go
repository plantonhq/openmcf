...
func pullSecretNames(spec *kubernetesrabbitmqv1.KubernetesRabbitMqSpec) []string {
...
// applies).
func buildService(service *kubernetesrabbitmqv1.KubernetesRabbitMqService) rabbitmqv1beta1.RabbitmqClusterSpecServicePtrInput {
	if service == nil {
		return nil
	}
	...
	case kubernetesrabbitmqv1.KubernetesRabbitMqService_load_balancer:
		out.Type = pulumi.String("LoadBalancer")
		rendered = true
	case kubernetesrabbitmqv1.KubernetesRabbitMqService_node_port:
	...
	case kubernetesrabbitmqv1.KubernetesRabbitMqService_single_stack:
		out.IpFamilyPolicy = pulumi.String("SingleStack")
		rendered = true
	case kubernetesrabbitmqv1.KubernetesRabbitMqService_prefer_dual_stack:
		out.IpFamilyPolicy = pulumi.String("PreferDualStack")
		rendered = true
	case kubernetesrabbitmqv1.KubernetesRabbitMqService_require_dual_stack:
...
func buildPersistence(spec *kubernetesrabbitmqv1.KubernetesRabbitMqSpec) rabbitmqv1beta1.RabbitmqClusterSpecPersistencePtrInput {
...
func buildRabbitmqConfiguration(configuration *kubernetesrabbitmqv1.KubernetesRabbitMqConfiguration) rabbitmqv1beta1.RabbitmqClusterSpecRabbitmqPtrInput {
...
func buildTls(tls *kubernetesrabbitmqv1.KubernetesRabbitMqTls) rabbitmqv1beta1.RabbitmqClusterSpecTlsPtrInput {
...
// the block is absent.
func buildSecretBackend(secretBackend *kubernetesrabbitmqv1.KubernetesRabbitMqSecretBackend) rabbitmqv1beta1.RabbitmqClusterSpecSecretBackendPtrInput {
