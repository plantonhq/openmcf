...
type Locals struct {
	KubernetesRabbitMq *kubernetesrabbitmqv1.KubernetesRabbitMq
	Spec               *kubernetesrabbitmqv1.KubernetesRabbitMqSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesrabbitmqv1.KubernetesRabbitMqStackInput) *Locals {
