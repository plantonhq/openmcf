...
type Locals struct {
	Spec *kubernetesgatekeeperv1.KubernetesGatekeeperSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesgatekeeperv1.KubernetesGatekeeperStackInput) *Locals {
