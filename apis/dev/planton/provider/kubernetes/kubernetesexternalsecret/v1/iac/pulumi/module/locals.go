...
type Locals struct {
	Spec *kubernetesexternalsecretv1.KubernetesExternalSecretSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesexternalsecretv1.KubernetesExternalSecretStackInput) *Locals {
