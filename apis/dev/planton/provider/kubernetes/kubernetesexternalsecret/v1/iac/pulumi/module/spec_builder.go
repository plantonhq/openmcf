...
func buildRemoteRef(ref *kubernetesexternalsecretv1.KubernetesExternalSecretRemoteRef) map[string]interface{} {
...
// nothing is set.
func buildTemplate(template *kubernetesexternalsecretv1.KubernetesExternalSecretTemplate) map[string]interface{} {
	if template == nil {
		return nil
	}
	rendered := map[string]interface{}{}
