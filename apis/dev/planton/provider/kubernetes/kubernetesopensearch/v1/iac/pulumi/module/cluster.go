...
func buildBootstrap(bootstrap *kubernetesopensearchv1.KubernetesOpenSearchBootstrap) opensearchv1.OpenSearchClusterSpecBootstrapPtrInput {
	if bootstrap == nil {
		return nil
	}
...
func buildNodePools(pools []*kubernetesopensearchv1.KubernetesOpenSearchNodePool) opensearchv1.OpenSearchClusterSpecNodePoolsArray {
...
func buildSecurity(security *kubernetesopensearchv1.KubernetesOpenSearchSecurity) opensearchv1.OpenSearchClusterSpecSecurityPtrInput {
	if security == nil {
		return nil
	}
