...
import (
	...
	kubernetesopensearchv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesopensearch/v1alpha1"
...
type Locals struct {
	KubernetesOpenSearch *kubernetesopensearchv1alpha1.KubernetesOpenSearch
	Spec                 *kubernetesopensearchv1alpha1.KubernetesOpenSearchSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesopensearchv1alpha1.KubernetesOpenSearchStackInput) *Locals {
