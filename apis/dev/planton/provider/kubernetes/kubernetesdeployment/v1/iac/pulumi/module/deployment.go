...
func getStrategy(availability *kubernetesdeploymentv1.KubernetesDeploymentAvailability) *kubernetesdeploymentv1.KubernetesDeploymentStrategy {
	if availability == nil {
		return nil
	}
...
func buildDeploymentStrategy(protoStrategy *kubernetesdeploymentv1.KubernetesDeploymentStrategy) *appsv1.DeploymentStrategyArgs {
