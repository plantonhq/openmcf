...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesdeployment/v1alpha1/spec.proto
...
func (x *KubernetesDeploymentSpec) Reset() {
	*x = KubernetesDeploymentSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesDeploymentSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesDeploymentContainer) Reset() {
	*x = KubernetesDeploymentContainer{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentContainer) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesDeploymentAvailability) Reset() {
	*x = KubernetesDeploymentAvailability{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentAvailability) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesDeploymentHpa) Reset() {
	*x = KubernetesDeploymentHpa{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentHpa) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesDeploymentStrategy) Reset() {
	*x = KubernetesDeploymentStrategy{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentStrategy) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesDeploymentPodDisruptionBudget) Reset() {
	*x = KubernetesDeploymentPodDisruptionBudget{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentPodDisruptionBudget) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
var File_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Hdev/planton/provider/kubernetes/kubernetesdeployment/v1alpha1/spec.proto\x12=dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a8dev/planton/provider/kubernetes/workload_container.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xac\x06\n" +
	...
	"\x13spec.version.format\x12|Version must contain only lowercase letters, numbers, and hyphens, and must not end with a hyphen (e.g. \"main\", \"review-42\")\x1aXthis == '' || this.matches('^[a-z0-9][a-z0-9-]*[a-z0-9]$') || this.matches('^[a-z0-9]$')r\x02\x18\x1e\x8a\xa6\x1d\x04mainH\x00R\aversion\x88\x01\x01\x12\x82\x01\n" +
	"\tcontainer\x18\x04 \x01(\v2\\.dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x12>\n" +
	"\x03pod\x18\x05 \x01(\v2,.dev.planton.provider.kubernetes.WorkloadPodR\x03pod\x12\x83\x01\n" +
	"\favailability\x18\x06 \x01(\v2_.dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentAvailabilityR\favailabilityB\n" +
	"\n" +
	"\b_version\"\xaa\x02\n" +
	...
	"\x1dspec.container.sidecars.named\x12(Every sidecar container must have a name\x1a\x19this.all(c, c.name != '')R\bsidecars\"\xba\x06\n" +
	" KubernetesDeploymentAvailability\x12-\n" +
	"\breplicas\x18\x01 \x01(\x05B\f\xbaH\x04\x1a\x02(\x00\x8a\xa6\x1d\x011H\x00R\breplicas\x88\x01\x01\x12\x94\x01\n" +
	"\x1ahorizontal_pod_autoscaling\x18\x02 \x01(\v2V.dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentHpaR\x18horizontalPodAutoscaling\x12w\n" +
	"\bstrategy\x18\x03 \x01(\v2[.dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentStrategyR\bstrategy\x12\x9a\x01\n" +
	"\x15pod_disruption_budget\x18\x04 \x01(\v2f.dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentPodDisruptionBudgetR\x13podDisruptionBudget\x128\n" +
	...
	"\x1aspec.pdb.exactly_one_bound\x12hSet exactly one of min_available or max_unavailable (defaults to min_available: \"1\" when both are empty)\x1aJ!this.enabled || !(this.min_available != '' && this.max_unavailable != '')B\xe7\x03\n" +
	"Acom.dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1B\tSpecProtoP\x01Z|github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesdeployment/v1alpha1;kubernetesdeploymentv1alpha1\xa2\x02\x05DPPKK\xaa\x02=Dev.Planton.Provider.Kubernetes.Kubernetesdeployment.V1alpha1\xca\x02=Dev\\Planton\\Provider\\Kubernetes\\Kubernetesdeployment\\V1alpha1\xe2\x02IDev\\Planton\\Provider\\Kubernetes\\Kubernetesdeployment\\V1alpha1\\GPBMetadata\xea\x02BDev::Planton::Provider::Kubernetes::Kubernetesdeployment::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesDeploymentSpec)(nil),                // 0: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentSpec
	(*KubernetesDeploymentContainer)(nil),           // 1: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentContainer
	(*KubernetesDeploymentAvailability)(nil),        // 2: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentAvailability
	(*KubernetesDeploymentHpa)(nil),                 // 3: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentHpa
	(*KubernetesDeploymentStrategy)(nil),            // 4: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentStrategy
	(*KubernetesDeploymentPodDisruptionBudget)(nil), // 5: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentPodDisruptionBudget
...
var file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentSpec.container:type_name -> dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentContainer
	7, // 2: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentSpec.pod:type_name -> dev.planton.provider.kubernetes.WorkloadPod
	2, // 3: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentSpec.availability:type_name -> dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentAvailability
	8, // 4: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentContainer.app:type_name -> dev.planton.provider.kubernetes.WorkloadContainer
	8, // 5: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentContainer.sidecars:type_name -> dev.planton.provider.kubernetes.WorkloadContainer
	3, // 6: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentAvailability.horizontal_pod_autoscaling:type_name -> dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentHpa
	4, // 7: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentAvailability.strategy:type_name -> dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentStrategy
	5, // 8: dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentAvailability.pod_disruption_budget:type_name -> dev.planton.provider.kubernetes.kubernetesdeployment.v1alpha1.KubernetesDeploymentPodDisruptionBudget
...
func init() { file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesdeployment_v1alpha1_spec_proto_depIdxs = nil
}
