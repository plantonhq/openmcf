...
- [KubernetesRbac](/docs/catalog/kubernetes/kubernetesrbac) — grants permissions to this identity as a ServiceAccount subject
- [KubernetesSecret](/docs/catalog/kubernetes/kubernetessecret) — provides the `kubernetes.io/dockerconfigjson` secrets referenced from `spec.imagePullSecrets`
