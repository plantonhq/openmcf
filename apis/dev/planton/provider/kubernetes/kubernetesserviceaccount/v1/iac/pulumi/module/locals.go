...
type Locals struct {
	...
	Target *kubernetesserviceaccountv1.KubernetesServiceAccount

	// Spec from the target
	Spec *kubernetesserviceaccountv1.KubernetesServiceAccountSpec
...
func initializeLocals(ctx *pulumi.Context, stackInput *kubernetesserviceaccountv1.KubernetesServiceAccountStackInput) *Locals {
	locals := &Locals{
		Ctx:        ctx,
