...
// visible in the diff).
func crdsBlock(crds *kuberneteskyvernov1alpha1.KubernetesKyvernoCrds) map[string]interface{} {
	if crds == nil {
		return nil
	}
...
func configBlock(config *kuberneteskyvernov1alpha1.KubernetesKyvernoConfig) map[string]interface{} {
	if config == nil {
		return nil
	}
	block := map[string]interface{}{}
...
func featuresBlock(features *kuberneteskyvernov1alpha1.KubernetesKyvernoFeatures) map[string]interface{} {
	if features == nil {
		return nil
	}
	block := map[string]interface{}{}
...
func optionalControllerBlock(controller *kuberneteskyvernov1alpha1.KubernetesKyvernoOptionalController) map[string]interface{} {
	block := map[string]interface{}{}
	if controller == nil {
		return block
	}
...
func certManagerBlock(cm *kuberneteskyvernov1alpha1.KubernetesKyvernoCertManagerCertificates) map[string]interface{} {
...
func schedulingEntries(scheduling *kuberneteskyvernov1alpha1.KubernetesKyvernoScheduling) map[string]interface{} {
	if scheduling == nil {
		return nil
	}
