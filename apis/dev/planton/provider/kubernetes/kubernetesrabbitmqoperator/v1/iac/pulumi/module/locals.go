...
type Locals struct {
	KubernetesRabbitMqOperator *kubernetesrabbitmqoperatorv1.KubernetesRabbitMqOperator
	Spec                       *kubernetesrabbitmqoperatorv1.KubernetesRabbitMqOperatorSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesrabbitmqoperatorv1.KubernetesRabbitMqOperatorStackInput) *Locals {
