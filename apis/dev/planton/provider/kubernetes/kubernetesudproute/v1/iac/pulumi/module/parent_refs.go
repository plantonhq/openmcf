...
func buildParentRefs(parentRefs []*kubernetesapis.KubernetesGatewayApiParentReference) gatewayv1.UDPRouteSpecParentRefsArray {
	arr := gatewayv1.UDPRouteSpecParentRefsArray{}
	for _, ref := range parentRefs {
		args := gatewayv1.UDPRouteSpecParentRefsArgs{
