...
type Locals struct {
	KubernetesMysql *kubernetesmysqlv1.KubernetesMysql
	Spec            *kubernetesmysqlv1.KubernetesMysqlSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesmysqlv1.KubernetesMysqlStackInput) *Locals {
