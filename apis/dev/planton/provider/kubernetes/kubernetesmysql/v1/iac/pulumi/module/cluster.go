...
func resolveInstances(spec *kubernetesmysqlv1.KubernetesMysqlSpec) int {
...
func resolvePxcImage(spec *kubernetesmysqlv1.KubernetesMysqlSpec) string {
...
func proxyServiceBody(expose *kubernetesmysqlv1.KubernetesMysqlProxyService) map[string]interface{} {
	body := map[string]interface{}{
...
func haproxyExposeReplicasBody(expose *kubernetesmysqlv1.KubernetesMysqlHaproxyReplicasService) map[string]interface{} {
...
func tlsBody(spec *kubernetesmysqlv1.KubernetesMysqlSpec) map[string]interface{} {
	tls := spec.GetTls()
	if tls == nil {
		return nil
	}
...
func backupSchedulesBody(backup *kubernetesmysqlv1.KubernetesMysqlBackup) []interface{} {
...
func pitrBody(backup *kubernetesmysqlv1.KubernetesMysqlBackup) map[string]interface{} {
	pitr := backup.GetPitr()
...
func logcollectorBody(spec *kubernetesmysqlv1.KubernetesMysqlSpec) map[string]interface{} {
...
func unsafeFlagsBody(unsafe *kubernetesmysqlv1.KubernetesMysqlUnsafe) map[string]interface{} {
