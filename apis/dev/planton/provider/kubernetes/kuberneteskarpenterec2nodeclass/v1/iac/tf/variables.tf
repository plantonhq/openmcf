...
#
# Thin projection of the karpenter.k8s.aws/v1 "EC2NodeClass" custom resource.
#
...
variable "spec" {
  description = "Spec for the karpenter.k8s.aws/v1 \"EC2NodeClass\" custom resource, passed through verbatim to kubectl_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
