...
// namespace.
type Locals struct {
	KubernetesKarpenterEc2NodeClass *kuberneteskarpenterec2nodeclassv1.KubernetesKarpenterEc2NodeClass
	NodeClassName                   string
	Labels                          map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskarpenterec2nodeclassv1.KubernetesKarpenterEc2NodeClassStackInput) *Locals {
