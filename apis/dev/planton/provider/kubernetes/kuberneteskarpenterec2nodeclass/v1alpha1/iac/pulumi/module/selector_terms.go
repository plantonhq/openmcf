...
func buildAmiSelectorTerms(terms []*kuberneteskarpenterec2nodeclassv1alpha1.KubernetesKarpenterEc2NodeClassAmiSelectorTerm) karpenterv1.EC2NodeClassSpecAmiSelectorTermsArray {
...
func buildSubnetSelectorTerms(terms []*kuberneteskarpenterec2nodeclassv1alpha1.KubernetesKarpenterEc2NodeClassSubnetSelectorTerm) karpenterv1.EC2NodeClassSpecSubnetSelectorTermsArray {
...
func buildSecurityGroupSelectorTerms(terms []*kuberneteskarpenterec2nodeclassv1alpha1.KubernetesKarpenterEc2NodeClassSecurityGroupSelectorTerm) karpenterv1.EC2NodeClassSpecSecurityGroupSelectorTermsArray {
...
func buildCapacityReservationSelectorTerms(terms []*kuberneteskarpenterec2nodeclassv1alpha1.KubernetesKarpenterEc2NodeClassCapacityReservationSelectorTerm) karpenterv1.EC2NodeClassSpecCapacityReservationSelectorTermsArray {
