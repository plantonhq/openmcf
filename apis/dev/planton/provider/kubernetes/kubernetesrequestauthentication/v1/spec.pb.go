...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesrequestauthentication/v1/spec.proto
...
func (x *KubernetesRequestAuthenticationSpec) Reset() {
	*x = KubernetesRequestAuthenticationSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesRequestAuthenticationJwtRule) Reset() {
	*x = KubernetesRequestAuthenticationJwtRule{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesRequestAuthenticationJwtRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesRequestAuthenticationJwtHeader) Reset() {
	*x = KubernetesRequestAuthenticationJwtHeader{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesRequestAuthenticationJwtHeader) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesRequestAuthenticationClaimToHeader) Reset() {
	*x = KubernetesRequestAuthenticationClaimToHeader{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesRequestAuthenticationClaimToHeader) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Mdev/planton/provider/kubernetes/kubernetesrequestauthentication/v1/spec.proto\x12Bdev.planton.provider.kubernetes.kubernetesrequestauthentication.v1\x1a\x1bbuf/validate/validate.proto\x1a/dev/planton/provider/kubernetes/istio_api.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xb5\x05\n" +
	...
	"/request_authentication.selector_xor_target_refs\x121at most one of selector or target_refs may be set\x1a3!(has(this.selector) && size(this.target_refs) > 0)J\x04\b\x01\x10\x02R\x0etarget_cluster\"\xb6\n" +
	"\n" +
	...
	"Fcom.dev.planton.provider.kubernetes.kubernetesrequestauthentication.v1B\tSpecProtoP\x01Z\x86\x01github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesrequestauthentication/v1;kubernetesrequestauthenticationv1\xa2\x02\x05DPPKK\xaa\x02BDev.Planton.Provider.Kubernetes.Kubernetesrequestauthentication.V1\xca\x02BDev\\Planton\\Provider\\Kubernetes\\Kubernetesrequestauthentication\\V1\xe2\x02NDev\\Planton\\Provider\\Kubernetes\\Kubernetesrequestauthentication\\V1\\GPBMetadata\xea\x02GDev::Planton::Provider::Kubernetes::Kubernetesrequestauthentication::V1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_goTypes = []any{
	(*KubernetesRequestAuthenticationSpec)(nil),                // 0: dev.planton.provider.kubernetes.kubernetesrequestauthentication.v1.KubernetesRequestAuthenticationSpec
...
func init() {
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_init()
}
func file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesrequestauthentication_v1_spec_proto_depIdxs = nil
}
