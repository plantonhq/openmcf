...
#
# Thin projection of the security.istio.io/v1 "RequestAuthentication" custom resource.
#
...
variable "spec" {
  description = "Spec for the security.istio.io/v1 \"RequestAuthentication\" custom resource, passed through verbatim to kubectl_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
