...
type Locals struct {
	KubernetesRequestAuthentication *kubernetesrequestauthenticationv1alpha1.KubernetesRequestAuthentication
	// RequestAuthenticationName is the Kubernetes resource name of the
	// RequestAuthentication. It equals the Planton resource metadata.name.
