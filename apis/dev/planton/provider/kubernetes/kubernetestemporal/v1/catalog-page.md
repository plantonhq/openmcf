...
- [KubernetesOpenSearch](/docs/catalog/kubernetes/kubernetesopensearch) — deploy an in-cluster OpenSearch cluster (Elasticsearch-compatible) for Temporal advanced visibility
