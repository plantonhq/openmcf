...
type Locals struct {
	Target *kuberneteskarapacev1.KubernetesKarapace
	Spec   *kuberneteskarapacev1.KubernetesKarapaceSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskarapacev1.KubernetesKarapaceStackInput) *Locals {
