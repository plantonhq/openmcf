...
import (
	...
	kuberneteskarapacev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kuberneteskarapace/v1alpha1"
	kubernetescorev1 "github.com/pulumi/pulumi-kubernetes/sdk/v4/go/kubernetes/core/v1"
	kubernetesmeta "github.com/pulumi/pulumi-kubernetes/sdk/v4/go/kubernetes/meta/v1"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

// namespace conditionally creates the registry namespace based on the
// create_namespace flag. Returns the created namespace resource (or nil
// when create_namespace is false — the namespace must then already exist).
// Terraform equivalent: kubernetes_namespace_v1 with count.
func namespace(ctx *pulumi.Context,
	stackInput *kuberneteskarapacev1alpha1.KubernetesKarapaceStackInput,
	locals *Locals,
