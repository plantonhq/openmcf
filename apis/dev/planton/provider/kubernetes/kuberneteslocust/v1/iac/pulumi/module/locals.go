...
type Locals struct {
	Spec *kuberneteslocustv1.KubernetesLocustSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteslocustv1.KubernetesLocustStackInput) *Locals {
...
func configChecksum(loadTest *kuberneteslocustv1.KubernetesLocustLoadTest, locals *Locals) string {
	parts := []string{
