...
// engaged).
func loadtestBlock(locals *Locals, loadTest *kuberneteslocustv1.KubernetesLocustLoadTest) map[string]interface{} {
...
// locustfile alone.
func masterBlock(locals *Locals, master *kuberneteslocustv1.KubernetesLocustMaster) map[string]interface{} {
	block := map[string]interface{}{
...
func workerBlock(locals *Locals, workers *kuberneteslocustv1.KubernetesLocustWorkers) map[string]interface{} {
	block := map[string]interface{}{
...
func kedaTriggers(locals *Locals, keda *kuberneteslocustv1.KubernetesLocustWorkerKeda) string {
