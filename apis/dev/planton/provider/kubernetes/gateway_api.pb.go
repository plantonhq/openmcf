...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/gateway_api.proto
...
func (x *KubernetesGatewayApiParentReference) Reset() {
	*x = KubernetesGatewayApiParentReference{}
	mi := &file_dev_planton_provider_kubernetes_gateway_api_proto_msgTypes[0]
...
func (*KubernetesGatewayApiParentReference) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_gateway_api_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_kubernetes_gateway_api_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_kubernetes_gateway_api_proto_rawDesc = "" +
	...
	"\rcookie_config\x18\x05 \x01(\v2A.dev.planton.provider.kubernetes.KubernetesGatewayApiCookieConfigR\fcookieConfig:\xdd\x03\xbaH\xd9\x03\x1a\x9e\x02\n" +
	...
	"#com.dev.planton.provider.kubernetesB\x0fGatewayApiProtoP\x01ZAgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes\xa2\x02\x04DPPK\xaa\x02\x1fDev.Planton.Provider.Kubernetes\xca\x02\x1fDev\\Planton\\Provider\\Kubernetes\xe2\x02+Dev\\Planton\\Provider\\Kubernetes\\GPBMetadata\xea\x02\"Dev::Planton::Provider::Kubernetesb\x06proto3"

var (
	file_dev_planton_provider_kubernetes_gateway_api_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_gateway_api_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_gateway_api_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_gateway_api_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_gateway_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_gateway_api_proto_rawDesc), len(file_dev_planton_provider_kubernetes_gateway_api_proto_rawDesc)))
	})
...
func file_dev_planton_provider_kubernetes_gateway_api_proto_init() {
	if File_dev_planton_provider_kubernetes_gateway_api_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_kubernetes_gateway_api_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_gateway_api_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_gateway_api_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_gateway_api_proto = out.File
	file_dev_planton_provider_kubernetes_gateway_api_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_gateway_api_proto_depIdxs = nil
}
