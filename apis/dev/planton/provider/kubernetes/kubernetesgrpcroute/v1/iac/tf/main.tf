...
#
# Applies one Gateway API GRPCRoute custom resource. The CR spec arrives from the
...
# connection at plan time — a GRPCRoute can be PLANNED before the Gateway API
...
resource "kubectl_manifest" "grpc_route" {
