...
// buildMatches maps the Planton request matchers (method, headers) onto the typed
...
// matching.
func buildMatches(matches []*kubernetesgrpcroutev1alpha1.KubernetesGrpcRouteMatch) gatewayv1.GRPCRouteSpecRulesMatchesArray {
...
func buildMethodMatch(m *kubernetesgrpcroutev1alpha1.KubernetesGrpcRouteMethodMatch) gatewayv1.GRPCRouteSpecRulesMatchesMethodArgs {
