...
import (
	kubernetesreferencegrantv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesreferencegrant/v1alpha1"
...
func buildFrom(from []*kubernetesreferencegrantv1alpha1.KubernetesReferenceGrantFrom) gatewayv1.ReferenceGrantSpecFromArray {
...
func buildTo(to []*kubernetesreferencegrantv1alpha1.KubernetesReferenceGrantTo) gatewayv1.ReferenceGrantSpecToArray {
