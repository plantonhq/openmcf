...
#
# Applies one Gateway API ReferenceGrant custom resource. The CR spec arrives from the
...
# connection at plan time — a ReferenceGrant can be PLANNED before the Gateway API
