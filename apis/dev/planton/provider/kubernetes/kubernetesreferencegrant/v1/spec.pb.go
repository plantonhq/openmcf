...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesreferencegrant/v1/spec.proto
...
func (x *KubernetesReferenceGrantSpec) Reset() {
	*x = KubernetesReferenceGrantSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesReferenceGrantFrom) Reset() {
	*x = KubernetesReferenceGrantFrom{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesReferenceGrantFrom) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesReferenceGrantTo) Reset() {
	*x = KubernetesReferenceGrantTo{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesReferenceGrantTo) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDesc = "" +
	...
	"\tnamespace\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x18\xbaH\x03\xc8\x01\x01\x88\xd4a\xa0\x06\x92\xd4a\tspec.nameR\tnamespace\x12y\n" +
	...
	"\x06_groupB\a\n" +
	"\x05_nameB\xd9\x03\n" +
	"?com.dev.planton.provider.kubernetes.kubernetesreferencegrant.v1B\tSpecProtoP\x01Zxgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesreferencegrant/v1;kubernetesreferencegrantv1\xa2\x02\x05DPPKK\xaa\x02;Dev.Planton.Provider.Kubernetes.Kubernetesreferencegrant.V1\xca\x02;Dev\\Planton\\Provider\\Kubernetes\\Kubernetesreferencegrant\\V1\xe2\x02GDev\\Planton\\Provider\\Kubernetes\\Kubernetesreferencegrant\\V1\\GPBMetadata\xea\x02@Dev::Planton::Provider::Kubernetes::Kubernetesreferencegrant::V1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDescData
}
...
func file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesreferencegrant_v1_spec_proto_depIdxs = nil
}
