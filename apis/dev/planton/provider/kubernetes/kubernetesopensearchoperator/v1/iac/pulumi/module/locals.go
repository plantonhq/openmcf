...
type Locals struct {
	Spec *kubernetesopensearchoperatorv1.KubernetesOpenSearchOperatorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesopensearchoperatorv1.KubernetesOpenSearchOperatorStackInput) *Locals {
