...
import (
	...
	kubernetesairflowv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesairflow/v1alpha1"
...
type Locals struct {
	Spec *kubernetesairflowv1alpha1.KubernetesAirflowSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesairflowv1alpha1.KubernetesAirflowStackInput) *Locals {
	...
	// ----------------------------- log read path --------------------------
	logBackend := (*kubernetesairflowv1alpha1.KubernetesAirflowLogSearchBackend)(nil)
