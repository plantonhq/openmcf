...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesoteloperator/v1alpha1/spec.proto
...
func (x *KubernetesOtelOperatorSpec) Reset() {
	*x = KubernetesOtelOperatorSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesOtelOperatorSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesOtelOperatorWebhook) Reset() {
	*x = KubernetesOtelOperatorWebhook{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesOtelOperatorWebhook) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesOtelOperatorIssuerRef) Reset() {
	*x = KubernetesOtelOperatorIssuerRef{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesOtelOperatorIssuerRef) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesOtelOperatorScheduling) Reset() {
	*x = KubernetesOtelOperatorScheduling{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesOtelOperatorScheduling) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Jdev/planton/provider/kubernetes/kubernetesoteloperator/v1alpha1/spec.proto\x12?dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xd8\a\n" +
	...
	"\tskip_crds\x18\x04 \x01(\bR\bskipCrds\x12x\n" +
	"\awebhook\x18\x05 \x01(\v2^.dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorWebhookR\awebhook\x126\n" +
	...
	"\x12image_pull_secrets\x18\v \x03(\tBJ\xaa\xa6\x1dFNames of existing image-pull Secrets (references), not secret materialR\x10imagePullSecrets\x12\x81\x01\n" +
	"\n" +
	"scheduling\x18\f \x01(\v2a.dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorSchedulingR\n" +
	"scheduling\x12\x1f\n" +
	"\vhelm_values\x18\r \x01(\tR\n" +
	"helmValuesB\x10\n" +
	"\x0e_chart_versionB\v\n" +
	"\t_replicas\"\xa0\x01\n" +
	"\x1dKubernetesOtelOperatorWebhook\x12\x7f\n" +
	"\n" +
	"issuer_ref\x18\x01 \x01(\v2`.dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorIssuerRefR\tissuerRef\"o\n" +
	...
	"\x04name\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\"\x85\x03\n" +
	" KubernetesOtelOperatorScheduling\x12\x98\x01\n" +
	"\rnode_selector\x18\x01 \x03(\v2s.dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling.NodeSelectorEntryR\fnodeSelector\x12U\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xf6\x03\n" +
...
var (
	file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesOtelOperatorSpec)(nil),       // 0: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorSpec
	(*KubernetesOtelOperatorWebhook)(nil),    // 1: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorWebhook
	(*KubernetesOtelOperatorIssuerRef)(nil),  // 2: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorIssuerRef
	(*KubernetesOtelOperatorScheduling)(nil), // 3: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling
	nil,                                      // 4: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling.NodeSelectorEntry
...
var file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorSpec.webhook:type_name -> dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorWebhook
	6, // 2: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorSpec.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	3, // 3: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorSpec.scheduling:type_name -> dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling
	2, // 4: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorWebhook.issuer_ref:type_name -> dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorIssuerRef
	4, // 5: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling.node_selector:type_name -> dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling.NodeSelectorEntry
	7, // 6: dev.planton.provider.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling.tolerations:type_name -> dev.planton.provider.kubernetes.WorkloadToleration
...
func init() { file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_depIdxs = nil
}
