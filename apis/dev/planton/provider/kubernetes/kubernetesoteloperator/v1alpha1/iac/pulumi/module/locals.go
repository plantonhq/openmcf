...
import (
	...
	kubernetesoteloperatorv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesoteloperator/v1alpha1"
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesoteloperatorv1alpha1.KubernetesOtelOperatorStackInput) *Locals {
