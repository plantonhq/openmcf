...
var file_dev_planton_provider_kubernetes_kubernetesmongodb_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesMongodbContainer)(nil),
		Field:         530001,
		Name:          "dev.planton.provider.kubernetes.kubernetesmongodb.v1.default_container",
		Tag:           "bytes,530001,opt,name=default_container",
		Filename:      "dev/planton/provider/kubernetes/kubernetesmongodb/v1/spec.proto",
	},
}

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional dev.planton.provider.kubernetes.kubernetesmongodb.v1.KubernetesMongodbContainer default_container = 530001;
	E_DefaultContainer = &file_dev_planton_provider_kubernetes_kubernetesmongodb_v1_spec_proto_extTypes[0]
)
...
const file_dev_planton_provider_kubernetes_kubernetesmongodb_v1_spec_proto_rawDesc = "" +
	...
	"\aingress\x18\x05 \x01(\v2N.dev.planton.provider.kubernetes.kubernetesmongodb.v1.KubernetesMongodbIngressR\aingress\x12|\n" +
	"\vhelm_values\x18\x06 \x03(\v2[.dev.planton.provider.kubernetes.kubernetesmongodb.v1.KubernetesMongodbSpec.HelmValuesEntryR\n" +
	"helmValues\x1a=\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18Ѭ  \x01(\v2P.dev.planton.provider.kubernetes.kubernetesmongodb.v1.KubernetesMongodbContainerR\x10defaultContainerB\xa8\x03\n" +
...
func file_dev_planton_provider_kubernetes_kubernetesmongodb_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		ExtensionInfos:    file_dev_planton_provider_kubernetes_kubernetesmongodb_v1_spec_proto_extTypes,
	}.Build()
