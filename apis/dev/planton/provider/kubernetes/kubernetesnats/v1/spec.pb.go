...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesnats/v1/spec.proto
...
func (x *KubernetesNatsSpec) Reset() {
	*x = KubernetesNatsSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesNatsAuth) Reset() {
	*x = KubernetesNatsAuth{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var (
	file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto != nil {
		return
	}
	...
	file_dev_planton_provider_kubernetes_kubernetesnats_v1_spec_proto_depIdxs = nil
}
