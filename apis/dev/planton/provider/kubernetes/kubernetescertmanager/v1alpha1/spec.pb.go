...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetescertmanager/v1alpha1/spec.proto
...
func (x *KubernetesCertManagerSpec) Reset() {
	*x = KubernetesCertManagerSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesCertManagerSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesCertManagerCrds) Reset() {
	*x = KubernetesCertManagerCrds{}
	mi := &file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerCrds) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesCertManagerDns01SelfCheck) Reset() {
	*x = KubernetesCertManagerDns01SelfCheck{}
	mi := &file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerDns01SelfCheck) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesCertManagerPrometheus) Reset() {
	*x = KubernetesCertManagerPrometheus{}
	mi := &file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerPrometheus) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesCertManagerWebhook) Reset() {
	*x = KubernetesCertManagerWebhook{}
	mi := &file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerWebhook) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesCertManagerCainjector) Reset() {
	*x = KubernetesCertManagerCainjector{}
	mi := &file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerCainjector) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesCertManagerStartupApiCheck) Reset() {
	*x = KubernetesCertManagerStartupApiCheck{}
	mi := &file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerStartupApiCheck) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Idev/planton/provider/kubernetes/kubernetescertmanager/v1alpha1/spec.proto\x12>dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a7dev/planton/provider/kubernetes/workload_identity.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\x96\x12\n" +
	...
	"\rchart_version\x18\x03 \x01(\tB\v\x8a\xa6\x1d\av1.20.3H\x00R\fchartVersion\x88\x01\x01\x12m\n" +
	"\x04crds\x18\x04 \x01(\v2Y.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCrdsR\x04crds\x12-\n" +
	...
	" \x01(\bR\x19enableCertificateOwnerRef\x12\x90\x01\n" +
	"\rfeature_gates\x18\v \x03(\v2k.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.FeatureGatesEntryR\ffeatureGates\x12\x8d\x01\n" +
	"\x10dns01_self_check\x18\f \x01(\v2c.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerDns01SelfCheckR\x0edns01SelfCheck\x12N\n" +
	...
	"\x0eimage_registry\x18\x0f \x01(\tR\rimageRegistry\x12\x7f\n" +
	"\n" +
	"prometheus\x18\x10 \x01(\v2_.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheusR\n" +
	"prometheus\x12\x90\x01\n" +
	"\rnode_selector\x18\x11 \x03(\v2k.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.NodeSelectorEntryR\fnodeSelector\x12U\n" +
	"\vtolerations\x18\x12 \x03(\v23.dev.planton.provider.kubernetes.WorkloadTolerationR\vtolerations\x122\n" +
	"\x15pod_disruption_budget\x18\x13 \x01(\bR\x13podDisruptionBudget\x12v\n" +
	"\awebhook\x18\x14 \x01(\v2\\.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhookR\awebhook\x12\x7f\n" +
	"\n" +
	"cainjector\x18\x15 \x01(\v2_.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjectorR\n" +
	"cainjector\x12\x8e\x01\n" +
	"\x0fstartupapicheck\x18\x16 \x01(\v2d.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerStartupApiCheckR\x0fstartupapicheck\x12\x1f\n" +
	...
	"\x1bdns01.only_requires_servers\x12\x93\x01recursive_nameservers_only requires recursive_nameservers to be set — 'only' restricts lookups to the configured resolvers, so there must be some\x1aH!this.recursive_nameservers_only || size(this.recursive_nameservers) > 0\"\xdf\x03\n" +
	...
	"\x18service_monitor_interval\x18\x03 \x01(\tB\a\x8a\xa6\x1d\x0360sH\x01R\x16serviceMonitorInterval\x88\x01\x01\x12\xaf\x01\n" +
	"\x16service_monitor_labels\x18\x04 \x03(\v2y.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.ServiceMonitorLabelsEntryR\x14serviceMonitorLabels\x1aG\n" +
	...
	"\n" +
	"\b_timeoutB\xee\x03\n" +
	"Bcom.dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1B\tSpecProtoP\x01Z~github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetescertmanager/v1alpha1;kubernetescertmanagerv1alpha1\xa2\x02\x05DPPKK\xaa\x02>Dev.Planton.Provider.Kubernetes.Kubernetescertmanager.V1alpha1\xca\x02>Dev\\Planton\\Provider\\Kubernetes\\Kubernetescertmanager\\V1alpha1\xe2\x02JDev\\Planton\\Provider\\Kubernetes\\Kubernetescertmanager\\V1alpha1\\GPBMetadata\xea\x02CDev::Planton::Provider::Kubernetes::Kubernetescertmanager::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesCertManagerSpec)(nil),            // 0: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec
	(*KubernetesCertManagerCrds)(nil),            // 1: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCrds
	(*KubernetesCertManagerDns01SelfCheck)(nil),  // 2: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerDns01SelfCheck
	(*KubernetesCertManagerPrometheus)(nil),      // 3: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus
	(*KubernetesCertManagerWebhook)(nil),         // 4: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhook
	(*KubernetesCertManagerCainjector)(nil),      // 5: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjector
	(*KubernetesCertManagerStartupApiCheck)(nil), // 6: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerStartupApiCheck
	nil,                                   // 7: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.FeatureGatesEntry
	nil,                                   // 8: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.NodeSelectorEntry
	nil,                                   // 9: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.ServiceMonitorLabelsEntry
...
var file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_depIdxs = []int32{
	10, // 0: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.crds:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCrds
	11, // 2: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	7,  // 3: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.feature_gates:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.FeatureGatesEntry
	2,  // 4: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.dns01_self_check:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerDns01SelfCheck
	12, // 5: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.workload_identity:type_name -> dev.planton.provider.kubernetes.KubernetesWorkloadIdentity
	3,  // 6: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.prometheus:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus
	8,  // 7: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.node_selector:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.NodeSelectorEntry
	13, // 8: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.tolerations:type_name -> dev.planton.provider.kubernetes.WorkloadToleration
	4,  // 9: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.webhook:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhook
	5,  // 10: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.cainjector:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjector
	6,  // 11: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.startupapicheck:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerStartupApiCheck
	9,  // 12: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.service_monitor_labels:type_name -> dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.ServiceMonitorLabelsEntry
	11, // 13: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhook.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	11, // 14: dev.planton.provider.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjector.resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
...
func init() { file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_depIdxs = nil
}
