...
func buildSolrImage(spec *kubernetessolrv1.KubernetesSolrSpec) solrv1beta1.SolrCloudSpecSolrImagePtrInput {
...
func buildZookeeperRef(zookeeper *kubernetessolrv1.KubernetesSolrZookeeper) solrv1beta1.SolrCloudSpecZookeeperRefPtrInput {
...
func buildDataStorage(storage *kubernetessolrv1.KubernetesSolrStorage) solrv1beta1.SolrCloudSpecDataStoragePtrInput {
...
// set.
func buildPodOptions(spec *kubernetessolrv1.KubernetesSolrSpec) solrv1beta1.SolrCloudSpecCustomSolrKubeOptionsPodOptionsPtrInput {
...
func buildSolrAddressability(spec *kubernetessolrv1.KubernetesSolrSpec) solrv1beta1.SolrCloudSpecSolrAddressabilityPtrInput {
	podPort := int32(8983)
	if spec.PodPort != nil {
...
func buildUpdateStrategy(updateStrategy *kubernetessolrv1.KubernetesSolrUpdateStrategy) solrv1beta1.SolrCloudSpecUpdateStrategyPtrInput {
...
func buildScaling(scaling *kubernetessolrv1.KubernetesSolrScaling) solrv1beta1.SolrCloudSpecScalingPtrInput {
	if scaling == nil {
		return nil
	}
...
func buildSolrTls(tls *kubernetessolrv1.KubernetesSolrTls) solrv1beta1.SolrCloudSpecSolrTLSPtrInput {
	if tls == nil {
		return nil
	}
...
func buildSolrSecurity(security *kubernetessolrv1.KubernetesSolrSecurity) solrv1beta1.SolrCloudSpecSolrSecurityPtrInput {
...
func buildBackupRepositories(repositories []*kubernetessolrv1.KubernetesSolrBackupRepository) solrv1beta1.SolrCloudSpecBackupRepositoriesArray {
