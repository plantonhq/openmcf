...
[KubernetesValkey](../../kubernetesvalkey/v1/reference.md) and point it
there (the field doc on [reference.md](reference.md)). Worker pods are
...
watch judgment in its [guide](../../kuberneteskuberayoperator/v1/GUIDE.md)).
...
- KubernetesKubeRayOperator — required (see its
  [guide](../../kuberneteskuberayoperator/v1/GUIDE.md)).
