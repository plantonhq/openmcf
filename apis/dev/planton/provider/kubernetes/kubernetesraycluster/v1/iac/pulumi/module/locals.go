...
// outputs.
type Locals struct {
	KubernetesRayCluster *kubernetesrayclusterv1.KubernetesRayCluster
	Spec                 *kubernetesrayclusterv1.KubernetesRayClusterSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesrayclusterv1.KubernetesRayClusterStackInput) *Locals {
