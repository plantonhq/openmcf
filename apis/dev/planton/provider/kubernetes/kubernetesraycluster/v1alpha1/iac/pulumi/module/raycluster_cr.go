...
func autoscalerOptionsBody(autoscaling *kubernetesrayclusterv1alpha1.KubernetesRayClusterAutoscaling) map[string]interface{} {
...
// RECOVERS.
func gcsFaultToleranceBody(gcsFt *kubernetesrayclusterv1alpha1.KubernetesRayClusterGcsFaultTolerance) map[string]interface{} {
...
// quiet.
func workerGroupSpecBody(locals *Locals, group *kubernetesrayclusterv1alpha1.KubernetesRayClusterWorkerGroup) map[string]interface{} {
	out := map[string]interface{}{
...
func schedulingEntries(podSpec map[string]interface{}, scheduling *kubernetesrayclusterv1alpha1.KubernetesRayClusterScheduling) {
	if scheduling == nil {
		return
	}
