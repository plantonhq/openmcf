...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kuberneteshelmrelease/v1alpha1/spec.proto
...
func (x *KubernetesHelmReleaseSpec) Reset() {
	*x = KubernetesHelmReleaseSpec{}
	mi := &file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesHelmReleaseSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Idev/planton/provider/kubernetes/kuberneteshelmrelease/v1alpha1/spec.proto\x12>dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xf3\x14\n" +
	...
	"valuesYaml\x12t\n" +
	"\x03set\x18\b \x03(\v2b.dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetEntryR\x03set\x12\x87\x01\n" +
	"\n" +
	"set_string\x18\t \x03(\v2h.dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetStringEntryR\tsetString\x12\x96\x01\n" +
	"\rset_sensitive\x18\n" +
	" \x03(\v2k.dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetSensitiveEntryB\x04\xa0\xa6\x1d\x01R\fsetSensitive\x12/\n" +
	...
	"\f_max_historyB\xee\x03\n" +
	"Bcom.dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1B\tSpecProtoP\x01Z~github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kuberneteshelmrelease/v1alpha1;kuberneteshelmreleasev1alpha1\xa2\x02\x05DPPKK\xaa\x02>Dev.Planton.Provider.Kubernetes.Kuberneteshelmrelease.V1alpha1\xca\x02>Dev\\Planton\\Provider\\Kubernetes\\Kuberneteshelmrelease\\V1alpha1\xe2\x02JDev\\Planton\\Provider\\Kubernetes\\Kuberneteshelmrelease\\V1alpha1\\GPBMetadata\xea\x02CDev::Planton::Provider::Kubernetes::Kuberneteshelmrelease::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesHelmReleaseSpec)(nil), // 0: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec
	nil,                               // 1: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetEntry
	nil,                               // 2: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetStringEntry
	nil,                               // 3: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetSensitiveEntry
	(*v1.StringValueOrRef)(nil),       // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.set:type_name -> dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetEntry
	2, // 2: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.set_string:type_name -> dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetStringEntry
	3, // 3: dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.set_sensitive:type_name -> dev.planton.provider.kubernetes.kuberneteshelmrelease.v1alpha1.KubernetesHelmReleaseSpec.SetSensitiveEntry
...
func init() { file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kuberneteshelmrelease_v1alpha1_spec_proto_depIdxs = nil
}
