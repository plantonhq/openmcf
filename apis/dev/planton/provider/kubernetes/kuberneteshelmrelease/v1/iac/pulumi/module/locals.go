...
// the module.
type Locals struct {
	Spec *kuberneteshelmreleasev1.KubernetesHelmReleaseSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteshelmreleasev1.KubernetesHelmReleaseStackInput) *Locals {
