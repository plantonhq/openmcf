...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetestektonoperator/v1alpha1/spec.proto
...
func (x *KubernetesTektonOperatorSpec) Reset() {
	*x = KubernetesTektonOperatorSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesTektonOperatorSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ldev/planton/provider/kubernetes/kubernetestektonoperator/v1alpha1/spec.proto\x12Adev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1\x1a0dev/planton/provider/kubernetes/kubernetes.proto\x1a2dev/planton/provider/kubernetes/workload_pod.proto\x1a(dev/planton/shared/options/options.proto\"\xbd\x06\n" +
	...
	"\x11webhook_resources\x18\x04 \x01(\v23.dev.planton.provider.kubernetes.ContainerResourcesR\x10webhookResources\x12\x96\x01\n" +
	"\rnode_selector\x18\x05 \x03(\v2q.dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.NodeSelectorEntryR\fnodeSelector\x12U\n" +
	...
	"Ecom.dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1B\tSpecProtoP\x01Z\x84\x01github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetestektonoperator/v1alpha1;kubernetestektonoperatorv1alpha1\xa2\x02\x05DPPKK\xaa\x02ADev.Planton.Provider.Kubernetes.Kubernetestektonoperator.V1alpha1\xca\x02ADev\\Planton\\Provider\\Kubernetes\\Kubernetestektonoperator\\V1alpha1\xe2\x02MDev\\Planton\\Provider\\Kubernetes\\Kubernetestektonoperator\\V1alpha1\\GPBMetadata\xea\x02FDev::Planton::Provider::Kubernetes::Kubernetestektonoperator::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesTektonOperatorSpec)(nil),  // 0: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec
	nil,                                   // 1: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.NodeSelectorEntry
...
var file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.operator_image:type_name -> dev.planton.provider.kubernetes.ContainerImage
	2, // 1: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.webhook_image:type_name -> dev.planton.provider.kubernetes.ContainerImage
	3, // 2: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.operator_resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	3, // 3: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.webhook_resources:type_name -> dev.planton.provider.kubernetes.ContainerResources
	1, // 4: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.node_selector:type_name -> dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.NodeSelectorEntry
	4, // 5: dev.planton.provider.kubernetes.kubernetestektonoperator.v1alpha1.KubernetesTektonOperatorSpec.tolerations:type_name -> dev.planton.provider.kubernetes.WorkloadToleration
...
func init() { file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetestektonoperator_v1alpha1_spec_proto_depIdxs = nil
}
