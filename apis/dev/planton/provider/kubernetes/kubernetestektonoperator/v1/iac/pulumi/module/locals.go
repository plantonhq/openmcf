...
type Locals struct {
	...
	Spec                     *kubernetestektonoperatorv1.KubernetesTektonOperatorSpec
...
func initializeLocals(_ *pulumi.Context, stackInput *kubernetestektonoperatorv1.KubernetesTektonOperatorStackInput) *Locals {
