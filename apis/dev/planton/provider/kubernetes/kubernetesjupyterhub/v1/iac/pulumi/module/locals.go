...
type Locals struct {
	Spec *kubernetesjupyterhubv1.KubernetesJupyterHubSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesjupyterhubv1.KubernetesJupyterHubStackInput) *Locals {
