...
// author to repeat it.
func ociPluginsBody(plugins []*kuberneteskafkaconnectv1.KubernetesKafkaConnectOciPlugin) []interface{} {
	if len(plugins) == 0 {
		return nil
	}
...
// the image.
func buildBody(build *kuberneteskafkaconnectv1.KubernetesKafkaConnectBuild) map[string]interface{} {
	if build == nil {
		return nil
	}
...
func buildArtifactBody(artifact *kuberneteskafkaconnectv1.KubernetesKafkaConnectBuildArtifact) map[string]interface{} {
	body := map[string]interface{}{
...
func templateBody(spec *kuberneteskafkaconnectv1.KubernetesKafkaConnectSpec) map[string]interface{} {
...
func jvmBody(jvm *kuberneteskafkaconnectv1.KubernetesKafkaConnectJvm) map[string]interface{} {
	if jvm == nil {
		return nil
	}
	body := map[string]interface{}{}
