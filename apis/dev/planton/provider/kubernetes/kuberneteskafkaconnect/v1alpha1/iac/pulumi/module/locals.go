...
type Locals struct {
	Spec *kuberneteskafkaconnectv1alpha1.KubernetesKafkaConnectSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskafkaconnectv1alpha1.KubernetesKafkaConnectStackInput) *Locals {
