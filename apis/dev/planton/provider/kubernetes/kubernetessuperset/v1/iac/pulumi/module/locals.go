...
type Locals struct {
	Spec *kubernetessupersetv1.KubernetesSupersetSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetessupersetv1.KubernetesSupersetStackInput) *Locals {
