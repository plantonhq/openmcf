...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetesgateway/v1/spec.proto
...
func (x *KubernetesGatewaySpec) Reset() {
	*x = KubernetesGatewaySpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesGatewayListener) Reset() {
	*x = KubernetesGatewayListener{}
	mi := &file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGatewayListener) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDesc = "" +
	...
	"\x12gateway_class_name\x18\x03 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB0\xbaH\x03\xc8\x01\x01\x88\xd4a\xc9\x1f\x92\xd4a!status.outputs.gateway_class_nameR\x10gatewayClassName\x12y\n" +
	...
	"\x0einfrastructure\x18\x06 \x01(\v2U.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayInfrastructureR\x0einfrastructure\x12\x84\x01\n" +
	"\x11allowed_listeners\x18\a \x01(\v2W.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayAllowedListenersR\x10allowedListeners\x12b\n" +
	"\x03tls\x18\b \x01(\v2P.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayTlsConfigR\x03tls:\xab\b\xbaH\xa7\b\x1a\xa0\x01\n" +
	...
	"\bfrontend\x18\x02 \x01(\v2X.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayFrontendTlsConfigR\bfrontend\"\xa0\x01\n" +
	"\x1bKubernetesGatewayBackendTls\x12\x80\x01\n" +
	"\x16client_certificate_ref\x18\x01 \x01(\v2J.dev.planton.provider.kubernetes.KubernetesGatewayApiSecretObjectReferenceR\x14clientCertificateRef\"\xdb\x03\n" +
	"\"KubernetesGatewayFrontendTlsConfig\x12\x84\x01\n" +
	"\adefault\x18\x01 \x01(\v2b.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayFrontendTlsValidationConfigB\x06\xbaH\x03\xc8\x01\x01R\adefault\x12y\n" +
	"\bper_port\x18\x02 \x03(\v2T.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayTlsPortConfigB\b\xbaH\x05\x92\x01\x02\x10@R\aperPort:\xb2\x01\xbaH\xae\x01\x1a\xab\x01\n" +
	...
	"\x03tls\x18\x02 \x01(\v2b.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayFrontendTlsValidationConfigB\x06\xbaH\x03\xc8\x01\x01R\x03tls\"\xac\x01\n" +
	",KubernetesGatewayFrontendTlsValidationConfig\x12|\n" +
	"\n" +
	"validation\x18\x01 \x01(\v2\\.dev.planton.provider.kubernetes.kubernetesgateway.v1.KubernetesGatewayFrontendTlsValidationR\n" +
	"validation\"\x80\x03\n" +
	...
	"\x05_modeB\xa8\x03\n" +
	"8com.dev.planton.provider.kubernetes.kubernetesgateway.v1B\tSpecProtoP\x01Zjgithub.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesgateway/v1;kubernetesgatewayv1\xa2\x02\x05DPPKK\xaa\x024Dev.Planton.Provider.Kubernetes.Kubernetesgateway.V1\xca\x024Dev\\Planton\\Provider\\Kubernetes\\Kubernetesgateway\\V1\xe2\x02@Dev\\Planton\\Provider\\Kubernetes\\Kubernetesgateway\\V1\\GPBMetadata\xea\x029Dev::Planton::Provider::Kubernetes::Kubernetesgateway::V1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_rawDesc)))
	})
...
func file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetesgateway_v1_spec_proto_depIdxs = nil
}
