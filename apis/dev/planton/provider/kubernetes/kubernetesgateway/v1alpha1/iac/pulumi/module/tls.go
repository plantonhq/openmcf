...
import (
	...
	kubernetesgatewayv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetesgateway/v1alpha1"
...
// builder below.
func buildGatewayTls(tls *kubernetesgatewayv1alpha1.KubernetesGatewayTlsConfig) gatewayv1.GatewaySpecTlsArgs {
...
func buildBackendTls(backend *kubernetesgatewayv1alpha1.KubernetesGatewayBackendTls) gatewayv1.GatewaySpecTlsBackendArgs {
...
func buildFrontendTls(frontend *kubernetesgatewayv1alpha1.KubernetesGatewayFrontendTlsConfig) gatewayv1.GatewaySpecTlsFrontendArgs {
...
func buildFrontendDefault(def *kubernetesgatewayv1alpha1.KubernetesGatewayFrontendTlsValidationConfig) gatewayv1.GatewaySpecTlsFrontendDefaultArgs {
...
func buildPerPortTls(tls *kubernetesgatewayv1alpha1.KubernetesGatewayFrontendTlsValidationConfig) gatewayv1.GatewaySpecTlsFrontendPerPortTlsArgs {
