...
// buildListeners maps the Planton listeners onto the typed crd2pulumi listener
// args array. Optional fields are only set when present so upstream/controller
// defaults flow through unchanged.
func buildListeners(listeners []*kubernetesgatewayv1alpha1.KubernetesGatewayListener) gatewayv1.GatewaySpecListenersArray {
