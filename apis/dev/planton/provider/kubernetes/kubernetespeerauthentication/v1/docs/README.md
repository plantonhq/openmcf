...
fidelity decisions behind the `KubernetesPeerAuthentication` Planton component
(kind 863).
...
Most Planton enum-like fields are `optional string` with a CEL rule that also
