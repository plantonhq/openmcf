...
// 	protoc        (unknown)
// source: dev/planton/provider/kubernetes/kubernetespeerauthentication/v1/spec.proto
...
func (x *KubernetesPeerAuthenticationSpec) Reset() {
	*x = KubernetesPeerAuthenticationSpec{}
	mi := &file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesPeerAuthenticationMutualTls) Reset() {
	*x = KubernetesPeerAuthenticationMutualTls{}
	mi := &file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesPeerAuthenticationMutualTls) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto protoreflect.FileDescriptor
...
const file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDesc = "" +
	...
	"Ccom.dev.planton.provider.kubernetes.kubernetespeerauthentication.v1B\tSpecProtoP\x01Z\x80\x01github.com/plantonhq/planton/apis/dev/planton/provider/kubernetes/kubernetespeerauthentication/v1;kubernetespeerauthenticationv1\xa2\x02\x05DPPKK\xaa\x02?Dev.Planton.Provider.Kubernetes.Kubernetespeerauthentication.V1\xca\x02?Dev\\Planton\\Provider\\Kubernetes\\Kubernetespeerauthentication\\V1\xe2\x02KDev\\Planton\\Provider\\Kubernetes\\Kubernetespeerauthentication\\V1\\GPBMetadata\xea\x02DDev::Planton::Provider::Kubernetes::Kubernetespeerauthentication::V1b\x06proto3"

var (
	file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_init() {
	if File_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDesc), len(file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto = out.File
	file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_kubernetes_kubernetespeerauthentication_v1_spec_proto_depIdxs = nil
}
