...
type Locals struct {
	Spec *kubernetescloudnativepgoperatorv1.KubernetesCloudNativePgOperatorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetescloudnativepgoperatorv1.KubernetesCloudNativePgOperatorStackInput) *Locals {
