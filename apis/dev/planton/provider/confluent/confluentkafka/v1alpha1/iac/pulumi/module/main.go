...
import (
	...
	confluentkafkav1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/confluent/confluentkafka/v1alpha1"
	"github.com/pulumi/pulumi-confluentcloud/sdk/v2/go/confluentcloud"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

// Resources creates a Confluent Cloud Kafka cluster with all configured parameters
func Resources(ctx *pulumi.Context, stackInput *confluentkafkav1alpha1.ConfluentKafkaStackInput) error {
...
func createProvider(ctx *pulumi.Context, stackInput *confluentkafkav1alpha1.ConfluentKafkaStackInput) (*confluentcloud.Provider, error) {
