...
The **Confluent Cloud Kafka Terraform Module** provides Infrastructure as Code (IaC) capabilities for deploying and managing Confluent Cloud Kafka clusters across AWS, GCP, and Azure. This module integrates with Planton's unified API framework, enabling developers to provision production-ready Kafka infrastructure using declarative Terraform configurations.
...
cd planton/apis/dev/planton/provider/confluent/confluentkafka/v1alpha1/iac/tf
```
...
For support:
- **Issues**: Open an issue on [GitHub](https://github.com/plantonhq/planton/issues)
...
This module is part of Planton and is licensed under the MIT License. See [LICENSE](../../../../../../../../../LICENSE) for details.
