...
import (
	...
	ocidnszonev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocidnszone/v1alpha1"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci/dns"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

var zoneTypeMap = map[ocidnszonev1alpha1.OciDnsZoneSpec_ZoneType]string{
	ocidnszonev1alpha1.OciDnsZoneSpec_primary:   "PRIMARY",
	ocidnszonev1alpha1.OciDnsZoneSpec_secondary: "SECONDARY",
}
...
func dnsZone(ctx *pulumi.Context, locals *Locals, provider *oci.Provider) error {
	...
	if spec.Scope == ocidnszonev1alpha1.OciDnsZoneSpec_scope_private {
		args.Scope = pulumi.String("PRIVATE")
	} else if spec.Scope == ocidnszonev1alpha1.OciDnsZoneSpec_global {
...
func buildExternalMasters(servers []*ocidnszonev1alpha1.OciDnsZoneSpec_ExternalServer) dns.ZoneExternalMasterArray {
...
func buildExternalDownstreams(servers []*ocidnszonev1alpha1.OciDnsZoneSpec_ExternalServer) dns.ZoneExternalDownstreamArray {
