...
OciDnsZone is an Planton component that deploys an OCI DNS zone. It provides a single declarative manifest to create a managed authoritative DNS zone with support for public and private scopes, primary and secondary types, DNSSEC signing, and zone transfers.
