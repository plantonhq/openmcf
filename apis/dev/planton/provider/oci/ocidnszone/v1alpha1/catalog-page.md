...
- [OciDnsRecord](/docs/catalog/oci/ocidnsrecord) — manages record sets within this zone
- [OciApplicationLoadBalancer](/docs/catalog/oci/ociapplicationloadbalancer) — load balancer IPs are common DNS targets
- [OciVcn](/docs/catalog/oci/ocivcn) — VCNs with private DNS views for private zone resolution
