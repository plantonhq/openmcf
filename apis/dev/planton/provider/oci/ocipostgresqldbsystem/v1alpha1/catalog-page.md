...
- [OciVcn](/docs/catalog/oci/ocivcn) — the virtual cloud network containing the subnet where the DB System is placed
- [OciSubnet](/docs/catalog/oci/ocisubnet) — provides the subnet referenced by `networkDetails.subnetId` via `valueFrom`
- [OciSecurityGroup](/docs/catalog/oci/ocisecuritygroup) — provides network security groups referenced by `networkDetails.nsgIds` via `valueFrom`
