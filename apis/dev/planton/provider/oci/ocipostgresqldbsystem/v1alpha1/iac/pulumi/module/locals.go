...
type Locals struct {
	OciPostgresqlDbSystem *ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystem
	DisplayName           string
	FreeformTags          map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemStackInput) *Locals {
	locals := &Locals{}
