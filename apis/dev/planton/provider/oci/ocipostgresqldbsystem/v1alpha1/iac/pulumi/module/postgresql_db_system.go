...
import (
	...
	ocipostgresqldbsystemv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocipostgresqldbsystem/v1alpha1"
...
func buildNetworkDetails(nd *ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_NetworkDetails) psql.DbSystemNetworkDetailsInput {
...
func buildStorageDetails(sd *ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_StorageDetails) psql.DbSystemStorageDetailsInput {
...
func buildCredentials(creds *ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_Credentials) psql.DbSystemCredentialsPtrInput {
	pd := creds.PasswordDetails
	pwdDetails := &psql.DbSystemCredentialsPasswordDetailsArgs{}

	if pd.PasswordType != ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_password_type_unspecified {
...
func buildManagementPolicy(mp *ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_ManagementPolicy) psql.DbSystemManagementPolicyPtrInput {
...
func buildBackupPolicy(bp *ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_BackupPolicy) psql.DbSystemManagementPolicyBackupPolicyPtrInput {
	backup := &psql.DbSystemManagementPolicyBackupPolicyArgs{}

	if bp.Kind != ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_backup_kind_unspecified {
...
func buildInstancesDetails(details []*ocipostgresqldbsystemv1alpha1.OciPostgresqlDbSystemSpec_InstanceDetails) psql.DbSystemInstancesDetailArrayInput {
