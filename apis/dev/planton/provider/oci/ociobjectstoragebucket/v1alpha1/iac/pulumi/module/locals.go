...
type Locals struct {
	OciObjectStorageBucket *ociobjectstoragebucketv1alpha1.OciObjectStorageBucket
	BucketName             string
	FreeformTags           map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ociobjectstoragebucketv1alpha1.OciObjectStorageBucketStackInput) *Locals {
	locals := &Locals{}
