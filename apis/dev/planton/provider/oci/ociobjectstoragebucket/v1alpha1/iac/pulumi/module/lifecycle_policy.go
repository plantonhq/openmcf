...
var lifecycleActionMap = map[ociobjectstoragebucketv1alpha1.OciObjectStorageBucketSpec_LifecycleAction]string{
	ociobjectstoragebucketv1alpha1.OciObjectStorageBucketSpec_lifecycle_archive:           "ARCHIVE",
	ociobjectstoragebucketv1alpha1.OciObjectStorageBucketSpec_lifecycle_infrequent_access: "INFREQUENT_ACCESS",
	ociobjectstoragebucketv1alpha1.OciObjectStorageBucketSpec_lifecycle_delete:            "DELETE",
	ociobjectstoragebucketv1alpha1.OciObjectStorageBucketSpec_lifecycle_abort:             "ABORT",
}
...
func buildLifecycleRules(rules []*ociobjectstoragebucketv1alpha1.OciObjectStorageBucketSpec_LifecycleRule) objectstorage.ObjectLifecyclePolicyRuleArray {
...
func buildObjectNameFilter(filter *ociobjectstoragebucketv1alpha1.OciObjectStorageBucketSpec_ObjectNameFilter) *objectstorage.ObjectLifecyclePolicyRuleObjectNameFilterArgs {
