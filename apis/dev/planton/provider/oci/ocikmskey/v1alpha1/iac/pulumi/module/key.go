...
import (
	...
	ocikmskeyv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocikmskey/v1alpha1"
...
func buildKeyShape(shape *ocikmskeyv1alpha1.OciKmsKeySpec_KeyShape) *kms.KeyKeyShapeArgs {
...
func buildAutoKeyRotationDetails(
	details *ocikmskeyv1alpha1.OciKmsKeySpec_AutoKeyRotationDetails,
...
func buildExternalKeyReference(
	ref *ocikmskeyv1alpha1.OciKmsKeySpec_ExternalKeyReference,
