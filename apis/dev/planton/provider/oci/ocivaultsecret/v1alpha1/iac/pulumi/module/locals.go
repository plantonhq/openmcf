...
type Locals struct {
	OciVaultSecret *ocivaultsecretv1alpha1.OciVaultSecret
	DisplayName    string
	FreeformTags   map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocivaultsecretv1alpha1.OciVaultSecretStackInput) *Locals {
	locals := &Locals{}
