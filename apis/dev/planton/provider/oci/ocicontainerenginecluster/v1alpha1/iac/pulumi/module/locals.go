...
type Locals struct {
	OciContainerEngineCluster *ocicontainerengineclusterv1alpha1.OciContainerEngineCluster
	DisplayName               string
	FreeformTags              map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterStackInput) *Locals {
	locals := &Locals{}
