...
import (
	...
	ocicontainerengineclusterv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocicontainerenginecluster/v1alpha1"
...
func cluster(ctx *pulumi.Context, locals *Locals, provider *oci.Provider) error {
	...
	if spec.Type != ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_unspecified {
		args.Type = pulumi.StringPtr(strings.ToUpper(spec.Type.String()))
	}

	if spec.CniType != ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_cni_unspecified {
...
func buildEndpointConfig(ec *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_EndpointConfig) *containerengine.ClusterEndpointConfigArgs {
...
func buildClusterOptions(opts *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_ClusterOptions) *containerengine.ClusterOptionsArgs {
...
func buildKubernetesNetworkConfig(knc *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_KubernetesNetworkConfig) *containerengine.ClusterOptionsKubernetesNetworkConfigArgs {
...
func buildServiceLbConfig(slc *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_ServiceLbConfig) *containerengine.ClusterOptionsServiceLbConfigArgs {
...
func buildPersistentVolumeConfig(pvc *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_PersistentVolumeConfig) *containerengine.ClusterOptionsPersistentVolumeConfigArgs {
...
func buildOidcConfig(oidc *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_OpenIdConnectTokenAuthenticationConfig) *containerengine.ClusterOptionsOpenIdConnectTokenAuthenticationConfigArgs {
...
func buildImagePolicyConfig(ipc *ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_ImagePolicyConfig) *containerengine.ClusterImagePolicyConfigArgs {
...
func ipFamilyString(f ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_IpFamily) string {
	switch f {
	case ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_ipv4:
		return "IPv4"
	case ocicontainerengineclusterv1alpha1.OciContainerEngineClusterSpec_ipv6:
		return "IPv6"
	default:
		return "IPv4"
	}
