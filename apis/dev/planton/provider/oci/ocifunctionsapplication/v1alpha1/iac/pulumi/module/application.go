...
func buildImagePolicyConfig(
	ipc *ocifunctionsapplicationv1alpha1.OciFunctionsApplicationSpec_ImagePolicyConfig,
...
func buildTraceConfig(
	tc *ocifunctionsapplicationv1alpha1.OciFunctionsApplicationSpec_TraceConfig,
