...
type Locals struct {
	OciFunctionsApplication *ocifunctionsapplicationv1alpha1.OciFunctionsApplication
	DisplayName             string
	FreeformTags            map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocifunctionsapplicationv1alpha1.OciFunctionsApplicationStackInput) *Locals {
	locals := &Locals{}
