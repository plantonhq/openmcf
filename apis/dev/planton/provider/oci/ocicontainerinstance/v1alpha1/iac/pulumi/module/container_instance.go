...
import (
	...
	ocicontainerinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocicontainerinstance/v1alpha1"
...
func containerInstance(ctx *pulumi.Context, locals *Locals, provider *oci.Provider) error {
	...
	if spec.ContainerRestartPolicy != ocicontainerinstancev1alpha1.OciContainerInstanceSpec_restart_policy_unspecified {
...
func buildShapeConfig(sc *ocicontainerinstancev1alpha1.OciContainerInstanceSpec_ShapeConfig) *containerengine.ContainerInstanceShapeConfigArgs {
...
func buildContainers(containers []*ocicontainerinstancev1alpha1.OciContainerInstanceSpec_Container) containerengine.ContainerInstanceContainerArray {
...
func buildContainer(c *ocicontainerinstancev1alpha1.OciContainerInstanceSpec_Container) *containerengine.ContainerInstanceContainerArgs {
...
func buildContainerResourceConfig(rc *ocicontainerinstancev1alpha1.OciContainerInstanceSpec_ContainerResourceConfig) *containerengine.ContainerInstanceContainerResourceConfigArgs {
...
func buildHealthChecks(checks []*ocicontainerinstancev1alpha1.OciContainerInstanceSpec_HealthCheck) containerengine.ContainerInstanceContainerHealthCheckArray {
	...
	for i, hc := range checks {
		...
		if hc.FailureAction != ocicontainerinstancev1alpha1.OciContainerInstanceSpec_failure_action_unspecified {
...
func buildSecurityContext(sc *ocicontainerinstancev1alpha1.OciContainerInstanceSpec_SecurityContext) *containerengine.ContainerInstanceContainerSecurityContextArgs {
...
func buildVolumeMounts(mounts []*ocicontainerinstancev1alpha1.OciContainerInstanceSpec_VolumeMount) containerengine.ContainerInstanceContainerVolumeMountArray {
...
func buildVnics(vnics []*ocicontainerinstancev1alpha1.OciContainerInstanceSpec_Vnic) containerengine.ContainerInstanceVnicArray {
...
func buildDnsConfig(dns *ocicontainerinstancev1alpha1.OciContainerInstanceSpec_DnsConfig) *containerengine.ContainerInstanceDnsConfigArgs {
...
func buildImagePullSecrets(secrets []*ocicontainerinstancev1alpha1.OciContainerInstanceSpec_ImagePullSecret) containerengine.ContainerInstanceImagePullSecretArray {
...
func buildVolumes(volumes []*ocicontainerinstancev1alpha1.OciContainerInstanceSpec_Volume) containerengine.ContainerInstanceVolumeArray {
