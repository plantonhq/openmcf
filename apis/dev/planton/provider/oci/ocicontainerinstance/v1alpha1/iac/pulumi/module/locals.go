...
type Locals struct {
	OciContainerInstance *ocicontainerinstancev1alpha1.OciContainerInstance
	DisplayName          string
	FreeformTags         map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocicontainerinstancev1alpha1.OciContainerInstanceStackInput) *Locals {
	locals := &Locals{}
