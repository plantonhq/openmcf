...
import (
	...
	ociautonomousdatabasev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ociautonomousdatabase/v1alpha1"
...
func autonomousDatabase(ctx *pulumi.Context, locals *Locals, provider *oci.Provider) error {
	...
	if spec.DbWorkload != ociautonomousdatabasev1alpha1.OciAutonomousDatabaseSpec_db_workload_unspecified {
	...
	if spec.DatabaseEdition != ociautonomousdatabasev1alpha1.OciAutonomousDatabaseSpec_database_edition_unspecified {
		args.DatabaseEdition = pulumi.StringPtr(strings.ToUpper(spec.DatabaseEdition.String()))
	}

	if spec.LicenseModel != ociautonomousdatabasev1alpha1.OciAutonomousDatabaseSpec_license_model_unspecified {
	...
	if spec.ComputeModel != ociautonomousdatabasev1alpha1.OciAutonomousDatabaseSpec_compute_model_unspecified {
	...
	if spec.AutonomousMaintenanceScheduleType != ociautonomousdatabasev1alpha1.OciAutonomousDatabaseSpec_maintenance_schedule_type_unspecified {
