...
type Locals struct {
	OciAutonomousDatabase *ociautonomousdatabasev1alpha1.OciAutonomousDatabase
	DisplayName           string
	FreeformTags          map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ociautonomousdatabasev1alpha1.OciAutonomousDatabaseStackInput) *Locals {
	locals := &Locals{}
