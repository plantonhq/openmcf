...
- [OciSubnet](/docs/catalog/oci/ocisubnet) — provides the subnet for private endpoint access via `subnetId`
- [OciSecurityGroup](/docs/catalog/oci/ocisecuritygroup) — provides NSGs for the private endpoint via `nsgIds`
- [OciVcn](/docs/catalog/oci/ocivcn) — the VCN containing the subnet used for private endpoint access
