...
import (
	...
	ocinetworkloadbalancerv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocinetworkloadbalancer/v1alpha1"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci/networkloadbalancer"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

var policyMap = map[ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_BackendSet_Policy]string{
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_BackendSet_five_tuple:  "FIVE_TUPLE",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_BackendSet_three_tuple: "THREE_TUPLE",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_BackendSet_two_tuple:   "TWO_TUPLE",
}

var healthCheckerProtocolMap = map[ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_HealthChecker_Protocol]string{
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_HealthChecker_http:  "HTTP",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_HealthChecker_https: "HTTPS",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_HealthChecker_tcp:   "TCP",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_HealthChecker_udp:   "UDP",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_HealthChecker_dns:   "DNS",
}
...
func createBackendSet(
	...
	provider *oci.Provider,
	nlb *networkloadbalancer.NetworkLoadBalancer,
	bsSpec *ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_BackendSet,
) (*networkloadbalancer.BackendSet, error) {
...
func createBackend(
	...
	bsName string,
	beSpec *ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_Backend,
) error {
...
func buildHealthChecker(hc *ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_HealthChecker) networkloadbalancer.BackendSetHealthCheckerArgs {
...
func buildDnsHealthCheck(dns *ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_DnsHealthCheck) *networkloadbalancer.BackendSetHealthCheckerDnsArgs {
