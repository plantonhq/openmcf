...
type Locals struct {
	OciNetworkLoadBalancer *ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancer
	DisplayName            string
	FreeformTags           map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerStackInput) *Locals {
	locals := &Locals{}
