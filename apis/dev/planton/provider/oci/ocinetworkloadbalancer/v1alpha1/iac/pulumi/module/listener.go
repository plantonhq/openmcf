...
var listenerProtocolMap = map[ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_Listener_Protocol]string{
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_Listener_tcp:         "TCP",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_Listener_udp:         "UDP",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_Listener_tcp_and_udp: "TCP_AND_UDP",
	ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_Listener_any:         "ANY",
}
...
func createListener(
	...
	provider *oci.Provider,
	nlb *networkloadbalancer.NetworkLoadBalancer,
	lnSpec *ocinetworkloadbalancerv1alpha1.OciNetworkLoadBalancerSpec_Listener,
