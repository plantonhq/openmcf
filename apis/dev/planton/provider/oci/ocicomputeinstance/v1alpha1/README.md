...
- **Automatic Tagging**: Standard Planton freeform tags applied to every instance (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
