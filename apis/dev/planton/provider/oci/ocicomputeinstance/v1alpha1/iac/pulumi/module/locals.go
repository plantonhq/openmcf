...
type Locals struct {
	OciComputeInstance *ocicomputeinstancev1alpha1.OciComputeInstance
	DisplayName        string
	FreeformTags       map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocicomputeinstancev1alpha1.OciComputeInstanceStackInput) *Locals {
	locals := &Locals{}
