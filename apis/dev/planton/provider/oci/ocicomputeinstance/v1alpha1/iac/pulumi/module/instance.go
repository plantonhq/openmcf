...
import (
	...
	ocicomputeinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocicomputeinstance/v1alpha1"
...
func buildSourceDetails(sd *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_SourceDetails) core.InstanceSourceDetailsArgs {
...
func buildCreateVnicDetails(vnic *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_CreateVnicDetails) core.InstanceCreateVnicDetailsArgs {
...
func buildShapeConfig(sc *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_ShapeConfig) core.InstanceShapeConfigArgs {
...
func buildAgentConfig(ac *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_AgentConfig) core.InstanceAgentConfigArgs {
...
func buildAvailabilityConfig(ac *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_AvailabilityConfig) core.InstanceAvailabilityConfigArgs {
	...
	if ac.RecoveryAction != ocicomputeinstancev1alpha1.OciComputeInstanceSpec_AvailabilityConfig_recovery_action_unspecified {
...
func buildLaunchOptions(lo *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_LaunchOptions) core.InstanceLaunchOptionsArgs {
	...
	if lo.Firmware != ocicomputeinstancev1alpha1.OciComputeInstanceSpec_LaunchOptions_firmware_unspecified {
...
func buildInstanceOptions(io *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_InstanceOptions) core.InstanceInstanceOptionsArgs {
...
func buildPreemptibleConfig(pc *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_PreemptibleInstanceConfig) core.InstancePreemptibleInstanceConfigArgs {
...
func buildPlatformConfig(pc *ocicomputeinstancev1alpha1.OciComputeInstanceSpec_PlatformConfig) core.InstancePlatformConfigArgs {
...
func sourceTypeString(st ocicomputeinstancev1alpha1.OciComputeInstanceSpec_SourceDetails_SourceType) string {
	switch st {
	case ocicomputeinstancev1alpha1.OciComputeInstanceSpec_SourceDetails_image:
		return "image"
	case ocicomputeinstancev1alpha1.OciComputeInstanceSpec_SourceDetails_boot_volume:
		return "bootVolume"
	default:
		return "image"
	}
