...
- **Automatic Tagging**: Standard Planton freeform tags are applied to every policy (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
...
- **Freeform Tagging**: Standard Planton labels applied as OCI freeform tags for policy tracking, compliance, and organizational reporting.
