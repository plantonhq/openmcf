...
import (
	ociidentitypolicyv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ociidentitypolicy/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	OciIdentityPolicy *ociidentitypolicyv1alpha1.OciIdentityPolicy
	Name              string
	FreeformTags      map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ociidentitypolicyv1alpha1.OciIdentityPolicyStackInput) *Locals {
	locals := &Locals{}
