...
import (
	...
	ociblockvolumev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ociblockvolume/v1alpha1"
	"github.com/plantonhq/planton/pkg/iac/pulumi/pulumimodule/provider/oci/pulumiociprovider"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

var autotuneTypeMap = map[ociblockvolumev1alpha1.OciBlockVolumeSpec_AutotunePolicy_AutotuneType]string{
	ociblockvolumev1alpha1.OciBlockVolumeSpec_AutotunePolicy_detached_volume:   "DETACHED_VOLUME",
	ociblockvolumev1alpha1.OciBlockVolumeSpec_AutotunePolicy_performance_based: "PERFORMANCE_BASED",
}

func Resources(ctx *pulumi.Context, stackInput *ociblockvolumev1alpha1.OciBlockVolumeStackInput) error {
