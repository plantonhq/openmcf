...
type Locals struct {
	OciBlockVolume *ociblockvolumev1alpha1.OciBlockVolume
	DisplayName    string
	FreeformTags   map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ociblockvolumev1alpha1.OciBlockVolumeStackInput) *Locals {
	locals := &Locals{}
