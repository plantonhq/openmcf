...
func buildAutotunePolicies(policies []*ociblockvolumev1alpha1.OciBlockVolumeSpec_AutotunePolicy) core.VolumeAutotunePolicyArray {
...
func buildBlockVolumeReplicas(replicas []*ociblockvolumev1alpha1.OciBlockVolumeSpec_BlockVolumeReplica) core.VolumeBlockVolumeReplicaArray {
