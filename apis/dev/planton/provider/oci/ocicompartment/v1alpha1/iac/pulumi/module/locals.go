...
type Locals struct {
	OciCompartment *ocicompartmentv1alpha1.OciCompartment
	Name           string
	FreeformTags   map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocicompartmentv1alpha1.OciCompartmentStackInput) *Locals {
	locals := &Locals{}
