...
type Locals struct {
	OciNetworkFirewall *ocinetworkfirewallv1alpha1.OciNetworkFirewall
	DisplayName        string
	PolicyDisplayName  string
	FreeformTags       map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocinetworkfirewallv1alpha1.OciNetworkFirewallStackInput) *Locals {
	locals := &Locals{}
