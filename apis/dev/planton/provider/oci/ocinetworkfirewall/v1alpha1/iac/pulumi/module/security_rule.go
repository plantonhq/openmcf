...
import (
	...
	ocinetworkfirewallv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocinetworkfirewall/v1alpha1"
...
func securityRuleResources(
	...
	for i, rule := range spec.Policy.SecurityRules {
		...
		if rule.Inspection != ocinetworkfirewallv1alpha1.OciNetworkFirewallSpec_SecurityRule_inspection_unspecified {
...
func buildSecurityRuleCondition(cond *ocinetworkfirewallv1alpha1.OciNetworkFirewallSpec_SecurityRuleCondition) *networkfirewall.NetworkFirewallPolicySecurityRuleConditionArgs {
