...
import (
	ocidevopsprojectv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocidevopsproject/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	OciDevopsProject *ocidevopsprojectv1alpha1.OciDevopsProject
	ProjectName      string
	FreeformTags     map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocidevopsprojectv1alpha1.OciDevopsProjectStackInput) *Locals {
	locals := &Locals{}
