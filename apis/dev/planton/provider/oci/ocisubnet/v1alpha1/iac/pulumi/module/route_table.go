...
func destinationTypeString(dt ocisubnetv1alpha1.OciSubnetSpec_RouteRule_DestinationType) string {
	switch dt {
	case ocisubnetv1alpha1.OciSubnetSpec_RouteRule_service_cidr_block:
		return "SERVICE_CIDR_BLOCK"
	case ocisubnetv1alpha1.OciSubnetSpec_RouteRule_cidr_block:
		return "CIDR_BLOCK"
	default:
