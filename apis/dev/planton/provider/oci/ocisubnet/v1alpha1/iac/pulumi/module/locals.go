...
import (
	ocisubnetv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocisubnet/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	OciSubnet    *ocisubnetv1alpha1.OciSubnet
	DisplayName  string
	FreeformTags map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocisubnetv1alpha1.OciSubnetStackInput) *Locals {
	locals := &Locals{}
	locals.OciSubnet = stackInput.Target
	...
	locals.FreeformTags = map[string]string{
		"resource":      "true",
		"resource_kind": cloudresourcekind.CloudResourceKind_OciSubnet.String(),
