...
OciStreamPool is an Planton component that deploys an OCI Streaming stream pool with bundled streams. It provides a single declarative manifest to create a Kafka-compatible event-streaming endpoint with configurable Kafka settings, encryption, private networking, and stream definitions.
