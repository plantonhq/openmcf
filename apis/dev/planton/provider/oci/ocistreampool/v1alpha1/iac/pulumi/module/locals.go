...
type Locals struct {
	OciStreamPool *ocistreampoolv1alpha1.OciStreamPool
	PoolName      string
	FreeformTags  map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocistreampoolv1alpha1.OciStreamPoolStackInput) *Locals {
	locals := &Locals{}
