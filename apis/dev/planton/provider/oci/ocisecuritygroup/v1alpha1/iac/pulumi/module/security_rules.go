...
import (
	...
	ocisecuritygroupv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocisecuritygroup/v1alpha1"
...
func protocolString(p ocisecuritygroupv1alpha1.OciSecurityGroupSpec_Protocol) string {
	switch p {
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_all:
		return "all"
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_icmp:
		return "1"
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_tcp:
		return "6"
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_udp:
		return "17"
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_icmpv6:
		return "58"
	default:
		return "all"
	}
...
func targetTypeString(t ocisecuritygroupv1alpha1.OciSecurityGroupSpec_TargetType) string {
	switch t {
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_cidr_block:
		return "CIDR_BLOCK"
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_service_cidr_block:
		return "SERVICE_CIDR_BLOCK"
	case ocisecuritygroupv1alpha1.OciSecurityGroupSpec_network_security_group:
...
func buildTcpOptions(opts *ocisecuritygroupv1alpha1.OciSecurityGroupSpec_TcpOptions) core.NetworkSecurityGroupSecurityRuleTcpOptionsPtrInput {
...
func buildUdpOptions(opts *ocisecuritygroupv1alpha1.OciSecurityGroupSpec_UdpOptions) core.NetworkSecurityGroupSecurityRuleUdpOptionsPtrInput {
...
func buildIcmpOptions(opts *ocisecuritygroupv1alpha1.OciSecurityGroupSpec_IcmpOptions) core.NetworkSecurityGroupSecurityRuleIcmpOptionsPtrInput {
