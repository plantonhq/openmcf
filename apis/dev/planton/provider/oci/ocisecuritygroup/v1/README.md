...
- **Automatic Tagging**: Standard Planton freeform tags are applied to the NSG (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
