...
func buildSpecification(deploy *ociapigatewayv1alpha1.OciApiGatewaySpec_Deployment) *apigateway.DeploymentSpecificationArgs {
...
func buildLoggingPolicies(lp *ociapigatewayv1alpha1.OciApiGatewaySpec_LoggingPolicies) *apigateway.DeploymentSpecificationLoggingPoliciesArgs {
...
func buildRequestPolicies(rp *ociapigatewayv1alpha1.OciApiGatewaySpec_RequestPolicies) *apigateway.DeploymentSpecificationRequestPoliciesArgs {
...
func buildAuthentication(auth *ociapigatewayv1alpha1.OciApiGatewaySpec_Authentication) *apigateway.DeploymentSpecificationRequestPoliciesAuthenticationArgs {
...
func buildPublicKeys(pk *ociapigatewayv1alpha1.OciApiGatewaySpec_PublicKeys) *apigateway.DeploymentSpecificationRequestPoliciesAuthenticationPublicKeysArgs {
...
func buildCors(cors *ociapigatewayv1alpha1.OciApiGatewaySpec_CorsPolicy) *apigateway.DeploymentSpecificationRequestPoliciesCorsArgs {
...
func buildRateLimiting(rl *ociapigatewayv1alpha1.OciApiGatewaySpec_RateLimiting) *apigateway.DeploymentSpecificationRequestPoliciesRateLimitingArgs {
...
func buildRoutes(routes []*ociapigatewayv1alpha1.OciApiGatewaySpec_Route) apigateway.DeploymentSpecificationRouteArray {
...
func buildBackend(b *ociapigatewayv1alpha1.OciApiGatewaySpec_Backend) *apigateway.DeploymentSpecificationRouteBackendArgs {
...
func buildRouteRequestPolicies(authz *ociapigatewayv1alpha1.OciApiGatewaySpec_RouteAuthorization) *apigateway.DeploymentSpecificationRouteRequestPoliciesArgs {
...
func buildRouteLoggingPolicies(lp *ociapigatewayv1alpha1.OciApiGatewaySpec_LoggingPolicies) *apigateway.DeploymentSpecificationRouteLoggingPoliciesArgs {
