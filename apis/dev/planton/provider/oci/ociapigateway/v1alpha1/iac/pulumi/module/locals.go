...
type Locals struct {
	OciApiGateway *ociapigatewayv1alpha1.OciApiGateway
	DisplayName   string
	FreeformTags  map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ociapigatewayv1alpha1.OciApiGatewayStackInput) *Locals {
	locals := &Locals{}
