...
import (
	...
	ocicontainerenginenodepoolv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocicontainerenginenodepool/v1alpha1"
...
func buildNodeShapeConfig(nsc *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_NodeShapeConfig) *containerengine.NodePoolNodeShapeConfigArgs {
...
func buildNodeSourceDetails(nsd *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_NodeSourceDetails) *containerengine.NodePoolNodeSourceDetailsArgs {
...
func buildNodeConfigDetails(ncd *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_NodeConfigDetails, freeformTags map[string]string) *containerengine.NodePoolNodeConfigDetailsArgs {
...
func buildPlacementConfig(pc *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_PlacementConfig) *containerengine.NodePoolNodeConfigDetailsPlacementConfigArgs {
...
func buildPreemptibleNodeConfig(pnc *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_PreemptibleNodeConfig) *containerengine.NodePoolNodeConfigDetailsPlacementConfigPreemptibleNodeConfigArgs {
...
func buildPodNetworkOptionDetails(pnod *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_PodNetworkOptionDetails) *containerengine.NodePoolNodeConfigDetailsNodePoolPodNetworkOptionDetailsArgs {
...
func buildInitialNodeLabels(labels []*ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_NodeLabel) containerengine.NodePoolInitialNodeLabelArray {
...
func buildNodeEvictionSettings(nes *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_NodeEvictionSettings) *containerengine.NodePoolNodeEvictionNodePoolSettingsArgs {
...
func buildNodePoolCyclingDetails(npcd *ocicontainerenginenodepoolv1alpha1.OciContainerEngineNodePoolSpec_NodePoolCyclingDetails) *containerengine.NodePoolNodePoolCyclingDetailsArgs {
