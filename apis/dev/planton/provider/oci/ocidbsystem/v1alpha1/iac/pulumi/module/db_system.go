...
import (
	...
	ocidbsystemv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocidbsystem/v1alpha1"
...
func dbSystem(ctx *pulumi.Context, locals *Locals, provider *oci.Provider) error {
	...
	if spec.DatabaseEdition != ocidbsystemv1alpha1.OciDbSystemSpec_database_edition_unspecified {
		args.DatabaseEdition = pulumi.StringPtr(strings.ToUpper(spec.DatabaseEdition.String()))
	}

	if spec.LicenseModel != ocidbsystemv1alpha1.OciDbSystemSpec_license_model_unspecified {
	...
	if spec.DiskRedundancy != ocidbsystemv1alpha1.OciDbSystemSpec_disk_redundancy_unspecified {
	...
	if spec.StorageVolumePerformanceMode != ocidbsystemv1alpha1.OciDbSystemSpec_storage_volume_performance_mode_unspecified {
...
func buildDbHome(dbHome *ocidbsystemv1alpha1.OciDbSystemSpec_DbHome) database.DbSystemDbHomeArgs {
...
func buildDatabase(db *ocidbsystemv1alpha1.OciDbSystemSpec_Database) database.DbSystemDbHomeDatabaseArgs {
...
func buildDbBackupConfig(cfg *ocidbsystemv1alpha1.OciDbSystemSpec_DbBackupConfig) database.DbSystemDbHomeDatabaseDbBackupConfigPtrInput {
...
func buildDataCollectionOptions(opts *ocidbsystemv1alpha1.OciDbSystemSpec_DataCollectionOptions) database.DbSystemDataCollectionOptionsPtrInput {
...
func buildDbSystemOptions(opts *ocidbsystemv1alpha1.OciDbSystemSpec_DbSystemOptions) database.DbSystemDbSystemOptionsPtrInput {
	args := &database.DbSystemDbSystemOptionsArgs{}

	if opts.StorageManagement != ocidbsystemv1alpha1.OciDbSystemSpec_storage_management_unspecified {
...
func buildMaintenanceWindowDetails(mw *ocidbsystemv1alpha1.OciDbSystemSpec_MaintenanceWindowDetails) database.DbSystemMaintenanceWindowDetailsPtrInput {
	args := &database.DbSystemMaintenanceWindowDetailsArgs{}

	if mw.Preference != ocidbsystemv1alpha1.OciDbSystemSpec_preference_unspecified {
		args.Preference = pulumi.StringPtr(strings.ToUpper(mw.Preference.String()))
	}

	if mw.PatchingMode != ocidbsystemv1alpha1.OciDbSystemSpec_patching_mode_unspecified {
