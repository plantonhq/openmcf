...
func Resources(ctx *pulumi.Context, stackInput *ocidbsystemv1alpha1.OciDbSystemStackInput) error {
	...
	if err := dbSystem(ctx, locals, ociProvider); err != nil {
		return errors.Wrap(err, "failed to create db system")
	}
