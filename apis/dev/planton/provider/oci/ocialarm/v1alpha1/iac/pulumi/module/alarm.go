...
import (
	...
	ocialarmv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocialarm/v1alpha1"
...
func alarmResource(ctx *pulumi.Context, locals *Locals, provider *oci.Provider) error {
	...
	if spec.MessageFormat != ocialarmv1alpha1.OciAlarmSpec_raw {
...
func buildOverrides(overrides []*ocialarmv1alpha1.OciAlarmSpec_AlarmOverride) monitoring.AlarmOverrideArray {
	...
	for _, o := range overrides {
		...
		if o.Severity != ocialarmv1alpha1.OciAlarmSpec_unspecified {
