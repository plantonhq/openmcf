...
var distributionTypeMap = map[ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_DrgRouteDistribution_DistributionType]string{
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_DrgRouteDistribution_import_routes: "IMPORT",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_DrgRouteDistribution_export_routes: "EXPORT",
}

var matchTypeMap = map[ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_MatchCriteria_MatchType]string{
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_MatchCriteria_match_all:           "MATCH_ALL",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_MatchCriteria_drg_attachment_type: "DRG_ATTACHMENT_TYPE",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_MatchCriteria_drg_attachment_id:   "DRG_ATTACHMENT_ID",
}
...
func createStatement(
	...
	distName string,
	stmtSpec *ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_DistributionStatement,
	attachmentIdMap map[string]pulumi.IDOutput,
) error {
