...
type Locals struct {
	OciDynamicRoutingGateway *ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGateway
	DisplayName              string
	FreeformTags             map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewayStackInput) *Locals {
	locals := &Locals{}
