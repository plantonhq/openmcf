...
import (
	...
	ocidynamicroutinggatewayv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocidynamicroutinggateway/v1alpha1"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci/core"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

var networkTypeMap = map[ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_NetworkType]string{
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_vcn:                       "VCN",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_ipsec_tunnel:              "IPSEC_TUNNEL",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_remote_peering_connection: "REMOTE_PEERING_CONNECTION",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_virtual_circuit:           "VIRTUAL_CIRCUIT",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_loopback:                  "LOOPBACK",
}

var vcnRouteTypeMap = map[ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_VcnRouteType]string{
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_vcn_cidrs:    "VCN_CIDRS",
	ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_subnet_cidrs: "SUBNET_CIDRS",
}
...
func createAttachments(
	...
	for _, attSpec := range spec.Attachments {
		...
		if nd.VcnRouteType != ocidynamicroutinggatewayv1alpha1.OciDynamicRoutingGatewaySpec_NetworkDetails_vcn_route_type_unspecified {
