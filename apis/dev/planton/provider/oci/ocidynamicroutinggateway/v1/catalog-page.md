...
- [OciVcn](/docs/catalog/oci/ocivcn) — provides VCN OCIDs for VCN attachments via `valueFrom`
- [OciSubnet](/docs/catalog/oci/ocisubnet) — subnets within attached VCNs route traffic through the DRG for cross-VCN and on-premises connectivity
