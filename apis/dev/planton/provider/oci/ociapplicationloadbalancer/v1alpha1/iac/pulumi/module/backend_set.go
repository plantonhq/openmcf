...
func createBackendSet(ctx *pulumi.Context, locals *Locals, provider *oci.Provider, lb *loadbalancer.LoadBalancer, bsSpec *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_BackendSet) (*loadbalancer.BackendSet, error) {
	policyMap := map[ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_BackendSet_Policy]string{
		ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_BackendSet_round_robin:       "ROUND_ROBIN",
		ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_BackendSet_least_connections: "LEAST_CONNECTIONS",
		ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_BackendSet_ip_hash:           "IP_HASH",
	}
...
func createBackend(ctx *pulumi.Context, provider *oci.Provider, lb *loadbalancer.LoadBalancer, bs *loadbalancer.BackendSet, bsName string, beSpec *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_Backend) error {
...
func buildHealthChecker(hc *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_HealthChecker) loadbalancer.BackendSetHealthCheckerArgs {
	protocolMap := map[ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_HealthChecker_Protocol]string{
		ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_HealthChecker_http: "HTTP",
		ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_HealthChecker_tcp:  "TCP",
	}
...
func buildBackendSetSslConfiguration(ssl *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_SslConfiguration) *loadbalancer.BackendSetSslConfigurationArgs {
...
func buildLbCookieSessionPersistence(cfg *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_LbCookieSessionPersistenceConfig) *loadbalancer.BackendSetLbCookieSessionPersistenceConfigurationArgs {
...
func buildSessionPersistence(cfg *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_SessionPersistenceConfig) *loadbalancer.BackendSetSessionPersistenceConfigurationArgs {
