...
type Locals struct {
	OciApplicationLoadBalancer *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancer
	DisplayName                string
	FreeformTags               map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerStackInput) *Locals {
	locals := &Locals{}
