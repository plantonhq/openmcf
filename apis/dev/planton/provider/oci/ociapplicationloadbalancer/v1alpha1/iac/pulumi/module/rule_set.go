...
import (
	...
	ociapplicationloadbalancerv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ociapplicationloadbalancer/v1alpha1"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci"
	"github.com/pulumi/pulumi-oci/sdk/v4/go/oci/loadbalancer"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

var actionMap = map[ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_Action]string{
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_add_http_request_header:           "ADD_HTTP_REQUEST_HEADER",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_add_http_response_header:          "ADD_HTTP_RESPONSE_HEADER",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_extend_http_request_header_value:  "EXTEND_HTTP_REQUEST_HEADER_VALUE",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_extend_http_response_header_value: "EXTEND_HTTP_RESPONSE_HEADER_VALUE",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_remove_http_request_header:        "REMOVE_HTTP_REQUEST_HEADER",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_remove_http_response_header:       "REMOVE_HTTP_RESPONSE_HEADER",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_redirect:                          "REDIRECT",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_allow:                             "ALLOW",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_control_access_using_http_methods: "CONTROL_ACCESS_USING_HTTP_METHODS",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_http_header:                       "HTTP_HEADER",
	ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem_ip_based_max_connections:          "IP_BASED_MAX_CONNECTIONS",
}
...
func buildRuleSetItems(items []*ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem) loadbalancer.RuleSetItemArray {
...
func buildRuleSetItem(item *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItem) *loadbalancer.RuleSetItemArgs {
...
func buildRedirectUri(ru *ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RedirectUri) *loadbalancer.RuleSetItemRedirectUriArgs {
...
func buildConditions(conditions []*ociapplicationloadbalancerv1alpha1.OciApplicationLoadBalancerSpec_RuleSetItemCondition) loadbalancer.RuleSetItemConditionArray {
