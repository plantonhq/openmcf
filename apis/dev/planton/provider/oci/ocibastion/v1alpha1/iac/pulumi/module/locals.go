...
import (
	ocibastionv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocibastion/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	OciBastion   *ocibastionv1alpha1.OciBastion
	DisplayName  string
	FreeformTags map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocibastionv1alpha1.OciBastionStackInput) *Locals {
	locals := &Locals{}
	locals.OciBastion = stackInput.Target
	...
	locals.FreeformTags = map[string]string{
		"resource":      "true",
		"resource_kind": cloudresourcekind.CloudResourceKind_OciBastion.String(),
