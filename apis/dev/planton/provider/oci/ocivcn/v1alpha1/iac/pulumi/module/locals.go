...
import (
	ocivcnv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocivcn/v1alpha1"
	"github.com/plantonhq/planton/apis/dev/planton/shared/cloudresourcekind"
	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
)

type Locals struct {
	OciVcn       *ocivcnv1alpha1.OciVcn
	DisplayName  string
	FreeformTags map[string]string
}

func initializeLocals(_ *pulumi.Context, stackInput *ocivcnv1alpha1.OciVcnStackInput) *Locals {
	locals := &Locals{}
