...
- [OciVcn](/docs/catalog/oci/ocivcn) — provides the VCN containing the subnet where the DB System is placed
...
- [OciSecurityGroup](/docs/catalog/oci/ocisecuritygroup) — manages network security rules attached via `nsgIds`
