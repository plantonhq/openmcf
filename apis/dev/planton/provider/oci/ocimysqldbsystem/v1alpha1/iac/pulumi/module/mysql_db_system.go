...
import (
	...
	ocimysqldbsystemv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/oci/ocimysqldbsystem/v1alpha1"
...
func buildDataStorage(ds *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_DataStorage) mysql.MysqlDbSystemDataStoragePtrInput {
...
func buildBackupPolicy(bp *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_BackupPolicy) mysql.MysqlDbSystemBackupPolicyPtrInput {
...
func buildMaintenance(m *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_Maintenance) mysql.MysqlDbSystemMaintenancePtrInput {
	maint := &mysql.MysqlDbSystemMaintenanceArgs{
		WindowStartTime: pulumi.String(m.WindowStartTime),
	}

	if m.MaintenanceScheduleType != ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_maintenance_schedule_type_unspecified {
		maint.MaintenanceScheduleType = pulumi.StringPtr(strings.ToUpper(m.MaintenanceScheduleType.String()))
	}

	if m.VersionPreference != ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_version_preference_unspecified {
		maint.VersionPreference = pulumi.StringPtr(strings.ToUpper(m.VersionPreference.String()))
	}

	if m.VersionTrackPreference != ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_version_track_preference_unspecified {
...
func buildDeletionPolicy(dp *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_DeletionPolicy) mysql.MysqlDbSystemDeletionPolicyArrayInput {
...
func buildEncryptData(ed *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_EncryptData) mysql.MysqlDbSystemEncryptDataPtrInput {
	encrypt := &mysql.MysqlDbSystemEncryptDataArgs{}

	if ed.KeyGenerationType != ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_key_generation_type_unspecified {
...
func buildSecureConnections(sc *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_SecureConnections) mysql.MysqlDbSystemSecureConnectionsPtrInput {
	secure := &mysql.MysqlDbSystemSecureConnectionsArgs{}

	if sc.CertificateGenerationType != ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_certificate_generation_type_unspecified {
...
func buildReadEndpoint(re *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_ReadEndpoint) mysql.MysqlDbSystemReadEndpointPtrInput {
...
func buildDatabaseConsole(dc *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_DatabaseConsole) mysql.MysqlDbSystemDatabaseConsolePtrInput {
	console := &mysql.MysqlDbSystemDatabaseConsoleArgs{}

	if dc.Status != ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_database_console_status_unspecified {
...
func buildRest(r *ocimysqldbsystemv1alpha1.OciMysqlDbSystemSpec_Rest) mysql.MysqlDbSystemRestPtrInput {
