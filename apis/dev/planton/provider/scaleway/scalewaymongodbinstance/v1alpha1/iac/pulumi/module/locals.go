...
type Locals struct {
	...
	ScalewayMongodbInstance *scalewaymongodbinstancev1alpha1.ScalewayMongodbInstance
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewaymongodbinstancev1alpha1.ScalewayMongodbInstanceStackInput) *Locals {
	locals := &Locals{}
