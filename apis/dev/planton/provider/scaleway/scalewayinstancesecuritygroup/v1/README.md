...
This Planton resource kind wraps the Scaleway `scaleway_instance_security_group` Terraform resource (or the Pulumi `instance.SecurityGroup` resource) into a declarative, Kubernetes-style manifest.
...
- Standard Planton tags auto-applied for resource tracking
