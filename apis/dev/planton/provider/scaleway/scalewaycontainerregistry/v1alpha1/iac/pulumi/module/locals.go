...
type Locals struct {
	...
	ScalewayContainerRegistry *scalewaycontainerregistryv1alpha1.ScalewayContainerRegistry
}
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewaycontainerregistryv1alpha1.ScalewayContainerRegistryStackInput) *Locals {
	return &Locals{
