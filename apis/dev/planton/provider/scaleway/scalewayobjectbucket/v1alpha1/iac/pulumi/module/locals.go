...
import (
	...
	scalewayobjectbucketv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayobjectbucket/v1alpha1"
...
type Locals struct {
	...
	ScalewayObjectBucket   *scalewayobjectbucketv1alpha1.ScalewayObjectBucket
...
// tags natively.
func initializeLocals(_ *pulumi.Context, stackInput *scalewayobjectbucketv1alpha1.ScalewayObjectBucketStackInput) *Locals {
	locals := &Locals{}
