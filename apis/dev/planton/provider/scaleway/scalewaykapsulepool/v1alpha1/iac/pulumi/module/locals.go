...
import (
	...
	scalewaykapsulepoolv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewaykapsulepool/v1alpha1"
...
type Locals struct {
	...
	ScalewayKapsulePool    *scalewaykapsulepoolv1alpha1.ScalewayKapsulePool
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewaykapsulepoolv1alpha1.ScalewayKapsulePoolStackInput) *Locals {
	locals := &Locals{}
