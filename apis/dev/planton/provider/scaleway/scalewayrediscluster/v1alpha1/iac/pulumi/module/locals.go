...
import (
	...
	scalewayredisclusterv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayrediscluster/v1alpha1"
...
type Locals struct {
	...
	ScalewayRedisCluster   *scalewayredisclusterv1alpha1.ScalewayRedisCluster
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewayredisclusterv1alpha1.ScalewayRedisClusterStackInput) *Locals {
	locals := &Locals{}
