...
// 	protoc        (unknown)
// source: dev/planton/provider/scaleway/scalewayrediscluster/v1/spec.proto
...
func (x *ScalewayRedisClusterSpec) Reset() {
	*x = ScalewayRedisClusterSpec{}
	mi := &file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_msgTypes[0]
...
func (*ScalewayRedisClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ScalewayRedisAclRule) Reset() {
	*x = ScalewayRedisAclRule{}
	mi := &file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayRedisAclRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"@dev/planton/provider/scaleway/scalewayrediscluster/v1/spec.proto\x125dev.planton.provider.scaleway.scalewayrediscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xdc\a\n" +
	...
	"9com.dev.planton.provider.scaleway.scalewayrediscluster.v1B\tSpecProtoP\x01Zngithub.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayrediscluster/v1;scalewayredisclusterv1\xa2\x02\x05DPPSS\xaa\x025Dev.Planton.Provider.Scaleway.Scalewayrediscluster.V1\xca\x025Dev\\Planton\\Provider\\Scaleway\\Scalewayrediscluster\\V1\xe2\x02ADev\\Planton\\Provider\\Scaleway\\Scalewayrediscluster\\V1\\GPBMetadata\xea\x02:Dev::Planton::Provider::Scaleway::Scalewayrediscluster::V1b\x06proto3"

var (
	file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_goTypes = []any{
	(*ScalewayRedisClusterSpec)(nil), // 0: dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisClusterSpec
	(*ScalewayRedisAclRule)(nil),     // 1: dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisAclRule
	nil,                              // 2: dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisClusterSpec.SettingsEntry
	(*v1.StringValueOrRef)(nil),      // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisClusterSpec.acl_rules:type_name -> dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisAclRule
	3, // 1: dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisClusterSpec.private_network_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisClusterSpec.settings:type_name -> dev.planton.provider.scaleway.scalewayrediscluster.v1.ScalewayRedisClusterSpec.SettingsEntry
...
func init() { file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_init() }
func file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_init() {
	if File_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto = out.File
	file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_scaleway_scalewayrediscluster_v1_spec_proto_depIdxs = nil
}
