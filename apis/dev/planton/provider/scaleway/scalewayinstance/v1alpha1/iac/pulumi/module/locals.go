...
type Locals struct {
	...
	ScalewayInstance       *scalewayinstancev1alpha1.ScalewayInstance
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewayinstancev1alpha1.ScalewayInstanceStackInput) *Locals {
	locals := &Locals{}
