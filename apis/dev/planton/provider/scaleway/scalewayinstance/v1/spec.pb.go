...
// 	protoc        (unknown)
// source: dev/planton/provider/scaleway/scalewayinstance/v1/spec.proto
...
func (x *ScalewayInstanceSpec) Reset() {
	*x = ScalewayInstanceSpec{}
	mi := &file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_msgTypes[0]
...
func (*ScalewayInstanceSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ScalewayInstancePublicIp) Reset() {
	*x = ScalewayInstancePublicIp{}
	mi := &file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayInstancePublicIp) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ScalewayInstanceRootVolume) Reset() {
	*x = ScalewayInstanceRootVolume{}
	mi := &file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayInstanceRootVolume) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ScalewayInstanceAdditionalVolume) Reset() {
	*x = ScalewayInstanceAdditionalVolume{}
	mi := &file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayInstanceAdditionalVolume) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<dev/planton/provider/scaleway/scalewayinstance/v1/spec.proto\x121dev.planton.provider.scaleway.scalewayinstance.v1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xc6\x06\n" +
	...
	"5com.dev.planton.provider.scaleway.scalewayinstance.v1B\tSpecProtoP\x01Zfgithub.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayinstance/v1;scalewayinstancev1\xa2\x02\x05DPPSS\xaa\x021Dev.Planton.Provider.Scaleway.Scalewayinstance.V1\xca\x021Dev\\Planton\\Provider\\Scaleway\\Scalewayinstance\\V1\xe2\x02=Dev\\Planton\\Provider\\Scaleway\\Scalewayinstance\\V1\\GPBMetadata\xea\x026Dev::Planton::Provider::Scaleway::Scalewayinstance::V1b\x06proto3"

var (
	file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_goTypes = []any{
	(*ScalewayInstanceSpec)(nil),             // 0: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceSpec
	(*ScalewayInstancePublicIp)(nil),         // 1: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstancePublicIp
	(*ScalewayInstanceRootVolume)(nil),       // 2: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceRootVolume
	(*ScalewayInstanceAdditionalVolume)(nil), // 3: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceAdditionalVolume
	(*v1.StringValueOrRef)(nil),              // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceSpec.public_ip:type_name -> dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstancePublicIp
	4, // 1: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceSpec.security_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 2: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceSpec.private_network_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceSpec.root_volume:type_name -> dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceRootVolume
	3, // 4: dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceSpec.additional_volumes:type_name -> dev.planton.provider.scaleway.scalewayinstance.v1.ScalewayInstanceAdditionalVolume
...
func init() { file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_init() }
func file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_init() {
	if File_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDesc), len(file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto = out.File
	file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_scaleway_scalewayinstance_v1_spec_proto_depIdxs = nil
}
