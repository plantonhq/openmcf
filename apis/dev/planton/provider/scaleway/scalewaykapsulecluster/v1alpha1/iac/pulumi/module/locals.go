...
import (
	...
	scalewaykapsuleclusterv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewaykapsulecluster/v1alpha1"
...
type Locals struct {
	...
	ScalewayKapsuleCluster *scalewaykapsuleclusterv1alpha1.ScalewayKapsuleCluster
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewaykapsuleclusterv1alpha1.ScalewayKapsuleClusterStackInput) *Locals {
	locals := &Locals{}
