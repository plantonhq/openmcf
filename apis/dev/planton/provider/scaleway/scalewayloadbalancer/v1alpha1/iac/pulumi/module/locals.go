...
import (
	...
	scalewayloadbalancerv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayloadbalancer/v1alpha1"
...
type Locals struct {
	...
	ScalewayLoadBalancer   *scalewayloadbalancerv1alpha1.ScalewayLoadBalancer
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewayloadbalancerv1alpha1.ScalewayLoadBalancerStackInput) *Locals {
	locals := &Locals{}
