...
import (
	...
	scalewayprivatenetworkv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayprivatenetwork/v1alpha1"
...
type Locals struct {
	...
	ScalewayPrivateNetwork *scalewayprivatenetworkv1alpha1.ScalewayPrivateNetwork
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewayprivatenetworkv1alpha1.ScalewayPrivateNetworkStackInput) *Locals {
	locals := &Locals{}
