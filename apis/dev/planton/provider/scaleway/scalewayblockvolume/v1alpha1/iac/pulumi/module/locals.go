...
type Locals struct {
	...
	ScalewayBlockVolume    *scalewayblockvolumev1alpha1.ScalewayBlockVolume
	ScalewayTags           []string
}
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewayblockvolumev1alpha1.ScalewayBlockVolumeStackInput) *Locals {
	locals := &Locals{}
