...
import (
	...
	scalewayrdbinstancev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayrdbinstance/v1alpha1"
...
type Locals struct {
	...
	ScalewayRdbInstance    *scalewayrdbinstancev1alpha1.ScalewayRdbInstance
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewayrdbinstancev1alpha1.ScalewayRdbInstanceStackInput) *Locals {
	locals := &Locals{}
