...
// 	protoc        (unknown)
// source: dev/planton/provider/scaleway/scalewaydnszone/v1alpha1/spec.proto
...
func (ScalewayDnsZoneRecord_RecordType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (ScalewayDnsZoneRecord_RecordType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes[0]
}
...
func (ScalewayDnsZoneRecord_RecordType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *ScalewayDnsZoneSpec) Reset() {
	*x = ScalewayDnsZoneSpec{}
	mi := &file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes[0]
...
func (*ScalewayDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type ScalewayDnsZoneRecord struct {
	...
	Type ScalewayDnsZoneRecord_RecordType `protobuf:"varint,2,opt,name=type,proto3,enum=dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord_RecordType" json:"type,omitempty"`
	// Record data/value.
	//
...
func (x *ScalewayDnsZoneRecord) Reset() {
	*x = ScalewayDnsZoneRecord{}
	mi := &file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayDnsZoneRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Adev/planton/provider/scaleway/scalewaydnszone/v1alpha1/spec.proto\x126dev.planton.provider.scaleway.scalewaydnszone.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xbc\x01\n" +
	"\x13ScalewayDnsZoneSpec\x12\x1e\n" +
	"\x06domain\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x06domain\x12\x1c\n" +
	"\tsubdomain\x18\x02 \x01(\tR\tsubdomain\x12g\n" +
	"\arecords\x18\x03 \x03(\v2M.dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecordR\arecords\"\xce\x03\n" +
	"\x15ScalewayDnsZoneRecord\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12t\n" +
	"\x04type\x18\x02 \x01(\x0e2X.dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.RecordTypeB\x06\xbaH\x03\xc8\x01\x01R\x04type\x12N\n" +
	...
	"\x03SRV\x10\v\x12\a\n" +
	"\x03TXT\x10\f\x12\b\n" +
	"\x04TLSA\x10\rB\xb8\x03\n" +
	":com.dev.planton.provider.scaleway.scalewaydnszone.v1alpha1B\tSpecProtoP\x01Zpgithub.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewaydnszone/v1alpha1;scalewaydnszonev1alpha1\xa2\x02\x05DPPSS\xaa\x026Dev.Planton.Provider.Scaleway.Scalewaydnszone.V1alpha1\xca\x026Dev\\Planton\\Provider\\Scaleway\\Scalewaydnszone\\V1alpha1\xe2\x02BDev\\Planton\\Provider\\Scaleway\\Scalewaydnszone\\V1alpha1\\GPBMetadata\xea\x02;Dev::Planton::Provider::Scaleway::Scalewaydnszone::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_goTypes = []any{
	(ScalewayDnsZoneRecord_RecordType)(0), // 0: dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.RecordType
	(*ScalewayDnsZoneSpec)(nil),           // 1: dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneSpec
	(*ScalewayDnsZoneRecord)(nil),         // 2: dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord
	(*v1.StringValueOrRef)(nil),           // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneSpec.records:type_name -> dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord
	0, // 1: dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.type:type_name -> dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.RecordType
	3, // 2: dev.planton.provider.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.data:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_scaleway_scalewaydnszone_v1alpha1_spec_proto_depIdxs = nil
}
