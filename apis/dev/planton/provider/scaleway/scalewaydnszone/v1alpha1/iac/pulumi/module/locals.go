...
import (
	...
	scalewaydnszonev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewaydnszone/v1alpha1"
...
type Locals struct {
	...
	ScalewayDnsZone        *scalewaydnszonev1alpha1.ScalewayDnsZone
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewaydnszonev1alpha1.ScalewayDnsZoneStackInput) *Locals {
