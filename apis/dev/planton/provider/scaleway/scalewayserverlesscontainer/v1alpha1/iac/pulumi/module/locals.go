...
import (
	...
	scalewayserverlesscontainerv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewayserverlesscontainer/v1alpha1"
...
type Locals struct {
	...
	ScalewayServerlessContainer *scalewayserverlesscontainerv1alpha1.ScalewayServerlessContainer
	ScalewayTags                []string
}

// initializeLocals copies stack-input fields into the Locals struct
// and builds the standard tag slice for Scaleway resources.
func initializeLocals(_ *pulumi.Context, stackInput *scalewayserverlesscontainerv1alpha1.ScalewayServerlessContainerStackInput) *Locals {
	locals := &Locals{}
