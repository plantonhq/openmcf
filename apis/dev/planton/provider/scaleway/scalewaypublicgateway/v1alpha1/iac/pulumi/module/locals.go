...
import (
	...
	scalewaypublicgatewayv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewaypublicgateway/v1alpha1"
...
type Locals struct {
	...
	ScalewayPublicGateway  *scalewaypublicgatewayv1alpha1.ScalewayPublicGateway
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewaypublicgatewayv1alpha1.ScalewayPublicGatewayStackInput) *Locals {
	locals := &Locals{}
