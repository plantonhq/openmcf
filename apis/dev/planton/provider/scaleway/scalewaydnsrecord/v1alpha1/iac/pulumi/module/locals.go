...
import (
	...
	scalewaydnsrecordv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/scaleway/scalewaydnsrecord/v1alpha1"
...
type Locals struct {
	...
	ScalewayDnsRecord      *scalewaydnsrecordv1alpha1.ScalewayDnsRecord
}
...
func initializeLocals(_ *pulumi.Context, stackInput *scalewaydnsrecordv1alpha1.ScalewayDnsRecordStackInput) *Locals {
	return &Locals{
