...
// 	protoc        (unknown)
// source: dev/planton/provider/digitalocean/digitaloceanloadbalancer/v1/spec.proto
...
func (DigitalOceanLoadBalancerProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanLoadBalancerProtocol) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanLoadBalancerProtocol) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanLoadBalancerSpec) Reset() {
	*x = DigitalOceanLoadBalancerSpec{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes[0]
...
type DigitalOceanLoadBalancerForwardingRule struct {
	...
	EntryProtocol DigitalOceanLoadBalancerProtocol `protobuf:"varint,2,opt,name=entry_protocol,json=entryProtocol,proto3,enum=dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol" json:"entry_protocol,omitempty"`
	...
	TargetProtocol DigitalOceanLoadBalancerProtocol `protobuf:"varint,4,opt,name=target_protocol,json=targetProtocol,proto3,enum=dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol" json:"target_protocol,omitempty"`
...
func (x *DigitalOceanLoadBalancerForwardingRule) Reset() {
	*x = DigitalOceanLoadBalancerForwardingRule{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanLoadBalancerForwardingRule) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type DigitalOceanLoadBalancerHealthCheck struct {
	...
	Protocol DigitalOceanLoadBalancerProtocol `protobuf:"varint,2,opt,name=protocol,proto3,enum=dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol" json:"protocol,omitempty"`
...
func (x *DigitalOceanLoadBalancerHealthCheck) Reset() {
	*x = DigitalOceanLoadBalancerHealthCheck{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanLoadBalancerHealthCheck) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Hdev/planton/provider/digitalocean/digitaloceanloadbalancer/v1/spec.proto\x12=dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1\x1a\x1bbuf/validate/validate.proto\x1a.dev/planton/provider/digitalocean/region.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xb2\x06\n" +
	...
	"\x0eentry_protocol\x18\x02 \x01(\x0e2_.dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocolB\x06\xbaH\x03\xc8\x01\x01R\rentryProtocol\x12/\n" +
	"\vtarget_port\x18\x03 \x01(\rB\x0e\xbaH\v\xc8\x01\x01*\x06\x18\xff\xff\x03(\x01R\n" +
	"targetPort\x12\x90\x01\n" +
	"\x0ftarget_protocol\x18\x04 \x01(\x0e2_.dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocolB\x06\xbaH\x03\xc8\x01\x01R\x0etargetProtocol\x128\n" +
	...
	"\bprotocol\x18\x02 \x01(\x0e2_.dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocolB\x06\xbaH\x03\xc8\x01\x01R\bprotocol\x12\x12\n" +
	...
	"Acom.dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1B\tSpecProtoP\x01Zzgithub.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceanloadbalancer/v1;digitaloceanloadbalancerv1\xa2\x02\x05DPPDD\xaa\x02=Dev.Planton.Provider.Digitalocean.Digitaloceanloadbalancer.V1\xca\x02=Dev\\Planton\\Provider\\Digitalocean\\Digitaloceanloadbalancer\\V1\xe2\x02IDev\\Planton\\Provider\\Digitalocean\\Digitaloceanloadbalancer\\V1\\GPBMetadata\xea\x02BDev::Planton::Provider::Digitalocean::Digitaloceanloadbalancer::V1b\x06proto3"

var (
	file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_goTypes = []any{
	(DigitalOceanLoadBalancerProtocol)(0),          // 0: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
	(*DigitalOceanLoadBalancerSpec)(nil),           // 1: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec
	(*DigitalOceanLoadBalancerForwardingRule)(nil), // 2: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule
	(*DigitalOceanLoadBalancerHealthCheck)(nil),    // 3: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerHealthCheck
...
var file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.region:type_name -> dev.planton.provider.digitalocean.DigitalOceanRegion
	5, // 1: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.vpc:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.forwarding_rules:type_name -> dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule
	3, // 3: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.health_check:type_name -> dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerHealthCheck
	5, // 4: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.droplet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 5: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule.entry_protocol:type_name -> dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
	0, // 6: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule.target_protocol:type_name -> dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
	0, // 7: dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerHealthCheck.protocol:type_name -> dev.planton.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
...
func init() { file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_init() }
func file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_init() {
	if File_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto = out.File
	file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_depIdxs = nil
}
