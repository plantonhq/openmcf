...
// 	protoc        (unknown)
// source: dev/planton/provider/digitalocean/digitaloceanappplatformservice/v1alpha1/spec.proto
...
func (DigitalOceanAppPlatformServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanAppPlatformServiceType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanAppPlatformServiceType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (DigitalOceanAppPlatformInstanceSize) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (DigitalOceanAppPlatformInstanceSize) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[1]
}
...
func (DigitalOceanAppPlatformInstanceSize) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
type DigitalOceanAppPlatformServiceSpec struct {
	...
	Region digitalocean.DigitalOceanRegion `protobuf:"varint,2,opt,name=region,proto3,enum=dev.planton.provider.digitalocean.DigitalOceanRegion" json:"region,omitempty"`
	// type of service being deployed (e.g., a web service that receives HTTP traffic, a background worker, or a one-off job).
	ServiceType DigitalOceanAppPlatformServiceType `protobuf:"varint,3,opt,name=service_type,json=serviceType,proto3,enum=dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceType" json:"service_type,omitempty"`
	...
	InstanceSizeSlug DigitalOceanAppPlatformInstanceSize `protobuf:"varint,6,opt,name=instance_size_slug,json=instanceSizeSlug,proto3,enum=dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSize" json:"instance_size_slug,omitempty"`
...
func (x *DigitalOceanAppPlatformServiceSpec) Reset() {
	*x = DigitalOceanAppPlatformServiceSpec{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[0]
...
func (x *DigitalOceanAppPlatformGitSource) Reset() {
	*x = DigitalOceanAppPlatformGitSource{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DigitalOceanAppPlatformRegistrySource) Reset() {
	*x = DigitalOceanAppPlatformRegistrySource{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanAppPlatformRegistrySource) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Tdev/planton/provider/digitalocean/digitaloceanappplatformservice/v1alpha1/spec.proto\x12Idev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a.dev/planton/provider/digitalocean/region.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xbb\n" +
	"\n" +
	...
	"\x06region\x18\x02 \x01(\x0e25.dev.planton.provider.digitalocean.DigitalOceanRegionB\x06\xbaH\x03\xc8\x01\x01R\x06region\x12\x98\x01\n" +
	"\fservice_type\x18\x03 \x01(\x0e2m.dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceTypeB\x06\xbaH\x03\xc8\x01\x01R\vserviceType\x12\x8c\x01\n" +
	"\n" +
	"git_source\x18\x04 \x01(\v2k.dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformGitSourceH\x00R\tgitSource\x12\x95\x01\n" +
	"\fimage_source\x18\x05 \x01(\v2p.dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySourceH\x00R\vimageSource\x12\xb1\x01\n" +
	"\x12instance_size_slug\x18\x06 \x01(\x0e2n.dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSizeB\x13\xbaH\x03\xc8\x01\x01\x92\xa6\x1d\tbasic-xxsR\x10instanceSizeSlug\x12,\n" +
	...
	" \x01(\rR\x10maxInstanceCount\x12\x88\x01\n" +
	"\x03env\x18\v \x03(\v2v.dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.EnvEntryR\x03env\x12v\n" +
	...
	"B\xba\x04\n" +
	"Mcom.dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1B\tSpecProtoP\x01Z\x92\x01github.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceanappplatformservice/v1alpha1;digitaloceanappplatformservicev1alpha1\xa2\x02\x05DPPDD\xaa\x02IDev.Planton.Provider.Digitalocean.Digitaloceanappplatformservice.V1alpha1\xca\x02IDev\\Planton\\Provider\\Digitalocean\\Digitaloceanappplatformservice\\V1alpha1\xe2\x02UDev\\Planton\\Provider\\Digitalocean\\Digitaloceanappplatformservice\\V1alpha1\\GPBMetadata\xea\x02NDev::Planton::Provider::Digitalocean::Digitaloceanappplatformservice::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_goTypes = []any{
	(DigitalOceanAppPlatformServiceType)(0),       // 0: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceType
	(DigitalOceanAppPlatformInstanceSize)(0),      // 1: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSize
	(*DigitalOceanAppPlatformServiceSpec)(nil),    // 2: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec
	(*DigitalOceanAppPlatformGitSource)(nil),      // 3: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformGitSource
	(*DigitalOceanAppPlatformRegistrySource)(nil), // 4: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySource
	nil,                                  // 5: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.EnvEntry
	(digitalocean.DigitalOceanRegion)(0), // 6: dev.planton.provider.digitalocean.DigitalOceanRegion
	(*v1.StringValueOrRef)(nil),          // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.region:type_name -> dev.planton.provider.digitalocean.DigitalOceanRegion
	0, // 1: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.service_type:type_name -> dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceType
	3, // 2: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.git_source:type_name -> dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformGitSource
	4, // 3: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.image_source:type_name -> dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySource
	1, // 4: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.instance_size_slug:type_name -> dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSize
	5, // 5: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.env:type_name -> dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.EnvEntry
	7, // 6: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.custom_domain:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7, // 7: dev.planton.provider.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySource.registry:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() {
	file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_init()
}
func file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto != nil {
		return
	}
	file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_depIdxs = nil
}
