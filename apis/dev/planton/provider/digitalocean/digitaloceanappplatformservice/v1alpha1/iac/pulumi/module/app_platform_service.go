...
import (
	...
	digitaloceanappplatformservicev1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceanappplatformservice/v1alpha1"
...
func appPlatformService(
	...
	case digitaloceanappplatformservicev1alpha1.DigitalOceanAppPlatformServiceType_web_service:
	...
	case digitaloceanappplatformservicev1alpha1.DigitalOceanAppPlatformServiceType_worker:
		workerArgs := buildWorker(spec, instanceCount, instanceSizeSlug)
		appSpecArgs.Workers = digitalocean.AppSpecWorkerArray{workerArgs}

	case digitaloceanappplatformservicev1alpha1.DigitalOceanAppPlatformServiceType_job:
...
func buildWebService(
	spec *digitaloceanappplatformservicev1alpha1.DigitalOceanAppPlatformServiceSpec,
