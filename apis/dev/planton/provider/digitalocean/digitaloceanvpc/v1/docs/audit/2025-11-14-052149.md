...
**Component Path:** `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/`  
**Enum Value:** 1212  
**ID Prefix:** dovpc
...
- **File:** `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/examples.md`
...
- **File:** `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/iac/pulumi/README.md`
...
- **File:** `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/iac/pulumi/overview.md`
...
- **Files:**
  - `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/iac/tf/main.tf`
  - `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/iac/tf/provider.tf`
  - `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/iac/tf/locals.tf`
  - `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/iac/tf/outputs.tf`
...
- **File:** `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/iac/tf/README.md`
...
- Folder exists at correct path: `apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/`
...
```bash
cd apis/dev/planton/provider/digitalocean/digitaloceanvpc/v1/
go test -v
```
...
**Most Similar Complete Component:** AwsVpc or GcpVpcNetwork
...
- `apis/dev/planton/provider/aws/awsvpc/v1/`
- `apis/dev/planton/provider/gcp/gcpvpcnetwork/v1/`
