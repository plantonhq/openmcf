...
import (
	...
	digitaloceankubernetesnodepoolv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceankubernetesnodepool/v1alpha1"
...
func initializeLocals(_ *pulumi.Context, stackInput *digitaloceankubernetesnodepoolv1alpha1.DigitalOceanKubernetesNodePoolStackInput) *Locals {
	locals := &Locals{}
