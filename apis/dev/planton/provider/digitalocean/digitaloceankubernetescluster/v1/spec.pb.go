...
// 	protoc        (unknown)
// source: dev/planton/provider/digitalocean/digitaloceankubernetescluster/v1/spec.proto
...
func (x *DigitalOceanKubernetesClusterSpec) Reset() {
	*x = DigitalOceanKubernetesClusterSpec{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanKubernetesClusterSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanKubernetesClusterDefaultNodePool) Reset() {
	*x = DigitalOceanKubernetesClusterDefaultNodePool{}
	mi := &file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanKubernetesClusterDefaultNodePool) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Mdev/planton/provider/digitalocean/digitaloceankubernetescluster/v1/spec.proto\x12Bdev.planton.provider.digitalocean.digitaloceankubernetescluster.v1\x1a\x1bbuf/validate/validate.proto\x1a.dev/planton/provider/digitalocean/region.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\x1a(dev/planton/shared/options/options.proto\"\xbe\x06\n" +
	...
	"\x04tags\x18\v \x03(\tR\x04tags\x12\xa4\x01\n" +
	"\x11default_node_pool\x18\f \x01(\v2p.dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterDefaultNodePoolB\x06\xbaH\x03\xc8\x01\x01R\x0fdefaultNodePool\"\xce\x01\n" +
	...
	"\tmax_nodes\x18\x05 \x01(\rR\bmaxNodesB\x89\x04\n" +
	"Fcom.dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1B\tSpecProtoP\x01Z\x84\x01github.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceankubernetescluster/v1;digitaloceankubernetesclusterv1\xa2\x02\x05DPPDD\xaa\x02BDev.Planton.Provider.Digitalocean.Digitaloceankubernetescluster.V1\xca\x02BDev\\Planton\\Provider\\Digitalocean\\Digitaloceankubernetescluster\\V1\xe2\x02NDev\\Planton\\Provider\\Digitalocean\\Digitaloceankubernetescluster\\V1\\GPBMetadata\xea\x02GDev::Planton::Provider::Digitalocean::Digitaloceankubernetescluster::V1b\x06proto3"

var (
	file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData
}

var file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes = []any{
	(*DigitalOceanKubernetesClusterSpec)(nil),            // 0: dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec
	(*DigitalOceanKubernetesClusterDefaultNodePool)(nil), // 1: dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterDefaultNodePool
...
var file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec.region:type_name -> dev.planton.provider.digitalocean.DigitalOceanRegion
	3, // 1: dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec.vpc:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec.default_node_pool:type_name -> dev.planton.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterDefaultNodePool
...
func init() {
	file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_init()
}
func file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_init() {
	if File_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc), len(file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto = out.File
	file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes = nil
	file_dev_planton_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs = nil
}
