...
import (
	...
	digitaloceanbucketv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/digitalocean/digitaloceanbucket/v1alpha1"
...
func bucket(
	...
	if locals.DigitalOceanBucket.Spec.AccessControl == digitaloceanbucketv1alpha1.DigitalOceanBucketAccessControl_PUBLIC_READ {
