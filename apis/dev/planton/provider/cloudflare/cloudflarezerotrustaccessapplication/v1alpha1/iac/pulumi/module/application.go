...
import (
	...
	cloudflarezerotrustaccessapplicationv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccessapplication/v1alpha1"
...
func application(
	...
	appType := "self_hosted"
	if spec.Type != cloudflarezerotrustaccessapplicationv1alpha1.CloudflareZeroTrustAccessApplicationType_application_type_unspecified {
...
func buildSaasApp(s *cloudflarezerotrustaccessapplicationv1alpha1.CloudflareZeroTrustAccessSaasApp) *cloudflare.ZeroTrustAccessApplicationSaasAppArgs {
	sa := &cloudflare.ZeroTrustAccessApplicationSaasAppArgs{}
	if s.AuthType != cloudflarezerotrustaccessapplicationv1alpha1.CloudflareZeroTrustAccessSaasApp_auth_type_unspecified {
	...
	if s.NameIdFormat != cloudflarezerotrustaccessapplicationv1alpha1.CloudflareZeroTrustAccessSaasApp_name_id_format_unspecified {
	...
	if len(s.CustomClaims) > 0 {
		...
		for _, c := range s.CustomClaims {
			...
			if c.Scope != cloudflarezerotrustaccessapplicationv1alpha1.CloudflareZeroTrustAccessSaasScope_scope_unspecified {
...
func buildScimConfig(sc *cloudflarezerotrustaccessapplicationv1alpha1.CloudflareZeroTrustAccessScimConfig) *cloudflare.ZeroTrustAccessApplicationScimConfigArgs {
	...
	if len(sc.Mappings) > 0 {
		...
		for _, m := range sc.Mappings {
			...
			if m.Strictness != cloudflarezerotrustaccessapplicationv1alpha1.CloudflareZeroTrustAccessScimMapping_strictness_unspecified {
