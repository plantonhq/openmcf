...
func listItem(
	...
	case *cloudflarelistitemv1alpha1.CloudflareListItemSpec_Ip:
		args.Ip = pulumi.StringPtr(v.Ip)
	case *cloudflarelistitemv1alpha1.CloudflareListItemSpec_Asn:
		args.Asn = pulumi.IntPtr(int(v.Asn))
	case *cloudflarelistitemv1alpha1.CloudflareListItemSpec_Hostname:
		h := v.Hostname
	...
	case *cloudflarelistitemv1alpha1.CloudflareListItemSpec_Redirect:
		r := v.Redirect
