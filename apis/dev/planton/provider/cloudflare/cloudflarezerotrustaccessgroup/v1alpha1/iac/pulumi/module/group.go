...
func riskLevels(levels []cloudflarezerotrustaccessgroupv1alpha1.AccessRuleUserRiskScore_Level) pulumi.StringArray {
...
func groupIncludes(ctx *pulumi.Context, rules []*cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule) cloudflare.ZeroTrustAccessGroupIncludeArray {
	...
	for _, r := range rules {
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_GithubOrganization:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_Gsuite:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_Okta:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_Saml:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_Oidc:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_AuthContext:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_ExternalEvaluation:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_LoginMethod:
			e.LoginMethod = &cloudflare.ZeroTrustAccessGroupIncludeLoginMethodArgs{Id: pulumi.String(v.LoginMethod.Id.GetValue())}
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_ServiceToken:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_AnyValidServiceToken:
			e.AnyValidServiceToken = &cloudflare.ZeroTrustAccessGroupIncludeAnyValidServiceTokenArgs{}
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_LinkedAppToken:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_UserRiskScore:
		...
		case *cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule_CloudflareAccountMember:
...
func groupExcludes(ctx *pulumi.Context, rules []*cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule) cloudflare.ZeroTrustAccessGroupExcludeArray {
...
func groupRequires(ctx *pulumi.Context, rules []*cloudflarezerotrustaccessgroupv1alpha1.CloudflareAccessRule) cloudflare.ZeroTrustAccessGroupRequireArray {
