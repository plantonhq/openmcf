...
export CLOUDFLARE_WORKER_MODULE=~/scm/github.com/plantonhq/planton/apis/dev/planton/provider/cloudflare/cloudflareworker/v1alpha1/iac/pulumi

planton pulumi up --manifest worker.your-worker.yaml --module-dir ${CLOUDFLARE_WORKER_MODULE}
```
