...
import (
	...
	cloudflarezerotrustaccesspolicyv1alpha1 "github.com/plantonhq/planton/apis/dev/planton/provider/cloudflare/cloudflarezerotrustaccesspolicy/v1alpha1"
...
func riskLevels(levels []cloudflarezerotrustaccesspolicyv1alpha1.AccessRuleUserRiskScore_Level) pulumi.StringArray {
...
func policyIncludes(ctx *pulumi.Context, rules []*cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule) cloudflare.ZeroTrustAccessPolicyIncludeArray {
	...
	for _, r := range rules {
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_GithubOrganization:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_Gsuite:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_Okta:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_Saml:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_Oidc:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_AuthContext:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_ExternalEvaluation:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_LoginMethod:
			e.LoginMethod = &cloudflare.ZeroTrustAccessPolicyIncludeLoginMethodArgs{Id: pulumi.String(v.LoginMethod.Id.GetValue())}
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_ServiceToken:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_AnyValidServiceToken:
			e.AnyValidServiceToken = &cloudflare.ZeroTrustAccessPolicyIncludeAnyValidServiceTokenArgs{}
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_LinkedAppToken:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_UserRiskScore:
		...
		case *cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule_CloudflareAccountMember:
...
func policyExcludes(ctx *pulumi.Context, rules []*cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule) cloudflare.ZeroTrustAccessPolicyExcludeArray {
...
func policyRequires(ctx *pulumi.Context, rules []*cloudflarezerotrustaccesspolicyv1alpha1.CloudflareAccessRule) cloudflare.ZeroTrustAccessPolicyRequireArray {
