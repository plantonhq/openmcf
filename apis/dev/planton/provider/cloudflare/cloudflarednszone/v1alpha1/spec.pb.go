...
// 	protoc        (unknown)
// source: dev/planton/provider/cloudflare/cloudflarednszone/v1alpha1/spec.proto
...
func (CloudflareDnsZoneSpec_ZoneType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareDnsZoneSpec_ZoneType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes[0]
}
...
func (CloudflareDnsZoneSpec_ZoneType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 0}
}
...
func (CloudflareDnsZoneSpec_ZoneMode) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (CloudflareDnsZoneSpec_ZoneMode) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes[1]
}
...
func (CloudflareDnsZoneSpec_ZoneMode) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 1}
}
...
func (CloudflareDnsZoneRecord_RecordType) Descriptor() protoreflect.EnumDescriptor {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (CloudflareDnsZoneRecord_RecordType) Type() protoreflect.EnumType {
	return &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes[2]
}
...
func (CloudflareDnsZoneRecord_RecordType) EnumDescriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1, 0}
}
...
type CloudflareDnsZoneSpec struct {
	...
	Type CloudflareDnsZoneSpec_ZoneType `protobuf:"varint,5,opt,name=type,proto3,enum=dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec_ZoneType" json:"type,omitempty"`
...
func (x *CloudflareDnsZoneSpec) Reset() {
	*x = CloudflareDnsZoneSpec{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes[0]
...
func (*CloudflareDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type CloudflareDnsZoneRecord struct {
	...
	// The DNS record type.
	Type CloudflareDnsZoneRecord_RecordType `protobuf:"varint,2,opt,name=type,proto3,enum=dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecord_RecordType" json:"type,omitempty"`
...
func (x *CloudflareDnsZoneRecord) Reset() {
	*x = CloudflareDnsZoneRecord{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareDnsZoneRecord) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
type CloudflareDnsZoneDnsSettings struct {
	...
	ZoneMode CloudflareDnsZoneSpec_ZoneMode `protobuf:"varint,6,opt,name=zone_mode,json=zoneMode,proto3,enum=dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec_ZoneMode" json:"zone_mode,omitempty"`
...
func (x *CloudflareDnsZoneDnsSettings) Reset() {
	*x = CloudflareDnsZoneDnsSettings{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareDnsZoneDnsSettings) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *CloudflareDnsZoneSoa) Reset() {
	*x = CloudflareDnsZoneSoa{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareDnsZoneSoa) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *CloudflareDnsZoneNameservers) Reset() {
	*x = CloudflareDnsZoneNameservers{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareDnsZoneNameservers) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *CloudflareDnsZoneInternalDns) Reset() {
	*x = CloudflareDnsZoneInternalDns{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareDnsZoneInternalDns) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *CloudflareDnsZoneDnssec) Reset() {
	*x = CloudflareDnsZoneDnssec{}
	mi := &file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareDnsZoneDnssec) Descriptor() ([]byte, []int) {
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Edev/planton/provider/cloudflare/cloudflarednszone/v1alpha1/spec.proto\x12:dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2dev/planton/shared/foreignkey/v1/foreign_key.proto\"\xce\a\n" +
	...
	"\arecords\x18\x04 \x03(\v2S.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecordR\arecords\x12n\n" +
	"\x04type\x18\x05 \x01(\x0e2Z.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.ZoneTypeR\x04type\x12.\n" +
	"\x13vanity_name_servers\x18\x06 \x03(\tR\x11vanityNameServers\x12{\n" +
	"\fdns_settings\x18\a \x01(\v2X.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnsSettingsR\vdnsSettings\x12k\n" +
	"\x06dnssec\x18\b \x01(\v2S.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnssecR\x06dnssec\"Y\n" +
	"\bZoneType\x12\x19\n" +
	...
	"\bdns_only\x10\x03\"\xa0\b\n" +
	"\x17CloudflareDnsZoneRecord\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\x12\xdf\x01\n" +
	"\x04type\x18\x02 \x01(\x0e2^.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecord.RecordTypeBk\xbaHh\xba\x01]\n" +
	...
	"\x1frecord.priority_required_for_mx\x12#priority is required for MX records\x1a#this.type != 4 || this.priority > 0\"\xc2\x06\n" +
	...
	"\x12ns_ttl.valid_range\x12:ns_ttl must be 0 (default) or between 30 and 86400 seconds\x1a-this == 0u || (this >= 30u && this <= 86400u)R\x05nsTtl\x12w\n" +
	"\tzone_mode\x18\x06 \x01(\x0e2Z.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.ZoneModeR\bzoneMode\x12b\n" +
	"\x03soa\x18\a \x01(\v2P.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSoaR\x03soa\x12z\n" +
	"\vnameservers\x18\b \x01(\v2X.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneNameserversR\vnameservers\x12{\n" +
	"\finternal_dns\x18\t \x01(\v2X.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneInternalDnsR\vinternalDns\"\x8b\a\n" +
	...
	"\tuse_nsec3\x18\x04 \x01(\bR\buseNsec3B\xd2\x03\n" +
	">com.dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1B\tSpecProtoP\x01Zvgithub.com/plantonhq/planton/apis/dev/planton/provider/cloudflare/cloudflarednszone/v1alpha1;cloudflarednszonev1alpha1\xa2\x02\x05DPPCC\xaa\x02:Dev.Planton.Provider.Cloudflare.Cloudflarednszone.V1alpha1\xca\x02:Dev\\Planton\\Provider\\Cloudflare\\Cloudflarednszone\\V1alpha1\xe2\x02FDev\\Planton\\Provider\\Cloudflare\\Cloudflarednszone\\V1alpha1\\GPBMetadata\xea\x02?Dev::Planton::Provider::Cloudflare::Cloudflarednszone::V1alpha1b\x06proto3"

var (
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescData []byte
)

func file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDesc)))
	})
	return file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDescData
}

var file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_goTypes = []any{
	(CloudflareDnsZoneSpec_ZoneType)(0),     // 0: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.ZoneType
	(CloudflareDnsZoneSpec_ZoneMode)(0),     // 1: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.ZoneMode
	(CloudflareDnsZoneRecord_RecordType)(0), // 2: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecord.RecordType
	(*CloudflareDnsZoneSpec)(nil),           // 3: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec
	(*CloudflareDnsZoneRecord)(nil),         // 4: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecord
	(*CloudflareDnsZoneDnsSettings)(nil),    // 5: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnsSettings
	(*CloudflareDnsZoneSoa)(nil),            // 6: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSoa
	(*CloudflareDnsZoneNameservers)(nil),    // 7: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneNameservers
	(*CloudflareDnsZoneInternalDns)(nil),    // 8: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneInternalDns
	(*CloudflareDnsZoneDnssec)(nil),         // 9: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnssec
	(*v1.StringValueOrRef)(nil),             // 10: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_depIdxs = []int32{
	4,  // 0: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.records:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecord
	0,  // 1: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.type:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.ZoneType
	5,  // 2: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.dns_settings:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnsSettings
	9,  // 3: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.dnssec:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnssec
	2,  // 4: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecord.type:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneRecord.RecordType
	1,  // 5: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnsSettings.zone_mode:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSpec.ZoneMode
	6,  // 6: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnsSettings.soa:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneSoa
	7,  // 7: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnsSettings.nameservers:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneNameservers
	8,  // 8: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneDnsSettings.internal_dns:type_name -> dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneInternalDns
	10, // 9: dev.planton.provider.cloudflare.cloudflarednszone.v1alpha1.CloudflareDnsZoneInternalDns.reference_zone_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_init() }
func file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_init() {
	if File_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDesc), len(file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto = out.File
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_goTypes = nil
	file_dev_planton_provider_cloudflare_cloudflarednszone_v1alpha1_spec_proto_depIdxs = nil
}
