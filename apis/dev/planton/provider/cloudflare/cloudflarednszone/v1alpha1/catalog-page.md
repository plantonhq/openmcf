...
- [CloudflareDnsRecord](/docs/catalog/cloudflare/cloudflarednsrecord) — manages individual DNS records as standalone resources with the full record feature set
- [CloudflareR2Bucket](/docs/catalog/cloudflare/cloudflarer2bucket) — references this zone via `customDomains[].zoneId` for custom domain bucket access
