...
type CloudResourceKindMeta struct {
	...
	// (e.g. "aws.planton.dev/v1" carries version "v1"). the value must match
...
const file_dev_planton_shared_cloudresourcekind_cloud_resource_kind_proto_rawDesc = "" +
	...
	"apiVersion\x12\x12\n" +
	"\x04kind\x18\x02 \x01(\tR\x04kind*\xd0\xf3\x01\n" +
	"\x11CloudResourceKind\x12\x0f\n" +
	"\vunspecified\x10\x00\x12.\n" +
	"\x18TestCloudResourceGeneric\x10\x01\x1a\x10\xa2\xf7\x04\f\b\x01\x12\x02v1\"\x04tcrg\x121\n" +
	"\x1bTestCloudResourceKubernetes\x10\x02\x1a\x10\xa2\xf7\x04\f\b\x01\x12\x02v1\"\x04tcrk\x12&\n" +
