...
**Provider:** snowflake  
**Component Path:** `apis/org/openmcf/provider/snowflake/snowflakedatabase/v1/`  
**Enum Value:** 52  
**ID Prefix:** snowdb
...
- Folder exists: `apis/org/openmcf/provider/snowflake/snowflakedatabase/v1/`
...
```bash
cd apis/org/openmcf/provider/snowflake/snowflakedatabase/v1/
go test -v
```
