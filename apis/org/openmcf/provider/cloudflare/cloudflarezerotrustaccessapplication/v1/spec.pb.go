...
// 	protoc        (unknown)
// source: org/openmcf/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/spec.proto
...
func (CloudflareZeroTrustPolicyType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareZeroTrustPolicyType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes[0]
}
...
func (CloudflareZeroTrustPolicyType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type CloudflareZeroTrustAccessApplicationSpec struct {
	...
	PolicyType CloudflareZeroTrustPolicyType `protobuf:"varint,4,opt,name=policy_type,json=policyType,proto3,enum=org.openmcf.provider.cloudflare.cloudflarezerotrustaccessapplication.v1.CloudflareZeroTrustPolicyType" json:"policy_type,omitempty"`
...
func (x *CloudflareZeroTrustAccessApplicationSpec) Reset() {
	*x = CloudflareZeroTrustAccessApplicationSpec{}
	mi := &file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_msgTypes[0]
...
var File_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc = "" +
	...
	"\x05BLOCK\x10\x01B\xae\x04\n" +
	"Kcom.org.openmcf.provider.cloudflare.cloudflarezerotrustaccessapplication.v1B\tSpecProtoP\x01Z\x90\x01github.com/plantonhq/openmcf/apis/org/openmcf/provider/cloudflare/cloudflarezerotrustaccessapplication/v1;cloudflarezerotrustaccessapplicationv1\xa2\x02\x05OOPCC\xaa\x02GOrg.Openmcf.Provider.Cloudflare.Cloudflarezerotrustaccessapplication.V1\xca\x02GOrg\\Openmcf\\Provider\\Cloudflare\\Cloudflarezerotrustaccessapplication\\V1\xe2\x02SOrg\\Openmcf\\Provider\\Cloudflare\\Cloudflarezerotrustaccessapplication\\V1\\GPBMetadata\xea\x02LOrg::Openmcf::Provider::Cloudflare::Cloudflarezerotrustaccessapplication::V1b\x06proto3"

var (
	file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_init() {
	if File_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto = out.File
	file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_depIdxs = nil
}
