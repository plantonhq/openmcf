...
**Provider:** cloudflare  
**Component Path:** `apis/org/openmcf/provider/cloudflare/cloudflared1database/v1/`  
**Enum Value:** 1805  
**ID Prefix:** cfd1db
...
- Folder exists: `apis/org/openmcf/provider/cloudflare/cloudflared1database/v1/`
...
- All proto files follow correct package naming: `org.openmcf.provider.cloudflare.cloudflared1database.v1`
...
```bash
cd apis/org/openmcf/provider/cloudflare/cloudflared1database/v1/
go test -v
```
