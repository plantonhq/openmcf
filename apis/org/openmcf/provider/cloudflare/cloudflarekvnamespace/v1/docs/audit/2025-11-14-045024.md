...
**Provider:** cloudflare  
**Component Path:** `apis/org/openmcf/provider/cloudflare/cloudflarekvnamespace/v1/`  
**Enum Value:** 1801  
**ID Prefix:** cfkvn
...
1. **Create README.md at v1/ level**
   ...
   - **File:** `apis/org/openmcf/provider/cloudflare/cloudflarekvnamespace/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/org/openmcf/provider/cloudflare/cloudflarekvnamespace/v1/examples.md`
...
- Folder exists: `apis/org/openmcf/provider/cloudflare/cloudflarekvnamespace/v1/`
...
```bash
cd apis/org/openmcf/provider/cloudflare/cloudflarekvnamespace/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/cloudflare/cloudflaредnszone/v1/`
