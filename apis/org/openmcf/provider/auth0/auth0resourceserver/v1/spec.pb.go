...
// 	protoc        (unknown)
// source: org/openmcf/provider/auth0/auth0resourceserver/v1/spec.proto
...
func (x *Auth0ResourceServerSpec) Reset() {
	*x = Auth0ResourceServerSpec{}
	mi := &file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes[0]
...
func (*Auth0ResourceServerSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *Auth0ResourceServerScope) Reset() {
	*x = Auth0ResourceServerScope{}
	mi := &file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Auth0ResourceServerScope) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc = "" +
	...
	"\vdescription\x18\x02 \x01(\tR\vdescriptionB\x98\x03\n" +
	"5com.org.openmcf.provider.auth0.auth0resourceserver.v1B\tSpecProtoP\x01Zigithub.com/plantonhq/openmcf/apis/org/openmcf/provider/auth0/auth0resourceserver/v1;auth0resourceserverv1\xa2\x02\x05OOPAA\xaa\x021Org.Openmcf.Provider.Auth0.Auth0resourceserver.V1\xca\x021Org\\Openmcf\\Provider\\Auth0\\Auth0resourceserver\\V1\xe2\x02=Org\\Openmcf\\Provider\\Auth0\\Auth0resourceserver\\V1\\GPBMetadata\xea\x026Org::Openmcf::Provider::Auth0::Auth0resourceserver::V1b\x06proto3"

var (
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_goTypes = []any{
	(*Auth0ResourceServerSpec)(nil),  // 0: org.openmcf.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerSpec
	(*Auth0ResourceServerScope)(nil), // 1: org.openmcf.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerScope
}
var file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerSpec.scopes:type_name -> org.openmcf.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerScope
...
func init() { file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_init() }
func file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_init() {
	if File_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto = out.File
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_spec_proto_depIdxs = nil
}
