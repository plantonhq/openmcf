...
// 	protoc        (unknown)
// source: org/openmcf/provider/auth0/auth0resourceserver/v1/stack_outputs.proto
...
func (x *Auth0ResourceServerStackOutputs) Reset() {
	*x = Auth0ResourceServerStackOutputs{}
	mi := &file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_msgTypes[0]
...
func (*Auth0ResourceServerStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Eorg/openmcf/provider/auth0/auth0resourceserver/v1/stack_outputs.proto\x121org.openmcf.provider.auth0.auth0resourceserver.v1\"\xa9\x04\n" +
	...
	"\tclient_id\x18\r \x01(\tR\bclientIdB\xa0\x03\n" +
	"5com.org.openmcf.provider.auth0.auth0resourceserver.v1B\x11StackOutputsProtoP\x01Zigithub.com/plantonhq/openmcf/apis/org/openmcf/provider/auth0/auth0resourceserver/v1;auth0resourceserverv1\xa2\x02\x05OOPAA\xaa\x021Org.Openmcf.Provider.Auth0.Auth0resourceserver.V1\xca\x021Org\\Openmcf\\Provider\\Auth0\\Auth0resourceserver\\V1\xe2\x02=Org\\Openmcf\\Provider\\Auth0\\Auth0resourceserver\\V1\\GPBMetadata\xea\x026Org::Openmcf::Provider::Auth0::Auth0resourceserver::V1b\x06proto3"

var (
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDescData
}

var file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_goTypes = []any{
	(*Auth0ResourceServerStackOutputs)(nil), // 0: org.openmcf.provider.auth0.auth0resourceserver.v1.Auth0ResourceServerStackOutputs
}
var file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_init() }
func file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_auth0_auth0resourceserver_v1_stack_outputs_proto_depIdxs = nil
}
