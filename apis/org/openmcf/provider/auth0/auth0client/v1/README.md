...
`Auth0Client` is a OpenMCF deployment component that enables declarative management of Auth0 Applications. In the Auth0 dashboard, these are shown as "Applications" - they represent OAuth 2.0 clients that can authenticate users and request access to APIs.
...
```bash
openmcf apply --manifest auth0-client.yaml \
