...
// 	protoc        (unknown)
// source: org/openmcf/provider/auth0/auth0client/v1/stack_outputs.proto
...
func (x *Auth0ClientStackOutputs) Reset() {
	*x = Auth0ClientStackOutputs{}
	mi := &file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes[0]
...
func (*Auth0ClientStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
func (x *Auth0SigningKey) Reset() {
	*x = Auth0SigningKey{}
	mi := &file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Auth0SigningKey) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"=org/openmcf/provider/auth0/auth0client/v1/stack_outputs.proto\x12)org.openmcf.provider.auth0.auth0client.v1\"\xbb\x03\n" +
	"\x17Auth0ClientStackOutputs\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\tclient_id\x18\x02 \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\x03 \x01(\tR\fclientSecret\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x12)\n" +
	"\x10application_type\x18\x05 \x01(\tR\x0fapplicationType\x12]\n" +
	"\fsigning_keys\x18\x06 \x03(\v2:.org.openmcf.provider.auth0.auth0client.v1.Auth0SigningKeyR\vsigningKeys\x122\n" +
	...
	"thumbprintB\xe8\x02\n" +
	"-com.org.openmcf.provider.auth0.auth0client.v1B\x11StackOutputsProtoP\x01ZYgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/auth0/auth0client/v1;auth0clientv1\xa2\x02\x05OOPAA\xaa\x02)Org.Openmcf.Provider.Auth0.Auth0client.V1\xca\x02)Org\\Openmcf\\Provider\\Auth0\\Auth0client\\V1\xe2\x025Org\\Openmcf\\Provider\\Auth0\\Auth0client\\V1\\GPBMetadata\xea\x02.Org::Openmcf::Provider::Auth0::Auth0client::V1b\x06proto3"

var (
	file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDescData
}

var file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_goTypes = []any{
	(*Auth0ClientStackOutputs)(nil), // 0: org.openmcf.provider.auth0.auth0client.v1.Auth0ClientStackOutputs
	(*Auth0SigningKey)(nil),         // 1: org.openmcf.provider.auth0.auth0client.v1.Auth0SigningKey
}
var file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.auth0.auth0client.v1.Auth0ClientStackOutputs.signing_keys:type_name -> org.openmcf.provider.auth0.auth0client.v1.Auth0SigningKey
...
func init() { file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_init() }
func file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_auth0_auth0client_v1_stack_outputs_proto_depIdxs = nil
}
