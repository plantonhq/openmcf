...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awslambda/v1/`  
**Enum Value:** 209  
**ID Prefix:** lambda
...
- Folder exists: `apis/org/openmcf/provider/aws/awslambda/v1/`
- Folder name matches lowercase enum name (AwsLambda → awslambda)
- `v1/` subfolder exists
- Follows standard OpenMCF directory structure
...
```bash
cd apis/org/openmcf/provider/aws/awslambda/v1/
go test -v
```
