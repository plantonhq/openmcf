...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsekscluster/v1/spec.proto
...
func (x *AwsEksClusterSpec) Reset() {
	*x = AwsEksClusterSpec{}
	mi := &file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_msgTypes[0]
...
func (*AwsEksClusterSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_aws_awsekscluster_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"4org/openmcf/provider/aws/awsekscluster/v1/spec.proto\x12)org.openmcf.provider.aws.awsekscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\"\xcd\x05\n" +
	"\x11AwsEksClusterSpec\x12\x8c\x01\n" +
	"\n" +
	"subnet_ids\x18\x01 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB9\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x02\x88\xd4a\xd8\x01\x92\xd4a%status.outputs.private_subnets.[*].idR\tsubnetIds\x12\x84\x01\n" +
	"\x10cluster_role_arn\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB&\xbaH\x03\xc8\x01\x01\x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\x0eclusterRoleArn\x12\x18\n" +
	...
	"\x19enable_control_plane_logs\x18\x06 \x01(\bR\x16enableControlPlaneLogs\x12s\n" +
	"\vkms_key_arn\x18\a \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\tkmsKeyArnB\xe2\x02\n" +
	"-com.org.openmcf.provider.aws.awsekscluster.v1B\tSpecProtoP\x01Z[github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsekscluster/v1;awseksclusterv1\xa2\x02\x05OOPAA\xaa\x02)Org.Openmcf.Provider.Aws.Awsekscluster.V1\xca\x02)Org\\Openmcf\\Provider\\Aws\\Awsekscluster\\V1\xe2\x025Org\\Openmcf\\Provider\\Aws\\Awsekscluster\\V1\\GPBMetadata\xea\x02.Org::Openmcf::Provider::Aws::Awsekscluster::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_goTypes = []any{
	(*AwsEksClusterSpec)(nil),   // 0: org.openmcf.provider.aws.awsekscluster.v1.AwsEksClusterSpec
	(*v1.StringValueOrRef)(nil), // 1: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.aws.awsekscluster.v1.AwsEksClusterSpec.subnet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 1: org.openmcf.provider.aws.awsekscluster.v1.AwsEksClusterSpec.cluster_role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 2: org.openmcf.provider.aws.awsekscluster.v1.AwsEksClusterSpec.kms_key_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsekscluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsekscluster_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsekscluster_v1_spec_proto_depIdxs = nil
}
