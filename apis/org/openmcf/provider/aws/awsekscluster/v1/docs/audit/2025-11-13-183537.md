...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awsekscluster/v1/`  
**Enum Value:** 207  
**ID Prefix:** eks
...
- Folder exists: `apis/org/openmcf/provider/aws/awsekscluster/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awsekscluster/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/aws/awsrdsinstance/v1/`
