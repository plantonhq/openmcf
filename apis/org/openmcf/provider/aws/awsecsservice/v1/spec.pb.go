...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsecsservice/v1/spec.proto
...
func (x *AwsEcsServiceSpec) Reset() {
	*x = AwsEcsServiceSpec{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[0]
...
func (x *AwsEcsServiceContainer) Reset() {
	*x = AwsEcsServiceContainer{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEcsServiceContainerLogging) Reset() {
	*x = AwsEcsServiceContainerLogging{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerLogging) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsEcsServiceContainerImage) Reset() {
	*x = AwsEcsServiceContainerImage{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerImage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsEcsServiceContainerEnv) Reset() {
	*x = AwsEcsServiceContainerEnv{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerEnv) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsEcsServiceNetwork) Reset() {
	*x = AwsEcsServiceNetwork{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceNetwork) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsEcsServiceIam) Reset() {
	*x = AwsEcsServiceIam{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceIam) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsEcsServiceAlb) Reset() {
	*x = AwsEcsServiceAlb{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceAlb) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsEcsServiceHealthCheck) Reset() {
	*x = AwsEcsServiceHealthCheck{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceHealthCheck) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsEcsServiceAutoscaling) Reset() {
	*x = AwsEcsServiceAutoscaling{}
	mi := &file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceAutoscaling) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
var File_org_openmcf_provider_aws_awsecsservice_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDesc = "" +
	...
	"\x03env\x18\x02 \x01(\v2D.org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnvR\x03env\x12\x12\n" +
	...
	"\alogging\x18\a \x01(\v2H.org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerLoggingR\alogging\"C\n" +
	...
	"\tvariables\x18\x01 \x03(\v2S.org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.VariablesEntryR\tvariables\x12k\n" +
	"\asecrets\x18\x02 \x03(\v2Q.org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.SecretsEntryR\asecrets\x12#\n" +
	...
	"\rtask_role_arn\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\vtaskRoleArn\"\xf3\x03\n" +
	"\x10AwsEcsServiceAlb\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12o\n" +
	"\x03arn\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xc8\x01\x92\xd4a status.outputs.load_balancer_arnR\x03arn\x128\n" +
	...
	"\fhealth_check\x18\b \x01(\v2C.org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceHealthCheckR\vhealthCheckB\x14\n" +
	...
	"-com.org.openmcf.provider.aws.awsecsservice.v1B\tSpecProtoP\x01Z[github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsecsservice/v1;awsecsservicev1\xa2\x02\x05OOPAA\xaa\x02)Org.Openmcf.Provider.Aws.Awsecsservice.V1\xca\x02)Org\\Openmcf\\Provider\\Aws\\Awsecsservice\\V1\xe2\x025Org\\Openmcf\\Provider\\Aws\\Awsecsservice\\V1\\GPBMetadata\xea\x02.Org::Openmcf::Provider::Aws::Awsecsservice::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_goTypes = []any{
	(*AwsEcsServiceSpec)(nil),             // 0: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceSpec
	(*AwsEcsServiceContainer)(nil),        // 1: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainer
	(*AwsEcsServiceContainerLogging)(nil), // 2: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerLogging
	(*AwsEcsServiceContainerImage)(nil),   // 3: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerImage
	(*AwsEcsServiceContainerEnv)(nil),     // 4: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv
	(*AwsEcsServiceNetwork)(nil),          // 5: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceNetwork
	(*AwsEcsServiceIam)(nil),              // 6: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceIam
	(*AwsEcsServiceAlb)(nil),              // 7: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceAlb
	(*AwsEcsServiceHealthCheck)(nil),      // 8: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceHealthCheck
	(*AwsEcsServiceAutoscaling)(nil),      // 9: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceAutoscaling
	nil,                                   // 10: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.VariablesEntry
	nil,                                   // 11: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.SecretsEntry
	(*v1.StringValueOrRef)(nil),           // 12: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_depIdxs = []int32{
	12, // 0: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceSpec.cluster_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceSpec.container:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainer
	5,  // 2: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceSpec.network:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceNetwork
	6,  // 3: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceSpec.iam:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceIam
	7,  // 4: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceSpec.alb:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceAlb
	9,  // 5: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceSpec.autoscaling:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceAutoscaling
	3,  // 6: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainer.image:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerImage
	4,  // 7: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainer.env:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv
	2,  // 8: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainer.logging:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerLogging
	10, // 9: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.variables:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.VariablesEntry
	11, // 10: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.secrets:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.SecretsEntry
	12, // 11: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceNetwork.subnets:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	12, // 12: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceNetwork.security_groups:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	12, // 13: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceIam.task_execution_role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	12, // 14: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceIam.task_role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	12, // 15: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceAlb.arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	8,  // 16: org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceAlb.health_check:type_name -> org.openmcf.provider.aws.awsecsservice.v1.AwsEcsServiceHealthCheck
...
func init() { file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsecsservice_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsecsservice_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsecsservice_v1_spec_proto_depIdxs = nil
}
