...
```bash
openmcf tofu apply --manifest ecs-service.yaml --stack myorg/dev
```
...
The module accepts the standard OpenMCF metadata and spec structure as defined in the protobuf schema.
