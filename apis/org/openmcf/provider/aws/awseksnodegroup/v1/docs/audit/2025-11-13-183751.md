...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awseksnodegroup/v1/`  
**Enum Value:** 217  
**ID Prefix:** eksng
...
- Folder exists: `apis/org/openmcf/provider/aws/awseksnodegroup/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awseksnodegroup/v1/
go test -v
```
...
- Explains 80/20 scoping decisions ("What OpenMCF Provides")
...
- Describes deployment with OpenMCF CLI
