...
This example uses OpenMCF resource references:
...
Once you've applied your manifest with OpenMCF tofu, you can confirm that the EKS node group is active via the AWS console or by
using the AWS CLI:
