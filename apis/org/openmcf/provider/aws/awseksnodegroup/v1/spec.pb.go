...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awseksnodegroup/v1/spec.proto
...
func (AwsEksNodeGroupCapacityType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsEksNodeGroupCapacityType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_enumTypes[0]
}
...
func (x *AwsEksNodeGroupSpec) Reset() {
	*x = AwsEksNodeGroupSpec{}
	mi := &file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_msgTypes[0]
...
func (x *AwsEksNodeGroupScalingConfig) Reset() {
	*x = AwsEksNodeGroupScalingConfig{}
	mi := &file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEksNodeGroupScalingConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDesc = "" +
	...
	"\x04spot\x10\x01B\xf0\x02\n" +
	"/com.org.openmcf.provider.aws.awseksnodegroup.v1B\tSpecProtoP\x01Z_github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awseksnodegroup/v1;awseksnodegroupv1\xa2\x02\x05OOPAA\xaa\x02+Org.Openmcf.Provider.Aws.Awseksnodegroup.V1\xca\x02+Org\\Openmcf\\Provider\\Aws\\Awseksnodegroup\\V1\xe2\x027Org\\Openmcf\\Provider\\Aws\\Awseksnodegroup\\V1\\GPBMetadata\xea\x020Org::Openmcf::Provider::Aws::Awseksnodegroup::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_goTypes = []any{
	(AwsEksNodeGroupCapacityType)(0),     // 0: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupCapacityType
	(*AwsEksNodeGroupSpec)(nil),          // 1: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec
	(*AwsEksNodeGroupScalingConfig)(nil), // 2: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupScalingConfig
	nil,                                  // 3: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.LabelsEntry
	(*v1.StringValueOrRef)(nil),          // 4: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_depIdxs = []int32{
	4, // 0: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.cluster_name:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	4, // 1: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.node_role_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	4, // 2: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.subnet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 3: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.scaling:type_name -> org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupScalingConfig
	0, // 4: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.capacity_type:type_name -> org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupCapacityType
	3, // 5: org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.labels:type_name -> org.openmcf.provider.aws.awseksnodegroup.v1.AwsEksNodeGroupSpec.LabelsEntry
...
func init() { file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awseksnodegroup_v1_spec_proto_depIdxs = nil
}
