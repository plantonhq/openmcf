...
This document provides practical examples for deploying AWS EKS managed node groups using OpenMCF. 
After creating one of these YAML manifests, deploy it using the OpenMCF CLI:
