...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsrdscluster/v1/spec.proto
...
func (x *AwsRdsClusterSpec) Reset() {
	*x = AwsRdsClusterSpec{}
	mi := &file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[0]
...
func (x *AwsRdsClusterParameter) Reset() {
	*x = AwsRdsClusterParameter{}
	mi := &file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterParameter) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRdsClusterServerlessV2ScalingConfiguration) Reset() {
	*x = AwsRdsClusterServerlessV2ScalingConfiguration{}
	mi := &file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterServerlessV2ScalingConfiguration) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDesc = "" +
	...
	"\x1cserverless_v2_scaling_bounds\x126max_capacity must be >= min_capacity when both are set\x1aBthis.max_capacity == 0.0 || this.max_capacity >= this.min_capacityB\xe2\x02\n" +
	"-com.org.openmcf.provider.aws.awsrdscluster.v1B\tSpecProtoP\x01Z[github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsrdscluster/v1;awsrdsclusterv1\xa2\x02\x05OOPAA\xaa\x02)Org.Openmcf.Provider.Aws.Awsrdscluster.V1\xca\x02)Org\\Openmcf\\Provider\\Aws\\Awsrdscluster\\V1\xe2\x025Org\\Openmcf\\Provider\\Aws\\Awsrdscluster\\V1\\GPBMetadata\xea\x02.Org::Openmcf::Provider::Aws::Awsrdscluster::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_goTypes = []any{
	(*AwsRdsClusterSpec)(nil),                             // 0: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec
	(*AwsRdsClusterParameter)(nil),                        // 1: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterParameter
	(*AwsRdsClusterServerlessV2ScalingConfiguration)(nil), // 2: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterServerlessV2ScalingConfiguration
	(*v1.StringValueOrRef)(nil),                           // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.subnet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 1: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.db_subnet_group_name:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 2: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 3: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.associate_security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 4: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.master_user_secret_kms_key_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 5: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.kms_key_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 6: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.serverless_v2_scaling:type_name -> org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterServerlessV2ScalingConfiguration
	1, // 7: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.parameters:type_name -> org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterParameter
	3, // 8: org.openmcf.provider.aws.awsrdscluster.v1.AwsRdsClusterSpec.vpc_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsrdscluster_v1_spec_proto_depIdxs = nil
}
