...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awsrdscluster/v1/`  
**Enum Value:** 210  
**ID Prefix:** rdsclu
...
- Folder exists: `apis/org/openmcf/provider/aws/awsrdscluster/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awsrdscluster/v1/
go test -v
```
