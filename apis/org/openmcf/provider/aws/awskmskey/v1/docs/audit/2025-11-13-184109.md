...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awskmskey/v1/`  
**Enum Value:** 219  
**ID Prefix:** awskms
...
- Folder exists: `apis/org/openmcf/provider/aws/awskmskey/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awskmskey/v1/
go test -v
```
