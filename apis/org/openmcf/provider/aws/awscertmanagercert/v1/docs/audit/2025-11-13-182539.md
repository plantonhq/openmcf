...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awscertmanagercert/v1/`  
**Enum Value:** 201  
**ID Prefix:** acmcert
...
- Folder exists: `apis/org/openmcf/provider/aws/awscertmanagercert/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awscertmanagercert/v1/
go test -v
```
...
- Documents usage with OpenMCF CLI
...
This component was successfully created using the OpenMCF forge rules and serves as an excellent reference implementation for other components.

---

## Comparison to Complete Components

**Component Status:** This is one of the most complete components in the OpenMCF repository.
...
This component can serve as a reference implementation for other components in the OpenMCF ecosystem.
