...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsvpc/v1/spec.proto
...
func (x *AwsVpcSpec) Reset() {
	*x = AwsVpcSpec{}
	mi := &file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_msgTypes[0]
...
var (
	file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_goTypes = []any{
	(*AwsVpcSpec)(nil), // 0: org.openmcf.provider.aws.awsvpc.v1.AwsVpcSpec
}
var file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_depIdxs = []int32{
...
func init() { file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsvpc_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsvpc_v1_spec_proto_depIdxs = nil
}
