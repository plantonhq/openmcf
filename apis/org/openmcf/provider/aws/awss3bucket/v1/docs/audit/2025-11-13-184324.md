...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awss3bucket/v1/`  
**Enum Value:** 213  
**ID Prefix:** s3bkt
...
- Folder exists: `apis/org/openmcf/provider/aws/awss3bucket/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awss3bucket/v1/
go test -v
```
...
PASS
ok  	github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awss3bucket/v1	0.372s
```
...
File is substantial, providing clear user-facing documentation from OpenMCF perspective.
...
- `apis/org/openmcf/provider/aws/awsalb/v1/`
- `apis/org/openmcf/provider/aws/awscertmanagercert/v1/`
- `apis/org/openmcf/provider/aws/awsdynamodb/v1/`
