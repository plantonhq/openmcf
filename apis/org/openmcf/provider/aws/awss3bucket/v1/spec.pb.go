...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awss3bucket/v1/spec.proto
...
func (AwsS3BucketSpec_EncryptionType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsS3BucketSpec_EncryptionType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_enumTypes[0]
}
...
func (AwsS3BucketSpec_EncryptionType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0, 0}
}
...
func (AwsS3BucketSpec_StorageClass) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AwsS3BucketSpec_StorageClass) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_enumTypes[1]
}
...
func (AwsS3BucketSpec_StorageClass) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0, 1}
}
...
type AwsS3BucketSpec struct {
	...
	EncryptionType AwsS3BucketSpec_EncryptionType `protobuf:"varint,4,opt,name=encryption_type,json=encryptionType,proto3,enum=org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec_EncryptionType" json:"encryption_type,omitempty"`
...
func (x *AwsS3BucketSpec) Reset() {
	*x = AwsS3BucketSpec{}
	mi := &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes[0]
...
type AwsS3BucketSpec_LifecycleRule struct {
	...
	TransitionStorageClass AwsS3BucketSpec_StorageClass `protobuf:"varint,5,opt,name=transition_storage_class,json=transitionStorageClass,proto3,enum=org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec_StorageClass" json:"transition_storage_class,omitempty"`
...
func (x *AwsS3BucketSpec_LifecycleRule) Reset() {
	*x = AwsS3BucketSpec_LifecycleRule{}
	mi := &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AwsS3BucketSpec_ReplicationConfiguration) Reset() {
	*x = AwsS3BucketSpec_ReplicationConfiguration{}
	mi := &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AwsS3BucketSpec_LoggingConfiguration) Reset() {
	*x = AwsS3BucketSpec_LoggingConfiguration{}
	mi := &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsS3BucketSpec_LoggingConfiguration) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *AwsS3BucketSpec_CorsConfiguration) Reset() {
	*x = AwsS3BucketSpec_CorsConfiguration{}
	mi := &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsS3BucketSpec_CorsConfiguration) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0, 3}
}
...
type AwsS3BucketSpec_ReplicationConfiguration_Destination struct {
	...
	StorageClass AwsS3BucketSpec_StorageClass `protobuf:"varint,2,opt,name=storage_class,json=storageClass,proto3,enum=org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec_StorageClass" json:"storage_class,omitempty"`
...
func (x *AwsS3BucketSpec_ReplicationConfiguration_Destination) Reset() {
	*x = AwsS3BucketSpec_ReplicationConfiguration_Destination{}
	mi := &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsS3BucketSpec_ReplicationConfiguration_Destination) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
func (x *AwsS3BucketSpec_CorsConfiguration_CorsRule) Reset() {
	*x = AwsS3BucketSpec_CorsConfiguration_CorsRule{}
	mi := &file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsS3BucketSpec_CorsConfiguration_CorsRule) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0, 3, 0}
}
...
var File_org_openmcf_provider_aws_awss3bucket_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDesc = "" +
	...
	"\alogging\x18\t \x01(\v2M.org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.LoggingConfigurationR\alogging\x12^\n" +
	"\x04cors\x18\n" +
	" \x01(\v2J.org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.CorsConfigurationR\x04cors\x12#\n" +
	...
	"\rstorage_class\x18\x02 \x01(\x0e2E.org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.StorageClassB\b\xbaH\x05\x82\x01\x02\x10\x01R\fstorageClass\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"cors_rules\x18\x01 \x03(\v2S.org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.CorsConfiguration.CorsRuleR\tcorsRules\x1a\xe8\x01\n" +
	"\bCorsRule\x121\n" +
	...
	"+com.org.openmcf.provider.aws.awss3bucket.v1B\tSpecProtoP\x01ZWgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awss3bucket/v1;awss3bucketv1\xa2\x02\x05OOPAA\xaa\x02'Org.Openmcf.Provider.Aws.Awss3bucket.V1\xca\x02'Org\\Openmcf\\Provider\\Aws\\Awss3bucket\\V1\xe2\x023Org\\Openmcf\\Provider\\Aws\\Awss3bucket\\V1\\GPBMetadata\xea\x02,Org::Openmcf::Provider::Aws::Awss3bucket::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_goTypes = []any{
	(AwsS3BucketSpec_EncryptionType)(0),              // 0: org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.EncryptionType
	(AwsS3BucketSpec_StorageClass)(0),                // 1: org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.StorageClass
	(*AwsS3BucketSpec)(nil),                          // 2: org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec
	(*AwsS3BucketSpec_LifecycleRule)(nil),            // 3: org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.LifecycleRule
	(*AwsS3BucketSpec_ReplicationConfiguration)(nil), // 4: org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.ReplicationConfiguration
	(*AwsS3BucketSpec_LoggingConfiguration)(nil),     // 5: org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.LoggingConfiguration
	(*AwsS3BucketSpec_CorsConfiguration)(nil),        // 6: org.openmcf.provider.aws.awss3bucket.v1.AwsS3BucketSpec.CorsConfiguration
...
func file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awss3bucket_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awss3bucket_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awss3bucket_v1_spec_proto_depIdxs = nil
}
