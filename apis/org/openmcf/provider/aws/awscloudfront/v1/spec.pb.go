...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awscloudfront/v1/spec.proto
...
func (AwsCloudFrontSpec_PriceClass) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsCloudFrontSpec_PriceClass) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_enumTypes[0]
}
...
func (AwsCloudFrontSpec_PriceClass) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AwsCloudFrontSpec) Reset() {
	*x = AwsCloudFrontSpec{}
	mi := &file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_msgTypes[0]
...
func (x *AwsCloudFrontSpec_Origin) Reset() {
	*x = AwsCloudFrontSpec_Origin{}
	mi := &file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_org_openmcf_provider_aws_awscloudfront_v1_spec_proto protoreflect.FileDescriptor
...
var (
	file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_goTypes = []any{
...
func file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awscloudfront_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awscloudfront_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awscloudfront_v1_spec_proto_depIdxs = nil
}
