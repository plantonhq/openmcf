...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awsdynamodb/v1/`  
**Enum Value:** 203  
**ID Prefix:** awsdyn
...
- Folder exists: `apis/org/openmcf/provider/aws/awsdynamodb/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awsdynamodb/v1/
go test -v
```
...
- Explains 80/20 scoping decisions and what OpenMCF supports
...
- Explains how it works with OpenMCF
...
**Path to reference:** Other AWS components at `apis/org/openmcf/provider/aws/` can serve as templates for the overview.md structure.
