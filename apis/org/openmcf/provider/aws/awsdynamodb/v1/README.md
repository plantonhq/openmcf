...
The **AwsDynamodb** resource provides a standardized way to provision and manage AWS DynamoDB tables through OpenMCF. It simplifies DynamoDB table configuration while supporting essential features like flexible billing modes, indexes, streams, TTL, and encryption.
...
When you define an AwsDynamodb resource, OpenMCF:
