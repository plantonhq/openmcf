...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awsecscluster/v1/`  
**Enum Value:** 205  
**ID Prefix:** ecsclu
...
- Folder exists under correct provider hierarchy: `apis/org/openmcf/provider/aws/awsecscluster/`
...
**Path to reference:** `apis/org/openmcf/provider/aws/awsecscluster/v1/`
...
This component represents the **gold standard** for OpenMCF components and should be referenced when creating or improving other components.
