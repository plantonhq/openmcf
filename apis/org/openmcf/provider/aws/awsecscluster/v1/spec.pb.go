...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsecscluster/v1/spec.proto
...
func (ExecConfiguration_Logging) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_enumTypes[0].Descriptor()
}

func (ExecConfiguration_Logging) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_enumTypes[0]
}
...
func (ExecConfiguration_Logging) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *AwsEcsClusterSpec) Reset() {
	*x = AwsEcsClusterSpec{}
	mi := &file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_msgTypes[0]
...
func (x *CapacityProviderStrategy) Reset() {
	*x = CapacityProviderStrategy{}
	mi := &file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CapacityProviderStrategy) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type ExecConfiguration struct {
	...
	Logging ExecConfiguration_Logging `protobuf:"varint,1,opt,name=logging,proto3,enum=org.openmcf.provider.aws.awsecscluster.v1.ExecConfiguration_Logging" json:"logging,omitempty"`
...
func (x *ExecConfiguration) Reset() {
	*x = ExecConfiguration{}
	mi := &file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecConfiguration) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExecLogConfiguration) Reset() {
	*x = ExecLogConfiguration{}
	mi := &file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecLogConfiguration) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_org_openmcf_provider_aws_awsecscluster_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDesc = "" +
	...
	"-com.org.openmcf.provider.aws.awsecscluster.v1B\tSpecProtoP\x01Z[github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsecscluster/v1;awsecsclusterv1\xa2\x02\x05OOPAA\xaa\x02)Org.Openmcf.Provider.Aws.Awsecscluster.V1\xca\x02)Org\\Openmcf\\Provider\\Aws\\Awsecscluster\\V1\xe2\x025Org\\Openmcf\\Provider\\Aws\\Awsecscluster\\V1\\GPBMetadata\xea\x02.Org::Openmcf::Provider::Aws::Awsecscluster::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_goTypes = []any{
	(ExecConfiguration_Logging)(0),   // 0: org.openmcf.provider.aws.awsecscluster.v1.ExecConfiguration.Logging
	(*AwsEcsClusterSpec)(nil),        // 1: org.openmcf.provider.aws.awsecscluster.v1.AwsEcsClusterSpec
...
func file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsecscluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsecscluster_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsecscluster_v1_spec_proto_depIdxs = nil
}
