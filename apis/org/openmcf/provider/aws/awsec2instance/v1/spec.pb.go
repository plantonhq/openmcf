...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsec2instance/v1/spec.proto
...
func (AwsEc2InstanceConnectionMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsEc2InstanceConnectionMethod) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_enumTypes[0]
}
...
func (AwsEc2InstanceConnectionMethod) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type AwsEc2InstanceSpec struct {
	...
	ConnectionMethod *AwsEc2InstanceConnectionMethod `protobuf:"varint,6,opt,name=connection_method,json=connectionMethod,proto3,enum=org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceConnectionMethod,oneof" json:"connection_method,omitempty"`
...
func (x *AwsEc2InstanceSpec) Reset() {
	*x = AwsEc2InstanceSpec{}
	mi := &file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_msgTypes[0]
...
var File_org_openmcf_provider_aws_awsec2instance_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDesc = "" +
	"\n" +
	"5org/openmcf/provider/aws/awsec2instance/v1/spec.proto\x12*org.openmcf.provider.aws.awsec2instance.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xe0\f\n" +
	...
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\finstanceType\x12\x81\x01\n" +
	"\tsubnet_id\x18\x04 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB0\xbaH\x03\xc8\x01\x01\x88\xd4a\xd8\x01\x92\xd4a!status.outputs.private_subnets.idR\bsubnetId\x12\x96\x01\n" +
	"\x12security_group_ids\x18\x05 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB4\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x10securityGroupIds\x12\x8d\x01\n" +
	"\x11connection_method\x18\x06 \x01(\x0e2J.org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceConnectionMethodB\x0f\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x03SSMH\x00R\x10connectionMethod\x88\x01\x01\x12\x8d\x01\n" +
	"\x18iam_instance_profile_arn\x18\a \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\x15iamInstanceProfileArn\x12\x19\n" +
	...
	"\x04tags\x18\n" +
	" \x03(\v2H.org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.TagsEntryR\x04tags\x12&\n" +
	...
	"\x10INSTANCE_CONNECT\x10\x02B\xe9\x02\n" +
	".com.org.openmcf.provider.aws.awsec2instance.v1B\tSpecProtoP\x01Z]github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsec2instance/v1;awsec2instancev1\xa2\x02\x05OOPAA\xaa\x02*Org.Openmcf.Provider.Aws.Awsec2instance.V1\xca\x02*Org\\Openmcf\\Provider\\Aws\\Awsec2instance\\V1\xe2\x026Org\\Openmcf\\Provider\\Aws\\Awsec2instance\\V1\\GPBMetadata\xea\x02/Org::Openmcf::Provider::Aws::Awsec2instance::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_goTypes = []any{
	(AwsEc2InstanceConnectionMethod)(0), // 0: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceConnectionMethod
	(*AwsEc2InstanceSpec)(nil),          // 1: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec
	nil,                                 // 2: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),         // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.subnet_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 1: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.security_group_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0, // 2: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.connection_method:type_name -> org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceConnectionMethod
	3, // 3: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.iam_instance_profile_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 4: org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.tags:type_name -> org.openmcf.provider.aws.awsec2instance.v1.AwsEc2InstanceSpec.TagsEntry
...
func init() { file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsec2instance_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsec2instance_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsec2instance_v1_spec_proto_depIdxs = nil
}
