...
The **AwsEc2Instance** resource provides a standardized way to provision and manage single AWS EC2 virtual machine instances through OpenMCF. It focuses on the most common production scenarios, covering networking, security, IAM, and access configuration with a simplified 80/20 approach.
...
When you define an AwsEc2Instance resource, OpenMCF:
