...
spec:
  ...
  userData: |
    ...
    echo "<h1>Hello from OpenMCF!</h1>" > /var/www/html/index.html
  tags:
    env: development
    app: web-application
```
...
Once you've applied your manifest with OpenMCF tofu, you can confirm that the EC2 instance is active via the AWS console or by
using the AWS CLI:
