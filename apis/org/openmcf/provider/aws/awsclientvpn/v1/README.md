...
The **AwsClientVpn** resource provides a standardized way to provision and manage AWS Client VPN endpoints through OpenMCF. It enables secure remote access into AWS VPCs using OpenVPN, allowing developers and teams to connect from their laptops or remote networks to private resources within a VPC.
...
When you define an AwsClientVpn resource, OpenMCF:
