...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsclientvpn/v1/spec.proto
...
func (AwsClientVpnAuthenticationType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsClientVpnAuthenticationType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[0]
}
...
func (AwsClientVpnTransportProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AwsClientVpnTransportProtocol) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[1]
}
...
func (AwsClientVpnTransportProtocol) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsClientVpnSpec) Reset() {
	*x = AwsClientVpnSpec{}
	mi := &file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_msgTypes[0]
...
var File_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDesc = "" +
	...
	",com.org.openmcf.provider.aws.awsclientvpn.v1B\tSpecProtoP\x01ZYgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsclientvpn/v1;awsclientvpnv1\xa2\x02\x05OOPAA\xaa\x02(Org.Openmcf.Provider.Aws.Awsclientvpn.V1\xca\x02(Org\\Openmcf\\Provider\\Aws\\Awsclientvpn\\V1\xe2\x024Org\\Openmcf\\Provider\\Aws\\Awsclientvpn\\V1\\GPBMetadata\xea\x02-Org::Openmcf::Provider::Aws::Awsclientvpn::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_goTypes = []any{
	(AwsClientVpnAuthenticationType)(0), // 0: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnAuthenticationType
	(AwsClientVpnTransportProtocol)(0),  // 1: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnTransportProtocol
	(*AwsClientVpnSpec)(nil),            // 2: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnSpec
	(*v1.StringValueOrRef)(nil),         // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnSpec.vpc_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 1: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnSpec.subnets:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0, // 2: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnSpec.authentication_type:type_name -> org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnAuthenticationType
	3, // 3: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnSpec.server_certificate_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 4: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnSpec.transport_protocol:type_name -> org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnTransportProtocol
	3, // 5: org.openmcf.provider.aws.awsclientvpn.v1.AwsClientVpnSpec.security_groups:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsclientvpn_v1_spec_proto_depIdxs = nil
}
