...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsdocumentdb/v1/spec.proto
...
func (x *AwsDocumentDbSpec) Reset() {
	*x = AwsDocumentDbSpec{}
	mi := &file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes[0]
...
func (x *AwsDocumentDbParameter) Reset() {
	*x = AwsDocumentDbParameter{}
	mi := &file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbParameter) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc = "" +
	...
	"-com.org.openmcf.provider.aws.awsdocumentdb.v1B\tSpecProtoP\x01Z[github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsdocumentdb/v1;awsdocumentdbv1\xa2\x02\x05OOPAA\xaa\x02)Org.Openmcf.Provider.Aws.Awsdocumentdb.V1\xca\x02)Org\\Openmcf\\Provider\\Aws\\Awsdocumentdb\\V1\xe2\x025Org\\Openmcf\\Provider\\Aws\\Awsdocumentdb\\V1\\GPBMetadata\xea\x02.Org::Openmcf::Provider::Aws::Awsdocumentdb::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_goTypes = []any{
	(*AwsDocumentDbSpec)(nil),      // 0: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec
	(*AwsDocumentDbParameter)(nil), // 1: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbParameter
	(*v1.StringValueOrRef)(nil),    // 2: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.subnets:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 1: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.db_subnet_group:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 2: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.security_groups:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 3: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.vpc:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 4: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.kms_key:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 5: org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.cluster_parameters:type_name -> org.openmcf.provider.aws.awsdocumentdb.v1.AwsDocumentDbParameter
...
func init() { file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsdocumentdb_v1_spec_proto_depIdxs = nil
}
