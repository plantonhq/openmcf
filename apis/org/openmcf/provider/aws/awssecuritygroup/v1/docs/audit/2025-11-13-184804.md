...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awssecuritygroup/v1/`  
**Enum Value:** 215  
**ID Prefix:** awssg
...
- Folder exists: `apis/org/openmcf/provider/aws/awssecuritygroup/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awssecuritygroup/v1/
go test -v
```
...
- **OpenMCF's Approach:** Design philosophy and comparison to raw IaC
...
**Path to reference:** `apis/org/openmcf/provider/aws/awsvpc/v1/`
