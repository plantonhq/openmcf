...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awssecuritygroup/v1/spec.proto
...
func (x *AwsSecurityGroupSpec) Reset() {
	*x = AwsSecurityGroupSpec{}
	mi := &file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes[0]
...
func (x *SecurityGroupRule) Reset() {
	*x = SecurityGroupRule{}
	mi := &file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SecurityGroupRule) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc = "" +
	...
	"0com.org.openmcf.provider.aws.awssecuritygroup.v1B\tSpecProtoP\x01Zagithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awssecuritygroup/v1;awssecuritygroupv1\xa2\x02\x05OOPAA\xaa\x02,Org.Openmcf.Provider.Aws.Awssecuritygroup.V1\xca\x02,Org\\Openmcf\\Provider\\Aws\\Awssecuritygroup\\V1\xe2\x028Org\\Openmcf\\Provider\\Aws\\Awssecuritygroup\\V1\\GPBMetadata\xea\x021Org::Openmcf::Provider::Aws::Awssecuritygroup::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_goTypes = []any{
	(*AwsSecurityGroupSpec)(nil), // 0: org.openmcf.provider.aws.awssecuritygroup.v1.AwsSecurityGroupSpec
	(*SecurityGroupRule)(nil),    // 1: org.openmcf.provider.aws.awssecuritygroup.v1.SecurityGroupRule
	(*v1.StringValueOrRef)(nil),  // 2: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs = []int32{
...
func file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs = nil
}
