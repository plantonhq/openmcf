...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsroute53zone/v1/spec.proto
...
func (Route53FailoverRoutingPolicy_FailoverRecordType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_enumTypes[0].Descriptor()
}

func (Route53FailoverRoutingPolicy_FailoverRecordType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_enumTypes[0]
}
...
func (Route53FailoverRoutingPolicy_FailoverRecordType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{7, 0}
}
...
func (x *AwsRoute53ZoneSpec) Reset() {
	*x = AwsRoute53ZoneSpec{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[0]
...
func (x *Route53VpcAssociation) Reset() {
	*x = Route53VpcAssociation{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type Route53DnsRecord struct {
	...
	RecordType dnsrecordtype.DnsRecordType `protobuf:"varint,1,opt,name=record_type,json=recordType,proto3,enum=org.openmcf.shared.networking.enums.dnsrecordtype.DnsRecordType" json:"record_type,omitempty"`
...
func (x *Route53DnsRecord) Reset() {
	*x = Route53DnsRecord{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Route53DnsRecord) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *Route53AliasTarget) Reset() {
	*x = Route53AliasTarget{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Route53AliasTarget) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *Route53RoutingPolicy) Reset() {
	*x = Route53RoutingPolicy{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Route53RoutingPolicy) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *Route53WeightedRoutingPolicy) Reset() {
	*x = Route53WeightedRoutingPolicy{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Route53WeightedRoutingPolicy) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *Route53LatencyRoutingPolicy) Reset() {
	*x = Route53LatencyRoutingPolicy{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Route53LatencyRoutingPolicy) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
type Route53FailoverRoutingPolicy struct {
	...
	Type          Route53FailoverRoutingPolicy_FailoverRecordType `protobuf:"varint,1,opt,name=type,proto3,enum=org.openmcf.provider.aws.awsroute53zone.v1.Route53FailoverRoutingPolicy_FailoverRecordType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Route53FailoverRoutingPolicy) Reset() {
	*x = Route53FailoverRoutingPolicy{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Route53FailoverRoutingPolicy) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *Route53GeolocationRoutingPolicy) Reset() {
	*x = Route53GeolocationRoutingPolicy{}
	mi := &file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Route53GeolocationRoutingPolicy) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
var File_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDesc = "" +
	...
	"ttlSeconds\x12\x16\n" +
	"\x06values\x18\x04 \x03(\tR\x06values\x12a\n" +
	"\falias_target\x18\x05 \x01(\v2>.org.openmcf.provider.aws.awsroute53zone.v1.Route53AliasTargetR\valiasTarget\x12g\n" +
	"\x0erouting_policy\x18\x06 \x01(\v2@.org.openmcf.provider.aws.awsroute53zone.v1.Route53RoutingPolicyR\rroutingPolicy\x12&\n" +
	...
	"\x16evaluate_target_health\x18\x03 \x01(\bR\x14evaluateTargetHealth\"\xc6\x03\n" +
	"\x14Route53RoutingPolicy\x12f\n" +
	"\bweighted\x18\x01 \x01(\v2H.org.openmcf.provider.aws.awsroute53zone.v1.Route53WeightedRoutingPolicyH\x00R\bweighted\x12c\n" +
	"\alatency\x18\x02 \x01(\v2G.org.openmcf.provider.aws.awsroute53zone.v1.Route53LatencyRoutingPolicyH\x00R\alatency\x12f\n" +
	"\bfailover\x18\x03 \x01(\v2H.org.openmcf.provider.aws.awsroute53zone.v1.Route53FailoverRoutingPolicyH\x00R\bfailover\x12o\n" +
	"\vgeolocation\x18\x04 \x01(\v2K.org.openmcf.provider.aws.awsroute53zone.v1.Route53GeolocationRoutingPolicyH\x00R\vgeolocationB\b\n" +
	"\x06policy\"B\n" +
	...
	"\x06region\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x06region\"\xef\x01\n" +
	"\x1cRoute53FailoverRoutingPolicy\x12w\n" +
	"\x04type\x18\x01 \x01(\x0e2[.org.openmcf.provider.aws.awsroute53zone.v1.Route53FailoverRoutingPolicy.FailoverRecordTypeB\x06\xbaH\x03\xc8\x01\x01R\x04type\"V\n" +
	...
	"\vsubdivision\x18\x03 \x01(\tR\vsubdivisionB\xe9\x02\n" +
	".com.org.openmcf.provider.aws.awsroute53zone.v1B\tSpecProtoP\x01Z]github.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsroute53zone/v1;awsroute53zonev1\xa2\x02\x05OOPAA\xaa\x02*Org.Openmcf.Provider.Aws.Awsroute53zone.V1\xca\x02*Org\\Openmcf\\Provider\\Aws\\Awsroute53zone\\V1\xe2\x026Org\\Openmcf\\Provider\\Aws\\Awsroute53zone\\V1\\GPBMetadata\xea\x02/Org::Openmcf::Provider::Aws::Awsroute53zone::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_goTypes = []any{
	(Route53FailoverRoutingPolicy_FailoverRecordType)(0), // 0: org.openmcf.provider.aws.awsroute53zone.v1.Route53FailoverRoutingPolicy.FailoverRecordType
	(*AwsRoute53ZoneSpec)(nil),                           // 1: org.openmcf.provider.aws.awsroute53zone.v1.AwsRoute53ZoneSpec
	(*Route53VpcAssociation)(nil),                        // 2: org.openmcf.provider.aws.awsroute53zone.v1.Route53VpcAssociation
	(*Route53DnsRecord)(nil),                             // 3: org.openmcf.provider.aws.awsroute53zone.v1.Route53DnsRecord
	(*Route53AliasTarget)(nil),                           // 4: org.openmcf.provider.aws.awsroute53zone.v1.Route53AliasTarget
	(*Route53RoutingPolicy)(nil),                         // 5: org.openmcf.provider.aws.awsroute53zone.v1.Route53RoutingPolicy
	(*Route53WeightedRoutingPolicy)(nil),                 // 6: org.openmcf.provider.aws.awsroute53zone.v1.Route53WeightedRoutingPolicy
...
func file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsroute53zone_v1_spec_proto_depIdxs = nil
}
