...
```shell
openmcf pulumi up --manifest aws-route53-zone.yaml --stack myorg/dev
```

or

```shell
openmcf terraform apply --manifest aws-route53-zone.yaml --stack myorg/dev
```
...
```shell
openmcf pulumi output nameservers --stack myorg/dev
```
