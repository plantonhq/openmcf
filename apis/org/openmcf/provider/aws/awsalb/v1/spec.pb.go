...
// 	protoc        (unknown)
// source: org/openmcf/provider/aws/awsalb/v1/spec.proto
...
func (x *AwsAlbSpec) Reset() {
	*x = AwsAlbSpec{}
	mi := &file_org_openmcf_provider_aws_awsalb_v1_spec_proto_msgTypes[0]
...
func (x *AwsAlbDns) Reset() {
	*x = AwsAlbDns{}
	mi := &file_org_openmcf_provider_aws_awsalb_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAlbDns) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsAlbSsl) Reset() {
	*x = AwsAlbSsl{}
	mi := &file_org_openmcf_provider_aws_awsalb_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAlbSsl) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_aws_awsalb_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDesc = "" +
	...
	"\x03ssl\x18\b \x01(\v2-.org.openmcf.provider.aws.awsalb.v1.AwsAlbSslR\x03ssl\"\xca\x01\n" +
	"\tAwsAlbDns\x12\x18\n" +
	...
	"\tAwsAlbSsl\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12}\n" +
	"\x0fcertificate_arn\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xc9\x01\x92\xd4a\x17status.outputs.cert_arnR\x0ecertificateArnB\xb1\x02\n" +
	"&com.org.openmcf.provider.aws.awsalb.v1B\tSpecProtoP\x01ZMgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/aws/awsalb/v1;awsalbv1\xa2\x02\x05OOPAA\xaa\x02\"Org.Openmcf.Provider.Aws.Awsalb.V1\xca\x02\"Org\\Openmcf\\Provider\\Aws\\Awsalb\\V1\xe2\x02.Org\\Openmcf\\Provider\\Aws\\Awsalb\\V1\\GPBMetadata\xea\x02'Org::Openmcf::Provider::Aws::Awsalb::V1b\x06proto3"

var (
	file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_aws_awsalb_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_openmcf_provider_aws_awsalb_v1_spec_proto_goTypes = []any{
	(*AwsAlbSpec)(nil),          // 0: org.openmcf.provider.aws.awsalb.v1.AwsAlbSpec
	(*AwsAlbDns)(nil),           // 1: org.openmcf.provider.aws.awsalb.v1.AwsAlbDns
	(*AwsAlbSsl)(nil),           // 2: org.openmcf.provider.aws.awsalb.v1.AwsAlbSsl
	(*v1.StringValueOrRef)(nil), // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_aws_awsalb_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.aws.awsalb.v1.AwsAlbSpec.subnets:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 1: org.openmcf.provider.aws.awsalb.v1.AwsAlbSpec.security_groups:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 2: org.openmcf.provider.aws.awsalb.v1.AwsAlbSpec.dns:type_name -> org.openmcf.provider.aws.awsalb.v1.AwsAlbDns
	2, // 3: org.openmcf.provider.aws.awsalb.v1.AwsAlbSpec.ssl:type_name -> org.openmcf.provider.aws.awsalb.v1.AwsAlbSsl
	3, // 4: org.openmcf.provider.aws.awsalb.v1.AwsAlbDns.route53_zone_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 5: org.openmcf.provider.aws.awsalb.v1.AwsAlbSsl.certificate_arn:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_aws_awsalb_v1_spec_proto_init() }
func file_org_openmcf_provider_aws_awsalb_v1_spec_proto_init() {
	if File_org_openmcf_provider_aws_awsalb_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_aws_awsalb_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_aws_awsalb_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_aws_awsalb_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_aws_awsalb_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_aws_awsalb_v1_spec_proto = out.File
	file_org_openmcf_provider_aws_awsalb_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_aws_awsalb_v1_spec_proto_depIdxs = nil
}
