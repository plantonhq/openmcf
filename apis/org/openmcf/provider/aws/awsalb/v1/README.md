...
The **AwsAlb** resource provides a standardized way to provision and manage AWS Application Load Balancers (ALBs) through OpenMCF. It simplifies ALB configuration by focusing on essential fields while providing flexibility for common networking, SSL, and DNS requirements.
...
When you define an AwsAlb resource, OpenMCF:
