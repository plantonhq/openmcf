...
**Provider:** aws  
**Component Path:** `apis/org/openmcf/provider/aws/awssecretsmanager/v1/`  
**Enum Value:** 214  
**ID Prefix:** awssm
...
- Folder exists: `apis/org/openmcf/provider/aws/awssecretsmanager/v1/`
...
```bash
cd apis/org/openmcf/provider/aws/awssecretsmanager/v1/
go test -v
```
...
- Explains 80/20 scoping decisions explicitly in "The OpenMCF Choice" section
...
**Path to reference:** `apis/org/openmcf/provider/gcp/gcpsecretsmanager/v1/`
