...
# 
# This module creates secret CONTAINERS in AWS Secrets Manager following the OpenMCF 80/20 philosophy:
...
resource "aws_secretsmanager_secret" "secrets" {
  ...
  # Apply OpenMCF standard tags plus user-provided tags
