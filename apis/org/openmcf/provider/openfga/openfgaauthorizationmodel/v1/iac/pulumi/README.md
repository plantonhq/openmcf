...
**OpenFGA does not have a Pulumi provider.** This module is a pass-through placeholder that exists only for structural consistency with other OpenMCF deployment components.
...
1. **Structural Consistency**: All OpenMCF deployment components have both Pulumi and Terraform modules
