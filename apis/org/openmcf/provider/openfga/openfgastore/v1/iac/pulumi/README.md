...
This module exists only to maintain consistency with the OpenMCF deployment component structure. All deployment components have both Pulumi and Terraform modules, but OpenFGA only has a Terraform provider.
