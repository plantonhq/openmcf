...
**Provider:** azure  
**Component Path:** `apis/org/openmcf/provider/azure/azurednszone/v1/`  
**Enum Value:** 403  
**ID Prefix:** azdns
...
✅ **Passed:**
- Folder exists under correct provider hierarchy: `apis/org/openmcf/provider/azure/azurednszone/`
...
**Test Output:**
```
ok  	github.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurednszone/v1	0.397s
```
...
1. **Complete Terraform Implementation**
   ...
   - **Why:** Critical gap. Component cannot be deployed with Terraform currently. This blocks dual-IaC support which is a core OpenMCF principle.
   - **How:** 
...
**Path to reference:** `apis/org/openmcf/provider/gcp/gcpdnszone/v1/`
