...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azurednszone/v1/spec.proto
...
func (x *AzureDnsZoneSpec) Reset() {
	*x = AzureDnsZoneSpec{}
	mi := &file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_msgTypes[0]
...
func (*AzureDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureDnsRecord) Reset() {
	*x = AzureDnsRecord{}
	mi := &file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsRecord) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_azure_azurednszone_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDesc = "" +
	...
	".com.org.openmcf.provider.azure.azurednszone.v1B\tSpecProtoP\x01Z[github.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurednszone/v1;azurednszonev1\xa2\x02\x05OOPAA\xaa\x02*Org.Openmcf.Provider.Azure.Azurednszone.V1\xca\x02*Org\\Openmcf\\Provider\\Azure\\Azurednszone\\V1\xe2\x026Org\\Openmcf\\Provider\\Azure\\Azurednszone\\V1\\GPBMetadata\xea\x02/Org::Openmcf::Provider::Azure::Azurednszone::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azurednszone_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azurednszone_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azurednszone_v1_spec_proto_depIdxs = nil
}
