...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azurekeyvault/v1/spec.proto
...
func (AzureKeyVaultSku) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureKeyVaultSku) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_enumTypes[0]
}
...
func (AzureKeyVaultSku) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureKeyVaultNetworkAction) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureKeyVaultNetworkAction) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_enumTypes[1]
}
...
func (AzureKeyVaultNetworkAction) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type AzureKeyVaultSpec struct {
	...
	// Default: STANDARD
	Sku *AzureKeyVaultSku `protobuf:"varint,3,opt,name=sku,proto3,enum=org.openmcf.provider.azure.azurekeyvault.v1.AzureKeyVaultSku,oneof" json:"sku,omitempty"`
...
func (x *AzureKeyVaultSpec) Reset() {
	*x = AzureKeyVaultSpec{}
	mi := &file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_msgTypes[0]
...
type AzureKeyVaultNetworkAcls struct {
	...
	// Default: DENY
	DefaultAction *AzureKeyVaultNetworkAction `protobuf:"varint,1,opt,name=default_action,json=defaultAction,proto3,enum=org.openmcf.provider.azure.azurekeyvault.v1.AzureKeyVaultNetworkAction,oneof" json:"default_action,omitempty"`
...
func (x *AzureKeyVaultNetworkAcls) Reset() {
	*x = AzureKeyVaultNetworkAcls{}
	mi := &file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDesc = "" +
	...
	"\x0edefault_action\x18\x01 \x01(\x0e2G.org.openmcf.provider.azure.azurekeyvault.v1.AzureKeyVaultNetworkActionB\b\x8a\xa6\x1d\x04DENYH\x00R\rdefaultAction\x88\x01\x01\x12A\n" +
	...
	"/com.org.openmcf.provider.azure.azurekeyvault.v1B\tSpecProtoP\x01Z]github.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurekeyvault/v1;azurekeyvaultv1\xa2\x02\x05OOPAA\xaa\x02+Org.Openmcf.Provider.Azure.Azurekeyvault.V1\xca\x02+Org\\Openmcf\\Provider\\Azure\\Azurekeyvault\\V1\xe2\x027Org\\Openmcf\\Provider\\Azure\\Azurekeyvault\\V1\\GPBMetadata\xea\x020Org::Openmcf::Provider::Azure::Azurekeyvault::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_goTypes = []any{
	(AzureKeyVaultSku)(0),            // 0: org.openmcf.provider.azure.azurekeyvault.v1.AzureKeyVaultSku
...
func file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azurekeyvault_v1_spec_proto_depIdxs = nil
}
