...
**Provider:** azure  
**Component Path:** `apis/org/openmcf/provider/azure/azurekeyvault/v1/`  
**Enum Value:** 404  
**ID Prefix:** azkv
...
✅ **Passed:**
- Folder exists under correct provider hierarchy (apis/org/openmcf/provider/azure/azurekeyvault/)
...
**Path to reference:** `apis/org/openmcf/provider/aws/awssecretsmanager/v1/`
