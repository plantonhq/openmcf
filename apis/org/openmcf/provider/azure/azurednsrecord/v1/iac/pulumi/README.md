...
```bash
export STACK_INPUT='{"target":{"apiVersion":"azure.openmcf.org/v1","kind":"AzureDnsRecord","metadata":{"name":"test-record"},"spec":{"resource_group":"my-rg","zone_name":{"value":"example.com"},"record_type":"A","name":"www","values":["192.0.2.1"]}},"provider_config":{"client_id":"...","client_secret":"...","subscription_id":"...","tenant_id":"..."}}'
```
