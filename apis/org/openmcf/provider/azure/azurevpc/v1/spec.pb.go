...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azurevpc/v1/spec.proto
...
func (x *AzureVpcSpec) Reset() {
	*x = AzureVpcSpec{}
	mi := &file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_msgTypes[0]
...
var File_org_openmcf_provider_azure_azurevpc_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDesc = "" +
	...
	"\x16dns_private_zone_links\x18\x04 \x03(\tR\x13dnsPrivateZoneLinks\x12R\n" +
	"\x04tags\x18\x05 \x03(\v2>.org.openmcf.provider.azure.azurevpc.v1.AzureVpcSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xcb\x02\n" +
	"*com.org.openmcf.provider.azure.azurevpc.v1B\tSpecProtoP\x01ZSgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurevpc/v1;azurevpcv1\xa2\x02\x05OOPAA\xaa\x02&Org.Openmcf.Provider.Azure.Azurevpc.V1\xca\x02&Org\\Openmcf\\Provider\\Azure\\Azurevpc\\V1\xe2\x022Org\\Openmcf\\Provider\\Azure\\Azurevpc\\V1\\GPBMetadata\xea\x02+Org::Openmcf::Provider::Azure::Azurevpc::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDescData
}
...
func file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azurevpc_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azurevpc_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azurevpc_v1_spec_proto_depIdxs = nil
}
