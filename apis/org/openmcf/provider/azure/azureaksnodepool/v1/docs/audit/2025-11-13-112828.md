...
**Provider:** azure  
**Component Path:** `apis/org/openmcf/provider/azure/azureaksnodepool/v1/`  
**Enum Value:** 401  
**ID Prefix:** aksnp
...
✅ **Passed:**
- Folder exists under correct provider hierarchy: `apis/org/openmcf/provider/azure/azureaksnodepool/`
...
- Tests execute successfully: `go test ./apis/org/openmcf/provider/azure/azureaksnodepool/v1/`
...
5. **Re-run audit to verify improvements** - Use `@audit-openmcf-component AzureAksNodePool`
