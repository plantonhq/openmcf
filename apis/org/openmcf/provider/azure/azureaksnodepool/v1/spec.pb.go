...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azureaksnodepool/v1/spec.proto
...
func (AzureAksNodePoolOsType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureAksNodePoolOsType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_enumTypes[0]
}
...
func (AzureAksNodePoolOsType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureAksNodePoolMode) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureAksNodePoolMode) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_enumTypes[1]
}
...
func (AzureAksNodePoolMode) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type AzureAksNodePoolSpec struct {
	...
	OsType *AzureAksNodePoolOsType `protobuf:"varint,6,opt,name=os_type,json=osType,proto3,enum=org.openmcf.provider.azure.azureaksnodepool.v1.AzureAksNodePoolOsType,oneof" json:"os_type,omitempty"`
...
func (x *AzureAksNodePoolSpec) Reset() {
	*x = AzureAksNodePoolSpec{}
	mi := &file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_msgTypes[0]
...
func (x *AzureAksNodePoolAutoscaling) Reset() {
	*x = AzureAksNodePoolAutoscaling{}
	mi := &file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDesc = "" +
	...
	"\vautoscaling\x18\x04 \x01(\v2K.org.openmcf.provider.azure.azureaksnodepool.v1.AzureAksNodePoolAutoscalingR\vautoscaling\x12G\n" +
	...
	"2com.org.openmcf.provider.azure.azureaksnodepool.v1B\tSpecProtoP\x01Zcgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azureaksnodepool/v1;azureaksnodepoolv1\xa2\x02\x05OOPAA\xaa\x02.Org.Openmcf.Provider.Azure.Azureaksnodepool.V1\xca\x02.Org\\Openmcf\\Provider\\Azure\\Azureaksnodepool\\V1\xe2\x02:Org\\Openmcf\\Provider\\Azure\\Azureaksnodepool\\V1\\GPBMetadata\xea\x023Org::Openmcf::Provider::Azure::Azureaksnodepool::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_goTypes = []any{
	(AzureAksNodePoolOsType)(0),         // 0: org.openmcf.provider.azure.azureaksnodepool.v1.AzureAksNodePoolOsType
	(AzureAksNodePoolMode)(0),           // 1: org.openmcf.provider.azure.azureaksnodepool.v1.AzureAksNodePoolMode
	(*AzureAksNodePoolSpec)(nil),        // 2: org.openmcf.provider.azure.azureaksnodepool.v1.AzureAksNodePoolSpec
	(*AzureAksNodePoolAutoscaling)(nil), // 3: org.openmcf.provider.azure.azureaksnodepool.v1.AzureAksNodePoolAutoscaling
	(*v1.StringValueOrRef)(nil),         // 4: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_depIdxs = []int32{
	4, // 0: org.openmcf.provider.azure.azureaksnodepool.v1.AzureAksNodePoolSpec.cluster_name:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azureaksnodepool_v1_spec_proto_depIdxs = nil
}
