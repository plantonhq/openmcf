...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azureakscluster/v1/spec.proto
...
func (AzureAksClusterControlPlaneSku) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureAksClusterControlPlaneSku) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes[0]
}
...
func (AzureAksClusterControlPlaneSku) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureAksClusterNetworkPlugin) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureAksClusterNetworkPlugin) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes[1]
}
...
func (AzureAksClusterNetworkPlugin) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureAksClusterNetworkPluginMode) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureAksClusterNetworkPluginMode) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes[2]
}
...
func (AzureAksClusterNetworkPluginMode) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
type AzureAksClusterSpec struct {
	...
	ControlPlaneSku AzureAksClusterControlPlaneSku `protobuf:"varint,4,opt,name=control_plane_sku,json=controlPlaneSku,proto3,enum=org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterControlPlaneSku" json:"control_plane_sku,omitempty"`
	...
	NetworkPlugin AzureAksClusterNetworkPlugin `protobuf:"varint,5,opt,name=network_plugin,json=networkPlugin,proto3,enum=org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterNetworkPlugin" json:"network_plugin,omitempty"`
	...
	// Defaults to OVERLAY.
	NetworkPluginMode AzureAksClusterNetworkPluginMode `protobuf:"varint,6,opt,name=network_plugin_mode,json=networkPluginMode,proto3,enum=org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterNetworkPluginMode" json:"network_plugin_mode,omitempty"`
...
func (x *AzureAksClusterSpec) Reset() {
	*x = AzureAksClusterSpec{}
	mi := &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes[0]
...
func (x *AzureAksClusterAutoscalingConfig) Reset() {
	*x = AzureAksClusterAutoscalingConfig{}
	mi := &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureAksClusterSystemNodePool) Reset() {
	*x = AzureAksClusterSystemNodePool{}
	mi := &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureAksClusterUserNodePool) Reset() {
	*x = AzureAksClusterUserNodePool{}
	mi := &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureAksClusterUserNodePool) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AzureAksClusterAddonsConfig) Reset() {
	*x = AzureAksClusterAddonsConfig{}
	mi := &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureAksClusterAddonsConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AzureAksClusterAdvancedNetworking) Reset() {
	*x = AzureAksClusterAdvancedNetworking{}
	mi := &file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureAksClusterAdvancedNetworking) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
var File_org_openmcf_provider_azure_azureakscluster_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8org/openmcf/provider/azure/azureakscluster/v1/spec.proto\x12-org.openmcf.provider.azure.azureakscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xe9\n" +
	"\n" +
	...
	"\x13network_plugin_mode\x18\x06 \x01(\x0e2O.org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterNetworkPluginModeR\x11networkPluginMode\x126\n" +
	...
	"\x15disable_azure_ad_rbac\x18\t \x01(\bR\x12disableAzureAdRbac\x12~\n" +
	"\x10system_node_pool\x18\n" +
	" \x01(\v2L.org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSystemNodePoolB\x06\xbaH\x03\xc8\x01\x01R\x0esystemNodePool\x12r\n" +
	"\x0fuser_node_pools\x18\v \x03(\v2J.org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterUserNodePoolR\ruserNodePools\x12b\n" +
	"\x06addons\x18\f \x01(\v2J.org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAddonsConfigR\x06addons\x12\x81\x01\n" +
	"\x13advanced_networking\x18\r \x01(\v2P.org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAdvancedNetworkingR\x12advancedNetworking\"n\n" +
	" AzureAksClusterAutoscalingConfig\x12$\n" +
	"\tmin_count\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\bminCount\x12$\n" +
	"\tmax_count\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\bmaxCount\"\x87\x02\n" +
	"\x1dAzureAksClusterSystemNodePool\x122\n" +
	"\avm_size\x18\x01 \x01(\tB\x19\xbaH\x03\xc8\x01\x01\x92\xa6\x1d\x0fStandard_D4s_v5R\x06vmSize\x12y\n" +
	"\vautoscaling\x18\x02 \x01(\v2O.org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAutoscalingConfigB\x06\xbaH\x03\xc8\x01\x01R\vautoscaling\x127\n" +
	"\x12availability_zones\x18\x03 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\x11availabilityZones\"\xc5\x02\n" +
	"\x1bAzureAksClusterUserNodePool\x12.\n" +
	"\x04name\x18\x01 \x01(\tB\x1a\xbaH\x17\xc8\x01\x01r\x122\x10^[a-z0-9]{1,12}$R\x04name\x12\x1f\n" +
	"\avm_size\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x06vmSize\x12y\n" +
	"\vautoscaling\x18\x03 \x01(\v2O.org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAutoscalingConfigB\x06\xbaH\x03\xc8\x01\x01R\vautoscaling\x127\n" +
	...
	"\aDYNAMIC\x10\x01B\xfc\x02\n" +
	"1com.org.openmcf.provider.azure.azureakscluster.v1B\tSpecProtoP\x01Zagithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azureakscluster/v1;azureaksclusterv1\xa2\x02\x05OOPAA\xaa\x02-Org.Openmcf.Provider.Azure.Azureakscluster.V1\xca\x02-Org\\Openmcf\\Provider\\Azure\\Azureakscluster\\V1\xe2\x029Org\\Openmcf\\Provider\\Azure\\Azureakscluster\\V1\\GPBMetadata\xea\x022Org::Openmcf::Provider::Azure::Azureakscluster::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_goTypes = []any{
	(AzureAksClusterControlPlaneSku)(0),       // 0: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterControlPlaneSku
	(AzureAksClusterNetworkPlugin)(0),         // 1: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterNetworkPlugin
	(AzureAksClusterNetworkPluginMode)(0),     // 2: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterNetworkPluginMode
	(*AzureAksClusterSpec)(nil),               // 3: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec
	(*AzureAksClusterAutoscalingConfig)(nil),  // 4: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAutoscalingConfig
	(*AzureAksClusterSystemNodePool)(nil),     // 5: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSystemNodePool
	(*AzureAksClusterUserNodePool)(nil),       // 6: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterUserNodePool
	(*AzureAksClusterAddonsConfig)(nil),       // 7: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAddonsConfig
	(*AzureAksClusterAdvancedNetworking)(nil), // 8: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAdvancedNetworking
	(*v1.StringValueOrRef)(nil),               // 9: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_depIdxs = []int32{
	9,  // 0: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.vnet_subnet_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0,  // 1: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.control_plane_sku:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterControlPlaneSku
	1,  // 2: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.network_plugin:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterNetworkPlugin
	2,  // 3: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.network_plugin_mode:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterNetworkPluginMode
	5,  // 4: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.system_node_pool:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSystemNodePool
	6,  // 5: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.user_node_pools:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterUserNodePool
	7,  // 6: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.addons:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAddonsConfig
	8,  // 7: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSpec.advanced_networking:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAdvancedNetworking
	4,  // 8: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterSystemNodePool.autoscaling:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAutoscalingConfig
	4,  // 9: org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterUserNodePool.autoscaling:type_name -> org.openmcf.provider.azure.azureakscluster.v1.AzureAksClusterAutoscalingConfig
...
func init() { file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_init() }
func file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azureakscluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azureakscluster_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azureakscluster_v1_spec_proto_depIdxs = nil
}
