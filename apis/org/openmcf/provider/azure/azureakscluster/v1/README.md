...
OpenMCF provisions AKS clusters via Pulumi or Terraform modules defined in this repository. The resource follows Microsoft's baseline architecture for production-ready AKS deployments:
