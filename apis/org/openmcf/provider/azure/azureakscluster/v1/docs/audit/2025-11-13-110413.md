...
- Folder exists under correct provider hierarchy: `apis/org/openmcf/provider/azure/azureakscluster/`
...
- Tests execute successfully: `go test ./apis/org/openmcf/provider/azure/azureakscluster/v1/`
...
PASS
ok  	github.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azureakscluster/v1	0.487s
```
...
1. **Add v1/examples.md**
   ...
   - **File:** `apis/org/openmcf/provider/azure/azureakscluster/v1/examples.md`
...
**Path to reference:** `apis/org/openmcf/provider/aws/awsekscluster/v1/`
