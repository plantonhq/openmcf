...
**Provider:** azure  
**Component Path:** `apis/org/openmcf/provider/azure/azurenatgateway/v1/`  
**Enum Value:** 406  
**ID Prefix:** aznat
...
✅ **Passed:**
- Folder exists at correct path: `apis/org/openmcf/provider/azure/azurenatgateway/v1/`
...
- Tests execute successfully: `ok github.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurenatgateway/v1 0.399s`
...
- Shows OpenMCF approach with example YAML configurations
...
4. **Fix v1/README.md**
   ...
   - **How:** Replace with NAT Gateway overview:
     ...
     - Why OpenMCF created this component
...
**Path to reference:** `apis/org/openmcf/provider/azure/azurevpc/v1/`
