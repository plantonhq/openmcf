...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azurenatgateway/v1/spec.proto
...
func (x *AzureNatGatewaySpec) Reset() {
	*x = AzureNatGatewaySpec{}
	mi := &file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_msgTypes[0]
...
func (*AzureNatGatewaySpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
const file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDesc = "" +
	...
	"1com.org.openmcf.provider.azure.azurenatgateway.v1B\tSpecProtoP\x01Zagithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurenatgateway/v1;azurenatgatewayv1\xa2\x02\x05OOPAA\xaa\x02-Org.Openmcf.Provider.Azure.Azurenatgateway.V1\xca\x02-Org\\Openmcf\\Provider\\Azure\\Azurenatgateway\\V1\xe2\x029Org\\Openmcf\\Provider\\Azure\\Azurenatgateway\\V1\\GPBMetadata\xea\x022Org::Openmcf::Provider::Azure::Azurenatgateway::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_goTypes = []any{
	(*AzureNatGatewaySpec)(nil), // 0: org.openmcf.provider.azure.azurenatgateway.v1.AzureNatGatewaySpec
	nil,                         // 1: org.openmcf.provider.azure.azurenatgateway.v1.AzureNatGatewaySpec.TagsEntry
...
func file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_init() {
	if File_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto = out.File
	file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_azure_azurenatgateway_v1_spec_proto_depIdxs = nil
}
