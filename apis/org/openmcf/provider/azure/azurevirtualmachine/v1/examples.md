...
Copy-paste ready examples for deploying Azure Virtual Machines with OpenMCF.
...
openmcf terraform apply --manifest vm.yaml

# Preview changes before deploying
openmcf pulumi preview --manifest vm.yaml
```
