...
// 	protoc        (unknown)
// source: org/openmcf/provider/azure/azurevirtualmachine/v1/stack_outputs.proto
...
func (x *AzureVirtualMachineStackOutputs) Reset() {
	*x = AzureVirtualMachineStackOutputs{}
	mi := &file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_msgTypes[0]
...
func (*AzureVirtualMachineStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Eorg/openmcf/provider/azure/azurevirtualmachine/v1/stack_outputs.proto\x121org.openmcf.provider.azure.azurevirtualmachine.v1\"\xa5\x03\n" +
	...
	"5com.org.openmcf.provider.azure.azurevirtualmachine.v1B\x11StackOutputsProtoP\x01Zigithub.com/plantonhq/openmcf/apis/org/openmcf/provider/azure/azurevirtualmachine/v1;azurevirtualmachinev1\xa2\x02\x05OOPAA\xaa\x021Org.Openmcf.Provider.Azure.Azurevirtualmachine.V1\xca\x021Org\\Openmcf\\Provider\\Azure\\Azurevirtualmachine\\V1\xe2\x02=Org\\Openmcf\\Provider\\Azure\\Azurevirtualmachine\\V1\\GPBMetadata\xea\x026Org::Openmcf::Provider::Azure::Azurevirtualmachine::V1b\x06proto3"

var (
	file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDescData
}

var file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_goTypes = []any{
	(*AzureVirtualMachineStackOutputs)(nil), // 0: org.openmcf.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineStackOutputs
}
var file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_init() }
func file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_azure_azurevirtualmachine_v1_stack_outputs_proto_depIdxs = nil
}
