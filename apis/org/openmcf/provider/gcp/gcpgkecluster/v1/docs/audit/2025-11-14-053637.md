...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/`  
**Enum Value:** 607  
**ID Prefix:** gke
...
1. **Create User-Facing README.md**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/examples.md`
...
3. **Create iac/pulumi/README.md**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/iac/pulumi/README.md`
...
1. **Empty Terraform main.tf file**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/iac/tf/main.tf`
...
2. **Missing Terraform locals.tf**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/iac/tf/locals.tf`
...
3. **Missing Research Documentation (docs/README.md)**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/docs/README.md`
...
4. **Missing Terraform variables.tf content**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/iac/tf/variables.tf`
...
- Folder exists at correct location: `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpgkecluster/v1/
go test -v
```
...
- Validation rules verified:
  - api_version must be "gcp.openmcf.org/v1"
...
7. **Create iac/pulumi/overview.md**
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/iac/pulumi/overview.md`
...
8. **Create iac/tf/README.md**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/iac/tf/README.md`
...
- `apis/org/openmcf/provider/aws/awsekscluster/v1/`
...
5. **Re-run audit to verify improvements**:
   ```bash
   @audit-openmcf-component GcpGkeCluster
   ```
