...
Once your YAML manifest is ready, deploy using the OpenMCF CLI:

- **Using Pulumi**:
  ```bash
  openmcf pulumi up --manifest gcpgkecluster.yaml --stack org/project/my-stack
  ```

- **Using Terraform**:
  ```bash
  openmcf terraform apply --manifest gcpgkecluster.yaml --stack org/project/my-stack
  ```
