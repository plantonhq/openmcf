...
- `merged_node_labels`: OpenMCF labels + user-specified node labels
...
## Integration with OpenMCF CLI

This module is typically invoked via the OpenMCF CLI, not standalone. The CLI:
...
- **OpenMCF Repository**: https://github.com/plantonhq/openmcf
