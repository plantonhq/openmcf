...
// 	protoc        (unknown)
// source: org/openmcf/provider/gcp/gcpgkenodepool/v1/spec.proto
...
func (x *GcpGkeNodePoolSpec) Reset() {
	*x = GcpGkeNodePoolSpec{}
	mi := &file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[0]
...
func (*GcpGkeNodePoolSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGkeNodePoolAutoscaling) Reset() {
	*x = GcpGkeNodePoolAutoscaling{}
	mi := &file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolAutoscaling) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpGkeClusterNodePoolNodeManagement) Reset() {
	*x = GcpGkeClusterNodePoolNodeManagement{}
	mi := &file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeClusterNodePoolNodeManagement) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc = "" +
	"\n" +
	"5org/openmcf/provider/gcp/gcpgkenodepool/v1/spec.proto\x12*org.openmcf.provider.gcp.gcpgkenodepool.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xf9\t\n" +
	"\x12GcpGkeNodePoolSpec\x12\x80\x01\n" +
	"\x12cluster_project_id\x18\x01 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1e\xbaH\x03\xc8\x01\x01\x88\xd4a\xdf\x04\x92\xd4a\x0fspec.project_idR\x10clusterProjectId\x12s\n" +
	"\fcluster_name\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1c\xbaH\x03\xc8\x01\x01\x88\xd4a\xdf\x04\x92\xd4a\rmetadata.nameR\vclusterName\x12{\n" +
	"\x10cluster_location\x18\x03 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\x1c\xbaH\x03\xc8\x01\x01\x88\xd4a\xdf\x04\x92\xd4a\rspec.locationR\x0fclusterLocation\x125\n" +
	...
	"\n" +
	"management\x18\t \x01(\v2O.org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeClusterNodePoolNodeManagementB\x06\xbaH\x03\xc8\x01\x00R\n" +
	"management\x12\x12\n" +
	"\x04spot\x18\n" +
	" \x01(\bR\x04spot\x12o\n" +
	"\vnode_labels\x18\v \x03(\v2N.org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.NodeLabelsEntryR\n" +
	"nodeLabels\x12\x1f\n" +
	"\n" +
	"node_count\x18d \x01(\rH\x00R\tnodeCount\x12i\n" +
	"\vautoscaling\x18e \x01(\v2E.org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolAutoscalingH\x00R\vautoscaling\x12Q\n" +
	...
	".com.org.openmcf.provider.gcp.gcpgkenodepool.v1B\tSpecProtoP\x01Z]github.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpgkenodepool/v1;gcpgkenodepoolv1\xa2\x02\x05OOPGG\xaa\x02*Org.Openmcf.Provider.Gcp.Gcpgkenodepool.V1\xca\x02*Org\\Openmcf\\Provider\\Gcp\\Gcpgkenodepool\\V1\xe2\x026Org\\Openmcf\\Provider\\Gcp\\Gcpgkenodepool\\V1\\GPBMetadata\xea\x02/Org::Openmcf::Provider::Gcp::Gcpgkenodepool::V1b\x06proto3"

var (
	file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes = []any{
	(*GcpGkeNodePoolSpec)(nil),                  // 0: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec
	(*GcpGkeNodePoolAutoscaling)(nil),           // 1: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolAutoscaling
	(*GcpGkeClusterNodePoolNodeManagement)(nil), // 2: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeClusterNodePoolNodeManagement
	nil,                         // 3: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.NodeLabelsEntry
	(*v1.StringValueOrRef)(nil), // 4: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs = []int32{
	4, // 0: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.cluster_project_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	4, // 1: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.cluster_name:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	4, // 2: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.cluster_location:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 3: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.management:type_name -> org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeClusterNodePoolNodeManagement
	3, // 4: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.node_labels:type_name -> org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.NodeLabelsEntry
	1, // 5: org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.autoscaling:type_name -> org.openmcf.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolAutoscaling
...
func init() { file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_init() }
func file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_init() {
	if File_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
		(*GcpGkeNodePoolSpec_NodeCount)(nil),
		(*GcpGkeNodePoolSpec_Autoscaling)(nil),
	}
	file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto = out.File
	file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs = nil
}
