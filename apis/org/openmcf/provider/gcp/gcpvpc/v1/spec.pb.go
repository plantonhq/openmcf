...
// 	protoc        (unknown)
// source: org/openmcf/provider/gcp/gcpvpc/v1/spec.proto
...
func (GcpVpcRoutingMode) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpVpcRoutingMode) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_enumTypes[0]
}
...
func (GcpVpcRoutingMode) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpVpcPrivateServicesAccess) Reset() {
	*x = GcpVpcPrivateServicesAccess{}
	mi := &file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_msgTypes[0]
...
type GcpVpcSpec struct {
	...
	RoutingMode *GcpVpcRoutingMode `protobuf:"varint,3,opt,name=routing_mode,json=routingMode,proto3,enum=org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcRoutingMode,oneof" json:"routing_mode,omitempty"`
...
func (x *GcpVpcSpec) Reset() {
	*x = GcpVpcSpec{}
	mi := &file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpVpcSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDesc = "" +
	"\n" +
	"-org/openmcf/provider/gcp/gcpvpc/v1/spec.proto\x12\"org.openmcf.provider.gcp.gcpvpc.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\x80\x01\n" +
	...
	"\frouting_mode\x18\x03 \x01(\x0e25.org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcRoutingModeB\f\x8a\xa6\x1d\bREGIONALH\x00R\vroutingMode\x88\x01\x01\x12N\n" +
	"\fnetwork_name\x18\x04 \x01(\tB+\xbaH(\xc8\x01\x01r#2!^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$R\vnetworkName\x12w\n" +
	"\x17private_services_access\x18\x05 \x01(\v2?.org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcPrivateServicesAccessR\x15privateServicesAccessB\x0f\n" +
	"\r_routing_mode*-\n" +
	"\x11GcpVpcRoutingMode\x12\f\n" +
	"\bREGIONAL\x10\x00\x12\n" +
	"\n" +
	"\x06GLOBAL\x10\x01B\xb1\x02\n" +
	"&com.org.openmcf.provider.gcp.gcpvpc.v1B\tSpecProtoP\x01ZMgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpvpc/v1;gcpvpcv1\xa2\x02\x05OOPGG\xaa\x02\"Org.Openmcf.Provider.Gcp.Gcpvpc.V1\xca\x02\"Org\\Openmcf\\Provider\\Gcp\\Gcpvpc\\V1\xe2\x02.Org\\Openmcf\\Provider\\Gcp\\Gcpvpc\\V1\\GPBMetadata\xea\x02'Org::Openmcf::Provider::Gcp::Gcpvpc::V1b\x06proto3"

var (
	file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_goTypes = []any{
	(GcpVpcRoutingMode)(0),              // 0: org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcRoutingMode
	(*GcpVpcPrivateServicesAccess)(nil), // 1: org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcPrivateServicesAccess
	(*GcpVpcSpec)(nil),                  // 2: org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcSpec
	(*v1.StringValueOrRef)(nil),         // 3: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcSpec.project_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0, // 1: org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcSpec.routing_mode:type_name -> org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcRoutingMode
	1, // 2: org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcSpec.private_services_access:type_name -> org.openmcf.provider.gcp.gcpvpc.v1.GcpVpcPrivateServicesAccess
...
func init() { file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_init() }
func file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_init() {
	if File_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto = out.File
	file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_gcp_gcpvpc_v1_spec_proto_depIdxs = nil
}
