...
This directory contains the Pulumi implementation for deploying GCP VPC networks using OpenMCF's `GcpVpc` API. The module is written in Go and leverages the Pulumi GCP provider to create production-ready Virtual Private Cloud networks with best-practice defaults.
...
# Update OpenMCF dependencies to latest
make update-deps
```
...
import (
    ...
    "github.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpvpc/v1/iac/pulumi/module"
)
...
- [OpenMCF Architecture Overview](../../docs/README.md)
...
4. Open an issue in the OpenMCF repository
