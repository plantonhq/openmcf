...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/`  
**Enum Value:** 611  
**ID Prefix:** gcpsnw
...
1. **Create user-facing README.md**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/README.md`
...
2. **Create examples.md**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/examples.md`
...
3. **Create Pulumi README.md**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/iac/pulumi/README.md`
...
1. **Terraform main.tf is completely empty (0 bytes)**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/iac/tf/main.tf`
...
2. **Terraform outputs.tf is empty (0 bytes)**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/iac/tf/outputs.tf`
...
3. **Missing locals.tf for Terraform**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/iac/tf/locals.tf`
...
- Folder exists at correct path: `apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpsubnetwork/v1/
go test -v
```
...
5. **Re-run audit** to verify improvements: `@audit-openmcf-component GcpSubnetwork`
