...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpgkeworkloadidentitybinding/v1/`  
**Enum Value:** 615  
**ID Prefix:** gkewib
...
- Folder exists: `apis/org/openmcf/provider/gcp/gcpgkeworkloadidentitybinding/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpgkeworkloadidentitybinding/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/gcp/gcpserviceaccount/v1/`
