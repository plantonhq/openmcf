...
The module expects GCP credentials to be provided via the stack input's `provider_config`. OpenMCF's CLI handles this automatically, but for standalone use:
