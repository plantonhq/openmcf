...
- **Using Pulumi**:
  ```bash
  openmcf pulumi up --manifest gcp_project.yaml --stack org/project/my-gcp-stack
  ```

- **Using Terraform**:
  ```bash
  openmcf terraform apply --manifest gcp_project.yaml --stack org/project/my-gcp-stack
  ```
