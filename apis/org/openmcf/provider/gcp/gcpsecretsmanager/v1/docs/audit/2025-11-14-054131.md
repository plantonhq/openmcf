...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpsecretsmanager/v1/`  
**Enum Value:** 608  
**ID Prefix:** gcpsm
...
- Folder exists: `apis/org/openmcf/provider/gcp/gcpsecretsmanager/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpsecretsmanager/v1/
go test -v
```
