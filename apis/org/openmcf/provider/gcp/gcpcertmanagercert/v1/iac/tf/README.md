...
### Using OpenMCF CLI (Recommended)

```bash
openmcf terraform apply --manifest cert.yaml --stack org/project/stack
```
...
This Terraform module integrates with OpenMCF CLI, which:
...
- Use OpenMCF CLI for production workflows
