...
// 	protoc        (unknown)
// source: org/openmcf/provider/gcp/gcpcertmanagercert/v1/spec.proto
...
func (CertificateType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CertificateType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_enumTypes[0]
}
...
func (CertificateType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type GcpCertManagerCertSpec struct {
	...
	CertificateType *CertificateType `protobuf:"varint,5,opt,name=certificate_type,json=certificateType,proto3,enum=org.openmcf.provider.gcp.gcpcertmanagercert.v1.CertificateType,oneof" json:"certificate_type,omitempty"`
...
func (x *GcpCertManagerCertSpec) Reset() {
	*x = GcpCertManagerCertSpec{}
	mi := &file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_msgTypes[0]
...
var File_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDesc = "" +
	...
	"2com.org.openmcf.provider.gcp.gcpcertmanagercert.v1B\tSpecProtoP\x01Zegithub.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpcertmanagercert/v1;gcpcertmanagercertv1\xa2\x02\x05OOPGG\xaa\x02.Org.Openmcf.Provider.Gcp.Gcpcertmanagercert.V1\xca\x02.Org\\Openmcf\\Provider\\Gcp\\Gcpcertmanagercert\\V1\xe2\x02:Org\\Openmcf\\Provider\\Gcp\\Gcpcertmanagercert\\V1\\GPBMetadata\xea\x023Org::Openmcf::Provider::Gcp::Gcpcertmanagercert::V1b\x06proto3"

var (
	file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_goTypes = []any{
	(CertificateType)(0),           // 0: org.openmcf.provider.gcp.gcpcertmanagercert.v1.CertificateType
	(*GcpCertManagerCertSpec)(nil), // 1: org.openmcf.provider.gcp.gcpcertmanagercert.v1.GcpCertManagerCertSpec
	(*v1.StringValueOrRef)(nil),    // 2: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.openmcf.provider.gcp.gcpcertmanagercert.v1.GcpCertManagerCertSpec.cloud_dns_zone_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0, // 1: org.openmcf.provider.gcp.gcpcertmanagercert.v1.GcpCertManagerCertSpec.certificate_type:type_name -> org.openmcf.provider.gcp.gcpcertmanagercert.v1.CertificateType
...
func init() { file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_init() }
func file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_init() {
	if File_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto = out.File
	file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_gcp_gcpcertmanagercert_v1_spec_proto_depIdxs = nil
}
