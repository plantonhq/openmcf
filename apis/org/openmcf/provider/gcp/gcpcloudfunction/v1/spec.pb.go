...
// 	protoc        (unknown)
// source: org/openmcf/provider/gcp/gcpcloudfunction/v1/spec.proto
...
func (GcpCloudFunctionTriggerType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpCloudFunctionTriggerType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[0]
}
...
func (GcpCloudFunctionTriggerType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (GcpCloudFunctionIngressSetting) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[1].Descriptor()
}

func (GcpCloudFunctionIngressSetting) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[1]
}
...
func (GcpCloudFunctionIngressSetting) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (GcpCloudFunctionVpcEgressSetting) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[2].Descriptor()
}

func (GcpCloudFunctionVpcEgressSetting) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[2]
}
...
func (GcpCloudFunctionVpcEgressSetting) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (GcpCloudFunctionRetryPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[3].Descriptor()
}

func (GcpCloudFunctionRetryPolicy) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes[3]
}
...
func (GcpCloudFunctionRetryPolicy) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpCloudFunctionSpec) Reset() {
	*x = GcpCloudFunctionSpec{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[0]
...
func (x *GcpCloudFunctionBuildConfig) Reset() {
	*x = GcpCloudFunctionBuildConfig{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GcpCloudFunctionSource) Reset() {
	*x = GcpCloudFunctionSource{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type GcpCloudFunctionServiceConfig struct {
	...
	VpcConnectorEgressSettings GcpCloudFunctionVpcEgressSetting `protobuf:"varint,8,opt,name=vpc_connector_egress_settings,json=vpcConnectorEgressSettings,proto3,enum=org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionVpcEgressSetting" json:"vpc_connector_egress_settings,omitempty"`
	...
	IngressSettings GcpCloudFunctionIngressSetting `protobuf:"varint,9,opt,name=ingress_settings,json=ingressSettings,proto3,enum=org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionIngressSetting" json:"ingress_settings,omitempty"`
...
func (x *GcpCloudFunctionServiceConfig) Reset() {
	*x = GcpCloudFunctionServiceConfig{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GcpCloudFunctionScalingConfig) Reset() {
	*x = GcpCloudFunctionScalingConfig{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionScalingConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
type GcpCloudFunctionTrigger struct {
	...
	TriggerType GcpCloudFunctionTriggerType `protobuf:"varint,1,opt,name=trigger_type,json=triggerType,proto3,enum=org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTriggerType" json:"trigger_type,omitempty"`
...
func (x *GcpCloudFunctionTrigger) Reset() {
	*x = GcpCloudFunctionTrigger{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionTrigger) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
type GcpCloudFunctionEventTrigger struct {
	...
	RetryPolicy GcpCloudFunctionRetryPolicy `protobuf:"varint,5,opt,name=retry_policy,json=retryPolicy,proto3,enum=org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionRetryPolicy" json:"retry_policy,omitempty"`
...
func (x *GcpCloudFunctionEventTrigger) Reset() {
	*x = GcpCloudFunctionEventTrigger{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionEventTrigger) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpCloudFunctionEventFilter) Reset() {
	*x = GcpCloudFunctionEventFilter{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudFunctionEventFilter) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
var File_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDesc = "" +
	"\n" +
	"7org/openmcf/provider/gcp/gcpcloudfunction/v1/spec.proto\x12,org.openmcf.provider.gcp.gcpcloudfunction.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xea\x04\n" +
	...
	"\fbuild_config\x18\x04 \x01(\v2I.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfigB\x06\xbaH\x03\xc8\x01\x01R\vbuildConfig\x12r\n" +
	"\x0eservice_config\x18\x05 \x01(\v2K.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfigR\rserviceConfig\x12_\n" +
	"\atrigger\x18\x06 \x01(\v2E.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTriggerR\atrigger\"\xb6\x04\n" +
	...
	"entryPoint\x12d\n" +
	"\x06source\x18\x03 \x01(\v2D.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSourceB\x06\xbaH\x03\xc8\x01\x01R\x06source\x12\xa8\x01\n" +
	"\x1bbuild_environment_variables\x18\x04 \x03(\v2h.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfig.BuildEnvironmentVariablesEntryR\x19buildEnvironmentVariables\x1aL\n" +
	...
	" max_instance_request_concurrency\x18\x04 \x01(\x05B\x10\xbaH\a\x1a\x05\x18\xe8\a(\x01\x92\xa6\x1d\x0280R\x1dmaxInstanceRequestConcurrency\x12\x9a\x01\n" +
	"\x15environment_variables\x18\x05 \x03(\v2e.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.EnvironmentVariablesEntryR\x14environmentVariables\x12\xad\x01\n" +
	"\x1csecret_environment_variables\x18\x06 \x03(\v2k.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.SecretEnvironmentVariablesEntryR\x1asecretEnvironmentVariables\x12\x9e\x01\n" +
	"\rvpc_connector\x18\a \x01(\tBy\xbaHv\xd8\x01\x01rq2o^projects/[a-z][a-z0-9-]{4,28}[a-z0-9]/locations/[a-z]+-[a-z]+[0-9]/connectors/[a-z]([a-z0-9-]{0,61}[a-z0-9])?$R\fvpcConnector\x12\xaa\x01\n" +
	"\x1dvpc_connector_egress_settings\x18\b \x01(\x0e2N.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionVpcEgressSettingB\x17\x92\xa6\x1d\x13PRIVATE_RANGES_ONLYR\x1avpcConnectorEgressSettings\x12\x86\x01\n" +
	"\x10ingress_settings\x18\t \x01(\x0e2L.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionIngressSettingB\r\x92\xa6\x1d\tALLOW_ALLR\x0fingressSettings\x12e\n" +
	"\ascaling\x18\n" +
	" \x01(\v2K.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionScalingConfigR\ascaling\x12>\n" +
	...
	"\x13scaling.min-lte-max\x12Cmin_instance_count must be less than or equal to max_instance_count\x1a2this.min_instance_count <= this.max_instance_count\"\x9d\x03\n" +
	"\x17GcpCloudFunctionTrigger\x12v\n" +
	"\ftrigger_type\x18\x01 \x01(\x0e2I.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTriggerTypeB\b\x92\xa6\x1d\x04HTTPR\vtriggerType\x12o\n" +
	"\revent_trigger\x18\x02 \x01(\v2J.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventTriggerR\feventTrigger:\x98\x01\xbaH\x94\x01\x1a\x91\x01\n" +
	...
	"\revent_filters\x18\x03 \x03(\v2I.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventFilterR\feventFilters\x12E\n" +
	"\x0etrigger_region\x18\x04 \x01(\tB\x1e\xbaH\x1b\xd8\x01\x01r\x162\x14^[a-z]+-[a-z]+[0-9]$R\rtriggerRegion\x12\x8b\x01\n" +
	"\fretry_policy\x18\x05 \x01(\x0e2I.org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionRetryPolicyB\x1d\x92\xa6\x1d\x19RETRY_POLICY_DO_NOT_RETRYR\vretryPolicy\x12p\n" +
	...
	"0com.org.openmcf.provider.gcp.gcpcloudfunction.v1B\tSpecProtoP\x01Zagithub.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpcloudfunction/v1;gcpcloudfunctionv1\xa2\x02\x05OOPGG\xaa\x02,Org.Openmcf.Provider.Gcp.Gcpcloudfunction.V1\xca\x02,Org\\Openmcf\\Provider\\Gcp\\Gcpcloudfunction\\V1\xe2\x028Org\\Openmcf\\Provider\\Gcp\\Gcpcloudfunction\\V1\\GPBMetadata\xea\x021Org::Openmcf::Provider::Gcp::Gcpcloudfunction::V1b\x06proto3"

var (
	file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_goTypes = []any{
	(GcpCloudFunctionTriggerType)(0),      // 0: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTriggerType
	(GcpCloudFunctionIngressSetting)(0),   // 1: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionIngressSetting
	(GcpCloudFunctionVpcEgressSetting)(0), // 2: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionVpcEgressSetting
	(GcpCloudFunctionRetryPolicy)(0),      // 3: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionRetryPolicy
	(*GcpCloudFunctionSpec)(nil),          // 4: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSpec
	(*GcpCloudFunctionBuildConfig)(nil),   // 5: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfig
	(*GcpCloudFunctionSource)(nil),        // 6: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSource
	(*GcpCloudFunctionServiceConfig)(nil), // 7: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig
	(*GcpCloudFunctionScalingConfig)(nil), // 8: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionScalingConfig
	(*GcpCloudFunctionTrigger)(nil),       // 9: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTrigger
	(*GcpCloudFunctionEventTrigger)(nil),  // 10: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventTrigger
	(*GcpCloudFunctionEventFilter)(nil),   // 11: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventFilter
	nil,                                   // 12: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfig.BuildEnvironmentVariablesEntry
	nil,                                   // 13: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.EnvironmentVariablesEntry
	nil,                                   // 14: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.SecretEnvironmentVariablesEntry
	(*v1.StringValueOrRef)(nil),           // 15: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_depIdxs = []int32{
	15, // 0: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSpec.project_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	5,  // 1: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSpec.build_config:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfig
	7,  // 2: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSpec.service_config:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig
	9,  // 3: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSpec.trigger:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTrigger
	6,  // 4: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfig.source:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionSource
	12, // 5: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfig.build_environment_variables:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionBuildConfig.BuildEnvironmentVariablesEntry
	13, // 6: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.environment_variables:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.EnvironmentVariablesEntry
	14, // 7: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.secret_environment_variables:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.SecretEnvironmentVariablesEntry
	2,  // 8: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.vpc_connector_egress_settings:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionVpcEgressSetting
	1,  // 9: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.ingress_settings:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionIngressSetting
	8,  // 10: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionServiceConfig.scaling:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionScalingConfig
	0,  // 11: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTrigger.trigger_type:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTriggerType
	10, // 12: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionTrigger.event_trigger:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventTrigger
	11, // 13: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventTrigger.event_filters:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventFilter
	3,  // 14: org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionEventTrigger.retry_policy:type_name -> org.openmcf.provider.gcp.gcpcloudfunction.v1.GcpCloudFunctionRetryPolicy
...
func init() { file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_init() }
func file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_init() {
	if File_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto = out.File
	file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_gcp_gcpcloudfunction_v1_spec_proto_depIdxs = nil
}
