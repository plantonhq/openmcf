...
- Folder exists: `apis/org/openmcf/provider/gcp/gcpserviceaccount/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpserviceaccount/v1/
go test -v
```
...
- Includes detailed "OpenMCF's Approach" section explaining design philosophy
