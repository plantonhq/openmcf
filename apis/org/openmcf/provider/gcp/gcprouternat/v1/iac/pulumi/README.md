...
cd apis/org/openmcf/provider/gcp/gcprouternat/v1/iac/pulumi
...
This Pulumi module is invoked by the OpenMCF CLI when processing `GcpRouterNat` resources:
...
These outputs are captured by OpenMCF and stored in `status.outputs`.
...
Use the OpenMCF CLI for end-to-end testing:
...
cd apis/org/openmcf/provider/gcp/gcprouternat/v1/iac/pulumi/module
