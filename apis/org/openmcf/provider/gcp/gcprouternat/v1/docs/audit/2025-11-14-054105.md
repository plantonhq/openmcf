...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcprouternat/v1/`  
**Enum Value:** 612  
**ID Prefix:** gcprnat
...
1. **Create README.md at v1 level**
   ...
   - **How:** Create a comprehensive README explaining the component's purpose, key features, use cases, and how to use it from OpenMCF CLI
...
3. **Terraform module has no feature parity with Pulumi**
   ...
   - **Why it blocks:** OpenMCF requires both Pulumi and Terraform implementations. The Terraform module is essentially non-existent
...
- Folder exists under correct provider hierarchy: `apis/org/openmcf/provider/gcp/gcprouternat/v1/`
...
- `api.proto` exists (918 bytes > 500 bytes minimum)
  ...
  - Uses correct package: `org.openmcf.provider.gcp.gcprouternat.v1`
...
```bash
cd apis/org/openmcf/provider/gcp/gcprouternat/v1/
go test -v
```
...
> **Critical:** The Terraform module is essentially non-existent. This is a blocker for production use. OpenMCF requires feature parity between Pulumi and Terraform implementations.
...
1. **Create README.md at v1 level**
   ...
   - **How:** Create comprehensive README explaining:
     ...
     - Benefits from OpenMCF perspective
     - Getting started guidance
   - **Reference:** Look at `apis/org/openmcf/provider/gcp/gcpvpc/v1/README.md` for structure
   - **Impact:** +6.67% completion score
...
**Path to reference:** `apis/org/openmcf/provider/gcp/gcpvpc/v1/`
