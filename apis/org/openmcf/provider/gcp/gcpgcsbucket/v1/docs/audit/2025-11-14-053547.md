...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpgcsbucket/v1/`  
**Enum Value:** 606  
**ID Prefix:** gcsbkt
...
- Folder exists: `apis/org/openmcf/provider/gcp/gcpgcsbucket/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpgcsbucket/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/gcp/gcpcloudcdn/v1/`
