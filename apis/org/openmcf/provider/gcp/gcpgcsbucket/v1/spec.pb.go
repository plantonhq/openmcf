...
// 	protoc        (unknown)
// source: org/openmcf/provider/gcp/gcpgcsbucket/v1/spec.proto
...
func (GcpGcsStorageClass) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpGcsStorageClass) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_enumTypes[0]
}
...
func (GcpGcsStorageClass) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type GcpGcsBucketSpec struct {
	...
	StorageClass *GcpGcsStorageClass `protobuf:"varint,4,opt,name=storage_class,json=storageClass,proto3,enum=org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClass,oneof" json:"storage_class,omitempty"`
...
func (x *GcpGcsBucketSpec) Reset() {
	*x = GcpGcsBucketSpec{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[0]
...
func (x *GcpGcsLifecycleRule) Reset() {
	*x = GcpGcsLifecycleRule{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsLifecycleRule) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type GcpGcsLifecycleAction struct {
	...
	StorageClass  *GcpGcsStorageClass `protobuf:"varint,2,opt,name=storage_class,json=storageClass,proto3,enum=org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClass,oneof" json:"storage_class,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GcpGcsLifecycleAction) Reset() {
	*x = GcpGcsLifecycleAction{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsLifecycleAction) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
type GcpGcsLifecycleCondition struct {
	...
	MatchesStorageClass []GcpGcsStorageClass `protobuf:"varint,5,rep,packed,name=matches_storage_class,json=matchesStorageClass,proto3,enum=org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClass" json:"matches_storage_class,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *GcpGcsLifecycleCondition) Reset() {
	*x = GcpGcsLifecycleCondition{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsLifecycleCondition) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpGcsIamBinding) Reset() {
	*x = GcpGcsIamBinding{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsIamBinding) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpGcsEncryption) Reset() {
	*x = GcpGcsEncryption{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsEncryption) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *GcpGcsCorsRule) Reset() {
	*x = GcpGcsCorsRule{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsCorsRule) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *GcpGcsWebsite) Reset() {
	*x = GcpGcsWebsite{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsWebsite) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *GcpGcsRetentionPolicy) Reset() {
	*x = GcpGcsRetentionPolicy{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsRetentionPolicy) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *GcpGcsLogging) Reset() {
	*x = GcpGcsLogging{}
	mi := &file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGcsLogging) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
var File_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDesc = "" +
	"\n" +
	"3org/openmcf/provider/gcp/gcpgcsbucket/v1/spec.proto\x12(org.openmcf.provider.gcp.gcpgcsbucket.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\"\xf5\v\n" +
	...
	"\rstorage_class\x18\x04 \x01(\x0e2<.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClassB\b\xbaH\x05\x82\x01\x02\x10\x01H\x00R\fstorageClass\x88\x01\x01\x12-\n" +
	"\x12versioning_enabled\x18\x05 \x01(\bR\x11versioningEnabled\x12f\n" +
	"\x0flifecycle_rules\x18\x06 \x03(\v2=.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleRuleR\x0elifecycleRules\x12]\n" +
	"\fiam_bindings\x18\a \x03(\v2:.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsIamBindingR\viamBindings\x12_\n" +
	"\n" +
	"encryption\x18\b \x01(\v2:.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsEncryptionH\x01R\n" +
	"encryption\x88\x01\x01\x12W\n" +
	"\n" +
	"cors_rules\x18\t \x03(\v28.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsCorsRuleR\tcorsRules\x12V\n" +
	"\awebsite\x18\n" +
	" \x01(\v27.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsWebsiteH\x02R\awebsite\x88\x01\x01\x12o\n" +
	"\x10retention_policy\x18\v \x01(\v2?.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsRetentionPolicyH\x03R\x0fretentionPolicy\x88\x01\x01\x12%\n" +
	"\x0erequester_pays\x18\f \x01(\bR\rrequesterPays\x12V\n" +
	"\alogging\x18\r \x01(\v27.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLoggingH\x04R\alogging\x88\x01\x01\x128\n" +
	"\x18public_access_prevention\x18\x0e \x01(\tR\x16publicAccessPrevention\x12h\n" +
	"\n" +
	"gcp_labels\x18\x0f \x03(\v2I.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.GcpLabelsEntryR\tgcpLabels\x12P\n" +
	...
	"\x06action\x18\x01 \x01(\v2?.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleActionB\x06\xbaH\x03\xc8\x01\x01R\x06action\x12h\n" +
	"\tcondition\x18\x02 \x01(\v2B.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleConditionB\x06\xbaH\x03\xc8\x01\x01R\tcondition\"\xb7\x01\n" +
	"\x15GcpGcsLifecycleAction\x12\x1a\n" +
	"\x04type\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04type\x12p\n" +
	"\rstorage_class\x18\x02 \x01(\x0e2<.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClassB\b\xbaH\x05\x82\x01\x02\x10\x01H\x00R\fstorageClass\x88\x01\x01B\x10\n" +
	...
	"\x15matches_storage_class\x18\x05 \x03(\x0e2<.org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClassB\r\xbaH\n" +
	...
	",com.org.openmcf.provider.gcp.gcpgcsbucket.v1B\tSpecProtoP\x01ZYgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpgcsbucket/v1;gcpgcsbucketv1\xa2\x02\x05OOPGG\xaa\x02(Org.Openmcf.Provider.Gcp.Gcpgcsbucket.V1\xca\x02(Org\\Openmcf\\Provider\\Gcp\\Gcpgcsbucket\\V1\xe2\x024Org\\Openmcf\\Provider\\Gcp\\Gcpgcsbucket\\V1\\GPBMetadata\xea\x02-Org::Openmcf::Provider::Gcp::Gcpgcsbucket::V1b\x06proto3"

var (
	file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_goTypes = []any{
	(GcpGcsStorageClass)(0),          // 0: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClass
	(*GcpGcsBucketSpec)(nil),         // 1: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec
	(*GcpGcsLifecycleRule)(nil),      // 2: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleRule
	(*GcpGcsLifecycleAction)(nil),    // 3: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleAction
	(*GcpGcsLifecycleCondition)(nil), // 4: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleCondition
	(*GcpGcsIamBinding)(nil),         // 5: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsIamBinding
	(*GcpGcsEncryption)(nil),         // 6: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsEncryption
	(*GcpGcsCorsRule)(nil),           // 7: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsCorsRule
	(*GcpGcsWebsite)(nil),            // 8: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsWebsite
	(*GcpGcsRetentionPolicy)(nil),    // 9: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsRetentionPolicy
	(*GcpGcsLogging)(nil),            // 10: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLogging
	nil,                              // 11: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.GcpLabelsEntry
	(*v1.StringValueOrRef)(nil),      // 12: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_depIdxs = []int32{
	12, // 0: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.gcp_project_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0,  // 1: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.storage_class:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClass
	2,  // 2: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.lifecycle_rules:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleRule
	5,  // 3: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.iam_bindings:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsIamBinding
	6,  // 4: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.encryption:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsEncryption
	7,  // 5: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.cors_rules:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsCorsRule
	8,  // 6: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.website:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsWebsite
	9,  // 7: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.retention_policy:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsRetentionPolicy
	10, // 8: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.logging:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLogging
	11, // 9: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.gcp_labels:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsBucketSpec.GcpLabelsEntry
	3,  // 10: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleRule.action:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleAction
	4,  // 11: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleRule.condition:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleCondition
	0,  // 12: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleAction.storage_class:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClass
	0,  // 13: org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsLifecycleCondition.matches_storage_class:type_name -> org.openmcf.provider.gcp.gcpgcsbucket.v1.GcpGcsStorageClass
...
func init() { file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_init() }
func file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_init() {
	if File_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto = out.File
	file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_gcp_gcpgcsbucket_v1_spec_proto_depIdxs = nil
}
