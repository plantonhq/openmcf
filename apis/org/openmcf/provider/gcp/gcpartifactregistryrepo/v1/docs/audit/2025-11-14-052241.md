...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpartifactregistryrepo/v1/`  
**Enum Value:** 600  
**ID Prefix:** gcpart
...
1. **Add iac/tf/examples.md with Terraform-specific examples**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpartifactregistryrepo/v1/iac/tf/examples.md`
...
2. **Create iac/tf/outputs.tf for Terraform outputs**
   ...
   - **File:** `apis/org/openmcf/provider/gcp/gcpartifactregistryrepo/v1/iac/tf/outputs.tf`
...
- Folder exists: `apis/org/openmcf/provider/gcp/gcpartifactregistryrepo/v1/`
