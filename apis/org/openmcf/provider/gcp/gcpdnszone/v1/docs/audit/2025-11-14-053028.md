...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpdnszone/v1/`  
**Enum Value:** 605  
**ID Prefix:** gcpdns
...
- Folder exists: `apis/org/openmcf/provider/gcp/gcpdnszone/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpdnszone/v1/
go test -v
```
...
- Good user-facing documentation from OpenMCF perspective
