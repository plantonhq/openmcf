...
// 	protoc        (unknown)
// source: org/openmcf/provider/gcp/gcpcloudcdn/v1/stack_outputs.proto
...
func (x *GcpCloudCdnStackOutputs) Reset() {
	*x = GcpCloudCdnStackOutputs{}
	mi := &file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_msgTypes[0]
...
func (*GcpCloudCdnStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	";org/openmcf/provider/gcp/gcpcloudcdn/v1/stack_outputs.proto\x12'org.openmcf.provider.gcp.gcpcloudcdn.v1\"\xa7\x06\n" +
	...
	"\x18monitoring_dashboard_url\x18\x13 \x01(\tR\x16monitoringDashboardUrlB\xdc\x02\n" +
	"+com.org.openmcf.provider.gcp.gcpcloudcdn.v1B\x11StackOutputsProtoP\x01ZWgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/gcp/gcpcloudcdn/v1;gcpcloudcdnv1\xa2\x02\x05OOPGG\xaa\x02'Org.Openmcf.Provider.Gcp.Gcpcloudcdn.V1\xca\x02'Org\\Openmcf\\Provider\\Gcp\\Gcpcloudcdn\\V1\xe2\x023Org\\Openmcf\\Provider\\Gcp\\Gcpcloudcdn\\V1\\GPBMetadata\xea\x02,Org::Openmcf::Provider::Gcp::Gcpcloudcdn::V1b\x06proto3"

var (
	file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDescData
}

var file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_goTypes = []any{
	(*GcpCloudCdnStackOutputs)(nil), // 0: org.openmcf.provider.gcp.gcpcloudcdn.v1.GcpCloudCdnStackOutputs
}
var file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_init() }
func file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_gcp_gcpcloudcdn_v1_stack_outputs_proto_depIdxs = nil
}
