...
**Provider:** gcp  
**Component Path:** `apis/org/openmcf/provider/gcp/gcpcloudcdn/v1/`  
**Enum Value:** 601  
**ID Prefix:** gcpcdn
...
- Folder exists: `apis/org/openmcf/provider/gcp/gcpcloudcdn/v1/`
...
```bash
cd apis/org/openmcf/provider/gcp/gcpcloudcdn/v1/
go test -v
```
