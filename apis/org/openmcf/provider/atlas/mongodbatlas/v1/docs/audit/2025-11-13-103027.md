...
- Folder exists under correct provider hierarchy: `apis/org/openmcf/provider/atlas/mongodbatlas/`
...
**Path to reference:** `apis/org/openmcf/provider/confluent/confluentkafka/v1/`
