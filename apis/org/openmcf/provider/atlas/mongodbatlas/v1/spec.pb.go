...
// 	protoc        (unknown)
// source: org/openmcf/provider/atlas/mongodbatlas/v1/spec.proto
...
func (x *MongodbAtlasSpec) Reset() {
	*x = MongodbAtlasSpec{}
	mi := &file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes[0]
...
func (*MongodbAtlasSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *MongodbAtlasClusterConfig) Reset() {
	*x = MongodbAtlasClusterConfig{}
	mi := &file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MongodbAtlasClusterConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc = "" +
	"\n" +
	"5org/openmcf/provider/atlas/mongodbatlas/v1/spec.proto\x12*org.openmcf.provider.atlas.mongodbatlas.v1\"\x80\x01\n" +
	"\x10MongodbAtlasSpec\x12l\n" +
	"\x0ecluster_config\x18\x01 \x01(\v2E.org.openmcf.provider.atlas.mongodbatlas.v1.MongodbAtlasClusterConfigR\rclusterConfig\"\xc6\x03\n" +
	...
	".com.org.openmcf.provider.atlas.mongodbatlas.v1B\tSpecProtoP\x01Z[github.com/plantonhq/openmcf/apis/org/openmcf/provider/atlas/mongodbatlas/v1;mongodbatlasv1\xa2\x02\x05OOPAM\xaa\x02*Org.Openmcf.Provider.Atlas.Mongodbatlas.V1\xca\x02*Org\\Openmcf\\Provider\\Atlas\\Mongodbatlas\\V1\xe2\x026Org\\Openmcf\\Provider\\Atlas\\Mongodbatlas\\V1\\GPBMetadata\xea\x02/Org::Openmcf::Provider::Atlas::Mongodbatlas::V1b\x06proto3"

var (
	file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_goTypes = []any{
	(*MongodbAtlasSpec)(nil),          // 0: org.openmcf.provider.atlas.mongodbatlas.v1.MongodbAtlasSpec
	(*MongodbAtlasClusterConfig)(nil), // 1: org.openmcf.provider.atlas.mongodbatlas.v1.MongodbAtlasClusterConfig
}
var file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.atlas.mongodbatlas.v1.MongodbAtlasSpec.cluster_config:type_name -> org.openmcf.provider.atlas.mongodbatlas.v1.MongodbAtlasClusterConfig
...
func init() { file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_init() }
func file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_init() {
	if File_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto = out.File
	file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_atlas_mongodbatlas_v1_spec_proto_depIdxs = nil
}
