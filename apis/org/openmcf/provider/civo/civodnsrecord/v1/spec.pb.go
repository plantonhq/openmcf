...
// 	protoc        (unknown)
// source: org/openmcf/provider/civo/civodnsrecord/v1/spec.proto
...
func (x *CivoDnsRecordSpec) Reset() {
	*x = CivoDnsRecordSpec{}
	mi := &file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_msgTypes[0]
...
var File_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto protoreflect.FileDescriptor
...
var (
	file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDescData
}
...
func init() { file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_init() }
func file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_init() {
	if File_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto = out.File
	file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_civo_civodnsrecord_v1_spec_proto_depIdxs = nil
}
