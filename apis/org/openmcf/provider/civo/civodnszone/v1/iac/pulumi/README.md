...
This directory contains the Pulumi implementation for managing Civo DNS zones. It's designed to be invoked by the OpenMCF CLI, but can also be used standalone for direct Pulumi workflows.
...
import (
    ...
    civodnszone "github.com/plantonhq/openmcf/apis/org/openmcf/provider/civo/civodnszone/v1/iac/pulumi/module"
)
