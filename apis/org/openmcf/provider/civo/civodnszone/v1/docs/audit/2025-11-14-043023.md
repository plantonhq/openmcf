...
**Provider:** civo  
**Component Path:** `apis/org/openmcf/provider/civo/civodnszone/v1/`  
**Enum Value:** 1504  
**ID Prefix:** cidns
...
- Folder exists: `apis/org/openmcf/provider/civo/civodnszone/v1/`
...
5. **Create Pulumi supporting documentation**
   ...
   - **Why:** Helps users running Pulumi directly (not through OpenMCF CLI)
   - **How:**
...
7. **Add IaC-specific examples documentation**
   ...
   - **How:** Show direct Pulumi/Terraform usage (not just OpenMCF abstraction)
   - **Impact:** +10.00% score
...
**Path to reference:** `apis/org/openmcf/provider/digital_ocean/digitaloceandnszone/v1/`

**Other good references:**

- `apis/org/openmcf/provider/aws/awsroute53zone/v1/` (AWS DNS zone)
- `apis/org/openmcf/provider/gcp/gcpdnszone/v1/` (GCP DNS zone)
- `apis/org/openmcf/provider/cloudflare/cloudflarednezone/v1/` (Cloudflare DNS zone)
...
**Audited by:** OpenMCF Code Auditor
