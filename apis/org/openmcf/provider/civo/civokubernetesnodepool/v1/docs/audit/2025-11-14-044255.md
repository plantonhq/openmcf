...
**Provider:** civo  
**Component Path:** `apis/org/openmcf/provider/civo/civokubernetesnodepool/v1/`  
**Enum Value:** 1508  
**ID Prefix:** ciknp
...
- Folder exists: `apis/org/openmcf/provider/civo/civokubernetesnodepool/v1/`
...
- Could add more concrete examples of OpenMCF API usage
...
1. **Create spec_test.go with comprehensive tests**
   ...
   - **How:**
     ...
     - Run: `go test ./apis/org/openmcf/provider/civo/civokubernetesnodepool/v1/ -v`
...
**Path to reference:** `apis/org/openmcf/provider/digital_ocean/digitaloceankubernetesnodepool/v1/`
