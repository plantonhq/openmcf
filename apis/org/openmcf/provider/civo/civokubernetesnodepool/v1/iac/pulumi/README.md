...
This directory contains the Pulumi implementation for managing Civo Kubernetes node pools. It's designed to be invoked by the OpenMCF CLI, but can also be used standalone.
...
- Issues: [GitHub](https://github.com/plantonhq/openmcf/issues)
