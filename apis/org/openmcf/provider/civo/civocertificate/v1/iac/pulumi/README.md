...
1. **Clone the repository**:
   ...
   cd openmcf/apis/org/openmcf/provider/civo/civocertificate/v1/iac/pulumi/
   ```
...
- **Discussions**: [GitHub Discussions](https://github.com/plantonhq/openmcf/discussions)
...
1. Follow [OpenMCF contribution guidelines](../../../../../../../../CONTRIBUTING.md)
