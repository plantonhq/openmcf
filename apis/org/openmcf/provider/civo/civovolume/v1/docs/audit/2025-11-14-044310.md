...
**Provider:** civo  
**Component Path:** `apis/org/openmcf/provider/civo/civovolume/v1/`  
**Enum Value:** 1510  
**ID Prefix:** civol
...
- Folder exists: `apis/org/openmcf/provider/civo/civovolume/v1/`
...
- No OpenMCF perspective overview
...
- `apis/org/openmcf/provider/civo/civobucket/v1/`
- `apis/org/openmcf/provider/civo/civocertificate/v1/`
- `apis/org/openmcf/provider/civo/civodatabase/v1/`
...
# 4. Re-audit
@audit-openmcf-component civovolume
```
