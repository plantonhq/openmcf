...
**Provider:** civo  
**Component Path:** `apis/org/openmcf/provider/civo/civobucket/v1/`  
**Enum Value:** 1500  
**ID Prefix:** cibkt
...
- Folder exists: `apis/org/openmcf/provider/civo/civobucket/v1/`
...
```bash
cd apis/org/openmcf/provider/civo/civobucket/v1/
go test -v
```
...
```
?       github.com/plantonhq/openmcf/apis/org/openmcf/provider/civo/civobucket/v1 [no test files]
```
...
**Path to reference:** `apis/org/openmcf/provider/digital_ocean/digitaloceanbucket/v1/`
...
6. Re-run audit to verify improvements: `@audit-openmcf-component CivoBucket`
