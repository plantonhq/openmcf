...
**Note:** Civo Network resources don't currently support labels/tags. These are stored in OpenMCF metadata.
...
**Workaround:**
- Description is stored in OpenMCF metadata
...
**Workaround:**
- Labels defined in `locals.planton_labels` are stored in OpenMCF metadata
...
This Terraform module can be used independently or as part of OpenMCF's orchestration:
...
**Pulumi vs. Terraform:**
- OpenMCF's primary implementation uses Pulumi (Go)
