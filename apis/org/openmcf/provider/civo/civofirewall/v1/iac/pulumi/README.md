...
This directory contains the Pulumi implementation for managing Civo firewalls. It's designed to be invoked by the OpenMCF CLI, but can also be used standalone for direct Pulumi workflows.
...
The `Resources` function is the single entry point invoked by OpenMCF CLI:
...
## Integration with OpenMCF

When using the OpenMCF CLI, you don't interact with Pulumi directly. The CLI:
...
import (
    ...
    civofirewall "github.com/plantonhq/openmcf/apis/org/openmcf/provider/civo/civofirewall/v1/iac/pulumi/module"
)
...
- [OpenMCF Documentation](https://github.com/plantonhq/openmcf)
- [Architecture Overview](overview.md)

## Support

- Issues: [GitHub Issues](https://github.com/plantonhq/openmcf/issues)
