...
// 	protoc        (unknown)
// source: org/openmcf/provider/digitalocean/provider.proto
...
type DigitalOceanProviderConfig struct {
	...
	DefaultRegion DigitalOceanRegion `protobuf:"varint,2,opt,name=default_region,json=defaultRegion,proto3,enum=org.openmcf.provider.digitalocean.DigitalOceanRegion" json:"default_region,omitempty"`
...
func (x *DigitalOceanProviderConfig) Reset() {
	*x = DigitalOceanProviderConfig{}
	mi := &file_org_openmcf_provider_digitalocean_provider_proto_msgTypes[0]
...
func (*DigitalOceanProviderConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_provider_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_digitalocean_provider_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_digitalocean_provider_proto_rawDesc = "" +
	"\n" +
	"0org/openmcf/provider/digitalocean/provider.proto\x12!org.openmcf.provider.digitalocean\x1a\x1bbuf/validate/validate.proto\x1a.org/openmcf/provider/digitalocean/region.proto\"\xfd\x01\n" +
	"\x1aDigitalOceanProviderConfig\x12#\n" +
	"\tapi_token\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\bapiToken\x12d\n" +
	"\x0edefault_region\x18\x02 \x01(\x0e25.org.openmcf.provider.digitalocean.DigitalOceanRegionB\x06\xbaH\x03\xc8\x01\x01R\rdefaultRegion\x12(\n" +
	"\x10spaces_access_id\x18\x03 \x01(\tR\x0espacesAccessId\x12*\n" +
	"\x11spaces_secret_key\x18\x04 \x01(\tR\x0fspacesSecretKeyB\xa3\x02\n" +
	"%com.org.openmcf.provider.digitaloceanB\rProviderProtoP\x01ZCgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/digitalocean\xa2\x02\x04OOPD\xaa\x02!Org.Openmcf.Provider.Digitalocean\xca\x02!Org\\Openmcf\\Provider\\Digitalocean\xe2\x02-Org\\Openmcf\\Provider\\Digitalocean\\GPBMetadata\xea\x02$Org::Openmcf::Provider::Digitaloceanb\x06proto3"

var (
	file_org_openmcf_provider_digitalocean_provider_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_digitalocean_provider_proto_rawDescData []byte
)

func file_org_openmcf_provider_digitalocean_provider_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_digitalocean_provider_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_digitalocean_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_provider_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_provider_proto_rawDesc)))
	})
	return file_org_openmcf_provider_digitalocean_provider_proto_rawDescData
}

var file_org_openmcf_provider_digitalocean_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_digitalocean_provider_proto_goTypes = []any{
	(*DigitalOceanProviderConfig)(nil), // 0: org.openmcf.provider.digitalocean.DigitalOceanProviderConfig
	(DigitalOceanRegion)(0),            // 1: org.openmcf.provider.digitalocean.DigitalOceanRegion
}
var file_org_openmcf_provider_digitalocean_provider_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.digitalocean.DigitalOceanProviderConfig.default_region:type_name -> org.openmcf.provider.digitalocean.DigitalOceanRegion
...
func init() { file_org_openmcf_provider_digitalocean_provider_proto_init() }
func file_org_openmcf_provider_digitalocean_provider_proto_init() {
	if File_org_openmcf_provider_digitalocean_provider_proto != nil {
		return
	}
	file_org_openmcf_provider_digitalocean_region_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_provider_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_digitalocean_provider_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_digitalocean_provider_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_digitalocean_provider_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_digitalocean_provider_proto = out.File
	file_org_openmcf_provider_digitalocean_provider_proto_goTypes = nil
	file_org_openmcf_provider_digitalocean_provider_proto_depIdxs = nil
}
