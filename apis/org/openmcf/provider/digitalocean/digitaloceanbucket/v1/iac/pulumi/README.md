...
This Pulumi module deploys DigitalOcean Spaces buckets (S3-compatible object storage) using OpenMCF's declarative API. The module transforms the `DigitalOceanBucketSpec` protobuf definition into DigitalOcean Spaces resources with built-in CDN integration.
...
This module is part of the OpenMCF monorepo:

```bash
git clone https://github.com/plantonhq/openmcf.git
cd openmcf/apis/org/openmcf/provider/digitalocean/digitaloceanbucket/v1/iac/pulumi
```
...
import (
    ...
    "github.com/plantonhq/openmcf/apis/org/openmcf/provider/digitalocean/digitaloceanbucket/v1/iac/pulumi/module"
