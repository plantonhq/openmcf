...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceankubernetesnodepool/v1/`  
**Enum Value:** 1209  
**ID Prefix:** doknp
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceankubernetesnodepool/v1/`
...
- Overview of DigitalOcean Kubernetes Node Pool from OpenMCF perspective
...
**Path to reference:** `apis/org/openmcf/provider/gcp/gcpgkenodepool/v1/`
