...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/`  
**Enum Value:** 1212  
**ID Prefix:** dovpc
...
- **File:** `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/examples.md`
...
- **File:** `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/iac/pulumi/README.md`
...
- **File:** `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/iac/pulumi/overview.md`
...
- **Files:**
  - `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/iac/tf/main.tf`
  - `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/iac/tf/provider.tf`
  - `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/iac/tf/locals.tf`
  - `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/iac/tf/outputs.tf`
...
- **File:** `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/iac/tf/README.md`
...
- Folder exists at correct path: `apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceanvpc/v1/
go test -v
```
...
- `apis/org/openmcf/provider/aws/awsvpc/v1/`
- `apis/org/openmcf/provider/gcp/gcpvpc/v1/`
