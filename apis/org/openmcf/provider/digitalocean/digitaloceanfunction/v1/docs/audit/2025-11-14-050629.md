...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceanfunction/v1/`  
**Enum Value:** 1207  
**ID Prefix:** dofn
...
1. **Create spec_test.go with validation tests**
   ...
   - **File:** `apis/org/openmcf/provider/digitalocean/digitaloceanfunction/v1/spec_test.go`
...
2. **Create examples.md with common use cases**
   ...
   - **File:** `apis/org/openmcf/provider/digitalocean/digitaloceanfunction/v1/examples.md`
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceanfunction/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceanfunction/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/gcp/gcpcloudfunction/v1/`
...
5. **Re-run audit to verify improvements**:
   ```bash
   @audit-openmcf-component DigitalOceanFunction
   ```
