...
This directory contains the Terraform implementation for provisioning DigitalOcean Droplets through the OpenMCF API. The module reads a structured input matching the `DigitalOceanDropletSpec` protobuf specification and deploys the corresponding virtual machine using the DigitalOcean Terraform provider.
...
| `tags` | All applied tags | `["production", "managed-by:openmcf"]` |
...
This implementation is part of the OpenMCF monorepo and follows the same license.
