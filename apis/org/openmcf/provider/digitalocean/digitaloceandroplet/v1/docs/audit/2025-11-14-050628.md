...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceandroplet/v1/`  
**Enum Value:** 1205  
**ID Prefix:** dodrop
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceandroplet/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceandroplet/v1/
go test -v
```
