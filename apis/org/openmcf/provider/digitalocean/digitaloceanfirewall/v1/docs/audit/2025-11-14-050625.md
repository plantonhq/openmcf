...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceanfirewall/v1/`  
**Enum Value:** 1206  
**ID Prefix:** dofw
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceanfirewall/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceanfirewall/v1/
go test -v
```
...
```
?       github.com/plantonhq/openmcf/apis/org/openmcf/provider/digitalocean/digitaloceanfirewall/v1 [no test files]
```
...
**Path to reference:** `apis/org/openmcf/provider/digitalocean/digitaloceanfirewall/v1/`
...
6. Re-run audit to verify improvements: `@audit-openmcf-component DigitalOceanFirewall`
