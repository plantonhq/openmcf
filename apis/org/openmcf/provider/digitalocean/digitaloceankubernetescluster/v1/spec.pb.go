...
// 	protoc        (unknown)
// source: org/openmcf/provider/digitalocean/digitaloceankubernetescluster/v1/spec.proto
...
func (x *DigitalOceanKubernetesClusterSpec) Reset() {
	*x = DigitalOceanKubernetesClusterSpec{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanKubernetesClusterSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanKubernetesClusterDefaultNodePool) Reset() {
	*x = DigitalOceanKubernetesClusterDefaultNodePool{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanKubernetesClusterDefaultNodePool) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc = "" +
	...
	"\x11default_node_pool\x18\f \x01(\v2p.org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterDefaultNodePoolB\x06\xbaH\x03\xc8\x01\x01R\x0fdefaultNodePool\"\xce\x01\n" +
	...
	"Fcom.org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1B\tSpecProtoP\x01Z\x84\x01github.com/plantonhq/openmcf/apis/org/openmcf/provider/digitalocean/digitaloceankubernetescluster/v1;digitaloceankubernetesclusterv1\xa2\x02\x05OOPDD\xaa\x02BOrg.Openmcf.Provider.Digitalocean.Digitaloceankubernetescluster.V1\xca\x02BOrg\\Openmcf\\Provider\\Digitalocean\\Digitaloceankubernetescluster\\V1\xe2\x02NOrg\\Openmcf\\Provider\\Digitalocean\\Digitaloceankubernetescluster\\V1\\GPBMetadata\xea\x02GOrg::Openmcf::Provider::Digitalocean::Digitaloceankubernetescluster::V1b\x06proto3"

var (
	file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes = []any{
	(*DigitalOceanKubernetesClusterSpec)(nil),            // 0: org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec
	(*DigitalOceanKubernetesClusterDefaultNodePool)(nil), // 1: org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterDefaultNodePool
...
var file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec.region:type_name -> org.openmcf.provider.digitalocean.DigitalOceanRegion
	3, // 1: org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec.vpc:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1, // 2: org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterSpec.default_node_pool:type_name -> org.openmcf.provider.digitalocean.digitaloceankubernetescluster.v1.DigitalOceanKubernetesClusterDefaultNodePool
...
func file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_init() {
	if File_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto = out.File
	file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs = nil
}
