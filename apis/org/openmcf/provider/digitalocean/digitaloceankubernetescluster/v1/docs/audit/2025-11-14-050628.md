...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceankubernetescluster/v1/`  
**Enum Value:** 1208  
**ID Prefix:** dokc
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceankubernetescluster/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceankubernetescluster/v1/
go test -v
```
...
- Documents OpenMCF's opinionated API design philosophy
...
- `apis/org/openmcf/provider/gcp/gcpgkecluster/v1/`
