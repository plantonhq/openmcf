...
- **Standardize Configuration**: Use a consistent API that aligns with other OpenMCF components
...
Your YAML manifests *are* your backup. Store them in Git for version control and disaster recovery. If you need to recreate DNS zones in a new account, simply apply the manifests with the OpenMCF CLI.
