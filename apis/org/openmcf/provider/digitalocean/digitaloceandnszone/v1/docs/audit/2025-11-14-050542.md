...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceandnszone/v1/`  
**Enum Value:** 1204  
**ID Prefix:** dodns
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceandnszone/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceandnszone/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/cloudflare/cloudflarednszone/v1/`
