...
// 	protoc        (unknown)
// source: org/openmcf/provider/digitalocean/digitaloceandnszone/v1/spec.proto
...
func (x *DigitalOceanDnsZoneSpec) Reset() {
	*x = DigitalOceanDnsZoneSpec{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type DigitalOceanDnsZoneRecord struct {
	...
	Type dnsrecordtype.DnsRecordType `protobuf:"varint,4,opt,name=type,proto3,enum=org.openmcf.shared.networking.enums.dnsrecordtype.DnsRecordType" json:"type,omitempty"`
...
func (x *DigitalOceanDnsZoneRecord) Reset() {
	*x = DigitalOceanDnsZoneRecord{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanDnsZoneRecord) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Corg/openmcf/provider/digitalocean/digitaloceandnszone/v1/spec.proto\x128org.openmcf.provider.digitalocean.digitaloceandnszone.v1\x1a\x1bbuf/validate/validate.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1aGorg/openmcf/shared/networking/enums/dnsrecordtype/dns_record_type.proto\x1a(org/openmcf/shared/options/options.proto\"\xd7\x01\n" +
	"\x17DigitalOceanDnsZoneSpec\x12M\n" +
	"\vdomain_name\x18\x01 \x01(\tB,\xbaH)\xc8\x01\x01r$2\"^(?:[A-Za-z0-9-]+\\.)+[A-Za-z]{2,}$R\n" +
	"domainName\x12m\n" +
	"\arecords\x18\x02 \x03(\v2S.org.openmcf.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecordR\arecords\"\xa5\x03\n" +
	"\x19DigitalOceanDnsZoneRecord\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\x12W\n" +
	"\x06values\x18\x02 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\x06values\x12)\n" +
	"\vttl_seconds\x18\x03 \x01(\rB\b\x92\xa6\x1d\x043600R\n" +
	"ttlSeconds\x12\\\n" +
	"\x04type\x18\x04 \x01(\x0e2@.org.openmcf.shared.networking.enums.dnsrecordtype.DnsRecordTypeB\x06\xbaH\x03\xc8\x01\x01R\x04type\x12!\n" +
	...
	"\x03tag\x18\t \x01(\tR\x03tagB\xc2\x03\n" +
	"<com.org.openmcf.provider.digitalocean.digitaloceandnszone.v1B\tSpecProtoP\x01Zpgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/digitalocean/digitaloceandnszone/v1;digitaloceandnszonev1\xa2\x02\x05OOPDD\xaa\x028Org.Openmcf.Provider.Digitalocean.Digitaloceandnszone.V1\xca\x028Org\\Openmcf\\Provider\\Digitalocean\\Digitaloceandnszone\\V1\xe2\x02DOrg\\Openmcf\\Provider\\Digitalocean\\Digitaloceandnszone\\V1\\GPBMetadata\xea\x02=Org::Openmcf::Provider::Digitalocean::Digitaloceandnszone::V1b\x06proto3"

var (
	file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes = []any{
	(*DigitalOceanDnsZoneSpec)(nil),   // 0: org.openmcf.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneSpec
	(*DigitalOceanDnsZoneRecord)(nil), // 1: org.openmcf.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord
...
var file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneSpec.records:type_name -> org.openmcf.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord
	2, // 1: org.openmcf.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord.values:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3, // 2: org.openmcf.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneRecord.type:type_name -> org.openmcf.shared.networking.enums.dnsrecordtype.DnsRecordType
...
func init() { file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_init() }
func file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_init() {
	if File_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto = out.File
	file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs = nil
}
