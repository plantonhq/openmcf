...
// 	protoc        (unknown)
// source: org/openmcf/provider/digitalocean/digitaloceandnsrecord/v1/spec.proto
...
func (x *DigitalOceanDnsRecordSpec) Reset() {
	*x = DigitalOceanDnsRecordSpec{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanDnsRecordSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto protoreflect.FileDescriptor
...
var (
	file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_rawDesc)))
	})
...
func init() { file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_init() }
func file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_init() {
	if File_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	...
	file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_digitalocean_digitaloceandnsrecord_v1_spec_proto_depIdxs = nil
}
