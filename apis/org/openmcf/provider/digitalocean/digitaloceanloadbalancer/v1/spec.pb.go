...
// 	protoc        (unknown)
// source: org/openmcf/provider/digitalocean/digitaloceanloadbalancer/v1/spec.proto
...
func (DigitalOceanLoadBalancerProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanLoadBalancerProtocol) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanLoadBalancerProtocol) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanLoadBalancerSpec) Reset() {
	*x = DigitalOceanLoadBalancerSpec{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes[0]
...
type DigitalOceanLoadBalancerForwardingRule struct {
	...
	EntryProtocol DigitalOceanLoadBalancerProtocol `protobuf:"varint,2,opt,name=entry_protocol,json=entryProtocol,proto3,enum=org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol" json:"entry_protocol,omitempty"`
	...
	TargetProtocol DigitalOceanLoadBalancerProtocol `protobuf:"varint,4,opt,name=target_protocol,json=targetProtocol,proto3,enum=org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol" json:"target_protocol,omitempty"`
...
func (x *DigitalOceanLoadBalancerForwardingRule) Reset() {
	*x = DigitalOceanLoadBalancerForwardingRule{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanLoadBalancerForwardingRule) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type DigitalOceanLoadBalancerHealthCheck struct {
	...
	Protocol DigitalOceanLoadBalancerProtocol `protobuf:"varint,2,opt,name=protocol,proto3,enum=org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol" json:"protocol,omitempty"`
...
func (x *DigitalOceanLoadBalancerHealthCheck) Reset() {
	*x = DigitalOceanLoadBalancerHealthCheck{}
	mi := &file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanLoadBalancerHealthCheck) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Horg/openmcf/provider/digitalocean/digitaloceanloadbalancer/v1/spec.proto\x12=org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1\x1a\x1bbuf/validate/validate.proto\x1a.org/openmcf/provider/digitalocean/region.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xb2\x06\n" +
	...
	"\x06region\x18\x02 \x01(\x0e25.org.openmcf.provider.digitalocean.DigitalOceanRegionB\x06\xbaH\x03\xc8\x01\x01R\x06region\x12j\n" +
	"\x03vpc\x18\x03 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB$\xbaH\x03\xc8\x01\x01\x88\xd4a\xbc\t\x92\xd4a\x15status.outputs.vpc_idR\x03vpc\x12\x9d\x01\n" +
	"\x10forwarding_rules\x18\x04 \x03(\v2e.org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRuleB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\x0fforwardingRules\x12\x85\x01\n" +
	"\fhealth_check\x18\x05 \x01(\v2b.org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerHealthCheckR\vhealthCheck\x12w\n" +
	"\vdroplet_ids\x18\x06 \x03(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB\"\x88\xd4a\xb5\t\x92\xd4a\x19status.outputs.droplet_idR\n" +
	"dropletIds\x12.\n" +
	"\vdroplet_tag\x18\a \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xff\x01R\n" +
	"dropletTag\x124\n" +
	"\x16enable_sticky_sessions\x18\b \x01(\bR\x14enableStickySessions\"\xe6\x03\n" +
	"&DigitalOceanLoadBalancerForwardingRule\x12-\n" +
	"\n" +
	"entry_port\x18\x01 \x01(\rB\x0e\xbaH\v\xc8\x01\x01*\x06\x18\xff\xff\x03(\x01R\tentryPort\x12\x8e\x01\n" +
	"\x0eentry_protocol\x18\x02 \x01(\x0e2_.org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocolB\x06\xbaH\x03\xc8\x01\x01R\rentryProtocol\x12/\n" +
	"\vtarget_port\x18\x03 \x01(\rB\x0e\xbaH\v\xc8\x01\x01*\x06\x18\xff\xff\x03(\x01R\n" +
	"targetPort\x12\x90\x01\n" +
	"\x0ftarget_protocol\x18\x04 \x01(\x0e2_.org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocolB\x06\xbaH\x03\xc8\x01\x01R\x0etargetProtocol\x128\n" +
	"\x10certificate_name\x18\x05 \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xff\x01R\x0fcertificateName\"\x99\x02\n" +
	"#DigitalOceanLoadBalancerHealthCheck\x12\"\n" +
	"\x04port\x18\x01 \x01(\rB\x0e\xbaH\v\xc8\x01\x01*\x06\x18\xff\xff\x03(\x01R\x04port\x12\x83\x01\n" +
	"\bprotocol\x18\x02 \x01(\x0e2_.org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocolB\x06\xbaH\x03\xc8\x01\x01R\bprotocol\x12\x12\n" +
	...
	"Acom.org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1B\tSpecProtoP\x01Zzgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/digitalocean/digitaloceanloadbalancer/v1;digitaloceanloadbalancerv1\xa2\x02\x05OOPDD\xaa\x02=Org.Openmcf.Provider.Digitalocean.Digitaloceanloadbalancer.V1\xca\x02=Org\\Openmcf\\Provider\\Digitalocean\\Digitaloceanloadbalancer\\V1\xe2\x02IOrg\\Openmcf\\Provider\\Digitalocean\\Digitaloceanloadbalancer\\V1\\GPBMetadata\xea\x02BOrg::Openmcf::Provider::Digitalocean::Digitaloceanloadbalancer::V1b\x06proto3"

var (
	file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_goTypes = []any{
	(DigitalOceanLoadBalancerProtocol)(0),          // 0: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
	(*DigitalOceanLoadBalancerSpec)(nil),           // 1: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec
	(*DigitalOceanLoadBalancerForwardingRule)(nil), // 2: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule
	(*DigitalOceanLoadBalancerHealthCheck)(nil),    // 3: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerHealthCheck
	(digitalocean.DigitalOceanRegion)(0),           // 4: org.openmcf.provider.digitalocean.DigitalOceanRegion
	(*v1.StringValueOrRef)(nil),                    // 5: org.openmcf.shared.foreignkey.v1.StringValueOrRef
}
var file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_depIdxs = []int32{
	4, // 0: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.region:type_name -> org.openmcf.provider.digitalocean.DigitalOceanRegion
	5, // 1: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.vpc:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2, // 2: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.forwarding_rules:type_name -> org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule
	3, // 3: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.health_check:type_name -> org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerHealthCheck
	5, // 4: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerSpec.droplet_ids:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	0, // 5: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule.entry_protocol:type_name -> org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
	0, // 6: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerForwardingRule.target_protocol:type_name -> org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
	0, // 7: org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerHealthCheck.protocol:type_name -> org.openmcf.provider.digitalocean.digitaloceanloadbalancer.v1.DigitalOceanLoadBalancerProtocol
...
func init() { file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_init() }
func file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_init() {
	if File_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto = out.File
	file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_digitalocean_digitaloceanloadbalancer_v1_spec_proto_depIdxs = nil
}
