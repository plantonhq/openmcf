...
This Terraform module deploys DigitalOcean Regional Load Balancers from OpenMCF's protobuf-defined manifests.
...
This Terraform module can be used standalone or as part of OpenMCF's manifest-driven workflow:
...
**Note:** OpenMCF primarily uses Pulumi for deployments. This Terraform module provides an alternative for teams preferring Terraform.
...
- Open an issue in the OpenMCF repository
