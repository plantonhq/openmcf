...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceanloadbalancer/v1/`  
**Enum Value:** 1210  
**ID Prefix:** dolb
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceanloadbalancer/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceanloadbalancer/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/digitalocean/digitaloceandroplet/v1/`
