...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceancertificate/v1/`  
**Enum Value:** 1213  
**ID Prefix:** docert
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceancertificate/v1/`
...
3. **Create user-facing README.md**
   ...
   - **How:** Write 50-100 line README with:
     - Overview from OpenMCF perspective
...
7. **Add BUILD.bazel validation**
   ...
   - **How:** Run `bazel build //apis/org/openmcf/provider/digitalocean/digitaloceancertificate/...` to verify
...
- `apis/org/openmcf/provider/gcp/gcpcertmanagercert/v1/` (for certificate management patterns)
- `apis/org/openmcf/provider/digitalocean/digitaloceandnszone/v1/` (for DigitalOcean provider patterns, if available)
...
5. Run `openmcf pulumi up` and `terraform apply` to verify both work
