...
The module implements OpenMCF's `DigitalOceanCertificate` protobuf spec, providing a declarative interface for:
...
cd apis/org/openmcf/provider/digitalocean/digitaloceancertificate/v1/iac/tf
