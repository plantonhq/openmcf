...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceandatabasecluster/v1/`  
**Enum Value:** 1203  
**ID Prefix:** dodb
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceandatabasecluster/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceandatabasecluster/v1/
go test -v
```
...
- **Clear explanation of 80/20 scoping decisions** in OpenMCF's API design
...
**Path to reference:** `apis/org/openmcf/provider/digitalocean/digitaloceancontainerregistry/v1/`
