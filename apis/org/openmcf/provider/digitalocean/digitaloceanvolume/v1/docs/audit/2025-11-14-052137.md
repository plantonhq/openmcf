...
**Component Path:** `apis/org/openmcf/provider/digitalocean/digitaloceanvolume/v1/`  
**Enum Value:** 1211  
**ID Prefix:** dovol
...
- Folder exists: `apis/org/openmcf/provider/digitalocean/digitaloceanvolume/v1/`
...
```bash
cd apis/org/openmcf/provider/digitalocean/digitaloceanvolume/v1/
go test -v
```
...
4. **Fix README.md content**
   ...
   - **How:** Rewrite README to be specific to DigitalOcean Volume. Explain:
     ...
     - Why OpenMCF provides native implementation
