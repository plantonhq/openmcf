...
# Deploy
openmcf pulumi up --manifest hack/manifest.yaml --module-dir ${KUBERNETES_CERT_MANAGER_MODULE}
```
...
```shell
openmcf pulumi preview --manifest manifest.yaml --module-dir ${KUBERNETES_CERT_MANAGER_MODULE}
```

### Deploy

```shell
openmcf pulumi up --manifest manifest.yaml --module-dir ${KUBERNETES_CERT_MANAGER_MODULE}
```

### Destroy

```shell
openmcf pulumi destroy --manifest manifest.yaml --module-dir ${KUBERNETES_CERT_MANAGER_MODULE}
```
