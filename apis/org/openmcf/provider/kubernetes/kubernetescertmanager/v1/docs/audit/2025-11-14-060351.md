...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetescertmanager/v1/`  
**Enum Value:** 821  
**ID Prefix:** cmk8s  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetescertmanager/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kubernetescertmanager/v1/
go test -v
```
...
- For Terraform implementation: `apis/org/openmcf/provider/kubernetes/externaldns/v1/iac/tf/`
- For test structure: `apis/org/openmcf/provider/kubernetes/externaldns/v1/*_test.go`
- For examples: `apis/org/openmcf/provider/kubernetes/externaldns/v1/examples.md`
