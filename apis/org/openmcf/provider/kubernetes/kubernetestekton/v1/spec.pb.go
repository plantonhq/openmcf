...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetestekton/v1/spec.proto
...
func (x *KubernetesTektonSpec) Reset() {
	*x = KubernetesTektonSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_msgTypes[0]
...
func (*KubernetesTektonSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesTektonDashboard) Reset() {
	*x = KubernetesTektonDashboard{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTektonDashboard) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesTektonDashboardIngress) Reset() {
	*x = KubernetesTektonDashboardIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTektonDashboardIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesTektonCloudEvents) Reset() {
	*x = KubernetesTektonCloudEvents{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTektonCloudEvents) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDesc = "" +
	"\n" +
	">org/openmcf/provider/kubernetes/kubernetestekton/v1/spec.proto\x123org.openmcf.provider.kubernetes.kubernetestekton.v1\x1a\x1bbuf/validate/validate.proto\x1a4org/openmcf/provider/kubernetes/target_cluster.proto\x1a(org/openmcf/shared/options/options.proto\"\x93\x03\n" +
	"\x14KubernetesTektonSpec\x12a\n" +
	"\x0etarget_cluster\x18\x01 \x01(\v2:.org.openmcf.provider.kubernetes.KubernetesClusterSelectorR\rtargetCluster\x125\n" +
	"\x10pipeline_version\x18\x02 \x01(\tB\n" +
	"\x8a\xa6\x1d\x06latestR\x0fpipelineVersion\x12l\n" +
	"\tdashboard\x18\x03 \x01(\v2N.org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonDashboardR\tdashboard\x12s\n" +
	"\fcloud_events\x18\x04 \x01(\v2P.org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonCloudEventsR\vcloudEvents\"\xcc\x01\n" +
	"\x19KubernetesTektonDashboard\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12$\n" +
	"\aversion\x18\x02 \x01(\tB\n" +
	"\x8a\xa6\x1d\x06latestR\aversion\x12o\n" +
	"\aingress\x18\x03 \x01(\v2U.org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonDashboardIngressR\aingress\"\xe9\x01\n" +
	...
	"7com.org.openmcf.provider.kubernetes.kubernetestekton.v1B\tSpecProtoP\x01Zhgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetestekton/v1;kubernetestektonv1\xa2\x02\x05OOPKK\xaa\x023Org.Openmcf.Provider.Kubernetes.Kubernetestekton.V1\xca\x023Org\\Openmcf\\Provider\\Kubernetes\\Kubernetestekton\\V1\xe2\x02?Org\\Openmcf\\Provider\\Kubernetes\\Kubernetestekton\\V1\\GPBMetadata\xea\x028Org::Openmcf::Provider::Kubernetes::Kubernetestekton::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_goTypes = []any{
	(*KubernetesTektonSpec)(nil),                 // 0: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonSpec
	(*KubernetesTektonDashboard)(nil),            // 1: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonDashboard
	(*KubernetesTektonDashboardIngress)(nil),     // 2: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonDashboardIngress
	(*KubernetesTektonCloudEvents)(nil),          // 3: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonCloudEvents
	(*kubernetes.KubernetesClusterSelector)(nil), // 4: org.openmcf.provider.kubernetes.KubernetesClusterSelector
}
var file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_depIdxs = []int32{
	4, // 0: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonSpec.target_cluster:type_name -> org.openmcf.provider.kubernetes.KubernetesClusterSelector
	1, // 1: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonSpec.dashboard:type_name -> org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonDashboard
	3, // 2: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonSpec.cloud_events:type_name -> org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonCloudEvents
	2, // 3: org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonDashboard.ingress:type_name -> org.openmcf.provider.kubernetes.kubernetestekton.v1.KubernetesTektonDashboardIngress
...
func init() { file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetestekton_v1_spec_proto_depIdxs = nil
}
