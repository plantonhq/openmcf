...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kuberneteskeycloak/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kuberneteskeycloak/v1/
go test -v
```
...
- **80/20 Scoping Decisions:** Clear explanation of why OpenMCF chose the Operator-emulating approach over Helm charts
