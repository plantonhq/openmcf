...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/volume_mount.proto
...
func (x *VolumeMount) Reset() {
	*x = VolumeMount{}
	mi := &file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes[0]
...
func (*VolumeMount) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConfigMapVolumeSource) Reset() {
	*x = ConfigMapVolumeSource{}
	mi := &file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfigMapVolumeSource) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{1}
}
...
func (x *SecretVolumeSource) Reset() {
	*x = SecretVolumeSource{}
	mi := &file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SecretVolumeSource) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{2}
}
...
func (x *HostPathVolumeSource) Reset() {
	*x = HostPathVolumeSource{}
	mi := &file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HostPathVolumeSource) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{3}
}
...
func (x *EmptyDirVolumeSource) Reset() {
	*x = EmptyDirVolumeSource{}
	mi := &file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EmptyDirVolumeSource) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{4}
}
...
func (x *PvcVolumeSource) Reset() {
	*x = PvcVolumeSource{}
	mi := &file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvcVolumeSource) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescGZIP(), []int{5}
}
...
var File_org_openmcf_provider_kubernetes_volume_mount_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDesc = "" +
	"\n" +
	"2org/openmcf/provider/kubernetes/volume_mount.proto\x12\x1forg.openmcf.provider.kubernetes\x1a\x1bbuf/validate/validate.proto\"\x98\x04\n" +
	...
	"\bsub_path\x18\x04 \x01(\tR\asubPath\x12U\n" +
	"\n" +
	"config_map\x18\x05 \x01(\v26.org.openmcf.provider.kubernetes.ConfigMapVolumeSourceR\tconfigMap\x12K\n" +
	"\x06secret\x18\x06 \x01(\v23.org.openmcf.provider.kubernetes.SecretVolumeSourceR\x06secret\x12R\n" +
	"\thost_path\x18\a \x01(\v25.org.openmcf.provider.kubernetes.HostPathVolumeSourceR\bhostPath\x12R\n" +
	"\tempty_dir\x18\b \x01(\v25.org.openmcf.provider.kubernetes.EmptyDirVolumeSourceR\bemptyDir\x12B\n" +
	"\x03pvc\x18\t \x01(\v20.org.openmcf.provider.kubernetes.PvcVolumeSourceR\x03pvc\"|\n" +
	...
	"\tread_only\x18\x02 \x01(\bR\breadOnlyB\x9a\x02\n" +
	"#com.org.openmcf.provider.kubernetesB\x10VolumeMountProtoP\x01ZAgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes\xa2\x02\x04OOPK\xaa\x02\x1fOrg.Openmcf.Provider.Kubernetes\xca\x02\x1fOrg\\Openmcf\\Provider\\Kubernetes\xe2\x02+Org\\Openmcf\\Provider\\Kubernetes\\GPBMetadata\xea\x02\"Org::Openmcf::Provider::Kubernetesb\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_org_openmcf_provider_kubernetes_volume_mount_proto_goTypes = []any{
	(*VolumeMount)(nil),           // 0: org.openmcf.provider.kubernetes.VolumeMount
	(*ConfigMapVolumeSource)(nil), // 1: org.openmcf.provider.kubernetes.ConfigMapVolumeSource
	(*SecretVolumeSource)(nil),    // 2: org.openmcf.provider.kubernetes.SecretVolumeSource
	(*HostPathVolumeSource)(nil),  // 3: org.openmcf.provider.kubernetes.HostPathVolumeSource
	(*EmptyDirVolumeSource)(nil),  // 4: org.openmcf.provider.kubernetes.EmptyDirVolumeSource
	(*PvcVolumeSource)(nil),       // 5: org.openmcf.provider.kubernetes.PvcVolumeSource
}
var file_org_openmcf_provider_kubernetes_volume_mount_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.kubernetes.VolumeMount.config_map:type_name -> org.openmcf.provider.kubernetes.ConfigMapVolumeSource
	2, // 1: org.openmcf.provider.kubernetes.VolumeMount.secret:type_name -> org.openmcf.provider.kubernetes.SecretVolumeSource
	3, // 2: org.openmcf.provider.kubernetes.VolumeMount.host_path:type_name -> org.openmcf.provider.kubernetes.HostPathVolumeSource
	4, // 3: org.openmcf.provider.kubernetes.VolumeMount.empty_dir:type_name -> org.openmcf.provider.kubernetes.EmptyDirVolumeSource
	5, // 4: org.openmcf.provider.kubernetes.VolumeMount.pvc:type_name -> org.openmcf.provider.kubernetes.PvcVolumeSource
...
func init() { file_org_openmcf_provider_kubernetes_volume_mount_proto_init() }
func file_org_openmcf_provider_kubernetes_volume_mount_proto_init() {
	if File_org_openmcf_provider_kubernetes_volume_mount_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_volume_mount_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_volume_mount_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_volume_mount_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_volume_mount_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_volume_mount_proto = out.File
	file_org_openmcf_provider_kubernetes_volume_mount_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_volume_mount_proto_depIdxs = nil
}
