...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesstatefulset/v1/spec.proto
...
func (x *KubernetesStatefulSetSpec) Reset() {
	*x = KubernetesStatefulSetSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_msgTypes[0]
...
func (*KubernetesStatefulSetSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesStatefulSetIngress) Reset() {
	*x = KubernetesStatefulSetIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesStatefulSetIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesStatefulSetContainer) Reset() {
	*x = KubernetesStatefulSetContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesStatefulSetContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesStatefulSetContainerApp) Reset() {
	*x = KubernetesStatefulSetContainerApp{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesStatefulSetContainerApp) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDesc = "" +
	...
	"\tcontainer\x18\x04 \x01(\v2X.org.openmcf.provider.kubernetes.kubernetesstatefulset.v1.KubernetesStatefulSetContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x12p\n" +
	"\aingress\x18\x05 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetesstatefulset.v1.KubernetesStatefulSetIngressR\aingress\x12\x7f\n" +
	"\favailability\x18\x06 \x01(\v2[.org.openmcf.provider.kubernetes.kubernetesstatefulset.v1.KubernetesStatefulSetAvailabilityR\favailability\x12\x98\x01\n" +
	"\x16volume_claim_templates\x18\a \x03(\v2b.org.openmcf.provider.kubernetes.kubernetesstatefulset.v1.KubernetesStatefulSetVolumeClaimTemplateR\x14volumeClaimTemplates\x12\xd5\x01\n" +
	...
	"\vconfig_maps\x18\t \x03(\v2c.org.openmcf.provider.kubernetes.kubernetesstatefulset.v1.KubernetesStatefulSetSpec.ConfigMapsEntryR\n" +
	"configMaps\x1a=\n" +
	...
	"\x0freadiness_probe\x18\a \x01(\v2&.org.openmcf.provider.kubernetes.ProbeR\x0ereadinessProbe\x12K\n" +
	...
	"\x15pod_disruption_budget\x18\x02 \x01(\v2b.org.openmcf.provider.kubernetes.kubernetesstatefulset.v1.KubernetesStatefulSetPodDisruptionBudgetR\x13podDisruptionBudget\"\x92\x01\n" +
	...
	"<com.org.openmcf.provider.kubernetes.kubernetesstatefulset.v1B\tSpecProtoP\x01Zrgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesstatefulset/v1;kubernetesstatefulsetv1\xa2\x02\x05OOPKK\xaa\x028Org.Openmcf.Provider.Kubernetes.Kubernetesstatefulset.V1\xca\x028Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesstatefulset\\V1\xe2\x02DOrg\\Openmcf\\Provider\\Kubernetes\\Kubernetesstatefulset\\V1\\GPBMetadata\xea\x02=Org::Openmcf::Provider::Kubernetes::Kubernetesstatefulset::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_rawDesc)))
	})
...
func file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesstatefulset_v1_spec_proto_depIdxs = nil
}
