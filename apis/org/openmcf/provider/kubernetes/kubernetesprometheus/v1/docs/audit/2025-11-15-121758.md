...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesprometheus/v1/`  
**Enum Value:** 815  
**ID Prefix:** k8sprom  
**Category:** workload  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesprometheus/v1/`
...
**Auditor:** OpenMCF Code Auditor  
**Tool Version:** audit-openmcf-component.mdc v1.0
