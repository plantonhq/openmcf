...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetespostgres/v1/`  
**Enum Value:** 814  
**ID Prefix:** k8spg  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetespostgres/v1/`
...
- `apis/org/openmcf/provider/kubernetes/kuberneteselasticsearch/v1/`
- `apis/org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/`
