...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/provider.proto
...
func (KubernetesProvider) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_provider_proto_enumTypes[0].Descriptor()
}

func (KubernetesProvider) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_provider_proto_enumTypes[0]
}
...
func (KubernetesProvider) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_provider_proto_rawDescGZIP(), []int{0}
}
...
type KubernetesProviderConfig struct {
	...
	Provider KubernetesProvider `protobuf:"varint,1,opt,name=provider,proto3,enum=org.openmcf.provider.kubernetes.KubernetesProvider" json:"provider,omitempty"`
...
func (x *KubernetesProviderConfig) Reset() {
	*x = KubernetesProviderConfig{}
	mi := &file_org_openmcf_provider_kubernetes_provider_proto_msgTypes[0]
...
func (x *KubernetesProviderConfigGcpGke) Reset() {
	*x = KubernetesProviderConfigGcpGke{}
	mi := &file_org_openmcf_provider_kubernetes_provider_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesProviderConfigGcpGke) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_provider_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesProviderConfigAwsEks) Reset() {
	*x = KubernetesProviderConfigAwsEks{}
	mi := &file_org_openmcf_provider_kubernetes_provider_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesProviderConfigAwsEks) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_provider_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesProviderConfigAzureAks) Reset() {
	*x = KubernetesProviderConfigAzureAks{}
	mi := &file_org_openmcf_provider_kubernetes_provider_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesProviderConfigAzureAks) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_provider_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesProviderConfigDigitalOceanDoks) Reset() {
	*x = KubernetesProviderConfigDigitalOceanDoks{}
	mi := &file_org_openmcf_provider_kubernetes_provider_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesProviderConfigDigitalOceanDoks) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_provider_proto_rawDescGZIP(), []int{4}
}
...
var File_org_openmcf_provider_kubernetes_provider_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_provider_proto_rawDesc = "" +
	"\n" +
	".org/openmcf/provider/kubernetes/provider.proto\x12\x1forg.openmcf.provider.kubernetes\x1a\x1bbuf/validate/validate.proto\"\x80\x04\n" +
	"\x18KubernetesProviderConfig\x12W\n" +
	"\bprovider\x18\x01 \x01(\x0e23.org.openmcf.provider.kubernetes.KubernetesProviderB\x06\xbaH\x03\xc8\x01\x01R\bprovider\x12X\n" +
	...
	"#com.org.openmcf.provider.kubernetesB\rProviderProtoP\x01ZAgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes\xa2\x02\x04OOPK\xaa\x02\x1fOrg.Openmcf.Provider.Kubernetes\xca\x02\x1fOrg\\Openmcf\\Provider\\Kubernetes\xe2\x02+Org\\Openmcf\\Provider\\Kubernetes\\GPBMetadata\xea\x02\"Org::Openmcf::Provider::Kubernetesb\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_provider_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_provider_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_provider_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_provider_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_provider_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_provider_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_provider_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_provider_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_kubernetes_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_org_openmcf_provider_kubernetes_provider_proto_goTypes = []any{
	(KubernetesProvider)(0),                          // 0: org.openmcf.provider.kubernetes.KubernetesProvider
	(*KubernetesProviderConfig)(nil),                 // 1: org.openmcf.provider.kubernetes.KubernetesProviderConfig
	(*KubernetesProviderConfigGcpGke)(nil),           // 2: org.openmcf.provider.kubernetes.KubernetesProviderConfigGcpGke
	(*KubernetesProviderConfigAwsEks)(nil),           // 3: org.openmcf.provider.kubernetes.KubernetesProviderConfigAwsEks
	(*KubernetesProviderConfigAzureAks)(nil),         // 4: org.openmcf.provider.kubernetes.KubernetesProviderConfigAzureAks
	(*KubernetesProviderConfigDigitalOceanDoks)(nil), // 5: org.openmcf.provider.kubernetes.KubernetesProviderConfigDigitalOceanDoks
}
var file_org_openmcf_provider_kubernetes_provider_proto_depIdxs = []int32{
	0, // 0: org.openmcf.provider.kubernetes.KubernetesProviderConfig.provider:type_name -> org.openmcf.provider.kubernetes.KubernetesProvider
	2, // 1: org.openmcf.provider.kubernetes.KubernetesProviderConfig.gcp_gke:type_name -> org.openmcf.provider.kubernetes.KubernetesProviderConfigGcpGke
	3, // 2: org.openmcf.provider.kubernetes.KubernetesProviderConfig.aws_eks:type_name -> org.openmcf.provider.kubernetes.KubernetesProviderConfigAwsEks
	4, // 3: org.openmcf.provider.kubernetes.KubernetesProviderConfig.azure_aks:type_name -> org.openmcf.provider.kubernetes.KubernetesProviderConfigAzureAks
	5, // 4: org.openmcf.provider.kubernetes.KubernetesProviderConfig.digital_ocean_doks:type_name -> org.openmcf.provider.kubernetes.KubernetesProviderConfigDigitalOceanDoks
...
func init() { file_org_openmcf_provider_kubernetes_provider_proto_init() }
func file_org_openmcf_provider_kubernetes_provider_proto_init() {
	if File_org_openmcf_provider_kubernetes_provider_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_provider_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_provider_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_provider_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_provider_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_kubernetes_provider_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_kubernetes_provider_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_provider_proto = out.File
	file_org_openmcf_provider_kubernetes_provider_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_provider_proto_depIdxs = nil
}
