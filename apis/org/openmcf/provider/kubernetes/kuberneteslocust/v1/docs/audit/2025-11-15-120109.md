...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kuberneteslocust/v1/`  
**Enum Value:** 809  
**ID Prefix:** k8sloc
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kuberneteslocust/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kuberneteslocust/v1/
go test -v
```
