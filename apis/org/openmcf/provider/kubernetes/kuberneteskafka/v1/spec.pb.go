...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kuberneteskafka/v1/spec.proto
...
func (x *KubernetesKafkaSpec) Reset() {
	*x = KubernetesKafkaSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes[0]
...
func (*KubernetesKafkaSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesKafkaIngress) Reset() {
	*x = KubernetesKafkaIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesKafkaBrokerContainer) Reset() {
	*x = KubernetesKafkaBrokerContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaBrokerContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesKafkaZookeeperContainer) Reset() {
	*x = KubernetesKafkaZookeeperContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaZookeeperContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesKafkaSchemaRegistryContainer) Reset() {
	*x = KubernetesKafkaSchemaRegistryContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaSchemaRegistryContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KafkaTopic) Reset() {
	*x = KafkaTopic{}
	mi := &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaTopic) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
var file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesKafkaBrokerContainer)(nil),
		Field:         524001,
		Name:          "org.openmcf.provider.kubernetes.kuberneteskafka.v1.default_broker_container",
		Tag:           "bytes,524001,opt,name=default_broker_container",
		Filename:      "org/openmcf/provider/kubernetes/kuberneteskafka/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesKafkaZookeeperContainer)(nil),
		Field:         524002,
		Name:          "org.openmcf.provider.kubernetes.kuberneteskafka.v1.default_zookeeper_container",
...
var (
	// optional org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaBrokerContainer default_broker_container = 524001;
	E_DefaultBrokerContainer = &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_extTypes[0]
	// optional org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaZookeeperContainer default_zookeeper_container = 524002;
	E_DefaultZookeeperContainer = &file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_extTypes[1]
)

var File_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=org/openmcf/provider/kubernetes/kuberneteskafka/v1/spec.proto\x122org.openmcf.provider.kubernetes.kuberneteskafka.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a0org/openmcf/provider/kubernetes/kubernetes.proto\x1a-org/openmcf/provider/kubernetes/options.proto\x1a4org/openmcf/provider/kubernetes/target_cluster.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\x89\b\n" +
	...
	"\fkafka_topics\x18\x04 \x03(\v2>.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KafkaTopicR\vkafkaTopics\x12\xa9\x01\n" +
	"\x10broker_container\x18\x05 \x01(\v2R.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaBrokerContainerB*\x8a\xee\xff\x01%\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x1a\x031GiR\x0fbrokerContainer\x12\xb2\x01\n" +
	"\x13zookeeper_container\x18\x06 \x01(\v2U.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaZookeeperContainerB*\x92\xee\xff\x01%\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x1a\x031GiR\x12zookeeperContainer\x12\x96\x01\n" +
	"\x19schema_registry_container\x18\a \x01(\v2Z.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSchemaRegistryContainerR\x17schemaRegistryContainer\x12d\n" +
	"\aingress\x18\b \x01(\v2J.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaIngressR\aingress\x125\n" +
	...
	"\tresources\x18\x02 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesR\tresources\x12\xc1\x01\n" +
	...
	"\tresources\x18\x03 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesB!\xba\xfb\xa4\x02\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	...
	"\x06config\x18\x04 \x03(\v2J.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KafkaTopic.ConfigEntryB\xd1\x02\x9a\xa6\x1d\x18\n" +
	...
	"\v_partitionsB\v\n" +
	"\t_replicas:\xad\x01\n" +
	"\x18default_broker_container\x12\x1d.google.protobuf.FieldOptions\x18\xe1\xfd\x1f \x01(\v2R.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaBrokerContainerR\x16defaultBrokerContainer:\xb6\x01\n" +
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xfd\x1f \x01(\v2U.org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaZookeeperContainerR\x19defaultZookeeperContainerB\x9a\x03\n" +
	"6com.org.openmcf.provider.kubernetes.kuberneteskafka.v1B\tSpecProtoP\x01Zfgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kuberneteskafka/v1;kuberneteskafkav1\xa2\x02\x05OOPKK\xaa\x022Org.Openmcf.Provider.Kubernetes.Kuberneteskafka.V1\xca\x022Org\\Openmcf\\Provider\\Kubernetes\\Kuberneteskafka\\V1\xe2\x02>Org\\Openmcf\\Provider\\Kubernetes\\Kuberneteskafka\\V1\\GPBMetadata\xea\x027Org::Openmcf::Provider::Kubernetes::Kuberneteskafka::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_goTypes = []any{
	(*KubernetesKafkaSpec)(nil),                    // 0: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec
	(*KubernetesKafkaIngress)(nil),                 // 1: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaIngress
	(*KubernetesKafkaBrokerContainer)(nil),         // 2: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaBrokerContainer
	(*KubernetesKafkaZookeeperContainer)(nil),      // 3: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaZookeeperContainer
	(*KubernetesKafkaSchemaRegistryContainer)(nil), // 4: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSchemaRegistryContainer
	(*KafkaTopic)(nil),                             // 5: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KafkaTopic
	nil,                                            // 6: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KafkaTopic.ConfigEntry
	(*kubernetes.KubernetesClusterSelector)(nil),   // 7: org.openmcf.provider.kubernetes.KubernetesClusterSelector
...
var file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_depIdxs = []int32{
	7,  // 0: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec.target_cluster:type_name -> org.openmcf.provider.kubernetes.KubernetesClusterSelector
	8,  // 1: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec.namespace:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	5,  // 2: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec.kafka_topics:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KafkaTopic
	2,  // 3: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec.broker_container:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaBrokerContainer
	3,  // 4: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec.zookeeper_container:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaZookeeperContainer
	4,  // 5: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec.schema_registry_container:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSchemaRegistryContainer
	1,  // 6: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSpec.ingress:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaIngress
	9,  // 7: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaBrokerContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	9,  // 8: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaZookeeperContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	9,  // 9: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaSchemaRegistryContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	6,  // 10: org.openmcf.provider.kubernetes.kuberneteskafka.v1.KafkaTopic.config:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KafkaTopic.ConfigEntry
	10, // 11: org.openmcf.provider.kubernetes.kuberneteskafka.v1.default_broker_container:extendee -> google.protobuf.FieldOptions
	10, // 12: org.openmcf.provider.kubernetes.kuberneteskafka.v1.default_zookeeper_container:extendee -> google.protobuf.FieldOptions
	2,  // 13: org.openmcf.provider.kubernetes.kuberneteskafka.v1.default_broker_container:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaBrokerContainer
	3,  // 14: org.openmcf.provider.kubernetes.kuberneteskafka.v1.default_zookeeper_container:type_name -> org.openmcf.provider.kubernetes.kuberneteskafka.v1.KubernetesKafkaZookeeperContainer
...
func init() { file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_init() }
func file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_extTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kuberneteskafka_v1_spec_proto_depIdxs = nil
}
