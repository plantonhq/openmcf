...
- Folder exists at correct path: `apis/org/openmcf/provider/kubernetes/kuberneteskafka/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kuberneteskafka/v1/
go test -v
```
...
**Path to reference:** `apis/org/openmcf/provider/kubernetes/kuberneteselasticsearch/v1/`
