...
- Automatic namespace creation with OpenMCF labels
...
# Deploy
openmcf pulumi up --manifest operator.yaml
```
...
import (
    ...
    "github.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kuberneteszalandopostgresoperator/v1/iac/pulumi/module"
)
...
- **Label Inheritance**: Operator configured to propagate OpenMCF labels to all databases
