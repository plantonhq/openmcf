...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesdeployment/v1/spec.proto
...
func (x *KubernetesDeploymentSpec) Reset() {
	*x = KubernetesDeploymentSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_msgTypes[0]
...
func (*KubernetesDeploymentSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesDeploymentIngress) Reset() {
	*x = KubernetesDeploymentIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesDeploymentContainer) Reset() {
	*x = KubernetesDeploymentContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesDeploymentContainerApp) Reset() {
	*x = KubernetesDeploymentContainerApp{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentContainerApp) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDesc = "" +
	...
	"\tcontainer\x18\x05 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetesdeployment.v1.KubernetesDeploymentContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x12n\n" +
	"\aingress\x18\x06 \x01(\v2T.org.openmcf.provider.kubernetes.kubernetesdeployment.v1.KubernetesDeploymentIngressR\aingress\x12}\n" +
	"\favailability\x18\a \x01(\v2Y.org.openmcf.provider.kubernetes.kubernetesdeployment.v1.KubernetesDeploymentAvailabilityR\favailability\x12\x82\x01\n" +
	"\vconfig_maps\x18\b \x03(\v2a.org.openmcf.provider.kubernetes.kubernetesdeployment.v1.KubernetesDeploymentSpec.ConfigMapsEntryR\n" +
	"configMaps\x1a=\n" +
	...
	"\rstartup_probe\x18\a \x01(\v2&.org.openmcf.provider.kubernetes.ProbeR\fstartupProbe\x12Q\n" +
	...
	"\x1ahorizontal_pod_autoscaling\x18\x02 \x01(\v2\\.org.openmcf.provider.kubernetes.kubernetesdeployment.v1.KubernetesDeploymentAvailabilityHpaR\x18horizontalPodAutoscaling\x12\x90\x01\n" +
	"\x13deployment_strategy\x18\x03 \x01(\v2_.org.openmcf.provider.kubernetes.kubernetesdeployment.v1.KubernetesDeploymentDeploymentStrategyR\x12deploymentStrategy\x12\x94\x01\n" +
	"\x15pod_disruption_budget\x18\x04 \x01(\v2`.org.openmcf.provider.kubernetes.kubernetesdeployment.v1.KubernetesDeploymentPodDisruptionBudgetR\x13podDisruptionBudget\"\xc5\x01\n" +
	...
	";com.org.openmcf.provider.kubernetes.kubernetesdeployment.v1B\tSpecProtoP\x01Zpgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesdeployment/v1;kubernetesdeploymentv1\xa2\x02\x05OOPKK\xaa\x027Org.Openmcf.Provider.Kubernetes.Kubernetesdeployment.V1\xca\x027Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesdeployment\\V1\xe2\x02COrg\\Openmcf\\Provider\\Kubernetes\\Kubernetesdeployment\\V1\\GPBMetadata\xea\x02<Org::Openmcf::Provider::Kubernetes::Kubernetesdeployment::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_rawDesc)))
	})
...
func file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesdeployment_v1_spec_proto_depIdxs = nil
}
