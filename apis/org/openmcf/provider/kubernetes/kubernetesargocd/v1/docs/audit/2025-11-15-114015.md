...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesargocd/v1/`  
**Enum Value:** 800  
**ID Prefix:** k8sargo  
...
- Folder exists at correct path: `apis/org/openmcf/provider/kubernetes/kubernetesargocd/v1/`
...
This is one of the **best research documents** in the entire OpenMCF codebase. It's opinionated, comprehensive, and explains the "why" behind design decisions. The only issue is that the code doesn't implement what the documentation describes.
...
Alternatively, use the **update-openmcf-component** rule with specific instructions to:
...
**Path to reference:** `apis/org/openmcf/provider/kubernetes/kubernetestemporal/v1/`
...
5. **Re-run audit to verify improvements**:
   - Run `@audit-openmcf-component KubernetesArgocd` after changes
