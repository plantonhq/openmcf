...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/`  
**Enum Value:** 816  
**ID Prefix:** k8sred  
**Category:** workload  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/`
...
- Focused on OpenMCF perspective
