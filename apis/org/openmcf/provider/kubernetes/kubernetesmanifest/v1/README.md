...
While OpenMCF provides specialized deployment components for common workloads (Deployments, StatefulSets, DaemonSets, Helm releases), there are many scenarios where you need to deploy custom or third-party Kubernetes manifests:
...
- **Migration Assistance**: Migrate existing YAML-based deployments to OpenMCF
