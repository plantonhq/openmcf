...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesmongodb/v1/`  
**Enum Value:** 811  
**ID Prefix:** k8smdb  
...
- Folder exists at correct path: `apis/org/openmcf/provider/kubernetes/kubernetesmongodb/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kubernetesmongodb/v1/
go test -v
```
...
- **update-openmcf-component** rule with specific instructions to fix mongodb.tf
...
**Path to reference:** `apis/org/openmcf/provider/kubernetes/kuberneteskafka/v1/`
