...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesdaemonset/v1/spec.proto
...
func (x *KubernetesDaemonSetSpec) Reset() {
	*x = KubernetesDaemonSetSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_msgTypes[0]
...
func (*KubernetesDaemonSetSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesDaemonSetContainer) Reset() {
	*x = KubernetesDaemonSetContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDaemonSetContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesDaemonSetContainerApp) Reset() {
	*x = KubernetesDaemonSetContainerApp{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDaemonSetContainerApp) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDesc = "" +
	...
	"\tcontainer\x18\x04 \x01(\v2T.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x12\x86\x01\n" +
	"\rnode_selector\x18\x05 \x03(\v2a.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetSpec.NodeSelectorEntryR\fnodeSelector\x12w\n" +
	"\vtolerations\x18\x06 \x03(\v2U.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetTolerationR\vtolerations\x12\x82\x01\n" +
	"\x0fupdate_strategy\x18\a \x01(\v2Y.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetUpdateStrategyR\x0eupdateStrategy\x12*\n" +
	...
	"\vconfig_maps\x18\v \x03(\v2_.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetSpec.ConfigMapsEntryR\n" +
	"configMaps\x12c\n" +
	"\x04rbac\x18\f \x01(\v2O.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetRbacR\x04rbac\x1a?\n" +
	...
	"\x0erolling_update\x18\x02 \x01(\v2X.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetRollingUpdateR\rrollingUpdate\"h\n" +
	...
	"\fcapabilities\x18\x06 \x01(\v2W.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetCapabilitiesR\fcapabilities\"G\n" +
	...
	"\rcluster_rules\x18\x01 \x03(\v2S.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetRbacRuleR\fclusterRules\x12|\n" +
	"\x0fnamespace_rules\x18\x02 \x03(\v2S.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1.KubernetesDaemonSetRbacRuleR\x0enamespaceRules\"\xb5\x01\n" +
	...
	":com.org.openmcf.provider.kubernetes.kubernetesdaemonset.v1B\tSpecProtoP\x01Zngithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesdaemonset/v1;kubernetesdaemonsetv1\xa2\x02\x05OOPKK\xaa\x026Org.Openmcf.Provider.Kubernetes.Kubernetesdaemonset.V1\xca\x026Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesdaemonset\\V1\xe2\x02BOrg\\Openmcf\\Provider\\Kubernetes\\Kubernetesdaemonset\\V1\\GPBMetadata\xea\x02;Org::Openmcf::Provider::Kubernetes::Kubernetesdaemonset::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_rawDesc)))
	})
...
func file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesdaemonset_v1_spec_proto_depIdxs = nil
}
