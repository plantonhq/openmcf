...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesopenbao/v1/stack_outputs.proto
...
func (x *KubernetesOpenBaoStackOutputs) Reset() {
	*x = KubernetesOpenBaoStackOutputs{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesOpenBaoStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Horg/openmcf/provider/kubernetes/kubernetesopenbao/v1/stack_outputs.proto\x124org.openmcf.provider.kubernetes.kubernetesopenbao.v1\x1a0org/openmcf/provider/kubernetes/kubernetes.proto\"\x8a\x04\n" +
	...
	"\x11root_token_secret\x18\x06 \x01(\v24.org.openmcf.provider.kubernetes.KubernetesSecretKeyR\x0frootTokenSecret\x12b\n" +
	"\x12unseal_keys_secret\x18\a \x01(\v24.org.openmcf.provider.kubernetes.KubernetesSecretKeyR\x10unsealKeysSecret\x12'\n" +
...
var (
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_goTypes = []any{
	(*KubernetesOpenBaoStackOutputs)(nil),  // 0: org.openmcf.provider.kubernetes.kubernetesopenbao.v1.KubernetesOpenBaoStackOutputs
	(*kubernetes.KubernetesSecretKey)(nil), // 1: org.openmcf.provider.kubernetes.KubernetesSecretKey
}
var file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.kubernetes.kubernetesopenbao.v1.KubernetesOpenBaoStackOutputs.root_token_secret:type_name -> org.openmcf.provider.kubernetes.KubernetesSecretKey
	1, // 1: org.openmcf.provider.kubernetes.kubernetesopenbao.v1.KubernetesOpenBaoStackOutputs.unseal_keys_secret:type_name -> org.openmcf.provider.kubernetes.KubernetesSecretKey
...
func init() { file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_stack_outputs_proto_depIdxs = nil
}
