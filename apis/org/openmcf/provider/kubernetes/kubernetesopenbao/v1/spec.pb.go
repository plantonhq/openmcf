...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesopenbao/v1/spec.proto
...
func (x *KubernetesOpenBaoSpec) Reset() {
	*x = KubernetesOpenBaoSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_msgTypes[0]
...
func (*KubernetesOpenBaoSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesOpenBaoServerContainer) Reset() {
	*x = KubernetesOpenBaoServerContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesOpenBaoServerContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesOpenBaoHighAvailability) Reset() {
	*x = KubernetesOpenBaoHighAvailability{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesOpenBaoHighAvailability) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesOpenBaoIngress) Reset() {
	*x = KubernetesOpenBaoIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesOpenBaoIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesOpenBaoInjector) Reset() {
	*x = KubernetesOpenBaoInjector{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesOpenBaoInjector) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         537100,
		Name:          "org.openmcf.provider.kubernetes.kubernetesopenbao.v1.default_server_container",
		Tag:           "bytes,537100,opt,name=default_server_container",
		Filename:      "org/openmcf/provider/kubernetes/kubernetesopenbao/v1/spec.proto",
	},
}

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional org.openmcf.provider.kubernetes.kubernetesopenbao.v1.KubernetesOpenBaoServerContainer default_server_container = 537100;
	E_DefaultServerContainer = &file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_extTypes[0]
)

var File_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto protoreflect.FileDescriptor
...
const file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDesc = "" +
	...
	"\x10server_container\x18\x05 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetesopenbao.v1.KubernetesOpenBaoServerContainerB-⠆\x02(\b\x01\x12\x1e\n" +
	"\r\n" +
	"\x04500m\x12\x05256Mi\x12\r\n" +
	"\x04100m\x12\x05128Mi\x1a\x0410GiR\x0fserverContainer\x12\x84\x01\n" +
	"\x11high_availability\x18\x06 \x01(\v2W.org.openmcf.provider.kubernetes.kubernetesopenbao.v1.KubernetesOpenBaoHighAvailabilityR\x10highAvailability\x12h\n" +
	"\aingress\x18\a \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesopenbao.v1.KubernetesOpenBaoIngressR\aingress\x12,\n" +
	"\n" +
	...
	"(\x01R\breplicas\x12Q\n" +
	"\tresources\x18\x02 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesR\tresources\x12d\n" +
...
var (
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_rawDesc)))
	})
...
func file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_extTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesopenbao_v1_spec_proto_depIdxs = nil
}
