...
# Deploy
openmcf pulumi up --manifest manifest.yaml --module-dir ${KUBERNETES_EXTERNAL_SECRETS_MODULE}
```
...
```shell
openmcf pulumi preview --manifest manifest.yaml --module-dir ${KUBERNETES_EXTERNAL_SECRETS_MODULE}
```
...
```shell
openmcf pulumi destroy --manifest manifest.yaml --module-dir ${KUBERNETES_EXTERNAL_SECRETS_MODULE}
```
