...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/probe.proto
...
func (x *Probe) Reset() {
	*x = Probe{}
	mi := &file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[0]
...
func (*Probe) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_probe_proto_rawDescGZIP(), []int{0}
}
...
func (x *HTTPGetAction) Reset() {
	*x = HTTPGetAction{}
	mi := &file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPGetAction) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_probe_proto_rawDescGZIP(), []int{1}
}
...
func (x *HTTPHeader) Reset() {
	*x = HTTPHeader{}
	mi := &file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPHeader) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_probe_proto_rawDescGZIP(), []int{2}
}
...
func (x *GRPCAction) Reset() {
	*x = GRPCAction{}
	mi := &file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GRPCAction) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_probe_proto_rawDescGZIP(), []int{3}
}
...
func (x *TCPSocketAction) Reset() {
	*x = TCPSocketAction{}
	mi := &file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TCPSocketAction) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_probe_proto_rawDescGZIP(), []int{4}
}
...
func (x *ExecAction) Reset() {
	*x = ExecAction{}
	mi := &file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecAction) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_probe_proto_rawDescGZIP(), []int{5}
}
...
var File_org_openmcf_provider_kubernetes_probe_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_probe_proto_rawDesc = "" +
	"\n" +
	"+org/openmcf/provider/kubernetes/probe.proto\x12\x1forg.openmcf.provider.kubernetes\x1a\x1bbuf/validate/validate.proto\"\x96\x04\n" +
	"\x05Probe\x122\n" +
	...
	"\x11failure_threshold\x18\x05 \x01(\x05R\x10failureThreshold\x12K\n" +
	"\bhttp_get\x18\x06 \x01(\v2..org.openmcf.provider.kubernetes.HTTPGetActionH\x00R\ahttpGet\x12A\n" +
	"\x04grpc\x18\a \x01(\v2+.org.openmcf.provider.kubernetes.GRPCActionH\x00R\x04grpc\x12Q\n" +
	"\n" +
	"tcp_socket\x18\b \x01(\v20.org.openmcf.provider.kubernetes.TCPSocketActionH\x00R\ttcpSocket\x12A\n" +
	"\x04exec\x18\t \x01(\v2+.org.openmcf.provider.kubernetes.ExecActionH\x00R\x04execB\t\n" +
	"\ahandler\"\xe9\x01\n" +
	...
	"\x06scheme\x18\x05 \x01(\tR\x06scheme\x12N\n" +
	"\fhttp_headers\x18\x06 \x03(\v2+.org.openmcf.provider.kubernetes.HTTPHeaderR\vhttpHeadersB\x06\n" +
	"\x04port\"6\n" +
	"\n" +
	"HTTPHeader\x12\x12\n" +
	...
	"\n" +
	"ExecAction\x12\x18\n" +
	"\acommand\x18\x01 \x03(\tR\acommandB\x94\x02\n" +
	"#com.org.openmcf.provider.kubernetesB\n" +
	"ProbeProtoP\x01ZAgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes\xa2\x02\x04OOPK\xaa\x02\x1fOrg.Openmcf.Provider.Kubernetes\xca\x02\x1fOrg\\Openmcf\\Provider\\Kubernetes\xe2\x02+Org\\Openmcf\\Provider\\Kubernetes\\GPBMetadata\xea\x02\"Org::Openmcf::Provider::Kubernetesb\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_probe_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_probe_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_probe_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_probe_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_probe_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_probe_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_probe_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_probe_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_probe_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_org_openmcf_provider_kubernetes_probe_proto_goTypes = []any{
	(*Probe)(nil),           // 0: org.openmcf.provider.kubernetes.Probe
	(*HTTPGetAction)(nil),   // 1: org.openmcf.provider.kubernetes.HTTPGetAction
	(*HTTPHeader)(nil),      // 2: org.openmcf.provider.kubernetes.HTTPHeader
	(*GRPCAction)(nil),      // 3: org.openmcf.provider.kubernetes.GRPCAction
	(*TCPSocketAction)(nil), // 4: org.openmcf.provider.kubernetes.TCPSocketAction
	(*ExecAction)(nil),      // 5: org.openmcf.provider.kubernetes.ExecAction
}
var file_org_openmcf_provider_kubernetes_probe_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.kubernetes.Probe.http_get:type_name -> org.openmcf.provider.kubernetes.HTTPGetAction
	3, // 1: org.openmcf.provider.kubernetes.Probe.grpc:type_name -> org.openmcf.provider.kubernetes.GRPCAction
	4, // 2: org.openmcf.provider.kubernetes.Probe.tcp_socket:type_name -> org.openmcf.provider.kubernetes.TCPSocketAction
	5, // 3: org.openmcf.provider.kubernetes.Probe.exec:type_name -> org.openmcf.provider.kubernetes.ExecAction
	2, // 4: org.openmcf.provider.kubernetes.HTTPGetAction.http_headers:type_name -> org.openmcf.provider.kubernetes.HTTPHeader
...
func init() { file_org_openmcf_provider_kubernetes_probe_proto_init() }
func file_org_openmcf_provider_kubernetes_probe_proto_init() {
	if File_org_openmcf_provider_kubernetes_probe_proto != nil {
		return
	}
	file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[0].OneofWrappers = []any{
		(*Probe_HttpGet)(nil),
		(*Probe_Grpc)(nil),
		(*Probe_TcpSocket)(nil),
		(*Probe_Exec)(nil),
	}
	file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[1].OneofWrappers = []any{
		(*HTTPGetAction_PortNumber)(nil),
		(*HTTPGetAction_PortName)(nil),
	}
	file_org_openmcf_provider_kubernetes_probe_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_probe_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_probe_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_probe_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_probe_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_probe_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_probe_proto = out.File
	file_org_openmcf_provider_kubernetes_probe_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_probe_proto_depIdxs = nil
}
