...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesexternaldns/v1/spec.proto
...
func (x *KubernetesExternalDnsSpec) Reset() {
	*x = KubernetesExternalDnsSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes[0]
...
func (*KubernetesExternalDnsSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesExternalDnsGkeConfig) Reset() {
	*x = KubernetesExternalDnsGkeConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsGkeConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesExternalDnsEksConfig) Reset() {
	*x = KubernetesExternalDnsEksConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsEksConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesExternalDnsAksConfig) Reset() {
	*x = KubernetesExternalDnsAksConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsAksConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesExternalDnsCloudflareConfig) Reset() {
	*x = KubernetesExternalDnsCloudflareConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsCloudflareConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Corg/openmcf/provider/kubernetes/kubernetesexternaldns/v1/spec.proto\x128org.openmcf.provider.kubernetes.kubernetesexternaldns.v1\x1a\x1bbuf/validate/validate.proto\x1a4org/openmcf/provider/kubernetes/target_cluster.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xad\a\n" +
	...
	"\x03gke\x18\xc8\x01 \x01(\v2X.org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsGkeConfigH\x00R\x03gke\x12m\n" +
	"\x03eks\x18\xc9\x01 \x01(\v2X.org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsEksConfigH\x00R\x03eks\x12m\n" +
	"\x03aks\x18\xca\x01 \x01(\v2X.org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsAksConfigH\x00R\x03aks\x12\x82\x01\n" +
	"\n" +
	"cloudflare\x18\xcb\x01 \x01(\v2_.org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsCloudflareConfigH\x00R\n" +
	"cloudflareB\x11\n" +
	...
	"\n" +
	"project_id\x18\x01 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB(\xbaH\x03\xc8\x01\x01\x88\xd4a\xe1\x04\x92\xd4a\x19status.outputs.project_idR\tprojectId\x12y\n" +
	"\vdns_zone_id\x18\x02 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB%\xbaH\x03\xc8\x01\x01\x88\xd4a\xdd\x04\x92\xd4a\x16status.outputs.zone_idR\tdnsZoneId\"\xd9\x01\n" +
	"\x1eKubernetesExternalDnsEksConfig\x12\x81\x01\n" +
	"\x0froute53_zone_id\x18\x01 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB%\xbaH\x03\xc8\x01\x01\x88\xd4a\xd4\x01\x92\xd4a\x16status.outputs.zone_idR\rroute53ZoneId\x123\n" +
	"\x16irsa_role_arn_override\x18\x02 \x01(\tR\x13irsaRoleArnOverride\"\xd8\x01\n" +
	"\x1eKubernetesExternalDnsAksConfig\x12y\n" +
	"\vdns_zone_id\x18\x01 \x01(\v22.org.openmcf.shared.foreignkey.v1.StringValueOrRefB%\xbaH\x03\xc8\x01\x01\x88\xd4a\x93\x03\x92\xd4a\x16status.outputs.zone_idR\tdnsZoneId\x12;\n" +
	...
	"<com.org.openmcf.provider.kubernetes.kubernetesexternaldns.v1B\tSpecProtoP\x01Zrgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesexternaldns/v1;kubernetesexternaldnsv1\xa2\x02\x05OOPKK\xaa\x028Org.Openmcf.Provider.Kubernetes.Kubernetesexternaldns.V1\xca\x028Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesexternaldns\\V1\xe2\x02DOrg\\Openmcf\\Provider\\Kubernetes\\Kubernetesexternaldns\\V1\\GPBMetadata\xea\x02=Org::Openmcf::Provider::Kubernetes::Kubernetesexternaldns::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_goTypes = []any{
	(*KubernetesExternalDnsSpec)(nil),             // 0: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsSpec
	(*KubernetesExternalDnsGkeConfig)(nil),        // 1: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsGkeConfig
	(*KubernetesExternalDnsEksConfig)(nil),        // 2: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsEksConfig
	(*KubernetesExternalDnsAksConfig)(nil),        // 3: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsAksConfig
	(*KubernetesExternalDnsCloudflareConfig)(nil), // 4: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsCloudflareConfig
...
var file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_depIdxs = []int32{
	5,  // 0: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsSpec.target_cluster:type_name -> org.openmcf.provider.kubernetes.KubernetesClusterSelector
	6,  // 1: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsSpec.namespace:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	1,  // 2: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsSpec.gke:type_name -> org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsGkeConfig
	2,  // 3: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsSpec.eks:type_name -> org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsEksConfig
	3,  // 4: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsSpec.aks:type_name -> org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsAksConfig
	4,  // 5: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsSpec.cloudflare:type_name -> org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsCloudflareConfig
	6,  // 6: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsGkeConfig.project_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	6,  // 7: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsGkeConfig.dns_zone_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	6,  // 8: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsEksConfig.route53_zone_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	6,  // 9: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsAksConfig.dns_zone_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	6,  // 10: org.openmcf.provider.kubernetes.kubernetesexternaldns.v1.KubernetesExternalDnsCloudflareConfig.dns_zone_id:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesexternaldns_v1_spec_proto_depIdxs = nil
}
