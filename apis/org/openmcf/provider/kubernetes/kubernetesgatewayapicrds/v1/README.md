...
**KubernetesGatewayApiCrds** is a OpenMCF component that installs the [Kubernetes Gateway API](https://gateway-api.sigs.k8s.io/) CRDs on any Kubernetes cluster. The Gateway API is the next evolution of Kubernetes ingress, providing a more expressive, role-oriented API for managing HTTP, TLS, and TCP routing.
