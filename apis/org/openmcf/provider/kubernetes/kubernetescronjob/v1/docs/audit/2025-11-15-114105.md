...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetescronjob/v1/`  
**Enum Value:** 801  
**ID Prefix:** k8scron  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetescronjob/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kubernetescronjob/v1/
go test -v
```
...
- ✅ **OpenMCF Integration**: Explains how OpenMCF's abstraction solves native API problems
...
**Path to reference:** `apis/org/openmcf/provider/kubernetes/kubernetescronjob/v1/`
