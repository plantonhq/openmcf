...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesharbor/v1/spec.proto
...
func (KubernetesHarborStorageType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesHarborStorageType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_enumTypes[0]
}
...
func (KubernetesHarborStorageType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesHarborSpec) Reset() {
	*x = KubernetesHarborSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesHarborContainer) Reset() {
	*x = KubernetesHarborContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesHarborDatabaseConfig) Reset() {
	*x = KubernetesHarborDatabaseConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborDatabaseConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesHarborExternalPostgresql) Reset() {
	*x = KubernetesHarborExternalPostgresql{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborExternalPostgresql) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesHarborManagedPostgresql) Reset() {
	*x = KubernetesHarborManagedPostgresql{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborManagedPostgresql) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesHarborPostgresqlContainer) Reset() {
	*x = KubernetesHarborPostgresqlContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborPostgresqlContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesHarborCacheConfig) Reset() {
	*x = KubernetesHarborCacheConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborCacheConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesHarborExternalRedis) Reset() {
	*x = KubernetesHarborExternalRedis{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborExternalRedis) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *KubernetesHarborManagedRedis) Reset() {
	*x = KubernetesHarborManagedRedis{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborManagedRedis) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *KubernetesHarborRedisContainer) Reset() {
	*x = KubernetesHarborRedisContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborRedisContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
type KubernetesHarborStorageConfig struct {
	...
	Type KubernetesHarborStorageType `protobuf:"varint,1,opt,name=type,proto3,enum=org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageType" json:"type,omitempty"`
...
func (x *KubernetesHarborStorageConfig) Reset() {
	*x = KubernetesHarborStorageConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborStorageConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *KubernetesHarborS3Storage) Reset() {
	*x = KubernetesHarborS3Storage{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborS3Storage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *KubernetesHarborGcsStorage) Reset() {
	*x = KubernetesHarborGcsStorage{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborGcsStorage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *KubernetesHarborAzureStorage) Reset() {
	*x = KubernetesHarborAzureStorage{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborAzureStorage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *KubernetesHarborOssStorage) Reset() {
	*x = KubernetesHarborOssStorage{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborOssStorage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *KubernetesHarborFilesystemStorage) Reset() {
	*x = KubernetesHarborFilesystemStorage{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborFilesystemStorage) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *KubernetesHarborIngress) Reset() {
	*x = KubernetesHarborIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{16}
}
...
func (x *KubernetesHarborIngressEndpoint) Reset() {
	*x = KubernetesHarborIngressEndpoint{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHarborIngressEndpoint) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP(), []int{17}
}
...
var file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesHarborContainer)(nil),
		Field:         570001,
		Name:          "org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_core_container",
		Tag:           "bytes,570001,opt,name=default_harbor_core_container",
		Filename:      "org/openmcf/provider/kubernetes/kubernetesharbor/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesHarborContainer)(nil),
		Field:         570002,
		Name:          "org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_portal_container",
	...
	},
	{
		...
		ExtensionType: (*KubernetesHarborContainer)(nil),
		Field:         570003,
		Name:          "org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_registry_container",
	...
	},
	{
		...
		ExtensionType: (*KubernetesHarborContainer)(nil),
		Field:         570004,
		Name:          "org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_jobservice_container",
	...
	},
	{
		...
		Field:         570005,
		Name:          "org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_postgresql_container",
	...
	},
	{
		...
		Field:         570006,
		Name:          "org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_redis_container",
...
var (
	// optional org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer default_harbor_core_container = 570001;
	E_DefaultHarborCoreContainer = &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes[0]
	// optional org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer default_harbor_portal_container = 570002;
	E_DefaultHarborPortalContainer = &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes[1]
	// optional org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer default_harbor_registry_container = 570003;
	E_DefaultHarborRegistryContainer = &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes[2]
	// optional org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer default_harbor_jobservice_container = 570004;
	E_DefaultHarborJobserviceContainer = &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes[3]
	// optional org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainer default_postgresql_container = 570005;
	E_DefaultPostgresqlContainer = &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes[4]
	// optional org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainer default_redis_container = 570006;
	E_DefaultRedisContainer = &file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes[5]
)

var File_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc = "" +
	"\n" +
	">org/openmcf/provider/kubernetes/kubernetesharbor/v1/spec.proto\x123org.openmcf.provider.kubernetes.kubernetesharbor.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a0org/openmcf/provider/kubernetes/kubernetes.proto\x1a4org/openmcf/provider/kubernetes/target_cluster.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xab\f\n" +
	"\x14KubernetesHarborSpec\x12a\n" +
	...
	"\x0ecore_container\x18\x04 \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerB&\x8a\xa9\x96\x02!\b\x01\x12\x1d\n" +
	"\f\n" +
	"\x051000m\x12\x032Gi\x12\r\n" +
	"\x04200m\x12\x05512MiR\rcoreContainer\x12\xa2\x01\n" +
	"\x10portal_container\x18\x05 \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerB'\x92\xa9\x96\x02\"\b\x01\x12\x1e\n" +
	"\r\n" +
	"\x04500m\x12\x05512Mi\x12\r\n" +
	"\x04100m\x12\x05256MiR\x0fportalContainer\x12\xa5\x01\n" +
	"\x12registry_container\x18\x06 \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerB&\x9a\xa9\x96\x02!\b\x01\x12\x1d\n" +
	"\f\n" +
	"\x051000m\x12\x032Gi\x12\r\n" +
	"\x04200m\x12\x05512MiR\x11registryContainer\x12\xa9\x01\n" +
	"\x14jobservice_container\x18\a \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerB&\xa2\xa9\x96\x02!\b\x01\x12\x1d\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\r\n" +
	"\x04100m\x12\x05256MiR\x13jobserviceContainer\x12w\n" +
	"\bdatabase\x18\b \x01(\v2S.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborDatabaseConfigB\x06\xbaH\x03\xc8\x01\x01R\bdatabase\x12n\n" +
	"\x05cache\x18\t \x01(\v2P.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborCacheConfigB\x06\xbaH\x03\xc8\x01\x01R\x05cache\x12t\n" +
	"\astorage\x18\n" +
	" \x01(\v2R.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfigB\x06\xbaH\x03\xc8\x01\x01R\astorage\x12f\n" +
	"\aingress\x18\v \x01(\v2L.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngressR\aingress\x12z\n" +
	"\vhelm_values\x18\f \x03(\v2Y.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.HelmValuesEntryR\n" +
	"helmValues\x1a=\n" +
	...
	"\tresources\x18\x02 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesR\tresources\x12E\n" +
	"\x05image\x18\x03 \x01(\v2/.org.openmcf.provider.kubernetes.ContainerImageR\x05image\"\xef\x03\n" +
	...
	"\tcontainer\x18\x01 \x01(\v2X.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainerB.\xaa\xa9\x96\x02)\b\x01\x12\x1d\n" +
	"\f\n" +
	"\x051000m\x12\x032Gi\x12\r\n" +
	...
	"\breplicas\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\breplicas\x12Q\n" +
	"\tresources\x18\x02 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesR\tresources\x12E\n" +
	"\x05image\x18\x03 \x01(\v2/.org.openmcf.provider.kubernetes.ContainerImageR\x05image\x12/\n" +
	...
	"\tcontainer\x18\x01 \x01(\v2S.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainerB.\xb2\xa9\x96\x02)\b\x01\x12\x1e\n" +
	"\r\n" +
	"\x04500m\x12\x05512Mi\x12\r\n" +
	...
	"\x04type\x18\x01 \x01(\x0e2P.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageTypeB\x06\xbaH\x03\xc8\x01\x01R\x04type\x12^\n" +
	"\x02s3\x18\x02 \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborS3StorageR\x02s3\x12a\n" +
	"\x03gcs\x18\x03 \x01(\v2O.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborGcsStorageR\x03gcs\x12g\n" +
	"\x05azure\x18\x04 \x01(\v2Q.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborAzureStorageR\x05azure\x12a\n" +
	"\x03oss\x18\x05 \x01(\v2O.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborOssStorageR\x03oss\x12v\n" +
	"\n" +
	"filesystem\x18\x06 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborFilesystemStorageR\n" +
	...
	"\x04core\x18\x01 \x01(\v2T.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngressEndpointR\x04core\x12l\n" +
	"\x06notary\x18\x02 \x01(\v2T.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngressEndpointR\x06notary\"\xd6\x01\n" +
	...
	"\x1ddefault_harbor_core_container\x12\x1d.google.protobuf.FieldOptions\x18\x91\xe5\" \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerR\x1adefaultHarborCoreContainer:\xb6\x01\n" +
	"\x1fdefault_harbor_portal_container\x12\x1d.google.protobuf.FieldOptions\x18\x92\xe5\" \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerR\x1cdefaultHarborPortalContainer:\xba\x01\n" +
	"!default_harbor_registry_container\x12\x1d.google.protobuf.FieldOptions\x18\x93\xe5\" \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerR\x1edefaultHarborRegistryContainer:\xbe\x01\n" +
	"#default_harbor_jobservice_container\x12\x1d.google.protobuf.FieldOptions\x18\x94\xe5\" \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainerR defaultHarborJobserviceContainer:\xbb\x01\n" +
	"\x1cdefault_postgresql_container\x12\x1d.google.protobuf.FieldOptions\x18\x95\xe5\" \x01(\v2X.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainerR\x1adefaultPostgresqlContainer:\xac\x01\n" +
	"\x17default_redis_container\x12\x1d.google.protobuf.FieldOptions\x18\x96\xe5\" \x01(\v2S.org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainerR\x15defaultRedisContainerB\xa1\x03\n" +
	"7com.org.openmcf.provider.kubernetes.kubernetesharbor.v1B\tSpecProtoP\x01Zhgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesharbor/v1;kubernetesharborv1\xa2\x02\x05OOPKK\xaa\x023Org.Openmcf.Provider.Kubernetes.Kubernetesharbor.V1\xca\x023Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesharbor\\V1\xe2\x02?Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesharbor\\V1\\GPBMetadata\xea\x028Org::Openmcf::Provider::Kubernetes::Kubernetesharbor::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_goTypes = []any{
	(KubernetesHarborStorageType)(0),             // 0: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageType
	(*KubernetesHarborSpec)(nil),                 // 1: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec
	(*KubernetesHarborContainer)(nil),            // 2: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	(*KubernetesHarborDatabaseConfig)(nil),       // 3: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborDatabaseConfig
	(*KubernetesHarborExternalPostgresql)(nil),   // 4: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborExternalPostgresql
	(*KubernetesHarborManagedPostgresql)(nil),    // 5: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborManagedPostgresql
	(*KubernetesHarborPostgresqlContainer)(nil),  // 6: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainer
	(*KubernetesHarborCacheConfig)(nil),          // 7: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborCacheConfig
	(*KubernetesHarborExternalRedis)(nil),        // 8: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborExternalRedis
	(*KubernetesHarborManagedRedis)(nil),         // 9: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborManagedRedis
	(*KubernetesHarborRedisContainer)(nil),       // 10: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainer
	(*KubernetesHarborStorageConfig)(nil),        // 11: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig
	(*KubernetesHarborS3Storage)(nil),            // 12: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborS3Storage
	(*KubernetesHarborGcsStorage)(nil),           // 13: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborGcsStorage
	(*KubernetesHarborAzureStorage)(nil),         // 14: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborAzureStorage
	(*KubernetesHarborOssStorage)(nil),           // 15: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborOssStorage
	(*KubernetesHarborFilesystemStorage)(nil),    // 16: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborFilesystemStorage
	(*KubernetesHarborIngress)(nil),              // 17: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngress
	(*KubernetesHarborIngressEndpoint)(nil),      // 18: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngressEndpoint
	nil,                                          // 19: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.HelmValuesEntry
	(*kubernetes.KubernetesClusterSelector)(nil), // 20: org.openmcf.provider.kubernetes.KubernetesClusterSelector
	(*v1.StringValueOrRef)(nil),                  // 21: org.openmcf.shared.foreignkey.v1.StringValueOrRef
	(*kubernetes.ContainerResources)(nil),        // 22: org.openmcf.provider.kubernetes.ContainerResources
	(*kubernetes.ContainerImage)(nil),            // 23: org.openmcf.provider.kubernetes.ContainerImage
	(*descriptorpb.FieldOptions)(nil),            // 24: google.protobuf.FieldOptions
}
var file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_depIdxs = []int32{
	20, // 0: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.target_cluster:type_name -> org.openmcf.provider.kubernetes.KubernetesClusterSelector
	21, // 1: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.namespace:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2,  // 2: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.core_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	2,  // 3: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.portal_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	2,  // 4: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.registry_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	2,  // 5: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.jobservice_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	3,  // 6: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.database:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborDatabaseConfig
	7,  // 7: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.cache:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborCacheConfig
	11, // 8: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.storage:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig
	17, // 9: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.ingress:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngress
	19, // 10: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.helm_values:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborSpec.HelmValuesEntry
	22, // 11: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	23, // 12: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer.image:type_name -> org.openmcf.provider.kubernetes.ContainerImage
	4,  // 13: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborDatabaseConfig.external_database:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborExternalPostgresql
	5,  // 14: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborDatabaseConfig.managed_database:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborManagedPostgresql
	6,  // 15: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborManagedPostgresql.container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainer
	22, // 16: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	23, // 17: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainer.image:type_name -> org.openmcf.provider.kubernetes.ContainerImage
	8,  // 18: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborCacheConfig.external_cache:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborExternalRedis
	9,  // 19: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborCacheConfig.managed_cache:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborManagedRedis
	10, // 20: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborManagedRedis.container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainer
	22, // 21: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	23, // 22: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainer.image:type_name -> org.openmcf.provider.kubernetes.ContainerImage
	0,  // 23: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig.type:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageType
	12, // 24: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig.s3:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborS3Storage
	13, // 25: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig.gcs:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborGcsStorage
	14, // 26: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig.azure:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborAzureStorage
	15, // 27: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig.oss:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborOssStorage
	16, // 28: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborStorageConfig.filesystem:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborFilesystemStorage
	18, // 29: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngress.core:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngressEndpoint
	18, // 30: org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngress.notary:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborIngressEndpoint
	24, // 31: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_core_container:extendee -> google.protobuf.FieldOptions
	24, // 32: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_portal_container:extendee -> google.protobuf.FieldOptions
	24, // 33: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_registry_container:extendee -> google.protobuf.FieldOptions
	24, // 34: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_jobservice_container:extendee -> google.protobuf.FieldOptions
	24, // 35: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_postgresql_container:extendee -> google.protobuf.FieldOptions
	24, // 36: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_redis_container:extendee -> google.protobuf.FieldOptions
	2,  // 37: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_core_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	2,  // 38: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_portal_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	2,  // 39: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_registry_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	2,  // 40: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_harbor_jobservice_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborContainer
	6,  // 41: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_postgresql_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborPostgresqlContainer
	10, // 42: org.openmcf.provider.kubernetes.kubernetesharbor.v1.default_redis_container:type_name -> org.openmcf.provider.kubernetes.kubernetesharbor.v1.KubernetesHarborRedisContainer
...
func init() { file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   19,
			NumExtensions: 6,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_extTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesharbor_v1_spec_proto_depIdxs = nil
}
