...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesjob/v1/spec.proto
...
func (x *KubernetesJobSpec) Reset() {
	*x = KubernetesJobSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_msgTypes[0]
...
func (*KubernetesJobSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
const file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDesc = "" +
	...
	"\x05image\x18\x04 \x01(\v2/.org.openmcf.provider.kubernetes.ContainerImageR\x05image\x12t\n" +
	...
	"\x03env\x18\x06 \x01(\v2N.org.openmcf.provider.kubernetes.kubernetesjob.v1.KubernetesJobContainerAppEnvR\x03env\x122\n" +
	...
	"\vconfig_maps\x18\x10 \x03(\v2S.org.openmcf.provider.kubernetes.kubernetesjob.v1.KubernetesJobSpec.ConfigMapsEntryR\n" +
	"configMaps\x12Q\n" +
	"\rvolume_mounts\x18\x11 \x03(\v2,.org.openmcf.provider.kubernetes.VolumeMountR\fvolumeMounts\x12(\n" +
...
var (
	file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_rawDesc)))
	})
...
func file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesjob_v1_spec_proto_depIdxs = nil
}
