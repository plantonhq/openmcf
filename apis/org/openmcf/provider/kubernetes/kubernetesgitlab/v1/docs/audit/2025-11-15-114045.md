...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesgitlab/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kubernetesgitlab/v1/
go test -v
```
...
- Explains purpose from OpenMCF perspective
