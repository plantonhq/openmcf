...
2. **Create v1/README.md**
   ...
   - **Why:** User-facing documentation is completely missing (6.67% gap). Users need a OpenMCF perspective overview.
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesistio/v1/`
...
- Explains why OpenMCF chose Helm over istioctl
...
- No user-facing overview from OpenMCF perspective
...
3. **Create v1/README.md**
   ...
   - **How:** Write concise OpenMCF perspective overview with one example
   - **Impact:** +6.67% → 85.32%
...
5. **Re-run audit to verify improvements:**
   ```bash
   @audit-openmcf-component KubernetesIstio
   ```
