...
- **Kubernetes Provider Config**: Valid OpenMCF Kubernetes credential
...
- **Module bugs**: File issue on OpenMCF repository
- **Operator behavior**: Check Apache Solr Operator documentation
- **Pulumi questions**: Consult Pulumi documentation

## License

This Pulumi module is part of OpenMCF. The Apache Solr Operator is licensed under Apache License 2.0.
