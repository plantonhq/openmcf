...
- **api_version**: Must be exactly `"kubernetes.openmcf.org/v1"`
...
- **OpenMCF**: File issues on OpenMCF repository

## License

The Apache Solr Operator is licensed under Apache License 2.0. This component (KubernetesSolrOperator) is part of OpenMCF and follows OpenMCF's licensing terms.
