...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesperconamongooperator/v1/`  
**Enum Value:** 833  
**ID Prefix:** percmdbop  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesperconamongooperator/v1/`
...
- While functional, this breaks OpenMCF naming conventions
...
2. **Standardize Pulumi module file names**
   ...
   - **Files:** `v1/iac/pulumi/module/main.go`, `v1/iac/pulumi/module/locals.go`
   - **Why:** Ensures consistency across all OpenMCF components
