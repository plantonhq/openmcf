...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesgrafana/v1/`  
**Enum Value:** 804  
**ID Prefix:** k8sgfn  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesgrafana/v1/`
...
**Path to reference:** `apis/org/openmcf/provider/kubernetes/kubernetesredis/v1/`
