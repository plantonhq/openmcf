...
The `TemporalKubernetes` component enables users of OpenMCF to deploy and manage [Temporal](https://temporal.io/)
—a robust, distributed, and highly scalable workflow orchestration platform—within Kubernetes environments. It leverages
OpenMCF's standardized, protobuf-defined API resource model to ensure consistent and simplified deployment across
...
ensures efficiency and reliability for your workflow orchestration needs within the OpenMCF ecosystem.
