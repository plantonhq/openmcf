...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetestemporal/v1/stack_outputs.proto
...
func (x *KubernetesTemporalStackOutputs) Reset() {
	*x = KubernetesTemporalStackOutputs{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesTemporalStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Iorg/openmcf/provider/kubernetes/kubernetestemporal/v1/stack_outputs.proto\x125org.openmcf.provider.kubernetes.kubernetestemporal.v1\"\xd9\x03\n" +
	...
	"9com.org.openmcf.provider.kubernetes.kubernetestemporal.v1B\x11StackOutputsProtoP\x01Zlgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetestemporal/v1;kubernetestemporalv1\xa2\x02\x05OOPKK\xaa\x025Org.Openmcf.Provider.Kubernetes.Kubernetestemporal.V1\xca\x025Org\\Openmcf\\Provider\\Kubernetes\\Kubernetestemporal\\V1\xe2\x02AOrg\\Openmcf\\Provider\\Kubernetes\\Kubernetestemporal\\V1\\GPBMetadata\xea\x02:Org::Openmcf::Provider::Kubernetes::Kubernetestemporal::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_goTypes = []any{
	(*KubernetesTemporalStackOutputs)(nil), // 0: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalStackOutputs
}
var file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_stack_outputs_proto_depIdxs = nil
}
