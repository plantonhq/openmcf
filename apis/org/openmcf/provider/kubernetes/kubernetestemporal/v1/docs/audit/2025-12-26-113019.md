...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetestemporal/v1/`  
**Enum Value:** 819  
**ID Prefix:** k8stprl
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetestemporal/v1/`
...
```bash
go test -v ./apis/org/openmcf/provider/kubernetes/kubernetestemporal/v1/
```
