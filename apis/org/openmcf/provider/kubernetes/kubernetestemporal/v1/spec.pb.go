...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetestemporal/v1/spec.proto
...
func (KubernetesTemporalDatabaseBackend) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesTemporalDatabaseBackend) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_enumTypes[0]
}
...
func (KubernetesTemporalDatabaseBackend) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesTemporalSpec) Reset() {
	*x = KubernetesTemporalSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[0]
...
type KubernetesTemporalDatabaseConfig struct {
	...
	Backend KubernetesTemporalDatabaseBackend `protobuf:"varint,1,opt,name=backend,proto3,enum=org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseBackend" json:"backend,omitempty"`
...
func (x *KubernetesTemporalDatabaseConfig) Reset() {
	*x = KubernetesTemporalDatabaseConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalDatabaseConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesTemporalExternalDatabase) Reset() {
	*x = KubernetesTemporalExternalDatabase{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalExternalDatabase) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesTemporalExternalElasticsearch) Reset() {
	*x = KubernetesTemporalExternalElasticsearch{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalExternalElasticsearch) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesTemporalIngress) Reset() {
	*x = KubernetesTemporalIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesTemporalFrontendIngressEndpoint) Reset() {
	*x = KubernetesTemporalFrontendIngressEndpoint{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalFrontendIngressEndpoint) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesTemporalWebUiIngressEndpoint) Reset() {
	*x = KubernetesTemporalWebUiIngressEndpoint{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalWebUiIngressEndpoint) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesTemporalDynamicConfig) Reset() {
	*x = KubernetesTemporalDynamicConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalDynamicConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *KubernetesTemporalServiceConfig) Reset() {
	*x = KubernetesTemporalServiceConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalServiceConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *KubernetesTemporalServices) Reset() {
	*x = KubernetesTemporalServices{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesTemporalServices) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
var File_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDesc = "" +
	"\n" +
	"@org/openmcf/provider/kubernetes/kubernetestemporal/v1/spec.proto\x125org.openmcf.provider.kubernetes.kubernetestemporal.v1\x1a\x1bbuf/validate/validate.proto\x1a0org/openmcf/provider/kubernetes/kubernetes.proto\x1a7org/openmcf/provider/kubernetes/kubernetes_secret.proto\x1a4org/openmcf/provider/kubernetes/target_cluster.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xe6\t\n" +
	...
	"\bdatabase\x18\x04 \x01(\v2W.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseConfigB\x06\xbaH\x03\xc8\x01\x01R\bdatabase\x12$\n" +
	...
	"\aingress\x18\t \x01(\v2P.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalIngressR\aingress\x12\x95\x01\n" +
	"\x16external_elasticsearch\x18\n" +
	" \x01(\v2^.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalElasticsearchR\x15externalElasticsearch\x12\x18\n" +
	"\aversion\x18\v \x01(\tR\aversion\x12}\n" +
	"\x0edynamic_config\x18\f \x01(\v2V.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDynamicConfigR\rdynamicConfig\x12>\n" +
	"\x12num_history_shards\x18\r \x01(\x05B\v\xbaH\b\x1a\x06\x18\x80\x80\x01(\x01H\x01R\x10numHistoryShards\x88\x01\x01\x12m\n" +
	"\bservices\x18\x0e \x01(\v2Q.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServicesR\bservicesB\x15\n" +
	"\x13_cassandra_replicasB\x15\n" +
	"\x13_num_history_shards\"\x87\x04\n" +
	" KubernetesTemporalDatabaseConfig\x12z\n" +
	"\abackend\x18\x01 \x01(\x0e2X.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseBackendB\x06\xbaH\x03\xc8\x01\x01R\abackend\x12\x86\x01\n" +
	"\x11external_database\x18\x02 \x01(\v2Y.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalDatabaseR\x10externalDatabase\x126\n" +
	...
	"\bpassword\x18\x04 \x01(\v29.org.openmcf.provider.kubernetes.KubernetesSensitiveValueR\bpassword\"\xbc\x01\n" +
	"'KubernetesTemporalExternalElasticsearch\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\x05R\x04port\x12\x12\n" +
	"\x04user\x18\x03 \x01(\tR\x04user\x12U\n" +
	"\bpassword\x18\x04 \x01(\v29.org.openmcf.provider.kubernetes.KubernetesSensitiveValueR\bpassword\"\x8f\x02\n" +
	"\x19KubernetesTemporalIngress\x12|\n" +
	"\bfrontend\x18\x01 \x01(\v2`.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalFrontendIngressEndpointR\bfrontend\x12t\n" +
	"\x06web_ui\x18\x02 \x01(\v2].org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalWebUiIngressEndpointR\x05webUi\"\xbb\x02\n" +
	...
	"\tresources\x18\x02 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesR\tresourcesB\v\n" +
	"\t_replicas\"\xe6\x03\n" +
	"\x1aKubernetesTemporalServices\x12r\n" +
	"\bfrontend\x18\x01 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfigR\bfrontend\x12p\n" +
	"\ahistory\x18\x02 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfigR\ahistory\x12r\n" +
	"\bmatching\x18\x03 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfigR\bmatching\x12n\n" +
	"\x06worker\x18\x04 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfigR\x06worker*\x83\x01\n" +
	...
	"9com.org.openmcf.provider.kubernetes.kubernetestemporal.v1B\tSpecProtoP\x01Zlgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetestemporal/v1;kubernetestemporalv1\xa2\x02\x05OOPKK\xaa\x025Org.Openmcf.Provider.Kubernetes.Kubernetestemporal.V1\xca\x025Org\\Openmcf\\Provider\\Kubernetes\\Kubernetestemporal\\V1\xe2\x02AOrg\\Openmcf\\Provider\\Kubernetes\\Kubernetestemporal\\V1\\GPBMetadata\xea\x02:Org::Openmcf::Provider::Kubernetes::Kubernetestemporal::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_goTypes = []any{
	(KubernetesTemporalDatabaseBackend)(0),            // 0: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseBackend
	(*KubernetesTemporalSpec)(nil),                    // 1: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec
	(*KubernetesTemporalDatabaseConfig)(nil),          // 2: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseConfig
	(*KubernetesTemporalExternalDatabase)(nil),        // 3: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalDatabase
	(*KubernetesTemporalExternalElasticsearch)(nil),   // 4: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalElasticsearch
	(*KubernetesTemporalIngress)(nil),                 // 5: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalIngress
	(*KubernetesTemporalFrontendIngressEndpoint)(nil), // 6: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalFrontendIngressEndpoint
	(*KubernetesTemporalWebUiIngressEndpoint)(nil),    // 7: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalWebUiIngressEndpoint
	(*KubernetesTemporalDynamicConfig)(nil),           // 8: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDynamicConfig
	(*KubernetesTemporalServiceConfig)(nil),           // 9: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfig
	(*KubernetesTemporalServices)(nil),                // 10: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServices
	(*kubernetes.KubernetesClusterSelector)(nil),      // 11: org.openmcf.provider.kubernetes.KubernetesClusterSelector
	(*v1.StringValueOrRef)(nil),                       // 12: org.openmcf.shared.foreignkey.v1.StringValueOrRef
	(*kubernetes.KubernetesSensitiveValue)(nil),       // 13: org.openmcf.provider.kubernetes.KubernetesSensitiveValue
	(*kubernetes.ContainerResources)(nil),             // 14: org.openmcf.provider.kubernetes.ContainerResources
}
var file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_depIdxs = []int32{
	11, // 0: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec.target_cluster:type_name -> org.openmcf.provider.kubernetes.KubernetesClusterSelector
	12, // 1: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec.namespace:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	2,  // 2: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec.database:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseConfig
	5,  // 3: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec.ingress:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalIngress
	4,  // 4: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec.external_elasticsearch:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalElasticsearch
	8,  // 5: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec.dynamic_config:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDynamicConfig
	10, // 6: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalSpec.services:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServices
	0,  // 7: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseConfig.backend:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseBackend
	3,  // 8: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalDatabaseConfig.external_database:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalDatabase
	13, // 9: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalDatabase.password:type_name -> org.openmcf.provider.kubernetes.KubernetesSensitiveValue
	13, // 10: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalExternalElasticsearch.password:type_name -> org.openmcf.provider.kubernetes.KubernetesSensitiveValue
	6,  // 11: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalIngress.frontend:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalFrontendIngressEndpoint
	7,  // 12: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalIngress.web_ui:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalWebUiIngressEndpoint
	14, // 13: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfig.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	9,  // 14: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServices.frontend:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfig
	9,  // 15: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServices.history:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfig
	9,  // 16: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServices.matching:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfig
	9,  // 17: org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServices.worker:type_name -> org.openmcf.provider.kubernetes.kubernetestemporal.v1.KubernetesTemporalServiceConfig
...
func init() { file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetestemporal_v1_spec_proto_depIdxs = nil
}
