...
This OpenMCF component simplifies deploying [Temporal](https://temporal.io/) onto Kubernetes clusters using
...
### Deploying with OpenMCF CLI

```bash
openmcf pulumi up --manifest temporal.yaml --stack acme/dev/my-temporal
```
...
- Adopts Istio/Gateway-API ingress patterns consistent across other OpenMCF modules.
