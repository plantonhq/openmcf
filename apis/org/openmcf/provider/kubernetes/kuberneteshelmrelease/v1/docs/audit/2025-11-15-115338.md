...
- Folder exists at correct location: `apis/org/openmcf/provider/kubernetes/kuberneteshelmrelease/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kuberneteshelmrelease/v1/
go test -v
```
...
4. OpenMCF's Approach - Clear positioning
...
- Contains clear overview from OpenMCF perspective
...
**Path to reference:** `apis/org/openmcf/provider/kubernetes/kubernetesargocd/v1/`
