...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetessignoz/v1/stack_outputs.proto
...
func (x *KubernetesSignozStackOutputs) Reset() {
	*x = KubernetesSignozStackOutputs{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesSignozStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Gorg/openmcf/provider/kubernetes/kubernetessignoz/v1/stack_outputs.proto\x123org.openmcf.provider.kubernetes.kubernetessignoz.v1\x1a0org/openmcf/provider/kubernetes/kubernetes.proto\"\xc6\x06\n" +
	...
	"\x13clickhouse_username\x18\r \x01(\tR\x12clickhouseUsername\x12r\n" +
	"\x1aclickhouse_password_secret\x18\x0e \x01(\v24.org.openmcf.provider.kubernetes.KubernetesSecretKeyR\x18clickhousePasswordSecretB\xa9\x03\n" +
	"7com.org.openmcf.provider.kubernetes.kubernetessignoz.v1B\x11StackOutputsProtoP\x01Zhgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetessignoz/v1;kubernetessignozv1\xa2\x02\x05OOPKK\xaa\x023Org.Openmcf.Provider.Kubernetes.Kubernetessignoz.V1\xca\x023Org\\Openmcf\\Provider\\Kubernetes\\Kubernetessignoz\\V1\xe2\x02?Org\\Openmcf\\Provider\\Kubernetes\\Kubernetessignoz\\V1\\GPBMetadata\xea\x028Org::Openmcf::Provider::Kubernetes::Kubernetessignoz::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_goTypes = []any{
	(*KubernetesSignozStackOutputs)(nil),   // 0: org.openmcf.provider.kubernetes.kubernetessignoz.v1.KubernetesSignozStackOutputs
	(*kubernetes.KubernetesSecretKey)(nil), // 1: org.openmcf.provider.kubernetes.KubernetesSecretKey
}
var file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: org.openmcf.provider.kubernetes.kubernetessignoz.v1.KubernetesSignozStackOutputs.clickhouse_password_secret:type_name -> org.openmcf.provider.kubernetes.KubernetesSecretKey
...
func init() { file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetessignoz_v1_stack_outputs_proto_depIdxs = nil
}
