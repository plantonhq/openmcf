...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesnats/v1/`  
**Enum Value:** 820  
**ID Prefix:** k8snats
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesnats/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kubernetesnats/v1/
go test -v
```
