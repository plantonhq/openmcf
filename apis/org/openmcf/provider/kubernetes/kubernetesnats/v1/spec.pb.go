...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesnats/v1/spec.proto
...
func (KubernetesNatsAuthScheme) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesNatsAuthScheme) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[0]
}
...
func (KubernetesNatsAuthScheme) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (StreamStorageEnum_Value) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[1].Descriptor()
}

func (StreamStorageEnum_Value) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[1]
}
...
func (StreamStorageEnum_Value) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{6, 0}
}
...
func (StreamRetentionEnum_Value) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[2].Descriptor()
}

func (StreamRetentionEnum_Value) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[2]
}
...
func (StreamRetentionEnum_Value) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{7, 0}
}
...
func (StreamDiscardEnum_Value) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[3].Descriptor()
}

func (StreamDiscardEnum_Value) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[3]
}
...
func (StreamDiscardEnum_Value) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{8, 0}
}
...
func (ConsumerDeliverPolicyEnum_Value) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[4].Descriptor()
}

func (ConsumerDeliverPolicyEnum_Value) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[4]
}
...
func (ConsumerDeliverPolicyEnum_Value) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{9, 0}
}
...
func (ConsumerAckPolicyEnum_Value) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[5].Descriptor()
}

func (ConsumerAckPolicyEnum_Value) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[5]
}
...
func (ConsumerAckPolicyEnum_Value) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{10, 0}
}
...
func (ConsumerReplayPolicyEnum_Value) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[6].Descriptor()
}

func (ConsumerReplayPolicyEnum_Value) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes[6]
}
...
func (ConsumerReplayPolicyEnum_Value) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *KubernetesNatsSpec) Reset() {
	*x = KubernetesNatsSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[0]
...
func (x *KubernetesNatsServerContainer) Reset() {
	*x = KubernetesNatsServerContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesNatsServerContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesNatsNoAuthUser) Reset() {
	*x = KubernetesNatsNoAuthUser{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesNatsNoAuthUser) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
type KubernetesNatsAuth struct {
	...
	Scheme KubernetesNatsAuthScheme `protobuf:"varint,2,opt,name=scheme,proto3,enum=org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuthScheme" json:"scheme,omitempty"`
...
func (x *KubernetesNatsAuth) Reset() {
	*x = KubernetesNatsAuth{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesNatsAuth) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesNatsIngress) Reset() {
	*x = KubernetesNatsIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesNatsIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesNatsNackController) Reset() {
	*x = KubernetesNatsNackController{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesNatsNackController) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *StreamStorageEnum) Reset() {
	*x = StreamStorageEnum{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamStorageEnum) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *StreamRetentionEnum) Reset() {
	*x = StreamRetentionEnum{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamRetentionEnum) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *StreamDiscardEnum) Reset() {
	*x = StreamDiscardEnum{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamDiscardEnum) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *ConsumerDeliverPolicyEnum) Reset() {
	*x = ConsumerDeliverPolicyEnum{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConsumerDeliverPolicyEnum) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *ConsumerAckPolicyEnum) Reset() {
	*x = ConsumerAckPolicyEnum{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConsumerAckPolicyEnum) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *ConsumerReplayPolicyEnum) Reset() {
	*x = ConsumerReplayPolicyEnum{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConsumerReplayPolicyEnum) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{11}
}
...
type KubernetesNatsStream struct {
	...
	Storage StreamStorageEnum_Value `protobuf:"varint,3,opt,name=storage,proto3,enum=org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamStorageEnum_Value" json:"storage,omitempty"`
	...
	Retention StreamRetentionEnum_Value `protobuf:"varint,5,opt,name=retention,proto3,enum=org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamRetentionEnum_Value" json:"retention,omitempty"`
	...
	Discard StreamDiscardEnum_Value `protobuf:"varint,11,opt,name=discard,proto3,enum=org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamDiscardEnum_Value" json:"discard,omitempty"`
...
func (x *KubernetesNatsStream) Reset() {
	*x = KubernetesNatsStream{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesNatsStream) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{12}
}
...
type KubernetesNatsConsumer struct {
	...
	DeliverPolicy ConsumerDeliverPolicyEnum_Value `protobuf:"varint,2,opt,name=deliver_policy,json=deliverPolicy,proto3,enum=org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerDeliverPolicyEnum_Value" json:"deliver_policy,omitempty"`
	// Acknowledgment policy for the consumer (none, all, or explicit).
	AckPolicy ConsumerAckPolicyEnum_Value `protobuf:"varint,3,opt,name=ack_policy,json=ackPolicy,proto3,enum=org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerAckPolicyEnum_Value" json:"ack_policy,omitempty"`
	...
	ReplayPolicy ConsumerReplayPolicyEnum_Value `protobuf:"varint,10,opt,name=replay_policy,json=replayPolicy,proto3,enum=org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerReplayPolicyEnum_Value" json:"replay_policy,omitempty"`
...
func (x *KubernetesNatsConsumer) Reset() {
	*x = KubernetesNatsConsumer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesNatsConsumer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP(), []int{13}
}
...
var file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesNatsServerContainer)(nil),
		Field:         525001,
		Name:          "org.openmcf.provider.kubernetes.kubernetesnats.v1.default_server_container",
		Tag:           "bytes,525001,opt,name=default_server_container",
		Filename:      "org/openmcf/provider/kubernetes/kubernetesnats/v1/spec.proto",
	},
}

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsServerContainer default_server_container = 525001;
	E_DefaultServerContainer = &file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_extTypes[0]
)

var File_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<org/openmcf/provider/kubernetes/kubernetesnats/v1/spec.proto\x121org.openmcf.provider.kubernetes.kubernetesnats.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a0org/openmcf/provider/kubernetes/kubernetes.proto\x1a4org/openmcf/provider/kubernetes/target_cluster.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x1a(org/openmcf/shared/options/options.proto\"\xb3\b\n" +
	...
	"\x10server_container\x18\x04 \x01(\v2P.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsServerContainerB,ʬ\x80\x02'\b\x01\x12\x1d\n" +
	"\f\n" +
	...
	"\x04auth\x18\x06 \x01(\v2E.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuthR\x04auth\x12\x1f\n" +
	"\vtls_enabled\x18\a \x01(\bR\n" +
	"tlsEnabled\x12b\n" +
	"\aingress\x18\b \x01(\v2H.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsIngressR\aingress\x12(\n" +
	"\x10disable_nats_box\x18\t \x01(\bR\x0edisableNatsBox\x12x\n" +
	"\x0fnack_controller\x18\n" +
	" \x01(\v2O.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsNackControllerR\x0enackController\x12a\n" +
	"\astreams\x18\v \x03(\v2G.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsStreamR\astreams\x12F\n" +
	...
	"\tresources\x18\x02 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesR\tresources\x12*\n" +
	...
	"\x06scheme\x18\x02 \x01(\x0e2K.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuthSchemeR\x06scheme\x12m\n" +
	"\fno_auth_user\x18\x03 \x01(\v2K.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsNoAuthUserR\n" +
	"noAuthUser\"\xcc\x01\n" +
	...
	"\astorage\x18\x03 \x01(\x0e2J.org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamStorageEnum.ValueR\astorage\x12%\n" +
	"\breplicas\x18\x04 \x01(\x05B\t\xbaH\x06\x1a\x04\x18\x05(\x01R\breplicas\x12j\n" +
	"\tretention\x18\x05 \x01(\x0e2L.org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamRetentionEnum.ValueR\tretention\x12\x17\n" +
	...
	"\adiscard\x18\v \x01(\x0e2J.org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamDiscardEnum.ValueR\adiscard\x12 \n" +
	"\vdescription\x18\f \x01(\tR\vdescription\x12g\n" +
	"\tconsumers\x18\r \x03(\v2I.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsConsumerR\tconsumers\"\xa7\x05\n" +
	"\x16KubernetesNatsConsumer\x120\n" +
	"\fdurable_name\x18\x01 \x01(\tB\r\xbaH\n" +
	"\xc8\x01\x01r\x05\x10\x01\x18\xff\x01R\vdurableName\x12y\n" +
	"\x0edeliver_policy\x18\x02 \x01(\x0e2R.org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerDeliverPolicyEnum.ValueR\rdeliverPolicy\x12m\n" +
	"\n" +
	"ack_policy\x18\x03 \x01(\x0e2N.org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerAckPolicyEnum.ValueR\tackPolicy\x12%\n" +
	...
	"\rreplay_policy\x18\n" +
	" \x01(\x0e2Q.org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerReplayPolicyEnum.ValueR\freplayPolicy\x12 \n" +
	...
	"\x18default_server_container\x12\x1d.google.protobuf.FieldOptions\x18Ʌ  \x01(\v2P.org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsServerContainerR\x16defaultServerContainerB\x93\x03\n" +
	"5com.org.openmcf.provider.kubernetes.kubernetesnats.v1B\tSpecProtoP\x01Zdgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesnats/v1;kubernetesnatsv1\xa2\x02\x05OOPKK\xaa\x021Org.Openmcf.Provider.Kubernetes.Kubernetesnats.V1\xca\x021Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesnats\\V1\xe2\x02=Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesnats\\V1\\GPBMetadata\xea\x026Org::Openmcf::Provider::Kubernetes::Kubernetesnats::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_goTypes = []any{
	(KubernetesNatsAuthScheme)(0),                // 0: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuthScheme
	(StreamStorageEnum_Value)(0),                 // 1: org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamStorageEnum.Value
	(StreamRetentionEnum_Value)(0),               // 2: org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamRetentionEnum.Value
	(StreamDiscardEnum_Value)(0),                 // 3: org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamDiscardEnum.Value
	(ConsumerDeliverPolicyEnum_Value)(0),         // 4: org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerDeliverPolicyEnum.Value
	(ConsumerAckPolicyEnum_Value)(0),             // 5: org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerAckPolicyEnum.Value
	(ConsumerReplayPolicyEnum_Value)(0),          // 6: org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerReplayPolicyEnum.Value
	(*KubernetesNatsSpec)(nil),                   // 7: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec
	(*KubernetesNatsServerContainer)(nil),        // 8: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsServerContainer
	(*KubernetesNatsNoAuthUser)(nil),             // 9: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsNoAuthUser
	(*KubernetesNatsAuth)(nil),                   // 10: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuth
	(*KubernetesNatsIngress)(nil),                // 11: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsIngress
	(*KubernetesNatsNackController)(nil),         // 12: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsNackController
	(*StreamStorageEnum)(nil),                    // 13: org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamStorageEnum
	(*StreamRetentionEnum)(nil),                  // 14: org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamRetentionEnum
	(*StreamDiscardEnum)(nil),                    // 15: org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamDiscardEnum
	(*ConsumerDeliverPolicyEnum)(nil),            // 16: org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerDeliverPolicyEnum
	(*ConsumerAckPolicyEnum)(nil),                // 17: org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerAckPolicyEnum
	(*ConsumerReplayPolicyEnum)(nil),             // 18: org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerReplayPolicyEnum
	(*KubernetesNatsStream)(nil),                 // 19: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsStream
	(*KubernetesNatsConsumer)(nil),               // 20: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsConsumer
	(*kubernetes.KubernetesClusterSelector)(nil), // 21: org.openmcf.provider.kubernetes.KubernetesClusterSelector
	(*v1.StringValueOrRef)(nil),                  // 22: org.openmcf.shared.foreignkey.v1.StringValueOrRef
	(*kubernetes.ContainerResources)(nil),        // 23: org.openmcf.provider.kubernetes.ContainerResources
	(*descriptorpb.FieldOptions)(nil),            // 24: google.protobuf.FieldOptions
}
var file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_depIdxs = []int32{
	21, // 0: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec.target_cluster:type_name -> org.openmcf.provider.kubernetes.KubernetesClusterSelector
	22, // 1: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec.namespace:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	8,  // 2: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec.server_container:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsServerContainer
	10, // 3: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec.auth:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuth
	11, // 4: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec.ingress:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsIngress
	12, // 5: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec.nack_controller:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsNackController
	19, // 6: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsSpec.streams:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsStream
	23, // 7: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsServerContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	0,  // 8: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuth.scheme:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuthScheme
	9,  // 9: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsAuth.no_auth_user:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsNoAuthUser
	1,  // 10: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsStream.storage:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamStorageEnum.Value
	2,  // 11: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsStream.retention:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamRetentionEnum.Value
	3,  // 12: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsStream.discard:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.StreamDiscardEnum.Value
	20, // 13: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsStream.consumers:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsConsumer
	4,  // 14: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsConsumer.deliver_policy:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerDeliverPolicyEnum.Value
	5,  // 15: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsConsumer.ack_policy:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerAckPolicyEnum.Value
	6,  // 16: org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsConsumer.replay_policy:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.ConsumerReplayPolicyEnum.Value
	24, // 17: org.openmcf.provider.kubernetes.kubernetesnats.v1.default_server_container:extendee -> google.protobuf.FieldOptions
	8,  // 18: org.openmcf.provider.kubernetes.kubernetesnats.v1.default_server_container:type_name -> org.openmcf.provider.kubernetes.kubernetesnats.v1.KubernetesNatsServerContainer
...
func init() { file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto != nil {
		return
	}
	file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   14,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_extTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesnats_v1_spec_proto_depIdxs = nil
}
