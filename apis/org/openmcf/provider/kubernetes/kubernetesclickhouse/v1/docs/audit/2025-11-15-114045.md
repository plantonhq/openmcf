...
**Provider:** kubernetes  
**Component Path:** `apis/org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/`  
**Enum Value:** 830  
**ID Prefix:** k8sclkhs  
**Category:** workload  
...
- Folder exists: `apis/org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/`
...
```bash
cd apis/org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/
go test -v
```
...
**Recommended as reference:** `apis/org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/`
...
The **KubernetesClickHouse** component is a **gold standard reference implementation** within the OpenMCF ecosystem. It demonstrates:
