...
// 	protoc        (unknown)
// source: org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/spec.proto
...
func (KubernetesClickHouseCoordinationConfig_CoordinationType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesClickHouseCoordinationConfig_CoordinationType) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_enumTypes[0]
}
...
func (KubernetesClickHouseCoordinationConfig_CoordinationType) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{3, 0}
}
...
func (KubernetesClickHouseLoggingConfig_LogLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_enumTypes[1].Descriptor()
}

func (KubernetesClickHouseLoggingConfig_LogLevel) Type() protoreflect.EnumType {
	return &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_enumTypes[1]
}
...
func (KubernetesClickHouseLoggingConfig_LogLevel) EnumDescriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{6, 0}
}
...
type KubernetesClickHouseSpec struct {
	...
	//
	// Deprecated: Marked as deprecated in org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/spec.proto.
...
func (x *KubernetesClickHouseSpec) Reset() {
	*x = KubernetesClickHouseSpec{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[0]
...
func (*KubernetesClickHouseSpec) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesClickHouseContainer) Reset() {
	*x = KubernetesClickHouseContainer{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseContainer) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesClickHouseClusterConfig) Reset() {
	*x = KubernetesClickHouseClusterConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseClusterConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
type KubernetesClickHouseCoordinationConfig struct {
	...
	Type KubernetesClickHouseCoordinationConfig_CoordinationType `protobuf:"varint,1,opt,name=type,proto3,enum=org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig_CoordinationType" json:"type,omitempty"`
	// *
...
func (x *KubernetesClickHouseCoordinationConfig) Reset() {
	*x = KubernetesClickHouseCoordinationConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesClickHouseKeeperConfig) Reset() {
	*x = KubernetesClickHouseKeeperConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseKeeperConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesClickHouseExternalCoordinationConfig) Reset() {
	*x = KubernetesClickHouseExternalCoordinationConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseExternalCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
type KubernetesClickHouseLoggingConfig struct {
	...
	Level         KubernetesClickHouseLoggingConfig_LogLevel `protobuf:"varint,1,opt,name=level,proto3,enum=org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfig_LogLevel" json:"level,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *KubernetesClickHouseLoggingConfig) Reset() {
	*x = KubernetesClickHouseLoggingConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseLoggingConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesClickHouseIngress) Reset() {
	*x = KubernetesClickHouseIngress{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseIngress) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *KubernetesClickHouseZookeeperConfig) Reset() {
	*x = KubernetesClickHouseZookeeperConfig{}
	mi := &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseZookeeperConfig) Descriptor() ([]byte, []int) {
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
var file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KubernetesClickHouseContainer)(nil),
		Field:         519001,
		Name:          "org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.default_container",
		Tag:           "bytes,519001,opt,name=default_container",
		Filename:      "org/openmcf/provider/kubernetes/kubernetesclickhouse/v1/spec.proto",
	},
}

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseContainer default_container = 519001;
	E_DefaultContainer = &file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_extTypes[0]
)

var File_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto protoreflect.FileDescriptor

const file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Borg/openmcf/provider/kubernetes/kubernetesclickhouse/v1/spec.proto\x127org.openmcf.provider.kubernetes.kubernetesclickhouse.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a0org/openmcf/provider/kubernetes/kubernetes.proto\x1a4org/openmcf/provider/kubernetes/target_cluster.proto\x1a2org/openmcf/shared/foreignkey/v1/foreign_key.proto\"\x88\t\n" +
	"\x18KubernetesClickHouseSpec\x12a\n" +
	...
	"\tcontainer\x18\x05 \x01(\v2V.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseContainerB,ʵ\xfd\x01'\b\x01\x12\x1b\n" +
	"\f\n" +
	"\x052000m\x12\x034Gi\x12\v\n" +
	"\x04500m\x12\x031Gi\x18\x01\"\x0450GiR\tcontainer\x12n\n" +
	"\aingress\x18\x06 \x01(\v2T.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseIngressR\aingress\x12t\n" +
	"\acluster\x18\a \x01(\v2Z.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseClusterConfigR\acluster\x12\x18\n" +
	"\aversion\x18\b \x01(\tR\aversion\x12\x83\x01\n" +
	"\fcoordination\x18\t \x01(\v2_.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfigR\fcoordination\x12~\n" +
	"\tzookeeper\x18\n" +
	" \x01(\v2\\.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseZookeeperConfigB\x02\x18\x01R\tzookeeper\x12|\n" +
	"\alogging\x18\v \x01(\v2Z.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfigB\x06\xbaH\x03\xc8\x01\x01R\alogging\"\xbf\x04\n" +
	...
	"\x04type\x18\x01 \x01(\x0e2p.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig.CoordinationTypeR\x04type\x12~\n" +
	"\rkeeper_config\x18\x02 \x01(\v2Y.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseKeeperConfigR\fkeeperConfig\x12\x90\x01\n" +
	"\x0fexternal_config\x18\x03 \x01(\v2g.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseExternalCoordinationConfigR\x0eexternalConfig\"\\\n" +
	...
	"\tresources\x18\x02 \x01(\v23.org.openmcf.provider.kubernetes.ContainerResourcesR\tresources\x12S\n" +
	...
	"\x05level\x18\x01 \x01(\x0e2c.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfig.LogLevelR\x05level\"1\n" +
	"\bLogLevel\x12\x0f\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xd9\xd6\x1f \x01(\v2V.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseContainerR\x10defaultContainerB\xbd\x03\n" +
	";com.org.openmcf.provider.kubernetes.kubernetesclickhouse.v1B\tSpecProtoP\x01Zpgithub.com/plantonhq/openmcf/apis/org/openmcf/provider/kubernetes/kubernetesclickhouse/v1;kubernetesclickhousev1\xa2\x02\x05OOPKK\xaa\x027Org.Openmcf.Provider.Kubernetes.Kubernetesclickhouse.V1\xca\x027Org\\Openmcf\\Provider\\Kubernetes\\Kubernetesclickhouse\\V1\xe2\x02COrg\\Openmcf\\Provider\\Kubernetes\\Kubernetesclickhouse\\V1\\GPBMetadata\xea\x02<Org::Openmcf::Provider::Kubernetes::Kubernetesclickhouse::V1b\x06proto3"

var (
	file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescOnce sync.Once
	file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescData []byte
)

func file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescGZIP() []byte {
	file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDesc)))
	})
	return file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDescData
}

var file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_goTypes = []any{
	(KubernetesClickHouseCoordinationConfig_CoordinationType)(0), // 0: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig.CoordinationType
	(KubernetesClickHouseLoggingConfig_LogLevel)(0),              // 1: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfig.LogLevel
	(*KubernetesClickHouseSpec)(nil),                             // 2: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec
	(*KubernetesClickHouseContainer)(nil),                        // 3: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseContainer
	(*KubernetesClickHouseClusterConfig)(nil),                    // 4: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseClusterConfig
	(*KubernetesClickHouseCoordinationConfig)(nil),               // 5: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig
	(*KubernetesClickHouseKeeperConfig)(nil),                     // 6: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseKeeperConfig
	(*KubernetesClickHouseExternalCoordinationConfig)(nil),       // 7: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseExternalCoordinationConfig
	(*KubernetesClickHouseLoggingConfig)(nil),                    // 8: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfig
	(*KubernetesClickHouseIngress)(nil),                          // 9: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseIngress
	(*KubernetesClickHouseZookeeperConfig)(nil),                  // 10: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseZookeeperConfig
...
var file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_depIdxs = []int32{
	11, // 0: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.target_cluster:type_name -> org.openmcf.provider.kubernetes.KubernetesClusterSelector
	12, // 1: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.namespace:type_name -> org.openmcf.shared.foreignkey.v1.StringValueOrRef
	3,  // 2: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.container:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseContainer
	9,  // 3: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.ingress:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseIngress
	4,  // 4: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.cluster:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseClusterConfig
	5,  // 5: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.coordination:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig
	10, // 6: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.zookeeper:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseZookeeperConfig
	8,  // 7: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseSpec.logging:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfig
	13, // 8: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseContainer.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	0,  // 9: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig.type:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig.CoordinationType
	6,  // 10: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig.keeper_config:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseKeeperConfig
	7,  // 11: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseCoordinationConfig.external_config:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseExternalCoordinationConfig
	13, // 12: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseKeeperConfig.resources:type_name -> org.openmcf.provider.kubernetes.ContainerResources
	1,  // 13: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfig.level:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseLoggingConfig.LogLevel
	14, // 14: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.default_container:extendee -> google.protobuf.FieldOptions
	3,  // 15: org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.default_container:type_name -> org.openmcf.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseContainer
...
func init() { file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_init() }
func file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_init() {
	if File_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDesc), len(file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_extTypes,
	}.Build()
	File_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto = out.File
	file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_goTypes = nil
	file_org_openmcf_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_depIdxs = nil
}
