...
// 	protoc        (unknown)
// source: org/openmcf/shared/foreignkey/v1/foreign_key.proto
...
func (x *ValueFromRef) Reset() {
	*x = ValueFromRef{}
	mi := &file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_msgTypes[0]
...
func (*ValueFromRef) Descriptor() ([]byte, []int) {
	return file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDescGZIP(), []int{0}
}
...
func (x *StringValueOrRef) Reset() {
	*x = StringValueOrRef{}
	mi := &file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StringValueOrRef) Descriptor() ([]byte, []int) {
	return file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDescGZIP(), []int{1}
}
...
var file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         200001,
		Name:          "org.openmcf.shared.foreignkey.v1.default_kind",
		Tag:           "varint,200001,opt,name=default_kind,enum=org.openmcf.shared.cloudresourcekind.CloudResourceKind",
		Filename:      "org/openmcf/shared/foreignkey/v1/foreign_key.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*string)(nil),
		Field:         200002,
		Name:          "org.openmcf.shared.foreignkey.v1.default_kind_field_path",
...
var (
	// optional org.openmcf.shared.cloudresourcekind.CloudResourceKind default_kind = 200001;
	E_DefaultKind = &file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_extTypes[0]
	// optional string default_kind_field_path = 200002;
	E_DefaultKindFieldPath = &file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_extTypes[1]
)

var File_org_openmcf_shared_foreignkey_v1_foreign_key_proto protoreflect.FileDescriptor

const file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDesc = "" +
	"\n" +
	"2org/openmcf/shared/foreignkey/v1/foreign_key.proto\x12 org.openmcf.shared.foreignkey.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a>org/openmcf/shared/cloudresourcekind/cloud_resource_kind.proto\"\xa8\x01\n" +
	"\fValueFromRef\x12K\n" +
	...
	"$com.org.openmcf.shared.foreignkey.v1B\x0fForeignKeyProtoP\x01ZOgithub.com/plantonhq/openmcf/apis/org/openmcf/shared/foreignkey/v1;foreignkeyv1\xa2\x02\x04OOSF\xaa\x02 Org.Openmcf.Shared.Foreignkey.V1\xca\x02 Org\\Openmcf\\Shared\\Foreignkey\\V1\xe2\x02,Org\\Openmcf\\Shared\\Foreignkey\\V1\\GPBMetadata\xea\x02$Org::Openmcf::Shared::Foreignkey::V1b\x06proto3"

var (
	file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDescOnce sync.Once
	file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDescData []byte
)

func file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDescGZIP() []byte {
	file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDescOnce.Do(func() {
		file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDesc), len(file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_rawDesc)))
	})
...
func file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_init() {
	if File_org_openmcf_shared_foreignkey_v1_foreign_key_proto != nil {
		return
	}
	file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_goTypes,
		DependencyIndexes: file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_depIdxs,
		MessageInfos:      file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_msgTypes,
		ExtensionInfos:    file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_extTypes,
	}.Build()
	File_org_openmcf_shared_foreignkey_v1_foreign_key_proto = out.File
	file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_goTypes = nil
	file_org_openmcf_shared_foreignkey_v1_foreign_key_proto_depIdxs = nil
}
