...
Here are examples of how to create and configure a **GcpComputeInstance** API resource using the Project Planton CLI. The examples cover various instance configurations from basic to production-grade setups.
