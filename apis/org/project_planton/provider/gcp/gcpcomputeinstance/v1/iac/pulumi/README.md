...
This Pulumi module deploys Google Compute Engine instances using the Project Planton framework.
...
```bash
# Deploy using Pulumi
project-planton pulumi up --manifest manifest.yaml --stack org/project/env

# Preview changes
project-planton pulumi preview --manifest manifest.yaml --stack org/project/env

# Destroy resources
project-planton pulumi destroy --manifest manifest.yaml --stack org/project/env
```
