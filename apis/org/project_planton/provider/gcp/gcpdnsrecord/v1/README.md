...
`GcpDnsRecord` is a Project Planton deployment component for managing individual DNS records within a Google Cloud DNS Managed Zone. It provides a declarative way to create, update, and manage DNS records across your GCP infrastructure.
...
4. **Validate before deploy**: Run `project-planton validate` to check your manifests
