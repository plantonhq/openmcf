...
Provision and manage individual DNS records in Cloudflare zones using Project Planton's unified API.
...
4. **Project Planton CLI**: Install from [project-planton.org](https://project-planton.org)
