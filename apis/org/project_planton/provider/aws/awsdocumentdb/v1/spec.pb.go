...
// 	protoc        (unknown)
// source: org/project_planton/provider/aws/awsdocumentdb/v1/spec.proto
...
func (x *AwsDocumentDbSpec) Reset() {
	*x = AwsDocumentDbSpec{}
	mi := &file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes[0]
...
func (*AwsDocumentDbSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsDocumentDbParameter) Reset() {
	*x = AwsDocumentDbParameter{}
	mi := &file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbParameter) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<org/project_planton/provider/aws/awsdocumentdb/v1/spec.proto\x121org.project_planton.provider.aws.awsdocumentdb.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project_planton/shared/foreignkey/v1/foreign_key.proto\x1a0org/project_planton/shared/options/options.proto\"\xc3\x16\n" +
	"\x11AwsDocumentDbSpec\x12\x84\x01\n" +
	"\asubnets\x18\x01 \x03(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB.\x88\xd4a\xd8\x01\x92\xd4a%status.outputs.private_subnets.[*].idR\asubnets\x12b\n" +
	"\x0fdb_subnet_group\x18\x02 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefR\rdbSubnetGroup\x12\x8e\x01\n" +
	"\x0fsecurity_groups\x18\x03 \x03(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x0esecurityGroups\x12\x96\x01\n" +
	"\rallowed_cidrs\x18\x04 \x03(\tBq\xbaHn\x92\x01k\x18\x01\"gre2c^(?:25[0-5]|2[0-4]\\d|[0-1]?\\d?\\d)(?:\\.(?:25[0-5]|2[0-4]\\d|[0-1]?\\d?\\d)){3}/(?:[0-9]|[12]\\d|3[0-2])$R\fallowedCidrs\x12l\n" +
	"\x03vpc\x18\x05 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB\x1e\x88\xd4a\xd8\x01\x92\xd4a\x15status.outputs.vpc_idR\x03vpc\x12<\n" +
	...
	"\x11storage_encrypted\x18\f \x01(\bB\b\x8a\xa6\x1d\x04trueH\x05R\x10storageEncrypted\x88\x01\x01\x12t\n" +
	"\akms_key\x18\r \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdb\x01\x92\xd4a\x16status.outputs.key_arnR\x06kmsKey\x12K\n" +
	...
	"\x1ccluster_parameter_group_name\x18\x17 \x01(\tR\x19clusterParameterGroupName\x12x\n" +
	"\x12cluster_parameters\x18\x18 \x03(\v2I.org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbParameterR\x11clusterParameters:\x81\x04\xbaH\xfd\x03\x1a|\n" +
	...
	"\fapply_method\x18\x03 \x01(\tB#\xbaH \xd8\x01\x01r\x1bR\timmediateR\x0epending-rebootR\vapplyMethodB\x96\x03\n" +
	"5com.org.project_planton.provider.aws.awsdocumentdb.v1B\tSpecProtoP\x01Zkgithub.com/plantonhq/project-planton/apis/org/project_planton/provider/aws/awsdocumentdb/v1;awsdocumentdbv1\xa2\x02\x05OPPAA\xaa\x020Org.ProjectPlanton.Provider.Aws.Awsdocumentdb.V1\xca\x020Org\\ProjectPlanton\\Provider\\Aws\\Awsdocumentdb\\V1\xe2\x02<Org\\ProjectPlanton\\Provider\\Aws\\Awsdocumentdb\\V1\\GPBMetadata\xea\x025Org::ProjectPlanton::Provider::Aws::Awsdocumentdb::V1b\x06proto3"

var (
	file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_goTypes = []any{
	(*AwsDocumentDbSpec)(nil),      // 0: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec
	(*AwsDocumentDbParameter)(nil), // 1: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbParameter
	(*v1.StringValueOrRef)(nil),    // 2: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.subnets:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.db_subnet_group:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.security_groups:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.vpc:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	2, // 4: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.kms_key:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	1, // 5: org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbSpec.cluster_parameters:type_name -> org.project_planton.provider.aws.awsdocumentdb.v1.AwsDocumentDbParameter
...
func init() { file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_init() }
func file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_init() {
	if File_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto = out.File
	file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_aws_awsdocumentdb_v1_spec_proto_depIdxs = nil
}
