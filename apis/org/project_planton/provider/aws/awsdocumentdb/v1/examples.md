...
## CLI flows
- Validate: `project-planton validate --manifest examples/aws/awsdocumentdb/v1/minimal.yaml`
- Pulumi deploy: `project-planton pulumi update --manifest examples/aws/awsdocumentdb/v1/minimal.yaml --stack <org/project/stack> --module-dir apis/org/project_planton/provider/aws/awsdocumentdb/v1/iac/pulumi`
- Terraform deploy: `project-planton tofu apply --manifest examples/aws/awsdocumentdb/v1/minimal.yaml --auto-approve`
