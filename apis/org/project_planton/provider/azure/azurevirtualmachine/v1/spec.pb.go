...
// 	protoc        (unknown)
// source: org/project_planton/provider/azure/azurevirtualmachine/v1/spec.proto
...
func (AzureVirtualMachineOsDisk_DiskCaching) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureVirtualMachineOsDisk_DiskCaching) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[0]
}
...
func (AzureVirtualMachineOsDisk_DiskCaching) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{2, 0}
}
...
func (AzureVirtualMachineOsDisk_DiskStorageType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureVirtualMachineOsDisk_DiskStorageType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[1]
}
...
func (AzureVirtualMachineOsDisk_DiskStorageType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{2, 1}
}
...
func (AzureVirtualMachineNetworkConfig_PublicIpSku) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureVirtualMachineNetworkConfig_PublicIpSku) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[2]
}
...
func (AzureVirtualMachineNetworkConfig_PublicIpSku) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{4, 0}
}
...
func (AzureVirtualMachineNetworkConfig_PublicIpAllocation) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[3].Descriptor()
}

func (AzureVirtualMachineNetworkConfig_PublicIpAllocation) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[3]
}
...
func (AzureVirtualMachineNetworkConfig_PublicIpAllocation) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{4, 1}
}
...
func (AzureVirtualMachineNetworkConfig_PrivateIpAllocation) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[4].Descriptor()
}

func (AzureVirtualMachineNetworkConfig_PrivateIpAllocation) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes[4]
}
...
func (AzureVirtualMachineNetworkConfig_PrivateIpAllocation) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{4, 2}
}
...
func (x *AzureVirtualMachineSpec) Reset() {
	*x = AzureVirtualMachineSpec{}
	mi := &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[0]
...
func (*AzureVirtualMachineSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureVirtualMachineImage) Reset() {
	*x = AzureVirtualMachineImage{}
	mi := &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureVirtualMachineImage) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type AzureVirtualMachineOsDisk struct {
	...
	// Storage account type for the OS disk.
	StorageType *AzureVirtualMachineOsDisk_DiskStorageType `protobuf:"varint,2,opt,name=storage_type,json=storageType,proto3,enum=org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk_DiskStorageType,oneof" json:"storage_type,omitempty"`
	// Caching mode for the OS disk.
	Caching *AzureVirtualMachineOsDisk_DiskCaching `protobuf:"varint,3,opt,name=caching,proto3,enum=org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk_DiskCaching,oneof" json:"caching,omitempty"`
...
func (x *AzureVirtualMachineOsDisk) Reset() {
	*x = AzureVirtualMachineOsDisk{}
	mi := &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureVirtualMachineOsDisk) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
type AzureVirtualMachineDataDisk struct {
	...
	StorageType *AzureVirtualMachineOsDisk_DiskStorageType `protobuf:"varint,3,opt,name=storage_type,json=storageType,proto3,enum=org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk_DiskStorageType,oneof" json:"storage_type,omitempty"`
	// Caching mode for the data disk.
	Caching *AzureVirtualMachineOsDisk_DiskCaching `protobuf:"varint,4,opt,name=caching,proto3,enum=org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk_DiskCaching,oneof" json:"caching,omitempty"`
...
func (x *AzureVirtualMachineDataDisk) Reset() {
	*x = AzureVirtualMachineDataDisk{}
	mi := &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureVirtualMachineDataDisk) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
type AzureVirtualMachineNetworkConfig struct {
	...
	PublicIpSku *AzureVirtualMachineNetworkConfig_PublicIpSku `protobuf:"varint,2,opt,name=public_ip_sku,json=publicIpSku,proto3,enum=org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig_PublicIpSku,oneof" json:"public_ip_sku,omitempty"`
	// Allocation method for the public IP.
	PublicIpAllocation *AzureVirtualMachineNetworkConfig_PublicIpAllocation `protobuf:"varint,3,opt,name=public_ip_allocation,json=publicIpAllocation,proto3,enum=org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig_PublicIpAllocation,oneof" json:"public_ip_allocation,omitempty"`
	...
	PrivateIpAllocation *AzureVirtualMachineNetworkConfig_PrivateIpAllocation `protobuf:"varint,6,opt,name=private_ip_allocation,json=privateIpAllocation,proto3,enum=org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig_PrivateIpAllocation,oneof" json:"private_ip_allocation,omitempty"`
...
func (x *AzureVirtualMachineNetworkConfig) Reset() {
	*x = AzureVirtualMachineNetworkConfig{}
	mi := &file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureVirtualMachineNetworkConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Dorg/project_planton/provider/azure/azurevirtualmachine/v1/spec.proto\x129org.project_planton.provider.azure.azurevirtualmachine.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project_planton/shared/foreignkey/v1/foreign_key.proto\x1a0org/project_planton/shared/options/options.proto\"\x85\x10\n" +
	...
	"\avm_size\x18\x03 \x01(\tB\x1d\xbaH\a\xd8\x01\x01r\x02\x10\x01\x92\xa6\x1d\x0fStandard_D2s_v3H\x00R\x06vmSize\x88\x01\x01\x12\x86\x01\n" +
	"\tsubnet_id\x18\x04 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB-\xbaH\x03\xc8\x01\x01\x88\xd4a\x95\x03\x92\xd4a\x1estatus.outputs.nodes_subnet_idR\bsubnetId\x12q\n" +
	"\x05image\x18\x05 \x01(\v2S.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineImageB\x06\xbaH\x03\xc8\x01\x01R\x05image\x12m\n" +
	"\aos_disk\x18\x06 \x01(\v2T.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDiskR\x06osDisk\x12u\n" +
	"\n" +
	"data_disks\x18\a \x03(\v2V.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineDataDiskR\tdataDisks\x12E\n" +
	...
	"\x0essh_public_key\x18\t \x01(\tR\fsshPublicKey\x12\x84\x01\n" +
	"\x0eadmin_password\x18\n" +
	" \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x94\x03\x92\xd4a\x18status.outputs.vault_uriR\radminPassword\x12u\n" +
	"\anetwork\x18\v \x01(\v2[.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfigR\anetwork\x12=\n" +
	...
	"customData\x12p\n" +
	"\x04tags\x18\x11 \x03(\v2\\.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.TagsEntryR\x04tags\x12(\n" +
	...
	"\asize_gb\x18\x01 \x01(\x05B\v\xbaH\b\x1a\x06\x18\xff\xff\x01(\x00R\x06sizeGb\x12\xa5\x01\n" +
	"\fstorage_type\x18\x02 \x01(\x0e2d.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskStorageTypeB\x17\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\vpremium_lrsH\x00R\vstorageType\x88\x01\x01\x12\x97\x01\n" +
	"\acaching\x18\x03 \x01(\x0e2`.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskCachingB\x16\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\n" +
	"read_writeH\x01R\acaching\x88\x01\x01\x123\n" +
	"\x0edelete_with_vm\x18\x04 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x02R\fdeleteWithVm\x88\x01\x01\x12\x91\x01\n" +
	"\x16disk_encryption_set_id\x18\x05 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\x94\x03\x92\xd4a\x17status.outputs.vault_idR\x13diskEncryptionSetId\"T\n" +
	...
	"\n" +
	"\b_cachingB\x11\n" +
	"\x0f_delete_with_vm\"\xab\x04\n" +
	"\x1bAzureVirtualMachineDataDisk\x12 \n" +
	"\x04name\x18\x01 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x01\x18PR\x04name\x12'\n" +
	"\asize_gb\x18\x02 \x01(\x05B\x0e\xbaH\v\xc8\x01\x01\x1a\x06\x18\xff\xff\x01(\x01R\x06sizeGb\x12\xa5\x01\n" +
	"\fstorage_type\x18\x03 \x01(\x0e2d.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskStorageTypeB\x17\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\vpremium_lrsH\x00R\vstorageType\x88\x01\x01\x12\x96\x01\n" +
	"\acaching\x18\x04 \x01(\x0e2`.org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskCachingB\x15\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\tread_onlyH\x01R\acaching\x88\x01\x01\x12\x1b\n" +
	...
	"\x16_private_ip_allocationB\xcc\x03\n" +
	"=com.org.project_planton.provider.azure.azurevirtualmachine.v1B\tSpecProtoP\x01Zygithub.com/plantonhq/project-planton/apis/org/project_planton/provider/azure/azurevirtualmachine/v1;azurevirtualmachinev1\xa2\x02\x05OPPAA\xaa\x028Org.ProjectPlanton.Provider.Azure.Azurevirtualmachine.V1\xca\x028Org\\ProjectPlanton\\Provider\\Azure\\Azurevirtualmachine\\V1\xe2\x02DOrg\\ProjectPlanton\\Provider\\Azure\\Azurevirtualmachine\\V1\\GPBMetadata\xea\x02=Org::ProjectPlanton::Provider::Azure::Azurevirtualmachine::V1b\x06proto3"

var (
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_goTypes = []any{
	(AzureVirtualMachineOsDisk_DiskCaching)(0),                // 0: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskCaching
	(AzureVirtualMachineOsDisk_DiskStorageType)(0),            // 1: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskStorageType
	(AzureVirtualMachineNetworkConfig_PublicIpSku)(0),         // 2: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.PublicIpSku
	(AzureVirtualMachineNetworkConfig_PublicIpAllocation)(0),  // 3: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.PublicIpAllocation
	(AzureVirtualMachineNetworkConfig_PrivateIpAllocation)(0), // 4: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.PrivateIpAllocation
	(*AzureVirtualMachineSpec)(nil),                           // 5: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec
	(*AzureVirtualMachineImage)(nil),                          // 6: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineImage
	(*AzureVirtualMachineOsDisk)(nil),                         // 7: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk
	(*AzureVirtualMachineDataDisk)(nil),                       // 8: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineDataDisk
	(*AzureVirtualMachineNetworkConfig)(nil),                  // 9: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig
	nil,                                                       // 10: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),                               // 11: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_depIdxs = []int32{
	11, // 0: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.subnet_id:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	6,  // 1: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.image:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineImage
	7,  // 2: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.os_disk:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk
	8,  // 3: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.data_disks:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineDataDisk
	11, // 4: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.admin_password:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 5: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.network:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig
	10, // 6: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.tags:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineSpec.TagsEntry
	1,  // 7: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.storage_type:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskStorageType
	0,  // 8: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.caching:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskCaching
	11, // 9: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.disk_encryption_set_id:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 10: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineDataDisk.storage_type:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskStorageType
	0,  // 11: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineDataDisk.caching:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineOsDisk.DiskCaching
	2,  // 12: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.public_ip_sku:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.PublicIpSku
	3,  // 13: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.public_ip_allocation:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.PublicIpAllocation
	11, // 14: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.network_security_group_id:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 15: org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.private_ip_allocation:type_name -> org.project_planton.provider.azure.azurevirtualmachine.v1.AzureVirtualMachineNetworkConfig.PrivateIpAllocation
...
func init() { file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_init() }
func file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_init() {
	if File_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto = out.File
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_azure_azurevirtualmachine_v1_spec_proto_depIdxs = nil
}
