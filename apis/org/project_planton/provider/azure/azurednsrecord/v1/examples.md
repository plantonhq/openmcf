...
This document provides copy-paste ready examples for deploying Azure DNS Records using Project Planton.
...
project-planton pulumi up --manifest <example-file>.yaml

# Using Terraform/OpenTofu backend
project-planton tofu apply --manifest <example-file>.yaml
```
