...
// 	protoc        (unknown)
// source: org/project_planton/provider/azure/azurestorageaccount/v1/spec.proto
...
func (AzureStorageAccountKind) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureStorageAccountKind) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[0]
}
...
func (AzureStorageAccountKind) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureStorageAccountTier) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureStorageAccountTier) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[1]
}
...
func (AzureStorageAccountTier) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureStorageReplicationType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureStorageReplicationType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[2]
}
...
func (AzureStorageReplicationType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (AzureStorageAccessTier) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[3].Descriptor()
}

func (AzureStorageAccessTier) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[3]
}
...
func (AzureStorageAccessTier) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (AzureTlsVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[4].Descriptor()
}

func (AzureTlsVersion) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[4]
}
...
func (AzureTlsVersion) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (AzureStorageNetworkAction) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[5].Descriptor()
}

func (AzureStorageNetworkAction) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[5]
}
...
func (AzureStorageNetworkAction) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (AzureStorageContainerAccess) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[6].Descriptor()
}

func (AzureStorageContainerAccess) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes[6]
}
...
func (AzureStorageContainerAccess) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
type AzureStorageAccountSpec struct {
	...
	// Default: STORAGE_V2
	AccountKind *AzureStorageAccountKind `protobuf:"varint,3,opt,name=account_kind,json=accountKind,proto3,enum=org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountKind,oneof" json:"account_kind,omitempty"`
	...
	// Default: STANDARD
	AccountTier *AzureStorageAccountTier `protobuf:"varint,4,opt,name=account_tier,json=accountTier,proto3,enum=org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountTier,oneof" json:"account_tier,omitempty"`
	...
	// Default: LRS
	ReplicationType *AzureStorageReplicationType `protobuf:"varint,5,opt,name=replication_type,json=replicationType,proto3,enum=org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageReplicationType,oneof" json:"replication_type,omitempty"`
	...
	// Default: HOT
	AccessTier *AzureStorageAccessTier `protobuf:"varint,6,opt,name=access_tier,json=accessTier,proto3,enum=org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccessTier,oneof" json:"access_tier,omitempty"`
	...
	// Default: TLS1_2
	MinTlsVersion *AzureTlsVersion `protobuf:"varint,8,opt,name=min_tls_version,json=minTlsVersion,proto3,enum=org.project_planton.provider.azure.azurestorageaccount.v1.AzureTlsVersion,oneof" json:"min_tls_version,omitempty"`
...
func (x *AzureStorageAccountSpec) Reset() {
	*x = AzureStorageAccountSpec{}
	mi := &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[0]
...
type AzureStorageNetworkRules struct {
	...
	// Default: DENY
	DefaultAction *AzureStorageNetworkAction `protobuf:"varint,1,opt,name=default_action,json=defaultAction,proto3,enum=org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkAction,oneof" json:"default_action,omitempty"`
...
func (x *AzureStorageNetworkRules) Reset() {
	*x = AzureStorageNetworkRules{}
	mi := &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureStorageBlobProperties) Reset() {
	*x = AzureStorageBlobProperties{}
	mi := &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureStorageContainer struct {
	...
	// Default: PRIVATE
	AccessType    *AzureStorageContainerAccess `protobuf:"varint,2,opt,name=access_type,json=accessType,proto3,enum=org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainerAccess,oneof" json:"access_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AzureStorageContainer) Reset() {
	*x = AzureStorageContainer{}
	mi := &file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Dorg/project_planton/provider/azure/azurestorageaccount/v1/spec.proto\x129org.project_planton.provider.azure.azurestorageaccount.v1\x1a\x1bbuf/validate/validate.proto\x1a0org/project_planton/shared/options/options.proto\"\x84\v\n" +
	"\x17AzureStorageAccountSpec\x12\"\n" +
	"\x06region\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x06region\x121\n" +
	"\x0eresource_group\x18\x02 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\rresourceGroup\x12\x92\x01\n" +
	"\faccount_kind\x18\x03 \x01(\x0e2R.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountKindB\x16\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\n" +
	"STORAGE_V2H\x00R\vaccountKind\x88\x01\x01\x12\x90\x01\n" +
	"\faccount_tier\x18\x04 \x01(\x0e2R.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountTierB\x14\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\bSTANDARDH\x01R\vaccountTier\x88\x01\x01\x12\x97\x01\n" +
	"\x10replication_type\x18\x05 \x01(\x0e2V.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageReplicationTypeB\x0f\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x03LRSH\x02R\x0freplicationType\x88\x01\x01\x12\x88\x01\n" +
	"\vaccess_tier\x18\x06 \x01(\x0e2Q.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccessTierB\x0f\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x03HOTH\x03R\n" +
	"accessTier\x88\x01\x01\x12H\n" +
	"\x19enable_https_traffic_only\x18\a \x01(\bB\b\x8a\xa6\x1d\x04trueH\x04R\x16enableHttpsTrafficOnly\x88\x01\x01\x12\x8b\x01\n" +
	"\x0fmin_tls_version\x18\b \x01(\x0e2J.org.project_planton.provider.azure.azurestorageaccount.v1.AzureTlsVersionB\x12\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x06TLS1_2H\x05R\rminTlsVersion\x88\x01\x01\x12x\n" +
	"\rnetwork_rules\x18\t \x01(\v2S.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkRulesR\fnetworkRules\x12~\n" +
	"\x0fblob_properties\x18\n" +
	" \x01(\v2U.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageBlobPropertiesR\x0eblobProperties\x12z\n" +
	"\n" +
	"containers\x18\v \x03(\v2P.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainerB\b\xbaH\x05\x92\x01\x02\x10dR\n" +
	"containersB\x0f\n" +
	"\r_account_kindB\x0f\n" +
	"\r_account_tierB\x13\n" +
	...
	"\x10_min_tls_version\"\x8c\x03\n" +
	"\x18AzureStorageNetworkRules\x12\x92\x01\n" +
	"\x0edefault_action\x18\x01 \x01(\x0e2T.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkActionB\x10\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x04DENYH\x00R\rdefaultAction\x88\x01\x01\x12A\n" +
	...
	"%_container_soft_delete_retention_days\"\xdd\x01\n" +
	"\x15AzureStorageContainer\x12 \n" +
	"\x04name\x18\x01 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x03\x18?R\x04name\x12\x91\x01\n" +
	"\vaccess_type\x18\x02 \x01(\x0e2V.org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainerAccessB\x13\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\aPRIVATEH\x00R\n" +
	...
	"\x04BLOB\x10\x02\x12\r\n" +
	"\tCONTAINER\x10\x03B\xcc\x03\n" +
	"=com.org.project_planton.provider.azure.azurestorageaccount.v1B\tSpecProtoP\x01Zygithub.com/plantonhq/project-planton/apis/org/project_planton/provider/azure/azurestorageaccount/v1;azurestorageaccountv1\xa2\x02\x05OPPAA\xaa\x028Org.ProjectPlanton.Provider.Azure.Azurestorageaccount.V1\xca\x028Org\\ProjectPlanton\\Provider\\Azure\\Azurestorageaccount\\V1\xe2\x02DOrg\\ProjectPlanton\\Provider\\Azure\\Azurestorageaccount\\V1\\GPBMetadata\xea\x02=Org::ProjectPlanton::Provider::Azure::Azurestorageaccount::V1b\x06proto3"

var (
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_goTypes = []any{
	(AzureStorageAccountKind)(0),       // 0: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountKind
	(AzureStorageAccountTier)(0),       // 1: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountTier
	(AzureStorageReplicationType)(0),   // 2: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageReplicationType
	(AzureStorageAccessTier)(0),        // 3: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccessTier
	(AzureTlsVersion)(0),               // 4: org.project_planton.provider.azure.azurestorageaccount.v1.AzureTlsVersion
	(AzureStorageNetworkAction)(0),     // 5: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkAction
	(AzureStorageContainerAccess)(0),   // 6: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainerAccess
	(*AzureStorageAccountSpec)(nil),    // 7: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec
	(*AzureStorageNetworkRules)(nil),   // 8: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkRules
	(*AzureStorageBlobProperties)(nil), // 9: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageBlobProperties
	(*AzureStorageContainer)(nil),      // 10: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainer
}
var file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_depIdxs = []int32{
	0,  // 0: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.account_kind:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountKind
	1,  // 1: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.account_tier:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountTier
	2,  // 2: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.replication_type:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageReplicationType
	3,  // 3: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.access_tier:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccessTier
	4,  // 4: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.min_tls_version:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureTlsVersion
	8,  // 5: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.network_rules:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkRules
	9,  // 6: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.blob_properties:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageBlobProperties
	10, // 7: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageAccountSpec.containers:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainer
	5,  // 8: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkRules.default_action:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageNetworkAction
	6,  // 9: org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainer.access_type:type_name -> org.project_planton.provider.azure.azurestorageaccount.v1.AzureStorageContainerAccess
...
func init() { file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_init() }
func file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_init() {
	if File_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto = out.File
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_azure_azurestorageaccount_v1_spec_proto_depIdxs = nil
}
