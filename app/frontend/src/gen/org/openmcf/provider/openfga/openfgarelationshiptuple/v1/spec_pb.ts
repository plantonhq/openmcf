...
// @generated from file org/openmcf/provider/openfga/openfgarelationshiptuple/v1/spec.proto (package org.openmcf.provider.openfga.openfgarelationshiptuple.v1, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file org/openmcf/provider/openfga/openfgarelationshiptuple/v1/spec.proto.
 */
export const file_org_openmcf_provider_openfga_openfgarelationshiptuple_v1_spec: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_org_openmcf_shared_foreignkey_v1_foreign_key]);
 ...
 *
 * @generated from message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec
 */
export type OpenFgaRelationshipTupleSpec = Message<"org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec"> & {
  /**
   ...
   *
   * @generated from field: org.openmcf.shared.foreignkey.v1.StringValueOrRef authorization_model_id = 2;
   */
   ...
   *
   * @generated from field: org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleUser user = 3;
   */
   ...
   *
   * @generated from field: org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleObject object = 5;
   */
   ...
   *
   * @generated from field: org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleCondition condition = 6;
   */
  condition?: OpenFgaRelationshipTupleCondition;
};

/**
 * Describes the message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleSpec.
...
export const OpenFgaRelationshipTupleSpecSchema: GenMessage<OpenFgaRelationshipTupleSpec> = /*@__PURE__*/
  messageDesc(file_org_openmcf_provider_openfga_openfgarelationshiptuple_v1_spec, 0);
 ...
 *
 * @generated from message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleUser
 */
export type OpenFgaRelationshipTupleUser = Message<"org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleUser"> & {
  /**
   ...
   *
   * @generated from field: org.openmcf.shared.foreignkey.v1.StringValueOrRef id = 2;
   */
  id?: StringValueOrRef;
...
/**
 * Describes the message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleUser.
...
export const OpenFgaRelationshipTupleUserSchema: GenMessage<OpenFgaRelationshipTupleUser> = /*@__PURE__*/
  messageDesc(file_org_openmcf_provider_openfga_openfgarelationshiptuple_v1_spec, 1);
 ...
 *
 * @generated from message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleObject
 */
export type OpenFgaRelationshipTupleObject = Message<"org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleObject"> & {
  /**
...
/**
 * Describes the message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleObject.
...
export const OpenFgaRelationshipTupleObjectSchema: GenMessage<OpenFgaRelationshipTupleObject> = /*@__PURE__*/
  messageDesc(file_org_openmcf_provider_openfga_openfgarelationshiptuple_v1_spec, 2);
 ...
 *
 * @generated from message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleCondition
 */
export type OpenFgaRelationshipTupleCondition = Message<"org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleCondition"> & {
  /**
...
/**
 * Describes the message org.openmcf.provider.openfga.openfgarelationshiptuple.v1.OpenFgaRelationshipTupleCondition.
...
export const OpenFgaRelationshipTupleConditionSchema: GenMessage<OpenFgaRelationshipTupleCondition> = /*@__PURE__*/
  messageDesc(file_org_openmcf_provider_openfga_openfgarelationshiptuple_v1_spec, 3);
