...
// 	protoc        (unknown)
// source: shared/relationship/v1/relationship.proto
...
const file_shared_relationship_v1_relationship_proto_rawDesc = "" +
	...
	"\x04uses\x10\x04B\xac\x02\n" +
	"&com.dev.planton.shared.relationship.v1B\x11RelationshipProtoP\x01ZBgithub.com/plantonhq/planton/shared/relationship/v1;relationshipv1\xa2\x02\x04DPSR\xaa\x02\"Dev.Planton.Shared.Relationship.V1\xca\x02\"Dev\\Planton\\Shared\\Relationship\\V1\xe2\x02.Dev\\Planton\\Shared\\Relationship\\V1\\GPBMetadata\xea\x02&Dev::Planton::Shared::Relationship::V1b\x06proto3"

var (
	file_shared_relationship_v1_relationship_proto_rawDescOnce sync.Once
	file_shared_relationship_v1_relationship_proto_rawDescData []byte
)

func file_shared_relationship_v1_relationship_proto_rawDescGZIP() []byte {
	file_shared_relationship_v1_relationship_proto_rawDescOnce.Do(func() {
		file_shared_relationship_v1_relationship_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shared_relationship_v1_relationship_proto_rawDesc), len(file_shared_relationship_v1_relationship_proto_rawDesc)))
	})
	return file_shared_relationship_v1_relationship_proto_rawDescData
}
...
func init() { file_shared_relationship_v1_relationship_proto_init() }
func file_shared_relationship_v1_relationship_proto_init() {
	if File_shared_relationship_v1_relationship_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shared_relationship_v1_relationship_proto_rawDesc), len(file_shared_relationship_v1_relationship_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_shared_relationship_v1_relationship_proto_goTypes,
		DependencyIndexes: file_shared_relationship_v1_relationship_proto_depIdxs,
		EnumInfos:         file_shared_relationship_v1_relationship_proto_enumTypes,
		MessageInfos:      file_shared_relationship_v1_relationship_proto_msgTypes,
	}.Build()
	File_shared_relationship_v1_relationship_proto = out.File
	file_shared_relationship_v1_relationship_proto_goTypes = nil
	file_shared_relationship_v1_relationship_proto_depIdxs = nil
}
