...
var File_shared_metadata_proto protoreflect.FileDescriptor
...
const file_shared_metadata_proto_rawDesc = "" +
	...
	"\x16com.dev.planton.sharedB\rMetadataProtoP\x01Z#github.com/plantonhq/planton/shared\xa2\x02\x03DPS\xaa\x02\x12Dev.Planton.Shared\xca\x02\x12Dev\\Planton\\Shared\xe2\x02\x1eDev\\Planton\\Shared\\GPBMetadata\xea\x02\x14Dev::Planton::Sharedb\x06proto3"

var (
	file_shared_metadata_proto_rawDescOnce sync.Once
	file_shared_metadata_proto_rawDescData []byte
)

func file_shared_metadata_proto_rawDescGZIP() []byte {
	file_shared_metadata_proto_rawDescOnce.Do(func() {
		file_shared_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shared_metadata_proto_rawDesc), len(file_shared_metadata_proto_rawDesc)))
	})
	return file_shared_metadata_proto_rawDescData
}
...
func init() { file_shared_metadata_proto_init() }
func file_shared_metadata_proto_init() {
	if File_shared_metadata_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shared_metadata_proto_rawDesc), len(file_shared_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_shared_metadata_proto_goTypes,
		DependencyIndexes: file_shared_metadata_proto_depIdxs,
		MessageInfos:      file_shared_metadata_proto_msgTypes,
	}.Build()
	File_shared_metadata_proto = out.File
	file_shared_metadata_proto_goTypes = nil
	file_shared_metadata_proto_depIdxs = nil
}
