...
// 	protoc        (unknown)
// source: iac/providerimportcatalog/v1/spec.proto
...
func (x *ProviderImportCatalogSpec) Reset() {
	*x = ProviderImportCatalogSpec{}
	mi := &file_iac_providerimportcatalog_v1_spec_proto_msgTypes[0]
...
func (*ProviderImportCatalogSpec) Descriptor() ([]byte, []int) {
	return file_iac_providerimportcatalog_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ResourceTypeImportId) Reset() {
	*x = ResourceTypeImportId{}
	mi := &file_iac_providerimportcatalog_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResourceTypeImportId) Descriptor() ([]byte, []int) {
	return file_iac_providerimportcatalog_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var (
	file_iac_providerimportcatalog_v1_spec_proto_rawDescOnce sync.Once
	file_iac_providerimportcatalog_v1_spec_proto_rawDescData []byte
)

func file_iac_providerimportcatalog_v1_spec_proto_rawDescGZIP() []byte {
	file_iac_providerimportcatalog_v1_spec_proto_rawDescOnce.Do(func() {
		file_iac_providerimportcatalog_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_iac_providerimportcatalog_v1_spec_proto_rawDesc), len(file_iac_providerimportcatalog_v1_spec_proto_rawDesc)))
	})
	return file_iac_providerimportcatalog_v1_spec_proto_rawDescData
}

var file_iac_providerimportcatalog_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_iac_providerimportcatalog_v1_spec_proto_goTypes = []any{
...
var file_iac_providerimportcatalog_v1_spec_proto_depIdxs = []int32{
...
func init() { file_iac_providerimportcatalog_v1_spec_proto_init() }
func file_iac_providerimportcatalog_v1_spec_proto_init() {
	if File_iac_providerimportcatalog_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_iac_providerimportcatalog_v1_spec_proto_rawDesc), len(file_iac_providerimportcatalog_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_iac_providerimportcatalog_v1_spec_proto_goTypes,
		DependencyIndexes: file_iac_providerimportcatalog_v1_spec_proto_depIdxs,
		MessageInfos:      file_iac_providerimportcatalog_v1_spec_proto_msgTypes,
	}.Build()
	File_iac_providerimportcatalog_v1_spec_proto = out.File
	file_iac_providerimportcatalog_v1_spec_proto_goTypes = nil
	file_iac_providerimportcatalog_v1_spec_proto_depIdxs = nil
}
