...
// 	protoc        (unknown)
// source: catalog/digitalocean/digitaloceanappplatformservice/v1alpha1/spec.proto
...
func (DigitalOceanAppPlatformServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanAppPlatformServiceType) Type() protoreflect.EnumType {
	return &file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanAppPlatformServiceType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (DigitalOceanAppPlatformInstanceSize) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (DigitalOceanAppPlatformInstanceSize) Type() protoreflect.EnumType {
	return &file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes[1]
}
...
func (DigitalOceanAppPlatformInstanceSize) EnumDescriptor() ([]byte, []int) {
	return file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
type DigitalOceanAppPlatformServiceSpec struct {
	...
	ServiceType DigitalOceanAppPlatformServiceType `protobuf:"varint,3,opt,name=service_type,json=serviceType,proto3,enum=dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceType" json:"service_type,omitempty"`
	...
	InstanceSizeSlug DigitalOceanAppPlatformInstanceSize `protobuf:"varint,6,opt,name=instance_size_slug,json=instanceSizeSlug,proto3,enum=dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSize" json:"instance_size_slug,omitempty"`
...
func (x *DigitalOceanAppPlatformServiceSpec) Reset() {
	*x = DigitalOceanAppPlatformServiceSpec{}
	mi := &file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[0]
...
func (x *DigitalOceanAppPlatformGitSource) Reset() {
	*x = DigitalOceanAppPlatformGitSource{}
	mi := &file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DigitalOceanAppPlatformRegistrySource) Reset() {
	*x = DigitalOceanAppPlatformRegistrySource{}
	mi := &file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanAppPlatformRegistrySource) Descriptor() ([]byte, []int) {
	return file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Gcatalog/digitalocean/digitaloceanappplatformservice/v1alpha1/spec.proto\x12@dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a!catalog/digitalocean/region.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\x84\n" +
	"\n" +
	"\"DigitalOceanAppPlatformServiceSpec\x12N\n" +
	"\fservice_name\x18\x01 \x01(\tB+\xbaH(\xc8\x01\x01r#\x18?2\x1f^[a-z0-9]([-a-z0-9]*[a-z0-9])?$R\vserviceName\x12L\n" +
	"\x06region\x18\x02 \x01(\x0e2,.dev.planton.digitalocean.DigitalOceanRegionB\x06\xbaH\x03\xc8\x01\x01R\x06region\x12\x8f\x01\n" +
	"\fservice_type\x18\x03 \x01(\x0e2d.dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceTypeB\x06\xbaH\x03\xc8\x01\x01R\vserviceType\x12\x83\x01\n" +
	"\n" +
	"git_source\x18\x04 \x01(\v2b.dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformGitSourceH\x00R\tgitSource\x12\x8c\x01\n" +
	"\fimage_source\x18\x05 \x01(\v2g.dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySourceH\x00R\vimageSource\x12\xa8\x01\n" +
	"\x12instance_size_slug\x18\x06 \x01(\x0e2e.dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSizeB\x13\xbaH\x03\xc8\x01\x01\x92\xa6\x1d\tbasic-xxsR\x10instanceSizeSlug\x12,\n" +
	...
	" \x01(\rR\x10maxInstanceCount\x12\x7f\n" +
	"\x03env\x18\v \x03(\v2m.dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.EnvEntryR\x03env\x12v\n" +
	...
	"B\xf9\x03\n" +
	"Dcom.dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1B\tSpecProtoP\x01Z\x80\x01github.com/plantonhq/planton/catalog/digitalocean/digitaloceanappplatformservice/v1alpha1;digitaloceanappplatformservicev1alpha1\xa2\x02\x04DPDD\xaa\x02@Dev.Planton.Digitalocean.Digitaloceanappplatformservice.V1alpha1\xca\x02@Dev\\Planton\\Digitalocean\\Digitaloceanappplatformservice\\V1alpha1\xe2\x02LDev\\Planton\\Digitalocean\\Digitaloceanappplatformservice\\V1alpha1\\GPBMetadata\xea\x02DDev::Planton::Digitalocean::Digitaloceanappplatformservice::V1alpha1b\x06proto3"

var (
	file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc), len(file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDescData
}

var file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_goTypes = []any{
	(DigitalOceanAppPlatformServiceType)(0),       // 0: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceType
	(DigitalOceanAppPlatformInstanceSize)(0),      // 1: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSize
	(*DigitalOceanAppPlatformServiceSpec)(nil),    // 2: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec
	(*DigitalOceanAppPlatformGitSource)(nil),      // 3: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformGitSource
	(*DigitalOceanAppPlatformRegistrySource)(nil), // 4: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySource
	nil,                                  // 5: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.EnvEntry
	(digitalocean.DigitalOceanRegion)(0), // 6: dev.planton.digitalocean.DigitalOceanRegion
	(*v1.StringValueOrRef)(nil),          // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.region:type_name -> dev.planton.digitalocean.DigitalOceanRegion
	0, // 1: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.service_type:type_name -> dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceType
	3, // 2: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.git_source:type_name -> dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformGitSource
	4, // 3: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.image_source:type_name -> dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySource
	1, // 4: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.instance_size_slug:type_name -> dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformInstanceSize
	5, // 5: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.env:type_name -> dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.EnvEntry
	7, // 6: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformServiceSpec.custom_domain:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7, // 7: dev.planton.digitalocean.digitaloceanappplatformservice.v1alpha1.DigitalOceanAppPlatformRegistrySource.registry:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_init() }
func file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_init() {
	if File_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc), len(file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto = out.File
	file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_goTypes = nil
	file_catalog_digitalocean_digitaloceanappplatformservice_v1alpha1_spec_proto_depIdxs = nil
}
