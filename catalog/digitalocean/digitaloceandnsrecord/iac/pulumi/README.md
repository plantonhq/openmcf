...
This module is designed to be used with Planton's CLI. The manifest is passed via environment variable.
...
```bash
export STACK_INPUT='{"target":{"apiVersion":"digital-ocean.planton.dev/v1alpha1","kind":"DigitalOceanDnsRecord","metadata":{"name":"www-record"},"spec":{"domain":"example.com","name":"www","type":"A","value":"192.0.2.1"}},"providerConfig":{"apiToken":"YOUR_TOKEN","defaultRegion":"nyc1"}}'
