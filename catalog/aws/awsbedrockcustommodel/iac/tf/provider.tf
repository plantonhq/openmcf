terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_bedrock_custom_model's full argument surface
      # (customization job + data configs + vpc_config) predates 6.x; no
      # argument this module renders needs a floor above the catalog pin.
