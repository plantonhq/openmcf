...
// 	protoc        (unknown)
// source: catalog/aws/awsecrrepo/v1alpha1/spec.proto
...
func (x *AwsEcrRepoSpec) Reset() {
	*x = AwsEcrRepoSpec{}
	mi := &file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsEcrRepoSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEcrRepoLifecycleRule) Reset() {
	*x = AwsEcrRepoLifecycleRule{}
	mi := &file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcrRepoLifecycleRule) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var (
	file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_goTypes = []any{
	(*AwsEcrRepoSpec)(nil),          // 0: dev.planton.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec
	(*AwsEcrRepoLifecycleRule)(nil), // 1: dev.planton.aws.awsecrrepo.v1alpha1.AwsEcrRepoLifecycleRule
	(*v1.StringValueOrRef)(nil),     // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),         // 3: google.protobuf.Struct
}
var file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec.lifecycle_rules:type_name -> dev.planton.aws.awsecrrepo.v1alpha1.AwsEcrRepoLifecycleRule
	3, // 2: dev.planton.aws.awsecrrepo.v1alpha1.AwsEcrRepoSpec.repository_policy:type_name -> google.protobuf.Struct
...
func init() { file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsecrrepo_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsecrrepo_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsecrrepo_v1alpha1_spec_proto_depIdxs = nil
}
