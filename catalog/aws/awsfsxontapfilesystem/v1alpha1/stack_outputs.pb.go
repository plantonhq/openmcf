...
// 	protoc        (unknown)
// source: catalog/aws/awsfsxontapfilesystem/v1alpha1/stack_outputs.proto
...
func (x *AwsFsxOntapFileSystemStackOutputs) Reset() {
	*x = AwsFsxOntapFileSystemStackOutputs{}
	mi := &file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*AwsFsxOntapFileSystemStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	">catalog/aws/awsfsxontapfilesystem/v1alpha1/stack_outputs.proto\x12.dev.planton.aws.awsfsxontapfilesystem.v1alpha1\"\xaf\x03\n" +
	...
	"\bowner_id\x18\t \x01(\tR\aownerIdB\x8b\x03\n" +
	"2com.dev.planton.aws.awsfsxontapfilesystem.v1alpha1B\x11StackOutputsProtoP\x01Zegithub.com/plantonhq/planton/catalog/aws/awsfsxontapfilesystem/v1alpha1;awsfsxontapfilesystemv1alpha1\xa2\x02\x04DPAA\xaa\x02.Dev.Planton.Aws.Awsfsxontapfilesystem.V1alpha1\xca\x02.Dev\\Planton\\Aws\\Awsfsxontapfilesystem\\V1alpha1\xe2\x02:Dev\\Planton\\Aws\\Awsfsxontapfilesystem\\V1alpha1\\GPBMetadata\xea\x022Dev::Planton::Aws::Awsfsxontapfilesystem::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*AwsFsxOntapFileSystemStackOutputs)(nil), // 0: dev.planton.aws.awsfsxontapfilesystem.v1alpha1.AwsFsxOntapFileSystemStackOutputs
}
var file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_init() }
func file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto = out.File
	file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_aws_awsfsxontapfilesystem_v1alpha1_stack_outputs_proto_depIdxs = nil
}
