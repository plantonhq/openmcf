...
func initializeLocals(_ *pulumi.Context, in *awsrestapivpclinkv1alpha1.AwsRestApiVpcLinkStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsRestApiVpcLink.String(),
