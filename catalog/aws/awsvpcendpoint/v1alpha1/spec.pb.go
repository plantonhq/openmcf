...
// 	protoc        (unknown)
// source: catalog/aws/awsvpcendpoint/v1alpha1/spec.proto
...
func (x *AwsVpcEndpointSpec) Reset() {
	*x = AwsVpcEndpointSpec{}
	mi := &file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsVpcEndpointSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsVpcEndpointDnsOptions) Reset() {
	*x = AwsVpcEndpointDnsOptions{}
	mi := &file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsVpcEndpointDnsOptions) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsVpcEndpointSubnetConfiguration) Reset() {
	*x = AwsVpcEndpointSubnetConfiguration{}
	mi := &file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsVpcEndpointSubnetConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x04ipv6\x18\x03 \x01(\tR\x04ipv6B\xd2\x02\n" +
	"+com.dev.planton.aws.awsvpcendpoint.v1alpha1B\tSpecProtoP\x01ZWgithub.com/plantonhq/planton/catalog/aws/awsvpcendpoint/v1alpha1;awsvpcendpointv1alpha1\xa2\x02\x04DPAA\xaa\x02'Dev.Planton.Aws.Awsvpcendpoint.V1alpha1\xca\x02'Dev\\Planton\\Aws\\Awsvpcendpoint\\V1alpha1\xe2\x023Dev\\Planton\\Aws\\Awsvpcendpoint\\V1alpha1\\GPBMetadata\xea\x02+Dev::Planton::Aws::Awsvpcendpoint::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_goTypes = []any{
	(*AwsVpcEndpointSpec)(nil),                // 0: dev.planton.aws.awsvpcendpoint.v1alpha1.AwsVpcEndpointSpec
...
var file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_depIdxs = []int32{
	...
	3, // 1: dev.planton.aws.awsvpcendpoint.v1alpha1.AwsVpcEndpointSpec.route_table_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsvpcendpoint_v1alpha1_spec_proto_depIdxs = nil
}
