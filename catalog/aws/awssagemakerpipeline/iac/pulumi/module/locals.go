...
func initializeLocals(_ *pulumi.Context, in *awssagemakerpipelinev1alpha1.AwsSagemakerPipelineStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsSagemakerPipeline.String(),
