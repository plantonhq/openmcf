...
// 	protoc        (unknown)
// source: catalog/aws/awsdocumentdb/v1alpha1/spec.proto
...
func (x *AwsDocumentDbSpec) Reset() {
	*x = AwsDocumentDbSpec{}
	mi := &file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsDocumentDbSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsDocumentDbInstance) Reset() {
	*x = AwsDocumentDbInstance{}
	mi := &file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbInstance) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsDocumentDbServerlessV2Scaling) Reset() {
	*x = AwsDocumentDbServerlessV2Scaling{}
	mi := &file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbServerlessV2Scaling) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsDocumentDbRestoreToPointInTime) Reset() {
	*x = AwsDocumentDbRestoreToPointInTime{}
	mi := &file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbRestoreToPointInTime) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsDocumentDbParameter) Reset() {
	*x = AwsDocumentDbParameter{}
	mi := &file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDocumentDbParameter) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_aws_awsdocumentdb_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\tinstances\x18\n" +
	" \x03(\v2=.dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbInstanceR\tinstances\x12|\n" +
	"\x15serverless_v2_scaling\x18\v \x01(\v2H.dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbServerlessV2ScalingR\x13serverlessV2Scaling\x12'\n" +
	...
	"\x18restore_to_point_in_time\x18\x19 \x01(\v2I.dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbRestoreToPointInTimeR\x14restoreToPointInTime\x12:\n" +
	"\x19global_cluster_identifier\x18\x1a \x01(\tR\x17globalClusterIdentifier\x12D\n" +
	"\x1fdb_cluster_parameter_group_name\x18\x1b \x01(\tR\x1bdbClusterParameterGroupName\x12^\n" +
	"\n" +
	...
	"*com.dev.planton.aws.awsdocumentdb.v1alpha1B\tSpecProtoP\x01ZUgithub.com/plantonhq/planton/catalog/aws/awsdocumentdb/v1alpha1;awsdocumentdbv1alpha1\xa2\x02\x04DPAA\xaa\x02&Dev.Planton.Aws.Awsdocumentdb.V1alpha1\xca\x02&Dev\\Planton\\Aws\\Awsdocumentdb\\V1alpha1\xe2\x022Dev\\Planton\\Aws\\Awsdocumentdb\\V1alpha1\\GPBMetadata\xea\x02*Dev::Planton::Aws::Awsdocumentdb::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_goTypes = []any{
	(*AwsDocumentDbSpec)(nil),                 // 0: dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbSpec
	(*AwsDocumentDbInstance)(nil),             // 1: dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbInstance
	(*AwsDocumentDbServerlessV2Scaling)(nil),  // 2: dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbServerlessV2Scaling
	(*AwsDocumentDbRestoreToPointInTime)(nil), // 3: dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbRestoreToPointInTime
	(*AwsDocumentDbParameter)(nil),            // 4: dev.planton.aws.awsdocumentdb.v1alpha1.AwsDocumentDbParameter
...
func file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsdocumentdb_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsdocumentdb_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsdocumentdb_v1alpha1_spec_proto_depIdxs = nil
}
