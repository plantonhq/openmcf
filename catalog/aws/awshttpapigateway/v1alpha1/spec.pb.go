...
// 	protoc        (unknown)
// source: catalog/aws/awshttpapigateway/v1alpha1/spec.proto
...
func (x *AwsHttpApiGatewaySpec) Reset() {
	*x = AwsHttpApiGatewaySpec{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsHttpApiGatewaySpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsHttpApiGatewayCorsConfig) Reset() {
	*x = AwsHttpApiGatewayCorsConfig{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayCorsConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsHttpApiGatewayStageConfig) Reset() {
	*x = AwsHttpApiGatewayStageConfig{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayStageConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsHttpApiGatewayAccessLogConfig) Reset() {
	*x = AwsHttpApiGatewayAccessLogConfig{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayAccessLogConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsHttpApiGatewayThrottleConfig) Reset() {
	*x = AwsHttpApiGatewayThrottleConfig{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayThrottleConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsHttpApiGatewayRouteSettings) Reset() {
	*x = AwsHttpApiGatewayRouteSettings{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayRouteSettings) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsHttpApiGatewayRoute) Reset() {
	*x = AwsHttpApiGatewayRoute{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayRoute) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsHttpApiGatewayIntegration) Reset() {
	*x = AwsHttpApiGatewayIntegration{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayIntegration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsHttpApiGatewayResponseParameters) Reset() {
	*x = AwsHttpApiGatewayResponseParameters{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayResponseParameters) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsHttpApiGatewayAuthorizer) Reset() {
	*x = AwsHttpApiGatewayAuthorizer{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayAuthorizer) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *AwsHttpApiGatewayJwtConfig) Reset() {
	*x = AwsHttpApiGatewayJwtConfig{}
	mi := &file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsHttpApiGatewayJwtConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
var File_catalog_aws_awshttpapigateway_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDesc = "" +
	...
	"apiVersion\x12v\n" +
	"\x12cors_configuration\x18\x04 \x01(\v2G.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayCorsConfigR\x11corsConfiguration\x12?\n" +
	...
	"\x11allow_credentials\x18\x06 \x01(\bR\x10allowCredentials\"\xf1\x05\n" +
	"\x1cAwsHttpApiGatewayStageConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12$\n" +
	"\vauto_deploy\x18\x02 \x01(\bH\x00R\n" +
	"autoDeploy\x88\x01\x01\x12*\n" +
	"\vdescription\x18\x03 \x01(\tB\b\xbaH\x05r\x03\x18\x80\bR\vdescription\x12k\n" +
	"\n" +
	"access_log\x18\x04 \x01(\v2L.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAccessLogConfigR\taccessLog\x12v\n" +
	"\x10default_throttle\x18\x05 \x01(\v2K.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayThrottleConfigR\x0fdefaultThrottle\x128\n" +
	"\x18detailed_metrics_enabled\x18\x06 \x01(\bR\x16detailedMetricsEnabled\x12q\n" +
	"\x0eroute_settings\x18\a \x03(\v2J.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayRouteSettingsR\rrouteSettings\x12\x85\x01\n" +
	"\x0fstage_variables\x18\b \x03(\v2\\.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig.StageVariablesEntryR\x0estageVariables\x1aA\n" +
	...
	"\x18detailed_metrics_enabled\x18\x04 \x01(\bR\x16detailedMetricsEnabled\"\xed\x02\n" +
	"\x16AwsHttpApiGatewayRoute\x12$\n" +
	"\troute_key\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\brouteKey\x12r\n" +
	"\vintegration\x18\x02 \x01(\v2H.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegrationB\x06\xbaH\x03\xc8\x01\x01R\vintegration\x12-\n" +
	...
	"\x0eoperation_name\x18\x06 \x01(\tB\a\xbaH\x04r\x02\x18@R\roperationName\"\x8f\t\n" +
	...
	"\x0fcredentials_arn\x18\t \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xf0\a\x92\xd4a\x17status.outputs.role_arnR\x0ecredentialsArn\x12\x8e\x01\n" +
	"\x12request_parameters\x18\n" +
	" \x03(\v2_.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.RequestParametersEntryR\x11requestParameters\x12\x80\x01\n" +
	"\x13response_parameters\x18\v \x03(\v2O.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayResponseParametersR\x12responseParameters\x128\n" +
	...
	"\x0fauthorizer_type\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x0eauthorizerType\x12s\n" +
	"\x11jwt_configuration\x18\x03 \x01(\v2F.dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayJwtConfigR\x10jwtConfiguration\x12\x7f\n" +
	...
	"\taudiences\x18\x02 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\x86\t\x92\xd4a\x18status.outputs.client_idR\taudiencesB\xe7\x02\n" +
	".com.dev.planton.aws.awshttpapigateway.v1alpha1B\tSpecProtoP\x01Z]github.com/plantonhq/planton/catalog/aws/awshttpapigateway/v1alpha1;awshttpapigatewayv1alpha1\xa2\x02\x04DPAA\xaa\x02*Dev.Planton.Aws.Awshttpapigateway.V1alpha1\xca\x02*Dev\\Planton\\Aws\\Awshttpapigateway\\V1alpha1\xe2\x026Dev\\Planton\\Aws\\Awshttpapigateway\\V1alpha1\\GPBMetadata\xea\x02.Dev::Planton::Aws::Awshttpapigateway::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_goTypes = []any{
	(*AwsHttpApiGatewaySpec)(nil),               // 0: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewaySpec
	(*AwsHttpApiGatewayCorsConfig)(nil),         // 1: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayCorsConfig
	(*AwsHttpApiGatewayStageConfig)(nil),        // 2: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig
	(*AwsHttpApiGatewayAccessLogConfig)(nil),    // 3: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAccessLogConfig
	(*AwsHttpApiGatewayThrottleConfig)(nil),     // 4: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayThrottleConfig
	(*AwsHttpApiGatewayRouteSettings)(nil),      // 5: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayRouteSettings
	(*AwsHttpApiGatewayRoute)(nil),              // 6: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayRoute
	(*AwsHttpApiGatewayIntegration)(nil),        // 7: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration
	(*AwsHttpApiGatewayResponseParameters)(nil), // 8: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayResponseParameters
	(*AwsHttpApiGatewayAuthorizer)(nil),         // 9: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAuthorizer
	(*AwsHttpApiGatewayJwtConfig)(nil),          // 10: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayJwtConfig
	nil,                                         // 11: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig.StageVariablesEntry
	nil,                                         // 12: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.RequestParametersEntry
	nil,                                         // 13: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayResponseParameters.MappingsEntry
	(*v1.StringValueOrRef)(nil),                 // 14: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewaySpec.cors_configuration:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayCorsConfig
	2,  // 1: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewaySpec.stage:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig
	6,  // 2: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewaySpec.routes:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayRoute
	9,  // 3: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewaySpec.authorizers:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAuthorizer
	3,  // 4: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig.access_log:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAccessLogConfig
	4,  // 5: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig.default_throttle:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayThrottleConfig
	5,  // 6: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig.route_settings:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayRouteSettings
	11, // 7: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig.stage_variables:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayStageConfig.StageVariablesEntry
	14, // 8: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAccessLogConfig.destination_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 9: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayRoute.integration:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration
	14, // 10: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.integration_uri:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	14, // 11: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.connection_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	14, // 12: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.credentials_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	12, // 13: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.request_parameters:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.RequestParametersEntry
	8,  // 14: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayIntegration.response_parameters:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayResponseParameters
	13, // 15: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayResponseParameters.mappings:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayResponseParameters.MappingsEntry
	10, // 16: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAuthorizer.jwt_configuration:type_name -> dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayJwtConfig
	14, // 17: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAuthorizer.authorizer_uri:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	14, // 18: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayAuthorizer.authorizer_credentials_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	14, // 19: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayJwtConfig.issuer:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	14, // 20: dev.planton.aws.awshttpapigateway.v1alpha1.AwsHttpApiGatewayJwtConfig.audiences:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_init() }
func file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awshttpapigateway_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awshttpapigateway_v1alpha1_spec_proto = out.File
	file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awshttpapigateway_v1alpha1_spec_proto_depIdxs = nil
}
