...
func initializeLocals(_ *pulumi.Context, in *awsbackupvaultv1alpha1.AwsBackupVaultStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsBackupVault.String(),
