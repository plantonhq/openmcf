...
// 	protoc        (unknown)
// source: catalog/aws/awsfsxontapvolume/v1alpha1/spec.proto
...
func (x *AwsFsxOntapVolumeSpec) Reset() {
	*x = AwsFsxOntapVolumeSpec{}
	mi := &file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsFsxOntapVolumeSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxOntapVolumeTieringPolicy) Reset() {
	*x = AwsFsxOntapVolumeTieringPolicy{}
	mi := &file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeTieringPolicy) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsFsxOntapVolumeSnaplockConfiguration) Reset() {
	*x = AwsFsxOntapVolumeSnaplockConfiguration{}
	mi := &file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeSnaplockConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsFsxOntapVolumeAutocommitPeriod) Reset() {
	*x = AwsFsxOntapVolumeAutocommitPeriod{}
	mi := &file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeAutocommitPeriod) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsFsxOntapVolumeRetentionPeriod) Reset() {
	*x = AwsFsxOntapVolumeRetentionPeriod{}
	mi := &file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeRetentionPeriod) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsFsxOntapVolumeRetentionDuration) Reset() {
	*x = AwsFsxOntapVolumeRetentionDuration{}
	mi := &file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeRetentionDuration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsFsxOntapVolumeAggregateConfiguration) Reset() {
	*x = AwsFsxOntapVolumeAggregateConfiguration{}
	mi := &file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapVolumeAggregateConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x11skip_final_backup\x18\r \x01(\bB\t\x8a\xa6\x1d\x05falseH\x06R\x0fskipFinalBackup\x88\x01\x01\x12\x82\x01\n" +
	"\x11final_backup_tags\x18\x0e \x03(\v2V.dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.FinalBackupTagsEntryR\x0ffinalBackupTags\x12_\n" +
	"$bypass_snaplock_enterprise_retention\x18\x0f \x01(\bB\t\x8a\xa6\x1d\x05falseH\aR!bypassSnaplockEnterpriseRetention\x88\x01\x01\x12q\n" +
	"\x0etiering_policy\x18\x10 \x01(\v2J.dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeTieringPolicyR\rtieringPolicy\x12\x89\x01\n" +
	"\x16snaplock_configuration\x18\x11 \x01(\v2R.dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfigurationR\x15snaplockConfiguration\x12\x8c\x01\n" +
	...
	"\x1avolume_append_mode_enabled\x18\x04 \x01(\bB\t\x8a\xa6\x1d\x05falseH\x02R\x17volumeAppendModeEnabled\x88\x01\x01\x12z\n" +
	"\x11autocommit_period\x18\x05 \x01(\v2M.dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAutocommitPeriodR\x10autocommitPeriod\x12w\n" +
	"\x10retention_period\x18\x06 \x01(\v2L.dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriodR\x0fretentionPeriod:\xd6\x02\xbaH\xd2\x02\x1a}\n" +
	...
	"\x12constituents_range\x124constituents_per_aggregate must be between 1 and 200\x1axthis.constituents_per_aggregate == 0 || (this.constituents_per_aggregate >= 1 && this.constituents_per_aggregate <= 200)B\xe7\x02\n" +
	".com.dev.planton.aws.awsfsxontapvolume.v1alpha1B\tSpecProtoP\x01Z]github.com/plantonhq/planton/catalog/aws/awsfsxontapvolume/v1alpha1;awsfsxontapvolumev1alpha1\xa2\x02\x04DPAA\xaa\x02*Dev.Planton.Aws.Awsfsxontapvolume.V1alpha1\xca\x02*Dev\\Planton\\Aws\\Awsfsxontapvolume\\V1alpha1\xe2\x026Dev\\Planton\\Aws\\Awsfsxontapvolume\\V1alpha1\\GPBMetadata\xea\x02.Dev::Planton::Aws::Awsfsxontapvolume::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_goTypes = []any{
	(*AwsFsxOntapVolumeSpec)(nil),                   // 0: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec
	(*AwsFsxOntapVolumeTieringPolicy)(nil),          // 1: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeTieringPolicy
	(*AwsFsxOntapVolumeSnaplockConfiguration)(nil),  // 2: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration
	(*AwsFsxOntapVolumeAutocommitPeriod)(nil),       // 3: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAutocommitPeriod
	(*AwsFsxOntapVolumeRetentionPeriod)(nil),        // 4: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod
	(*AwsFsxOntapVolumeRetentionDuration)(nil),      // 5: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
	(*AwsFsxOntapVolumeAggregateConfiguration)(nil), // 6: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAggregateConfiguration
	nil,                         // 7: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.FinalBackupTagsEntry
	(*v1.StringValueOrRef)(nil), // 8: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_depIdxs = []int32{
	8,  // 0: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.storage_virtual_machine_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7,  // 1: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.final_backup_tags:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.FinalBackupTagsEntry
	1,  // 2: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.tiering_policy:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeTieringPolicy
	2,  // 3: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.snaplock_configuration:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration
	6,  // 4: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSpec.aggregate_configuration:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAggregateConfiguration
	3,  // 5: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration.autocommit_period:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeAutocommitPeriod
	4,  // 6: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeSnaplockConfiguration.retention_period:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod
	5,  // 7: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod.default_retention:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
	5,  // 8: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod.minimum_retention:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
	5,  // 9: dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionPeriod.maximum_retention:type_name -> dev.planton.aws.awsfsxontapvolume.v1alpha1.AwsFsxOntapVolumeRetentionDuration
...
func init() { file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsfsxontapvolume_v1alpha1_spec_proto_depIdxs = nil
}
