terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the AI_PROTECTION / AI_ANALYST detector features and
      # the member-detector-feature resource are the newest surfaces here;
      # all are v6-era — nothing needs newer than the catalog pin.
