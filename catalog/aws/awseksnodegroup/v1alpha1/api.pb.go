...
const file_catalog_aws_awseksnodegroup_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	".catalog/aws/awseksnodegroup/v1alpha1/api.proto\x12(dev.planton.aws.awseksnodegroup.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a2catalog/aws/awseksnodegroup/v1alpha1/outputs.proto\x1a/catalog/aws/awseksnodegroup/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\x82\x03\n" +
...
func file_catalog_aws_awseksnodegroup_v1alpha1_api_proto_init() {
	...
	file_catalog_aws_awseksnodegroup_v1alpha1_outputs_proto_init()
