...
- [AwsCognitoUserPool](../../awscognitouserpool/v1alpha1/README.md) — parent resource; must be created first
- [AwsCognitoUserPoolClient](../../awscognitouserpoolclient/v1alpha1/README.md) — list this provider (by reference to its `provider_name` output) in `supportedIdentityProviders` to enable federated sign-in
