...
// 	protoc        (unknown)
// source: catalog/aws/awssqsqueue/v1alpha1/spec.proto
...
func (x *AwsSqsQueueSpec) Reset() {
	*x = AwsSqsQueueSpec{}
	mi := &file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsSqsQueueSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsSqsQueueDeadLetterConfig) Reset() {
	*x = AwsSqsQueueDeadLetterConfig{}
	mi := &file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSqsQueueDeadLetterConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsSqsQueueRedriveAllowPolicy) Reset() {
	*x = AwsSqsQueueRedriveAllowPolicy{}
	mi := &file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsSqsQueueRedriveAllowPolicy) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_aws_awssqsqueue_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc = "" +
	...
	" \x01(\tR\x13fifoThroughputLimit\x12o\n" +
	...
	"\x1esource_queues_match_permission\x12|source_queue_arns is required (1-10 entries) with redrive_permission 'byQueue' and must be empty for 'allowAll' or 'denyAll'\x1althis.redrive_permission == 'byQueue' ? size(this.source_queue_arns) >= 1 : size(this.source_queue_arns) == 0B\xbd\x02\n" +
	"(com.dev.planton.aws.awssqsqueue.v1alpha1B\tSpecProtoP\x01ZQgithub.com/plantonhq/planton/catalog/aws/awssqsqueue/v1alpha1;awssqsqueuev1alpha1\xa2\x02\x04DPAA\xaa\x02$Dev.Planton.Aws.Awssqsqueue.V1alpha1\xca\x02$Dev\\Planton\\Aws\\Awssqsqueue\\V1alpha1\xe2\x020Dev\\Planton\\Aws\\Awssqsqueue\\V1alpha1\\GPBMetadata\xea\x02(Dev::Planton::Aws::Awssqsqueue::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_goTypes = []any{
	(*AwsSqsQueueSpec)(nil),               // 0: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec
	(*AwsSqsQueueDeadLetterConfig)(nil),   // 1: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueDeadLetterConfig
	(*AwsSqsQueueRedriveAllowPolicy)(nil), // 2: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueRedriveAllowPolicy
	(*v1.StringValueOrRef)(nil),           // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),               // 4: google.protobuf.Struct
}
var file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.dead_letter_config:type_name -> dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueDeadLetterConfig
	3, // 1: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 2: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.policy:type_name -> google.protobuf.Struct
	2, // 3: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueSpec.redrive_allow_policy:type_name -> dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueRedriveAllowPolicy
	3, // 4: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueDeadLetterConfig.target_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 5: dev.planton.aws.awssqsqueue.v1alpha1.AwsSqsQueueRedriveAllowPolicy.source_queue_arns:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_init() }
func file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awssqsqueue_v1alpha1_spec_proto = out.File
	file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awssqsqueue_v1alpha1_spec_proto_depIdxs = nil
}
