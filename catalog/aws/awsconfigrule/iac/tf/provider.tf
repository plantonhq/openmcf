terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: evaluation modes (proactive rules) and Guard
      # custom-policy details are the newest surfaces here; both are v6-era —
      # nothing needs newer than the catalog pin.
