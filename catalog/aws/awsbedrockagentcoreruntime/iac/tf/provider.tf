terraform {
  ...
  required_providers {
    aws = {
      ...
      # line and still expanding at 6.58.0 (agent_runtime's
      # lifecycle_configuration and request_header_configuration are
      # 6.58.0-additions), so an older floor would reject arguments this
      # module renders.
