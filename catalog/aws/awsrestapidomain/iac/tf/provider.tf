terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: routing_mode, endpoint_access_mode, and the 2025-09
      # TLS security-policy family on aws_api_gateway_domain_name are 6.5x
      # additions, and aws_api_gateway_domain_name_access_association is a
      # recent Plugin Framework resource -- an older floor would reject
      # arguments this module renders.
