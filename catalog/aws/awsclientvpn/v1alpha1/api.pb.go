...
const file_catalog_aws_awsclientvpn_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"+catalog/aws/awsclientvpn/v1alpha1/api.proto\x12%dev.planton.aws.awsclientvpn.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a/catalog/aws/awsclientvpn/v1alpha1/outputs.proto\x1a,catalog/aws/awsclientvpn/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\xf0\x02\n" +
	"\fAwsClientVpn\x12@\n" +
...
func file_catalog_aws_awsclientvpn_v1alpha1_api_proto_init() {
	...
	file_catalog_aws_awsclientvpn_v1alpha1_outputs_proto_init()
