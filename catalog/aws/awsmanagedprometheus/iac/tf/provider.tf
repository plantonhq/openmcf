terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_prometheus_workspace_configuration,
      # aws_prometheus_query_logging_configuration,
      # aws_prometheus_anomaly_detector, and
      # aws_prometheus_resource_policy are all 6.5x-era Plugin Framework
      # resources - the catalog pin is exactly their floor generation.
