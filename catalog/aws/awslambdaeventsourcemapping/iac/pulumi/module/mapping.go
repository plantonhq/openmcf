...
func sourceAccessConfigurations(configs []*awslambdaeventsourcemappingv1alpha1.AwsLambdaEventSourceMappingSourceAccess) lambda.EventSourceMappingSourceAccessConfigurationArray {
...
func amazonManagedSchemaAccessConfigs(configs []*awslambdaeventsourcemappingv1alpha1.AwsLambdaEventSourceMappingSourceAccess) lambda.EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfigArray {
...
func selfManagedSchemaAccessConfigs(configs []*awslambdaeventsourcemappingv1alpha1.AwsLambdaEventSourceMappingSourceAccess) lambda.EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfigArray {
