terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aggregation is v1-era surface; authorized_aws_region
      # (the v6 rename of the grant's deprecated "region") is what this
      # module renders — nothing needs newer than the catalog pin.
