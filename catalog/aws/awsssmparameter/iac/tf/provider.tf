terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_ssm_parameter's insecure_value split and the
      # Intelligent-Tiering tier are long-settled v5-era surface — nothing
      # needs newer than the catalog pin.
