...
// 	protoc        (unknown)
// source: catalog/aws/awscodepipeline/v1alpha1/spec.proto
...
func (x *AwsCodePipelineSpec) Reset() {
	*x = AwsCodePipelineSpec{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsCodePipelineSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsCodePipelineArtifactStore) Reset() {
	*x = AwsCodePipelineArtifactStore{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineArtifactStore) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCodePipelineStage) Reset() {
	*x = AwsCodePipelineStage{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineStage) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsCodePipelineStageCondition) Reset() {
	*x = AwsCodePipelineStageCondition{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineStageCondition) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsCodePipelineFailureHandling) Reset() {
	*x = AwsCodePipelineFailureHandling{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineFailureHandling) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsCodePipelineRetryConfiguration) Reset() {
	*x = AwsCodePipelineRetryConfiguration{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineRetryConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsCodePipelineRule) Reset() {
	*x = AwsCodePipelineRule{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineRule) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsCodePipelineRuleTypeId) Reset() {
	*x = AwsCodePipelineRuleTypeId{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineRuleTypeId) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsCodePipelineAction) Reset() {
	*x = AwsCodePipelineAction{}
	mi := &file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodePipelineAction) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
var File_catalog_aws_awscodepipeline_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x11encryption_key_id\x18\x03 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xfb\a\x92\xd4a\x16status.outputs.key_arnR\x0fencryptionKeyId\"\xf2\x03\n" +
	"\x14AwsCodePipelineStage\x125\n" +
	"\x04name\x18\x01 \x01(\tB!\xbaH\x1e\xc8\x01\x01r\x19\x10\x01\x18d2\x13^[0-9A-Za-z_.@\\-]+$R\x04name\x12f\n" +
	"\aactions\x18\x02 \x03(\v2?.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineActionB\v\xbaH\b\xc8\x01\x01\x92\x01\x02\b\x01R\aactions\x12j\n" +
	"\fbefore_entry\x18\x03 \x01(\v2G.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineStageConditionR\vbeforeEntry\x12f\n" +
	"\n" +
	"on_success\x18\x04 \x01(\v2G.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineStageConditionR\tonSuccess\x12g\n" +
	"\n" +
	"on_failure\x18\x05 \x01(\v2H.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineFailureHandlingR\tonFailure\"\xb1\x01\n" +
	"\x1dAwsCodePipelineStageCondition\x12,\n" +
	"\x06result\x18\x01 \x01(\tB\x14\xbaH\x11\xd8\x01\x01r\fR\x04FAILR\x04SKIPR\x06result\x12b\n" +
	"\x05rules\x18\x02 \x03(\v2=.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineRuleB\r\xbaH\n" +
	"\xc8\x01\x01\x92\x01\x04\b\x01\x10\x05R\x05rules\"\xde\x03\n" +
	"\x1eAwsCodePipelineFailureHandling\x127\n" +
	"\x06result\x18\x01 \x01(\tB\x1f\xbaH\x1c\xd8\x01\x01r\x17R\bROLLBACKR\x05RETRYR\x04FAILR\x06result\x12|\n" +
	"\x13retry_configuration\x18\x02 \x01(\v2K.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineRetryConfigurationR\x12retryConfiguration\x12e\n" +
	"\tcondition\x18\x03 \x01(\v2G.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineStageConditionR\tcondition:\x9d\x01\xbaH\x99\x01\x1a\x96\x01\n" +
	...
	"\x11git_configuration\x18\x02 \x01(\v2I.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitConfigurationB\x06\xbaH\x03\xc8\x01\x01R\x10gitConfiguration\"\xd6\x03\n" +
	"\x1fAwsCodePipelineGitConfiguration\x12:\n" +
	"\x12source_action_name\x18\x01 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x01\x18dR\x10sourceActionName\x12^\n" +
	"\x04push\x18\x02 \x03(\v2@.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitPushB\b\xbaH\x05\x92\x01\x02\x10\x03R\x04push\x12t\n" +
	"\fpull_request\x18\x03 \x03(\v2G.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitPullRequestB\b\xbaH\x05\x92\x01\x02\x10\x03R\vpullRequest:\xa0\x01\xbaH\x9c\x01\x1a\x99\x01\n" +
	"\x1egit_configuration_needs_filter\x12Cgit_configuration requires at least one push or pull_request filter\x1a2size(this.push) > 0 || size(this.pull_request) > 0\"\xb3\x02\n" +
	"\x16AwsCodePipelineGitPush\x12^\n" +
	"\bbranches\x18\x01 \x01(\v2B.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitFilterR\bbranches\x12a\n" +
	"\n" +
	"file_paths\x18\x02 \x01(\v2B.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitFilterR\tfilePaths\x12V\n" +
	"\x04tags\x18\x03 \x01(\v2B.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitFilterR\x04tags\"\x9f\x02\n" +
	"\x1dAwsCodePipelineGitPullRequest\x12^\n" +
	"\bbranches\x18\x01 \x01(\v2B.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitFilterR\bbranches\x12a\n" +
	"\n" +
	"file_paths\x18\x02 \x01(\v2B.dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineGitFilterR\tfilePaths\x12;\n" +
	...
	"\vdescription\x18\x03 \x01(\tR\vdescriptionB\xd9\x02\n" +
	",com.dev.planton.aws.awscodepipeline.v1alpha1B\tSpecProtoP\x01ZYgithub.com/plantonhq/planton/catalog/aws/awscodepipeline/v1alpha1;awscodepipelinev1alpha1\xa2\x02\x04DPAA\xaa\x02(Dev.Planton.Aws.Awscodepipeline.V1alpha1\xca\x02(Dev\\Planton\\Aws\\Awscodepipeline\\V1alpha1\xe2\x024Dev\\Planton\\Aws\\Awscodepipeline\\V1alpha1\\GPBMetadata\xea\x02,Dev::Planton::Aws::Awscodepipeline::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_rawDesc)))
	})
...
var file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_depIdxs = []int32{
	...
	4,  // 10: dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineStage.on_failure:type_name -> dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineFailureHandling
	6,  // 11: dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineStageCondition.rules:type_name -> dev.planton.aws.awscodepipeline.v1alpha1.AwsCodePipelineRule
...
func file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awscodepipeline_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awscodepipeline_v1alpha1_spec_proto = out.File
	file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awscodepipeline_v1alpha1_spec_proto_depIdxs = nil
}
