terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the evaluation trio is 6.4x-6.5x new
      # (harness 6.46.0, online_evaluation_config 6.47.0, evaluator
      # 6.51.0) and the harness's workload/private-endpoint arms landed
      # in 6.55.0 -- an older floor would reject arguments this module
      # renders.
