...
// 	protoc        (unknown)
// source: catalog/aws/awstransitgatewayroutetable/v1alpha1/spec.proto
...
func (x *AwsTransitGatewayRouteTableSpec) Reset() {
	*x = AwsTransitGatewayRouteTableSpec{}
	mi := &file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsTransitGatewayRouteTableSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x1eprefix_list_target_exactly_one\x125exactly one of attachment_id or blackhole must be set\x1aCthis.blackhole ? !has(this.attachment_id) : has(this.attachment_id)B\xad\x03\n" +
	"8com.dev.planton.aws.awstransitgatewayroutetable.v1alpha1B\tSpecProtoP\x01Zqgithub.com/plantonhq/planton/catalog/aws/awstransitgatewayroutetable/v1alpha1;awstransitgatewayroutetablev1alpha1\xa2\x02\x04DPAA\xaa\x024Dev.Planton.Aws.Awstransitgatewayroutetable.V1alpha1\xca\x024Dev\\Planton\\Aws\\Awstransitgatewayroutetable\\V1alpha1\xe2\x02@Dev\\Planton\\Aws\\Awstransitgatewayroutetable\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Aws::Awstransitgatewayroutetable::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto = out.File
	file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awstransitgatewayroutetable_v1alpha1_spec_proto_depIdxs = nil
}
