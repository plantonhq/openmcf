terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the endpoint and configuration resources are
      # long-stable; the newest arms rendered here (managed_instance_scaling,
      # capacity_reservation_config, inference_ami_version) shipped in the
      # 5.3x-6.5x range — all covered by this pin.
