...
// 	protoc        (unknown)
// source: catalog/aws/awslaunchtemplate/v1alpha1/spec.proto
...
func (x *AwsLaunchTemplateSpec) Reset() {
	*x = AwsLaunchTemplateSpec{}
	mi := &file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsLaunchTemplateSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\rinstance_type\x18\x04 \x01(\tR\finstanceType\x12\x86\x01\n" +
	"\x15instance_requirements\x18\x05 \x01(\v2Q.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateInstanceRequirementsR\x14instanceRequirements\x12\x19\n" +
	...
	"\rebs_optimized\x18\n" +
	" \x01(\bR\febsOptimized\x12\x83\x01\n" +
	"\x15block_device_mappings\x18\v \x03(\v2O.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateBlockDeviceMappingR\x13blockDeviceMappings\x12|\n" +
	"\x12network_interfaces\x18\f \x03(\v2M.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateNetworkInterfaceR\x11networkInterfaces\x12w\n" +
	"\x10metadata_options\x18\r \x01(\v2L.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateMetadataOptionsR\x0fmetadataOptions\x12/\n" +
	"\x13detailed_monitoring\x18\x0e \x01(\bR\x12detailedMonitoring\x12d\n" +
	"\tplacement\x18\x0f \x01(\v2F.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplatePlacementR\tplacement\x12h\n" +
	"\vcpu_options\x18\x10 \x01(\v2G.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateCpuOptionsR\n" +
	"cpuOptions\x12\x1f\n" +
	"\vcpu_credits\x18\x11 \x01(\tR\n" +
	"cpuCredits\x12k\n" +
	"\fspot_options\x18\x12 \x01(\v2H.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateSpotOptionsR\vspotOptions\x12'\n" +
	"\x0fenclave_enabled\x18\x13 \x01(\bR\x0eenclaveEnabled\x12/\n" +
	"\x13hibernation_enabled\x18\x14 \x01(\bR\x12hibernationEnabled\x12#\n" +
	"\rauto_recovery\x18\x15 \x01(\tR\fautoRecovery\x12\x8b\x01\n" +
	...
	"\n" +
	"vcpu_count\x18\x02 \x01(\v2E.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateIntRangeB\x06\xbaH\x03\xc8\x01\x01R\tvcpuCount\x12?\n" +
	...
	"\x13local_storage_types\x18\x0e \x03(\tR\x11localStorageTypes\x12}\n" +
	"\x16total_local_storage_gb\x18\x0f \x01(\v2H.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateDoubleRangeR\x13totalLocalStorageGb\x12w\n" +
	"\x13memory_gib_per_vcpu\x18\x10 \x01(\v2H.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateDoubleRangeR\x10memoryGibPerVcpu\x12}\n" +
	"\x17network_interface_count\x18\x11 \x01(\v2E.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateIntRangeR\x15networkInterfaceCount\x12~\n" +
	"\x16network_bandwidth_gbps\x18\x12 \x01(\v2H.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateDoubleRangeR\x14networkBandwidthGbps\x12\x84\x01\n" +
	"\x1bbaseline_ebs_bandwidth_mbps\x18\x13 \x01(\v2E.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateIntRangeR\x18baselineEbsBandwidthMbps\x12r\n" +
	"\x11accelerator_count\x18\x14 \x01(\v2E.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateIntRangeR\x10acceleratorCount\x12;\n" +
	...
	"\x11accelerator_types\x18\x17 \x03(\tR\x10acceleratorTypes\x12\x86\x01\n" +
	"\x1caccelerator_total_memory_mib\x18\x18 \x01(\v2E.dev.planton.aws.awslaunchtemplate.v1alpha1.AwsLaunchTemplateIntRangeR\x19acceleratorTotalMemoryMib:\x97\b\xbaH\x93\b\x1a\xba\x01\n" +
	...
	"\x14double_range_ordered\x12:max must be greater than or equal to min when both are set\x1a:this.min == 0.0 || this.max == 0.0 || this.max >= this.min\"\xf0\x03\n" +
	...
	"\x13hostname_type_valid\x12;hostname_type must be 'ip-name' or 'resource-name' when set\x1aNthis.hostname_type == '' || this.hostname_type in ['ip-name', 'resource-name']B\xe7\x02\n" +
	".com.dev.planton.aws.awslaunchtemplate.v1alpha1B\tSpecProtoP\x01Z]github.com/plantonhq/planton/catalog/aws/awslaunchtemplate/v1alpha1;awslaunchtemplatev1alpha1\xa2\x02\x04DPAA\xaa\x02*Dev.Planton.Aws.Awslaunchtemplate.V1alpha1\xca\x02*Dev\\Planton\\Aws\\Awslaunchtemplate\\V1alpha1\xe2\x026Dev\\Planton\\Aws\\Awslaunchtemplate\\V1alpha1\\GPBMetadata\xea\x02.Dev::Planton::Aws::Awslaunchtemplate::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto = out.File
	file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awslaunchtemplate_v1alpha1_spec_proto_depIdxs = nil
}
