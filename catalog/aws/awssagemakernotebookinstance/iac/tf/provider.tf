terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: both notebook resources are long-stable; the newest
      # arm rendered here (instance_metadata_service_configuration) shipped
      # in the 4.x line — well below this pin. accelerator_types was REMOVED
      # in 6.0 (EI retirement) and is deliberately not modeled.
