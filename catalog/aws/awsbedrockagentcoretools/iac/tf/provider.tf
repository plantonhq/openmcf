terraform {
  ...
  required_providers {
    aws = {
      ...
      # line and still expanding at 6.58.0 (the browser's enterprise_policy
      # and certificate surfaces are late-6.5x additions), so an older floor
      # would reject arguments this module renders.
