terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_bedrock_provisioned_model_throughput's whole
      # argument surface predates 6.x; v6.15.0 fixes state upgrades from
      # pre-6.0 versions, well under the catalog pin.
