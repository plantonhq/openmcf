...
func routeArgs(route *awssubnetv1alpha1.AwsSubnetSpec_AwsSubnetRoute) ec2.RouteTableRouteArgs {
	...
	case awssubnetv1alpha1.AwsSubnetSpec_AwsSubnetRoute_internet_gateway:
		args.GatewayId = pulumi.StringPtr(targetID)
	case awssubnetv1alpha1.AwsSubnetSpec_AwsSubnetRoute_nat_gateway:
		args.NatGatewayId = pulumi.StringPtr(targetID)
	case awssubnetv1alpha1.AwsSubnetSpec_AwsSubnetRoute_transit_gateway:
		args.TransitGatewayId = pulumi.StringPtr(targetID)
	case awssubnetv1alpha1.AwsSubnetSpec_AwsSubnetRoute_vpc_peering_connection:
		args.VpcPeeringConnectionId = pulumi.StringPtr(targetID)
	case awssubnetv1alpha1.AwsSubnetSpec_AwsSubnetRoute_vpc_endpoint:
		args.VpcEndpointId = pulumi.StringPtr(targetID)
	case awssubnetv1alpha1.AwsSubnetSpec_AwsSubnetRoute_network_interface:
