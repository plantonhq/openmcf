terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_sagemaker_image is long-stable; the version's
      # metadata arms (aliases, job_type, ml_framework, processor,
      # vendor_guidance) shipped in the 5.4x line — covered by this pin.
