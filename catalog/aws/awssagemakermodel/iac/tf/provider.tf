terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_sagemaker_model is a long-stable resource; its
      # newest arms rendered here (model_data_source with model_access_config,
      # additional_model_data_source) shipped in the 5.x line — all well below
      # this pin.
