...
// 	protoc        (unknown)
// source: catalog/aws/awsserverlesselasticache/v1alpha1/spec.proto
...
func (x *AwsServerlessElasticacheSpec) Reset() {
	*x = AwsServerlessElasticacheSpec{}
	mi := &file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsServerlessElasticacheSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"8catalog/aws/awsserverlesselasticache/v1alpha1/spec.proto\x121dev.planton.aws.awsserverlesselasticache.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\xc2\x17\n" +
	...
	"\x0eecpu_max_floor\x12'ecpu_max must be at least 1000 when set\x1a+this.ecpu_max == 0 || this.ecpu_max >= 1000B\x98\x03\n" +
	"5com.dev.planton.aws.awsserverlesselasticache.v1alpha1B\tSpecProtoP\x01Zkgithub.com/plantonhq/planton/catalog/aws/awsserverlesselasticache/v1alpha1;awsserverlesselasticachev1alpha1\xa2\x02\x04DPAA\xaa\x021Dev.Planton.Aws.Awsserverlesselasticache.V1alpha1\xca\x021Dev\\Planton\\Aws\\Awsserverlesselasticache\\V1alpha1\xe2\x02=Dev\\Planton\\Aws\\Awsserverlesselasticache\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Aws::Awsserverlesselasticache::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_goTypes = []any{
	(*AwsServerlessElasticacheSpec)(nil), // 0: dev.planton.aws.awsserverlesselasticache.v1alpha1.AwsServerlessElasticacheSpec
	(*v1.StringValueOrRef)(nil),          // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.aws.awsserverlesselasticache.v1alpha1.AwsServerlessElasticacheSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.aws.awsserverlesselasticache.v1alpha1.AwsServerlessElasticacheSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.aws.awsserverlesselasticache.v1alpha1.AwsServerlessElasticacheSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 3: dev.planton.aws.awsserverlesselasticache.v1alpha1.AwsServerlessElasticacheSpec.user_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsserverlesselasticache_v1alpha1_spec_proto_depIdxs = nil
}
