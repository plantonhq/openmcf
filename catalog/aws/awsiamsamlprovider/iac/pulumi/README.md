# AwsIamSamlProvider — Pulumi module (Go)

Manages one IAM SAML identity provider (`iam.SamlProvider`).
...
Outputs mirror the Terraform module key-for-key: `provider_arn`,
