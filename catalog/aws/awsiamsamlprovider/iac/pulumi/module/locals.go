...
func initializeLocals(_ *pulumi.Context, in *awsiamsamlproviderv1alpha1.AwsIamSamlProviderStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsIamSamlProvider.String(),
