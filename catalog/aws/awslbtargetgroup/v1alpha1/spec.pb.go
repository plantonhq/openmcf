...
// 	protoc        (unknown)
// source: catalog/aws/awslbtargetgroup/v1alpha1/spec.proto
...
func (x *AwsLbTargetGroupSpec) Reset() {
	*x = AwsLbTargetGroupSpec{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsLbTargetGroupSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsLbTargetGroupHealthCheck) Reset() {
	*x = AwsLbTargetGroupHealthCheck{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLbTargetGroupHealthCheck) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsLbTargetGroupStickiness) Reset() {
	*x = AwsLbTargetGroupStickiness{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLbTargetGroupStickiness) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsLbTargetGroupHealthPolicy) Reset() {
	*x = AwsLbTargetGroupHealthPolicy{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLbTargetGroupHealthPolicy) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsLbTargetGroupDnsFailover) Reset() {
	*x = AwsLbTargetGroupDnsFailover{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLbTargetGroupDnsFailover) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsLbTargetGroupUnhealthyStateRouting) Reset() {
	*x = AwsLbTargetGroupUnhealthyStateRouting{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLbTargetGroupUnhealthyStateRouting) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsLbTargetGroupTargetHealthState) Reset() {
	*x = AwsLbTargetGroupTargetHealthState{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLbTargetGroupTargetHealthState) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsLbTargetGroupTarget) Reset() {
	*x = AwsLbTargetGroupTarget{}
	mi := &file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsLbTargetGroupTarget) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
const file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x0fip_address_type\x18\a \x01(\tR\ripAddressType\x12i\n" +
	"\fhealth_check\x18\b \x01(\v2F.dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupHealthCheckR\vhealthCheck\x12e\n" +
	"\n" +
	"stickiness\x18\t \x01(\v2E.dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupStickinessR\n" +
	"stickiness\x12I\n" +
	...
	"\n" +
	"\b_enabled\"\x94\x02\n" +
	"\x1cAwsLbTargetGroupHealthPolicy\x12i\n" +
	"\fdns_failover\x18\x01 \x01(\v2F.dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupDnsFailoverR\vdnsFailover\x12\x88\x01\n" +
	"\x17unhealthy_state_routing\x18\x02 \x01(\v2P.dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupUnhealthyStateRoutingR\x15unhealthyStateRouting\"\xad\x01\n" +
...
var (
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_goTypes = []any{
	(*AwsLbTargetGroupSpec)(nil),                  // 0: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupSpec
	(*AwsLbTargetGroupHealthCheck)(nil),           // 1: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupHealthCheck
	(*AwsLbTargetGroupStickiness)(nil),            // 2: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupStickiness
	(*AwsLbTargetGroupHealthPolicy)(nil),          // 3: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupHealthPolicy
	(*AwsLbTargetGroupDnsFailover)(nil),           // 4: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupDnsFailover
	(*AwsLbTargetGroupUnhealthyStateRouting)(nil), // 5: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupUnhealthyStateRouting
	(*AwsLbTargetGroupTargetHealthState)(nil),     // 6: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupTargetHealthState
	(*AwsLbTargetGroupTarget)(nil),                // 7: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupTarget
	(*v1.StringValueOrRef)(nil),                   // 8: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_depIdxs = []int32{
	8, // 0: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupSpec.health_check:type_name -> dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupHealthCheck
	2, // 2: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupSpec.stickiness:type_name -> dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupStickiness
	3, // 3: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupSpec.target_group_health:type_name -> dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupHealthPolicy
	6, // 4: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupSpec.target_health_state:type_name -> dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupTargetHealthState
	7, // 5: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupSpec.targets:type_name -> dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupTarget
	4, // 6: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupHealthPolicy.dns_failover:type_name -> dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupDnsFailover
	5, // 7: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupHealthPolicy.unhealthy_state_routing:type_name -> dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupUnhealthyStateRouting
	8, // 8: dev.planton.aws.awslbtargetgroup.v1alpha1.AwsLbTargetGroupTarget.target_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_init() }
func file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto = out.File
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awslbtargetgroup_v1alpha1_spec_proto_depIdxs = nil
}
