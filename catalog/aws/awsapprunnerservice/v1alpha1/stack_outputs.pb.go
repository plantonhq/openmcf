...
// 	protoc        (unknown)
// source: catalog/aws/awsapprunnerservice/v1alpha1/stack_outputs.proto
...
func (x *AwsAppRunnerServiceStackOutputs) Reset() {
	*x = AwsAppRunnerServiceStackOutputs{}
	mi := &file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*AwsAppRunnerServiceStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsAppRunnerServiceCustomDomainOutput) Reset() {
	*x = AwsAppRunnerServiceCustomDomainOutput{}
	mi := &file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceCustomDomainOutput) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsAppRunnerServiceCertificateValidationRecord) Reset() {
	*x = AwsAppRunnerServiceCertificateValidationRecord{}
	mi := &file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAppRunnerServiceCertificateValidationRecord) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"<catalog/aws/awsapprunnerservice/v1alpha1/stack_outputs.proto\x12,dev.planton.aws.awsapprunnerservice.v1alpha1\"\xc8\x02\n" +
	...
	"\x06status\x18\x03 \x01(\tR\x06status\x12\xa2\x01\n" +
	"\x1ecertificate_validation_records\x18\x04 \x03(\v2\\.dev.planton.aws.awsapprunnerservice.v1alpha1.AwsAppRunnerServiceCertificateValidationRecordR\x1ccertificateValidationRecords\"\x95\x01\n" +
	".AwsAppRunnerServiceCertificateValidationRecord\x12\x1f\n" +
	"\vrecord_name\x18\x01 \x01(\tR\n" +
	"recordName\x12\x1f\n" +
	"\vrecord_type\x18\x02 \x01(\tR\n" +
	"recordType\x12!\n" +
	"\frecord_value\x18\x03 \x01(\tR\vrecordValueB\xfd\x02\n" +
	"0com.dev.planton.aws.awsapprunnerservice.v1alpha1B\x11StackOutputsProtoP\x01Zagithub.com/plantonhq/planton/catalog/aws/awsapprunnerservice/v1alpha1;awsapprunnerservicev1alpha1\xa2\x02\x04DPAA\xaa\x02,Dev.Planton.Aws.Awsapprunnerservice.V1alpha1\xca\x02,Dev\\Planton\\Aws\\Awsapprunnerservice\\V1alpha1\xe2\x028Dev\\Planton\\Aws\\Awsapprunnerservice\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Aws::Awsapprunnerservice::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_goTypes = []any{
...
var file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_init() }
func file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto = out.File
	file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_aws_awsapprunnerservice_v1alpha1_stack_outputs_proto_depIdxs = nil
}
