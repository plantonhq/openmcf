...
func initializeLocals(_ *pulumi.Context, in *awseventbridgeschedulerv1alpha1.AwsEventBridgeSchedulerStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsEventBridgeScheduler.String(),
