...
func initializeLocals(_ *pulumi.Context, in *awss3vectorbucketv1alpha1.AwsS3VectorBucketStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsS3VectorBucket.String(),
