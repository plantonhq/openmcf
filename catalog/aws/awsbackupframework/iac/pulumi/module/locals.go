...
func initializeLocals(_ *pulumi.Context, in *awsbackupframeworkv1alpha1.AwsBackupFrameworkStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsBackupFramework.String(),
