...
func buildLoggingConfiguration(config *awsmwaaenvironmentv1alpha1.AwsMwaaEnvironmentLoggingConfiguration) mwaa.EnvironmentLoggingConfigurationPtrInput {
	if config == nil {
		return nil
	}
...
func buildLoggingModuleConfig(config *awsmwaaenvironmentv1alpha1.AwsMwaaEnvironmentLoggingModuleConfig) mwaa.EnvironmentLoggingConfigurationDagProcessingLogsPtrInput {
...
func buildSchedulerLoggingModuleConfig(config *awsmwaaenvironmentv1alpha1.AwsMwaaEnvironmentLoggingModuleConfig) mwaa.EnvironmentLoggingConfigurationSchedulerLogsPtrInput {
...
func buildTaskLoggingModuleConfig(config *awsmwaaenvironmentv1alpha1.AwsMwaaEnvironmentLoggingModuleConfig) mwaa.EnvironmentLoggingConfigurationTaskLogsPtrInput {
...
func buildWebserverLoggingModuleConfig(config *awsmwaaenvironmentv1alpha1.AwsMwaaEnvironmentLoggingModuleConfig) mwaa.EnvironmentLoggingConfigurationWebserverLogsPtrInput {
...
func buildWorkerLoggingModuleConfig(config *awsmwaaenvironmentv1alpha1.AwsMwaaEnvironmentLoggingModuleConfig) mwaa.EnvironmentLoggingConfigurationWorkerLogsPtrInput {
