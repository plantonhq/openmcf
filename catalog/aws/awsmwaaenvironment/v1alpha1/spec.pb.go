...
// 	protoc        (unknown)
// source: catalog/aws/awsmwaaenvironment/v1alpha1/spec.proto
...
func (x *AwsMwaaEnvironmentSpec) Reset() {
	*x = AwsMwaaEnvironmentSpec{}
	mi := &file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsMwaaEnvironmentSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsMwaaEnvironmentLoggingConfiguration) Reset() {
	*x = AwsMwaaEnvironmentLoggingConfiguration{}
	mi := &file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMwaaEnvironmentLoggingConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsMwaaEnvironmentLoggingModuleConfig) Reset() {
	*x = AwsMwaaEnvironmentLoggingModuleConfig{}
	mi := &file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMwaaEnvironmentLoggingModuleConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x1dairflow_configuration_options\x18\x03 \x03(\v2d.dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntryR\x1bairflowConfigurationOptions\x12\x88\x01\n" +
	...
	"\x16_webserver_access_mode\"\x89\x05\n" +
	"&AwsMwaaEnvironmentLoggingConfiguration\x12\x82\x01\n" +
	"\x13dag_processing_logs\x18\x01 \x01(\v2R.dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\x11dagProcessingLogs\x12y\n" +
	"\x0escheduler_logs\x18\x02 \x01(\v2R.dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\rschedulerLogs\x12o\n" +
	"\ttask_logs\x18\x03 \x01(\v2R.dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\btaskLogs\x12y\n" +
	"\x0ewebserver_logs\x18\x04 \x01(\v2R.dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\rwebserverLogs\x12s\n" +
	"\vworker_logs\x18\x05 \x01(\v2R.dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfigR\n" +
	"workerLogs\"\x8f\x01\n" +
	"%AwsMwaaEnvironmentLoggingModuleConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12L\n" +
	"\tlog_level\x18\x02 \x01(\tB/\xbaH,\xd8\x01\x01r'R\bCRITICALR\x05ERRORR\aWARNINGR\x04INFOR\x05DEBUGR\blogLevelB\xee\x02\n" +
	"/com.dev.planton.aws.awsmwaaenvironment.v1alpha1B\tSpecProtoP\x01Z_github.com/plantonhq/planton/catalog/aws/awsmwaaenvironment/v1alpha1;awsmwaaenvironmentv1alpha1\xa2\x02\x04DPAA\xaa\x02+Dev.Planton.Aws.Awsmwaaenvironment.V1alpha1\xca\x02+Dev\\Planton\\Aws\\Awsmwaaenvironment\\V1alpha1\xe2\x027Dev\\Planton\\Aws\\Awsmwaaenvironment\\V1alpha1\\GPBMetadata\xea\x02/Dev::Planton::Aws::Awsmwaaenvironment::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_goTypes = []any{
	(*AwsMwaaEnvironmentSpec)(nil),                 // 0: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec
	(*AwsMwaaEnvironmentLoggingConfiguration)(nil), // 1: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration
	(*AwsMwaaEnvironmentLoggingModuleConfig)(nil),  // 2: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	nil,                         // 3: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntry
	(*v1.StringValueOrRef)(nil), // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_depIdxs = []int32{
	3,  // 0: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.airflow_configuration_options:type_name -> dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.AirflowConfigurationOptionsEntry
	4,  // 1: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.source_bucket_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 2: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.execution_role_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 3: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 4: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 5: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 6: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentSpec.logging_configuration:type_name -> dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration
	2,  // 7: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.dag_processing_logs:type_name -> dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 8: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.scheduler_logs:type_name -> dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 9: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.task_logs:type_name -> dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 10: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.webserver_logs:type_name -> dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
	2,  // 11: dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingConfiguration.worker_logs:type_name -> dev.planton.aws.awsmwaaenvironment.v1alpha1.AwsMwaaEnvironmentLoggingModuleConfig
...
func init() { file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsmwaaenvironment_v1alpha1_spec_proto_depIdxs = nil
}
