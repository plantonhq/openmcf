terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the vended delivery family (delivery, source,
      # destination + policy) is v5.6x-era Plugin Framework surface with
      # the XRAY destination type arriving in 6.x; the catalog pin covers
      # all of it.
