...
// 	protoc        (unknown)
// source: catalog/aws/awsrdsinstance/v1alpha1/spec.proto
...
func (x *AwsRdsInstanceSpec) Reset() {
	*x = AwsRdsInstanceSpec{}
	mi := &file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRdsInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRdsInstanceActiveDirectory) Reset() {
	*x = AwsRdsInstanceActiveDirectory{}
	mi := &file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsInstanceActiveDirectory) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRdsInstanceRestoreToPointInTime) Reset() {
	*x = AwsRdsInstanceRestoreToPointInTime{}
	mi := &file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsInstanceRestoreToPointInTime) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
const file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x13snapshot_identifier\x18\x1c \x01(\tR\x12snapshotIdentifier\x12\x83\x01\n" +
	"\x18restore_to_point_in_time\x18\x1d \x01(\v2K.dev.planton.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceRestoreToPointInTimeR\x14restoreToPointInTime\x12A\n" +
	...
	"\x11option_group_name\x18/ \x01(\tR\x0foptionGroupName\x12q\n" +
	"\x10active_directory\x180 \x01(\v2F.dev.planton.aws.awsrdsinstance.v1alpha1.AwsRdsInstanceActiveDirectoryR\x0factiveDirectory\x12#\n" +
...
var (
	file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsrdsinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsrdsinstance_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsrdsinstance_v1alpha1_spec_proto_depIdxs = nil
}
