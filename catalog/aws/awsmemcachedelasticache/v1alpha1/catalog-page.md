...
- [AwsVpc](/docs/catalog/aws/awsvpc) — provides the subnets for cluster node placement
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — controls network-level access to the Memcached endpoint
- [AwsSnsTopic](/docs/catalog/aws/awssnstopic) — receives cluster event notifications
- [AwsRedisElasticache](/docs/catalog/aws/awsrediselasticache) — alternative cache engine with replication, persistence, and authentication
