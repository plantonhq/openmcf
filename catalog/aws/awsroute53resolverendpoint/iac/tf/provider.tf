terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the endpoint's protocols / resolver_endpoint_type and
      # the rni_enhanced_metrics_enabled pair are the newest arguments
      # consumed - all accepted at the pin (verified by the offline plan).
