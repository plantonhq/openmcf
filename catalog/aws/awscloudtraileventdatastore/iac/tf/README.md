# AwsCloudTrailEventDataStore — Terraform/OpenTofu module
...
- **Selector rendering matches the trail kind's idiom** (empty
  operator lists become nulls so both engines send identical
  payloads).

Outputs mirror the Pulumi module key-for-key: `event_data_store_arn`.
