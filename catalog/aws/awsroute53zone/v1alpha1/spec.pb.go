...
// 	protoc        (unknown)
// source: catalog/aws/awsroute53zone/v1alpha1/spec.proto
...
func (x *AwsRoute53ZoneSpec) Reset() {
	*x = AwsRoute53ZoneSpec{}
	mi := &file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsRoute53ZoneSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRoute53ZoneVpcAssociation) Reset() {
	*x = AwsRoute53ZoneVpcAssociation{}
	mi := &file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53ZoneVpcAssociation) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRoute53ZoneQueryLogging) Reset() {
	*x = AwsRoute53ZoneQueryLogging{}
	mi := &file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53ZoneQueryLogging) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsRoute53ZoneDnssec) Reset() {
	*x = AwsRoute53ZoneDnssec{}
	mi := &file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53ZoneDnssec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var (
	file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_goTypes = []any{
	(*AwsRoute53ZoneSpec)(nil),           // 0: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneSpec
	(*AwsRoute53ZoneVpcAssociation)(nil), // 1: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneVpcAssociation
	(*AwsRoute53ZoneQueryLogging)(nil),   // 2: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneQueryLogging
	(*AwsRoute53ZoneDnssec)(nil),         // 3: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneDnssec
	(*v1.StringValueOrRef)(nil),          // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneSpec.vpc_associations:type_name -> dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneVpcAssociation
	2, // 1: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneSpec.query_logging:type_name -> dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneQueryLogging
	3, // 2: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneSpec.dnssec:type_name -> dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneDnssec
	4, // 3: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneVpcAssociation.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 4: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneQueryLogging.cloudwatch_log_group_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 5: dev.planton.aws.awsroute53zone.v1alpha1.AwsRoute53ZoneDnssec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsroute53zone_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsroute53zone_v1alpha1_spec_proto_depIdxs = nil
}
