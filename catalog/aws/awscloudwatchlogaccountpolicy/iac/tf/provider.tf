terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_cloudwatch_log_account_policy's
      # METRIC_EXTRACTION_POLICY type is the newest surface here (6.50-era);
      # the catalog pin comfortably covers it.
