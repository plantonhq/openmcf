...
func initializeLocals(_ *pulumi.Context, in *awssagemakermlflowserverv1alpha1.AwsSagemakerMlflowServerStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsSagemakerMlflowServer.String(),
