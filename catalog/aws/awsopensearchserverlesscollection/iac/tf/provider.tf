terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: collection_group_name and vector_options on
      # aws_opensearchserverless_collection land in v6.58.0 -- an older
      # floor would silently reject the collection-group and
      # vector-acceleration surface. (The collection and policy resources
      # themselves predate 6.x.)
