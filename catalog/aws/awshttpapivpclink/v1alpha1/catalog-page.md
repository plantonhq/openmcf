...
- [AwsHttpApiGateway](/docs/catalog/aws/awshttpapigateway) — HTTP APIs whose private integrations route through this link
- [AwsSubnet](/docs/catalog/aws/awssubnet) — Subnets hosting the link's network interfaces
- [AwsSecurityGroup](/docs/catalog/aws/awssecuritygroup) — Security groups governing the link's reach
- [AwsAlb](/docs/catalog/aws/awsalb) — Internal ALBs targeted by private integrations
- [AwsNlb](/docs/catalog/aws/awsnlb) — Internal NLBs targeted by private integrations
