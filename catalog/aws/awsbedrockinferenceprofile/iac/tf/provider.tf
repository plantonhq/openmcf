terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_bedrock_inference_profile predates 6.x; the fix
      # that stops model_source forcing replacement after import ships in
      # v6.29.0, well under the catalog pin.
