...
// 	protoc        (unknown)
// source: catalog/aws/awsfsxontapstoragevirtualmachine/v1alpha1/spec.proto
...
func (x *AwsFsxOntapStorageVirtualMachineSpec) Reset() {
	*x = AwsFsxOntapStorageVirtualMachineSpec{}
	mi := &file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsFsxOntapStorageVirtualMachineSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration) Reset() {
	*x = AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration{}
	mi := &file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"@catalog/aws/awsfsxontapstoragevirtualmachine/v1alpha1/spec.proto\x129dev.planton.aws.awsfsxontapstoragevirtualmachine.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\x8b\t\n" +
	...
	"!_file_system_administrators_groupB\xd0\x03\n" +
	"=com.dev.planton.aws.awsfsxontapstoragevirtualmachine.v1alpha1B\tSpecProtoP\x01Z{github.com/plantonhq/planton/catalog/aws/awsfsxontapstoragevirtualmachine/v1alpha1;awsfsxontapstoragevirtualmachinev1alpha1\xa2\x02\x04DPAA\xaa\x029Dev.Planton.Aws.Awsfsxontapstoragevirtualmachine.V1alpha1\xca\x029Dev\\Planton\\Aws\\Awsfsxontapstoragevirtualmachine\\V1alpha1\xe2\x02EDev\\Planton\\Aws\\Awsfsxontapstoragevirtualmachine\\V1alpha1\\GPBMetadata\xea\x02=Dev::Planton::Aws::Awsfsxontapstoragevirtualmachine::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_goTypes = []any{
	(*AwsFsxOntapStorageVirtualMachineSpec)(nil),                         // 0: dev.planton.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineSpec
	(*AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration)(nil), // 1: dev.planton.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration
	(*v1.StringValueOrRef)(nil),                                          // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineSpec.file_system_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineSpec.active_directory_configuration:type_name -> dev.planton.aws.awsfsxontapstoragevirtualmachine.v1alpha1.AwsFsxOntapStorageVirtualMachineActiveDirectoryConfiguration
...
func init() { file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsfsxontapstoragevirtualmachine_v1alpha1_spec_proto_depIdxs = nil
}
