...
func initializeLocals(_ *pulumi.Context, in *awsbedrockflowv1alpha1.AwsBedrockFlowStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsBedrockFlow.String(),
