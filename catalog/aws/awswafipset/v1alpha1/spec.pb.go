...
// 	protoc        (unknown)
// source: catalog/aws/awswafipset/v1alpha1/spec.proto
...
func (x *AwsWafIpSetSpec) Reset() {
	*x = AwsWafIpSetSpec{}
	mi := &file_catalog_aws_awswafipset_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsWafIpSetSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_aws_awswafipset_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"+catalog/aws/awswafipset/v1alpha1/spec.proto\x12$dev.planton.aws.awswafipset.v1alpha1\x1a\x1bbuf/validate/validate.proto\"\x8f\a\n" +
	...
	"#cloudfront_scope_requires_us_east_1\x12~CloudFront-scoped WAF resources live in the global (us-east-1) region — set region to 'us-east-1' when scope is 'CLOUDFRONT'\x1a8this.scope != 'CLOUDFRONT' || this.region == 'us-east-1'B\xbd\x02\n" +
	"(com.dev.planton.aws.awswafipset.v1alpha1B\tSpecProtoP\x01ZQgithub.com/plantonhq/planton/catalog/aws/awswafipset/v1alpha1;awswafipsetv1alpha1\xa2\x02\x04DPAA\xaa\x02$Dev.Planton.Aws.Awswafipset.V1alpha1\xca\x02$Dev\\Planton\\Aws\\Awswafipset\\V1alpha1\xe2\x020Dev\\Planton\\Aws\\Awswafipset\\V1alpha1\\GPBMetadata\xea\x02(Dev::Planton::Aws::Awswafipset::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awswafipset_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_aws_awswafipset_v1alpha1_spec_proto_goTypes = []any{
	(*AwsWafIpSetSpec)(nil), // 0: dev.planton.aws.awswafipset.v1alpha1.AwsWafIpSetSpec
}
var file_catalog_aws_awswafipset_v1alpha1_spec_proto_depIdxs = []int32{
...
func init() { file_catalog_aws_awswafipset_v1alpha1_spec_proto_init() }
func file_catalog_aws_awswafipset_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awswafipset_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awswafipset_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awswafipset_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awswafipset_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awswafipset_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awswafipset_v1alpha1_spec_proto = out.File
	file_catalog_aws_awswafipset_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awswafipset_v1alpha1_spec_proto_depIdxs = nil
}
