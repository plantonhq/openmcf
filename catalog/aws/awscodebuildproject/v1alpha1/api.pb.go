...
const file_catalog_aws_awscodebuildproject_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"2catalog/aws/awscodebuildproject/v1alpha1/api.proto\x12,dev.planton.aws.awscodebuildproject.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a6catalog/aws/awscodebuildproject/v1alpha1/outputs.proto\x1a3catalog/aws/awscodebuildproject/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\x9a\x03\n" +
...
func file_catalog_aws_awscodebuildproject_v1alpha1_api_proto_init() {
	...
	file_catalog_aws_awscodebuildproject_v1alpha1_outputs_proto_init()
