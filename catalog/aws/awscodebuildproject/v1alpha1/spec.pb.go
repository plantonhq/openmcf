...
// 	protoc        (unknown)
// source: catalog/aws/awscodebuildproject/v1alpha1/spec.proto
...
func (x *AwsCodeBuildProjectSpec) Reset() {
	*x = AwsCodeBuildProjectSpec{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsCodeBuildProjectSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsCodeBuildSource) Reset() {
	*x = AwsCodeBuildSource{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildSource) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCodeBuildGitSubmodulesConfig) Reset() {
	*x = AwsCodeBuildGitSubmodulesConfig{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildGitSubmodulesConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsCodeBuildBuildStatusConfig) Reset() {
	*x = AwsCodeBuildBuildStatusConfig{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildBuildStatusConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsCodeBuildSourceAuth) Reset() {
	*x = AwsCodeBuildSourceAuth{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildSourceAuth) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsCodeBuildSecondarySourceVersion) Reset() {
	*x = AwsCodeBuildSecondarySourceVersion{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildSecondarySourceVersion) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsCodeBuildEnvironment) Reset() {
	*x = AwsCodeBuildEnvironment{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildEnvironment) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsCodeBuildDockerServer) Reset() {
	*x = AwsCodeBuildDockerServer{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildDockerServer) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsCodeBuildEnvironmentVariable) Reset() {
	*x = AwsCodeBuildEnvironmentVariable{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildEnvironmentVariable) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *AwsCodeBuildRegistryCredential) Reset() {
	*x = AwsCodeBuildRegistryCredential{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildRegistryCredential) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *AwsCodeBuildArtifacts) Reset() {
	*x = AwsCodeBuildArtifacts{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildArtifacts) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *AwsCodeBuildCache) Reset() {
	*x = AwsCodeBuildCache{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildCache) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *AwsCodeBuildLogsConfig) Reset() {
	*x = AwsCodeBuildLogsConfig{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildLogsConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *AwsCodeBuildCloudWatchLogs) Reset() {
	*x = AwsCodeBuildCloudWatchLogs{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildCloudWatchLogs) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *AwsCodeBuildS3Logs) Reset() {
	*x = AwsCodeBuildS3Logs{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildS3Logs) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
func (x *AwsCodeBuildVpcConfig) Reset() {
	*x = AwsCodeBuildVpcConfig{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildVpcConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *AwsCodeBuildFileSystemLocation) Reset() {
	*x = AwsCodeBuildFileSystemLocation{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildFileSystemLocation) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{16}
}
...
func (x *AwsCodeBuildBatchConfig) Reset() {
	*x = AwsCodeBuildBatchConfig{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildBatchConfig) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{17}
}
...
func (x *AwsCodeBuildBatchRestrictions) Reset() {
	*x = AwsCodeBuildBatchRestrictions{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildBatchRestrictions) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{18}
}
...
func (x *AwsCodeBuildWebhook) Reset() {
	*x = AwsCodeBuildWebhook{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildWebhook) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{19}
}
...
func (x *AwsCodeBuildWebhookFilterGroup) Reset() {
	*x = AwsCodeBuildWebhookFilterGroup{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildWebhookFilterGroup) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{20}
}
...
func (x *AwsCodeBuildWebhookFilter) Reset() {
	*x = AwsCodeBuildWebhookFilter{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildWebhookFilter) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{21}
}
...
func (x *AwsCodeBuildWebhookScopeConfiguration) Reset() {
	*x = AwsCodeBuildWebhookScopeConfiguration{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildWebhookScopeConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{22}
}
...
func (x *AwsCodeBuildWebhookPullRequestBuildPolicy) Reset() {
	*x = AwsCodeBuildWebhookPullRequestBuildPolicy{}
	mi := &file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCodeBuildWebhookPullRequestBuildPolicy) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP(), []int{23}
}
...
var File_catalog_aws_awscodebuildproject_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"3catalog/aws/awscodebuildproject/v1alpha1/spec.proto\x12,dev.planton.aws.awscodebuildproject.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xf71\n" +
	"\x17AwsCodeBuildProjectSpec\x12\x1f\n" +
	"\x06region\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06region\x12`\n" +
	"\x06source\x18\x02 \x01(\v2@.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSourceB\x06\xbaH\x03\xc8\x01\x01R\x06source\x12w\n" +
	"\x11secondary_sources\x18\x03 \x03(\v2@.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSourceB\b\xbaH\x05\x92\x01\x02\x10\fR\x10secondarySources\x12\x96\x01\n" +
	"\x19secondary_source_versions\x18\x04 \x03(\v2P.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSecondarySourceVersionB\b\xbaH\x05\x92\x01\x02\x10\fR\x17secondarySourceVersions\x12o\n" +
	"\venvironment\x18\x05 \x01(\v2E.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironmentB\x06\xbaH\x03\xc8\x01\x01R\venvironment\x12i\n" +
	"\tartifacts\x18\x06 \x01(\v2C.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildArtifactsB\x06\xbaH\x03\xc8\x01\x01R\tartifacts\x12~\n" +
	"\x13secondary_artifacts\x18\a \x03(\v2C.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildArtifactsB\b\xbaH\x05\x92\x01\x02\x10\fR\x12secondaryArtifacts\x12}\n" +
	...
	"\x0esource_version\x18\x10 \x01(\tR\rsourceVersion\x12U\n" +
	"\x05cache\x18\x11 \x01(\v2?.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildCacheR\x05cache\x12e\n" +
	"\vlogs_config\x18\x12 \x01(\v2D.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildLogsConfigR\n" +
	"logsConfig\x12b\n" +
	"\n" +
	"vpc_config\x18\x13 \x01(\v2C.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildVpcConfigR\tvpcConfig\x12\x80\x01\n" +
	"\x15file_system_locations\x18\x14 \x03(\v2L.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildFileSystemLocationR\x13fileSystemLocations\x12s\n" +
	"\x12build_batch_config\x18\x15 \x01(\v2E.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchConfigR\x10buildBatchConfig\x12Z\n" +
	...
	"\awebhook\x18\x19 \x01(\v2A.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookR\awebhook:\xd2\x1e\xbaH\xce\x1e\x1a\xd3\x01\n" +
	...
	"\x13_project_visibility\"\x83\x06\n" +
	...
	"\x0fgit_clone_depth\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\rgitCloneDepth\x12\x81\x01\n" +
	"\x15git_submodules_config\x18\x05 \x01(\v2M.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildGitSubmodulesConfigR\x13gitSubmodulesConfig\x12!\n" +
	"\finsecure_ssl\x18\x06 \x01(\bR\vinsecureSsl\x12.\n" +
	"\x13report_build_status\x18\a \x01(\bR\x11reportBuildStatus\x12{\n" +
	"\x13build_status_config\x18\b \x01(\v2K.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBuildStatusConfigR\x11buildStatusConfig\x12X\n" +
	"\x04auth\x18\t \x01(\v2D.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSourceAuthR\x04auth\x12I\n" +
	...
	"\x05_type\"\xe6\x01\n" +
	"\x16AwsCodeBuildLogsConfig\x12q\n" +
	"\x0fcloudwatch_logs\x18\x01 \x01(\v2H.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildCloudWatchLogsR\x0ecloudwatchLogs\x12Y\n" +
	"\as3_logs\x18\x02 \x01(\v2@.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildS3LogsR\x06s3Logs\"\x85\x02\n" +
	...
	"\xd8\x01\x01\x1a\x05\x18\xf0\x10(\x05R\rtimeoutInMins\x12o\n" +
	"\frestrictions\x18\x04 \x01(\v2K.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchRestrictionsR\frestrictions\"\xa5\x03\n" +
	...
	"\x16maximum_builds_allowed\x18\x02 \x01(\x05B\f\xbaH\t\xd8\x01\x01\x1a\x04\x18d(\x01R\x14maximumBuildsAllowed\"\xa2\x04\n" +
	...
	"\x0fmanual_creation\x18\x02 \x01(\bR\x0emanualCreation\x12q\n" +
	"\rfilter_groups\x18\x03 \x03(\v2L.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookFilterGroupR\ffilterGroups\x12\x84\x01\n" +
	"\x13scope_configuration\x18\x04 \x01(\v2S.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookScopeConfigurationR\x12scopeConfiguration\x12\x92\x01\n" +
	"\x19pull_request_build_policy\x18\x05 \x01(\v2W.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookPullRequestBuildPolicyR\x16pullRequestBuildPolicy\"\x8d\x01\n" +
	"\x1eAwsCodeBuildWebhookFilterGroup\x12k\n" +
	"\afilters\x18\x01 \x03(\v2G.dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookFilterB\b\xbaH\x05\x92\x01\x02\b\x01R\afilters\"\xaa\x02\n" +
	...
	"\x0eapprover_roles\x18\x02 \x03(\tB\xeb\x01\xbaH\xe7\x01\x92\x01\xe3\x01\"\xe0\x01r\xdd\x01R\vGITHUB_READR\rGITHUB_TRIAGER\fGITHUB_WRITER\x0fGITHUB_MAINTAINR\fGITHUB_ADMINR\fGITLAB_GUESTR\x0eGITLAB_PLANNERR\x0fGITLAB_REPORTERR\x10GITLAB_DEVELOPERR\x11GITLAB_MAINTAINERR\fGITLAB_OWNERR\x0eBITBUCKET_READR\x0fBITBUCKET_WRITER\x0fBITBUCKET_ADMINR\rapproverRolesB\xf5\x02\n" +
	"0com.dev.planton.aws.awscodebuildproject.v1alpha1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/catalog/aws/awscodebuildproject/v1alpha1;awscodebuildprojectv1alpha1\xa2\x02\x04DPAA\xaa\x02,Dev.Planton.Aws.Awscodebuildproject.V1alpha1\xca\x02,Dev\\Planton\\Aws\\Awscodebuildproject\\V1alpha1\xe2\x028Dev\\Planton\\Aws\\Awscodebuildproject\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Aws::Awscodebuildproject::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_goTypes = []any{
	(*AwsCodeBuildProjectSpec)(nil),                   // 0: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec
	(*AwsCodeBuildSource)(nil),                        // 1: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSource
	(*AwsCodeBuildGitSubmodulesConfig)(nil),           // 2: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildGitSubmodulesConfig
	(*AwsCodeBuildBuildStatusConfig)(nil),             // 3: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBuildStatusConfig
	(*AwsCodeBuildSourceAuth)(nil),                    // 4: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSourceAuth
	(*AwsCodeBuildSecondarySourceVersion)(nil),        // 5: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSecondarySourceVersion
	(*AwsCodeBuildEnvironment)(nil),                   // 6: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironment
	(*AwsCodeBuildDockerServer)(nil),                  // 7: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildDockerServer
	(*AwsCodeBuildEnvironmentVariable)(nil),           // 8: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironmentVariable
	(*AwsCodeBuildRegistryCredential)(nil),            // 9: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildRegistryCredential
	(*AwsCodeBuildArtifacts)(nil),                     // 10: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildArtifacts
	(*AwsCodeBuildCache)(nil),                         // 11: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildCache
	(*AwsCodeBuildLogsConfig)(nil),                    // 12: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildLogsConfig
	(*AwsCodeBuildCloudWatchLogs)(nil),                // 13: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildCloudWatchLogs
	(*AwsCodeBuildS3Logs)(nil),                        // 14: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildS3Logs
	(*AwsCodeBuildVpcConfig)(nil),                     // 15: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildVpcConfig
	(*AwsCodeBuildFileSystemLocation)(nil),            // 16: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildFileSystemLocation
	(*AwsCodeBuildBatchConfig)(nil),                   // 17: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchConfig
	(*AwsCodeBuildBatchRestrictions)(nil),             // 18: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchRestrictions
	(*AwsCodeBuildWebhook)(nil),                       // 19: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhook
	(*AwsCodeBuildWebhookFilterGroup)(nil),            // 20: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookFilterGroup
	(*AwsCodeBuildWebhookFilter)(nil),                 // 21: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookFilter
	(*AwsCodeBuildWebhookScopeConfiguration)(nil),     // 22: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookScopeConfiguration
	(*AwsCodeBuildWebhookPullRequestBuildPolicy)(nil), // 23: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookPullRequestBuildPolicy
	(*v1.StringValueOrRef)(nil),                       // 24: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*structpb.Struct)(nil),                           // 25: google.protobuf.Struct
}
var file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_depIdxs = []int32{
	1,  // 0: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.source:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSource
	1,  // 1: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.secondary_sources:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSource
	5,  // 2: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.secondary_source_versions:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSecondarySourceVersion
	6,  // 3: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.environment:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironment
	10, // 4: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.artifacts:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildArtifacts
	10, // 5: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.secondary_artifacts:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildArtifacts
	24, // 6: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.service_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	24, // 7: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.encryption_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 8: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.cache:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildCache
	12, // 9: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.logs_config:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildLogsConfig
	15, // 10: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.vpc_config:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildVpcConfig
	16, // 11: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.file_system_locations:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildFileSystemLocation
	17, // 12: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.build_batch_config:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchConfig
	24, // 13: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.resource_access_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	25, // 14: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.resource_policy:type_name -> google.protobuf.Struct
	19, // 15: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildProjectSpec.webhook:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhook
	2,  // 16: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSource.git_submodules_config:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildGitSubmodulesConfig
	3,  // 17: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSource.build_status_config:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBuildStatusConfig
	4,  // 18: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSource.auth:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildSourceAuth
	8,  // 19: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironment.environment_variables:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironmentVariable
	9,  // 20: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironment.registry_credential:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildRegistryCredential
	7,  // 21: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildEnvironment.docker_server:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildDockerServer
	24, // 22: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildDockerServer.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	24, // 23: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildArtifacts.location:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	24, // 24: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildCache.location:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	...
	24, // 32: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchConfig.service_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	18, // 33: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchConfig.restrictions:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildBatchRestrictions
	20, // 34: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhook.filter_groups:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookFilterGroup
	22, // 35: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhook.scope_configuration:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookScopeConfiguration
	23, // 36: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhook.pull_request_build_policy:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookPullRequestBuildPolicy
	21, // 37: dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookFilterGroup.filters:type_name -> dev.planton.aws.awscodebuildproject.v1alpha1.AwsCodeBuildWebhookFilter
...
func init() { file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_init() }
func file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awscodebuildproject_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[8].OneofWrappers = []any{}
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[11].OneofWrappers = []any{}
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[13].OneofWrappers = []any{}
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[14].OneofWrappers = []any{}
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes[16].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awscodebuildproject_v1alpha1_spec_proto = out.File
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awscodebuildproject_v1alpha1_spec_proto_depIdxs = nil
}
