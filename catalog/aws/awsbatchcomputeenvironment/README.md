...
- **[AwsBatchJobQueue](../awsbatchjobqueue/README.md)** maps onto one or more compute environments in preference order and is where jobs are submitted.
- **[AwsBatchJobDefinition](../awsbatchjobdefinition/README.md)** is the container blueprint jobs run from.
- **[AwsBatchSchedulingPolicy](../awsbatchschedulingpolicy/README.md)** optionally divides a queue's capacity fairly across teams.
