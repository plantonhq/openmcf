...
// 	protoc        (unknown)
// source: catalog/aws/awsfsxlustrefilesystem/v1alpha1/spec.proto
...
func (x *AwsFsxLustreFileSystemSpec) Reset() {
	*x = AwsFsxLustreFileSystemSpec{}
	mi := &file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsFsxLustreFileSystemSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsFsxLustreFileSystemDataReadCacheConfiguration) Reset() {
	*x = AwsFsxLustreFileSystemDataReadCacheConfiguration{}
	mi := &file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxLustreFileSystemDataReadCacheConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsFsxLustreFileSystemRootSquashConfiguration) Reset() {
	*x = AwsFsxLustreFileSystemRootSquashConfiguration{}
	mi := &file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxLustreFileSystemRootSquashConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsFsxLustreFileSystemLogConfiguration) Reset() {
	*x = AwsFsxLustreFileSystemLogConfiguration{}
	mi := &file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxLustreFileSystemLogConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsFsxLustreFileSystemMetadataConfiguration) Reset() {
	*x = AwsFsxLustreFileSystemMetadataConfiguration{}
	mi := &file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsFsxLustreFileSystemMetadataConfiguration) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"6catalog/aws/awsfsxlustrefilesystem/v1alpha1/spec.proto\x12/dev.planton.aws.awsfsxlustrefilesystem.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xbc;\n" +
	...
	" \x01(\tR\x0edriveCacheType\x12\xa4\x01\n" +
	"\x1ddata_read_cache_configuration\x18\v \x01(\v2a.dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemDataReadCacheConfigurationR\x1adataReadCacheConfiguration\x12x\n" +
	...
	"\x18imported_file_chunk_size\x18\x13 \x01(\x05B\v\xbaH\b\x1a\x06\x18\x80\xa0\x1f(\x01H\x06R\x15importedFileChunkSize\x88\x01\x01\x12\x9a\x01\n" +
	"\x19root_squash_configuration\x18\x14 \x01(\v2^.dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemRootSquashConfigurationR\x17rootSquashConfiguration\x12\x84\x01\n" +
	"\x11log_configuration\x18\x15 \x01(\v2W.dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemLogConfigurationR\x10logConfiguration\x12\x93\x01\n" +
	"\x16metadata_configuration\x18\x16 \x01(\v2\\.dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemMetadataConfigurationR\x15metadataConfiguration\x12Z\n" +
	...
	"\x11skip_final_backup\x18\x1a \x01(\bB\b\x8a\xa6\x1d\x04trueH\bR\x0fskipFinalBackup\x88\x01\x01\x12\x8c\x01\n" +
	"\x11final_backup_tags\x18\x1b \x03(\v2`.dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.FinalBackupTagsEntryR\x0ffinalBackupTags\x12\xa4\x02\n" +
	...
	"\x05_modeB\a\n" +
	"\x05_iopsB\x8a\x03\n" +
	"3com.dev.planton.aws.awsfsxlustrefilesystem.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/catalog/aws/awsfsxlustrefilesystem/v1alpha1;awsfsxlustrefilesystemv1alpha1\xa2\x02\x04DPAA\xaa\x02/Dev.Planton.Aws.Awsfsxlustrefilesystem.V1alpha1\xca\x02/Dev\\Planton\\Aws\\Awsfsxlustrefilesystem\\V1alpha1\xe2\x02;Dev\\Planton\\Aws\\Awsfsxlustrefilesystem\\V1alpha1\\GPBMetadata\xea\x023Dev::Planton::Aws::Awsfsxlustrefilesystem::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_goTypes = []any{
	(*AwsFsxLustreFileSystemSpec)(nil),                       // 0: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec
	(*AwsFsxLustreFileSystemDataReadCacheConfiguration)(nil), // 1: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemDataReadCacheConfiguration
	(*AwsFsxLustreFileSystemRootSquashConfiguration)(nil),    // 2: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemRootSquashConfiguration
	(*AwsFsxLustreFileSystemLogConfiguration)(nil),           // 3: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemLogConfiguration
	(*AwsFsxLustreFileSystemMetadataConfiguration)(nil),      // 4: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemMetadataConfiguration
	nil,                         // 5: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.FinalBackupTagsEntry
	(*v1.StringValueOrRef)(nil), // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.data_read_cache_configuration:type_name -> dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemDataReadCacheConfiguration
	6, // 1: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 2: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 3: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.kms_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 4: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.root_squash_configuration:type_name -> dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemRootSquashConfiguration
	3, // 5: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.log_configuration:type_name -> dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemLogConfiguration
	4, // 6: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.metadata_configuration:type_name -> dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemMetadataConfiguration
	5, // 7: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.final_backup_tags:type_name -> dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemSpec.FinalBackupTagsEntry
	6, // 8: dev.planton.aws.awsfsxlustrefilesystem.v1alpha1.AwsFsxLustreFileSystemLogConfiguration.destination:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsfsxlustrefilesystem_v1alpha1_spec_proto_depIdxs = nil
}
