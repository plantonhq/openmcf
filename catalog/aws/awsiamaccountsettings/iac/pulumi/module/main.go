...
// Resources orchestrates the IAM account-settings arms and exports
// outputs.
func Resources(ctx *pulumi.Context, stackInput *awsiamaccountsettingsv1alpha1.AwsIamAccountSettingsStackInput) error {
	...
	if err := accountSettings(ctx, locals, provider); err != nil {
		return errors.Wrap(err, "account settings")
	}
