terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the alias and password policy are foundational
      # v1-era surface; aws_iam_security_token_service_preferences landed in
      # v5 — nothing needs newer than the catalog pin.
