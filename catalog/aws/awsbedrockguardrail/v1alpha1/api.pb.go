...
// 	protoc        (unknown)
// source: catalog/aws/awsbedrockguardrail/v1alpha1/api.proto
...
// published versions for production pinning.
type AwsBedrockGuardrail struct {
	...
	Status        *AwsBedrockGuardrailStatus `protobuf:"bytes,5,opt,name=status,proto3" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AwsBedrockGuardrail) Reset() {
	*x = AwsBedrockGuardrail{}
	mi := &file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AwsBedrockGuardrail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AwsBedrockGuardrail) ProtoMessage() {}

func (x *AwsBedrockGuardrail) ProtoReflect() protoreflect.Message {
	mi := &file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use AwsBedrockGuardrail.ProtoReflect.Descriptor instead.
func (*AwsBedrockGuardrail) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDescGZIP(), []int{0}
}

func (x *AwsBedrockGuardrail) GetApiVersion() string {
	if x != nil {
		return x.ApiVersion
	}
	return ""
...
func (x *AwsBedrockGuardrail) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *AwsBedrockGuardrail) GetSpec() *AwsBedrockGuardrailSpec {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *AwsBedrockGuardrail) GetStatus() *AwsBedrockGuardrailStatus {
	if x != nil {
		return x.Status
	}
	return nil
...
// AwsBedrockGuardrailStatus contains the status and outputs for the
// guardrail.
...
func (x *AwsBedrockGuardrailStatus) Reset() {
	*x = AwsBedrockGuardrailStatus{}
	mi := &file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AwsBedrockGuardrailStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AwsBedrockGuardrailStatus) ProtoMessage() {}

func (x *AwsBedrockGuardrailStatus) ProtoReflect() protoreflect.Message {
	mi := &file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AwsBedrockGuardrailStatus.ProtoReflect.Descriptor instead.
func (*AwsBedrockGuardrailStatus) Descriptor() ([]byte, []int) {
...
var File_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto protoreflect.FileDescriptor

const file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"2catalog/aws/awsbedrockguardrail/v1alpha1/api.proto\x12,dev.planton.aws.awsbedrockguardrail.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a6catalog/aws/awsbedrockguardrail/v1alpha1/outputs.proto\x1a3catalog/aws/awsbedrockguardrail/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\x9a\x03\n" +
	"\x13AwsBedrockGuardrail\x12@\n" +
...
var (
	file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDescOnce sync.Once
	file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDescData []byte
)

func file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDesc), len(file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDesc)))
	})
	return file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDescData
}
...
func init() { file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_init() }
func file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_init() {
	if File_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto != nil {
		return
	}
	file_catalog_aws_awsbedrockguardrail_v1alpha1_outputs_proto_init()
	file_catalog_aws_awsbedrockguardrail_v1alpha1_spec_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDesc), len(file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto = out.File
	file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_goTypes = nil
	file_catalog_aws_awsbedrockguardrail_v1alpha1_api_proto_depIdxs = nil
}
