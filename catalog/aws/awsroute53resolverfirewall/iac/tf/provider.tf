terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the rule's dns_threat_protection /
      # confidence_threshold arm (Advanced protection) is the newest
      # argument consumed - accepted at the pin (verified by the offline
      # plan).
