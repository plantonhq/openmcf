terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: aws_organizations_account and the account-service
      # satellites (alternate/primary contacts, region enablement) are
      # settled surface — nothing needs newer than the catalog pin.
