...
// 	protoc        (unknown)
// source: catalog/aws/awscloudwatchalarm/v1alpha1/spec.proto
...
func (x *AwsCloudwatchAlarmSpec) Reset() {
	*x = AwsCloudwatchAlarmSpec{}
	mi := &file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsCloudwatchAlarmSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsCloudwatchAlarmMetricQuery) Reset() {
	*x = AwsCloudwatchAlarmMetricQuery{}
	mi := &file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmMetricQuery) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsCloudwatchAlarmMetricQueryMetric) Reset() {
	*x = AwsCloudwatchAlarmMetricQueryMetric{}
	mi := &file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmMetricQueryMetric) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsCloudwatchAlarmEvaluationCriteria) Reset() {
	*x = AwsCloudwatchAlarmEvaluationCriteria{}
	mi := &file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmEvaluationCriteria) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsCloudwatchAlarmPromqlCriteria) Reset() {
	*x = AwsCloudwatchAlarmPromqlCriteria{}
	mi := &file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsCloudwatchAlarmPromqlCriteria) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x12extended_statistic\x18\r \x01(\tR\x11extendedStatistic\x12s\n" +
	"\n" +
	"dimensions\x18\x0e \x03(\v2S.dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.DimensionsEntryR\n" +
	"dimensions\x12\x12\n" +
	"\x04unit\x18\x0f \x01(\tR\x04unit\x12q\n" +
	"\x0emetric_queries\x18\x10 \x03(\v2J.dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryR\rmetricQueries\x12z\n" +
	...
	"%evaluate_low_sample_count_percentiles\x18\x15 \x01(\tR!evaluateLowSampleCountPercentiles\x12\x82\x01\n" +
	"\x13evaluation_criteria\x18\x16 \x01(\v2Q.dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteriaR\x12evaluationCriteria\x12/\n" +
	...
	"expression\x12h\n" +
	"\x06metric\x18\x03 \x01(\v2P.dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetricR\x06metric\x12\x14\n" +
	...
	"\x04stat\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04stat\x12\x80\x01\n" +
	"\n" +
	"dimensions\x18\x05 \x03(\v2`.dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntryR\n" +
	"dimensions\x12\x12\n" +
	...
	"\x10_recovery_periodB\xee\x02\n" +
	"/com.dev.planton.aws.awscloudwatchalarm.v1alpha1B\tSpecProtoP\x01Z_github.com/plantonhq/planton/catalog/aws/awscloudwatchalarm/v1alpha1;awscloudwatchalarmv1alpha1\xa2\x02\x04DPAA\xaa\x02+Dev.Planton.Aws.Awscloudwatchalarm.V1alpha1\xca\x02+Dev\\Planton\\Aws\\Awscloudwatchalarm\\V1alpha1\xe2\x027Dev\\Planton\\Aws\\Awscloudwatchalarm\\V1alpha1\\GPBMetadata\xea\x02/Dev::Planton::Aws::Awscloudwatchalarm::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_goTypes = []any{
	(*AwsCloudwatchAlarmSpec)(nil),               // 0: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec
	(*AwsCloudwatchAlarmMetricQuery)(nil),        // 1: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQuery
	(*AwsCloudwatchAlarmMetricQueryMetric)(nil),  // 2: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric
	(*AwsCloudwatchAlarmEvaluationCriteria)(nil), // 3: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteria
	(*AwsCloudwatchAlarmPromqlCriteria)(nil),     // 4: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmPromqlCriteria
	nil,                                          // 5: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.DimensionsEntry
	nil,                                          // 6: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntry
	(*v1.StringValueOrRef)(nil),                  // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.dimensions:type_name -> dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.DimensionsEntry
	1, // 1: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.metric_queries:type_name -> dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQuery
	7, // 2: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.alarm_actions:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7, // 3: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.ok_actions:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	7, // 4: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.insufficient_data_actions:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 5: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmSpec.evaluation_criteria:type_name -> dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteria
	2, // 6: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQuery.metric:type_name -> dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric
	6, // 7: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.dimensions:type_name -> dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmMetricQueryMetric.DimensionsEntry
	4, // 8: dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmEvaluationCriteria.promql_criteria:type_name -> dev.planton.aws.awscloudwatchalarm.v1alpha1.AwsCloudwatchAlarmPromqlCriteria
...
func init() { file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_init() }
func file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto = out.File
	file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awscloudwatchalarm_v1alpha1_spec_proto_depIdxs = nil
}
