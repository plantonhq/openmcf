...
// riskConfiguration creates the pool-wide aws_cognito_risk_configuration.
// AWS applies it to every app client without a client-scoped configuration
...
func riskConfiguration(ctx *pulumi.Context, locals *Locals, createdPool *cognito.UserPool, provider *aws.Provider) error {
