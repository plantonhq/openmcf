terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: endpoint_access_mode, response_transfer_mode (and its
      # 900s STREAM timeout ceiling), and the 2025-09 TLS security-policy
      # family on aws_api_gateway_rest_api are 6.5x additions -- an older
      # floor would reject arguments this module renders.
