...
func initializeLocals(_ *pulumi.Context, in *awsmanagedprefixlistv1alpha1.AwsManagedPrefixListStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsManagedPrefixList.String(),
