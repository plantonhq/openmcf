terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the newest arms rendered here (throughput_config,
      # online-store ttl_duration and InMemory storage, collection types)
      # shipped in the 5.3x line — all covered by this pin.
