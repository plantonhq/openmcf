terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the recorder's recording_mode (periodic recording) and
      # the Plugin Framework retention resource are the newest surfaces here;
      # both are v6-era — nothing needs newer than the catalog pin.
