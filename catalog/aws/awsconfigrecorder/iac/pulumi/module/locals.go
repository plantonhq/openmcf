...
func initializeLocals(_ *pulumi.Context, in *awsconfigrecorderv1alpha1.AwsConfigRecorderStackInput) *Locals {
	locals := &Locals{}
	...
	locals.AwsTags = map[string]string{
		...
		awstagkeys.ResourceKind: cloudresourcekind.CloudResourceKind_AwsConfigRecorder.String(),
