...
// 	protoc        (unknown)
// source: catalog/aws/awsmemorydbcluster/v1alpha1/spec.proto
...
func (x *AwsMemorydbClusterSpec) Reset() {
	*x = AwsMemorydbClusterSpec{}
	mi := &file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AwsMemorydbClusterSpec) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsMemorydbClusterParameter) Reset() {
	*x = AwsMemorydbClusterParameter{}
	mi := &file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsMemorydbClusterParameter) Descriptor() ([]byte, []int) {
	return file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\n" +
	"parameters\x18\x18 \x03(\v2H.dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterParameterR\n" +
	"parameters\x120\n" +
	...
	"/com.dev.planton.aws.awsmemorydbcluster.v1alpha1B\tSpecProtoP\x01Z_github.com/plantonhq/planton/catalog/aws/awsmemorydbcluster/v1alpha1;awsmemorydbclusterv1alpha1\xa2\x02\x04DPAA\xaa\x02+Dev.Planton.Aws.Awsmemorydbcluster.V1alpha1\xca\x02+Dev\\Planton\\Aws\\Awsmemorydbcluster\\V1alpha1\xe2\x027Dev\\Planton\\Aws\\Awsmemorydbcluster\\V1alpha1\\GPBMetadata\xea\x02/Dev::Planton::Aws::Awsmemorydbcluster::V1alpha1b\x06proto3"

var (
	file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDescData
}

var file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_goTypes = []any{
	(*AwsMemorydbClusterSpec)(nil),      // 0: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterSpec
	(*AwsMemorydbClusterParameter)(nil), // 1: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterParameter
	(*v1.StringValueOrRef)(nil),         // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterSpec.acl_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterSpec.subnet_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterSpec.kms_key_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 4: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterSpec.parameters:type_name -> dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterParameter
	2, // 5: dev.planton.aws.awsmemorydbcluster.v1alpha1.AwsMemorydbClusterSpec.sns_topic_arn:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_init() }
func file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_init() {
	if File_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDesc), len(file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto = out.File
	file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_goTypes = nil
	file_catalog_aws_awsmemorydbcluster_v1alpha1_spec_proto_depIdxs = nil
}
