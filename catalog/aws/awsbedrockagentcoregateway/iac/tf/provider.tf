terraform {
  ...
  required_providers {
    aws = {
      ...
      # line and still expanding at 6.58.0 (the gateway's
      # interceptor_configuration and policy_engine_configuration are
      # late-6.5x additions), so an older floor would reject arguments this
      # module renders.
