terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: trails are long-stable; the newest surface this module
      # renders (ARN-based trail identity, the delegated-admin resource) is
      # v6-era — nothing needs newer than the catalog pin.
