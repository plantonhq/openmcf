terraform {
  ...
  required_providers {
    aws = {
      ...
      #
      # Feature floor: the whole bedrockagentcore package is new in the 6.5x
      # line and still expanding at 6.58.0 (the memory's indexed_key,
      # stream_delivery_resources, and the strategy's namespace_templates/
      # EPISODIC surfaces are late-6.5x additions), so an older floor would
      # reject arguments this module renders.
