...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudpolardbcluster/v1alpha1/spec.proto
...
func (x *AliCloudPolardbClusterSpec) Reset() {
	*x = AliCloudPolardbClusterSpec{}
	mi := &file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudPolardbClusterSpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudPolardbParameter) Reset() {
	*x = AliCloudPolardbParameter{}
	mi := &file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbParameter) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudPolardbDatabase) Reset() {
	*x = AliCloudPolardbDatabase{}
	mi := &file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbDatabase) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudPolardbAccount) Reset() {
	*x = AliCloudPolardbAccount{}
	mi := &file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbAccount) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudPolardbAccountPrivilege) Reset() {
	*x = AliCloudPolardbAccountPrivilege{}
	mi := &file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudPolardbAccountPrivilege) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";catalog/alicloud/alicloudpolardbcluster/v1alpha1/spec.proto\x124dev.planton.alicloud.alicloudpolardbcluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xe2\x1f\n" +
	...
	"\x11resource_group_id\x18\x10 \x01(\tR\x0fresourceGroupId\x12n\n" +
	"\x04tags\x18\x11 \x03(\v2Z.dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.TagsEntryR\x04tags\x12\x8e\x02\n" +
	...
	"\x1dbackup_retention_policy_valid\x12Mbackup_retention_policy_on_cluster_deletion must be one of: ALL, LATEST, NONE\x1a/this == '' || this in ['ALL', 'LATEST', 'NONE']H\fR&backupRetentionPolicyOnClusterDeletion\x88\x01\x01\x12n\n" +
	"\n" +
	"parameters\x18\x1b \x03(\v2N.dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbParameterR\n" +
	"parameters\x12k\n" +
	"\tdatabases\x18\x1c \x03(\v2M.dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbDatabaseR\tdatabases\x12h\n" +
	"\baccounts\x18\x1d \x03(\v2L.dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbAccountR\baccounts\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x05ctype\x18\x05 \x01(\tR\x05ctype\"\xe1\x03\n" +
	...
	"\x13account_description\x18\x04 \x01(\tR\x12accountDescription\x12u\n" +
	"\n" +
	"privileges\x18\x05 \x03(\v2U.dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbAccountPrivilegeR\n" +
	"privilegesB\x0f\n" +
	...
	"\x12_account_privilegeB\xa8\x03\n" +
	"8com.dev.planton.alicloud.alicloudpolardbcluster.v1alpha1B\tSpecProtoP\x01Zlgithub.com/plantonhq/planton/catalog/alicloud/alicloudpolardbcluster/v1alpha1;alicloudpolardbclusterv1alpha1\xa2\x02\x04DPAA\xaa\x024Dev.Planton.Alicloud.Alicloudpolardbcluster.V1alpha1\xca\x024Dev\\Planton\\Alicloud\\Alicloudpolardbcluster\\V1alpha1\xe2\x02@Dev\\Planton\\Alicloud\\Alicloudpolardbcluster\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Alicloud::Alicloudpolardbcluster::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudPolardbClusterSpec)(nil),      // 0: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec
	(*AliCloudPolardbParameter)(nil),        // 1: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbParameter
	(*AliCloudPolardbDatabase)(nil),         // 2: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbDatabase
	(*AliCloudPolardbAccount)(nil),          // 3: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbAccount
	(*AliCloudPolardbAccountPrivilege)(nil), // 4: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbAccountPrivilege
	nil,                                     // 5: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),             // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 1: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.tags:type_name -> dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.TagsEntry
	1, // 2: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.parameters:type_name -> dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbParameter
	2, // 3: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.databases:type_name -> dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbDatabase
	3, // 4: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbClusterSpec.accounts:type_name -> dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbAccount
	4, // 5: dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbAccount.privileges:type_name -> dev.planton.alicloud.alicloudpolardbcluster.v1alpha1.AliCloudPolardbAccountPrivilege
...
func init() { file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudpolardbcluster_v1alpha1_spec_proto_depIdxs = nil
}
