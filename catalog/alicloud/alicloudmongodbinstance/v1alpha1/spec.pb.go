...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudmongodbinstance/v1alpha1/spec.proto
...
func (x *AliCloudMongodbInstanceSpec) Reset() {
	*x = AliCloudMongodbInstanceSpec{}
	mi := &file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudMongodbInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"<catalog/alicloud/alicloudmongodbinstance/v1alpha1/spec.proto\x125dev.planton.alicloud.alicloudmongodbinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xab\x1c\n" +
	...
	"\x11resource_group_id\x18\x13 \x01(\tR\x0fresourceGroupId\x12p\n" +
	"\x04tags\x18\x14 \x03(\v2\\.dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.TagsEntryR\x04tags\x12\x9f\x01\n" +
	"\n" +
	...
	"backupTime\x12#\n" +
	"\rbackup_period\x18\x1d \x03(\tR\fbackupPeriod\x12\x82\x01\n" +
	"\n" +
	"parameters\x18\x1e \x03(\v2b.dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.ParametersEntryR\n" +
	"parameters\x12H\n" +
	...
	"\a_periodB\r\n" +
	"\v_auto_renewB\x16\n" +
	"\x14_auto_renew_durationB\xaf\x03\n" +
	"9com.dev.planton.alicloud.alicloudmongodbinstance.v1alpha1B\tSpecProtoP\x01Zngithub.com/plantonhq/planton/catalog/alicloud/alicloudmongodbinstance/v1alpha1;alicloudmongodbinstancev1alpha1\xa2\x02\x04DPAA\xaa\x025Dev.Planton.Alicloud.Alicloudmongodbinstance.V1alpha1\xca\x025Dev\\Planton\\Alicloud\\Alicloudmongodbinstance\\V1alpha1\xe2\x02ADev\\Planton\\Alicloud\\Alicloudmongodbinstance\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Alicloud::Alicloudmongodbinstance::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudMongodbInstanceSpec)(nil), // 0: dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec
	nil,                                 // 1: dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.TagsEntry
	nil,                                 // 2: dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.ParametersEntry
	(*v1.StringValueOrRef)(nil),         // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.tags:type_name -> dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.TagsEntry
	2, // 2: dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.parameters:type_name -> dev.planton.alicloud.alicloudmongodbinstance.v1alpha1.AliCloudMongodbInstanceSpec.ParametersEntry
...
func init() { file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudmongodbinstance_v1alpha1_spec_proto_depIdxs = nil
}
