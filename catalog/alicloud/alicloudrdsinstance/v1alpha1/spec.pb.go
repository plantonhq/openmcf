...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudrdsinstance/v1alpha1/spec.proto
...
func (x *AliCloudRdsInstanceSpec) Reset() {
	*x = AliCloudRdsInstanceSpec{}
	mi := &file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudRdsInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudRdsParameter) Reset() {
	*x = AliCloudRdsParameter{}
	mi := &file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudRdsParameter) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudRdsDatabase) Reset() {
	*x = AliCloudRdsDatabase{}
	mi := &file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudRdsDatabase) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudRdsAccount) Reset() {
	*x = AliCloudRdsAccount{}
	mi := &file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudRdsAccount) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudRdsAccountPrivilege) Reset() {
	*x = AliCloudRdsAccountPrivilege{}
	mi := &file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudRdsAccountPrivilege) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"8catalog/alicloud/alicloudrdsinstance/v1alpha1/spec.proto\x121dev.planton.alicloud.alicloudrdsinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\x92\x19\n" +
	...
	"\x11resource_group_id\x18\x18 \x01(\tR\x0fresourceGroupId\x12h\n" +
	"\x04tags\x18\x19 \x03(\v2T.dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.TagsEntryR\x04tags\x12g\n" +
	"\n" +
	"parameters\x18\x1a \x03(\v2G.dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsParameterR\n" +
	"parameters\x12d\n" +
	"\tdatabases\x18\x1b \x03(\v2F.dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsDatabaseR\tdatabases\x12a\n" +
	"\baccounts\x18\x1c \x03(\v2E.dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsAccountR\baccounts\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x13account_description\x18\x04 \x01(\tR\x12accountDescription\x12n\n" +
	"\n" +
	"privileges\x18\x05 \x03(\v2N.dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsAccountPrivilegeR\n" +
	"privilegesB\x0f\n" +
	...
	"\n" +
	"_privilegeB\x93\x03\n" +
	"5com.dev.planton.alicloud.alicloudrdsinstance.v1alpha1B\tSpecProtoP\x01Zfgithub.com/plantonhq/planton/catalog/alicloud/alicloudrdsinstance/v1alpha1;alicloudrdsinstancev1alpha1\xa2\x02\x04DPAA\xaa\x021Dev.Planton.Alicloud.Alicloudrdsinstance.V1alpha1\xca\x021Dev\\Planton\\Alicloud\\Alicloudrdsinstance\\V1alpha1\xe2\x02=Dev\\Planton\\Alicloud\\Alicloudrdsinstance\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Alicloud::Alicloudrdsinstance::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudRdsInstanceSpec)(nil),     // 0: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec
	(*AliCloudRdsParameter)(nil),        // 1: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsParameter
	(*AliCloudRdsDatabase)(nil),         // 2: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsDatabase
	(*AliCloudRdsAccount)(nil),          // 3: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsAccount
	(*AliCloudRdsAccountPrivilege)(nil), // 4: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsAccountPrivilege
	nil,                                 // 5: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),         // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 1: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.tags:type_name -> dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.TagsEntry
	1, // 2: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.parameters:type_name -> dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsParameter
	2, // 3: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.databases:type_name -> dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsDatabase
	3, // 4: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsInstanceSpec.accounts:type_name -> dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsAccount
	4, // 5: dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsAccount.privileges:type_name -> dev.planton.alicloud.alicloudrdsinstance.v1alpha1.AliCloudRdsAccountPrivilege
...
func init() { file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudrdsinstance_v1alpha1_spec_proto_depIdxs = nil
}
