...
func Resources(ctx *pulumi.Context, stackInput *alicloudcdndomainv1alpha1.AliCloudCdnDomainStackInput) error {
...
func buildSources(sources []*alicloudcdndomainv1alpha1.AliCloudCdnDomainSource) cdn.DomainNewSourceArray {
...
func buildCertificateConfig(cc *alicloudcdndomainv1alpha1.AliCloudCdnDomainCertificateConfig) cdn.DomainNewCertificateConfigPtrInput {
