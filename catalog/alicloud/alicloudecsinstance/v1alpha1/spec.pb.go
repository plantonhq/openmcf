...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudecsinstance/v1alpha1/spec.proto
...
func (x *AliCloudEcsInstanceSpec) Reset() {
	*x = AliCloudEcsInstanceSpec{}
	mi := &file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudEcsInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudEcsSystemDisk) Reset() {
	*x = AliCloudEcsSystemDisk{}
	mi := &file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudEcsSystemDisk) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudEcsDataDisk) Reset() {
	*x = AliCloudEcsDataDisk{}
	mi := &file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudEcsDataDisk) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"8catalog/alicloud/alicloudecsinstance/v1alpha1/spec.proto\x121dev.planton.alicloud.alicloudecsinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xf6\x18\n" +
	...
	"\x12description_length\x129description must be between 2 and 256 characters when set\x1a6this == '' || (this.size() >= 2 && this.size() <= 256)R\vdescription\x12i\n" +
	"\vsystem_disk\x18\t \x01(\v2H.dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsSystemDiskR\n" +
	"systemDisk\x12o\n" +
	"\n" +
	"data_disks\x18\n" +
	" \x03(\v2F.dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsDataDiskB\b\xbaH\x05\x92\x01\x02\x10\x10R\tdataDisks\x12\x19\n" +
	...
	"\x04tags\x18\x19 \x03(\v2T.dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\n" +
	"_encryptedB\x17\n" +
	"\x15_delete_with_instanceB\x93\x03\n" +
	"5com.dev.planton.alicloud.alicloudecsinstance.v1alpha1B\tSpecProtoP\x01Zfgithub.com/plantonhq/planton/catalog/alicloud/alicloudecsinstance/v1alpha1;alicloudecsinstancev1alpha1\xa2\x02\x04DPAA\xaa\x021Dev.Planton.Alicloud.Alicloudecsinstance.V1alpha1\xca\x021Dev\\Planton\\Alicloud\\Alicloudecsinstance\\V1alpha1\xe2\x02=Dev\\Planton\\Alicloud\\Alicloudecsinstance\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Alicloud::Alicloudecsinstance::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudEcsInstanceSpec)(nil), // 0: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec
	(*AliCloudEcsSystemDisk)(nil),   // 1: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsSystemDisk
	(*AliCloudEcsDataDisk)(nil),     // 2: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsDataDisk
	nil,                             // 3: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),     // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.system_disk:type_name -> dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsSystemDisk
	2, // 3: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.data_disks:type_name -> dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsDataDisk
	3, // 4: dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.tags:type_name -> dev.planton.alicloud.alicloudecsinstance.v1alpha1.AliCloudEcsInstanceSpec.TagsEntry
...
func init() { file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudecsinstance_v1alpha1_spec_proto_depIdxs = nil
}
