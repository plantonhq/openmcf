...
go build ./catalog/alicloud/alicloudnatgateway/v1alpha1/iac/pulumi/...

# Go vet
go vet ./catalog/alicloud/alicloudnatgateway/v1alpha1/iac/pulumi/...

# Spec tests
go test ./catalog/alicloud/alicloudnatgateway/v1alpha1/...

# Terraform validation
cd catalog/alicloud/alicloudnatgateway/v1alpha1/iac/tf
