...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudnatgateway/v1alpha1/spec.proto
...
func (x *AliCloudNatGatewaySpec) Reset() {
	*x = AliCloudNatGatewaySpec{}
	mi := &file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudNatGatewaySpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudSnatEntry) Reset() {
	*x = AliCloudSnatEntry{}
	mi := &file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSnatEntry) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7catalog/alicloud/alicloudnatgateway/v1alpha1/spec.proto\x120dev.planton.alicloud.alicloudnatgateway.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\x97\r\n" +
	...
	" \x01(\bH\x04R\x12deletionProtection\x88\x01\x01\x12f\n" +
	"\x04tags\x18\v \x03(\v2R.dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.TagsEntryR\x04tags\x12o\n" +
	"\x06eip_id\x18\f \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB$\xbaH\x03\xc8\x01\x01\x88\xd4a\xf7]\x92\xd4a\x15status.outputs.eip_idR\x05eipId\x12f\n" +
	"\fsnat_entries\x18\r \x03(\v2C.dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudSnatEntryR\vsnatEntries\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"sourceCidr\x12&\n" +
	"\x0fsnat_entry_name\x18\x03 \x01(\tR\rsnatEntryNameB\x8c\x03\n" +
	"4com.dev.planton.alicloud.alicloudnatgateway.v1alpha1B\tSpecProtoP\x01Zdgithub.com/plantonhq/planton/catalog/alicloud/alicloudnatgateway/v1alpha1;alicloudnatgatewayv1alpha1\xa2\x02\x04DPAA\xaa\x020Dev.Planton.Alicloud.Alicloudnatgateway.V1alpha1\xca\x020Dev\\Planton\\Alicloud\\Alicloudnatgateway\\V1alpha1\xe2\x02<Dev\\Planton\\Alicloud\\Alicloudnatgateway\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Alicloud::Alicloudnatgateway::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudNatGatewaySpec)(nil), // 0: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec
	(*AliCloudSnatEntry)(nil),      // 1: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudSnatEntry
	nil,                            // 2: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.TagsEntry
	(*v1.StringValueOrRef)(nil),    // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.tags:type_name -> dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.TagsEntry
	3, // 3: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.eip_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 4: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudNatGatewaySpec.snat_entries:type_name -> dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudSnatEntry
	3, // 5: dev.planton.alicloud.alicloudnatgateway.v1alpha1.AliCloudSnatEntry.source_vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudnatgateway_v1alpha1_spec_proto_depIdxs = nil
}
