...
go build ./catalog/alicloud/alicloudnatgateway/iac/pulumi/...

# Go vet
go vet ./catalog/alicloud/alicloudnatgateway/iac/pulumi/...

# Spec tests
go test ./catalog/alicloud/alicloudnatgateway/v1alpha1/...

# Terraform validation
cd catalog/alicloud/alicloudnatgateway/iac/tf
