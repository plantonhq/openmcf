...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudsecuritygroup/v1alpha1/spec.proto
...
func (x *AliCloudSecurityGroupSpec) Reset() {
	*x = AliCloudSecurityGroupSpec{}
	mi := &file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudSecurityGroupSpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudSecurityGroupRule) Reset() {
	*x = AliCloudSecurityGroupRule{}
	mi := &file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSecurityGroupRule) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":catalog/alicloud/alicloudsecuritygroup/v1alpha1/spec.proto\x123dev.planton.alicloud.alicloudsecuritygroup.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xa2\x06\n" +
	...
	"\x11resource_group_id\x18\x06 \x01(\tR\x0fresourceGroupId\x12l\n" +
	"\x04tags\x18\a \x03(\v2X.dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.TagsEntryR\x04tags\x12d\n" +
	"\x05rules\x18\b \x03(\v2N.dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupRuleR\x05rules\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\t_priorityB\t\n" +
	"\a_policyB\xa1\x03\n" +
	"7com.dev.planton.alicloud.alicloudsecuritygroup.v1alpha1B\tSpecProtoP\x01Zjgithub.com/plantonhq/planton/catalog/alicloud/alicloudsecuritygroup/v1alpha1;alicloudsecuritygroupv1alpha1\xa2\x02\x04DPAA\xaa\x023Dev.Planton.Alicloud.Alicloudsecuritygroup.V1alpha1\xca\x023Dev\\Planton\\Alicloud\\Alicloudsecuritygroup\\V1alpha1\xe2\x02?Dev\\Planton\\Alicloud\\Alicloudsecuritygroup\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Alicloud::Alicloudsecuritygroup::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudSecurityGroupSpec)(nil), // 0: dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec
	(*AliCloudSecurityGroupRule)(nil), // 1: dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupRule
	nil,                               // 2: dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),       // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.tags:type_name -> dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.TagsEntry
	1, // 2: dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupSpec.rules:type_name -> dev.planton.alicloud.alicloudsecuritygroup.v1alpha1.AliCloudSecurityGroupRule
...
func init() { file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudsecuritygroup_v1alpha1_spec_proto_depIdxs = nil
}
