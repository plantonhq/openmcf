...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudcontainerregistry/v1alpha1/spec.proto
...
func (x *AliCloudContainerRegistrySpec) Reset() {
	*x = AliCloudContainerRegistrySpec{}
	mi := &file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudContainerRegistrySpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudContainerRegistryNamespace) Reset() {
	*x = AliCloudContainerRegistryNamespace{}
	mi := &file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudContainerRegistryNamespace) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	">catalog/alicloud/alicloudcontainerregistry/v1alpha1/spec.proto\x127dev.planton.alicloud.alicloudcontainerregistry.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a\x1cshared/options/options.proto\"\xd8\x05\n" +
	...
	"\n" +
	"namespaces\x18\b \x03(\v2[.dev.planton.alicloud.alicloudcontainerregistry.v1alpha1.AliCloudContainerRegistryNamespaceR\n" +
	"namespacesB\x0f\n" +
	...
	"\f_auto_createB\x15\n" +
	"\x13_default_visibilityB\xbd\x03\n" +
	";com.dev.planton.alicloud.alicloudcontainerregistry.v1alpha1B\tSpecProtoP\x01Zrgithub.com/plantonhq/planton/catalog/alicloud/alicloudcontainerregistry/v1alpha1;alicloudcontainerregistryv1alpha1\xa2\x02\x04DPAA\xaa\x027Dev.Planton.Alicloud.Alicloudcontainerregistry.V1alpha1\xca\x027Dev\\Planton\\Alicloud\\Alicloudcontainerregistry\\V1alpha1\xe2\x02CDev\\Planton\\Alicloud\\Alicloudcontainerregistry\\V1alpha1\\GPBMetadata\xea\x02;Dev::Planton::Alicloud::Alicloudcontainerregistry::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudContainerRegistrySpec)(nil),      // 0: dev.planton.alicloud.alicloudcontainerregistry.v1alpha1.AliCloudContainerRegistrySpec
	(*AliCloudContainerRegistryNamespace)(nil), // 1: dev.planton.alicloud.alicloudcontainerregistry.v1alpha1.AliCloudContainerRegistryNamespace
}
var file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.alicloud.alicloudcontainerregistry.v1alpha1.AliCloudContainerRegistrySpec.namespaces:type_name -> dev.planton.alicloud.alicloudcontainerregistry.v1alpha1.AliCloudContainerRegistryNamespace
...
func init() { file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudcontainerregistry_v1alpha1_spec_proto_depIdxs = nil
}
