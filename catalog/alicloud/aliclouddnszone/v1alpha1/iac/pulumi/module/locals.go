...
type Locals struct {
	AliCloudDnsZone *aliclouddnszonev1alpha1.AliCloudDnsZone
	Tags            map[string]string
}

func initializeLocals(ctx *pulumi.Context, stackInput *aliclouddnszonev1alpha1.AliCloudDnsZoneStackInput) *Locals {
	locals := &Locals{}
