...
go build ./catalog/alicloud/alicloudvpngateway/v1alpha1/iac/pulumi/...

# Go vet
go vet ./catalog/alicloud/alicloudvpngateway/v1alpha1/iac/pulumi/...

# Spec tests
go test ./catalog/alicloud/alicloudvpngateway/v1alpha1/...

# Terraform validation
cd catalog/alicloud/alicloudvpngateway/v1alpha1/iac/tf
