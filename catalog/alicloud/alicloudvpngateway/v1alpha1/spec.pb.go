...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudvpngateway/v1alpha1/spec.proto
...
func (x *AliCloudVpnGatewaySpec) Reset() {
	*x = AliCloudVpnGatewaySpec{}
	mi := &file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudVpnGatewaySpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudVpnConnection) Reset() {
	*x = AliCloudVpnConnection{}
	mi := &file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudVpnConnection) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudIkeConfig) Reset() {
	*x = AliCloudIkeConfig{}
	mi := &file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudIkeConfig) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudIpsecConfig) Reset() {
	*x = AliCloudIpsecConfig{}
	mi := &file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudIpsecConfig) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudVpnHealthCheckConfig) Reset() {
	*x = AliCloudVpnHealthCheckConfig{}
	mi := &file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudVpnHealthCheckConfig) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7catalog/alicloud/alicloudvpngateway/v1alpha1/spec.proto\x120dev.planton.alicloud.alicloudvpngateway.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xc2\t\n" +
	...
	"\x0fssl_connections\x18\t \x01(\x05H\x02R\x0esslConnections\x88\x01\x01\x12f\n" +
	"\x04tags\x18\n" +
	" \x03(\v2R.dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.TagsEntryR\x04tags\x12*\n" +
	"\x11resource_group_id\x18\v \x01(\tR\x0fresourceGroupId\x12i\n" +
	"\vconnections\x18\f \x03(\v2G.dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnectionR\vconnections\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x0f\n" +
	"\r_payment_typeB\r\n" +
	"\v_enable_sslB\x12\n" +
	"\x10_ssl_connections\"\xc6\x06\n" +
	...
	"\x12effect_immediately\x18\b \x01(\bB\b\x8a\xa6\x1d\x04trueH\x02R\x11effectImmediately\x88\x01\x01\x12b\n" +
	"\n" +
	"ike_config\x18\t \x01(\v2C.dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudIkeConfigR\tikeConfig\x12h\n" +
	"\fipsec_config\x18\n" +
	" \x01(\v2E.dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudIpsecConfigR\vipsecConfig\x12~\n" +
	"\x13health_check_config\x18\v \x01(\v2N.dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnHealthCheckConfigR\x11healthCheckConfigB\r\n" +
	"\v_enable_dpdB\x17\n" +
	...
	"\t_intervalB\b\n" +
	"\x06_retryB\x8c\x03\n" +
	"4com.dev.planton.alicloud.alicloudvpngateway.v1alpha1B\tSpecProtoP\x01Zdgithub.com/plantonhq/planton/catalog/alicloud/alicloudvpngateway/v1alpha1;alicloudvpngatewayv1alpha1\xa2\x02\x04DPAA\xaa\x020Dev.Planton.Alicloud.Alicloudvpngateway.V1alpha1\xca\x020Dev\\Planton\\Alicloud\\Alicloudvpngateway\\V1alpha1\xe2\x02<Dev\\Planton\\Alicloud\\Alicloudvpngateway\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Alicloud::Alicloudvpngateway::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudVpnGatewaySpec)(nil),       // 0: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec
	(*AliCloudVpnConnection)(nil),        // 1: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection
	(*AliCloudIkeConfig)(nil),            // 2: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudIkeConfig
	(*AliCloudIpsecConfig)(nil),          // 3: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudIpsecConfig
	(*AliCloudVpnHealthCheckConfig)(nil), // 4: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnHealthCheckConfig
	nil,                                  // 5: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.TagsEntry
	(*v1.StringValueOrRef)(nil),          // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 1: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5, // 2: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.tags:type_name -> dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.TagsEntry
	1, // 3: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnGatewaySpec.connections:type_name -> dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection
	2, // 4: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection.ike_config:type_name -> dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudIkeConfig
	3, // 5: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection.ipsec_config:type_name -> dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudIpsecConfig
	4, // 6: dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnConnection.health_check_config:type_name -> dev.planton.alicloud.alicloudvpngateway.v1alpha1.AliCloudVpnHealthCheckConfig
...
func init() { file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudvpngateway_v1alpha1_spec_proto_depIdxs = nil
}
