...
type Locals struct {
	AliCloudKubernetesNodePool *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePool
	ClusterId                  string
	VswitchIds                 []string
...
func initializeLocals(ctx *pulumi.Context, stackInput *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolStackInput) *Locals {
	locals := &Locals{}
...
func imageType(spec *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolSpec) string {
...
func systemDiskCategory(disk *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolSystemDisk) string {
...
func systemDiskSize(disk *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolSystemDisk) int {
...
func instanceChargeType(spec *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolSpec) string {
...
func installCloudMonitor(spec *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolSpec) bool {
