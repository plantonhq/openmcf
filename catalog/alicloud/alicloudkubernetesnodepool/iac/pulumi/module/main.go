...
func Resources(ctx *pulumi.Context, stackInput *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolStackInput) error {
...
func dataDisks(disks []*alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolDataDisk) cs.NodePoolDataDiskArray {
...
func nodeTaints(taints []*alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolTaint) cs.NodePoolTaintArray {
...
func scalingConfig(sc *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolScalingConfig) cs.NodePoolScalingConfigPtrInput {
	enable := true
	if sc.Enable != nil {
		enable = *sc.Enable
	}
...
func managementConfig(mgmt *alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolManagement) cs.NodePoolManagementPtrInput {
	enable := true
	if mgmt.Enable != nil {
		enable = *mgmt.Enable
	}
...
func spotPriceLimits(limits []*alicloudkubernetesnodepoolv1alpha1.AliCloudKubernetesNodePoolSpotPriceLimit) cs.NodePoolSpotPriceLimitArray {
