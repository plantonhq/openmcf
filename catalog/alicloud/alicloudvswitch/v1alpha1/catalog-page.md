...
- [AliCloudVpc](/docs/catalog/alicloud/alicloudvpc) — the parent VPC that this VSwitch belongs to
- [AliCloudSecurityGroup](/docs/catalog/alicloud/alicloudsecuritygroup) — controls network traffic for resources deployed in this VSwitch
- [AliCloudNatGateway](/docs/catalog/alicloud/alicloudnatgateway) — provides outbound internet access for resources in private VSwitches
- [AliCloudEcsInstance](/docs/catalog/alicloud/alicloudecsinstance) — launches compute instances in this VSwitch
