...
go build ./catalog/alicloud/alicloudceninstance/v1alpha1/iac/pulumi/...

# Go vet
go vet ./catalog/alicloud/alicloudceninstance/v1alpha1/iac/pulumi/...

# Spec tests
go test ./catalog/alicloud/alicloudceninstance/v1alpha1/...

# Terraform validation
cd catalog/alicloud/alicloudceninstance/v1alpha1/iac/tf
