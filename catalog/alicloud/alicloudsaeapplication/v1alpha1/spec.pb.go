...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudsaeapplication/v1alpha1/spec.proto
...
func (x *AliCloudSaeApplicationSpec) Reset() {
	*x = AliCloudSaeApplicationSpec{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudSaeApplicationSpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AliCloudSaeApplicationHealthCheck) Reset() {
	*x = AliCloudSaeApplicationHealthCheck{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSaeApplicationHealthCheck) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudSaeApplicationHttpGetAction) Reset() {
	*x = AliCloudSaeApplicationHttpGetAction{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSaeApplicationHttpGetAction) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudSaeApplicationTcpSocketAction) Reset() {
	*x = AliCloudSaeApplicationTcpSocketAction{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSaeApplicationTcpSocketAction) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudSaeApplicationExecAction) Reset() {
	*x = AliCloudSaeApplicationExecAction{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSaeApplicationExecAction) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AliCloudSaeApplicationCustomHostAlias) Reset() {
	*x = AliCloudSaeApplicationCustomHostAlias{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSaeApplicationCustomHostAlias) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AliCloudSaeApplicationUpdateStrategy) Reset() {
	*x = AliCloudSaeApplicationUpdateStrategy{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSaeApplicationUpdateStrategy) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AliCloudSaeApplicationBatchUpdate) Reset() {
	*x = AliCloudSaeApplicationBatchUpdate{}
	mi := &file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSaeApplicationBatchUpdate) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
var File_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";catalog/alicloud/alicloudsaeapplication/v1alpha1/spec.proto\x124dev.planton.alicloud.alicloudsaeapplication.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\xf9\x16\n" +
	...
	"\fcommand_args\x18\x10 \x03(\tR\vcommandArgs\x12n\n" +
	"\x04envs\x18\x11 \x03(\v2Z.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.EnvsEntryR\x04envs\x12\x10\n" +
	...
	"\x0facr_instance_id\x18\x19 \x01(\tR\racrInstanceId\x12s\n" +
	"\bliveness\x18\x1a \x01(\v2W.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheckR\bliveness\x12u\n" +
	"\treadiness\x18\x1b \x01(\v2W.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheckR\treadiness\x12\x8b\x01\n" +
	"\x13custom_host_aliases\x18\x1c \x03(\v2[.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationCustomHostAliasR\x11customHostAliases\x12\x83\x01\n" +
	"\x0fupdate_strategy\x18\x1d \x01(\v2Z.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationUpdateStrategyR\x0eupdateStrategy\x12\x1f\n" +
	"\vsls_configs\x18\x1e \x01(\tR\n" +
	"slsConfigs\x12n\n" +
	"\x04tags\x18\x1f \x03(\v2Z.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tEnvsEntry\x12\x10\n" +
	...
	"\x14_min_ready_instances\"\xe5\x05\n" +
	"!AliCloudSaeApplicationHealthCheck\x12t\n" +
	"\bhttp_get\x18\x01 \x01(\v2Y.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHttpGetActionR\ahttpGet\x12z\n" +
	"\n" +
	"tcp_socket\x18\x02 \x01(\v2[.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationTcpSocketActionR\ttcpSocket\x12j\n" +
	"\x04exec\x18\x03 \x01(\v2V.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationExecActionR\x04exec\x127\n" +
	...
	"\x02ip\x18\x02 \x01(\tR\x02ip\"\xd9\x02\n" +
	"$AliCloudSaeApplicationUpdateStrategy\x12\xab\x01\n" +
	"\x04type\x18\x01 \x01(\tB\x91\x01\xbaH\x8d\x01\xba\x01\x89\x01\n" +
	"\x1aupdate_strategy_type_valid\x121type must be one of: BatchUpdate, GrayBatchUpdate\x1a8this == '' || this in ['BatchUpdate', 'GrayBatchUpdate']H\x00R\x04type\x88\x01\x01\x12z\n" +
	"\fbatch_update\x18\x02 \x01(\v2W.dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationBatchUpdateR\vbatchUpdateB\a\n" +
	"\x05_type\"\xb4\x02\n" +
	...
	"\r_release_typeB\xa8\x03\n" +
	"8com.dev.planton.alicloud.alicloudsaeapplication.v1alpha1B\tSpecProtoP\x01Zlgithub.com/plantonhq/planton/catalog/alicloud/alicloudsaeapplication/v1alpha1;alicloudsaeapplicationv1alpha1\xa2\x02\x04DPAA\xaa\x024Dev.Planton.Alicloud.Alicloudsaeapplication.V1alpha1\xca\x024Dev\\Planton\\Alicloud\\Alicloudsaeapplication\\V1alpha1\xe2\x02@Dev\\Planton\\Alicloud\\Alicloudsaeapplication\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Alicloud::Alicloudsaeapplication::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudSaeApplicationSpec)(nil),            // 0: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec
	(*AliCloudSaeApplicationHealthCheck)(nil),     // 1: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheck
	(*AliCloudSaeApplicationHttpGetAction)(nil),   // 2: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHttpGetAction
	(*AliCloudSaeApplicationTcpSocketAction)(nil), // 3: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationTcpSocketAction
	(*AliCloudSaeApplicationExecAction)(nil),      // 4: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationExecAction
	(*AliCloudSaeApplicationCustomHostAlias)(nil), // 5: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationCustomHostAlias
	(*AliCloudSaeApplicationUpdateStrategy)(nil),  // 6: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationUpdateStrategy
	(*AliCloudSaeApplicationBatchUpdate)(nil),     // 7: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationBatchUpdate
	nil,                         // 8: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.EnvsEntry
	nil,                         // 9: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 10: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_depIdxs = []int32{
	10, // 0: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.vpc_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	10, // 1: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	10, // 2: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.security_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 3: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.envs:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.EnvsEntry
	1,  // 4: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.liveness:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheck
	1,  // 5: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.readiness:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheck
	5,  // 6: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.custom_host_aliases:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationCustomHostAlias
	6,  // 7: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.update_strategy:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationUpdateStrategy
	9,  // 8: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.tags:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationSpec.TagsEntry
	2,  // 9: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheck.http_get:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHttpGetAction
	3,  // 10: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheck.tcp_socket:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationTcpSocketAction
	4,  // 11: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationHealthCheck.exec:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationExecAction
	7,  // 12: dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationUpdateStrategy.batch_update:type_name -> dev.planton.alicloud.alicloudsaeapplication.v1alpha1.AliCloudSaeApplicationBatchUpdate
...
func init() { file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudsaeapplication_v1alpha1_spec_proto_depIdxs = nil
}
