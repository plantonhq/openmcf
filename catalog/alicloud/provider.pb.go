...
// 	protoc        (unknown)
// source: catalog/alicloud/provider.proto
...
func (AuthenticationType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_alicloud_provider_proto_enumTypes[0].Descriptor()
}

func (AuthenticationType) Type() protoreflect.EnumType {
	return &file_catalog_alicloud_provider_proto_enumTypes[0]
}
...
func (AuthenticationType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{0}
}
...
type AliCloudProviderConfig struct {
	...
	AuthenticationType AuthenticationType `protobuf:"varint,1,opt,name=authentication_type,json=authenticationType,proto3,enum=dev.planton.alicloud.AuthenticationType" json:"authentication_type,omitempty"`
...
func (x *AliCloudProviderConfig) Reset() {
	*x = AliCloudProviderConfig{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[0]
...
func (x *AliCloudStaticCredentials) Reset() {
	*x = AliCloudStaticCredentials{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudStaticCredentials) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{1}
}
...
func (x *AliCloudStsTokenCredentials) Reset() {
	*x = AliCloudStsTokenCredentials{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudStsTokenCredentials) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{2}
}
...
func (x *AliCloudEcsRoleCredentials) Reset() {
	*x = AliCloudEcsRoleCredentials{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudEcsRoleCredentials) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{3}
}
...
func (x *AliCloudAssumeRoleCredentials) Reset() {
	*x = AliCloudAssumeRoleCredentials{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudAssumeRoleCredentials) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{4}
}
...
func (x *AliCloudAssumeRoleWithOidcCredentials) Reset() {
	*x = AliCloudAssumeRoleWithOidcCredentials{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudAssumeRoleWithOidcCredentials) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{5}
}
...
func (x *AliCloudSharedCredentials) Reset() {
	*x = AliCloudSharedCredentials{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSharedCredentials) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{6}
}
...
func (x *AliCloudSidecarCredentials) Reset() {
	*x = AliCloudSidecarCredentials{}
	mi := &file_catalog_alicloud_provider_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AliCloudSidecarCredentials) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_provider_proto_rawDescGZIP(), []int{7}
}
...
var File_catalog_alicloud_provider_proto protoreflect.FileDescriptor

const file_catalog_alicloud_provider_proto_rawDesc = "" +
	"\n" +
	"\x1fcatalog/alicloud/provider.proto\x12\x14dev.planton.alicloud\x1a\x1bbuf/validate/validate.proto\"\xdb\x06\n" +
	"\x16AliCloudProviderConfig\x12a\n" +
	"\x13authentication_type\x18\x01 \x01(\x0e2(.dev.planton.alicloud.AuthenticationTypeB\x06\xbaH\x03\xc8\x01\x01R\x12authenticationType\x12\x16\n" +
	...
	" \x01(\v2/.dev.planton.alicloud.AliCloudStaticCredentialsR\x11staticCredentials\x12N\n" +
	"\tsts_token\x18\v \x01(\v21.dev.planton.alicloud.AliCloudStsTokenCredentialsR\bstsToken\x12K\n" +
	"\becs_role\x18\f \x01(\v20.dev.planton.alicloud.AliCloudEcsRoleCredentialsR\aecsRole\x12T\n" +
	"\vassume_role\x18\r \x01(\v23.dev.planton.alicloud.AliCloudAssumeRoleCredentialsR\n" +
	"assumeRole\x12n\n" +
	"\x15assume_role_with_oidc\x18\x0e \x01(\v2;.dev.planton.alicloud.AliCloudAssumeRoleWithOidcCredentialsR\x12assumeRoleWithOidc\x12^\n" +
	"\x12shared_credentials\x18\x0f \x01(\v2/.dev.planton.alicloud.AliCloudSharedCredentialsR\x11sharedCredentials\x12a\n" +
	"\x13sidecar_credentials\x18\x10 \x01(\v20.dev.planton.alicloud.AliCloudSidecarCredentialsR\x12sidecarCredentials\"i\n" +
	...
	"\x13sidecar_credentials\x10\aB\xca\x01\n" +
	"\x18com.dev.planton.alicloudB\rProviderProtoP\x01Z-github.com/plantonhq/planton/catalog/alicloud\xa2\x02\x03DPA\xaa\x02\x14Dev.Planton.Alicloud\xca\x02\x14Dev\\Planton\\Alicloud\xe2\x02 Dev\\Planton\\Alicloud\\GPBMetadata\xea\x02\x16Dev::Planton::Alicloudb\x06proto3"

var (
	file_catalog_alicloud_provider_proto_rawDescOnce sync.Once
	file_catalog_alicloud_provider_proto_rawDescData []byte
)

func file_catalog_alicloud_provider_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_provider_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_provider_proto_rawDesc), len(file_catalog_alicloud_provider_proto_rawDesc)))
	})
	return file_catalog_alicloud_provider_proto_rawDescData
}

var file_catalog_alicloud_provider_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_catalog_alicloud_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_catalog_alicloud_provider_proto_goTypes = []any{
	(AuthenticationType)(0),                       // 0: dev.planton.alicloud.AuthenticationType
	(*AliCloudProviderConfig)(nil),                // 1: dev.planton.alicloud.AliCloudProviderConfig
	(*AliCloudStaticCredentials)(nil),             // 2: dev.planton.alicloud.AliCloudStaticCredentials
	(*AliCloudStsTokenCredentials)(nil),           // 3: dev.planton.alicloud.AliCloudStsTokenCredentials
	(*AliCloudEcsRoleCredentials)(nil),            // 4: dev.planton.alicloud.AliCloudEcsRoleCredentials
	(*AliCloudAssumeRoleCredentials)(nil),         // 5: dev.planton.alicloud.AliCloudAssumeRoleCredentials
	(*AliCloudAssumeRoleWithOidcCredentials)(nil), // 6: dev.planton.alicloud.AliCloudAssumeRoleWithOidcCredentials
	(*AliCloudSharedCredentials)(nil),             // 7: dev.planton.alicloud.AliCloudSharedCredentials
	(*AliCloudSidecarCredentials)(nil),            // 8: dev.planton.alicloud.AliCloudSidecarCredentials
}
var file_catalog_alicloud_provider_proto_depIdxs = []int32{
	0, // 0: dev.planton.alicloud.AliCloudProviderConfig.authentication_type:type_name -> dev.planton.alicloud.AuthenticationType
	2, // 1: dev.planton.alicloud.AliCloudProviderConfig.static_credentials:type_name -> dev.planton.alicloud.AliCloudStaticCredentials
	3, // 2: dev.planton.alicloud.AliCloudProviderConfig.sts_token:type_name -> dev.planton.alicloud.AliCloudStsTokenCredentials
	4, // 3: dev.planton.alicloud.AliCloudProviderConfig.ecs_role:type_name -> dev.planton.alicloud.AliCloudEcsRoleCredentials
	5, // 4: dev.planton.alicloud.AliCloudProviderConfig.assume_role:type_name -> dev.planton.alicloud.AliCloudAssumeRoleCredentials
	6, // 5: dev.planton.alicloud.AliCloudProviderConfig.assume_role_with_oidc:type_name -> dev.planton.alicloud.AliCloudAssumeRoleWithOidcCredentials
	7, // 6: dev.planton.alicloud.AliCloudProviderConfig.shared_credentials:type_name -> dev.planton.alicloud.AliCloudSharedCredentials
	8, // 7: dev.planton.alicloud.AliCloudProviderConfig.sidecar_credentials:type_name -> dev.planton.alicloud.AliCloudSidecarCredentials
...
func init() { file_catalog_alicloud_provider_proto_init() }
func file_catalog_alicloud_provider_proto_init() {
	if File_catalog_alicloud_provider_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_provider_proto_rawDesc), len(file_catalog_alicloud_provider_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_provider_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_provider_proto_depIdxs,
		EnumInfos:         file_catalog_alicloud_provider_proto_enumTypes,
		MessageInfos:      file_catalog_alicloud_provider_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_provider_proto = out.File
	file_catalog_alicloud_provider_proto_goTypes = nil
	file_catalog_alicloud_provider_proto_depIdxs = nil
}
