...
go build ./catalog/alicloud/alicloudredisinstance/iac/pulumi/...

# Go vet
go vet ./catalog/alicloud/alicloudredisinstance/iac/pulumi/...

# Spec tests
go test ./catalog/alicloud/alicloudredisinstance/v1alpha1/...

# Terraform validation
cd catalog/alicloud/alicloudredisinstance/iac/tf
