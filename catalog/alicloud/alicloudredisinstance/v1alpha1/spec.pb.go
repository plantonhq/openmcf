...
// 	protoc        (unknown)
// source: catalog/alicloud/alicloudredisinstance/v1alpha1/spec.proto
...
func (x *AliCloudRedisInstanceSpec) Reset() {
	*x = AliCloudRedisInstanceSpec{}
	mi := &file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*AliCloudRedisInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":catalog/alicloud/alicloudredisinstance/v1alpha1/spec.proto\x123dev.planton.alicloud.alicloudredisinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xf3\x17\n" +
	...
	"\x11resource_group_id\x18\r \x01(\tR\x0fresourceGroupId\x12l\n" +
	"\x04tags\x18\x0e \x03(\v2X.dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.TagsEntryR\x04tags\x12-\n" +
	...
	"\x13vpc_auth_mode_valid\x12)vpc_auth_mode must be one of: Open, Close\x1a'this == '' || this in ['Open', 'Close']\x8a\xa6\x1d\x04OpenH\aR\vvpcAuthMode\x88\x01\x01\x12r\n" +
	"\x06config\x18\x15 \x03(\v2Z.dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.ConfigEntryR\x06config\x12C\n" +
	...
	"\a_periodB\xa1\x03\n" +
	"7com.dev.planton.alicloud.alicloudredisinstance.v1alpha1B\tSpecProtoP\x01Zjgithub.com/plantonhq/planton/catalog/alicloud/alicloudredisinstance/v1alpha1;alicloudredisinstancev1alpha1\xa2\x02\x04DPAA\xaa\x023Dev.Planton.Alicloud.Alicloudredisinstance.V1alpha1\xca\x023Dev\\Planton\\Alicloud\\Alicloudredisinstance\\V1alpha1\xe2\x02?Dev\\Planton\\Alicloud\\Alicloudredisinstance\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Alicloud::Alicloudredisinstance::V1alpha1b\x06proto3"

var (
	file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDescData
}

var file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_goTypes = []any{
	(*AliCloudRedisInstanceSpec)(nil), // 0: dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec
	nil,                               // 1: dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.TagsEntry
	nil,                               // 2: dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.ConfigEntry
	(*v1.StringValueOrRef)(nil),       // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.vswitch_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.tags:type_name -> dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.TagsEntry
	2, // 2: dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.config:type_name -> dev.planton.alicloud.alicloudredisinstance.v1alpha1.AliCloudRedisInstanceSpec.ConfigEntry
...
func init() { file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_init() }
func file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_init() {
	if File_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto = out.File
	file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_alicloud_alicloudredisinstance_v1alpha1_spec_proto_depIdxs = nil
}
