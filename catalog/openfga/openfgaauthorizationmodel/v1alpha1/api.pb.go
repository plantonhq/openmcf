...
const file_catalog_openfga_openfgaauthorizationmodel_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"<catalog/openfga/openfgaauthorizationmodel/v1alpha1/api.proto\x126dev.planton.openfga.openfgaauthorizationmodel.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a@catalog/openfga/openfgaauthorizationmodel/v1alpha1/outputs.proto\x1a=catalog/openfga/openfgaauthorizationmodel/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\xca\x03\n" +
...
func file_catalog_openfga_openfgaauthorizationmodel_v1alpha1_api_proto_init() {
	...
	file_catalog_openfga_openfgaauthorizationmodel_v1alpha1_outputs_proto_init()
