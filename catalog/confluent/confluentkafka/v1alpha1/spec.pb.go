...
// 	protoc        (unknown)
// source: catalog/confluent/confluentkafka/v1alpha1/spec.proto
...
func (x *ConfluentKafkaSpec) Reset() {
	*x = ConfluentKafkaSpec{}
	mi := &file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_msgTypes[0]
...
func (*ConfluentKafkaSpec) Descriptor() ([]byte, []int) {
	return file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConfluentKafkaDedicatedConfig) Reset() {
	*x = ConfluentKafkaDedicatedConfig{}
	mi := &file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfluentKafkaDedicatedConfig) Descriptor() ([]byte, []int) {
	return file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ConfluentKafkaNetworkConfig) Reset() {
	*x = ConfluentKafkaNetworkConfig{}
	mi := &file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfluentKafkaNetworkConfig) Descriptor() ([]byte, []int) {
	return file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_confluent_confluentkafka_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"4catalog/confluent/confluentkafka/v1alpha1/spec.proto\x12-dev.planton.confluent.confluentkafka.v1alpha1\x1a\x1bbuf/validate/validate.proto\"\xd2\x04\n" +
	...
	"ENTERPRISER\tDEDICATEDR\vclusterType\x12w\n" +
	"\x10dedicated_config\x18\x06 \x01(\v2L.dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaDedicatedConfigR\x0fdedicatedConfig\x12q\n" +
	"\x0enetwork_config\x18\a \x01(\v2J.dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaNetworkConfigR\rnetworkConfig\x12!\n" +
	...
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\tnetworkIdB\xf6\x02\n" +
	"1com.dev.planton.confluent.confluentkafka.v1alpha1B\tSpecProtoP\x01Z]github.com/plantonhq/planton/catalog/confluent/confluentkafka/v1alpha1;confluentkafkav1alpha1\xa2\x02\x04DPCC\xaa\x02-Dev.Planton.Confluent.Confluentkafka.V1alpha1\xca\x02-Dev\\Planton\\Confluent\\Confluentkafka\\V1alpha1\xe2\x029Dev\\Planton\\Confluent\\Confluentkafka\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Confluent::Confluentkafka::V1alpha1b\x06proto3"

var (
	file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDesc), len(file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDescData
}

var file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_goTypes = []any{
	(*ConfluentKafkaSpec)(nil),            // 0: dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaSpec
	(*ConfluentKafkaDedicatedConfig)(nil), // 1: dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaDedicatedConfig
	(*ConfluentKafkaNetworkConfig)(nil),   // 2: dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaNetworkConfig
}
var file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaSpec.dedicated_config:type_name -> dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaDedicatedConfig
	2, // 1: dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaSpec.network_config:type_name -> dev.planton.confluent.confluentkafka.v1alpha1.ConfluentKafkaNetworkConfig
...
func init() { file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_init() }
func file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_init() {
	if File_catalog_confluent_confluentkafka_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDesc), len(file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_confluent_confluentkafka_v1alpha1_spec_proto = out.File
	file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_goTypes = nil
	file_catalog_confluent_confluentkafka_v1alpha1_spec_proto_depIdxs = nil
}
