...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesoteloperator/v1alpha1/spec.proto
...
func (x *KubernetesOtelOperatorSpec) Reset() {
	*x = KubernetesOtelOperatorSpec{}
	mi := &file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesOtelOperatorSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\tresources\x18\b \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x126\n" +
	"\x17service_monitor_enabled\x18\t \x01(\bR\x15serviceMonitorEnabled\x12%\n" +
	"\x0eimage_registry\x18\n" +
	" \x01(\tR\rimageRegistry\x12x\n" +
	"\x12image_pull_secrets\x18\v \x03(\tBJ\xaa\xa6\x1dFNames of existing image-pull Secrets (references), not secret materialR\x10imagePullSecrets\x12x\n" +
	"\n" +
	...
	"\x04name\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\"\xf3\x02\n" +
	" KubernetesOtelOperatorScheduling\x12\x8f\x01\n" +
	"\rnode_selector\x18\x01 \x03(\v2j.dev.planton.kubernetes.kubernetesoteloperator.v1alpha1.KubernetesOtelOperatorScheduling.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xb4\x03\n" +
	":com.dev.planton.kubernetes.kubernetesoteloperator.v1alpha1B\tSpecProtoP\x01Zngithub.com/plantonhq/planton/catalog/kubernetes/kubernetesoteloperator/v1alpha1;kubernetesoteloperatorv1alpha1\xa2\x02\x04DPKK\xaa\x026Dev.Planton.Kubernetes.Kubernetesoteloperator.V1alpha1\xca\x026Dev\\Planton\\Kubernetes\\Kubernetesoteloperator\\V1alpha1\xe2\x02BDev\\Planton\\Kubernetes\\Kubernetesoteloperator\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Kubernetes::Kubernetesoteloperator::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesoteloperator_v1alpha1_spec_proto_depIdxs = nil
}
