...
type Locals struct {
	Spec *kuberneteskafkav1alpha1.KubernetesKafkaSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kuberneteskafkav1alpha1.KubernetesKafkaStackInput) *Locals {
