...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesopensearchoperator/v1alpha1/spec.proto
...
func (x *KubernetesOpenSearchOperatorSpec) Reset() {
	*x = KubernetesOpenSearchOperatorSpec{}
	mi := &file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesOpenSearchOperatorSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDesc = "" +
	...
	" \x01(\bB\b\x8a\xa6\x1d\x04trueH\x04R\x14kubeRbacProxyEnabled\x88\x01\x01\x12H\n" +
	"\tresources\x18\v \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x12\x95\x01\n" +
	"\rnode_selector\x18\f \x03(\v2p.dev.planton.kubernetes.kubernetesopensearchoperator.v1alpha1.KubernetesOpenSearchOperatorSpec.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	...
	"repository\x12\x10\n" +
	"\x03tag\x18\x02 \x01(\tR\x03tagB\xde\x03\n" +
	"@com.dev.planton.kubernetes.kubernetesopensearchoperator.v1alpha1B\tSpecProtoP\x01Zzgithub.com/plantonhq/planton/catalog/kubernetes/kubernetesopensearchoperator/v1alpha1;kubernetesopensearchoperatorv1alpha1\xa2\x02\x04DPKK\xaa\x02<Dev.Planton.Kubernetes.Kubernetesopensearchoperator.V1alpha1\xca\x02<Dev\\Planton\\Kubernetes\\Kubernetesopensearchoperator\\V1alpha1\xe2\x02HDev\\Planton\\Kubernetes\\Kubernetesopensearchoperator\\V1alpha1\\GPBMetadata\xea\x02@Dev::Planton::Kubernetes::Kubernetesopensearchoperator::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesopensearchoperator_v1alpha1_spec_proto_depIdxs = nil
}
