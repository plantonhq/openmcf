...
func buildHelmValues(locals *Locals) (map[string]interface{}, error) {
	...
	if service := spec.GetService(); service != nil {
		...
		case kubernetesnatsv1alpha1.KubernetesNatsService_load_balancer:
			serviceMerge["spec"] = map[string]interface{}{"type": "LoadBalancer"}
		case kubernetesnatsv1alpha1.KubernetesNatsService_node_port:
...
func userEntry(u *kubernetesnatsv1alpha1.KubernetesNatsUser, envVar string) map[string]interface{} {
