...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesdaemonset/v1alpha1/spec.proto
...
func (x *KubernetesDaemonSetSpec) Reset() {
	*x = KubernetesDaemonSetSpec{}
	mi := &file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesDaemonSetSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesDaemonSetContainer) Reset() {
	*x = KubernetesDaemonSetContainer{}
	mi := &file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDaemonSetContainer) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesDaemonSetUpdateStrategy) Reset() {
	*x = KubernetesDaemonSetUpdateStrategy{}
	mi := &file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDaemonSetUpdateStrategy) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":catalog/kubernetes/kubernetesdaemonset/v1alpha1/spec.proto\x123dev.planton.kubernetes.kubernetesdaemonset.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a+catalog/kubernetes/workload_container.proto\x1a%catalog/kubernetes/workload_pod.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\x90\x05\n" +
	"\x17KubernetesDaemonSetSpec\x12j\n" +
	"\tnamespace\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x18\xbaH\x03\xc8\x01\x01\x88\xd4a\xa0\x1f\x92\xd4a\tspec.nameR\tnamespace\x12)\n" +
	"\x10create_namespace\x18\x02 \x01(\bR\x0fcreateNamespace\x12w\n" +
	"\tcontainer\x18\x03 \x01(\v2Q.dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x125\n" +
	"\x03pod\x18\x04 \x01(\v2#.dev.planton.kubernetes.WorkloadPodR\x03pod\x12\x7f\n" +
	"\x0fupdate_strategy\x18\x05 \x01(\v2V.dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetUpdateStrategyR\x0eupdateStrategy\x128\n" +
	...
	"\x17_revision_history_limit\"\x97\x02\n" +
	"\x1cKubernetesDaemonSetContainer\x12C\n" +
	...
	"\"spec.update_strategy.not_both_zero\x12_max_unavailable and max_surge cannot both be 0 — the rollout would be unable to make progress\x1aG!(this.max_unavailable in ['0', '0%'] && this.max_surge in ['0', '0%'])B\x9f\x03\n" +
	"7com.dev.planton.kubernetes.kubernetesdaemonset.v1alpha1B\tSpecProtoP\x01Zhgithub.com/plantonhq/planton/catalog/kubernetes/kubernetesdaemonset/v1alpha1;kubernetesdaemonsetv1alpha1\xa2\x02\x04DPKK\xaa\x023Dev.Planton.Kubernetes.Kubernetesdaemonset.V1alpha1\xca\x023Dev\\Planton\\Kubernetes\\Kubernetesdaemonset\\V1alpha1\xe2\x02?Dev\\Planton\\Kubernetes\\Kubernetesdaemonset\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Kubernetes::Kubernetesdaemonset::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesDaemonSetSpec)(nil),           // 0: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetSpec
	(*KubernetesDaemonSetContainer)(nil),      // 1: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetContainer
	(*KubernetesDaemonSetUpdateStrategy)(nil), // 2: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetUpdateStrategy
	(*v1.StringValueOrRef)(nil),               // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*kubernetes.WorkloadPod)(nil),            // 4: dev.planton.kubernetes.WorkloadPod
	(*kubernetes.WorkloadContainer)(nil),      // 5: dev.planton.kubernetes.WorkloadContainer
}
var file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetSpec.container:type_name -> dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetContainer
	4, // 2: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetSpec.pod:type_name -> dev.planton.kubernetes.WorkloadPod
	2, // 3: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetSpec.update_strategy:type_name -> dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetUpdateStrategy
	5, // 4: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetContainer.app:type_name -> dev.planton.kubernetes.WorkloadContainer
	5, // 5: dev.planton.kubernetes.kubernetesdaemonset.v1alpha1.KubernetesDaemonSetContainer.sidecars:type_name -> dev.planton.kubernetes.WorkloadContainer
...
func init() { file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesdaemonset_v1alpha1_spec_proto_depIdxs = nil
}
