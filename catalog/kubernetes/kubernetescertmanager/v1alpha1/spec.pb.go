...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetescertmanager/v1alpha1/spec.proto
...
func (x *KubernetesCertManagerSpec) Reset() {
	*x = KubernetesCertManagerSpec{}
	mi := &file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesCertManagerSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesCertManagerCrds) Reset() {
	*x = KubernetesCertManagerCrds{}
	mi := &file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerCrds) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesCertManagerDns01SelfCheck) Reset() {
	*x = KubernetesCertManagerDns01SelfCheck{}
	mi := &file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerDns01SelfCheck) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesCertManagerPrometheus) Reset() {
	*x = KubernetesCertManagerPrometheus{}
	mi := &file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerPrometheus) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesCertManagerWebhook) Reset() {
	*x = KubernetesCertManagerWebhook{}
	mi := &file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerWebhook) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesCertManagerCainjector) Reset() {
	*x = KubernetesCertManagerCainjector{}
	mi := &file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerCainjector) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesCertManagerStartupApiCheck) Reset() {
	*x = KubernetesCertManagerStartupApiCheck{}
	mi := &file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertManagerStartupApiCheck) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"<catalog/kubernetes/kubernetescertmanager/v1alpha1/spec.proto\x125dev.planton.kubernetes.kubernetescertmanager.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a#catalog/kubernetes/kubernetes.proto\x1a*catalog/kubernetes/workload_identity.proto\x1a%catalog/kubernetes/workload_pod.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xb3\x11\n" +
	...
	"\rchart_version\x18\x03 \x01(\tB\v\x8a\xa6\x1d\av1.20.3H\x00R\fchartVersion\x88\x01\x01\x12d\n" +
	"\x04crds\x18\x04 \x01(\v2P.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCrdsR\x04crds\x12-\n" +
	"\breplicas\x18\x05 \x01(\x05B\f\xbaH\x04\x1a\x02(\x01\x8a\xa6\x1d\x011H\x01R\breplicas\x88\x01\x01\x12H\n" +
	"\tresources\x18\x06 \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x120\n" +
	...
	" \x01(\bR\x19enableCertificateOwnerRef\x12\x87\x01\n" +
	"\rfeature_gates\x18\v \x03(\v2b.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.FeatureGatesEntryR\ffeatureGates\x12\x84\x01\n" +
	"\x10dns01_self_check\x18\f \x01(\v2Z.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerDns01SelfCheckR\x0edns01SelfCheck\x12N\n" +
	"\x19max_concurrent_challenges\x18\r \x01(\x05B\r\xbaH\x04\x1a\x02(\x01\x8a\xa6\x1d\x0260H\x04R\x17maxConcurrentChallenges\x88\x01\x01\x12_\n" +
	"\x11workload_identity\x18\x0e \x01(\v22.dev.planton.kubernetes.KubernetesWorkloadIdentityR\x10workloadIdentity\x12%\n" +
	"\x0eimage_registry\x18\x0f \x01(\tR\rimageRegistry\x12v\n" +
	"\n" +
	"prometheus\x18\x10 \x01(\v2V.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheusR\n" +
	"prometheus\x12\x87\x01\n" +
	"\rnode_selector\x18\x11 \x03(\v2b.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	"\vtolerations\x18\x12 \x03(\v2*.dev.planton.kubernetes.WorkloadTolerationR\vtolerations\x122\n" +
	"\x15pod_disruption_budget\x18\x13 \x01(\bR\x13podDisruptionBudget\x12m\n" +
	"\awebhook\x18\x14 \x01(\v2S.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhookR\awebhook\x12v\n" +
	"\n" +
	"cainjector\x18\x15 \x01(\v2V.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjectorR\n" +
	"cainjector\x12\x85\x01\n" +
	"\x0fstartupapicheck\x18\x16 \x01(\v2[.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerStartupApiCheckR\x0fstartupapicheck\x12\x1f\n" +
	...
	"\x1bdns01.only_requires_servers\x12\x93\x01recursive_nameservers_only requires recursive_nameservers to be set — 'only' restricts lookups to the configured resolvers, so there must be some\x1aH!this.recursive_nameservers_only || size(this.recursive_nameservers) > 0\"\xd6\x03\n" +
	...
	"\x18service_monitor_interval\x18\x03 \x01(\tB\a\x8a\xa6\x1d\x0360sH\x01R\x16serviceMonitorInterval\x88\x01\x01\x12\xa6\x01\n" +
	"\x16service_monitor_labels\x18\x04 \x03(\v2p.dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.ServiceMonitorLabelsEntryR\x14serviceMonitorLabels\x1aG\n" +
	"\x19ServiceMonitorLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\n" +
	"\n" +
	"\b_enabledB\x1b\n" +
	"\x19_service_monitor_interval\"\xe6\x02\n" +
	...
	"securePort\x88\x01\x01\x12H\n" +
	"\tresources\x18\x05 \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresourcesB\v\n" +
	"\t_replicasB\x12\n" +
	"\x10_timeout_secondsB\x0e\n" +
	"\f_secure_port\"\xdc\x01\n" +
	...
	"\n" +
	"\b_timeoutB\xad\x03\n" +
	"9com.dev.planton.kubernetes.kubernetescertmanager.v1alpha1B\tSpecProtoP\x01Zlgithub.com/plantonhq/planton/catalog/kubernetes/kubernetescertmanager/v1alpha1;kubernetescertmanagerv1alpha1\xa2\x02\x04DPKK\xaa\x025Dev.Planton.Kubernetes.Kubernetescertmanager.V1alpha1\xca\x025Dev\\Planton\\Kubernetes\\Kubernetescertmanager\\V1alpha1\xe2\x02ADev\\Planton\\Kubernetes\\Kubernetescertmanager\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Kubernetes::Kubernetescertmanager::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesCertManagerSpec)(nil),            // 0: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec
	(*KubernetesCertManagerCrds)(nil),            // 1: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCrds
	(*KubernetesCertManagerDns01SelfCheck)(nil),  // 2: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerDns01SelfCheck
	(*KubernetesCertManagerPrometheus)(nil),      // 3: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus
	(*KubernetesCertManagerWebhook)(nil),         // 4: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhook
	(*KubernetesCertManagerCainjector)(nil),      // 5: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjector
	(*KubernetesCertManagerStartupApiCheck)(nil), // 6: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerStartupApiCheck
	nil,                                   // 7: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.FeatureGatesEntry
	nil,                                   // 8: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.NodeSelectorEntry
	nil,                                   // 9: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.ServiceMonitorLabelsEntry
...
var file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_depIdxs = []int32{
	10, // 0: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.crds:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCrds
	11, // 2: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.resources:type_name -> dev.planton.kubernetes.ContainerResources
	7,  // 3: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.feature_gates:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.FeatureGatesEntry
	2,  // 4: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.dns01_self_check:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerDns01SelfCheck
	12, // 5: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.workload_identity:type_name -> dev.planton.kubernetes.KubernetesWorkloadIdentity
	3,  // 6: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.prometheus:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus
	8,  // 7: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.node_selector:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.NodeSelectorEntry
	13, // 8: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.tolerations:type_name -> dev.planton.kubernetes.WorkloadToleration
	4,  // 9: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.webhook:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhook
	5,  // 10: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.cainjector:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjector
	6,  // 11: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerSpec.startupapicheck:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerStartupApiCheck
	9,  // 12: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.service_monitor_labels:type_name -> dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerPrometheus.ServiceMonitorLabelsEntry
	11, // 13: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerWebhook.resources:type_name -> dev.planton.kubernetes.ContainerResources
	11, // 14: dev.planton.kubernetes.kubernetescertmanager.v1alpha1.KubernetesCertManagerCainjector.resources:type_name -> dev.planton.kubernetes.ContainerResources
...
func init() { file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetescertmanager_v1alpha1_spec_proto_depIdxs = nil
}
