...
func buildConfigPatchArgs(patch *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterConfigPatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesArgs {
...
// when set.
func buildMatchArgs(match *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterEnvoyConfigObjectMatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesMatchArgs {
...
func buildWaypointMatchArgs(waypoint *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterWaypointMatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesMatchWaypointArgs {
...
func buildClusterMatchArgs(cluster *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterClusterMatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesMatchClusterArgs {
...
func buildRouteConfigurationMatchArgs(rc *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterRouteConfigurationMatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesMatchRouteConfigurationArgs {
...
func buildListenerMatchArgs(listener *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterListenerMatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesMatchListenerArgs {
...
func buildFilterChainMatchArgs(fc *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterFilterChainMatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesMatchListenerFilterChainArgs {
...
func buildPatchArgs(p *kubernetesenvoyfilterv1alpha1.KubernetesEnvoyFilterPatch) istionetworkingv1alpha3.EnvoyFilterSpecConfigPatchesPatchArgs {
