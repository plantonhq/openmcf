...
#
# Thin projection of the networking.istio.io/v1alpha3 "EnvoyFilter" custom resource.
#
...
variable "spec" {
  description = "Spec for the networking.istio.io/v1alpha3 \"EnvoyFilter\" custom resource, passed through verbatim to kubectl_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
