...
// 	protoc        (unknown)
// source: catalog/kubernetes/istio_api.proto
...
func (x *KubernetesIstioApiWorkloadSelector) Reset() {
	*x = KubernetesIstioApiWorkloadSelector{}
	mi := &file_catalog_kubernetes_istio_api_proto_msgTypes[0]
...
func (*KubernetesIstioApiWorkloadSelector) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_istio_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesIstioApiNetworkingWorkloadSelector) Reset() {
	*x = KubernetesIstioApiNetworkingWorkloadSelector{}
	mi := &file_catalog_kubernetes_istio_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesIstioApiNetworkingWorkloadSelector) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_istio_api_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesIstioApiPortSelector) Reset() {
	*x = KubernetesIstioApiPortSelector{}
	mi := &file_catalog_kubernetes_istio_api_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesIstioApiPortSelector) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_istio_api_proto_rawDescGZIP(), []int{2}
}
...
// Istio models this as a `oneof { exact, prefix, regex }` (all same-type), so Planton
...
func (x *KubernetesIstioApiStringMatch) Reset() {
	*x = KubernetesIstioApiStringMatch{}
	mi := &file_catalog_kubernetes_istio_api_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesIstioApiStringMatch) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_istio_api_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesIstioApiPolicyTargetReference) Reset() {
	*x = KubernetesIstioApiPolicyTargetReference{}
	mi := &file_catalog_kubernetes_istio_api_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesIstioApiPolicyTargetReference) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_istio_api_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_kubernetes_istio_api_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_istio_api_proto_rawDesc = "" +
	"\n" +
	"\"catalog/kubernetes/istio_api.proto\x12\x16dev.planton.kubernetes\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\x8d\x05\n" +
	"\"KubernetesIstioApiWorkloadSelector\x12\xa6\x04\n" +
	"\fmatch_labels\x18\x01 \x03(\v2K.dev.planton.kubernetes.KubernetesIstioApiWorkloadSelector.MatchLabelsEntryB\xb5\x03\xbaH\xb1\x03\xba\x01x\n" +
	...
	",KubernetesIstioApiNetworkingWorkloadSelector\x12\x9a\x02\n" +
	"\x06labels\x18\x01 \x03(\v2P.dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelector.LabelsEntryB\xaf\x01\xbaH\xab\x01\xba\x01\x9b\x01\n" +
	...
	"0istio_policy_target_reference.no_cross_namespace\x12Jcross-namespace target references are not supported; leave namespace empty\x1a\x10this.size() == 0R\tnamespaceB\xd6\x01\n" +
	"\x1acom.dev.planton.kubernetesB\rIstioApiProtoP\x01Z/github.com/plantonhq/planton/catalog/kubernetes\xa2\x02\x03DPK\xaa\x02\x16Dev.Planton.Kubernetes\xca\x02\x16Dev\\Planton\\Kubernetes\xe2\x02\"Dev\\Planton\\Kubernetes\\GPBMetadata\xea\x02\x18Dev::Planton::Kubernetesb\x06proto3"

var (
	file_catalog_kubernetes_istio_api_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_istio_api_proto_rawDescData []byte
)

func file_catalog_kubernetes_istio_api_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_istio_api_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_istio_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_istio_api_proto_rawDesc), len(file_catalog_kubernetes_istio_api_proto_rawDesc)))
	})
	return file_catalog_kubernetes_istio_api_proto_rawDescData
}

var file_catalog_kubernetes_istio_api_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_catalog_kubernetes_istio_api_proto_goTypes = []any{
	(*KubernetesIstioApiWorkloadSelector)(nil),           // 0: dev.planton.kubernetes.KubernetesIstioApiWorkloadSelector
	(*KubernetesIstioApiNetworkingWorkloadSelector)(nil), // 1: dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelector
	(*KubernetesIstioApiPortSelector)(nil),               // 2: dev.planton.kubernetes.KubernetesIstioApiPortSelector
	(*KubernetesIstioApiStringMatch)(nil),                // 3: dev.planton.kubernetes.KubernetesIstioApiStringMatch
	(*KubernetesIstioApiPolicyTargetReference)(nil),      // 4: dev.planton.kubernetes.KubernetesIstioApiPolicyTargetReference
	nil,                         // 5: dev.planton.kubernetes.KubernetesIstioApiWorkloadSelector.MatchLabelsEntry
	nil,                         // 6: dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelector.LabelsEntry
	(*v1.StringValueOrRef)(nil), // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_kubernetes_istio_api_proto_depIdxs = []int32{
	5, // 0: dev.planton.kubernetes.KubernetesIstioApiWorkloadSelector.match_labels:type_name -> dev.planton.kubernetes.KubernetesIstioApiWorkloadSelector.MatchLabelsEntry
	6, // 1: dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelector.labels:type_name -> dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelector.LabelsEntry
	7, // 2: dev.planton.kubernetes.KubernetesIstioApiPolicyTargetReference.name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_kubernetes_istio_api_proto_init() }
func file_catalog_kubernetes_istio_api_proto_init() {
	if File_catalog_kubernetes_istio_api_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_istio_api_proto_rawDesc), len(file_catalog_kubernetes_istio_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_istio_api_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_istio_api_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_istio_api_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_istio_api_proto = out.File
	file_catalog_kubernetes_istio_api_proto_goTypes = nil
	file_catalog_kubernetes_istio_api_proto_depIdxs = nil
}
