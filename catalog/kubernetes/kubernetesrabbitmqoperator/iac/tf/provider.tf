# Provider requirements for the KubernetesRabbitMqOperator module.
#
...
# and server-side apply carries the ~342 KB CRD document past the
# client-side annotation cap. The http provider fetches the released
# manifest from the pinned tag.
#
