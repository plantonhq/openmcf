...
func deploymentTransformation(spec *kubernetesrabbitmqoperatorv1alpha1.KubernetesRabbitMqOperatorSpec) func(state map[string]interface{}, opts ...pulumi.ResourceOption) {
...
func extraEnvEntries(spec *kubernetesrabbitmqoperatorv1alpha1.KubernetesRabbitMqOperatorSpec) []interface{} {
	entries := []interface{}{}
...
func pullSecretNames(spec *kubernetesrabbitmqoperatorv1alpha1.KubernetesRabbitMqOperatorSpec) []string {
...
func resolveOperatorImage(spec *kubernetesrabbitmqoperatorv1alpha1.KubernetesRabbitMqOperatorSpec) string {
...
func resourcesMap(spec *kubernetesrabbitmqoperatorv1alpha1.KubernetesRabbitMqOperatorSpec) map[string]interface{} {
...
func tolerationsSlice(spec *kubernetesrabbitmqoperatorv1alpha1.KubernetesRabbitMqOperatorSpec) []interface{} {
