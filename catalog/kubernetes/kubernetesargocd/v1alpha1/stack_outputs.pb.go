...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesargocd/v1alpha1/stack_outputs.proto
...
func (x *KubernetesArgocdStackOutputs) Reset() {
	*x = KubernetesArgocdStackOutputs{}
	mi := &file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesArgocdStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"@catalog/kubernetes/kubernetesargocd/v1alpha1/stack_outputs.proto\x120dev.planton.kubernetes.kubernetesargocd.v1alpha1\"\xa5\x02\n" +
	...
	"4com.dev.planton.kubernetes.kubernetesargocd.v1alpha1B\x11StackOutputsProtoP\x01Zbgithub.com/plantonhq/planton/catalog/kubernetes/kubernetesargocd/v1alpha1;kubernetesargocdv1alpha1\xa2\x02\x04DPKK\xaa\x020Dev.Planton.Kubernetes.Kubernetesargocd.V1alpha1\xca\x020Dev\\Planton\\Kubernetes\\Kubernetesargocd\\V1alpha1\xe2\x02<Dev\\Planton\\Kubernetes\\Kubernetesargocd\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Kubernetes::Kubernetesargocd::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*KubernetesArgocdStackOutputs)(nil), // 0: dev.planton.kubernetes.kubernetesargocd.v1alpha1.KubernetesArgocdStackOutputs
}
var file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_init() }
func file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto = out.File
	file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesargocd_v1alpha1_stack_outputs_proto_depIdxs = nil
}
