...
func autoscalingBlock(a *kubernetesargocdv1alpha1.KubernetesArgocdAutoscaling) map[string]interface{} {
...
func toggleableBlock(c *kubernetesargocdv1alpha1.KubernetesArgocdToggleableComponent) map[string]interface{} {
