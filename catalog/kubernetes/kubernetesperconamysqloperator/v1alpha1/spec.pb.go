...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesperconamysqloperator/v1alpha1/spec.proto
...
func (x *KubernetesPerconaMysqlOperatorSpec) Reset() {
	*x = KubernetesPerconaMysqlOperatorSpec{}
	mi := &file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesPerconaMysqlOperatorSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesPerconaMysqlOperatorWatch) Reset() {
	*x = KubernetesPerconaMysqlOperatorWatch{}
	mi := &file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesPerconaMysqlOperatorWatch) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesPerconaMysqlOperatorLog) Reset() {
	*x = KubernetesPerconaMysqlOperatorLog{}
	mi := &file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesPerconaMysqlOperatorLog) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesPerconaMysqlOperatorLeaderElection) Reset() {
	*x = KubernetesPerconaMysqlOperatorLeaderElection{}
	mi := &file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesPerconaMysqlOperatorLeaderElection) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesPerconaMysqlOperatorImage) Reset() {
	*x = KubernetesPerconaMysqlOperatorImage{}
	mi := &file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesPerconaMysqlOperatorImage) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Ecatalog/kubernetes/kubernetesperconamysqloperator/v1alpha1/spec.proto\x12>dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a#catalog/kubernetes/kubernetes.proto\x1a%catalog/kubernetes/workload_pod.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xee\f\n" +
	...
	"\x05watch\x18\x05 \x01(\v2c.dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorWatchR\x05watch\x12M\n" +
	...
	"\x10s3_workers_limit\x18\a \x01(\x05B\r\xbaH\x04\x1a\x02(\x01\x8a\xa6\x1d\x0210H\x03R\x0es3WorkersLimit\x88\x01\x01\x12s\n" +
	"\x03log\x18\b \x01(\v2a.dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorLogR\x03log\x12+\n" +
	"\x11disable_telemetry\x18\t \x01(\bR\x10disableTelemetry\x12\x95\x01\n" +
	"\x0fleader_election\x18\n" +
	" \x01(\v2l.dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorLeaderElectionR\x0eleaderElection\x12-\n" +
	"\x12xtrabackup_sidecar\x18\v \x01(\bR\x11xtrabackupSidecar\x12H\n" +
	"\tresources\x18\f \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x12\x99\x01\n" +
	"\rnode_selector\x18\r \x03(\v2t.dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	"\vtolerations\x18\x0e \x03(\v2*.dev.planton.kubernetes.WorkloadTolerationR\vtolerations\x12x\n" +
	"\x12image_pull_secrets\x18\x0f \x03(\tBJ\xaa\xa6\x1dFNames of existing Kubernetes Secrets (references), not secret materialR\x10imagePullSecrets\x12y\n" +
	"\x05image\x18\x10 \x01(\v2c.dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorImageR\x05image\x12\x1f\n" +
	...
	"Bcom.dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1B\tSpecProtoP\x01Z~github.com/plantonhq/planton/catalog/kubernetes/kubernetesperconamysqloperator/v1alpha1;kubernetesperconamysqloperatorv1alpha1\xa2\x02\x04DPKK\xaa\x02>Dev.Planton.Kubernetes.Kubernetesperconamysqloperator.V1alpha1\xca\x02>Dev\\Planton\\Kubernetes\\Kubernetesperconamysqloperator\\V1alpha1\xe2\x02JDev\\Planton\\Kubernetes\\Kubernetesperconamysqloperator\\V1alpha1\\GPBMetadata\xea\x02BDev::Planton::Kubernetes::Kubernetesperconamysqloperator::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesPerconaMysqlOperatorSpec)(nil),           // 0: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec
	(*KubernetesPerconaMysqlOperatorWatch)(nil),          // 1: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorWatch
	(*KubernetesPerconaMysqlOperatorLog)(nil),            // 2: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorLog
	(*KubernetesPerconaMysqlOperatorLeaderElection)(nil), // 3: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorLeaderElection
	(*KubernetesPerconaMysqlOperatorImage)(nil),          // 4: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorImage
	nil,                                   // 5: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.NodeSelectorEntry
...
var file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.watch:type_name -> dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorWatch
	2, // 2: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.log:type_name -> dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorLog
	3, // 3: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.leader_election:type_name -> dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorLeaderElection
	7, // 4: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.resources:type_name -> dev.planton.kubernetes.ContainerResources
	5, // 5: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.node_selector:type_name -> dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.NodeSelectorEntry
	8, // 6: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.tolerations:type_name -> dev.planton.kubernetes.WorkloadToleration
	4, // 7: dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorSpec.image:type_name -> dev.planton.kubernetes.kubernetesperconamysqloperator.v1alpha1.KubernetesPerconaMysqlOperatorImage
...
func init() { file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesperconamysqloperator_v1alpha1_spec_proto_depIdxs = nil
}
