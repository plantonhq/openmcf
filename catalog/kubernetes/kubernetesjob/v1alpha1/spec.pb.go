...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesjob/v1alpha1/spec.proto
...
func (x *KubernetesJobSpec) Reset() {
	*x = KubernetesJobSpec{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesJobSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesJobContainer) Reset() {
	*x = KubernetesJobContainer{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesJobContainer) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesJobPodFailurePolicy) Reset() {
	*x = KubernetesJobPodFailurePolicy{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesJobPodFailurePolicy) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesJobPodFailurePolicyRule) Reset() {
	*x = KubernetesJobPodFailurePolicyRule{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesJobPodFailurePolicyRule) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesJobPodFailurePolicyOnExitCodes) Reset() {
	*x = KubernetesJobPodFailurePolicyOnExitCodes{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesJobPodFailurePolicyOnExitCodes) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesJobPodFailurePolicyOnPodCondition) Reset() {
	*x = KubernetesJobPodFailurePolicyOnPodCondition{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesJobPodFailurePolicyOnPodCondition) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesJobSuccessPolicy) Reset() {
	*x = KubernetesJobSuccessPolicy{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesJobSuccessPolicy) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesJobSuccessPolicyRule) Reset() {
	*x = KubernetesJobSuccessPolicyRule{}
	mi := &file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesJobSuccessPolicyRule) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
var File_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"4catalog/kubernetes/kubernetesjob/v1alpha1/spec.proto\x12-dev.planton.kubernetes.kubernetesjob.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a+catalog/kubernetes/workload_container.proto\x1a%catalog/kubernetes/workload_pod.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\x92\r\n" +
	"\x11KubernetesJobSpec\x12j\n" +
	"\tnamespace\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x18\xbaH\x03\xc8\x01\x01\x88\xd4a\xa0\x1f\x92\xd4a\tspec.nameR\tnamespace\x12)\n" +
	"\x10create_namespace\x18\x02 \x01(\bR\x0fcreateNamespace\x12k\n" +
	"\tcontainer\x18\x03 \x01(\v2E.dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x125\n" +
	"\x03pod\x18\x04 \x01(\v2#.dev.planton.kubernetes.WorkloadPodR\x03pod\x123\n" +
	...
	"\x13spec.restart_policy\x12\x83\x01Restart policy must be either \"Never\" or \"OnFailure\" — \"Always\" would restart completed containers and the Job could never finish\x1a,this == '' || this in ['Never', 'OnFailure']\x8a\xa6\x1d\x05NeverH\bR\rrestartPolicy\x88\x01\x01\x12z\n" +
	"\x12pod_failure_policy\x18\x0f \x01(\v2L.dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyR\x10podFailurePolicy\x12p\n" +
	"\x0esuccess_policy\x18\x10 \x01(\v2I.dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSuccessPolicyR\rsuccessPolicyB\x0e\n" +
	"\f_parallelismB\x0e\n" +
	"\f_completionsB\x12\n" +
	...
	"\x0f_restart_policy\"\x91\x02\n" +
	"\x16KubernetesJobContainer\x12C\n" +
	...
	"\x1dspec.container.sidecars.named\x12(Every sidecar container must have a name\x1a\x19this.all(c, c.name != '')R\bsidecars\"\x91\x01\n" +
	"\x1dKubernetesJobPodFailurePolicy\x12p\n" +
	"\x05rules\x18\x01 \x03(\v2P.dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyRuleB\b\xbaH\x05\x92\x01\x02\b\x01R\x05rules\"\xed\x05\n" +
	...
	"\ron_exit_codes\x18\x02 \x01(\v2W.dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyOnExitCodesR\vonExitCodes\x12\x86\x01\n" +
	"\x11on_pod_conditions\x18\x03 \x03(\v2Z.dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyOnPodConditionR\x0fonPodConditions:\xfc\x01\xbaH\xf8\x01\x1a\xf5\x01\n" +
	...
	"\a_status\"\x8b\x01\n" +
	"\x1aKubernetesJobSuccessPolicy\x12m\n" +
	"\x05rules\x18\x01 \x03(\v2M.dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSuccessPolicyRuleB\b\xbaH\x05\x92\x01\x02\b\x01R\x05rules\"\xaf\x04\n" +
	...
	"\x10_succeeded_countB\xf5\x02\n" +
	"1com.dev.planton.kubernetes.kubernetesjob.v1alpha1B\tSpecProtoP\x01Z\\github.com/plantonhq/planton/catalog/kubernetes/kubernetesjob/v1alpha1;kubernetesjobv1alpha1\xa2\x02\x04DPKK\xaa\x02-Dev.Planton.Kubernetes.Kubernetesjob.V1alpha1\xca\x02-Dev\\Planton\\Kubernetes\\Kubernetesjob\\V1alpha1\xe2\x029Dev\\Planton\\Kubernetes\\Kubernetesjob\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Kubernetes::Kubernetesjob::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesJobSpec)(nil),                           // 0: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSpec
	(*KubernetesJobContainer)(nil),                      // 1: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobContainer
	(*KubernetesJobPodFailurePolicy)(nil),               // 2: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicy
	(*KubernetesJobPodFailurePolicyRule)(nil),           // 3: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyRule
	(*KubernetesJobPodFailurePolicyOnExitCodes)(nil),    // 4: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyOnExitCodes
	(*KubernetesJobPodFailurePolicyOnPodCondition)(nil), // 5: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyOnPodCondition
	(*KubernetesJobSuccessPolicy)(nil),                  // 6: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSuccessPolicy
	(*KubernetesJobSuccessPolicyRule)(nil),              // 7: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSuccessPolicyRule
...
var file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_depIdxs = []int32{
	8,  // 0: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSpec.container:type_name -> dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobContainer
	9,  // 2: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSpec.pod:type_name -> dev.planton.kubernetes.WorkloadPod
	2,  // 3: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSpec.pod_failure_policy:type_name -> dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicy
	6,  // 4: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSpec.success_policy:type_name -> dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSuccessPolicy
	10, // 5: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobContainer.app:type_name -> dev.planton.kubernetes.WorkloadContainer
	10, // 6: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobContainer.sidecars:type_name -> dev.planton.kubernetes.WorkloadContainer
	3,  // 7: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicy.rules:type_name -> dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyRule
	4,  // 8: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyRule.on_exit_codes:type_name -> dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyOnExitCodes
	5,  // 9: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyRule.on_pod_conditions:type_name -> dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobPodFailurePolicyOnPodCondition
	7,  // 10: dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSuccessPolicy.rules:type_name -> dev.planton.kubernetes.kubernetesjob.v1alpha1.KubernetesJobSuccessPolicyRule
...
func init() { file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[5].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesjob_v1alpha1_spec_proto_depIdxs = nil
}
