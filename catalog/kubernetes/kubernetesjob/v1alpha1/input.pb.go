...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesjob/v1alpha1/input.proto
...
var (
	file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDesc), len(file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDescData
}
...
func init() { file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_init() }
func file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_init() {
	if File_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDesc), len(file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto = out.File
	file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesjob_v1alpha1_input_proto_depIdxs = nil
}
