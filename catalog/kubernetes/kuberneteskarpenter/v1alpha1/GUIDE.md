...
- **[KubernetesClusterAutoscaler](../../kubernetesclusterautoscaler/v1alpha1/GUIDE.md)**
...
AWS provider — [reference.md](reference.md) carries the scope).
...
[KubernetesKarpenterNodePool](../../kuberneteskarpenternodepool/v1alpha1/GUIDE.md)
