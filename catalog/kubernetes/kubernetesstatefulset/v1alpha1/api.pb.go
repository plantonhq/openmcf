...
const file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	";catalog/kubernetes/kubernetesstatefulset/v1alpha1/api.proto\x125dev.planton.kubernetes.kubernetesstatefulset.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a?catalog/kubernetes/kubernetesstatefulset/v1alpha1/outputs.proto\x1a<catalog/kubernetes/kubernetesstatefulset/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\xbb\x03\n" +
...
func file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_api_proto_init() {
	...
	file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_outputs_proto_init()
