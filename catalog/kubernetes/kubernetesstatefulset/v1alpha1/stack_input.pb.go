...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesstatefulset/v1alpha1/stack_input.proto
...
func (x *KubernetesStatefulSetStackInput) Reset() {
	*x = KubernetesStatefulSetStackInput{}
	mi := &file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_msgTypes[0]
...
func (*KubernetesStatefulSetStackInput) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDesc = "" +
	"\n" +
	"Ccatalog/kubernetes/kubernetesstatefulset/v1alpha1/stack_input.proto\x125dev.planton.kubernetes.kubernetesstatefulset.v1alpha1\x1a;catalog/kubernetes/kubernetesstatefulset/v1alpha1/api.proto\x1a!catalog/kubernetes/provider.proto\"\x90\x02\n" +
	...
	"\x12docker_config_json\x18\x03 \x01(\tR\x10dockerConfigJsonB\xb3\x03\n" +
	"9com.dev.planton.kubernetes.kubernetesstatefulset.v1alpha1B\x0fStackInputProtoP\x01Zlgithub.com/plantonhq/planton/catalog/kubernetes/kubernetesstatefulset/v1alpha1;kubernetesstatefulsetv1alpha1\xa2\x02\x04DPKK\xaa\x025Dev.Planton.Kubernetes.Kubernetesstatefulset.V1alpha1\xca\x025Dev\\Planton\\Kubernetes\\Kubernetesstatefulset\\V1alpha1\xe2\x02ADev\\Planton\\Kubernetes\\Kubernetesstatefulset\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Kubernetes::Kubernetesstatefulset::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDesc), len(file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_goTypes = []any{
...
var file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_depIdxs = []int32{
...
func init() { file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_init() }
func file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_init() {
	if File_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDesc), len(file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto = out.File
	file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesstatefulset_v1alpha1_stack_input_proto_depIdxs = nil
}
