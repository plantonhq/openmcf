...
// 	protoc        (unknown)
// source: catalog/kubernetes/kuberneteskafkaui/v1alpha1/spec.proto
...
func (x *KubernetesKafkaUiSpec) Reset() {
	*x = KubernetesKafkaUiSpec{}
	mi := &file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesKafkaUiSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesKafkaUiCluster) Reset() {
	*x = KubernetesKafkaUiCluster{}
	mi := &file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaUiCluster) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesKafkaUiClusterTls) Reset() {
	*x = KubernetesKafkaUiClusterTls{}
	mi := &file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaUiClusterTls) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesKafkaUiClusterSasl) Reset() {
	*x = KubernetesKafkaUiClusterSasl{}
	mi := &file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaUiClusterSasl) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesKafkaUiPasswordSecret) Reset() {
	*x = KubernetesKafkaUiPasswordSecret{}
	mi := &file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaUiPasswordSecret) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"8catalog/kubernetes/kuberneteskafkaui/v1alpha1/spec.proto\x121dev.planton.kubernetes.kuberneteskafkaui.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a#catalog/kubernetes/kubernetes.proto\x1a%catalog/kubernetes/workload_pod.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xa3\n" +
	"\n" +
	"\x15KubernetesKafkaUiSpec\x12j\n" +
	"\tnamespace\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x18\xbaH\x03\xc8\x01\x01\x88\xd4a\xa0\x1f\x92\xd4a\tspec.nameR\tnamespace\x12)\n" +
	"\x10create_namespace\x18\x02 \x01(\bR\x0fcreateNamespace\x12#\n" +
	"\rchart_version\x18\x03 \x01(\tR\fchartVersion\x12\xdf\x01\n" +
	"\bclusters\x18\x04 \x03(\v2K.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiClusterBv\xbaHs\xba\x01k\n" +
	"\x1aspec.clusters.unique_names\x12/cluster names must be unique within the console\x1a\x1cthis.map(c, c.name).unique()\x92\x01\x02\b\x01R\bclusters\x12\\\n" +
	"\x04auth\x18\x05 \x01(\v2H.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiAuthR\x04auth\x12-\n" +
	"\breplicas\x18\x06 \x01(\x05B\f\xbaH\x04\x1a\x02(\x01\x8a\xa6\x1d\x011H\x00R\breplicas\x88\x01\x01\x12H\n" +
	"\tresources\x18\a \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x12\xd2\x01\n" +
	...
	"\fservice_port\x18\t \x01(\x05B\x11\xbaH\b\x1a\x06\x18\xff\xff\x03(\x01\x8a\xa6\x1d\x0280H\x02R\vservicePort\x88\x01\x01\x12\x7f\n" +
	"\rnode_selector\x18\n" +
	" \x03(\v2Z.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiSpec.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	"\vtolerations\x18\v \x03(\v2*.dev.planton.kubernetes.WorkloadTolerationR\vtolerations\x12%\n" +
	...
	"\x03tls\x18\x04 \x01(\v2N.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiClusterTlsR\x03tls\x12c\n" +
	"\x04sasl\x18\x05 \x01(\v2O.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiClusterSaslR\x04sasl\x12{\n" +
	"\x0fschema_registry\x18\x06 \x01(\v2R.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiSchemaRegistryR\x0eschemaRegistry\x12\x87\x02\n" +
	"\rkafka_connect\x18\a \x03(\v2R.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiConnectClusterB\x8d\x01\xbaH\x89\x01\xba\x01\x85\x01\n" +
	...
	"\n" +
	"properties\x18\b \x03(\v2[.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiCluster.PropertiesEntryR\n" +
	"properties\x1a=\n" +
	...
	"\busername\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\busername\x12\x83\x01\n" +
	"\x0fpassword_secret\x18\x03 \x01(\v2R.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiPasswordSecretB\x06\xbaH\x03\xc8\x01\x01R\x0epasswordSecret\"\xce\x01\n" +
	...
	"\x04user\x18\x02 \x01(\v2H.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1.KubernetesKafkaUiUserB\x06\xbaH\x03\xc8\x01\x01R\x04user\"c\n" +
	"\x15KubernetesKafkaUiUser\x12\"\n" +
	"\busername\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\busername\x12&\n" +
	"\bpassword\x18\x02 \x01(\tB\n" +
	"\xbaH\x03\xc8\x01\x01\xa0\xa6\x1d\x01R\bpasswordB\x91\x03\n" +
	"5com.dev.planton.kubernetes.kuberneteskafkaui.v1alpha1B\tSpecProtoP\x01Zdgithub.com/plantonhq/planton/catalog/kubernetes/kuberneteskafkaui/v1alpha1;kuberneteskafkauiv1alpha1\xa2\x02\x04DPKK\xaa\x021Dev.Planton.Kubernetes.Kuberneteskafkaui.V1alpha1\xca\x021Dev\\Planton\\Kubernetes\\Kuberneteskafkaui\\V1alpha1\xe2\x02=Dev\\Planton\\Kubernetes\\Kuberneteskafkaui\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Kubernetes::Kuberneteskafkaui::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kuberneteskafkaui_v1alpha1_spec_proto_depIdxs = nil
}
