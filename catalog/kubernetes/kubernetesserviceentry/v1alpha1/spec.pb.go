...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesserviceentry/v1alpha1/spec.proto
...
func (x *KubernetesServiceEntrySpec) Reset() {
	*x = KubernetesServiceEntrySpec{}
	mi := &file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesServiceEntrySpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesServiceEntryPort) Reset() {
	*x = KubernetesServiceEntryPort{}
	mi := &file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesServiceEntryPort) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesServiceEntryEndpoint) Reset() {
	*x = KubernetesServiceEntryEndpoint{}
	mi := &file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesServiceEntryEndpoint) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"=catalog/kubernetes/kubernetesserviceentry/v1alpha1/spec.proto\x126dev.planton.kubernetes.kubernetesserviceentry.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a\"catalog/kubernetes/istio_api.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\xad\x18\n" +
	...
	"\taddresses\x18\x04 \x03(\tB\x0f\xbaH\f\x92\x01\t\x10\x80\x02\"\x04r\x02\x18@R\taddresses\x12s\n" +
	"\x05ports\x18\x05 \x03(\v2R.dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryPortB\t\xbaH\x06\x92\x01\x03\x10\x80\x02R\x05ports\x12D\n" +
	...
	"resolution\x88\x01\x01\x12\x7f\n" +
	"\tendpoints\x18\b \x03(\v2V.dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpointB\t\xbaH\x06\x92\x01\x03\x10\x80 R\tendpoints\x12\x1b\n" +
	"\texport_to\x18\t \x03(\tR\bexportTo\x12*\n" +
	"\x11subject_alt_names\x18\n" +
	" \x03(\tR\x0fsubjectAltNames\x12q\n" +
	"\x11workload_selector\x18\v \x01(\v2D.dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelectorR\x10workloadSelector:\xfe\x10\xbaH\xfa\x10\x1a\xa5\x01\n" +
	...
	"\t_localityB\t\n" +
	"\a_weightB\x12\n" +
	"\x10_service_accountB\xb4\x03\n" +
	":com.dev.planton.kubernetes.kubernetesserviceentry.v1alpha1B\tSpecProtoP\x01Zngithub.com/plantonhq/planton/catalog/kubernetes/kubernetesserviceentry/v1alpha1;kubernetesserviceentryv1alpha1\xa2\x02\x04DPKK\xaa\x026Dev.Planton.Kubernetes.Kubernetesserviceentry.V1alpha1\xca\x026Dev\\Planton\\Kubernetes\\Kubernetesserviceentry\\V1alpha1\xe2\x02BDev\\Planton\\Kubernetes\\Kubernetesserviceentry\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Kubernetes::Kubernetesserviceentry::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesServiceEntrySpec)(nil),     // 0: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntrySpec
	(*KubernetesServiceEntryPort)(nil),     // 1: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryPort
	(*KubernetesServiceEntryEndpoint)(nil), // 2: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint
	nil,                                    // 3: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint.PortsEntry
	nil,                                    // 4: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint.LabelsEntry
	(*v1.StringValueOrRef)(nil),            // 5: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*kubernetes.KubernetesIstioApiNetworkingWorkloadSelector)(nil), // 6: dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelector
}
var file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_depIdxs = []int32{
	5, // 0: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntrySpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntrySpec.ports:type_name -> dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryPort
	2, // 2: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntrySpec.endpoints:type_name -> dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint
	6, // 3: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntrySpec.workload_selector:type_name -> dev.planton.kubernetes.KubernetesIstioApiNetworkingWorkloadSelector
	3, // 4: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint.ports:type_name -> dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint.PortsEntry
	4, // 5: dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint.labels:type_name -> dev.planton.kubernetes.kubernetesserviceentry.v1alpha1.KubernetesServiceEntryEndpoint.LabelsEntry
...
func init() { file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesserviceentry_v1alpha1_spec_proto_depIdxs = nil
}
