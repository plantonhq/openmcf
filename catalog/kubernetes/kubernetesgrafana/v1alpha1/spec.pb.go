...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesgrafana/v1alpha1/spec.proto
...
func (KubernetesGrafanaDatabaseEngine) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesGrafanaDatabaseEngine) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_enumTypes[0]
}
...
func (KubernetesGrafanaDatabaseEngine) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesGrafanaSpec) Reset() {
	*x = KubernetesGrafanaSpec{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[0]
...
func (x *KubernetesGrafanaAdminSecret) Reset() {
	*x = KubernetesGrafanaAdminSecret{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaAdminSecret) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesGrafanaStorage) Reset() {
	*x = KubernetesGrafanaStorage{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaStorage) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
type KubernetesGrafanaDatabase struct {
	...
	// *
	// Database engine.
	Engine KubernetesGrafanaDatabaseEngine `protobuf:"varint,1,opt,name=engine,proto3,enum=dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatabaseEngine" json:"engine,omitempty"`
	// *
...
func (x *KubernetesGrafanaDatabase) Reset() {
	*x = KubernetesGrafanaDatabase{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaDatabase) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesGrafanaSecretKeyRef) Reset() {
	*x = KubernetesGrafanaSecretKeyRef{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaSecretKeyRef) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesGrafanaDatasource) Reset() {
	*x = KubernetesGrafanaDatasource{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaDatasource) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesGrafanaDatasourceBasicAuth) Reset() {
	*x = KubernetesGrafanaDatasourceBasicAuth{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaDatasourceBasicAuth) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesGrafanaCommunityDashboard) Reset() {
	*x = KubernetesGrafanaCommunityDashboard{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaCommunityDashboard) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *KubernetesGrafanaServer) Reset() {
	*x = KubernetesGrafanaServer{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaServer) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *KubernetesGrafanaAuth) Reset() {
	*x = KubernetesGrafanaAuth{}
	mi := &file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesGrafanaAuth) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
const file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\tresources\x18\x05 \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x12r\n" +
	"\fadmin_secret\x18\x06 \x01(\v2O.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaAdminSecretR\vadminSecret\x12e\n" +
	"\astorage\x18\a \x01(\v2K.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaStorageR\astorage\x12h\n" +
	"\bdatabase\x18\b \x01(\v2L.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatabaseR\bdatabase\x12p\n" +
	"\vdatasources\x18\t \x03(\v2N.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatasourceR\vdatasources\x12I\n" +
	"\x19dashboard_sidecar_enabled\x18\n" +
	" \x01(\bB\b\x8a\xa6\x1d\x04trueH\x02R\x17dashboardSidecarEnabled\x88\x01\x01\x12\x89\x01\n" +
	"\x14community_dashboards\x18\v \x03(\v2V.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaCommunityDashboardR\x13communityDashboards\x12\x18\n" +
	"\aplugins\x18\f \x03(\tR\aplugins\x12b\n" +
	"\x06server\x18\r \x01(\v2J.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaServerR\x06server\x12\\\n" +
	"\x04auth\x18\x0e \x01(\v2H.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaAuthR\x04auth\x12\\\n" +
	"\x04smtp\x18\x0f \x01(\v2H.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaSmtpR\x04smtp\x126\n" +
	"\x17service_monitor_enabled\x18\x10 \x01(\bR\x15serviceMonitorEnabled\x12_\n" +
	"\x05image\x18\x11 \x01(\v2I.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaImageR\x05image\x12n\n" +
	"\n" +
	...
	"\x05_size\"\xe0\x03\n" +
	"\x19KubernetesGrafanaDatabase\x12w\n" +
	"\x06engine\x18\x01 \x01(\x0e2R.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatabaseEngineB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x06engine\x12s\n" +
	...
	"\x04user\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04user\x12\x81\x01\n" +
	"\x0fpassword_secret\x18\x05 \x01(\v2P.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaSecretKeyRefB\x06\xbaH\x03\xc8\x01\x01R\x0epasswordSecret\x12\x19\n" +
	...
	"\x03key\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x03key\"\xaa\x03\n" +
	...
	"\x03uid\x18\x05 \x01(\tR\x03uid\x12v\n" +
	"\n" +
	"basic_auth\x18\x06 \x01(\v2W.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatasourceBasicAuthR\tbasicAuth\x12\x1b\n" +
	"\tjson_data\x18\a \x01(\tR\bjsonDataB\a\n" +
	"\x05_type\"\xce\x01\n" +
	"$KubernetesGrafanaDatasourceBasicAuth\x12\"\n" +
	"\busername\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\busername\x12\x81\x01\n" +
	"\x0fpassword_secret\x18\x02 \x01(\v2P.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaSecretKeyRefB\x06\xbaH\x03\xc8\x01\x01R\x0epasswordSecret\"\x8b\x01\n" +
	...
	"\x10pull_secret_name\x18\x03 \x01(\tR\x0epullSecretName\"\xe4\x02\n" +
	"\x1bKubernetesGrafanaScheduling\x12\x85\x01\n" +
	"\rnode_selector\x18\x01 \x03(\v2`.dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaScheduling.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	...
	"\x05mysql\x10\x02B\x91\x03\n" +
	"5com.dev.planton.kubernetes.kubernetesgrafana.v1alpha1B\tSpecProtoP\x01Zdgithub.com/plantonhq/planton/catalog/kubernetes/kubernetesgrafana/v1alpha1;kubernetesgrafanav1alpha1\xa2\x02\x04DPKK\xaa\x021Dev.Planton.Kubernetes.Kubernetesgrafana.V1alpha1\xca\x021Dev\\Planton\\Kubernetes\\Kubernetesgrafana\\V1alpha1\xe2\x02=Dev\\Planton\\Kubernetes\\Kubernetesgrafana\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Kubernetes::Kubernetesgrafana::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_rawDescData
}
...
var file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_goTypes = []any{
	...
	(*KubernetesGrafanaAdminSecret)(nil),         // 2: dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaAdminSecret
	(*KubernetesGrafanaStorage)(nil),             // 3: dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaStorage
	(*KubernetesGrafanaDatabase)(nil),            // 4: dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatabase
	(*KubernetesGrafanaSecretKeyRef)(nil),        // 5: dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaSecretKeyRef
	(*KubernetesGrafanaDatasource)(nil),          // 6: dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatasource
	(*KubernetesGrafanaDatasourceBasicAuth)(nil), // 7: dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatasourceBasicAuth
...
var file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_depIdxs = []int32{
	...
	6,  // 5: dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaSpec.datasources:type_name -> dev.planton.kubernetes.kubernetesgrafana.v1alpha1.KubernetesGrafanaDatasource
...
func file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesgrafana_v1alpha1_spec_proto_depIdxs = nil
}
