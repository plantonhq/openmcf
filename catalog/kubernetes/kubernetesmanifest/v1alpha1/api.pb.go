...
const file_catalog_kubernetes_kubernetesmanifest_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"8catalog/kubernetes/kubernetesmanifest/v1alpha1/api.proto\x122dev.planton.kubernetes.kubernetesmanifest.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a9catalog/kubernetes/kubernetesmanifest/v1alpha1/spec.proto\x1aBcatalog/kubernetes/kubernetesmanifest/v1alpha1/stack_outputs.proto\x1a\x15shared/metadata.proto\"\xa9\x03\n" +
...
func file_catalog_kubernetes_kubernetesmanifest_v1alpha1_api_proto_init() {
	...
	file_catalog_kubernetes_kubernetesmanifest_v1alpha1_stack_outputs_proto_init()
	type x struct{}
