...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetessolroperator/v1alpha1/spec.proto
...
func (x *KubernetesSolrOperatorSpec) Reset() {
	*x = KubernetesSolrOperatorSpec{}
	mi := &file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesSolrOperatorSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x10watch_namespaces\x18\x05 \x03(\tR\x0fwatchNamespaces\x12\x8e\x01\n" +
	"\x12zookeeper_operator\x18\x06 \x01(\v2_.dev.planton.kubernetes.kubernetessolroperator.v1alpha1.KubernetesSolrOperatorZookeeperOperatorR\x11zookeeperOperator\x12E\n" +
	"\x17leader_election_enabled\x18\a \x01(\bB\b\x8a\xa6\x1d\x04trueH\x02R\x15leaderElectionEnabled\x88\x01\x01\x126\n" +
	"\x0fmetrics_enabled\x18\b \x01(\bB\b\x8a\xa6\x1d\x04trueH\x03R\x0emetricsEnabled\x88\x01\x01\x12f\n" +
	"\x04mtls\x18\t \x01(\v2R.dev.planton.kubernetes.kubernetessolroperator.v1alpha1.KubernetesSolrOperatorMtlsR\x04mtls\x12H\n" +
	"\tresources\x18\n" +
	" \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x12\x89\x01\n" +
	"\rnode_selector\x18\v \x03(\v2d.dev.planton.kubernetes.kubernetessolroperator.v1alpha1.KubernetesSolrOperatorSpec.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	"\vtolerations\x18\f \x03(\v2*.dev.planton.kubernetes.WorkloadTolerationR\vtolerations\x12v\n" +
	...
	"repository\x12\x10\n" +
	"\x03tag\x18\x02 \x01(\tR\x03tagB\xb4\x03\n" +
	":com.dev.planton.kubernetes.kubernetessolroperator.v1alpha1B\tSpecProtoP\x01Zngithub.com/plantonhq/planton/catalog/kubernetes/kubernetessolroperator/v1alpha1;kubernetessolroperatorv1alpha1\xa2\x02\x04DPKK\xaa\x026Dev.Planton.Kubernetes.Kubernetessolroperator.V1alpha1\xca\x026Dev\\Planton\\Kubernetes\\Kubernetessolroperator\\V1alpha1\xe2\x02BDev\\Planton\\Kubernetes\\Kubernetessolroperator\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Kubernetes::Kubernetessolroperator::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetessolroperator_v1alpha1_spec_proto_depIdxs = nil
}
