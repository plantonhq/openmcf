...
type Locals struct {
	Spec *kubernetesaltinityoperatorv1alpha1.KubernetesAltinityOperatorSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesaltinityoperatorv1alpha1.KubernetesAltinityOperatorStackInput) *Locals {
