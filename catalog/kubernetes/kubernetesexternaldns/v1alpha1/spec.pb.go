...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesexternaldns/v1alpha1/spec.proto
...
func (x *KubernetesExternalDnsSpec) Reset() {
	*x = KubernetesExternalDnsSpec{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesExternalDnsSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesExternalDnsAwsRoute53) Reset() {
	*x = KubernetesExternalDnsAwsRoute53{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsAwsRoute53) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesExternalDnsGoogleCloudDns) Reset() {
	*x = KubernetesExternalDnsGoogleCloudDns{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsGoogleCloudDns) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesExternalDnsAzureDns) Reset() {
	*x = KubernetesExternalDnsAzureDns{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsAzureDns) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesExternalDnsCloudflare) Reset() {
	*x = KubernetesExternalDnsCloudflare{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsCloudflare) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesExternalDnsWebhook) Reset() {
	*x = KubernetesExternalDnsWebhook{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsWebhook) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesExternalDnsInMemory) Reset() {
	*x = KubernetesExternalDnsInMemory{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsInMemory) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesExternalDnsPrometheus) Reset() {
	*x = KubernetesExternalDnsPrometheus{}
	mi := &file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesExternalDnsPrometheus) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
var File_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x8a\xa6\x1d\x061.21.1H\x01R\fchartVersion\x88\x01\x01\x12y\n" +
	"\vaws_route53\x18\x04 \x01(\v2V.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53H\x00R\n" +
	"awsRoute53\x12\x86\x01\n" +
	"\x10google_cloud_dns\x18\x05 \x01(\v2Z.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDnsH\x00R\x0egoogleCloudDns\x12s\n" +
	"\tazure_dns\x18\x06 \x01(\v2T.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDnsH\x00R\bazureDns\x12x\n" +
	"\n" +
	"cloudflare\x18\a \x01(\v2V.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflareH\x00R\n" +
	"cloudflare\x12o\n" +
	"\awebhook\x18\b \x01(\v2S.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhookH\x00R\awebhook\x12s\n" +
	"\tin_memory\x18\t \x01(\v2T.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsInMemoryH\x00R\binMemory\x12_\n" +
	...
	"\n" +
	"log_format\x18\x1c \x01(\tB\x19\xbaH\x0er\fR\x04textR\x04json\x8a\xa6\x1d\x04textH\x06R\tlogFormat\x88\x01\x01\x12H\n" +
	"\tresources\x18\x1d \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x12\x87\x01\n" +
	"\rnode_selector\x18\x1e \x03(\v2b.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	"\vtolerations\x18\x1f \x03(\v2*.dev.planton.kubernetes.WorkloadTolerationR\vtolerations\x12.\n" +
	"\x13priority_class_name\x18  \x01(\tR\x11priorityClassName\x12v\n" +
	"\n" +
	"prometheus\x18! \x01(\v2V.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheusR\n" +
	"prometheus\x12)\n" +
	...
	"\x15_dns_records_per_page\"\xf4\x02\n" +
	...
	"\x04args\x18\x03 \x03(\tR\x04args\x12n\n" +
	"\x03env\x18\x04 \x03(\v2\\.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.EnvEntryR\x03env\x12H\n" +
	"\tresources\x18\x05 \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"5\n" +
	"\x1dKubernetesExternalDnsInMemory\x12\x14\n" +
	"\x05zones\x18\x01 \x03(\tR\x05zones\"\xf6\x02\n" +
	"\x1fKubernetesExternalDnsPrometheus\x12'\n" +
	"\x0fservice_monitor\x18\x01 \x01(\bR\x0eserviceMonitor\x128\n" +
	"\x18service_monitor_interval\x18\x02 \x01(\tR\x16serviceMonitorInterval\x12\xa6\x01\n" +
	"\x16service_monitor_labels\x18\x03 \x03(\v2p.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.ServiceMonitorLabelsEntryR\x14serviceMonitorLabels\x1aG\n" +
	"\x19ServiceMonitorLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xad\x03\n" +
	"9com.dev.planton.kubernetes.kubernetesexternaldns.v1alpha1B\tSpecProtoP\x01Zlgithub.com/plantonhq/planton/catalog/kubernetes/kubernetesexternaldns/v1alpha1;kubernetesexternaldnsv1alpha1\xa2\x02\x04DPKK\xaa\x025Dev.Planton.Kubernetes.Kubernetesexternaldns.V1alpha1\xca\x025Dev\\Planton\\Kubernetes\\Kubernetesexternaldns\\V1alpha1\xe2\x02ADev\\Planton\\Kubernetes\\Kubernetesexternaldns\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Kubernetes::Kubernetesexternaldns::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_goTypes = []any{
	(*KubernetesExternalDnsSpec)(nil),             // 0: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec
	(*KubernetesExternalDnsAwsRoute53)(nil),       // 1: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53
	(*KubernetesExternalDnsGoogleCloudDns)(nil),   // 2: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns
	(*KubernetesExternalDnsAzureDns)(nil),         // 3: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDns
	(*KubernetesExternalDnsCloudflare)(nil),       // 4: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflare
	(*KubernetesExternalDnsWebhook)(nil),          // 5: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook
	(*KubernetesExternalDnsInMemory)(nil),         // 6: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsInMemory
	(*KubernetesExternalDnsPrometheus)(nil),       // 7: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus
	nil,                                           // 8: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.NodeSelectorEntry
	nil,                                           // 9: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.EnvEntry
	nil,                                           // 10: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.ServiceMonitorLabelsEntry
	(*v1.StringValueOrRef)(nil),                   // 11: dev.planton.shared.foreignkey.v1.StringValueOrRef
	(*kubernetes.KubernetesWorkloadIdentity)(nil), // 12: dev.planton.kubernetes.KubernetesWorkloadIdentity
...
var file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_depIdxs = []int32{
	11, // 0: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 1: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.aws_route53:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53
	2,  // 2: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.google_cloud_dns:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns
	3,  // 3: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.azure_dns:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDns
	4,  // 4: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.cloudflare:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflare
	5,  // 5: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.webhook:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook
	6,  // 6: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.in_memory:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsInMemory
	12, // 7: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.workload_identity:type_name -> dev.planton.kubernetes.KubernetesWorkloadIdentity
	13, // 8: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.resources:type_name -> dev.planton.kubernetes.ContainerResources
	8,  // 9: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.node_selector:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.NodeSelectorEntry
	14, // 10: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.tolerations:type_name -> dev.planton.kubernetes.WorkloadToleration
	7,  // 11: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsSpec.prometheus:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus
	11, // 12: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 13: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAwsRoute53.assume_role:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 14: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns.project:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 15: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsGoogleCloudDns.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 16: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsAzureDns.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 17: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsCloudflare.zone_id_filters:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 18: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.env:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.EnvEntry
	13, // 19: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsWebhook.resources:type_name -> dev.planton.kubernetes.ContainerResources
	10, // 20: dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.service_monitor_labels:type_name -> dev.planton.kubernetes.kubernetesexternaldns.v1alpha1.KubernetesExternalDnsPrometheus.ServiceMonitorLabelsEntry
...
func init() { file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesexternaldns_v1alpha1_spec_proto_depIdxs = nil
}
