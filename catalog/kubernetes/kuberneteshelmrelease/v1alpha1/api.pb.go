...
const file_catalog_kubernetes_kuberneteshelmrelease_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	";catalog/kubernetes/kuberneteshelmrelease/v1alpha1/api.proto\x125dev.planton.kubernetes.kuberneteshelmrelease.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a<catalog/kubernetes/kuberneteshelmrelease/v1alpha1/spec.proto\x1aEcatalog/kubernetes/kuberneteshelmrelease/v1alpha1/stack_outputs.proto\x1a\x15shared/metadata.proto\"\xbb\x03\n" +
...
func file_catalog_kubernetes_kuberneteshelmrelease_v1alpha1_api_proto_init() {
	...
	file_catalog_kubernetes_kuberneteshelmrelease_v1alpha1_stack_outputs_proto_init()
	type x struct{}
