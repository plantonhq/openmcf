...
#
# Thin projection of the gateway.networking.k8s.io/v1 "GRPCRoute" custom resource.
#
...
variable "spec" {
  description = "Spec for the gateway.networking.k8s.io/v1 \"GRPCRoute\" custom resource, passed through verbatim to kubectl_manifest. Typed 'any': the apiserver and Planton protovalidate are the schema authority."
  type        = any
}
