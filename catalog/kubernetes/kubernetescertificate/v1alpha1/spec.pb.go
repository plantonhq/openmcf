...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetescertificate/v1alpha1/spec.proto
...
func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyAlgorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyAlgorithm) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes[0]
}
...
func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyAlgorithm) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{7, 0}
}
...
func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyEncoding) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyEncoding) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes[1]
}
...
func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyEncoding) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{7, 1}
}
...
func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyRotationPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyRotationPolicy) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes[2]
}
...
func (KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyRotationPolicy) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{7, 2}
}
...
func (x *KubernetesCertificateSpec) Reset() {
	*x = KubernetesCertificateSpec{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesCertificateSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesCertificateIssuerRef) Reset() {
	*x = KubernetesCertificateIssuerRef{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateIssuerRef) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesCertificateClusterIssuerRef) Reset() {
	*x = KubernetesCertificateClusterIssuerRef{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateClusterIssuerRef) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesCertificateNamespacedIssuerRef) Reset() {
	*x = KubernetesCertificateNamespacedIssuerRef{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateNamespacedIssuerRef) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesCertificateExternalIssuerRef) Reset() {
	*x = KubernetesCertificateExternalIssuerRef{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateExternalIssuerRef) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesCertificateSubject) Reset() {
	*x = KubernetesCertificateSubject{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateSubject) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesCertificateOtherName) Reset() {
	*x = KubernetesCertificateOtherName{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateOtherName) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
type KubernetesCertificatePrivateKey struct {
	...
	Algorithm *KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyAlgorithm `protobuf:"varint,1,opt,name=algorithm,proto3,enum=dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyAlgorithm,oneof" json:"algorithm,omitempty"`
	...
	Encoding *KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyEncoding `protobuf:"varint,3,opt,name=encoding,proto3,enum=dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyEncoding,oneof" json:"encoding,omitempty"`
	// Key rotation at renewal. Default upstream (v1.18+): always.
	RotationPolicy *KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyRotationPolicy `protobuf:"varint,4,opt,name=rotation_policy,json=rotationPolicy,proto3,enum=dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyRotationPolicy,oneof" json:"rotation_policy,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *KubernetesCertificatePrivateKey) Reset() {
	*x = KubernetesCertificatePrivateKey{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificatePrivateKey) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *KubernetesCertificateKeystores) Reset() {
	*x = KubernetesCertificateKeystores{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateKeystores) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *KubernetesCertificateJksKeystore) Reset() {
	*x = KubernetesCertificateJksKeystore{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateJksKeystore) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *KubernetesCertificatePkcs12Keystore) Reset() {
	*x = KubernetesCertificatePkcs12Keystore{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificatePkcs12Keystore) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (x *KubernetesCertificateAdditionalOutputFormat) Reset() {
	*x = KubernetesCertificateAdditionalOutputFormat{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateAdditionalOutputFormat) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (x *KubernetesCertificateNameConstraints) Reset() {
	*x = KubernetesCertificateNameConstraints{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateNameConstraints) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
func (x *KubernetesCertificateNameConstraintSet) Reset() {
	*x = KubernetesCertificateNameConstraintSet{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateNameConstraintSet) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
func (x *KubernetesCertificateSecretTemplate) Reset() {
	*x = KubernetesCertificateSecretTemplate{}
	mi := &file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesCertificateSecretTemplate) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
var File_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"<catalog/kubernetes/kubernetescertificate/v1alpha1/spec.proto\x125dev.planton.kubernetes.kubernetescertificate.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xc4!\n" +
	"\x19KubernetesCertificateSpec\x12j\n" +
	"\tnamespace\x18\x01 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x18\xbaH\x03\xc8\x01\x01\x88\xd4a\xa0\x1f\x92\xd4a\tspec.nameR\tnamespace\x12'\n" +
	"\vsecret_name\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"secretName\x12|\n" +
	"\n" +
	"issuer_ref\x18\x03 \x01(\v2U.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateIssuerRefB\x06\xbaH\x03\xc8\x01\x01R\tissuerRef\x12\x1b\n" +
	...
	"commonName\x12m\n" +
	"\asubject\x18\t \x01(\v2S.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSubjectR\asubject\x12'\n" +
	"\x0fliteral_subject\x18\n" +
	" \x01(\tR\x0eliteralSubject\x12v\n" +
	"\vother_names\x18\v \x03(\v2U.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateOtherNameR\n" +
	...
	"\x17renew_before_percentage\x18\x0e \x01(\x05B\t\xbaH\x06\x1a\x04\x18c(\x01H\x01R\x15renewBeforePercentage\x88\x01\x01\x12w\n" +
	"\vprivate_key\x18\x0f \x01(\v2V.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKeyR\n" +
	...
	"\x1esignature_algorithm.vocabulary\x12\x8e\x01signature_algorithm must be one of SHA256WithRSA, SHA384WithRSA, SHA512WithRSA, ECDSAWithSHA256, ECDSAWithSHA384, ECDSAWithSHA512, PureEd25519\x1a\x91\x01this == '' || this in ['SHA256WithRSA', 'SHA384WithRSA', 'SHA512WithRSA', 'ECDSAWithSHA256', 'ECDSAWithSHA384', 'ECDSAWithSHA512', 'PureEd25519']H\x02R\x12signatureAlgorithm\x88\x01\x01\x12s\n" +
	"\tkeystores\x18\x14 \x01(\v2U.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateKeystoresR\tkeystores\x12\x9e\x01\n" +
	"\x19additional_output_formats\x18\x15 \x03(\v2b.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateAdditionalOutputFormatR\x17additionalOutputFormats\x12\x86\x01\n" +
	"\x10name_constraints\x18\x16 \x01(\v2[.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraintsR\x0fnameConstraints\x12\x83\x01\n" +
	"\x0fsecret_template\x18\x17 \x01(\v2Z.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplateR\x0esecretTemplate\x12B\n" +
	...
	"\x17_revision_history_limit\"\x95\x06\n" +
	"\x1eKubernetesCertificateIssuerRef\x12\x85\x01\n" +
	"\x0ecluster_issuer\x18\x01 \x01(\v2\\.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateClusterIssuerRefH\x00R\rclusterIssuer\x12y\n" +
	"\x06issuer\x18\x02 \x01(\v2_.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNamespacedIssuerRefH\x00R\x06issuer\x12{\n" +
	"\bexternal\x18\x03 \x01(\v2].dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateExternalIssuerRefH\x00R\bexternal:\xe3\x02\xbaH\xdf\x02\x1a\xdc\x02\n" +
	...
	"\n" +
	"utf8_value\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\tutf8Value\"\xf4\v\n" +
	"\x1fKubernetesCertificatePrivateKey\x12\xab\x01\n" +
	"\talgorithm\x18\x01 \x01(\x0e2\x7f.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyAlgorithmB\a\x8a\xa6\x1d\x03rsaH\x00R\talgorithm\x88\x01\x01\x12\xb1\x01\n" +
	"\x04size\x18\x02 \x01(\x05B\x97\x01\xbaH\x93\x01\xba\x01\x8f\x01\n" +
	"\x10private_key.size\x12Jsize must be 2048, 3072, 4096, or 8192 for RSA; 256, 384, or 521 for ECDSA\x1a/this in [256, 384, 521, 2048, 3072, 4096, 8192]H\x01R\x04size\x88\x01\x01\x12\xaa\x01\n" +
	"\bencoding\x18\x03 \x01(\x0e2~.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyEncodingB\t\x8a\xa6\x1d\x05pkcs1H\x02R\bencoding\x88\x01\x01\x12\xbf\x01\n" +
	"\x0frotation_policy\x18\x04 \x01(\x0e2\x84\x01.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyRotationPolicyB\n" +
	...
	"\x05_sizeB\v\n" +
	"\t_encodingB\x12\n" +
	"\x10_rotation_policy\"\xff\x01\n" +
	"\x1eKubernetesCertificateKeystores\x12i\n" +
	"\x03jks\x18\x01 \x01(\v2W.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateJksKeystoreR\x03jks\x12r\n" +
	"\x06pkcs12\x18\x02 \x01(\v2Z.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePkcs12KeystoreR\x06pkcs12\"\x98\x01\n" +
	...
	"\x12output_format.type\x12$type must be 'der' or 'combined_pem'\x1a\x1fthis in ['der', 'combined_pem']\xc8\x01\x01R\x04type\"\xba\x02\n" +
	"$KubernetesCertificateNameConstraints\x12\x1a\n" +
	"\bcritical\x18\x01 \x01(\bR\bcritical\x12{\n" +
	"\tpermitted\x18\x02 \x01(\v2].dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraintSetR\tpermitted\x12y\n" +
	"\bexcluded\x18\x03 \x01(\v2].dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraintSetR\bexcluded\"\xb0\x01\n" +
	...
	"uriDomains\"\xb0\x03\n" +
	"#KubernetesCertificateSecretTemplate\x12~\n" +
	"\x06labels\x18\x01 \x03(\v2f.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.LabelsEntryR\x06labels\x12\x8d\x01\n" +
	"\vannotations\x18\x02 \x03(\v2k.dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.AnnotationsEntryR\vannotations\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xad\x03\n" +
	"9com.dev.planton.kubernetes.kubernetescertificate.v1alpha1B\tSpecProtoP\x01Zlgithub.com/plantonhq/planton/catalog/kubernetes/kubernetescertificate/v1alpha1;kubernetescertificatev1alpha1\xa2\x02\x04DPKK\xaa\x025Dev.Planton.Kubernetes.Kubernetescertificate.V1alpha1\xca\x025Dev\\Planton\\Kubernetes\\Kubernetescertificate\\V1alpha1\xe2\x02ADev\\Planton\\Kubernetes\\Kubernetescertificate\\V1alpha1\\GPBMetadata\xea\x029Dev::Planton::Kubernetes::Kubernetescertificate::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_goTypes = []any{
	(KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyAlgorithm)(0),      // 0: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyAlgorithm
	(KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyEncoding)(0),       // 1: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyEncoding
	(KubernetesCertificatePrivateKey_KubernetesCertificatePrivateKeyRotationPolicy)(0), // 2: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyRotationPolicy
	(*KubernetesCertificateSpec)(nil),                                                  // 3: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec
	(*KubernetesCertificateIssuerRef)(nil),                                             // 4: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateIssuerRef
	(*KubernetesCertificateClusterIssuerRef)(nil),                                      // 5: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateClusterIssuerRef
	(*KubernetesCertificateNamespacedIssuerRef)(nil),                                   // 6: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNamespacedIssuerRef
	(*KubernetesCertificateExternalIssuerRef)(nil),                                     // 7: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateExternalIssuerRef
	(*KubernetesCertificateSubject)(nil),                                               // 8: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSubject
	(*KubernetesCertificateOtherName)(nil),                                             // 9: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateOtherName
	(*KubernetesCertificatePrivateKey)(nil),                                            // 10: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey
	(*KubernetesCertificateKeystores)(nil),                                             // 11: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateKeystores
	(*KubernetesCertificateJksKeystore)(nil),                                           // 12: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateJksKeystore
	(*KubernetesCertificatePkcs12Keystore)(nil),                                        // 13: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePkcs12Keystore
	(*KubernetesCertificateAdditionalOutputFormat)(nil),                                // 14: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateAdditionalOutputFormat
	(*KubernetesCertificateNameConstraints)(nil),                                       // 15: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraints
	(*KubernetesCertificateNameConstraintSet)(nil),                                     // 16: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraintSet
	(*KubernetesCertificateSecretTemplate)(nil),                                        // 17: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate
	nil,                         // 18: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.LabelsEntry
	nil,                         // 19: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.AnnotationsEntry
	(*v1.StringValueOrRef)(nil), // 20: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_depIdxs = []int32{
	20, // 0: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4,  // 1: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.issuer_ref:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateIssuerRef
	8,  // 2: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.subject:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSubject
	9,  // 3: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.other_names:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateOtherName
	10, // 4: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.private_key:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey
	11, // 5: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.keystores:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateKeystores
	14, // 6: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.additional_output_formats:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateAdditionalOutputFormat
	15, // 7: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.name_constraints:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraints
	17, // 8: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSpec.secret_template:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate
	5,  // 9: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateIssuerRef.cluster_issuer:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateClusterIssuerRef
	6,  // 10: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateIssuerRef.issuer:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNamespacedIssuerRef
	7,  // 11: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateIssuerRef.external:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateExternalIssuerRef
	20, // 12: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateClusterIssuerRef.name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	20, // 13: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNamespacedIssuerRef.name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 14: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.algorithm:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyAlgorithm
	1,  // 15: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.encoding:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyEncoding
	2,  // 16: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.rotation_policy:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePrivateKey.KubernetesCertificatePrivateKeyRotationPolicy
	12, // 17: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateKeystores.jks:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateJksKeystore
	13, // 18: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateKeystores.pkcs12:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificatePkcs12Keystore
	16, // 19: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraints.permitted:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraintSet
	16, // 20: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraints.excluded:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateNameConstraintSet
	18, // 21: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.labels:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.LabelsEntry
	19, // 22: dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.annotations:type_name -> dev.planton.kubernetes.kubernetescertificate.v1alpha1.KubernetesCertificateSecretTemplate.AnnotationsEntry
...
func init() { file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[9].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetescertificate_v1alpha1_spec_proto_depIdxs = nil
}
