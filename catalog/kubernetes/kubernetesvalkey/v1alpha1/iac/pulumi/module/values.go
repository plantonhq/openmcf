...
func renderValkeyConfig(config *kubernetesvalkeyv1alpha1.KubernetesValkeyConfig) string {
	if config == nil {
		return ""
	}
	var lines []string
...
// usersExistingSecret).
func aclUsersMap(auth *kubernetesvalkeyv1alpha1.KubernetesValkeyAuth) map[string]interface{} {
