...
// 	protoc        (unknown)
// source: catalog/kubernetes/kuberneteskeycloak/v1alpha1/spec.proto
...
func (x *KubernetesKeycloakSpec) Reset() {
	*x = KubernetesKeycloakSpec{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesKeycloakSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesKeycloakDb) Reset() {
	*x = KubernetesKeycloakDb{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKeycloakDb) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesKeycloakSecretSelector) Reset() {
	*x = KubernetesKeycloakSecretSelector{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKeycloakSecretSelector) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesKeycloakHttp) Reset() {
	*x = KubernetesKeycloakHttp{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKeycloakHttp) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesKeycloakHostname) Reset() {
	*x = KubernetesKeycloakHostname{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKeycloakHostname) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesKeycloakFeatures) Reset() {
	*x = KubernetesKeycloakFeatures{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKeycloakFeatures) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesKeycloakCacheConfig) Reset() {
	*x = KubernetesKeycloakCacheConfig{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKeycloakCacheConfig) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesKeycloakAdditionalOption) Reset() {
	*x = KubernetesKeycloakAdditionalOption{}
	mi := &file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKeycloakAdditionalOption) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
var File_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"9catalog/kubernetes/kuberneteskeycloak/v1alpha1/spec.proto\x122dev.planton.kubernetes.kuberneteskeycloak.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a#catalog/kubernetes/kubernetes.proto\x1a catalog/kubernetes/options.proto\x1a%catalog/kubernetes/workload_pod.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xff\x1a\n" +
	...
	"\x0fstart_optimized\x18\x05 \x01(\bR\x0estartOptimized\x12`\n" +
	"\x02db\x18\x06 \x01(\v2H.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakDbB\x06\xbaH\x03\xc8\x01\x01R\x02db\x12f\n" +
	"\x04http\x18\a \x01(\v2J.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakHttpB\x06\xbaH\x03\xc8\x01\x01R\x04http\x12r\n" +
	"\bhostname\x18\b \x01(\v2N.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakHostnameB\x06\xbaH\x03\xc8\x01\x01R\bhostname\x12\xbc\x01\n" +
	"\rproxy_headers\x18\t \x01(\tB\x96\x01\xbaH\x92\x01\xba\x01\x8e\x01\n" +
	"\x12spec.proxy_headers\x12Eproxy_headers must be \"xforwarded\", \"forwarded\", or empty (no proxy).\x1a1this == \"\" || this in [\"xforwarded\", \"forwarded\"]R\fproxyHeaders\x12j\n" +
	"\bfeatures\x18\n" +
	" \x01(\v2N.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakFeaturesR\bfeatures\x124\n" +
	"\x16transaction_xa_enabled\x18\v \x01(\bR\x14transactionXaEnabled\x12t\n" +
	"\fcache_config\x18\f \x01(\v2Q.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakCacheConfigR\vcacheConfig\x12w\n" +
	"\x17truststore_secret_names\x18\r \x03(\tB?\xaa\xa6\x1d;NAMES of existing Secrets (references), not secret materialR\x15truststoreSecretNames\x12\x85\x01\n" +
	"\x12additional_options\x18\x0e \x03(\v2V.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakAdditionalOptionR\x11additionalOptions\x12=\n" +
	"\x1bbootstrap_admin_secret_name\x18\x0f \x01(\tR\x18bootstrapAdminSecretName\x12l\n" +
	"\tresources\x18\x10 \x01(\v2*.dev.planton.kubernetes.ContainerResourcesB\"\xba\xfb\xa4\x02\x1d\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\r\n" +
	"\x04250m\x12\x05768MiR\tresources\x12p\n" +
	"\n" +
	"scheduling\x18\x11 \x01(\v2P.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakSchedulingR\n" +
	"scheduling\x12d\n" +
	"\x06probes\x18\x12 \x01(\v2L.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakProbesR\x06probes\x12J\n" +
	...
	"\x17service_monitor_enabled\x18\x15 \x01(\bB\b\x8a\xa6\x1d\x04trueH\x03R\x15serviceMonitorEnabled\x88\x01\x01\x12d\n" +
	"\x06update\x18\x16 \x01(\v2L.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakUpdateR\x06update\x12g\n" +
	"\atracing\x18\x17 \x01(\v2M.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakTracingR\atracing:\xbb\t\xbaH\xb7\t\x1a\xe2\x03\n" +
	...
	"\x18_service_monitor_enabled\"\x83\v\n" +
	...
	"\x0fusername_secret\x18\x05 \x01(\v2T.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakSecretSelectorR\x0eusernameSecret\x12}\n" +
	"\x0fpassword_secret\x18\x06 \x01(\v2T.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1.KubernetesKeycloakSecretSelectorR\x0epasswordSecret\x12\x16\n" +
	...
	"\t_protocolB\x10\n" +
	"\x0e_sampler_ratioB\x98\x03\n" +
	"6com.dev.planton.kubernetes.kuberneteskeycloak.v1alpha1B\tSpecProtoP\x01Zfgithub.com/plantonhq/planton/catalog/kubernetes/kuberneteskeycloak/v1alpha1;kuberneteskeycloakv1alpha1\xa2\x02\x04DPKK\xaa\x022Dev.Planton.Kubernetes.Kuberneteskeycloak.V1alpha1\xca\x022Dev\\Planton\\Kubernetes\\Kuberneteskeycloak\\V1alpha1\xe2\x02>Dev\\Planton\\Kubernetes\\Kuberneteskeycloak\\V1alpha1\\GPBMetadata\xea\x026Dev::Planton::Kubernetes::Kuberneteskeycloak::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kuberneteskeycloak_v1alpha1_spec_proto_depIdxs = nil
}
