...
func buildParentRefs(parentRefs []*kubernetesapis.KubernetesGatewayApiParentReference) gatewayv1.TCPRouteSpecParentRefsArray {
	arr := gatewayv1.TCPRouteSpecParentRefsArray{}
	for _, ref := range parentRefs {
		args := gatewayv1.TCPRouteSpecParentRefsArgs{
