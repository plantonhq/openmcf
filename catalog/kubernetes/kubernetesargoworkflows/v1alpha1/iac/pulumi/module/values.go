...
func buildHelmValues(locals *Locals) (map[string]interface{}, error) {
	...
	if archive := spec.GetArchive(); archive != nil {
		...
		defaultPort := 5432
		if archive.GetEngine() == kubernetesargoworkflowsv1alpha1.KubernetesArgoWorkflowsArchiveEngine_mysql {
			engineKey = "mysql"
			defaultPort = 3306
		}
		port := defaultPort
	...
	if ar := spec.GetArtifactRepository(); ar != nil {
		...
		case *kubernetesargoworkflowsv1alpha1.KubernetesArgoWorkflowsArtifactRepository_S3:
			...
			repository["s3"] = s3
		case *kubernetesargoworkflowsv1alpha1.KubernetesArgoWorkflowsArtifactRepository_Gcs:
			...
			repository["gcs"] = gcs
		case *kubernetesargoworkflowsv1alpha1.KubernetesArgoWorkflowsArtifactRepository_Azure:
