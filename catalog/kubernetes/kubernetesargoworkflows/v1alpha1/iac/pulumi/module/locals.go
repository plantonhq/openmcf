...
type Locals struct {
	Spec *kubernetesargoworkflowsv1alpha1.KubernetesArgoWorkflowsSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesargoworkflowsv1alpha1.KubernetesArgoWorkflowsStackInput) *Locals {
