...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesmetricsserver/v1alpha1/spec.proto
...
func (KubernetesMetricsServerTlsType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesMetricsServerTlsType) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_enumTypes[0]
}
...
func (KubernetesMetricsServerTlsType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesMetricsServerSpec) Reset() {
	*x = KubernetesMetricsServerSpec{}
	mi := &file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_msgTypes[0]
...
func (x *KubernetesMetricsServerApiService) Reset() {
	*x = KubernetesMetricsServerApiService{}
	mi := &file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type KubernetesMetricsServerTls struct {
	...
	Type *KubernetesMetricsServerTlsType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.kubernetes.kubernetesmetricsserver.v1alpha1.KubernetesMetricsServerTlsType,oneof" json:"type,omitempty"`
	// *
...
func (x *KubernetesMetricsServerTls) Reset() {
	*x = KubernetesMetricsServerTls{}
	mi := &file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesMetricsServerTls) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\vapi_service\x18\t \x01(\v2Z.dev.planton.kubernetes.kubernetesmetricsserver.v1alpha1.KubernetesMetricsServerApiServiceR\n" +
	"apiService\x12e\n" +
	"\x03tls\x18\n" +
	" \x01(\v2S.dev.planton.kubernetes.kubernetesmetricsserver.v1alpha1.KubernetesMetricsServerTlsR\x03tls\x12H\n" +
	"\tresources\x18\v \x01(\v2*.dev.planton.kubernetes.ContainerResourcesR\tresources\x12\x8b\x01\n" +
	"\rnode_selector\x18\f \x03(\v2f.dev.planton.kubernetes.kubernetesmetricsserver.v1alpha1.KubernetesMetricsServerSpec.NodeSelectorEntryR\fnodeSelector\x12L\n" +
	"\vtolerations\x18\r \x03(\v2*.dev.planton.kubernetes.WorkloadTolerationR\vtolerations\x12P\n" +
	...
	"\x15pod_disruption_budget\x18\x0f \x01(\bR\x13podDisruptionBudget\x12z\n" +
	"\n" +
	"prometheus\x18\x10 \x01(\v2Z.dev.planton.kubernetes.kubernetesmetricsserver.v1alpha1.KubernetesMetricsServerPrometheusR\n" +
	"prometheus\x12k\n" +
	"\x05image\x18\x11 \x01(\v2U.dev.planton.kubernetes.kubernetesmetricsserver.v1alpha1.KubernetesMetricsServerImageR\x05image\x12\x1f\n" +
	...
	"\x18service_monitor_interval\x18\x03 \x01(\tB\x06\x8a\xa6\x1d\x021mH\x00R\x16serviceMonitorInterval\x88\x01\x01\x12\xaa\x01\n" +
	"\x16service_monitor_labels\x18\x04 \x03(\v2t.dev.planton.kubernetes.kubernetesmetricsserver.v1alpha1.KubernetesMetricsServerPrometheus.ServiceMonitorLabelsEntryR\x14serviceMonitorLabels\x1aG\n" +
...
var (
	file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesmetricsserver_v1alpha1_spec_proto_depIdxs = nil
}
