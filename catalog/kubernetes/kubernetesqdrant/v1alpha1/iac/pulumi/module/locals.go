...
type Locals struct {
	Spec *kubernetesqdrantv1alpha1.KubernetesQdrantSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesqdrantv1alpha1.KubernetesQdrantStackInput) *Locals {
