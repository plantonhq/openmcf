...
// 	protoc        (unknown)
// source: catalog/kubernetes/kubernetesservice/v1alpha1/spec.proto
...
func (KubernetesServiceSpec_KubernetesServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesServiceSpec_KubernetesServiceType) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[0]
}
...
func (KubernetesServiceSpec_KubernetesServiceType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 0}
}
...
func (KubernetesServiceSpec_KubernetesServiceExternalTrafficPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (KubernetesServiceSpec_KubernetesServiceExternalTrafficPolicy) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[1]
}
...
func (KubernetesServiceSpec_KubernetesServiceExternalTrafficPolicy) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 1}
}
...
func (KubernetesServiceSpec_KubernetesServiceInternalTrafficPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (KubernetesServiceSpec_KubernetesServiceInternalTrafficPolicy) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[2]
}
...
func (KubernetesServiceSpec_KubernetesServiceInternalTrafficPolicy) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 2}
}
...
func (KubernetesServiceSpec_KubernetesServiceTrafficDistribution) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[3].Descriptor()
}

func (KubernetesServiceSpec_KubernetesServiceTrafficDistribution) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[3]
}
...
func (KubernetesServiceSpec_KubernetesServiceTrafficDistribution) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 3}
}
...
func (KubernetesServiceSpec_KubernetesServiceSessionAffinity) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[4].Descriptor()
}

func (KubernetesServiceSpec_KubernetesServiceSessionAffinity) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[4]
}
...
func (KubernetesServiceSpec_KubernetesServiceSessionAffinity) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 4}
}
...
func (KubernetesServiceSpec_KubernetesServiceIpFamily) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[5].Descriptor()
}

func (KubernetesServiceSpec_KubernetesServiceIpFamily) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[5]
}
...
func (KubernetesServiceSpec_KubernetesServiceIpFamily) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 5}
}
...
func (KubernetesServiceSpec_KubernetesServiceIpFamilyPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[6].Descriptor()
}

func (KubernetesServiceSpec_KubernetesServiceIpFamilyPolicy) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[6]
}
...
func (KubernetesServiceSpec_KubernetesServiceIpFamilyPolicy) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0, 6}
}
...
func (KubernetesServicePort_KubernetesServiceProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[7].Descriptor()
}

func (KubernetesServicePort_KubernetesServiceProtocol) Type() protoreflect.EnumType {
	return &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes[7]
}
...
func (KubernetesServicePort_KubernetesServiceProtocol) EnumDescriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{1, 0}
}
...
type KubernetesServiceSpec struct {
	...
	// Default: cluster_ip
	Type *KubernetesServiceSpec_KubernetesServiceType `protobuf:"varint,5,opt,name=type,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec_KubernetesServiceType,oneof" json:"type,omitempty"`
	// *
	...
	// Default: cluster
	ExternalTrafficPolicy *KubernetesServiceSpec_KubernetesServiceExternalTrafficPolicy `protobuf:"varint,12,opt,name=external_traffic_policy,json=externalTrafficPolicy,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec_KubernetesServiceExternalTrafficPolicy,oneof" json:"external_traffic_policy,omitempty"`
	// *
	// Internal traffic policy for ClusterIP traffic.
	// Default: internal_cluster
	InternalTrafficPolicy *KubernetesServiceSpec_KubernetesServiceInternalTrafficPolicy `protobuf:"varint,13,opt,name=internal_traffic_policy,json=internalTrafficPolicy,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec_KubernetesServiceInternalTrafficPolicy,oneof" json:"internal_traffic_policy,omitempty"`
	// *
	// Topology-aware routing preference. Omit for the cluster's default routing.
	TrafficDistribution *KubernetesServiceSpec_KubernetesServiceTrafficDistribution `protobuf:"varint,14,opt,name=traffic_distribution,json=trafficDistribution,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec_KubernetesServiceTrafficDistribution,oneof" json:"traffic_distribution,omitempty"`
	// *
	// Session affinity mode.
	// Default: none
	SessionAffinity *KubernetesServiceSpec_KubernetesServiceSessionAffinity `protobuf:"varint,15,opt,name=session_affinity,json=sessionAffinity,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec_KubernetesServiceSessionAffinity,oneof" json:"session_affinity,omitempty"`
	// *
	...
	IpFamilies []KubernetesServiceSpec_KubernetesServiceIpFamily `protobuf:"varint,22,rep,packed,name=ip_families,json=ipFamilies,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec_KubernetesServiceIpFamily" json:"ip_families,omitempty"`
	// *
	// The dual-stack policy for this Service. Omit for SingleStack.
	IpFamilyPolicy *KubernetesServiceSpec_KubernetesServiceIpFamilyPolicy `protobuf:"varint,23,opt,name=ip_family_policy,json=ipFamilyPolicy,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec_KubernetesServiceIpFamilyPolicy,oneof" json:"ip_family_policy,omitempty"`
...
func (x *KubernetesServiceSpec) Reset() {
	*x = KubernetesServiceSpec{}
	mi := &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_msgTypes[0]
...
func (*KubernetesServiceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type KubernetesServicePort struct {
	...
	// Default: TCP
	Protocol *KubernetesServicePort_KubernetesServiceProtocol `protobuf:"varint,2,opt,name=protocol,proto3,enum=dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePort_KubernetesServiceProtocol,oneof" json:"protocol,omitempty"`
	// *
...
func (x *KubernetesServicePort) Reset() {
	*x = KubernetesServicePort{}
	mi := &file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesServicePort) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"8catalog/kubernetes/kubernetesservice/v1alpha1/spec.proto\x121dev.planton.kubernetes.kubernetesservice.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xe77\n" +
	...
	"\x13name.dns_1035_label\x12\xa2\x01Service name must be a valid DNS-1035 label: lowercase alphanumeric and hyphens, starting with a letter and ending with an alphanumeric (e.g. \"my-service\", \"web\")\x1a,this.matches('^[a-z]([-a-z0-9]*[a-z0-9])?$')r\x04\x10\x01\x18?R\x04name\x12l\n" +
	"\x06labels\x18\x03 \x03(\v2T.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.LabelsEntryR\x06labels\x12{\n" +
	"\vannotations\x18\x04 \x03(\v2Y.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.AnnotationsEntryR\vannotations\x12\x8f\x01\n" +
	"\x04type\x18\x05 \x01(\x0e2^.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceTypeB\x16\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\n" +
	"cluster_ipH\x00R\x04type\x88\x01\x01\x12r\n" +
	"\bselector\x18\x06 \x03(\v2V.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.SelectorEntryR\bselector\x12^\n" +
	"\x05ports\x18\a \x03(\v2H.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePortR\x05ports\x12\x1a\n" +
	...
	"\x13external_ips.format\x125each external IP must be a valid IPv4 or IPv6 address\x1a\vthis.isIp()R\vexternalIps\x12\xc1\x01\n" +
	"\x17external_traffic_policy\x18\f \x01(\x0e2o.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceExternalTrafficPolicyB\x13\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\aclusterH\x01R\x15externalTrafficPolicy\x88\x01\x01\x12\xca\x01\n" +
	"\x17internal_traffic_policy\x18\r \x01(\x0e2o.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceInternalTrafficPolicyB\x1c\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x10internal_clusterH\x02R\x15internalTrafficPolicy\x88\x01\x01\x12\xaf\x01\n" +
	"\x14traffic_distribution\x18\x0e \x01(\x0e2m.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceTrafficDistributionB\b\xbaH\x05\x82\x01\x02\x10\x01H\x03R\x13trafficDistribution\x88\x01\x01\x12\xab\x01\n" +
	"\x10session_affinity\x18\x0f \x01(\x0e2i.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceSessionAffinityB\x10\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x04noneH\x04R\x0fsessionAffinity\x88\x01\x01\x12Y\n" +
	...
	"\x1bpublish_not_ready_addresses\x18\x15 \x01(\bR\x18publishNotReadyAddresses\x12\x96\x01\n" +
	"\vip_families\x18\x16 \x03(\x0e2b.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceIpFamilyB\x11\xbaH\x0e\x92\x01\v\x10\x02\"\a\x82\x01\x04\x10\x01 \x00R\n" +
	"ipFamilies\x12\xa1\x01\n" +
	"\x10ip_family_policy\x18\x17 \x01(\x0e2h.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceIpFamilyPolicyB\b\xbaH\x05\x82\x01\x02\x10\x01H\aR\x0eipFamilyPolicy\x88\x01\x01\x1a9\n" +
	...
	"\x11_ip_family_policy\"\x98\v\n" +
	"\x15KubernetesServicePort\x12\xcc\x02\n" +
	"\x04name\x18\x01 \x01(\tB\xb7\x02\xbaH\xb3\x02\xba\x01\xaf\x02\n" +
	"\x17port_name.iana_svc_name\x12\xa0\x01Port name must be a valid IANA service name: lowercase alphanumeric and hyphens, at most 15 characters, containing at least one letter (e.g. \"http\", \"grpc-web\")\x1aqthis == '' || (this.matches('^[a-z0-9]([-a-z0-9]*[a-z0-9])?$') && this.size() <= 15 && this.matches('.*[a-z].*'))R\x04name\x12\x94\x01\n" +
	"\bprotocol\x18\x02 \x01(\x0e2b.dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePort.KubernetesServiceProtocolB\x0f\xbaH\x05\x82\x01\x02\x10\x01\x8a\xa6\x1d\x03TCPH\x00R\bprotocol\x88\x01\x01\x12+\n" +
	...
	"\t_protocolB\x91\x03\n" +
	"5com.dev.planton.kubernetes.kubernetesservice.v1alpha1B\tSpecProtoP\x01Zdgithub.com/plantonhq/planton/catalog/kubernetes/kubernetesservice/v1alpha1;kubernetesservicev1alpha1\xa2\x02\x04DPKK\xaa\x021Dev.Planton.Kubernetes.Kubernetesservice.V1alpha1\xca\x021Dev\\Planton\\Kubernetes\\Kubernetesservice\\V1alpha1\xe2\x02=Dev\\Planton\\Kubernetes\\Kubernetesservice\\V1alpha1\\GPBMetadata\xea\x025Dev::Planton::Kubernetes::Kubernetesservice::V1alpha1b\x06proto3"

var (
	file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDescData
}

var file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_goTypes = []any{
	(KubernetesServiceSpec_KubernetesServiceType)(0),                  // 0: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceType
	(KubernetesServiceSpec_KubernetesServiceExternalTrafficPolicy)(0), // 1: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceExternalTrafficPolicy
	(KubernetesServiceSpec_KubernetesServiceInternalTrafficPolicy)(0), // 2: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceInternalTrafficPolicy
	(KubernetesServiceSpec_KubernetesServiceTrafficDistribution)(0),   // 3: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceTrafficDistribution
	(KubernetesServiceSpec_KubernetesServiceSessionAffinity)(0),       // 4: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceSessionAffinity
	(KubernetesServiceSpec_KubernetesServiceIpFamily)(0),              // 5: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceIpFamily
	(KubernetesServiceSpec_KubernetesServiceIpFamilyPolicy)(0),        // 6: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceIpFamilyPolicy
	(KubernetesServicePort_KubernetesServiceProtocol)(0),              // 7: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePort.KubernetesServiceProtocol
	(*KubernetesServiceSpec)(nil),                                     // 8: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec
	(*KubernetesServicePort)(nil),                                     // 9: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePort
	nil,                                                               // 10: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.LabelsEntry
	nil,                                                               // 11: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.AnnotationsEntry
	nil,                                                               // 12: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.SelectorEntry
	(*v1.StringValueOrRef)(nil),                                       // 13: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_depIdxs = []int32{
	13, // 0: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.namespace:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	10, // 1: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.labels:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.LabelsEntry
	11, // 2: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.annotations:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.AnnotationsEntry
	0,  // 3: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.type:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceType
	12, // 4: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.selector:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.SelectorEntry
	9,  // 5: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.ports:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePort
	1,  // 6: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.external_traffic_policy:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceExternalTrafficPolicy
	2,  // 7: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.internal_traffic_policy:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceInternalTrafficPolicy
	3,  // 8: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.traffic_distribution:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceTrafficDistribution
	4,  // 9: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.session_affinity:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceSessionAffinity
	5,  // 10: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.ip_families:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceIpFamily
	6,  // 11: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.ip_family_policy:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServiceSpec.KubernetesServiceIpFamilyPolicy
	7,  // 12: dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePort.protocol:type_name -> dev.planton.kubernetes.kubernetesservice.v1alpha1.KubernetesServicePort.KubernetesServiceProtocol
...
func init() { file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_init() }
func file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_init() {
	if File_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDesc), len(file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto = out.File
	file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_goTypes = nil
	file_catalog_kubernetes_kubernetesservice_v1alpha1_spec_proto_depIdxs = nil
}
