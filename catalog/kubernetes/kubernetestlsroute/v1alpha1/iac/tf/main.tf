...
#
# Applies one Gateway API TLSRoute custom resource. The CR spec arrives from the
...
# connection at plan time — a TLSRoute can be PLANNED before the Gateway API
...
resource "kubectl_manifest" "tls_route" {
