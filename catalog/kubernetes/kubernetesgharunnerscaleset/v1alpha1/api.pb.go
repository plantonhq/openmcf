...
const file_catalog_kubernetes_kubernetesgharunnerscaleset_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"Acatalog/kubernetes/kubernetesgharunnerscaleset/v1alpha1/api.proto\x12;dev.planton.kubernetes.kubernetesgharunnerscaleset.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1aEcatalog/kubernetes/kubernetesgharunnerscaleset/v1alpha1/outputs.proto\x1aBcatalog/kubernetes/kubernetesgharunnerscaleset/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\xdf\x03\n" +
...
func file_catalog_kubernetes_kubernetesgharunnerscaleset_v1alpha1_api_proto_init() {
	...
	file_catalog_kubernetes_kubernetesgharunnerscaleset_v1alpha1_outputs_proto_init()
