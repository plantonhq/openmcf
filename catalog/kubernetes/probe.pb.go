...
// 	protoc        (unknown)
// source: catalog/kubernetes/probe.proto
...
func (x *Probe) Reset() {
	*x = Probe{}
	mi := &file_catalog_kubernetes_probe_proto_msgTypes[0]
...
func (*Probe) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_probe_proto_rawDescGZIP(), []int{0}
}
...
func (x *HTTPGetAction) Reset() {
	*x = HTTPGetAction{}
	mi := &file_catalog_kubernetes_probe_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPGetAction) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_probe_proto_rawDescGZIP(), []int{1}
}
...
func (x *HTTPHeader) Reset() {
	*x = HTTPHeader{}
	mi := &file_catalog_kubernetes_probe_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPHeader) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_probe_proto_rawDescGZIP(), []int{2}
}
...
func (x *GRPCAction) Reset() {
	*x = GRPCAction{}
	mi := &file_catalog_kubernetes_probe_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GRPCAction) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_probe_proto_rawDescGZIP(), []int{3}
}
...
func (x *TCPSocketAction) Reset() {
	*x = TCPSocketAction{}
	mi := &file_catalog_kubernetes_probe_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TCPSocketAction) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_probe_proto_rawDescGZIP(), []int{4}
}
...
func (x *ExecAction) Reset() {
	*x = ExecAction{}
	mi := &file_catalog_kubernetes_probe_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecAction) Descriptor() ([]byte, []int) {
	return file_catalog_kubernetes_probe_proto_rawDescGZIP(), []int{5}
}
...
var File_catalog_kubernetes_probe_proto protoreflect.FileDescriptor

const file_catalog_kubernetes_probe_proto_rawDesc = "" +
	"\n" +
	"\x1ecatalog/kubernetes/probe.proto\x12\x16dev.planton.kubernetes\x1a\x1bbuf/validate/validate.proto\"\xf2\x03\n" +
	"\x05Probe\x122\n" +
	...
	"\x11failure_threshold\x18\x05 \x01(\x05R\x10failureThreshold\x12B\n" +
	"\bhttp_get\x18\x06 \x01(\v2%.dev.planton.kubernetes.HTTPGetActionH\x00R\ahttpGet\x128\n" +
	"\x04grpc\x18\a \x01(\v2\".dev.planton.kubernetes.GRPCActionH\x00R\x04grpc\x12H\n" +
	"\n" +
	"tcp_socket\x18\b \x01(\v2'.dev.planton.kubernetes.TCPSocketActionH\x00R\ttcpSocket\x128\n" +
	"\x04exec\x18\t \x01(\v2\".dev.planton.kubernetes.ExecActionH\x00R\x04execB\t\n" +
	"\ahandler\"\xe0\x01\n" +
	...
	"\x06scheme\x18\x05 \x01(\tR\x06scheme\x12E\n" +
	"\fhttp_headers\x18\x06 \x03(\v2\".dev.planton.kubernetes.HTTPHeaderR\vhttpHeadersB\x06\n" +
	"\x04port\"6\n" +
	"\n" +
	"HTTPHeader\x12\x12\n" +
	...
	"\n" +
	"ExecAction\x12\x18\n" +
	"\acommand\x18\x01 \x03(\tR\acommandB\xd3\x01\n" +
	"\x1acom.dev.planton.kubernetesB\n" +
	"ProbeProtoP\x01Z/github.com/plantonhq/planton/catalog/kubernetes\xa2\x02\x03DPK\xaa\x02\x16Dev.Planton.Kubernetes\xca\x02\x16Dev\\Planton\\Kubernetes\xe2\x02\"Dev\\Planton\\Kubernetes\\GPBMetadata\xea\x02\x18Dev::Planton::Kubernetesb\x06proto3"

var (
	file_catalog_kubernetes_probe_proto_rawDescOnce sync.Once
	file_catalog_kubernetes_probe_proto_rawDescData []byte
)

func file_catalog_kubernetes_probe_proto_rawDescGZIP() []byte {
	file_catalog_kubernetes_probe_proto_rawDescOnce.Do(func() {
		file_catalog_kubernetes_probe_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_probe_proto_rawDesc), len(file_catalog_kubernetes_probe_proto_rawDesc)))
	})
	return file_catalog_kubernetes_probe_proto_rawDescData
}

var file_catalog_kubernetes_probe_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_catalog_kubernetes_probe_proto_goTypes = []any{
	(*Probe)(nil),           // 0: dev.planton.kubernetes.Probe
	(*HTTPGetAction)(nil),   // 1: dev.planton.kubernetes.HTTPGetAction
	(*HTTPHeader)(nil),      // 2: dev.planton.kubernetes.HTTPHeader
	(*GRPCAction)(nil),      // 3: dev.planton.kubernetes.GRPCAction
	(*TCPSocketAction)(nil), // 4: dev.planton.kubernetes.TCPSocketAction
	(*ExecAction)(nil),      // 5: dev.planton.kubernetes.ExecAction
}
var file_catalog_kubernetes_probe_proto_depIdxs = []int32{
	1, // 0: dev.planton.kubernetes.Probe.http_get:type_name -> dev.planton.kubernetes.HTTPGetAction
	3, // 1: dev.planton.kubernetes.Probe.grpc:type_name -> dev.planton.kubernetes.GRPCAction
	4, // 2: dev.planton.kubernetes.Probe.tcp_socket:type_name -> dev.planton.kubernetes.TCPSocketAction
	5, // 3: dev.planton.kubernetes.Probe.exec:type_name -> dev.planton.kubernetes.ExecAction
	2, // 4: dev.planton.kubernetes.HTTPGetAction.http_headers:type_name -> dev.planton.kubernetes.HTTPHeader
...
func init() { file_catalog_kubernetes_probe_proto_init() }
func file_catalog_kubernetes_probe_proto_init() {
	if File_catalog_kubernetes_probe_proto != nil {
		return
	}
	file_catalog_kubernetes_probe_proto_msgTypes[0].OneofWrappers = []any{
		(*Probe_HttpGet)(nil),
		(*Probe_Grpc)(nil),
		(*Probe_TcpSocket)(nil),
		(*Probe_Exec)(nil),
	}
	file_catalog_kubernetes_probe_proto_msgTypes[1].OneofWrappers = []any{
		(*HTTPGetAction_PortNumber)(nil),
		(*HTTPGetAction_PortName)(nil),
	}
	file_catalog_kubernetes_probe_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_kubernetes_probe_proto_rawDesc), len(file_catalog_kubernetes_probe_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_kubernetes_probe_proto_goTypes,
		DependencyIndexes: file_catalog_kubernetes_probe_proto_depIdxs,
		MessageInfos:      file_catalog_kubernetes_probe_proto_msgTypes,
	}.Build()
	File_catalog_kubernetes_probe_proto = out.File
	file_catalog_kubernetes_probe_proto_goTypes = nil
	file_catalog_kubernetes_probe_proto_depIdxs = nil
}
