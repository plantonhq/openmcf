...
- [KubernetesGatewayApiCrds](/docs/catalog/kubernetes/kubernetesgatewayapicrds) — installs the Gateway API CRDs (prerequisite)
- [KubernetesGateway](/docs/catalog/kubernetes/kubernetesgateway) — references this class via `gatewayClassName` to define listeners and entry points
- [KubernetesHttpRoute](/docs/catalog/kubernetes/kuberneteshttproute) — routes HTTP traffic through a Gateway of this class
