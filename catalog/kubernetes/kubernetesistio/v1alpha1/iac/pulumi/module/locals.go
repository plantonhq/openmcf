...
type Locals struct {
	Spec *kubernetesistiov1alpha1.KubernetesIstioSpec
...
// values.
func initializeLocals(_ *pulumi.Context, stackInput *kubernetesistiov1alpha1.KubernetesIstioStackInput) *Locals {
