...
#
# Applies one Gateway API HTTPRoute custom resource. The CR spec arrives from the
...
# connection at plan time — a HTTPRoute can be PLANNED before the Gateway API
