...
```bash
planton pulumi up --manifest httproute.yaml
```
...
- [`KubernetesGateway`](../../kubernetesgateway/v1alpha1/README.md) -- the Gateway routes attach to.
- [`KubernetesGatewayClass`](../../kubernetesgatewayclass/v1alpha1/README.md) -- the controller class.
- [`KubernetesGatewayApiCrds`](../../kubernetesgatewayapicrds/v1alpha1/README.md) -- installs the CRDs.
- [`KubernetesNamespace`](../../kubernetesnamespace/v1alpha1/README.md) -- the target namespace.
