...
const file_catalog__test_testcloudresourcegeneric_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"9catalog/_test/testcloudresourcegeneric/v1alpha1/api.proto\x123dev.planton._test.testcloudresourcegeneric.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a:catalog/_test/testcloudresourcegeneric/v1alpha1/spec.proto\x1aCcatalog/_test/testcloudresourcegeneric/v1alpha1/stack_outputs.proto\x1a\x15shared/metadata.proto\"\xb6\x03\n" +
...
func file_catalog__test_testcloudresourcegeneric_v1alpha1_api_proto_init() {
	...
	file_catalog__test_testcloudresourcegeneric_v1alpha1_stack_outputs_proto_init()
	type x struct{}
