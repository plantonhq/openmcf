...
**Early Nova floating IPs (2011-2013):** Floating IPs were originally managed through the Nova API (`os-floating-ips`). This legacy API is deprecated and should not be used. Planton exclusively uses the Neutron API.
...
**Cons:** Requires Planton platform.
