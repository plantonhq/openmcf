...
**Cost and time**: the gateway bills per scale unit (~$0.42/hr per
unit) from creation, and ARM takes roughly 30 minutes to provision
one. Each scale unit adds ~2 Gbps of circuit-to-WAN throughput.
