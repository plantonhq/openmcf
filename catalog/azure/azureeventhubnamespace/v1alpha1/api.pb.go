...
func file_catalog_azure_azureeventhubnamespace_v1alpha1_api_proto_init() {
	...
	file_catalog_azure_azureeventhubnamespace_v1alpha1_stack_outputs_proto_init()
	type x struct{}
