...
// 	protoc        (unknown)
// source: catalog/azure/azureserviceplan/v1alpha1/spec.proto
...
func (AzureServicePlanOsType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureServicePlanOsType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureServicePlanOsType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureServicePlanSku) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureServicePlanSku) Type() protoreflect.EnumType {
	return &file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureServicePlanSku) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
type AzureServicePlanSpec struct {
	...
	//
	// **ForceNew**: Changing this destroys and recreates the plan.
	OsType AzureServicePlanOsType `protobuf:"varint,4,opt,name=os_type,json=osType,proto3,enum=dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanOsType" json:"os_type,omitempty"`
	...
	SkuName AzureServicePlanSku `protobuf:"varint,5,opt,name=sku_name,json=skuName,proto3,enum=dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSku" json:"sku_name,omitempty"`
...
func (x *AzureServicePlanSpec) Reset() {
	*x = AzureServicePlanSpec{}
	mi := &file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_msgTypes[0]
...
var File_catalog_azure_azureserviceplan_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"2catalog/azure/azureserviceplan/v1alpha1/spec.proto\x12+dev.planton.azure.azureserviceplan.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xd5\x16\n" +
	...
	"\x18service_plan_name_format\x12UService Plan name must contain only alphanumeric characters, hyphens, and underscores\x1a%this.matches('^[0-9a-zA-Z-_]{1,60}$')\xc8\x01\x01r\x04\x10\x01\x18<R\x0fservicePlanName\x12f\n" +
	"\aos_type\x18\x04 \x01(\x0e2C.dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanOsTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06osType\x12h\n" +
	"\bsku_name\x18\x05 \x01(\x0e2@.dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSkuB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\askuName\x12\xfc\x02\n" +
	...
	"\x18per_site_scaling_enabled\x18\v \x01(\bB\t\x8a\xa6\x1d\x05falseH\x04R\x15perSiteScalingEnabled\x88\x01\x01\x12_\n" +
	"\x04tags\x18\f \x03(\v2K.dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\fWORKFLOW_WS3\x104B\xec\x02\n" +
	"/com.dev.planton.azure.azureserviceplan.v1alpha1B\tSpecProtoP\x01Z]github.com/plantonhq/planton/catalog/azure/azureserviceplan/v1alpha1;azureserviceplanv1alpha1\xa2\x02\x04DPAA\xaa\x02+Dev.Planton.Azure.Azureserviceplan.V1alpha1\xca\x02+Dev\\Planton\\Azure\\Azureserviceplan\\V1alpha1\xe2\x027Dev\\Planton\\Azure\\Azureserviceplan\\V1alpha1\\GPBMetadata\xea\x02/Dev::Planton::Azure::Azureserviceplan::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_goTypes = []any{
	(AzureServicePlanOsType)(0),  // 0: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanOsType
	(AzureServicePlanSku)(0),     // 1: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSku
	(*AzureServicePlanSpec)(nil), // 2: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec
	nil,                          // 3: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),  // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_depIdxs = []int32{
	4, // 0: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 1: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec.os_type:type_name -> dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanOsType
	1, // 2: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec.sku_name:type_name -> dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSku
	3, // 3: dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec.tags:type_name -> dev.planton.azure.azureserviceplan.v1alpha1.AzureServicePlanSpec.TagsEntry
...
func init() { file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_init() }
func file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azureserviceplan_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azureserviceplan_v1alpha1_spec_proto = out.File
	file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azureserviceplan_v1alpha1_spec_proto_depIdxs = nil
}
