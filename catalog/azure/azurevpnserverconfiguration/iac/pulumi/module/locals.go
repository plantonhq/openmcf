...
type Locals struct {
	AzureVpnServerConfiguration *azurevpnserverconfigurationv1alpha1.AzureVpnServerConfiguration
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurevpnserverconfigurationv1alpha1.AzureVpnServerConfigurationStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureVpnServerConfiguration.String()),
	}
