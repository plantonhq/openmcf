locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_machine_learning_compute_cluster"
  ...
  # The spec's VM priorities to the provider's wire values. Required on
  # the provider -- the spec enum is required, so no null fallback.
  vm_priority_wire = {
    "DEDICATED"    = "Dedicated"
