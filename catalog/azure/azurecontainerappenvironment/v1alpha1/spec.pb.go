...
// 	protoc        (unknown)
// source: catalog/azure/azurecontainerappenvironment/v1alpha1/spec.proto
...
func (AzureContainerAppEnvironmentLogsDestination) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureContainerAppEnvironmentLogsDestination) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureContainerAppEnvironmentLogsDestination) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureContainerAppEnvironmentPublicNetworkAccess) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureContainerAppEnvironmentPublicNetworkAccess) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureContainerAppEnvironmentPublicNetworkAccess) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureContainerAppEnvironmentWorkloadProfileType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureContainerAppEnvironmentWorkloadProfileType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureContainerAppEnvironmentWorkloadProfileType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (AzureContainerAppEnvironmentIdentityType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[3].Descriptor()
}

func (AzureContainerAppEnvironmentIdentityType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes[3]
}
...
func (AzureContainerAppEnvironmentIdentityType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
type AzureContainerAppEnvironmentSpec struct {
	...
	LogsDestination AzureContainerAppEnvironmentLogsDestination `protobuf:"varint,4,opt,name=logs_destination,json=logsDestination,proto3,enum=dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentLogsDestination" json:"logs_destination,omitempty"`
	...
	PublicNetworkAccess AzureContainerAppEnvironmentPublicNetworkAccess `protobuf:"varint,11,opt,name=public_network_access,json=publicNetworkAccess,proto3,enum=dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentPublicNetworkAccess" json:"public_network_access,omitempty"`
...
func (x *AzureContainerAppEnvironmentSpec) Reset() {
	*x = AzureContainerAppEnvironmentSpec{}
	mi := &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes[0]
...
type AzureContainerAppEnvironmentWorkloadProfile struct {
	...
	WorkloadProfileType AzureContainerAppEnvironmentWorkloadProfileType `protobuf:"varint,2,opt,name=workload_profile_type,json=workloadProfileType,proto3,enum=dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfileType" json:"workload_profile_type,omitempty"`
...
func (x *AzureContainerAppEnvironmentWorkloadProfile) Reset() {
	*x = AzureContainerAppEnvironmentWorkloadProfile{}
	mi := &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureContainerAppEnvironmentCustomDomain) Reset() {
	*x = AzureContainerAppEnvironmentCustomDomain{}
	mi := &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureContainerAppEnvironmentIdentity struct {
	...
	Type AzureContainerAppEnvironmentIdentityType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentityType" json:"type,omitempty"`
...
func (x *AzureContainerAppEnvironmentIdentity) Reset() {
	*x = AzureContainerAppEnvironmentIdentity{}
	mi := &file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	">catalog/azure/azurecontainerappenvironment/v1alpha1/spec.proto\x127dev.planton.azure.azurecontainerappenvironment.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xc4\x1e\n" +
	...
	"\x17environment_name_format\x12nEnvironment name must contain only alphanumeric characters and hyphens, and may not start or end with a hyphen\x1aRthis.matches('^[a-zA-Z0-9][a-zA-Z0-9-]{1,58}[a-zA-Z0-9]?$') && !this.endsWith('-')\xc8\x01\x01r\x04\x10\x02\x18<R\x0fenvironmentName\x12\x99\x01\n" +
	"\x10logs_destination\x18\x04 \x01(\x0e2d.dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentLogsDestinationB\b\xbaH\x05\x82\x01\x02\x10\x01R\x0flogsDestination\x12\x95\x01\n" +
	...
	" \x01(\bB\t\x8a\xa6\x1d\x05falseH\x01R\x15zoneRedundancyEnabled\x88\x01\x01\x12\xa6\x01\n" +
	"\x15public_network_access\x18\v \x01(\x0e2h.dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentPublicNetworkAccessB\b\xbaH\x05\x82\x01\x02\x10\x01R\x13publicNetworkAccess\x12<\n" +
	"\x12mutual_tls_enabled\x18\f \x01(\bB\t\x8a\xa6\x1d\x05falseH\x02R\x10mutualTlsEnabled\x88\x01\x01\x12\x91\x01\n" +
	"\x11workload_profiles\x18\r \x03(\v2d.dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfileR\x10workloadProfiles\x12\x86\x01\n" +
	"\rcustom_domain\x18\x0e \x01(\v2a.dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentCustomDomainR\fcustomDomain\x12y\n" +
	"\bidentity\x18\x0f \x01(\v2].dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentityR\bidentity\x12w\n" +
	"\x04tags\x18\x10 \x03(\v2c.dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x13_mutual_tls_enabled\"\xc5\x05\n" +
	"+AzureContainerAppEnvironmentWorkloadProfile\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12\xab\x01\n" +
	"\x15workload_profile_type\x18\x02 \x01(\x0e2h.dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfileTypeB\r\xbaH\n" +
	...
	"\x14certificate_password\x18\x03 \x01(\tB\x0e\xbaH\a\xc8\x01\x01r\x02\x10\x01\xa0\xa6\x1d\x01R\x13certificatePassword\"\xf8\x04\n" +
	"$AzureContainerAppEnvironmentIdentity\x12\x81\x01\n" +
	"\x04type\x18\x01 \x01(\x0e2a.dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentityTypeB\n" +
	...
	";com.dev.planton.azure.azurecontainerappenvironment.v1alpha1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/catalog/azure/azurecontainerappenvironment/v1alpha1;azurecontainerappenvironmentv1alpha1\xa2\x02\x04DPAA\xaa\x027Dev.Planton.Azure.Azurecontainerappenvironment.V1alpha1\xca\x027Dev\\Planton\\Azure\\Azurecontainerappenvironment\\V1alpha1\xe2\x02CDev\\Planton\\Azure\\Azurecontainerappenvironment\\V1alpha1\\GPBMetadata\xea\x02;Dev::Planton::Azure::Azurecontainerappenvironment::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_goTypes = []any{
	(AzureContainerAppEnvironmentLogsDestination)(0),     // 0: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentLogsDestination
	(AzureContainerAppEnvironmentPublicNetworkAccess)(0), // 1: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentPublicNetworkAccess
	(AzureContainerAppEnvironmentWorkloadProfileType)(0), // 2: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfileType
	(AzureContainerAppEnvironmentIdentityType)(0),        // 3: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentityType
	(*AzureContainerAppEnvironmentSpec)(nil),             // 4: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec
	(*AzureContainerAppEnvironmentWorkloadProfile)(nil),  // 5: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfile
	(*AzureContainerAppEnvironmentCustomDomain)(nil),     // 6: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentCustomDomain
	(*AzureContainerAppEnvironmentIdentity)(nil),         // 7: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentity
	nil,                         // 8: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 9: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_depIdxs = []int32{
	9,  // 0: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 1: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.logs_destination:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentLogsDestination
	9,  // 2: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.log_analytics_workspace_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 3: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.infrastructure_subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 4: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.public_network_access:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentPublicNetworkAccess
	5,  // 5: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.workload_profiles:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfile
	6,  // 6: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.custom_domain:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentCustomDomain
	7,  // 7: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.identity:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentity
	8,  // 8: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.tags:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentSpec.TagsEntry
	2,  // 9: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfile.workload_profile_type:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentWorkloadProfileType
	3,  // 10: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentity.type:type_name -> dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentityType
	9,  // 11: dev.planton.azure.azurecontainerappenvironment.v1alpha1.AzureContainerAppEnvironmentIdentity.user_assigned_identity_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_init() }
func file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto = out.File
	file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azurecontainerappenvironment_v1alpha1_spec_proto_depIdxs = nil
}
