...
// 	protoc        (unknown)
// source: catalog/azure/azurefunctionapp/v1alpha1/spec.proto
...
func (AzureFunctionAppIdentityType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureFunctionAppIdentityType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureFunctionAppIdentityType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureFunctionAppConnectionStringType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureFunctionAppConnectionStringType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureFunctionAppConnectionStringType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureFunctionAppIpRestrictionAction) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureFunctionAppIpRestrictionAction) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureFunctionAppIpRestrictionAction) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (AzureFunctionAppStorageMountType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[3].Descriptor()
}

func (AzureFunctionAppStorageMountType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[3]
}
...
func (AzureFunctionAppStorageMountType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (AzureFunctionAppBackupFrequencyUnit) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[4].Descriptor()
}

func (AzureFunctionAppBackupFrequencyUnit) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[4]
}
...
func (AzureFunctionAppBackupFrequencyUnit) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (AzureFunctionAppClientCertificateMode) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[5].Descriptor()
}

func (AzureFunctionAppClientCertificateMode) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[5]
}
...
func (AzureFunctionAppClientCertificateMode) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (AzureFunctionAppTlsVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[6].Descriptor()
}

func (AzureFunctionAppTlsVersion) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[6]
}
...
func (AzureFunctionAppTlsVersion) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (AzureFunctionAppFtpsState) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[7].Descriptor()
}

func (AzureFunctionAppFtpsState) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[7]
}
...
func (AzureFunctionAppFtpsState) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (AzureFunctionAppLoadBalancingMode) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[8].Descriptor()
}

func (AzureFunctionAppLoadBalancingMode) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[8]
}
...
func (AzureFunctionAppLoadBalancingMode) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (AzureFunctionAppManagedPipelineMode) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[9].Descriptor()
}

func (AzureFunctionAppManagedPipelineMode) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[9]
}
...
func (AzureFunctionAppManagedPipelineMode) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (AzureFunctionAppUnauthenticatedAction) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[10].Descriptor()
}

func (AzureFunctionAppUnauthenticatedAction) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[10]
}
...
func (AzureFunctionAppUnauthenticatedAction) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{10}
}
...
func (AzureFunctionAppForwardProxyConvention) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[11].Descriptor()
}

func (AzureFunctionAppForwardProxyConvention) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[11]
}
...
func (AzureFunctionAppForwardProxyConvention) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{11}
}
...
func (AzureFunctionAppCookieExpirationConvention) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[12].Descriptor()
}

func (AzureFunctionAppCookieExpirationConvention) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes[12]
}
...
func (AzureFunctionAppCookieExpirationConvention) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{12}
}
...
type AzureFunctionAppSpec struct {
	...
	ClientCertificateMode AzureFunctionAppClientCertificateMode `protobuf:"varint,22,opt,name=client_certificate_mode,json=clientCertificateMode,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppClientCertificateMode" json:"client_certificate_mode,omitempty"`
...
func (x *AzureFunctionAppSpec) Reset() {
	*x = AzureFunctionAppSpec{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[0]
...
type AzureFunctionAppSiteConfig struct {
	...
	MinimumTlsVersion AzureFunctionAppTlsVersion `protobuf:"varint,9,opt,name=minimum_tls_version,json=minimumTlsVersion,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppTlsVersion" json:"minimum_tls_version,omitempty"`
	// Minimum TLS version for the SCM (Kudu) site. Unset deploys TLS_1_2.
	ScmMinimumTlsVersion AzureFunctionAppTlsVersion `protobuf:"varint,10,opt,name=scm_minimum_tls_version,json=scmMinimumTlsVersion,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppTlsVersion" json:"scm_minimum_tls_version,omitempty"`
	...
	FtpsState AzureFunctionAppFtpsState `protobuf:"varint,20,opt,name=ftps_state,json=ftpsState,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppFtpsState" json:"ftps_state,omitempty"`
	// Load balancing mode for distributing requests across instances.
	// Unset deploys LEAST_REQUESTS.
	LoadBalancingMode AzureFunctionAppLoadBalancingMode `protobuf:"varint,21,opt,name=load_balancing_mode,json=loadBalancingMode,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppLoadBalancingMode" json:"load_balancing_mode,omitempty"`
	// IIS-lineage request pipeline mode. INTEGRATED (the default) is
	// correct for everything modern; CLASSIC exists for legacy
	// compatibility only.
	ManagedPipelineMode AzureFunctionAppManagedPipelineMode `protobuf:"varint,22,opt,name=managed_pipeline_mode,json=managedPipelineMode,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppManagedPipelineMode" json:"managed_pipeline_mode,omitempty"`
	...
	// into an allow-list.
	IpRestrictionDefaultAction AzureFunctionAppIpRestrictionAction `protobuf:"varint,27,opt,name=ip_restriction_default_action,json=ipRestrictionDefaultAction,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionAction" json:"ip_restriction_default_action,omitempty"`
...
func (x *AzureFunctionAppSiteConfig) Reset() {
	*x = AzureFunctionAppSiteConfig{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppApplicationStack) Reset() {
	*x = AzureFunctionAppApplicationStack{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppDockerConfig) Reset() {
	*x = AzureFunctionAppDockerConfig{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureFunctionAppIdentity struct {
	...
	Type AzureFunctionAppIdentityType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentityType" json:"type,omitempty"`
...
func (x *AzureFunctionAppIdentity) Reset() {
	*x = AzureFunctionAppIdentity{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppConnectionString) Reset() {
	*x = AzureFunctionAppConnectionString{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppStickySettings) Reset() {
	*x = AzureFunctionAppStickySettings{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureFunctionAppIpRestriction struct {
	...
	Action AzureFunctionAppIpRestrictionAction `protobuf:"varint,3,opt,name=action,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionAction" json:"action,omitempty"`
...
func (x *AzureFunctionAppIpRestriction) Reset() {
	*x = AzureFunctionAppIpRestriction{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppIpRestrictionHeaders) Reset() {
	*x = AzureFunctionAppIpRestrictionHeaders{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppCorsSettings) Reset() {
	*x = AzureFunctionAppCorsSettings{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppAppServiceLogs) Reset() {
	*x = AzureFunctionAppAppServiceLogs{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureFunctionAppStorageMount struct {
	...
	// container (read-only).
	Type AzureFunctionAppStorageMountType `protobuf:"varint,2,opt,name=type,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMountType" json:"type,omitempty"`
...
func (x *AzureFunctionAppStorageMount) Reset() {
	*x = AzureFunctionAppStorageMount{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureFunctionAppBackup) Reset() {
	*x = AzureFunctionAppBackup{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureFunctionAppBackupSchedule struct {
	...
	FrequencyUnit AzureFunctionAppBackupFrequencyUnit `protobuf:"varint,2,opt,name=frequency_unit,json=frequencyUnit,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupFrequencyUnit" json:"frequency_unit,omitempty"`
...
func (x *AzureFunctionAppBackupSchedule) Reset() {
	*x = AzureFunctionAppBackupSchedule{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppBackupSchedule) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{13}
}
...
type AzureFunctionAppAuthSettingsV2 struct {
	...
	UnauthenticatedAction AzureFunctionAppUnauthenticatedAction `protobuf:"varint,5,opt,name=unauthenticated_action,json=unauthenticatedAction,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppUnauthenticatedAction" json:"unauthenticated_action,omitempty"`
	...
	ForwardProxyConvention AzureFunctionAppForwardProxyConvention `protobuf:"varint,10,opt,name=forward_proxy_convention,json=forwardProxyConvention,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppForwardProxyConvention" json:"forward_proxy_convention,omitempty"`
...
func (x *AzureFunctionAppAuthSettingsV2) Reset() {
	*x = AzureFunctionAppAuthSettingsV2{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthSettingsV2) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{14}
}
...
type AzureFunctionAppAuthV2Login struct {
	...
	CookieExpirationConvention AzureFunctionAppCookieExpirationConvention `protobuf:"varint,8,opt,name=cookie_expiration_convention,json=cookieExpirationConvention,proto3,enum=dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppCookieExpirationConvention" json:"cookie_expiration_convention,omitempty"`
...
func (x *AzureFunctionAppAuthV2Login) Reset() {
	*x = AzureFunctionAppAuthV2Login{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2Login) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{15}
}
...
func (x *AzureFunctionAppAuthV2Apple) Reset() {
	*x = AzureFunctionAppAuthV2Apple{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2Apple) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{16}
}
...
func (x *AzureFunctionAppAuthV2ActiveDirectory) Reset() {
	*x = AzureFunctionAppAuthV2ActiveDirectory{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2ActiveDirectory) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{17}
}
...
func (x *AzureFunctionAppAuthV2StaticWebApp) Reset() {
	*x = AzureFunctionAppAuthV2StaticWebApp{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2StaticWebApp) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{18}
}
...
func (x *AzureFunctionAppAuthV2CustomOidc) Reset() {
	*x = AzureFunctionAppAuthV2CustomOidc{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2CustomOidc) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{19}
}
...
func (x *AzureFunctionAppAuthV2Facebook) Reset() {
	*x = AzureFunctionAppAuthV2Facebook{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2Facebook) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{20}
}
...
func (x *AzureFunctionAppAuthV2Github) Reset() {
	*x = AzureFunctionAppAuthV2Github{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2Github) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{21}
}
...
func (x *AzureFunctionAppAuthV2Google) Reset() {
	*x = AzureFunctionAppAuthV2Google{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2Google) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{22}
}
...
func (x *AzureFunctionAppAuthV2Microsoft) Reset() {
	*x = AzureFunctionAppAuthV2Microsoft{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2Microsoft) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{23}
}
...
func (x *AzureFunctionAppAuthV2Twitter) Reset() {
	*x = AzureFunctionAppAuthV2Twitter{}
	mi := &file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFunctionAppAuthV2Twitter) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP(), []int{24}
}
...
var File_catalog_azure_azurefunctionapp_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"2catalog/azure/azurefunctionapp/v1alpha1/spec.proto\x12+dev.planton.azure.azurefunctionapp.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xf4/\n" +
	...
	" \x01(\x05B\f\xbaH\x04\x1a\x02(\x00\x8a\xa6\x1d\x010H\x02R\x14dailyMemoryTimeQuota\x88\x01\x01\x12p\n" +
	"\vsite_config\x18\v \x01(\v2G.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfigB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"siteConfig\x12u\n" +
	"\fapp_settings\x18\f \x03(\v2R.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.AppSettingsEntryR\vappSettings\x12|\n" +
	"\x12connection_strings\x18\r \x03(\v2M.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppConnectionStringR\x11connectionStrings\x12t\n" +
	"\x0fsticky_settings\x18\x0e \x01(\v2K.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStickySettingsR\x0estickySettings\x12\xd8\x02\n" +
	...
	"\x1aclient_certificate_enabled\x18\x15 \x01(\bB\t\x8a\xa6\x1d\x05falseH\bR\x18clientCertificateEnabled\x88\x01\x01\x12\x94\x01\n" +
	"\x17client_certificate_mode\x18\x16 \x01(\x0e2R.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppClientCertificateModeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x15clientCertificateMode\x12K\n" +
	...
	"R\"virtualNetworkBackupRestoreEnabled\x88\x01\x01\x12a\n" +
	"\bidentity\x18\x1b \x01(\v2E.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentityR\bidentity\x12\x9d\x01\n" +
	...
	"\x0fzip_deploy_file\x18\x1f \x01(\tR\rzipDeployFile\x12p\n" +
	"\x0estorage_mounts\x18  \x03(\v2I.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMountR\rstorageMounts\x12[\n" +
	"\x06backup\x18! \x01(\v2C.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupR\x06backup\x12u\n" +
	"\x10auth_settings_v2\x18\" \x01(\v2K.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2R\x0eauthSettingsV2\x12_\n" +
	"\x04tags\x18# \x03(\v2K.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.TagsEntryR\x04tags\x1a>\n" +
	...
	")_ftp_publish_basic_authentication_enabled\"\xe7\"\n" +
	"\x1aAzureFunctionAppSiteConfig\x12z\n" +
	"\x11application_stack\x18\x01 \x01(\v2M.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppApplicationStackR\x10applicationStack\x12 \n" +
	...
	"\x13minimum_tls_version\x18\t \x01(\x0e2G.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppTlsVersionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x11minimumTlsVersion\x12\x88\x01\n" +
	"\x17scm_minimum_tls_version\x18\n" +
	" \x01(\x0e2G.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppTlsVersionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x14scmMinimumTlsVersion\x12\x80\a\n" +
	...
	"\x16vnet_route_all_enabled\x18\x13 \x01(\bB\t\x8a\xa6\x1d\x05falseH\tR\x13vnetRouteAllEnabled\x88\x01\x01\x12o\n" +
	"\n" +
	"ftps_state\x18\x14 \x01(\x0e2F.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppFtpsStateB\b\xbaH\x05\x82\x01\x02\x10\x01R\tftpsState\x12\x88\x01\n" +
	"\x13load_balancing_mode\x18\x15 \x01(\x0e2N.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppLoadBalancingModeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x11loadBalancingMode\x12\x8e\x01\n" +
	"\x15managed_pipeline_mode\x18\x16 \x01(\x0e2P.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppManagedPipelineModeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x13managedPipelineMode\x12H\n" +
	...
	"\x04cors\x18\x19 \x01(\v2I.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppCorsSettingsR\x04cors\x12s\n" +
	"\x0fip_restrictions\x18\x1a \x03(\v2J.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionR\x0eipRestrictions\x12\x9d\x01\n" +
	"\x1dip_restriction_default_action\x18\x1b \x01(\x0e2P.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionActionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x1aipRestrictionDefaultAction\x12L\n" +
	"\x1bscm_use_main_ip_restriction\x18\x1c \x01(\bB\t\x8a\xa6\x1d\x05falseH\fR\x17scmUseMainIpRestriction\x88\x01\x01\x12z\n" +
	"\x13scm_ip_restrictions\x18\x1d \x03(\v2J.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionR\x11scmIpRestrictions\x12\xa4\x01\n" +
	"!scm_ip_restriction_default_action\x18\x1e \x01(\x0e2P.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionActionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x1dscmIpRestrictionDefaultAction\x12u\n" +
	"\x10app_service_logs\x18\x1f \x01(\v2K.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAppServiceLogsR\x0eappServiceLogs\x12d\n" +
	...
	"(_container_registry_use_managed_identity\"\x81\n" +
	"\n" +
	...
	"\x1dpowershell_core_version_valid\x123powershell_core_version must be one of: 7, 7.2, 7.4\x1a)this == '' || this in ['7', '7.2', '7.4']R\x15powershellCoreVersion\x12a\n" +
	"\x06docker\x18\a \x01(\v2I.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppDockerConfigR\x06docker\x121\n" +
	...
	"\x11registry_password\x18\x05 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB\x04\xa0\xa6\x1d\x01R\x10registryPassword\"\xf8\x03\n" +
	...
	"&function_app_sticky_settings_not_empty\x12Xsticky_settings requires at least one app_setting_names or connection_string_names entry\x1aLthis.app_setting_names.size() > 0 || this.connection_string_names.size() > 0\"\xc8\x04\n" +
	...
	"\x06action\x18\x03 \x01(\x0e2P.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionActionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06action\x12\x1d\n" +
	"\n" +
	...
	"\aheaders\x18\b \x01(\v2Q.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionHeadersR\aheadersB\v\n" +
	"\t_priority\"\xcb\x02\n" +
	...
	"\x16_retention_period_days\"\xb5\x03\n" +
	"\x1cAzureFunctionAppStorageMount\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12n\n" +
	"\x04type\x18\x02 \x01(\x0e2M.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMountTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12-\n" +
	...
	"\n" +
	"mount_path\x18\x06 \x01(\tR\tmountPath\"\xce\x02\n" +
	...
	"\bschedule\x18\x04 \x01(\v2K.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupScheduleB\x06\xbaH\x03\xc8\x01\x01R\bscheduleB\n" +
	"\n" +
	"\b_enabled\"\xcb\x03\n" +
	...
	"\x0efrequency_unit\x18\x02 \x01(\x0e2P.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupFrequencyUnitB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\rfrequencyUnit\x12F\n" +
	...
	"\x16_retention_period_days\"\xb2\x13\n" +
	...
	"\x16unauthenticated_action\x18\x05 \x01(\x0e2R.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppUnauthenticatedActionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x15unauthenticatedAction\x12)\n" +
	...
	" \x01(\x0e2S.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppForwardProxyConventionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x16forwardProxyConvention\x12O\n" +
	...
	"\x05login\x18\r \x01(\v2H.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2LoginB\x06\xbaH\x03\xc8\x01\x01R\x05login\x12c\n" +
	"\bapple_v2\x18\x0e \x01(\v2H.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2AppleR\aappleV2\x12\x82\x01\n" +
	"\x13active_directory_v2\x18\x0f \x01(\v2R.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2ActiveDirectoryR\x11activeDirectoryV2\x12\x85\x01\n" +
	"\x17azure_static_web_app_v2\x18\x10 \x01(\v2O.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2StaticWebAppR\x13azureStaticWebAppV2\x12s\n" +
	"\x0ecustom_oidc_v2\x18\x11 \x03(\v2M.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2CustomOidcR\fcustomOidcV2\x12l\n" +
	"\vfacebook_v2\x18\x12 \x01(\v2K.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2FacebookR\n" +
	"facebookV2\x12f\n" +
	"\tgithub_v2\x18\x13 \x01(\v2I.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2GithubR\bgithubV2\x12f\n" +
	"\tgoogle_v2\x18\x14 \x01(\v2I.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2GoogleR\bgoogleV2\x12o\n" +
	"\fmicrosoft_v2\x18\x15 \x01(\v2L.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2MicrosoftR\vmicrosoftV2\x12i\n" +
	"\n" +
	"twitter_v2\x18\x16 \x01(\v2J.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2TwitterR\ttwitterV2:\xc0\x02\xbaH\xbc\x02\x1a\xb9\x02\n" +
	...
	"\x1ccookie_expiration_convention\x18\b \x01(\x0e2W.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppCookieExpirationConventionB\b\xbaH\x05\x82\x01\x02\x10\x01R\x1acookieExpirationConvention\x12\xd9\x01\n" +
	...
	"\x10login_parameters\x18\x05 \x03(\v2g.dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2ActiveDirectory.LoginParametersEntryR\x0floginParameters\x12N\n" +
	...
	"/com.dev.planton.azure.azurefunctionapp.v1alpha1B\tSpecProtoP\x01Z]github.com/plantonhq/planton/catalog/azure/azurefunctionapp/v1alpha1;azurefunctionappv1alpha1\xa2\x02\x04DPAA\xaa\x02+Dev.Planton.Azure.Azurefunctionapp.V1alpha1\xca\x02+Dev\\Planton\\Azure\\Azurefunctionapp\\V1alpha1\xe2\x027Dev\\Planton\\Azure\\Azurefunctionapp\\V1alpha1\\GPBMetadata\xea\x02/Dev::Planton::Azure::Azurefunctionapp::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 13)
var file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_goTypes = []any{
	(AzureFunctionAppIdentityType)(0),               // 0: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentityType
	(AzureFunctionAppConnectionStringType)(0),       // 1: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppConnectionStringType
	(AzureFunctionAppIpRestrictionAction)(0),        // 2: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionAction
	(AzureFunctionAppStorageMountType)(0),           // 3: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMountType
	(AzureFunctionAppBackupFrequencyUnit)(0),        // 4: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupFrequencyUnit
	(AzureFunctionAppClientCertificateMode)(0),      // 5: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppClientCertificateMode
	(AzureFunctionAppTlsVersion)(0),                 // 6: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppTlsVersion
	(AzureFunctionAppFtpsState)(0),                  // 7: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppFtpsState
	(AzureFunctionAppLoadBalancingMode)(0),          // 8: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppLoadBalancingMode
	(AzureFunctionAppManagedPipelineMode)(0),        // 9: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppManagedPipelineMode
	(AzureFunctionAppUnauthenticatedAction)(0),      // 10: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppUnauthenticatedAction
	(AzureFunctionAppForwardProxyConvention)(0),     // 11: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppForwardProxyConvention
	(AzureFunctionAppCookieExpirationConvention)(0), // 12: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppCookieExpirationConvention
	(*AzureFunctionAppSpec)(nil),                    // 13: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec
	(*AzureFunctionAppSiteConfig)(nil),              // 14: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig
	(*AzureFunctionAppApplicationStack)(nil),        // 15: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppApplicationStack
	(*AzureFunctionAppDockerConfig)(nil),            // 16: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppDockerConfig
	(*AzureFunctionAppIdentity)(nil),                // 17: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentity
	(*AzureFunctionAppConnectionString)(nil),        // 18: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppConnectionString
	(*AzureFunctionAppStickySettings)(nil),          // 19: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStickySettings
	(*AzureFunctionAppIpRestriction)(nil),           // 20: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestriction
	(*AzureFunctionAppIpRestrictionHeaders)(nil),    // 21: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionHeaders
	(*AzureFunctionAppCorsSettings)(nil),            // 22: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppCorsSettings
	(*AzureFunctionAppAppServiceLogs)(nil),          // 23: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAppServiceLogs
	(*AzureFunctionAppStorageMount)(nil),            // 24: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMount
	(*AzureFunctionAppBackup)(nil),                  // 25: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackup
	(*AzureFunctionAppBackupSchedule)(nil),          // 26: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupSchedule
	(*AzureFunctionAppAuthSettingsV2)(nil),          // 27: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2
	(*AzureFunctionAppAuthV2Login)(nil),             // 28: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Login
	(*AzureFunctionAppAuthV2Apple)(nil),             // 29: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Apple
	(*AzureFunctionAppAuthV2ActiveDirectory)(nil),   // 30: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2ActiveDirectory
	(*AzureFunctionAppAuthV2StaticWebApp)(nil),      // 31: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2StaticWebApp
	(*AzureFunctionAppAuthV2CustomOidc)(nil),        // 32: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2CustomOidc
	(*AzureFunctionAppAuthV2Facebook)(nil),          // 33: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Facebook
	(*AzureFunctionAppAuthV2Github)(nil),            // 34: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Github
	(*AzureFunctionAppAuthV2Google)(nil),            // 35: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Google
	(*AzureFunctionAppAuthV2Microsoft)(nil),         // 36: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Microsoft
	(*AzureFunctionAppAuthV2Twitter)(nil),           // 37: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Twitter
	nil,                                             // 38: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.AppSettingsEntry
	nil,                                             // 39: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.TagsEntry
	nil,                                             // 40: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2ActiveDirectory.LoginParametersEntry
	(*v1.StringValueOrRef)(nil),                     // 41: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_depIdxs = []int32{
	41, // 0: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	41, // 1: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.service_plan_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	41, // 2: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.storage_account_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	41, // 3: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.storage_account_access_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	14, // 4: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.site_config:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig
	38, // 5: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.app_settings:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.AppSettingsEntry
	18, // 6: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.connection_strings:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppConnectionString
	19, // 7: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.sticky_settings:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStickySettings
	41, // 8: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.application_insights_connection_string:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	5,  // 9: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.client_certificate_mode:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppClientCertificateMode
	41, // 10: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.virtual_network_subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	17, // 11: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.identity:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentity
	41, // 12: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.key_vault_reference_identity_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	24, // 13: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.storage_mounts:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMount
	25, // 14: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.backup:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackup
	27, // 15: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.auth_settings_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2
	39, // 16: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.tags:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSpec.TagsEntry
	15, // 17: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.application_stack:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppApplicationStack
	6,  // 18: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.minimum_tls_version:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppTlsVersion
	6,  // 19: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.scm_minimum_tls_version:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppTlsVersion
	7,  // 20: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.ftps_state:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppFtpsState
	8,  // 21: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.load_balancing_mode:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppLoadBalancingMode
	9,  // 22: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.managed_pipeline_mode:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppManagedPipelineMode
	22, // 23: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.cors:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppCorsSettings
	20, // 24: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.ip_restrictions:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestriction
	2,  // 25: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.ip_restriction_default_action:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionAction
	20, // 26: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.scm_ip_restrictions:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestriction
	2,  // 27: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.scm_ip_restriction_default_action:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionAction
	23, // 28: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppSiteConfig.app_service_logs:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAppServiceLogs
	16, // 29: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppApplicationStack.docker:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppDockerConfig
	41, // 30: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppDockerConfig.registry_password:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 31: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentity.type:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentityType
	41, // 32: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIdentity.identity_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1,  // 33: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppConnectionString.type:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppConnectionStringType
	41, // 34: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppConnectionString.value:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 35: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestriction.action:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionAction
	41, // 36: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestriction.virtual_network_subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	21, // 37: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestriction.headers:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionHeaders
	41, // 38: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppIpRestrictionHeaders.x_azure_fdid:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3,  // 39: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMount.type:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMountType
	41, // 40: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppStorageMount.access_key:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	41, // 41: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackup.storage_account_url:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	26, // 42: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackup.schedule:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupSchedule
	4,  // 43: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupSchedule.frequency_unit:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppBackupFrequencyUnit
	10, // 44: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.unauthenticated_action:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppUnauthenticatedAction
	11, // 45: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.forward_proxy_convention:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppForwardProxyConvention
	28, // 46: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.login:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Login
	29, // 47: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.apple_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Apple
	30, // 48: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.active_directory_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2ActiveDirectory
	31, // 49: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.azure_static_web_app_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2StaticWebApp
	32, // 50: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.custom_oidc_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2CustomOidc
	33, // 51: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.facebook_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Facebook
	34, // 52: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.github_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Github
	35, // 53: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.google_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Google
	36, // 54: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.microsoft_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Microsoft
	37, // 55: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthSettingsV2.twitter_v2:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Twitter
	12, // 56: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2Login.cookie_expiration_convention:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppCookieExpirationConvention
	40, // 57: dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2ActiveDirectory.login_parameters:type_name -> dev.planton.azure.azurefunctionapp.v1alpha1.AzureFunctionAppAuthV2ActiveDirectory.LoginParametersEntry
...
func init() { file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_init() }
func file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azurefunctionapp_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[9].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[10].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[12].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[13].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[14].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[15].OneofWrappers = []any{}
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes[17].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      13,
			NumMessages:   28,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurefunctionapp_v1alpha1_spec_proto = out.File
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azurefunctionapp_v1alpha1_spec_proto_depIdxs = nil
}
