# AzureEventgridDomain Pulumi Module
...
- `eventgrid.Domain` -- the domain (endpoint, access keys, topic-lifecycle flags, optional managed identity, optional IP firewall)
