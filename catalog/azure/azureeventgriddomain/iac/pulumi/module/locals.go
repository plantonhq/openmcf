...
type Locals struct {
	AzureEventgridDomain *azureeventgriddomainv1alpha1.AzureEventgridDomain
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureeventgriddomainv1alpha1.AzureEventgridDomainStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureEventgridDomain.String()),
	}
