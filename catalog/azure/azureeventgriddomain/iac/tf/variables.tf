...
variable "spec" {
  description = "AzureEventgridDomain specification"
  type = object({
    ...
    # Domain-topic lifecycle: auto-managed (both true, Azure's default)
    # or pinned (both false -- topics exist only as declared
