locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_machine_learning_compute_instance"
  ...
  # NOTE: instance tags are ForceNew on the provider -- changing any tag
  # replaces the instance (its OS disk and local files go with it).
