...
- [Azure Front Door Custom Domain](/docs/catalog/azure/azurefrontdoorcustomdomain) -- terminates TLS with this secret
- [Azure Key Vault Certificate](/docs/catalog/azure/azurekeyvaultcertificate) -- the wrapped certificate
