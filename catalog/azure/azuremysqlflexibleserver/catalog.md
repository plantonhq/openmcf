...
spec:
  ...
  administratorPassword:
    value: "$secret/mysql-admin-password"
...
- [**Azure User Assigned Identity**](/cloud-catalog/azure-user-assigned-identity) -- unwraps the CMK and serves as the Entra administrator principal
