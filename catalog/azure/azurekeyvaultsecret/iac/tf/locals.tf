locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_key_vault_secret"
  ...
  # override the derived values where they collide. Key Vault caps a
  # secret at 15 tags -- the spec's own cap leaves room for the four-to-six
  # derived entries.
