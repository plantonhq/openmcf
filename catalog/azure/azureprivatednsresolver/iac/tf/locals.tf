locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_private_dns_resolver"
  ...
  # Spec enum NAME -> ARM wire value. Unspecified applies Dynamic, the
  # provider's own default, kept explicit here so plans are deterministic.
  allocation_method_wire = {
    "DYNAMIC" = "Dynamic"
    "STATIC"  = "Static"
  }
}
