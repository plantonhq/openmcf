...
// 	protoc        (unknown)
// source: catalog/azure/azurefederatedidentitycredential/v1alpha1/spec.proto
...
func (x *AzureFederatedIdentityCredentialSpec) Reset() {
	*x = AzureFederatedIdentityCredentialSpec{}
	mi := &file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_msgTypes[0]
...
func (*AzureFederatedIdentityCredentialSpec) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"Bcatalog/azure/azurefederatedidentitycredential/v1alpha1/spec.proto\x12;dev.planton.azure.azurefederatedidentitycredential.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xd8\x03\n" +
	...
	"\t_audienceB\xdc\x03\n" +
	"?com.dev.planton.azure.azurefederatedidentitycredential.v1alpha1B\tSpecProtoP\x01Z}github.com/plantonhq/planton/catalog/azure/azurefederatedidentitycredential/v1alpha1;azurefederatedidentitycredentialv1alpha1\xa2\x02\x04DPAA\xaa\x02;Dev.Planton.Azure.Azurefederatedidentitycredential.V1alpha1\xca\x02;Dev\\Planton\\Azure\\Azurefederatedidentitycredential\\V1alpha1\xe2\x02GDev\\Planton\\Azure\\Azurefederatedidentitycredential\\V1alpha1\\GPBMetadata\xea\x02?Dev::Planton::Azure::Azurefederatedidentitycredential::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_goTypes = []any{
	(*AzureFederatedIdentityCredentialSpec)(nil), // 0: dev.planton.azure.azurefederatedidentitycredential.v1alpha1.AzureFederatedIdentityCredentialSpec
	(*v1.StringValueOrRef)(nil),                  // 1: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.azure.azurefederatedidentitycredential.v1alpha1.AzureFederatedIdentityCredentialSpec.user_assigned_identity:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.azure.azurefederatedidentitycredential.v1alpha1.AzureFederatedIdentityCredentialSpec.issuer:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_init() }
func file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto = out.File
	file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azurefederatedidentitycredential_v1alpha1_spec_proto_depIdxs = nil
}
