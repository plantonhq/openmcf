...
The deploying principal needs `Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/*` on the vault's resource group plus read on the storage account (Contributor covers both).
