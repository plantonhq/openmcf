locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_search_service"
  ...
  # The spec's hosting modes to the provider's wire values (the ARM enum
  # is camelCase). Unspecified maps to null so the provider applies its
  # default, "default".
  hosting_mode_wire = {
    "DEFAULT"      = "default"
