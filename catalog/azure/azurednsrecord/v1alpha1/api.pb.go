...
const file_catalog_azure_azurednsrecord_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"/catalog/azure/azurednsrecord/v1alpha1/api.proto\x12)dev.planton.azure.azurednsrecord.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a3catalog/azure/azurednsrecord/v1alpha1/outputs.proto\x1a0catalog/azure/azurednsrecord/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\x82\x03\n" +
...
func file_catalog_azure_azurednsrecord_v1alpha1_api_proto_init() {
	...
	file_catalog_azure_azurednsrecord_v1alpha1_outputs_proto_init()
