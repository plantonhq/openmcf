...
type Locals struct {
	AzureMongoCluster *azuremongoclusterv1alpha1.AzureMongoCluster
...
func initializeLocals(ctx *pulumi.Context, stackInput *azuremongoclusterv1alpha1.AzureMongoClusterStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureMongoCluster.String()),
	}
