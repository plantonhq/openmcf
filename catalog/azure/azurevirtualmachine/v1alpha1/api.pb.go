...
const file_catalog_azure_azurevirtualmachine_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"4catalog/azure/azurevirtualmachine/v1alpha1/api.proto\x12.dev.planton.azure.azurevirtualmachine.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a8catalog/azure/azurevirtualmachine/v1alpha1/outputs.proto\x1a5catalog/azure/azurevirtualmachine/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\xa0\x03\n" +
...
func file_catalog_azure_azurevirtualmachine_v1alpha1_api_proto_init() {
	...
	file_catalog_azure_azurevirtualmachine_v1alpha1_outputs_proto_init()
