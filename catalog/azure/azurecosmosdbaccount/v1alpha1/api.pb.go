...
const file_catalog_azure_azurecosmosdbaccount_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"5catalog/azure/azurecosmosdbaccount/v1alpha1/api.proto\x12/dev.planton.azure.azurecosmosdbaccount.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a9catalog/azure/azurecosmosdbaccount/v1alpha1/outputs.proto\x1a6catalog/azure/azurecosmosdbaccount/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\xa6\x03\n" +
...
func file_catalog_azure_azurecosmosdbaccount_v1alpha1_api_proto_init() {
	...
	file_catalog_azure_azurecosmosdbaccount_v1alpha1_outputs_proto_init()
