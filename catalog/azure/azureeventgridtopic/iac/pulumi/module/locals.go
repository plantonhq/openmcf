...
type Locals struct {
	AzureEventgridTopic *azureeventgridtopicv1alpha1.AzureEventgridTopic
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureeventgridtopicv1alpha1.AzureEventgridTopicStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureEventgridTopic.String()),
	}
