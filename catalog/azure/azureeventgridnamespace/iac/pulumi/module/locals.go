...
type Locals struct {
	AzureEventgridNamespace *azureeventgridnamespacev1alpha1.AzureEventgridNamespace
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureeventgridnamespacev1alpha1.AzureEventgridNamespaceStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureEventgridNamespace.String()),
	}
