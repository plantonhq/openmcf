...
// 	protoc        (unknown)
// source: catalog/azure/azureipgroup/v1alpha1/spec.proto
...
func (x *AzureIpGroupSpec) Reset() {
	*x = AzureIpGroupSpec{}
	mi := &file_catalog_azure_azureipgroup_v1alpha1_spec_proto_msgTypes[0]
...
func (*AzureIpGroupSpec) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_azure_azureipgroup_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	".catalog/azure/azureipgroup/v1alpha1/spec.proto\x12'dev.planton.azure.azureipgroup.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\xa0\x05\n" +
	...
	"\x05cidrs\x18\x04 \x03(\tB\f\xbaH\t\x92\x01\x06\"\x04r\x02\x10\x01R\x05cidrs\x12W\n" +
	"\x04tags\x18\x05 \x03(\v2C.dev.planton.azure.azureipgroup.v1alpha1.AzureIpGroupSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xd0\x02\n" +
	"+com.dev.planton.azure.azureipgroup.v1alpha1B\tSpecProtoP\x01ZUgithub.com/plantonhq/planton/catalog/azure/azureipgroup/v1alpha1;azureipgroupv1alpha1\xa2\x02\x04DPAA\xaa\x02'Dev.Planton.Azure.Azureipgroup.V1alpha1\xca\x02'Dev\\Planton\\Azure\\Azureipgroup\\V1alpha1\xe2\x023Dev\\Planton\\Azure\\Azureipgroup\\V1alpha1\\GPBMetadata\xea\x02+Dev::Planton::Azure::Azureipgroup::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azureipgroup_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_azure_azureipgroup_v1alpha1_spec_proto_goTypes = []any{
	(*AzureIpGroupSpec)(nil),    // 0: dev.planton.azure.azureipgroup.v1alpha1.AzureIpGroupSpec
	nil,                         // 1: dev.planton.azure.azureipgroup.v1alpha1.AzureIpGroupSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azureipgroup_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.azure.azureipgroup.v1alpha1.AzureIpGroupSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.azure.azureipgroup.v1alpha1.AzureIpGroupSpec.tags:type_name -> dev.planton.azure.azureipgroup.v1alpha1.AzureIpGroupSpec.TagsEntry
...
func init() { file_catalog_azure_azureipgroup_v1alpha1_spec_proto_init() }
func file_catalog_azure_azureipgroup_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azureipgroup_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azureipgroup_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azureipgroup_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azureipgroup_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_azure_azureipgroup_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azureipgroup_v1alpha1_spec_proto = out.File
	file_catalog_azure_azureipgroup_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azureipgroup_v1alpha1_spec_proto_depIdxs = nil
}
