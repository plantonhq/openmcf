...
// 	protoc        (unknown)
// source: catalog/azure/azureservicebusnamespace/v1alpha1/spec.proto
...
func (AzureServiceBusNamespaceSku) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureServiceBusNamespaceSku) Type() protoreflect.EnumType {
	return &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureServiceBusNamespaceSku) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureServiceBusNamespaceIdentityType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureServiceBusNamespaceIdentityType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureServiceBusNamespaceIdentityType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureServiceBusNetworkDefaultAction) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureServiceBusNetworkDefaultAction) Type() protoreflect.EnumType {
	return &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureServiceBusNetworkDefaultAction) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
type AzureServiceBusNamespaceSpec struct {
	...
	Sku AzureServiceBusNamespaceSku `protobuf:"varint,4,opt,name=sku,proto3,enum=dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSku" json:"sku,omitempty"`
...
func (x *AzureServiceBusNamespaceSpec) Reset() {
	*x = AzureServiceBusNamespaceSpec{}
	mi := &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[0]
...
type AzureServiceBusNamespaceIdentity struct {
	...
	Type AzureServiceBusNamespaceIdentityType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentityType" json:"type,omitempty"`
...
func (x *AzureServiceBusNamespaceIdentity) Reset() {
	*x = AzureServiceBusNamespaceIdentity{}
	mi := &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AzureServiceBusNamespaceCustomerManagedKey) Reset() {
	*x = AzureServiceBusNamespaceCustomerManagedKey{}
	mi := &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AzureServiceBusNamespaceNetworkRuleSet struct {
	...
	DefaultAction AzureServiceBusNetworkDefaultAction `protobuf:"varint,1,opt,name=default_action,json=defaultAction,proto3,enum=dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNetworkDefaultAction" json:"default_action,omitempty"`
...
func (x *AzureServiceBusNamespaceNetworkRuleSet) Reset() {
	*x = AzureServiceBusNamespaceNetworkRuleSet{}
	mi := &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureServiceBusNamespaceNetworkRuleSet) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AzureServiceBusNamespaceNetworkRule) Reset() {
	*x = AzureServiceBusNamespaceNetworkRule{}
	mi := &file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureServiceBusNamespaceNetworkRule) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":catalog/azure/azureservicebusnamespace/v1alpha1/spec.proto\x123dev.planton.azure.azureservicebusnamespace.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xa6\x1a\n" +
	...
	"*service_bus_namespace_name_reserved_suffix\x12nnamespace_name cannot end with '-sb' or '-mgmt' -- Azure reserves these suffixes for its own service endpoints\x1a0!this.endsWith('-sb') && !this.endsWith('-mgmt')\xc8\x01\x01r\x04\x10\x06\x182R\rnamespaceName\x12l\n" +
	"\x03sku\x18\x04 \x01(\x0e2P.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSkuB\b\xbaH\x05\x82\x01\x02\x10\x01R\x03sku\x120\n" +
	"\bcapacity\x18\x05 \x01(\x05B\x0f\xbaH\f\x1a\n" +
	"0\x010\x020\x040\b0\x10H\x00R\bcapacity\x88\x01\x01\x12R\n" +
	"\x1cpremium_messaging_partitions\x18\x06 \x01(\x05B\v\xbaH\b\x1a\x060\x010\x020\x04H\x01R\x1apremiumMessagingPartitions\x88\x01\x01\x12q\n" +
	"\bidentity\x18\a \x01(\v2U.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentityR\bidentity\x12\x91\x01\n" +
	"\x14customer_managed_key\x18\b \x01(\v2_.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceCustomerManagedKeyR\x12customerManagedKey\x12;\n" +
	...
	" \x01(\bB\b\x8a\xa6\x1d\x04trueH\x03R\x1apublicNetworkAccessEnabled\x88\x01\x01\x12\x85\x01\n" +
	"\x10network_rule_set\x18\v \x01(\v2[.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRuleSetR\x0enetworkRuleSet\x12o\n" +
	"\x04tags\x18\f \x03(\v2[.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x1e_public_network_access_enabled\"\xeb\x04\n" +
	" AzureServiceBusNamespaceIdentity\x12y\n" +
	"\x04type\x18\x01 \x01(\x0e2Y.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentityTypeB\n" +
	...
	"\"_infrastructure_encryption_enabled\"\xde\x06\n" +
	"&AzureServiceBusNamespaceNetworkRuleSet\x12\x89\x01\n" +
	"\x0edefault_action\x18\x01 \x01(\x0e2X.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNetworkDefaultActionB\b\xbaH\x05\x82\x01\x02\x10\x01R\rdefaultAction\x12P\n" +
	...
	"\bip_rules\x18\x04 \x03(\tR\aipRules\x12}\n" +
	"\rnetwork_rules\x18\x05 \x03(\v2X.dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRuleR\fnetworkRules:\xbd\x02\xbaH\xb9\x02\x1a\xb6\x02\n" +
	...
	"\x04DENY\x10\x02B\xa4\x03\n" +
	"7com.dev.planton.azure.azureservicebusnamespace.v1alpha1B\tSpecProtoP\x01Zmgithub.com/plantonhq/planton/catalog/azure/azureservicebusnamespace/v1alpha1;azureservicebusnamespacev1alpha1\xa2\x02\x04DPAA\xaa\x023Dev.Planton.Azure.Azureservicebusnamespace.V1alpha1\xca\x023Dev\\Planton\\Azure\\Azureservicebusnamespace\\V1alpha1\xe2\x02?Dev\\Planton\\Azure\\Azureservicebusnamespace\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Azure::Azureservicebusnamespace::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_goTypes = []any{
	(AzureServiceBusNamespaceSku)(0),                   // 0: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSku
	(AzureServiceBusNamespaceIdentityType)(0),          // 1: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentityType
	(AzureServiceBusNetworkDefaultAction)(0),           // 2: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNetworkDefaultAction
	(*AzureServiceBusNamespaceSpec)(nil),               // 3: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec
	(*AzureServiceBusNamespaceIdentity)(nil),           // 4: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentity
	(*AzureServiceBusNamespaceCustomerManagedKey)(nil), // 5: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceCustomerManagedKey
	(*AzureServiceBusNamespaceNetworkRuleSet)(nil),     // 6: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRuleSet
	(*AzureServiceBusNamespaceNetworkRule)(nil),        // 7: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRule
	nil,                         // 8: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.TagsEntry
	(*v1.StringValueOrRef)(nil), // 9: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_depIdxs = []int32{
	9,  // 0: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0,  // 1: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.sku:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSku
	4,  // 2: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.identity:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentity
	5,  // 3: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.customer_managed_key:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceCustomerManagedKey
	6,  // 4: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.network_rule_set:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRuleSet
	8,  // 5: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.tags:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceSpec.TagsEntry
	1,  // 6: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentity.type:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentityType
	9,  // 7: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceIdentity.user_assigned_identity_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 8: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceCustomerManagedKey.key_vault_key_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	9,  // 9: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceCustomerManagedKey.user_assigned_identity_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2,  // 10: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRuleSet.default_action:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNetworkDefaultAction
	7,  // 11: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRuleSet.network_rules:type_name -> dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRule
	9,  // 12: dev.planton.azure.azureservicebusnamespace.v1alpha1.AzureServiceBusNamespaceNetworkRule.subnet_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_init() }
func file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto = out.File
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azureservicebusnamespace_v1alpha1_spec_proto_depIdxs = nil
}
