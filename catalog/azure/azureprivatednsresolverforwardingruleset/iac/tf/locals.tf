locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_private_dns_resolver_forwarding_ruleset"
  ...
  # Individual forwarding rules carry NO tags (ARM gives them a metadata
  # map instead) -- these tags land on the ruleset only.
