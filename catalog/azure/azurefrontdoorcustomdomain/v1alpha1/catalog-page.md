...
- [Azure Front Door Profile](/docs/catalog/azure/azurefrontdoorprofile) -- the parent profile
- [Azure Front Door Secret](/docs/catalog/azure/azurefrontdoorsecret) -- the BYO certificate node
- [Azure Front Door Route](/docs/catalog/azure/azurefrontdoorroute) -- serves this domain
- [Azure DNS Zone](/docs/catalog/azure/azurednszone) -- hosts the validation and CNAME records
