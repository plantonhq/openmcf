...
type Locals struct {
	AzureMonitorAutoscaleSetting *azuremonitorautoscalesettingv1alpha1.AzureMonitorAutoscaleSetting
...
func initializeLocals(ctx *pulumi.Context, stackInput *azuremonitorautoscalesettingv1alpha1.AzureMonitorAutoscaleSettingStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureMonitorAutoscaleSetting.String()),
	}
