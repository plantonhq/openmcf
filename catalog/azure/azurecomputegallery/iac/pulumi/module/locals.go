...
type Locals struct {
	AzureComputeGallery *azurecomputegalleryv1alpha1.AzureComputeGallery
...
func initializeLocals(ctx *pulumi.Context, stackInput *azurecomputegalleryv1alpha1.AzureComputeGalleryStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureComputeGallery.String()),
	}
