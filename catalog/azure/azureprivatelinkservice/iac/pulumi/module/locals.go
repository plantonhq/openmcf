...
type Locals struct {
	AzurePrivateLinkService *azureprivatelinkservicev1alpha1.AzurePrivateLinkService
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureprivatelinkservicev1alpha1.AzurePrivateLinkServiceStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzurePrivateLinkService.String()),
	}
