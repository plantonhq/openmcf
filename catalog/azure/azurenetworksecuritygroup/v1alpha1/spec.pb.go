...
// 	protoc        (unknown)
// source: catalog/azure/azurenetworksecuritygroup/v1alpha1/spec.proto
...
func (AzureNetworkSecurityGroupRuleDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureNetworkSecurityGroupRuleDirection) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureNetworkSecurityGroupRuleDirection) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureNetworkSecurityGroupRuleAccess) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureNetworkSecurityGroupRuleAccess) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureNetworkSecurityGroupRuleAccess) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureNetworkSecurityGroupRuleProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureNetworkSecurityGroupRuleProtocol) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureNetworkSecurityGroupRuleProtocol) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AzureNetworkSecurityGroupSpec) Reset() {
	*x = AzureNetworkSecurityGroupSpec{}
	mi := &file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes[0]
...
type AzureNetworkSecurityGroupRule struct {
	...
	Direction AzureNetworkSecurityGroupRuleDirection `protobuf:"varint,4,opt,name=direction,proto3,enum=dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirection" json:"direction,omitempty"`
	// Whether matching traffic is permitted (ALLOW) or blocked (DENY).
	Access AzureNetworkSecurityGroupRuleAccess `protobuf:"varint,5,opt,name=access,proto3,enum=dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccess" json:"access,omitempty"`
	// The network protocol the rule matches. ANY matches everything; AH and
	// ESP match IPsec traffic (site-to-site VPN scenarios).
	Protocol AzureNetworkSecurityGroupRuleProtocol `protobuf:"varint,6,opt,name=protocol,proto3,enum=dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocol" json:"protocol,omitempty"`
...
func (x *AzureNetworkSecurityGroupRule) Reset() {
	*x = AzureNetworkSecurityGroupRule{}
	mi := &file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";catalog/azure/azurenetworksecuritygroup/v1alpha1/spec.proto\x124dev.planton.azure.azurenetworksecuritygroup.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\x95\x06\n" +
	...
	"\x0fnsg_name_format\x12\x93\x01NSG names start with a letter or number, end with a letter, number, or underscore, and may contain alphanumerics, underscores, periods, and hyphens\x1aIthis == '' || this.matches('^[a-zA-Z0-9]([a-zA-Z0-9._-]*[a-zA-Z0-9_])?$')\xc8\x01\x01r\x04\x10\x01\x18PR\x04name\x12z\n" +
	"\x0esecurity_rules\x18\x04 \x03(\v2S.dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleR\rsecurityRules\x12q\n" +
	"\x04tags\x18\x05 \x03(\v2].dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xf4\x14\n" +
	...
	"\xc8\x01\x01\x1a\x05\x18\x80 (dR\bpriority\x12\x87\x01\n" +
	"\tdirection\x18\x04 \x01(\x0e2\\.dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirectionB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\tdirection\x12~\n" +
	"\x06access\x18\x05 \x01(\x0e2Y.dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccessB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x06access\x12\x84\x01\n" +
	"\bprotocol\x18\x06 \x01(\x0e2[.dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocolB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\bprotocol\x12/\n" +
	...
	"\x02AH\x10\x05\x12\a\n" +
	"\x03ESP\x10\x06B\xab\x03\n" +
	"8com.dev.planton.azure.azurenetworksecuritygroup.v1alpha1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/catalog/azure/azurenetworksecuritygroup/v1alpha1;azurenetworksecuritygroupv1alpha1\xa2\x02\x04DPAA\xaa\x024Dev.Planton.Azure.Azurenetworksecuritygroup.V1alpha1\xca\x024Dev\\Planton\\Azure\\Azurenetworksecuritygroup\\V1alpha1\xe2\x02@Dev\\Planton\\Azure\\Azurenetworksecuritygroup\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Azure::Azurenetworksecuritygroup::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_goTypes = []any{
	(AzureNetworkSecurityGroupRuleDirection)(0), // 0: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirection
	(AzureNetworkSecurityGroupRuleAccess)(0),    // 1: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccess
	(AzureNetworkSecurityGroupRuleProtocol)(0),  // 2: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocol
	(*AzureNetworkSecurityGroupSpec)(nil),       // 3: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec
	(*AzureNetworkSecurityGroupRule)(nil),       // 4: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule
	nil,                                         // 5: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),                 // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.security_rules:type_name -> dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule
	5, // 2: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.tags:type_name -> dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupSpec.TagsEntry
	0, // 3: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.direction:type_name -> dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleDirection
	1, // 4: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.access:type_name -> dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleAccess
	2, // 5: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.protocol:type_name -> dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRuleProtocol
	6, // 6: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.source_application_security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 7: dev.planton.azure.azurenetworksecuritygroup.v1alpha1.AzureNetworkSecurityGroupRule.destination_application_security_group_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_init() }
func file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto = out.File
	file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azurenetworksecuritygroup_v1alpha1_spec_proto_depIdxs = nil
}
