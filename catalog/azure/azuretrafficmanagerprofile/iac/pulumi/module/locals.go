...
type Locals struct {
	AzureTrafficManagerProfile *azuretrafficmanagerprofilev1alpha1.AzureTrafficManagerProfile
...
func initializeLocals(ctx *pulumi.Context, stackInput *azuretrafficmanagerprofilev1alpha1.AzureTrafficManagerProfileStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureTrafficManagerProfile.String()),
	}
