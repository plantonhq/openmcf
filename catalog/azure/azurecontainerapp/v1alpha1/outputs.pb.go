...
// 	protoc        (unknown)
// source: catalog/azure/azurecontainerapp/v1alpha1/outputs.proto
...
var File_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto protoreflect.FileDescriptor
...
const file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDesc = "" +
	...
	"\x15identity_principal_id\x18\b \x01(\tR\x13identityPrincipalIdB\xf6\x02\n" +
	"0com.dev.planton.azure.azurecontainerapp.v1alpha1B\fOutputsProtoP\x01Z_github.com/plantonhq/planton/catalog/azure/azurecontainerapp/v1alpha1;azurecontainerappv1alpha1\xa2\x02\x04DPAA\xaa\x02,Dev.Planton.Azure.Azurecontainerapp.V1alpha1\xca\x02,Dev\\Planton\\Azure\\Azurecontainerapp\\V1alpha1\xe2\x028Dev\\Planton\\Azure\\Azurecontainerapp\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Azure::Azurecontainerapp::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDescOnce sync.Once
	file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDescData []byte
)

func file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDesc), len(file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDesc)))
	})
	return file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDescData
}
...
func init() { file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_init() }
func file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_init() {
	if File_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDesc), len(file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto = out.File
	file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_goTypes = nil
	file_catalog_azure_azurecontainerapp_v1alpha1_outputs_proto_depIdxs = nil
}
