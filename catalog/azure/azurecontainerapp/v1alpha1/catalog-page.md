...
- [Azure Container App Environment](/docs/catalog/azure/azurecontainerappenvironment) -- the hosting boundary
- [Azure Container App Job](/docs/catalog/azure/azurecontainerappjob) -- run-to-completion workloads
- [Azure Container App Environment Storage](/docs/catalog/azure/azurecontainerappenvironmentstorage) -- share-backed volumes
- [Azure Container App Environment Dapr Component](/docs/catalog/azure/azurecontainerappenvironmentdaprcomponent) -- Dapr backends
- [Azure User Assigned Identity](/docs/catalog/azure/azureuserassignedidentity) -- keyless auth for registries, Key Vault, and scalers
