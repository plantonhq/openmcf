...
type Locals struct {
	AzureMonitorDataCollectionRule *azuremonitordatacollectionrulev1alpha1.AzureMonitorDataCollectionRule
...
func initializeLocals(ctx *pulumi.Context, stackInput *azuremonitordatacollectionrulev1alpha1.AzureMonitorDataCollectionRuleStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureMonitorDataCollectionRule.String()),
	}
