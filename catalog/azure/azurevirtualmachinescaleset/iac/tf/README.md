...
```bash
planton tofu plan --manifest fleet.yaml --module-dir catalog/azure/azurevirtualmachinescaleset/iac/tf
planton tofu apply --manifest fleet.yaml --module-dir catalog/azure/azurevirtualmachinescaleset/iac/tf
```
