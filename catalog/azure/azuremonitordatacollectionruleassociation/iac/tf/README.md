# AzureMonitorDataCollectionRuleAssociation Terraform Module
...
- `azurerm_monitor_data_collection_rule_association` -- the attachment, an extension resource scoped under the target machine's ARM ID
...
- `spec` -- the AzureMonitorDataCollectionRuleAssociationSpec fields; the target, rule, and endpoint references arrive as resolved literals
