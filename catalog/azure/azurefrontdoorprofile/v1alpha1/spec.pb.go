...
// 	protoc        (unknown)
// source: catalog/azure/azurefrontdoorprofile/v1alpha1/spec.proto
...
func (AzureFrontDoorProfileSku) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureFrontDoorProfileSku) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureFrontDoorProfileSku) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AzureFrontDoorProfileIdentityType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (AzureFrontDoorProfileIdentityType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[1]
}
...
func (AzureFrontDoorProfileIdentityType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (AzureFrontDoorProfileLogScrubbingVariable) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[2].Descriptor()
}

func (AzureFrontDoorProfileLogScrubbingVariable) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes[2]
}
...
func (AzureFrontDoorProfileLogScrubbingVariable) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
type AzureFrontDoorProfileSpec struct {
	...
	Sku AzureFrontDoorProfileSku `protobuf:"varint,3,opt,name=sku,proto3,enum=dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSku" json:"sku,omitempty"`
	...
	LogScrubbingVariables []AzureFrontDoorProfileLogScrubbingVariable `protobuf:"varint,6,rep,packed,name=log_scrubbing_variables,json=logScrubbingVariables,proto3,enum=dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariable" json:"log_scrubbing_variables,omitempty"`
...
func (x *AzureFrontDoorProfileSpec) Reset() {
	*x = AzureFrontDoorProfileSpec{}
	mi := &file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes[0]
...
type AzureFrontDoorProfileIdentity struct {
	...
	Type AzureFrontDoorProfileIdentityType `protobuf:"varint,1,opt,name=type,proto3,enum=dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityType" json:"type,omitempty"`
...
func (x *AzureFrontDoorProfileIdentity) Reset() {
	*x = AzureFrontDoorProfileIdentity{}
	mi := &file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7catalog/azure/azurefrontdoorprofile/v1alpha1/spec.proto\x120dev.planton.azure.azurefrontdoorprofile.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xcc\b\n" +
	...
	"\x1efront_door_profile_name_format\x12yprofile_name must be 2-90 characters, start and end with a letter or digit, and contain only letters, digits, and hyphens\x1a:this.matches('^[a-zA-Z0-9][a-zA-Z0-9-]{0,88}[a-zA-Z0-9]$')\xc8\x01\x01r\x04\x10\x02\x18ZR\vprofileName\x12f\n" +
	"\x03sku\x18\x03 \x01(\x0e2J.dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSkuB\b\xbaH\x05\x82\x01\x02\x10\x01R\x03sku\x12P\n" +
	"\x18response_timeout_seconds\x18\x04 \x01(\x05B\x11\xbaH\a\x1a\x05\x18\xf0\x01(\x10\x8a\xa6\x1d\x03120H\x00R\x16responseTimeoutSeconds\x88\x01\x01\x12k\n" +
	"\bidentity\x18\x05 \x01(\v2O.dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityR\bidentity\x12\xa8\x01\n" +
	"\x17log_scrubbing_variables\x18\x06 \x03(\x0e2[.dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariableB\x13\xbaH\x10\x92\x01\r\x10\x03\x18\x01\"\a\x82\x01\x04\x10\x01 \x00R\x15logScrubbingVariables\x12i\n" +
	"\x04tags\x18\a \x03(\v2U.dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x1b\n" +
	"\x19_response_timeout_seconds\"\xe9\x04\n" +
	"\x1dAzureFrontDoorProfileIdentity\x12s\n" +
	"\x04type\x18\x01 \x01(\x0e2S.dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityTypeB\n" +
	...
	"\vREQUEST_URI\x10\x03B\x8f\x03\n" +
	"4com.dev.planton.azure.azurefrontdoorprofile.v1alpha1B\tSpecProtoP\x01Zggithub.com/plantonhq/planton/catalog/azure/azurefrontdoorprofile/v1alpha1;azurefrontdoorprofilev1alpha1\xa2\x02\x04DPAA\xaa\x020Dev.Planton.Azure.Azurefrontdoorprofile.V1alpha1\xca\x020Dev\\Planton\\Azure\\Azurefrontdoorprofile\\V1alpha1\xe2\x02<Dev\\Planton\\Azure\\Azurefrontdoorprofile\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Azure::Azurefrontdoorprofile::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_goTypes = []any{
	(AzureFrontDoorProfileSku)(0),                  // 0: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSku
	(AzureFrontDoorProfileIdentityType)(0),         // 1: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityType
	(AzureFrontDoorProfileLogScrubbingVariable)(0), // 2: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariable
	(*AzureFrontDoorProfileSpec)(nil),              // 3: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec
	(*AzureFrontDoorProfileIdentity)(nil),          // 4: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity
	nil,                                            // 5: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),                    // 6: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_depIdxs = []int32{
	6, // 0: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.resource_group:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 1: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.sku:type_name -> dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSku
	4, // 2: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.identity:type_name -> dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity
	2, // 3: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.log_scrubbing_variables:type_name -> dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileLogScrubbingVariable
	5, // 4: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.tags:type_name -> dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileSpec.TagsEntry
	1, // 5: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity.type:type_name -> dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentityType
	6, // 6: dev.planton.azure.azurefrontdoorprofile.v1alpha1.AzureFrontDoorProfileIdentity.user_assigned_identity_ids:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_init() }
func file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto = out.File
	file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azurefrontdoorprofile_v1alpha1_spec_proto_depIdxs = nil
}
