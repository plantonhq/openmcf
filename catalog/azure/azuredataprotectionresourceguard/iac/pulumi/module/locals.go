...
type Locals struct {
	AzureDataProtectionResourceGuard *azuredataprotectionresourceguardv1alpha1.AzureDataProtectionResourceGuard
...
func initializeLocals(ctx *pulumi.Context, stackInput *azuredataprotectionresourceguardv1alpha1.AzureDataProtectionResourceGuardStackInput) *Locals {
	locals := &Locals{}

	locals.AzureDataProtectionResourceGuard = stackInput.Target
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureDataProtectionResourceGuard.String()),
	}
