locals {
  ...
  base_tags = {
    ...
    "resource_kind" = "azure_eventgrid_system_topic"
  ...
  # Unlike the Event Grid publisher kinds, a system topic supports the
  # combined mode -- the provider's third token carries both flavors.
  identity_type_map = {
