...
type Locals struct {
	AzureEventgridSystemTopic *azureeventgridsystemtopicv1alpha1.AzureEventgridSystemTopic
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureeventgridsystemtopicv1alpha1.AzureEventgridSystemTopicStackInput) *Locals {
	...
	locals.AzureTags = map[string]string{
		...
		"resource_kind": strings.ToLower(cloudresourcekind.CloudResourceKind_AzureEventgridSystemTopic.String()),
	}
