...
type Locals struct {
	AzurePrivateDnsZone *azureprivatednszonev1alpha1.AzurePrivateDnsZone
...
func initializeLocals(ctx *pulumi.Context, stackInput *azureprivatednszonev1alpha1.AzurePrivateDnsZoneStackInput) *Locals {
	locals := &Locals{}
