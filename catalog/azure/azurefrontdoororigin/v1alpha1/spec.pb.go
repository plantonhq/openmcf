...
// 	protoc        (unknown)
// source: catalog/azure/azurefrontdoororigin/v1alpha1/spec.proto
...
func (AzureFrontDoorOriginPrivateLinkTargetType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureFrontDoorOriginPrivateLinkTargetType) Type() protoreflect.EnumType {
	return &file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_enumTypes[0]
}
...
func (AzureFrontDoorOriginPrivateLinkTargetType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureFrontDoorOriginSpec) Reset() {
	*x = AzureFrontDoorOriginSpec{}
	mi := &file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_msgTypes[0]
...
type AzureFrontDoorOriginPrivateLink struct {
	...
	TargetType AzureFrontDoorOriginPrivateLinkTargetType `protobuf:"varint,3,opt,name=target_type,json=targetType,proto3,enum=dev.planton.azure.azurefrontdoororigin.v1alpha1.AzureFrontDoorOriginPrivateLinkTargetType" json:"target_type,omitempty"`
...
func (x *AzureFrontDoorOriginPrivateLink) Reset() {
	*x = AzureFrontDoorOriginPrivateLink{}
	mi := &file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureFrontDoorOriginPrivateLink) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"6catalog/azure/azurefrontdoororigin/v1alpha1/spec.proto\x12/dev.planton.azure.azurefrontdoororigin.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xa5\v\n" +
	...
	"\aenabled\x18\n" +
	" \x01(\bB\b\x8a\xa6\x1d\x04trueH\x05R\aenabled\x88\x01\x01\x12s\n" +
	"\fprivate_link\x18\v \x01(\v2P.dev.planton.azure.azurefrontdoororigin.v1alpha1.AzureFrontDoorOriginPrivateLinkR\vprivateLink:\x92\x02\xbaH\x8e\x02\x1a\x8b\x02\n" +
	...
	"\aGATEWAY\x10\aB\x88\x03\n" +
	"3com.dev.planton.azure.azurefrontdoororigin.v1alpha1B\tSpecProtoP\x01Zegithub.com/plantonhq/planton/catalog/azure/azurefrontdoororigin/v1alpha1;azurefrontdoororiginv1alpha1\xa2\x02\x04DPAA\xaa\x02/Dev.Planton.Azure.Azurefrontdoororigin.V1alpha1\xca\x02/Dev\\Planton\\Azure\\Azurefrontdoororigin\\V1alpha1\xe2\x02;Dev\\Planton\\Azure\\Azurefrontdoororigin\\V1alpha1\\GPBMetadata\xea\x023Dev::Planton::Azure::Azurefrontdoororigin::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDescData
}

var file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_goTypes = []any{
	(AzureFrontDoorOriginPrivateLinkTargetType)(0), // 0: dev.planton.azure.azurefrontdoororigin.v1alpha1.AzureFrontDoorOriginPrivateLinkTargetType
	(*AzureFrontDoorOriginSpec)(nil),               // 1: dev.planton.azure.azurefrontdoororigin.v1alpha1.AzureFrontDoorOriginSpec
	(*AzureFrontDoorOriginPrivateLink)(nil),        // 2: dev.planton.azure.azurefrontdoororigin.v1alpha1.AzureFrontDoorOriginPrivateLink
	(*v1.StringValueOrRef)(nil),                    // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.azure.azurefrontdoororigin.v1alpha1.AzureFrontDoorOriginSpec.origin_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_init() {
	if File_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDesc), len(file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto = out.File
	file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_goTypes = nil
	file_catalog_azure_azurefrontdoororigin_v1alpha1_spec_proto_depIdxs = nil
}
