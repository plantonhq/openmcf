...
// 	protoc        (unknown)
// source: catalog/azure/provider.proto
...
func (x *AzureProviderConfig) Reset() {
	*x = AzureProviderConfig{}
	mi := &file_catalog_azure_provider_proto_msgTypes[0]
...
func (*AzureProviderConfig) Descriptor() ([]byte, []int) {
	return file_catalog_azure_provider_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureWebIdentityProviderConfig) Reset() {
	*x = AzureWebIdentityProviderConfig{}
	mi := &file_catalog_azure_provider_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureWebIdentityProviderConfig) Descriptor() ([]byte, []int) {
	return file_catalog_azure_provider_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_azure_provider_proto protoreflect.FileDescriptor

const file_catalog_azure_provider_proto_rawDesc = "" +
	"\n" +
	"\x1ccatalog/azure/provider.proto\x12\x11dev.planton.azure\x1a\x1bbuf/validate/validate.proto\"\x93\x02\n" +
	...
	"\x0fsubscription_id\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x0esubscriptionId\x12T\n" +
	"\fweb_identity\x18\x05 \x01(\v21.dev.planton.azure.AzureWebIdentityProviderConfigR\vwebIdentity\"V\n" +
	"\x1eAzureWebIdentityProviderConfig\x124\n" +
	"\x12web_identity_token\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x10webIdentityTokenB\xb8\x01\n" +
	"\x15com.dev.planton.azureB\rProviderProtoP\x01Z*github.com/plantonhq/planton/catalog/azure\xa2\x02\x03DPA\xaa\x02\x11Dev.Planton.Azure\xca\x02\x11Dev\\Planton\\Azure\xe2\x02\x1dDev\\Planton\\Azure\\GPBMetadata\xea\x02\x13Dev::Planton::Azureb\x06proto3"

var (
	file_catalog_azure_provider_proto_rawDescOnce sync.Once
	file_catalog_azure_provider_proto_rawDescData []byte
)

func file_catalog_azure_provider_proto_rawDescGZIP() []byte {
	file_catalog_azure_provider_proto_rawDescOnce.Do(func() {
		file_catalog_azure_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_provider_proto_rawDesc), len(file_catalog_azure_provider_proto_rawDesc)))
	})
	return file_catalog_azure_provider_proto_rawDescData
}

var file_catalog_azure_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_azure_provider_proto_goTypes = []any{
	(*AzureProviderConfig)(nil),            // 0: dev.planton.azure.AzureProviderConfig
	(*AzureWebIdentityProviderConfig)(nil), // 1: dev.planton.azure.AzureWebIdentityProviderConfig
}
var file_catalog_azure_provider_proto_depIdxs = []int32{
	1, // 0: dev.planton.azure.AzureProviderConfig.web_identity:type_name -> dev.planton.azure.AzureWebIdentityProviderConfig
...
func init() { file_catalog_azure_provider_proto_init() }
func file_catalog_azure_provider_proto_init() {
	if File_catalog_azure_provider_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_provider_proto_rawDesc), len(file_catalog_azure_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_provider_proto_goTypes,
		DependencyIndexes: file_catalog_azure_provider_proto_depIdxs,
		MessageInfos:      file_catalog_azure_provider_proto_msgTypes,
	}.Build()
	File_catalog_azure_provider_proto = out.File
	file_catalog_azure_provider_proto_goTypes = nil
	file_catalog_azure_provider_proto_depIdxs = nil
}
