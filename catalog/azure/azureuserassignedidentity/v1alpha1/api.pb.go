...
const file_catalog_azure_azureuserassignedidentity_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	":catalog/azure/azureuserassignedidentity/v1alpha1/api.proto\x124dev.planton.azure.azureuserassignedidentity.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a>catalog/azure/azureuserassignedidentity/v1alpha1/outputs.proto\x1a;catalog/azure/azureuserassignedidentity/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\xc4\x03\n" +
...
func file_catalog_azure_azureuserassignedidentity_v1alpha1_api_proto_init() {
	...
	file_catalog_azure_azureuserassignedidentity_v1alpha1_outputs_proto_init()
