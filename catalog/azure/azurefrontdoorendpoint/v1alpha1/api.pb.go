...
const file_catalog_azure_azurefrontdoorendpoint_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"7catalog/azure/azurefrontdoorendpoint/v1alpha1/api.proto\x121dev.planton.azure.azurefrontdoorendpoint.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a8catalog/azure/azurefrontdoorendpoint/v1alpha1/spec.proto\x1aAcatalog/azure/azurefrontdoorendpoint/v1alpha1/stack_outputs.proto\x1a\x15shared/metadata.proto\"\xb2\x03\n" +
...
func file_catalog_azure_azurefrontdoorendpoint_v1alpha1_api_proto_init() {
	...
	file_catalog_azure_azurefrontdoorendpoint_v1alpha1_stack_outputs_proto_init()
	type x struct{}
