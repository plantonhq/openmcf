...
// 	protoc        (unknown)
// source: catalog/azure/azurepostgresqlflexibleserver/v1alpha1/stack_outputs.proto
...
func (x *AzurePostgresqlFlexibleServerStackOutputs) Reset() {
	*x = AzurePostgresqlFlexibleServerStackOutputs{}
	mi := &file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*AzurePostgresqlFlexibleServerStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Hcatalog/azure/azurepostgresqlflexibleserver/v1alpha1/stack_outputs.proto\x128dev.planton.azure.azurepostgresqlflexibleserver.v1alpha1\"\xbc\x03\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xcf\x03\n" +
	"<com.dev.planton.azure.azurepostgresqlflexibleserver.v1alpha1B\x11StackOutputsProtoP\x01Zwgithub.com/plantonhq/planton/catalog/azure/azurepostgresqlflexibleserver/v1alpha1;azurepostgresqlflexibleserverv1alpha1\xa2\x02\x04DPAA\xaa\x028Dev.Planton.Azure.Azurepostgresqlflexibleserver.V1alpha1\xca\x028Dev\\Planton\\Azure\\Azurepostgresqlflexibleserver\\V1alpha1\xe2\x02DDev\\Planton\\Azure\\Azurepostgresqlflexibleserver\\V1alpha1\\GPBMetadata\xea\x02<Dev::Planton::Azure::Azurepostgresqlflexibleserver::V1alpha1b\x06proto3"

var (
	file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_goTypes = []any{
...
var file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_init() }
func file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto = out.File
	file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_azure_azurepostgresqlflexibleserver_v1alpha1_stack_outputs_proto_depIdxs = nil
}
