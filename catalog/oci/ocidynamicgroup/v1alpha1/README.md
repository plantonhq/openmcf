...
- **Automatic Tagging**: Standard Planton freeform tags are applied to every dynamic group (resource kind, resource ID, organization, environment, and user-defined labels from metadata).
...
- **Freeform Tagging**: Standard Planton labels applied as OCI freeform tags for group tracking, compliance, and organizational reporting.
