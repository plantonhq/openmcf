...
- [OciKmsKey](/docs/catalog/oci/ocikmskey) — creates encryption keys within this vault using the `managementEndpoint` output
- [OciVaultSecret](/docs/catalog/oci/ocivaultsecret) — stores secrets encrypted by keys in this vault using the `vaultId` output
