...
- [OciVcn](/docs/catalog/oci/ocivcn) — VCNs and subnets are common sources for flow logs
- [OciObjectStorageBucket](/docs/catalog/oci/ociobjectstoragebucket) — buckets are common sources for Object Storage service logs
- [OciApiGateway](/docs/catalog/oci/ociapigateway) — API gateways emit access and execution logs
- [OciFunctionsApplication](/docs/catalog/oci/ocifunctionsapplication) — functions emit invocation logs
