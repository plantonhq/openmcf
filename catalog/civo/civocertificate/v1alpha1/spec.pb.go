...
// 	protoc        (unknown)
// source: catalog/civo/civocertificate/v1alpha1/spec.proto
...
func (CivoCertificateType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_civo_civocertificate_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (CivoCertificateType) Type() protoreflect.EnumType {
	return &file_catalog_civo_civocertificate_v1alpha1_spec_proto_enumTypes[0]
}
...
func (CivoCertificateType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type CivoCertificateSpec struct {
	...
	Type CivoCertificateType `protobuf:"varint,2,opt,name=type,proto3,enum=dev.planton.civo.civocertificate.v1alpha1.CivoCertificateType" json:"type,omitempty"`
...
func (x *CivoCertificateSpec) Reset() {
	*x = CivoCertificateSpec{}
	mi := &file_catalog_civo_civocertificate_v1alpha1_spec_proto_msgTypes[0]
...
func (x *CivoCertificateLetsEncryptParams) Reset() {
	*x = CivoCertificateLetsEncryptParams{}
	mi := &file_catalog_civo_civocertificate_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoCertificateLetsEncryptParams) Descriptor() ([]byte, []int) {
	return file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CivoCertificateCustomParams) Reset() {
	*x = CivoCertificateCustomParams{}
	mi := &file_catalog_civo_civocertificate_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoCertificateCustomParams) Descriptor() ([]byte, []int) {
	return file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_civo_civocertificate_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"0catalog/civo/civocertificate/v1alpha1/spec.proto\x12)dev.planton.civo.civocertificate.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a\x1cshared/options/options.proto\"\xea\x03\n" +
	"\x13CivoCertificateSpec\x127\n" +
	"\x10certificate_name\x18\x01 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x01\x18@R\x0fcertificateName\x12_\n" +
	"\x04type\x18\x02 \x01(\x0e2>.dev.planton.civo.civocertificate.v1alpha1.CivoCertificateTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12p\n" +
	"\flets_encrypt\x18\x03 \x01(\v2K.dev.planton.civo.civocertificate.v1alpha1.CivoCertificateLetsEncryptParamsH\x00R\vletsEncrypt\x12`\n" +
	"\x06custom\x18\x04 \x01(\v2F.dev.planton.civo.civocertificate.v1alpha1.CivoCertificateCustomParamsH\x00R\x06custom\x12*\n" +
	...
	"\n" +
	"\x06custom\x10\x02B\xdf\x02\n" +
	"-com.dev.planton.civo.civocertificate.v1alpha1B\tSpecProtoP\x01ZZgithub.com/plantonhq/planton/catalog/civo/civocertificate/v1alpha1;civocertificatev1alpha1\xa2\x02\x04DPCC\xaa\x02)Dev.Planton.Civo.Civocertificate.V1alpha1\xca\x02)Dev\\Planton\\Civo\\Civocertificate\\V1alpha1\xe2\x025Dev\\Planton\\Civo\\Civocertificate\\V1alpha1\\GPBMetadata\xea\x02-Dev::Planton::Civo::Civocertificate::V1alpha1b\x06proto3"

var (
	file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDesc), len(file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDescData
}

var file_catalog_civo_civocertificate_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_catalog_civo_civocertificate_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_civo_civocertificate_v1alpha1_spec_proto_goTypes = []any{
	(CivoCertificateType)(0),                 // 0: dev.planton.civo.civocertificate.v1alpha1.CivoCertificateType
	(*CivoCertificateSpec)(nil),              // 1: dev.planton.civo.civocertificate.v1alpha1.CivoCertificateSpec
	(*CivoCertificateLetsEncryptParams)(nil), // 2: dev.planton.civo.civocertificate.v1alpha1.CivoCertificateLetsEncryptParams
	(*CivoCertificateCustomParams)(nil),      // 3: dev.planton.civo.civocertificate.v1alpha1.CivoCertificateCustomParams
}
var file_catalog_civo_civocertificate_v1alpha1_spec_proto_depIdxs = []int32{
	0, // 0: dev.planton.civo.civocertificate.v1alpha1.CivoCertificateSpec.type:type_name -> dev.planton.civo.civocertificate.v1alpha1.CivoCertificateType
	2, // 1: dev.planton.civo.civocertificate.v1alpha1.CivoCertificateSpec.lets_encrypt:type_name -> dev.planton.civo.civocertificate.v1alpha1.CivoCertificateLetsEncryptParams
	3, // 2: dev.planton.civo.civocertificate.v1alpha1.CivoCertificateSpec.custom:type_name -> dev.planton.civo.civocertificate.v1alpha1.CivoCertificateCustomParams
...
func init() { file_catalog_civo_civocertificate_v1alpha1_spec_proto_init() }
func file_catalog_civo_civocertificate_v1alpha1_spec_proto_init() {
	if File_catalog_civo_civocertificate_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_civo_civocertificate_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDesc), len(file_catalog_civo_civocertificate_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_civo_civocertificate_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_civo_civocertificate_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_civo_civocertificate_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_civo_civocertificate_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_civo_civocertificate_v1alpha1_spec_proto = out.File
	file_catalog_civo_civocertificate_v1alpha1_spec_proto_goTypes = nil
	file_catalog_civo_civocertificate_v1alpha1_spec_proto_depIdxs = nil
}
