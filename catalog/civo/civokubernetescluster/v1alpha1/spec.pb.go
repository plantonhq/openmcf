...
// 	protoc        (unknown)
// source: catalog/civo/civokubernetescluster/v1alpha1/spec.proto
...
func (x *CivoKubernetesClusterSpec) Reset() {
	*x = CivoKubernetesClusterSpec{}
	mi := &file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_msgTypes[0]
...
func (*CivoKubernetesClusterSpec) Descriptor() ([]byte, []int) {
	return file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoKubernetesClusterDefaultNodePool) Reset() {
	*x = CivoKubernetesClusterDefaultNodePool{}
	mi := &file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoKubernetesClusterDefaultNodePool) Descriptor() ([]byte, []int) {
	return file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_civo_civokubernetescluster_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"6catalog/civo/civokubernetescluster/v1alpha1/spec.proto\x12/dev.planton.civo.civokubernetescluster.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a\x19catalog/civo/region.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xe0\x04\n" +
	"\x19CivoKubernetesClusterSpec\x12)\n" +
	"\fcluster_name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\vclusterName\x12<\n" +
	"\x06region\x18\x02 \x01(\x0e2\x1c.dev.planton.civo.CivoRegionB\x06\xbaH\x03\xc8\x01\x01R\x06region\x125\n" +
	...
	"\x04tags\x18\b \x03(\tR\x04tags\x12\x89\x01\n" +
	"\x11default_node_pool\x18\t \x01(\v2U.dev.planton.civo.civokubernetescluster.v1alpha1.CivoKubernetesClusterDefaultNodePoolB\x06\xbaH\x03\xc8\x01\x01R\x0fdefaultNodePool\"m\n" +
	...
	"\xbaH\a\xc8\x01\x01*\x02 \x00R\tnodeCountB\x89\x03\n" +
	"3com.dev.planton.civo.civokubernetescluster.v1alpha1B\tSpecProtoP\x01Zfgithub.com/plantonhq/planton/catalog/civo/civokubernetescluster/v1alpha1;civokubernetesclusterv1alpha1\xa2\x02\x04DPCC\xaa\x02/Dev.Planton.Civo.Civokubernetescluster.V1alpha1\xca\x02/Dev\\Planton\\Civo\\Civokubernetescluster\\V1alpha1\xe2\x02;Dev\\Planton\\Civo\\Civokubernetescluster\\V1alpha1\\GPBMetadata\xea\x023Dev::Planton::Civo::Civokubernetescluster::V1alpha1b\x06proto3"

var (
	file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDesc), len(file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDescData
}

var file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_goTypes = []any{
	(*CivoKubernetesClusterSpec)(nil),            // 0: dev.planton.civo.civokubernetescluster.v1alpha1.CivoKubernetesClusterSpec
	(*CivoKubernetesClusterDefaultNodePool)(nil), // 1: dev.planton.civo.civokubernetescluster.v1alpha1.CivoKubernetesClusterDefaultNodePool
...
var file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.civo.civokubernetescluster.v1alpha1.CivoKubernetesClusterSpec.region:type_name -> dev.planton.civo.CivoRegion
	3, // 1: dev.planton.civo.civokubernetescluster.v1alpha1.CivoKubernetesClusterSpec.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.civo.civokubernetescluster.v1alpha1.CivoKubernetesClusterSpec.default_node_pool:type_name -> dev.planton.civo.civokubernetescluster.v1alpha1.CivoKubernetesClusterDefaultNodePool
...
func init() { file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_init() }
func file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_init() {
	if File_catalog_civo_civokubernetescluster_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDesc), len(file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_civo_civokubernetescluster_v1alpha1_spec_proto = out.File
	file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_goTypes = nil
	file_catalog_civo_civokubernetescluster_v1alpha1_spec_proto_depIdxs = nil
}
