...
// 	protoc        (unknown)
// source: catalog/civo/civofirewall/v1alpha1/spec.proto
...
func (x *CivoFirewallSpec) Reset() {
	*x = CivoFirewallSpec{}
	mi := &file_catalog_civo_civofirewall_v1alpha1_spec_proto_msgTypes[0]
...
func (*CivoFirewallSpec) Descriptor() ([]byte, []int) {
	return file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoFirewallInboundRule) Reset() {
	*x = CivoFirewallInboundRule{}
	mi := &file_catalog_civo_civofirewall_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoFirewallInboundRule) Descriptor() ([]byte, []int) {
	return file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CivoFirewallOutboundRule) Reset() {
	*x = CivoFirewallOutboundRule{}
	mi := &file_catalog_civo_civofirewall_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoFirewallOutboundRule) Descriptor() ([]byte, []int) {
	return file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_civo_civofirewall_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"-catalog/civo/civofirewall/v1alpha1/spec.proto\x12&dev.planton.civo.civofirewall.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\x8e\x03\n" +
	"\x10CivoFirewallSpec\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\x12{\n" +
	"\n" +
	"network_id\x18\x02 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB(\xbaH\x03\xc8\x01\x01\x88\xd4a\xfa.\x92\xd4a\x19status.outputs.network_idR\tnetworkId\x12d\n" +
	"\rinbound_rules\x18\x03 \x03(\v2?.dev.planton.civo.civofirewall.v1alpha1.CivoFirewallInboundRuleR\finboundRules\x12g\n" +
	"\x0eoutbound_rules\x18\x04 \x03(\v2@.dev.planton.civo.civofirewall.v1alpha1.CivoFirewallOutboundRuleR\routboundRules\x12\x12\n" +
	...
	"\x05cidrs\x18\x03 \x03(\tR\x05cidrs\x12\x16\n" +
	"\x06action\x18\x04 \x01(\tR\x06action\x12\x14\n" +
	"\x05label\x18\x05 \x01(\tR\x05labelB\xca\x02\n" +
	"*com.dev.planton.civo.civofirewall.v1alpha1B\tSpecProtoP\x01ZTgithub.com/plantonhq/planton/catalog/civo/civofirewall/v1alpha1;civofirewallv1alpha1\xa2\x02\x04DPCC\xaa\x02&Dev.Planton.Civo.Civofirewall.V1alpha1\xca\x02&Dev\\Planton\\Civo\\Civofirewall\\V1alpha1\xe2\x022Dev\\Planton\\Civo\\Civofirewall\\V1alpha1\\GPBMetadata\xea\x02*Dev::Planton::Civo::Civofirewall::V1alpha1b\x06proto3"

var (
	file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDesc), len(file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDescData
}

var file_catalog_civo_civofirewall_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_civo_civofirewall_v1alpha1_spec_proto_goTypes = []any{
	(*CivoFirewallSpec)(nil),         // 0: dev.planton.civo.civofirewall.v1alpha1.CivoFirewallSpec
	(*CivoFirewallInboundRule)(nil),  // 1: dev.planton.civo.civofirewall.v1alpha1.CivoFirewallInboundRule
	(*CivoFirewallOutboundRule)(nil), // 2: dev.planton.civo.civofirewall.v1alpha1.CivoFirewallOutboundRule
	(*v1.StringValueOrRef)(nil),      // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_civo_civofirewall_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.civo.civofirewall.v1alpha1.CivoFirewallSpec.network_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: dev.planton.civo.civofirewall.v1alpha1.CivoFirewallSpec.inbound_rules:type_name -> dev.planton.civo.civofirewall.v1alpha1.CivoFirewallInboundRule
	2, // 2: dev.planton.civo.civofirewall.v1alpha1.CivoFirewallSpec.outbound_rules:type_name -> dev.planton.civo.civofirewall.v1alpha1.CivoFirewallOutboundRule
...
func init() { file_catalog_civo_civofirewall_v1alpha1_spec_proto_init() }
func file_catalog_civo_civofirewall_v1alpha1_spec_proto_init() {
	if File_catalog_civo_civofirewall_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDesc), len(file_catalog_civo_civofirewall_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_civo_civofirewall_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_civo_civofirewall_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_civo_civofirewall_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_civo_civofirewall_v1alpha1_spec_proto = out.File
	file_catalog_civo_civofirewall_v1alpha1_spec_proto_goTypes = nil
	file_catalog_civo_civofirewall_v1alpha1_spec_proto_depIdxs = nil
}
