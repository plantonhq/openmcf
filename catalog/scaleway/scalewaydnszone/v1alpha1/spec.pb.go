...
// 	protoc        (unknown)
// source: catalog/scaleway/scalewaydnszone/v1alpha1/spec.proto
...
func (ScalewayDnsZoneRecord_RecordType) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (ScalewayDnsZoneRecord_RecordType) Type() protoreflect.EnumType {
	return &file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes[0]
}
...
func (ScalewayDnsZoneRecord_RecordType) EnumDescriptor() ([]byte, []int) {
	return file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *ScalewayDnsZoneSpec) Reset() {
	*x = ScalewayDnsZoneSpec{}
	mi := &file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes[0]
...
func (*ScalewayDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
type ScalewayDnsZoneRecord struct {
	...
	Type ScalewayDnsZoneRecord_RecordType `protobuf:"varint,2,opt,name=type,proto3,enum=dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord_RecordType" json:"type,omitempty"`
	// Record data/value.
	//
...
func (x *ScalewayDnsZoneRecord) Reset() {
	*x = ScalewayDnsZoneRecord{}
	mi := &file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayDnsZoneRecord) Descriptor() ([]byte, []int) {
	return file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"4catalog/scaleway/scalewaydnszone/v1alpha1/spec.proto\x12-dev.planton.scaleway.scalewaydnszone.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xb3\x01\n" +
	...
	"\arecords\x18\x03 \x03(\v2D.dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecordR\arecords\"\xc5\x03\n" +
	"\x15ScalewayDnsZoneRecord\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12k\n" +
	"\x04type\x18\x02 \x01(\x0e2O.dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.RecordTypeB\x06\xbaH\x03\xc8\x01\x01R\x04type\x12N\n" +
	...
	"\x03SRV\x10\v\x12\a\n" +
	"\x03TXT\x10\f\x12\b\n" +
	"\x04TLSA\x10\rB\xf7\x02\n" +
	"1com.dev.planton.scaleway.scalewaydnszone.v1alpha1B\tSpecProtoP\x01Z^github.com/plantonhq/planton/catalog/scaleway/scalewaydnszone/v1alpha1;scalewaydnszonev1alpha1\xa2\x02\x04DPSS\xaa\x02-Dev.Planton.Scaleway.Scalewaydnszone.V1alpha1\xca\x02-Dev\\Planton\\Scaleway\\Scalewaydnszone\\V1alpha1\xe2\x029Dev\\Planton\\Scaleway\\Scalewaydnszone\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Scaleway::Scalewaydnszone::V1alpha1b\x06proto3"

var (
	file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc), len(file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDescData
}

var file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_goTypes = []any{
	(ScalewayDnsZoneRecord_RecordType)(0), // 0: dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.RecordType
	(*ScalewayDnsZoneSpec)(nil),           // 1: dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneSpec
	(*ScalewayDnsZoneRecord)(nil),         // 2: dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord
	(*v1.StringValueOrRef)(nil),           // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneSpec.records:type_name -> dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord
	0, // 1: dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.type:type_name -> dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.RecordType
	3, // 2: dev.planton.scaleway.scalewaydnszone.v1alpha1.ScalewayDnsZoneRecord.data:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_init() }
func file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_init() {
	if File_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc), len(file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto = out.File
	file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_goTypes = nil
	file_catalog_scaleway_scalewaydnszone_v1alpha1_spec_proto_depIdxs = nil
}
