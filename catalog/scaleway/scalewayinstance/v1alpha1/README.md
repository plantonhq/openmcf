...
The **ScalewayInstance** resource provides a declarative way to provision and manage Scaleway compute instances through Planton. It is a **composite resource** that bundles a virtual machine with its public IP, local volumes, and private network attachment into a single manifest.
