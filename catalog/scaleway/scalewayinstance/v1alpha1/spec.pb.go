...
// 	protoc        (unknown)
// source: catalog/scaleway/scalewayinstance/v1alpha1/spec.proto
...
func (x *ScalewayInstanceSpec) Reset() {
	*x = ScalewayInstanceSpec{}
	mi := &file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*ScalewayInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ScalewayInstancePublicIp) Reset() {
	*x = ScalewayInstancePublicIp{}
	mi := &file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayInstancePublicIp) Descriptor() ([]byte, []int) {
	return file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ScalewayInstanceRootVolume) Reset() {
	*x = ScalewayInstanceRootVolume{}
	mi := &file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayInstanceRootVolume) Descriptor() ([]byte, []int) {
	return file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ScalewayInstanceAdditionalVolume) Reset() {
	*x = ScalewayInstanceAdditionalVolume{}
	mi := &file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScalewayInstanceAdditionalVolume) Descriptor() ([]byte, []int) {
	return file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"5catalog/scaleway/scalewayinstance/v1alpha1/spec.proto\x12.dev.planton.scaleway.scalewayinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xbc\x06\n" +
	...
	"\x05image\x18\x03 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05image\x12e\n" +
	"\tpublic_ip\x18\x04 \x01(\v2H.dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstancePublicIpR\bpublicIp\x12\x89\x01\n" +
	...
	"\x12private_network_id\x18\x06 \x01(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB*\x88\xd4a\xf9U\x92\xd4a!status.outputs.private_network_idR\x10privateNetworkId\x12k\n" +
	"\vroot_volume\x18\a \x01(\v2J.dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceRootVolumeR\n" +
	"rootVolume\x12\x7f\n" +
	"\x12additional_volumes\x18\b \x03(\v2P.dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceAdditionalVolumeR\x11additionalVolumes\x12\x1d\n" +
	"\n" +
	...
	"volumeType\x12$\n" +
	"\n" +
	"size_in_gb\x18\x03 \x01(\x05B\x06\xbaH\x03\xc8\x01\x01R\bsizeInGbB\xfe\x02\n" +
	"2com.dev.planton.scaleway.scalewayinstance.v1alpha1B\tSpecProtoP\x01Z`github.com/plantonhq/planton/catalog/scaleway/scalewayinstance/v1alpha1;scalewayinstancev1alpha1\xa2\x02\x04DPSS\xaa\x02.Dev.Planton.Scaleway.Scalewayinstance.V1alpha1\xca\x02.Dev\\Planton\\Scaleway\\Scalewayinstance\\V1alpha1\xe2\x02:Dev\\Planton\\Scaleway\\Scalewayinstance\\V1alpha1\\GPBMetadata\xea\x022Dev::Planton::Scaleway::Scalewayinstance::V1alpha1b\x06proto3"

var (
	file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDescData
}

var file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_goTypes = []any{
	(*ScalewayInstanceSpec)(nil),             // 0: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceSpec
	(*ScalewayInstancePublicIp)(nil),         // 1: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstancePublicIp
	(*ScalewayInstanceRootVolume)(nil),       // 2: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceRootVolume
	(*ScalewayInstanceAdditionalVolume)(nil), // 3: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceAdditionalVolume
	(*v1.StringValueOrRef)(nil),              // 4: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceSpec.public_ip:type_name -> dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstancePublicIp
	4, // 1: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceSpec.security_group_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 2: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceSpec.private_network_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceSpec.root_volume:type_name -> dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceRootVolume
	3, // 4: dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceSpec.additional_volumes:type_name -> dev.planton.scaleway.scalewayinstance.v1alpha1.ScalewayInstanceAdditionalVolume
...
func init() { file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_init() }
func file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_init() {
	if File_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto = out.File
	file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_scaleway_scalewayinstance_v1alpha1_spec_proto_depIdxs = nil
}
