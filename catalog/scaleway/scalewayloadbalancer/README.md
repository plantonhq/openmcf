...
The **ScalewayLoadBalancer** resource provides a declarative way to provision and manage Scaleway Load Balancers through Planton. It is a **composite resource** that bundles a Flexible IP, the Load Balancer appliance, backend server pools, frontend listeners, and optional TLS certificates into a single manifest.
