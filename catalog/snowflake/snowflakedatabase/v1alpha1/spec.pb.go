...
// 	protoc        (unknown)
// source: catalog/snowflake/snowflakedatabase/v1alpha1/spec.proto
...
func (x *SnowflakeDatabaseSpec) Reset() {
	*x = SnowflakeDatabaseSpec{}
	mi := &file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_msgTypes[0]
...
func (*SnowflakeDatabaseSpec) Descriptor() ([]byte, []int) {
	return file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SnowflakeDatabaseUserTask) Reset() {
	*x = SnowflakeDatabaseUserTask{}
	mi := &file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SnowflakeDatabaseUserTask) Descriptor() ([]byte, []int) {
	return file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"7catalog/snowflake/snowflakedatabase/v1alpha1/spec.proto\x120dev.planton.snowflake.snowflakedatabase.v1alpha1\"\xc6\a\n" +
	...
	"traceLevel\x12h\n" +
	"\tuser_task\x18\x12 \x01(\v2K.dev.planton.snowflake.snowflakedatabase.v1alpha1.SnowflakeDatabaseUserTaskR\buserTask\"\xcd\x01\n" +
	...
	"\n" +
	"timeout_ms\x18\x03 \x01(\x05R\ttimeoutMsB\x8b\x03\n" +
	"4com.dev.planton.snowflake.snowflakedatabase.v1alpha1B\tSpecProtoP\x01Zcgithub.com/plantonhq/planton/catalog/snowflake/snowflakedatabase/v1alpha1;snowflakedatabasev1alpha1\xa2\x02\x04DPSS\xaa\x020Dev.Planton.Snowflake.Snowflakedatabase.V1alpha1\xca\x020Dev\\Planton\\Snowflake\\Snowflakedatabase\\V1alpha1\xe2\x02<Dev\\Planton\\Snowflake\\Snowflakedatabase\\V1alpha1\\GPBMetadata\xea\x024Dev::Planton::Snowflake::Snowflakedatabase::V1alpha1b\x06proto3"

var (
	file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDesc), len(file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDescData
}

var file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_goTypes = []any{
	(*SnowflakeDatabaseSpec)(nil),     // 0: dev.planton.snowflake.snowflakedatabase.v1alpha1.SnowflakeDatabaseSpec
	(*SnowflakeDatabaseUserTask)(nil), // 1: dev.planton.snowflake.snowflakedatabase.v1alpha1.SnowflakeDatabaseUserTask
}
var file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_depIdxs = []int32{
	1, // 0: dev.planton.snowflake.snowflakedatabase.v1alpha1.SnowflakeDatabaseSpec.user_task:type_name -> dev.planton.snowflake.snowflakedatabase.v1alpha1.SnowflakeDatabaseUserTask
...
func init() { file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_init() }
func file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_init() {
	if File_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDesc), len(file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto = out.File
	file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_goTypes = nil
	file_catalog_snowflake_snowflakedatabase_v1alpha1_spec_proto_depIdxs = nil
}
