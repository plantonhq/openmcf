...
- [Auth0ResourceServer](/docs/catalog/auth0/auth0resourceserver) — defines the APIs and scopes (permissions) that roles grant
- [Auth0Client](/docs/catalog/auth0/auth0client) — applications whose users are assigned roles
