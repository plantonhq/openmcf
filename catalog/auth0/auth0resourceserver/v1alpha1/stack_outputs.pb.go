...
// 	protoc        (unknown)
// source: catalog/auth0/auth0resourceserver/v1alpha1/stack_outputs.proto
...
func (x *Auth0ResourceServerStackOutputs) Reset() {
	*x = Auth0ResourceServerStackOutputs{}
	mi := &file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*Auth0ResourceServerStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	">catalog/auth0/auth0resourceserver/v1alpha1/stack_outputs.proto\x12.dev.planton.auth0.auth0resourceserver.v1alpha1\"\xa9\x04\n" +
	...
	"\tclient_id\x18\r \x01(\tR\bclientIdB\x89\x03\n" +
	"2com.dev.planton.auth0.auth0resourceserver.v1alpha1B\x11StackOutputsProtoP\x01Zcgithub.com/plantonhq/planton/catalog/auth0/auth0resourceserver/v1alpha1;auth0resourceserverv1alpha1\xa2\x02\x04DPAA\xaa\x02.Dev.Planton.Auth0.Auth0resourceserver.V1alpha1\xca\x02.Dev\\Planton\\Auth0\\Auth0resourceserver\\V1alpha1\xe2\x02:Dev\\Planton\\Auth0\\Auth0resourceserver\\V1alpha1\\GPBMetadata\xea\x022Dev::Planton::Auth0::Auth0resourceserver::V1alpha1b\x06proto3"

var (
	file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*Auth0ResourceServerStackOutputs)(nil), // 0: dev.planton.auth0.auth0resourceserver.v1alpha1.Auth0ResourceServerStackOutputs
}
var file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_init() }
func file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto = out.File
	file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_auth0_auth0resourceserver_v1alpha1_stack_outputs_proto_depIdxs = nil
}
