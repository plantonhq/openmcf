...
// 	protoc        (unknown)
// source: catalog/gcp/gcpsubnetwork/v1alpha1/stack_outputs.proto
...
func (x *GcpSubnetworkStackOutputs) Reset() {
	*x = GcpSubnetworkStackOutputs{}
	mi := &file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*GcpSubnetworkStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpSubnetworkSecondaryRangeStackOutput) Reset() {
	*x = GcpSubnetworkSecondaryRangeStackOutput{}
	mi := &file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSubnetworkSecondaryRangeStackOutput) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"6catalog/gcp/gcpsubnetwork/v1alpha1/stack_outputs.proto\x12&dev.planton.gcp.gcpsubnetwork.v1alpha1\"\xdf\x03\n" +
	...
	"\rip_cidr_range\x18\x02 \x01(\tR\vipCidrRangeB\xd3\x02\n" +
	"*com.dev.planton.gcp.gcpsubnetwork.v1alpha1B\x11StackOutputsProtoP\x01ZUgithub.com/plantonhq/planton/catalog/gcp/gcpsubnetwork/v1alpha1;gcpsubnetworkv1alpha1\xa2\x02\x04DPGG\xaa\x02&Dev.Planton.Gcp.Gcpsubnetwork.V1alpha1\xca\x02&Dev\\Planton\\Gcp\\Gcpsubnetwork\\V1alpha1\xe2\x022Dev\\Planton\\Gcp\\Gcpsubnetwork\\V1alpha1\\GPBMetadata\xea\x02*Dev::Planton::Gcp::Gcpsubnetwork::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_goTypes = []any{
...
var file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_init() }
func file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto = out.File
	file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_gcp_gcpsubnetwork_v1alpha1_stack_outputs_proto_depIdxs = nil
}
