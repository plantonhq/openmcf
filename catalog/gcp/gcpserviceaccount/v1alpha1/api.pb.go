...
const file_catalog_gcp_gcpserviceaccount_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"0catalog/gcp/gcpserviceaccount/v1alpha1/api.proto\x12*dev.planton.gcp.gcpserviceaccount.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a4catalog/gcp/gcpserviceaccount/v1alpha1/outputs.proto\x1a1catalog/gcp/gcpserviceaccount/v1alpha1/spec.proto\x1a\x15shared/metadata.proto\"\x8e\x03\n" +
...
func file_catalog_gcp_gcpserviceaccount_v1alpha1_api_proto_init() {
	...
	file_catalog_gcp_gcpserviceaccount_v1alpha1_outputs_proto_init()
