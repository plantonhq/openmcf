...
- [GcpBackendService](/docs/catalog/gcp/gcpbackendservice) — backends this map routes to
- [GcpBackendBucket](/docs/catalog/gcp/gcpbackendbucket) — static assets and custom error pages
- [GcpProject](/docs/catalog/gcp/gcpproject) — provides the project that owns the map
