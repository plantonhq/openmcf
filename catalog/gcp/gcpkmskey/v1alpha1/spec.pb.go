...
// 	protoc        (unknown)
// source: catalog/gcp/gcpkmskey/v1alpha1/spec.proto
...
func (x *GcpKmsKeyVersionTemplate) Reset() {
	*x = GcpKmsKeyVersionTemplate{}
	mi := &file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpKmsKeyVersionTemplate) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpKmsKeySpec) Reset() {
	*x = GcpKmsKeySpec{}
	mi := &file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpKmsKeySpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
const file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	")catalog/gcp/gcpkmskey/v1alpha1/spec.proto\x12\"dev.planton.gcp.gcpkmskey.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\x9e\x02\n" +
	...
	"\x1dvalid_destroy_duration_format\x12Wdestroy_scheduled_duration must be a duration in seconds (e.g., '2592000s' for 30 days)\x1a7this == '' || this.matches('^[0-9]+(\\\\.[0-9]{1,9})?s$')R\x18destroyScheduledDuration\x12g\n" +
...
var (
	file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDescData
}

var file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_goTypes = []any{
	(*GcpKmsKeyVersionTemplate)(nil), // 0: dev.planton.gcp.gcpkmskey.v1alpha1.GcpKmsKeyVersionTemplate
	(*GcpKmsKeySpec)(nil),            // 1: dev.planton.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec
	nil,                              // 2: dev.planton.gcp.gcpkmskey.v1alpha1.GcpKmsKeySpec.LabelsEntry
...
func file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpkmskey_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpkmskey_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpkmskey_v1alpha1_spec_proto_depIdxs = nil
}
