...
// 	protoc        (unknown)
// source: catalog/gcp/gcpserverlessvpcconnector/v1alpha1/spec.proto
...
func (x *GcpServerlessVpcConnectorSpec) Reset() {
	*x = GcpServerlessVpcConnectorSpec{}
	mi := &file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpServerlessVpcConnectorSpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpServerlessVpcConnectorSubnet) Reset() {
	*x = GcpServerlessVpcConnectorSubnet{}
	mi := &file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpServerlessVpcConnectorSubnet) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\rip_cidr_range\x18\x05 \x01(\tB*\xbaH'\xd8\x01\x01r\"2 ^([0-9]{1,3}\\.){3}[0-9]{1,3}/28$R\vipCidrRange\x12k\n" +
	"\x06subnet\x18\x06 \x01(\v2S.dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSubnetR\x06subnet\x12\\\n" +
	...
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectIdB\x9f\x03\n" +
	"6com.dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1B\tSpecProtoP\x01Zmgithub.com/plantonhq/planton/catalog/gcp/gcpserverlessvpcconnector/v1alpha1;gcpserverlessvpcconnectorv1alpha1\xa2\x02\x04DPGG\xaa\x022Dev.Planton.Gcp.Gcpserverlessvpcconnector.V1alpha1\xca\x022Dev\\Planton\\Gcp\\Gcpserverlessvpcconnector\\V1alpha1\xe2\x02>Dev\\Planton\\Gcp\\Gcpserverlessvpcconnector\\V1alpha1\\GPBMetadata\xea\x026Dev::Planton::Gcp::Gcpserverlessvpcconnector::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDescData
}

var file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_goTypes = []any{
	(*GcpServerlessVpcConnectorSpec)(nil),   // 0: dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSpec
	(*GcpServerlessVpcConnectorSubnet)(nil), // 1: dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSubnet
	(*v1.StringValueOrRef)(nil),             // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSpec.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSpec.subnet:type_name -> dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSubnet
	2, // 3: dev.planton.gcp.gcpserverlessvpcconnector.v1alpha1.GcpServerlessVpcConnectorSubnet.name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_init() }
func file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpserverlessvpcconnector_v1alpha1_spec_proto_depIdxs = nil
}
