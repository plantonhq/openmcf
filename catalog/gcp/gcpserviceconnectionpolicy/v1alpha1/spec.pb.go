...
// 	protoc        (unknown)
// source: catalog/gcp/gcpserviceconnectionpolicy/v1alpha1/spec.proto
...
func (x *GcpServiceConnectionPolicyPscConfig) Reset() {
	*x = GcpServiceConnectionPolicyPscConfig{}
	mi := &file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpServiceConnectionPolicyPscConfig) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpServiceConnectionPolicySpec) Reset() {
	*x = GcpServiceConnectionPolicySpec{}
	mi := &file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpServiceConnectionPolicySpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
const file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	":catalog/gcp/gcpserviceconnectionpolicy/v1alpha1/spec.proto\x123dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\xee\v\n" +
	...
	"7com.dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1B\tSpecProtoP\x01Zogithub.com/plantonhq/planton/catalog/gcp/gcpserviceconnectionpolicy/v1alpha1;gcpserviceconnectionpolicyv1alpha1\xa2\x02\x04DPGG\xaa\x023Dev.Planton.Gcp.Gcpserviceconnectionpolicy.V1alpha1\xca\x023Dev\\Planton\\Gcp\\Gcpserviceconnectionpolicy\\V1alpha1\xe2\x02?Dev\\Planton\\Gcp\\Gcpserviceconnectionpolicy\\V1alpha1\\GPBMetadata\xea\x027Dev::Planton::Gcp::Gcpserviceconnectionpolicy::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDescData
}

var file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_goTypes = []any{
	(*GcpServiceConnectionPolicyPscConfig)(nil), // 0: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicyPscConfig
	(*GcpServiceConnectionPolicySpec)(nil),      // 1: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicySpec
	nil,                                         // 2: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicySpec.LabelsEntry
	(*v1.StringValueOrRef)(nil),                 // 3: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_depIdxs = []int32{
	3, // 0: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicyPscConfig.subnetworks:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicySpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicySpec.network:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicySpec.labels:type_name -> dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicySpec.LabelsEntry
	0, // 4: dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicySpec.psc_config:type_name -> dev.planton.gcp.gcpserviceconnectionpolicy.v1alpha1.GcpServiceConnectionPolicyPscConfig
...
func init() { file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_init() }
func file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpserviceconnectionpolicy_v1alpha1_spec_proto_depIdxs = nil
}
