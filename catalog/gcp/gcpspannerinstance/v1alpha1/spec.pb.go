...
// 	protoc        (unknown)
// source: catalog/gcp/gcpspannerinstance/v1alpha1/spec.proto
...
func (x *GcpSpannerInstanceAutoscalingLimits) Reset() {
	*x = GcpSpannerInstanceAutoscalingLimits{}
	mi := &file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpSpannerInstanceAutoscalingLimits) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpSpannerInstanceAutoscalingTargets) Reset() {
	*x = GcpSpannerInstanceAutoscalingTargets{}
	mi := &file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSpannerInstanceAutoscalingTargets) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpSpannerInstanceAsymmetricAutoscalingOverrides) Reset() {
	*x = GcpSpannerInstanceAsymmetricAutoscalingOverrides{}
	mi := &file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSpannerInstanceAsymmetricAutoscalingOverrides) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpSpannerInstanceAsymmetricAutoscalingOption) Reset() {
	*x = GcpSpannerInstanceAsymmetricAutoscalingOption{}
	mi := &file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSpannerInstanceAsymmetricAutoscalingOption) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *GcpSpannerInstanceAutoscalingConfig) Reset() {
	*x = GcpSpannerInstanceAutoscalingConfig{}
	mi := &file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSpannerInstanceAutoscalingConfig) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *GcpSpannerInstanceSpec) Reset() {
	*x = GcpSpannerInstanceSpec{}
	mi := &file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSpannerInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{5}
}
...
const file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"2catalog/gcp/gcpspannerinstance/v1alpha1/spec.proto\x12+dev.planton.gcp.gcpspannerinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\xb2\a\n" +
	...
	"\fdisplay_name\x18\x04 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x04\x18\x1eR\vdisplayName\x12g\n" +
	"\x06labels\x18\x05 \x03(\v2O.dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceSpec.LabelsEntryR\x06labels\x12\x1b\n" +
	"\tnum_nodes\x18\x06 \x01(\x05R\bnumNodes\x12)\n" +
	"\x10processing_units\x18\a \x01(\x05R\x0fprocessingUnits\x12\x7f\n" +
	"\x12autoscaling_config\x18\b \x01(\v2P.dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingConfigR\x11autoscalingConfig\x12\xb5\x01\n" +
	...
	"!free_instance_no_automatic_backup\x12Tdefault_backup_schedule_type cannot be AUTOMATIC when instance_type is FREE_INSTANCE\x1aYthis.instance_type != 'FREE_INSTANCE' || this.default_backup_schedule_type != 'AUTOMATIC'B\xee\x02\n" +
	"/com.dev.planton.gcp.gcpspannerinstance.v1alpha1B\tSpecProtoP\x01Z_github.com/plantonhq/planton/catalog/gcp/gcpspannerinstance/v1alpha1;gcpspannerinstancev1alpha1\xa2\x02\x04DPGG\xaa\x02+Dev.Planton.Gcp.Gcpspannerinstance.V1alpha1\xca\x02+Dev\\Planton\\Gcp\\Gcpspannerinstance\\V1alpha1\xe2\x027Dev\\Planton\\Gcp\\Gcpspannerinstance\\V1alpha1\\GPBMetadata\xea\x02/Dev::Planton::Gcp::Gcpspannerinstance::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDescData
}

var file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_goTypes = []any{
	(*GcpSpannerInstanceAutoscalingLimits)(nil),              // 0: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingLimits
	(*GcpSpannerInstanceAutoscalingTargets)(nil),             // 1: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingTargets
	(*GcpSpannerInstanceAsymmetricAutoscalingOverrides)(nil), // 2: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAsymmetricAutoscalingOverrides
	(*GcpSpannerInstanceAsymmetricAutoscalingOption)(nil),    // 3: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAsymmetricAutoscalingOption
	(*GcpSpannerInstanceAutoscalingConfig)(nil),              // 4: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingConfig
	(*GcpSpannerInstanceSpec)(nil),                           // 5: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceSpec
	nil,                                                      // 6: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceSpec.LabelsEntry
	(*v1.StringValueOrRef)(nil),                              // 7: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAsymmetricAutoscalingOption.overrides:type_name -> dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAsymmetricAutoscalingOverrides
	0, // 1: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingConfig.autoscaling_limits:type_name -> dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingLimits
	1, // 2: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingConfig.autoscaling_targets:type_name -> dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingTargets
	3, // 3: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingConfig.asymmetric_autoscaling_options:type_name -> dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAsymmetricAutoscalingOption
	7, // 4: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	6, // 5: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceSpec.labels:type_name -> dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceSpec.LabelsEntry
	4, // 6: dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceSpec.autoscaling_config:type_name -> dev.planton.gcp.gcpspannerinstance.v1alpha1.GcpSpannerInstanceAutoscalingConfig
...
func init() { file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_init() }
func file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpspannerinstance_v1alpha1_spec_proto_depIdxs = nil
}
