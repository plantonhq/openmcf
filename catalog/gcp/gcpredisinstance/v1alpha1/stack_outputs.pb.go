...
// 	protoc        (unknown)
// source: catalog/gcp/gcpredisinstance/v1alpha1/stack_outputs.proto
...
func (x *GcpRedisInstanceStackOutputs) Reset() {
	*x = GcpRedisInstanceStackOutputs{}
	mi := &file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*GcpRedisInstanceStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"9catalog/gcp/gcpredisinstance/v1alpha1/stack_outputs.proto\x12)dev.planton.gcp.gcpredisinstance.v1alpha1\"\xc8\x03\n" +
	...
	"\x06region\x18\v \x01(\tR\x06regionB\xe8\x02\n" +
	"-com.dev.planton.gcp.gcpredisinstance.v1alpha1B\x11StackOutputsProtoP\x01Z[github.com/plantonhq/planton/catalog/gcp/gcpredisinstance/v1alpha1;gcpredisinstancev1alpha1\xa2\x02\x04DPGG\xaa\x02)Dev.Planton.Gcp.Gcpredisinstance.V1alpha1\xca\x02)Dev\\Planton\\Gcp\\Gcpredisinstance\\V1alpha1\xe2\x025Dev\\Planton\\Gcp\\Gcpredisinstance\\V1alpha1\\GPBMetadata\xea\x02-Dev::Planton::Gcp::Gcpredisinstance::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_goTypes = []any{
	(*GcpRedisInstanceStackOutputs)(nil), // 0: dev.planton.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceStackOutputs
}
var file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_init() }
func file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto = out.File
	file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_gcp_gcpredisinstance_v1alpha1_stack_outputs_proto_depIdxs = nil
}
