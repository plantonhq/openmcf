...
// 	protoc        (unknown)
// source: catalog/gcp/gcpredisinstance/v1alpha1/spec.proto
...
func (x *GcpRedisInstanceMaintenanceWindow) Reset() {
	*x = GcpRedisInstanceMaintenanceWindow{}
	mi := &file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpRedisInstanceMaintenanceWindow) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpRedisInstancePersistenceConfig) Reset() {
	*x = GcpRedisInstancePersistenceConfig{}
	mi := &file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpRedisInstancePersistenceConfig) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpRedisInstanceSpec) Reset() {
	*x = GcpRedisInstanceSpec{}
	mi := &file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpRedisInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
const file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc = "" +
	...
	"#transit_encryption_mode_valid_value\x12Atransit_encryption_mode must be DISABLED or SERVER_AUTHENTICATION\x1a;this == '' || this in ['DISABLED', 'SERVER_AUTHENTICATION']R\x15transitEncryptionMode\x12v\n" +
	"\rredis_configs\x18\x10 \x03(\v2Q.dev.planton.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceSpec.RedisConfigsEntryR\fredisConfigs\x12{\n" +
	"\x12maintenance_window\x18\x11 \x01(\v2L.dev.planton.gcp.gcpredisinstance.v1alpha1.GcpRedisInstanceMaintenanceWindowR\x11maintenanceWindow\x12/\n" +
...
var (
	file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpredisinstance_v1alpha1_spec_proto_depIdxs = nil
}
