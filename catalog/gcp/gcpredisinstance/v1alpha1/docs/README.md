...
The Planton GcpRedisInstance Pulumi module lives at `catalog/gcp/gcpredisinstance/v1alpha1/iac/pulumi/`. The main program:
...
The Terraform module lives at `catalog/gcp/gcpredisinstance/v1alpha1/iac/tf/`. It:
