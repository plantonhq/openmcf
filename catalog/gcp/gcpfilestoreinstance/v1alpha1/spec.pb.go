...
// 	protoc        (unknown)
// source: catalog/gcp/gcpfilestoreinstance/v1alpha1/spec.proto
...
func (x *GcpFilestoreInstanceNfsExportOption) Reset() {
	*x = GcpFilestoreInstanceNfsExportOption{}
	mi := &file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpFilestoreInstanceNfsExportOption) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpFilestoreInstanceFileShare) Reset() {
	*x = GcpFilestoreInstanceFileShare{}
	mi := &file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpFilestoreInstanceFileShare) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpFilestoreInstanceNetworkConfig) Reset() {
	*x = GcpFilestoreInstanceNetworkConfig{}
	mi := &file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpFilestoreInstanceNetworkConfig) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto protoreflect.FileDescriptor
...
const file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\xbaH\a\xc8\x01\x01\x1a\x02(\x01R\fmaxIopsPerTb\"\xa3\x03\n" +
	"%GcpFilestoreInstancePerformanceConfig\x12k\n" +
	"\n" +
	...
	"\n" +
	"file_share\x18\n" +
	" \x01(\v2L.dev.planton.gcp.gcpfilestoreinstance.v1alpha1.GcpFilestoreInstanceFileShareB\x06\xbaH\x03\xc8\x01\x01R\tfileShare\x12\x7f\n" +
	"\x0enetwork_config\x18\v \x01(\v2P.dev.planton.gcp.gcpfilestoreinstance.v1alpha1.GcpFilestoreInstanceNetworkConfigB\x06\xbaH\x03\xc8\x01\x01R\rnetworkConfig\x12\x83\x01\n" +
	...
	"\x0epeer_instances\x18\x02 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB+\xbaH\x05\x92\x01\x02\b\x01\x88\xd4a\x9c\x18\x92\xd4a\x1astatus.outputs.instance_idR\rpeerInstancesB\xfc\x02\n" +
	"1com.dev.planton.gcp.gcpfilestoreinstance.v1alpha1B\tSpecProtoP\x01Zcgithub.com/plantonhq/planton/catalog/gcp/gcpfilestoreinstance/v1alpha1;gcpfilestoreinstancev1alpha1\xa2\x02\x04DPGG\xaa\x02-Dev.Planton.Gcp.Gcpfilestoreinstance.V1alpha1\xca\x02-Dev\\Planton\\Gcp\\Gcpfilestoreinstance\\V1alpha1\xe2\x029Dev\\Planton\\Gcp\\Gcpfilestoreinstance\\V1alpha1\\GPBMetadata\xea\x021Dev::Planton::Gcp::Gcpfilestoreinstance::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpfilestoreinstance_v1alpha1_spec_proto_depIdxs = nil
}
