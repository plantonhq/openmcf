...
// 	protoc        (unknown)
// source: catalog/gcp/gcpbigtableinstance/v1alpha1/spec.proto
...
func (x *GcpBigtableInstanceClusterAutoscalingConfig) Reset() {
	*x = GcpBigtableInstanceClusterAutoscalingConfig{}
	mi := &file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpBigtableInstanceClusterAutoscalingConfig) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpBigtableInstanceCluster) Reset() {
	*x = GcpBigtableInstanceCluster{}
	mi := &file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpBigtableInstanceCluster) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpBigtableInstanceSpec) Reset() {
	*x = GcpBigtableInstanceSpec{}
	mi := &file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpBigtableInstanceSpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
const file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"3catalog/gcp/gcpbigtableinstance/v1alpha1/spec.proto\x12,dev.planton.gcp.gcpbigtableinstance.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xcb\x02\n" +
	...
	"0com.dev.planton.gcp.gcpbigtableinstance.v1alpha1B\tSpecProtoP\x01Zagithub.com/plantonhq/planton/catalog/gcp/gcpbigtableinstance/v1alpha1;gcpbigtableinstancev1alpha1\xa2\x02\x04DPGG\xaa\x02,Dev.Planton.Gcp.Gcpbigtableinstance.V1alpha1\xca\x02,Dev\\Planton\\Gcp\\Gcpbigtableinstance\\V1alpha1\xe2\x028Dev\\Planton\\Gcp\\Gcpbigtableinstance\\V1alpha1\\GPBMetadata\xea\x020Dev::Planton::Gcp::Gcpbigtableinstance::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpbigtableinstance_v1alpha1_spec_proto_depIdxs = nil
}
