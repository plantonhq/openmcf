...
// 	protoc        (unknown)
// source: catalog/gcp/gcpspannerdatabase/v1alpha1/spec.proto
...
func (x *GcpSpannerDatabaseEncryptionConfig) Reset() {
	*x = GcpSpannerDatabaseEncryptionConfig{}
	mi := &file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpSpannerDatabaseEncryptionConfig) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpSpannerDatabaseSpec) Reset() {
	*x = GcpSpannerDatabaseSpec{}
	mi := &file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSpannerDatabaseSpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
const file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDesc = "" +
	...
	"\x16enable_drop_protection\x18\a \x01(\bR\x14enableDropProtection\x12|\n" +
...
var (
	file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDescData
}

var file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_goTypes = []any{
	(*GcpSpannerDatabaseEncryptionConfig)(nil), // 0: dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseEncryptionConfig
	(*GcpSpannerDatabaseSpec)(nil),             // 1: dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseSpec
	(*v1.StringValueOrRef)(nil),                // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseEncryptionConfig.kms_key_name:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseEncryptionConfig.kms_key_names:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 2: dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 3: dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseSpec.instance:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	0, // 4: dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseSpec.encryption_config:type_name -> dev.planton.gcp.gcpspannerdatabase.v1alpha1.GcpSpannerDatabaseEncryptionConfig
...
func init() { file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_init() }
func file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpspannerdatabase_v1alpha1_spec_proto_depIdxs = nil
}
