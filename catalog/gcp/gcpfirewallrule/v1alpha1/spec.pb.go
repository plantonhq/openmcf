...
// 	protoc        (unknown)
// source: catalog/gcp/gcpfirewallrule/v1alpha1/spec.proto
...
func (x *GcpFirewallProtocolPort) Reset() {
	*x = GcpFirewallProtocolPort{}
	mi := &file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpFirewallProtocolPort) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpFirewallLogConfig) Reset() {
	*x = GcpFirewallLogConfig{}
	mi := &file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpFirewallLogConfig) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpFirewallRuleSpec) Reset() {
	*x = GcpFirewallRuleSpec{}
	mi := &file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpFirewallRuleSpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescGZIP(), []int{2}
}
...
const file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"/catalog/gcp/gcpfirewallrule/v1alpha1/spec.proto\x12(dev.planton.gcp.gcpfirewallrule.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"S\n" +
	...
	"\faction_valid\x12\x1caction must be ALLOW or DENY\x1a\x19this in ['ALLOW', 'DENY']\xc8\x01\x01R\x06action\x12a\n" +
	"\x05rules\x18\x06 \x03(\v2A.dev.planton.gcp.gcpfirewallrule.v1alpha1.GcpFirewallProtocolPortB\b\xbaH\x05\x92\x01\x02\b\x01R\x05rules\x124\n" +
	...
	"\t_priorityB\xd9\x02\n" +
	",com.dev.planton.gcp.gcpfirewallrule.v1alpha1B\tSpecProtoP\x01ZYgithub.com/plantonhq/planton/catalog/gcp/gcpfirewallrule/v1alpha1;gcpfirewallrulev1alpha1\xa2\x02\x04DPGG\xaa\x02(Dev.Planton.Gcp.Gcpfirewallrule.V1alpha1\xca\x02(Dev\\Planton\\Gcp\\Gcpfirewallrule\\V1alpha1\xe2\x024Dev\\Planton\\Gcp\\Gcpfirewallrule\\V1alpha1\\GPBMetadata\xea\x02,Dev::Planton::Gcp::Gcpfirewallrule::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_rawDesc)))
	})
...
func file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto != nil {
		return
	}
	file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpfirewallrule_v1alpha1_spec_proto_depIdxs = nil
}
