...
// 	protoc        (unknown)
// source: catalog/gcp/gcpgkeworkloadidentitybinding/v1alpha1/spec.proto
...
func (x *GcpGkeWorkloadIdentityBindingSpec) Reset() {
	*x = GcpGkeWorkloadIdentityBindingSpec{}
	mi := &file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_msgTypes[0]
...
func (*GcpGkeWorkloadIdentityBindingSpec) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGkeWorkloadIdentityBindingCondition) Reset() {
	*x = GcpGkeWorkloadIdentityBindingCondition{}
	mi := &file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeWorkloadIdentityBindingCondition) Descriptor() ([]byte, []int) {
	return file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	"=catalog/gcp/gcpgkeworkloadidentitybinding/v1alpha1/spec.proto\x126dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\"\xc2\x04\n" +
	...
	"\bksa_name\x18\x04 \x01(\tB-\xbaH*\xc8\x01\x01r%\x18\xfd\x012 ^[a-z0-9]([-a-z0-9.]*[a-z0-9])?$R\aksaName\x12|\n" +
	"\tcondition\x18\x05 \x01(\v2^.dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1.GcpGkeWorkloadIdentityBindingConditionR\tcondition\"\x9e\x01\n" +
	...
	"expression\x12*\n" +
	"\vdescription\x18\x03 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x02R\vdescriptionB\xbb\x03\n" +
	":com.dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1B\tSpecProtoP\x01Zugithub.com/plantonhq/planton/catalog/gcp/gcpgkeworkloadidentitybinding/v1alpha1;gcpgkeworkloadidentitybindingv1alpha1\xa2\x02\x04DPGG\xaa\x026Dev.Planton.Gcp.Gcpgkeworkloadidentitybinding.V1alpha1\xca\x026Dev\\Planton\\Gcp\\Gcpgkeworkloadidentitybinding\\V1alpha1\xe2\x02BDev\\Planton\\Gcp\\Gcpgkeworkloadidentitybinding\\V1alpha1\\GPBMetadata\xea\x02:Dev::Planton::Gcp::Gcpgkeworkloadidentitybinding::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDescData
}

var file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_goTypes = []any{
	(*GcpGkeWorkloadIdentityBindingSpec)(nil),      // 0: dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1.GcpGkeWorkloadIdentityBindingSpec
	(*GcpGkeWorkloadIdentityBindingCondition)(nil), // 1: dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1.GcpGkeWorkloadIdentityBindingCondition
	(*v1.StringValueOrRef)(nil),                    // 2: dev.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_depIdxs = []int32{
	2, // 0: dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1.GcpGkeWorkloadIdentityBindingSpec.project_id:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1.GcpGkeWorkloadIdentityBindingSpec.service_account_email:type_name -> dev.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1.GcpGkeWorkloadIdentityBindingSpec.condition:type_name -> dev.planton.gcp.gcpgkeworkloadidentitybinding.v1alpha1.GcpGkeWorkloadIdentityBindingCondition
...
func init() { file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_init() }
func file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_init() {
	if File_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_depIdxs,
		MessageInfos:      file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcpgkeworkloadidentitybinding_v1alpha1_spec_proto_depIdxs = nil
}
