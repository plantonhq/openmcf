...
const file_catalog_gcp_gcpdnsrecord_v1alpha1_api_proto_rawDesc = "" +
	"\n" +
	"+catalog/gcp/gcpdnsrecord/v1alpha1/api.proto\x12%dev.planton.gcp.gcpdnsrecord.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a,catalog/gcp/gcpdnsrecord/v1alpha1/spec.proto\x1a5catalog/gcp/gcpdnsrecord/v1alpha1/stack_outputs.proto\x1a\x15shared/metadata.proto\"\xf0\x02\n" +
	"\fGcpDnsRecord\x12@\n" +
...
func file_catalog_gcp_gcpdnsrecord_v1alpha1_api_proto_init() {
	...
	file_catalog_gcp_gcpdnsrecord_v1alpha1_stack_outputs_proto_init()
	type x struct{}
