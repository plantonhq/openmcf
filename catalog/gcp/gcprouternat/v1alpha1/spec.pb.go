...
// 	protoc        (unknown)
// source: catalog/gcp/gcprouternat/v1alpha1/spec.proto
...
func (GcpRouterNatLogFilter) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpRouterNatLogFilter) Type() protoreflect.EnumType {
	return &file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_enumTypes[0]
}
...
func (GcpRouterNatLogFilter) EnumDescriptor() ([]byte, []int) {
	return file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpRouterNatSubnetwork) Reset() {
	*x = GcpRouterNatSubnetwork{}
	mi := &file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_msgTypes[0]
...
const file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	",catalog/gcp/gcprouternat/v1alpha1/spec.proto\x12%dev.planton.gcp.gcprouternat.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a&shared/foreignkey/v1/foreign_key.proto\x1a\x1cshared/options/options.proto\"\xec\x06\n" +
	...
	"\x17source_nat_drain_ranges\x18\x04 \x03(\v22.dev.planton.shared.foreignkey.v1.StringValueOrRefB0\x88\xd4a\xc3\x17\x92\xd4a#status.outputs.subnetwork_self_link\x98\xd4a\x01R\x14sourceNatDrainRanges\"\xd5\x01\n" +
	...
	"\x11TRANSLATIONS_ONLY\x10\x03B\xc4\x02\n" +
	")com.dev.planton.gcp.gcprouternat.v1alpha1B\tSpecProtoP\x01ZSgithub.com/plantonhq/planton/catalog/gcp/gcprouternat/v1alpha1;gcprouternatv1alpha1\xa2\x02\x04DPGG\xaa\x02%Dev.Planton.Gcp.Gcprouternat.V1alpha1\xca\x02%Dev\\Planton\\Gcp\\Gcprouternat\\V1alpha1\xe2\x021Dev\\Planton\\Gcp\\Gcprouternat\\V1alpha1\\GPBMetadata\xea\x02)Dev::Planton::Gcp::Gcprouternat::V1alpha1b\x06proto3"

var (
	file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDesc), len(file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_rawDescData
}
...
func file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_gcp_gcprouternat_v1alpha1_spec_proto = out.File
	file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_goTypes = nil
	file_catalog_gcp_gcprouternat_v1alpha1_spec_proto_depIdxs = nil
}
