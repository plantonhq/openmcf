...
func Resources(
	ctx *pulumi.Context,
	stackInput *cloudflarezerotrustdnslocationv1alpha1.CloudflareZeroTrustDnsLocationStackInput,
) error {
	...
	// 3. Create the DNS location.
	if err := dnsLocation(ctx, locals, cloudflareProvider); err != nil {
