...
// 	protoc        (unknown)
// source: catalog/cloudflare/cloudflarezerotrustaccessapplication/v1alpha1/stack_outputs.proto
...
func (x *CloudflareZeroTrustAccessApplicationStackOutputs) Reset() {
	*x = CloudflareZeroTrustAccessApplicationStackOutputs{}
	mi := &file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_msgTypes[0]
...
func (*CloudflareZeroTrustAccessApplicationStackOutputs) Descriptor() ([]byte, []int) {
	return file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto protoreflect.FileDescriptor

const file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Tcatalog/cloudflare/cloudflarezerotrustaccessapplication/v1alpha1/stack_outputs.proto\x12Ddev.planton.cloudflare.cloudflarezerotrustaccessapplication.v1alpha1\"\xd8\x02\n" +
	...
	"\x12saas_idp_entity_id\x18\b \x01(\tR\x0fsaasIdpEntityIdB\x9f\x04\n" +
	"Hcom.dev.planton.cloudflare.cloudflarezerotrustaccessapplication.v1alpha1B\x11StackOutputsProtoP\x01Z\x8a\x01github.com/plantonhq/planton/catalog/cloudflare/cloudflarezerotrustaccessapplication/v1alpha1;cloudflarezerotrustaccessapplicationv1alpha1\xa2\x02\x04DPCC\xaa\x02DDev.Planton.Cloudflare.Cloudflarezerotrustaccessapplication.V1alpha1\xca\x02DDev\\Planton\\Cloudflare\\Cloudflarezerotrustaccessapplication\\V1alpha1\xe2\x02PDev\\Planton\\Cloudflare\\Cloudflarezerotrustaccessapplication\\V1alpha1\\GPBMetadata\xea\x02HDev::Planton::Cloudflare::Cloudflarezerotrustaccessapplication::V1alpha1b\x06proto3"

var (
	file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDescOnce sync.Once
	file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDescData []byte
)

func file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDescGZIP() []byte {
	file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDesc)))
	})
	return file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDescData
}

var file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_goTypes = []any{
...
var file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_depIdxs = []int32{
...
func file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_init() {
	if File_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDesc), len(file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_msgTypes,
	}.Build()
	File_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto = out.File
	file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_goTypes = nil
	file_catalog_cloudflare_cloudflarezerotrustaccessapplication_v1alpha1_stack_outputs_proto_depIdxs = nil
}
