...
// 	protoc        (unknown)
// source: catalog/cloudflare/cloudflared1database/v1alpha1/spec.proto
...
func (CloudflareD1Region) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareD1Region) Type() protoreflect.EnumType {
	return &file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_enumTypes[0]
}
...
func (CloudflareD1Region) EnumDescriptor() ([]byte, []int) {
	return file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (CloudflareD1ReadReplicationMode) Descriptor() protoreflect.EnumDescriptor {
	return file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_enumTypes[1].Descriptor()
}

func (CloudflareD1ReadReplicationMode) Type() protoreflect.EnumType {
	return &file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_enumTypes[1]
}
...
func (CloudflareD1ReadReplicationMode) EnumDescriptor() ([]byte, []int) {
	return file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescGZIP(), []int{1}
}
...
type CloudflareD1DatabaseSpec struct {
	...
	// constraint.
	Region CloudflareD1Region `protobuf:"varint,3,opt,name=region,proto3,enum=dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1Region" json:"region,omitempty"`
...
func (x *CloudflareD1DatabaseSpec) Reset() {
	*x = CloudflareD1DatabaseSpec{}
	mi := &file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_msgTypes[0]
...
type CloudflareD1ReadReplication struct {
	...
	Mode          CloudflareD1ReadReplicationMode `protobuf:"varint,1,opt,name=mode,proto3,enum=dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplicationMode" json:"mode,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CloudflareD1ReadReplication) Reset() {
	*x = CloudflareD1ReadReplication{}
	mi := &file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto protoreflect.FileDescriptor

const file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDesc = "" +
	"\n" +
	";catalog/cloudflare/cloudflared1database/v1alpha1/spec.proto\x124dev.planton.cloudflare.cloudflared1database.v1alpha1\x1a\x1bbuf/validate/validate.proto\"\xb0\x05\n" +
	...
	"\x06region\x18\x03 \x01(\x0e2H.dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1RegionR\x06region\x12|\n" +
	"\x10read_replication\x18\x04 \x01(\v2Q.dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplicationR\x0freadReplication\x12\x94\x01\n" +
	...
	"\x1cspec.region_xor_jurisdiction\x12Uset at most one of region or jurisdiction (jurisdiction already constrains placement)\x1a.!(this.jurisdiction != '' && this.region != 0)\"\xee\x01\n" +
	"\x1bCloudflareD1ReadReplication\x12\xce\x01\n" +
	"\x04mode\x18\x01 \x01(\x0e2U.dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplicationModeBc\xbaH`\xba\x01U\n" +
	...
	"\bdisabled\x10\x02B\xa6\x03\n" +
	"8com.dev.planton.cloudflare.cloudflared1database.v1alpha1B\tSpecProtoP\x01Zjgithub.com/plantonhq/planton/catalog/cloudflare/cloudflared1database/v1alpha1;cloudflared1databasev1alpha1\xa2\x02\x04DPCC\xaa\x024Dev.Planton.Cloudflare.Cloudflared1database.V1alpha1\xca\x024Dev\\Planton\\Cloudflare\\Cloudflared1database\\V1alpha1\xe2\x02@Dev\\Planton\\Cloudflare\\Cloudflared1database\\V1alpha1\\GPBMetadata\xea\x028Dev::Planton::Cloudflare::Cloudflared1database::V1alpha1b\x06proto3"

var (
	file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescOnce sync.Once
	file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescData []byte
)

func file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescGZIP() []byte {
	file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescOnce.Do(func() {
		file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDesc), len(file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDesc)))
	})
	return file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDescData
}

var file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_goTypes = []any{
	(CloudflareD1Region)(0),              // 0: dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1Region
	(CloudflareD1ReadReplicationMode)(0), // 1: dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplicationMode
	(*CloudflareD1DatabaseSpec)(nil),     // 2: dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1DatabaseSpec
	(*CloudflareD1ReadReplication)(nil),  // 3: dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplication
}
var file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_depIdxs = []int32{
	0, // 0: dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1DatabaseSpec.region:type_name -> dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1Region
	3, // 1: dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1DatabaseSpec.read_replication:type_name -> dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplication
	1, // 2: dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplication.mode:type_name -> dev.planton.cloudflare.cloudflared1database.v1alpha1.CloudflareD1ReadReplicationMode
...
func init() { file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_init() }
func file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_init() {
	if File_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDesc), len(file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_goTypes,
		DependencyIndexes: file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_depIdxs,
		EnumInfos:         file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_enumTypes,
		MessageInfos:      file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_msgTypes,
	}.Build()
	File_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto = out.File
	file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_goTypes = nil
	file_catalog_cloudflare_cloudflared1database_v1alpha1_spec_proto_depIdxs = nil
}
