...
func buildRules(protoRules []*cloudflarerulesetv1alpha1.CloudflareRulesetRule) cloudflare.RulesetRuleArray {
...
func buildRatelimit(rl *cloudflarerulesetv1alpha1.CloudflareRulesetRatelimit) *cloudflare.RulesetRuleRatelimitArgs {
...
func buildActionParameters(ap *cloudflarerulesetv1alpha1.CloudflareRulesetActionParameters) *cloudflare.RulesetRuleActionParametersArgs {
...
func buildCacheKey(ck *cloudflarerulesetv1alpha1.CloudflareRulesetCacheKey) *cloudflare.RulesetRuleActionParametersCacheKeyArgs {
...
func logFieldArray(fields []*cloudflarerulesetv1alpha1.CloudflareRulesetLogField) cloudflare.RulesetRuleActionParametersCookieFieldArray {
...
func buildOverrides(o *cloudflarerulesetv1alpha1.CloudflareRulesetOverrides) *cloudflare.RulesetRuleActionParametersOverridesArgs {
...
func rulesetKindString(k cloudflarerulesetv1alpha1.CloudflareRulesetSpec_RulesetKind) string {
	switch k {
	case cloudflarerulesetv1alpha1.CloudflareRulesetSpec_zone:
		return "zone"
	case cloudflarerulesetv1alpha1.CloudflareRulesetSpec_custom:
		return "custom"
	case cloudflarerulesetv1alpha1.CloudflareRulesetSpec_managed:
		return "managed"
	case cloudflarerulesetv1alpha1.CloudflareRulesetSpec_root:
		return "root"
	default:
		return "zone"
	}
...
func phaseString(p cloudflarerulesetv1alpha1.CloudflareRulesetSpec_Phase) string {
	return p.String()
}

func actionString(a cloudflarerulesetv1alpha1.CloudflareRulesetRule_Action) string {
	return a.String()
}
