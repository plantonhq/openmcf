...
func tunnel(
	...
	if spec.GetConfigSrc() == cloudflarezerotrusttunnelv1alpha1.CloudflareZeroTrustTunnelConfigSource_local {
		configSrc = "local"
	}
...
func buildIngresses(rules []*cloudflarezerotrusttunnelv1alpha1.CloudflareZeroTrustTunnelIngressRule) cloudflare.ZeroTrustTunnelCloudflaredConfigConfigIngressArray {
...
func buildIngressOriginRequest(or *cloudflarezerotrusttunnelv1alpha1.CloudflareZeroTrustTunnelOriginRequest) cloudflare.ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestPtrInput {
...
func buildConfigOriginRequest(or *cloudflarezerotrusttunnelv1alpha1.CloudflareZeroTrustTunnelOriginRequest) cloudflare.ZeroTrustTunnelCloudflaredConfigConfigOriginRequestPtrInput {
	if or == nil {
		return nil
	}
...
func audTags(access *cloudflarezerotrusttunnelv1alpha1.CloudflareZeroTrustTunnelAccessConfig) pulumi.StringArray {
